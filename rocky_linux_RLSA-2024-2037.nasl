...
# Rocky Linux Security Advisory RLSA-2024:2037.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:2037");

  script_name(english:"Rocky Linux 8 : tigervnc (RLSA-2024:2037)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2024:2037 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:2037");
...
var pkgs = [
    {'reference':'tigervnc-1.13.1-2.el8_9.10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-1.13.1-2.el8_9.10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-debuginfo-1.13.1-2.el8_9.10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-debuginfo-1.13.1-2.el8_9.10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-debugsource-1.13.1-2.el8_9.10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-debugsource-1.13.1-2.el8_9.10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-icons-1.13.1-2.el8_9.10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-license-1.13.1-2.el8_9.10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-selinux-1.13.1-2.el8_9.10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-1.13.1-2.el8_9.10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-1.13.1-2.el8_9.10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-debuginfo-1.13.1-2.el8_9.10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-debuginfo-1.13.1-2.el8_9.10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-minimal-1.13.1-2.el8_9.10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-minimal-1.13.1-2.el8_9.10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-minimal-debuginfo-1.13.1-2.el8_9.10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-minimal-debuginfo-1.13.1-2.el8_9.10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-module-1.13.1-2.el8_9.10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-module-1.13.1-2.el8_9.10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-module-debuginfo-1.13.1-2.el8_9.10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-module-debuginfo-1.13.1-2.el8_9.10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
