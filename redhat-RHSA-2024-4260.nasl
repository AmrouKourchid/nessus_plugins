...
# extracted from Red Hat Security Advisory RHSA-2024:4260. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4260");

  script_name(english:"RHEL 8 : python-idna (RHSA-2024:4260)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bce370e4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4260");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-idna package based on the guidance in RHSA-2024:4260.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-idna-2.5-7.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
