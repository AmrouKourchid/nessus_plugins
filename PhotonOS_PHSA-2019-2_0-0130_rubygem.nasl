...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rubygem-concurrent-ruby-1.0.5-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rubygem-libxml-ruby-3.0.0-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rubygem-yajl-ruby-1.4.0-2.ph2')) flag++;
