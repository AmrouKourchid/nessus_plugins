...
if (description)
{
  ...
  script_cve_id("CVE-2024-52968");

  script_name(english:"Fortinet FortiClient Agent (FG-IR-24-300) (macOS)");
...
vulnerability as referenced in the FG-IR-24-300 advisory.

  - An improper authentication in Fortinet FortiClientMac 7.0.11 through 7.2.4 allows attacker to gain
    improper access to MacOS via empty password. (CVE-2024-52968)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-24-300");
...
"Upgrade to FortiClient version 7.0.13 / 7.2.5 / 7.4.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-52968");
...
var constraints = [
  { 'min_version' : '7.0.11', 'max_version' : '7.0.12', 'fixed_version' : '7.0.13' },
  { 'min_version' : '7.2.3', 'max_version' : '7.2.4', 'fixed_version' : '7.2.5' },
