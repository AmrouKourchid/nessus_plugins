...
# SUSE update advisory SUSE-SU-2021:3202-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:3202-1");

  script_name(english:"SUSE SLES15 Security Update : linuxptp (SUSE-SU-2021:3202-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19dffe36");
...
var pkgs = [
    {'reference':'linuxptp-3.1.1-3.3.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-server-applications-release-15.3']}
];
