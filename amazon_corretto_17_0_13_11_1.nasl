...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 17.x < 17.0.13.11.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 17 < 17.0.13.11.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-17-2024-Oct-15 advisory.

  - core-libs/java.net (CVE-2024-21208)

  - hotspot/compiler (CVE-2024-21210, CVE-2024-21235)

  - core-libs/java.io:serialization (CVE-2024-21217)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"solution", value:
"Update to Amazon Corretto Java 17.0.13.11.1 or later");
...
var constraints = [
  { 'min_version' : '17.0', 'fixed_version' : '17.0.13.11.1' }
];
