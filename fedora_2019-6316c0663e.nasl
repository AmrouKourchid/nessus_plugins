...
# extracted from Fedora Security Advisory FEDORA-2019-6316c0663e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : evince (2019-6316c0663e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-6316c0663e");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"evince-3.32.0-3.fc30")) flag++;
