...
# extracted from Fedora Security Advisory FEDORA-2024-3936682805
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3936682805");

  script_name(english:"Fedora 39 : qt5-qtnetworkauth (2024-3936682805)");
...
FEDORA-2024-3936682805 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3936682805");
  script_set_attribute(attribute:"solution", value:
"Update the affected qt5-qtnetworkauth package.");
...
var pkgs = [
    {'reference':'qt5-qtnetworkauth-5.15.13-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'qt5-qtnetworkauth');
}
