...
# extracted from Ubuntu Security Notice USN-5269-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5269-2");

  script_name(english:"Ubuntu 16.04 ESM : Django vulnerabilities (USN-5269-2)");
...
the USN-5269-2 advisory.

    USN-5269-1 fixed several vulnerabilities in Django. This update provides the corresponding update for
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5269-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-django', 'pkgver': '1.8.7-1ubuntu5.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-django-common', 'pkgver': '1.8.7-1ubuntu5.15+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-django', 'pkgver': '1.8.7-1ubuntu5.15+esm4', 'ubuntu_pro': TRUE}
];
