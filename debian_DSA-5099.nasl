...
# extracted from Debian Security Advisory dsa-5099. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5099-1 : tryton-proteus - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5099");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/tryton-proteus");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/tryton-proteus");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'tryton-proteus', 'reference': '5.0.1-3+deb10u1'},
    {'release': '11.0', 'prefix': 'tryton-proteus', 'reference': '5.0.8-1+deb11u1'}
];
