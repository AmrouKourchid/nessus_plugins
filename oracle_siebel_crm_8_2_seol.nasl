...
if (description)
{
  ...
  script_name(english:"Oracle Siebel CRM SEoL (8.2.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Oracle Siebel CRM is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Oracle Siebel CRM is 8.2.x. It is, therefore, no longer maintained by its
vendor or provider.
