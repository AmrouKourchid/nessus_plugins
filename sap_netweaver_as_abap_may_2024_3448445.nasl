...
if (description)
{
  ...
  script_cve_id("CVE-2024-34687");
  script_xref(name:"IAVA", value:"2024-A-0277");

  script_name(english:"SAP NetWeaver AS ABAP XSS (May 2024) (3448445)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SAP NetWeaver ABAP server may be affected by a cross-site scripting vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote SAP NetWeaver ABAP server may be affected by a cross-site scripting (XSS) vulnerability. A cross-site
scripting (XSS) vulnerability exists due to improper validation of user-supplied input before returning it to users. An
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://me.sap.com/notes/3448445");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-34687");
...
var constraints = [
  ...
  {'equal': '795', 'fixed_display': 'SAPK-79508INSAPBASIS' },
  {'equal': '796', 'fixed_display': 'SAPK-79602INSAPBASIS' },
];
