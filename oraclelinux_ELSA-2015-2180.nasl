...
# Oracle Linux Security Advisory ELSA-2015-2180 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : rubygem-bundler / and / rubygem-thor (ELSA-2015-2180)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2015-2180 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-2180.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:rubygem-thor");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:rubygem-thor-doc");
...
var pkgs = [
    {'reference':'rubygem-bundler-1.7.8-3.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rubygem-bundler-doc-1.7.8-3.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rubygem-thor-0.19.1-1.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rubygem-thor-doc-0.19.1-1.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
