...
if (description)
{
  ...
  script_cve_id("CVE-2014-8562");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-8562");
...
patch available.
  ...
  - DCM decode in ImageMagick before 6.8.9-9 allows remote attackers to cause a denial of service (out-of-
    bounds read). (CVE-2014-8562)
