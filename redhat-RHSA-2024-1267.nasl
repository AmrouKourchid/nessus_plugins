...
# extracted from Red Hat Security Advisory RHSA-2024:1267. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1267");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.12.53 (RHSA-2024:1267)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.12.53.");
...
in the RHSA-2024:1267 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.53. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b351e3c2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2214402");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1267");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.12.53 packages based on the guidance in RHSA-2024:1267.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.12.0-202403042037.p0.g9946c63.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.12.0-202403042037.p0.g9946c63.assembly.stream.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
