...
# extracted from Red Hat Security Advisory librsvg. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-11464", "CVE-2019-20446", "CVE-2023-38633");

  script_name(english:"RHEL 6 : librsvg (Unpatched Vulnerability) (deprecated)");
