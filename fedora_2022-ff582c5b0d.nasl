...
# extracted from Fedora Security Advisory FEDORA-2022-ff582c5b0d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ff582c5b0d");

  script_name(english:"Fedora 36 : mbedtls (2022-ff582c5b0d)");
...
FEDORA-2022-ff582c5b0d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ff582c5b0d");
...
var pkgs = [
    {'reference':'mbedtls-2.28.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
