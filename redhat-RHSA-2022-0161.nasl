...
referenced in the RHSA-2022:0161 advisory.
    ...
    * OpenJDK: Excessive memory allocation in TIFF*Decompressor (ImageIO, 8274096) (CVE-2022-21366)
    ...
    For more details about the security issues and their impact, the CVSS score, acknowledgements, and other
    related information, see the CVE pages listed in the References section.

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0161.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?495b0cc3");
...
"Update the RHEL java-17-openjdk package based on the guidance in RHSA-2022:0161.");
