...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Kubernetes PHSA-2021-2.0-0394");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'kubernetes-1.18.19-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'kubernetes-kubeadm-1.18.19-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'kubernetes-kubectl-extras-1.18.19-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'kubernetes-pause-1.18.19-3.ph2')) flag++;
