...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : python-cryptography (EulerOS-SA-2024-2893)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2893
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c7719678");
...
var pkgs = [
  "python3-cryptography-2.9.2-1.h7.eulerosv2r10"
];
