...
if (description)
{
  ...
  script_cve_id("CVE-2024-27025");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-27025");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: nbd: null check for nla_nest_start
    nla_nest_start() may fail and return NULL. Insert a check and set errno based on other call sites within
    the same source code. (CVE-2024-27025)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-27025");
