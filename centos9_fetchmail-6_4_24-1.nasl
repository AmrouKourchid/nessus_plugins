...
if (description)
{
  ...
  script_name(english:"CentOS 9 : fetchmail-6.4.24-1.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for fetchmail.");
...
fetchmail-6.4.24-1.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=16166");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream fetchmail package.");
...
var pkgs = [
    {'reference':'fetchmail-6.4.24-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
