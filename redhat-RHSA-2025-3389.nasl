...
# extracted from Red Hat Security Advisory RHSA-2025:3389. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3389");

  script_name(english:"RHEL 9 : libxslt (RHSA-2025:3389)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3389.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?344f04f0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3389");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libxslt package based on the guidance in RHSA-2025:3389.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxslt-1.1.34-10.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxslt-devel-1.1.34-10.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
