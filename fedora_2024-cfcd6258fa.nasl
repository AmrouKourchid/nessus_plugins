...
# extracted from Fedora Security Advisory FEDORA-2024-cfcd6258fa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-cfcd6258fa");

  script_name(english:"Fedora 41 : ruby (2024-cfcd6258fa)");
...
FEDORA-2024-cfcd6258fa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-cfcd6258fa");
...
var pkgs = [
    {'reference':'ruby-3.3.5-14.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
