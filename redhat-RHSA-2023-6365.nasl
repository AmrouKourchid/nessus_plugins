...
# extracted from Red Hat Security Advisory RHSA-2023:6365. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6365");

  script_name(english:"RHEL 9 : mod_auth_openidc (RHSA-2023:6365)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for mod_auth_openidc.");
...
referenced in the RHSA-2023:6365 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6365.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b93f51c8");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2189268");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6365");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_auth_openidc package based on the guidance in RHSA-2023:6365.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_auth_openidc-2.4.9.4-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
