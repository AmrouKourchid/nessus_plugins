...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : python-cryptography (EulerOS-SA-2024-1823)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1823
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c08b74cb");
...
var pkgs = [
  "python3-cryptography-3.3.1-2.h9.eulerosv2r11"
];
