...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-1.7.0-openjdk on SL6.x i386/x86_64 (20180521) (Spectre)");
...
Note: This is the OpenJDK side of the CVE-2018-3639 mitigation.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bdd691af");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"java-1.7.0-openjdk-1.7.0.181-2.6.14.8.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.7.0-openjdk-debuginfo-1.7.0.181-2.6.14.8.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.7.0-openjdk-demo-1.7.0.181-2.6.14.8.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.7.0-openjdk-devel-1.7.0.181-2.6.14.8.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.7.0-openjdk-javadoc-1.7.0.181-2.6.14.8.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.7.0-openjdk-src-1.7.0.181-2.6.14.8.el6_9")) flag++;
