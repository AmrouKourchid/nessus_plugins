...
if (description)
{
  ...
  script_name(english:"Security Update for Microsoft .NET 6 Core (October 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by a .NET Core vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft .NET 6 Core installed on the remote host is prior to 6.0.23. It is, therefore, affected by
  a vulnerability as referenced in the 2023_Oct_10 advisory.
...
var constraints = [
  { 'min_version' : '6.0.0', 'fixed_version' : '6.0.23' }
];
