...
# extracted from Red Hat Security Advisory RHSA-2022:8096. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8096");

  script_name(english:"RHEL 9 : redis (RHSA-2022:8096)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for redis.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:8096 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8096.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2158a736");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8096");
...
"Update the RHEL redis package based on the guidance in RHSA-2022:8096.");
