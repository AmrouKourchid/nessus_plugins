...
# extracted from Gentoo Linux Security Advisory GLSA 202501-04.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202501-04 : Yubico pam-u2f: Partial Authentication Bypass");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202501-04 (Yubico pam-u2f: Partial Authentication
Bypass)

    Multiple vulnerabilities have been discovered in Yubico pam-u2f. Please review the CVE identifiers
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202501-04");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=948201");
