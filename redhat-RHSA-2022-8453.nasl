...
# extracted from Red Hat Security Advisory RHSA-2022:8453. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8453");

  script_name(english:"RHEL 9 : device-mapper-multipath (RHSA-2022:8453)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8453.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be8c520f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8453");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2138959");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL device-mapper-multipath package based on the guidance in RHSA-2022:8453.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'device-mapper-multipath-0.8.7-12.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
