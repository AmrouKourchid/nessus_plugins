...
if (description)
{
  ...
  script_name(english:"Debian Linux SEoL (9.x)");
...
contain security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/News/2020/20200718");
...
"Upgrade to a version of Debian Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2020/07/18");
...
var constraints = [
  { max_branch : '9', min_branch : '9', seol : 20200718 }
];
