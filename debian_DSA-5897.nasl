...
# extracted from Debian Security Advisory dsa-5897. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2025-31510");

  script_name(english:"Debian dsa-5897 : lemonldap-ng - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5897
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-31510");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/lemonldap-ng");
...
"Upgrade the lemonldap-ng packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-31510");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:liblemonldap-ng-ssoaas-apache-client-perl");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'lemonldap-ng', 'reference': '2.16.1+ds-deb12u6'},
    {'release': '12.0', 'prefix': 'lemonldap-ng-doc', 'reference': '2.16.1+ds-deb12u6'},
    {'release': '12.0', 'prefix': 'lemonldap-ng-fastcgi-server', 'reference': '2.16.1+ds-deb12u6'},
    {'release': '12.0', 'prefix': 'lemonldap-ng-handler', 'reference': '2.16.1+ds-deb12u6'},
    {'release': '12.0', 'prefix': 'lemonldap-ng-uwsgi-app', 'reference': '2.16.1+ds-deb12u6'},
    {'release': '12.0', 'prefix': 'liblemonldap-ng-common-perl', 'reference': '2.16.1+ds-deb12u6'},
    {'release': '12.0', 'prefix': 'liblemonldap-ng-handler-perl', 'reference': '2.16.1+ds-deb12u6'},
    {'release': '12.0', 'prefix': 'liblemonldap-ng-manager-perl', 'reference': '2.16.1+ds-deb12u6'},
    {'release': '12.0', 'prefix': 'liblemonldap-ng-portal-perl', 'reference': '2.16.1+ds-deb12u6'},
    {'release': '12.0', 'prefix': 'liblemonldap-ng-ssoaas-apache-client-perl', 'reference': '2.16.1+ds-deb12u6'}
];
