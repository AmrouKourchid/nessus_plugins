...
# extracted from Oracle Linux Security Advisory ELSA-2025-0673.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : git-lfs (ELSA-2025-0673)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-0673.html");
...
var pkgs = [
    {'reference':'git-lfs-3.4.1-4.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-3.4.1-4.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
