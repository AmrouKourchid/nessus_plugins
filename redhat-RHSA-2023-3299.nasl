...
# extracted from Red Hat Security Advisory RHSA-2023:3299. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3299");

  script_name(english:"RHEL 8 : jenkins and jenkins-2-plugins (RHSA-2023:3299)");
...
referenced in the RHSA-2023:3299 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3299.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12874ded");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1856376");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2034388");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2087606");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2134291");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2134292");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2177630");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2177634");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2177638");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2177646");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2185707");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/PITEAM-10");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/PITEAM-9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3299");
...
"Update the RHEL jenkins / jenkins-2-plugins packages based on the guidance in RHSA-2023:3299.");
  ...
  script_cwe_id(20, 79, 200, 266, 358, 400, 404, 502, 770, 787, 1188, 1220);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.13.1684911916-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2020-7692', 'CVE-2021-4178', 'CVE-2022-25647', 'CVE-2022-42889', 'CVE-2023-24422', 'CVE-2023-25761', 'CVE-2023-25762']},
      {'reference':'jenkins-2.387.3.1684911776-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-46877', 'CVE-2022-22978', 'CVE-2022-40151', 'CVE-2022-40152', 'CVE-2023-24998', 'CVE-2023-27900', 'CVE-2023-27901', 'CVE-2023-27902', 'CVE-2023-27904']}
    ]
  }
];
