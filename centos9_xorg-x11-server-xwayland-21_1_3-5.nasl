...
if (description)
{
  ...
  script_name(english:"CentOS 9 : xorg-x11-server-Xwayland-21.1.3-5.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for xorg-x11-server-Xwayland.");
...
xorg-x11-server-Xwayland-21.1.3-5.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=27834");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-21.1.3-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xwayland-devel-21.1.3-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
