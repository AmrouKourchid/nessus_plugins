...
if (description)
{
  ...
  script_cve_id("CVE-2021-46975");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-46975 (deprecated)");
...
"Plugin has been deprecated due to the specified CVE being rejected by NVD.");
  ...
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:R/S:C/C:L/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-46975");
