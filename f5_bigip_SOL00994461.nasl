...
# extracted from F5 Networks BIG-IP Solution K00994461.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : GSON vulnerability (K00994461)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K00994461 advisory.

    The package com.google.code.gson:gson before 2.8.9 are vulnerable to Deserialization of Untrusted Data via
    the writeReplace() method in internal classes, which may lead to DoS attacks.(CVE-2022-25647)ImpactTraffic
    is disrupted for new client connections. This vulnerability allows a remote, authenticated attacker to
    cause a denial-of-service (DoS) on the BIG-IP system specific to the iAppsLX service, and the BIG-IQ
    system specific to the iControl REST framework. There is no data plane exposure; this is a control plane
    issue only.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K00994461");
