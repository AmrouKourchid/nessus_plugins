...
# extracted from Red Hat Security Advisory RHSA-2021:0739. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0739.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d18019f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0739");
...
"Update the RHEL nodejs:12 package based on the guidance in RHSA-2021:0739.");
  ...
  'nodejs:12': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-12.21.0-1.module+el8.1.0+10194+d5e49c90', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-12.21.0-1.module+el8.1.0+10194+d5e49c90', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-12.21.0-1.module+el8.1.0+10194+d5e49c90', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-12.21.0-1.module+el8.1.0+10194+d5e49c90', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-6.14.11-1.12.21.0.1.module+el8.1.0+10194+d5e49c90', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
