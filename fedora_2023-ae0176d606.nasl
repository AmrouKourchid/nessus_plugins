...
# extracted from Fedora Security Advisory FEDORA-2023-ae0176d606
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ae0176d606");

  script_name(english:"Fedora 37 : dotnet6.0 (2023-ae0176d606)");
...
FEDORA-2023-ae0176d606 advisory.

    This is the monthly update for .NET 6 for September 2023.

    Release notes:

    - Runtime: https://github.com/dotnet/core/blob/main/release-notes/6.0/6.0.22/6.0.22.md
    - SDK: https://github.com/dotnet/core/blob/main/release-notes/6.0/6.0.22/6.0.122.md

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ae0176d606");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.122-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
