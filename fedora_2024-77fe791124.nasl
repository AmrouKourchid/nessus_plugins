...
# extracted from Fedora Security Advisory FEDORA-2024-77fe791124
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-77fe791124");

  script_name(english:"Fedora 40 : trafficserver (2024-77fe791124)");
...
FEDORA-2024-77fe791124 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-77fe791124");
...
var pkgs = [
    {'reference':'trafficserver-9.2.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
