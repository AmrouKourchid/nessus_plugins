...
"The version of OpenSSL installed on the remote host is prior to 1.0.1t. It is, therefore, affected by multiple
vulnerabilities as referenced in the 1.0.1t advisory.
...
var constraints = [
  { 'min_version' : '1.0.1', 'fixed_version' : '1.0.1t' }
];
