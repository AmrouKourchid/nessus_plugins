...
# extracted from VMware Security Advisory PHSA-2023-4.0-0404. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Wireshark PHSA-2023-4.0-0404");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the wireshark package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-404.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wireshark-4.0.6-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wireshark-devel-4.0.6-1.ph4')) flag++;
