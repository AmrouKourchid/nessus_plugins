...
# extracted from Red Hat Security Advisory RHSA-2024:10784. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10784");

  script_name(english:"RHEL 8 : rhc (RHSA-2024:10784)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10784.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c3bfd4a1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10784");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rhc package based on the guidance in RHSA-2024:10784.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhc-0.2.5-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
