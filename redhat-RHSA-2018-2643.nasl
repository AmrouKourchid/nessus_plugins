...
if (description)
{
  ...
  script_name(english:"RHEL 7 : rhvm-appliance (RHSA-2018:2643)");
...
referenced in the RHSA-2018:2643 advisory.
    ...
    The following packages have been upgraded to a later upstream version: rhvm-appliance (4.2). (BZ#1590658,
    BZ#1591095, BZ#1591096, BZ#1592655, BZ#1594636, BZ#1597534, BZ#1612683)

    Red Hat would like to thank the PostgreSQL project for reporting CVE-2018-10915 and Ammarit Thongthua
    (Deloitte Thailand Pentest team) and Nattakit Intarasorn (Deloitte Thailand Pentest team) for reporting
    CVE-2018-1067. Upstream acknowledges Andrew Krasichkov as the original reporter of CVE-2018-10915.

    Security fixes:

    * vulnerability: wildfly-core: Path traversal can allow the extraction of .war archives to write arbitrary
    files (Zip Slip) (CVE-2018-10862)

    * vulnerability: apache-cxf: TLS hostname verification does not work correctly with com.sun.net.ssl.*
    (CVE-2018-8039)

    * vulnerability: postgresql: Certain host connection parameters defeat client-side security defenses
    (CVE-2018-10915)

    * vulnerability: undertow: HTTP header injection using CRLF with UTF-8 Encoding (incomplete fix of )
    (CVE-2018-1067, CVE-2016-4993)

    * vulnerability: undertow: File descriptor leak caused by JarURLConnection.getLastModified() allows
    attacker to cause a denial of service (CVE-2018-1114)

    * vulnerability: guava: Unbounded memory allocation in AtomicDoubleArray and CompoundOrdering classes
    allow remote attackers to cause a denial of service (CVE-2018-10237)

    * vulnerability: bouncycastle: flaw in the low-level interface to RSA key pair generator
    (CVE-2018-1000180)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f79f411");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1573045");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1616249");
...
"Update the RHEL rhvm-appliance package based on the guidance in RHSA-2018:2643.");
  ...
  script_cwe_id(113, 119, 22, 248, 325, 400, 89);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhvm-appliance-4.2-20180828.0.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ovirt-'}
    ]
  }
];
