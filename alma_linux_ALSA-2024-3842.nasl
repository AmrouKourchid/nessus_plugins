...
# AlmaLinux Security Advisory ALSA-2024:3842.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:3842");

  script_name(english:"AlmaLinux 9 : c-ares (ALSA-2024:3842)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-3842.html");
