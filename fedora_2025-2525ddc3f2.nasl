...
# extracted from Fedora Security Advisory FEDORA-2025-2525ddc3f2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-2525ddc3f2");

  script_name(english:"Fedora 41 : chromium (2025-2525ddc3f2)");
...
FEDORA-2025-2525ddc3f2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2525ddc3f2");
...
var pkgs = [
    {'reference':'chromium-132.0.6834.159-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
