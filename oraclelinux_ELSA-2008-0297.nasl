...
# extracted from Oracle Linux Security Advisory ELSA-2008-0297.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : dovecot (ELSA-2008-0297)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0297.html");
...
"Update the affected dovecot package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-6598");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2008-1199");
...
var pkgs = [
    {'reference':'dovecot-1.0.7-2.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dovecot-1.0.7-2.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
