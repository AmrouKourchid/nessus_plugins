...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.1.0 : libsndfile (EulerOS-SA-2019-1441)");
...
the following vulnerabilities :
  ...
  - Heap-based buffer overflow in libsndfile 1.0.25 allows
    ...
    headindex value in the header in an AIFF
    file.(CVE-2015-7805)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1441
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3e51702d");
...
"Update the affected libsndfile packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2017-14246");
...
pkgs = ["libsndfile-1.0.25-10.h3.eulerosv2r7"];
