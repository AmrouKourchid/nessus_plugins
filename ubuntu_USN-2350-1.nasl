...
# extracted from Ubuntu Security Notice USN-2350-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2350-1");

  script_name(english:"Ubuntu 14.04 LTS : NSS update (USN-2350-1)");
...
USN-2350-1 advisory.
    ...
    The NSS package contained outdated CA certificates. This update refreshes the NSS package to version 3.17
    which includes the latest CA certificate bundle.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2350-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libnss3', 'pkgver': '2:3.17-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-1d', 'pkgver': '2:3.17-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-dev', 'pkgver': '2:3.17-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-nssdb', 'pkgver': '2:3.17-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libnss3-tools', 'pkgver': '2:3.17-0ubuntu0.14.04.1'}
];
