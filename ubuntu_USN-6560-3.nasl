...
# extracted from Ubuntu Security Notice USN-6560-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6560-3");

  script_name(english:"Ubuntu 16.04 LTS : OpenSSH vulnerability (USN-6560-3)");
...
USN-6560-3 advisory.
    ...
    USN-6560-2 fixed a vulnerability in OpenSSH. This update provides the corresponding update for Ubuntu
    16.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6560-3");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'openssh-client', 'pkgver': '1:7.2p2-4ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openssh-client-ssh1', 'pkgver': '1:7.2p2-4ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openssh-server', 'pkgver': '1:7.2p2-4ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openssh-sftp-server', 'pkgver': '1:7.2p2-4ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ssh', 'pkgver': '1:7.2p2-4ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ssh-askpass-gnome', 'pkgver': '1:7.2p2-4ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ssh-krb5', 'pkgver': '1:7.2p2-4ubuntu2.10+esm6', 'ubuntu_pro': TRUE}
];
