...
# extracted from Fedora Security Advisory FEDORA-2022-d73cfd3a36
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d73cfd3a36");

  script_name(english:"Fedora 36 : qemu (2022-d73cfd3a36)");
...
FEDORA-2022-d73cfd3a36 advisory.

    Automatic update for qemu-6.2.0-4.fc36.1.

    ##### **Changelog**

    ```
    * Wed Feb  9 2022 Eduardo Lima (Etrunko) <etrunko@redhat.com> - 2:6.2.0-4
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d73cfd3a36");
...
var pkgs = [
    {'reference':'qemu-6.2.0-4.fc36.1', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
