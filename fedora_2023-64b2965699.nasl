...
# extracted from Fedora Security Advisory FEDORA-2023-64b2965699
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-64b2965699");

  script_name(english:"Fedora 39 : python-configobj (2023-64b2965699)");
...
FEDORA-2023-64b2965699 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-64b2965699");
...
"Update the affected python-configobj package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-configobj");
...
var pkgs = [
    {'reference':'python-configobj-5.0.8-6.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
