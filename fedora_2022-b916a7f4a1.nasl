...
# extracted from Fedora Security Advisory FEDORA-2022-b916a7f4a1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-b916a7f4a1");

  script_name(english:"Fedora 36 : suricata (2022-b916a7f4a1)");
...
FEDORA-2022-b916a7f4a1 advisory.

    LibHTP has been updated to 0.5.42 and is bundled with the release. Various security, performance, accuracy
    and stability issues have been fixed.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-b916a7f4a1");
...
var pkgs = [
    {'reference':'suricata-6.0.9-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
