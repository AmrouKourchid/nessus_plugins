...
# extracted from Red Hat Security Advisory RHSA-2022:8866. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8866");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.1.9 (python-XStatic-Angular) (RHSA-2022:8866)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.1.9 (python-XStatic-Angular).");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:8866 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8866.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0da89e85");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8866");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1813309");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.1.9 (python-XStatic-Angular) package based on the guidance in
RHSA-2022:8866.");
