...
# extracted from Red Hat Security Advisory RHSA-2020:2064.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : chromium-browser (RHSA-2020:2064)");
...
RHSA-2020:2064 advisory.

  - Type confusion in Blink in Google Chrome prior to 81.0.4044.138 allowed a remote attacker to potentially
...
var pkgs = [
    {'reference':'chromium-browser-81.0.4044.138-1.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
