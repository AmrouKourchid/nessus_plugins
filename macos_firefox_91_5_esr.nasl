...
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 91.5. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2022-02 advisory.
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'91.5', min:'91.0.0', severity:SECURITY_HOLE);
