...
# AlmaLinux Security Advisory ALSA-2021:5160.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:5160");

  script_name(english:"AlmaLinux 8 : go-toolset:rhel8 (ALSA-2021:5160)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2021:5160 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-5160.html");
...
var appstreams = {
    'go-toolset:rhel8': [
      {'reference':'delve-1.6.0-1.module_el8.5.0+2604+960c7771', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.16.12-1.module_el8.5.0+2604+960c7771', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-1.16.12-1.module_el8.5.0+2604+960c7771', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-bin-1.16.12-1.module_el8.5.0+2604+960c7771', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-docs-1.16.12-1.module_el8.5.0+2604+960c7771', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-misc-1.16.12-1.module_el8.5.0+2604+960c7771', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-race-1.16.12-1.module_el8.5.0+2604+960c7771', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-src-1.16.12-1.module_el8.5.0+2604+960c7771', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'golang-tests-1.16.12-1.module_el8.5.0+2604+960c7771', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
