...
if (description)
{
  ...
  script_cve_id("CVE-2022-49191");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49191");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: mxser: fix xmit_buf leak in activate
    when LSR == 0xff When LSR is 0xff in ->activate() (rather unlike), we return an error. Provided
    ->shutdown() is not called when ->activate() fails, nothing actually frees the buffer in this case. Fix
    this by properly freeing the buffer in a designated label. We jump there also from the !info->type if
    now too. (CVE-2022-49191)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49191");
