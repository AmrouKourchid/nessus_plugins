...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : libpcap (EulerOS-SA-2020-1487)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1487
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a106d25");
...
pkgs = ["libpcap-1.5.3-11.h3.eulerosv2r7"];
