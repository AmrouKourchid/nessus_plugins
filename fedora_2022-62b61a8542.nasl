...
# extracted from Fedora Security Advisory FEDORA-2022-62b61a8542
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-62b61a8542");

  script_name(english:"Fedora 37 : trafficserver (2022-62b61a8542)");
...
FEDORA-2022-62b61a8542 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-62b61a8542");
...
var pkgs = [
    {'reference':'trafficserver-9.1.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
