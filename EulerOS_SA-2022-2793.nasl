...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : dpdk (EulerOS-SA-2022-2793)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2793
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7190428d");
...
var pkgs = [
  "dpdk-18.11-0.h50.eulerosv2r8",
  "dpdk-devel-18.11-0.h50.eulerosv2r8",
  "dpdk-tools-18.11-0.h50.eulerosv2r8"
];
