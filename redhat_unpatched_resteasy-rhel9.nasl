...
if (description)
{
  ...
  script_cve_id("CVE-2023-0482");

  script_name(english:"RHEL 9 : resteasy (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-0482");
