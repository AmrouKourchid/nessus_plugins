...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-297.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : ca-certificates (ALAS2023-2023-297)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2023-297 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-297.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2023-37920.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/faqs.html");
  script_set_attribute(attribute:"solution", value:
"Run 'dnf update ca-certificates --releasever 2023.1.20230823' to update your system.");
...
var pkgs = [
    {'reference':'ca-certificates-2023.2.60-1.0.amzn2023.0.3', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
