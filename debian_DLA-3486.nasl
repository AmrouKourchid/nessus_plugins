...
# extracted from Debian Security Advisory dla-3486. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3486 : ocsinventory-reports - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3486
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3486-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c36d4e0");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-39369");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/ocsinventory-server");
  script_set_attribute(attribute:"solution", value:
"Upgrade the ocsinventory-reports packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:ocsinventory-reports");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:ocsinventory-server");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ocsinventory-reports', 'reference': '2.5+dfsg1-1+deb10u1'},
    {'release': '10.0', 'prefix': 'ocsinventory-server', 'reference': '2.5+dfsg1-1+deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ocsinventory-reports / ocsinventory-server');
}
