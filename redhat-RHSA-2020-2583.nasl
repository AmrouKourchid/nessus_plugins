...
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.4.9 python-psutil.");
...
the RHSA-2020:2583 advisory.
    ...
    * python-psutil: A double free issue has been discovered in python-psutil that may allow a local attacker
    to get code execution with the privileges of the user running the python-psutil application.
    (CVE-2019-18874)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2583.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4f057170");
...
"Update the RHEL OpenShift Container Platform 4.4.9 python-psutil package based on the guidance in RHSA-2020:2583.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python2-psutil-5.6.6-1.el7ar', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ar', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'python2-psutil-5.6.6-1.el7ar', 'cpu':'s390x', 'release':'7', 'el_string':'el7ar', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'python2-psutil-5.6.6-1.el7ar', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ar', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
