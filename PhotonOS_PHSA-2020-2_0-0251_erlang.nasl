...
if (description)
{
  ...
  script_bugtraq_id(102197);

  script_name(english:"Photon OS 2.0: Erlang PHSA-2020-2.0-0251");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'erlang-19.3-4.ph2')) flag++;
