...
# SUSE update advisory SUSE-SU-2022:2297-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:2297-1");

  script_name(english:"SUSE SLES15 Security Update : python-Twisted (SUSE-SU-2022:2297-1)");
...
in the SUSE-SU-2022:2297-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-July/011415.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd7df3ca");
...
var pkgs = [
    {'reference':'python3-Twisted-22.2.0-150400.5.4.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'python3-Twisted-22.2.0-150400.5.4.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-server-applications-release-15.4', 'sles-release-15.4']}
];
