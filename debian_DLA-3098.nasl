...
# extracted from Debian Security Advisory dla-3098. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3098 : libmodbus-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3098
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3098-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Markus Koschany
    September 04, 2022                            https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : libmodbus
    Version        : 3.1.4-2+deb10u2
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/libmodbus");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libmodbus-dev', 'reference': '3.1.4-2+deb10u2'},
    {'release': '10.0', 'prefix': 'libmodbus5', 'reference': '3.1.4-2+deb10u2'}
];
