...
# extracted from Fedora Security Advisory FEDORA-2023-0259c3f26f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0259c3f26f");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 38 : mod_http2 (2023-0259c3f26f)");
...
FEDORA-2023-0259c3f26f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0259c3f26f");
...
var pkgs = [
    {'reference':'mod_http2-2.0.25-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
