...
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2023-171 advisory.
    ...
    A timing side-channel vulnerability was found in RSA ClientKeyExchange messages in GnuTLS. This side-
    channel may be sufficient to recover the key encrypted in the RSA ciphertext across a network in a
