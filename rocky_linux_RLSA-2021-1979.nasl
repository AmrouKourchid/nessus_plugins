...
# Rocky Linux Security Advisory RLSA-2021:1979.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2021:1979");
  script_xref(name:"IAVB", value:"2021-B-0021-S");

  script_name(english:"Rocky Linux 8 : squid:4 (RLSA-2021:1979)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2021:1979 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2021:1979");
...
var appstreams = {
    'squid:4': [
      ...
      {'reference':'squid-4.11-4.module+el8.4.0+404+316a0dc5.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-4.11-4.module+el8.4.0+404+316a0dc5.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-debuginfo-4.11-4.module+el8.4.0+404+316a0dc5.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-debuginfo-4.11-4.module+el8.4.0+404+316a0dc5.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-debugsource-4.11-4.module+el8.4.0+404+316a0dc5.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-debugsource-4.11-4.module+el8.4.0+404+316a0dc5.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
};
