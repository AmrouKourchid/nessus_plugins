...
# extracted from Fedora Security Advisory FEDORA-2020-0e055ea503.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : python-lxml (2020-0e055ea503)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This update fixes mXSS security vulnerability due to the use of
improper parser (CVE-2020-27783)

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-0e055ea503");
...
"Update the affected python-lxml package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-lxml");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"python-lxml-4.5.1-3.fc33")) flag++;
