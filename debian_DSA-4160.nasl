...
denial of service if a malformed EVT file is processed.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/libevt");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/libevt");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4160");
...
version 20170120-1+deb9u1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-8754");
