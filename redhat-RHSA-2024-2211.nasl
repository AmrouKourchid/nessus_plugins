...
# extracted from Red Hat Security Advisory RHSA-2024:2211. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2211");

  script_name(english:"RHEL 9 : tcpdump (RHSA-2024:2211)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2211.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?742c1aa1");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2211");
...
"Update the RHEL tcpdump package based on the guidance in RHSA-2024:2211.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tcpdump-4.99.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'}
    ]
  }
];
