...
# extracted from Red Hat Security Advisory RHSA-2022:8098. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8098");

  script_name(english:"RHEL 9 : toolbox (RHSA-2022:8098)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for toolbox.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:8098 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8098.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?239e5e95");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8098");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL toolbox package based on the guidance in RHSA-2022:8098.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'toolbox-0.0.99.3-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'toolbox-tests-0.0.99.3-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
