...
# extracted from Fedora Security Advisory FEDORA-2019-1bd9cfb718.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : libreswan (2019-1bd9cfb718)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1bd9cfb718");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libreswan-3.29-1.fc29")) flag++;
