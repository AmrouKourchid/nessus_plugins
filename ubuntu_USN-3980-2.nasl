...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : Linux kernel (HWE) vulnerabilities (USN-3980-2)");
...
the USN-3980-2 advisory.

    USN-3980-1 fixed vulnerabilities in the Linux kernel for Ubuntu 18.10. This update provides the
    ...
    Marc Orr discovered that the KVM hypervisor implementation in the Linux kernel did not properly restrict
    APIC MSR register values when nested virtualization is used. An attacker in a guest vm could use this to
    cause a denial of service (host OS crash). (CVE-2019-3887)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3980-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.18.0-1018-azure");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.18.0-20-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.18.0-20-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.18.0-20-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.18.0-20-snapdragon");
...
var kernel_mappings = {
  '18.04': {
    '4.18.0': {
      'generic': '4.18.0-20',
      'generic-lpae': '4.18.0-20',
      'lowlatency': '4.18.0-20',
      'snapdragon': '4.18.0-20',
      'azure': '4.18.0-1018'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3980-2');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2018-12126', 'CVE-2018-12127', 'CVE-2018-12130', 'CVE-2018-16884', 'CVE-2019-3874', 'CVE-2019-3882', 'CVE-2019-3887', 'CVE-2019-9500', 'CVE-2019-9503', 'CVE-2019-11091');
