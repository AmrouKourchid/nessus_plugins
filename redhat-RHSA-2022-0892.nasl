...
# extracted from Red Hat Security Advisory RHSA-2022:0892. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0892");

  script_name(english:"RHEL 8 : libarchive (RHSA-2022:0892)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libarchive.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:0892 advisory.
    ...
    * libarchive: symbolic links incorrectly followed when changing modes, times, ACL and flags of a file
    while extracting an archive (CVE-2021-31566)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0892.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d8f74128");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0892");
...
"Update the RHEL libarchive package based on the guidance in RHSA-2022:0892.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bsdtar-3.3.3-3.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libarchive-3.3.3-3.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libarchive-devel-3.3.3-3.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
