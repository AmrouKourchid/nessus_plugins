...
# extracted from Fedora Security Advisory FEDORA-2024-c395d8fef4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c395d8fef4");

  script_name(english:"Fedora 39 : freeradius (2024-c395d8fef4)");
...
FEDORA-2024-c395d8fef4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c395d8fef4");
...
var pkgs = [
    {'reference':'freeradius-3.2.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
