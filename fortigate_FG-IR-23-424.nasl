...
if (description)
{
  ...
  script_cve_id("CVE-2023-46717");
  script_xref(name:"IAVA", value:"2024-A-0165-S");

  script_name(english:"Fortinet Fortigate Improper authentication following read-only user login (FG-IR-23-424)");
...
vulnerability as referenced in the FG-IR-23-424 advisory.

  - An improper authentication vulnerability [CWE-287] in FortiOS versions 7.4.1 and below, versions 7.2.6 and
    below, and versions 7.0.12 and below when configured with FortiAuthenticator in HA may allow a readonly
    user to gain read-write access via successive login attempts. (CVE-2023-46717)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-23-424");
  script_set_attribute(attribute:"solution", value:
"Please upgrade to FortiOS version 7.0.13/7.2.8/7.4.2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-46717");
