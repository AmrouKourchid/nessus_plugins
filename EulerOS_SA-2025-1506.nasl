...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : emacs (EulerOS-SA-2025-1506)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1506
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a01d90c7");
...
var pkgs = [
  "emacs-filesystem-27.1-4.h11.eulerosv2r10"
];
