...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : file (EulerOS-SA-2023-3375)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the file packages installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3375
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86650041");
...
var pkgs = [
  "file-5.41-1.h2.eulerosv2r11",
  "file-libs-5.41-1.h2.eulerosv2r11",
  "python3-magic-5.41-1.h2.eulerosv2r11"
];
