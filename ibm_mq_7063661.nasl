...
if (description)
{
  ...
  script_cve_id("CVE-2023-45177");
  script_xref(name:"IAVA", value:"2023-A-0658-S");

  script_name(english:"IBM MQ Denial of Service (7063661)");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server is affected by a denial of service vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of IBM MQ Server running on the remote host is affected by a vulnerability as referenced in the 7063661
advisory.

  - IBM MQ has addressed an error within the IBM MQ clustering logic, in which a specially crafted message could cause 
    a denial-of-service.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7063661");
  script_set_attribute(attribute:"solution", value:
"Upgrade to 9.0.0.21 LTS, 9.1.0.18 LTS, 9.2.0.20 LTS, 9.3.0.10 LTS, 9.3.4 CD or later. Alternatively, install APAR 
IT41871 where appropriate.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-45177");
...
{
  constraints = [
    { 'min_version' : '9.0', 'fixed_version' : '9.0.0.21' },
    { 'min_version' : '9.1', 'fixed_version' : '9.1.0.18' },
    { 'min_version' : '9.2', 'fixed_version' : '9.2.0.20' },
    { 'min_version' : '9.3', 'fixed_version' : '9.3.0.10' }
  ];
}
