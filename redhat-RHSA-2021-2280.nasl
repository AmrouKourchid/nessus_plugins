...
# extracted from Red Hat Security Advisory RHSA-2021:2280. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2280");

  script_name(english:"RHEL 7 : nettle (RHSA-2021:2280)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for nettle.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:2280 advisory.

    Nettle is a cryptographic library that is designed to fit easily in almost any context: In crypto toolkits
    for object-oriented languages, such as C++, Python, or Pike, in applications like LSH or GNUPG, or even in
    kernel space.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2280.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6903cce3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2280");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1942533");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nettle package based on the guidance in RHSA-2021:2280.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nettle-2.7.1-9.el7_7', 'sp':'7', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nettle-2.7.1-9.el7_7', 'sp':'7', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nettle-2.7.1-9.el7_7', 'sp':'7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nettle-2.7.1-9.el7_7', 'sp':'7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nettle-2.7.1-9.el7_7', 'sp':'7', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nettle-2.7.1-9.el7_7', 'sp':'7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nettle-2.7.1-9.el7_7', 'sp':'7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nettle-devel-2.7.1-9.el7_7', 'sp':'7', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nettle-devel-2.7.1-9.el7_7', 'sp':'7', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nettle-devel-2.7.1-9.el7_7', 'sp':'7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nettle-devel-2.7.1-9.el7_7', 'sp':'7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nettle-devel-2.7.1-9.el7_7', 'sp':'7', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nettle-devel-2.7.1-9.el7_7', 'sp':'7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nettle-devel-2.7.1-9.el7_7', 'sp':'7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
