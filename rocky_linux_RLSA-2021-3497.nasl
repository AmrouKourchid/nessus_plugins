...
# Rocky Linux Security Advisory RLSA-2021:3497.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2021:3497");
  script_xref(name:"IAVA", value:"2021-A-0405-S");

  script_name(english:"Rocky Linux 8 : firefox (RLSA-2021:3497)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2021:3497 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2021:3497");
