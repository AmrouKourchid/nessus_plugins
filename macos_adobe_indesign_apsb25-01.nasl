...
if (description)
{
  ...
  script_name(english:"Adobe InDesign < 19.5.2 / 20.0 < 20.1.0 Multiple Vulnerabilities (APSB25-01) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe InDesign instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe InDesign installed on the remote macOS host is prior to 19.5.2, 20.1.0. It is, therefore, affected
by multiple vulnerabilities as referenced in the APSB25-01 advisory.
...
var constraints = [
  ...
  { 'min_version' : '20.0', 'max_version' : '20.0', 'fixed_version' : '20.1.0', 'fixed_display' : 'ID20.1' }
];
