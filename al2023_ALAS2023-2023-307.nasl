...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-307.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : amazon-cloudwatch-agent (ALAS2023-2023-307)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2023-307 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-307.html");
...
"Run 'dnf update amazon-cloudwatch-agent --releasever 2023.1.20230823' to update your system.");
...
var pkgs = [
    {'reference':'amazon-cloudwatch-agent-1.300026.2-1.amzn2023', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-cloudwatch-agent-1.300026.2-1.amzn2023', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
