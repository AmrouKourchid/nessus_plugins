...
# extracted from Red Hat Security Advisory RHSA-2020:5020. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5020");

  script_name(english:"RHEL 7 : tomcat (RHSA-2020:5020)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for tomcat.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:5020 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5020.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7de7f43a");
...
"Update the RHEL tomcat package based on the guidance in RHSA-2020:5020.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tomcat-7.0.76-16.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-admin-webapps-7.0.76-16.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-docs-webapp-7.0.76-16.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-el-2.2-api-7.0.76-16.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-javadoc-7.0.76-16.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-jsp-2.2-api-7.0.76-16.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-jsvc-7.0.76-16.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-lib-7.0.76-16.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-servlet-3.0-api-7.0.76-16.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-webapps-7.0.76-16.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
