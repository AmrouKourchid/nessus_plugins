...
# extracted from Fedora Security Advisory FEDORA-2022-21aa9bae12
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-21aa9bae12");

  script_name(english:"Fedora 37 : golang-github-docker-distribution (2022-21aa9bae12)");
...
FEDORA-2022-21aa9bae12 advisory.
    ...
    ```
    * Sun Aug 21 2022 Robert-Andr Mauchin <zebob.m@gmail.com> 2.8.1-2
    - Update to 2.8.1, commit bc6b7455cb168d3000c18714ee1c57d2cd03b953 - Close:
      rhbz#2043861 rhbz#2067428 rhbz#2067396 rhbz#2045498
    * Sun Aug 21 2022 Robert-Andr Mauchin <zebob.m@gmail.com> 2.8.1-1
    - Update to 2.8.1, commit bc6b7455cb168d3000c18714ee1c57d2cd03b953 - Close:
      rhbz#2043861 rhbz#2067428 rhbz#2067396 rhbz#2045498
    ...
    * Tue Jul 19 2022 Maxwell G <gotmax@e.email> - 2.7.1-10
    - Rebuild for CVE-2022-{1705,32148,30631,30633,28131,30635,30632,30630,1962} in
      golang
    * Sat Jun 18 2022 Robert-Andr Mauchin <zebob.m@gmail.com> - 2.7.1-9
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-21aa9bae12");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-github-docker-distribution package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-github-docker-distribution");
...
var pkgs = [
    {'reference':'golang-github-docker-distribution-2.8.1-2.20220821gitbc6b745.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-docker-distribution');
}
