...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : numpy (EulerOS-SA-2023-1072)");
...
affected by the following vulnerabilities :
  ...
  - Buffer overflow in the array_from_pyobj function of fortranobject.c in NumPy < 1.19, which allows
    ...
    NOTE: The vendor does not agree this is a vulnerability; the negative dimensions can only be created by an
    already privileged user (or internally) (CVE-2021-41496)

Note that Tenable Network Security has extracted the preceding description block directly from the EulerOS security
advisory. Tenable has attempted to automatically clean and format it as much as possible without introducing additional
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1072
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c98e43db");
...
var pkgs = [
  "numpy-1.7.1-13.h3.eulerosv2r7",
  "numpy-f2py-1.7.1-13.h3.eulerosv2r7"
];
