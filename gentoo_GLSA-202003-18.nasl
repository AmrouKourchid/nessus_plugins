...
# extracted from Gentoo Linux Security Advisory GLSA 202003-18.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-18");

  script_name(english:"GLSA-202003-18 : libvirt: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-18
...
Impact :
    ...
    A local privileged attacker could execute arbitrary commands, escalate
      privileges or cause a Denial of Service condition.
  
Workaround :

    There is no known workaround at this time.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-18");
...
if (qpkg_check(package:"app-emulation/libvirt", unaffected:make_list("ge 5.4.1"), vulnerable:make_list("lt 5.4.1"))) flag++;
