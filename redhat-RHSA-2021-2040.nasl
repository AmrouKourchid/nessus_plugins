...
"The remote Red Hat host is missing a security update for rh-mariadb103-mariadb / rh-mariadb103-galera.");
...
the RHSA-2021:2040 advisory.
    ...
    The following packages have been upgraded to a later upstream version: rh-mariadb103-mariadb (10.3.28),
    rh-mariadb103-galera (25.3.32).
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2040.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae5d06d7");
...
"Update the RHEL rh-mariadb103-mariadb / rh-mariadb103-galera packages based on the guidance in RHSA-2021:2040.");
