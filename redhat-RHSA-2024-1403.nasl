...
# extracted from Red Hat Security Advisory RHSA-2024:1403. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1403");

  script_name(english:"RHEL 8 : fwupd (RHSA-2024:1403)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for fwupd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:1403 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1403.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d766f293");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2129904");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1403");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL fwupd package based on the guidance in RHSA-2024:1403.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'fwupd-1.7.8-2.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fwupd-devel-1.7.8-2.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'fwupd / fwupd-devel');
}
