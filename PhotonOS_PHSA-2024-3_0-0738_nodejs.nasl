...
if (description)
{
  ...
  script_cve_id("CVE-2023-46809", "CVE-2024-22019", "CVE-2024-22025");

  script_name(english:"Photon OS 3.0: Nodejs PHSA-2024-3.0-0738");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nodejs-16.20.2-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nodejs-devel-16.20.2-2.ph3')) flag++;
