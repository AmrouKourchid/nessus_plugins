...
# extracted from Ubuntu Security Notice USN-4491-1. The text
...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : GnuTLS vulnerability (USN-4491-1)");
...
USN-4491-1 advisory.
    ...
    It was discovered that GnuTLS incorrectly handled certain alerts when being used with TLS 1.3 servers. A
    remote attacker could use this issue to cause GnuTLS to crash, resulting in a denial of service, or
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4491-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'gnutls-bin', 'pkgver': '3.6.13-2ubuntu1.3'},
    {'osver': '20.04', 'pkgname': 'guile-gnutls', 'pkgver': '3.6.13-2ubuntu1.3'},
    {'osver': '20.04', 'pkgname': 'libgnutls-dane0', 'pkgver': '3.6.13-2ubuntu1.3'},
    {'osver': '20.04', 'pkgname': 'libgnutls-openssl27', 'pkgver': '3.6.13-2ubuntu1.3'},
    {'osver': '20.04', 'pkgname': 'libgnutls28-dev', 'pkgver': '3.6.13-2ubuntu1.3'},
    {'osver': '20.04', 'pkgname': 'libgnutls30', 'pkgver': '3.6.13-2ubuntu1.3'},
    {'osver': '20.04', 'pkgname': 'libgnutlsxx28', 'pkgver': '3.6.13-2ubuntu1.3'}
];
