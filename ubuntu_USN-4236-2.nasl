...
# extracted from Ubuntu Security Notice USN-4236-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Libgcrypt vulnerability (USN-4236-2)");
...
USN-4236-2 advisory.
    ...
    USN-4236-1 fixed a vulnerability in Libgcrypt. This update provides the corresponding fix for Ubuntu 16.04
    LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4236-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libgcrypt11-dev', 'pkgver': '1.5.4-3+really1.6.5-2ubuntu0.6'},
    {'osver': '16.04', 'pkgname': 'libgcrypt20', 'pkgver': '1.6.5-2ubuntu0.6'},
    {'osver': '16.04', 'pkgname': 'libgcrypt20-dev', 'pkgver': '1.6.5-2ubuntu0.6'},
    {'osver': '16.04', 'pkgname': 'libgcrypt20-udeb', 'pkgver': '1.6.5-2ubuntu0.6'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libgcrypt11-dev / libgcrypt20 / libgcrypt20-dev / libgcrypt20-udeb');
}
