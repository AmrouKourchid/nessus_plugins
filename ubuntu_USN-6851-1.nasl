...
# extracted from Ubuntu Security Notice USN-6851-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6851-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.10 / 24.04 LTS : Netplan vulnerabilities (USN-6851-1)");
...
vulnerability as referenced in the USN-6851-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6851-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-4968");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libnetplan-dev', 'pkgver': '0.104-0ubuntu2~20.04.5'},
    {'osver': '20.04', 'pkgname': 'libnetplan0', 'pkgver': '0.104-0ubuntu2~20.04.5'},
    {'osver': '20.04', 'pkgname': 'netplan.io', 'pkgver': '0.104-0ubuntu2~20.04.5'},
    {'osver': '22.04', 'pkgname': 'libnetplan-dev', 'pkgver': '0.106.1-7ubuntu0.22.04.3'},
    {'osver': '22.04', 'pkgname': 'libnetplan0', 'pkgver': '0.106.1-7ubuntu0.22.04.3'},
    {'osver': '22.04', 'pkgname': 'netplan.io', 'pkgver': '0.106.1-7ubuntu0.22.04.3'},
    {'osver': '23.10', 'pkgname': 'libnetplan-dev', 'pkgver': '0.107-5ubuntu0.3'},
    {'osver': '23.10', 'pkgname': 'libnetplan0', 'pkgver': '0.107-5ubuntu0.3'},
    {'osver': '23.10', 'pkgname': 'netplan-generator', 'pkgver': '0.107-5ubuntu0.3'},
    {'osver': '23.10', 'pkgname': 'netplan.io', 'pkgver': '0.107-5ubuntu0.3'},
    {'osver': '23.10', 'pkgname': 'python3-netplan', 'pkgver': '0.107-5ubuntu0.3'},
    {'osver': '24.04', 'pkgname': 'libnetplan-dev', 'pkgver': '1.0-2ubuntu1.1'},
    {'osver': '24.04', 'pkgname': 'libnetplan1', 'pkgver': '1.0-2ubuntu1.1'},
    {'osver': '24.04', 'pkgname': 'netplan-generator', 'pkgver': '1.0-2ubuntu1.1'},
    {'osver': '24.04', 'pkgname': 'netplan.io', 'pkgver': '1.0-2ubuntu1.1'},
    {'osver': '24.04', 'pkgname': 'python3-netplan', 'pkgver': '1.0-2ubuntu1.1'}
];
