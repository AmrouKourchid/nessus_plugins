...
# extracted from Fedora Security Advisory FEDORA-2025-5fce1e4f70
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-5fce1e4f70");

  script_name(english:"Fedora 41 : incus (2025-5fce1e4f70)");
...
FEDORA-2025-5fce1e4f70 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-5fce1e4f70");
  script_set_attribute(attribute:"solution", value:
"Update the affected incus package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:incus");
...
var pkgs = [
    {'reference':'incus-6.12-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'incus');
}
