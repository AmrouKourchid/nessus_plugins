...
# SUSE update advisory SUSE-SU-2024:2577-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:2577-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : python-Django (SUSE-SU-2024:2577-1)");
...
referenced in the SUSE-SU-2024:2577-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2024-July/036097.html");
...
var pkgs = [
    {'reference':'python311-Django-4.2.11-150600.3.3.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']},
    {'reference':'python311-Django-4.2.11-150600.3.3.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.6']}
];
