...
# extracted from Red Hat Security Advisory RHSA-2019:2189 and 
# CentOS Errata and Security Advisory 2019:2189 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : procps-ng (CESA-2019:2189)");
...
Enterprise Linux 7.7 Release Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2019-August/006053.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?226b2296");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"procps-ng-3.3.10-26.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"procps-ng-devel-3.3.10-26.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"procps-ng-i18n-3.3.10-26.el7")) flag++;
