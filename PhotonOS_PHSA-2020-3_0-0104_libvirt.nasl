...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libvirt PHSA-2020-3.0-0104");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libvirt package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-104.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-4.7.0-6.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-devel-4.7.0-6.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-docs-4.7.0-6.ph3')) flag++;
