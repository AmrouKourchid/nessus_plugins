...
# extracted from Red Hat Security Advisory RHSA-2023:7024. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7024.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb7d8bb3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2207631");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2235795");
...
"Update the RHEL python3.11 package based on the guidance in RHSA-2023:7024.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-3.11.5-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-debug-3.11.5-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-devel-3.11.5-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-idle-3.11.5-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-libs-3.11.5-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-rpm-macros-3.11.5-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-test-3.11.5-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-tkinter-3.11.5-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
