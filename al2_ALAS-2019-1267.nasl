...
affects Firefox, Firefox, and Thunderbird. (CVE-2019-11715)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1267.html");
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"thunderbird-60.8.0-1.amzn2.0.1", allowmaj:TRUE)) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"thunderbird-debuginfo-60.8.0-1.amzn2.0.1", allowmaj:TRUE)) flag++;
