...
if (description)
{
  ...
  script_cve_id("CVE-2023-49344");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-49344");
...
patch available.
  ...
  - Temporary data passed between application components by Budgie Extras Window Shuffler applet could
    potentially be viewed or manipulated. The data is stored in a location that is accessible to any user who
    has local access to the system. Attackers may pre-create and control this file to present false
    information to users or deny access to the application and panel. (CVE-2023-49344)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-49344");
