...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 / 7 : Red Hat JBoss Enterprise Application Platform 6.4 (RHSA-2020:2169)");
...
referenced in the RHSA-2020:2169 advisory.

    Red Hat JBoss Enterprise Application Platform is a platform for Java applications based on the JBoss
    Application Server.

    This asynchronous patch is an update for JBoss Enterprise Application Platform 6.4 for Red Hat Enterprise
    Linux 5, 6, and 7. All users of Red Hat JBoss Enterprise Application Platform 6.4 are advised to upgrade
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5667c3e8");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2169.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8aa727ad");
...
"Update the RHEL Red Hat JBoss Enterprise Application Platform 6.4 package based on the guidance in RHSA-2020:2169.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jboss-as-controller-7.5.22-3.Final_redhat_4.1.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'jboss-as-server-7.5.22-3.Final_redhat_4.1.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'jboss-as-weld-7.5.22-3.Final_redhat_4.1.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jboss-as-controller-7.5.22-3.Final_redhat_4.1.ep6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'jboss-as-server-7.5.22-3.Final_redhat_4.1.ep6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'jboss-as-weld-7.5.22-3.Final_redhat_4.1.ep6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jboss-as-controller-7.5.22-3.Final_redhat_4.1.ep6.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'jboss-as-server-7.5.22-3.Final_redhat_4.1.ep6.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'jboss-as-weld-7.5.22-3.Final_redhat_4.1.ep6.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  }
];
