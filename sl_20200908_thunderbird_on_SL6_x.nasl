...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL6.x i386/x86_64 (20200908)");
...
"Security Fix(es) :
  ...
  - Mozilla: Use-After-Free when aborting an operation
    (CVE-2020-15669)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2009&L=SCIENTIFIC-LINUX-ERRATA&P=3009
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3b1580f2");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"thunderbird-68.12.0-1.el6_10", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"thunderbird-debuginfo-68.12.0-1.el6_10", allowmaj:TRUE)) flag++;
