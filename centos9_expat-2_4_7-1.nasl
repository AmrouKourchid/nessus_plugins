...
if (description)
{
  ...
  script_cve_id("CVE-2022-25236", "CVE-2022-25313", "CVE-2022-25314");

  script_name(english:"CentOS 9 : expat-2.4.7-1.el9");
...
expat-2.4.7-1.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=18235");
...
var pkgs = [
    {'reference':'expat-2.4.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.4.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-static-2.4.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
