...
system using the Configuration utility.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K00363258");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K00363258.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '13.0.0','12.1.0-12.1.2','11.6.0-11.6.3','11.2.1-11.5.5'
    ],
    'unaffected': [
      '13.1.0','13.0.0 HF1','12.1.3','12.1.2 HF1','11.6.3.2','11.5.6'
    ],
  },
  'AM': {
    'affected': [
