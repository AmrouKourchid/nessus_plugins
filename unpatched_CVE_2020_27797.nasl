...
if (description)
{
  ...
  script_cve_id("CVE-2020-27797");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-27797");
...
patch available.
  ...
  - An invalid memory address reference was discovered in the elf_lookup function in p_lx_elf.cpp in UPX 4.0.0
    via a crafted Mach-O file. (CVE-2020-27797)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-27797");
