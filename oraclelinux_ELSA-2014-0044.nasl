...
# Oracle Linux Security Advisory ELSA-2014-0044 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : augeas (ELSA-2014-0044)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-0044.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected augeas, augeas-devel and / or augeas-libs packages.");
...
var pkgs = [
    {'reference':'augeas-1.0.0-5.el6_5.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'augeas-devel-1.0.0-5.el6_5.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'augeas-libs-1.0.0-5.el6_5.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'augeas-1.0.0-5.el6_5.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'augeas-devel-1.0.0-5.el6_5.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'augeas-libs-1.0.0-5.el6_5.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
