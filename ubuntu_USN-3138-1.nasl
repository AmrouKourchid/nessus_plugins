...
# extracted from Ubuntu Security Notice USN-3138-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : python-cryptography vulnerability (USN-3138-1)");
...
USN-3138-1 advisory.
    ...
    Markus Dring discovered that python-cryptography incorrectly handled certain HKDF lengths. This could
    result in python-cryptography returning an empty string instead of the expected derived key.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3138-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-cryptography', 'pkgver': '1.2.3-1ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'python3-cryptography', 'pkgver': '1.2.3-1ubuntu0.1'}
];
