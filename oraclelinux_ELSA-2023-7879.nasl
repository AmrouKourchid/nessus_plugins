...
# extracted from Oracle Linux Security Advisory ELSA-2023-7879.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : opensc (ELSA-2023-7879)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-7879.html");
...
var pkgs = [
    {'reference':'opensc-0.23.0-3.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'opensc-0.23.0-3.el9_3', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'opensc-0.23.0-3.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
