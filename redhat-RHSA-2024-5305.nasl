...
# extracted from Red Hat Security Advisory RHSA-2024:5305. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5305");

  script_name(english:"RHEL 8 : poppler (RHSA-2024:5305)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for poppler.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:5305 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5305.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a4b86b1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5305");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL poppler package based on the guidance in RHSA-2024:5305.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'poppler-20.11.0-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-cpp-20.11.0-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-cpp-devel-20.11.0-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-devel-20.11.0-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-glib-20.11.0-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-glib-devel-20.11.0-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-glib-doc-20.11.0-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-qt5-20.11.0-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-qt5-devel-20.11.0-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'poppler-utils-20.11.0-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
