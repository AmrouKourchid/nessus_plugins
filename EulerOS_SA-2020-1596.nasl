...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : dom4j (EulerOS-SA-2020-1596)");
...
vulnerability :
  ...
  - dom4j before 2.1.3 allows external DTDs and External
    Entities by default, which might enable XXE attacks.
    However, there is popular external documentation from
    OWASP showing how to enable the safe, non-default
    behavior in any application that uses
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1596
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0ba187d0");
...
pkgs = ["dom4j-1.6.1-20.h2.eulerosv2r7"];
