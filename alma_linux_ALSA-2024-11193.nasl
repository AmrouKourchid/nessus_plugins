...
# AlmaLinux Security Advisory ALSA-2024:11193.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:11193");
  script_xref(name:"RHSA", value:"2024:11193");

  script_name(english:"AlmaLinux 8 : mpg123 (ALSA-2024:11193)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2024:11193 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-11193.html");
...
var pkgs = [
    {'reference':'mpg123-1.32.9-1.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'mpg123-devel-1.32.9-1.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'mpg123-libs-1.32.9-1.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'mpg123-plugins-pulseaudio-1.32.9-1.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
