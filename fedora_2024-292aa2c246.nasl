...
# extracted from Fedora Security Advisory FEDORA-2024-292aa2c246
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-292aa2c246");

  script_name(english:"Fedora 40 : chromium (2024-292aa2c246)");
...
FEDORA-2024-292aa2c246 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-292aa2c246");
...
var pkgs = [
    {'reference':'chromium-131.0.6778.85-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
