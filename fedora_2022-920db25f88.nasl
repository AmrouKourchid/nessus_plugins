...
# extracted from Fedora Security Advisory FEDORA-2022-920db25f88
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-920db25f88");

  script_name(english:"Fedora 37 : qemu (2022-920db25f88)");
...
FEDORA-2022-920db25f88 advisory.

    Automatic update for qemu-6.2.0-5.fc37.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-920db25f88");
...
var pkgs = [
    {'reference':'qemu-6.2.0-5.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
