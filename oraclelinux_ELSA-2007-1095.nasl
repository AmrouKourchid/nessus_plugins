...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / htdig (ELSA-2007-1095)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-1095.html");
...
var pkgs = [
    {'reference':'htdig-3.2.0b6-9.0.1.el5_1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
    {'reference':'htdig-web-3.2.0b6-9.0.1.el5_1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
    {'reference':'htdig-3.2.0b6-9.0.1.el5_1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
    {'reference':'htdig-web-3.2.0b6-9.0.1.el5_1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
