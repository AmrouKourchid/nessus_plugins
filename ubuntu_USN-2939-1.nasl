...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : LibTIFF vulnerabilities (USN-2939-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2939-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2939-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8784");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libtiff-opengl', 'pkgver': '4.0.3-7ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'libtiff-tools', 'pkgver': '4.0.3-7ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'libtiff4-dev', 'pkgver': '4.0.3-7ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'libtiff5', 'pkgver': '4.0.3-7ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'libtiff5-alt-dev', 'pkgver': '4.0.3-7ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'libtiff5-dev', 'pkgver': '4.0.3-7ubuntu0.4'},
    {'osver': '14.04', 'pkgname': 'libtiffxx5', 'pkgver': '4.0.3-7ubuntu0.4'}
];
