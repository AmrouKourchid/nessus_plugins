...
# extracted from Fedora Security Advisory FEDORA-2019-243442e600.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-243442e600");

  script_name(english:"Fedora 29 : python3 (2019-243442e600)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-243442e600");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"python3-3.7.2-5.fc29")) flag++;
