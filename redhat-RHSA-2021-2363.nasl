...
# extracted from Red Hat Security Advisory RHSA-2021:2363. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2363");

  script_name(english:"RHEL 8 : gupnp (RHSA-2021:2363)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gupnp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:2363 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2363.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?76cc682a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2363");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1964091");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gupnp package based on the guidance in RHSA-2021:2363.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gupnp-1.0.6-2.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gupnp-devel-1.0.6-2.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'gupnp-1.0.6-2.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gupnp-devel-1.0.6-2.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
