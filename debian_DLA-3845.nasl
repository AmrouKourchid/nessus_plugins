...
# extracted from Debian Security Advisory dla-3845. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3845 : dlt-daemon - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-39836");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-39837");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-26257");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-36321");
...
"Upgrade the dlt-daemon packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-36321");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'dlt-daemon', 'reference': '2.18.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'dlt-tools', 'reference': '2.18.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'libdlt-dev', 'reference': '2.18.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'libdlt-examples', 'reference': '2.18.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'libdlt2', 'reference': '2.18.0-1+deb10u2'}
];
