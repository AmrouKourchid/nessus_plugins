...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : postgresql-jdbc (EulerOS-SA-2021-1165)");
...
following vulnerability :
  ...
  - A flaw was found in PostgreSQL JDBC in versions prior
    to 42.2.13. An XML External Entity (XXE) weakness was
    found in PostgreSQL JDBC. The highest threat from this
    vulnerability is to data confidentiality and system
    availability.(CVE-2020-13692)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1165
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c076d2a");
...
pkgs = ["postgresql-jdbc-42.2.4-1.h3.eulerosv2r8"];
