...
if (description)
{
  ...
  script_name(english:"Atlassian JIRA SEoL (3.13.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Atlassian JIRA is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Atlassian JIRA is 3.13.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of Atlassian JIRA that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2011/07/21");
...
var constraints = [
  { max_branch : '3.13', min_branch : '3.13', seol : 20110721 }
];
