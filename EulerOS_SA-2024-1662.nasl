...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : procps-ng (EulerOS-SA-2024-1662)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1662
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72ccfc63");
...
var pkgs = [
  "procps-ng-3.3.10-17.2.h16.eulerosv2r7"
];
