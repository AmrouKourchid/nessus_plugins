...
# extracted from Fedora Security Advisory FEDORA-2025-96c31e2086
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-96c31e2086");
  script_xref(name:"IAVA", value:"2025-A-0211-S");

  script_name(english:"Fedora 41 : firefox (2025-96c31e2086)");
...
FEDORA-2025-96c31e2086 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-96c31e2086");
...
var pkgs = [
    {'reference':'firefox-137.0-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
