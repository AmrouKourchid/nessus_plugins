...
# extracted from Red Hat Security Advisory RHSA-2022:7541. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7541");

  script_name(english:"RHEL 8 : redis:6 (RHSA-2022:7541)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:7541 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7541.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e567198e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7541");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1999873");
  ...
  'redis:6': [
    {
      ...
      'pkgs': [
        {'reference':'redis-6.2.7-1.module+el8.7.0+15197+cc495aeb', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-6.2.7-1.module+el8.7.0+15197+cc495aeb', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-doc-6.2.7-1.module+el8.7.0+15197+cc495aeb', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
