...
# extracted from Red Hat Security Advisory RHSA-2025:2220. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:2220");

  script_name(english:"RHEL 8 : Red Hat Product OCP Tools 4.15 Openshift Jenkins (RHSA-2025:2220)");
...
referenced in the RHSA-2025:2220 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_2220.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fdfe4122");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:2220");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Product OCP Tools 4.15 Openshift Jenkins package based on the guidance in RHSA-2025:2220.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.15.1740052174-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jenkins-2.479.3.1740051993-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
