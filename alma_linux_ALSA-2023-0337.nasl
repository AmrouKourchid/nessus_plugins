...
# AlmaLinux Security Advisory ALSA-2023:0337.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:0337");

  script_name(english:"AlmaLinux 9 : expat (ALSA-2023:0337)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-0337.html");
