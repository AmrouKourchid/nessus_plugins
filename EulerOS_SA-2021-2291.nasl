...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : dhcp (EulerOS-SA-2021-2291)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2291
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?96402a9d");
...
pkgs = ["dhcp-client-4.3.6-28.h17.eulerosv2r8",
