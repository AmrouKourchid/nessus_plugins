...
# extracted from Gentoo Linux Security Advisory GLSA 201903-20.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201903-20");

  script_name(english:"GLSA-201903-20 : cabextract, libmspack: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201903-20
...
Impact :
    ...
    Please review the referenced CVE&rsquo;s for details.
  
Workaround :

    There is no known workaround at this time.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201903-20");
...
"All cabextract users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libmspack");
...
if (qpkg_check(package:"app-arch/cabextract", unaffected:make_list("ge 1.8"), vulnerable:make_list("lt 1.8"))) flag++;
if (qpkg_check(package:"dev-libs/libmspack", unaffected:make_list("ge 0.8_alpha"), vulnerable:make_list("lt 0.8_alpha"))) flag++;
