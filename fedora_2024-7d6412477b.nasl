...
# extracted from Fedora Security Advisory FEDORA-2024-7d6412477b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7d6412477b");

  script_name(english:"Fedora 41 : php-tcpdf (2024-7d6412477b)");
...
FEDORA-2024-7d6412477b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7d6412477b");
...
var pkgs = [
    {'reference':'php-tcpdf-6.8.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
