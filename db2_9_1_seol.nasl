...
if (description)
{
  ...
  script_name(english:"IBM DB2 SEoL (9.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of IBM DB2 is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, IBM DB2 is 9.1.x. It is, therefore, no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # http://www.ibm.com/common/ssi/ShowDoc.jsp?docURL=/common/ssi/rep_ca/6/897/ENUS910-286/index.html&breadCrum=DET001PT022&url=buttonpressed=DET002PT005&specific_index=DET001PEF502&DET015PGL002=DET001PEF011&submit.x=7&submit.y=8&lang=en_US
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd1fc95e");
...
var constraints = [
  { max_branch : '9.1', min_branch : '9.1', seol : 20150430 }
];
