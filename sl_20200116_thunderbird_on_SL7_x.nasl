...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL7.x x86_64 (20200116)");
...
"Security Fix(es) :
  ...
  - Mozilla: CSS sanitization does not escape HTML tags
    (CVE-2019-17022)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2001&L=SCIENTIFIC-LINUX-ERRATA&P=3747
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e570eac8");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"thunderbird-68.4.1-2.el7_7", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"thunderbird-debuginfo-68.4.1-2.el7_7", allowmaj:TRUE)) flag++;
