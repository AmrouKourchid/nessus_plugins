...
# extracted from openSUSE Security Update openSUSE-2018-590.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : kernel-firmware (openSUSE-2018-590) (Spectre)");
...
if ( rpm_check(release:"SUSE42.3", reference:"kernel-firmware-20170530-20.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ucode-amd-20170530-20.1") ) flag++;
