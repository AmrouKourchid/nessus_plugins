...
if (description)
{
  ...
  script_cve_id("CVE-2025-21635");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21635");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: rds: sysctl: rds_tcp_{rcv,snd}buf:
    ...
    using acct(2). The per-netns structure can be obtained from the table->data using container_of(), then the
    'net' one can be retrieved from the listen socket (if available). (CVE-2025-21635)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21635");
