...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5003220");
  script_xref(name:"MSFT", value:"MS21-5003209");
  script_xref(name:"MSFT", value:"MS21-5003220");

  script_name(english:"KB5003209: Windows 8.1 and Windows Server 2012 R2 Security Update (May 2021)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5003209.
It is, therefore, affected by multiple vulnerabilities");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/");
  script_set_attribute(attribute:"solution", value:
"Apply Cumulative Update 5003209.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-26144");
...
if (
  smb_check_rollup(os:'6.3', 
                   ...
                   rollup_date:'05_2021',
                   bulletin:bulletin,
                   rollup_kb_list:[5003209, 5003220])
)
{
