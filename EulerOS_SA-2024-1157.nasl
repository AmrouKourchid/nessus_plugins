...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : openssl111d (EulerOS-SA-2024-1157)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1157
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32d778db");
...
var pkgs = [
  "openssl111d-1.1.1d-2.h20.eulerosv2r7",
  "openssl111d-devel-1.1.1d-2.h20.eulerosv2r7",
  "openssl111d-libs-1.1.1d-2.h20.eulerosv2r7",
  "openssl111d-static-1.1.1d-2.h20.eulerosv2r7"
];
