...
# extracted from Red Hat Security Advisory RHSA-2019:0968. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0968");

  script_name(english:"RHEL 8 : edk2 (RHSA-2019:0968)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for edk2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:0968 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0968.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7dcfaf6b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0968");
...
"Update the RHEL edk2 package based on the guidance in RHSA-2019:0968.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'edk2-aarch64-20180508gitee3198e672e2-9.el8_0.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'edk2-ovmf-20180508gitee3198e672e2-9.el8_0.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
