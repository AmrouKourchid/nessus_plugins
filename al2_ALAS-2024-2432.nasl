...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2432.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : ImageMagick (ALAS-2024-2432)");
...
vulnerabilities as referenced in the ALAS2-2024-2432 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2432.html");
