...
# extracted from Red Hat Security Advisory RHSA-2022:1950. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1950.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7e54d7b2");
...
"Update the RHEL dovecot package based on the guidance in RHSA-2022:1950.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dovecot-2.3.16-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-devel-2.3.16-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-mysql-2.3.16-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-pgsql-2.3.16-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-pigeonhole-2.3.16-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
