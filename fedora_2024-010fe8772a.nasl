...
# extracted from Fedora Security Advisory FEDORA-2024-010fe8772a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-010fe8772a");

  script_name(english:"Fedora 40 : kernel (2024-010fe8772a)");
...
FEDORA-2024-010fe8772a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-010fe8772a");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2024-010fe8772a');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.8.8-300.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
