...
# extracted from Fedora Security Advisory FEDORA-2019-d5ded5326b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-d5ded5326b");

  script_name(english:"Fedora 30 : 1:dbus (2019-d5ded5326b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d5ded5326b");
...
"Update the affected 1:dbus package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:1:dbus");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"dbus-1.12.16-1.fc30", epoch:"1")) flag++;
