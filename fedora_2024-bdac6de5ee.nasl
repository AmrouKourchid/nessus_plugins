...
# extracted from Fedora Security Advisory FEDORA-2024-bdac6de5ee
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bdac6de5ee");

  script_name(english:"Fedora 39 : nextcloud (2024-bdac6de5ee)");
...
FEDORA-2024-bdac6de5ee advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bdac6de5ee");
...
var pkgs = [
    {'reference':'nextcloud-29.0.6-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
