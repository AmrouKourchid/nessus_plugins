...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1123.html");
...
"Update the affected gstreamer-plugins-good and / or gstreamer-plugins-good-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-1932");
...
var pkgs = [
    {'reference':'gstreamer-plugins-good-0.10.9-1.el5_3.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gstreamer-plugins-good-devel-0.10.9-1.el5_3.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gstreamer-plugins-good-0.10.9-1.el5_3.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gstreamer-plugins-good-devel-0.10.9-1.el5_3.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
