...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Unzip PHSA-2019-2.0-0171");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'unzip-6.0-14.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'unzip-debuginfo-6.0-14.ph2')) flag++;
