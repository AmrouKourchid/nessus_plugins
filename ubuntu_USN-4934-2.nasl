...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : Exim vulnerabilities (USN-4934-2)");
...
the USN-4934-2 advisory.
    ...
    USN-4934-1 fixed several vulnerabilities in Exim. This update provides the corresponding update for Ubuntu
    14.04 ESM and Ubuntu 16.04 ESM. CVE-2020-28026 only affected Ubuntu 16.04 ESM.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'exim4', 'pkgver': '4.86.2-2ubuntu2.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'exim4-base', 'pkgver': '4.86.2-2ubuntu2.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'exim4-config', 'pkgver': '4.86.2-2ubuntu2.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'exim4-daemon-heavy', 'pkgver': '4.86.2-2ubuntu2.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'exim4-daemon-light', 'pkgver': '4.86.2-2ubuntu2.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'exim4-dev', 'pkgver': '4.86.2-2ubuntu2.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'eximon4', 'pkgver': '4.86.2-2ubuntu2.6+esm1', 'ubuntu_pro': TRUE}
];
