...
# extracted from Fedora Security Advisory FEDORA-2024-40ff0d8644
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-40ff0d8644");

  script_name(english:"Fedora 39 : python-webob (2024-40ff0d8644)");
...
FEDORA-2024-40ff0d8644 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-40ff0d8644");
...
var pkgs = [
    {'reference':'python-webob-1.8.8-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
