...
# extracted from Red Hat Security Advisory RHSA-2022:9098. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:9098");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.10.46 (RHSA-2022:9098)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.10.46.");
...
the RHSA-2022:9098 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.10.46. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f183c736");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:9098");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.10.46 packages based on the guidance in RHSA-2022:9098.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.10.1670851835-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
