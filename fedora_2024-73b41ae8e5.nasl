...
# extracted from Fedora Security Advisory FEDORA-2024-73b41ae8e5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-73b41ae8e5");

  script_name(english:"Fedora 41 : dnsdist (2024-73b41ae8e5)");
...
FEDORA-2024-73b41ae8e5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-73b41ae8e5");
...
var pkgs = [
    {'reference':'dnsdist-1.9.7-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
