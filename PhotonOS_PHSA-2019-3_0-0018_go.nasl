...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Go PHSA-2019-3.0-0018");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-1.9.7-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-debuginfo-1.9.7-2.ph3')) flag++;
