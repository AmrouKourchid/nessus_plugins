...
if (description)
{
  ...
  script_cve_id("CVE-2023-26242");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-26242");
...
patch available.
  ...
  - afu_mmio_region_get_by_offset in drivers/fpga/dfl-afu-region.c in the Linux kernel through 6.1.12 has an
    integer overflow. (CVE-2023-26242)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-26242");
