...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.5.0 : expat (EulerOS-SA-2020-1075)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1075
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9998ad79");
...
pkgs = ["expat-2.2.6-1.h2.eulerosv2r8",
        "expat-devel-2.2.6-1.h2.eulerosv2r8"];
