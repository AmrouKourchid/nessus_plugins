...
# extracted from Fedora Security Advisory FEDORA-2023-2cb0f34efe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2cb0f34efe");

  script_name(english:"Fedora 37 : frr (2023-2cb0f34efe)");
...
FEDORA-2023-2cb0f34efe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2cb0f34efe");
...
var pkgs = [
    {'reference':'frr-8.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
