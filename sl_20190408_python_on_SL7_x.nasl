...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : python on SL7.x x86_64 (20190408)");
...
"Security Fix(es) :
  ...
  - python: Information Disclosure due to urlsplit improper
    NFKC normalization (CVE-2019-9636)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1904&L=SCIENTIFIC-LINUX-ERRATA&P=430
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0ec6c49");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-2.7.5-77.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-debug-2.7.5-77.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-debuginfo-2.7.5-77.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-devel-2.7.5-77.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-libs-2.7.5-77.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-test-2.7.5-77.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"python-tools-2.7.5-77.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"tkinter-2.7.5-77.el7_6")) flag++;
