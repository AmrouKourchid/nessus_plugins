...
# extracted from Amazon Linux 2 Security Advisory ALASPYTHON3.8-2024-012.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python38-setuptools (ALASPYTHON3.8-2024-012)");
...
vulnerability as referenced in the ALAS2PYTHON3.8-2024-012 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASPYTHON3.8-2024-012.html");
...
var pkgs = [
    {'reference':'python38-setuptools-38.4.0-4.amzn2.0.3', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'python3.8'}
];
