...
if (description)
{
  ...
  script_name(english:"PHP 5.6.x < 5.6.21 Multiple Vulnerabilities");
...
server is 5.6.x prior to 5.6.21. It is, therefore, affected by
multiple vulnerabilities :
...
"Upgrade to PHP version 5.6.21 or later.");
...
if (version =~ "^5\.6\." && ver_compare(ver:version, fix:"5.6.21", strict:FALSE) < 0){
  security_report_v4(
  port  : port,
  extra :
