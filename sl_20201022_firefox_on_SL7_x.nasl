...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL7.x x86_64 (20201022)");
...
"Security Fix(es) :
  ...
  - Mozilla: Memory safety bugs fixed in Firefox 82 and
    Firefox ESR 78.4 (CVE-2020-15683)

  - chromium-browser: Use after free in WebRTC
    (CVE-2020-15969)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=26820
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3fa6fd68");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-78.4.0-1.el7_9", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-debuginfo-78.4.0-1.el7_9", allowmaj:TRUE)) flag++;
