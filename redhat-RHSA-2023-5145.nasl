...
# extracted from Red Hat Security Advisory RHSA-2023:5145. The text
...
the RHSA-2023:5145 advisory.
    ...
    .NET SDK 7.0.111 and .NET Runtime 7.0.11.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5145.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a48f2a5");
...
"Update the RHEL .NET 7.0 package based on the guidance in RHSA-2023:5145.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aspnetcore-runtime-7.0-7.0.11-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-7.0-7.0.11-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-7.0.111-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-apphost-pack-7.0-7.0.11-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-host-7.0.11-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-hostfxr-7.0-7.0.11-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-7.0-7.0.11-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-7.0-7.0.111-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-7.0-source-built-artifacts-7.0.111-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-targeting-pack-7.0-7.0.11-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-templates-7.0-7.0.111-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'netstandard-targeting-pack-2.1-7.0.111-1.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'aspnetcore-runtime-7.0-7.0.11-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-7.0-7.0.11-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-7.0.111-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-apphost-pack-7.0-7.0.11-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-host-7.0.11-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-hostfxr-7.0-7.0.11-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-7.0-7.0.11-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-7.0-7.0.111-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-7.0-source-built-artifacts-7.0.111-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-targeting-pack-7.0-7.0.11-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-templates-7.0-7.0.111-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'netstandard-targeting-pack-2.1-7.0.111-1.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
