...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : java-1.7.0-openjdk (EulerOS-SA-2018-1193)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1193
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?17fa0c71");
...
pkgs = ["java-1.7.0-openjdk-1.7.0.181-2.6.14.8",
        "java-1.7.0-openjdk-devel-1.7.0.181-2.6.14.8",
        "java-1.7.0-openjdk-headless-1.7.0.181-2.6.14.8"];
