...
# extracted from Red Hat Security Advisory RHSA-2024:7811. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7811");
  script_xref(name:"IAVA", value:"2024-A-0629-S");

  script_name(english:"RHEL 7 / 8 / 9 : Red Hat JBoss Enterprise Application Platform 7.4 Security update (Critical) (RHSA-2024:7811)");
...
referenced in the RHSA-2024:7811 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7811.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91a129fe");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7811");
  script_set_attribute(attribute:"solution", value:
"Update the affected eap7-avro package.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-avro-1.11.4-1.redhat_00001.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'eap7-avro-1.11.4-1.redhat_00001.1.el9eap', 'release':'9', 'el_string':'el9eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'eap7-avro-1.11.4-1.redhat_00001.1.el7eap', 'release':'7', 'el_string':'el7eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'eap7-avro');
}
