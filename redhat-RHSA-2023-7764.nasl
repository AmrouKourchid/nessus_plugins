...
# extracted from Red Hat Security Advisory RHSA-2023:7764. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7764");

  script_name(english:"RHEL 9 : buildah (RHSA-2023:7764)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for buildah.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:7764 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7764.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25da0b3b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7764");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL buildah package based on the guidance in RHSA-2023:7764.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.31.3-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'buildah-tests-1.31.3-2.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
