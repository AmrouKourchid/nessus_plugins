...
# extracted from Gentoo Linux Security Advisory GLSA 201803-07.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-10807", "CVE-2017-18225", "CVE-2017-18226");
  script_xref(name:"GLSA", value:"201803-07");

  script_name(english:"GLSA-201803-07 : JabberD 2.x: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201803-07
(JabberD 2.x: Multiple vulnerabilities)

    Multiple vulnerabilities have been discovered in Gentoo&rsquo;s JabberD 2.x
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201803-07");
...
"Gentoo has discontinued support for JabberD 2.x and recommends that
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-10807");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:jabberd2");
...
if (qpkg_check(package:"net-im/jabberd2", unaffected:make_list(), vulnerable:make_list("le 2.6.1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "JabberD 2.x");
}
