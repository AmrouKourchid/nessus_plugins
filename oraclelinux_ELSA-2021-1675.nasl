...
# extracted from Oracle Linux Security Advisory ELSA-2021-1675.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libdb (ELSA-2021-1675)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2021-1675 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-1675.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:libdb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:libdb-cxx");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:libdb-cxx-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:libdb-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:libdb-devel-doc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:libdb-sql");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:libdb-sql-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:libdb-utils");
...
var pkgs = [
    ...
    {'reference':'libdb-devel-doc-5.3.28-40.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'libdb-devel-doc-5.3.28-40.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'libdb-utils-5.3.28-40.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'libdb-devel-doc-5.3.28-40.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
