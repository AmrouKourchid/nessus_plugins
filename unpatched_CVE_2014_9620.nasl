...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-9620");
...
patch available.
  ...
  - The ELF parser in file 5.08 through 5.21 allows remote attackers to cause a denial of service via a large
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9620");
