...
if (description)
{
  ...
  script_cve_id("CVE-2024-43905");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-43905");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/pm: Fix the null pointer
    dereference for vega10_hwmgr Check return value and conduct null pointer handling to avoid null pointer
    dereference. (CVE-2024-43905)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-43905");
