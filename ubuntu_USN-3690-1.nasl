...
# extracted from Ubuntu Security Notice USN-3690-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS : AMD Microcode update (USN-3690-1)");
...
referenced in the USN-3690-1 advisory.
    ...
    This update provides the microcode updates for AMD 17H family processors required for the corresponding
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3690-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'amd64-microcode', 'pkgver': '3.20180524.1~ubuntu0.14.04.1'},
    {'osver': '16.04', 'pkgname': 'amd64-microcode', 'pkgver': '3.20180524.1~ubuntu0.16.04.1'},
    {'osver': '18.04', 'pkgname': 'amd64-microcode', 'pkgver': '3.20180524.1~ubuntu0.18.04.1'}
];
