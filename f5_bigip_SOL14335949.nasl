...
# extracted from F5 Networks BIG-IP Solution K14335949.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Intel processors vulnerability (K14335949)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K14335949 advisory.

    Observable behavioral in power management throttling for some Intel(R) Processors may allow an
    authenticated user to potentially enable information disclosure via network access.(CVE-2022-24436 also
    known as hertzbleed)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K14335949");
...
Refer to the vendor for remediation guidance.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-24436");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.0.0-17.5.0','16.1.0-16.1.6','15.1.0-15.1.10','14.1.0-14.1.5','13.1.0-13.1.5'
    ],
  },
  'APM': {
    'affected': [
