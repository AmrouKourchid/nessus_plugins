...
# extracted from Ubuntu Security Notice USN-3199-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3199-1");

  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Python Crypto vulnerability (USN-3199-1)");
...
in the USN-3199-1 advisory.

    It was discovered that the ALGnew function in block_templace.c in the Python Cryptography Toolkit
    contained a heap-based buffer overflow vulnerability. A remote attacker could use this flaw to execute
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3199-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-crypto', 'pkgver': '2.6.1-4ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'python3-crypto', 'pkgver': '2.6.1-4ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'python-crypto', 'pkgver': '2.6.1-6ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'python3-crypto', 'pkgver': '2.6.1-6ubuntu0.16.04.1'}
];
