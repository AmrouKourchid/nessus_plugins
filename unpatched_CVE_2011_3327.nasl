...
if (description)
{
  ...
  script_cve_id("CVE-2011-3327");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2011-3327");
...
patch available.
  ...
  - Heap-based buffer overflow in the ecommunity_ecom2str function in bgp_ecommunity.c in bgpd in Quagga
    ...
    arbitrary code by sending a crafted BGP UPDATE message over IPv4. (CVE-2011-3327)
