...
# extracted from Fedora Security Advisory FEDORA-2022-9f51d13fa3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-9f51d13fa3");

  script_name(english:"Fedora 37 : xen (2022-9f51d13fa3)");
...
FEDORA-2022-9f51d13fa3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-9f51d13fa3");
...
var pkgs = [
    {'reference':'xen-4.16.2-4.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
