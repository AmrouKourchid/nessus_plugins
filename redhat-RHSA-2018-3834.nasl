...
referenced in the RHSA-2018:3834 advisory.
  ...
  - ghostscript: Incorrect restoration of privilege checking when running out of stack during exception
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3834.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f6a1b79f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3834");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1625832");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1625846");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1627959");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1632471");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1642578");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1642584");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1642940");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1652583");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1655599");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1657822");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ghostscript package based on the guidance in RHSA-2018:3834.");
  ...
  script_cwe_id(20, 391, 416, 456, 460);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ghostscript-9.07-31.el7_6.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-cups-9.07-31.el7_6.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-devel-9.07-31.el7_6.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-doc-9.07-31.el7_6.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-gtk-9.07-31.el7_6.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
