...
# extracted from Oracle Linux Security Advisory ELSA-2020-0512.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : firefox (ELSA-2020-0512)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0512.html");
...
var pkgs = [
    {'reference':'firefox-68.5.0-2.0.1.el8_1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-68.5.0-2.0.1.el8_1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
