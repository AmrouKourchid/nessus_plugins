...
# extracted from openSUSE Security Update openSUSE-2018-804.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libsndfile (openSUSE-2018-804)");
...
This update was imported from the SUSE:SLE-12:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1071767");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1071777");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1100167");
...
if ( rpm_check(release:"SUSE42.3", reference:"libsndfile-debugsource-1.0.25-34.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libsndfile-devel-1.0.25-34.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libsndfile-progs-1.0.25-34.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libsndfile-progs-debuginfo-1.0.25-34.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libsndfile-progs-debugsource-1.0.25-34.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libsndfile1-1.0.25-34.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libsndfile1-debuginfo-1.0.25-34.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libsndfile1-32bit-1.0.25-34.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libsndfile1-debuginfo-32bit-1.0.25-34.1") ) flag++;
