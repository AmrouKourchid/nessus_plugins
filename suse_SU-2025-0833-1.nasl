...
# SUSE update advisory SUSE-SU-2025:0833-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0833-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (SUSE-SU-2025:0833-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2025:0833-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-March/020499.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ccf03351");
...
"Update the affected kernel-default-livepatch, kernel-default-livepatch-devel and / or kernel-
livepatch-5_14_21-150500_55_97-default packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-5_14_21-150500_55_97-default");
...
var pkgs = [
    {'reference':'kernel-default-livepatch-5.14.21-150500.55.97.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.5']},
    {'reference':'kernel-default-livepatch-devel-5.14.21-150500.55.97.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.5']},
    {'reference':'kernel-livepatch-5_14_21-150500_55_97-default-1-150500.11.3.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-default-livepatch / kernel-default-livepatch-devel / etc');
}
