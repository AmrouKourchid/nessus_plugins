...
# extracted from Fedora Security Advisory FEDORA-2023-b845c60d1c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b845c60d1c");

  script_name(english:"Fedora 37 : java-latest-openjdk (2023-b845c60d1c)");
...
FEDORA-2023-b845c60d1c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b845c60d1c");
...
var pkgs = [
    {'reference':'java-latest-openjdk-21.0.1.0.12-1.rolling.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
