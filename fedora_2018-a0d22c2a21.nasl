...
# extracted from Fedora Security Advisory FEDORA-2018-a0d22c2a21.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-a0d22c2a21");

  script_name(english:"Fedora 29 : strongswan (2018-a0d22c2a21)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a0d22c2a21");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"strongswan-5.7.1-1.fc29")) flag++;
