...
# SUSE update advisory SUSE-SU-2024:0972-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0972-1");

  script_name(english:"openSUSE 15 Security Update : jbcrypt, trilead-ssh2 (SUSE-SU-2024:0972-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?43fe9406");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-48795");
  script_set_attribute(attribute:"solution", value:
"Update the affected trilead-ssh2 and / or trilead-ssh2-javadoc packages.");
...
var pkgs = [
    {'reference':'trilead-ssh2-217.293.v56de4d4d3515-150200.3.7.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'trilead-ssh2-javadoc-217.293.v56de4d4d3515-150200.3.7.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'trilead-ssh2 / trilead-ssh2-javadoc');
}
