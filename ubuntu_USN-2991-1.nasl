...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : nginx vulnerability (USN-2991-1)");
...
in the USN-2991-1 advisory.

    It was discovered that nginx incorrectly handled saving client request bodies to temporary files. A remote
    attacker could possibly use this issue to cause nginx to crash, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2991-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'nginx', 'pkgver': '1.4.6-1ubuntu3.5'},
    {'osver': '14.04', 'pkgname': 'nginx-common', 'pkgver': '1.4.6-1ubuntu3.5'},
    {'osver': '14.04', 'pkgname': 'nginx-core', 'pkgver': '1.4.6-1ubuntu3.5'},
    {'osver': '14.04', 'pkgname': 'nginx-extras', 'pkgver': '1.4.6-1ubuntu3.5'},
    {'osver': '14.04', 'pkgname': 'nginx-full', 'pkgver': '1.4.6-1ubuntu3.5'},
    {'osver': '14.04', 'pkgname': 'nginx-light', 'pkgver': '1.4.6-1ubuntu3.5'},
    {'osver': '14.04', 'pkgname': 'nginx-naxsi', 'pkgver': '1.4.6-1ubuntu3.5'},
    {'osver': '14.04', 'pkgname': 'nginx-naxsi-ui', 'pkgver': '1.4.6-1ubuntu3.5'},
    {'osver': '16.04', 'pkgname': 'nginx', 'pkgver': '1.10.0-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'nginx-common', 'pkgver': '1.10.0-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'nginx-core', 'pkgver': '1.10.0-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'nginx-extras', 'pkgver': '1.10.0-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'nginx-full', 'pkgver': '1.10.0-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'nginx-light', 'pkgver': '1.10.0-0ubuntu0.16.04.2'}
];
