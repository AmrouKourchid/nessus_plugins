...
# extracted from Ubuntu Security Notice USN-6972-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6972-3");

  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS : Linux kernel (Azure) vulnerabilities (USN-6972-3)");
...
vulnerabilities as referenced in the USN-6972-3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6972-3");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1180-azure");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6972-3');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6972-3');
  }
  else
  {
