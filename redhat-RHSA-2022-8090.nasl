...
# extracted from Red Hat Security Advisory RHSA-2022:8090. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8090");

  script_name(english:"RHEL 9 : runc (RHSA-2022:8090)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8090.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b94c707");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8090");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2086398");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL runc package based on the guidance in RHSA-2022:8090.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'runc-1.1.4-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  }
];
