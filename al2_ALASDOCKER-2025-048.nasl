...
# extracted from Amazon Linux 2 Security Advisory ALASDOCKER-2025-048.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-45338", "CVE-2024-51744");

  script_name(english:"Amazon Linux 2 : runfinch-finch (ALASDOCKER-2025-048)");
...
vulnerabilities as referenced in the ALAS2DOCKER-2025-048 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASDOCKER-2025-048.html");
