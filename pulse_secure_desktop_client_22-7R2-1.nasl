...
if (description)
{
  ...
  script_cve_id("CVE-2024-37401");
  script_xref(name:"IAVA", value:"2024-A-0800-S");

  script_name(english:"Pulse Connect Secure < 22.7R2.1 Denial of Service");

  script_set_attribute(attribute:"synopsis", value:
"Pulse Connect Secure installed on the remote host is affected by DoS vulnerability");
  script_set_attribute(attribute:"description", value:
"The Pulse Connect Secure installed on the remote host is prior to 22.7R2.1. It is, therefore, affected by 
An out-of-bounds read in IPsec of Ivanti Connect Secure before version 22.7R2.1 allows a remote unauthenticated 
attacker to cause a denial of service. (CVE-2024-37401)
...
"Upgrade to Pulse Connect Secure 22.7R2.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-37401");
...
var constraints = [
  {'fixed_version':'22.7.2.3191', 'fixed_display':'22.7R2.1 (Build 3191)'}
];
