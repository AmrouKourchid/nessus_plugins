...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5050008");
  script_xref(name:"MSFT", value:"MS25-5050008");
  script_xref(name:"IAVA", value:"2025-A-0034-S");
  script_xref(name:"IAVA", value:"2025-A-0033-S");

  script_name(english:"KB5050008: Windows 10 version 1809 / Windows Server 2019 Security Update (January 2025)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5050008");
