...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : glibc on SL6.x i386/x86_64 (20180619)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1807&L=scientific-linux-errata&F=&S=&P=2414
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0397ad35");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"glibc-2.12-1.212.el6")) flag++;
if (rpm_check(release:"SL6", reference:"glibc-common-2.12-1.212.el6")) flag++;
if (rpm_check(release:"SL6", reference:"glibc-debuginfo-2.12-1.212.el6")) flag++;
if (rpm_check(release:"SL6", reference:"glibc-debuginfo-common-2.12-1.212.el6")) flag++;
if (rpm_check(release:"SL6", reference:"glibc-devel-2.12-1.212.el6")) flag++;
if (rpm_check(release:"SL6", reference:"glibc-headers-2.12-1.212.el6")) flag++;
if (rpm_check(release:"SL6", reference:"glibc-static-2.12-1.212.el6")) flag++;
if (rpm_check(release:"SL6", reference:"glibc-utils-2.12-1.212.el6")) flag++;
if (rpm_check(release:"SL6", reference:"nscd-2.12-1.212.el6")) flag++;
