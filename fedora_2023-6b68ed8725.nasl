...
# extracted from Fedora Security Advisory FEDORA-2023-6b68ed8725
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6b68ed8725");

  script_name(english:"Fedora 38 : yt-dlp (2023-6b68ed8725)");
...
FEDORA-2023-6b68ed8725 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6b68ed8725");
...
var pkgs = [
    {'reference':'yt-dlp-2023.06.22-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
