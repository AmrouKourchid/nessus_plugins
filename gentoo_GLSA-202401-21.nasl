...
# extracted from Gentoo Linux Security Advisory GLSA 202401-21.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202401-21 : KTextEditor: Arbitrary Local Code Execution");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202401-21 (KTextEditor: Arbitrary Local Code
Execution)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202401-21");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=832447");
...
"All KTextEditor users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-23853");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:ktexteditor");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 5.90.0-r2"),
    'vulnerable' : make_list("lt 5.90.0-r2")
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'KTextEditor');
}
