...
# extracted from Fedora Security Advisory FEDORA-2024-5cf9589726
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5cf9589726");

  script_name(english:"Fedora 40 : python-werkzeug (2024-5cf9589726)");
...
FEDORA-2024-5cf9589726 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5cf9589726");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-werkzeug package.");
...
var pkgs = [
    {'reference':'python-werkzeug-3.0.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
