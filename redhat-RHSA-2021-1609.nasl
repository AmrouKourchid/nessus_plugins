...
# extracted from Red Hat Security Advisory RHSA-2021:1609. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : p11-kit (RHSA-2021:1609)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:1609 advisory.

    The p11-kit packages provide a mechanism to manage PKCS#11 modules. The p11-kit-trust subpackage includes
    a PKCS#11 trust module that provides certificate anchors and black lists based on configuration files.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1609.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2fa4dde");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:p11-kit");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:p11-kit-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:p11-kit-server");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:p11-kit-trust");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'p11-kit-0.23.22-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'p11-kit-devel-0.23.22-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'p11-kit-server-0.23.22-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'p11-kit-trust-0.23.22-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
