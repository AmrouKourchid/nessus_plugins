...
# extracted from VMware Security Advisory PHSA-2025-5.0-0488. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Elfutils PHSA-2025-5.0-0488");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the elfutils package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-488.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'elfutils-0.189-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'elfutils-devel-0.189-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'elfutils-devel-static-0.189-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'elfutils-libelf-0.189-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'elfutils-libelf-devel-0.189-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'elfutils-libelf-devel-static-0.189-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'elfutils-libelf-lang-0.189-6.ph5')) flag++;
