...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : mercurial (EulerOS-SA-2019-2214)");
...
vulnerabilities :
  ...
  - The mpatch_apply function in mpatch.c in Mercurial
    ...
    aka OVE-20180430-0004.(CVE-2018-13346)

  - mpatch.c in Mercurial before 4.6.1 mishandles integer
    addition and subtraction, aka
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2214
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1bab543");
...
pkgs = ["mercurial-2.6.2-8.h3.eulerosv2r7"];
