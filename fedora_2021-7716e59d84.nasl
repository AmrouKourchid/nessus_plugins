...
# extracted from Fedora Security Advisory FEDORA-2021-7716e59d84
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-7716e59d84");

  script_name(english:"Fedora 32 : jasper (2021-7716e59d84)");
...
FEDORA-2021-7716e59d84 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-7716e59d84");
...
pkgs = [
    {'reference':'jasper-2.0.25-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
