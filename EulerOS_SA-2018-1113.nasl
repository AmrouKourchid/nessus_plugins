...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : qemu-kvm (EulerOS-SA-2018-1113)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1113
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?349d7b71");
...
pkgs = ["qemu-img-1.5.3-156.h2",
        "qemu-kvm-1.5.3-156.h2",
        "qemu-kvm-common-1.5.3-156.h2"];
