...
# extracted from Red Hat Security Advisory ncurses. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-19211", "CVE-2018-19217");

  script_name(english:"RHEL 8 : ncurses (Unpatched Vulnerability) (deprecated)");
