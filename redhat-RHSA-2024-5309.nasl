...
# extracted from Red Hat Security Advisory RHSA-2024:5309. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5309");

  script_name(english:"RHEL 8 : python-urllib3 (RHSA-2024:5309)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5309.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb61db0a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5309");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-urllib3 package based on the guidance in RHSA-2024:5309.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-urllib3-1.24.2-8.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
