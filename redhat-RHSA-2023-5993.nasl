...
# extracted from Red Hat Security Advisory RHSA-2023:5993. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5993.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b4749bd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2235789");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5993");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python27:2.7 package based on the guidance in RHSA-2023:5993.");
  ...
  'python27:2.7': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'python2-2.7.18-10.module+el8.6.0+20145+6b7037b1.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-debug-2.7.18-10.module+el8.6.0+20145+6b7037b1.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-devel-2.7.18-10.module+el8.6.0+20145+6b7037b1.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-libs-2.7.18-10.module+el8.6.0+20145+6b7037b1.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-test-2.7.18-10.module+el8.6.0+20145+6b7037b1.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tkinter-2.7.18-10.module+el8.6.0+20145+6b7037b1.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tools-2.7.18-10.module+el8.6.0+20145+6b7037b1.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
