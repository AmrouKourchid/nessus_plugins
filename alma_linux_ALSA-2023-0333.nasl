...
# AlmaLinux Security Advisory ALSA-2023:0333.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:0333");
  script_xref(name:"IAVA", value:"2022-A-0451-S");

  script_name(english:"AlmaLinux 9 : curl (ALSA-2023:0333)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-0333.html");
