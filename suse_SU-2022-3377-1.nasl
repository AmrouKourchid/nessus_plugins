...
# SUSE update advisory SUSE-SU-2022:3377-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2022-29581", "CVE-2022-39188");
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3377-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 22 for SLE 15 SP3) (SUSE-SU-2022:3377-1)");
...
vulnerabilities as referenced in the SUSE-SU-2022:3377-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-September/012365.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef19c2e6");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-5_3_18-150300_59_87-default and / or kgraft-patch-4_12_14-122_130-default packages.");
...
var pkgs = [
    {'reference':'kernel-livepatch-5_3_18-150300_59_87-default-4-150300.2.2', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'kernel-livepatch-5_3_18-150300_59_87-default-4-150300.2.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-live-patching-release-15.3', 'sles-release-15.3']},
    {'reference':'kgraft-patch-4_12_14-122_130-default-3-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150300_59_87-default / etc');
}
