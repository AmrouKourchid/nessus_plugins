...
# extracted from Fedora Security Advisory FEDORA-2024-0a2f144348
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0a2f144348");

  script_name(english:"Fedora 38 : wordpress (2024-0a2f144348)");
...
FEDORA-2024-0a2f144348 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0a2f144348");
...
var pkgs = [
    {'reference':'wordpress-6.4.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
