...
# extracted from Fedora Security Advisory FEDORA-2024-43ea98691e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-43ea98691e");

  script_name(english:"Fedora 40 : flatpak (2024-43ea98691e)");
...
FEDORA-2024-43ea98691e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-43ea98691e");
...
var pkgs = [
    {'reference':'flatpak-1.15.8-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
