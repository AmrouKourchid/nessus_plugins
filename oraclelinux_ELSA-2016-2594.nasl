...
ELSA-2016-2594 advisory.

    - Resolves: bug 1360976 - EMBARGOED CVE-2016-5405 389-ds-base: Password verification vulnerable to timing
    attack
    - Resolves: bug 1350799 - CVE-2016-4992 389-ds-base: Information disclosure via repeat
    - Resolves: bug 1350799 - CVE-2016-4992 389-ds-base: Information disclosure via repeat
    - Resolves: bug 1299758 - CVE-2016-0741 389-ds-base: Worker threads do not detect abnormally closed
    connections causing DoS [rhel-7.3]

Tenable has extracted the preceding description block directly from the Oracle Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-2594.html");
