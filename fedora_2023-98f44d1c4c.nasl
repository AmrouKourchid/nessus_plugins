...
# extracted from Fedora Security Advisory FEDORA-2023-98f44d1c4c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-98f44d1c4c");

  script_name(english:"Fedora 38 : firecracker / rust-aes-gcm (2023-98f44d1c4c)");
...
FEDORA-2023-98f44d1c4c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-98f44d1c4c");
...
var pkgs = [
    {'reference':'firecracker-1.4.1-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-aes-gcm-0.10.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
