...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libarchive PHSA-2025-5.0-0487");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libarchive-3.7.1-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libarchive-devel-3.7.1-6.ph5')) flag++;
