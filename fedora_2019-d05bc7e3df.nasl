...
# extracted from Fedora Security Advisory FEDORA-2019-d05bc7e3df.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-d05bc7e3df");

  script_name(english:"Fedora 29 : golang (2019-d05bc7e3df)");
...
"- Rebase to go1.11.6
  ...
  - Security fix for CVE-2019-9741

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d05bc7e3df");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"golang-1.11.6-1.fc29")) flag++;
