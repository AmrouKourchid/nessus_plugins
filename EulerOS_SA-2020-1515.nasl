...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : e2fsprogs (EulerOS-SA-2020-1515)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1515
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c0ec92a2");
...
pkgs = ["e2fsprogs-1.44.3-1.h5",
        "e2fsprogs-libs-1.44.3-1.h5",
        "libcom_err-1.44.3-1.h5",
        "libcom_err-devel-1.44.3-1.h5",
        "libss-1.44.3-1.h5"];
