...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : busybox (EulerOS-SA-2022-2126)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2126
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2cd92ab");
...
var pkgs = [
  "busybox-help-1.31.1-6.h8.eulerosv2r10"
];
