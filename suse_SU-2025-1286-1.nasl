...
# SUSE update advisory SUSE-SU-2025:1286-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:1286-1");
  script_xref(name:"IAVB", value:"2025-B-0058");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : apache2-mod_auth_openidc (SUSE-SU-2025:1286-1)");
...
as referenced in the SUSE-SU-2025:1286-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2025-April/039009.html");
...
var pkgs = [
    {'reference':'apache2-mod_auth_openidc-2.3.8-150600.16.8.1', 'sp':'6', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.6']},
    {'reference':'apache2-mod_auth_openidc-2.3.8-150600.16.8.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.6', 'sle-module-server-applications-release-15.6', 'sles-release-15.6']},
    {'reference':'apache2-mod_auth_openidc-2.3.8-150600.16.8.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']}
];
