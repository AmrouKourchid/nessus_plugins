...
# extracted from Debian Security Advisory DLA-1760-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1760-1 : wget security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/04/msg00020.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"wget", reference:"1.16-1+deb8u6")) flag++;
