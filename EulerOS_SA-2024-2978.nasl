...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : curl (EulerOS-SA-2024-2978)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2978
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?803dc886");
...
var pkgs = [
  "curl-7.79.1-2.h31.eulerosv2r11",
  "libcurl-7.79.1-2.h31.eulerosv2r11"
];
