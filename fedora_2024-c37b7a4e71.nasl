...
# extracted from Fedora Security Advisory FEDORA-2024-c37b7a4e71
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c37b7a4e71");

  script_name(english:"Fedora 40 : mingw-qt5-qtbase (2024-c37b7a4e71)");
...
FEDORA-2024-c37b7a4e71 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c37b7a4e71");
...
var pkgs = [
    {'reference':'mingw-qt5-qtbase-5.15.14-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
