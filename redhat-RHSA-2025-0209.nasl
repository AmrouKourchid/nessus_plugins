...
# extracted from Red Hat Security Advisory RHSA-2025:0209. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0209");

  script_name(english:"RHEL 9 : dpdk (RHSA-2025:0209)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0209.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?94103a85");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0209");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dpdk package based on the guidance in RHSA-2025:0209.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dpdk-23.11-2.el9_4', 'sp':'4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-23.11-2.el9_4', 'sp':'4', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-23.11-2.el9_4', 'sp':'4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-devel-23.11-2.el9_4', 'sp':'4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-devel-23.11-2.el9_4', 'sp':'4', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-devel-23.11-2.el9_4', 'sp':'4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-doc-23.11-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-tools-23.11-2.el9_4', 'sp':'4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-tools-23.11-2.el9_4', 'sp':'4', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'dpdk-tools-23.11-2.el9_4', 'sp':'4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
