...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : bind (IJ44425)");
  script_summary(english:"Check for APAR IJ44425");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ44425m4b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.4") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ44425m4b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.102") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ44425m4b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.5.200", maxfilesetver:"7.2.5.200") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ44425m4b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.4") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ44425m4b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.102") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ44425m4b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.5.200", maxfilesetver:"7.2.5.200") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"05", patch:"IJ44425s5b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.4") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"05", patch:"IJ44425s5b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.102") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"05", patch:"IJ44425s5b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.5.200", maxfilesetver:"7.2.5.200") < 0) flag++;
