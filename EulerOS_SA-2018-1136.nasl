...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : sqlite (EulerOS-SA-2018-1136)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1136
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1befef7");
...
pkgs = ["sqlite-3.7.17-6.1.h1",
        "sqlite-devel-3.7.17-6.1.h1"];
