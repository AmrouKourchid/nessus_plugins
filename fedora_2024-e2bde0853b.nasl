...
# extracted from Fedora Security Advisory FEDORA-2024-e2bde0853b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e2bde0853b");
  script_xref(name:"IAVA", value:"2024-A-0540-S");

  script_name(english:"Fedora 39 : python-django (2024-e2bde0853b)");
...
FEDORA-2024-e2bde0853b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e2bde0853b");
...
var pkgs = [
    {'reference':'python-django-4.2.16-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
