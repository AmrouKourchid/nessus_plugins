...
# AlmaLinux Security Advisory ALSA-2024:6683.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:6683");

  script_name(english:"AlmaLinux 9 : thunderbird (ALSA-2024:6683)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-6683.html");
...
var pkgs = [
    {'reference':'thunderbird-128.2.0-1.el9_4.alma.1', 'cpu':'aarch64', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'thunderbird-128.2.0-1.el9_4.alma.1', 'cpu':'ppc64le', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'thunderbird-128.2.0-1.el9_4.alma.1', 'cpu':'s390x', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'thunderbird-128.2.0-1.el9_4.alma.1', 'cpu':'x86_64', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE}
];
