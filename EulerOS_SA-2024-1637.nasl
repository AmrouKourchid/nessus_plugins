...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : python-pycryptodome (EulerOS-SA-2024-1637)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1637
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e668249e");
...
var pkgs = [
  "python3-pycryptodome-3.11.0-1.h4.eulerosv2r11"
];
