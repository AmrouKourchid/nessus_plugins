...
# extracted from Oracle Linux Security Advisory ELSA-2021-0809.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : wpa_supplicant (ELSA-2021-0809)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-0809.html");
...
var pkgs = [
    {'reference':'wpa_supplicant-2.9-2.el8_3.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'wpa_supplicant-2.9-2.el8_3.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
