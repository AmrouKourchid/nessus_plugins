...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-189272bcce");

  script_name(english:"Fedora 37 : curl (2023-189272bcce) (deprecated)");

  script_set_attribute(attribute:"synopsis", value:
"This plugin has been deprecated.");
  script_set_attribute(attribute:"description", value:
"This plugin has been deprecated as the CVE that is assessed by the plugin has been rejected.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-189272bcce");
