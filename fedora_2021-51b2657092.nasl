...
# extracted from Fedora Security Advisory FEDORA-2021-51b2657092
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-51b2657092");

  script_name(english:"Fedora 33 : jasper (2021-51b2657092)");
...
FEDORA-2021-51b2657092 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-51b2657092");
...
pkgs = [
    {'reference':'jasper-2.0.26-2.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
