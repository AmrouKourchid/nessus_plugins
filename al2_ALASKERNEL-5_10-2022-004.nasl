...
vulnerabilities as referenced in the ALAS2KERNEL-5.10-2022-004 advisory.
    ...
    A flaw was found in the Linux kernel, where a BPF program can obtain sensitive information from kernel
    memory via a Speculative Store Bypass side-channel attack. This issue occurs when the protection mechanism
    neglects the possibility of uninitialized memory locations on the BPF stack. The highest threat from this
    vulnerability is to confidentiality. (CVE-2021-34556)
    ...
    A flaw use-after-free in the Linux kernel USB High Speed Mobile Devices functionality was found in the way
    user detaches USB device. A local user could use this flaw to crash the system or escalate their
    privileges on the system. (CVE-2021-37159)
    ...
    ** DISPUTED ** In drivers/char/virtio_console.c in the Linux kernel before 5.13.4, data corruption or loss
    ...
    xdp, net: Fix use-after-free in bpf_xdp_link_release (CVE-2021-47299)

    In the Linux kernel, the following vulnerability has been resolved:

    bpf: Fix tail_call_reachable rejection for interpreter when jit failed (CVE-2021-47300)
    ...
    bpf: Track subprog poke descriptors correctly and fix use-after-free (CVE-2021-47303)
    ...
    NFSv4: Fix an Oops in pnfs_mark_request_commit() when doing O_DIRECT (CVE-2021-47322)
    ...
    A flaw was found in the Linux Kernel's memory management subsytem. In this flaw, A task is exiting and
    releasing 2MB page in a vma (vm_area_struct) and hits the BUG statement in pfn_swap_entry_to_page()
    referencing pmd_t x. This may allow a local user to crash the Linux kernel. (CVE-2023-4732)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47299.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47300.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47301.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47303.html");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47322.html");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2023-4732.html");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2021-3655", "CVE-2021-3679", "CVE-2021-34556", "CVE-2021-35477", "CVE-2021-37159", "CVE-2021-38160", "CVE-2021-38199", "CVE-2021-47291", "CVE-2021-47295", "CVE-2021-47299", "CVE-2021-47300", "CVE-2021-47301", "CVE-2021-47303", "CVE-2021-47309", "CVE-2021-47311", "CVE-2021-47322", "CVE-2021-47325", "CVE-2021-47327", "CVE-2021-47328", "CVE-2021-47329", "CVE-2021-47338", "CVE-2021-47341", "CVE-2021-47354", "CVE-2023-4732", "CVE-2023-28772");
