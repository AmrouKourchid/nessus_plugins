...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libxml2 PHSA-2023-5.0-0001");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libxml2-2.9.14-7.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libxml2-devel-2.9.14-7.ph5')) flag++;
