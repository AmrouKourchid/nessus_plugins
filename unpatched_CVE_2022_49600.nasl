...
if (description)
{
  ...
  script_cve_id("CVE-2022-49600");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49600");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ip: Fix a data-race around
    sysctl_ip_autobind_reuse. While reading sysctl_ip_autobind_reuse, it can be changed concurrently. Thus, we
    need to add READ_ONCE() to its reader. (CVE-2022-49600)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49600");
