...
# extracted from Fedora Security Advisory FEDORA-2024-f652468298
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f652468298");

  script_name(english:"Fedora 39 : python3.8 (2024-f652468298)");
...
FEDORA-2024-f652468298 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f652468298");
...
var pkgs = [
    {'reference':'python3.8-3.8.20-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
