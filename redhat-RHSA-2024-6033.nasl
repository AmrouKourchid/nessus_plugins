...
# extracted from Red Hat Security Advisory RHSA-2024:6033. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6033");

  script_name(english:"RHEL 8 : openldap (RHSA-2024:6033)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openldap.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:6033 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6033.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f530298d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6033");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openldap package based on the guidance in RHSA-2024:6033.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openldap-2.4.46-20.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openldap-clients-2.4.46-20.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openldap-devel-2.4.46-20.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openldap-servers-2.4.46-20.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
