...
# extracted from Red Hat Security Advisory RHSA-2025:3629. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3629");

  script_name(english:"RHEL 9 : gimp (RHSA-2025:3629)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for gimp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:3629 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3629.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4a7abc0f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3629");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gimp package based on the guidance in RHSA-2025:3629.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gimp-2.99.8-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'gimp-libs-2.99.8-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
