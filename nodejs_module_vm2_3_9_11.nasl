...
if (description)
{
  ...
  script_name(english:"Node.js Module vm2 < 3.9.11 Sandbox Breakout");
...
"The version of the Node.js module vm2 installed on the remote host is prior to 3.9.11. It is, therefore affected by a
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/patriksimek/vm2/issues/467");
  # https://github.com/patriksimek/vm2/security/advisories/GHSA-mrgp-mrhc-5jrq
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ce0132b");
  script_set_attribute(attribute:"solution", value:
"Upgrade to vm2 version 3.9.11 or later.");
  script_set_attribute(attribute:"agent", value:"windows");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:C/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-36067");
