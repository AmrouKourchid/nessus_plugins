...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : wayland (EulerOS-SA-2023-1209)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the wayland package installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1209
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f44eb26");
...
"Update the affected wayland packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:wayland");
...
var pkgs = [
  "wayland-1.17.0-2.h1.r1.eulerosv2r9"
];
