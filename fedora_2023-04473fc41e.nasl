...
# extracted from Fedora Security Advisory FEDORA-2023-04473fc41e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-04473fc41e");

  script_name(english:"Fedora 37 : xen (2023-04473fc41e)");
...
FEDORA-2023-04473fc41e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-04473fc41e");
...
var pkgs = [
    {'reference':'xen-4.16.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
