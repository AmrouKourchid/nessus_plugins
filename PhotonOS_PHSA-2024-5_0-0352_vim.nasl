...
if (description)
{
  ...
  script_cve_id("CVE-2024-41957", "CVE-2024-41965", "CVE-2024-43374");
  script_xref(name:"IAVA", value:"2024-A-0461-S");
  script_xref(name:"IAVA", value:"2024-A-0505-S");

  script_name(english:"Photon OS 5.0: Vim PHSA-2024-5.0-0352");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'vim-9.1.0682-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'vim-extra-9.1.0682-1.ph5')) flag++;
