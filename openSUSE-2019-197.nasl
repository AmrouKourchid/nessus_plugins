...
# extracted from openSUSE Security Update openSUSE-2019-197.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : avahi (openSUSE-2019-197)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1120281");
...
if ( rpm_check(release:"SUSE15.0", reference:"avahi-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"avahi-autoipd-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"avahi-autoipd-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"avahi-compat-howl-devel-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"avahi-compat-mDNSResponder-devel-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"avahi-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"avahi-debugsource-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"avahi-glib2-debugsource-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"avahi-lang-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"avahi-utils-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"avahi-utils-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"avahi-utils-gtk-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"avahi-utils-gtk-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-client3-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-client3-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-common3-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-common3-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-core7-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-core7-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-devel-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-glib-devel-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-glib1-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-glib1-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-gobject-devel-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-gobject0-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-gobject0-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-ui-gtk3-0-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-ui-gtk3-0-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-ui0-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavahi-ui0-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libdns_sd-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libdns_sd-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libhowl0-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libhowl0-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python-avahi-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python-avahi-gtk-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"typelib-1_0-Avahi-0_6-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"avahi-32bit-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"avahi-mono-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"avahi-qt4-debugsource-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libavahi-client3-32bit-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libavahi-client3-32bit-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libavahi-common3-32bit-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libavahi-common3-32bit-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libavahi-glib1-32bit-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libavahi-glib1-32bit-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libavahi-qt4-1-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libavahi-qt4-1-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libavahi-qt4-devel-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libdns_sd-32bit-0.6.32-lp150.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libdns_sd-32bit-debuginfo-0.6.32-lp150.4.3.1") ) flag++;
