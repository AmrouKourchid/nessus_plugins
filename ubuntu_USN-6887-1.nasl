...
# extracted from Ubuntu Security Notice USN-6887-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6887-1");
  script_xref(name:"IAVA", value:"2024-A-0375-S");

  script_name(english:"Ubuntu 24.04 LTS : OpenSSH vulnerability (USN-6887-1)");
...
USN-6887-1 advisory.
    ...
    Philippos Giavridis, Jacky Wei En Kung, Daniel Hugenroth, and Alastair Beresford discovered that the
    OpenSSH ObscureKeystrokeTiming feature did not work as expected. A remote attacker could possibly use this
    issue to determine timing information about keystrokes.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6887-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-39894");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'openssh-client', 'pkgver': '1:9.6p1-3ubuntu13.4'},
    {'osver': '24.04', 'pkgname': 'openssh-server', 'pkgver': '1:9.6p1-3ubuntu13.4'},
    {'osver': '24.04', 'pkgname': 'openssh-sftp-server', 'pkgver': '1:9.6p1-3ubuntu13.4'},
    {'osver': '24.04', 'pkgname': 'openssh-tests', 'pkgver': '1:9.6p1-3ubuntu13.4'},
    {'osver': '24.04', 'pkgname': 'ssh', 'pkgver': '1:9.6p1-3ubuntu13.4'},
    {'osver': '24.04', 'pkgname': 'ssh-askpass-gnome', 'pkgver': '1:9.6p1-3ubuntu13.4'}
];
