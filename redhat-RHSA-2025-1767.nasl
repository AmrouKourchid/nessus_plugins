...
# extracted from Red Hat Security Advisory RHSA-2025:1767. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1767");

  script_name(english:"RHEL 9 : mysql (RHSA-2025:1767)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1767.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?340a8043");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1767");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mysql package based on the guidance in RHSA-2025:1767.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mysql-8.0.40-1.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-common-8.0.40-1.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-devel-8.0.40-1.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-errmsg-8.0.40-1.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-libs-8.0.40-1.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-server-8.0.40-1.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-test-8.0.40-1.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
