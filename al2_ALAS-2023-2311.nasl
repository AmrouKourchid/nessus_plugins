...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2311.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : oniguruma (ALAS-2023-2311)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of oniguruma installed on the remote host is prior to 5.9.6-1. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2-2023-2311 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2311.html");
...
var pkgs = [
    {'reference':'oniguruma-5.9.6-1.amzn2.0.7', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oniguruma-5.9.6-1.amzn2.0.7', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oniguruma-5.9.6-1.amzn2.0.7', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oniguruma-debuginfo-5.9.6-1.amzn2.0.7', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oniguruma-debuginfo-5.9.6-1.amzn2.0.7', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oniguruma-debuginfo-5.9.6-1.amzn2.0.7', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oniguruma-devel-5.9.6-1.amzn2.0.7', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oniguruma-devel-5.9.6-1.amzn2.0.7', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oniguruma-devel-5.9.6-1.amzn2.0.7', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
