...
# extracted from Red Hat Security Advisory RHSA-2021:4588. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4588");

  script_name(english:"RHEL 8 : gcc-toolset-10-binutils (RHSA-2021:4588)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gcc-toolset-10-binutils.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4588 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4588.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?60efdf01");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4588");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2005819");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gcc-toolset-10-binutils package based on the guidance in RHSA-2021:4588.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-10-binutils-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gcc-toolset-10-binutils-2.35-8.el8_4.5', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-10-binutils-devel-2.35-8.el8_4.5', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
