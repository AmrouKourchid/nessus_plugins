...
if (description)
{
  ...
  script_name(english:"CentOS 9 : expat-2.2.10-10.el9");
...
expat-2.2.10-10.el9 build changelog.

  - malformed 2 (CVE-2022-25235)

  - namespace-separator characters in xmlns[:prefix] attribute values can lead to arbitrary code execution
    (CVE-2022-25236)

  - integer overflow in storeRawNames() (CVE-2022-25315)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=17506");
...
var pkgs = [
    {'reference':'expat-2.2.10-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.2.10-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-static-2.2.10-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
