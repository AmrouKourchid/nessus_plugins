...
ELSA-2012-0051 advisory.

    - Resolves: bz#772079
      (EMBARGOED CVE-2012-0029 qemu-kvm: e1000: process_tx_desc legacy mode packets heap overflow
    [rhel-5.7.z])
    - Resolves: bz#770100
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-0051.html");
...
var pkgs = [
    {'reference':'kmod-kvm-83-239.0.1.el5_7.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kmod-kvm-debug-83-239.0.1.el5_7.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-83-239.0.1.el5_7.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-qemu-img-83-239.0.1.el5_7.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-tools-83-239.0.1.el5_7.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
