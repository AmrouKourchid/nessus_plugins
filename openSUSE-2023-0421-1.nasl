...
# openSUSE Security Update openSUSE-SU-2023:0421-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  script_id(187399);
  script_version("1.0");
  script_set_attribute(attribute:"plugin_modification_date", value:"2023/12/30");

  script_cve_id("CVE-2023-48795");

  script_name(english:"openSUSE 15 Security Update : proftpd (openSUSE-SU-2023:0421-1)");
...
number.");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/CNYVAEZZNHEKG5C7JHU5U3MPN73U4OKG/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9bf89f5c");
...
var pkgs = [
    {'reference':'proftpd-1.3.8b-bp155.2.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-1.3.8b-bp155.2.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-devel-1.3.8b-bp155.2.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-devel-1.3.8b-bp155.2.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-lang-1.3.8b-bp155.2.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-lang-1.3.8b-bp155.2.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-ldap-1.3.8b-bp155.2.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-ldap-1.3.8b-bp155.2.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-mysql-1.3.8b-bp155.2.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-mysql-1.3.8b-bp155.2.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-pgsql-1.3.8b-bp155.2.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-pgsql-1.3.8b-bp155.2.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-radius-1.3.8b-bp155.2.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-radius-1.3.8b-bp155.2.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-sqlite-1.3.8b-bp155.2.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-sqlite-1.3.8b-bp155.2.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'proftpd / proftpd-devel / proftpd-lang / proftpd-ldap / etc');
}
