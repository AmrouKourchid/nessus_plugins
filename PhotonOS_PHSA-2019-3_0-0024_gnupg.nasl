...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Gnupg PHSA-2019-3.0-0024");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'gnupg-2.2.17-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'gnupg-debuginfo-2.2.17-1.ph3')) flag++;
