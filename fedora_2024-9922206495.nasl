...
# extracted from Fedora Security Advisory FEDORA-2024-9922206495
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9922206495");
  script_xref(name:"IAVA", value:"2024-A-0538-S");

  script_name(english:"Fedora 40 : firefox (2024-9922206495)");
...
FEDORA-2024-9922206495 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9922206495");
...
var pkgs = [
    {'reference':'firefox-130.0-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
