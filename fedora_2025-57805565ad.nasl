...
# extracted from Fedora Security Advisory FEDORA-2025-57805565ad
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-57805565ad");

  script_name(english:"Fedora 40 : webkitgtk (2025-57805565ad)");
...
FEDORA-2025-57805565ad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-57805565ad");
...
var pkgs = [
    {'reference':'webkitgtk-2.46.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
