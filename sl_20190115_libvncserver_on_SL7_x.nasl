...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libvncserver on SL7.x x86_64 (20190115)");
...
"Security Fix(es) :
  ...
  - libvncserver: Heap out-of-bounds write in rfbserver.c in
    rfbProcessFileTransferReadBuffer() allows for potential
    code execution (CVE-2018-15127)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1901&L=SCIENTIFIC-LINUX-ERRATA&P=1782
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be646c3d");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libvncserver-0.9.9-13.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libvncserver-debuginfo-0.9.9-13.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libvncserver-devel-0.9.9-13.el7_6")) flag++;
