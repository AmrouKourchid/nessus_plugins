...
if (description)
{
  ...
  script_name(english:"CentOS 9 : opensc-0.23.0-3.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for opensc.");
...
opensc-0.23.0-3.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=41557");
...
var pkgs = [
    {'reference':'opensc-0.23.0-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
