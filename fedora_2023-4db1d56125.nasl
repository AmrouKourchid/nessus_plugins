...
# extracted from Fedora Security Advisory FEDORA-2023-4db1d56125
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4db1d56125");

  script_name(english:"Fedora 38 : amanda (2023-4db1d56125)");
...
FEDORA-2023-4db1d56125 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4db1d56125");
...
var pkgs = [
    {'reference':'amanda-3.5.4-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
