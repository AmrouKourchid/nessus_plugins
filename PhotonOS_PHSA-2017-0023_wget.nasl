...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Wget PHSA-2017-0023");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'wget-1.18-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'wget-debuginfo-1.18-2.ph1')) flag++;
