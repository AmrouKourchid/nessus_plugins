...
"The version of Google Chrome installed on the remote Windows host is prior to 125.0.6422.141. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'125.0.6422.141', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
