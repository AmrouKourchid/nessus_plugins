...
# extracted from Red Hat Security Advisory RHSA-2022:8863. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8863");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.1.9 (python-paramiko) (RHSA-2022:8863)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.1.9 (python-paramiko).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8863.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9bd0d4e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8863");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2065665");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.1.9 (python-paramiko) package based on the guidance in RHSA-2022:8863.");
