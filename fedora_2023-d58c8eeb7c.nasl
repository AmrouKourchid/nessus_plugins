...
# extracted from Fedora Security Advisory FEDORA-2023-d58c8eeb7c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d58c8eeb7c");

  script_name(english:"Fedora 38 : syncthing (2023-d58c8eeb7c)");
...
FEDORA-2023-d58c8eeb7c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d58c8eeb7c");
...
var pkgs = [
    {'reference':'syncthing-1.26.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
