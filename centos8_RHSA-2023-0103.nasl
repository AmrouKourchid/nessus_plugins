...
# Red Hat Security Advisory RHSA-2023:0103. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : expat (CESA-2023:0103)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2023:0103 advisory.
...
var pkgs = [
    {'reference':'expat-2.2.5-10.el8.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-2.2.5-10.el8.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.2.5-10.el8.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.2.5-10.el8.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
