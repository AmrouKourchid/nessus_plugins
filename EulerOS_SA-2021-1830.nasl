...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : php (EulerOS-SA-2021-1830)");
...
vulnerabilities :
  ...
  - ext/mysqlnd/mysqlnd.c in PHP before 5.4.43, 5.5.x
    before 5.5.27, and 5.6.x before 5.6.11 uses a client
    SSL option to mean that SSL is optional, which allows
    man-in-the-middle attackers to spoof servers via a
    cleartext-downgrade attack, a related issue to
    CVE-2015-3152.(CVE-2015-8838)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1830
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?82f0e07f");
...
"Update the affected php packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2015-8838");
...
pkgs = ["php-5.4.16-42.h61",
        "php-cli-5.4.16-42.h61",
        "php-common-5.4.16-42.h61",
        "php-gd-5.4.16-42.h61",
        "php-ldap-5.4.16-42.h61",
        "php-mysql-5.4.16-42.h61",
        "php-odbc-5.4.16-42.h61",
        "php-pdo-5.4.16-42.h61",
        "php-pgsql-5.4.16-42.h61",
        "php-process-5.4.16-42.h61",
        "php-recode-5.4.16-42.h61",
        "php-soap-5.4.16-42.h61",
        "php-xml-5.4.16-42.h61",
        "php-xmlrpc-5.4.16-42.h61"];
