...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : java-1.8.0-openjdk (EulerOS-SA-2018-1130)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1130
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28239082");
...
pkgs = ["java-1.8.0-openjdk-1.8.0.171-7.b10",
        "java-1.8.0-openjdk-devel-1.8.0.171-7.b10",
        "java-1.8.0-openjdk-headless-1.8.0.171-7.b10"];
