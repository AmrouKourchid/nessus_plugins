...
# extracted from Red Hat Security Advisory RHSA-2023:0339. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0339");

  script_name(english:"RHEL 9 : sqlite (RHSA-2023:0339)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0339.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a08a644");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2110291");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0339");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sqlite package based on the guidance in RHSA-2023:0339.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sqlite-3.34.1-6.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sqlite-devel-3.34.1-6.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sqlite-libs-3.34.1-6.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'sqlite / sqlite-devel / sqlite-libs');
}
