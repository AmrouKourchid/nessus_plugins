...
# extracted from Red Hat Security Advisory RHSA-2024:2101. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2101");
  script_xref(name:"CEA-ID", value:"CEA-2023-0052");

  script_name(english:"RHEL 6 / 7 / 8 / 9 : Red Hat Satellite Client (RHSA-2024:2101)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat Satellite Client.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 / 7 / 8 / 9 host has a package installed that is affected by a vulnerability as
referenced in the RHSA-2024:2101 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2101.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06ff990e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2101");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Satellite Client package based on the guidance in RHSA-2024:2101.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'puppet-agent-7.28.0-1.el8sat', 'cpu':'x86_64', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'puppet-agent-7.28.0-1.el9sat', 'cpu':'x86_64', 'release':'9', 'el_string':'el9sat', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'puppet-agent-7.28.0-1.el7sat', 'cpu':'x86_64', 'release':'7', 'el_string':'el7sat', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'puppet-agent-7.28.0-1.el6sat', 'cpu':'i686', 'release':'6', 'el_string':'el6sat', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'puppet-agent-7.28.0-1.el6sat', 'cpu':'x86_64', 'release':'6', 'el_string':'el6sat', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
