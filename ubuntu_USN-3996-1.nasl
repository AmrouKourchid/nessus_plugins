...
# extracted from Ubuntu Security Notice USN-3996-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3996-1");

  script_name(english:"Ubuntu 14.04 LTS : GNU Screen vulnerability (USN-3996-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security-related patch.");
  script_set_attribute(attribute:"description", value:
"Kuang-che Wu discovered that GNU Screen improperly handled certain
input. An attacker could use this issue to cause GNU Screen to crash,
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/3996-1/");
...
if (ubuntu_check(osver:"14.04", pkgname:"screen", pkgver:"4.1.0~20120320gitdb59704-9ubuntu0.1~esm1")) flag++;
