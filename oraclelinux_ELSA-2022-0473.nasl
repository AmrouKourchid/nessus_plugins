...
# extracted from Oracle Linux Security Advisory ELSA-2022-0473.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : aide (ELSA-2022-0473)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-0473.html");
...
var pkgs = [
    {'reference':'aide-0.15.1-13.0.1.el7_9.1', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'aide-0.15.1-13.0.1.el7_9.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
