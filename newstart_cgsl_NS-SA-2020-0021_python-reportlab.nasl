...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : python-reportlab Vulnerability (NS-SA-2020-0021)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has python-reportlab packages installed that are affected by a
vulnerability:
...
pkgs = {
  "CGSL MAIN 4.05": [
    "python-reportlab-2.3-3.el6_10.1",
    "python-reportlab-debuginfo-2.3-3.el6_10.1",
    "python-reportlab-docs-2.3-3.el6_10.1"
  ]
};
