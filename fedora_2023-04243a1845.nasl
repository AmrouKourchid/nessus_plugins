...
# extracted from Fedora Security Advisory FEDORA-2023-04243a1845
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-04243a1845");

  script_name(english:"Fedora 38 : iperf3 (2023-04243a1845)");
...
FEDORA-2023-04243a1845 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-04243a1845");
...
var pkgs = [
    {'reference':'iperf3-3.14-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
