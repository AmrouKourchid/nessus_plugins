...
# extracted from Red Hat Security Advisory RHSA-2024:0310. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0310");
  script_xref(name:"IAVA", value:"2023-A-0582-S");

  script_name(english:"RHEL 9 : openssl (RHSA-2024:0310)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0310.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?60c2dd80");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2243839");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-15993");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0310");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openssl package based on the guidance in RHSA-2024:0310.");
