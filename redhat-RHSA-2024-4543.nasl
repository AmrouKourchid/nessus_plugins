...
# extracted from Red Hat Security Advisory RHSA-2024:4543. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4543");

  script_name(english:"RHEL 9 : git-lfs (RHSA-2024:4543)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28304572");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4543");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL git-lfs package based on the guidance in RHSA-2024:4543.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-lfs-2.13.3-5.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
