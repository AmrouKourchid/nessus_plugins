...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : openssh (EulerOS-SA-2021-2153)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2153
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1bbe92e0");
...
pkgs = ["openssh-7.4p1-16.h20.eulerosv2r7",
        ...
        "pam_ssh_agent_auth-0.10.3-2.16.h20.eulerosv2r7"];
