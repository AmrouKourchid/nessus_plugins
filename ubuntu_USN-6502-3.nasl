...
# extracted from Ubuntu Security Notice USN-6502-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6502-3");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (NVIDIA) vulnerabilities (USN-6502-3)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6502-3");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1012-nvidia");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1012-nvidia-64k");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6502-3');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6502-3');
  }
  else
  {
