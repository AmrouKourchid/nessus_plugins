...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Firefox vulnerabilities (USN-4756-1)");
...
vulnerabilities as referenced in the USN-4756-1 advisory.
    ...
    sensitive information, conduct cross-site scripting (XSS) attacks, bypass HTTP auth phishing warnings, or
