...
# extracted from Oracle Linux Security Advisory ELSA-2022-9720.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : cri-o (ELSA-2022-9720)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9720.html");
...
var pkgs = [
    {'reference':'cri-o-1.22.5-1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'cri-o-1.22.'}
];
