...
if (description)
{
  ...
  script_cve_id("CVE-2022-49122");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49122");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: dm ioctl: prevent potential spectre v1
    gadget It appears like cmd could be a Spectre v1 gadget as it's supplied by a user and used as an array
    index. Prevent the contents of kernel memory from being leaked to userspace via speculative execution by
    using array_index_nospec. (CVE-2022-49122)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49122");
