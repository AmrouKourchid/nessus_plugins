...
# extracted from Fedora Security Advisory FEDORA-2018-de5457b0a2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : 1:epiphany (2018-de5457b0a2)");
...
"- Ensure search engine migration does not fail (#794645)
  ...
  - Do not open adblock filters when automatic open
    downloads is enabled (#794646)

  - Fix crash destroying sync service (#794728)

  - Fix CVE-2018-11396/CVE-2018-12016 (#795740)

  - Do not use Fanboy's Annoyance adblock list by default
    (#796245)
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-de5457b0a2");
...
"Update the affected 1:epiphany package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-12016");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"epiphany-3.26.7-1.fc27", epoch:"1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "1:epiphany");
}
