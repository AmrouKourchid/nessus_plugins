...
# extracted from openSUSE Security Update openSUSE-2021-195.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : nodejs8 (openSUSE-2021-195)");
...
"This update for nodejs8 fixes the following issue :
  ...
  - CVE-2020-8287: Fixed an HTTP request smuggling
    vulnerability (bsc#1180554).
...
if ( rpm_check(release:"SUSE15.2", reference:"nodejs8-8.17.0-lp152.3.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nodejs8-debuginfo-8.17.0-lp152.3.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nodejs8-debugsource-8.17.0-lp152.3.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nodejs8-devel-8.17.0-lp152.3.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"npm8-8.17.0-lp152.3.8.1") ) flag++;
