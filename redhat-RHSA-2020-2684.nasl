...
# extracted from Red Hat Security Advisory RHSA-2020:2684. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2684");

  script_name(english:"RHEL 7 : containernetworking-plugins (RHSA-2020:2684)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f17f6747");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2684");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1833220");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL containernetworking-plugins package based on the guidance in RHSA-2020:2684.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'containernetworking-plugins-0.8.3-3.el7_8', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'containernetworking-plugins-0.8.3-3.el7_8', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'containernetworking-plugins-0.8.3-3.el7_8', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
