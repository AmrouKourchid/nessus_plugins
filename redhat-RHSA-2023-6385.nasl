...
# extracted from Red Hat Security Advisory RHSA-2023:6385. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6385");

  script_name(english:"RHEL 9 : liblouis (RHSA-2023:6385)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for liblouis.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:6385 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6385.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0d48685");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2181135");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2181139");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2181143");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6385");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL liblouis package based on the guidance in RHSA-2023:6385.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'liblouis-3.16.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-louis-3.16.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
