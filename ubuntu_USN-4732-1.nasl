...
# extracted from Ubuntu Security Notice USN-4732-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4732-1");
  script_xref(name:"IAVA", value:"2021-A-0493-S");
  script_xref(name:"IAVA", value:"2022-A-0382-S");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Ubuntu 20.10 : SQLite vulnerability (USN-4732-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 20.10 host has packages installed that are affected by a vulnerability as referenced in the USN-4732-1
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4732-1");
...
var pkgs = [
    {'osver': '20.10', 'pkgname': 'lemon', 'pkgver': '3.33.0-1ubuntu0.1'},
    {'osver': '20.10', 'pkgname': 'libsqlite3-0', 'pkgver': '3.33.0-1ubuntu0.1'},
    {'osver': '20.10', 'pkgname': 'libsqlite3-dev', 'pkgver': '3.33.0-1ubuntu0.1'},
    {'osver': '20.10', 'pkgname': 'libsqlite3-tcl', 'pkgver': '3.33.0-1ubuntu0.1'},
    {'osver': '20.10', 'pkgname': 'sqlite3', 'pkgver': '3.33.0-1ubuntu0.1'}
];
