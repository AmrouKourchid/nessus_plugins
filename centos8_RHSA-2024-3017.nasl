...
# Red Hat Security Advisory RHSA-2024:3017. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : edk2 (CESA-2024:3017)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2024:3017 advisory.
...
var pkgs = [
    {'reference':'edk2-aarch64-20220126gitbb1bba3d77-13.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'edk2-ovmf-20220126gitbb1bba3d77-13.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
