...
# extracted from Red Hat Security Advisory RHSA-2020:3285. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3285");

  script_name(english:"RHEL 7 : postgresql-jdbc (RHSA-2020:3285)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for postgresql-jdbc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:3285 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3285.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a29dea3e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/articles/5266441");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3285");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1852985");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql-jdbc package based on the guidance in RHSA-2020:3285.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postgresql-jdbc-9.2.1002-8.el7_8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-jdbc-javadoc-9.2.1002-8.el7_8', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
