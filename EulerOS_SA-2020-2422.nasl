...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : tigervnc (EulerOS-SA-2020-2422)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the tigervnc package installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2422
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?87b13114");
...
"Update the affected tigervnc package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:tigervnc-help");
...
pkgs = ["tigervnc-help-1.10.1-2.h1.eulerosv2r9"];
