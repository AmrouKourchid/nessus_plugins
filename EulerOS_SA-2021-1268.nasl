...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : nss (EulerOS-SA-2021-1268)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1268
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?24c40fd2");
...
"Update the affected nss package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-12401");
...
pkgs = ["nss-3.40.1-11.h10.eulerosv2r9",
        "nss-softokn-3.40.1-11.h10.eulerosv2r9",
        "nss-util-3.40.1-11.h10.eulerosv2r9"];
