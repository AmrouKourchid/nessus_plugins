...
# extracted from Debian Security Advisory dsa-5888. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5888 : ghostscript - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-27830");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-27831");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-27832");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-27833");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-27834");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-27835");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-27836");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'ghostscript', 'reference': '10.0.0~dfsg-11+deb12u7'},
    {'release': '12.0', 'prefix': 'ghostscript-doc', 'reference': '10.0.0~dfsg-11+deb12u7'},
    {'release': '12.0', 'prefix': 'ghostscript-x', 'reference': '10.0.0~dfsg-11+deb12u7'},
    {'release': '12.0', 'prefix': 'libgs-common', 'reference': '10.0.0~dfsg-11+deb12u7'},
    {'release': '12.0', 'prefix': 'libgs-dev', 'reference': '10.0.0~dfsg-11+deb12u7'},
    {'release': '12.0', 'prefix': 'libgs10', 'reference': '10.0.0~dfsg-11+deb12u7'},
    {'release': '12.0', 'prefix': 'libgs10-common', 'reference': '10.0.0~dfsg-11+deb12u7'},
    {'release': '12.0', 'prefix': 'libgs9-common', 'reference': '10.0.0~dfsg-11+deb12u7'}
];
