...
# extracted from Fedora Security Advisory FEDORA-2023-fa2d7b25d9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fa2d7b25d9");

  script_name(english:"Fedora 37 : syncthing (2023-fa2d7b25d9)");
...
FEDORA-2023-fa2d7b25d9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fa2d7b25d9");
...
var pkgs = [
    {'reference':'syncthing-1.26.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
