...
if (description)
{
  ...
  script_name(english:"Rocky Linux 9 : Image Builder (RLSA-2022:7950)");
...
var pkgs = [
    {'reference':'cockpit-composer-41-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'osbuild-65-1.el9.rocky.0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'osbuild-luks2-65-1.el9.rocky.0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'osbuild-lvm2-65-1.el9.rocky.0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'osbuild-ostree-65-1.el9.rocky.0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'osbuild-selinux-65-1.el9.rocky.0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-osbuild-65-1.el9.rocky.0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'weldr-client-35.5-4.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'weldr-client-35.5-4.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'weldr-client-35.5-4.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'weldr-client-debuginfo-35.5-4.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'weldr-client-debuginfo-35.5-4.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'weldr-client-debuginfo-35.5-4.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'weldr-client-debugsource-35.5-4.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'weldr-client-debugsource-35.5-4.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'weldr-client-debugsource-35.5-4.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
