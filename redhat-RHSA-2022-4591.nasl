...
# extracted from Red Hat Security Advisory RHSA-2022:4591. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:4591");

  script_name(english:"RHEL 9 : subversion (RHSA-2022:4591)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4591.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f1e7489");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4591");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2074772");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL subversion package based on the guidance in RHSA-2022:4591.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_dav_svn-1.14.1-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-subversion-1.14.1-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subversion-1.14.1-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subversion-devel-1.14.1-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subversion-gnome-1.14.1-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subversion-libs-1.14.1-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subversion-perl-1.14.1-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subversion-tools-1.14.1-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'mod_dav_svn-1.14.1-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-subversion-1.14.1-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subversion-1.14.1-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subversion-devel-1.14.1-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subversion-gnome-1.14.1-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subversion-libs-1.14.1-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subversion-perl-1.14.1-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subversion-tools-1.14.1-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mod_dav_svn / python3-subversion / subversion / subversion-devel / etc');
}
