...
"The version of Firefox ESR installed on the remote Windows host is prior to 115.11. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2024-22 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'115.11', min:'115.0.0', severity:SECURITY_HOLE);
