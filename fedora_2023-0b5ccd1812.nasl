...
# extracted from Fedora Security Advisory FEDORA-2023-0b5ccd1812
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0b5ccd1812");

  script_name(english:"Fedora 37 : rnp (2023-0b5ccd1812)");
...
FEDORA-2023-0b5ccd1812 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0b5ccd1812");
...
var pkgs = [
    {'reference':'rnp-0.16.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
