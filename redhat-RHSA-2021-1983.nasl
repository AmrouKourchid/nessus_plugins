...
# extracted from Red Hat Security Advisory RHSA-2021:1983. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1983");

  script_name(english:"RHEL 8 : idm:DL1 (RHSA-2021:1983)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for idm:DL1.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:1983 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1983.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b12aa1da");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1983");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1944640");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL idm:DL1 package based on the guidance in RHSA-2021:1983.");
  ...
  'idm:DL1': [
    {
      ...
      'pkgs': [
        {'reference':'bind-dyndb-ldap-11.6-2.module+el8.4.0+9328+4ec4e316', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'custodia-0.6.0-3.module+el8.1.0+4098+f286395e', 'sp':'4', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-common-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-epn-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-samba-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-common-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-healthcheck-0.7-3.module+el8.4.0+9007+5084bdd8', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-healthcheck-core-0.7-3.module+el8.4.0+9007+5084bdd8', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-python-compat-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-selinux-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-common-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-dns-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-trust-ad-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'opendnssec-2.1.7-1.module+el8.4.0+9007+5084bdd8', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-custodia-0.6.0-3.module+el8.1.0+4098+f286395e', 'sp':'4', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipaclient-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipalib-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipaserver-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipatests-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'slapi-nis-0.56.6-2.module+el8.4.0+10615+2234cc2c', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'softhsm-2.6.0-5.module+el8.4.0+10227+076cd560', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'softhsm-devel-2.6.0-5.module+el8.4.0+10227+076cd560', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        ...
        {'reference':'ipa-client-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-common-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-epn-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-samba-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-common-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-healthcheck-0.7-3.module+el8.4.0+9007+5084bdd8', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-healthcheck-core-0.7-3.module+el8.4.0+9007+5084bdd8', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-python-compat-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-selinux-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-common-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-dns-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-trust-ad-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python3-ipaclient-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipalib-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipaserver-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipatests-4.9.2-3.module+el8.4.0+10412+5ecb5b37', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'slapi-nis-0.56.6-2.module+el8.4.0+10615+2234cc2c', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
