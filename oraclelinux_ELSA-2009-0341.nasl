...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : curl (ELSA-2009-0341)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0341.html");
...
"Update the affected curl and / or curl-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0037");
...
var pkgs = [
    {'reference':'curl-7.15.5-2.1.el5_3.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'curl-devel-7.15.5-2.1.el5_3.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'curl-7.15.5-2.1.el5_3.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'curl-devel-7.15.5-2.1.el5_3.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
