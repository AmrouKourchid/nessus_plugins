...
# extracted from Gentoo Linux Security Advisory GLSA 202406-02.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202406-02 : Flatpak: Sandbox Escape");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202406-02 (Flatpak: Sandbox Escape)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202406-02");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=930202");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.14.6"),
    'vulnerable' : make_list("lt 1.14.6")
  }
];
