...
# extracted from Fedora Security Advisory FEDORA-2024-8568f9cd5e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8568f9cd5e");

  script_name(english:"Fedora 41 : uv (2024-8568f9cd5e)");
...
FEDORA-2024-8568f9cd5e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8568f9cd5e");
...
var pkgs = [
    {'reference':'uv-0.5.5-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
