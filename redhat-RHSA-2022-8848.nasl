...
# extracted from Red Hat Security Advisory RHSA-2022:8848. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8848");

  script_name(english:"RHEL 8 : Red Hat OpenStack 16.2.4 (python-XStatic-Bootstrap-SCSS) (RHSA-2022:8848)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack 16.2.4 (python-XStatic-Bootstrap-SCSS).");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:8848 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8848.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0041ff0f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8848");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1686454");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack 16.2.4 (python-XStatic-Bootstrap-SCSS) package based on the guidance in
RHSA-2022:8848.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python-XStatic-Bootstrap-SCSS");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-XStatic-Bootstrap-SCSS");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xstatic-bootstrap-scss-common");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-XStatic-Bootstrap-SCSS-3.4.1.0-2.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'xstatic-bootstrap-scss-common-3.4.1.0-2.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-XStatic-Bootstrap-SCSS / xstatic-bootstrap-scss-common');
}
