...
# extracted from Red Hat Security Advisory RHSA-2005:640. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : fetchmail (RHSA-2005:640)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for fetchmail.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_640.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d07610b8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=163816");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:640");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL fetchmail package based on the guidance in RHSA-2005:640.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-2335");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'fetchmail-6.2.5-6.el4.2', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fetchmail-6.2.5-6.el4.2', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fetchmail-6.2.5-6.el4.2', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fetchmail-6.2.5-6.el4.2', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fetchmail-6.2.5-6.el4.2', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
