...
# extracted from Red Hat Security Advisory golang.org_x_crypto. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : golang.org_x_crypto (Unpatched Vulnerability) (deprecated)");
