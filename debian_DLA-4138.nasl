...
# extracted from Debian Security Advisory dla-4138. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4138 : distro-info-data - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4138
advisory.
...
"Upgrade the distro-info-data packages.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2025/04/26");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'distro-info-data', 'reference': '0.51+deb11u8'}
];
