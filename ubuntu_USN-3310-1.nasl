...
# extracted from Ubuntu Security Notice USN-3310-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3310-1");

  script_name(english:"Ubuntu 16.04 LTS : lintian vulnerability (USN-3310-1)");
...
USN-3310-1 advisory.
    ...
    Jakub Wilk discovered that lintian incorrectly handled deserializing certain YAML files. If a user or
    automated system were tricked into running lintian on a specially crafted package, a remote attacker could
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3310-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected lintian package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-8829");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'lintian', 'pkgver': '2.5.43ubuntu0.1'}
];
