...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.1.0 : fuse (EulerOS-SA-2019-1607)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1607
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c4b961c2");
...
pkgs = ["fuse-2.9.2-11.h6",
        "fuse-devel-2.9.2-11.h6",
        "fuse-libs-2.9.2-11.h6"];
