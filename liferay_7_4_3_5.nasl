...
if (description)
{
  ...
  script_cve_id("CVE-2024-25603");

  script_name(english:"Liferay Portal 7.4.x < 7.4.3.5 XSS");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of Liferay Portal installed on the remote host is prior to 7.4.3.5. It is, therefore, affected by a
vulnerability as referenced in the advisory.

  - Stored cross-site scripting (XSS) vulnerability in the Dynamic Data Mapping module's DDMForm in Liferay
    Portal 7.2.0 through 7.4.3.4, and older unsupported versions, and Liferay DXP 7.4.13, 7.3 before update 4,
    7.2 before fix pack 17, and older unsupported versions allows remote authenticated users to inject
    arbitrary web script or HTML via the instanceId parameter. (CVE-2024-25603)
...
"Upgrade Liferay Portal based upon the guidance specified in the advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-25603");
...
var constraints = [
  { 'min_version' : '7.4.0', 'fixed_version' : '7.4.3.5' }
];
