...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Lz4 PHSA-2021-4.0-0047");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'lz4-1.9.2-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'lz4-devel-1.9.2-2.ph4')) flag++;
