...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: C PHSA-2021-2.0-0337");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'c-ares-1.16.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'c-ares-devel-1.16.1-1.ph2')) flag++;
