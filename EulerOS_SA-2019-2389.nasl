...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : git (EulerOS-SA-2019-2389)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2389
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f816f6ea");
...
pkgs = ["git-1.8.3.1-14.h4",
        "perl-Git-1.8.3.1-14.h4"];
