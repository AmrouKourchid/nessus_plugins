...
# extracted from Fedora Security Advisory FEDORA-2021-be62be8c7c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-be62be8c7c");

  script_name(english:"Fedora 33 : perl-Net-Netmask (2021-be62be8c7c)");
...
FEDORA-2021-be62be8c7c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-be62be8c7c");
...
pkgs = [
    {'reference':'perl-Net-Netmask-2.0001-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
