...
the RHSA-2022:8400 advisory.
    ...
    The libtirpc packages contain SunLib's implementation of transport-independent remote procedure call (TI-
    RPC) documentation, which includes a library required by programs in the nfs-utils and rpcbind packages.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8400.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eaebcd7c");
...
"Update the RHEL libtirpc package based on the guidance in RHSA-2022:8400.");
