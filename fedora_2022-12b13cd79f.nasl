...
# extracted from Fedora Security Advisory FEDORA-2022-12b13cd79f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-12b13cd79f");

  script_name(english:"Fedora 36 : drupal7-context (2022-12b13cd79f)");
...
FEDORA-2022-12b13cd79f advisory.

    - https://www.drupal.org/project/context/releases/7.x-3.11
        - [SA-CONTRIB-2022-049](https://www.drupal.org/sa-contrib-2022-049)

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-12b13cd79f");
  script_set_attribute(attribute:"solution", value:
"Update the affected drupal7-context package.");
...
var pkgs = [
    {'reference':'drupal7-context-3.11-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
