...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : netpbm (EulerOS-SA-2021-2107)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2107
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4309bf10");
...
"Update the affected netpbm package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-2587");
...
pkgs = ["netpbm-10.79.00-7.h3",
        "netpbm-progs-10.79.00-7.h3"];
