...
# extracted from Fedora Security Advisory FEDORA-2025-4a832bf2b1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-4a832bf2b1");

  script_name(english:"Fedora 40 : xorg-x11-server-Xwayland (2025-4a832bf2b1)");
...
FEDORA-2025-4a832bf2b1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-4a832bf2b1");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-24.1.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
