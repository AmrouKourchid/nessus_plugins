...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Cluster 8.x < 8.2.0 (Oct 2023 CPU)");
...
October 2023 CPU advisory.
  ...
  - Vulnerability in the MySQL Cluster product of Oracle MySQL (component: Cluster: General (libxml2)). 
    ...
    (complete DOS) of MySQL Cluster. (CVE-2023-28484)

  - Vulnerability in the MySQL Cluster product of Oracle MySQL (component: Cluster: General (curl)). 
    Supported versions that are affected are 8.0.34 and prior and 8.1.0. Easily exploitable vulnerability 
    allows unauthenticated attacker with network access via multiple protocols to compromise MySQL Cluster. 
    Successful attacks of this vulnerability can result in takeover of MySQL Cluster. (CVE-2023-38545)
  ...
  - Vulnerability in the MySQL Cluster product of Oracle MySQL (component: Cluster: General (Kerberos)). 
    ...
    Successful attacks of this vulnerability can result in takeover of MySQL Cluster.(CVE-2022-42898)
...
mysql_check_version(variant:'Cluster', fixed:'8.2.0', min:'8.1.0', severity:SECURITY_HOLE);
