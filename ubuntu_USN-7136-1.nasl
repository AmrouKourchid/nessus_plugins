...
# extracted from Ubuntu Security Notice USN-7136-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7136-1");
  script_xref(name:"IAVA", value:"2024-A-0796-S");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 24.04 LTS / 24.10 : Django vulnerabilities (USN-7136-1)");
...
vulnerabilities as referenced in the USN-7136-1 advisory.

    jiangniao discovered that Django incorrectly handled the API to strip tags. A remote attacker could
    possibly use this issue to cause Django to consume resources, leading to a denial of service.
    (CVE-2024-53907)

    Seokchan Yoon discovered that Django incorrectly handled HasKey lookups when using Oracle. A remote
    attacker could possibly use this issue to inject arbitrary SQL code. This issue only affected Ubuntu 24.04
    LTS and Ubuntu 24.10. (CVE-2024-53908)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7136-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'python3-django', 'pkgver': '2:2.2.12-1ubuntu0.26'},
    {'osver': '22.04', 'pkgname': 'python3-django', 'pkgver': '2:3.2.12-2ubuntu1.15'},
    {'osver': '24.04', 'pkgname': 'python3-django', 'pkgver': '3:4.2.11-1ubuntu1.4'},
    {'osver': '24.10', 'pkgname': 'python3-django', 'pkgver': '3:4.2.15-1ubuntu1.1'}
];
