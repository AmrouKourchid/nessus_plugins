...
# openSUSE Security Update openSUSE-SU-2022:10185-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : EternalTerminal (openSUSE-SU-2022:10185-1)");
...
the openSUSE-SU-2022:10185-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/OHYD4A5UEJOUE57LY64OW2WI6GAVBOMR/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d960f843");
...
var pkgs = [
    {'reference':'EternalTerminal-6.2.1-bp154.2.3.1', 'cpu':'aarch64', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'EternalTerminal-6.2.1-bp154.2.3.1', 'cpu':'x86_64', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
