...
# extracted from Red Hat Security Advisory RHSA-2024:2730. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2730");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (collectd-sensubility) (RHSA-2024:2730)");
...
referenced in the RHSA-2024:2730 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2730.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4cf861a2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2730");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1 (collectd-sensubility) package based on the guidance in RHSA-2024:2730.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'collectd-sensubility-0.2.1-3.el9ost', 'cpu':'x86_64', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
