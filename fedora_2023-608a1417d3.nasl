...
# extracted from Fedora Security Advisory FEDORA-2023-608a1417d3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-608a1417d3");

  script_name(english:"Fedora 38 : nodejs16 (2023-608a1417d3)");
...
FEDORA-2023-608a1417d3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-608a1417d3");
...
var pkgs = [
    {'reference':'nodejs16-16.20.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
