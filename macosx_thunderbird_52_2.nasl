...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 52.2 Multiple Vulnerabilities (macOS)");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', fix:'52.2', severity:SECURITY_HOLE);
