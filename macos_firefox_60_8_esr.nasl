...
# extracted from Mozilla Foundation Security Advisory mfsa2019-22.
...
if (description)
{
  ...
  script_xref(name:"MFSA", value:"2019-22");

  script_name(english:"Mozilla Firefox ESR < 60.8");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 60.8. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2019-22 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2019-22/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Mozilla Firefox ESR version 60.8 or later.");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'60.8', min:'60.0.0', xss:TRUE, severity:SECURITY_HOLE);
