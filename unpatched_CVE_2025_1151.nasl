...
if (description)
{
  ...
  script_cve_id("CVE-2025-1151");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-1151");
...
patch available.
  ...
  - A vulnerability was found in GNU Binutils 2.43. It has been rated as problematic. This issue affects the
    function xmemdup of the file xmemdup.c of the component ld. The manipulation leads to memory leak. The
    attack may be initiated remotely. The complexity of an attack is rather high. The exploitation is known to
    ...
    leaks in this bugzilla have been fixed on binutils master. (CVE-2025-1151)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-1151");
