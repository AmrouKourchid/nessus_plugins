...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : xorg-x11-server (EulerOS-SA-2024-2067)");
...
remote host is affected by the following vulnerabilities :
    ...
    XSELINUX code will try to use an object that was never labeled and crash because the SID is
    NULL.(CVE-2024-0408)
...
Tenable has extracted the preceding description block directly from the EulerOS Virtualization xorg-x11-server security
advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2067
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38e4586e");
...
var pkgs = [
  "xorg-x11-server-Xephyr-1.20.1-4.h19.eulerosv2r8",
  "xorg-x11-server-Xorg-1.20.1-4.h19.eulerosv2r8",
  "xorg-x11-server-Xvfb-1.20.1-4.h19.eulerosv2r8",
  "xorg-x11-server-Xwayland-1.20.1-4.h19.eulerosv2r8",
  "xorg-x11-server-common-1.20.1-4.h19.eulerosv2r8"
];
