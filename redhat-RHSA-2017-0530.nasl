...
# extracted from Red Hat Security Advisory RHSA-2017:0530. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:0530");

  script_name(english:"RHEL 7 : rabbitmq-server (RHSA-2017:0530)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rabbitmq-server.");
...
the RHSA-2017:0530 advisory.
    ...
    * A resource-consumption flaw was found in RabbitMQ Server, where the lengths_age or lengths_incr
    parameters were not validated in the management plugin. Remote, authenticated users with certain
    privileges could exploit this flaw to cause a denial of service by passing values which were too large.
    (CVE-2015-8786)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1404150");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1405211");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_0530.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6aa71de0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:0530");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rabbitmq-server package based on the guidance in RHSA-2017:0530.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8786");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rabbitmq-server-3.3.5-31.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
