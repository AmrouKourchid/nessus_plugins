...
# extracted from Fedora Security Advisory FEDORA-2023-8d4b772755
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8d4b772755");

  script_name(english:"Fedora 37 : yarnpkg (2023-8d4b772755)");
...
FEDORA-2023-8d4b772755 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8d4b772755");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.19-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
