...
# extracted from Red Hat Security Advisory mingw-virt-viewer. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : mingw-virt-viewer (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-9636");
