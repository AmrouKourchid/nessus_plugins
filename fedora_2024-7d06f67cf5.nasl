...
# extracted from Fedora Security Advisory FEDORA-2024-7d06f67cf5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7d06f67cf5");

  script_name(english:"Fedora 39 : libgsf (2024-7d06f67cf5)");
...
FEDORA-2024-7d06f67cf5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7d06f67cf5");
...
var pkgs = [
    {'reference':'libgsf-1.14.53-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
