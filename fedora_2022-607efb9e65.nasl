...
# extracted from Fedora Security Advisory FEDORA-2022-607efb9e65
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-607efb9e65");

  script_name(english:"Fedora 37 : python3.9 (2022-607efb9e65)");
...
FEDORA-2022-607efb9e65 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-607efb9e65");
...
var pkgs = [
    {'reference':'python3.9-3.9.15-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
