...
if (description)
{
  ...
  script_cve_id("CVE-2021-28876", "CVE-2021-28878", "CVE-2021-28879");

  script_name(english:"Photon OS 3.0: Rust PHSA-2021-3.0-0228");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-28879");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'rust-1.51.0-2.ph3')) flag++;
