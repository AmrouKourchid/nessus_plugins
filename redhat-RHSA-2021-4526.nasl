...
# extracted from Red Hat Security Advisory RHSA-2021:4526. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4526");

  script_name(english:"RHEL 8 : mingw-glib2 (RHSA-2021:4526)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:4526 advisory.
    ...
    The following packages have been upgraded to a later upstream version: mingw-glib2 (2.66.7). (BZ#1935248,
    BZ#1939111)
    ...
    * glib: integer overflow in g_byte_array_new_take function when called with a buffer of 4GB or more on a
    64-bit platform (CVE-2021-27218)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4526.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f4c578e");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.5_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7240878e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4526");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mingw32-glib2-2.66.7-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-glib2-static-2.66.7-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-glib2-2.66.7-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-glib2-static-2.66.7-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
