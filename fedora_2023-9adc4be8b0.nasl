...
# extracted from Fedora Security Advisory FEDORA-2023-9adc4be8b0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9adc4be8b0");

  script_name(english:"Fedora 39 : mosquitto (2023-9adc4be8b0)");
...
FEDORA-2023-9adc4be8b0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9adc4be8b0");
...
var pkgs = [
    {'reference':'mosquitto-2.0.17-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
