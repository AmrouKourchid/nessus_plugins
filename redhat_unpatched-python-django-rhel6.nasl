...
# extracted from Red Hat Security Advisory python-django. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-9014", "CVE-2017-7233");

  script_name(english:"RHEL 6 : python-django (Unpatched Vulnerability) (deprecated)");
