...
therefore, affected by multiple vulnerabilities as referenced in the apsb20-45 advisory.
  ...
  - Security bypass potentially leading to Privilege Escalation (CVE-2020-9709)
...
"Upgrade to Adobe Photoshop version 20.0.10/21.2.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-9687");
...
var constraints = [
  { 'min_version' : '20.0.0', 'fixed_version' : '20.0.10' },
  { 'min_version' : '21.0.0', 'fixed_version' : '21.2.1' }
];
