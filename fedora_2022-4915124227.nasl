...
# extracted from Fedora Security Advisory FEDORA-2022-4915124227
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-4915124227");

  script_name(english:"Fedora 36 : ntfs-3g (2022-4915124227)");
...
FEDORA-2022-4915124227 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-4915124227");
...
var pkgs = [
    {'reference':'ntfs-3g-2022.10.3-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
