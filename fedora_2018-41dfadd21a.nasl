...
# extracted from Fedora Security Advisory FEDORA-2018-41dfadd21a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : 1:wpa_supplicant (2018-41dfadd21a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-41dfadd21a");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"wpa_supplicant-2.6-17.fc28", epoch:"1")) flag++;
