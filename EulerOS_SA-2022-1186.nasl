...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : qt (EulerOS-SA-2022-1186)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1186
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aaeb1757");
...
var pkgs = [
  "qt-4.8.5-13.h9",
  "qt-devel-4.8.5-13.h9",
  "qt-mysql-4.8.5-13.h9",
  "qt-odbc-4.8.5-13.h9",
  "qt-postgresql-4.8.5-13.h9",
  "qt-x11-4.8.5-13.h9"
];
