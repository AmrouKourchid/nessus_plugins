...
if (description)
{
  ...
  script_cve_id("CVE-2023-34044");
  script_xref(name:"VMSA", value:"2023-0022");
  script_xref(name:"IAVA", value:"2023-A-0576-S");

  script_name(english:"VMware Workstation 17.0.x < 17.5 Information Disclosure (VMSA-2023-0022)");
...
"VMware Workstation( 17.x prior to 17.5) contains an out-of-bounds read vulnerability that exists in the functionality
for sharing host Bluetooth devices with the virtual machine. A malicious actor with local administrative privileges
...
"Update to VMware Workstation version 17.5, or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-34044");
...
var constraints = [
  { 'min_version' : '17.0', 'fixed_version' : '17.5' }
];
