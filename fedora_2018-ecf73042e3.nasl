...
# extracted from Fedora Security Advisory FEDORA-2018-ecf73042e3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : 1:libuv / 1:nodejs (2018-ecf73042e3)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ecf73042e3");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libuv-1.19.2-1.fc27", epoch:"1")) flag++;
if (rpm_check(release:"FC27", reference:"nodejs-8.11.0-1.fc27", epoch:"1")) flag++;
