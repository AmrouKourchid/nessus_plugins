...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : curl (EulerOS-SA-2023-1496)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1496
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cabe54f5");
...
var pkgs = [
  "curl-7.29.0-46.h23.eulerosv2r7",
  "libcurl-7.29.0-46.h23.eulerosv2r7",
  "libcurl-devel-7.29.0-46.h23.eulerosv2r7"
];
