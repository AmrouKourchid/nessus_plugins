...
if (description)
{
  ...
  script_name(english:"CentOS 9 : python-lxml-4.6.5-1.el9");
...
lxml-4.6.5-1.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=16215");
...
var pkgs = [
    {'reference':'python3-lxml-4.6.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
