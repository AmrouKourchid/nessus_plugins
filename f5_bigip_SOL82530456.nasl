...
fails over to its high availability (HA) peer, if configured.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K82530456");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K82530456.");
...
var vmatrix = {
  'PEM': {
    ...
    'unaffected': [
      '16.1.0','16.0.1','15.1.1','14.1.2.8','13.1.3.5','12.1.5.3','11.6.5.3'
    ],
  }
};
