...
# extracted from Fedora Security Advisory FEDORA-2022-c3a65f7c65
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c3a65f7c65");

  script_name(english:"Fedora 37 : xorg-x11-server (2022-c3a65f7c65)");
...
FEDORA-2022-c3a65f7c65 advisory.

    CVE fixes for: CVE-2022-4283, CVE-2022-46340, CVE-2022-46341, CVE-2022-46342, CVE-2022-46343,
    CVE-2022-46344
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c3a65f7c65");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-11.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
