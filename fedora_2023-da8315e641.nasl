...
# extracted from Fedora Security Advisory FEDORA-2023-da8315e641
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-da8315e641");

  script_name(english:"Fedora 37 : xen (2023-da8315e641)");
...
FEDORA-2023-da8315e641 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-da8315e641");
...
var pkgs = [
    {'reference':'xen-4.16.3-4.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
