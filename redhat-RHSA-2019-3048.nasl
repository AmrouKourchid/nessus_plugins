...
# extracted from Red Hat Security Advisory RHSA-2019:3048. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3048");

  script_name(english:"RHEL 6 / 7 : RH-SSO 7.3.4 adapters for Enterprise Application Platform 6 (RHSA-2019:3048)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for RH-SSO 7.3.4 adapters for Enterprise Application Platform 6.");
...
in the RHSA-2019:3048 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3048.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b4308bc");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3048");
...
"Update the RHEL RH-SSO 7.3.4 adapters for Enterprise Application Platform 6 package based on the guidance in
RHSA-2019:3048.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:keycloak-adapter-sso7_3-eap6");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:keycloak-saml-adapter-sso7_3-eap6");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'keycloak-adapter-sso7_3-eap6-4.8.13-1.Final_redhat_00001.1.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'keycloak-saml-adapter-sso7_3-eap6-4.8.13-1.Final_redhat_00001.1.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'keycloak-adapter-sso7_3-eap6-4.8.13-1.Final_redhat_00001.1.ep6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'keycloak-saml-adapter-sso7_3-eap6-4.8.13-1.Final_redhat_00001.1.ep6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'keycloak-adapter-sso7_3-eap6 / keycloak-saml-adapter-sso7_3-eap6');
}
