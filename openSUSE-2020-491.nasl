...
# extracted from openSUSE Security Update openSUSE-2020-491.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : exim (openSUSE-2020-491)");
...
"This update for exim fixes the following issues :
  ...
  - CVE-2020-8015: Fixed a local privilege escalation from
    user mail to root (boo#1154183).");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1154183");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1160726");
...
if ( rpm_check(release:"SUSE15.1", reference:"exim-4.88-lp151.4.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"exim-debuginfo-4.88-lp151.4.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"exim-debugsource-4.88-lp151.4.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"eximon-4.88-lp151.4.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"eximon-debuginfo-4.88-lp151.4.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"eximstats-html-4.88-lp151.4.12.1") ) flag++;
