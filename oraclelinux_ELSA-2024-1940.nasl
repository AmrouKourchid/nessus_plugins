...
# extracted from Oracle Linux Security Advisory ELSA-2024-1940.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : owO: / thunderbird (ELSA-2024-1940)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1940.html");
...
var pkgs = [
    {'reference':'thunderbird-115.10.0-2.0.1.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.10.0-2.0.1.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
