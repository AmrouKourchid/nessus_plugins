...
if (description)
{
  ...
  script_cve_id("CVE-2023-39410");
  script_xref(name:"IAVA", value:"2024-A-0175-S");

  script_name(english:"Atlassian Confluence 4.1.x < 7.19.17 / 8.0.x < 8.5.4 / 8.6.x < 8.6.2 / 8.7.x < 8.7.2 / 8.8.0 (CONFSERVER-94108)");
...
the CONFSERVER-94108 advisory.

  - This High severity org.apache.avro:avro Dependency vulnerability was introduced in versions 4.1 of 
    Confluence Data Center and Server. (CVE-2023-39410)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-94108");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Atlassian Confluence version 7.19.17, 8.5.4, 8.6.2, 8.7.2, 8.8.0 or later.");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-39410");
...
var constraints = [
  { 'min_version' : '4.1', 'max_version' : '7.17.5', 'fixed_display' : '7.19.19' },
  { 'min_version' : '7.18.0', 'max_version' : '7.18.3', 'fixed_display' : '7.19.19' },
  { 'min_version' : '7.19.0', 'max_version' : '7.19.16', 'fixed_display' : '7.19.17 / 7.19.18 / 7.19.19' }, 
  ...
  { 'min_version' : '8.6.0', 'max_version' : '8.6.1', 'fixed_display' : '8.6.2 / 8.8.0 (Data Center Only)' },
