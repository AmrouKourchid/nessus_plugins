...
# extracted from Fedora Security Advisory FEDORA-2023-30f824b8b8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-30f824b8b8");

  script_name(english:"Fedora 36 : libreswan (2023-30f824b8b8)");
...
FEDORA-2023-30f824b8b8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-30f824b8b8");
...
var pkgs = [
    {'reference':'libreswan-4.11-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
