...
# extracted from Fedora Security Advisory FEDORA-2023-9ff7fd16a0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9ff7fd16a0");

  script_name(english:"Fedora 38 : community-mysql (2023-9ff7fd16a0)");
...
FEDORA-2023-9ff7fd16a0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9ff7fd16a0");
...
var pkgs = [
    {'reference':'community-mysql-8.0.35-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
