...
# extracted from Red Hat Security Advisory RHSA-2023:2076. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2076");

  script_name(english:"RHEL 8 : libwebp (RHSA-2023:2076)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libwebp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:2076 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2076.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ac0258d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2186102");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2076");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libwebp package based on the guidance in RHSA-2023:2076.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libwebp-1.0.0-8.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-devel-1.0.0-8.el8_7', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
