...
# extracted from Fedora Security Advisory FEDORA-2024-8382d1b267
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8382d1b267");

  script_name(english:"Fedora 40 : zabbix (2024-8382d1b267)");
...
FEDORA-2024-8382d1b267 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8382d1b267");
...
"Update the affected 1:zabbix package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-22122");
...
var pkgs = [
    {'reference':'zabbix-6.0.33-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
