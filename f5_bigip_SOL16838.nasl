...
# extracted from F5 Networks BIG-IP Solution K16838.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2015-1470");

  script_name(english:"F5 Networks BIG-IP : XSS vulnerability in the BIG-IP and Enterprise Manager Configuration utilities (K16838)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"Using the BIGIPAuthUsernameCookie value with /tmui/login.jsp can
expose a cross-site scripting (XSS) security flaw. (CVE-2015-1470)");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K16838");
