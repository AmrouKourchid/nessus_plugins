...
# extracted from Red Hat Security Advisory RHSA-2023:7376. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7376");

  script_name(english:"RHEL 9 : libqb (RHSA-2023:7376)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7376.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d320500");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2230708");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7376");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libqb package based on the guidance in RHSA-2023:7376.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libqb-2.0.6-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libqb-devel-2.0.6-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
