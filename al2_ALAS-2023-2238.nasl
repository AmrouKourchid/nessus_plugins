...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2238.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : amazon-ssm-agent (ALAS-2023-2238)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of amazon-ssm-agent installed on the remote host is prior to 3.2.1377.0-1. It is, therefore, affected by
multiple vulnerabilities as referenced in the ALAS2-2023-2238 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2238.html");
...
var pkgs = [
    {'reference':'amazon-ssm-agent-3.2.1377.0-1.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ssm-agent-3.2.1377.0-1.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ssm-agent-debuginfo-3.2.1377.0-1.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ssm-agent-debuginfo-3.2.1377.0-1.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
