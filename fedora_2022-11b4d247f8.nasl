...
# extracted from Fedora Security Advisory FEDORA-2022-11b4d247f8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-11b4d247f8");

  script_name(english:"Fedora 36 : admesh (2022-11b4d247f8)");
...
FEDORA-2022-11b4d247f8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-11b4d247f8");
...
var pkgs = [
    {'reference':'admesh-0.98.5-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
