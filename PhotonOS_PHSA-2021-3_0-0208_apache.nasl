...
# extracted from VMware Security Advisory PHSA-2021-3.0-0208. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Apache PHSA-2021-3.0-0208");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the apache package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-208.md");
...
if (rpm_check(release:'PhotonOS-3.0', reference:'apache-tomcat-8.5.60-2.ph3')) flag++;
