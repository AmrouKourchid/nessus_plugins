...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : qemu-guest-agent / qemu-img / qemu-kvm / etc (VZLSA-2020-4056)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Virtuozzo host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in the RHSA-2020:4056 advisory.
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2020-4056.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?afef8035");
...
pkgs = ["qemu-guest-agent-0.12.1.2-2.506.vl6.8",
        "qemu-img-0.12.1.2-2.506.vl6.8",
        "qemu-kvm-0.12.1.2-2.506.vl6.8",
        "qemu-kvm-tools-0.12.1.2-2.506.vl6.8"];
