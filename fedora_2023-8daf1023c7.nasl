...
# extracted from Fedora Security Advisory FEDORA-2023-8daf1023c7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8daf1023c7");

  script_name(english:"Fedora 38 : libtiff (2023-8daf1023c7)");
...
FEDORA-2023-8daf1023c7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8daf1023c7");
...
var pkgs = [
    {'reference':'libtiff-4.4.0-8.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
