...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : gnutls (EulerOS-SA-2019-1743)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1743
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?93b0ed70");
...
pkgs = ["gnutls-3.3.26-9.h5",
        "gnutls-c++-3.3.26-9.h5",
        "gnutls-dane-3.3.26-9.h5",
        "gnutls-devel-3.3.26-9.h5",
        "gnutls-utils-3.3.26-9.h5"];
