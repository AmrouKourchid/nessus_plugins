...
# extracted from Debian Security Advisory dla-3728. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3728 : openjdk-11-dbg - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'openjdk-11-dbg', 'reference': '11.0.22+7-1~deb10u1'},
    {'release': '10.0', 'prefix': 'openjdk-11-demo', 'reference': '11.0.22+7-1~deb10u1'},
    {'release': '10.0', 'prefix': 'openjdk-11-doc', 'reference': '11.0.22+7-1~deb10u1'},
    {'release': '10.0', 'prefix': 'openjdk-11-jdk', 'reference': '11.0.22+7-1~deb10u1'},
    {'release': '10.0', 'prefix': 'openjdk-11-jdk-headless', 'reference': '11.0.22+7-1~deb10u1'},
    {'release': '10.0', 'prefix': 'openjdk-11-jre', 'reference': '11.0.22+7-1~deb10u1'},
    {'release': '10.0', 'prefix': 'openjdk-11-jre-headless', 'reference': '11.0.22+7-1~deb10u1'},
    {'release': '10.0', 'prefix': 'openjdk-11-jre-zero', 'reference': '11.0.22+7-1~deb10u1'},
    {'release': '10.0', 'prefix': 'openjdk-11-source', 'reference': '11.0.22+7-1~deb10u1'}
];
