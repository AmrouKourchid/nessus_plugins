...
the RHSA-2017:3263 advisory.
    ...
    * A buffer overrun flaw was found in the IMAP handler of libcurl. By tricking an unsuspecting user into
    connecting to a malicious IMAP server, an attacker could exploit this flaw to potentially cause
    information disclosure or crash the application. (CVE-2017-1000257)

    Red Hat would like to thank the Curl project for reporting this issue. Upstream acknowledges Brian
    Carpenter and the OSS-Fuzz project as the original reporters.

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_3263.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?78972681");
  script_set_attribute(attribute:"see_also", value:"https://curl.haxx.se/docs/adv_20171023.html");
...
"Update the RHEL curl package based on the guidance in RHSA-2017:3263.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'curl-7.29.0-42.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-7.29.0-42.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-devel-7.29.0-42.el7_4.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
