...
# extracted from Red Hat Security Advisory RHSA-2021:3493. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3493");

  script_name(english:"RHEL 8 : cyrus-imapd (RHSA-2021:3493)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for cyrus-imapd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:3493 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3493.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bbcbd438");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3493");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1993232");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cyrus-imapd package based on the guidance in RHSA-2021:3493.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cyrus-imapd-3.0.7-16.el8_2.1', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cyrus-imapd-utils-3.0.7-16.el8_2.1', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cyrus-imapd-vzic-3.0.7-16.el8_2.1', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
