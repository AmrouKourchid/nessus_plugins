...
the RHSA-2021:0473 advisory.
    ...
    .NET SDK 5.0.103 and .NET Runtime 5.0.3.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0473.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fa7154e2");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet50-aspnetcore-runtime-5.0-5.0.3-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-aspnetcore-targeting-pack-5.0-5.0.3-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-5.0.103-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-apphost-pack-5.0-5.0.3-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-host-5.0.3-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-hostfxr-5.0-5.0.3-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-runtime-5.0-5.0.3-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-sdk-5.0-5.0.103-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-targeting-pack-5.0-5.0.3-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-templates-5.0-5.0.103-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-netstandard-targeting-pack-2.1-5.0.103-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'}
    ]
  }
];
