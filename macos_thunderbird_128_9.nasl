...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 128.9");

  script_set_attribute(attribute:"synopsis", value:
"A mail client installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 128.9. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2025-24 advisory.
...
"Upgrade to Mozilla Thunderbird version 128.9 or later.");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'128.9', severity:SECURITY_WARNING);
