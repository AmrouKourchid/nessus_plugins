...
if (description)
{
  ...
  script_name(english:"CentOS 9 : libnbd-1.12.4-3.el9");
...
libnbd-1.12.4-3.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=23581");
...
var pkgs = [
    {'reference':'libnbd-1.12.4-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libnbd-bash-completion-1.12.4-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libnbd-devel-1.12.4-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nbdfuse-1.12.4-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ocaml-libnbd-1.12.4-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ocaml-libnbd-devel-1.12.4-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-libnbd-1.12.4-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
