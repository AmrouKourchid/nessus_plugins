...
# extracted from Fedora Security Advisory FEDORA-2022-88252e4f80
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-88252e4f80");

  script_name(english:"Fedora 37 : weechat (2022-88252e4f80)");
...
FEDORA-2022-88252e4f80 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-88252e4f80");
...
var pkgs = [
    {'reference':'weechat-3.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
