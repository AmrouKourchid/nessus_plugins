...
# SUSE update advisory SUSE-SU-2023:2455-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2455-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 3 for SLE 15 SP4) (SUSE-SU-2023:2455-1)");
...
the SUSE-SU-2023:2455-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/029779.html");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.24.21-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_21-default-10-150400.2.3', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      }
    }
  }
