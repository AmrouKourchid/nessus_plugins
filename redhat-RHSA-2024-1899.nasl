...
# extracted from Red Hat Security Advisory RHSA-2024:1899. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1899");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.12.56 (RHSA-2024:1899)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.12.56.");
...
in the RHSA-2024:1899 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.56. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c34e6b22");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1899");
...
"Update the RHEL OpenShift Container Platform 4.12.56 package based on the guidance in RHSA-2024:1899.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.12.0-202404161006.p0.g054f0ba.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.12.0-202404161006.p0.g054f0ba.assembly.stream.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
