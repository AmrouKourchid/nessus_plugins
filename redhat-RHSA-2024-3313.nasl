...
# extracted from Red Hat Security Advisory RHSA-2024:3313. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3313");

  script_name(english:"RHEL 8 : postgresql-jdbc (RHSA-2024:3313)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for postgresql-jdbc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3313 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2266523");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3313.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af4d1822");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3313");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql-jdbc package based on the guidance in RHSA-2024:3313.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postgresql-jdbc-42.2.14-5.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-jdbc-javadoc-42.2.14-5.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
