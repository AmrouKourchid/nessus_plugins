...
# extracted from Debian Security Advisory dla-4032. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-7250", "CVE-2024-26306", "CVE-2024-53580");

  script_name(english:"Debian dla-4032 : iperf3 - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-7250");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-26306");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-53580");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'iperf3', 'reference': '3.9-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libiperf-dev', 'reference': '3.9-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libiperf0', 'reference': '3.9-1+deb11u2'}
];
