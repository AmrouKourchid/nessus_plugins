...
# extracted from Fedora Security Advisory FEDORA-2024-83fc86a0bc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-83fc86a0bc");

  script_name(english:"Fedora 40 : plasma-workspace (2024-83fc86a0bc)");
...
FEDORA-2024-83fc86a0bc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-83fc86a0bc");
...
var pkgs = [
    {'reference':'plasma-workspace-6.0.5.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
