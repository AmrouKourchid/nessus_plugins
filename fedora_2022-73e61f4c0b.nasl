...
# extracted from Fedora Security Advisory FEDORA-2022-73e61f4c0b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-73e61f4c0b");

  script_name(english:"Fedora 35 : drupal7-i18n (2022-73e61f4c0b)");
...
FEDORA-2022-73e61f4c0b advisory.
    ...
    - https://www.drupal.org/project/i18n/releases/7.x-1.27
        - [SA-CONTRIB-2020-025](https://www.drupal.org/sa-contrib-2020-025)

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-73e61f4c0b");
  script_set_attribute(attribute:"solution", value:
"Update the affected drupal7-i18n package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:drupal7-i18n");
...
var pkgs = [
    {'reference':'drupal7-i18n-1.31-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'drupal7-i18n');
}
