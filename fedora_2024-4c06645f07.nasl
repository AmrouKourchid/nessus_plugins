...
# extracted from Fedora Security Advisory FEDORA-2024-4c06645f07
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4c06645f07");

  script_name(english:"Fedora 39 : git (2024-4c06645f07)");
...
FEDORA-2024-4c06645f07 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4c06645f07");
...
var pkgs = [
    {'reference':'git-2.45.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
