...
# extracted from Amazon Linux 2 Security Advisory ALAS-2025-2846.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python3-requests (ALAS-2025-2846)");
...
vulnerability as referenced in the ALAS2-2025-2846 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2025-2846.html");
...
var pkgs = [
    {'reference':'python3-requests-2.14.2-2.amzn2.0.4', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
