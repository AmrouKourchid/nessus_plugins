...
# extracted from Gentoo Linux Security Advisory GLSA 202006-13.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202006-13");

  script_name(english:"GLSA-202006-13 : json-c: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202006-13
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202006-13");
...
if (qpkg_check(package:"dev-libs/json-c", unaffected:make_list("ge 0.14-r3"), vulnerable:make_list("lt 0.14-r3"))) flag++;
