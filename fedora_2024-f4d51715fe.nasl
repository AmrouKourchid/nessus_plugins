...
# extracted from Fedora Security Advisory FEDORA-2024-f4d51715fe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f4d51715fe");

  script_name(english:"Fedora 38 : mingw-openexr (2024-f4d51715fe)");
...
FEDORA-2024-f4d51715fe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f4d51715fe");
...
var pkgs = [
    {'reference':'mingw-openexr-3.1.10-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
