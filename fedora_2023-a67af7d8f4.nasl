...
# extracted from Fedora Security Advisory FEDORA-2023-a67af7d8f4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a67af7d8f4");

  script_name(english:"Fedora 39 : python-django (2023-a67af7d8f4)");
...
FEDORA-2023-a67af7d8f4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a67af7d8f4");
...
var pkgs = [
    {'reference':'python-django-4.2.6-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
