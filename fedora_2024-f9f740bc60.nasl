...
# extracted from Fedora Security Advisory FEDORA-2024-f9f740bc60
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f9f740bc60");
  script_xref(name:"IAVB", value:"2024-B-0185-S");

  script_name(english:"Fedora 41 : wireshark (2024-f9f740bc60)");
...
FEDORA-2024-f9f740bc60 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f9f740bc60");
...
var pkgs = [
    {'reference':'wireshark-4.4.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
