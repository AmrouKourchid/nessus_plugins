...
# extracted from VMware Security Advisory PHSA-2025-4.0-0793. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Expat PHSA-2025-4.0-0793");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the expat package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-793.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'expat-2.7.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'expat-devel-2.7.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'expat-docs-2.7.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'expat-libs-2.7.1-1.ph4')) flag++;
