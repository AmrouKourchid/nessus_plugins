...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : dhcp (EulerOS-SA-2025-1152)");
...
following vulnerabilities :
    ...
    also when handling client queries for this name.(CVE-2024-1737)
    ...
    sending a stream of SIG(0) signed requests.(CVE-2024-1975)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1152
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b0cfe18c");
...
var pkgs = [
  "dhcp-4.4.2-13.h11.eulerosv2r11"
];
