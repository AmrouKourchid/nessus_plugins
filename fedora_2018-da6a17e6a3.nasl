...
# extracted from Fedora Security Advisory FEDORA-2018-da6a17e6a3.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-da6a17e6a3");

  script_name(english:"Fedora 28 : gnupg2 (2018-da6a17e6a3)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-da6a17e6a3");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"gnupg2-2.2.6-1.fc28")) flag++;
