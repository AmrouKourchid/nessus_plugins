...
"It is, therefore, affected by a vulnerability as referenced in the ALAS-2022-1648 advisory.
    ...
    A flaw was found in the rubygem-nokogiri package. This flaw allows malicious users to change partial
    contents or configurations on the system. Additionally, this vulnerability can also cause a limited denial
    of service in the form of interruptions in resource availability. (CVE-2022-29181)
