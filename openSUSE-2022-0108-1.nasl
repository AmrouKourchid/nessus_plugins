...
# openSUSE Security Update openSUSE-SU-2022:0108-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : java-1_8_0-ibm (openSUSE-SU-2022:0108-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the openSUSE-SU-2022:0108-1 advisory.
  ...
  - Vulnerability in the Java SE product of Oracle Java SE (component: Deployment). The supported version that
    ...
    Vector: (CVSS:3.1/AV:N/AC:H/PR:N/UI:R/S:U/C:H/I:H/A:H). (CVE-2021-35560)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dbe9d5dd");
...
var pkgs = [
    {'reference':'java-1_8_0-ibm-1.8.0_sr7.0-3.53.1', 'cpu':'s390x', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-1_8_0-ibm-1.8.0_sr7.0-3.53.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-1_8_0-ibm-32bit-1.8.0_sr7.0-3.53.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-1_8_0-ibm-alsa-1.8.0_sr7.0-3.53.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-1_8_0-ibm-demo-1.8.0_sr7.0-3.53.1', 'cpu':'s390x', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-1_8_0-ibm-demo-1.8.0_sr7.0-3.53.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-1_8_0-ibm-devel-1.8.0_sr7.0-3.53.1', 'cpu':'s390x', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-1_8_0-ibm-devel-1.8.0_sr7.0-3.53.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-1_8_0-ibm-devel-32bit-1.8.0_sr7.0-3.53.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-1_8_0-ibm-plugin-1.8.0_sr7.0-3.53.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-1_8_0-ibm-src-1.8.0_sr7.0-3.53.1', 'cpu':'s390x', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'java-1_8_0-ibm-src-1.8.0_sr7.0-3.53.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
