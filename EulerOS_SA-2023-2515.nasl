...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : openssl (EulerOS-SA-2023-2515)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2515
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c1a7565");
...
var pkgs = [
  "openssl-1.1.1f-7.h33.eulerosv2r9",
  "openssl-libs-1.1.1f-7.h33.eulerosv2r9",
  "openssl-perl-1.1.1f-7.h33.eulerosv2r9"
];
