...
# extracted from Fedora Security Advisory FEDORA-2023-25617e952a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-25617e952a");

  script_name(english:"Fedora 37 : tpm2-tss (2023-25617e952a)");
...
FEDORA-2023-25617e952a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-25617e952a");
...
var pkgs = [
    {'reference':'tpm2-tss-3.2.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
