...
# extracted from Fedora Security Advisory FEDORA-2019-5b062c4a3b.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : mingw-OpenEXR / mingw-ilmbase (2019-5b062c4a3b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5b062c4a3b");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-OpenEXR and / or mingw-ilmbase packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mingw-ilmbase");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mingw-OpenEXR-2.3.0-3.fc31")) flag++;
if (rpm_check(release:"FC31", reference:"mingw-ilmbase-2.3.0-3.fc31")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "mingw-OpenEXR / mingw-ilmbase");
}
