...
var appstreams = {
    'pki-core:10.6': [
      ...
      {'reference':'jss-4.9.3-1.module_el8.6.0+2764+9fc58d50', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jss-javadoc-4.9.3-1.module_el8.6.0+2764+9fc58d50', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-symkey-10.12.0-2.module_el8.6.0+2764+9fc58d50', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-tools-10.12.0-2.module_el8.6.0+2764+9fc58d50', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
