...
if (description)
{
  ...
  script_name(english:"NuGet Package 'BotSharp.Core' Detection");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.nuget.org/packages/BotSharp.Core/");
  script_set_attribute(attribute:"solution", value:
"The BotSharp.Core package is installed on the remote host.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:scisharp:botsharp.core");
...
var app_info = vcf::nuget_package::get_app_info(pkg_name:"BotSharp.Core");
app_info.vendor = "SciSharp";
app_info.cpe = "cpe:/a:scisharp:botsharp.core";
