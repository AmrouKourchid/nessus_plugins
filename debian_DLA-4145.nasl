...
# extracted from Debian Security Advisory dla-4145. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4145 : expat - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4145
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-50602");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'expat', 'reference': '2.2.10-2+deb11u7'},
    {'release': '11.0', 'prefix': 'libexpat1', 'reference': '2.2.10-2+deb11u7'},
    {'release': '11.0', 'prefix': 'libexpat1-dev', 'reference': '2.2.10-2+deb11u7'},
    {'release': '11.0', 'prefix': 'libexpat1-udeb', 'reference': '2.2.10-2+deb11u7'}
];
