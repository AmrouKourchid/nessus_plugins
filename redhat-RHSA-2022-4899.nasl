...
# extracted from Red Hat Security Advisory RHSA-2022:4899. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:4899");

  script_name(english:"RHEL 9 : compat-openssl11 (RHSA-2022:4899)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for compat-openssl11.");
...
the RHSA-2022:4899 advisory.

    OpenSSL is a toolkit that implements the Secure Sockets Layer (SSL) and Transport Layer Security (TLS)
    protocols, as well as a full-strength general-purpose cryptography library. compat-openssl11 provides the
    legacy 1.1 version of OpenSSL for use with older binaries.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4899.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c488ecf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4899");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2062202");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL compat-openssl11 package based on the guidance in RHSA-2022:4899.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'compat-openssl11-1.1.1k-4.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'compat-openssl11-1.1.1k-4.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
