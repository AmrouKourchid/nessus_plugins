...
# extracted from Red Hat Security Advisory RHSA-2020:4265. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4265");

  script_name(english:"RHEL 7 : OpenShift Container Platform 4.3.40 jenkins-2-plugins (RHSA-2020:4265)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.3.40
jenkins-2-plugins.");
...
referenced in the RHSA-2020:4265 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4265.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c2aa850");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4265");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1861842");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.3.40 jenkins-2-plugins package based on the guidance in RHSA-2020:4265.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.3.1601981312-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
