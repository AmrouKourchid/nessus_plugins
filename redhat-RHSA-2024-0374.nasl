...
# extracted from Red Hat Security Advisory RHSA-2024:0374. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0374");

  script_name(english:"RHEL 8 : python-pip (RHSA-2024:0374)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-pip.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:0374 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0374.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ce987510");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=263261");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0374");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-pip package based on the guidance in RHSA-2024:0374.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'platform-python-pip-9.0.3-22.1.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pip-9.0.3-22.1.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pip-wheel-9.0.3-22.1.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
