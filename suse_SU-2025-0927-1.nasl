...
# SUSE update advisory SUSE-SU-2025:0927-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2022-48911", "CVE-2024-46818", "CVE-2024-50302");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/03/25");
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0927-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 59 for SLE 12 SP5) (SUSE-SU-2025:0927-1)");
...
the SUSE-SU-2025:0927-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-March/020550.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2b7216b");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.225-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_225-default-6-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      }
    }
  }
