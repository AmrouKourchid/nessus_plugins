...
# extracted from openSUSE Security Update openSUSE-2020-1141.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : targetcli-fb (openSUSE-2020-1141)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1172743");
  script_set_attribute(attribute:"solution", value:
"Update the affected targetcli-fb packages.");
...
if ( rpm_check(release:"SUSE15.1", reference:"python2-targetcli-fb-2.1.49-lp151.2.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-targetcli-fb-2.1.49-lp151.2.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"targetcli-fb-common-2.1.49-lp151.2.10.1") ) flag++;
