...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Unbound PHSA-2024-4.0-0565");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'unbound-1.16.3-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'unbound-devel-1.16.3-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'unbound-docs-1.16.3-1.ph4')) flag++;
