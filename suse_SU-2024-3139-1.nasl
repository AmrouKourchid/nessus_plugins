...
# SUSE update advisory SUSE-SU-2024:3139-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:3139-1");
  script_xref(name:"IAVA", value:"2024-A-0540-S");

  script_name(english:"openSUSE 15 Security Update : python-Django (SUSE-SU-2024:3139-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-September/019372.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?79d5728a");
...
var pkgs = [
    {'reference':'python3-Django-2.0.7-150000.1.33.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
