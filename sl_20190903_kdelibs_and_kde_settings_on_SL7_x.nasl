...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : kdelibs and kde-settings on SL7.x x86_64 (20190903)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Scientific Linux host is missing one or more security
updates.");
  script_set_attribute(attribute:"description", value:
"- kdelibs: malicious desktop files and configuration files
    lead to code&#13; execution with minimal user
    interaction (CVE-2019-14744)&#13; &#13; Bug
    Fix(es):&#13; &#13;

  - kde.csh profile file contains bourne-shell code&#13;
    --&#13;");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1909&L=SCIENTIFIC-LINUX-ERRATA&P=8014
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18200c77");
...
flag = 0;
if (rpm_check(release:"SL7", reference:"kde-settings-19-23.10.el7_7")) flag++;
if (rpm_check(release:"SL7", reference:"kde-settings-ksplash-19-23.10.el7_7")) flag++;
if (rpm_check(release:"SL7", reference:"kde-settings-minimal-19-23.10.el7_7")) flag++;
if (rpm_check(release:"SL7", reference:"kde-settings-plasma-19-23.10.el7_7")) flag++;
if (rpm_check(release:"SL7", reference:"kde-settings-pulseaudio-19-23.10.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"kdelibs-4.14.8-11.el7_7")) flag++;
if (rpm_check(release:"SL7", reference:"kdelibs-apidocs-4.14.8-11.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"kdelibs-common-4.14.8-11.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"kdelibs-debuginfo-4.14.8-11.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"kdelibs-devel-4.14.8-11.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"kdelibs-ktexteditor-4.14.8-11.el7_7")) flag++;
if (rpm_check(release:"SL7", reference:"qt-settings-19-23.10.el7_7")) flag++;
