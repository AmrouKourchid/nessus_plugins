...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : samba (EulerOS-SA-2021-2168)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2168
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a25f35ff");
...
pkgs = ["libsmbclient-4.7.1-9.h24.eulerosv2r7",
        "libwbclient-4.7.1-9.h24.eulerosv2r7",
        "samba-client-libs-4.7.1-9.h24.eulerosv2r7",
        "samba-common-4.7.1-9.h24.eulerosv2r7",
        "samba-common-libs-4.7.1-9.h24.eulerosv2r7",
        "samba-common-tools-4.7.1-9.h24.eulerosv2r7",
        "samba-libs-4.7.1-9.h24.eulerosv2r7"];
