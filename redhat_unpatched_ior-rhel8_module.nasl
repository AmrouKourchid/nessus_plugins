...
# extracted from Red Hat Security Advisory ior. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-3114", "CVE-2022-30629");

  script_name(english:"RHEL 8 : ior (Unpatched Vulnerability) (deprecated)");
