...
# extracted from Fedora Security Advisory FEDORA-2025-858cec7479
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-858cec7479");

  script_name(english:"Fedora 40 : java-17-openjdk (2025-858cec7479)");
...
FEDORA-2025-858cec7479 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-858cec7479");
...
var pkgs = [
    {'reference':'java-17-openjdk-17.0.15.0.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
