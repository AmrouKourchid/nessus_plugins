...
if (description)
{
  ...
  script_name(english:"Microsoft Windows Server 2012 SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows Server 2012 is no longer maintained by its vendor or provider.
...
"Upgrade to a version of Microsoft Windows that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2023/10/10");
...
var os = ucf::get_os_cpe(vendor:'microsoft', product:'windows_server_2012', type:'local');

var constraints = [
  { eseol : 20261013, seol : 20231010 }
];
