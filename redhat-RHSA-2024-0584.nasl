...
# extracted from Red Hat Security Advisory RHSA-2024:0584. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0584");

  script_name(english:"RHEL 8 : libmicrohttpd (RHSA-2024:0584)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libmicrohttpd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:0584 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0584.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b702339d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2174313");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0584");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libmicrohttpd package based on the guidance in RHSA-2024:0584.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libmicrohttpd-0.9.59-2.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libmicrohttpd-devel-0.9.59-2.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libmicrohttpd-doc-0.9.59-2.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
