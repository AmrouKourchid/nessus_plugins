...
# extracted from Fedora Security Advisory FEDORA-2022-68134abd68
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-68134abd68");

  script_name(english:"Fedora 37 : python3.9 (2022-68134abd68)");
...
FEDORA-2022-68134abd68 advisory.

    Automatic update for python3.9-3.9.13-2.fc37.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-68134abd68");
...
var pkgs = [
    {'reference':'python3.9-3.9.13-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
