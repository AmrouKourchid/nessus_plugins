...
if (description)
{
  ...
  script_name(english:"Red Hat Enterprise Linux SEoL (8.0.x <= x <= 8.3.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Red Hat Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Red Hat Enterprise Linux is between 8.0.x and 8.3.x. It is, therefore, no longer maintained by
...
"Upgrade to a version of Red Hat Enterprise Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2022/04/30");
...
var constraints = [
  { max_branch : '8.3', min_branch : '8.0', eseol : 20240730, seol : 20220430 }
];
