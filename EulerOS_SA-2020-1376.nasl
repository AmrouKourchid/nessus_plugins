...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : curl (EulerOS-SA-2020-1376)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1376
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6c0f1694");
...
pkgs = ["curl-7.29.0-35.h29",
        "libcurl-7.29.0-35.h29",
        "libcurl-devel-7.29.0-35.h29"];
