...
# extracted from Debian Security Advisory dla-3547. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3547 : tryton-server - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3547
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3547-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/               Santiago Ruano Rincn
    August 29, 2023                               https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : tryton-server
    Version        : 5.0.4-2+deb10u2

    Edbo and Cedric Krier discovered that the Tryton application server does
...
var pkgs = [
    {'release': '10.0', 'prefix': 'tryton-server', 'reference': '5.0.4-2+deb10u2'},
    {'release': '10.0', 'prefix': 'tryton-server-doc', 'reference': '5.0.4-2+deb10u2'}
];
