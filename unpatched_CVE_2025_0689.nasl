...
if (description)
{
  ...
  script_cve_id("CVE-2025-0689");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-0689");
...
patch available.
  ...
  - When reading data from disk, the grub's UDF filesystem module utilizes the user controlled data length
    ...
    to be corrupted, resulting in the risk of arbitrary code execution by-passing secure boot protections.
    (CVE-2025-0689)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-0689");
