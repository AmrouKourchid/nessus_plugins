...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : spice (EulerOS-SA-2022-1146)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the spice package installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1146
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9469ef7");
...
var pkgs = [
  "spice-server-0.14.0-6.1.h2.eulerosv2r7"
];
