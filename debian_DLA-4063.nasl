...
# extracted from Debian Security Advisory dla-4063. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4063 : gnutls-bin - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4063
advisory.
...
var pkgs = [
    {'release': '11.0', 'prefix': 'gnutls-bin', 'reference': '3.7.1-5+deb11u7'},
    {'release': '11.0', 'prefix': 'gnutls-doc', 'reference': '3.7.1-5+deb11u7'},
    {'release': '11.0', 'prefix': 'guile-gnutls', 'reference': '3.7.1-5+deb11u7'},
    {'release': '11.0', 'prefix': 'libgnutls-dane0', 'reference': '3.7.1-5+deb11u7'},
    {'release': '11.0', 'prefix': 'libgnutls-openssl27', 'reference': '3.7.1-5+deb11u7'},
    {'release': '11.0', 'prefix': 'libgnutls28-dev', 'reference': '3.7.1-5+deb11u7'},
    {'release': '11.0', 'prefix': 'libgnutls30', 'reference': '3.7.1-5+deb11u7'},
    {'release': '11.0', 'prefix': 'libgnutlsxx28', 'reference': '3.7.1-5+deb11u7'}
];
