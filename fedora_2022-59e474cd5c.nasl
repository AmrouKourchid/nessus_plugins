...
# extracted from Fedora Security Advisory FEDORA-2022-59e474cd5c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-59e474cd5c");

  script_name(english:"Fedora 36 : firefox (2022-59e474cd5c)");
...
FEDORA-2022-59e474cd5c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-59e474cd5c");
...
var pkgs = [
    {'reference':'firefox-102.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
