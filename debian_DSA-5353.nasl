...
# extracted from Debian Security Advisory dsa-5353. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5353-1 : nss - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5353
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5353");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libnss3', 'reference': '2:3.61-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libnss3-dev', 'reference': '2:3.61-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libnss3-tools', 'reference': '2:3.61-1+deb11u3'}
];
