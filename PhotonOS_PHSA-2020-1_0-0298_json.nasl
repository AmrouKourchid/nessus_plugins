...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Json PHSA-2020-1.0-0298");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"json-c-0.13.1-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"json-c-devel-0.13.1-1.ph1")) flag++;
