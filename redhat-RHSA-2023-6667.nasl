...
# extracted from Red Hat Security Advisory RHSA-2023:6667. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6667");

  script_name(english:"RHEL 9 : samba (RHSA-2023:6667)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:6667 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6667.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6984c495");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2190415");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2207692");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2211605");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2211617");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2214327");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2216712");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2222883");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6667");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ctdb-4.18.6-100.el9', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ctdb-4.18.6-100.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ctdb-4.18.6-100.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnetapi-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnetapi-devel-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsmbclient-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsmbclient-devel-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwbclient-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwbclient-devel-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-samba-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-samba-dc-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-samba-devel-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-samba-test-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-client-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-client-libs-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-libs-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-tools-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-dc-libs-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-dcerpc-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-devel-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-krb5-printing-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-ldb-ldap-modules-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-libs-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-pidl-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-test-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-test-libs-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-tools-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-usershares-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-vfs-iouring-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-clients-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-krb5-locator-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-modules-4.18.6-100.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
