...
# extracted from Red Hat Security Advisory RHSA-2020:3096. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-12689", "CVE-2020-12691");
  script_xref(name:"RHSA", value:"2020:3096");

  script_name(english:"RHEL 7 : openstack-keystone (RHSA-2020:3096)");
...
referenced in the RHSA-2020:3096 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3096.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ccb1b290");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3096");
...
"Update the RHEL openstack-keystone package based on the guidance in RHSA-2020:3096.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-keystone-10.0.3-8.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-keystone-10.0.3-8.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-keystone-tests-10.0.3-8.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
