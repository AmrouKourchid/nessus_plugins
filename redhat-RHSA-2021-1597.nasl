...
# extracted from Red Hat Security Advisory RHSA-2021:1597. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1597");

  script_name(english:"RHEL 8 : libxml2 (RHSA-2021:1597)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libxml2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:1597 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1597.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?699b68ef");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.4_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?862005a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1597");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1877788");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libxml2 package based on the guidance in RHSA-2021:1597.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxml2-2.9.7-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.9.7-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libxml2-2.9.7-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
