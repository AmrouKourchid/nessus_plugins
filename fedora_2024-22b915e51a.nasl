...
# extracted from Fedora Security Advisory FEDORA-2024-22b915e51a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-22b915e51a");

  script_name(english:"Fedora 39 : caddy (2024-22b915e51a)");
...
FEDORA-2024-22b915e51a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-22b915e51a");
...
var pkgs = [
    {'reference':'caddy-2.7.6-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
