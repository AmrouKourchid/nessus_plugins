...
This also includes the update to 3.1.2 :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1052478");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1052484");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1105084");
  script_set_attribute(attribute:"see_also", value:"https://github.com/ledger/ledger-mode");
...
"Update the affected ledger packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-2808");
