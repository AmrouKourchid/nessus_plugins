...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'vim-7.4-6.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'vim-extra-7.4-6.ph1')) flag++;
