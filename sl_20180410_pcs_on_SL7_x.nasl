...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : pcs on SL7.x x86_64 (20180410)");
...
"Security Fix(es) :
  ...
  - pcs: Privilege escalation via authorized user malicious
    REST call (CVE-2018-1079)
  ...
  - rack-protection: Timing attack in authenticity_token.rb
    (CVE-2018-1000119)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1804&L=scientific-linux-errata&F=&S=&P=4049
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?78b26423");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"pcs-0.9.162-5.sl7_5.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"pcs-debuginfo-0.9.162-5.sl7_5.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"pcs-snmp-0.9.162-5.sl7_5.1")) flag++;
