...
# extracted from Debian Security Advisory dla-4049. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4049 : librust-openssl-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4049
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85d2128e");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-24898");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/rust-openssl");
  script_set_attribute(attribute:"solution", value:
"Upgrade the librust-openssl-dev packages.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2025/02/02");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:librust-openssl-dev");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'librust-openssl-dev', 'reference': '0.10.29-1+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'librust-openssl-dev');
}
