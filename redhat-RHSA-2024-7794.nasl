...
# extracted from Red Hat Security Advisory RHSA-2024:7794. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7794");

  script_name(english:"RHEL 9 : skopeo (RHSA-2024:7794)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7794.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e99a5a2a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7794");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL skopeo package based on the guidance in RHSA-2024:7794.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'skopeo-1.8.0-4.1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'skopeo-tests-1.8.0-4.1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
