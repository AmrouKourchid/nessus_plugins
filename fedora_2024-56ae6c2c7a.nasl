...
# extracted from Fedora Security Advisory FEDORA-2024-56ae6c2c7a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-56ae6c2c7a");
  script_xref(name:"IAVA", value:"2024-A-0442-S");

  script_name(english:"Fedora 41 : bind / bind-dyndb-ldap (2024-56ae6c2c7a)");
...
FEDORA-2024-56ae6c2c7a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-56ae6c2c7a");
...
var pkgs = [
    {'reference':'bind-9.18.28-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-dyndb-ldap-11.10-30.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
