...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : openssh (EulerOS-SA-2023-3088)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3088
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16731afa");
...
var pkgs = [
  "openssh-8.2p1-2.h42.eulerosv2r9",
  "openssh-clients-8.2p1-2.h42.eulerosv2r9",
  "openssh-server-8.2p1-2.h42.eulerosv2r9"
];
