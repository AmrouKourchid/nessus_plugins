...
# extracted from Red Hat Security Advisory RHSA-2022:1891. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1891.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c9079f1");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.6_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9341665d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1891");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2022675");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libpq package based on the guidance in RHSA-2022:1891.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libpq-13.5-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libpq-devel-13.5-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
