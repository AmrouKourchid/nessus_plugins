...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002062");
  script_xref(name:"MSKB", value:"5002167");
  script_xref(name:"MSKB", value:"5002219");
  script_xref(name:"MSFT", value:"MS22-5002062");
  script_xref(name:"MSFT", value:"MS22-5002167");
  script_xref(name:"MSFT", value:"MS22-5002219");
  script_xref(name:"IAVA", value:"2022-A-0237-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2013 (June 2022)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft SharePoint Server 2013 installation on the remote host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The Microsoft SharePoint Server 2013 installation on on the remote host on the remote host is missing 
security updates. It is, therefore, affected by multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002167");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002062");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002219");
