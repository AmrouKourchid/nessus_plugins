...
# AlmaLinux Security Advisory ALSA-2024:8180.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:8180");

  script_name(english:"AlmaLinux 9 : webkit2gtk3 (ALSA-2024:8180)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:8180 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-8180.html");
...
"Update the affected packages.");
  ...
  script_cwe_id(119, 125, 200, 416, 942);
...
var pkgs = [
    {'reference':'webkit2gtk3-2.46.1-2.el9_4', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-devel-2.46.1-2.el9_4', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-2.46.1-2.el9_4', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-devel-2.46.1-2.el9_4', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
