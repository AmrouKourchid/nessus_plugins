...
ELSA-2017-0933 advisory.
    ...
    - [net] avoid signed overflows for SO_{SND|RCV}BUFFORCE (Sabrina Dubroca) [1412473 1412474]
    {CVE-2016-9793}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-514.16.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
