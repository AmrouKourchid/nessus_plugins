...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Dhcp PHSA-2019-2.0-0152");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'dhcp-client-4.3.5-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'dhcp-debuginfo-4.3.5-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'dhcp-devel-4.3.5-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'dhcp-libs-4.3.5-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'dhcp-server-4.3.5-5.ph2')) flag++;
