...
# extracted from Red Hat Security Advisory RHSA-2021:2575. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2575");

  script_name(english:"RHEL 8 : lz4 (RHSA-2021:2575)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for lz4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:2575 advisory.

    The lz4 packages provide support for LZ4, a very fast, lossless compression algorithm that provides
    compression speeds of 400 MB/s per core and scales with multicore CPUs. It also features an extremely fast
    decoder that reaches speeds of multiple GB/s per core and typically reaches RAM speed limits on multicore
    systems.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2575.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85bd873b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1954559");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2575");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL lz4 package based on the guidance in RHSA-2021:2575.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:lz4");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:lz4-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:lz4-libs");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lz4-1.8.3-3.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lz4-devel-1.8.3-3.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lz4-libs-1.8.3-3.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'lz4-1.8.3-3.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lz4-devel-1.8.3-3.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lz4-libs-1.8.3-3.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'lz4 / lz4-devel / lz4-libs');
}
