...
# extracted from Red Hat Security Advisory RHSA-2024:1139. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1139");

  script_name(english:"RHEL 9 : keylime (RHSA-2024:1139)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1139.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c0a5745");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2222903");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1139");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL keylime package based on the guidance in RHSA-2024:1139.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'keylime-7.3.0-13.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-base-7.3.0-13.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-registrar-7.3.0-13.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-selinux-7.3.0-13.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-tenant-7.3.0-13.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-verifier-7.3.0-13.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-keylime-7.3.0-13.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
