#TRUSTED 
#TRUST-RSA-SHA256 
#
...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0609");
...
"Upgrade to a Cisco operating system that is currently supported.");
  ...
  script_dependencies("os_fingerprint.nasl", "cisco_fwsm_version.nasl");
...
function report_and_exit(txt)
{
  ...
  else if ("FWSM" >< txt) tag_name = "cisco:firewall_services_module";

  if (tag_name)
  {
    tmp_ver = NULL;
    pat = "(IOS|IOS-XE|IOS-XR|NX-OS|PIX|FWSM) ([^ ]+)( has)? reached end";
...
var conf = get_kb_item("Host/OS/Confidence");
var fwsm_ver = get_kb_item('Host/Cisco/FWSM/Version');
...
if (ver = pregmatch(string:os, pattern:"Cisco NX-OS Version\s+([0-9a-zA-Z\.\(\)]+)[^\s\r\n]*"))
{
  os_type = "NX-OS";
  if (!isnull(ver)) os_ver = ver[1];
  model = get_kb_item("Host/Cisco/NX-OS/Model");
}
else if (ver = pregmatch(string:os, pattern:"Cisco IOS XE\s+([0-9a-zA-Z\.\(\)]+)[^\s\r\n]*"))
{
  os_type = "IOS-XE";
  if (!isnull(ver)) os_ver = ver[1];
  model = get_kb_item("Host/Cisco/IOS-XE/Model");
}
else if (ver = pregmatch(string:os, pattern:"Cisco IOS XR\s+([0-9a-zA-Z\.\(\)]+)[^\s\r\n]*"))
{
  os_type = "IOS-XR";
  if (!isnull(ver)) os_ver = ver[1];
  model = NULL;
}
else if (ver = pregmatch(string:os, pattern:"CISCO IOS\s+([0-9a-zA-Z\.\(\)]+)[^\s\r\n]*"))
{
  os_type = "IOS";
  if (!isnull(ver)) os_ver = ver[1];
  model = get_kb_item("Host/Cisco/IOS/Image");
}
else if (ver = pregmatch(string:os, pattern:"CISCO PIX\s+([0-9a-zA-Z\.\(\)]+)[^\s\r\n]*"))
{
  os_type = "PIX";
  if (!isnull(ver)) os_ver = ver[1];
  model = NULL;
...
if ((os_type == "" || os_ver == "") && isnull(fwsm_ver)) exit(0, "The remote system is not currently supported by this plugin.");
...
i++;
oses[i] = "IOS";
urls[i] = "https://www.cisco.com/c/en/us/products/collateral/ios-nx-os-software/ios-software-releases-12-2-s/prod_end-of-life_notice0900aecd804be5cf.html";
...
data[i] = "";
...
data[i] = "";
...
i++;
oses[i] = "IOS";
urls[i] = "https://www.cisco.com/c/en/us/obsolete/ios-nx-os-software/cisco-ios-software-releases-12-3-mainline.html";
data[i] = "QlpoMzFBWSZTWYd9+MAAAAgaAAAXeoAABCAAMQDTTQNTZTJsoqta9fIQxMryGkUhCDnxdyRThQkId9+MAA==";

i++;
oses[i] = "IOS";
urls[i] = "https://www.cisco.com/c/en/us/obsolete/ios-nx-os-software/cisco-ios-software-releases-12-4-mainline.html";
data[i] = "QlpoOTFBWSZTWUD5m+EAAAjaAAAQABd9AAAEIAAhKmRk08oQNA0LrcnESJ4IahnoIMscnfi7kinChIIHzN8I";

i++;
oses[i] = "IOS";
urls[i] = "https://www.cisco.com/c/en/us/products/collateral/switches/catalyst-3750-series-switches/eos-eol-notice-c51-736302.html";
data[i] = "QlpoMzFBWSZTWZRRHgEAAAifAABleiACAAgEAAEgACGk2kMTahAAAwcETZtrFMUcnKcP33HmBpI7hfF3JFOFCQlFEeAQ";

i++;
oses[i] = "IOS";
urls[i] = "https://www.cisco.com/c/en/us/obsolete/ios-nx-os-software/cisco-ios-software-release-12-2-55-se.html";
data[i] = "QlpoMzFBWSZTWUQ0d0wAAAifAABtfiACAAgEBAAgADFMABNBqYTQYnqeBfcXSCUpRIqEGlDYWbhoB8+Sfi7kinChIIho7pg=";

i++;
oses[i] = "IOS";
urls[i] = "https://www.cisco.com/c/en/us/products/collateral/switches/catalyst-3750-series-switches/eol_C51-723166.html";
data[i] = "QlpoMzFBWSZTWTrN5PYAAAifAABle0ACAAgEAAEgADFMAADU0PU9Q9TJI4iuNuIsxmkhs4EXhytA1XZNfF3JFOFCQOs3k9g=";

i++;
oses[i] = "IOS";
urls[i] = "https://www.cisco.com/c/en/us/products/collateral/ios-nx-os-software/ios-software-releases-12-1-e/prod_end-of-life_notice0900aecd8052e0f5.html";
data[i] = "QlpoMzFBWSZTWT/QAPkAAAofgAB9esACAAAEBAAAgCAAISk0EzSPaUKGmmACSqNRv6UhNIjXl225gcsS8JVTfi7kinChIH+gAfI=";
...
i++;
oses[i] = "IOS-XE";
urls[i] = "https://www.cisco.com/c/en/us/products/collateral/ios-nx-os-software/ios-xe-16/eos-eol-notice-c51-744154.html";
data[i] = "QlpoMzFBWSZTWdbRIMYAAFafgAR//eAuL5tPhAEACjAAuKGkmmgyAAaAaDTIYaGTIGRiDEyaGmBFSNEGQwgDQ0Gj1E45gfYzjWOwYifMtLhCN42gahpontYQN3GkGwbr8SbONgPAcsksGIMBkSGJEagaAc4zjsHkDAGBviMq5hoGUw+ccLVumYS8VD6c/cbmhqQsOciSRR5ksHJjS1MeD4gkESwCXk+xaj8fxdyRThQkNbRIMYA=";

i++;
oses[i] = "IOS-XE";
urls[i] = "https://www.cisco.com/c/en/us/products/collateral/switches/catalyst-4500-series-switches/eos-eol-notice-c51-738124.html";
data[i] = "QlpoMzFBWSZTWfMdQq0AAAobgARne6AADwABAAQgADFMJpoDTEGoaA9QNMkcrOmCdDfF9UdsIsRRIEK7Jl76f4u5IpwoSHmOoVaA";

i++;
oses[i] = "IOS-XE";
urls[i] = "https://www.cisco.com/c/en/us/products/collateral/switches/catalyst-4500-series-switches/eos-eol-notice-c51-742520.html";
data[i] = "QlpoMzFBWSZTWcIuuo8AAA2fgERnfqAIBAgPKGUMpCAAVGMABGmEYI8oRT0m0TQyaeo8o0yB3hkTEpOEiU4XsGfDthA7isJgrXmmINFHkH0tdKOWxMhrsRMACP4u5IpwoSGEXXUe";
...
i++;
oses[i] = "NX-OS";
urls[i] = "https://www.cisco.com/c/en/us/products/collateral/switches/nexus-5000-series-switches/eos-eol-notice-c51-733330.html";
data[i] = "QlpoMzFBWSZTWZ4Y8c0AAAqagARneiAADwAEIAAxQ00wACVGgxDRpVu3w49O8PMHCFqijCCGYl/S0/F3JFOFCQnhjxzQ";

i++;
oses[i] = "NX-OS";
urls[i] = "https://www.cisco.com/c/en/us/products/collateral/switches/nexus-5000-series-switches/eos-eol-notice-c51-740720.html";
data[i] = "QlpoMzFBWSZTWXfMddUAAAkbgABlfyAADwQAAA4gACGqG001PR6kPaoUwmmgNMQhZaOjp7ZEgbwSRzT4twyqJp0lt2nwRGvxdyRThQkHfMddUA==";
...
for (i=0; i<=m_index; i++)
{
  ...
  var search_pattern = "^0," + regexify(str:os_ver) + ",,";
  ...
  var eol_list = egrep(pattern:search_pattern, string:res);
  if (strlen(eol_list))
  {
...
for (i=0; i<=n; i++)
{
  ...
  if (strlen(eol_list))
  {
    regex_check(eol_list:eol_list, ostype:os_type, version:os_ver, model:model, url:urls[i]);
  }
}
...
{
  checkDate(url:
      # https://www.cisco.com/c/en/us/obsolete/interfaces-modules/cisco-catalyst-6500-series-firewall-services-module.html
      'http://www.nessus.org/u?73899f56', os:'FWSM', version:fwsm_ver);
}
