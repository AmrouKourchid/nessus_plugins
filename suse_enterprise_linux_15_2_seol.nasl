...
if (description)
{
  ...
  script_name(english:"SUSE Enterprise Linux SEoL (15.2.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of SUSE Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, SUSE Enterprise Linux is 15.2.x. It is, therefore, no longer maintained by its vendor or
provider.
...
var constraints = [
  { max_branch : '15.2', min_branch : '15.2', seol : 20211231, eseol : 20241231 }
];
