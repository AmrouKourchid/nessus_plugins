...
# extracted from Oracle Linux Security Advisory ELSA-2023-1572.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : pesign (ELSA-2023-1572)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-1572.html");
...
"Update the affected pesign package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:pesign");
...
var pkgs = [
    {'reference':'pesign-0.112-27.0.1.el8_7', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pesign-0.112-27.0.1.el8_7', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
