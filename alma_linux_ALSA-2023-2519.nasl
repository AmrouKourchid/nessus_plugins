...
# AlmaLinux Security Advisory ALSA-2023:2519.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2519");

  script_name(english:"AlmaLinux 9 : samba (ALSA-2023:2519)");
...
ALSA-2023:2519 advisory.

  - In Samba, GnuTLS gnutls_rnd() can fail and give predictable random values. (CVE-2022-1615)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-2519.html");
...
var pkgs = [
    {'reference':'ctdb-4.17.5-102.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'samba-winexe-4.17.5-102.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
