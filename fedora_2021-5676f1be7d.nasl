...
# extracted from Fedora Security Advisory FEDORA-2021-5676f1be7d
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : golang-github-buger-jsonparser (2021-5676f1be7d)");
...
FEDORA-2021-5676f1be7d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-5676f1be7d");
...
pkgs = [
    {'reference':'golang-github-buger-jsonparser-1.1.1-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
