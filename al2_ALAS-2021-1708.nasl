...
# extracted from Amazon Linux 2 Security Advisory ALAS-2021-1708.
##
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2021-1708");

  script_name(english:"Amazon Linux 2 : php-pear (ALAS-2021-1708)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of php-pear installed on the remote host is prior to 1.10.12-9. It is, therefore, affected by a
vulnerability as referenced in the ALAS2-2021-1708 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2021-1708.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2021-32610");
...
var pkgs = [
    {'reference':'php-pear-1.10.12-9.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
