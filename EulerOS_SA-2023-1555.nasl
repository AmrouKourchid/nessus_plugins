...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : libtiff (EulerOS-SA-2023-1555)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1555
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?97e1675d");
...
var pkgs = [
  "libtiff-4.1.0-1.h20.eulerosv2r10"
];
