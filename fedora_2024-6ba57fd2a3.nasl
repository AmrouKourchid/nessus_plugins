...
# extracted from Fedora Security Advisory FEDORA-2024-6ba57fd2a3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6ba57fd2a3");

  script_name(english:"Fedora 40 : nginx / nginx-mod-fancyindex / nginx-mod-modsecurity / etc (2024-6ba57fd2a3)");
...
FEDORA-2024-6ba57fd2a3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6ba57fd2a3");
...
var pkgs = [
    {'reference':'nginx-1.26.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'nginx-mod-fancyindex-0.5.2-7.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nginx-mod-modsecurity-1.0.3-13.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nginx-mod-naxsi-1.6-6.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nginx-mod-vts-0.2.2-9.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
