...
if (description)
{
  ...
  script_cve_id("CVE-2024-56702");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-56702");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: bpf: Mark raw_tp arguments with
    ...
    https://lore.kernel.org/bpf/ZrCZS6nisraEqehw@jlelli-thinkpadt14gen4.remote.csb (CVE-2024-56702)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56702");
