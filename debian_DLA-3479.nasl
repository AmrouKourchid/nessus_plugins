...
# extracted from Debian Security Advisory dla-3479. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3479 : golang-gopkg-yaml.v2-dev - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-4235");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-3064");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/golang-yaml.v2");
  # https://security-tracker.debian.org/tracker/source-package/golang-yaml.v2
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a5a16fe");
  script_set_attribute(attribute:"solution", value:
"Upgrade the golang-gopkg-yaml.v2-dev packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:golang-yaml.v2-dev");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:debian:debian_linux:10.0");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:golang-gopkg-yaml.v2-dev");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'golang-gopkg-yaml.v2-dev', 'reference': '2.2.2-1+deb10u1'},
    {'release': '10.0', 'prefix': 'golang-yaml.v2-dev', 'reference': '2.2.2-1+deb10u1'}
];
