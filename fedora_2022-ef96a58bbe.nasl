...
# extracted from Fedora Security Advisory FEDORA-2022-ef96a58bbe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ef96a58bbe");

  script_name(english:"Fedora 36 : ruby (2022-ef96a58bbe)");
...
FEDORA-2022-ef96a58bbe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ef96a58bbe");
...
var pkgs = [
    {'reference':'ruby-3.1.3-172.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
