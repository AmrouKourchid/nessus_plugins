...
# extracted from Red Hat Security Advisory RHSA-2025:7243. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7243");

  script_name(english:"RHEL 9 : gstreamer1-plugins-base (RHSA-2025:7243)");
...
referenced in the RHSA-2025:7243 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331717");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331724");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331738");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331742");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7243.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?80d289df");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7243");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gstreamer1-plugins-base package based on the guidance in RHSA-2025:7243.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-plugins-base-1.22.12-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-base-devel-1.22.12-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-base-tools-1.22.12-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
