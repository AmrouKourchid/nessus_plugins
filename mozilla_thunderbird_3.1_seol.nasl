...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird SEoL (3.1.x)");
...
"Upgrade to a version of Mozilla Thunderbird that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2011/02/01");
...
var constraints = [
{ max_branch : '3.1', min_branch : '3.1', seol : 20110201 }
];
