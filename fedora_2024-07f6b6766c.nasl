...
# extracted from Fedora Security Advisory FEDORA-2024-07f6b6766c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-07f6b6766c");

  script_name(english:"Fedora 41 : thunderbird (2024-07f6b6766c)");
...
FEDORA-2024-07f6b6766c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-07f6b6766c");
...
var pkgs = [
    {'reference':'thunderbird-128.5.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
