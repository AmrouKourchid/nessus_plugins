...
# extracted from Red Hat Security Advisory RHSA-2024:11200. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:11200");

  script_name(english:"RHEL 9 : expat (RHSA-2024:11200)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_11200.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?81c9246e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11200");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL expat package based on the guidance in RHSA-2024:11200.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'expat-2.5.0-2.el9_4.2', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-devel-2.5.0-2.el9_4.2', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
