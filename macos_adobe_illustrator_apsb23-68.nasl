...
if (description)
{
  ...
  script_name(english:"Adobe Illustrator < 27.9.1 / 28.0 < 28.1 Multiple Arbitrary code execution (APSB23-68) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Illustrator instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Illustrator installed on the remote macOS host is prior to 27.9.1, 28.1. It is, therefore, affected
by multiple vulnerabilities as referenced in the APSB23-68 advisory.
