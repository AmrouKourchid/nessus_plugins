...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libtiff PHSA-2018-2.0-0017");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-4.0.9-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-debuginfo-4.0.9-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtiff-devel-4.0.9-3.ph2')) flag++;
