...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : haproxy (EulerOS-SA-2024-1106)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1106
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd4c4448");
...
var pkgs = [
  "haproxy-2.4.8-2.h9.eulerosv2r11"
];
