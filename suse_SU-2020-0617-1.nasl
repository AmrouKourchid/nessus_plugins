...
# extracted from SUSE update advisory SUSE-SU-2020:0617-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : ipmitool (SUSE-SU-2020:0617-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20200617-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?75e03a7e");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"ipmitool-1.8.18-4.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"ipmitool-debuginfo-1.8.18-4.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"ipmitool-debugsource-1.8.18-4.3.1")) flag++;
