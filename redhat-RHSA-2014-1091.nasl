...
# extracted from Red Hat Security Advisory RHSA-2014:1091. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : mod_wsgi (RHSA-2014:1091)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mod_wsgi.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_1091.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98b7f7e2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1091");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1101863");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_wsgi package based on the guidance in RHSA-2014:1091.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_wsgi-3.4-12.el7_0', 'cpu':'ppc64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_wsgi-3.4-12.el7_0', 'cpu':'s390x', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_wsgi-3.4-12.el7_0', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
