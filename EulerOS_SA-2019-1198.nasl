...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : openssh (EulerOS-SA-2019-1198)");
...
the following vulnerability :
  ...
  - OpenSSH through 7.7 is prone to a user enumeration
    ...
    auth2-pubkey.c.i1/4^CVE-2018-15473i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1198
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c507132");
...
pkgs = ["openssh-7.4p1-13.h8",
        "openssh-clients-7.4p1-13.h8",
        "openssh-keycat-7.4p1-13.h8",
        "openssh-server-7.4p1-13.h8",
