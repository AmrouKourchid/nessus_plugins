...
# Rocky Linux Security Advisory RLSA-2022:6357.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:6357");

  script_name(english:"Rocky Linux 8 : open-vm-tools (RLSA-2022:6357)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2022:6357 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:6357");
...
var pkgs = [
    ...
    {'reference':'open-vm-tools-debuginfo-11.3.5-1.el8_6.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-debugsource-11.3.5-1.el8_6.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-desktop-11.3.5-1.el8_6.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-desktop-debuginfo-11.3.5-1.el8_6.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-sdmp-11.3.5-1.el8_6.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'open-vm-tools-sdmp-debuginfo-11.3.5-1.el8_6.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
