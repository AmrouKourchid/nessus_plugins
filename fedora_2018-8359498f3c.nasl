...
# extracted from Fedora Security Advisory FEDORA-2018-8359498f3c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-8359498f3c");

  script_name(english:"Fedora 28 : ghostscript (2018-8359498f3c)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-8359498f3c");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"ghostscript-9.23-2.fc28")) flag++;
