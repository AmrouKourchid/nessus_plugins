...
if (description)
{
  ...
  script_cve_id("CVE-2022-42432");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-42432 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-42432");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-42432");
