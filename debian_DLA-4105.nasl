...
# extracted from Debian Security Advisory dla-4105. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4105 : tzdata - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4105
advisory.
    ...
    - - New America/Coyhaique zone for Aysn Region in Chile, which moves
...
var pkgs = [
    {'release': '11.0', 'prefix': 'tzdata', 'reference': '2025b-0+deb11u1'}
];
