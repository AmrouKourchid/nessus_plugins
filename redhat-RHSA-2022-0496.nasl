...
# extracted from Red Hat Security Advisory RHSA-2022:0496. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0496.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f05fedb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0496");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'aspnetcore-runtime-6.0-6.0.2-1.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'aspnetcore-targeting-pack-6.0-6.0.2-1.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-6.0-6.0.2-1.el8_5', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-6.0.102-1.el8_5', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-6.0.102-1.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-apphost-pack-6.0-6.0.2-1.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-host-6.0.2-1.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-hostfxr-6.0-6.0.2-1.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-runtime-6.0-6.0.2-1.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-sdk-6.0-6.0.102-1.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-targeting-pack-6.0-6.0.2-1.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'dotnet-templates-6.0-6.0.102-1.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'netstandard-targeting-pack-2.1-6.0.102-1.el8_5', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
