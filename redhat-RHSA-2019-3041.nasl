...
if (description)
{
  ...
  script_name(english:"RHEL 7 / 8 : Red Hat OpenShift Service Mesh 1.0.1 RPMs (Important) (RHSA-2019:3041)");
...
referenced in the RHSA-2019:3041 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3041.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9093645");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/MAISTRA-977");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'servicemesh-1.0.1-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-citadel-1.0.1-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-cni-1.0.1-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-galley-1.0.1-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-grafana-6.2.2-21.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-grafana-prometheus-6.2.2-21.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-istioctl-1.0.1-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-mixc-1.0.1-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-mixs-1.0.1-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-operator-1.0.1-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-pilot-agent-1.0.1-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-pilot-discovery-1.0.1-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-prometheus-2.7.2-22.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-proxy-1.0.1-7.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
      {'reference':'servicemesh-sidecar-injector-1.0.1-8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'kiali-v1.0.6.redhat1-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'}
    ]
  }
];
