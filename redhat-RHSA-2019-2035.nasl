...
# extracted from Red Hat Security Advisory RHSA-2019:2035. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : python-requests (RHSA-2019:2035)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2035.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ca2cca5");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html/7.7_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc7115e8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2035");
...
"Update the RHEL python-requests package based on the guidance in RHSA-2019:2035.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-requests-2.6.0-5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
