...
# extracted from Gentoo Linux Security Advisory GLSA 202104-04.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-23336", "CVE-2021-3426");
  script_xref(name:"GLSA", value:"202104-04");

  script_name(english:"GLSA-202104-04 : Python: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202104-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202104-04"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"dev-lang/python", unaffected:make_list("ge 2.7.18_p8", "ge 3.6.13_p1", "ge 3.7.10_p1", "ge 3.8.8_p1", "ge 3.9.2_p1"), vulnerable:make_list("lt 3.9.2_p1"))) flag++;
