...
# extracted from Ubuntu Security Notice USN-6415-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6415-1");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (OEM) vulnerabilities (USN-6415-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6415-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.1.0-1023-oem");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6415-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-3772', 'CVE-2023-3773', 'CVE-2023-4622', 'CVE-2023-4623', 'CVE-2023-20569', 'CVE-2023-25775', 'CVE-2023-37453', 'CVE-2023-42753');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6415-1');
  }
  else
  {
