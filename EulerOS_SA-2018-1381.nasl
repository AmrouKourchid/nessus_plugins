...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.1 : freetype (EulerOS-SA-2018-1381)");
...
the following vulnerability :
  ...
  - FreeType 2 before 2017-03-26 has an out-of-bounds write
    ...
    psaux/psobjs.c.i1/4^CVE-2017-8287i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1381
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?78464d8b");
...
pkgs = ["freetype-2.4.11-10_1.2.h2"];
