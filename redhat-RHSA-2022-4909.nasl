...
# extracted from Red Hat Security Advisory RHSA-2022:4909. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-29036", "CVE-2022-29046", "CVE-2022-29047");
  script_xref(name:"RHSA", value:"2022:4909");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.7.52 paackages (RHSA-2022:4909)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.7.52 paackages.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2022:4909 advisory.

    Red Hat OpenShift Container Platform is Red Hat's cloud computing
    Kubernetes application platform solution designed for on-premise or private
    cloud deployments.

    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.7.52. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4909.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8e8e70d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4909");
...
"Update the RHEL OpenShift Container Platform 4.7.52 paackages package based on the guidance in RHSA-2022:4909.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.7.1652967082-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
