...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.04 : Avahi vulnerability (USN-6129-1)");
...
referenced in the USN-6129-1 advisory.
    ...
    It was discovered that Avahi incorrectly handled certain DBus messages. A local attacker could possibly
...
var pkgs = [
    ...
    {'osver': '23.04', 'pkgname': 'avahi-autoipd', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'avahi-daemon', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'avahi-discover', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'avahi-dnsconfd', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'avahi-ui-utils', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'avahi-utils', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'gir1.2-avahi-0.6', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-client-dev', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-client3', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-common-data', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-common-dev', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-common3', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-compat-libdnssd-dev', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-compat-libdnssd1', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-core-dev', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-core7', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-glib-dev', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-glib1', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-gobject-dev', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-gobject0', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-ui-gtk3-0', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'libavahi-ui-gtk3-dev', 'pkgver': '0.8-6ubuntu1.23.04.1'},
    {'osver': '23.04', 'pkgname': 'python3-avahi', 'pkgver': '0.8-6ubuntu1.23.04.1'}
];
