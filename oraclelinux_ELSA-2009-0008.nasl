...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0008.html");
...
"Update the affected dbus, dbus-devel and / or dbus-x11 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-3834");
...
var pkgs = [
    {'reference':'dbus-1.0.0-7.el5_2.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dbus-devel-1.0.0-7.el5_2.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dbus-x11-1.0.0-7.el5_2.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dbus-1.0.0-7.el5_2.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dbus-devel-1.0.0-7.el5_2.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dbus-x11-1.0.0-7.el5_2.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
