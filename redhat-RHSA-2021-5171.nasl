...
referenced in the RHSA-2021:5171 advisory.
    ...
    The following packages have been upgraded to a later upstream version: nodejs (16.13.1), nodejs-nodemon
    (2.0.15). (BZ#2027610)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_5171.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f01e78d");
  ...
  'nodejs:16': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-16.13.1-3.module+el8.5.0+13548+45d748af', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2020-7788', 'CVE-2020-28469', 'CVE-2021-3918', 'CVE-2021-22959', 'CVE-2021-22960', 'CVE-2021-33502']},
        {'reference':'nodejs-devel-16.13.1-3.module+el8.5.0+13548+45d748af', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2020-7788', 'CVE-2020-28469', 'CVE-2021-3918', 'CVE-2021-22959', 'CVE-2021-22960', 'CVE-2021-33502']},
        {'reference':'nodejs-docs-16.13.1-3.module+el8.5.0+13548+45d748af', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2020-7788', 'CVE-2020-28469', 'CVE-2021-3918', 'CVE-2021-22959', 'CVE-2021-22960', 'CVE-2021-33502']},
        {'reference':'nodejs-full-i18n-16.13.1-3.module+el8.5.0+13548+45d748af', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2020-7788', 'CVE-2020-28469', 'CVE-2021-3918', 'CVE-2021-22959', 'CVE-2021-22960', 'CVE-2021-33502']},
        {'reference':'nodejs-nodemon-2.0.15-1.module+el8.5.0+13548+45d748af', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2020-7788', 'CVE-2020-28469', 'CVE-2021-3807', 'CVE-2021-3918', 'CVE-2021-22959', 'CVE-2021-22960', 'CVE-2021-33502']},
        {'reference':'nodejs-packaging-25-1.module+el8.5.0+10992+fac5fe06', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'cves':['CVE-2020-7788', 'CVE-2020-28469', 'CVE-2021-3918', 'CVE-2021-22959', 'CVE-2021-22960', 'CVE-2021-33502']},
        {'reference':'npm-8.1.2-1.16.13.1.3.module+el8.5.0+13548+45d748af', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2020-7788', 'CVE-2020-28469', 'CVE-2021-3918', 'CVE-2021-22959', 'CVE-2021-22960', 'CVE-2021-33502']}
      ]
    }
  ]
};
