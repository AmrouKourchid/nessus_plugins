...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : libwebp (EulerOS-SA-2023-3221)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3221
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?08b818b9");
...
var pkgs = [
  "libwebp-1.1.0-2.h3.eulerosv2r10"
];
