...
if (description)
{
  ...
  script_cve_id("CVE-2010-4253");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2010-4253");
...
patch available.
  ...
  - Heap-based buffer overflow in Impress in OpenOffice.org (OOo) 2.x and 3.x before 3.3 allows remote
    ...
    crafted PNG file in an ODF or Microsoft Office document, as demonstrated by a PowerPoint (aka PPT)
    document. (CVE-2010-4253)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-4253");
