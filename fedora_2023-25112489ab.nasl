...
# extracted from Fedora Security Advisory FEDORA-2023-25112489ab
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-25112489ab");

  script_name(english:"Fedora 37 : dotnet6.0 / dotnet7.0 (2023-25112489ab)");
...
FEDORA-2023-25112489ab advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-25112489ab");
  script_set_attribute(attribute:"solution", value:
"Update the affected dotnet6.0 and / or dotnet7.0 packages.");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2023/08/20");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:dotnet7.0");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.121-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dotnet7.0-7.0.110-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'dotnet6.0 / dotnet7.0');
}
