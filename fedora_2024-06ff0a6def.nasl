...
# extracted from Fedora Security Advisory FEDORA-2024-06ff0a6def
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-06ff0a6def");

  script_name(english:"Fedora 39 : python2.7 (2024-06ff0a6def)");
...
FEDORA-2024-06ff0a6def advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-06ff0a6def");
...
var pkgs = [
    {'reference':'python2.7-2.7.18-37.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
