...
# extracted from Red Hat Security Advisory udisks. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2010-4661", "CVE-2018-17336");

  script_name(english:"RHEL 6 : udisks (Unpatched Vulnerability) (deprecated)");
