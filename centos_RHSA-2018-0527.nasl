...
# CentOS Errata and Security Advisory 2018:0527 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2018:0527)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2018-March/022804.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f6fe2137");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-52.7.0-1.el7.centos", allowmaj:TRUE)) flag++;
