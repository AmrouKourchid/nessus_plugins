...
if (description)
{
  ...
  script_cve_id("CVE-2023-29939");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-29939");
...
patch available.
  ...
  - llvm-project commit a0138390 was discovered to contain a segmentation fault via the component
    mlir::spirv::TargetEnv::TargetEnv(mlir::spirv::TargetEnvAttr). (CVE-2023-29939)
