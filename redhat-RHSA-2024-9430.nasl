...
# extracted from Red Hat Security Advisory RHSA-2024:9430. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9430");

  script_name(english:"RHEL 9 : nano (RHSA-2024:9430)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9430.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e9c80031");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9430");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nano package based on the guidance in RHSA-2024:9430.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nano-5.6.1-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
