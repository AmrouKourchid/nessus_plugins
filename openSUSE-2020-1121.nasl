...
# extracted from openSUSE Security Update openSUSE-2020-1121.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ldb (openSUSE-2020-1121)");
...
if ( rpm_check(release:"SUSE15.1", reference:"ldb-debugsource-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ldb-tools-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ldb-tools-debuginfo-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libldb-devel-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libldb1-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libldb1-debuginfo-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-ldb-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-ldb-debuginfo-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-ldb-devel-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-ldb-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-ldb-debuginfo-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-ldb-devel-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libldb1-32bit-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libldb1-32bit-debuginfo-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python-ldb-32bit-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python-ldb-32bit-debuginfo-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python3-ldb-32bit-1.4.6-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python3-ldb-32bit-debuginfo-1.4.6-lp151.2.3.1") ) flag++;
