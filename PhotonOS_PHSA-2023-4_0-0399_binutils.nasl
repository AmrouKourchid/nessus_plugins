...
if (description)
{
  ...
  script_cve_id("CVE-2022-4285", "CVE-2023-1972");

  script_name(english:"Photon OS 4.0: Binutils PHSA-2023-4.0-0399");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'binutils-2.35-7.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'binutils-devel-2.35-7.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'binutils-libs-2.35-7.ph4')) flag++;
