...
# extracted from Gentoo Linux Security Advisory GLSA 202007-57.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-57");

  script_name(english:"GLSA-202007-57 : Mutt, Neomutt: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-57
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-57");
...
if (qpkg_check(package:"mail-client/mutt", unaffected:make_list("ge 1.14.4"), vulnerable:make_list("lt 1.14.4"))) flag++;
if (qpkg_check(package:"mail-client/neomutt", unaffected:make_list("ge 20200619"), vulnerable:make_list("lt 20200619"))) flag++;
