...
# extracted from Debian Security Advisory dla-3328. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3328 : clamav - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-20032");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-20052");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'clamav', 'reference': '0.103.8+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamav-base', 'reference': '0.103.8+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamav-daemon', 'reference': '0.103.8+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamav-docs', 'reference': '0.103.8+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamav-freshclam', 'reference': '0.103.8+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamav-milter', 'reference': '0.103.8+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamav-testfiles', 'reference': '0.103.8+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'clamdscan', 'reference': '0.103.8+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libclamav-dev', 'reference': '0.103.8+dfsg-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libclamav9', 'reference': '0.103.8+dfsg-0+deb10u1'}
];
