...
# extracted from Fedora Security Advisory FEDORA-2024-35c28f59d1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-35c28f59d1");

  script_name(english:"Fedora 40 : exercism (2024-35c28f59d1)");
...
FEDORA-2024-35c28f59d1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-35c28f59d1");
...
var pkgs = [
    {'reference':'exercism-3.3.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
