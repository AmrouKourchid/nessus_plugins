...
# extracted from Fedora Security Advisory FEDORA-2024-3fc66f8bf3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3fc66f8bf3");

  script_name(english:"Fedora 39 : w3m (2024-3fc66f8bf3)");
...
FEDORA-2024-3fc66f8bf3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3fc66f8bf3");
...
var pkgs = [
    {'reference':'w3m-0.5.3-63.git20230121.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
