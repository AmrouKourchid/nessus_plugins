...
if (description)
{
  ...
  script_cve_id("CVE-2025-1019");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-1019");
...
patch available.
  ...
  - The z-order of the browser windows could be manipulated to hide the fullscreen notification. This could
    potentially be leveraged to perform a spoofing attack. This vulnerability affects Firefox < 135 and
    Thunderbird < 135. (CVE-2025-1019)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-1019");
