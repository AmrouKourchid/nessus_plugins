...
"The remote Citrix ADC or Citrix Gateway device is version 12.1 before 12.1-65.25, 12.1-FIPS before 12.1-55.296
or 13.0 before 13.0-58.32. It is therefore affected by an unauthentictaed remote code execution vulnerability:
...
"Upgrade to version 12.1-65.25, 12.1-55.296-FIPS, 13.0-58.32 or later.");
...
if (app_info['fips_status'] == 1)
{
  if (preg(pattern:"^12.1.*", string:app_info['version']))
    constraints = [ {'min_version': '12.1', 'fixed_version': '12.1.55.291', 'fixed_display': '12.1-55.291 and later releases of 12.1-FIPS.'} ];
}
else
{
  constraints = [
