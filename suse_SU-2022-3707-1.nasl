...
# SUSE update advisory SUSE-SU-2022:3707-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3707-1");

  script_name(english:"SUSE SLES12 Security Update : multipath-tools (SUSE-SU-2022:3707-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES12 / SLES_SAP12 host has packages installed that are affected by multiple vulnerabilities as
referenced in the SUSE-SU-2022:3707-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-October/012644.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?44ffcc9c");
  script_set_attribute(attribute:"solution", value:
"Update the affected kpartx, multipath-tools and / or multipath-tools-devel packages.");
...
var pkgs = [
    {'reference':'kpartx-0.7.9+232+suse.cbc3754-3.14.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'multipath-tools-0.7.9+232+suse.cbc3754-3.14.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'multipath-tools-devel-0.7.9+232+suse.cbc3754-3.14.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'multipath-tools-devel-0.7.9+232+suse.cbc3754-3.14.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-sdk-release-12.5', 'sles-release-12.5']},
    {'reference':'kpartx-0.7.9+232+suse.cbc3754-3.14.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']},
    {'reference':'multipath-tools-0.7.9+232+suse.cbc3754-3.14.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kpartx / multipath-tools / multipath-tools-devel');
}
