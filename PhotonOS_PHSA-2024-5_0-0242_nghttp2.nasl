...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Nghttp2 PHSA-2024-5.0-0242");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'nghttp2-1.57.0-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'nghttp2-devel-1.57.0-2.ph5')) flag++;
