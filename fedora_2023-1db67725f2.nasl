...
# extracted from Fedora Security Advisory FEDORA-2023-1db67725f2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1db67725f2");

  script_name(english:"Fedora 37 : firecracker (2023-1db67725f2)");
...
FEDORA-2023-1db67725f2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1db67725f2");
  script_set_attribute(attribute:"solution", value:
"Update the affected firecracker package.");
...
var pkgs = [
    {'reference':'firecracker-1.4.1-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'firecracker');
}
