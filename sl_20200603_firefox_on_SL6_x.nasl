...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL6.x i386/x86_64 (20200603)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2006&L=SCIENTIFIC-LINUX-ERRATA&P=1667
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7abd8980");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"firefox-68.9.0-1.el6_10", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-68.9.0-1.el6_10", allowmaj:TRUE)) flag++;
