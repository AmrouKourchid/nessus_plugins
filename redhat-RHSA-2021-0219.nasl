...
# extracted from Red Hat Security Advisory RHSA-2021:0219. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0219.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77d8d849");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0219");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1917684");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sudo package based on the guidance in RHSA-2021:0219.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.8.29-5.el8_2.1', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
