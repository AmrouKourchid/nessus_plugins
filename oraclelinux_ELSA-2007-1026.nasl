...
# extracted from Red Hat Security Advisory RHSA-2007:1026 and 
# Oracle Linux Security Advisory ELSA-2007-1026 respectively.
#
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2007:1026");

  script_name(english:"Oracle Linux 5 : Important: / poppler (ELSA-2007-1026)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-1026.html");
...
var pkgs = [
    {'reference':'poppler-0.5.4-4.3.el5_1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-devel-0.5.4-4.3.el5_1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-utils-0.5.4-4.3.el5_1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-0.5.4-4.3.el5_1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-devel-0.5.4-4.3.el5_1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-utils-0.5.4-4.3.el5_1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
