...
# extracted from Fedora Security Advisory FEDORA-2024-2cface5aba
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2cface5aba");

  script_name(english:"Fedora 40 : jose (2024-2cface5aba)");
...
FEDORA-2024-2cface5aba advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2cface5aba");
  script_set_attribute(attribute:"solution", value:
"Update the affected jose package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:jose");
...
var pkgs = [
    {'reference':'jose-13-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
