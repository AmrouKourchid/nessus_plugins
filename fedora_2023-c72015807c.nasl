...
# extracted from Fedora Security Advisory FEDORA-2023-c72015807c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c72015807c");

  script_name(english:"Fedora 38 : podman (2023-c72015807c)");
...
FEDORA-2023-c72015807c advisory.

    Automatic update for podman-4.7.2-1.fc38.
    ...
    * Thu Oct 05 2023 Packit <hello@packit.dev> - 5:4.7.1-1
    ...
    Automatic update for podman-4.7.1-1.fc38.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c72015807c");
  script_set_attribute(attribute:"solution", value:
"Update the affected 5:podman package.");
...
var pkgs = [
    {'reference':'podman-4.7.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
