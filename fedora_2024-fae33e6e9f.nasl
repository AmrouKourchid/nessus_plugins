...
# extracted from Fedora Security Advisory FEDORA-2024-fae33e6e9f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fae33e6e9f");

  script_name(english:"Fedora 40 : gdcm (2024-fae33e6e9f)");
...
FEDORA-2024-fae33e6e9f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fae33e6e9f");
...
var pkgs = [
    {'reference':'gdcm-3.0.23-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
