...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : libarchive (EulerOS-SA-2024-2507)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2507
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67be3344");
...
var pkgs = [
  "libarchive-3.5.2-5.h4.eulerosv2r12"
];
