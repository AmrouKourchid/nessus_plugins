...
# extracted from Fedora Security Advisory FEDORA-2024-0c9aaeb447
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0c9aaeb447");

  script_name(english:"Fedora 38 : python-cbor2 (2024-0c9aaeb447)");
...
FEDORA-2024-0c9aaeb447 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0c9aaeb447");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-cbor2 package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-26134");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-cbor2");
...
var pkgs = [
    {'reference':'python-cbor2-5.6.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-cbor2');
}
