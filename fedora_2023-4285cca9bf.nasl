...
# extracted from Fedora Security Advisory FEDORA-2023-4285cca9bf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4285cca9bf");

  script_name(english:"Fedora 39 : mingw-poppler (2023-4285cca9bf)");
...
FEDORA-2023-4285cca9bf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4285cca9bf");
...
var pkgs = [
    {'reference':'mingw-poppler-23.02.0-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
