...
if (description)
{
  ...
  script_cve_id("CVE-2025-22008");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-22008");
...
patch available.
  ...
  - regulator: check that dummy regulator has been probed before using it Due to asynchronous driver probing
    there is a chance that the dummy regulator hasn't already been probed when first accessing it.
    (CVE-2025-22008)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-22008");
