...
referenced in the RHSA-2020:0580 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0580.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2df1039e");
...
"Update the RHEL python-pillow package based on the guidance in RHSA-2020:0580.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-pillow-5.1.1-10.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-pillow-5.1.1-10.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
