...
if (description)
{
  ...
  script_cve_id("CVE-2024-53144");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-53144");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: Bluetooth: hci_event: Align BR/EDR
    JUST_WORKS paring with LE This aligned BR/EDR JUST_WORKS method with LE which since 92516cd97fd4
    (Bluetooth: Always request for user confirmation for Just Works) always request user confirmation with
    confirm_hint set since the likes of bluetoothd have dedicated policy around JUST_WORKS method (e.g.
    main.conf:JustWorksRepairing). CVE: CVE-2024-8805 (CVE-2024-53144)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53144");
