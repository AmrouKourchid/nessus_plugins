...
# extracted from Oracle Linux Security Advisory ELSA-2020-2378.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : firefox (ELSA-2020-2378)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-2378.html");
...
var pkgs = [
    {'reference':'firefox-68.9.0-1.0.1.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-68.9.0-1.0.1.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
