...
"The version of OpenSSL installed on the remote host is prior to 1.0.2d. It is, therefore, affected by multiple
vulnerabilities as referenced in the 1.0.2d advisory.
...
var constraints = [
  { 'min_version' : '1.0.2', 'fixed_version' : '1.0.2d' },
  { 'min_version' : '1.0.2b', 'fixed_version' : '1.0.2d' }
];
