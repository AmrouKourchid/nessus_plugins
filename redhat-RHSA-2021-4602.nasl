...
# extracted from Red Hat Security Advisory RHSA-2021:4602. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4602");

  script_name(english:"RHEL 8 : binutils (RHSA-2021:4602)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for binutils.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4602 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4602.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0e7759f5");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4602");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2005819");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL binutils package based on the guidance in RHSA-2021:4602.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'binutils-2.30-58.el8_1.3', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'binutils-devel-2.30-58.el8_1.3', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
