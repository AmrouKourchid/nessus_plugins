...
# SUSE update advisory SUSE-SU-2023:0238-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0238-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 28 for SLE 12 SP4) (SUSE-SU-2023:0238-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES12 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2023:0238-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013622.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4706f2b");
  script_set_attribute(attribute:"solution", value:
"Update the affected kgraft-patch-4_12_14-95_102-default, kgraft-patch-4_12_14-95_108-default and / or kgraft-
patch-4_12_14-95_111-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-95.102-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_102-default-6-2.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      },
      '4.12.14-95.108-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_108-default-4-2.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      },
      '4.12.14-95.111-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_111-default-3-2.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-95_102-default / etc');
}
