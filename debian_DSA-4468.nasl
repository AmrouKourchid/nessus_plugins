...
execution.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=930321");
  # https://security-tracker.debian.org/tracker/source-package/php-horde-form
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a6ae065");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/php-horde-form");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2019/dsa-4468");
...
version 2.0.15-1+deb9u1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-9858");
