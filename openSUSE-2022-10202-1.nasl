...
# openSUSE Security Update openSUSE-SU-2022:10202-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : jhead (openSUSE-SU-2022:10202-1)");
...
openSUSE-SU-2022:10202-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37934001");
...
var pkgs = [
    {'reference':'jhead-3.06.0.1-bp154.2.6.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
