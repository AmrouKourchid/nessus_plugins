...
# extracted from Fedora Security Advisory FEDORA-2023-62ce942e75
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-62ce942e75");

  script_name(english:"Fedora 38 : stargz-snapshotter (2023-62ce942e75)");
...
FEDORA-2023-62ce942e75 advisory.

    Release of stargz snapshotter v0.14.2 https://github.com/containerd/stargz-
    snapshotter/releases/tag/v0.14.2

    This release uses containerd v1.7.0-rc.1 so this release fixes GHSA-hmfx-3pcx-653p (CVE-2023-25173) and
    GHSA-259w-8hf6-59c2 (CVE-2023-25153).
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-62ce942e75");
...
var pkgs = [
    {'reference':'stargz-snapshotter-0.14.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
