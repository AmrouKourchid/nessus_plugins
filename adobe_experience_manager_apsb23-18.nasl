...
multiple vulnerabilities as referenced in the APSB23-18 advisory.
  ...
  - Experience Manager versions 6.5.15.0 (and earlier) are affected by a reflected Cross-Site Scripting (XSS)
    vulnerability. If a low-privileged attacker is able to convince a victim to visit a URL referencing a
    vulnerable page, malicious JavaScript content may be executed within the context of the victim's browser.
    (CVE-2023-21615, CVE-2023-21616, CVE-2023-22252, CVE-2023-22253, CVE-2023-22254, CVE-2023-22269)

  - Experience Manager versions 6.5.15.0 (and earlier) are affected by a URL Redirection to Untrusted Site
    ...
    (CVE-2023-22256, CVE-2023-22257, CVE-2023-22258, CVE-2023-22259, CVE-2023-22260, CVE-2023-22261,
    CVE-2023-22262, CVE-2023-22263, CVE-2023-22264, CVE-2023-22265, CVE-2023-22266)

  - Experience Manager versions 6.5.15.0 (and earlier) are affected by a Weak Cryptography for Passwords
    vulnerability that can lead to a security feature bypass. A low-privileged attacker can exploit this in
    order to decrypt a user's password. The attack complexity is high since a successful exploitation requires
    to already have in possession this encrypted secret. (CVE-2023-22271)
