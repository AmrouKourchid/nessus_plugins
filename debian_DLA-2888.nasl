...
dla-2888 advisory.
    ...
    Multiple security vulnerabilities have been discovered in the NVIDIA binary driver and libraries that
    provide optimized hardware acceleration which may lead to denial of service, information disclosure or
    data corruption. For Debian 9 stretch, these problems have been fixed in version 390.144-1~deb9u1. We
    recommend that you upgrade your nvidia-graphics-drivers packages. For the detailed security status of
    nvidia-graphics-drivers please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/nvidia-graphics-drivers Further information about Debian LTS security
