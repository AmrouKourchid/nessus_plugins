...
# extracted from Ubuntu Security Notice USN-2229-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : GnuTLS vulnerability (USN-2229-1)");
...
USN-2229-1 advisory.
    ...
    Joonas Kuorilehto discovered that GnuTLS incorrectly handled Server Hello messages. A malicious remote
    server or a machine-in-the-middle could use this issue to cause GnuTLS to crash, resulting in a denial of
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2229-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'gnutls-bin', 'pkgver': '3.0.11+really2.12.23-12ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'libgnutls-dev', 'pkgver': '2.12.23-12ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'libgnutls-openssl27', 'pkgver': '2.12.23-12ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'libgnutls26', 'pkgver': '2.12.23-12ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'libgnutlsxx27', 'pkgver': '2.12.23-12ubuntu2.1'}
];
