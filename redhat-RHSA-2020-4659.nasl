...
# extracted from Red Hat Security Advisory RHSA-2020:4659. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4659");

  script_name(english:"RHEL 8 : gd (RHSA-2020:4659)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for gd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:4659 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4659.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed7c4b05");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4659");
...
"Update the RHEL gd package based on the guidance in RHSA-2020:4659.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gd-2.2.5-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gd-devel-2.2.5-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
