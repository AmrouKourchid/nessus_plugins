...
# extracted from Fedora Security Advisory FEDORA-2025-70a32aa438
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-70a32aa438");

  script_name(english:"Fedora 41 : golang (2025-70a32aa438)");
...
FEDORA-2025-70a32aa438 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-70a32aa438");
...
var pkgs = [
    {'reference':'golang-1.23.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
