...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.1 : openssl (EulerOS-SA-2018-1383)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1383
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5db9b5cf");
...
pkgs = ["openssl-1.0.1e-60.1.h3",
        "openssl-devel-1.0.1e-60.1.h3",
        "openssl-libs-1.0.1e-60.1.h3"];
