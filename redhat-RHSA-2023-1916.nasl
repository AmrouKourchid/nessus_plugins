...
# extracted from Red Hat Security Advisory RHSA-2023:1916. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1916");

  script_name(english:"RHEL 9 : httpd and mod_http2 (RHSA-2023:1916)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1916.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00c7440b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2176209");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1916");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL httpd / mod_http2 packages based on the guidance in RHSA-2023:1916.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'httpd-2.4.51-7.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-devel-2.4.51-7.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-filesystem-2.4.51-7.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-manual-2.4.51-7.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-tools-2.4.51-7.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_http2-1.15.19-3.el9_0.5', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ldap-2.4.51-7.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_lua-2.4.51-7.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_proxy_html-2.4.51-7.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'mod_session-2.4.51-7.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ssl-2.4.51-7.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
