...
if (description)
{
  ...
  script_name(english:"HCLTech Domino SEoL (9.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of HCLTech Domino is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, HCLTech Domino is 9.0.x. It is, therefore, no longer maintained by its vendor or provider.
...
var constraints = [
  { max_branch : '9.0', min_branch : '9.0', seol : 20240601 }
];
