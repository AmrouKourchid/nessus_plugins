...
# extracted from Amazon Linux 2 Security Advisory ALASKERNEL-5.10-2024-049.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : kernel (ALASKERNEL-5.10-2024-049)");
...
vulnerabilities as referenced in the ALAS2KERNEL-5.10-2024-049 advisory.
    ...
    A flaw heap buffer overflow in the Linux kernel's AMD Radeon graphics card driver was found in the way
    user writes some malicious data to the AMD GPU Display Driver Debug Filesystem (to the VGA sub-directory
    of the /sys/kernel/debug/ directory). A local user could use this flaw to crash the system or escalate
    their privileges on the system. (CVE-2021-42327)
    ...
    escalate their privileges on the system. (CVE-2023-1252)

Tenable has extracted the preceding description block directly from the tested product security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASKERNEL-5.10-2024-049.html");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47186.html");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47191.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47192.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47197.html");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47218.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47219.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47342.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47459.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47461.html");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-47496.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2023-1252.html");
...
"Run 'yum update kernel' to update your system.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-1252");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2020-27820", "CVE-2021-3640", "CVE-2021-3772", "CVE-2021-4001", "CVE-2021-4002", "CVE-2021-42327", "CVE-2021-47184", "CVE-2021-47185", "CVE-2021-47186", "CVE-2021-47189", "CVE-2021-47190", "CVE-2021-47191", "CVE-2021-47192", "CVE-2021-47197", "CVE-2021-47201", "CVE-2021-47202", "CVE-2021-47203", "CVE-2021-47217", "CVE-2021-47218", "CVE-2021-47219", "CVE-2021-47342", "CVE-2021-47459", "CVE-2021-47461", "CVE-2021-47464", "CVE-2021-47483", "CVE-2021-47496", "CVE-2023-1252");
  if (hotfix_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "kpatch hotfix for ALASKERNEL-5.10-2024-049");
  }
  else
  {
