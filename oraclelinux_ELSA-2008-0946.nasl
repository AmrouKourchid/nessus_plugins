...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : ed (ELSA-2008-0946)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0946.html");
...
"Update the affected ed package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-3916");
...
var pkgs = [
    {'reference':'ed-0.2-39.el5_2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ed-0.2-39.el5_2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
