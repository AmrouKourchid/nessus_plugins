...
# extracted from Red Hat Security Advisory RHSA-2024:0465. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0465");
  script_xref(name:"IAVA", value:"2024-A-0003-S");

  script_name(english:"RHEL 9 : sqlite (RHSA-2024:0465)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0465.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e2ec6a69");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2256194");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0465");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sqlite package based on the guidance in RHSA-2024:0465.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sqlite-3.34.1-7.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sqlite-devel-3.34.1-7.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sqlite-libs-3.34.1-7.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
