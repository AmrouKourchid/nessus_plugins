...
# extracted from Fedora Security Advisory FEDORA-2020-1eaffe0013.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : ghc-cmark-gfm / ghc-hakyll / gitit / pandoc / pandoc-citeproc / etc (2020-1eaffe0013)");
...
"Security fix for CVE-2020-5238
  ...
  - also update hakyll to 4.13.4.0
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-1eaffe0013");
  # https://github.com/github/cmark-gfm/security/advisories/GHSA-7gc6-9qr5-hc85
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?374af7be");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"ghc-cmark-gfm-0.2.2-1.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"ghc-hakyll-4.13.4.0-1.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"gitit-0.12.3.2-6.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"pandoc-2.7.3-4.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"pandoc-citeproc-0.16.2-2.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"patat-0.8.4.3-2.fc32")) flag++;
