...
# extracted from Fedora Security Advisory FEDORA-2025-bee62eff98
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-bee62eff98");

  script_name(english:"Fedora 40 : chromium (2025-bee62eff98)");
...
FEDORA-2025-bee62eff98 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-bee62eff98");
...
var pkgs = [
    {'reference':'chromium-134.0.6998.117-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
