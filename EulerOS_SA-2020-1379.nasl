...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : e2fsprogs (EulerOS-SA-2020-1379)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1379
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d61b51e4");
...
pkgs = ["e2fsprogs-1.43.6-1.h2",
        "e2fsprogs-devel-1.43.6-1.h2",
        "e2fsprogs-libs-1.43.6-1.h2",
        "libcom_err-1.43.6-1.h2",
        "libcom_err-devel-1.43.6-1.h2",
        "libss-1.43.6-1.h2"];
