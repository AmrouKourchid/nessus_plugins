...
if (description)
{
  ...
  script_cve_id("CVE-2010-3614", "CVE-2012-1667");

  script_name(english:"RHEL 3 : bind (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2010-3614");
