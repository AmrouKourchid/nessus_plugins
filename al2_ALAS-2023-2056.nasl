...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2056.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : microcode_ctl (ALAS-2023-2056)");
...
vulnerabilities as referenced in the ALAS2-2023-2056 advisory.

    2024-05-09: CVE-2022-33196 was added to this advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2056.html");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2022-33972.html");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-47.amzn2.0.15', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'microcode_ctl-2.1-47.amzn2.0.15', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'microcode_ctl-debuginfo-2.1-47.amzn2.0.15', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'microcode_ctl-debuginfo-2.1-47.amzn2.0.15', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
