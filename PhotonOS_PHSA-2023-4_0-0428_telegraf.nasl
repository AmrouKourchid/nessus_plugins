...
if (description)
{
  ...
  script_cve_id("CVE-2019-3826", "CVE-2022-46908", "CVE-2023-36191");

  script_name(english:"Photon OS 4.0: Telegraf PHSA-2023-4.0-0428");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-3826");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-46908");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'telegraf-1.27.1-1.ph4')) flag++;
