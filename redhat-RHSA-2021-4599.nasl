...
# extracted from Red Hat Security Advisory RHSA-2021:4599. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4599");

  script_name(english:"RHEL 8 : annobin (RHSA-2021:4599)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4599.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4b6afbe0");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4599");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2005819");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL annobin package based on the guidance in RHSA-2021:4599.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'annobin-8.78-1.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
