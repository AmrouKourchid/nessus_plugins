...
# extracted from Red Hat Security Advisory RHSA-2020:5526. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5526");

  script_name(english:"RHEL 6 : Red Hat Single Sign-On 7.4.4 security update on RHEL 6 (Low) (RHSA-2020:5526)");
...
the RHSA-2020:5526 advisory.
    ...
    This release of Red Hat Single Sign-On 7.4.4 on RHEL 6 serves as a replacement for Red Hat Single Sign-On
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5526.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0fe66f6f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5526");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1905089");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Single Sign-On 7.4.4 package based on the guidance in RHSA-2020:5526.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-sso7-keycloak-9.0.10-1.redhat_00001.1.el6sso', 'release':'6', 'el_string':'el6sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'},
      {'reference':'rh-sso7-keycloak-server-9.0.10-1.redhat_00001.1.el6sso', 'release':'6', 'el_string':'el6sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'}
    ]
  }
];
