...
# extracted from Red Hat Security Advisory RHSA-2023:3447. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-28235", "CVE-2022-41723");
  script_xref(name:"RHSA", value:"2023:3447");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.1 (etcd) (RHSA-2023:3447)");
...
referenced in the RHSA-2023:3447 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3447.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc8df9f9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3447");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.1 (etcd) package based on the guidance in RHSA-2023:3447.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'etcd-3.3.23-14.el8ost', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'etcd-3.3.23-14.el8ost', 'cpu':'x86_64', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
