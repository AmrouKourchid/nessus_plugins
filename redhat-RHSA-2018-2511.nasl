...
# extracted from Red Hat Security Advisory RHSA-2018:2511. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2511");

  script_name(english:"RHEL 6 / 7 : rh-postgresql95-postgresql (RHSA-2018:2511)");
...
referenced in the RHSA-2018:2511 advisory.

    PostgreSQL is an advanced object-relational database management system (DBMS).

    The following packages have been upgraded to a later upstream version: rh-postgresql95-postgresql
    (9.5.14). (BZ#1612671)
    ...
    * postgresql: INSERT ... ON CONFLICT DO UPDATE fails to enforce SELECT privileges (CVE-2017-15099)
    ...
    CVE-2017-15098, CVE-2018-1053, and CVE-2017-15099. Upstream acknowledges Andrew Krasichkov as the original
    reporter of CVE-2018-10915; David Rowley as the original reporter of CVE-2017-15098; Tom Lane as the
    original reporter of CVE-2018-1053; and Dean Rasheed as the original reporter of CVE-2017-15099.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2511.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?80b576c1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2511");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-postgresql95-postgresql package based on the guidance in RHSA-2018:2511.");
  ...
  script_cwe_id(20, 89, 200, 377, 863);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-postgresql95-postgresql-9.5.14-1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-contrib-9.5.14-1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-devel-9.5.14-1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-docs-9.5.14-1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-libs-9.5.14-1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-plperl-9.5.14-1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-plpython-9.5.14-1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-pltcl-9.5.14-1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-server-9.5.14-1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-static-9.5.14-1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-test-9.5.14-1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-postgresql95-postgresql-9.5.14-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-contrib-9.5.14-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-devel-9.5.14-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-docs-9.5.14-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-libs-9.5.14-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-plperl-9.5.14-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-plpython-9.5.14-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-pltcl-9.5.14-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-server-9.5.14-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-static-9.5.14-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql95-postgresql-test-9.5.14-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
