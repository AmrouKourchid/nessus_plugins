...
"The version of Google Chrome installed on the remote macOS host is prior to 122.0.6261.57. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2024_02_stable-channel-update-for-desktop_20 advisory.
...
google_chrome_check_version(fix:'122.0.6261.57', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
