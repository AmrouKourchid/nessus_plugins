...
# extracted from Fedora Security Advisory FEDORA-2021-f4fd9372c7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-f4fd9372c7");

  script_name(english:"Fedora 33 : python3.7 (2021-f4fd9372c7)");
...
FEDORA-2021-f4fd9372c7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-f4fd9372c7");
...
pkgs = [
    {'reference':'python3.7-3.7.10-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
