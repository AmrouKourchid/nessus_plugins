...
# extracted from Debian Security Advisory dla-2894. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2894-1 : aide - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2894
advisory.
    ...
    This may result in denial of service or privilege escalation. For Debian 9 stretch, this problem has been
    fixed in version 0.16-1+deb9u1. We recommend that you upgrade your aide packages. For the detailed
    security status of aide please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/aide Further information about Debian LTS security advisories, how to apply
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2894");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-45417");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/aide");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'aide', 'reference': '0.16-1+deb9u1'},
    {'release': '9.0', 'prefix': 'aide-common', 'reference': '0.16-1+deb9u1'},
    {'release': '9.0', 'prefix': 'aide-dynamic', 'reference': '0.16-1+deb9u1'},
    {'release': '9.0', 'prefix': 'aide-xen', 'reference': '0.16-1+deb9u1'}
];
