...
# extracted from Ubuntu Security Notice USN-5175-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5175-1");

  script_name(english:"Ubuntu 20.04 ESM : NTP vulnerability (USN-5175-1)");
...
USN-5175-1 advisory.
    ...
    It was discovered that ntpd incorrectly handled memory when CMAC keys were used. A remote attacker could
    possibly use this issue to cause ntpd to crash resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5175-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'ntp', 'pkgver': '1:4.2.8p12+dfsg-3ubuntu4.20.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'ntpdate', 'pkgver': '1:4.2.8p12+dfsg-3ubuntu4.20.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'sntp', 'pkgver': '1:4.2.8p12+dfsg-3ubuntu4.20.04.1+esm1', 'ubuntu_pro': TRUE}
];
