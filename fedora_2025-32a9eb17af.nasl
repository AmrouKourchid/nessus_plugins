...
# extracted from Fedora Security Advisory FEDORA-2025-32a9eb17af
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-32a9eb17af");
  script_xref(name:"IAVA", value:"2025-A-0306");

  script_name(english:"Fedora 40 : mingw-LibRaw (2025-32a9eb17af)");
...
FEDORA-2025-32a9eb17af advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-32a9eb17af");
...
var pkgs = [
    {'reference':'mingw-LibRaw-0.21.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
