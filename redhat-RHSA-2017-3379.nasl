...
the RHSA-2017:3379 advisory.
    ...
    * It was found that sssd's sysdb_search_user_by_upn_res() function did not sanitize requests when querying
    its local cache and was vulnerable to injection. In a centralized login environment, if a password hash
    was locally cached for a given user, an authenticated attacker could use this flaw to retrieve it.
    (CVE-2017-12173)
    ...
    * Previously, SSSD's krb5 provider did not respect changed UIDs in ID views overriding the default view.
    Consequently, Kerberos credential caches were created with the incorrect, original UID, and processes of
    the user were not able to find the changed UID. With this update, SSSD's krb5 provider is made aware of
    the proper ID view name and respects the ID override data. As a result, the Kerberos credential cache is
    now created with the expected UID, and the processes can find it. (BZ#1508972)

    * Previously, the list of cache request domains was sometimes freed in the middle of a cache request
    operation due to the refresh domains request, as they both were using the same list. As a consequence, a
    segmentation fault sometimes occurred in SSSD. With this update, SSSD uses a copy of the cache request
    domains' list for each cache request. As a result, SSSD no longer crashes in this case. (BZ#1509177)

    * Previously, the calls provided by SSSD to send data to the Privilege Attribute Certificate (PAC)
    responder did not use a mutex or any other means to serialize access to the PAC responder from a single
    process. When multithreaded applications overran the PAC responder with multiple parallel requests, some
    threads did not receive a proper reply. Consequently, such threads only resumed work after waiting 5
    minutes for a response. This update configures mutex to serialize access to the PAC responder socket for
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_3379.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?96291dbc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:3379");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1498173");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1506142");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1506682");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1509177");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sssd package based on the guidance in RHSA-2017:3379.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libipa_hbac-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libipa_hbac-devel-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_autofs-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_certmap-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_certmap-devel-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_idmap-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_idmap-devel-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_nss_idmap-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_nss_idmap-devel-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_simpleifp-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_simpleifp-devel-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_sudo-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-libipa_hbac-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-libsss_nss_idmap-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-sss-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-sss-murmur-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-sssdconfig-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ad-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-client-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-common-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-common-pac-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-dbus-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ipa-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-kcm-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-krb5-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-krb5-common-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ldap-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-libwbclient-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-libwbclient-devel-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-polkit-rules-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-proxy-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-tools-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-winbind-idmap-1.15.2-50.el7_4.8', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
