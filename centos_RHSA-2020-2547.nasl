...
# extracted from Red Hat Security Advisory RHSA-2020:2547.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : flash-plugin (RHSA-2020:2547)");
...
RHSA-2020:2547 advisory.

  - Adobe Flash Player Desktop Runtime 32.0.0.371 and earlier, Adobe Flash Player for Google Chrome 32.0.0.371
    and earlier, and Adobe Flash Player for Microsoft Edge and Internet Explorer 32.0.0.330 and earlier have
...
var pkgs = [
    {'reference':'flash-plugin-32.0.0.387-1.el6_10', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE}
];
