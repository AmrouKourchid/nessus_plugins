...
if (description)
{
  ...
  script_cve_id("CVE-2010-2431");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2010-2431");
...
patch available.
  ...
  - The cupsFileOpen function in CUPS before 1.4.4 allows local users, with lp group membership, to overwrite
    arbitrary files via a symlink attack on the (1) /var/cache/cups/remote.cache or (2)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-2431");
