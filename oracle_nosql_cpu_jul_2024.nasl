...
if (description)
{
  ...
  script_name(english:"Oracle NoSQL Database (Jul 2024 CPU)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Oracle NoSQL Database running on the remote host is prior to 23.3.34. It is, therefore, affected by a
vulnerability as referenced in the July 2024 CPU advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.oracle.com/security-alerts/cpujul2024.html#AppendixNSQL");
...
var constraints = [
  { 'fixed_version' : '19.5.42', 'fixed_display' : '23.3.34' },
  { 'min_version' : '20.0', 'fixed_version' : '20.3.40', 'fixed_display' : '23.3.34' },
  { 'min_version' : '21.0', 'fixed_version' : '21.2.27', 'fixed_display' : '23.3.34' },
  { 'min_version' : '22.0', 'fixed_version' : '22.3.46', 'fixed_display' : '23.3.34' },
  { 'min_version' : '23.0', 'fixed_version' : '23.3.32', 'fixed_display' : '23.3.34' }
];
