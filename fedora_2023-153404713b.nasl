...
# extracted from Fedora Security Advisory FEDORA-2023-153404713b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-153404713b");

  script_name(english:"Fedora 39 : proftpd (2023-153404713b)");
...
FEDORA-2023-153404713b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-153404713b");
...
var pkgs = [
    {'reference':'proftpd-1.3.8b-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
