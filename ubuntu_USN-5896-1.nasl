...
# extracted from Ubuntu Security Notice USN-5896-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5896-1");

  script_name(english:"Ubuntu 18.04 ESM / 20.04 ESM / 22.04 ESM : Rack vulnerabilities (USN-5896-1)");
...
vulnerabilities as referenced in the USN-5896-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5896-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'ruby-rack', 'pkgver': '1.6.4-4ubuntu0.2+esm2', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'ruby-rack', 'pkgver': '2.0.7-2ubuntu0.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'ruby-rack', 'pkgver': '2.1.4-5ubuntu1+esm2', 'ubuntu_pro': TRUE}
];
