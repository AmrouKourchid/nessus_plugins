...
# SUSE update advisory SUSE-SU-2023:2839-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-31047", "CVE-2023-36053");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2839-1");

  script_name(english:"openSUSE 15 Security Update : python-Django (SUSE-SU-2023:2839-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1210866");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1212742");
  # https://lists.suse.com/pipermail/sle-security-updates/2023-July/015497.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7743f13e");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-31047");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-36053");
...
var pkgs = [
    {'reference':'python3-Django-2.0.7-150000.1.11.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
