...
"The remote Red Hat host is missing one or more security updates for virt:8.1 / virt-devel:8.1.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4290.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?afff6e42");
...
"Update the RHEL virt:8.1 / virt-devel:8.1 packages based on the guidance in RHSA-2020:4290.");
