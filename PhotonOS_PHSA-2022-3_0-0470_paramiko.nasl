...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Paramiko PHSA-2022-3.0-0470");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the paramiko package has been released.");
...
if (rpm_check(release:'PhotonOS-3.0', reference:'paramiko-2.7.2-2.ph3')) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'paramiko');
}
