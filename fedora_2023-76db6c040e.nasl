...
# extracted from Fedora Security Advisory FEDORA-2023-76db6c040e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-76db6c040e");

  script_name(english:"Fedora 39 : seamonkey (2023-76db6c040e)");
...
FEDORA-2023-76db6c040e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-76db6c040e");
...
var pkgs = [
    {'reference':'seamonkey-2.53.18-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
