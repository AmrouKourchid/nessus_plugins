...
# extracted from Red Hat Security Advisory RHSA-2020:4844. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4844");

  script_name(english:"RHEL 8 : fontforge (RHSA-2020:4844)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4844.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a5227c9");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.3_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7e37d18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4844");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1893188");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL fontforge package based on the guidance in RHSA-2020:4844.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-25690");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'fontforge-20170731-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
