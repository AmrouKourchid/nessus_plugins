...
# extracted from Red Hat Security Advisory fuseiso. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : fuseiso (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:fuseiso");
