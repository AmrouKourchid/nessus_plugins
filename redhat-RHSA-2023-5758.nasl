...
# extracted from Red Hat Security Advisory RHSA-2023:5758. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-5115", "CVE-2023-41164", "CVE-2023-43665");
  script_xref(name:"RHSA", value:"2023:5758");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.4 Product Security and Bug Fix Update (Moderate) (RHSA-2023:5758)");
...
referenced in the RHSA-2023:5758 advisory.
    ...
    * automation controller: Added a new subscription usage page to the controller UI to view historical usage
    of licenses (AAP-16983)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5758.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?84a1d2ca");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5758");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-core-2.15.5-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-5115']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.4.6-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-41164']},
      {'reference':'python39-django-3.2.22-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-43665']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-core-2.15.5-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-5115']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'automation-controller-venv-tower-4.4.6-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-41164']},
      {'reference':'python3-django-3.2.22-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-43665']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ansible-core / automation-controller-venv-tower / python3-django / etc');
}
