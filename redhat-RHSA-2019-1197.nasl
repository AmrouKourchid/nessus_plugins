...
# extracted from Red Hat Security Advisory RHSA-2019:1197. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1197.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d3a1cad7");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1197");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libvirt package based on the guidance in RHSA-2019:1197.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvirt-0.10.2-29.el6_5.18', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-0.10.2-29.el6_5.18', 'sp':'5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-0.10.2-29.el6_5.18', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-0.10.2-29.el6_5.18', 'sp':'5', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-0.10.2-29.el6_5.18', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-lock-sanlock-0.10.2-29.el6_5.18', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-python-0.10.2-29.el6_5.18', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
