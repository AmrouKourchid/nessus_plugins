...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libksba (EulerOS-SA-2023-2155)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2155
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?db8cd7a4");
...
var pkgs = [
  "libksba-1.3.0-5.h3.eulerosv2r7"
];
