...
# extracted from Red Hat Security Advisory RHSA-2022:8219. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8219");

  script_name(english:"RHEL 9 : mutt (RHSA-2022:8219)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8219.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0b936e52");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.1_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f1eb6cc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8219");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2076058");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mutt package based on the guidance in RHSA-2022:8219.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mutt-2.2.6-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
    ]
  }
];
