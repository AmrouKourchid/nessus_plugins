...
# extracted from Oracle Linux Security Advisory ELSA-2023-0116.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libtasn1 (ELSA-2023-0116)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2023-0116 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-0116.html");
...
var pkgs = [
    ...
    {'reference':'libtasn1-tools-4.13-4.el8_7', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
