...
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.5.41.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2431.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2c550a17");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1972114");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.5.41 package based on the guidance in RHSA-2021:2431.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.5.1623326336-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-21642', 'CVE-2021-21643', 'CVE-2021-21644', 'CVE-2021-21645']},
      {'reference':'jenkins-2.277.3.1623846768-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-27216', 'CVE-2020-27218', 'CVE-2020-27223']}
    ]
  }
];
