...
# extracted from Red Hat Security Advisory RHSA-2024:10271. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10271");

  script_name(english:"RHEL 8 : haproxy (RHSA-2024:10271)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10271.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8972f53a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10271");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL haproxy package based on the guidance in RHSA-2024:10271.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy-1.8.27-2.el8_4.1', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'haproxy-1.8.27-2.el8_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
