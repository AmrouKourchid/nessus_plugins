...
# extracted from Fedora Security Advisory FEDORA-2023-abb47e24d8
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-3064", "CVE-2022-41717", "CVE-2022-41723");
  script_xref(name:"FEDORA", value:"2023-abb47e24d8");

  script_name(english:"Fedora 36 : gmailctl (2023-abb47e24d8)");
...
FEDORA-2023-abb47e24d8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-abb47e24d8");
...
var pkgs = [
    {'reference':'gmailctl-0.10.6-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
