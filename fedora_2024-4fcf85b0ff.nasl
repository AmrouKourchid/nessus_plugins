...
# extracted from Fedora Security Advisory FEDORA-2024-4fcf85b0ff
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4fcf85b0ff");
  script_xref(name:"IAVA", value:"2024-A-0465-S");

  script_name(english:"Fedora 39 : firefox / nss (2024-4fcf85b0ff)");
...
FEDORA-2024-4fcf85b0ff advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4fcf85b0ff");
...
var pkgs = [
    {'reference':'firefox-129.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'nss-3.103.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
