...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 20.x < 20.0.9 / 21.x < 21.1.1 Multiple Vulnerabilities (APSB20-14)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop CC or Photoshop installed on the remote Windows host is prior to 20.0.9/21.1.1. It is,
therefore, affected by multiple vulnerabilities as referenced in the apsb20-14 advisory.
...
var constraints = [
  ...
  { 'min_version' : '21.0.0', 'fixed_version' : '21.1.1' }
];
