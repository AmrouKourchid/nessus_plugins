...
# extracted from Gentoo Linux Security Advisory GLSA 202006-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202006-05");

  script_name(english:"GLSA-202006-05 : Nokogiri: Command injection");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202006-05
(Nokogiri: Command injection)

    A command injection vulnerability in Nokogiri allows commands to be
      executed in a subprocess by Ruby&rsquo;s Kernel.open method. Processes are
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://github.com/sparklemotion/nokogiri/issues/1915");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202006-05");
...
if (qpkg_check(package:"dev-ruby/nokogiri", unaffected:make_list("ge 1.10.4"), vulnerable:make_list("lt 1.10.4"))) flag++;
