...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5023698");
  script_xref(name:"MSFT", value:"MS23-5023698");
  ...
  script_name(english:"KB5023698: Windows 11 version 21H2 Security Update (March 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5023698. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5023698");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5023698");
