...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : openssh (EulerOS-SA-2024-2454)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2454
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89e1026e");
...
var pkgs = [
  "openssh-8.8p1-14.h19.eulerosv2r12",
  "openssh-clients-8.8p1-14.h19.eulerosv2r12",
  "openssh-server-8.8p1-14.h19.eulerosv2r12"
];
