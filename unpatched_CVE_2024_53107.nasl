...
if (description)
{
  ...
  script_cve_id("CVE-2024-53107");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-53107");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: fs/proc/task_mmu: prevent integer
    overflow in pagemap_scan_get_args() The arg->vec_len variable is a u64 that comes from the user at the
    start of the function. The arg->vec_len * sizeof(struct page_region)) multiplication can lead to integer
    wrapping. Use size_mul() to avoid that. Also the size_add/mul() functions work on unsigned long so for
    32bit systems we need to ensure that arg->vec_len fits in an unsigned long. (CVE-2024-53107)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53107");
