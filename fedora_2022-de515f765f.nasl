...
# extracted from Fedora Security Advisory FEDORA-2022-de515f765f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-de515f765f");

  script_name(english:"Fedora 35 : nodejs (2022-de515f765f)");
...
FEDORA-2022-de515f765f advisory.
    ...
    [September Security Updates for Node.js](https://nodejs.org/en/blog/vulnerability/september-2022-security-
    releases/)
    ...
    Note that we will be skipping 16.14.2 since the only changes were in the bundled copy of OpenSSL, which we
    do not use. The relevant security patches are handled in Fedora's `openssl` package.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-de515f765f");
...
var pkgs = [
    {'reference':'nodejs-16.18.1-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
