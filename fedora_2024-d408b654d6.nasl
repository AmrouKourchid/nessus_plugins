...
# extracted from Fedora Security Advisory FEDORA-2024-d408b654d6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d408b654d6");

  script_name(english:"Fedora 39 : matrix-synapse / rust-pythonize (2024-d408b654d6)");
...
FEDORA-2024-d408b654d6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d408b654d6");
...
var pkgs = [
    {'reference':'matrix-synapse-1.105.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-pythonize-0.21.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
