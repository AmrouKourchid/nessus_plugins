...
# extracted from Debian Security Advisory dsa-5508. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5508-1 : chromium - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5508");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-5186");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-5187");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'chromium', 'reference': '117.0.5938.132-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-common', 'reference': '117.0.5938.132-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-driver', 'reference': '117.0.5938.132-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-l10n', 'reference': '117.0.5938.132-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-sandbox', 'reference': '117.0.5938.132-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-shell', 'reference': '117.0.5938.132-1~deb11u1'},
    {'release': '12.0', 'prefix': 'chromium', 'reference': '117.0.5938.132-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-common', 'reference': '117.0.5938.132-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-driver', 'reference': '117.0.5938.132-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-l10n', 'reference': '117.0.5938.132-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-sandbox', 'reference': '117.0.5938.132-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-shell', 'reference': '117.0.5938.132-1~deb12u1'}
];
