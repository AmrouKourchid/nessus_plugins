...
# openSUSE Security Update openSUSE-SU-2023:0177-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-Django1 (openSUSE-SU-2023:0177-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae75a52f");
...
var pkgs = [
    {'reference':'python3-Django1-1.11.29-bp154.2.6.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
