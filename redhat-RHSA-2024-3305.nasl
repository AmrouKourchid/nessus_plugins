...
# extracted from Red Hat Security Advisory RHSA-2024:3305. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3305");

  script_name(english:"RHEL 8 : varnish:6 (RHSA-2024:3305)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for varnish:6.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3305 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3305.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e00dc52");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3305");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL varnish:6 package based on the guidance in RHSA-2024:3305.");
  ...
  'varnish:6': [
    {
      ...
      'pkgs': [
        {'reference':'varnish-6.0.8-3.module+el8.8.0+21796+79393093.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-devel-6.0.8-3.module+el8.8.0+21796+79393093.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-docs-6.0.8-3.module+el8.8.0+21796+79393093.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-modules-0.15.0-6.module+el8.5.0+11976+0b4af72d', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
