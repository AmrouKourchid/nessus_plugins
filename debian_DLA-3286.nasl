...
# extracted from Debian Security Advisory dla-3286. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3286 : tor - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3286
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3286-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                    Thorsten Alteholz
    January 28, 2023                              https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------

    Package        : tor
    Version        : 0.3.5.16-1+deb10u1
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/tor");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'tor', 'reference': '0.3.5.16-1+deb10u1'},
    {'release': '10.0', 'prefix': 'tor-geoipdb', 'reference': '0.3.5.16-1+deb10u1'}
];
