...
# extracted from Debian Security Advisory DLA-2390-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2390-1 : ruby-json-jwt security update");
...
Therefore, there was a need to explicitly specify the number of
elements when splitting a JWE string.
...
For the detailed security status of ruby-json-jwt please refer to its
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/10/msg00001.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/ruby-json-jwt");
  # https://security-tracker.debian.org/tracker/source-package/ruby-json-jwt
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0f0dbb2d");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected ruby-json-jwt package.");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"ruby-json-jwt", reference:"1.6.2-1+deb9u2")) flag++;
