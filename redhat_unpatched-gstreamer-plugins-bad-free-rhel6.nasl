...
# extracted from Red Hat Security Advisory gstreamer-plugins-bad-free. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-9446", "CVE-2017-5843", "CVE-2017-5848");

  script_name(english:"RHEL 6 : gstreamer-plugins-bad-free (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw-gstreamer-plugins-bad-free");
