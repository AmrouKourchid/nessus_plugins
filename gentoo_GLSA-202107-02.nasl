...
# extracted from Gentoo Linux Security Advisory GLSA 202107-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-02");

  script_name(english:"GLSA-202107-02 : FreeImage: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-02"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All FreeImage users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:freeimage");
...
if (qpkg_check(package:"media-libs/freeimage", unaffected:make_list("ge 3.18.0-r2"), vulnerable:make_list("lt 3.18.0-r2"))) flag++;
