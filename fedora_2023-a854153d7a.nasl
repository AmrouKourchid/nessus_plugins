...
# extracted from Fedora Security Advisory FEDORA-2023-a854153d7a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a854153d7a");

  script_name(english:"Fedora 39 : opensc (2023-a854153d7a)");
...
FEDORA-2023-a854153d7a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a854153d7a");
...
var pkgs = [
    {'reference':'opensc-0.24.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
