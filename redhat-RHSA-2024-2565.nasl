...
# extracted from Red Hat Security Advisory RHSA-2024:2565. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2565");

  script_name(english:"RHEL 9 : libreswan (RHSA-2024:2565)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2565.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70aadc55");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2565");
...
"Update the RHEL libreswan package based on the guidance in RHSA-2024:2565.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.12-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libreswan-4.12-2.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
