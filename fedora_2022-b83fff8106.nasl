...
# extracted from Fedora Security Advisory FEDORA-2022-b83fff8106
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-b83fff8106");

  script_name(english:"Fedora 36 : thunderbird (2022-b83fff8106)");
...
FEDORA-2022-b83fff8106 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-b83fff8106");
...
var pkgs = [
    {'reference':'thunderbird-102.5.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
