...
# extracted from Fedora Security Advisory FEDORA-2022-cbbd105d08
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-cbbd105d08");

  script_name(english:"Fedora 35 : heimdal (2022-cbbd105d08)");
...
FEDORA-2022-cbbd105d08 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-cbbd105d08");
...
var pkgs = [
    {'reference':'heimdal-7.7.1-3.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
