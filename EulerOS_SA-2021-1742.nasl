...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : samba (EulerOS-SA-2021-1742)");
...
following vulnerability :
  ...
  - A NULL pointer dereference, or possible use-after-free
    flaw was found in the Samba AD LDAP server. Although
    some versions of Samba shipped with Red Hat Enterprise
    Linux do not support Samba in AD mode, the affected
    code is shipped with the libldb package. This flaw
    allows an authenticated user to possibly trigger a
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1742
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85d47a8e");
...
pkgs = ["libsmbclient-4.11.6-6.h13.eulerosv2r9",
        "libwbclient-4.11.6-6.h13.eulerosv2r9",
        "samba-client-4.11.6-6.h13.eulerosv2r9",
        "samba-common-4.11.6-6.h13.eulerosv2r9",
        "samba-common-tools-4.11.6-6.h13.eulerosv2r9",
        "samba-libs-4.11.6-6.h13.eulerosv2r9"];
