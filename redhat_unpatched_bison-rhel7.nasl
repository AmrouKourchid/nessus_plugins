...
# extracted from Red Hat Security Advisory bison. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-14150", "CVE-2020-24979");

  script_name(english:"RHEL 7 : bison (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-14150");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bison");
