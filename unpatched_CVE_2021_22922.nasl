...
if (description)
{
  ...
  script_cve_id("CVE-2021-22922");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-22922");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2021/07/25");
