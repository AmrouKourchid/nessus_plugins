...
if (description)
{
  ...
  script_cve_id("CVE-2023-23931", "CVE-2023-48795", "CVE-2023-49083");
  script_xref(name:"IAVA", value:"2023-A-0703");

  script_name(english:"Photon OS 5.0: Python3 PHSA-2024-5.0-0187");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'python3-cryptography-41.0.7-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', reference:'python3-paramiko-2.12.0-5.ph5')) flag++;
