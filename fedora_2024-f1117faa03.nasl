...
# extracted from Fedora Security Advisory FEDORA-2024-f1117faa03
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f1117faa03");

  script_name(english:"Fedora 40 : chromium (2024-f1117faa03)");
...
FEDORA-2024-f1117faa03 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f1117faa03");
...
var pkgs = [
    {'reference':'chromium-130.0.6723.69-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
