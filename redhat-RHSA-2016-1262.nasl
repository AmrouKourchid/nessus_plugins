...
the RHSA-2016:1262 advisory.
    ...
    * Multiple flaws were found in the processing of malformed web content. A web page containing malicious
    ...
    visited by the victim. (CVE-2016-1704)
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2016/rhsa-2016_1262.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fa57208f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:1262");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1347675");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL chromium-browser package based on the guidance in RHSA-2016:1262.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'chromium-browser-51.0.2704.103-1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'chromium-browser-51.0.2704.103-1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
