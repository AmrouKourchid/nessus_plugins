...
# extracted from Fedora Security Advisory FEDORA-2023-492b7be466
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-492b7be466");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 39 : mod_http2 (2023-492b7be466)");
...
FEDORA-2023-492b7be466 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-492b7be466");
...
var pkgs = [
    {'reference':'mod_http2-2.0.25-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
