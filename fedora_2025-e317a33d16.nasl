...
# extracted from Fedora Security Advisory FEDORA-2025-e317a33d16
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e317a33d16");

  script_name(english:"Fedora 40 : mariadb10.11 (2025-e317a33d16)");
...
FEDORA-2025-e317a33d16 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e317a33d16");
...
var pkgs = [
    {'reference':'mariadb10.11-10.11.11-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
