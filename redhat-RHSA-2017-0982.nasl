...
# extracted from Red Hat Security Advisory RHSA-2017:0982. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:0982");

  script_name(english:"RHEL 7 : qemu-kvm-rhev (RHSA-2017:0982)");
...
referenced in the RHSA-2017:0982 advisory.
    ...
    * Quick Emulator (QEMU), built with the Cirrus CLGD 54xx VGA Emulator and the VNC display driver support,
    is vulnerable to a heap buffer overflow issue. The issue could occur when a VNC client attempts to update
    its display after a VGA operation is performed by a guest. A privileged user/process inside guest could
    use this flaw to crash the QEMU process resulting in DoS or, potentially, leverage it to execute arbitrary
    code on the host with privileges of the QEMU process. (CVE-2016-9603)
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_0982.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fbe827b4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:0982");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2017:0982.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-rhev-2.6.0-28.el7_3.9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-common-rhev-2.6.0-28.el7_3.9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-rhev-2.6.0-28.el7_3.9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-tools-rhev-2.6.0-28.el7_3.9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'}
    ]
  }
];
