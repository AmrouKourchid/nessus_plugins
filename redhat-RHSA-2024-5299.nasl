...
# extracted from Red Hat Security Advisory RHSA-2024:5299. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5299");

  script_name(english:"RHEL 8 : wget (RHSA-2024:5299)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5299.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?61b16b36");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5299");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL wget package based on the guidance in RHSA-2024:5299.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wget-1.19.5-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
