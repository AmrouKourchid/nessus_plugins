...
# extracted from Fedora Security Advisory FEDORA-2023-2932e6c7d8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2932e6c7d8");

  script_name(english:"Fedora 37 : kernel (2023-2932e6c7d8)");
...
FEDORA-2023-2932e6c7d8 advisory.

    The 6.3.12 stable kernel update contains a number of important fixes across the tree.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2932e6c7d8");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-2932e6c7d8');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.3.12-100.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
