...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Perl PHSA-2018-2.0-0050");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'perl-5.24.1-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'perl-debuginfo-5.24.1-5.ph2')) flag++;
