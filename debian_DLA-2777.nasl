...
dla-2777 advisory.
    ...
    CVE-2020-19131 Buffer Overflow in LibTiff allows attackers to cause a denial of service via the
    invertImage() function in the component tiffcrop. CVE-2020-19144 Buffer Overflow in LibTiff allows
    attackers to cause a denial of service via the in _TIFFmemcpy funtion in the component tif_unix.c. For
    Debian 9 stretch, these problems have been fixed in version 4.0.8-2+deb9u7. We recommend that you upgrade
    your tiff packages. For the detailed security status of tiff please refer to its security tracker page at:
