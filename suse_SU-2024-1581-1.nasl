...
# SUSE update advisory SUSE-SU-2024:1581-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-5717", "CVE-2024-0775", "CVE-2024-1086");
  script_xref(name:"SuSE", value:"SUSE-SU-2024:1581-1");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/06/20");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 39 for SLE 15 SP2) (SUSE-SU-2024:1581-1)");
...
the SUSE-SU-2024:1581-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-May/018496.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?153e5de9");
...
"Update the affected kernel-livepatch-5_3_18-150200_24_160-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150200.24.160-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150200_24_160-default-9-150200.2.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150200_24_160-default');
}
