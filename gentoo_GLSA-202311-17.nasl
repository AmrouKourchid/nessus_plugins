...
# extracted from Gentoo Linux Security Advisory GLSA 202311-17.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-0813", "CVE-2022-23807", "CVE-2022-23808");

  script_name(english:"GLSA-202311-17 : phpMyAdmin: Multiple Vulnerabilities");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202311-17");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=831841");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=835071");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 5.2.0"),
    'vulnerable' : make_list("lt 5.2.0")
  }
];
