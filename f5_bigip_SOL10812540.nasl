...
# extracted from F5 Networks BIG-IP Solution K10812540.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenJDK vulnerability (K10812540)");
...
affected by a vulnerability as referenced in the K10812540 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K10812540");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K10812540.");
