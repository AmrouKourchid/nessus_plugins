...
# extracted from Debian Security Advisory dla-3599. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3599 : exim4 - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'exim4', 'reference': '4.92-8+deb10u8'},
    {'release': '10.0', 'prefix': 'exim4-base', 'reference': '4.92-8+deb10u8'},
    {'release': '10.0', 'prefix': 'exim4-config', 'reference': '4.92-8+deb10u8'},
    {'release': '10.0', 'prefix': 'exim4-daemon-heavy', 'reference': '4.92-8+deb10u8'},
    {'release': '10.0', 'prefix': 'exim4-daemon-light', 'reference': '4.92-8+deb10u8'},
    {'release': '10.0', 'prefix': 'exim4-dev', 'reference': '4.92-8+deb10u8'},
    {'release': '10.0', 'prefix': 'eximon4', 'reference': '4.92-8+deb10u8'}
];
