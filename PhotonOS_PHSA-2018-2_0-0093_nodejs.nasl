...
"An update of the nodejs package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-93.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nodejs-8.11.4-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nodejs-debuginfo-8.11.4-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nodejs-devel-8.11.4-1.ph2')) flag++;
