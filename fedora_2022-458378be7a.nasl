...
# extracted from Fedora Security Advisory FEDORA-2022-458378be7a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-458378be7a");

  script_name(english:"Fedora 35 : sfnt2woff-zopfli (2022-458378be7a)");
...
FEDORA-2022-458378be7a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-458378be7a");
...
var pkgs = [
    {'reference':'sfnt2woff-zopfli-1.3.1-3.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
