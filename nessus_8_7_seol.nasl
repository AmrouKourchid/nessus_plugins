...
if (description)
{
  ...
  script_name(english:"Tenable Nessus SEoL (8.7.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus is 8.7.x. It is, therefore, no longer maintained by its vendor or provider.
...
var constraints = [
  { max_branch : '8.7', min_branch : '8.7', seol : 20210331, eseol : 20210930 }
];
