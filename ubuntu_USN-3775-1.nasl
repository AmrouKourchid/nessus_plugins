...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Linux kernel vulnerabilities (USN-3775-1)");
...
the USN-3775-1 advisory.
    ...
    It was discovered that an integer overflow vulnerability existed in the Linux kernel when loading an
    executable to run. A local attacker could use this to gain administrative privileges. (CVE-2018-14634)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3775-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-160-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-160-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-160-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-160-powerpc-e500");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-160-powerpc-e500mc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-160-powerpc-smp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-160-powerpc64-emb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-160-powerpc64-smp");
...
var kernel_mappings = {
  '14.04': {
    '3.13.0': {
      'generic': '3.13.0-160',
      'generic-lpae': '3.13.0-160',
      'lowlatency': '3.13.0-160',
      'powerpc-e500': '3.13.0-160',
      'powerpc-e500mc': '3.13.0-160',
      'powerpc-smp': '3.13.0-160',
      'powerpc64-emb': '3.13.0-160',
      'powerpc64-smp': '3.13.0-160'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3775-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2018-6554', 'CVE-2018-6555', 'CVE-2018-14633', 'CVE-2018-14634', 'CVE-2018-15572', 'CVE-2018-15594');
