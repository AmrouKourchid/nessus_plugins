...
# openSUSE Security Update openSUSE-SU-2021:0882-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : htmldoc (openSUSE-SU-2021:0882-1)");
...
openSUSE-SU-2021:0882-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1184424");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/RXMQHLXPNKTCGM4HNTMLHF7NWL3ZXKIO/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73ef2946");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2021-20308");
...
"Update the affected htmldoc package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-20308");
...
pkgs = [
    {'reference':'htmldoc-1.9.12-lp152.4.3.1', 'cpu':'x86_64', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
