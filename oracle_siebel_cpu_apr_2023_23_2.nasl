...
if (description)
{
  ...
  script_cve_id("CVE-2022-42003", "CVE-2022-42004", "CVE-2022-42252");

  script_name(english:"Oracle Siebel Server <= 23.2 (April 2023 CPU)");
...
the April 2023 CPU advisory.
  ...
  - Vulnerability in the Siebel CRM product of Oracle Siebel CRM (component: Services (Apache Tomcat)).
    Supported versions that are affected are 23.2 and prior. Easily exploitable vulnerability allows
    ...
    Siebel CRM accessible data. (CVE-2022-42252)

  - Vulnerability in the Siebel CRM product of Oracle Siebel CRM (component: EAI (jackson-databind)).
    Supported versions that are affected are 23.2 and prior. Easily exploitable vulnerability allows
    unauthenticated attacker with network access via HTTP to compromise Siebel CRM. Successful attacks of this
    vulnerability can result in unauthorized ability to cause a hang or frequently repeatable crash (complete
    DOS) of Siebel CRM. (CVE-2022-42003, CVE-2022-42004)
...
var constraints = [
  { 'max_version' : '23.2.999', 'fixed_version' : '23.4' }
];
