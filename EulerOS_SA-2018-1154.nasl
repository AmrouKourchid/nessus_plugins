...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : binutils (EulerOS-SA-2018-1154)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1154
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0046f2ec");
...
pkgs = ["binutils-2.25.1-22.base.h8",
        "binutils-devel-2.25.1-22.base.h8"];
