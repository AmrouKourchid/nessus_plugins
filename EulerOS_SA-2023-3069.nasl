...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : dbus (EulerOS-SA-2023-3069)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3069
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3c89131");
...
var pkgs = [
  "dbus-1.12.20-6.h10.eulerosv2r11",
  "dbus-common-1.12.20-6.h10.eulerosv2r11",
  "dbus-daemon-1.12.20-6.h10.eulerosv2r11",
  "dbus-libs-1.12.20-6.h10.eulerosv2r11",
  "dbus-tools-1.12.20-6.h10.eulerosv2r11"
];
