...
# extracted from Ubuntu Security Notice USN-6294-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6294-2");

  script_name(english:"Ubuntu 20.04 LTS : HAProxy vulnerability (USN-6294-2)");
...
USN-6294-2 advisory.
    ...
    USN-6294-1 fixed vulnerabilities in HAProxy. This update provides the corresponding updates for Ubuntu
    20.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6294-2");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'haproxy', 'pkgver': '2.0.31-0ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'vim-haproxy', 'pkgver': '2.0.31-0ubuntu0.2'}
];
