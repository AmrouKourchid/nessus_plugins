...
if (description)
{
  ...
  script_cve_id("CVE-2024-21165");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-21165");
...
patch available.
  ...
  - Vulnerability in the MySQL Server product of Oracle MySQL (component: Server: Pluggable Auth). Supported
    versions that are affected are 8.0.37 and prior. Easily exploitable vulnerability allows high privileged
    ...
    DOS) of MySQL Server. (CVE-2024-21165)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21165");
