...
# extracted from Red Hat Security Advisory RHSA-2025:1725. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1725");
  script_xref(name:"IAVB", value:"2025-B-0028");

  script_name(english:"RHEL 9 : libpq (RHSA-2025:1725)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1725.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?da53f6d7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1725");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libpq package based on the guidance in RHSA-2025:1725.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libpq-13.20-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libpq-devel-13.20-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
