...
# extracted from Fedora Security Advisory FEDORA-2023-42313af0de
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-42313af0de");
  script_xref(name:"IAVA", value:"2023-A-0521-S");

  script_name(english:"Fedora 38 : exim (2023-42313af0de)");
...
FEDORA-2023-42313af0de advisory.

    This is exim update fixing several security problems.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-42313af0de");
...
var pkgs = [
    {'reference':'exim-4.96.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
