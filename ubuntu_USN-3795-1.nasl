...
referenced in the USN-3795-1 advisory.

    Peter Winter-Smith discovered that libssh incorrectly handled authentication when being used as a server.
    A remote attacker could use this issue to bypass authentication without any credentials.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3795-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libssh-4', 'pkgver': '0.6.1-0ubuntu3.4'},
    {'osver': '14.04', 'pkgname': 'libssh-dev', 'pkgver': '0.6.1-0ubuntu3.4'},
    {'osver': '16.04', 'pkgname': 'libssh-4', 'pkgver': '0.6.3-4.3ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'libssh-dev', 'pkgver': '0.6.3-4.3ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'libssh-gcrypt-4', 'pkgver': '0.6.3-4.3ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'libssh-gcrypt-dev', 'pkgver': '0.6.3-4.3ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'libssh-4', 'pkgver': '0.8.0~20170825.94fa1e38-1ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'libssh-dev', 'pkgver': '0.8.0~20170825.94fa1e38-1ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'libssh-gcrypt-4', 'pkgver': '0.8.0~20170825.94fa1e38-1ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'libssh-gcrypt-dev', 'pkgver': '0.8.0~20170825.94fa1e38-1ubuntu0.1'}
];
