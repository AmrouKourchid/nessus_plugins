...
# extracted from Fedora Security Advisory FEDORA-2023-508e400dec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-508e400dec");

  script_name(english:"Fedora 38 : flatpak (2023-508e400dec)");
...
FEDORA-2023-508e400dec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-508e400dec");
...
var pkgs = [
    {'reference':'flatpak-1.15.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
