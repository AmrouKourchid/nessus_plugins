...
# extracted from Red Hat Security Advisory RHSA-2023:0333. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0333");

  script_name(english:"RHEL 9 : curl (RHSA-2023:0333)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0333.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7fa446ab");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2135411");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0333");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL curl package based on the guidance in RHSA-2023:0333.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'curl-7.76.1-19.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'curl-minimal-7.76.1-19.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-7.76.1-19.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-devel-7.76.1-19.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-minimal-7.76.1-19.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
