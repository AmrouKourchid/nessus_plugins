...
# SUSE update advisory SUSE-SU-2025:0449-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2022-48912", "CVE-2024-45016", "CVE-2024-47684");
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0449-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 44 for SLE 15 SP3) (SUSE-SU-2025:0449-1)");
...
the SUSE-SU-2025:0449-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-February/020322.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2e7b0249");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150300.59.161-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_161-default-11-150300.2.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
