...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2436.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python-jinja2 (ALAS-2024-2436)");
...
vulnerability as referenced in the ALAS2-2024-2436 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2436.html");
...
var pkgs = [
    {'reference':'python-jinja2-2.7.2-3.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
