...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libldb (EulerOS-SA-2023-2211)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libldb packages installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2211
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1abae712");
...
var pkgs = [
  "ldb-tools-1.4.2-1.h7.eulerosv2r8",
  "libldb-1.4.2-1.h7.eulerosv2r8",
  "libldb-devel-1.4.2-1.h7.eulerosv2r8",
  "python2-ldb-1.4.2-1.h7.eulerosv2r8",
  "python3-ldb-1.4.2-1.h7.eulerosv2r8"
];
