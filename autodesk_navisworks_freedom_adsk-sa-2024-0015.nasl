...
if (description)
{
  ...
  script_name(english:"Autodesk Navisworks Freedom 25.0.x < 25.0.999.0 (2025.3) Multiple Vulnerabilities (adsk-sa-2024-0015)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The version of Autodesk Navisworks Freedom installed on the remote host is prior to 25.0.999.0 (2025.3). It is,
...
"Upgrade to Autodesk Navisworks Freedom version 25.0.999.0 (2025.3) or later.");
