...
# extracted from Red Hat Security Advisory RHSA-2024:3347. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3347.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?864b1406");
...
"Update the RHEL python3 package based on the guidance in RHSA-2024:3347.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'platform-python-3.6.8-62.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'platform-python-debug-3.6.8-62.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'platform-python-devel-3.6.8-62.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-idle-3.6.8-62.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libs-3.6.8-62.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-test-3.6.8-62.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-tkinter-3.6.8-62.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
