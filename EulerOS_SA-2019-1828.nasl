...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : compat-openssl10 (EulerOS-SA-2019-1828)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1828
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?deaa9cdd");
...
pkgs = ["compat-openssl10-1.0.2o-3.h4.eulerosv2r8"];
