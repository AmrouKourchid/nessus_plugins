...
# extracted from Fedora Security Advisory FEDORA-2023-bf8423a373
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bf8423a373");

  script_name(english:"Fedora 37 : flac (2023-bf8423a373)");
...
FEDORA-2023-bf8423a373 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bf8423a373");
...
var pkgs = [
    {'reference':'flac-1.3.4-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
