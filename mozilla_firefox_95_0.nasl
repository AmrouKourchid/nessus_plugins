...
"The version of Firefox installed on the remote Windows host is prior to 95.0. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2021-52 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'95.0', xss:TRUE, severity:SECURITY_WARNING);
