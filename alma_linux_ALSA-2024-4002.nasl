...
# AlmaLinux Security Advisory ALSA-2024:4002.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4002");
  script_xref(name:"IAVA", value:"2024-A-0387-S");

  script_name(english:"AlmaLinux 9 : thunderbird (ALSA-2024:4002)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-4002.html");
...
var pkgs = [
    {'reference':'thunderbird-115.12.1-1.el9_4.alma.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.12.1-1.el9_4.alma.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
