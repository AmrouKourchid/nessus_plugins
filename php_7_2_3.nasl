...
if (description)
{
  ...
  script_name(english:"PHP 7.2.x < 7.2.3 Stack Buffer Overflow");
...
server is 7.2.x prior to 7.2.3. It is, therefore, affected by
a stack buffer overflow vulnerability.");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.2.3");
...
"Upgrade to PHP version 7.2.3 or later.");
