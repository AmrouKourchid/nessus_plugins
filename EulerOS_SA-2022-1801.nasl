...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : bluez (EulerOS-SA-2022-1801)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the bluez package installed, the EulerOS installation on the remote host is affected by the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1801
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?546c3298");
...
"Update the affected bluez packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:bluez-help");
...
var pkgs = [
  "bluez-help-5.54-1.h8.eulerosv2r10"
];
