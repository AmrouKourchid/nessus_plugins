...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2543.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : cni-plugins (ALAS-2024-2543)");
...
vulnerability as referenced in the ALAS2-2024-2543 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2543.html");
...
var pkgs = [
    {'reference':'cni-plugins-1.2.0-1.amzn2.0.5', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cni-plugins-1.2.0-1.amzn2.0.5', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cni-plugins-debuginfo-1.2.0-1.amzn2.0.5', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cni-plugins-debuginfo-1.2.0-1.amzn2.0.5', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
