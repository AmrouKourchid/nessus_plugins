...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 78.0. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2020-29 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'78.0', severity:SECURITY_HOLE);
