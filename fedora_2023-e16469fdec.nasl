...
# extracted from Fedora Security Advisory FEDORA-2023-e16469fdec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e16469fdec");

  script_name(english:"Fedora 39 : exercism (2023-e16469fdec)");
...
FEDORA-2023-e16469fdec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e16469fdec");
...
var pkgs = [
    {'reference':'exercism-3.2.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
