...
# extracted from openSUSE Security Update openSUSE-2021-74.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : hawk2 (openSUSE-2021-74)");
...
if ( rpm_check(release:"SUSE15.1", reference:"hawk2-2.3.0+git.1603969748.10468582-lp151.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"hawk2-debuginfo-2.3.0+git.1603969748.10468582-lp151.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"hawk2-debugsource-2.3.0+git.1603969748.10468582-lp151.2.18.1") ) flag++;
