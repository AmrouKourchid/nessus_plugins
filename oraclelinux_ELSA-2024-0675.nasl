...
# extracted from Oracle Linux Security Advisory ELSA-2024-0675.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : gimp (ELSA-2024-0675)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2024-0675 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-0675.html");
...
var pkgs = [
    {'reference':'gimp-2.99.8-4.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'gimp-libs-2.99.8-4.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
