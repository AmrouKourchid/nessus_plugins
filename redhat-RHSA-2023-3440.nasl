...
# extracted from Red Hat Security Advisory RHSA-2023:3440. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3440");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.0 (python-flask) (RHSA-2023:3440)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 17.0 (python-flask).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3440.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?647a5a90");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2196643");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3440");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.0 (python-flask) package based on the guidance in RHSA-2023:3440.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-flask-1.1.2-6.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
