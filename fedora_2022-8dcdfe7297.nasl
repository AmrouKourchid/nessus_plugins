...
# extracted from Fedora Security Advisory FEDORA-2022-8dcdfe7297
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8dcdfe7297");

  script_name(english:"Fedora 36 : qemu (2022-8dcdfe7297)");
...
FEDORA-2022-8dcdfe7297 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8dcdfe7297");
...
var pkgs = [
    {'reference':'qemu-6.2.0-16.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
