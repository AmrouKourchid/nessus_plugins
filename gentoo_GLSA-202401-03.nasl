...
# extracted from Gentoo Linux Security Advisory GLSA 202401-03.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202401-03 : BlueZ: Privilege Escalation");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202401-03 (BlueZ: Privilege Escalation)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202401-03");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=919383");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 5.70-r1"),
    'vulnerable' : make_list("lt 5.70-r1")
  }
];
