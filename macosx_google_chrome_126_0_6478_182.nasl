...
"The version of Google Chrome installed on the remote macOS host is prior to 126.0.6478.182. It is, therefore, affected
...
google_chrome_check_version(fix:'126.0.6478.182', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
