...
# extracted from Fedora Security Advisory FEDORA-2024-31cac8b8ec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-31cac8b8ec");
  script_xref(name:"IAVA", value:"2024-A-0328");

  script_name(english:"Fedora 39 : ruby (2024-31cac8b8ec)");
...
FEDORA-2024-31cac8b8ec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-31cac8b8ec");
...
var pkgs = [
    {'reference':'ruby-3.2.4-182.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
