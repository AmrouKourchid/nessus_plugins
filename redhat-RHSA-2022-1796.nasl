...
# extracted from Red Hat Security Advisory RHSA-2022:1796. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1796");

  script_name(english:"RHEL 8 : qt5-qtbase (RHSA-2022:1796)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for qt5-qtbase.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:1796 advisory.
    ...
    * qt: out-of-bounds write in QOutlineMapper::convertPath called from QRasterPaintEngine::fill and
    QPaintEngineEx::stroke (CVE-2021-38593)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1796.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a5472193");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1796");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1994719");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qt5-qtbase package based on the guidance in RHSA-2022:1796.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qt5-qtbase-5.15.2-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-common-5.15.2-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-devel-5.15.2-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-examples-5.15.2-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-gui-5.15.2-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-mysql-5.15.2-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-odbc-5.15.2-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-postgresql-5.15.2-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-private-devel-5.15.2-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-static-5.15.2-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
