...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.5.0 < 8.5.3");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 8.5.3. It is, therefore, affected by a vulnerability as
...
"Upgrade to Apache Tomcat version 8.5.3 or later.");
