...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Bluez PHSA-2023-5.0-0006");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'bluez-5.66-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'bluez-devel-5.66-3.ph5')) flag++;
