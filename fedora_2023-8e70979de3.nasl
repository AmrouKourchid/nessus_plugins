...
# extracted from Fedora Security Advisory FEDORA-2023-8e70979de3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8e70979de3");

  script_name(english:"Fedora 39 : PyDrive2 (2023-8e70979de3)");
...
FEDORA-2023-8e70979de3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8e70979de3");
...
var pkgs = [
    {'reference':'PyDrive2-1.18.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
