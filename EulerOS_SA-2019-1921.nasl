...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : samba (EulerOS-SA-2019-1921)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1921
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?193185cd");
...
pkgs = ["libsmbclient-4.7.1-9.h9",
        "libwbclient-4.7.1-9.h9",
        "samba-client-libs-4.7.1-9.h9",
        "samba-common-4.7.1-9.h9",
        "samba-common-libs-4.7.1-9.h9",
        "samba-common-tools-4.7.1-9.h9",
        "samba-libs-4.7.1-9.h9"];
