...
# extracted from Red Hat Security Advisory RHSA-2020:4182 and
# CentOS Errata and Security Advisory 2020:4182 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : kernel (RHSA-2020:4182)");
...
"Update the affected kernel-kdump and / or kernel-kdump-devel packages.");
...
var pkgs = [
    {'reference':'kernel-kdump-2.6.32-754.35.1.el6', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-kdump-devel-2.6.32-754.35.1.el6', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-kdump / kernel-kdump-devel');
}
