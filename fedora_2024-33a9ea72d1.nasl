...
# extracted from Fedora Security Advisory FEDORA-2024-33a9ea72d1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-33a9ea72d1");

  script_name(english:"Fedora 39 : kernel (2024-33a9ea72d1)");
...
FEDORA-2024-33a9ea72d1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-33a9ea72d1");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2024-33a9ea72d1');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.8.5-201.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
