...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libxml2 (EulerOS-SA-2022-2572)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2572
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2055893");
...
var pkgs = [
  "libxml2-2.9.8-4.h18.eulerosv2r8",
  "libxml2-devel-2.9.8-4.h18.eulerosv2r8",
  "python2-libxml2-2.9.8-4.h18.eulerosv2r8",
  "python3-libxml2-2.9.8-4.h18.eulerosv2r8"
];
