...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : samba (EulerOS-SA-2023-1154)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1154
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8fa89332");
...
var pkgs = [
  "libsmbclient-4.11.12-3.h16.eulerosv2r10",
  "libwbclient-4.11.12-3.h16.eulerosv2r10",
  "samba-4.11.12-3.h16.eulerosv2r10",
  "samba-client-4.11.12-3.h16.eulerosv2r10",
  "samba-common-4.11.12-3.h16.eulerosv2r10",
  "samba-common-tools-4.11.12-3.h16.eulerosv2r10",
  "samba-libs-4.11.12-3.h16.eulerosv2r10",
  "samba-winbind-4.11.12-3.h16.eulerosv2r10",
  "samba-winbind-clients-4.11.12-3.h16.eulerosv2r10",
  "samba-winbind-modules-4.11.12-3.h16.eulerosv2r10"
];
