...
# extracted from openSUSE Security Update openSUSE-2020-1200.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : xrdp (openSUSE-2020-1200)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1173580");
  script_set_attribute(attribute:"solution", value:
"Update the affected xrdp packages.");
...
if ( rpm_check(release:"SUSE15.2", reference:"libpainter0-0.9.13.1-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libpainter0-debuginfo-0.9.13.1-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"librfxencode0-0.9.13.1-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"librfxencode0-debuginfo-0.9.13.1-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"xrdp-0.9.13.1-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"xrdp-debuginfo-0.9.13.1-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"xrdp-debugsource-0.9.13.1-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"xrdp-devel-0.9.13.1-lp152.3.3.1") ) flag++;
