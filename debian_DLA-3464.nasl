...
# extracted from Debian Security Advisory dla-3464. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3464 : libxmltooling-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3464
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3464-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/xmltooling");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libxmltooling-dev packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libxmltooling8");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libxmltooling-dev', 'reference': '3.0.4-1+deb10u2'},
    {'release': '10.0', 'prefix': 'libxmltooling-doc', 'reference': '3.0.4-1+deb10u2'},
    {'release': '10.0', 'prefix': 'libxmltooling8', 'reference': '3.0.4-1+deb10u2'},
    {'release': '10.0', 'prefix': 'xmltooling-schemas', 'reference': '3.0.4-1+deb10u2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libxmltooling-dev / libxmltooling-doc / libxmltooling8 / etc');
}
