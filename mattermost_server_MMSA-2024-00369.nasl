...
if (description)
{
  ...
  script_cve_id("CVE-2024-45843");
  script_xref(name:"IAVA", value:"2024-A-0677-S");

  script_name(english:"Mattermost Server 9.5.x < 9.5.9 (MMSA-2024-00369)");
...
vulnerability as referenced in the MMSA-2024-00369 advisory.

  - Mattermost versions 9.5.x <= 9.5.8 fail to include the metadata endpoints of Oracle Cloud and Alibaba in
    the SSRF denylist, which allows an attacker to possibly cause an SSRF if Mattermost was deployed in Oracle
    Cloud or Alibaba. (CVE-2024-45843)
...
"Upgrade to Mattermost Server version 9.5.9 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-45843");
