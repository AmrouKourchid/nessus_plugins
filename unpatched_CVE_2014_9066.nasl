...
if (description)
{
  ...
  script_cve_id("CVE-2014-9066");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-9066");
...
patch available.
  ...
  - Xen 4.4.x and earlier, when using a large number of VCPUs, does not properly handle read and write locks,
    which allows local x86 guest users to cause a denial of service (write denial or NMI watchdog timeout and
    host crash) via a large number of read requests, a different vulnerability than CVE-2014-9065.
    (CVE-2014-9066)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9066");
