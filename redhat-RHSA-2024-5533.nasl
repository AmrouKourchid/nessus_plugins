...
# extracted from Red Hat Security Advisory RHSA-2024:5533. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5533");

  script_name(english:"RHEL 9 : python3.12-setuptools (RHSA-2024:5533)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python3.12-setuptools.");
...
the RHSA-2024:5533 advisory.

    Setuptools is a collection of enhancements to the Python 3 distutils that allow you to more easily build
    and distribute Python 3 packages, especially ones that have dependencies on other packages.  This package
    also contains the runtime components of setuptools, necessary to execute the software that requires
    pkg_resources.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5533.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5eb4fd97");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2297771");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5533");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.12-setuptools package based on the guidance in RHSA-2024:5533.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3.12-setuptools");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3.12-setuptools-wheel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.12-setuptools-68.2.2-3.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-setuptools-wheel-68.2.2-3.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3.12-setuptools-68.2.2-3.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.12-setuptools-wheel-68.2.2-3.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3.12-setuptools / python3.12-setuptools-wheel');
}
