...
if (description)
{
  ...
  script_name(english:"Oracle Business Intelligence Publisher Information Disclosure (Oct 2016 CPU)");
...
11.1.1.9.x prior to 11.1.1.9.161018, or 12.2.1.0.x prior to 12.2.1.0.161018. It is, therefore, affected by an
unspecified vulnerability in the BI Publisher component in Oracle Fusion Middleware which allows remote, authenticated
users to affect confidentiality via unknown vectors.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.oracle.com/security-alerts/cpuoct2016.htm");
...
"Apply the appropriate patch according to the October 2016 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-3473");
...
# Bundle numbers come from October 2016 CPU Fusion Middleware for BI Publisher, patch numbers come from docs as noted below
# 11.1.1.7.x - Bundle: 23703041 | Patch: 23299563 from Doc ID 1276869.1
# 11.1.1.9.x - Bundle: 24668000 | Patch: 24736889 from Doc ID 1276869.1
# 12.2.1.0.x - Bundle: 24695761 | Patch: 24695761 (Doc ID 2147699.1 has no specific patch)
constraints = [
  {'min_version': '11.1.1.7', 'fixed_version': '11.1.1.7.160719', 'patch': '23299563', 'bundle': '23703041'},
  {'min_version': '11.1.1.9', 'fixed_version': '11.1.1.9.161018', 'patch': '24736889', 'bundle': '24668000'},
  {'min_version': '12.2.1.0', 'fixed_version': '12.2.1.0.161018', 'patch': '24695761', 'bundle': '24695761'}
];
