...
# SUSE update advisory SUSE-SU-2022:14938-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:14938-1");
  script_xref(name:"IAVA", value:"2024-A-0327");

  script_name(english:"SUSE SLES11 Security Update : xz (SUSE-SU-2022:14938-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-April/010689.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cea627a6");
  script_set_attribute(attribute:"solution", value:
"Update the affected liblzma5, liblzma5-32bit, xz and / or xz-lang packages.");
...
var pkgs = [
    {'reference':'liblzma5-32bit-5.0.3-0.12.7.1', 'sp':'4', 'cpu':'s390x', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'liblzma5-32bit-5.0.3-0.12.7.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'liblzma5-5.0.3-0.12.7.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'xz-5.0.3-0.12.7.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'xz-lang-5.0.3-0.12.7.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'liblzma5 / liblzma5-32bit / xz / xz-lang');
}
