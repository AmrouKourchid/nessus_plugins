...
if (description)
{
  ...
  script_name(english:"Security Updates for Windows 10 / Windows Server 2019 (February 2019) (Spectre) (Meltdown) (Foreshadow)");
...
"Microsoft has released security updates for Windows 10, Server 2016 and Server 2019.");
...
# No update for version 1511 and RTM, skip testing
...
if (
  # 1607
  hotfix_is_vulnerable(os:"10", sp:0, os_build:"14393", file:"mcupdate_genuineintel.dll", version:"10.0.14393.2756", min_version:"10.0.14393.0", dir:"\system32", bulletin:bulletin, kb:"4346087") ||

  # 1703
  hotfix_is_vulnerable(os:"10", sp:0, os_build:"15063", file:"mcupdate_genuineintel.dll", version:"10.0.15063.1594", min_version:"10.0.15063.0", dir:"\system32", bulletin:bulletin, kb:"4346086") ||

  # 1709
  hotfix_is_vulnerable(os:"10", sp:0, os_build:"16299", file:"mcupdate_genuineintel.dll", version:"10.0.16299.936", min_version:"10.0.16299.0", dir:"\system32", bulletin:bulletin, kb:"4346085") ||

  # 1803
  hotfix_is_vulnerable(os:"10", sp:0, os_build:"17134", file:"mcupdate_genuineintel.dll", version:"10.0.17134.554", min_version:"10.0.17134.0", dir:"\system32", bulletin:bulletin, kb:"4346084") ||

  # 1809
  hotfix_is_vulnerable(os:"10", sp:0, os_build:"17763", file:"mcupdate_genuineintel.dll", version:"10.0.17763.252", min_version:"10.0.17763.0", dir:"\system32", bulletin:bulletin, kb:"4465065")
)
{
