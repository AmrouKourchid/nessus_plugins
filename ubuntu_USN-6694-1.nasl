...
# extracted from Ubuntu Security Notice USN-6694-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6694-1");
  script_xref(name:"IAVA", value:"2024-A-0134-S");
  script_xref(name:"IAVA", value:"2024-A-0192-S");

  script_name(english:"Ubuntu 22.04 LTS / 23.10 : Expat vulnerabilities (USN-6694-1)");
...
referenced in the USN-6694-1 advisory.

    It was discovered that Expat could be made to consume large amounts of resources. If a user or automated
    system were tricked into processing specially crafted input, an attacker could possibly use this issue to
    cause a denial of service. (CVE-2023-52425, CVE-2024-28757)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6694-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'expat', 'pkgver': '2.4.7-1ubuntu0.3'},
    {'osver': '22.04', 'pkgname': 'libexpat1', 'pkgver': '2.4.7-1ubuntu0.3'},
    {'osver': '22.04', 'pkgname': 'libexpat1-dev', 'pkgver': '2.4.7-1ubuntu0.3'},
    {'osver': '23.10', 'pkgname': 'expat', 'pkgver': '2.5.0-2ubuntu0.1'},
    {'osver': '23.10', 'pkgname': 'libexpat1', 'pkgver': '2.5.0-2ubuntu0.1'},
    {'osver': '23.10', 'pkgname': 'libexpat1-dev', 'pkgver': '2.5.0-2ubuntu0.1'}
];
