...
# extracted from Fedora Security Advisory FEDORA-2020-7e1e9abf77.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : libproxy (2020-7e1e9abf77)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7e1e9abf77");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"libproxy-0.4.15-15.fc31")) flag++;
