...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : FreeType vulnerabilities (USN-2510-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2510-1 advisory.

    Mateusz Jurczyk discovered that FreeType did not correctly handle certain malformed font files. If a user
    were tricked into using a specially crafted font file, a remote attacker could cause FreeType to crash or
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2510-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'freetype2-demos', 'pkgver': '2.5.2-1ubuntu2.4'},
    {'osver': '14.04', 'pkgname': 'libfreetype6', 'pkgver': '2.5.2-1ubuntu2.4'},
    {'osver': '14.04', 'pkgname': 'libfreetype6-dev', 'pkgver': '2.5.2-1ubuntu2.4'},
    {'osver': '14.04', 'pkgname': 'libfreetype6-udeb', 'pkgver': '2.5.2-1ubuntu2.4'}
];
