...
if (description)
{
  ...
  script_cve_id("CVE-2019-8720");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/06/13");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-8720");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-8720");
