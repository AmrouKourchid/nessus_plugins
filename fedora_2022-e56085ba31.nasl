...
# extracted from Fedora Security Advisory FEDORA-2022-e56085ba31
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e56085ba31");

  script_name(english:"Fedora 36 : pcre2 (2022-e56085ba31)");
...
FEDORA-2022-e56085ba31 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e56085ba31");
...
"Update the affected pcre2 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:pcre2");
...
var pkgs = [
    {'reference':'pcre2-10.40-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
