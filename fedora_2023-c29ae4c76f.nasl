...
# extracted from Fedora Security Advisory FEDORA-2023-c29ae4c76f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c29ae4c76f");

  script_name(english:"Fedora 37 : php-nyholm-psr7 (2023-c29ae4c76f)");
...
FEDORA-2023-c29ae4c76f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c29ae4c76f");
...
var pkgs = [
    {'reference':'php-nyholm-psr7-1.6.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
