...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Keepalived PHSA-2019-1.0-0212");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"keepalived-1.3.5-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"keepalived-debuginfo-1.3.5-2.ph1")) flag++;
