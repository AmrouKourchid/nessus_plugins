...
# extracted from Fedora Security Advisory FEDORA-2025-c55f39aeb3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-c55f39aeb3");
  script_xref(name:"IAVB", value:"2025-B-0056");

  script_name(english:"Fedora 41 : corosync (2025-c55f39aeb3)");
...
FEDORA-2025-c55f39aeb3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-c55f39aeb3");
...
var pkgs = [
    {'reference':'corosync-3.1.9-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
