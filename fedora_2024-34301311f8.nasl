...
# extracted from Fedora Security Advisory FEDORA-2024-34301311f8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-34301311f8");

  script_name(english:"Fedora 39 : liblas (2024-34301311f8)");
...
FEDORA-2024-34301311f8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-34301311f8");
...
var pkgs = [
    {'reference':'liblas-1.8.2-0.12.gitf1da555.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
