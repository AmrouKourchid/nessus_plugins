...
# extracted from Ubuntu Security Notice USN-7159-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7159-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Linux kernel vulnerabilities (USN-7159-1)");
...
referenced in the USN-7159-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7159-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1055-xilinx-zynqmp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1083-ibm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1120-raspi");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1124-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1140-gcp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-202-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-202-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-202-lowlatency");
...
var kernel_mappings = {
  ...
  '20.04': {
    '5.4.0': {
      'generic': '5.4.0-202',
      'generic-lpae': '5.4.0-202',
      'lowlatency': '5.4.0-202',
      'xilinx-zynqmp': '5.4.0-1055',
      'ibm': '5.4.0-1083',
      'raspi': '5.4.0-1120',
      'kvm': '5.4.0-1124',
      'gcp': '5.4.0-1140'
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-7159-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-7159-1');
  }
  else
  {
