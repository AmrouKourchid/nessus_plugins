...
# extracted from Ubuntu Security Notice USN-3258-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Dovecot vulnerability (USN-3258-1)");
...
USN-3258-1 advisory.
    ...
    It was discovered that Dovecot incorrectly handled some usernames. An attacker could possibly use this
    issue to cause Dovecot to hang or crash, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3258-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'dovecot-core', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'dovecot-dev', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'dovecot-gssapi', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'dovecot-imapd', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'dovecot-ldap', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'dovecot-lmtpd', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'dovecot-lucene', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'dovecot-managesieved', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'dovecot-mysql', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'dovecot-pgsql', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'dovecot-pop3d', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'dovecot-sieve', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'dovecot-solr', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'dovecot-sqlite', 'pkgver': '1:2.2.22-1ubuntu2.3'},
    {'osver': '16.04', 'pkgname': 'mail-stack-delivery', 'pkgver': '1:2.2.22-1ubuntu2.3'}
];
