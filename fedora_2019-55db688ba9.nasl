...
# extracted from Fedora Security Advisory FEDORA-2019-55db688ba9.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-55db688ba9");

  script_name(english:"Fedora 29 : tor (2019-55db688ba9)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-55db688ba9");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"tor-0.3.5.8-1.fc29")) flag++;
