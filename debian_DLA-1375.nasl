...
# extracted from Debian Security Advisory DLA-1375-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1375-1 : wget security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/05/msg00006.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/wheezy/wget");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"wget", reference:"1.13.4-3+deb7u6")) flag++;
