...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : jbigkit (EulerOS-SA-2021-1561)");
...
affected by the following vulnerability :
  ...
  - In LibTIFF 4.0.8, there is a memory malloc failure in
    tif_jbig.c. A crafted TIFF document can lead to an
    abort resulting in a remote denial of service
    attack.(CVE-2017-9937)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1561
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?17fcfbbc");
...
pkgs = ["jbigkit-libs-2.1-14.h1.eulerosv2r8"];
