...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : gd (EulerOS-SA-2019-1250)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1250
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8e44bf43");
...
pkgs = ["gd-2.0.35-26.h5.eulerosv2r7"];
