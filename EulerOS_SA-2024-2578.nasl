...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : emacs (EulerOS-SA-2024-2578)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2578
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c73b570");
...
var pkgs = [
  "emacs-filesystem-27.2-3.h8.eulerosv2r11"
];
