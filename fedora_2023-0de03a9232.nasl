...
# extracted from Fedora Security Advisory FEDORA-2023-0de03a9232
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0de03a9232");

  script_name(english:"Fedora 38 : curl (2023-0de03a9232)");
...
FEDORA-2023-0de03a9232 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0de03a9232");
...
var pkgs = [
    {'reference':'curl-7.87.0-7.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
