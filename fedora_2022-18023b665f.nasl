...
# extracted from Fedora Security Advisory FEDORA-2022-18023b665f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-18023b665f");

  script_name(english:"Fedora 37 : capnproto / fastnetmon / librime / rr / sonic-visualiser (2022-18023b665f)");
...
FEDORA-2022-18023b665f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-18023b665f");
...
var pkgs = [
    {'reference':'capnproto-0.9.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fastnetmon-1.2.1-4.20220528git420e7b8.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'librime-1.7.3-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rr-5.6.0-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sonic-visualiser-4.5-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
