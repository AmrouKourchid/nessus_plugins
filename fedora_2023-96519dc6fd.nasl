...
# extracted from Fedora Security Advisory FEDORA-2023-96519dc6fd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-96519dc6fd");

  script_name(english:"Fedora 38 : cups (2023-96519dc6fd)");
...
FEDORA-2023-96519dc6fd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-96519dc6fd");
...
var pkgs = [
    {'reference':'cups-2.4.7-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
