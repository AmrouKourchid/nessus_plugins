...
# extracted from Gentoo Linux Security Advisory GLSA 202012-16.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202012-16");

  script_name(english:"GLSA-202012-16 : PHP: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202012-16
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202012-16");
...
if (qpkg_check(package:"dev-lang/php", unaffected:make_list("ge 7.2.34-r1", "ge 7.3.25", "ge 7.4.13"), vulnerable:make_list("lt 8.0.0"))) flag++;
