...
# extracted from Red Hat Security Advisory RHSA-2024:2517. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2517");

  script_name(english:"RHEL 9 : wpa_supplicant (RHSA-2024:2517)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2517.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0494dd28");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2517");
...
"Update the RHEL wpa_supplicant package based on the guidance in RHSA-2024:2517.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wpa_supplicant-2.10-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
