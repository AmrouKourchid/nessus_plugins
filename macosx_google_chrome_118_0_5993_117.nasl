...
"The version of Google Chrome installed on the remote macOS host is prior to 118.0.5993.117. It is, therefore, affected
...
google_chrome_check_version(fix:'118.0.5993.117', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
