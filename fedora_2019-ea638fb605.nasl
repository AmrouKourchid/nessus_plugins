...
# extracted from Fedora Security Advisory FEDORA-2019-ea638fb605.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-ea638fb605");

  script_name(english:"Fedora 31 : 1:dovecot (2019-ea638fb605)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"- CVE-2019-11500: IMAP protocol parser does not properly
    handle NUL byte when scanning data in quoted strings,
    leading to out of bounds heap memory writes

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-ea638fb605");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"dovecot-2.3.7.2-1.fc31", epoch:"1")) flag++;
