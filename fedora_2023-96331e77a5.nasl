...
# extracted from Fedora Security Advisory FEDORA-2023-96331e77a5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-96331e77a5");

  script_name(english:"Fedora 38 : golang (2023-96331e77a5)");
...
FEDORA-2023-96331e77a5 advisory.

    Includes security fixes to the path/filepath package, as well as bug fixes to the linker, the runtime, the
    compiler, and the go/types, net/http, and runtime/cgo packages. [See the whole changelog
    here](https://go.dev/doc/devel/release).

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-96331e77a5");
...
var pkgs = [
    {'reference':'golang-1.20.11-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
