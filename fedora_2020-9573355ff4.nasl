...
# extracted from Fedora Security Advisory FEDORA-2020-9573355ff4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : xmlsec1 (2020-9573355ff4)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Update to 1.2.29 that's required by LibreOffice 6.4.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-9573355ff4");
  script_set_attribute(attribute:"solution", value:
"Update the affected xmlsec1 package.");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"xmlsec1-1.2.29-1.fc31")) flag++;
