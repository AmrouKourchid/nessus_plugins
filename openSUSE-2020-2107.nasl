...
# extracted from openSUSE Security Update openSUSE-2020-2107.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : wireshark (openSUSE-2020-2107)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1177406");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1178291");
...
if ( rpm_check(release:"SUSE15.1", reference:"libwireshark13-3.2.8-lp151.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libwireshark13-debuginfo-3.2.8-lp151.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libwiretap10-3.2.8-lp151.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libwiretap10-debuginfo-3.2.8-lp151.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libwsutil11-3.2.8-lp151.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libwsutil11-debuginfo-3.2.8-lp151.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"wireshark-3.2.8-lp151.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"wireshark-debuginfo-3.2.8-lp151.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"wireshark-debugsource-3.2.8-lp151.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"wireshark-devel-3.2.8-lp151.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"wireshark-ui-qt-3.2.8-lp151.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"wireshark-ui-qt-debuginfo-3.2.8-lp151.2.18.1") ) flag++;
