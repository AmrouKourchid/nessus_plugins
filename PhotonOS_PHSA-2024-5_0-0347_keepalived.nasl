...
# extracted from VMware Security Advisory PHSA-2024-5.0-0347. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Keepalived PHSA-2024-5.0-0347");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the keepalived package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-347.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'keepalived-2.2.7-3.ph5')) flag++;
