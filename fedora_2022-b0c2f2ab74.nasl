...
# extracted from Fedora Security Advisory FEDORA-2022-b0c2f2ab74
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-b0c2f2ab74");

  script_name(english:"Fedora 37 : dbus (2022-b0c2f2ab74)");
...
FEDORA-2022-b0c2f2ab74 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-b0c2f2ab74");
...
var pkgs = [
    {'reference':'dbus-1.14.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
