...
if (description)
{
  ...
  script_cve_id("CVE-2015-2582");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-2582");
...
patch available.
  ...
  - Unspecified vulnerability in Oracle MySQL Server 5.5.43 and earlier and 5.6.24 and earlier allows remote
    authenticated users to affect availability via vectors related to GIS. (CVE-2015-2582)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-2582");
