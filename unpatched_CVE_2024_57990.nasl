...
if (description)
{
  ...
  script_cve_id("CVE-2024-57990");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-57990");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: wifi: mt76: mt7925: fix off by one in
    mt7925_load_clc() This comparison should be >= instead of > to prevent an out of bounds read and write.
    (CVE-2024-57990)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-57990");
