...
the RHSA-2019:2945 advisory.
    ...
    * If the Wake-up on Wireless LAN functionality is configured in the brcmfmac driver, which only works with
    Broadcom FullMAC chipsets, a malicious event frame can be constructed to trigger a heap buffer overflow in
    the brcmf_wowl_nd_results() function. This vulnerability can be exploited by compromised chipsets to
    compromise the host, or when used in combination with another brcmfmac driver flaw (CVE-2019-9503), can be
    used remotely. This can result in a remote denial of service (DoS). Due to the nature of the flaw, a
    remote privilege escalation cannot be fully ruled out. (CVE-2019-9500)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2945.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ef7fde1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2945");
...
"Update the RHEL kpatch-patch package based on the guidance in RHSA-2019:2945.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2019:2945');
  }
  else
  {
...
var kernel_live_checks = [
  {
    ...
    'kernels': {
      '3.10.0-1062.el7.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-3_10_0-1062-1-2.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '3.10.0-1062.el7.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-3_10_0-1062-1-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kpatch-patch-3_10_0-1062');
}
