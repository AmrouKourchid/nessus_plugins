...
# Rocky Linux Security Advisory RLSA-2024:7135.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:7135");
  script_xref(name:"IAVB", value:"2024-B-0132-S");

  script_name(english:"Rocky Linux 8 : git-lfs (RLSA-2024:7135)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2024:7135 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:7135");
...
var pkgs = [
    {'reference':'git-lfs-3.4.1-3.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-3.4.1-3.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-debuginfo-3.4.1-3.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-debuginfo-3.4.1-3.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-debugsource-3.4.1-3.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-debugsource-3.4.1-3.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
