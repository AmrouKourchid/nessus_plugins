...
# extracted from Fedora Security Advisory FEDORA-2023-5beead493f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5beead493f");

  script_name(english:"Fedora 39 : python-jupyter-server (2023-5beead493f)");
...
FEDORA-2023-5beead493f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5beead493f");
...
var pkgs = [
    {'reference':'python-jupyter-server-2.7.2-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
