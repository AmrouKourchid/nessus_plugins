...
# extracted from Red Hat Security Advisory RHSA-2024:2410. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2410");

  script_name(english:"RHEL 9 : harfbuzz (RHSA-2024:2410)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2410.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2bba349f");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2410");
...
"Update the RHEL harfbuzz package based on the guidance in RHSA-2024:2410.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'harfbuzz-2.7.4-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'harfbuzz-devel-2.7.4-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'harfbuzz-icu-2.7.4-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
