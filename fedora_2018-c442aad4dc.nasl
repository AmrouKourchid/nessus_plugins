...
# extracted from Fedora Security Advisory FEDORA-2018-c442aad4dc.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : exempi (2018-c442aad4dc)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-c442aad4dc");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"exempi-2.4.5-1.fc27")) flag++;
