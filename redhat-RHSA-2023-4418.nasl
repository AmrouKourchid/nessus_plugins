...
# extracted from Red Hat Security Advisory RHSA-2023:4418. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4418");

  script_name(english:"RHEL 8 : mod_auth_openidc:2.3 (RHSA-2023:4418)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mod_auth_openidc:2.3.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:4418 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4418.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d526006");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2223295");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4418");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_auth_openidc:2.3 package based on the guidance in RHSA-2023:4418.");
  ...
  'mod_auth_openidc:2.3': [
    {
      ...
      'pkgs': [
        {'reference':'cjose-0.6.1-3.module+el8.8.0+19464+578f4546', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'cjose-devel-0.6.1-3.module+el8.8.0+19464+578f4546', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_auth_openidc-2.4.9.4-1.module+el8.7.0+14797+4085fcb6', 'release':'8', 'el_string':'el8.7.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'cjose-0.6.1-3.module+el8.8.0+19464+578f4546', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'cjose-devel-0.6.1-3.module+el8.8.0+19464+578f4546', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_auth_openidc-2.4.9.4-1.module+el8.7.0+14797+4085fcb6', 'sp':'8', 'release':'8', 'el_string':'el8.7.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
