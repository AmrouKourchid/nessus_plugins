...
# extracted from Debian Security Advisory DLA-1546-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1546-1 : moin security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/10/msg00007.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/moin");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected python-moinmoin package.");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"python-moinmoin", reference:"1.9.8-1+deb8u2")) flag++;
