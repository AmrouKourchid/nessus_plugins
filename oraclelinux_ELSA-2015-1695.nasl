...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-1695.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected jakarta-taglibs-standard and / or jakarta-taglibs-standard-javadoc packages.");
...
var pkgs = [
    {'reference':'jakarta-taglibs-standard-1.1.1-11.7.el6_7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jakarta-taglibs-standard-javadoc-1.1.1-11.7.el6_7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jakarta-taglibs-standard-1.1.2-14.el7_1', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jakarta-taglibs-standard-javadoc-1.1.2-14.el7_1', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
