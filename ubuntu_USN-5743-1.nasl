...
# extracted from Ubuntu Security Notice USN-5743-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5743-1");

  script_name(english:"Ubuntu 16.04 ESM : LibTIFF vulnerability (USN-5743-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5743-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libtiff-opengl', 'pkgver': '4.0.6-1ubuntu0.8+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiff-tools', 'pkgver': '4.0.6-1ubuntu0.8+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiff5', 'pkgver': '4.0.6-1ubuntu0.8+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiff5-dev', 'pkgver': '4.0.6-1ubuntu0.8+esm8', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiffxx5', 'pkgver': '4.0.6-1ubuntu0.8+esm8', 'ubuntu_pro': TRUE}
];
