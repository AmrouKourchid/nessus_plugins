...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Ncurses PHSA-2017-0024");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ncurses-6.0-5.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ncurses-compat-6.0-5.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ncurses-debuginfo-6.0-5.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ncurses-devel-6.0-5.ph1')) flag++;
