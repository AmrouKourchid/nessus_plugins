...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5055581");
  script_xref(name:"MSFT", value:"MS25-5055581");
  script_xref(name:"IAVA", value:"2025-A-0255");
  script_xref(name:"IAVA", value:"2025-A-0256");

  script_name(english:"KB5055581: Windows Server 2012 Security Update (April 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5055581. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5055581");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5055581");
