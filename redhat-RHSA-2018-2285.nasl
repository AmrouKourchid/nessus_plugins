...
"The remote Red Hat host is missing a security update for yum-utils.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:2285 advisory.

    The yum-utils packages provide a collection of utilities and examples for the yum package manager to make
    yum easier and more powerful to use.
    ...
    * yum-utils: reposync: improper path validation may lead to directory traversal (CVE-2018-10897)
    ...
    Red Hat would like to thank Jay Grizzard (Clover Network) and Aaron Levy (Clover Network) for reporting
    this issue.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2285.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16a14d30");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2285");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1600221");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL yum-utils package based on the guidance in RHSA-2018:2285.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'yum-NetworkManager-dispatcher-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-aliases-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-auto-update-debug-info-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-changelog-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-copr-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-fastestmirror-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-filter-data-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-fs-snapshot-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-keys-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-list-data-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-local-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-merge-conf-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-ovl-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-post-transaction-actions-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-pre-transaction-actions-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-priorities-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-protectbase-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-ps-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-remove-with-leaves-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-rpm-warm-cache-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-show-leaves-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-tmprepo-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-tsflags-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-upgrade-helper-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-verify-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-plugin-versionlock-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-updateonboot-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yum-utils-1.1.31-46.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
