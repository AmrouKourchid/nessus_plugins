...
# extracted from Red Hat Security Advisory RHSA-2020:1653. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1653");

  script_name(english:"RHEL 8 : zziplib (RHSA-2020:1653)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for zziplib.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:1653 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1653.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e7d1f61b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1653");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1635888");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL zziplib package based on the guidance in RHSA-2020:1653.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'zziplib-0.13.68-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zziplib-devel-0.13.68-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zziplib-utils-0.13.68-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
