...
# extracted from Red Hat Security Advisory RHSA-2020:1605. The text
...
if (description)
{
  ...
  script_bugtraq_id(108793, 108815, 109177);
  script_xref(name:"RHSA", value:"2020:1605");

  script_name(english:"RHEL 8 : python27:2.7 (RHSA-2020:1605)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:1605 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1605.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae94b28a");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd7b3f20");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1605");
...
"Update the affected packages.");
  ...
  script_cwe_id(20, 79, 113, 295, 522);
  ...
  'python27:2.7': [
    {
      ...
      'pkgs': [
        {'reference':'babel-2.5.1-9.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-nose-docs-1.3.7-30.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-psycopg2-doc-2.7.5-7.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-sqlalchemy-doc-1.3.2-1.module+el8.1.0+2994+98e054d6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-2.7.17-1.module+el8.2.0+4561+f4e0d66a', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-attrs-17.4.0-10.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-babel-2.5.1-9.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-backports-1.0-15.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-backports-ssl_match_hostname-3.5.0.1-11.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-bson-3.6.1-11.module+el8.1.0+3446+c3d52da3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-debug-2.7.17-1.module+el8.2.0+4561+f4e0d66a', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-devel-2.7.17-1.module+el8.2.0+4561+f4e0d66a', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-jinja2-2.10-8.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-libs-2.7.17-1.module+el8.2.0+4561+f4e0d66a', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-lxml-4.2.3-3.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-nose-1.3.7-30.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-numpy-1.14.2-13.module+el8.1.0+3323+7ac3e00f', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'python2-numpy-doc-1.14.2-13.module+el8.1.0+3323+7ac3e00f', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'python2-numpy-f2py-1.14.2-13.module+el8.1.0+3323+7ac3e00f', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'python2-pip-9.0.3-16.module+el8.2.0+5478+b505947e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-pip-wheel-9.0.3-16.module+el8.2.0+5478+b505947e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-pygments-2.2.0-20.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-pymongo-3.6.1-11.module+el8.1.0+3446+c3d52da3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-pymongo-gridfs-3.6.1-11.module+el8.1.0+3446+c3d52da3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-scipy-1.0.0-20.module+el8.1.0+3323+7ac3e00f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-setuptools-39.0.1-11.module+el8.1.0+3446+c3d52da3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-setuptools-wheel-39.0.1-11.module+el8.1.0+3446+c3d52da3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-setuptools_scm-1.15.7-6.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-six-1.11.0-5.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-sqlalchemy-1.3.2-1.module+el8.1.0+2994+98e054d6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-test-2.7.17-1.module+el8.2.0+4561+f4e0d66a', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tkinter-2.7.17-1.module+el8.2.0+4561+f4e0d66a', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tools-2.7.17-1.module+el8.2.0+4561+f4e0d66a', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-urllib3-1.24.2-1.module+el8.1.0+3280+19512f10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-virtualenv-15.1.0-19.module+el8.1.0+3507+d69c168d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-wheel-0.31.1-2.module+el8.1.0+3725+aac5cd17', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'python2-wheel-wheel-0.31.1-2.module+el8.1.0+3725+aac5cd17', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
