...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : binutils (EulerOS-SA-2019-1089)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1089
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b0dd6dc1");
...
pkgs = ["binutils-2.25.1-22.base.h20",
        "binutils-devel-2.25.1-22.base.h20"];
