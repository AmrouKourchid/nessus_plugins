...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : sqlite (EulerOS-SA-2023-2104)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2104
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?087999fc");
...
var pkgs = [
  "sqlite-3.37.2-3.h1.eulerosv2r11"
];
