...
the RHSA-2021:4361 advisory.
    ...
    The following packages have been upgraded to a later upstream version: NetworkManager (1.32.10).
    (BZ#1934465)

    Security Fix(es):

    * systemd: DHCP FORCERENEW authentication not implemented can cause a system running the DHCP client to
    have its network reconfigured (CVE-2020-13529)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4361.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?17879cc3");
