...
# extracted from Red Hat Security Advisory RHSA-2024:0299. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0299");

  script_name(english:"RHEL 8 : python-requests (RHSA-2024:0299)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0299.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2306bffd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2209469");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0299");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-requests package based on the guidance in RHSA-2024:0299.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-requests-2.20.0-3.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
