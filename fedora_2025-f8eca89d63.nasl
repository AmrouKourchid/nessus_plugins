...
# extracted from Fedora Security Advisory FEDORA-2025-f8eca89d63
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-f8eca89d63");

  script_name(english:"Fedora 40 : radare2 (2025-f8eca89d63)");
...
FEDORA-2025-f8eca89d63 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-f8eca89d63");
...
var pkgs = [
    {'reference':'radare2-5.9.8-7.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
