...
# extracted from Fedora Security Advisory FEDORA-2025-9eccdb2c3e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-9eccdb2c3e");

  script_name(english:"Fedora 40 : valkey (2025-9eccdb2c3e)");
...
FEDORA-2025-9eccdb2c3e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-9eccdb2c3e");
...
var pkgs = [
    {'reference':'valkey-8.0.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
