...
# extracted from Fedora Security Advisory FEDORA-2023-d294ef140e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d294ef140e");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 37 : pypy3.8 (2023-d294ef140e)");
...
FEDORA-2023-d294ef140e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d294ef140e");
...
var pkgs = [
    {'reference':'pypy3.8-7.3.11-2.3.8.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
