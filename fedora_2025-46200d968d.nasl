...
# extracted from Fedora Security Advisory FEDORA-2025-46200d968d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-46200d968d");

  script_name(english:"Fedora 41 : crun (2025-46200d968d)");
...
FEDORA-2025-46200d968d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-46200d968d");
...
var pkgs = [
    {'reference':'crun-1.20-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
