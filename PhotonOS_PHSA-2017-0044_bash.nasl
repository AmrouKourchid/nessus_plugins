...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'bash-4.3.48-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'bash-debuginfo-4.3.48-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'bash-lang-4.3.48-2.ph1')) flag++;
