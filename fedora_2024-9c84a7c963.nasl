...
# extracted from Fedora Security Advisory FEDORA-2024-9c84a7c963
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-6228", "CVE-2023-52356", "CVE-2024-7006");
  script_xref(name:"FEDORA", value:"2024-9c84a7c963");

  script_name(english:"Fedora 40 : libtiff (2024-9c84a7c963)");
...
FEDORA-2024-9c84a7c963 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9c84a7c963");
...
var pkgs = [
    {'reference':'libtiff-4.6.0-5.fc40.1', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
