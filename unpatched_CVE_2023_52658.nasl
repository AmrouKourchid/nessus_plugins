...
if (description)
{
  ...
  script_cve_id("CVE-2023-52658");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-52658");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: Revert net/mlx5: Block entering
    switchdev mode with ns inconsistency This reverts commit 662404b24a4c4d839839ed25e3097571f5938b9b. The
    revert is required due to the suspicion it is not good for anything and cause crash. (CVE-2023-52658)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52658");
