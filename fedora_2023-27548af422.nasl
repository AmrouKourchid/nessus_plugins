...
# extracted from Fedora Security Advisory FEDORA-2023-27548af422
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-27548af422");
  script_xref(name:"IAVB", value:"2024-B-0077-S");

  script_name(english:"Fedora 38 : ImageMagick (2023-27548af422)");
...
FEDORA-2023-27548af422 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-27548af422");
...
"Update the affected 1:ImageMagick package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-34475");
...
var pkgs = [
    {'reference':'ImageMagick-7.1.1.15-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
