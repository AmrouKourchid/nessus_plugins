...
# extracted from Red Hat Security Advisory RHSA-2024:11143. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:11143");
  script_xref(name:"IAVA", value:"2024-A-0832-S");

  script_name(english:"RHEL 8 : gstreamer1-plugins-base (RHSA-2024:11143)");
...
referenced in the RHSA-2024:11143 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_11143.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4167b5f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11143");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gstreamer1-plugins-base package based on the guidance in RHSA-2024:11143.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-plugins-base-1.16.1-3.el8_4', 'sp':'4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-base-1.16.1-3.el8_4', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-base-1.16.1-3.el8_4', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-base-devel-1.16.1-3.el8_4', 'sp':'4', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-base-devel-1.16.1-3.el8_4', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-base-devel-1.16.1-3.el8_4', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
