...
# extracted from Fedora Security Advisory FEDORA-2024-12513b5cee
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-12513b5cee");

  script_name(english:"Fedora 39 : vim (2024-12513b5cee)");
...
FEDORA-2024-12513b5cee advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-12513b5cee");
...
var pkgs = [
    {'reference':'vim-9.1.076-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
