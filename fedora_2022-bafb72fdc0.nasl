...
# extracted from Fedora Security Advisory FEDORA-2022-bafb72fdc0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-bafb72fdc0");

  script_name(english:"Fedora 35 : efl / enlightenment (2022-bafb72fdc0)");
...
FEDORA-2022-bafb72fdc0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-bafb72fdc0");
...
var pkgs = [
    {'reference':'efl-1.26.3-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'enlightenment-0.25.4-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
