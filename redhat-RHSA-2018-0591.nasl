...
# extracted from Red Hat Security Advisory RHSA-2018:0591. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0591");

  script_name(english:"RHEL 7 : python-paramiko (RHSA-2018:0591)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-paramiko.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:0591 advisory.

    The python-paramiko package provides a Python module that implements the SSH2 protocol for encrypted and
    authenticated connections to remote machines. Unlike SSL, the SSH2 protocol does not require hierarchical
    certificates signed by a powerful central authority. The protocol also includes the ability to open
    ...
    * python-paramiko has been using the python2-pyasn1 package, but did not depend on it. With new versions
    of python2-cryptography, python2-pyasn1 was not getting installed and this caused python-paramiko to
    malfunction. This bug was fixed by making python-paramiko depend on python2-pyasn1 explicitly.
    (BZ#1559133)
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0591.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d4f8d1af");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0591");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1557130");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1559133");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-paramiko package based on the guidance in RHSA-2018:0591.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-paramiko-2.1.1-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-paramiko-doc-2.1.1-4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
