...
# SUSE update advisory SUSE-SU-2024:1461-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:1461-1");

  script_name(english:"SUSE SLES15 Security Update : shim (SUSE-SU-2024:1461-1)");
...
referenced in the SUSE-SU-2024:1461-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/035121.html");
...
var pkgs = [
    {'reference':'shim-15.8-150100.3.38.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
    {'reference':'shim-15.8-150100.3.38.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.2', 'sles-ltss-release-15.2']}
];
