...
if (description)
{
  ...
  script_cve_id("CVE-2021-33631");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-33631 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-33631");
