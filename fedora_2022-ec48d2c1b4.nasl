...
# extracted from Fedora Security Advisory FEDORA-2022-ec48d2c1b4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ec48d2c1b4");

  script_name(english:"Fedora 35 : firefox (2022-ec48d2c1b4)");
...
FEDORA-2022-ec48d2c1b4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ec48d2c1b4");
...
var pkgs = [
    {'reference':'firefox-107.0-4.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
