...
# extracted from Fedora Security Advisory FEDORA-2022-6fe4046ae9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6fe4046ae9");

  script_name(english:"Fedora 37 : xrdp (2022-6fe4046ae9)");
...
FEDORA-2022-6fe4046ae9 advisory.
    ...
    These security issues are reported by Team BT5 (BoB 11th). We appreciate their great help with making and
    reviewing patches.
    New features
    ...
    - On-the-fly resolution change requires the Microsoft Store version of Remote Desktop client but sometimes
    crashes on connect (#1869)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6fe4046ae9");
...
var pkgs = [
    {'reference':'xrdp-0.9.21-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
