...
# extracted from Ubuntu Security Notice USN-3971-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.10 / 19.04 : Monit vulnerabilities (USN-3971-1)");
...
Zack Flack discovered a buffer overread when Monit decoded certain
crafted URLs. An attacker could exploit this to leak potentially
sensitive information. (CVE-2019-11455).

Note that Tenable Network Security has extracted the preceding
description block directly from the Ubuntu security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/3971-1/");
...
if (ubuntu_check(osver:"18.10", pkgname:"monit", pkgver:"1:5.25.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"monit", pkgver:"1:5.25.2-3ubuntu0.1")) flag++;
