...
# extracted from Ubuntu Security Notice USN-6375-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6375-1");

  script_name(english:"Ubuntu 22.04 LTS / 23.04 : atftp vulnerability (USN-6375-1)");
...
the USN-6375-1 advisory.

    Florian Fainelli discovered that atftp did not properly manage requests made to a non-existent file, which
    could lead to a crash. A remote
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6375-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'atftp', 'pkgver': '0.7.git20210915-4build1'},
    {'osver': '22.04', 'pkgname': 'atftpd', 'pkgver': '0.7.git20210915-4build1'},
    {'osver': '23.04', 'pkgname': 'atftp', 'pkgver': '0.8.0-3build0.23.04.1'},
    {'osver': '23.04', 'pkgname': 'atftpd', 'pkgver': '0.8.0-3build0.23.04.1'}
];
