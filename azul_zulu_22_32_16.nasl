...
if (description)
{
  ...
  script_name(english:"Azul Zulu Java Multiple Vulnerabilities (2024-07-16)");

  script_set_attribute(attribute:"synopsis", value:
"Azul Zulu OpenJDK is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Azul Zulu installed on the remote host is prior to 6 < 6.65.0.16 / 7 < 7.71.0.18 / 8 < 8.79.0.14 / 11 <
11.73.14 / 17 < 17.51.16 / 21 < 21.35.18 / 22 < 22.32.16. It is, therefore, affected by multiple vulnerabilities as
referenced in the 2024-07-16 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://docs.azul.com/core/release/july-2024/release-notes");
  script_set_attribute(attribute:"solution", value:
"Apply the appropriate patch according to the July 2024 Azul Zulu OpenJDK Patch Update advisory.");
...
{
constraints = [
    { 'min_version' : '6.0.0', 'fixed_version' : '6.65.0.16', 'fixed_display' : 'Upgrade to a version 6.65.0.16 (SA) and above' },
    { 'min_version' : '7.0.0', 'fixed_version' : '7.71.0.18', 'fixed_display' : 'Upgrade to a version 7.71.0.18 (SA) and above' },
    { 'min_version' : '8.0.0', 'fixed_version' : '8.79.0.14', 'fixed_display' : 'Upgrade to a version 8.79.0.14 (SA) and above' },
    { 'min_version' : '11.0.0', 'fixed_version' : '11.73.14', 'fixed_display' : 'Upgrade to a version 11.73.14 (SA) and above' },
    { 'min_version' : '17.0.0', 'fixed_version' : '17.51.16', 'fixed_display' : 'Upgrade to a version 17.51.16 (SA) and above' },
    { 'min_version' : '21.0.0', 'fixed_version' : '21.35.18', 'fixed_display' : 'Upgrade to a version 21.35.18 (SA) and above' },
    { 'min_version' : '22.0.0', 'fixed_version' : '22.32.16', 'fixed_display' : 'Upgrade to a version 22.32.16 (SA) and above' }
  ];
}
else if ('CA' == package_type)
{
  constraints = [
    { 'min_version' : '8.0.0', 'fixed_version' : '8.80.0.17', 'fixed_display' : 'Upgrade to a version 8.80.0.17 (CA) and above' },
    { 'min_version' : '11.0.0', 'fixed_version' : '11.74.15', 'fixed_display' : 'Upgrade to a version 11.74.15 (CA) and above' },
    { 'min_version' : '17.0.0', 'fixed_version' : '17.52.17', 'fixed_display' : 'Upgrade to a version 17.52.17 (CA) and above' },
    { 'min_version' : '21.0.0', 'fixed_version' : '21.36.17', 'fixed_display' : 'Upgrade to a version 21.36.17 (CA) and above' },
    { 'min_version' : '22.0.0', 'fixed_version' : '22.32.15', 'fixed_display' : 'Upgrade to a version 22.32.15 (CA) and above' }
  ];
}
