...
# extracted from Red Hat Security Advisory RHSA-2024:6986. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6986");

  script_name(english:"RHEL 8 : nano (RHSA-2024:6986)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for nano.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6986.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f52517ce");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6986");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nano package based on the guidance in RHSA-2024:6986.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:nano");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nano-2.9.8-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
