...
if (description)
{
  ...
  script_cve_id("CVE-2024-30100");
  script_xref(name:"MSKB", value:"5002603");
  script_xref(name:"MSFT", value:"MS23-5002603");
  script_xref(name:"IAVA", value:"2024-A-0338-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server Subscription Edition (June 2024)");
...
It is, therefore, affected by a local code execution vulnerability. An attacker can exploit this with a specially 
crafted file to bypass authentication and execute unauthorized arbitrary commands.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002603");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002603 to address this issue.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-30100");
