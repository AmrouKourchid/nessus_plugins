...
# extracted from Red Hat Security Advisory RHSA-2019:0697. The text 
...
referenced in the RHSA-2019:0697 advisory.
    ...
    * freerdp: Integer truncation leading to heap-based buffer overflow in update_read_bitmap_update()
    function (CVE-2018-8786)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0697.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?633e9842");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0697");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1671359");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1671361");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1671363");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL freerdp package based on the guidance in RHSA-2019:0697.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freerdp-1.0.2-15.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freerdp-devel-1.0.2-15.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freerdp-libs-1.0.2-15.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freerdp-plugins-1.0.2-15.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
