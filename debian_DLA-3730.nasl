...
# extracted from Debian Security Advisory dla-3730. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3730 : python-asyncssh-doc - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3730
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/python-asyncssh");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'python-asyncssh-doc', 'reference': '1.12.2-1+deb10u1'},
    {'release': '10.0', 'prefix': 'python3-asyncssh', 'reference': '1.12.2-1+deb10u1'}
];
