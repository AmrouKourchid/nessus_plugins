...
if (description)
{
  ...
  script_name(english:"Security Update for Microsoft .NET Core SDK (January 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple Microsoft .NET Core SDK vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of .NET Core SDK installed on the remote host is 6.x prior to 6.0.26 or 7.x prior to 7.0.15. It is, 
therefore, affected by multiple vulnerabilities as referenced in the January 2024 advisory:

  - .NET Core Denial of Service Vulnerability (CVE-2024-20672)
