...
# extracted from Red Hat Security Advisory RHSA-2024:5534. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5534");

  script_name(english:"RHEL 9 : python-setuptools (RHSA-2024:5534)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5534.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c8016845");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5534");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-setuptools package based on the guidance in RHSA-2024:5534.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-setuptools-53.0.0-12.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-setuptools-wheel-53.0.0-12.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-setuptools-53.0.0-12.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-setuptools-wheel-53.0.0-12.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-setuptools / python3-setuptools-wheel');
}
