...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : libxml2 (EulerOS-SA-2024-1363)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1363
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?03859ea9");
...
var pkgs = [
  "libxml2-2.9.10-11.h26.eulerosv2r10",
  "python3-libxml2-2.9.10-11.h26.eulerosv2r10"
];
