...
# extracted from Red Hat Security Advisory RHSA-2023:6171. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6171");

  script_name(english:"RHEL 8 : Red Hat Product OCP Tools 4.11 Openshift Jenkins (RHSA-2023:6171)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat Product OCP Tools 4.11 Openshift Jenkins.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:6171 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cdf0455d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6171");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Product OCP Tools 4.11 Openshift Jenkins package based on the guidance in RHSA-2023:6171.");
  ...
  script_cwe_id(20, 77, 79, 200, 266, 400, 502, 1188);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.11.1698299029-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-1471', 'CVE-2022-29599', 'CVE-2022-42889', 'CVE-2023-24422', 'CVE-2023-25761', 'CVE-2023-25762', 'CVE-2023-39325']},
      {'reference':'jenkins-2.414.3.1698298955-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-27903', 'CVE-2023-27904', 'CVE-2023-39325']}
    ]
  }
];
