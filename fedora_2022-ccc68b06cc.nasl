...
# extracted from Fedora Security Advisory FEDORA-2022-ccc68b06cc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ccc68b06cc");

  script_name(english:"Fedora 36 : libtar (2022-ccc68b06cc)");
...
FEDORA-2022-ccc68b06cc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ccc68b06cc");
...
var pkgs = [
    {'reference':'libtar-1.2.20-26.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
