...
# extracted from VMware Security Advisory PHSA-2020-3.0-0165. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Tcpdump PHSA-2020-3.0-0165");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the tcpdump package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-3.0-165.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'tcpdump-4.9.3-2.ph3')) flag++;
