...
ELSA-2019-0818 advisory.
    ...
    - [kvm] kvm: fix kvm_ioctl_create_device() reference counting (Paolo Bonzini) [1671922 1671923]
    {CVE-2019-6974}
    - [kvm] KVM: nVMX: unconditionally cancel preemption timer in free_nested (Paolo Bonzini) [1671905
    1671906] {CVE-2019-7221}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-957.12.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
