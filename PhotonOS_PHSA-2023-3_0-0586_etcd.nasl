...
# extracted from VMware Security Advisory PHSA-2023-3.0-0586. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Etcd PHSA-2023-3.0-0586");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the etcd package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-586.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-32082");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'etcd-3.5.1-11.ph3')) flag++;
