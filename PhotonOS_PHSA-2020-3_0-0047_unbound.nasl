...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Unbound PHSA-2020-3.0-0047");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'unbound-1.8.0-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'unbound-devel-1.8.0-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'unbound-docs-1.8.0-3.ph3')) flag++;
