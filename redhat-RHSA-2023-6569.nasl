...
# extracted from Red Hat Security Advisory RHSA-2023:6569. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6569");

  script_name(english:"RHEL 9 : sysstat (RHSA-2023:6569)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for sysstat.");
...
the RHSA-2023:6569 advisory.

    The sysstat packages provide the sar and iostat commands. These commands enable system monitoring of disk,
    network, and other I/O activity.

    Security Fix(es):

    * sysstat: check_overflow() function can work incorrectly, which could lead to an overflow
    (CVE-2023-33204)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6569.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?639dbf36");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2208270");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2216805");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6569");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sysstat package based on the guidance in RHSA-2023:6569.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sysstat-12.5.4-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
