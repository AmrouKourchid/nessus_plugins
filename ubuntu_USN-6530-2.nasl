...
# extracted from Ubuntu Security Notice USN-6530-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6530-2");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : HAProxy vulnerability (USN-6530-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6530-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'haproxy', 'pkgver': '1.6.3-1ubuntu0.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-haproxy', 'pkgver': '1.6.3-1ubuntu0.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'haproxy', 'pkgver': '1.8.8-1ubuntu0.13+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'vim-haproxy', 'pkgver': '1.8.8-1ubuntu0.13+esm2', 'ubuntu_pro': TRUE}
];
