...
# extracted from Ubuntu Security Notice USN-6981-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6981-1");

  script_name(english:"Ubuntu 16.04 LTS : Drupal vulnerabilities (USN-6981-1)");
...
the USN-6981-1 advisory.

    It was discovered that Drupal incorrectly sanitized uploaded filenames. A remote attacker could possibly
    use this issue to execute arbitrary code. (CVE-2020-13671)

    It was discovered that Drupal incorrectly sanitized archived filenames. A remote attacker could possibly
    use this issue to overwrite arbitrary files, or execute arbitrary code. (CVE-2020-28948, CVE-2020-28949)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6981-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'drupal7', 'pkgver': '7.44-1ubuntu1~16.04.0+esm2', 'ubuntu_pro': TRUE}
];
