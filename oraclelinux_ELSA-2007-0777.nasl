...
# Oracle Linux Security Advisory ELSA-2007-0777 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / gdm (ELSA-2007-0777)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0777.html");
...
"Update the affected gdm package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-3381");
...
var pkgs = [
    {'reference':'gdm-2.16.0-31.0.1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'gdm-2.16.0-31.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
