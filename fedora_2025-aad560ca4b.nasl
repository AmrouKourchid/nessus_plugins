...
# extracted from Fedora Security Advisory FEDORA-2025-aad560ca4b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-aad560ca4b");

  script_name(english:"Fedora 41 : java-latest-openjdk (2025-aad560ca4b)");
...
FEDORA-2025-aad560ca4b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-aad560ca4b");
...
var pkgs = [
    {'reference':'java-latest-openjdk-24.0.1.0.9-1.rolling.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
