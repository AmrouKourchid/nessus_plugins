...
if (description)
{
  ...
  script_cve_id("CVE-2022-1160");

  script_name(english:"Photon OS 4.0: Vim PHSA-2022-4.0-0171");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-1160");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-8.2.4647-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-extra-8.2.4647-1.ph4')) flag++;
