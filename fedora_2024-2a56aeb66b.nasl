...
# extracted from Fedora Security Advisory FEDORA-2024-2a56aeb66b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2a56aeb66b");

  script_name(english:"Fedora 40 : chromium (2024-2a56aeb66b)");
...
FEDORA-2024-2a56aeb66b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2a56aeb66b");
...
var pkgs = [
    {'reference':'chromium-126.0.6478.182-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
