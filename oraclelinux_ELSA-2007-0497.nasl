...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / iscsi-initiator-utils (ELSA-2007-0497)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0497.html");
...
"Update the affected iscsi-initiator-utils package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-3100");
...
var pkgs = [
    {'reference':'iscsi-initiator-utils-6.2.0.742-0.6.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iscsi-initiator-utils-6.2.0.742-0.6.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
