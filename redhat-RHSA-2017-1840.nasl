...
# extracted from Red Hat Security Advisory RHSA-2017:1840. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:1840");

  script_name(english:"RHEL 6 / 7 : devtoolset-4-jackson-databind (RHSA-2017:1840)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for devtoolset-4-jackson-databind.");
...
in the RHSA-2017:1840 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_1840.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1579f18a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:1840");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL devtoolset-4-jackson-databind package based on the guidance in RHSA-2017:1840.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:devtoolset-4-jackson-databind");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:devtoolset-4-jackson-databind-javadoc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'devtoolset-4-jackson-databind-2.5.0-2.4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-4-jackson-databind-javadoc-2.5.0-2.4.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'devtoolset-4-jackson-databind-2.5.0-2.4.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-4-jackson-databind-javadoc-2.5.0-2.4.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'devtoolset-4-jackson-databind / etc');
}
