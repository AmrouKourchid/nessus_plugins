...
# SUSE update advisory SUSE-SU-2025:1254-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:1254-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 46 for SLE 15 SP3) (SUSE-SU-2025:1254-1)");
...
referenced in the SUSE-SU-2025:1254-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2025-April/038985.html");
...
"Update the affected kernel-livepatch-5_3_18-150300_59_167-default and / or kgraft-patch-4_12_14-122_219-default
packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.219-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_219-default-11-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '5.3.18-150300.59.167-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_167-default-11-150300.2.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150300_59_167-default / etc');
}
