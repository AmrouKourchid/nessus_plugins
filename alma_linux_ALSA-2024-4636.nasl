...
# AlmaLinux Security Advisory ALSA-2024:4636.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4636");

  script_name(english:"AlmaLinux 9 : libndp (ALSA-2024:4636)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-4636.html");
...
var pkgs = [
    {'reference':'libndp-1.8-6.el9_4.alma.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
