...
# extracted from Red Hat Security Advisory RHSA-2023:2234. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2234");

  script_name(english:"RHEL 9 : sysstat (RHSA-2023:2234)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2234.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?101ac7e8");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecefa061");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2141207");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2234");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sysstat package based on the guidance in RHSA-2023:2234.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sysstat-12.5.4-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
