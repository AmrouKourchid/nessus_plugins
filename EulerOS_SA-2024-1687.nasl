...
if (description)
{
  ...
  script_cve_id("CVE-2020-18768");

  script_name(english:"EulerOS Virtualization 3.0.6.0 : libtiff (EulerOS-SA-2024-1687)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1687
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?22871787");
...
"Update the affected libtiff packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-18768");
...
var pkgs = [
  "libtiff-4.0.9-11.h33.eulerosv2r8",
  "libtiff-devel-4.0.9-11.h33.eulerosv2r8"
];
