...
# extracted from Red Hat Security Advisory RHSA-2025:1516. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1516");

  script_name(english:"RHEL 9 : libxml2 (RHSA-2025:1516)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1516.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad214fa3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1516");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxml2-2.9.13-3.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.9.13-3.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libxml2-2.9.13-3.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
