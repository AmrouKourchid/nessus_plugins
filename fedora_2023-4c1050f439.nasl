...
# extracted from Fedora Security Advisory FEDORA-2023-4c1050f439
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4c1050f439");

  script_name(english:"Fedora 39 : golang-github-schollz-croc (2023-4c1050f439)");
...
FEDORA-2023-4c1050f439 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4c1050f439");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-github-schollz-croc package.");
...
var pkgs = [
    {'reference':'golang-github-schollz-croc-9.6.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-schollz-croc');
}
