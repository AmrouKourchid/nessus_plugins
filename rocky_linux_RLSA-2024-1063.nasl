...
# Rocky Linux Security Advisory RLSA-2024:1063.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:1063");

  script_name(english:"Rocky Linux 8 : edk2 (RLSA-2024:1063)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2024:1063 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:1063");
