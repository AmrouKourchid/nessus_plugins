...
# extracted from Red Hat Security Advisory RHSA-2021:0948. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0948");

  script_name(english:"RHEL 7 : Red Hat Certificate System (RHSA-2021:0948)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat Certificate System.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:0948 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0948.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9588997a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0948");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Certificate System package based on the guidance in RHSA-2021:0948.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pki-console");
...
var constraints = [
  {
    'repo_relative_urls': [
      'content/eus/rhel/server/7/7.6/x86_64/certificate-system/9/debug',
      'content/eus/rhel/server/7/7.6/x86_64/certificate-system/9/os',
      'content/eus/rhel/server/7/7.6/x86_64/certificate-system/9/source/SRPMS'
    ],
    'pkgs': [
      {'reference':'idm-console-framework-1.1.17-4.el7dsrv', 'release':'7', 'el_string':'el7dsrv', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-console-10.5.9-2.el7pki', 'release':'7', 'el_string':'el7pki', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-ocsp-10.5.9-15.el7pki', 'release':'7', 'el_string':'el7pki', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-tks-10.5.9-15.el7pki', 'release':'7', 'el_string':'el7pki', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pki-tps-10.5.9-15.el7pki', 'cpu':'x86_64', 'release':'7', 'el_string':'el7pki', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redhat-pki-console-theme-10.5.9-5.el7pki', 'release':'7', 'el_string':'el7pki', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redhat-pki-server-theme-10.5.9-5.el7pki', 'release':'7', 'el_string':'el7pki', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'idm-console-framework / pki-console / pki-ocsp / pki-tks / pki-tps / etc');
}
