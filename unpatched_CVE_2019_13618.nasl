...
if (description)
{
  ...
  script_cve_id("CVE-2019-13618");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-13618");
...
patch available.
  ...
  - In GPAC before 0.8.0, isomedia/isom_read.c in libgpac.a has a heap-based buffer over-read, as demonstrated
    by a crash in gf_m2ts_sync in media_tools/mpegts.c. (CVE-2019-13618)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-13618");
