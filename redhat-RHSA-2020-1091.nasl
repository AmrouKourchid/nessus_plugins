...
# extracted from Red Hat Security Advisory RHSA-2020:1091. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1091");

  script_name(english:"RHEL 7 : python-twisted-web (RHSA-2020:1091)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-twisted-web.");
...
the RHSA-2020:1091 advisory.

    Twisted is an event-based framework for internet applications. Twisted Web is a complete web server, aimed
    at hosting web applications using Twisted and Python, but fully able to serve static pages too.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1091.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c717569");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html/7.8_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?afba0e17");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1091");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1719501");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-twisted-web package based on the guidance in RHSA-2020:1091.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-twisted-web-12.1.0-6.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-twisted-web-12.1.0-6.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-twisted-web-12.1.0-6.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-twisted-web-12.1.0-6.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
