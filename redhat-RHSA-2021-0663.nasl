...
# extracted from Red Hat Security Advisory RHSA-2021:0663. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0663");
  script_xref(name:"IAVB", value:"2021-B-0013-S");

  script_name(english:"RHEL 7 / 8 : Ansible security update (2.9.18) (Moderate) (RHSA-2021:0663)");
...
referenced in the RHSA-2021:0663 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0663.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?828fc91b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0663");
...
"Update the RHEL Ansible package based on the guidance in RHSA-2021:0663.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.9.18-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'},
      {'reference':'ansible-test-2.9.18-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-2.9.18-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'},
      {'reference':'ansible-test-2.9.18-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'}
    ]
  }
];
