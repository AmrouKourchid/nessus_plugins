...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : libsndfile Vulnerability (NS-SA-2022-0068)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has libsndfile packages installed that are affected by a
vulnerability:
