...
# extracted from Gentoo Linux Security Advisory GLSA 202107-35.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-35");

  script_name(english:"GLSA-202107-35 : OpenSCAD: Buffer overflow");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-35
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-35"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All OpenSCAD users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:openscad");
...
if (qpkg_check(package:"media-gfx/openscad", unaffected:make_list("ge 2021.01"), vulnerable:make_list("lt 2021.01"))) flag++;
