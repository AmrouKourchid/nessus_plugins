...
# extracted from Fedora Security Advisory FEDORA-2024-68f9c0741f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-68f9c0741f");

  script_name(english:"Fedora 39 : redis (2024-68f9c0741f)");
...
FEDORA-2024-68f9c0741f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-68f9c0741f");
...
var pkgs = [
    {'reference':'redis-7.2.6-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
