...
# extracted from Amazon Linux AMI Security Advisory ALAS-2022-1606.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-33117", "CVE-2022-21151", "CVE-2022-21166");

  script_name(english:"Amazon Linux AMI : microcode_ctl (ALAS-2022-1606)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of microcode_ctl installed on the remote host is prior to 2.1-47.40. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS-2022-1606 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2022-1606.html");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-47.40.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'microcode_ctl-2.1-47.40.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'microcode_ctl-debuginfo-2.1-47.40.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'microcode_ctl-debuginfo-2.1-47.40.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
