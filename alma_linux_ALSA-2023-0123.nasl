...
# AlmaLinux Security Advisory ALSA-2023:0123.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:0123");

  script_name(english:"AlmaLinux 8 : kpatch-patch (ALSA-2023:0123)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-0123.html");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for ALSA-2023:0123');
  }
  else
  {
