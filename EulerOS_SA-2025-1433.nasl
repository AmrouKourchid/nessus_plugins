...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : proftpd (EulerOS-SA-2025-1433)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1433
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ee0d73a");
...
var pkgs = [
  "proftpd-1.3.7c-4.h8.eulerosv2r12"
];
