...
"The version of docker installed on the remote host is prior to 19.03.6ce-4.58. It is, therefore, affected by a
vulnerability as referenced in the ALAS-2020-1376 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2020-13401");
...
var pkgs = [
    {'reference':'docker-19.03.6ce-4.58.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-debuginfo-19.03.6ce-4.58.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
