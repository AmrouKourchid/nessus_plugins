...
# extracted from Fedora Security Advisory FEDORA-2023-cfe04c6093
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cfe04c6093");

  script_name(english:"Fedora 39 : unrealircd (2023-cfe04c6093)");
...
FEDORA-2023-cfe04c6093 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cfe04c6093");
...
var pkgs = [
    {'reference':'unrealircd-6.1.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
