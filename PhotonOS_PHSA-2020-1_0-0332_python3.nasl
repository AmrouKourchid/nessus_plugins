...
# extracted from VMware Security Advisory PHSA-2020-1.0-0332. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Python3 PHSA-2020-1.0-0332");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the python3 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-332.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'python3-3.5.6-17.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'python3-devel-3.5.6-17.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'python3-libs-3.5.6-17.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'python3-tools-3.5.6-17.ph1')) flag++;
