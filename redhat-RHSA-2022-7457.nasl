...
# extracted from Red Hat Security Advisory RHSA-2022:7457. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7457");

  script_name(english:"RHEL 8 : container-tools:rhel8 (RHSA-2022:7457)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:7457 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d87fe338");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7457");
...
"Update the affected packages.");
  ...
  script_cwe_id(276, 327, 362, 770, 842, 843);
  ...
  'container-tools:rhel8': [
    {
      ...
      'pkgs': [
        {'reference':'aardvark-dns-1.1.0-4.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'buildah-1.27.0-2.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'buildah-tests-1.27.0-2.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'cockpit-podman-53-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'conmon-2.1.4-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'container-selinux-2.189.0-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'containernetworking-plugins-1.1.1-3.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'containers-common-1-40.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'allowmaj':TRUE},
        {'reference':'crit-3.15-3.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-3.15-3.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-devel-3.15-3.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-libs-3.15-3.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'crun-1.5-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'fuse-overlayfs-1.9-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libslirp-4.4.0-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libslirp-devel-4.4.0-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'netavark-1.1.0-6.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'oci-seccomp-bpf-hook-1.2.6-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-4.2.0-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-catatonit-4.2.0-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-docker-4.2.0-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-gvproxy-4.2.0-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-plugins-4.2.0-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-remote-4.2.0-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'podman-tests-4.2.0-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'python3-criu-3.15-3.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-podman-4.2.0-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'runc-1.1.4-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'skopeo-1.9.2-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'skopeo-tests-1.9.2-1.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'slirp4netns-1.2.0-2.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'toolbox-0.0.99.3-0.6.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'toolbox-tests-0.0.99.3-0.6.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'udica-0.2.6-3.module+el8.7.0+16772+33343656', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
