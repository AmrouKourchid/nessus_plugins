...
# extracted from Red Hat Security Advisory RHSA-2017:1381 and 
# Oracle Linux Security Advisory ELSA-2017-1381 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : sudo (ELSA-2017-1381)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2017-1381.html");
...
var pkgs = [
    {'reference':'sudo-1.7.2p1-29.0.1.el5_10', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.7.2p1-29.0.1.el5_10', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
