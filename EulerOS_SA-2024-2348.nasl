...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : python-jinja2 (EulerOS-SA-2024-2348)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2348
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4478955e");
...
var pkgs = [
  "python3-jinja2-3.0.3-2.h2.eulerosv2r12"
];
