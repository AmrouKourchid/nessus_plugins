...
# extracted from Fedora Security Advisory FEDORA-2024-3fedeba41f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3fedeba41f");

  script_name(english:"Fedora 39 : emacs (2024-3fedeba41f)");
...
FEDORA-2024-3fedeba41f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3fedeba41f");
...
var pkgs = [
    {'reference':'emacs-29.4-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
