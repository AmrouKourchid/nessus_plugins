...
# extracted from openSUSE Security Update openSUSE-2020-1613.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : python-pip (openSUSE-2020-1613)");
...
"This update for python-pip fixes the following issues :
  ...
  - CVE-2019-20916: Fixed a directory traversal in
    _download_http_url (bsc#1176262)
...
if ( rpm_check(release:"SUSE15.1", reference:"python2-pip-10.0.1-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-pip-10.0.1-lp151.3.3.1") ) flag++;
