...
# extracted from Gentoo Linux Security Advisory GLSA 202210-27.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202210-27 : open-vm-tools: Local Privilege Escalation");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202210-27 (open-vm-tools: Local Privilege Escalation)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202210-27");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=866227");
...
"All open-vm-tools users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:open-vm-tools");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 12.1.0", "lt 12.0.0"),
    'vulnerable' : make_list("lt 12.1.0")
  }
];
