...
# extracted from Red Hat Security Advisory RHSA-2024:9424. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9424");

  script_name(english:"RHEL 9 : tpm2-tools (RHSA-2024:9424)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for tpm2-tools.");
...
referenced in the RHSA-2024:9424 advisory.

    The tpm2-tools packages add a set of utilities for management and utilization of Trusted Platform Module
    (TPM) 2.0 devices from user space.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2278071");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2278075");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9424.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?415b1c9d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9424");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tpm2-tools package based on the guidance in RHSA-2024:9424.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:tpm2-tools");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tpm2-tools-5.2-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'tpm2-tools');
}
