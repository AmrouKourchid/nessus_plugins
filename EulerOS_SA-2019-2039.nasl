...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : gvfs (EulerOS-SA-2019-2039)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2039
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?65dda9a9");
...
pkgs = ["gvfs-1.22.4-6.h2",
        "gvfs-afc-1.22.4-6.h2",
        "gvfs-afp-1.22.4-6.h2",
        "gvfs-archive-1.22.4-6.h2",
        "gvfs-devel-1.22.4-6.h2",
        "gvfs-fuse-1.22.4-6.h2",
        "gvfs-goa-1.22.4-6.h2",
        "gvfs-gphoto2-1.22.4-6.h2",
        "gvfs-mtp-1.22.4-6.h2",
        "gvfs-smb-1.22.4-6.h2"];
