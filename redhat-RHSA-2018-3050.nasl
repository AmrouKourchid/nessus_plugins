...
# extracted from Red Hat Security Advisory RHSA-2018:3050. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3050");

  script_name(english:"RHEL 7 : gnutls (RHSA-2018:3050)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2018:3050 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3050.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e3b7d8c3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3050");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1375307");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1434091");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1444792");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1460125");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1464896");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1561481");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1582571");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1582572");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1582574");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnutls-3.3.29-8.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-c++-3.3.29-8.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-dane-3.3.29-8.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-devel-3.3.29-8.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-utils-3.3.29-8.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
