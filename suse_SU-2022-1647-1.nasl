...
# SUSE update advisory SUSE-SU-2022:1647-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:1647-1");

  script_name(english:"SUSE SLES12 Security Update : clamav (SUSE-SU-2022:1647-1)");
...
referenced in the SUSE-SU-2022:1647-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-May/010995.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d1ef032c");
...
var pkgs = [
    {'reference':'clamav-0.103.6-3.18.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'clamav-0.103.6-3.18.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
