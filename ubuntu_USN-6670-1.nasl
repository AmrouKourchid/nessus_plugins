...
# extracted from Ubuntu Security Notice USN-6670-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6670-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : php-guzzlehttp-psr7 vulnerabilities (USN-6670-1)");
...
referenced in the USN-6670-1 advisory.

    It was discovered that php-guzzlehttp-psr7 incorrectly parsed HTTP headers. A remote attacker could
    possibly use these issues to perform an HTTP header injection attack.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6670-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected php-guzzlehttp-psr7 package.");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'php-guzzlehttp-psr7', 'pkgver': '1.4.2-0.1+deb10u2build0.20.04.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'php-guzzlehttp-psr7', 'pkgver': '1.8.3-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
