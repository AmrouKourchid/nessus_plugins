...
# extracted from openSUSE Security Update openSUSE-2020-1465.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libxml2 (openSUSE-2020-1465)");
...
if ( rpm_check(release:"SUSE15.2", reference:"libxml2-2-2.9.7-lp152.10.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libxml2-2-debuginfo-2.9.7-lp152.10.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libxml2-debugsource-2.9.7-lp152.10.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libxml2-devel-2.9.7-lp152.10.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libxml2-tools-2.9.7-lp152.10.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libxml2-tools-debuginfo-2.9.7-lp152.10.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python-libxml2-python-debugsource-2.9.7-lp152.10.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python2-libxml2-python-2.9.7-lp152.10.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python2-libxml2-python-debuginfo-2.9.7-lp152.10.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python3-libxml2-python-2.9.7-lp152.10.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"python3-libxml2-python-debuginfo-2.9.7-lp152.10.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libxml2-2-32bit-2.9.7-lp152.10.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libxml2-2-32bit-debuginfo-2.9.7-lp152.10.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libxml2-devel-32bit-2.9.7-lp152.10.3.1") ) flag++;
