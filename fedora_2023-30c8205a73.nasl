...
# extracted from Fedora Security Advisory FEDORA-2023-30c8205a73
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-30c8205a73");

  script_name(english:"Fedora 38 : java-11-openjdk (2023-30c8205a73)");
...
FEDORA-2023-30c8205a73 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-30c8205a73");
...
var pkgs = [
    {'reference':'java-11-openjdk-11.0.20.0.8-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
