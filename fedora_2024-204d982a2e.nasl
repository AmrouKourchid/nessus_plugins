...
# extracted from Fedora Security Advisory FEDORA-2024-204d982a2e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-204d982a2e");

  script_name(english:"Fedora 40 : dotnet8.0 (2024-204d982a2e)");
...
FEDORA-2024-204d982a2e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-204d982a2e");
...
var pkgs = [
    {'reference':'dotnet8.0-8.0.110-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
