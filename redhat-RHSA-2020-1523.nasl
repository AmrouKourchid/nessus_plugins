...
# extracted from Red Hat Security Advisory RHSA-2020:1523. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1523");

  script_name(english:"RHEL 7 : rh-maven35-jackson-databind (RHSA-2020:1523)");
...
referenced in the RHSA-2020:1523 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1523.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b77cb1ea");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1523");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1821304");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1821311");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1821315");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-maven35-jackson-databind package based on the guidance in RHSA-2020:1523.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-maven35-jackson-databind-2.7.6-2.9.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven35-jackson-databind-javadoc-2.7.6-2.9.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
