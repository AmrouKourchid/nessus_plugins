...
# Oracle Linux Security Advisory ELSA-2019-0218 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : firefox (ELSA-2019-0218)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-0218.html");
...
var pkgs = [
    {'reference':'firefox-60.5.0-2.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
