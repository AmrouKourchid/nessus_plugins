...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.12.49 (RHSA-2024:0666)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.12.49.");
...
referenced in the RHSA-2024:0666 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.12.49 packages based on the guidance in RHSA-2024:0666.");
...
var pkgs = [
    {'reference':'runc-1.1.6-5.1.rhaos4.12.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube'}
];
