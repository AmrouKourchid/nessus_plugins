...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : kernel (EulerOS-SA-2019-1168)");
...
the following vulnerability :
  ...
  - A flaw named FragmentSmack was found in the way the
    ...
    a denial of service on the system.i1/4^CVE-2018-5391i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1168
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8ed86976");
...
pkgs = ["kernel-3.10.0-862.14.1.1_24",
        "kernel-devel-3.10.0-862.14.1.1_24",
        "kernel-headers-3.10.0-862.14.1.1_24",
        "kernel-tools-3.10.0-862.14.1.1_24",
        "kernel-tools-libs-3.10.0-862.14.1.1_24",
        "kernel-tools-libs-devel-3.10.0-862.14.1.1_24"];
