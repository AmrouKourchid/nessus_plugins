...
# extracted from Oracle Linux Security Advisory ELSA-2024-1719.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : rear (ELSA-2024-1719)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1719.html");
...
"Update the affected rear package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:rear");
...
var pkgs = [
    {'reference':'rear-2.6-11.0.1.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rear-2.6-11.0.1.el8_9', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
