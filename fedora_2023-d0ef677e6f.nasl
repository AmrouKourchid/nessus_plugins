...
# extracted from Fedora Security Advisory FEDORA-2023-d0ef677e6f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d0ef677e6f");
  script_xref(name:"IAVB", value:"2023-B-0070-S");

  script_name(english:"Fedora 37 : ghostscript (2023-d0ef677e6f)");
...
FEDORA-2023-d0ef677e6f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d0ef677e6f");
...
var pkgs = [
    {'reference':'ghostscript-9.56.1-9.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
