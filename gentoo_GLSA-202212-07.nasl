...
# extracted from Gentoo Linux Security Advisory GLSA 202212-07.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202212-07 : libksba: Remote Code Execution");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202212-07 (libksba: Remote Code Execution)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202212-07");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.6.3"),
    'vulnerable' : make_list("lt 1.6.3")
  }
];
