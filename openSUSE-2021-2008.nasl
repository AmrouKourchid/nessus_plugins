...
# openSUSE Security Update openSUSE-SU-2021:2008-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-rsa (openSUSE-SU-2021:2008-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:2008-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/V4YOO76ZUMWHQXJCEHC2KUOF54N5673X/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?49e01325");
...
pkgs = [
    {'reference':'python2-rsa-3.4.2-3.4.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-rsa-3.4.2-3.4.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
