...
# extracted from Red Hat Security Advisory RHSA-2022:7968. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7968");

  script_name(english:"RHEL 9 : virt-v2v (RHSA-2022:7968)");
...
the RHSA-2022:7968 advisory.

    The virt-v2v package provides a tool for converting virtual machines to use the KVM (Kernel-based Virtual
    Machine) hypervisor or Red Hat Enterprise Virtualization. The tool modifies both the virtual machine image
    and its associated libvirt metadata. Also, virt-v2v can configure a guest to use VirtIO drivers if
    possible.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7968.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3556b694");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7968");
