...
# SUSE update advisory SUSE-SU-2024:4299-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:4299-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : govulncheck-vulndb (SUSE-SU-2024:4299-1)");
...
referenced in the SUSE-SU-2024:4299-1 advisory.
...
number.");
  # https://lists.suse.com/pipermail/sle-security-updates/2024-December/019993.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9063f912");
...
var pkgs = [
    {'reference':'govulncheck-vulndb-0.0.20241209T183251-150000.1.20.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'govulncheck-vulndb-0.0.20241209T183251-150000.1.20.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']},
    {'reference':'govulncheck-vulndb-0.0.20241209T183251-150000.1.20.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.5']},
    {'reference':'govulncheck-vulndb-0.0.20241209T183251-150000.1.20.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.6']}
];
