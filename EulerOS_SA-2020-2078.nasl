...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : golang (EulerOS-SA-2020-2078)");
...
vulnerabilities :
  ...
  - Go before 1.8.7, Go 1.9.x before 1.9.4, and Go 1.10
    pre-releases before Go 1.10rc2 allow 'go get' remote
    command execution during source code build, by
    leveraging the gcc or clang plugin feature, because
    -fplugin= and -plugin= arguments were not
    blocked.(CVE-2018-6574)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2078
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?11cdceb8");
