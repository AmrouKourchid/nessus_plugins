...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2019-A-0108-S");
...
therefore, affected by multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?22c1a457");
...
foreach install (installs[1])
{
  ...
  # 2018 Update 3.2
  else if (release == '2018' && ver_compare(ver:update, fix:'3.2', minver:'2', strict:FALSE) <= 0 && !isnull(ver_compare(ver:update, fix:'3.2', minver:'2', strict:FALSE)))
  {
    path = hotfix_append_path(path:path, value:'Application Tier\\Web Services\\bin');
