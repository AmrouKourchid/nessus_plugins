...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libksba PHSA-2024-5.0-0424");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libksba-1.6.3-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libksba-devel-1.6.3-2.ph5')) flag++;
