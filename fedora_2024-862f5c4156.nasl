...
# extracted from Fedora Security Advisory FEDORA-2024-862f5c4156
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-862f5c4156");

  script_name(english:"Fedora 39 : krb5 (2024-862f5c4156)");
...
FEDORA-2024-862f5c4156 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-862f5c4156");
...
var pkgs = [
    {'reference':'krb5-1.21.3-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
