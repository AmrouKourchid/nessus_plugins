...
# extracted from Red Hat Security Advisory RHSA-2021:4033 and
# CentOS Errata and Security Advisory 2021:4033 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : binutils (RHSA-2021:4033)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2021:4033 advisory.
...
var pkgs = [
    {'reference':'binutils-2.27-44.base.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'binutils-2.27-44.base.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'binutils-devel-2.27-44.base.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'binutils-devel-2.27-44.base.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
