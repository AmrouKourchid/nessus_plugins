...
# extracted from Gentoo Linux Security Advisory GLSA 202407-20.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202407-20 : KDE Plasma Workspaces: Privilege Escalation");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202407-20 (KDE Plasma Workspaces: Privilege
Escalation)

    Multiple vulnerabilities have been discovered in KDE Plasma Workspaces. Please review the CVE identifiers
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202407-20");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=933342");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 5.27.11.1"),
    'vulnerable' : make_list("lt 5.27.11.1")
  }
];
