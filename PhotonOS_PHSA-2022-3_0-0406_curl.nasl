...
# extracted from VMware Security Advisory PHSA-2022-3.0-0406. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Curl PHSA-2022-3.0-0406");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the curl package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-406.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'curl-7.83.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'curl-devel-7.83.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'curl-libs-7.83.1-1.ph3')) flag++;
