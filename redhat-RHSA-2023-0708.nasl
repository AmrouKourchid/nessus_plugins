...
# extracted from Red Hat Security Advisory RHSA-2023:0708. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0708");

  script_name(english:"RHEL 8 : Release of OpenShift Serverless Client kn 1.27.0 (Moderate) (RHSA-2023:0708)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2023:0708 advisory.

    Red Hat OpenShift Serverless Client kn 1.27.0 provides a CLI to interact with Red Hat OpenShift Serverless
    1.27.0. The kn CLI is delivered as an RPM package for installation on RHEL platforms, and as binaries for
    non-Linux platforms.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0708.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?adeef808");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2154756");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0708");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-serverless-clients-1.6.1-1.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-1.6.1-1.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-1.6.1-1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
