...
# AlmaLinux Security Advisory ALSA-2025:1330.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:1330");
  script_xref(name:"RHSA", value:"2025:1330");
  script_xref(name:"IAVA", value:"2025-A-0127");

  script_name(english:"AlmaLinux 9 : openssl (ALSA-2025:1330)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2025-1330.html");
...
var pkgs = [
    {'reference':'openssl-3.2.2-6.el9_5.1', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-devel-3.2.2-6.el9_5.1', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-libs-3.2.2-6.el9_5.1', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-perl-3.2.2-6.el9_5.1', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
