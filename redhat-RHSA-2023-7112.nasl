...
# extracted from Red Hat Security Advisory RHSA-2023:7112. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7112");

  script_name(english:"RHEL 8 : shadow-utils (RHSA-2023:7112)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for shadow-utils.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:7112 advisory.

    The shadow-utils packages include programs for converting UNIX password files to the shadow password
    format, as well as utilities for managing user and group accounts.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7112.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?612d4537");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1984740");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1994269");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2012929");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2215945");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7112");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL shadow-utils package based on the guidance in RHSA-2023:7112.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:shadow-utils-subid");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:shadow-utils-subid-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'shadow-utils-4.6-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'shadow-utils-subid-4.6-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'shadow-utils-subid-devel-4.6-19.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'shadow-utils / shadow-utils-subid / shadow-utils-subid-devel');
}
