...
# extracted from Fedora Security Advisory FEDORA-2019-72e5ac943a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-72e5ac943a");

  script_name(english:"Fedora 30 : 1:dovecot (2019-72e5ac943a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-72e5ac943a");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"dovecot-2.3.9.2-1.fc30", epoch:"1")) flag++;
