...
if (description)
{
  ...
  script_cve_id("CVE-2018-1232", "CVE-2018-1233");
  script_xref(name:"IAVA", value:"2018-A-0101");

  script_name(english:"RSA Authentication Agent for Web for Apache 8.x < 8.0.2 Multiple Vulnerabilities");
...
prior to 8.0.2. It is, therefore, potentially affected by multiple
vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2018/Mar/60");
  script_set_attribute(attribute:"solution", value:
"Upgrade to RSA Authentication Agent for Web for Apache 8.0.2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1233");
