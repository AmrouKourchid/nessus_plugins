...
# extracted from Debian Security Advisory dla-3959. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-52867");

  script_name(english:"Debian dla-3959 : guix - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-3959
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-52867");
...
"Upgrade the guix packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-52867");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'guix', 'reference': '1.2.0-4+deb11u3'}
];
