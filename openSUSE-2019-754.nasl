...
# extracted from openSUSE Security Update openSUSE-2019-754.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gitolite (openSUSE-2019-754)");
...
The update to 3.6.6 contains :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1108272");
