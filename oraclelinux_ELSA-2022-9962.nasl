...
# extracted from Oracle Linux Security Advisory ELSA-2022-9962.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : expat (ELSA-2022-9962)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9962.html");
...
var pkgs = [
    {'reference':'expat-2.0.1-13.0.2.el6_8', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.0.1-13.0.2.el6_8', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-2.0.1-13.0.2.el6_8', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.0.1-13.0.2.el6_8', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
