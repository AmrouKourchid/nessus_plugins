...
# extracted from Gentoo Linux Security Advisory GLSA 202012-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202012-06");

  script_name(english:"GLSA-202012-06 : Linux-PAM: Authentication bypass");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202012-06
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202012-06");
...
"All Linux-PAM users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-27780");
...
if (qpkg_check(package:"sys-libs/pam", unaffected:make_list("ge 1.5.1"), vulnerable:make_list("lt 1.5.1"))) flag++;
