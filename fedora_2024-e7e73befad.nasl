...
# extracted from Fedora Security Advisory FEDORA-2024-e7e73befad
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e7e73befad");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/05/22");

  script_name(english:"Fedora 39 : httpd (2024-e7e73befad)");
...
FEDORA-2024-e7e73befad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e7e73befad");
...
var pkgs = [
    {'reference':'httpd-2.4.61-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
