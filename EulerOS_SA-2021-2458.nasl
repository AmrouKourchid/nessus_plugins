...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : dnsmasq (EulerOS-SA-2021-2458)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2458
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8340d712");
...
var pkgs = [
  "dnsmasq-2.79-7.h6.eulerosv2r8",
  "dnsmasq-utils-2.79-7.h6.eulerosv2r8"
];
