...
# extracted from Red Hat Security Advisory RHSA-2022:1932. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1932");

  script_name(english:"RHEL 8 : python-lxml (RHSA-2022:1932)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1932.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2ddea1f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1932");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2032569");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-lxml package based on the guidance in RHSA-2022:1932.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-lxml-4.2.3-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
