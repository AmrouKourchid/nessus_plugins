...
# Oracle Linux Security Advisory ELSA-2007-0967 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Critical: / pcre (ELSA-2007-0967)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0967.html");
...
var pkgs = [
    {'reference':'pcre-6.6-2.el5_0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pcre-devel-6.6-2.el5_0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pcre-6.6-2.el5_0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pcre-devel-6.6-2.el5_0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
