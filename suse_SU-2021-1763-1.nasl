...
# extracted from SUSE update advisory SUSE-SU-2021:1763-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : curl (SUSE-SU-2021:1763-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd030a94");
...
zypper in -t patch SUSE-SLE-SDK-12-SP5-2021-1763=1

SUSE Linux Enterprise Server 12-SP5 :

zypper in -t patch SUSE-SLE-SERVER-12-SP5-2021-1763=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"curl-7.60.0-11.18.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"curl-debuginfo-7.60.0-11.18.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"curl-debugsource-7.60.0-11.18.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libcurl4-32bit-7.60.0-11.18.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libcurl4-7.60.0-11.18.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libcurl4-debuginfo-32bit-7.60.0-11.18.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libcurl4-debuginfo-7.60.0-11.18.1")) flag++;
