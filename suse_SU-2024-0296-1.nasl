...
# SUSE update advisory SUSE-SU-2024:0296-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0296-1");

  script_name(english:"SUSE SLES12 Security Update : squid (SUSE-SU-2024:0296-1)");
...
referenced in the SUSE-SU-2024:0296-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-February/017836.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?21057d6c");
...
var pkgs = [
    {'reference':'squid-4.17-4.41.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'squid-4.17-4.41.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
