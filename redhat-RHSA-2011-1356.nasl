...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2011/rhsa-2011_1356.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fa0bd265");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=742065");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:1356");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openswan package based on the guidance in RHSA-2011:1356.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openswan-2.6.32-4.el6_1.2', 'cpu':'i686', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-2.6.32-4.el6_1.2', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-2.6.32-4.el6_1.2', 'cpu':'s390x', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-2.6.32-4.el6_1.2', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-doc-2.6.32-4.el6_1.2', 'cpu':'i686', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-doc-2.6.32-4.el6_1.2', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-doc-2.6.32-4.el6_1.2', 'cpu':'s390x', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-doc-2.6.32-4.el6_1.2', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
