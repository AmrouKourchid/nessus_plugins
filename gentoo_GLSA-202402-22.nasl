...
# extracted from Gentoo Linux Security Advisory GLSA 202402-22.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-0127", "CVE-2021-0146");

  script_name(english:"GLSA-202402-22 : intel-microcode: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202402-22 (intel-microcode: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202402-22");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=832985");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=894474");
...
"All intel-microcode users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:intel-microcode");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 20230214_p20230212"),
    'vulnerable' : make_list("lt 20230214_p20230212")
  }
];
