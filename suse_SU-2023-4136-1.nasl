...
# SUSE update advisory SUSE-SU-2023:4136-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4136-1");

  script_name(english:"SUSE SLED15 / SLES15 Security Update : suse-module-tools (SUSE-SU-2023:4136-1)");
...
multiple vulnerabilities as referenced in the SUSE-SU-2023:4136-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-October/016757.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37ae81da");
...
var pkgs = [
    {'reference':'suse-module-tools-15.5.3-150500.3.6.1', 'sp':'5', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'suse-module-tools-15.5.3-150500.3.6.1', 'sp':'5', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'suse-module-tools-15.5.3-150500.3.6.1', 'sp':'5', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-basesystem-release-15.5', 'sled-release-15.5', 'sles-release-15.5']},
    {'reference':'suse-module-tools-15.5.3-150500.3.6.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-basesystem-release-15.5', 'sled-release-15.5', 'sles-release-15.5']}
];
