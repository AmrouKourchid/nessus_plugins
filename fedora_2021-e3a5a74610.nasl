...
# extracted from Fedora Security Advisory FEDORA-2021-e3a5a74610
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-e3a5a74610");
  script_xref(name:"IAVA", value:"2021-A-0052-S");

  script_name(english:"Fedora 32 : python39 (2021-e3a5a74610)");
...
FEDORA-2021-e3a5a74610 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-e3a5a74610");
  script_set_attribute(attribute:"solution", value:
"Update the affected python39 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python39");
...
pkgs = [
    {'reference':'python39-3.9.1-2.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python39');
}
