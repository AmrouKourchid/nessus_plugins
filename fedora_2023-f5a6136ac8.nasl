...
# extracted from Fedora Security Advisory FEDORA-2023-f5a6136ac8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f5a6136ac8");

  script_name(english:"Fedora 37 : libpano13 (2023-f5a6136ac8)");
...
FEDORA-2023-f5a6136ac8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f5a6136ac8");
  script_set_attribute(attribute:"solution", value:
"Update the affected libpano13 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libpano13");
...
var pkgs = [
    {'reference':'libpano13-2.9.22-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
