...
# extracted from Fedora Security Advisory FEDORA-2024-5dc487ee89
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5dc487ee89");

  script_name(english:"Fedora 38 : llhttp / python-aiohttp / uxplay (2024-5dc487ee89)");
...
FEDORA-2024-5dc487ee89 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5dc487ee89");
...
var pkgs = [
    {'reference':'llhttp-9.2.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-aiohttp-3.9.3-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'uxplay-1.68.2-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
