...
# extracted from Fedora Security Advisory FEDORA-2024-c94f884440
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c94f884440");

  script_name(english:"Fedora 39 : less (2024-c94f884440)");
...
FEDORA-2024-c94f884440 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c94f884440");
...
var pkgs = [
    {'reference':'less-633-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
