...
if (description)
{
  ...
  script_cve_id("CVE-2024-35369");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-35369");
...
patch available.
  ...
  - In FFmpeg version n6.1.1, specifically within the avcodec/speexdec.c module, a potential security
    ...
    undefined behavior or crashes during the decoding process. (CVE-2024-35369)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-35369");
