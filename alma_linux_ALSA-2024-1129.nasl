...
# AlmaLinux Security Advisory ALSA-2024:1129.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1129");
  script_xref(name:"IAVA", value:"2023-A-0674-S");

  script_name(english:"AlmaLinux 9 : curl (ALSA-2024:1129)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-1129.html");
