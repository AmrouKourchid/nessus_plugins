...
# extracted from Fedora Security Advisory FEDORA-2021-138674557c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-138674557c");

  script_name(english:"Fedora 32 : 1:wireshark (2021-138674557c)");
...
FEDORA-2021-138674557c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-138674557c");
...
pkgs = [
    {'reference':'wireshark-3.4.2-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
