...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Openldap PHSA-2017-0024");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openldap-2.4.43-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openldap-debuginfo-2.4.43-3.ph1')) flag++;
