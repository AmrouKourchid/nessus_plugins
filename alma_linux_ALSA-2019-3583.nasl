...
# AlmaLinux Security Advisory ALSA-2019:3583.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2019:3583");

  script_name(english:"AlmaLinux 8 : yum (ALSA-2019:3583)");
...
ALSA-2019:3583 advisory.
  ...
  - A use-after-free flaw has been discovered in libcomps before version 0.1.10 in the way ObjMRTrees are
    merged. An attacker, who is able to make an application read a crafted comps XML file, may be able to
    crash the application or execute malicious code. (CVE-2019-3817)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2019-3583.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected librhsm package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:librhsm");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'librhsm');
}
