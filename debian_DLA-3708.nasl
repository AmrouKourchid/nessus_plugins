...
# extracted from Debian Security Advisory dla-3708. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3708 : exim4 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3708
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-51766");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'exim4', 'reference': '4.92-8+deb10u9'},
    {'release': '10.0', 'prefix': 'exim4-base', 'reference': '4.92-8+deb10u9'},
    {'release': '10.0', 'prefix': 'exim4-config', 'reference': '4.92-8+deb10u9'},
    {'release': '10.0', 'prefix': 'exim4-daemon-heavy', 'reference': '4.92-8+deb10u9'},
    {'release': '10.0', 'prefix': 'exim4-daemon-light', 'reference': '4.92-8+deb10u9'},
    {'release': '10.0', 'prefix': 'exim4-dev', 'reference': '4.92-8+deb10u9'},
    {'release': '10.0', 'prefix': 'eximon4', 'reference': '4.92-8+deb10u9'}
];
