...
# AlmaLinux Security Advisory ALSA-2024:6754.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:6754");

  script_name(english:"AlmaLinux 9 : expat (ALSA-2024:6754)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:6754 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-6754.html");
...
var pkgs = [
    {'reference':'expat-2.5.0-2.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'expat-devel-2.5.0-2.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
