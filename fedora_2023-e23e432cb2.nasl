...
# extracted from Fedora Security Advisory FEDORA-2023-e23e432cb2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e23e432cb2");

  script_name(english:"Fedora 37 : audiofile (2023-e23e432cb2)");
...
FEDORA-2023-e23e432cb2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e23e432cb2");
...
var pkgs = [
    {'reference':'audiofile-0.3.6-36.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
