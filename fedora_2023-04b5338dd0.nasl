...
# extracted from Fedora Security Advisory FEDORA-2023-04b5338dd0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-04b5338dd0");

  script_name(english:"Fedora 36 : xen (2023-04b5338dd0)");
...
FEDORA-2023-04b5338dd0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-04b5338dd0");
...
var pkgs = [
    {'reference':'xen-4.16.3-4.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
