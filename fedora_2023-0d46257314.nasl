...
# extracted from Fedora Security Advisory FEDORA-2023-0d46257314
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0d46257314");

  script_name(english:"Fedora 39 : syncthing (2023-0d46257314)");
...
FEDORA-2023-0d46257314 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0d46257314");
...
var pkgs = [
    {'reference':'syncthing-1.26.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
