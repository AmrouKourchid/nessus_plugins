...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : python2 (EulerOS-SA-2020-1024)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1024
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?455fa253");
...
pkgs = ["python-unversioned-command-2.7.15-10.h18.eulerosv2r8",
        ...
        "python2-test-2.7.15-10.h18.eulerosv2r8"];
