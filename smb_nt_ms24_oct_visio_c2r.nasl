...
if (description)
{
  ...
  script_cve_id("CVE-2024-43505");

  script_name(english:"Security Updates for Microsoft Visio Products C2R (October 2024)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-43505");
...
manually perform an update.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-43505");
