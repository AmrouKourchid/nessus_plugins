...
# extracted from Red Hat Security Advisory RHSA-2022:5331. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5331");

  script_name(english:"RHEL 8 : libinput (RHSA-2022:5331)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libinput.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:5331 advisory.

    libinput is a library that handles input devices for display servers and other applications that need to
    directly deal with input devices.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5331.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?161bcc99");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5331");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2074952");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libinput package based on the guidance in RHSA-2022:5331.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libinput-1.16.3-3.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libinput-devel-1.16.3-3.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libinput-utils-1.16.3-3.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libinput-1.16.3-3.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libinput-devel-1.16.3-3.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libinput-utils-1.16.3-3.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libinput / libinput-devel / libinput-utils');
}
