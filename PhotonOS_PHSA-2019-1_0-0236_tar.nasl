...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Tar PHSA-2019-1.0-0236");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"tar-1.29-3.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"tar-debuginfo-1.29-3.ph1")) flag++;
