...
# extracted from Fedora Security Advisory FEDORA-2024-de08df1535
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-de08df1535");

  script_name(english:"Fedora 40 : httpd (2024-de08df1535)");
...
FEDORA-2024-de08df1535 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-de08df1535");
...
var pkgs = [
    {'reference':'httpd-2.4.62-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
