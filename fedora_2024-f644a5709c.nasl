...
# extracted from Fedora Security Advisory FEDORA-2024-f644a5709c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f644a5709c");
  script_xref(name:"IAVB", value:"2024-B-0028-S");

  script_name(english:"Fedora 39 : wireshark (2024-f644a5709c)");
...
FEDORA-2024-f644a5709c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f644a5709c");
...
var pkgs = [
    {'reference':'wireshark-4.0.14-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
