...
# extracted from Oracle Linux Security Advisory ELSA-2024-0116.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python-urllib3 (ELSA-2024-0116)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-0116.html");
...
"Update the affected python3-urllib3 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python3-urllib3");
...
var pkgs = [
    {'reference':'python3-urllib3-1.24.2-5.0.1.el8_9.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
