...
# extracted from openSUSE Security Update openSUSE-2020-2349.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openexr (openSUSE-2020-2349)");
...
Security issues fixed :
  ...
  - CVE-2020-16587: Fixed a heap-based buffer overflow in
    chunkOffsetReconstruction in ImfMultiPartInputFile.cpp
    (bsc#1179879).

  - CVE-2020-16588: Fixed a NULL pointer deference in
    generatePreview (bsc#1179879).

  - CVE-2020-16589: Fixed a heap-based buffer overflow in
    writeTileData in ImfTiledOutputFile.cpp (bsc#1179879).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1179879");
...
if ( rpm_check(release:"SUSE15.1", reference:"libIlmImf-2_2-23-2.2.1-lp151.4.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libIlmImf-2_2-23-debuginfo-2.2.1-lp151.4.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libIlmImfUtil-2_2-23-2.2.1-lp151.4.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libIlmImfUtil-2_2-23-debuginfo-2.2.1-lp151.4.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openexr-2.2.1-lp151.4.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openexr-debuginfo-2.2.1-lp151.4.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openexr-debugsource-2.2.1-lp151.4.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openexr-devel-2.2.1-lp151.4.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libIlmImf-2_2-23-32bit-2.2.1-lp151.4.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libIlmImf-2_2-23-32bit-debuginfo-2.2.1-lp151.4.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libIlmImfUtil-2_2-23-32bit-2.2.1-lp151.4.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libIlmImfUtil-2_2-23-32bit-debuginfo-2.2.1-lp151.4.15.1") ) flag++;
