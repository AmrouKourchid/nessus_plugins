...
if (description)
{
  ...
  script_name(english:"CentOS 9 : rpm-4.16.1.3-26.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for python3-rpm.");
...
rpm-4.16.1.3-26.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=41133");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream python3-rpm package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:python3-rpm");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:rpm-plugin-audit");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:rpm-plugin-fapolicyd");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:rpm-plugin-ima");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:rpm-plugin-prioreset");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:rpm-plugin-selinux");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:rpm-plugin-syslog");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:rpm-plugin-systemd-inhibit");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:rpm-sign");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:rpm-sign-libs");
...
var pkgs = [
    {'reference':'python3-rpm-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-apidocs-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-build-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-build-libs-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-cron-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-devel-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-libs-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-plugin-audit-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-plugin-fapolicyd-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-plugin-ima-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-plugin-prioreset-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-plugin-selinux-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-plugin-syslog-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-plugin-systemd-inhibit-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-sign-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-sign-libs-4.16.1.3-26.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
