...
"The version of Apache Log4j on the remote host is 2.x < 2.3.1 / 2.4 < 2.12.2 / 2.13 < 2.15.0. It is, therefore, 
affected by a remote code execution vulnerability in the JDNI parser due to improper log validation. An unauthenticated,
...
"Upgrade to Apache Log4j version 2.3.1 / 2.12.2 / 2.15.0 or later, or apply the vendor mitigation.
...
if (get_kb_item('SMB/Registry/Enumerated')) audit(AUDIT_OS_NOT, 'macOS / Linux', 'Windows');
