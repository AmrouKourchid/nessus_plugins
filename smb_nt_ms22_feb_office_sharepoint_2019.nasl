...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002135");
  script_xref(name:"MSFT", value:"MS22-5002135");
  script_xref(name:"IAVA", value:"2022-A-0065-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (February 2022)");
...
affected by multiple vulnerabilities:
  ...
  - A security feature bypass vulnerability exists. An
    ...
    (CVE-2022-21968)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002135");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002135 to address this issue.");
