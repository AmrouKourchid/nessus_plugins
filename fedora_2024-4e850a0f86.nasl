...
# extracted from Fedora Security Advisory FEDORA-2024-4e850a0f86
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4e850a0f86");

  script_name(english:"Fedora 41 : sssd (2024-4e850a0f86)");
...
FEDORA-2024-4e850a0f86 advisory.
    ...
    ```
    * Fri Apr 19 2024 Pavel Bezina <pbrezina@redhat.com> - 2.9.4-7
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4e850a0f86");
...
var pkgs = [
    {'reference':'sssd-2.9.4-7.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
