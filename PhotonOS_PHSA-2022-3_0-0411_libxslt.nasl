...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libxslt PHSA-2022-3.0-0411");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libxslt-1.1.34-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libxslt-devel-1.1.34-1.ph3')) flag++;
