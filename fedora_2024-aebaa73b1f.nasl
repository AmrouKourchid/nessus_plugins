...
# extracted from Fedora Security Advisory FEDORA-2024-aebaa73b1f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-aebaa73b1f");

  script_name(english:"Fedora 41 : pdns-recursor (2024-aebaa73b1f)");
...
FEDORA-2024-aebaa73b1f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-aebaa73b1f");
...
var pkgs = [
    {'reference':'pdns-recursor-5.1.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
