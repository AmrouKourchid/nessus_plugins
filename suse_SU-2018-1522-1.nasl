...
# extracted from SUSE update advisory SUSE-SU-2018:1522-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (SUSE-SU-2018:1522-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1090869");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20181522-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae4dc273");
...
SUSE-SLE-SAP-12-SP2-2018-1070=1

SUSE Linux Enterprise Server 12-SP2-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP2-2018-1070=1");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kgraft-patch-4_4_59-92_20-default");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"kgraft-patch-4_4_59-92_20-default-12-2.1")) flag++;
