...
if (description)
{
  ...
  script_name(english:"VMware Workstation 16.0.x < 16.2.5 Vulnerability (VMSA-2022-0033)");

  script_set_attribute(attribute:"synopsis", value:
"A virtualization application installed on the remote Windows host is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of VMware Workstation installed on the remote host is 16.0.x prior to 16.2.5. It is, therefore, affected by
a vulnerability.
