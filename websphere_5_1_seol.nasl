...
if (description)
{
  ...
  script_name(english:"IBM WebSphere Application Server SEoL (5.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of IBM WebSphere Application Server is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, IBM WebSphere Application Server is 5.1.x. It is, therefore, no longer maintained by its
vendor or provider.
...
"Upgrade to a version of IBM WebSphere Application Server that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2008/09/30");
...
var constraints = [
  { max_branch : '5.1', min_branch : '5.1', seol : 20080930, eseol : 20100926 }
];
