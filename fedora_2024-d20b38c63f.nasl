...
# extracted from Fedora Security Advisory FEDORA-2024-d20b38c63f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d20b38c63f");

  script_name(english:"Fedora 39 : NetworkManager-libreswan (2024-d20b38c63f)");
...
FEDORA-2024-d20b38c63f advisory.

    This is an update to 1.2.24 release of NetworkManager-libreswan, the IPSec VPN plugin for NetworkManager.
    It fixes a local privilege escalation bug due to improper escaping of Libreswan configuration.
    (CVE-2024-9050)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d20b38c63f");
  script_set_attribute(attribute:"solution", value:
"Update the affected NetworkManager-libreswan package.");
...
var pkgs = [
    {'reference':'NetworkManager-libreswan-1.2.24-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'NetworkManager-libreswan');
}
