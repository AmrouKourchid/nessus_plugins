...
# extracted from Fedora Security Advisory FEDORA-2024-1304d7f338
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1304d7f338");
  script_xref(name:"IAVA", value:"2024-A-0538-S");

  script_name(english:"Fedora 39 : firefox (2024-1304d7f338)");
...
FEDORA-2024-1304d7f338 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1304d7f338");
...
var pkgs = [
    {'reference':'firefox-130.0-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
