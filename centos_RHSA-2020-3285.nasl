...
# CentOS Errata and Security Advisory 2020:3285 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : postgresql-jdbc (RHSA-2020:3285)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2020:3285 advisory.
...
var pkgs = [
    {'reference':'postgresql-jdbc-9.2.1002-8.el7_8', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-jdbc-javadoc-9.2.1002-8.el7_8', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
