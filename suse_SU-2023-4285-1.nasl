...
# SUSE update advisory SUSE-SU-2023:4285-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4285-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 32 for SLE 15 SP3) (SUSE-SU-2023:4285-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2023:4285-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1212934");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1214812");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1215118");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1215440");
  # https://lists.suse.com/pipermail/sle-security-updates/2023-October/016936.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?84d7089b");
...
"Update the affected kernel-livepatch-5_14_21-150400_24_38-default and / or kernel-livepatch-5_3_18-150300_59_121-default
packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.24.38-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_38-default-11-150400.2.3', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      },
      '5.3.18-150300.59.121-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_121-default-7-150300.2.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_24_38-default / etc');
}
