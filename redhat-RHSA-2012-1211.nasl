...
if (description)
{
  ...
  script_name(english:"RHEL 6 : thunderbird (RHSA-2012:1211)");
...
referenced in the RHSA-2012:1211 advisory.
    ...
    Schoenick, Vladimir Vukicevic, Daniel Holbert, Abhishek Arya, Frdric
    Hoguin, miaubiz, Arthur Gerkis, Nicolas Grgoire, moz_bug_r_a4, and Colby
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2012/rhsa-2012_1211.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cb66fff2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1211");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-10.0.7-1.el6_3', 'cpu':'i686', 'release':'6', 'el_string':'el6_3', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-10.0.7-1.el6_3', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_3', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-10.0.7-1.el6_3', 'cpu':'s390x', 'release':'6', 'el_string':'el6_3', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-10.0.7-1.el6_3', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_3', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
