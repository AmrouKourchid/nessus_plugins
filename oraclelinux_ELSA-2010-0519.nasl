...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : libtiff (ELSA-2010-0519)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0519.html");
...
"Update the affected libtiff and / or libtiff-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-1411");
...
var pkgs = [
    {'reference':'libtiff-3.8.2-7.el5_5.5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtiff-devel-3.8.2-7.el5_5.5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtiff-3.8.2-7.el5_5.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libtiff-devel-3.8.2-7.el5_5.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
