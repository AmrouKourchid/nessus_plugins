...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : dpdk (EulerOS-SA-2019-2688)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2688
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2bcc73de");
...
pkgs = ["dpdk-18.11-0.h16.eulerosv2r7",
        "dpdk-devel-18.11-0.h16.eulerosv2r7"];
