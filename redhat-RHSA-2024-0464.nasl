...
# extracted from Red Hat Security Advisory RHSA-2024:0464. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0464");

  script_name(english:"RHEL 9 : python-urllib3 (RHSA-2024:0464)");
...
referenced in the RHSA-2024:0464 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0464.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?946b3b7f");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0464");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-urllib3 package based on the guidance in RHSA-2024:0464.");
