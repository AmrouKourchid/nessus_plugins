...
# extracted from Red Hat Security Advisory jboss-on. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-46877", "CVE-2022-42003", "CVE-2022-42004");

  script_name(english:"RHEL 8 : jboss-on (Unpatched Vulnerability) (deprecated)");
