...
# extracted from Red Hat Security Advisory RHSA-2024:5000. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5000");

  script_name(english:"RHEL 8 : python-setuptools (RHSA-2024:5000)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-setuptools.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:5000 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5000.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a010c85");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5000");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-setuptools package based on the guidance in RHSA-2024:5000.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'platform-python-setuptools-39.2.0-7.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-setuptools-39.2.0-7.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-setuptools-wheel-39.2.0-7.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
