...
if (description)
{
  ...
  script_name(english:"CentOS 7 : xstream (RHSA-2021:1354)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RHSA-2021:1354 advisory.
...
var pkgs = [
    {'reference':'xstream-1.3.1-13.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xstream-javadoc-1.3.1-13.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
