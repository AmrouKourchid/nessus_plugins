...
# extracted from Fedora Security Advisory FEDORA-2019-88f264563f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-88f264563f");

  script_name(english:"Fedora 29 : wavpack (2019-88f264563f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-88f264563f");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"wavpack-5.1.0-12.fc29")) flag++;
