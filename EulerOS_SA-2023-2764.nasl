...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : ncurses (EulerOS-SA-2023-2764)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2764
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?81e1ef3c");
...
var pkgs = [
  "ncurses-6.3-2.h4.eulerosv2r11",
  "ncurses-base-6.3-2.h4.eulerosv2r11",
  "ncurses-libs-6.3-2.h4.eulerosv2r11"
];
