...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : git (EulerOS-SA-2021-1944)");
...
vulnerability :
  ...
  - Git is an open-source distributed revision control
    ...
    The earliest impacted version is
    2.14.2.(CVE-2021-21300)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1944
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?59f7f5d5");
...
pkgs = ["git-2.23.0-12.h3.eulerosv2r9",
        "git-help-2.23.0-12.h3.eulerosv2r9"];
