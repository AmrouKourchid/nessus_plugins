...
if (description)
{
  ...
  script_cve_id("CVE-2021-32256", "CVE-2022-4285", "CVE-2023-2222");

  script_name(english:"RHEL 8 : gdb (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-11-gdb");
