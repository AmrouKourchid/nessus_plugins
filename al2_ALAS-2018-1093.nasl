...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-1093.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : git (ALAS-2018-1093)");
...
URL field beginning with a '-' character.(CVE-2018-17456)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-1093.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"git-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"git-all-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"git-core-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"git-core-doc-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"git-cvs-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"git-daemon-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"git-debuginfo-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"git-email-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"git-gnome-keyring-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"git-gui-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"git-p4-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"git-svn-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"gitk-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"gitweb-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-Git-2.14.5-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"perl-Git-SVN-2.14.5-1.amzn2")) flag++;
