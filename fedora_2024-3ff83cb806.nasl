...
# extracted from Fedora Security Advisory FEDORA-2024-3ff83cb806
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3ff83cb806");

  script_name(english:"Fedora 40 : matrix-synapse / rust-pythonize (2024-3ff83cb806)");
...
FEDORA-2024-3ff83cb806 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3ff83cb806");
...
var pkgs = [
    {'reference':'matrix-synapse-1.105.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-pythonize-0.21.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
