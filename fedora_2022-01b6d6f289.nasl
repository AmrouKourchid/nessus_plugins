...
# extracted from Fedora Security Advisory FEDORA-2022-01b6d6f289
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-01b6d6f289");

  script_name(english:"Fedora 36 : thunderbird (2022-01b6d6f289)");
...
FEDORA-2022-01b6d6f289 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-01b6d6f289");
...
var pkgs = [
    {'reference':'thunderbird-91.11.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
