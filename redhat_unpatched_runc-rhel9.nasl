...
# extracted from Red Hat Security Advisory runc. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 9 : runc (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6646c51e");
