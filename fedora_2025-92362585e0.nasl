...
# extracted from Fedora Security Advisory FEDORA-2025-92362585e0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-92362585e0");
  script_xref(name:"IAVA", value:"2025-A-0300");

  script_name(english:"Fedora 41 : containerd (2025-92362585e0)");
...
FEDORA-2025-92362585e0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-92362585e0");
...
var pkgs = [
    {'reference':'containerd-1.7.27-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
