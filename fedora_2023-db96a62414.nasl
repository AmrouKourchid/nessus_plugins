...
# extracted from Fedora Security Advisory FEDORA-2023-db96a62414
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-db96a62414");

  script_name(english:"Fedora 37 : rust-libgit2-sys (2023-db96a62414)");
...
FEDORA-2023-db96a62414 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-db96a62414");
...
var pkgs = [
    {'reference':'rust-libgit2-sys-0.13.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
