...
# extracted from Ubuntu Security Notice USN-7205-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7205-1");
  script_xref(name:"IAVA", value:"2025-A-0039-S");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 24.04 LTS / 24.10 : Django vulnerability (USN-7205-1)");
...
vulnerability as referenced in the USN-7205-1 advisory.

    It was discovered that Django incorrectly handled certain IPv6 strings. An attacker could possibly use
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7205-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'python3-django', 'pkgver': '2:2.2.12-1ubuntu0.27'},
    {'osver': '22.04', 'pkgname': 'python3-django', 'pkgver': '2:3.2.12-2ubuntu1.16'},
    {'osver': '24.04', 'pkgname': 'python3-django', 'pkgver': '3:4.2.11-1ubuntu1.5'},
    {'osver': '24.10', 'pkgname': 'python3-django', 'pkgver': '3:4.2.15-1ubuntu1.2'}
];
