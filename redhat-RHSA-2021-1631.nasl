...
# extracted from Red Hat Security Advisory RHSA-2021:1631. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1631");

  script_name(english:"RHEL 8 : python-urllib3 (RHSA-2021:1631)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1631.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5bd6414d");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.4_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?862005a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1631");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1883632");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-urllib3 package based on the guidance in RHSA-2021:1631.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-urllib3-1.24.2-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
