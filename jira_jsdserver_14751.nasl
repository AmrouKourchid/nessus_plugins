...
if (description)
{
  ...
  script_name(english:"Atlassian Jira Service Management Data Center and Server 4.20.x < 4.20.27 / 5.4.x < 5.4.11 (JSDSERVER-14751)");
...
host is affected by a vulnerability as referenced in the JSDSERVER-14751 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/JSDSERVER-14751");
