...
# extracted from Red Hat Security Advisory RHSA-2022:6822. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6822");

  script_name(english:"RHEL 8 : Red Hat JBoss Enterprise Application Platform 7.4.7 Security update (Important) (RHSA-2022:6822)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:6822 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6822.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?07e123f6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6822");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/JBEAP-23619");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-snakeyaml-1.31.0-1.redhat_00001.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2022-25857']},
      {'reference':'eap7-undertow-2.2.19-1.SP2_redhat_00001.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2022-1259', 'CVE-2022-2053']}
    ]
  }
];
