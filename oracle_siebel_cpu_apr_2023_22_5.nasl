...
if (description)
{
  ...
  script_cve_id("CVE-2020-7712");

  script_name(english:"Oracle Siebel Server <= 22.5 (April 2023 CPU)");
...
April 2023 CPU advisory.
  ...
  - Vulnerability in the Siebel CRM product of Oracle Siebel CRM (component: Loging (Apache ZooKeeper)).
    Supported versions that are affected are 22.5 and prior. Easily exploitable vulnerability allows high
    privileged attacker with network access via HTTP to compromise Siebel CRM. Successful attacks of this
    vulnerability can result in takeover of Siebel CRM. (CVE-2020-7712)
...
"Apply the appropriate patch according to the April 2023 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-7712");
...
var constraints = [
  { 'max_version' : '22.5.999', 'fixed_version' : '23.4' }
];
