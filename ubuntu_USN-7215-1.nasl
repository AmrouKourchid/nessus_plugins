...
# extracted from Ubuntu Security Notice USN-7215-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7215-1");

  script_name(english:"Ubuntu 24.10 : libxml2 vulnerability (USN-7215-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 24.10 host has packages installed that are affected by a vulnerability as referenced in the USN-7215-1
advisory.

    Xisco Fauli discovered that libxml2 incorrectly handled custom SAX handlers. A remote attacker could
    possibly use this issue to perform XML External Entity (XXE) attacks.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7215-1");
...
var pkgs = [
    {'osver': '24.10', 'pkgname': 'libxml2', 'pkgver': '2.12.7+dfsg-3ubuntu0.1'},
    {'osver': '24.10', 'pkgname': 'libxml2-dev', 'pkgver': '2.12.7+dfsg-3ubuntu0.1'},
    {'osver': '24.10', 'pkgname': 'libxml2-utils', 'pkgver': '2.12.7+dfsg-3ubuntu0.1'},
    {'osver': '24.10', 'pkgname': 'python3-libxml2', 'pkgver': '2.12.7+dfsg-3ubuntu0.1'}
];
