...
if (description)
{
  ...
  script_name(english:"Adobe Reader < 17.012.30262 / 20.005.30381 / 22.002.20191 Multiple Vulnerabilities (APSB22-39) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The version of Adobe Reader installed on the remote macOS host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Reader installed on the remote macOS host is a version prior to 17.012.30262, 20.005.30381, or
...
"Upgrade to Adobe Reader version 17.012.30262 / 20.005.30381 / 22.002.20191 or later.");
