...
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.7.38.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4801.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26029edf");
...
"Update the RHEL OpenShift Container Platform 4.7.38 package based on the guidance in RHSA-2021:4801.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.7.1637600997-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-21698']},
      {'reference':'jenkins-2.303.3.1637597018-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-21685', 'CVE-2021-21686', 'CVE-2021-21687', 'CVE-2021-21688', 'CVE-2021-21689', 'CVE-2021-21690', 'CVE-2021-21691', 'CVE-2021-21692', 'CVE-2021-21693', 'CVE-2021-21694', 'CVE-2021-21695', 'CVE-2021-21696', 'CVE-2021-21697']}
    ]
  }
];
