...
# extracted from Red Hat Security Advisory RHSA-2023:6566. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6566");

  script_name(english:"RHEL 9 : libmicrohttpd (RHSA-2023:6566)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6566.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b181b51");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6566");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libmicrohttpd package based on the guidance in RHSA-2023:6566.");
