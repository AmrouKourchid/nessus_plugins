...
# extracted from Red Hat Security Advisory RHSA-2023:3567. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3567");
  script_xref(name:"IAVA", value:"2023-A-0284-S");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2023:3567)");
...
referenced in the RHSA-2023:3567 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3567.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd1337d3");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3567");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2023:3567.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-102.12.0-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
