...
# extracted from Red Hat Security Advisory RHSA-2019:2403. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2403");

  script_name(english:"RHEL 7 : augeas (RHSA-2019:2403)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for augeas.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:2403 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2403.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?280dcf57");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2403");
...
"Update the RHEL augeas package based on the guidance in RHSA-2019:2403.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'augeas-1.4.0-2.el7_3.1', 'sp':'3', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-1.4.0-2.el7_3.1', 'sp':'3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-devel-1.4.0-2.el7_3.1', 'sp':'3', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-devel-1.4.0-2.el7_3.1', 'sp':'3', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-devel-1.4.0-2.el7_3.1', 'sp':'3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-libs-1.4.0-2.el7_3.1', 'sp':'3', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-libs-1.4.0-2.el7_3.1', 'sp':'3', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'augeas-libs-1.4.0-2.el7_3.1', 'sp':'3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
