...
# extracted from Fedora Security Advisory FEDORA-2024-a5861bce91
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a5861bce91");

  script_name(english:"Fedora 40 : xen (2024-a5861bce91)");
...
FEDORA-2024-a5861bce91 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a5861bce91");
...
var pkgs = [
    {'reference':'xen-4.18.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
