...
# extracted from Fedora Security Advisory FEDORA-2019-6469ad8129.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-6469ad8129");

  script_name(english:"Fedora 29 : libmp4v2 (2019-6469ad8129)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-6469ad8129");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libmp4v2-2.1.0-0.19.trunkREV507.fc29")) flag++;
