...
# extracted from Debian Security Advisory DLA-1364-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1364-1 : openslp-dfsg security update");
...
corruption, which may result in a denial of service or remote code
execution.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/04/msg00029.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/wheezy/openslp-dfsg");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libslp-dev", reference:"1.2.1-9+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libslp1", reference:"1.2.1-9+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"openslp-doc", reference:"1.2.1-9+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"slpd", reference:"1.2.1-9+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"slptool", reference:"1.2.1-9+deb7u2")) flag++;
