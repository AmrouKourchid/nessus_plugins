...
# extracted from Gentoo Linux Security Advisory GLSA 202107-46.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-46");

  script_name(english:"GLSA-202107-46 : mpv: Format string vulnerability");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-46
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-46"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"media-video/mpv", unaffected:make_list("ge 0.33.1"), vulnerable:make_list("lt 0.33.1"))) flag++;
