...
# extracted from Red Hat Security Advisory RHSA-2022:8552. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : firefox (RHSA-2022:8552)");
...
referenced in the RHSA-2022:8552 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8552.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f9e7a0e");
...
"Update the RHEL firefox package based on the guidance in RHSA-2022:8552.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.5.0-1.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.5.0-1.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.5.0-1.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.5.0-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-102.5.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
