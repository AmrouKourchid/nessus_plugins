...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5035110");
  script_xref(name:"MSFT", value:"MS24-5035110");
  script_xref(name:"IAVA", value:"2024-A-0098-S");

  script_name(english:"Security Updates for Microsoft Dynamics 365 (on-premises) (February 2024)");
...
multiple vulnerabilities.
 ...
 - Cross-site scripting (XSS) in Microsoft Dynamics 365 (CVE-2024-21327, CVE-2024-21389, CVE-2024-21393,
   CVE-2024-21395)

 - Spoofing vulnerability in the Sales and Field Service components. (CVE-2024-21328, CVE-2024-21394,
   CVE-2024-21396)

Note that Nessus has not tested for these issues but has instead relied only on the application's
self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5035110");
...
"Microsoft has released the following security updates to address this issue: 
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21395");
...
var constraints = [
  { 'min_version' : '9.1', 'fixed_version' : '9.1.25.17', 'fixed_display' : 'Update v9.1 (on-premises) Update 1.25' }
];
