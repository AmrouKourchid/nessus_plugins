...
# AlmaLinux Security Advisory ALSA-2021:4319.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:4319");

  script_name(english:"AlmaLinux 8 : compat-exiv2-026 (ALSA-2021:4319)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-4319.html");
