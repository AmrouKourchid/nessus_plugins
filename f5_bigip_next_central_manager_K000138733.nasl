...
# extracted from F5 Networks BIG-IP Solution K000138733.
#
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-26026");
  script_xref(name:"IAVA", value:"2024-A-0273");
  script_xref(name:"CEA-ID", value:"CEA-2024-0008");

  script_name(english:"F5 BIG-IP Next Central Manager 20.0.1 < 20.2.0 SQL Injection (K000138733)");

  script_set_attribute(attribute:"synopsis", value:
"F5 BIG-IP Next Central Manager installed on the remote Linux host is affected by an SQL Injection vulnerability.");
...
It is, therefore, affected by an SQL Injection vulnerability as referenced in the K000138733 advisory. An 
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K000138733");
...
"Upgrade client software to a version referenced in the advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-26026");
