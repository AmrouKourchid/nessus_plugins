...
# extracted from Red Hat Security Advisory RHSA-2020:3970 and
# CentOS Errata and Security Advisory 2020:3970 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : mod_auth_openidc (RHSA-2020:3970)");
...
var pkgs = [
    {'reference':'mod_auth_openidc-1.8.8-7.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_auth_openidc-1.8.8-7.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
