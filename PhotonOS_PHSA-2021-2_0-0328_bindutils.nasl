...
# extracted from VMware Security Advisory PHSA-2021-2.0-0328. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Bindutils PHSA-2021-2.0-0328");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the bindutils package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-328.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'bindutils-9.16.6-2.ph2')) flag++;
