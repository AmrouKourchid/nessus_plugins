...
if (description)
{
  ...
  script_cve_id("CVE-2011-0700", "CVE-2011-0701", "CVE-2011-3818");
...
only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/news/2011/02/wordpress-3-0-5/");
  script_set_attribute(attribute:"see_also", value:"https://codex.wordpress.org/Version_3.0.5");
  script_set_attribute(attribute:"solution", value:
"Upgrade to WordPress 3.0.5 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-3818");
