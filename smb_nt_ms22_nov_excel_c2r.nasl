...
if (description)
{
  ...
  script_name(english:"Security Updates for Microsoft Excel Products C2R (November 2022)");
...
vulnerabilities:
  ...
  - A security feature bypass vulnerability. (CVE-2022-41104)

  - Two remote code execution vulnerabilities. (CVE-2022-41106, CVE-2022-41063)
