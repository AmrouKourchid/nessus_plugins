...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5034819");
  script_xref(name:"MSFT", value:"MS24-5034819");
  ...
  script_name(english:"KB5034819: Windows Server 2012 R2 Security Update (February 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5034819. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034819");
