...
# extracted from Fedora Security Advisory FEDORA-2022-104076b1d8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-104076b1d8");

  script_name(english:"Fedora 36 : python3.6 (2022-104076b1d8)");
...
FEDORA-2022-104076b1d8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-104076b1d8");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-14.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
