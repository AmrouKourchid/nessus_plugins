...
# extracted from Debian Security Advisory DLA-1521-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1521-1 : otrs2 security update");
...
Remote deletions of arbitrary files that the OTRS web server user has
write access when opening malicious email.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/09/msg00033.html");
...
"Upgrade the affected otrs, and otrs2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-16587");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"otrs", reference:"3.3.18-1+deb8u6")) flag++;
if (deb_check(release:"8.0", prefix:"otrs2", reference:"3.3.18-1+deb8u6")) flag++;
