...
# extracted from ZTE advisory NS-SA-2023-0084. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : ruby Vulnerability (NS-SA-2023-0084)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.06, has ruby packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0084");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-28739");
...
var pkgs = {
  'CGSL MAIN 6.06': [
    'ruby-2.6.10-109.module+zncgsl6.6.0+10811+c4e2cb16',
    'ruby-libs-2.6.10-109.module+zncgsl6.6.0+10811+c4e2cb16',
    'rubygem-bigdecimal-1.4.1-109.module+zncgsl6.6.0+10811+c4e2cb16',
    'rubygem-io-console-0.4.7-109.module+zncgsl6.6.0+10811+c4e2cb16',
    'rubygem-irb-1.0.0-109.module+zncgsl6.6.0+10811+c4e2cb16',
    'rubygem-json-2.1.0-109.module+zncgsl6.6.0+10811+c4e2cb16',
    'rubygem-openssl-2.1.2-109.module+zncgsl6.6.0+10811+c4e2cb16',
    'rubygem-psych-3.1.0-109.module+zncgsl6.6.0+10811+c4e2cb16',
    'rubygem-rdoc-6.1.2.1-109.module+zncgsl6.6.0+10811+c4e2cb16',
    'rubygems-3.0.3.1-109.module+zncgsl6.6.0+10811+c4e2cb16'
  ]
};
