...
# extracted from Red Hat Security Advisory RHSA-2023:5866. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5866");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");
  script_xref(name:"IAVB", value:"2023-B-0083-S");

  script_name(english:"RHEL 9 : grafana (RHSA-2023:5866)");
...
referenced in the RHSA-2023:5866 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5866.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f20341ed");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5866");
...
"Update the RHEL grafana package based on the guidance in RHSA-2023:5866.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-7.5.11-6.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
