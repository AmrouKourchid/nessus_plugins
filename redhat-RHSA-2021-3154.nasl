...
# extracted from Red Hat Security Advisory RHSA-2021:3154. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3154");
  script_xref(name:"IAVA", value:"2021-A-0366-S");

  script_name(english:"RHEL 7 : firefox (RHSA-2021:3154)");
...
referenced in the RHSA-2021:3154 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3154.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1b71d720");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3154");
...
"Update the RHEL firefox package based on the guidance in RHSA-2021:3154.");
  ...
  script_cwe_id(119, 120, 367, 416, 908);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-78.13.0-2.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-78.13.0-2.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-78.13.0-2.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-78.13.0-2.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-78.13.0-2.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
