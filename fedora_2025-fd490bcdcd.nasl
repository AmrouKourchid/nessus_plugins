...
# extracted from Fedora Security Advisory FEDORA-2025-fd490bcdcd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-fd490bcdcd");

  script_name(english:"Fedora 40 : xorg-x11-server (2025-fd490bcdcd)");
...
FEDORA-2025-fd490bcdcd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-fd490bcdcd");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-37.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
