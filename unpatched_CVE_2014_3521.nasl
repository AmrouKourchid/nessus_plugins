...
if (description)
{
  ...
  script_cve_id("CVE-2014-3521");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-3521");
...
patch available.
  ...
  - The component in (1) /luci/homebase and (2) /luci/cluster menu in Red Hat Conga 0.12.2 allows remote
    authenticated users to bypass intended access restrictions via a crafted URL. (CVE-2014-3521)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3521");
