...
"The remote Red Hat host is missing one or more security updates for python-twisted-web.");
...
referenced in the RHSA-2020:1561 advisory.
    ...
    * python-twisted: HTTP request smuggling when presented with a Content-Length and a chunked Transfer-
    Encoding header (CVE-2020-10109)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1561.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4180183d");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1813447");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-twisted-web package based on the guidance in RHSA-2020:1561.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-twisted-web-12.1.0-7.el7_8', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-twisted-web-12.1.0-7.el7_8', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-twisted-web-12.1.0-7.el7_8', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-twisted-web-12.1.0-7.el7_8', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
