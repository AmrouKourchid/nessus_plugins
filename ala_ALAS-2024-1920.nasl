...
# extracted from Amazon Linux AMI Security Advisory ALAS-2024-1920.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : amazon-ssm-agent (ALAS-2024-1920)");
...
multiple vulnerabilities as referenced in the ALAS-2024-1920 advisory.

    2024-04-25: CVE-2023-49568 was added to this advisory.

    2024-02-28: CVE-2023-39325 was added to this advisory.

    2024-02-28: CVE-2023-39326 was added to this advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2024-1920.html");
...
var pkgs = [
    {'reference':'amazon-ssm-agent-3.2.2222.0-1.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ssm-agent-debuginfo-3.2.2222.0-1.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
