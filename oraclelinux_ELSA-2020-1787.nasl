...
# extracted from Oracle Linux Security Advisory ELSA-2020-1787.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : unzip (ELSA-2020-1787)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1787.html");
...
var pkgs = [
    {'reference':'unzip-6.0-43.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'unzip-6.0-43.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
