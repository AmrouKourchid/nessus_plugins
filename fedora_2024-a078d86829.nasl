...
# extracted from Fedora Security Advisory FEDORA-2024-a078d86829
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a078d86829");

  script_name(english:"Fedora 41 : thunderbird (2024-a078d86829)");
...
FEDORA-2024-a078d86829 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a078d86829");
...
var pkgs = [
    {'reference':'thunderbird-128.3.3-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
