...
# extracted from Red Hat Security Advisory RHSA-2022:8384. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8384");

  script_name(english:"RHEL 9 : harfbuzz (RHSA-2022:8384)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for harfbuzz.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8384.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86da0b7c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8384");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2102608");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL harfbuzz package based on the guidance in RHSA-2022:8384.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'harfbuzz-2.7.4-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'harfbuzz-devel-2.7.4-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'harfbuzz-icu-2.7.4-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
