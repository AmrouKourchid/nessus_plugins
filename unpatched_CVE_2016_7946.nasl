...
if (description)
{
  ...
  script_cve_id("CVE-2016-7946");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-7946");
...
patch available.
  ...
  - X.org libXi before 1.7.7 allows remote X servers to cause a denial of service (infinite loop) via vectors
