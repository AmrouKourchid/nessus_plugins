...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : cloud-init (EulerOS-SA-2022-1058)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1058
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?45bfee49");
...
var pkgs = [
  "cloud-init-17.1-7.h17.eulerosv2r8"
];
