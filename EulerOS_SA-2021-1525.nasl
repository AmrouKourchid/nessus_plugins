...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : vim (EulerOS-SA-2021-1525)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1525
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38402bb9");
...
"Update the affected vim package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-11109");
...
pkgs = ["vim-X11-7.4.160-4.h11.eulerosv2r7",
        "vim-common-7.4.160-4.h11.eulerosv2r7",
        "vim-enhanced-7.4.160-4.h11.eulerosv2r7",
        "vim-filesystem-7.4.160-4.h11.eulerosv2r7",
        "vim-minimal-7.4.160-4.h11.eulerosv2r7"];
