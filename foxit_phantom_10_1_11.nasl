...
if (description)
{
  ...
  script_name(english:"Foxit PhantomPDF < 10.1.11 Multiple Vulnerabilities");
...
host is prior to 10.1.11. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PhantomPDF version 10.1.11 or later");
...
var constraints = [
  { 'max_version' : '10.1.10.37854', 'fixed_version' : '10.1.11' }
];
