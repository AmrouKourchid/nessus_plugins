...
if (description)
{
  ...
  script_name(english:"Debian dla-3309 : graphite-web - security update");
...
number.");
  # https://security-tracker.debian.org/tracker/source-package/graphite-web
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3baae2c6");
