...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1289.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1289");

  script_name(english:"Amazon Linux 2 : glib2 (ALAS-2019-1289)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"file_copy_fallback in gio/gfile.c in GNOME GLib 2.56.1 does not
properly restrict file permissions while a copy operation is in
progress. Instead, default permissions are used. (CVE-2019-12450)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1289.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"glib2-2.56.1-4.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"glib2-debuginfo-2.56.1-4.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"glib2-devel-2.56.1-4.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"glib2-doc-2.56.1-4.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"glib2-fam-2.56.1-4.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"glib2-static-2.56.1-4.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"glib2-tests-2.56.1-4.amzn2")) flag++;
