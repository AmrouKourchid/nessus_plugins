...
# extracted from Fedora Security Advisory FEDORA-2025-4c65803ea6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-4c65803ea6");

  script_name(english:"Fedora 40 : chromium (2025-4c65803ea6)");
...
FEDORA-2025-4c65803ea6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-4c65803ea6");
...
var pkgs = [
    {'reference':'chromium-132.0.6834.83-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
