...
if (description)
{
  ...
  script_name(english:"CentOS 9 : gdk-pixbuf2-2.42.6-3.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for gdk-pixbuf2.");
...
gdk-pixbuf2-2.42.6-3.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=25529");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream gdk-pixbuf2 package.");
...
var pkgs = [
    ...
    {'reference':'gdk-pixbuf2-tests-2.42.6-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
