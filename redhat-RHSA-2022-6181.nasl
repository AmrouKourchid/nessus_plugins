...
# extracted from Red Hat Security Advisory RHSA-2022:6181. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6181");

  script_name(english:"RHEL 9 : rsync (RHSA-2022:6181)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6181.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91fe1e9b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6181");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2110928");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rsync package based on the guidance in RHSA-2022:6181.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rsync-3.2.3-9.el9_0.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
  ...
  },
  {
    ...
    'pkgs': [
      {'reference':'rsync-3.2.3-9.el9_0.2', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsync-daemon-3.2.3-9.el9_0.2', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
