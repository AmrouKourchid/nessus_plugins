...
# extracted from Red Hat Security Advisory RHSA-2024:11238. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:11238");

  script_name(english:"RHEL 9 : python3.11-urllib3 (RHSA-2024:11238)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python3.11-urllib3.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_11238.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?95daef06");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11238");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11-urllib3 package based on the guidance in RHSA-2024:11238.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-urllib3-1.26.12-2.el9_5.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3.11-urllib3');
}
