...
# AlmaLinux Security Advisory ALSA-2023:7879.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:7879");

  script_name(english:"AlmaLinux 9 : opensc (ALSA-2023:7879)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-7879.html");
...
"Update the affected opensc package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:opensc");
