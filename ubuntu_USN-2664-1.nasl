...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Linux kernel (Utopic HWE) vulnerabilities (USN-2664-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2664-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.16.0-43-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.16.0-43-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.16.0-43-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.16.0-43-powerpc-e500mc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.16.0-43-powerpc-smp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.16.0-43-powerpc64-emb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.16.0-43-powerpc64-smp");
...
var kernel_mappings = {
  '14.04': {
    '3.16.0': {
      'generic': '3.16.0-43',
      'generic-lpae': '3.16.0-43',
      'lowlatency': '3.16.0-43',
      'powerpc-e500mc': '3.16.0-43',
      'powerpc-smp': '3.16.0-43',
      'powerpc64-emb': '3.16.0-43',
      'powerpc64-smp': '3.16.0-43'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-2664-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2015-1420', 'CVE-2015-4001', 'CVE-2015-4002', 'CVE-2015-4003', 'CVE-2015-4167', 'CVE-2015-4700', 'CVE-2015-5706');
