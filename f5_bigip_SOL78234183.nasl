...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Linux SACK Panic vulnerability (K78234183)");
...
service by sending a sequence of specially crafted TCP SACK packets.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K78234183");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K78234183.");
