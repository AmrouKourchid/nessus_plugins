...
# extracted from openSUSE Security Update openSUSE-2020-779.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : GraphicsMagick (openSUSE-2020-779)");
...
"This update for GraphicsMagick fixes the following issues :
  ...
  - CVE-2020-12672: heap-based buffer overflow in
    ReadMNGImage in coders/png.c. (boo#1171271)");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1171271");
...
if ( rpm_check(release:"SUSE15.1", reference:"GraphicsMagick-1.3.29-lp151.4.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"GraphicsMagick-debuginfo-1.3.29-lp151.4.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"GraphicsMagick-debugsource-1.3.29-lp151.4.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"GraphicsMagick-devel-1.3.29-lp151.4.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagick++-Q16-12-1.3.29-lp151.4.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagick++-Q16-12-debuginfo-1.3.29-lp151.4.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagick++-devel-1.3.29-lp151.4.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagick-Q16-3-1.3.29-lp151.4.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagick-Q16-3-debuginfo-1.3.29-lp151.4.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagick3-config-1.3.29-lp151.4.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagickWand-Q16-2-1.3.29-lp151.4.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagickWand-Q16-2-debuginfo-1.3.29-lp151.4.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"perl-GraphicsMagick-1.3.29-lp151.4.20.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"perl-GraphicsMagick-debuginfo-1.3.29-lp151.4.20.1") ) flag++;
