...
if (description)
{
  ...
  script_cve_id("CVE-2018-10935", "CVE-2018-14648");

  script_name(english:"Scientific Linux Security Update : 389-ds-base on SL7.x x86_64 (20181030)");
...
"Security Fix(es) :
  ...
  - 389-ds-base: Mishandled search requests in
    servers/slapd/search.c:do_search() allows for denial of
    service (CVE-2018-14648)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1811&L=scientific-linux-errata&F=&S=&P=5820
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1ea6cff0");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"389-ds-base-1.3.8.4-15.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"389-ds-base-debuginfo-1.3.8.4-15.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"389-ds-base-devel-1.3.8.4-15.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"389-ds-base-libs-1.3.8.4-15.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"389-ds-base-snmp-1.3.8.4-15.el7")) flag++;
