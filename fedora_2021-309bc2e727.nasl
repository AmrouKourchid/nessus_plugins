...
# extracted from Fedora Security Advisory FEDORA-2021-309bc2e727
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-309bc2e727");

  script_name(english:"Fedora 32 : mingw-python3 (2021-309bc2e727)");
...
FEDORA-2021-309bc2e727 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-309bc2e727");
...
pkgs = [
    {'reference':'mingw-python3-3.8.8-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
