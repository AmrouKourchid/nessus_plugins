...
# extracted from SUSE update advisory SUSE-SU-2021:0673-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : nodejs10 (SUSE-SU-2021:0673-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9bcdb6d");
...
zypper in -t patch SUSE-SLE-Module-Web-Scripting-12-2021-673=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs10-10.24.0-1.36.2")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs10-debuginfo-10.24.0-1.36.2")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs10-debugsource-10.24.0-1.36.2")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs10-devel-10.24.0-1.36.2")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"npm10-10.24.0-1.36.2")) flag++;
