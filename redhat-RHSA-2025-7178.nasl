...
# extracted from Red Hat Security Advisory RHSA-2025:7178. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7178");

  script_name(english:"RHEL 9 : gstreamer1, gstreamer1-plugins-bad-free, gstreamer1-plugins-ugly-free, and gstreamer1-rtsp-server (RHSA-2025:7178)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for gstreamer1 / gstreamer1-plugins-bad-free /
gstreamer1-plugins-ugly-free / gstreamer1-rtsp-server.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:7178 advisory.

    The gstreamer1 packages contain a streaming media framework, based on graphs of filters which operate on
    media data.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2292335");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7178.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b0e16be1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7178");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gstreamer1 / gstreamer1-plugins-bad-free / gstreamer1-plugins-ugly-free / gstreamer1-rtsp-server
packages based on the guidance in RHSA-2025:7178.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-1.22.12-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-devel-1.22.12-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gstreamer1 / gstreamer1-devel');
}
