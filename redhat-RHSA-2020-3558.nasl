...
# extracted from Red Hat Security Advisory RHSA-2020:3558. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:3558");
  script_xref(name:"IAVA", value:"2020-A-0391-S");

  script_name(english:"RHEL 6 : firefox (RHSA-2020:3558)");
...
referenced in the RHSA-2020:3558 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3558.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a46cb913");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3558");
...
"Update the RHEL firefox package based on the guidance in RHSA-2020:3558.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-68.12.0-1.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.12.0-1.el6_10', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.12.0-1.el6_10', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.12.0-1.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
