...
var constraints = [
    {'max_version' : '1.0', 'fixed_version' : '1.1', 'plugin' : 'Agent Server Parameter Plugin'},
    {'max_version' : '1.15', 'fixed_version' : '1.16', 'plugin' : 'autonomiq Plugin'},
    {'max_version' : '2022.1.2', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Checkmarx Plugin'},
    {'max_version' : '1.20', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Chef Sinatra Plugin'},
    {'max_version' : '1.0.11', 'fixed_version' : '1.0.12', 'plugin' : 'Conjur Secrets Plugin'},
    {'max_version' : '1.1', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Convertigo Mobile Platform Plugin'},
    {'max_version' : '1.1', 'fixed_version' : '1.2', 'plugin' : 'Custom Checkbox Parameter Plugin'},
    {'max_version' : '0.5.2', 'fixed_display' : 'See vendor advisory', 'plugin' : 'dbCharts Plugin'},
    {'max_version' : '0.4.1', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Doktor Plugin'},
    {'max_version' : '20.2.34', 'fixed_version' : '20.2.35', 'plugin' : 'Fortify Plugin'},
    {'max_version' : '1.81', 'fixed_version' : '1.82', 'plugin' : 'Generic Webhook Trigger Plugin'},
    {'max_version' : '1.13', 'fixed_display' : 'See vendor advisory', 'plugin' : 'GitLab Authentication Plugin'},
    {'min_version' : '3.8.0', 'fixed_version' : '336', 'fixed_display' : '336.v182c0fbaaeb7', 'plugin' : 'HashiCorp Vault Plugin'},
    {'max_version' : '2.15', 'fixed_version' : '2.15.1', 'plugin' : 'Pipeline: Build Step Plugin'},
    ...
    {'max_version' : '552', 'fixed_version' : '561', 'fixed_display' : '561.va_ce0de3c2d69', 'plugin' : 'Pipeline: Deprecated Groovy Libraries Plugin'},
    {'max_version' : '552', 'fixed_version' : '561', 'fixed_display' : '561.va_ce0de3c2d69', 'plugin' : 'Pipeline: Shared Groovy Libraries Plugin'},
    {'max_version' : '2648', 'fixed_version' : '2656', 'fixed_display' : '2656.vf7a_e7b_75a_457', 'plugin' : 'Pipeline: Groovy Plugin'},
    {'max_version' : '706', 'fixed_version' : '707', 'fixed_display' : '707.v71c3f0a_6ccdb_', 'plugin' : 'Pipeline: Multibranch Plugin'},
    {'max_version' : '1.9', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Promoted Builds (Simple) Plugin'},
    {'max_version' : '1.8', 'fixed_display' : 'See vendor advisory', 'plugin' : 'SCP publisher Plugin'},
    # Advisory lists 2.0 as both affected and fixed
    {'max_version' : '2.0', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Snow Commander Plugin'},
    {'max_version' : '2.79', 'fixed_version' : '2.79.1', 'plugin' : 'Support Core Plugin'},
    {'max_version' : '1.2.6', 'fixed_display' : 'See vendor advisory', 'plugin' : 'SWAMP Plugin'},
    {'max_version' : '0.9.0', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Team Views Plugin'}
];
