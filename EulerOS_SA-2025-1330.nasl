...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP13 : curl (EulerOS-SA-2025-1330)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1330
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37618e87");
...
var pkgs = [
  "curl-7.79.1-25.h10.eulerosv2r13",
  "libcurl-7.79.1-25.h10.eulerosv2r13"
];
