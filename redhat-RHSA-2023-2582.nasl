...
# extracted from Red Hat Security Advisory RHSA-2023:2582. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-28805");
  script_xref(name:"RHSA", value:"2023:2582");

  script_name(english:"RHEL 9 : lua (RHSA-2023:2582)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2582.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3b9819c2");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecefa061");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2073884");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2582");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL lua package based on the guidance in RHSA-2023:2582.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lua-5.4.4-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lua-devel-5.4.4-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lua-libs-5.4.4-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
