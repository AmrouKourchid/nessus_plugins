...
# extracted from Red Hat Security Advisory RHSA-2020:2828 and 
# Oracle Linux Security Advisory ELSA-2020-2828 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : firefox (ELSA-2020-2828)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-2828.html");
...
var pkgs = [
    {'reference':'firefox-68.10.0-1.0.1.el8_2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
