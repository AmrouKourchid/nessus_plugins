...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2972621");
...
the affected service.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e1356bab");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-2814");
  ...
  script_require_keys("installed_sw/Microsoft Service Bus for Windows Server");
...
var appname = 'Microsoft Service Bus for Windows Server';

var bulletin = 'MS14-042';
var kb = '2972621';
var version = UNKNOWN_VER;
var path, info;

var kbs = make_list(kb);
...
var install = get_installs(app_name:appname);
