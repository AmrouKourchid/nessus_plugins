...
if (description)
{
  ...
  script_cve_id("CVE-2015-1865");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-1865");
...
patch available.
  ...
  - fts.c in coreutils 8.4 allows local users to delete arbitrary files. (CVE-2015-1865)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-1865");
