...
# extracted from Red Hat Security Advisory RHSA-2024:3017. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3017");

  script_name(english:"RHEL 8 : edk2 (RHSA-2024:3017)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for edk2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:3017 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-12626");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3017.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?51157b19");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3017");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL edk2 package based on the guidance in RHSA-2024:3017.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'edk2-aarch64-20220126gitbb1bba3d77-13.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'edk2-ovmf-20220126gitbb1bba3d77-13.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
