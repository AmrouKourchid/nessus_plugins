...
# extracted from Red Hat Security Advisory RHSA-2019:2775. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2775");
  script_xref(name:"CEA-ID", value:"CEA-2019-0643");

  script_name(english:"RHEL 7 : rh-nginx114-nginx (RHSA-2019:2775)");
...
referenced in the RHSA-2019:2775 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2775.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3204f23a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2775");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-nginx114-nginx package based on the guidance in RHSA-2019:2775.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nginx114-nginx-1.14.1-1.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx114-nginx-mod-http-image-filter-1.14.1-1.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx114-nginx-mod-http-perl-1.14.1-1.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx114-nginx-mod-http-xslt-filter-1.14.1-1.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx114-nginx-mod-mail-1.14.1-1.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-nginx114-nginx-mod-stream-1.14.1-1.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
