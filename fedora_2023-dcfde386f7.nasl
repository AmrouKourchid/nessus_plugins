...
# extracted from Fedora Security Advisory FEDORA-2023-dcfde386f7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dcfde386f7");

  script_name(english:"Fedora 37 : thunderbird (2023-dcfde386f7)");
...
FEDORA-2023-dcfde386f7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dcfde386f7");
...
var pkgs = [
    {'reference':'thunderbird-102.12.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
