...
if (description)
{
  ...
  script_name(english:"AIX : Multiple Vulnerabilities (IJ53929)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ53929. It is, therefore, affected by multiple
vulnerabilities as referenced in the IJ53929 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ53929");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ53929.");
...
var constraints = [
    {'release': '7.3', 'ml': '01', 'sp': '03', 'patch': '(IJ53929m3a|IJ53929m3b)', 'package': 'bos.sysmgt.nim.client', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.3'},
    {'release': '7.3', 'ml': '01', 'sp': '03', 'patch': '(IJ53929m3a|IJ53929m3b)', 'package': 'bos.sysmgt.nim.master', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.3'},
    {'release': '7.3', 'ml': '01', 'sp': '03', 'patch': '(IJ53929m3a|IJ53929m3b)', 'package': 'bos.sysmgt.sysbr', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.3'},
    {'release': '7.3', 'ml': '01', 'sp': '04', 'patch': '(IJ53929m4a|IJ53929m4b)', 'package': 'bos.sysmgt.nim.client', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.3'},
    {'release': '7.3', 'ml': '01', 'sp': '04', 'patch': '(IJ53929m4a|IJ53929m4b)', 'package': 'bos.sysmgt.nim.master', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.3'},
    {'release': '7.3', 'ml': '01', 'sp': '04', 'patch': '(IJ53929m4a|IJ53929m4b)', 'package': 'bos.sysmgt.sysbr', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.3'}
];
