...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2023-A-0228-S");

  script_name(english:"Foxit PDF Reader < 12.1.2 Multiple Vulnerabilities");
...
var constraints = [
  { 'max_version' : '12.1.1.15289', 'fixed_version' : '12.1.2' }
];
