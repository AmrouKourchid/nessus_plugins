...
# extracted from Fedora Security Advisory FEDORA-2024-da73f3fc92
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-da73f3fc92");

  script_name(english:"Fedora 39 : dotnet6.0 (2024-da73f3fc92)");
...
FEDORA-2024-da73f3fc92 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-da73f3fc92");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.126-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
