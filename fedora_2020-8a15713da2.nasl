...
# extracted from Fedora Security Advisory FEDORA-2020-8a15713da2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : cacti / cacti-spine (2020-8a15713da2)");
...
Release notes: https://www.cacti.net/release_notes.php?version=1.2.13

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-8a15713da2");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"cacti-1.2.13-1.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"cacti-spine-1.2.13-1.fc32")) flag++;
