...
if (description)
{
  ...
  script_name(english:"RHEL 8 : OpenShift Container Platform 4.13.25 (RHSA-2023:7606)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.13.25.");
...
the RHSA-2023:7606 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.13.25. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7606.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d3b8e5ff");
...
"Update the RHEL OpenShift Container Platform 4.13.25 packages based on the guidance in RHSA-2023:7606.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy22-2.2.24-4.rhaos4.13.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
