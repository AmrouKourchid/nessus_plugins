...
# extracted from Oracle Linux Security Advisory ELSA-2022-7968.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : virt-v2v (ELSA-2022-7968)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-7968.html");
...
var pkgs = [
    {'reference':'virt-v2v-2.0.7-6.0.1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'virt-v2v-bash-completion-2.0.7-6.0.1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'virt-v2v-man-pages-ja-2.0.7-6.0.1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'virt-v2v-man-pages-uk-2.0.7-6.0.1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
