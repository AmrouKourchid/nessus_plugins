...
# extracted from Fedora Security Advisory FEDORA-2022-05bdce3585
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-05bdce3585");

  script_name(english:"Fedora 36 : thunderbird (2022-05bdce3585)");
...
FEDORA-2022-05bdce3585 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-05bdce3585");
...
var pkgs = [
    {'reference':'thunderbird-102.5.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
