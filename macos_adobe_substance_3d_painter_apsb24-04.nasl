...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2024-B-0011-S");

  script_name(english:"Adobe Substance 3D Painter < 9.1.2 Multiple Vulnerabilities (APSB24-04) (macOS)");
...
"The version of Adobe Substance 3D Painter installed on the remote macOS host is prior to 9.1.2. It is, therefore,
affected by multiple vulnerabilities as referenced in the APSB24-04 advisory. Successful exploitation could lead to 
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a43e42fb");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe Substance 3D Painter 9.1.2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-20744");
