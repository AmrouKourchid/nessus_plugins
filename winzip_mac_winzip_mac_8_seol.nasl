...
if (description)
{
  ...
  script_name(english:"Winzip for Mac SEoL (8.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Winzip For Mac is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Winzip For Mac is 8.0.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of Winzip For Mac that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2023/11/07");
...
var constraints = [
  { max_branch : '8.0', min_branch : '8.0', seol : 20231107 }
];
