...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : rsyslog (EulerOS-SA-2019-1243)");
...
the following vulnerability :
  ...
  - A denial of service vulnerability was found in rsyslog
    ...
    would cause rsyslog to crash.i1/4^CVE-2018-16881i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1243
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2c52267e");
...
pkgs = ["rsyslog-8.24.0-12.h18.x86_64.com",
        "rsyslog-mmjsonparse-8.24.0-12.h18.x86_64.com"];
