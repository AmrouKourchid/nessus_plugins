...
# extracted from Fedora Security Advisory FEDORA-2024-b73e44fe9d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b73e44fe9d");

  script_name(english:"Fedora 39 : wolfssl (2024-b73e44fe9d)");
...
FEDORA-2024-b73e44fe9d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b73e44fe9d");
...
var pkgs = [
    {'reference':'wolfssl-5.7.2-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
