...
# extracted from Fedora Security Advisory FEDORA-2022-f0980dffd1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f0980dffd1");

  script_name(english:"Fedora 36 : sfnt2woff-zopfli (2022-f0980dffd1)");
...
FEDORA-2022-f0980dffd1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f0980dffd1");
...
var pkgs = [
    {'reference':'sfnt2woff-zopfli-1.3.1-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
