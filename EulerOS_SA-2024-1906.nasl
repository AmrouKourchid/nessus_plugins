...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : git (EulerOS-SA-2024-1906)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1906
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aaa527fd");
...
var pkgs = [
  "git-2.27.0-2.h15.r1.eulerosv2r10",
  "git-help-2.27.0-2.h15.r1.eulerosv2r10"
];
