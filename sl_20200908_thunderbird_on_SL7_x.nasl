...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL7.x x86_64 (20200908)");
...
"Security Fix(es) :
  ...
  - Mozilla: Use-After-Free when aborting an operation
    (CVE-2020-15669)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2009&L=SCIENTIFIC-LINUX-ERRATA&P=2686
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?972cf16b");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"thunderbird-68.12.0-1.el7_8", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"thunderbird-debuginfo-68.12.0-1.el7_8", allowmaj:TRUE)) flag++;
