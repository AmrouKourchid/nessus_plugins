...
"The remote Red Hat host is missing one or more security updates for mod_auth_mellon.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2019:0766 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0766.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9192fe47");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1697487");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_auth_mellon package based on the guidance in RHSA-2019:0766.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_auth_mellon-0.14.0-2.el7_6.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_mellon-diagnostics-0.14.0-2.el7_6.4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
