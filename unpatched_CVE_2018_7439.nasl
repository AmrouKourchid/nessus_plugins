...
if (description)
{
  ...
  script_cve_id("CVE-2018-7439");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-7439");
...
patch available.
  ...
  - An issue was discovered in FreeXL before 1.0.5. There is a heap-based buffer over-read in the function
    read_mini_biff_next_record. (CVE-2018-7439)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-7439");
