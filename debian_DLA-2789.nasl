...
# extracted from Debian Security Advisory dla-2789. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2789-1 : squashfs-tools - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2789
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2789");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'squashfs-tools', 'reference': '1:4.3-3+deb9u3'},
    {'release': '9.0', 'prefix': 'squashfs-tools-dbg', 'reference': '1:4.3-3+deb9u3'}
];
