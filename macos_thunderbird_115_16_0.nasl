...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 115.16.0. It is, therefore,
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'115.16.0', min:'115.0.0', severity:SECURITY_HOLE);
