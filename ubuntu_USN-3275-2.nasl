...
the USN-3275-2 advisory.

    USN-3275-1 fixed vulnerabilities in OpenJDK 8. This update provides the corresponding updates for OpenJDK
    7.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3275-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'icedtea-7-jre-jamvm', 'pkgver': '7u131-2.6.9-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-demo', 'pkgver': '7u131-2.6.9-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jdk', 'pkgver': '7u131-2.6.9-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre', 'pkgver': '7u131-2.6.9-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-headless', 'pkgver': '7u131-2.6.9-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-lib', 'pkgver': '7u131-2.6.9-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-zero', 'pkgver': '7u131-2.6.9-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-source', 'pkgver': '7u131-2.6.9-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-tests', 'pkgver': '7u131-2.6.9-0ubuntu0.14.04.1'}
];
