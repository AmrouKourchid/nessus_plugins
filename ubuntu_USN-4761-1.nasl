...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Git vulnerability (USN-4761-1)");
...
referenced in the USN-4761-1 advisory.

    Matheus Tavares discovered that Git incorrectly handled delay-capable clean/smudge filters when being used
    on case-insensitive filesystems. A remote attacker could possibly use this issue to execute arbitrary
    code.
