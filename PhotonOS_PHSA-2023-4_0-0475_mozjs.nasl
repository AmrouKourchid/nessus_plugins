...
# extracted from VMware Security Advisory PHSA-2023-4.0-0475. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-43539", "CVE-2022-42928");

  script_name(english:"Photon OS 4.0: Mozjs PHSA-2023-4.0-0475");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the mozjs package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-475.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'mozjs-78.15.0-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'mozjs-devel-78.15.0-2.ph4')) flag++;
