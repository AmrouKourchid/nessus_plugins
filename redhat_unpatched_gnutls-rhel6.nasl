...
# extracted from Red Hat Security Advisory gnutls. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : gnutls (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-10845");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw32-gnutls");
