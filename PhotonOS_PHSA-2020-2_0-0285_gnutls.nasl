...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Gnutls PHSA-2020-2.0-0285");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'gnutls-3.5.15-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'gnutls-devel-3.5.15-5.ph2')) flag++;
