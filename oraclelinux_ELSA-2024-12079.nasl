...
# extracted from Oracle Linux Security Advisory ELSA-2024-12079.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 / 9 : python-cryptography (ELSA-2024-12079)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-12079.html");
...
"Update the affected python3-cryptography package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python3-cryptography");
...
var pkgs = [
    {'reference':'python3-cryptography-3.2.1-6.0.1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-cryptography-3.2.1-6.0.1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-cryptography-36.0.1-4.0.1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-cryptography-36.0.1-4.0.1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
