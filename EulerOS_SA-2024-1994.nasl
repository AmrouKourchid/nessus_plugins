...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : unbound (EulerOS-SA-2024-1994)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1994
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?821be939");
...
var pkgs = [
  "python3-unbound-1.11.0-2.h8.eulerosv2r10",
  "unbound-1.11.0-2.h8.eulerosv2r10",
  "unbound-libs-1.11.0-2.h8.eulerosv2r10"
];
