...
if (description)
{
  ...
  script_name(english:"Adobe InDesign < 18.5.1 / 19.0 < 19.1.0 Multiple Vulnerabilities (APSB23-70)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe InDesign instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe InDesign installed on the remote Windows host is prior to 18.5.1, 19.1.0. It is, therefore,
affected by multiple vulnerabilities as referenced in the APSB23-70 advisory.
