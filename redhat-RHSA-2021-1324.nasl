...
"The remote Red Hat host is missing one or more security updates for Red Hat OpenShift Service Mesh 2.0.3.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1324.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a0597fee");
...
"Update the RHEL Red Hat OpenShift Service Mesh 2.0.3 package based on the guidance in RHSA-2021:1324.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'servicemesh-proxy-2.0.3-1.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh-'},
