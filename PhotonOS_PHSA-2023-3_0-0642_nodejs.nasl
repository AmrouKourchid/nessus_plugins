...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Nodejs PHSA-2023-3.0-0642");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nodejs-16.20.2-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nodejs-devel-16.20.2-1.ph3')) flag++;
