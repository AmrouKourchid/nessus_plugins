...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : gnupg2 on SL6.x i386/x86_64 (20180712)");
...
"Security Fix(es) :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?44d79a95");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"gnupg2-2.0.14-9.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"gnupg2-debuginfo-2.0.14-9.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"gnupg2-smime-2.0.14-9.el6_10")) flag++;
