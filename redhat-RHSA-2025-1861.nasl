...
# extracted from Red Hat Security Advisory RHSA-2025:1861. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-9902", "CVE-2024-56201", "CVE-2024-56326");
  script_xref(name:"RHSA", value:"2025:1861");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1.4 (openstack-ansible-core) (RHSA-2025:1861)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 17.1.4 (openstack-
ansible-core).");
...
referenced in the RHSA-2025:1861 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1861.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc8e363a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1861");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1.4 (openstack-ansible-core) package based on the guidance in
RHSA-2025:1861.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:openstack-ansible-core");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-ansible-core-2.14.2-4.6.el9ost', 'cpu':'x86_64', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openstack-ansible-core');
}
