...
# extracted from Red Hat Security Advisory RHSA-2023:5597. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5597");

  script_name(english:"RHEL 9 : libqb (RHSA-2023:5597)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5597.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?605c0803");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2230708");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5597");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libqb package based on the guidance in RHSA-2023:5597.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libqb-2.0.3-12.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libqb-devel-2.0.3-12.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
