...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : JUnit 4 vulnerability (USN-4731-1)");
...
referenced in the USN-4731-1 advisory.

    It was discovered that JUnit 4 contains a local information disclosure vulnerability. An attacker could
