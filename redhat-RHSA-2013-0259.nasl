...
# extracted from Red Hat Security Advisory RHSA-2013:0259. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:0259");

  script_name(english:"RHEL 5 / 6 : JBoss Enterprise Web Platform 5.2.0 (RHSA-2013:0259)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for JBoss Enterprise Web Platform 5.2.0.");
...
referenced in the RHSA-2013:0259 advisory.

  - jbossws-cxf, apache-cxf: SOAPAction spoofing on document literal web services (CVE-2012-3451)

  - jbossws-cxf, apache-cxf: Bypass of security constraints on WS endpoints when using WSS4JInInterceptor
    (CVE-2012-5633)
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2013/rhsa-2013_0259.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f99eaada");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0259");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL JBoss Enterprise Web Platform 5.2.0 package based on the guidance in RHSA-2013:0259.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'apache-cxf-2.2.12-10.patch_06.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'apache-cxf-2.2.12-10.patch_06.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
