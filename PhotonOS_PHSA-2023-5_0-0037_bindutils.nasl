...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Bindutils PHSA-2023-5.0-0037");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'bindutils-9.19.14-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'bindutils-devel-9.19.14-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'bindutils-libs-9.19.14-1.ph5')) flag++;
