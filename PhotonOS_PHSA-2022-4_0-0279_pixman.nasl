...
# extracted from VMware Security Advisory PHSA-2022-4.0-0279. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Pixman PHSA-2022-4.0-0279");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the pixman package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-279.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:pixman");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'pixman-0.40.0-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'pixman-devel-0.40.0-2.ph4')) flag++;
