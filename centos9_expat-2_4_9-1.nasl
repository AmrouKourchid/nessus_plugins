...
if (description)
{
  ...
  script_name(english:"CentOS 9 : expat-2.4.9-1.el9");
...
expat-2.4.9-1.el9 build changelog.

  - libexpat before 2.4.9 has a use-after-free in the doContent function in xmlparse.c. (CVE-2022-40674)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=25184");
...
var pkgs = [
    {'reference':'expat-2.4.9-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.4.9-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-static-2.4.9-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
