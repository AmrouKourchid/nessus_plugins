...
# extracted from Red Hat Security Advisory RHSA-2024:10696. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10696");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (python-werkzeug) (RHSA-2024:10696)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.2 (python-werkzeug).");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10696.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3fb2224d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10696");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2 (python-werkzeug) package based on the guidance in RHSA-2024:10696.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-werkzeug-0.14.1-13.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
