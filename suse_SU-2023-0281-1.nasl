...
# SUSE update advisory SUSE-SU-2023:0281-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0281-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 15 for SLE 15 SP3) (SUSE-SU-2023:0281-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2023:0281-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013638.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b77f06cb");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-5_3_18-150300_59_54-default, kernel-livepatch-5_3_18-150300_59_60-default and / or
kernel-livepatch-5_3_18-150300_59_63-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150300.59.54-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_54-default-16-150300.2.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      },
      '5.3.18-150300.59.60-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_60-default-15-150300.2.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      },
      '5.3.18-150300.59.63-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_63-default-12-150300.2.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
