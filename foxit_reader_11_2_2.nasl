...
if (description)
{
  ...
  script_name(english:"Foxit PDF Reader < 11.2.2 Multiple Vulnerabilities");
...
"Upgrade to Foxit PDF Reader version 11.2.2 or later");
...
var constraints = [
  { 'max_version' : '11.2.1.53537', 'fixed_version' : '11.2.2' }
];
