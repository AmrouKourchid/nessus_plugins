...
referenced in the RHSA-2023:0095 advisory.
    ...
    * libtiff: Invalid crop_width and/or crop_length could cause an out-of-bounds read in
    reverseSamples16bits() (CVE-2022-2868)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0095.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d20c6eb8");
...
"Update the RHEL libtiff package based on the guidance in RHSA-2023:0095.");
  ...
  script_cwe_id(122, 1284, 131, 369, 415, 763, 787);
