...
# extracted from Red Hat Security Advisory mingw-wavpack. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-19841", "CVE-2019-11498", "CVE-2019-1010315");

  script_name(english:"RHEL 8 : mingw-wavpack (Unpatched Vulnerability) (deprecated)");
