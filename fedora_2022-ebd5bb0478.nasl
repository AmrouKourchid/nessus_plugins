...
# extracted from Fedora Security Advisory FEDORA-2022-ebd5bb0478
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ebd5bb0478");

  script_name(english:"Fedora 36 : exim (2022-ebd5bb0478)");
...
FEDORA-2022-ebd5bb0478 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ebd5bb0478");
...
var pkgs = [
    {'reference':'exim-4.96-5.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
