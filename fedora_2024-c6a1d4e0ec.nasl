...
# extracted from Fedora Security Advisory FEDORA-2024-c6a1d4e0ec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c6a1d4e0ec");
  script_xref(name:"IAVA", value:"2024-A-0245-S");

  script_name(english:"Fedora 40 : firefox (2024-c6a1d4e0ec)");
...
FEDORA-2024-c6a1d4e0ec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c6a1d4e0ec");
...
var pkgs = [
    {'reference':'firefox-125.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
