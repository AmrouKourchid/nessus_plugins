...
"The version of Thunderbird installed on the remote Windows host is prior to 115.5. It is, therefore, affected by
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'115.5', severity:SECURITY_HOLE);
