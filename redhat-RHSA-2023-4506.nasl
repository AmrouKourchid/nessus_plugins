...
# extracted from Red Hat Security Advisory RHSA-2023:4506. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4506");

  script_name(english:"RHEL 8 : Red Hat JBoss Enterprise Application Platform (RHSA-2023:4506)");
...
referenced in the RHSA-2023:4506 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4506.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c7bb98c0");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/JBEAP-24721");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4506");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat JBoss Enterprise Application Platform package based on the guidance in RHSA-2023:4506.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-jettison-1.5.4-1.redhat_00002.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2023-1436']},
      {'reference':'eap7-undertow-2.2.25-3.SP3_redhat_00001.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2023-3223']},
      {'reference':'eap7-wildfly-7.4.12-3.GA_redhat_00003.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2021-46877']},
      {'reference':'eap7-wildfly-java-jdk11-7.4.12-3.GA_redhat_00003.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2021-46877']},
      {'reference':'eap7-wildfly-java-jdk17-7.4.12-3.GA_redhat_00003.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2021-46877']},
      {'reference':'eap7-wildfly-java-jdk8-7.4.12-3.GA_redhat_00003.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2021-46877']},
      {'reference':'eap7-wildfly-javadocs-7.4.12-3.GA_redhat_00003.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2021-46877']},
      {'reference':'eap7-wildfly-modules-7.4.12-3.GA_redhat_00003.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2021-46877']}
    ]
  }
];
