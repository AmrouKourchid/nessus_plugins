...
if (description)
{
  ...
  script_cve_id("CVE-2014-9843");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-9843");
...
patch available.
  ...
  - The DecodePSDPixels function in coders/psd.c in ImageMagick 6.8.9.9 allows remote attackers to have
    unspecified impact via unknown vectors. (CVE-2014-9843)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9843");
