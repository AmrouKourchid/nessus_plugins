...
if (description)
{
  ...
  script_cve_id("CVE-2024-43602");
  script_xref(name:"IAVA", value:"0001-A-0731");
  script_xref(name:"IAVA", value:"2024-A-0731");

  script_name(english:"Security Updates for Azure CycleCloud (November 2024)");
...
"The Azure CycleCloud product is missing security updates. It is, therefore, affected by the following vulnerability:
  ...
  - A remote code execution vulnerability exists due to a disclosure of the storage credentials. An
    ...
    with root privileges. (CVE-2024-43602)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported 
version number.");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-43602");
  # https://learn.microsoft.com/en-us/azure/cyclecloud/how-to/upgrade-and-migrate?view=cyclecloud-8
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e6e40abc");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released CycleCloud version 8.6.5 to address this issue");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:C/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-43602");
...
var constraints = [
  {'min_version': '8.0.0', 'fixed_version': '8.6.5'}
];
