...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : fribidi (EulerOS-SA-2020-1149)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the fribidi packages installed, the
...
vulnerability :
  ...
  - A buffer overflow in the
    ...
    content to a user, when this content is then rendered
    by an application that uses FriBidi for text layout
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1149
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ca1d5d09");
  script_set_attribute(attribute:"solution", value:
"Update the affected fribidi package.");
...
pkgs = ["fribidi-1.0.5-1.h1.eulerosv2r8",
        "fribidi-devel-1.0.5-1.h1.eulerosv2r8"];
