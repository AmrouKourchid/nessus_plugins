...
# extracted from Oracle Linux Security Advisory ELSA-2024-1959.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : shim (ELSA-2024-1959)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2024-1959 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1959.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected mokutil, shim-unsigned-x64 and / or shim-x64 packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:shim-unsigned-x64");
...
var pkgs = [
    {'reference':'mokutil-15.8-1.0.3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'shim-unsigned-x64-15.8-2.0.3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'shim-x64-15.8-1.0.3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mokutil / shim-unsigned-x64 / shim-x64');
}
