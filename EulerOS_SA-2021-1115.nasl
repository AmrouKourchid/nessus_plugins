...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : python-ipaddress (EulerOS-SA-2021-1115)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the python-ipaddress package installed,
...
following vulnerability :
  ...
  - Lib/ipaddress.py in Python through 3.8.3 improperly
    ...
    created. This is fixed in: v3.5.10, v3.5.10rc1 v3.6.12
    v3.7.9 v3.8.4, v3.8.4rc1, v3.8.5, v3.8.6, v3.8.6rc1
    v3.9.0, v3.9.0b4, v3.9.0b5, v3.9.0rc1,
    v3.9.0rc2.(CVE-2020-14422)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1115
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?448b1fa1");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-ipaddress package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python-ipaddress");
...
pkgs = ["python-ipaddress-1.0.16-2.h1"];
