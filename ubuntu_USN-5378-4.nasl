...
# extracted from Ubuntu Security Notice USN-5378-4. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5378-4");
  script_xref(name:"IAVA", value:"2024-A-0327");

  script_name(english:"Ubuntu 16.04 ESM : Gzip vulnerability (USN-5378-4)");
...
USN-5378-4 advisory.
    ...
    USN-5378-1 fixed a vulnerability in Gzip. This update provides the corresponding update for Ubuntu 14.04
    ESM and 16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5378-4");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'gzip', 'pkgver': '1.6-4ubuntu1+esm1', 'ubuntu_pro': TRUE}
];
