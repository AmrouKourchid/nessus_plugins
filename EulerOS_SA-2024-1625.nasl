...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : curl (EulerOS-SA-2024-1625)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1625
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?63733610");
...
"Update the affected curl packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-46219");
...
var pkgs = [
  "curl-7.79.1-2.h27.eulerosv2r11",
  "libcurl-7.79.1-2.h27.eulerosv2r11"
];
