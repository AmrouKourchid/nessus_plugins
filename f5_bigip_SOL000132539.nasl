...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIG-IP Edge Client for Windows and macOS vulnerability (K000132539)");
...
is, therefore, affected by a vulnerability as referenced in the K000132539 advisory.

  - An improper certificate validation vulnerability exists in the BIG-IP Edge Client for Windows and macOS
    and may allow an attacker to impersonate a BIG-IP APM system. Note: Software versions which have reached
    End of Technical Support (EoTS) are not evaluated. (CVE-2023-24461)
