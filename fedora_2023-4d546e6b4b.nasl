...
# extracted from Fedora Security Advisory FEDORA-2023-4d546e6b4b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4d546e6b4b");

  script_name(english:"Fedora 38 : pcs (2023-4d546e6b4b)");
...
FEDORA-2023-4d546e6b4b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4d546e6b4b");
...
var pkgs = [
    {'reference':'pcs-0.11.5-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
