...
# extracted from Fedora Security Advisory FEDORA-2025-93d6242840
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-93d6242840");

  script_name(english:"Fedora 40 : yq (2025-93d6242840)");
...
FEDORA-2025-93d6242840 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-93d6242840");
  script_set_attribute(attribute:"solution", value:
"Update the affected yq package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:yq");
...
var pkgs = [
    {'reference':'yq-4.43.1-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'yq');
}
