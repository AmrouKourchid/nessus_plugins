...
# Oracle Linux Security Advisory ELSA-2018-2757 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : 389-ds-base (ELSA-2018-2757)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2018-2757 advisory.

    [1.3.7.5-28]
    - Bump version to 1.3.7.5-28
    - Resolves: Bug 1628676 - 389-ds-base: race condition on reference counter leads to DoS using persistent
    search
    - Resolves: Bug 1628677 - Crash in delete_passwdPolicy when persistent search connections are terminated
    unexpectedly
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-2757.html");
...
var pkgs = [
    {'reference':'389-ds-base-1.3.7.5-28.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-devel-1.3.7.5-28.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-libs-1.3.7.5-28.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-snmp-1.3.7.5-28.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-1.3.7.5-28.el7_5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-devel-1.3.7.5-28.el7_5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-libs-1.3.7.5-28.el7_5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-snmp-1.3.7.5-28.el7_5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
