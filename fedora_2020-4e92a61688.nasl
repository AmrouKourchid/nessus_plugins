...
# extracted from Fedora Security Advisory FEDORA-2020-4e92a61688.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : glibc (2020-4e92a61688)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This update incorporates fixes from the upstream glibc 2.30 stable
release branch, including a fix for a medium severity security
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-4e92a61688");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"glibc-2.30-13.fc31")) flag++;
