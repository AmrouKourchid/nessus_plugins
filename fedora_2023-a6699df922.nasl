...
# extracted from Fedora Security Advisory FEDORA-2023-a6699df922
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a6699df922");
  script_xref(name:"IAVA", value:"2023-A-0609-S");

  script_name(english:"Fedora 38 : salt (2023-a6699df922)");
...
FEDORA-2023-a6699df922 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a6699df922");
...
var pkgs = [
    {'reference':'salt-3006.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
