...
# extracted from Debian Security Advisory DLA-1650-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1650-1 : rssh security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/01/msg00027.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/rssh");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected rssh package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-1000018");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"rssh", reference:"2.3.4-4+deb8u1")) flag++;
