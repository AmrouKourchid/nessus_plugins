...
# extracted from Fedora Security Advisory FEDORA-2023-3d9f2bed46
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3d9f2bed46");

  script_name(english:"Fedora 37 : mingw-binutils (2023-3d9f2bed46)");
...
FEDORA-2023-3d9f2bed46 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3d9f2bed46");
...
var pkgs = [
    {'reference':'mingw-binutils-2.38-6.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
