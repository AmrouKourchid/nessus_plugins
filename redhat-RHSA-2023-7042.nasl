...
# extracted from Red Hat Security Advisory RHSA-2023:7042. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7042");

  script_name(english:"RHEL 8 : python27:2.7 (RHSA-2023:7042)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python27:2.7.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:7042 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7042.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ab5666a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1909674");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2168662");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2209469");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2213054");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2213056");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2213283");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2213304");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2213306");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2213850");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2217852");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7042");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python27:2.7 package based on the guidance in RHSA-2023:7042.");
  ...
  'python27:2.7': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'python2-2.7.18-15.module+el8.9.0+20125+68111a8f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-debug-2.7.18-15.module+el8.9.0+20125+68111a8f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-devel-2.7.18-15.module+el8.9.0+20125+68111a8f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-jinja2-2.10-9.module+el8.9.0+19487+7dc18407', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-libs-2.7.18-15.module+el8.9.0+20125+68111a8f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-setuptools-39.0.1-13.module+el8.9.0+19487+7dc18407', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-setuptools-wheel-39.0.1-13.module+el8.9.0+19487+7dc18407', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-test-2.7.18-15.module+el8.9.0+20125+68111a8f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tkinter-2.7.18-15.module+el8.9.0+20125+68111a8f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tools-2.7.18-15.module+el8.9.0+20125+68111a8f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-urllib3-1.24.2-3.module+el8.9.0+19487+7dc18407', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
