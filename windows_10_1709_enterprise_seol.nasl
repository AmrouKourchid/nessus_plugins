...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 1709 Enterprise SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 1709 Enterprise is no longer maintained by its vendor or provider.
...
"Upgrade to a version of Microsoft Windows that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2019/04/09");
...
var os = ucf::get_os_cpe(vendor:'microsoft', product:'windows_10_1709', type:'local');

var constraints = [
  { seol : 20190409, cpe_attributes : [{'edition': 'enterprise*'}] }
];
