...
# extracted from Fedora Security Advisory FEDORA-2023-bc1f081ca0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bc1f081ca0");

  script_name(english:"Fedora 38 : llhttp / python-aiohttp / uxplay (2023-bc1f081ca0)");
...
FEDORA-2023-bc1f081ca0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bc1f081ca0");
...
var pkgs = [
    {'reference':'llhttp-9.1.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-aiohttp-3.8.6-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'uxplay-1.66-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
