...
# extracted from Red Hat Security Advisory RHSA-2020:3908 and
# CentOS Errata and Security Advisory 2020:3908 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : cpio (RHSA-2020:3908)");
...
var pkgs = [
    {'reference':'cpio-2.11-28.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cpio-2.11-28.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
