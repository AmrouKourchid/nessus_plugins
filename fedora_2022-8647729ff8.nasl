...
# extracted from Fedora Security Advisory FEDORA-2022-8647729ff8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8647729ff8");

  script_name(english:"Fedora 37 : kubernetes (2022-8647729ff8)");
...
FEDORA-2022-8647729ff8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8647729ff8");
...
var pkgs = [
    {'reference':'kubernetes-1.25.4-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
