...
# extracted from Debian Security Advisory dla-3740. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3740 : gnutls-bin - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-0553");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'gnutls-bin', 'reference': '3.6.7-4+deb10u12'},
    {'release': '10.0', 'prefix': 'gnutls-doc', 'reference': '3.6.7-4+deb10u12'},
    {'release': '10.0', 'prefix': 'libgnutls-dane0', 'reference': '3.6.7-4+deb10u12'},
    {'release': '10.0', 'prefix': 'libgnutls-openssl27', 'reference': '3.6.7-4+deb10u12'},
    {'release': '10.0', 'prefix': 'libgnutls28-dev', 'reference': '3.6.7-4+deb10u12'},
    {'release': '10.0', 'prefix': 'libgnutls30', 'reference': '3.6.7-4+deb10u12'},
    {'release': '10.0', 'prefix': 'libgnutlsxx28', 'reference': '3.6.7-4+deb10u12'}
];
