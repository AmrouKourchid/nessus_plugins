...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Bind vulnerability (USN-5126-1)");
...
in the USN-5126-1 advisory.

    Kishore Kumar Kothapalli discovered that Bind incorrectly handled the lame cache when processing
    responses. A remote attacker could possibly use this issue to cause Bind to consume resources, resulting
