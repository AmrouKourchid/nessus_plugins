...
# extracted from Debian Security Advisory dsa-5699. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5699 : redmine - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-47258");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-47259");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-47260");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/redmine");
...
"Upgrade the redmine packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-47260");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'redmine', 'reference': '5.0.4-5+deb12u1'},
    {'release': '12.0', 'prefix': 'redmine-mysql', 'reference': '5.0.4-5+deb12u1'},
    {'release': '12.0', 'prefix': 'redmine-pgsql', 'reference': '5.0.4-5+deb12u1'},
    {'release': '12.0', 'prefix': 'redmine-sqlite', 'reference': '5.0.4-5+deb12u1'}
];
