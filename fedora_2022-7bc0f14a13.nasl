...
# extracted from Fedora Security Advisory FEDORA-2022-7bc0f14a13
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7bc0f14a13");

  script_name(english:"Fedora 38 : rubygem-puma (2022-7bc0f14a13)");
...
FEDORA-2022-7bc0f14a13 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7bc0f14a13");
...
var pkgs = [
    {'reference':'rubygem-puma-5.6.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
