...
# extracted from Debian Security Advisory dla-2853. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2853-1 : ruby2.3 - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2853");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libruby2.3', 'reference': '2.3.3-1+deb9u11'},
    {'release': '9.0', 'prefix': 'ruby2.3', 'reference': '2.3.3-1+deb9u11'},
    {'release': '9.0', 'prefix': 'ruby2.3-dev', 'reference': '2.3.3-1+deb9u11'},
    {'release': '9.0', 'prefix': 'ruby2.3-doc', 'reference': '2.3.3-1+deb9u11'},
    {'release': '9.0', 'prefix': 'ruby2.3-tcltk', 'reference': '2.3.3-1+deb9u11'}
];
