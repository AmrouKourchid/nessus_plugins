...
# extracted from Fedora Security Advisory FEDORA-2024-ccaff13d21
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ccaff13d21");
  script_xref(name:"IAVA", value:"2024-A-0798-S");

  script_name(english:"Fedora 41 : chromium (2024-ccaff13d21)");
...
FEDORA-2024-ccaff13d21 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ccaff13d21");
...
var pkgs = [
    {'reference':'chromium-131.0.6778.139-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
