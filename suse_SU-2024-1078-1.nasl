...
# SUSE update advisory SUSE-SU-2024:1078-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:1078-1");

  script_name(english:"SUSE SLES15 Security Update : libvirt (SUSE-SU-2024:1078-1)");
...
in the SUSE-SU-2024:1078-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/034823.html");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2024-2494");
  script_set_attribute(attribute:"solution", value:
"Update the affected libvirt-bash-completion package.");
...
var pkgs = [
    {'reference':'libvirt-bash-completion-7.1.0-150300.6.41.1', 'sp':'5', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'libvirt-bash-completion-7.1.0-150300.6.41.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-server-applications-release-15.5', 'sles-release-15.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libvirt-bash-completion');
}
