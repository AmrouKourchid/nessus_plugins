...
# extracted from Fedora Security Advisory FEDORA-2024-dad1d2b46a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-dad1d2b46a");

  script_name(english:"Fedora 39 : oath-toolkit (2024-dad1d2b46a)");
...
FEDORA-2024-dad1d2b46a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-dad1d2b46a");
...
var pkgs = [
    {'reference':'oath-toolkit-2.6.12-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
