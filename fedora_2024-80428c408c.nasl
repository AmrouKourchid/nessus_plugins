...
# extracted from Fedora Security Advisory FEDORA-2024-80428c408c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-80428c408c");

  script_name(english:"Fedora 39 : gnutls (2024-80428c408c)");
...
FEDORA-2024-80428c408c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-80428c408c");
...
var pkgs = [
    {'reference':'gnutls-3.8.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
