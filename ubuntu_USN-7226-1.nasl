...
# extracted from Ubuntu Security Notice USN-7226-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7226-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : Cacti vulnerability (USN-7226-1)");
...
referenced in the USN-7226-1 advisory.

    It was discovered that Cacti did not properly sanitize the 'poller_id' parameter in the remote_agent.php
    file. A remote attacker could possibly use this issue to achieve remote code execution.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7226-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'cacti', 'pkgver': '1.1.38+ds1-1ubuntu0.1~esm4', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'cacti', 'pkgver': '1.2.10+ds1-1ubuntu1.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'cacti', 'pkgver': '1.2.19+ds1-2ubuntu1.1+esm2', 'ubuntu_pro': TRUE}
];
