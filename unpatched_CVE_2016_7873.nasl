...
if (description)
{
  ...
  script_cve_id("CVE-2016-7873");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-7873");
...
patch available.
  ...
  - Adobe Flash Player versions 23.0.0.207 and earlier, 11.2.202.644 and earlier have an exploitable memory
    corruption vulnerability in the PSDK class related to ad policy functionality method. Successful
    exploitation could lead to arbitrary code execution. (CVE-2016-7873)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-7873");
