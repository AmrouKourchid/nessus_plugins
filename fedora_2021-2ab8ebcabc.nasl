...
# extracted from Fedora Security Advisory FEDORA-2021-2ab8ebcabc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-2ab8ebcabc");

  script_name(english:"Fedora 33 : mingw-python-jinja2 (2021-2ab8ebcabc)");
...
FEDORA-2021-2ab8ebcabc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-2ab8ebcabc");
...
pkgs = [
    {'reference':'mingw-python-jinja2-2.11.3-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
