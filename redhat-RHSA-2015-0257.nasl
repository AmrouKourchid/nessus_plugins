...
# extracted from Red Hat Security Advisory RHSA-2015:0257. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:0257");

  script_name(english:"RHEL 6 : Storage Server (RHSA-2015:0257)");
...
automatically.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:0257");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2015-0240");
...
else
{
  ...
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libsmbclient-3.6.9-167.10.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libsmbclient-devel-3.6.9-167.10.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"samba-3.6.9-167.10.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"samba-client-3.6.9-167.10.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"samba-common-3.6.9-167.10.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"samba-debuginfo-3.6.9-167.10.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"samba-doc-3.6.9-167.10.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"samba-domainjoin-gui-3.6.9-167.10.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"samba-glusterfs-3.6.9-167.10.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"samba-swat-3.6.9-167.10.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"samba-winbind-3.6.9-167.10.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"samba-winbind-clients-3.6.9-167.10.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"samba-winbind-devel-3.6.9-167.10.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"samba-winbind-krb5-locator-3.6.9-167.10.3.el6")) flag++;
