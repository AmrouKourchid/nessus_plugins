...
# extracted from Fedora Security Advisory FEDORA-2024-39913e097a
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-45506");
  script_xref(name:"FEDORA", value:"2024-39913e097a");

  script_name(english:"Fedora 40 : haproxy (2024-39913e097a)");
...
FEDORA-2024-39913e097a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-39913e097a");
...
"Update the affected haproxy package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-45506");
...
var pkgs = [
    {'reference':'haproxy-2.9.10-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
