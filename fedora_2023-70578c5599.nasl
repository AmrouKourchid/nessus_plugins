...
# extracted from Fedora Security Advisory FEDORA-2023-70578c5599
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-70578c5599");
  script_xref(name:"IAVA", value:"2023-A-0667-S");

  script_name(english:"Fedora 37 : roundcubemail (2023-70578c5599)");
...
FEDORA-2023-70578c5599 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-70578c5599");
...
var pkgs = [
    {'reference':'roundcubemail-1.6.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
