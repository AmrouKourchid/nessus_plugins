...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1238.html");
...
"Update the affected dnsmasq package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2009-2958");
...
var pkgs = [
    {'reference':'dnsmasq-2.45-1.1.el5_3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-2.45-1.1.el5_3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
