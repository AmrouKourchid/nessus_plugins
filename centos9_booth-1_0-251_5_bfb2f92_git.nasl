...
if (description)
{
  ...
  script_name(english:"CentOS 9 : booth-1.0-251.5.bfb2f92.git.el9 (deprecated)");
...
"This plugin was deprecated due to incorrect CVE matches for the build.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=25473");
