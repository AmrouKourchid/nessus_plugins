...
# extracted from Red Hat Security Advisory RHSA-2022:1645. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1645");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (python-twisted) (RHSA-2022:1645)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.2 (python-twisted).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1645.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8125340b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1645");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2073114");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2 (python-twisted) package based on the guidance in RHSA-2022:1645.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-twisted-16.4.1-20.el8ost', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python3-twisted-16.4.1-20.el8ost', 'cpu':'x86_64', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
