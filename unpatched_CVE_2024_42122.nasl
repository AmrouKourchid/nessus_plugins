...
if (description)
{
  ...
  script_cve_id("CVE-2024-42122");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-42122");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Add NULL pointer
    check for kzalloc [Why & How] Check return pointer of kzalloc before using it. (CVE-2024-42122)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-42122");
