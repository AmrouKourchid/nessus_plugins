...
# extracted from Red Hat Security Advisory RHSA-2023:1696. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1696");

  script_name(english:"RHEL 9 : haproxy (RHSA-2023:1696)");
...
referenced in the RHSA-2023:1696 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1696.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?751f821b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1696");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL haproxy package based on the guidance in RHSA-2023:1696.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy-2.4.17-3.el9_1.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
