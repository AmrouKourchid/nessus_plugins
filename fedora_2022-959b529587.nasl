...
# extracted from Fedora Security Advisory FEDORA-2022-959b529587
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-959b529587");

  script_name(english:"Fedora 37 : nheko (2022-959b529587)");
...
FEDORA-2022-959b529587 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-959b529587");
...
var pkgs = [
    {'reference':'nheko-0.10.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
