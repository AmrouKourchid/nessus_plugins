...
# extracted from Red Hat Security Advisory RHSA-2020:2516.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : libexif (RHSA-2020:2516)");
...
var pkgs = [
    {'reference':'libexif-0.6.21-6.el7', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libexif-devel-0.6.21-6.el7', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE}
];
