...
# extracted from Red Hat Security Advisory RHSA-2020:0708. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0708");

  script_name(english:"RHEL 8 : http-parser (RHSA-2020:0708)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0708.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77c47a4e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0708");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1800364");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL http-parser package based on the guidance in RHSA-2020:0708.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'http-parser-2.8.0-5.el8_1.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'http-parser-2.8.0-5.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
