...
if (description)
{
  ...
  script_cve_id("CVE-2021-28712");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-28712");
...
patch available.
  ...
  - Rogue backends can cause DoS of guests via high frequency events T[his CNA information record relates to
    ...
    3, CVE-2021-28713 (CVE-2021-28712)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-28712");
