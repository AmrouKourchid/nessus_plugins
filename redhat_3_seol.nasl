...
if (description)
{
  ...
  script_name(english:"Red Hat Enterprise Linux SEoL (3.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Red Hat Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Red Hat Enterprise Linux is 3.x. It is, therefore, no longer maintained by its vendor or
provider.
