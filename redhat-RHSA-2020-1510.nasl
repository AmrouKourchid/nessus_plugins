...
# extracted from Red Hat Security Advisory RHSA-2020:1510. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1510");

  script_name(english:"RHEL 7 : http-parser (RHSA-2020:1510)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for http-parser.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:1510 advisory.

    The http-parser package provides a utility for parsing HTTP messages. It parses both requests and
    responses. The parser is designed to be used in performance HTTP applications. It does not make any system
    calls or allocations, it does not buffer data, and it can be interrupted at any time. Depending on your
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1510.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f049ad43");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1510");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1800364");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL http-parser package based on the guidance in RHSA-2020:1510.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.7.1-5.el7_6.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-devel-2.7.1-5.el7_6.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
