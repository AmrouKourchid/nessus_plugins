...
# extracted from Gentoo Linux Security Advisory GLSA 202012-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202012-04");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2021/11/17");
  script_xref(name:"CEA-ID", value:"CEA-2020-0124");

  script_name(english:"GLSA-202012-04 : Mozilla Thunderbird: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202012-04
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9589e875");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202012-04");
...
if (qpkg_check(package:"mail-client/thunderbird", unaffected:make_list("ge 78.5.1"), vulnerable:make_list("lt 78.5.1"))) flag++;
if (qpkg_check(package:"mail-client/thunderbird-bin", unaffected:make_list("ge 78.5.1"), vulnerable:make_list("lt 78.5.1"))) flag++;
