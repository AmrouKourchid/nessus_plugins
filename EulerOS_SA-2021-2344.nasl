...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : postgresql (EulerOS-SA-2021-2344)");
...
vulnerability :
  ...
  - A flaw was found in postgresql in versions before 13.3,
    before 12.7, before 11.12, before 10.17 and before
    9.6.22. While modifying certain SQL array values,
    missing bounds checks let authenticated database users
    write arbitrary bytes to a wide area of server memory.
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2344
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?62781030");
...
pkgs = ["postgresql-9.2.24-1.h2.eulerosv2r7",
        "postgresql-contrib-9.2.24-1.h2.eulerosv2r7",
        "postgresql-devel-9.2.24-1.h2.eulerosv2r7",
        "postgresql-docs-9.2.24-1.h2.eulerosv2r7",
        "postgresql-libs-9.2.24-1.h2.eulerosv2r7",
        "postgresql-plperl-9.2.24-1.h2.eulerosv2r7",
        "postgresql-plpython-9.2.24-1.h2.eulerosv2r7",
        "postgresql-pltcl-9.2.24-1.h2.eulerosv2r7",
        "postgresql-server-9.2.24-1.h2.eulerosv2r7",
        "postgresql-test-9.2.24-1.h2.eulerosv2r7"];
