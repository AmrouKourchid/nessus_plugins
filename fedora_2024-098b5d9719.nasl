...
# extracted from Fedora Security Advisory FEDORA-2024-098b5d9719
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-098b5d9719");

  script_name(english:"Fedora 40 : python-idna (2024-098b5d9719)");
...
FEDORA-2024-098b5d9719 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-098b5d9719");
...
var pkgs = [
    {'reference':'python-idna-3.7-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
