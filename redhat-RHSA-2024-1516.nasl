...
# extracted from Red Hat Security Advisory RHSA-2024:1516. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1516");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.1.9 (python-twisted) (RHSA-2024:1516)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.1.9 (python-twisted).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1516.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c26711f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2246264");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1516");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.1.9 (python-twisted) package based on the guidance in RHSA-2024:1516.");
