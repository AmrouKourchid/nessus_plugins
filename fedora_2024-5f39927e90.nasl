...
# extracted from Fedora Security Advisory FEDORA-2024-5f39927e90
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5f39927e90");

  script_name(english:"Fedora 40 : firefox (2024-5f39927e90)");
...
FEDORA-2024-5f39927e90 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5f39927e90");
...
var pkgs = [
    {'reference':'firefox-131.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
