...
# openSUSE Security Update openSUSE-SU-2025:0123-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : perl-Data-Entropy (openSUSE-SU-2025:0123-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1240395");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/DEV777CDY3ONNFKV6ZABSLHPDKVBS3AA/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6543384b");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2025-1860");
...
"Update the affected perl-Data-Entropy package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:perl-Data-Entropy");
...
var pkgs = [
    {'reference':'perl-Data-Entropy-0.8.0-bp156.4.3.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE}
];
