...
# extracted from Fedora Security Advisory FEDORA-2022-5fd3e7f635
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-5fd3e7f635");

  script_name(english:"Fedora 36 : python3.8 (2022-5fd3e7f635)");
...
FEDORA-2022-5fd3e7f635 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-5fd3e7f635");
...
var pkgs = [
    {'reference':'python3.8-3.8.15-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
