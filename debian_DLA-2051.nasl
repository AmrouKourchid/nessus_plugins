...
# extracted from Debian Security Advisory DLA-2051-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2051-1 : intel-microcode security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/12/msg00035.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/intel-microcode");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected intel-microcode package.");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"intel-microcode", reference:"3.20191115.2~deb8u1")) flag++;
