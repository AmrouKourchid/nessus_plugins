...
# extracted from Red Hat Security Advisory RHSA-2024:4016.
##
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4016");
  script_xref(name:"IAVA", value:"2024-A-0387-S");

  script_name(english:"CentOS 7 : thunderbird (RHSA-2024:4016)");
...
RHSA-2024:4016 advisory.

  - If a garbage collection was triggered at the right time, a use-after-free could have occurred during
    object transplant. This vulnerability affects Firefox < 127, Firefox ESR < 115.12, and Thunderbird <
    115.12. (CVE-2024-5688)
  ...
  - By tricking the browser with a `X-Frame-Options` header, a sandboxed iframe could have presented a button
    ...
    Firefox < 127, Firefox ESR < 115.12, and Thunderbird < 115.12. (CVE-2024-5691)
  ...
  - By manipulating the text in an `<input>` tag, an attacker could have caused corrupt memory leading
    to a potentially exploitable crash. This vulnerability affects Firefox < 127, Firefox ESR < 115.12, and
    Thunderbird < 115.12. (CVE-2024-5696)
  ...
  - Memory safety bugs present in Firefox 126, Firefox ESR 115.11, and Thunderbird 115.11. Some of these bugs
    ...
    exploited to run arbitrary code. This vulnerability affects Firefox < 127, Firefox ESR < 115.12, and
  ...
  - Memory corruption in the networking stack could have led to a potentially exploitable crash. This
    vulnerability affects Firefox < 125, Firefox ESR < 115.12, and Thunderbird < 115.12. (CVE-2024-5702)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4016");
...
var pkgs = [
    {'reference':'thunderbird-115.12.1-1.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.12.1-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
