...
# extracted from Fedora Security Advisory FEDORA-2023-37eac50e9b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-37eac50e9b");

  script_name(english:"Fedora 38 : curl (2023-37eac50e9b)");
...
FEDORA-2023-37eac50e9b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-37eac50e9b");
...
var pkgs = [
    {'reference':'curl-8.0.1-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
