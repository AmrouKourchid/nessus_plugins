...
if (description)
{
  ...
  script_cve_id("CVE-2025-21762");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21762");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: arp: use RCU protection in arp_xmit()
    arp_xmit() can be called without RTNL or RCU protection. Use RCU protection to avoid potential UAF.
    (CVE-2025-21762)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21762");
