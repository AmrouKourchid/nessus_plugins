...
# extracted from Fedora Security Advisory FEDORA-2018-a2e9bd6eae.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-a2e9bd6eae");

  script_name(english:"Fedora 29 : php-PHPMailer (2018-a2e9bd6eae)");
...
"**Version 5.2.27**
  ...
  - SECURITY Fix potential object injection vulnerability.
    **CVE-2018-19296**. Reported by Sehun Oh of cyberone.kr.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a2e9bd6eae");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"php-PHPMailer-5.2.27-1.fc29")) flag++;
