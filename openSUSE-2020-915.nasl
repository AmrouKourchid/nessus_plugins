...
# extracted from openSUSE Security Update openSUSE-2020-915.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mutt (openSUSE-2020-915)");
...
if ( rpm_check(release:"SUSE15.2", reference:"mutt-1.10.1-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mutt-debuginfo-1.10.1-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mutt-debugsource-1.10.1-lp152.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mutt-lang-1.10.1-lp152.3.3.1") ) flag++;
