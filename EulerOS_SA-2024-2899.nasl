...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : xmlrpc-c (EulerOS-SA-2024-2899)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2899
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e850a442");
...
var pkgs = [
  "xmlrpc-c-help-1.51.06-1.h2.eulerosv2r10"
];
