...
# extracted from Fedora Security Advisory FEDORA-2023-1ba499965f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1ba499965f");

  script_name(english:"Fedora 37 : runc (2023-1ba499965f)");
...
FEDORA-2023-1ba499965f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1ba499965f");
...
var pkgs = [
    {'reference':'runc-1.1.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
