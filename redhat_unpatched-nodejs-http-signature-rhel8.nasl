...
# extracted from Red Hat Security Advisory nodejs-http-signature. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : nodejs-http-signature (Unpatched Vulnerability) (deprecated)");
