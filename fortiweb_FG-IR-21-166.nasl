...
if (description)
{
  ...
  script_cve_id("CVE-2021-41018");

  script_name(english:"Fortinet FortiWeb OS command injection due to unsafe input validation function (FG-IR-21-166)");
...
vulnerability as referenced in the FG-IR-21-166 advisory.
  ...
  - A improper neutralization of special elements used in an os command ('os command injection') in Fortinet
    ...
    commands via crafted HTTP requests. (CVE-2021-41018)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-21-166");
...
"Please upgrade to FortiWeb version 6.3.16/6.4.2/7.0.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-41018");
