...
# extracted from Fedora Security Advisory FEDORA-2023-ea6b94395f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ea6b94395f");

  script_name(english:"Fedora 38 : dino (2023-ea6b94395f)");
...
FEDORA-2023-ea6b94395f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ea6b94395f");
...
var pkgs = [
    {'reference':'dino-0.4.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
