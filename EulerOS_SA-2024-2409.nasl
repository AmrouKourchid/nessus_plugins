...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : cups (EulerOS-SA-2024-2409)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2409
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8fdca61");
...
var pkgs = [
  "cups-libs-2.2.13-4.h10.eulerosv2r10"
];
