...
# extracted from Fedora Security Advisory FEDORA-2023-a9c17dff60
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a9c17dff60");

  script_name(english:"Fedora 38 : thunderbird (2023-a9c17dff60)");
...
FEDORA-2023-a9c17dff60 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a9c17dff60");
...
var pkgs = [
    {'reference':'thunderbird-102.9.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
