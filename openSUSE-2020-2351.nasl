...
# extracted from openSUSE Security Update openSUSE-2020-2351.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openexr (openSUSE-2020-2351)");
...
if ( rpm_check(release:"SUSE15.2", reference:"libIlmImf-2_2-23-2.2.1-lp152.7.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libIlmImf-2_2-23-debuginfo-2.2.1-lp152.7.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libIlmImfUtil-2_2-23-2.2.1-lp152.7.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libIlmImfUtil-2_2-23-debuginfo-2.2.1-lp152.7.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openexr-2.2.1-lp152.7.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openexr-debuginfo-2.2.1-lp152.7.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openexr-debugsource-2.2.1-lp152.7.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openexr-devel-2.2.1-lp152.7.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libIlmImf-2_2-23-32bit-2.2.1-lp152.7.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libIlmImf-2_2-23-32bit-debuginfo-2.2.1-lp152.7.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libIlmImfUtil-2_2-23-32bit-2.2.1-lp152.7.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libIlmImfUtil-2_2-23-32bit-debuginfo-2.2.1-lp152.7.8.1") ) flag++;
