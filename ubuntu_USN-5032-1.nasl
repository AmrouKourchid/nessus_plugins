...
# extracted from Ubuntu Security Notice USN-5032-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5032-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Docker vulnerabilities (USN-5032-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5032-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'docker.io', 'pkgver': '20.10.7-0ubuntu1~18.04.1'},
    {'osver': '20.04', 'pkgname': 'docker.io', 'pkgver': '20.10.7-0ubuntu1~20.04.1'}
];
