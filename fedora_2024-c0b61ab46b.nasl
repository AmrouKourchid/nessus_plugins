...
# extracted from Fedora Security Advisory FEDORA-2024-c0b61ab46b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c0b61ab46b");

  script_name(english:"Fedora 39 : freeimage / mingw-freeimage (2024-c0b61ab46b)");
...
FEDORA-2024-c0b61ab46b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c0b61ab46b");
...
"Update the affected freeimage and / or mingw-freeimage packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-47997");
...
var pkgs = [
    {'reference':'freeimage-3.19.0-0.23.svn1909.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mingw-freeimage-3.19.0-0.20.svn1909.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
