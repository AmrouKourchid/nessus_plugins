...
# extracted from Fedora Security Advisory FEDORA-2019-d8ec88b21e.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2019-3808", "CVE-2019-3809", "CVE-2019-3810");
  script_xref(name:"FEDORA", value:"2019-d8ec88b21e");

  script_name(english:"Fedora 29 : moodle (2019-d8ec88b21e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d8ec88b21e");
...
"Update the affected moodle package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-3809");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"moodle-3.5.4-1.fc29")) flag++;
