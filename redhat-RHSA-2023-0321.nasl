...
# extracted from Red Hat Security Advisory RHSA-2023:0321. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0321");

  script_name(english:"RHEL 9 : nodejs and nodejs-nodemon (RHSA-2023:0321)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:0321 advisory.

    Node.js is a software development platform for building fast and scalable network applications in the
    JavaScript programming language.

    The following packages have been upgraded to a later upstream version: nodejs (16.18.1), nodejs-nodemon
    (2.0.20).
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0321.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4622f6fd");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0321");
...
"Update the affected packages.");
  ...
  script_cwe_id(350, 444, 1321, 1333);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nodejs-16.18.1-3.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-44906', 'CVE-2022-3517', 'CVE-2022-35256', 'CVE-2022-43548']},
      {'reference':'nodejs-docs-16.18.1-3.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-44906', 'CVE-2022-3517', 'CVE-2022-35256', 'CVE-2022-43548']},
      {'reference':'nodejs-full-i18n-16.18.1-3.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-44906', 'CVE-2022-3517', 'CVE-2022-35256', 'CVE-2022-43548']},
      {'reference':'nodejs-libs-16.18.1-3.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-44906', 'CVE-2022-3517', 'CVE-2022-35256', 'CVE-2022-43548']},
      {'reference':'nodejs-nodemon-2.0.20-2.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2021-44906', 'CVE-2022-3517']},
      {'reference':'npm-8.19.2-1.16.18.1.3.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2021-44906', 'CVE-2022-3517', 'CVE-2022-35256', 'CVE-2022-43548']}
    ]
  }
];
