...
# AlmaLinux Security Advisory ALSA-2022:7715.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7715");

  script_name(english:"AlmaLinux 8 : libxml2 (ALSA-2022:7715)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2022:7715 advisory.

  - Possible cross-site scripting vulnerability in libxml after commit 960f0e2. (CVE-2016-3709)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-7715.html");
