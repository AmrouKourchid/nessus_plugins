...
# extracted from Fedora Security Advisory FEDORA-2021-5f268ab238
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-5f268ab238");

  script_name(english:"Fedora 33 : 1:wpa_supplicant (2021-5f268ab238)");
...
FEDORA-2021-5f268ab238 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-5f268ab238");
...
pkgs = [
    {'reference':'wpa_supplicant-2.9-7.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
