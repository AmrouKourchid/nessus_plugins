...
# extracted from Gentoo Linux Security Advisory GLSA 202309-05.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202309-05 : WebP: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202309-05 (WebP: Multiple vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202309-05");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=909369");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=914010");
...
"All WebP users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libwebp");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.3.1_p20230908"),
    'vulnerable' : make_list("lt 1.3.1_p20230908")
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'WebP');
}
