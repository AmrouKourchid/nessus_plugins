...
# SUSE update advisory SUSE-SU-2021:14827-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14827-1");

  script_name(english:"SUSE SLES11 Security Update : strongswan (SUSE-SU-2021:14827-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-October/009612.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c1bdd6e");
...
var pkgs = [
    {'reference':'strongswan-4.4.0-6.36.9.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    {'reference':'strongswan-doc-4.4.0-6.36.9.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
