...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : openldap (EulerOS-SA-2020-1200)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1200
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d1121fa6");
...
pkgs = ["openldap-2.4.44-15.h8",
        "openldap-clients-2.4.44-15.h8"];
