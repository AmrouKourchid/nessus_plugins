...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : openjpeg (SUSE-SU-2022:4082-1)");
...
multiple vulnerabilities as referenced in the SUSE-SU-2022:4082-1 advisory.
...
"Update the affected libopenjpeg1, libopenjpeg1-32bit and / or openjpeg-devel packages.");
...
if (os_ver == "SLES_SAP15" && (! preg(pattern:"^(0|3)$", string:service_pack))) audit(AUDIT_OS_NOT, "SLES_SAP15 SP0/3", os_ver + " SP" + service_pack);

var pkgs = [
    {'reference':'libopenjpeg1-1.5.2-150000.4.10.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15']},
    {'reference':'libopenjpeg1-32bit-1.5.2-150000.4.10.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15']},
    {'reference':'openjpeg-devel-1.5.2-150000.4.10.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15']},
    {'reference':'libopenjpeg1-1.5.2-150000.4.10.1', 'sp':'3', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'libopenjpeg1-1.5.2-150000.4.10.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'openjpeg-devel-1.5.2-150000.4.10.1', 'sp':'3', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'openjpeg-devel-1.5.2-150000.4.10.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'libopenjpeg1-1.5.2-150000.4.10.1', 'sp':'3', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-desktop-applications-release-15.3', 'sled-release-15.3', 'sles-release-15.3']},
    {'reference':'libopenjpeg1-1.5.2-150000.4.10.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-desktop-applications-release-15.3', 'sled-release-15.3', 'sles-release-15.3']},
    {'reference':'openjpeg-devel-1.5.2-150000.4.10.1', 'sp':'3', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-desktop-applications-release-15.3', 'sled-release-15.3', 'sles-release-15.3']},
    {'reference':'openjpeg-devel-1.5.2-150000.4.10.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-desktop-applications-release-15.3', 'sled-release-15.3', 'sles-release-15.3']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libopenjpeg1 / libopenjpeg1-32bit / openjpeg-devel');
}
