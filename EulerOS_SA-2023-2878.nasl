...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : haproxy (EulerOS-SA-2023-2878)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2878
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?521164ec");
...
var pkgs = [
  "haproxy-2.0.14-1.h7.eulerosv2r9"
];
