...
# extracted from Fedora Security Advisory FEDORA-2019-f5558abfef.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-f5558abfef");

  script_name(english:"Fedora 31 : SDL (2019-f5558abfef)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This release fixes a heap buffer over-read in BlitNtoN() function when
processing an invalid BMP image.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-f5558abfef");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"SDL-1.2.15-42.fc31")) flag++;
