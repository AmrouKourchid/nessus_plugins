...
"The version of Firefox ESR installed on the remote Windows host is prior to 115.3. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2023-42 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'115.3', min:'115.0.0', severity:SECURITY_HOLE);
