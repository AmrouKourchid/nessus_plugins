...
# extracted from Fedora Security Advisory FEDORA-2024-93e88b1c0d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-93e88b1c0d");

  script_name(english:"Fedora 41 : subversion (2024-93e88b1c0d)");
...
FEDORA-2024-93e88b1c0d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-93e88b1c0d");
...
var pkgs = [
    {'reference':'subversion-1.14.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
