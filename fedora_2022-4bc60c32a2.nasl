...
# extracted from Fedora Security Advisory FEDORA-2022-4bc60c32a2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-4bc60c32a2");

  script_name(english:"Fedora 37 : vim (2022-4bc60c32a2)");
...
FEDORA-2022-4bc60c32a2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-4bc60c32a2");
...
var pkgs = [
    {'reference':'vim-9.0.828-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
