...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : gnutls (EulerOS-SA-2023-2411)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2411
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e3eb2636");
...
var pkgs = [
  "gnutls-3.3.26-9.h6.eulerosv2r7",
  "gnutls-c++-3.3.26-9.h6.eulerosv2r7",
  "gnutls-dane-3.3.26-9.h6.eulerosv2r7",
  "gnutls-devel-3.3.26-9.h6.eulerosv2r7",
  "gnutls-utils-3.3.26-9.h6.eulerosv2r7"
];
