...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5010404");
  script_xref(name:"MSKB", value:"5010422");
  script_xref(name:"MSFT", value:"MS22-5010404");
  script_xref(name:"MSFT", value:"MS22-5010422");
  script_xref(name:"IAVA", value:"2022-A-0068-S");
  script_xref(name:"IAVA", value:"2022-A-0074-S");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/04/15");

  script_name(english:"KB5010422: Windows 7 and Windows Server 2008 R2 Security Update (February 2022)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5010404");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5010422");
...
"Apply Cumulative Update 5010404 or Security Update 5010422");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-22718");
...
if (
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'02_2022',
                   bulletin:bulletin,
                   rollup_kb_list:[5010422, 5010404])
)
{
