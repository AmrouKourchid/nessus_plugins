...
# extracted from SUSE update advisory SUSE-SU-2020:2806-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : tar (SUSE-SU-2020:2806-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?015eb460");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"tar-1.27.1-15.6.3")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"tar-debuginfo-1.27.1-15.6.3")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"tar-debugsource-1.27.1-15.6.3")) flag++;
