...
# Red Hat Security Advisory RHSA-2023:7010. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : sysstat (CESA-2023:7010)");
...
var pkgs = [
    {'reference':'sysstat-11.7.3-11.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sysstat-11.7.3-11.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
