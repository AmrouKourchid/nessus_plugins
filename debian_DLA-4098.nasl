...
# extracted from Debian Security Advisory dla-4098. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-56161");

  script_name(english:"Debian dla-4098 : amd64-microcode - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4098
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-56161");
...
"Upgrade the amd64-microcode packages.");
  ...
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:H/PR:H/UI:N/S:C/C:H/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56161");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'amd64-microcode', 'reference': '3.20250311.1~deb11u1'}
];
