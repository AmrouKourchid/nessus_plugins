...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : shim (EulerOS-SA-2022-2367)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2367
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?445bba76");
...
var pkgs = [
  "shim-15-19.h10.eulerosv2r9",
  "shim-aa64-storage-15-19.h10.eulerosv2r9"
];
