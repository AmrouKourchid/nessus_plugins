...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : patch on SL7.x x86_64 (20180423)");
...
Security Fix(es) :
  ...
  - patch: Malicious patch files cause ed to execute
    arbitrary commands (CVE-2018-1000156)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1804&L=scientific-linux-errata&F=&S=&P=9028
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6615ac43");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"patch-2.7.1-10.el7_5")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"patch-debuginfo-2.7.1-10.el7_5")) flag++;
