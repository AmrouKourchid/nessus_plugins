...
# extracted from Fedora Security Advisory FEDORA-2023-1c2c29a683
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1c2c29a683");

  script_name(english:"Fedora 39 : vim (2023-1c2c29a683)");
...
FEDORA-2023-1c2c29a683 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1c2c29a683");
...
var pkgs = [
    {'reference':'vim-9.0.1872-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
