...
# extracted from Red Hat Security Advisory RHSA-2019:3582. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3582");

  script_name(english:"RHEL 8 : samba (RHSA-2019:3582)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:3582 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3582.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b55abeb");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.1_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8d3b26b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3582");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1669004");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1672167");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ctdb-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ctdb-tests-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsmbclient-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsmbclient-devel-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwbclient-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwbclient-devel-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-samba-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-samba-test-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-client-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-client-libs-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-libs-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-tools-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-krb5-printing-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-libs-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-pidl-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-test-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-test-libs-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-clients-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-krb5-locator-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-modules-4.10.4-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
