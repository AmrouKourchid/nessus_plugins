...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : Git vulnerabilities (USN-5810-1)");
...
vulnerabilities as referenced in the USN-5810-1 advisory.
    ...
    Markus Vervier and Eric Sesterhenn discovered that Git incorrectly handled certain gitattributes. An
    attacker could possibly use this issue to cause a crash or execute arbitrary code. (CVE-2022-23521)

    Joern Schneeweisz discovered that Git incorrectly handled certain commands. An attacker could possibly use
    this issue to cause a crash or execute arbitrary code. (CVE-2022-41903)
