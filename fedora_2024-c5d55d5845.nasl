...
# extracted from Fedora Security Advisory FEDORA-2024-c5d55d5845
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c5d55d5845");

  script_name(english:"Fedora 41 : mingw-expat (2024-c5d55d5845)");
...
FEDORA-2024-c5d55d5845 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c5d55d5845");
...
var pkgs = [
    {'reference':'mingw-expat-2.6.3-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
