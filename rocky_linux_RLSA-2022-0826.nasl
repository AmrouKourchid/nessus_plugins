...
# Rocky Linux Security Advisory RLSA-2022:0826.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:0826");

  script_name(english:"Rocky Linux 8 : .NET 6.0 (RLSA-2022:0826)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2022:0826 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:0826");
