...
# extracted from openSUSE Security Update openSUSE-2020-69.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : uftpd (openSUSE-2020-69)");
...
"This update for uftpd to version 2.11 fixes the following issues :
  ...
  - CVE-2020-5204: Fixed a buffer overflow in FTP PORT
    parser (boo#1160199).

  - Fixed additional bugs which could have security
    implications.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1160199");
  script_set_attribute(attribute:"solution", value:
"Update the affected uftpd packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-5204");
...
if ( rpm_check(release:"SUSE15.1", reference:"uftpd-2.11-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"uftpd-debuginfo-2.11-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"uftpd-debugsource-2.11-lp151.2.3.1") ) flag++;
