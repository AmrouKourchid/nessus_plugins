...
"The remote Red Hat host is missing a security update for go-toolset-7 / go-toolset-7-golang.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:1304 advisory.

    Go Toolset provides the Go programming language tools and libraries. Go is alternatively known as golang.

    The following packages have been upgraded to a later upstream version: go-toolset-7-golang (1.8.7).
    (BZ#1545319)
    ...
    * golang: arbitrary code execution during go get via C compiler options (CVE-2018-6574)
    ...
    For detailed changes and information on usage, see Using Go Toolset linked from the References section.
    For information on scope of support, see the Technology Preview Features Support Scope document.

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_1304.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?688e3510");
  # https://access.redhat.com/documentation/en-us/red_hat_developer_tools/2018.2/html/using_go_toolset/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e3a590ad");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/support/offerings/techpreview/");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1536154");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1543561");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1550079");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1304");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL go-toolset-7 / go-toolset-7-golang packages based on the guidance in RHSA-2018:1304.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'go-toolset-7-1.8-14.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-7-build-1.8-14.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-7-golang-1.8.7-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-7-golang-bin-1.8.7-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-7-golang-docs-1.8.7-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-7-golang-misc-1.8.7-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-7-golang-race-1.8.7-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-7-golang-src-1.8.7-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-7-golang-tests-1.8.7-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-7-runtime-1.8-14.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-7-scldevel-1.8-14.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
