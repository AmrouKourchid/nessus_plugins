...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2632.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python2-setuptools (ALAS-2024-2632)");
...
vulnerability as referenced in the ALAS2-2024-2632 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2632.html");
...
var pkgs = [
    {'reference':'python2-setuptools-41.2.0-4.amzn2.0.4', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
