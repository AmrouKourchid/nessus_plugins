...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Nodejs PHSA-2024-4.0-0586");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nodejs-18.19.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nodejs-devel-18.19.1-1.ph4')) flag++;
