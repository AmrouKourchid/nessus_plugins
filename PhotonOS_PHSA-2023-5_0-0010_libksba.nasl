...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libksba PHSA-2023-5.0-0010");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libksba-1.6.3-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libksba-devel-1.6.3-1.ph5')) flag++;
