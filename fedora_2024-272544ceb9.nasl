...
# extracted from Fedora Security Advisory FEDORA-2024-272544ceb9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-272544ceb9");

  script_name(english:"Fedora 40 : openjpeg2 (2024-272544ceb9)");
...
FEDORA-2024-272544ceb9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-272544ceb9");
...
var pkgs = [
    {'reference':'openjpeg2-2.5.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
