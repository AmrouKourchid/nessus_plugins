...
# extracted from Debian Security Advisory dla-3749. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3749 : php-seclib - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'php-seclib', 'reference': '1.0.19-3~deb10u3'}
];
