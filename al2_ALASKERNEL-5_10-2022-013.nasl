...
vulnerabilities as referenced in the ALAS2KERNEL-5.10-2022-013 advisory.
    ...
    A buffer overflow flaw was found in the Linux kernel's NFC protocol functionality. This flaw allows a
    local user to crash or escalate their privileges on the system. (CVE-2022-26490)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2022-48834.html");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2022-49286.html");
...
"Run 'yum update kernel' to update your system.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-48834");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2022-1048", "CVE-2022-20368", "CVE-2022-26490", "CVE-2022-28356", "CVE-2022-48834", "CVE-2022-48839", "CVE-2022-48843", "CVE-2022-49286", "CVE-2022-49291");
