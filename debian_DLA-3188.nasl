...
# extracted from Debian Security Advisory dla-3188. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3188 : isag - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2019-16167");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2019-19725");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'isag', 'reference': '12.0.3-2+deb10u1'},
    {'release': '10.0', 'prefix': 'sysstat', 'reference': '12.0.3-2+deb10u1'}
];
