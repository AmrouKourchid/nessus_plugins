...
affected by the following vulnerability :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fae2b3b0");
...
var lync_installs = get_installs(app_name:"Microsoft Lync", exit_if_not_found:TRUE);
...
var lync_install, file, timestamp, patched_timestamp, info, kb, path;
