...
scripting or the disclosure of hidden users.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=971985");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=971986");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4816");
...
in version 1:1.31.12-1~deb10u1.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-35475");
