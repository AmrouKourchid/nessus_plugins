...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 17.x < 17.0.10.7.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 17 < 17.0.10.7.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-17-2024-Jan-16 advisory.
...
"Update to Amazon Corretto Java 17.0.10.7.1 or later");
...
var constraints = [
  { 'min_version' : '17.0', 'fixed_version' : '17.0.10.7.1' }
];
