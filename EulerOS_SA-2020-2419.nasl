...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python3 (EulerOS-SA-2020-2419)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2419
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ac8c215");
...
pkgs = ["python3-3.7.4-7.h14.eulerosv2r9",
        "python3-unversioned-command-3.7.4-7.h14.eulerosv2r9"];
