...
# extracted from SUSE update advisory SUSE-SU-2020:1606-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : nodejs12 (SUSE-SU-2020:1606-1)");
...
CVE-2020-8172: Fixed am issue where TLS session reuse could have led
to host certificate verification bypass (bsc#1172441).
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1172441");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1172728");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2020-8172/");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e45a62e9");
...
zypper in -t patch SUSE-SLE-Module-Web-Scripting-12-2020-1606=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs12-12.18.0-1.14.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs12-debuginfo-12.18.0-1.14.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs12-debugsource-12.18.0-1.14.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs12-devel-12.18.0-1.14.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"npm12-12.18.0-1.14.1")) flag++;
