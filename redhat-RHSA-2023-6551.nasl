...
# extracted from Red Hat Security Advisory RHSA-2023:6551. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6551");

  script_name(english:"RHEL 9 : yajl (RHSA-2023:6551)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6551.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3020da43");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6551");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL yajl package based on the guidance in RHSA-2023:6551.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'yajl-2.1.0-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'yajl-devel-2.1.0-22.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
