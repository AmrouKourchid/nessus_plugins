...
# extracted from Fedora Security Advisory FEDORA-2022-6f4e6120d7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6f4e6120d7");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"Fedora 35 : python3.9 (2022-6f4e6120d7)");
...
FEDORA-2022-6f4e6120d7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6f4e6120d7");
...
var pkgs = [
    {'reference':'python3.9-3.9.16-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
