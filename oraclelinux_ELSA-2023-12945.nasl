...
# extracted from Oracle Linux Security Advisory ELSA-2023-12945.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : dnsmasq (ELSA-2023-12945)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2023-12945 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-12945.html");
...
var pkgs = [
    {'reference':'dnsmasq-2.76-17.0.1.el7_9.3', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-utils-2.76-17.0.1.el7_9.3', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-2.76-17.0.1.el7_9.3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-utils-2.76-17.0.1.el7_9.3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
