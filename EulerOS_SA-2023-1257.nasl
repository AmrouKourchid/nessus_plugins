...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : grub2 (EulerOS-SA-2023-1257)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1257
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?62ab5f6b");
...
var pkgs = [
  "grub2-2.02-0.65.2.h17",
  "grub2-common-2.02-0.65.2.h17",
  "grub2-efi-x64-2.02-0.65.2.h17",
  "grub2-efi-x64-cdboot-2.02-0.65.2",
  "grub2-efi-x64-modules-2.02-0.65.2.h17",
  "grub2-pc-2.02-0.65.2.h17",
  "grub2-pc-modules-2.02-0.65.2.h17",
  "grub2-tools-2.02-0.65.2.h17",
  "grub2-tools-extra-2.02-0.65.2.h17",
  "grub2-tools-minimal-2.02-0.65.2.h17"
];
