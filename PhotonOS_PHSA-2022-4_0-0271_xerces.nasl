...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Xerces PHSA-2022-4.0-0271");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'xerces-c-3.2.4-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'xerces-c-devel-3.2.4-1.ph4')) flag++;
