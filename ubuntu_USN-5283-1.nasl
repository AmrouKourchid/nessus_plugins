...
USN-5283-1 advisory.
    ...
    use this issue to read arbitrary files, resulting in a directory traversal attack.
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'node-tar', 'pkgver': '4.4.10+ds1-2ubuntu1+esm1', 'ubuntu_pro': TRUE}
];
