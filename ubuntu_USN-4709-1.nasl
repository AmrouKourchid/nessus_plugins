...
the USN-4709-1 advisory.
    ...
    that, when mounted, could cause a denial of service (system crash). (CVE-2019-19813, CVE-2019-19816)
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-1121-aws");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4709-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2018-13093', 'CVE-2019-19813', 'CVE-2019-19816', 'CVE-2020-25669', 'CVE-2020-28374');
