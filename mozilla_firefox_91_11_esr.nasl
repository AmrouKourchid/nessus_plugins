...
"The version of Firefox ESR installed on the remote Windows host is prior to 91.11. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2022-25 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'91.11', min:'91.0.0', severity:SECURITY_HOLE);
