...
if (description)
{
  ...
  script_cve_id("CVE-2022-3238");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-3238");
...
patch available.
  ...
  - A double-free flaw was found in the Linux kernel's NTFS3 subsystem in how a user triggers remount and
    umount simultaneously. This flaw allows a local user to crash or potentially escalate their privileges on
    the system. (CVE-2022-3238)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-3238");
