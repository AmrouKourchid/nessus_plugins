...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.1.0 : openssh (EulerOS-SA-2019-1399)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1399
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a5858ae");
...
pkgs = ["openssh-7.4p1-16.h6",
        "openssh-clients-7.4p1-16.h6",
        "openssh-keycat-7.4p1-16.h6",
        "openssh-server-7.4p1-16.h6"];
