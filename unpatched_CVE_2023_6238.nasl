...
if (description)
{
  ...
  script_cve_id("CVE-2023-6238");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-6238");
...
patch available.
  ...
  - A buffer overflow vulnerability was found in the NVM Express (NVMe) driver in the Linux kernel. Only
    privileged user could specify a small meta buffer and let the device perform larger Direct Memory Access
    (DMA) into the same buffer, overwriting unrelated kernel memory, causing random kernel crashes and memory
    corruption. (CVE-2023-6238)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-6238");
