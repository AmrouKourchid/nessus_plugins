...
# extracted from Red Hat Security Advisory RHSA-2024:10748. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10748");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2024:10748)");
...
referenced in the RHSA-2024:10748 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33bb2790");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10748");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2024:10748.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-128.5.0-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
