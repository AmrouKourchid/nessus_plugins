...
# extracted from Debian Security Advisory dsa-5816. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5816 : libmodule-scandeps-perl - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has a package installed that is affected by a vulnerability as referenced in the dsa-5816
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/libmodule-scandeps-perl");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'libmodule-scandeps-perl', 'reference': '1.31-2+deb12u1'}
];
