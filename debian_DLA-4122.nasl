...
# extracted from Debian Security Advisory dla-4122. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4122 : libbssolv-perl - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4122
advisory.
...
number.");
  # https://security-tracker.debian.org/tracker/source-package/libbssolv-perl
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?22980f68");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/libbssolv-perl");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libbssolv-perl packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libbssolv-perl");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libbssolv-perl', 'reference': '0.17-3+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libbssolv-perl');
}
