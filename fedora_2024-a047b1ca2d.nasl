...
# extracted from Fedora Security Advisory FEDORA-2024-a047b1ca2d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a047b1ca2d");

  script_name(english:"Fedora 38 : stalld (2024-a047b1ca2d)");
...
FEDORA-2024-a047b1ca2d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a047b1ca2d");
...
var pkgs = [
    {'reference':'stalld-1.19.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
