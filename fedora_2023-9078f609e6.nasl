...
# extracted from Fedora Security Advisory FEDORA-2023-9078f609e6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9078f609e6");

  script_name(english:"Fedora 37 : sudo (2023-9078f609e6)");
...
FEDORA-2023-9078f609e6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9078f609e6");
...
var pkgs = [
    {'reference':'sudo-1.9.12-1.p2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
