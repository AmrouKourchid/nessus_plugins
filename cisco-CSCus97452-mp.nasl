...
might be affected.");
  # https://tools.cisco.com/security/center/viewAlert.x?alertId=39130
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f608cf4a");
...
CSCus97452.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-0758");
