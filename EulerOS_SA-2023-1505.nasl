...
if (description)
{
  ...
  script_cve_id("CVE-2022-2880", "CVE-2022-27664", "CVE-2022-41716");
  script_xref(name:"IAVB", value:"2022-B-0042-S");
  script_xref(name:"IAVB", value:"2022-B-0046-S");

  script_name(english:"EulerOS 2.0 SP5 : golang (EulerOS-SA-2023-1505)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1505
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25739a34");
...
var pkgs = [
  "golang-1.13.3-9.h26.eulerosv2r7",
  "golang-bin-1.13.3-9.h26.eulerosv2r7",
  "golang-src-1.13.3-9.h26.eulerosv2r7"
];
