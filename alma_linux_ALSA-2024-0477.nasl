...
# AlmaLinux Security Advisory ALSA-2024:0477.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:0477");

  script_name(english:"AlmaLinux 9 : frr (ALSA-2024:0477)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:0477 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-0477.html");
...
var pkgs = [
    {'reference':'frr-8.3.1-11.el9_3.2.alma.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'frr-8.3.1-11.el9_3.2.alma.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'frr-selinux-8.3.1-11.el9_3.2.alma.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
