...
# extracted from Fedora Security Advisory FEDORA-2024-0f08e59f25
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0f08e59f25");

  script_name(english:"Fedora 38 : editorconfig (2024-0f08e59f25)");
...
FEDORA-2024-0f08e59f25 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0f08e59f25");
...
var pkgs = [
    {'reference':'editorconfig-0.12.7-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
