...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : python-jinja2 (EulerOS-SA-2024-1634)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1634
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0d90a8dc");
...
var pkgs = [
  "python3-jinja2-3.0.3-1.h2.eulerosv2r11"
];
