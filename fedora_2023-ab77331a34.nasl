...
# extracted from Fedora Security Advisory FEDORA-2023-ab77331a34
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ab77331a34");

  script_name(english:"Fedora 39 : squid (2023-ab77331a34)");
...
FEDORA-2023-ab77331a34 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ab77331a34");
...
var pkgs = [
    {'reference':'squid-6.6-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
