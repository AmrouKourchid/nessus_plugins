...
# extracted from Fedora Security Advisory FEDORA-2024-55603127f3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-55603127f3");
  script_xref(name:"IAVA", value:"2024-A-0416-S");

  script_name(english:"Fedora 40 : exim (2024-55603127f3)");
...
FEDORA-2024-55603127f3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-55603127f3");
...
var pkgs = [
    {'reference':'exim-4.98-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
