...
# extracted from Debian Security Advisory dla-3221. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3221 : node-cached-path-relative - security update");
...
dla-3221 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3221-1                debian-lts@lists.debian.org
    ...
    CVE ID         : CVE-2018-16472 CVE-2021-23518
    Debian Bug     : #1004338
...
number.");
  # https://security-tracker.debian.org/tracker/source-package/node-cached-path-relative
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4504c44");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2018-16472");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-23518");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/node-cached-path-relative");
...
"Upgrade the node-cached-path-relative packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-23518");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:node-cached-path-relative");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'node-cached-path-relative', 'reference': '1.0.1-2+deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'node-cached-path-relative');
}
