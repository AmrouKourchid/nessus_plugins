...
if (description)
{
  ...
  script_cve_id("CVE-2016-0726");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-0726");
...
patch available.
  ...
  - The Fedora Nagios package uses nagiosadmin as the default password for the nagiosadmin administrator
    account, which makes it easier for remote attackers to obtain access by leveraging knowledge of the
    credentials. (CVE-2016-0726)
