...
"The version of Google Chrome installed on the remote macOS host is prior to 112.0.5615.137. It is, therefore, affected
...
google_chrome_check_version(fix:'112.0.5615.137', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
