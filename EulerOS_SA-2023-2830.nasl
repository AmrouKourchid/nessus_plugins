...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : openssl (EulerOS-SA-2023-2830)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2830
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f86c9f42");
...
var pkgs = [
  "openssl-1.1.1m-2.h28.eulerosv2r11",
  "openssl-libs-1.1.1m-2.h28.eulerosv2r11",
  "openssl-perl-1.1.1m-2.h28.eulerosv2r11"
];
