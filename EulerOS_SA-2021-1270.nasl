...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : openssh (EulerOS-SA-2021-1270)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1270
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?246a4495");
...
pkgs = ["openssh-8.2p1-2.h17.eulerosv2r9",
        "openssh-clients-8.2p1-2.h17.eulerosv2r9",
        "openssh-server-8.2p1-2.h17.eulerosv2r9"];
