...
# extracted from VMware Security Advisory PHSA-2021-3.0-0320. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Strongswan PHSA-2021-3.0-0320");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the strongswan package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-320.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'strongswan-5.6.3-5.ph3')) flag++;
