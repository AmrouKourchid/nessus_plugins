...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Apport vulnerabilities (USN-2609-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2609-1 advisory.

    Sander Bos discovered that Apport incorrectly handled permissions when the system was configured to
    generate core dumps for setuid binaries. A local attacker could use this issue to gain elevated
    privileges. (CVE-2015-1324)

    Philip Pettersson discovered that Apport contained race conditions resulting core dumps to be generated
    with incorrect permissions in arbitrary locations. A local attacker could use this issue to gain elevated
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2609-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-1324");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'apport', 'pkgver': '2.14.1-0ubuntu3.11'},
    {'osver': '14.04', 'pkgname': 'apport-gtk', 'pkgver': '2.14.1-0ubuntu3.11'},
    {'osver': '14.04', 'pkgname': 'apport-kde', 'pkgver': '2.14.1-0ubuntu3.11'},
    {'osver': '14.04', 'pkgname': 'apport-noui', 'pkgver': '2.14.1-0ubuntu3.11'},
    {'osver': '14.04', 'pkgname': 'apport-retrace', 'pkgver': '2.14.1-0ubuntu3.11'},
    {'osver': '14.04', 'pkgname': 'apport-valgrind', 'pkgver': '2.14.1-0ubuntu3.11'},
    {'osver': '14.04', 'pkgname': 'dh-apport', 'pkgver': '2.14.1-0ubuntu3.11'},
    {'osver': '14.04', 'pkgname': 'python-apport', 'pkgver': '2.14.1-0ubuntu3.11'},
    {'osver': '14.04', 'pkgname': 'python-problem-report', 'pkgver': '2.14.1-0ubuntu3.11'},
    {'osver': '14.04', 'pkgname': 'python3-apport', 'pkgver': '2.14.1-0ubuntu3.11'},
    {'osver': '14.04', 'pkgname': 'python3-problem-report', 'pkgver': '2.14.1-0ubuntu3.11'}
];
