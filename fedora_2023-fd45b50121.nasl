...
# extracted from Fedora Security Advisory FEDORA-2023-fd45b50121
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fd45b50121");

  script_name(english:"Fedora 37 : mingw-qt5-qtbase (2023-fd45b50121)");
...
FEDORA-2023-fd45b50121 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fd45b50121");
...
var pkgs = [
    {'reference':'mingw-qt5-qtbase-5.15.10-4.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
