...
# extracted from Fedora Security Advisory FEDORA-2023-c7af372e2e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c7af372e2e");
  script_xref(name:"IAVA", value:"2023-A-0491-S");

  script_name(english:"Fedora 38 : firefox (2023-c7af372e2e)");
...
FEDORA-2023-c7af372e2e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c7af372e2e");
...
var pkgs = [
    {'reference':'firefox-117.0.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
