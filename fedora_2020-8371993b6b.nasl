...
# extracted from Fedora Security Advisory FEDORA-2020-8371993b6b.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : python-py (2020-8371993b6b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-8371993b6b");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"python-py-1.10.0-1.fc33")) flag++;
