...
# extracted from Red Hat Security Advisory RHSA-2019:1764. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1764.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1669a169");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1764");
...
"Update the RHEL firefox package based on the guidance in RHSA-2019:1764.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-60.8.0-1.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
