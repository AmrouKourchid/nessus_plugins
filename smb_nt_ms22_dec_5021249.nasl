...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5021249");
  script_xref(name:"MSFT", value:"MS22-5021249");
  ...
  script_name(english:"KB5021249: Windows Server 2022 Security Update (December 2022)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5021249. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5021249");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5021249");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5021249");
