...
# extracted from VMware Security Advisory PHSA-2021-1.0-0427. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-2356");
  script_xref(name:"IAVA", value:"2021-A-0333-S");

  script_name(english:"Photon OS 1.0: Mysql PHSA-2021-1.0-0427");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the mysql package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-427.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'mysql-5.7.35-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'mysql-devel-5.7.35-1.ph1')) flag++;
