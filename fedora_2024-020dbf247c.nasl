...
# extracted from Fedora Security Advisory FEDORA-2024-020dbf247c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-020dbf247c");
  script_xref(name:"IAVB", value:"2024-B-0095-S");

  script_name(english:"Fedora 39 : xen (2024-020dbf247c)");
...
FEDORA-2024-020dbf247c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-020dbf247c");
...
var pkgs = [
    {'reference':'xen-4.17.5-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
