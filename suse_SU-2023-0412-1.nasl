...
# SUSE update advisory SUSE-SU-2023:0412-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0412-1");

  script_name(english:"SUSE SLES15 Security Update : haproxy (SUSE-SU-2023:0412-1)");
...
the SUSE-SU-2023:0412-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013763.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?176c5ae2");
...
var pkgs = [
    {'reference':'haproxy-2.0.14-150100.8.27.1', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.1']}
];
