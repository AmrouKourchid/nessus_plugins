...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5001949");
  script_xref(name:"MSFT", value:"MS21-5001949");
  script_xref(name:"IAVA", value:"2021-A-0320-S");

  script_name(english:"Security Updates for Microsoft Word Products (July 2021)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/kb/5001949");
...
var checks = make_array(
  '16.0', make_nested_list(
    make_array('sp', 0, 'version', '16.0.5188.1000', 'channel', 'MSI', 'kb', '5001949')
  )
);
