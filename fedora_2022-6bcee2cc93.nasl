...
# extracted from Fedora Security Advisory FEDORA-2022-6bcee2cc93
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6bcee2cc93");

  script_name(english:"Fedora 36 : ghc-cmark-gfm (2022-6bcee2cc93)");
...
FEDORA-2022-6bcee2cc93 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6bcee2cc93");
...
var pkgs = [
    {'reference':'ghc-cmark-gfm-0.2.5-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
