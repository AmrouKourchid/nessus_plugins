...
var constraints = [
    ...
    {'max_version' : '2022.4.3', 'fixed_version' : '2023.2.6', 'plugin' : 'Checkmarx Plugin'},
    {'max_version' : '2.6', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Digital.ai App Management Publisher Plugin'},
    {'max_version' : '0.9.3', 'fixed_version' : '0.9.3.1', 'plugin' : 'Dimensions Plugin'},
    {'max_version' : '1.10', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Maven Repository Server Plugin'},
    {'max_version' : '5.0.1', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Sonargraph Integration Plugin'},
    {'max_version' : '2.4.1', 'fixed_version' : '2.4.2', 'plugin' : 'Team Concert Plugin'},
    {'max_version' : '41', 'fixed_display' : 'See vendor advisory', 'plugin' : 'Template Workflows Plugin'}
];
