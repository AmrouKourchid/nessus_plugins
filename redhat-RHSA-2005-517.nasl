...
# extracted from Red Hat Security Advisory RHSA-2005:517. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : HelixPlayer (RHSA-2005:517)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for HelixPlayer.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2005/rhsa-2005_517.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4b6aa5e1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=159871");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:517");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL HelixPlayer package based on the guidance in RHSA-2005:517.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-1766");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'HelixPlayer-1.0.5-0.EL4.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'HelixPlayer-1.0.5-0.EL4.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
