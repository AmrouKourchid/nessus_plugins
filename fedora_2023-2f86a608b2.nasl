...
# extracted from Fedora Security Advisory FEDORA-2023-2f86a608b2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2f86a608b2");

  script_name(english:"Fedora 39 : python3.9 (2023-2f86a608b2)");
...
FEDORA-2023-2f86a608b2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2f86a608b2");
...
var pkgs = [
    {'reference':'python3.9-3.9.18-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
