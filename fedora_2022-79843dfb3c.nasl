...
# extracted from Fedora Security Advisory FEDORA-2022-79843dfb3c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-79843dfb3c");

  script_name(english:"Fedora 37 : mingw-python3 (2022-79843dfb3c)");
...
FEDORA-2022-79843dfb3c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-79843dfb3c");
...
var pkgs = [
    {'reference':'mingw-python3-3.10.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
