...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR 52.x < 52.1 Multiple Vulnerabilities");
...
host is 52.x prior to 52.1. It is, therefore, affected by the
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'52.1', min:'52', severity:SECURITY_HOLE);
