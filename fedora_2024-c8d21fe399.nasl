...
# extracted from Fedora Security Advisory FEDORA-2024-c8d21fe399
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c8d21fe399");

  script_name(english:"Fedora 39 : flatpak (2024-c8d21fe399)");
...
FEDORA-2024-c8d21fe399 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c8d21fe399");
...
var pkgs = [
    {'reference':'flatpak-1.15.8-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
