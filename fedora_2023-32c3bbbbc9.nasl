...
# extracted from Fedora Security Advisory FEDORA-2023-32c3bbbbc9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-32c3bbbbc9");

  script_name(english:"Fedora 37 : ffmpeg (2023-32c3bbbbc9)");
...
FEDORA-2023-32c3bbbbc9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-32c3bbbbc9");
...
var pkgs = [
    {'reference':'ffmpeg-5.1.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
