...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : bluez (EulerOS-SA-2021-2357)");
...
vulnerability :
  ...
  - In BlueZ before 5.55, a double free was found in the
    ...
    due to a redundant disconnect MGMT event.
    (CVE-2020-27153)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2357
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0d958526");
...
pkgs = ["bluez-5.44-4.h4",
        "bluez-libs-5.44-4.h4"];
