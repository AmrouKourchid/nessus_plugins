...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : glusterfs (EulerOS-SA-2018-1442)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1442
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9061bc08");
...
pkgs = ["glusterfs-3.8.4-54.15.h1",
        "glusterfs-api-3.8.4-54.15.h1",
        "glusterfs-client-xlators-3.8.4-54.15.h1",
        "glusterfs-fuse-3.8.4-54.15.h1",
        "glusterfs-libs-3.8.4-54.15.h1",
        "glusterfs-rdma-3.8.4-54.15.h1"];
