...
# extracted from Oracle Linux Security Advisory ELSA-2022-5250.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : libxml2 (ELSA-2022-5250)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-5250.html");
...
var pkgs = [
    ...
    {'reference':'python3-libxml2-2.9.13-1.el9_0.1', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
