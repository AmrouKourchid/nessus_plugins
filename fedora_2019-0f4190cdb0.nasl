...
# extracted from Fedora Security Advisory FEDORA-2019-0f4190cdb0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : openssh (2019-0f4190cdb0)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"New upstream release with significantly reworked PKCS#11 support,
GSSAPI key exchange and several fixes for CVE-2019-6111 and
CVE-2019-6109
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-0f4190cdb0");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"openssh-8.0p1-1.fc30")) flag++;
