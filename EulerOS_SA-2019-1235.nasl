...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : openssh (EulerOS-SA-2019-1235)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1235
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bec46c45");
...
pkgs = ["openssh-7.4p1-16.h5",
        "openssh-clients-7.4p1-16.h5",
        "openssh-keycat-7.4p1-16.h5",
        "openssh-server-7.4p1-16.h5",
