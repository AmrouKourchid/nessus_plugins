...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2024-A-0481-S");

  script_name(english:"Adobe Substance 3D Sampler < 4.5.1 Multiple Vulnerabilities (apsb24-65)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Substance 3D Sampler installed on the remote host is prior to 4.5.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the apsb24-65 advisory.

  - Substance3D - Sampler versions 4.5 and earlier are affected by an out-of-bounds read vulnerability that
    ...
    a malicious file. (CVE-2024-41860, CVE-2024-41861, CVE-2024-41862, CVE-2024-41863)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://helpx.adobe.com/security/products/substance3d-sampler/apsb24-65.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9b1535f");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe Substance 3D Sampler version 4.5.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-41863");
