...
if (description)
{
  ...
  script_cve_id("CVE-2024-35943");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-35943");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: pmdomain: ti: Add a null pointer check
    to the omap_prm_domain_init devm_kasprintf() returns a pointer to dynamically allocated memory which can
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-35943");
