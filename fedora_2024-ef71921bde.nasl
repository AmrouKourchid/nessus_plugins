...
# extracted from Fedora Security Advisory FEDORA-2024-ef71921bde
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ef71921bde");

  script_name(english:"Fedora 39 : python-tqdm (2024-ef71921bde)");
...
FEDORA-2024-ef71921bde advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ef71921bde");
...
var pkgs = [
    {'reference':'python-tqdm-4.66.4-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
