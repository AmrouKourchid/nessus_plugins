...
# extracted from Red Hat Security Advisory kubernetes_api_server. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : kubernetes_api_server (Unpatched Vulnerability) (deprecated)");
