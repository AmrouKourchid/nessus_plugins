...
# extracted from Fedora Security Advisory FEDORA-2025-18cb3f852d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-18cb3f852d");

  script_name(english:"Fedora 41 : openssh (2025-18cb3f852d)");
...
FEDORA-2025-18cb3f852d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-18cb3f852d");
...
var pkgs = [
    {'reference':'openssh-9.9p1-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
