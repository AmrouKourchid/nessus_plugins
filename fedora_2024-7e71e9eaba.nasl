...
# extracted from Fedora Security Advisory FEDORA-2024-7e71e9eaba
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7e71e9eaba");
  script_xref(name:"IAVA", value:"2024-A-0174-S");
  script_xref(name:"IAVA", value:"2024-A-0245-S");

  script_name(english:"Fedora 38 : firefox (2024-7e71e9eaba)");
...
FEDORA-2024-7e71e9eaba advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7e71e9eaba");
...
var pkgs = [
    {'reference':'firefox-124.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
