...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libjpeg-turbo (EulerOS-SA-2021-1085)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1085
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be54979b");
...
pkgs = ["libjpeg-turbo-1.2.90-5.h7",
        "libjpeg-turbo-devel-1.2.90-5.h7"];
