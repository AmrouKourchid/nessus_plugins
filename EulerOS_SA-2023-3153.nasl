...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : qemu (EulerOS-SA-2023-3153)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3153
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ac62141");
...
var pkgs = [
  "qemu-img-3.0.1-3.h12.eulerosv2r8"
];
