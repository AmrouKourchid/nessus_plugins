...
# extracted from F5 Networks BIG-IP Solution K35040315.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : glibc vulnerability (K35040315)");
...
vulnerability as referenced in the K35040315 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K35040315");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K35040315.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '15.1.0-15.1.10','14.0.0-14.1.5','13.0.0-13.1.5','12.1.0-12.1.6','11.5.1-11.6.5'
    ],
    'unaffected': [
      '16.0.0'
    ],
