...
# extracted from Gentoo Linux Security Advisory GLSA 202210-39.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202210-39 : libxml2: Multiple Vulnerabilities");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202210-39");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=877149");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 2.10.3", "lt 2.0.0"),
    'vulnerable' : make_list("lt 2.10.3")
  }
];
