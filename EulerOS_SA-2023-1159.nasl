...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : wayland (EulerOS-SA-2023-1159)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1159
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ab8b856");
...
var pkgs = [
  "wayland-1.17.0-2.h2.eulerosv2r10"
];
