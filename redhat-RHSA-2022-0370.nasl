...
# extracted from Red Hat Security Advisory RHSA-2022:0370. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0370");

  script_name(english:"RHEL 8 : cryptsetup (RHSA-2022:0370)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for cryptsetup.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:0370 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0370.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2898b32");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0370");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2032401");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cryptsetup package based on the guidance in RHSA-2022:0370.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cryptsetup-2.3.3-4.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cryptsetup-devel-2.3.3-4.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cryptsetup-libs-2.3.3-4.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cryptsetup-reencrypt-2.3.3-4.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'integritysetup-2.3.3-4.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'veritysetup-2.3.3-4.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
