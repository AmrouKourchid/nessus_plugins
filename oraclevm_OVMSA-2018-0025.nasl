...
# Security Advisory OVMSA-2018-0025.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.4 : qemu-kvm (OVMSA-2018-0025)");
...
critical security updates :
  ...
  - Resolves: bz#1501296 &nbsp  (CVE-2017-15289 qemu-kvm:
    Qemu: cirrus: OOB access issue in mode4and5 write
    functions [rhel-6.9.z])");
  # https://oss.oracle.com/pipermail/oraclevm-errata/2018-March/000836.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b0ef9752");
...
flag = 0;
if (rpm_check(release:"OVS3.4", reference:"qemu-img-0.12.1.2-2.503.el6_9.5")) flag++;
