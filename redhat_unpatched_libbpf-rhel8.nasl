...
# extracted from Red Hat Security Advisory libbpf. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-45940", "CVE-2021-45941", "CVE-2022-3606");

  script_name(english:"RHEL 8 : libbpf (Unpatched Vulnerability) (deprecated)");
