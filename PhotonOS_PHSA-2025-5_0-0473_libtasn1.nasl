...
# extracted from VMware Security Advisory PHSA-2025-5.0-0473. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libtasn1 PHSA-2025-5.0-0473");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libtasn1 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-473.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libtasn1-4.19.0-4.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libtasn1-devel-4.19.0-4.ph5')) flag++;
