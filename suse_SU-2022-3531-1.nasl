...
# SUSE update advisory SUSE-SU-2022:3531-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3531-1");

  script_name(english:"SUSE SLES15 Security Update : squid (SUSE-SU-2022:3531-1)");
...
referenced in the SUSE-SU-2022:3531-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-October/012509.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a7a6215");
...
var pkgs = [
    {'reference':'squid-5.7-150400.3.6.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'squid-5.7-150400.3.6.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-server-applications-release-15.4', 'sles-release-15.4']}
];
