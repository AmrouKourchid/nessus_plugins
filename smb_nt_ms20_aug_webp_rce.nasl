...
"Upgrade to app version 1.0.31251.0 or later via the Microsoft Store.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:microsoft:webp_image_extension");
...
var app = 'Microsoft.WebpImageExtension';
var win_port = get_kb_item('SMB/transport');
if (!win_port) win_port = 445;

get_install_count(app_name:app, exit_if_zero:TRUE);

var app_info = vcf::get_app_info(app:app, port:win_port);
