...
if (description)
{
  ...
  script_cve_id("CVE-2013-2000");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-2000");
...
patch available.
  ...
  - Multiple buffer overflows in X.org libXxf86dga 1.1.3 and earlier allow X servers to cause a denial of
    ...
    XDGAQueryModes and (2) XDGASetMode functions. (CVE-2013-2000)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-2000");
