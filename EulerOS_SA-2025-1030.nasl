...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : python-urllib3 (EulerOS-SA-2025-1030)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1030
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5139bb68");
...
var pkgs = [
  "python3-urllib3-1.25.9-1.h10.eulerosv2r10"
];
