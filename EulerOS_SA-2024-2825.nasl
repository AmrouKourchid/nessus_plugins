...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : curl (EulerOS-SA-2024-2825)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2825
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b648209e");
...
var pkgs = [
  "curl-7.69.1-2.h28.eulerosv2r9",
  "libcurl-7.69.1-2.h28.eulerosv2r9"
];
