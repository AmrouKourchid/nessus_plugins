...
# extracted from Fedora Security Advisory FEDORA-2024-71c2c6526c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-71c2c6526c");

  script_name(english:"Fedora 38 : putty (2024-71c2c6526c)");
...
FEDORA-2024-71c2c6526c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-71c2c6526c");
...
var pkgs = [
    {'reference':'putty-0.80-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
