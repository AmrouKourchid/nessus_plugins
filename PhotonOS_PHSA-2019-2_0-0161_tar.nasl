...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Tar PHSA-2019-2.0-0161");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'tar-1.29-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'tar-debuginfo-1.29-3.ph2')) flag++;
