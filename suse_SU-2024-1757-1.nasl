...
# SUSE update advisory SUSE-SU-2024:1757-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:1757-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 19 for SLE 15 SP4) (SUSE-SU-2024:1757-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2024:1757-1 advisory.
    ...
    - CVE-2023-6546: Fixed a race condition that could lead to a use-after-free in the GSM 0710 tty
    multiplexor (bsc#1222685).
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2024-May/035341.html");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.24.92-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_92-default-8-150400.2.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      },
      '5.14.21-150500.55.28-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150500_55_28-default-9-150500.2.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.5']}
        ]
      }
    }
  }
