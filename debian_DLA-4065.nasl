...
# extracted from Debian Security Advisory dla-4065. The text
...
if (description)
{
  script_id(216673);
  script_version("1.1");
  script_set_attribute(attribute:"plugin_modification_date", value:"2025/02/23");

  script_cve_id("CVE-2025-24528");

  script_name(english:"Debian dla-4065 : krb5-admin-server - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4065
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-24528");
...
"Upgrade the krb5-admin-server packages.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2025/02/23");
  script_set_attribute(attribute:"plugin_publication_date", value:"2025/02/23");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'krb5-admin-server', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'krb5-doc', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'krb5-gss-samples', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'krb5-k5tls', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'krb5-kdc', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'krb5-kdc-ldap', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'krb5-kpropd', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'krb5-locales', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'krb5-multidev', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'krb5-otp', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'krb5-pkinit', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'krb5-user', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'libgssapi-krb5-2', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'libgssrpc4', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'libk5crypto3', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'libkadm5clnt-mit12', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'libkadm5srv-mit12', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'libkdb5-10', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'libkrad-dev', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'libkrad0', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'libkrb5-3', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'libkrb5-dbg', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'libkrb5-dev', 'reference': '1.18.3-6+deb11u6'},
    {'release': '11.0', 'prefix': 'libkrb5support0', 'reference': '1.18.3-6+deb11u6'}
];
