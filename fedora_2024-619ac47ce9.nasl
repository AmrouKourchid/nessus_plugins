...
# extracted from Fedora Security Advisory FEDORA-2024-619ac47ce9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-619ac47ce9");

  script_name(english:"Fedora 40 : python-cbor2 (2024-619ac47ce9)");
...
FEDORA-2024-619ac47ce9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-619ac47ce9");
...
var pkgs = [
    {'reference':'python-cbor2-5.6.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
