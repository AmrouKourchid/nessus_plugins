...
# extracted from Fedora Security Advisory FEDORA-2023-1254a1fc28
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1254a1fc28");

  script_name(english:"Fedora 36 : tor (2023-1254a1fc28)");
...
FEDORA-2023-1254a1fc28 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1254a1fc28");
...
var pkgs = [
    {'reference':'tor-0.4.7.13-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
