...
if (description)
{
  ...
  script_cve_id("CVE-2017-18210");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-18210");
...
patch available.
  ...
  - In ImageMagick 7.0.7, a NULL pointer dereference vulnerability was found in the function
    BenchmarkOpenCLDevices in MagickCore/opencl.c because a memory allocation result is not checked.
    (CVE-2017-18210)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-18210");
