...
# SUSE update advisory SUSE-SU-2022:1650-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:1650-1");
  script_xref(name:"IAVA", value:"2024-A-0327");

  script_name(english:"SUSE SLES12 Security Update : gzip (SUSE-SU-2022:1650-1)");
...
in the SUSE-SU-2022:1650-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-May/010998.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?82b8c4d8");
...
var pkgs = [
    {'reference':'gzip-1.10-4.14.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'gzip-1.10-4.14.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
