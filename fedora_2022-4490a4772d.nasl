...
# extracted from Fedora Security Advisory FEDORA-2022-4490a4772d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-4490a4772d");

  script_name(english:"Fedora 35 : php-twig (2022-4490a4772d)");
...
FEDORA-2022-4490a4772d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-4490a4772d");
...
var pkgs = [
    {'reference':'php-twig-1.44.7-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
