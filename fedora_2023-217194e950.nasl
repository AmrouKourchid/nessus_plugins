...
# extracted from Fedora Security Advisory FEDORA-2023-217194e950
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-217194e950");

  script_name(english:"Fedora 39 : roundcubemail (2023-217194e950)");
...
FEDORA-2023-217194e950 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-217194e950");
...
var pkgs = [
    {'reference':'roundcubemail-1.6.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
