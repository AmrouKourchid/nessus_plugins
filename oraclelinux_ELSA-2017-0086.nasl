...
ELSA-2017-0086 advisory.
    ...
    - [net] sctp: keep fragmentation point aligned to word size (Hangbin Liu) [1399458 1399459]
    {CVE-2016-9555}
    - [net] tcp: fix use after free in tcp_xmit_retransmit_queue() (Mateusz Guzik) [1379530 1379531]
    {CVE-2016-6828}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-514.6.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
