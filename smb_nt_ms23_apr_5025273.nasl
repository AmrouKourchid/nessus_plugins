...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5025271");
  script_xref(name:"MSKB", value:"5025273");
  script_xref(name:"MSFT", value:"MS23-5025271");
  script_xref(name:"MSFT", value:"MS23-5025273");
  ...
  script_name(english:"KB5025273: Windows Server 2008 Security Update (April 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5025273. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5025271");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5025273");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5025273 or Cumulative Update 5025271");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'04_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5025273, 5025271])
)
{
