...
if (description)
{
  ...
  script_name(english:"WinZip SEoL (25.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of WinZip is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, WinZip is 25.0.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of WinZip that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2023/09/12");
...
var constraints = [
  { max_branch : '25.0', min_branch : '25.0', seol : 20230912 }
];
