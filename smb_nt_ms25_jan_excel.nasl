...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002673");
  script_xref(name:"MSFT", value:"MS25-5002673");
  script_xref(name:"IAVA", value:"2025-A-0032-S");

  script_name(english:"Security Updates for Microsoft Excel Products (January 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Excel Products are missing a security update.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Excel Products are missing a security update. It is, therefore, affected by a remote code execution
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002673");
...
var constraints = [
  { 'kb':'5002673', 'channel':'MSI', 'fixed_version': '16.0.5483.1000', 'sp' : 0}
];
