...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : graphviz (EulerOS-SA-2024-1590)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the graphviz package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1590
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c663bee");
...
var pkgs = [
  "graphviz-2.44.0-1.h5.eulerosv2r10"
];
