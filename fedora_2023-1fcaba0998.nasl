...
# extracted from Fedora Security Advisory FEDORA-2023-1fcaba0998
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1fcaba0998");

  script_name(english:"Fedora 38 : mediawiki (2023-1fcaba0998)");
...
FEDORA-2023-1fcaba0998 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1fcaba0998");
...
"Update the affected mediawiki package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-36675");
...
var pkgs = [
    {'reference':'mediawiki-1.39.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
