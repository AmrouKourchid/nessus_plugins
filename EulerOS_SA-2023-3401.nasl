...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libtiff (EulerOS-SA-2023-3401)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3401
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d06ee17");
...
var pkgs = [
  "libtiff-4.0.3-27.h45.eulerosv2r7",
  "libtiff-devel-4.0.3-27.h45.eulerosv2r7"
];
