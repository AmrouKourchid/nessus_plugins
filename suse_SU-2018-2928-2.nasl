...
# extracted from SUSE update advisory SUSE-SU-2018:2928-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : openssl (SUSE-SU-2018:2928-2)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20182928-2/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?496c3ed2");
...
SUSE-SLE-SERVER-12-SP2-BCL-2018-2069=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl-devel-1.0.2j-60.39.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl1_0_0-1.0.2j-60.39.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl1_0_0-32bit-1.0.2j-60.39.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl1_0_0-debuginfo-1.0.2j-60.39.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl1_0_0-debuginfo-32bit-1.0.2j-60.39.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl1_0_0-hmac-1.0.2j-60.39.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl1_0_0-hmac-32bit-1.0.2j-60.39.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"openssl-1.0.2j-60.39.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"openssl-debuginfo-1.0.2j-60.39.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"openssl-debugsource-1.0.2j-60.39.1")) flag++;
