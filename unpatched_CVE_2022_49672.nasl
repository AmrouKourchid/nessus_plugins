...
if (description)
{
  ...
  script_cve_id("CVE-2022-49672");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49672");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: net: tun: unlink NAPI from device on
    destruction Syzbot found a race between tun file and device destruction. NAPIs live in struct tun_file
    which can get destroyed before the netdev so we have to del them explicitly. The current code is missing
    deleting the NAPI if the queue was detached first. (CVE-2022-49672)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49672");
