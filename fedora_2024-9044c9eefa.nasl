...
# extracted from Fedora Security Advisory FEDORA-2024-9044c9eefa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9044c9eefa");

  script_name(english:"Fedora 38 : runc (2024-9044c9eefa)");
...
FEDORA-2024-9044c9eefa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9044c9eefa");
...
var pkgs = [
    {'reference':'runc-1.1.12-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
