...
if (description)
{
  ...
  script_cve_id("CVE-2015-5213");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-5213");
...
patch available.
  ...
  - Integer overflow in LibreOffice before 4.4.5 and Apache OpenOffice before 4.1.2 allows remote attackers to
    cause a denial of service (memory corruption and application crash) or possibly execute arbitrary code via
    a long DOC file, which triggers a buffer overflow. (CVE-2015-5213)
