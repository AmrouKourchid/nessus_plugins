...
# extracted from Oracle Linux Security Advisory ELSA-2023-6542.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : perl-HTTP-Tiny (ELSA-2023-6542)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6542.html");
...
var pkgs = [
    {'reference':'perl-HTTP-Tiny-0.076-461.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
