...
# Rocky Linux Security Advisory RLSA-2024:7136.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:7136");
  script_xref(name:"IAVB", value:"2024-B-0132-S");

  script_name(english:"Rocky Linux 9 : git-lfs (RLSA-2024:7136)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:7136");
...
var pkgs = [
    {'reference':'git-lfs-3.4.1-4.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-3.4.1-4.el9_4', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-3.4.1-4.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-debuginfo-3.4.1-4.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-debuginfo-3.4.1-4.el9_4', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-debuginfo-3.4.1-4.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-debugsource-3.4.1-4.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-debugsource-3.4.1-4.el9_4', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'git-lfs-debugsource-3.4.1-4.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
