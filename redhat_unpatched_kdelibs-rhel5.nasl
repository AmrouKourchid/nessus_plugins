...
# extracted from Red Hat Security Advisory kdelibs. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2009-2702", "CVE-2013-2074", "CVE-2017-6410");

  script_name(english:"RHEL 5 : kdelibs (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2017-6410");
