...
# extracted from Fedora Security Advisory FEDORA-2023-75b22000cd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-75b22000cd");

  script_name(english:"Fedora 38 : kernel (2023-75b22000cd)");
...
FEDORA-2023-75b22000cd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-75b22000cd");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-75b22000cd');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.3.7-200.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
