...
if (description)
{
  ...
  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.15.10 (RHSA-2024:1892)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.15.10.");
...
in the RHSA-2024:1892 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.15.10. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3bc1cf70");
...
"Update the RHEL OpenShift Container Platform 4.15.10 packages based on the guidance in RHSA-2024:1892.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.15.0-202404151212.p0.g8974577.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.15.0-202404151212.p0.g8974577.assembly.stream.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
