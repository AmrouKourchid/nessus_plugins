...
# extracted from Fedora Security Advisory FEDORA-2024-727ecb90c7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-727ecb90c7");

  script_name(english:"Fedora 40 : php-bartlett-PHP-CompatInfo (2024-727ecb90c7)");
...
FEDORA-2024-727ecb90c7 advisory.
    ...
    **bartlett/php-compatinfo-db  6.11.1** - 2024-10-04
    ...
    - PHAR distribution was broken (reason is [issue](https://github.com/llaville/box-manifest/issues/13)
      ...
      Solved now, we use the final stable version [4.0.0](https://github.com/llaville/box-
    manifest/releases/tag/4.0.0)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-727ecb90c7");
  script_set_attribute(attribute:"solution", value:
"Update the affected php-bartlett-PHP-CompatInfo package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50342");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:php-bartlett-PHP-CompatInfo");
...
var pkgs = [
    {'reference':'php-bartlett-PHP-CompatInfo-7.1.4-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'php-bartlett-PHP-CompatInfo');
}
