...
# extracted from Red Hat Security Advisory RHSA-2024:9442. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9442");

  script_name(english:"RHEL 9 : mingw-glib2 (RHSA-2024:9442)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9442.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89766809");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9442");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mingw-glib2 package based on the guidance in RHSA-2024:9442.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mingw32-glib2-2.78.6-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-glib2-static-2.78.6-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-glib2-2.78.6-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-glib2-static-2.78.6-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
