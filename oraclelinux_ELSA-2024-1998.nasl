...
# extracted from Oracle Linux Security Advisory ELSA-2024-1998.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libreswan (ELSA-2024-1998)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1998.html");
...
var pkgs = [
    {'reference':'libreswan-4.12-2.0.1.el8_9.2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libreswan-4.12-2.0.1.el8_9.2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
