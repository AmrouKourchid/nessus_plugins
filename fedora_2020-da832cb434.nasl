...
# extracted from Fedora Security Advisory FEDORA-2020-da832cb434.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : curl (2020-da832cb434)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-da832cb434");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"curl-7.69.1-5.fc32")) flag++;
