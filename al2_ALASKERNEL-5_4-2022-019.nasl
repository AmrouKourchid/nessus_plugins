...
vulnerabilities as referenced in the ALAS2KERNEL-5.4-2022-019 advisory.
    ...
    A flaw was found in the JFS filesystem code. This flaw allows a local attacker with the ability to set
    extended attributes to panic the system, causing memory corruption or escalating privileges. The highest
    ...
    A locking inconsistency issue was discovered in the tty subsystem of the Linux kernel. A local user could
    use this flaw to read numerical value from memory after free. (CVE-2020-29660)
