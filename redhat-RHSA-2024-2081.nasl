...
# extracted from Red Hat Security Advisory RHSA-2024:2081. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2081");

  script_name(english:"RHEL 8 : libreswan (RHSA-2024:2081)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2081.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71cba65e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2081");
...
"Update the RHEL libreswan package based on the guidance in RHSA-2024:2081.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.9-3.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
