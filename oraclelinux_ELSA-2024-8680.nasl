...
# extracted from Oracle Linux Security Advisory ELSA-2024-8680.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : mod_http2 (ELSA-2024-8680)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-8680.html");
...
var pkgs = [
    {'reference':'mod_http2-2.0.26-2.el9_4.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_http2-2.0.26-2.el9_4.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
