...
# extracted from Fedora Security Advisory FEDORA-2019-d79f89346c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : 2:vim (2019-d79f89346c)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d79f89346c");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"vim-8.1.1471-1.fc30", epoch:"2")) flag++;
