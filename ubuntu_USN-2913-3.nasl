...
# extracted from Ubuntu Security Notice USN-2913-3. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2913-3");

  script_name(english:"Ubuntu 14.04 LTS : OpenSSL update (USN-2913-3)");
...
USN-2913-3 advisory.
    ...
    for alternate certificate chains to the OpenSSL package to properly handle the removal.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2913-3");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libcrypto1.0.0-udeb', 'pkgver': '1.0.1f-1ubuntu2.17'},
    {'osver': '14.04', 'pkgname': 'libssl-dev', 'pkgver': '1.0.1f-1ubuntu2.17'},
    {'osver': '14.04', 'pkgname': 'libssl1.0.0', 'pkgver': '1.0.1f-1ubuntu2.17'},
    {'osver': '14.04', 'pkgname': 'libssl1.0.0-udeb', 'pkgver': '1.0.1f-1ubuntu2.17'},
    {'osver': '14.04', 'pkgname': 'openssl', 'pkgver': '1.0.1f-1ubuntu2.17'}
];
