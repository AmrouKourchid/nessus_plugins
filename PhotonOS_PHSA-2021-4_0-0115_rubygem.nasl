...
if (description)
{
  ...
  script_cve_id("CVE-2021-41098");

  script_name(english:"Photon OS 4.0: Rubygem PHSA-2021-4.0-0115");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-41098");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'rubygem-nokogiri-1.12.5-1.ph4')) flag++;
