...
# extracted from Red Hat Security Advisory RHSA-2024:8357. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8357");

  script_name(english:"RHEL 7 : NetworkManager-libreswan (RHSA-2024:8357)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for NetworkManager-libreswan.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:8357 advisory.

    This package contains software for integrating the libreswan VPN software with NetworkManager and the
    GNOME desktop
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8357.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?781eb9f4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8357");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL NetworkManager-libreswan package based on the guidance in RHSA-2024:8357.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'NetworkManager-libreswan-1.2.4-4.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'NetworkManager-libreswan-1.2.4-4.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'NetworkManager-libreswan-1.2.4-4.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'NetworkManager-libreswan-1.2.4-4.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'NetworkManager-libreswan-gnome-1.2.4-4.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'NetworkManager-libreswan-gnome-1.2.4-4.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'NetworkManager-libreswan-gnome-1.2.4-4.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'NetworkManager-libreswan-gnome-1.2.4-4.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'NetworkManager-libreswan / NetworkManager-libreswan-gnome');
}
