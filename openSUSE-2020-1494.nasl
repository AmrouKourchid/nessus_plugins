...
# extracted from openSUSE Security Update openSUSE-2020-1494.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : curl (openSUSE-2020-1494)");
...
if ( rpm_check(release:"SUSE15.2", reference:"curl-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"curl-debuginfo-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"curl-debugsource-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"curl-mini-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"curl-mini-debuginfo-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"curl-mini-debugsource-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcurl-devel-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcurl-mini-devel-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcurl4-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcurl4-debuginfo-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcurl4-mini-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcurl4-mini-debuginfo-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libcurl-devel-32bit-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libcurl4-32bit-7.66.0-lp152.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libcurl4-32bit-debuginfo-7.66.0-lp152.3.9.1") ) flag++;
