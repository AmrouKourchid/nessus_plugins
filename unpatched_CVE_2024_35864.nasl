...
if (description)
{
  ...
  script_cve_id("CVE-2024-35864");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-35864");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: smb: client: fix potential UAF in
    smb2_is_valid_lease_break() Skip sessions that are being teared down (status == SES_EXITING) to avoid UAF.
    (CVE-2024-35864)
