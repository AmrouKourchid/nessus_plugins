...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-0807.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected hypervkvpd package.");
...
var pkgs = [
    {'reference':'hypervkvpd-0-0.7.0.1.el5_9.3', 'cpu':'i686', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'hypervkvpd-0-0.7.0.1.el5_9.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
