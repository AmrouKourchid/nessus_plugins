...
# extracted from openSUSE Security Update openSUSE-2019-275.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : kernel-firmware (openSUSE-2019-275)");

  script_set_attribute(attribute:"synopsis", value:
"The remote openSUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This update for kernel-firmware fixes the following issues: Security
issue fixed :

  - CVE-2018-5383: Fixed an implementation issue in
    Bluetooth where the eliptic curve parameters were not
    sufficiently validated during Diffie-Hellman key
    exchange (bsc#1104301). This update was imported from
    the SUSE:SLE-12-SP2:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1104301");
...
if ( rpm_check(release:"SUSE42.3", reference:"kernel-firmware-20170530-26.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ucode-amd-20170530-26.1") ) flag++;
