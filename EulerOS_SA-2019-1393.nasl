...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.1.0 : libssh2 (EulerOS-SA-2019-1393)");
...
affected by the following vulnerabilities :
  ...
  - An integer overflow flaw which could lead to an out of
    ...
    system when a user connects to the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1393
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef1232f4");
