...
# extracted from Fedora Security Advisory FEDORA-2023-0ab3a5423f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0ab3a5423f");

  script_name(english:"Fedora 37 : java-11-openjdk-portable (2023-0ab3a5423f)");
...
FEDORA-2023-0ab3a5423f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0ab3a5423f");
...
var pkgs = [
    {'reference':'java-11-openjdk-portable-11.0.19.0.7-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
