...
# extracted from VMware Security Advisory PHSA-2021-1.0-0418. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Apache PHSA-2021-1.0-0418");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the apache package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-418.md");
...
if (rpm_check(release:'PhotonOS-1.0', reference:'apache-ant-1.10.8-4.ph1')) flag++;
