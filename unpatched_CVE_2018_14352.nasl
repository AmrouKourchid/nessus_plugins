...
if (description)
{
  ...
  script_cve_id("CVE-2018-14352");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-14352");
...
patch available.
  ...
  - An issue was discovered in Mutt before 1.10.1 and NeoMutt before 2018-07-16. imap_quote_string in
    imap/util.c does not leave room for quote characters, leading to a stack-based buffer overflow.
    (CVE-2018-14352)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-14352");
