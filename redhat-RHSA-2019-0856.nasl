...
# extracted from Red Hat Security Advisory RHSA-2019:0856. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2019-3868");
  script_xref(name:"RHSA", value:"2019:0856");

  script_name(english:"RHEL 7 : Red Hat Single Sign-On 7.2.7 security update on RHEL 7 (Moderate) (RHSA-2019:0856)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat Single Sign-On 7.2.7.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:0856 advisory.
    ...
    This release of Red Hat Single Sign-On 7.2.7 serves as a replacement for Red Hat Single Sign-On 7.2.6, and
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0856.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d370c32");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0856");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1679144");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/JBEAP-16660");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Single Sign-On 7.2.7 package based on the guidance in RHSA-2019:0856.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:H/UI:N/S:U/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-3868");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-sso7-keycloak-3.4.17-1.Final_redhat_00001.1.jbcs.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'},
      {'reference':'rh-sso7-keycloak-server-3.4.17-1.Final_redhat_00001.1.jbcs.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'}
    ]
  }
];
