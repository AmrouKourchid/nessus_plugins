...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5025272");
  script_xref(name:"MSKB", value:"5025287");
  script_xref(name:"MSFT", value:"MS23-5025272");
  script_xref(name:"MSFT", value:"MS23-5025287");
  ...
  script_name(english:"KB5025272: Windows Server 2012 Security Update (April 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5025272. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5025272");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5025287");
...
if (
  smb_check_rollup(os:'6.2',
                   ...
                   rollup_date:'04_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5025287, 5025272])
)
{
