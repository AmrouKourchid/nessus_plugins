...
# extracted from Fedora Security Advisory FEDORA-2022-076b1c9978
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-076b1c9978");

  script_name(english:"Fedora 37 : freerdp (2022-076b1c9978)");
...
FEDORA-2022-076b1c9978 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-076b1c9978");
...
var pkgs = [
    {'reference':'freerdp-2.9.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
