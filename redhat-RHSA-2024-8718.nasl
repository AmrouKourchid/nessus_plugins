...
# extracted from Red Hat Security Advisory RHSA-2024:8718. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8718");

  script_name(english:"RHEL 8 : Satellite 6.14.4.3 Async Update (Important) (RHSA-2024:8718)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:8718 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6e38faca");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8718.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7324baca");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8718");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'foreman-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']},
      {'reference':'foreman-cli-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']},
      {'reference':'foreman-debug-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']},
      {'reference':'foreman-dynflow-sidekiq-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']},
      {'reference':'foreman-ec2-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']},
      {'reference':'foreman-journald-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']},
      {'reference':'foreman-libvirt-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']},
      {'reference':'foreman-openstack-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']},
      {'reference':'foreman-ovirt-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']},
      {'reference':'foreman-postgresql-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']},
      {'reference':'foreman-redis-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']},
      {'reference':'foreman-service-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']},
      {'reference':'foreman-telemetry-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']},
      {'reference':'foreman-vmware-3.7.0.14-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-8553']}
    ]
  },
  {
    'repo_relative_urls': [
