...
# extracted from Oracle Linux Security Advisory ELSA-2015-1064.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 / 7 : python27 (ELSA-2015-1064)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 6 / 7 host has packages installed that are affected by multiple vulnerabilities as referenced in
the ELSA-2015-1064 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-1064.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27-python");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27-python-debug");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27-python-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27-python-libs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27-python-pip");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27-python-setuptools");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27-python-simplejson");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27-python-test");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27-python-tools");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27-python-wheel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27-runtime");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27-scldevel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python27-tkinter");
...
var pkgs = [
    ...
    {'reference':'python27-python-pip-1.5.6-5.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-python-setuptools-0.9.8-3.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'python27-python-wheel-0.24.0-2.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'python27-python-pip-1.5.6-5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-python-setuptools-0.9.8-5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'python27-python-wheel-0.24.0-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
