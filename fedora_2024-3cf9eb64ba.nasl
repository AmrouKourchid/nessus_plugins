...
# extracted from Fedora Security Advisory FEDORA-2024-3cf9eb64ba
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3cf9eb64ba");

  script_name(english:"Fedora 39 : amavis (2024-3cf9eb64ba)");
...
FEDORA-2024-3cf9eb64ba advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3cf9eb64ba");
  script_set_attribute(attribute:"solution", value:
"Update the affected amavis package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:amavis");
...
var pkgs = [
    {'reference':'amavis-2.13.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'amavis');
}
