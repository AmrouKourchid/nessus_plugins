...
# extracted from Fedora Security Advisory FEDORA-2025-5e9faa5173
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-5e9faa5173");

  script_name(english:"Fedora 41 : mingw-poppler (2025-5e9faa5173)");
...
FEDORA-2025-5e9faa5173 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-5e9faa5173");
...
var pkgs = [
    {'reference':'mingw-poppler-24.02.0-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
