...
# extracted from Fedora Security Advisory FEDORA-2021-d5b2c18fe6
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : 1:nodejs (2021-d5b2c18fe6)");
...
FEDORA-2021-d5b2c18fe6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-d5b2c18fe6");
...
pkgs = [
    {'reference':'nodejs-12.20.1-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
