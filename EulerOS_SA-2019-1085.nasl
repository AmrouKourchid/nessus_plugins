...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.2 : wget (EulerOS-SA-2019-1085)");
...
following vulnerability :
  ...
  - GNU Wget before 1.19.5 is prone to a cookie injection
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1085
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a5cf40b4");
