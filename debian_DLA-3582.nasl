...
# extracted from Debian Security Advisory dla-3582. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3582 : ghostscript - security update");
...
dla-3582 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3582-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-21710");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-21890");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ghostscript', 'reference': '9.27~dfsg-2+deb10u9'},
    {'release': '10.0', 'prefix': 'ghostscript-dbg', 'reference': '9.27~dfsg-2+deb10u9'},
    {'release': '10.0', 'prefix': 'ghostscript-doc', 'reference': '9.27~dfsg-2+deb10u9'},
    {'release': '10.0', 'prefix': 'ghostscript-x', 'reference': '9.27~dfsg-2+deb10u9'},
    {'release': '10.0', 'prefix': 'libgs-dev', 'reference': '9.27~dfsg-2+deb10u9'},
    {'release': '10.0', 'prefix': 'libgs9', 'reference': '9.27~dfsg-2+deb10u9'},
    {'release': '10.0', 'prefix': 'libgs9-common', 'reference': '9.27~dfsg-2+deb10u9'}
];
