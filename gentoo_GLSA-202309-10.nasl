...
# extracted from Gentoo Linux Security Advisory GLSA 202309-10.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202309-10 : Fish: User-assisted execution of arbitrary code");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202309-10 (Fish: User-assisted execution of arbitrary
code)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202309-10");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=835337");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 3.4.0"),
    'vulnerable' : make_list("lt 3.4.0")
  }
];
