...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002581");
  script_xref(name:"MSFT", value:"MS23-5002581");
  script_xref(name:"IAVA", value:"2024-A-0222-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server Subscription Edition (April 2024)");
...
"The Microsoft SharePoint Server Subscription Edition installation on the remote host is missing a security update. It is, therefore, 
affected by a session spoofing vulnerability exists. An attacker can exploit this to perform actions with the privileges 
of another user.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002581");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002581 to address this issue.");
