...
# extracted from Red Hat Security Advisory RHSA-2025:3588. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3588");

  script_name(english:"RHEL 9 : python-jinja2 (RHSA-2025:3588)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3588.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e529e265");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3588");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-jinja2 package based on the guidance in RHSA-2025:3588.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-jinja2-2.11.3-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
