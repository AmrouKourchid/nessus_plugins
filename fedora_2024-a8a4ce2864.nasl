...
# extracted from Fedora Security Advisory FEDORA-2024-a8a4ce2864
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a8a4ce2864");

  script_name(english:"Fedora 39 : prometheus-podman-exporter (2024-a8a4ce2864)");
...
FEDORA-2024-a8a4ce2864 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a8a4ce2864");
...
var pkgs = [
    {'reference':'prometheus-podman-exporter-1.11.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
