...
# extracted from openSUSE Security Update openSUSE-2020-1907.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : zeromq (openSUSE-2020-1907)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176116");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176256");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176257");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176258");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176259");
...
if ( rpm_check(release:"SUSE15.1", reference:"libunwind-1.2.1-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libunwind-debuginfo-1.2.1-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libunwind-debugsource-1.2.1-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libunwind-devel-1.2.1-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libunwind-32bit-1.2.1-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libunwind-32bit-debuginfo-1.2.1-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libzmq5-4.2.3-lp151.5.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libzmq5-debuginfo-4.2.3-lp151.5.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"zeromq-debugsource-4.2.3-lp151.5.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"zeromq-devel-4.2.3-lp151.5.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"zeromq-tools-4.2.3-lp151.5.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"zeromq-tools-debuginfo-4.2.3-lp151.5.6.1") ) flag++;
