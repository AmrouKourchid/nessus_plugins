...
if (description)
{
  ...
  script_name(english:"Jenkins LTS < 2.319.2 / Jenkins weekly < 2.330 Multiple Vulnerabilities");
...
LTS prior to 2.319.2 or Jenkins weekly prior to 2.330. It is, therefore, affected by multiple vulnerabilities:
...
var constraints = [
  { 'max_version' : '2.329', 'fixed_version' : '2.330', 'edition' : 'Open Source' },
  { 'max_version' : '2.319.1', 'fixed_version' : '2.319.2', 'edition' : 'Open Source LTS' }
];

var app_info = vcf::combined_get_app_info(app:'Jenkins');

var flags = {'xsrf':TRUE, 'xss':TRUE};
vcf::jenkins::check_version_and_report(app_info:app_info, constraints:constraints, severity:SECURITY_HOLE, flags:flags);
