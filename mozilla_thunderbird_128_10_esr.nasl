...
"The version of Thunderbird ESR installed on the remote Windows host is prior to 128.10. It is, therefore, affected by
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:TRUE, fix:'128.10', min:'128.0.0', severity:SECURITY_WARNING);
