...
affected by a vulnerability as referenced in the K67830124 advisory.

    A memory out-of-bounds read flaw was found in the Linux kernel's ext3/ext4 file systemin the way it
    ...
    (CVE-2020-14314)ImpactIf the local filesystem has a corrupted index, a malicious attacker with local
    access to the Linux operating system may crash the BIG-IP system, making it unavailable.
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.0.0-17.1.1','16.1.0-16.1.4 16.0.0','15.1.0-15.1.8','14.1.0-14.1.5','13.1.0-13.1.5','12.1.0-12.1.6','11.6.1-11.6.5'
    ],
    'unaffected': [
