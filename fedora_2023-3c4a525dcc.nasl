...
# extracted from Fedora Security Advisory FEDORA-2023-3c4a525dcc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3c4a525dcc");

  script_name(english:"Fedora 36 : mbedtls (2023-3c4a525dcc)");
...
FEDORA-2023-3c4a525dcc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3c4a525dcc");
...
"Update the affected mbedtls package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-46393");
...
var pkgs = [
    {'reference':'mbedtls-2.28.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
