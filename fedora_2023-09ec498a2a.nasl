...
# extracted from Fedora Security Advisory FEDORA-2023-09ec498a2a
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-5129", "CVE-2023-5217");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/10/23");
  script_xref(name:"FEDORA", value:"2023-09ec498a2a");
  script_xref(name:"IAVA", value:"2023-A-0522-S");

  script_name(english:"Fedora 37 : firefox (2023-09ec498a2a)");
...
FEDORA-2023-09ec498a2a advisory.

    This update is intended to fix all the issues with broken launchers and KDE crashes that were caused by
    changes to the .desktop files in recent Firefox updates. Please report any remaining issues.

    ----

    This update provides the latest release of Firefox, with an important security fix. We highly recommend
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-09ec498a2a");
...
var pkgs = [
    {'reference':'firefox-118.0.1-7.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
