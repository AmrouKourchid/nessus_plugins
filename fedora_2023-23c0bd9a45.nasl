...
# extracted from Fedora Security Advisory FEDORA-2023-23c0bd9a45
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-23c0bd9a45");

  script_name(english:"Fedora 38 : mlpack (2023-23c0bd9a45)");
...
FEDORA-2023-23c0bd9a45 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-23c0bd9a45");
  script_set_attribute(attribute:"solution", value:
"Update the affected mlpack package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mlpack");
...
var pkgs = [
    {'reference':'mlpack-4.2.1-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mlpack');
}
