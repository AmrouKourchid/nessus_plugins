...
if (description)
{
  ...
  script_cve_id("CVE-2018-0027");
  script_bugtraq_id(104721);
  script_xref(name:"JSA", value:"JSA10861");

  script_name(english:"Juniper Junos Malformed RSVP RPD DoS (JSA10861)");
...
is affected by a denial of service vulnerability.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?96359e8c");
  script_set_attribute(attribute:"solution", value:
"Apply the relevant Junos software release referenced in
Juniper advisory JSA10861.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-0027");
