...
# extracted from Fedora Security Advisory FEDORA-2024-db558f6fb2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-db558f6fb2");

  script_name(english:"Fedora 40 : pgadmin4 (2024-db558f6fb2)");
...
FEDORA-2024-db558f6fb2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-db558f6fb2");
...
var pkgs = [
    {'reference':'pgadmin4-8.4-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
