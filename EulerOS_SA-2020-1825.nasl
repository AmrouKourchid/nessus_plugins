...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : PyYaml (EulerOS-SA-2020-1825)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1825
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?602e3a10");
...
pkgs = ["python2-pyyaml-4.2-0.1.b4.h4.eulerosv2r8",
        "python3-pyyaml-4.2-0.1.b4.h4.eulerosv2r8"];
