...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Net PHSA-2023-5.0-0025");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'net-snmp-5.9.3-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'net-snmp-devel-5.9.3-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'net-snmp-perl-5.9.3-2.ph5')) flag++;
