...
# extracted from Ubuntu Security Notice USN-4976-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4976-2");

  script_name(english:"Ubuntu 16.04 ESM : Dnsmasq vulnerability (USN-4976-2)");
...
USN-4976-2 advisory.
    ...
    USN-4976-1 fixed a vulnerability in Dnsmasq. This update provides the corresponding update for Ubuntu
    16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4976-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'dnsmasq', 'pkgver': '2.79-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'dnsmasq-base', 'pkgver': '2.79-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'dnsmasq-base-lua', 'pkgver': '2.79-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'dnsmasq-utils', 'pkgver': '2.79-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE}
];
