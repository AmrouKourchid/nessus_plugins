...
if (description)
{
  ...
  script_cve_id("CVE-2024-40715");

  script_name(english:"Veeam Backup and Replication 10.x < 12.2.0.334 Authentication Bypass (November 2024) (KB4682)");

  script_set_attribute(attribute:"synopsis", value:
"The version of Veeam Backup and Replication installed on the remote Windows host is affected by an authentication bypass.");
  script_set_attribute(attribute:"description", value:
"The version of Veeam Backup and Replication installed on the remote Windows host is prior to 12.2.0.334. It is,
therefore, affected by an authentication bypass vulnerability. Attackers must be able to perform Man-in-the-Middle 
(MITM) attack to exploit this vulnerability. 
...
"Upgrade to Veeam Backup and Replication version 12.2.0.334 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-40715");
  ...
  script_require_keys("SMB/Registry/Enumerated", "installed_sw/Veeam Backup and Replication", "Settings/ParanoidReport");
...
# No insight into the private hotfix patch
...
var constraints = [
  { 'min_version':'12.0', 'max_version' : '12.2.0.334', 'fixed_display' : 'See vendor advisory' }
];
