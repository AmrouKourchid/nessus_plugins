...
referenced in the RHSA-2019:3703 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3703.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d8f803c5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3703");
...
"Update the RHEL libvorbis package based on the guidance in RHSA-2019:3703.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvorbis-1.3.6-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libvorbis-devel-1.3.6-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
