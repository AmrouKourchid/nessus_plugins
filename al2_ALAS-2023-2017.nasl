...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2017.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : mysql-connector-java (ALAS-2023-2017)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of mysql-connector-java installed on the remote host is prior to 5.1.25-3. It is, therefore, affected by a
vulnerability as referenced in the ALAS2-2023-2017 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2017.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2020-2934.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/faqs.html");
  script_set_attribute(attribute:"solution", value:
"Run 'yum update mysql-connector-java' to update your system.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:mysql-connector-java");
...
var pkgs = [
    {'reference':'mysql-connector-java-5.1.25-3.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
