...
following vulnerabilities :
  ...
  - An issue was discovered in PHP before 5.6.40, 7.x
    ...
    ext/xmlrpc/libxmlrpc/xml_element.c.i1/4^CVE-2019-9020i1/4%0
  ...
  - An issue was discovered in PHP before 5.6.40, 7.x
    ...
    ext/phar/phar.c.i1/4^CVE-2019-9021i1/4%0
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae35672c");
...
"Update the affected php packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-9021");
