...
# extracted from Fedora Security Advisory FEDORA-2020-93d7305d71.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : exim (2020-93d7305d71)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This is an update fixing out-of-bounds read in the SPA authenticator.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-93d7305d71");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"exim-4.93-8.fc31")) flag++;
