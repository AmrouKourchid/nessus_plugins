...
# extracted from Fedora Security Advisory FEDORA-2023-32eb9d8ee7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-32eb9d8ee7");

  script_name(english:"Fedora 37 : binwalk (2023-32eb9d8ee7)");
...
FEDORA-2023-32eb9d8ee7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-32eb9d8ee7");
...
var pkgs = [
    {'reference':'binwalk-2.3.3-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
