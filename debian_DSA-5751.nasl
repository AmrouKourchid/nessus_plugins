...
# extracted from Debian Security Advisory dsa-5751. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5751 : squid - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5751
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-37894");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'squid', 'reference': '5.7-2+deb12u2'},
    {'release': '12.0', 'prefix': 'squid-cgi', 'reference': '5.7-2+deb12u2'},
    {'release': '12.0', 'prefix': 'squid-common', 'reference': '5.7-2+deb12u2'},
    {'release': '12.0', 'prefix': 'squid-openssl', 'reference': '5.7-2+deb12u2'},
    {'release': '12.0', 'prefix': 'squid-purge', 'reference': '5.7-2+deb12u2'},
    {'release': '12.0', 'prefix': 'squidclient', 'reference': '5.7-2+deb12u2'}
];
