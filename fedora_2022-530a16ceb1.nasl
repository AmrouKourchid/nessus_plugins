...
# extracted from Fedora Security Advisory FEDORA-2022-530a16ceb1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-530a16ceb1");

  script_name(english:"Fedora 37 : zziplib (2022-530a16ceb1)");
...
FEDORA-2022-530a16ceb1 advisory.

    Automatic update for zziplib-0.13.72-1.fc37.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-530a16ceb1");
  script_set_attribute(attribute:"solution", value:
"Update the affected zziplib package.");
...
var pkgs = [
    {'reference':'zziplib-0.13.72-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
