...
# extracted from Fedora Security Advisory FEDORA-2024-cc2c07317b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-cc2c07317b");
  script_xref(name:"IAVA", value:"2025-A-0135");

  script_name(english:"Fedora 39 : xorg-x11-server-Xwayland (2024-cc2c07317b)");
...
FEDORA-2024-cc2c07317b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-cc2c07317b");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-23.2.7-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
