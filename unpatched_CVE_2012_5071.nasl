...
if (description)
{
  ...
  script_cve_id("CVE-2012-5071");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-5071");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment (JRE) component in Oracle Java SE 7 Update 7 and
    ...
    confidentiality and integrity, related to JMX. (CVE-2012-5071)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-5071");
