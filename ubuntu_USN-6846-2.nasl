...
# extracted from Ubuntu Security Notice USN-6846-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6846-2");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : Ansible regression (USN-6846-2)");
...
in the USN-6846-2 advisory.

    USN-6846-1 fixed vulnerabilities in ansible. The update introduced a regression in ansible. This update
    fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6846-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ansible', 'pkgver': '2.0.0.2-2ubuntu1.3+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ansible-fireball', 'pkgver': '2.0.0.2-2ubuntu1.3+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ansible-node-fireball', 'pkgver': '2.0.0.2-2ubuntu1.3+esm3', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'ansible', 'pkgver': '2.5.1+dfsg-1ubuntu0.1+esm3', 'ubuntu_pro': TRUE}
];
