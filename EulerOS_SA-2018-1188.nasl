...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : dhcp (EulerOS-SA-2018-1188)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1188
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f4047526");
...
pkgs = ["dhclient-4.2.5-68.1.h3",
        "dhcp-4.2.5-68.1.h3",
        "dhcp-common-4.2.5-68.1.h3",
        "dhcp-libs-4.2.5-68.1.h3"];
