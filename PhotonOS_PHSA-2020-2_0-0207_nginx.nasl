...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Nginx PHSA-2020-2.0-0207");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nginx-1.16.1-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nginx-debuginfo-1.16.1-2.ph2')) flag++;
