...
# extracted from Fedora Security Advisory FEDORA-2024-18ac02a385
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-18ac02a385");

  script_name(english:"Fedora 39 : thunderbird (2024-18ac02a385)");
...
FEDORA-2024-18ac02a385 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-18ac02a385");
...
var pkgs = [
    {'reference':'thunderbird-115.16.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
