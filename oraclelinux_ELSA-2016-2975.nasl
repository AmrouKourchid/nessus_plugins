...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-2975.html");
...
var pkgs = [
    {'reference':'gstreamer-plugins-good-0.10.23-4.el6_8', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gstreamer-plugins-good-devel-0.10.23-4.el6_8', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gstreamer-plugins-good-0.10.23-4.el6_8', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gstreamer-plugins-good-devel-0.10.23-4.el6_8', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
