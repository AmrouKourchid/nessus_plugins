...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-313.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : nerdctl (ALAS2023-2023-313)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2023-313 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-313.html");
...
"Run 'dnf update nerdctl --releasever 2023.1.20230823' to update your system.");
...
var pkgs = [
    {'reference':'nerdctl-1.1.0-1.amzn2023.0.2', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nerdctl-1.1.0-1.amzn2023.0.2', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
