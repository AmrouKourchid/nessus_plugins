...
# Red Hat Security Advisory RHSA-2023:4536. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : nodejs:18 (CESA-2023:4536)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2023:4536 advisory.
...
"Update the affected nodejs-packaging and / or nodejs-packaging-bundler packages.");
