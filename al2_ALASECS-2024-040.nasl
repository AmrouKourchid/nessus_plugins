...
# extracted from Amazon Linux 2 Security Advisory ALASECS-2024-040.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-24790", "CVE-2024-28180");

  script_name(english:"Amazon Linux 2 : containerd (ALASECS-2024-040)");
...
vulnerabilities as referenced in the ALAS2ECS-2024-040 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASECS-2024-040.html");
