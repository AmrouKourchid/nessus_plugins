...
if (description)
{
  ...
  script_name(english:"Tensorflow-hub Detection");

  script_set_attribute(attribute:"synopsis", value:
"A Tensorflow-hub Python library is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"A Tensorflow-hub Python library is installed on the remote host. 

Note that Nessus has relied upon on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://pypi.org/project/tensorflow_hub/");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:google:tensorflow_hub");
...
var lib_info = {
  ...
  register_install(
    ...
    cpe             : 'cpe:/a:google:tensorflow-hub'
  );
