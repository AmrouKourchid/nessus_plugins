...
# extracted from Fedora Security Advisory FEDORA-2018-22c609e92a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-22c609e92a");

  script_name(english:"Fedora 29 : cobbler (2018-22c609e92a)");
...
----
  ...
  - Update to 2.8.4 (Fixes BZ 1613292, 1643860, 1614433,
    CVE-2018-1000226, CVE-2018-10931)
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-22c609e92a");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"cobbler-2.8.4-5.fc29")) flag++;
