...
# extracted from Fedora Security Advisory FEDORA-2024-ba78b27eb8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ba78b27eb8");

  script_name(english:"Fedora 39 : webkitgtk (2024-ba78b27eb8)");
...
FEDORA-2024-ba78b27eb8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ba78b27eb8");
...
var pkgs = [
    {'reference':'webkitgtk-2.44.3-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
