...
# extracted from Fedora Security Advisory FEDORA-2023-4936e4e7f1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4936e4e7f1");

  script_name(english:"Fedora 37 : polkit (2023-4936e4e7f1)");
...
FEDORA-2023-4936e4e7f1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4936e4e7f1");
...
var pkgs = [
    {'reference':'polkit-121-4.fc37.2', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
