...
# extracted from VMware Security Advisory PHSA-2024-5.0-0188. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-48795", "CVE-2023-51384");
  script_xref(name:"IAVA", value:"2023-A-0701-S");
  script_xref(name:"IAVA", value:"2023-A-0703");

  script_name(english:"Photon OS 5.0: Openssh PHSA-2024-5.0-0188");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openssh package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-188.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssh-9.3p2-7.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssh-clients-9.3p2-7.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssh-server-9.3p2-7.ph5')) flag++;
