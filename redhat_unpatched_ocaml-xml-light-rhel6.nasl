...
# extracted from Red Hat Security Advisory ocaml-xml-light. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : ocaml-xml-light (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-3514");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ocaml-xml-light");
