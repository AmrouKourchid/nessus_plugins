...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2308.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f469e0a2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2308");
...
"Update the RHEL libguestfs-winsupport package based on the guidance in RHSA-2019:2308.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libguestfs-winsupport-7.2-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
