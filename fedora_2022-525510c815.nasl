...
# extracted from Fedora Security Advisory FEDORA-2022-525510c815
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-525510c815");

  script_name(english:"Fedora 37 : strongswan (2022-525510c815)");
...
FEDORA-2022-525510c815 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-525510c815");
...
var pkgs = [
    {'reference':'strongswan-5.9.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
