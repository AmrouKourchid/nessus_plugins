...
# extracted from Fedora Security Advisory FEDORA-2019-6e325234a4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-6e325234a4");

  script_name(english:"Fedora 29 : php (2019-6e325234a4)");
...
**Standard:**
  ...
  - Fixed bug php#77680 (recursive mkdir on ftp stream
    wrapper is incorrect). (Vlad Temian)
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-6e325234a4");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"php-7.2.18-1.fc29")) flag++;
