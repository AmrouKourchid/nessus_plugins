...
referenced in the USN-5953-1 advisory.
    ...
    It was discovered that IPython incorrectly processed REST API POST requests. An attacker could possibly
    use this issue to launch a cross-site request forgery (CSRF) attack and leak user's sensitive information.
    This issue only affected Ubuntu 14.04 ESM. (CVE-2015-5607)

    It was discovered that IPython did not properly manage cross user temporary files. A local attacker could
    possibly use this issue to execute arbitrary code. This issue only affected Ubuntu 18.04 ESM and Ubuntu
    20.04 ESM. (CVE-2022-21699)
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'ipython', 'pkgver': '5.5.0-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'ipython3', 'pkgver': '5.5.0-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python-ipython', 'pkgver': '5.5.0-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3-ipython', 'pkgver': '5.5.0-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'ipython3', 'pkgver': '7.13.0-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'python3-ipython', 'pkgver': '7.13.0-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
