...
# extracted from Fedora Security Advisory FEDORA-2022-9836111c44
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-9836111c44");
  script_xref(name:"IAVA", value:"2023-A-0008-S");

  script_name(english:"Fedora 36 : curl (2022-9836111c44)");
...
FEDORA-2022-9836111c44 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-9836111c44");
...
var pkgs = [
    {'reference':'curl-7.82.0-12.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
