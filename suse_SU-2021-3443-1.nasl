...
# SUSE update advisory SUSE-SU-2021:3443-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-3573", "CVE-2021-3640", "CVE-2021-38160");
  script_xref(name:"SuSE", value:"SUSE-SU-2021:3443-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 16 for SLE 12 SP5) (SUSE-SU-2021:3443-1)");
...
referenced in the SUSE-SU-2021:3443-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-October/009594.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?612346ac");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-4_12_14-197_86-default, kernel-livepatch-5_3_18-24_43-default, kgraft-
patch-4_12_14-122_63-default and / or kgraft-patch-4_12_14-95_71-default packages.");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-95_71-default-10-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']},
    {'reference':'kgraft-patch-4_12_14-122_63-default-10-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']},
    {'reference':'kernel-livepatch-4_12_14-197_86-default-10-2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']},
    {'reference':'kernel-livepatch-5_3_18-24_43-default-12-2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
];
