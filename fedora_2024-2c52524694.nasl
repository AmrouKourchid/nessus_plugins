...
# extracted from Fedora Security Advisory FEDORA-2024-2c52524694
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2c52524694");

  script_name(english:"Fedora 40 : nodejs18 (2024-2c52524694)");
...
FEDORA-2024-2c52524694 advisory.
    ...
    * CVE-2024-27980 - Command injection via args parameter of `child_process.spawn` without shell option
    enabled on Windows

    ### Commits

    * \[[`6627222409`](https://github.com/nodejs/node/commit/6627222409)] - **src**: disallow direct .bat and
    .cmd file spawning (Ben Noordhuis) [nodejs-private/node-private#564](https://github.com/nodejs-
    private/node-private/pull/564)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2c52524694");
...
var pkgs = [
    {'reference':'nodejs18-18.20.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
