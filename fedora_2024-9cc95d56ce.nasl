...
# extracted from Fedora Security Advisory FEDORA-2024-9cc95d56ce
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9cc95d56ce");

  script_name(english:"Fedora 41 : edk2 (2024-9cc95d56ce)");
...
FEDORA-2024-9cc95d56ce advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9cc95d56ce");
...
var pkgs = [
    {'reference':'edk2-20240813-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
