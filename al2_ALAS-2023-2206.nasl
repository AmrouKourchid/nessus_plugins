...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2206.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : kernel (ALAS-2023-2206)");
...
vulnerabilities as referenced in the ALAS2-2023-2206 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2206.html");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "kpatch hotfix for ALAS-2023-2206");
  }
  else
  {
