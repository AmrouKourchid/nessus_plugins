...
# extracted from SUSE update advisory SUSE-SU-2020:1289-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : libvirt (SUSE-SU-2020:1289-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1154093");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201289-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?27e95d01");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"libvirt-daemon-driver-libxl-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"libvirt-daemon-driver-libxl-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"libvirt-daemon-driver-storage-rbd-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"libvirt-daemon-driver-storage-rbd-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"libvirt-daemon-xen-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-admin-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-admin-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-client-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-client-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-config-network-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-config-nwfilter-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-interface-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-interface-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-lxc-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-lxc-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-network-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-network-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-nodedev-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-nodedev-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-nwfilter-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-nwfilter-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-qemu-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-qemu-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-secret-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-secret-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-storage-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-storage-core-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-storage-core-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-storage-disk-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-storage-disk-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-storage-iscsi-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-storage-iscsi-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-storage-logical-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-storage-logical-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-storage-mpath-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-storage-mpath-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-storage-scsi-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-driver-storage-scsi-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-hooks-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-lxc-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-daemon-qemu-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-debugsource-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-doc-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-libs-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-libs-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-lock-sanlock-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-lock-sanlock-debuginfo-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-nss-4.0.0-8.20.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvirt-nss-debuginfo-4.0.0-8.20.2")) flag++;
