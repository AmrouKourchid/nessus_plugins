...
Workaround :
    ...
    Users should ensure the proper permissions are set as discussed in the
      referenced bugs.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201904-05");
...
"All BURP users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-18285");
