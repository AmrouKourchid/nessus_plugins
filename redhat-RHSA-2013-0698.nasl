...
"The remote Red Hat host is missing one or more security updates for rubygem-actionpack / ruby193-rubygem-actionpack.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2013:0698 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2013/rhsa-2013_0698.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc0a9377");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0698");
...
"Update the RHEL rubygem-actionpack / ruby193-rubygem-actionpack packages based on the guidance in RHSA-2013:0698.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1857");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ruby193-rubygem-actionpack-3.2.8-5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-ansible'},
      {'reference':'ruby193-rubygem-actionpack-doc-3.2.8-5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-ansible'},
      {'reference':'rubygem-actionpack-3.0.13-8.el6op', 'release':'6', 'el_string':'el6op', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-ansible'}
    ]
  }
];
