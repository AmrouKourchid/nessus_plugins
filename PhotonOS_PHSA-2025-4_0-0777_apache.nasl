...
# extracted from VMware Security Advisory PHSA-2025-4.0-0777. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Apache PHSA-2025-4.0-0777");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the apache package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-777.md");
...
if (rpm_check(release:'PhotonOS-4.0', reference:'apache-tomcat9-9.0.98-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', reference:'apache-tomcat9-webapps-9.0.98-2.ph4')) flag++;
