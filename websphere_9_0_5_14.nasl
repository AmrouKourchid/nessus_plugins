...
if (description)
{
  ...
  script_cve_id("CVE-2022-35282");
  script_xref(name:"IAVA", value:"2022-A-0389");

  script_name(english:"IBM WebSphere Application SSRF (6824179)");

  script_set_attribute(attribute:"synopsis", value:
"The remote web application server is vulnerable to SSRF.");
  script_set_attribute(attribute:"description", value:
"IBM WebSphere Application Server 7.0, 8.0, 8.5, and 9.0 is vulnerable to server-side request forgery (SSRF). By sending
a specially crafted request, an attacker with local network access could exploit this vulnerability to obtain sensitive
data.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6823907");
  script_set_attribute(attribute:"solution", value:
"Update to IBM WebSphere Application Server version 8.5.5.23, 9.0.5.14 or later. Alternatively, upgrade to the minimal
fix pack levels required by the interim fix and then apply Interim Fix PH47385.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-35282");
...
if ('PH47385' >< app_info['Fixes'])
  audit(AUDIT_INST_VER_NOT_VULN, app);

var constraints = [
  { 'min_version' : '9.0', 'fixed_version' : '9.0.5.14', 'fixed_display' : '9.0.5.14 or ' + fix },
  { 'min_version' : '8.5', 'fixed_version' : '8.5.5.23', 'fixed_display' : '8.5.5.23 or ' + fix },
