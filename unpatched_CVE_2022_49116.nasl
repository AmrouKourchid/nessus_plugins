...
if (description)
{
  ...
  script_cve_id("CVE-2022-49116");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49116");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: Bluetooth: use memset avoid memory
    leaks Use memset to initialize structs to prevent memory leaks in l2cap_ecred_connect (CVE-2022-49116)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49116");
