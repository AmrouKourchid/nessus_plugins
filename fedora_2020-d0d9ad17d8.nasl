...
# extracted from Fedora Security Advisory FEDORA-2020-d0d9ad17d8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-d0d9ad17d8");

  script_name(english:"Fedora 30 : python-pip (2020-d0d9ad17d8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-d0d9ad17d8");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"python-pip-19.0.3-6.fc30")) flag++;
