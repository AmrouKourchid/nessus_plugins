...
"The version of Google Chrome installed on the remote Windows host is prior to 133.0.6943.126. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'133.0.6943.126', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
