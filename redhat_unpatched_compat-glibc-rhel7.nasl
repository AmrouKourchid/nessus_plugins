...
# extracted from Red Hat Security Advisory compat-glibc. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-15804");

  script_name(english:"RHEL 7 : compat-glibc (Unpatched Vulnerability) (deprecated)");
