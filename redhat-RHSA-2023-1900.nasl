...
referenced in the RHSA-2023:1900 advisory.
    ...
    * In FIPS mode, the list of cryptographic services and algorithms available is limited to those that are
    ...
    These attributes are now made available in FIPS mode, as they are in non-FIPS mode. (RHBZ#2186805)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1900.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?482af183");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2186805");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2186808");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2186812");
...
"Update the RHEL java-17-openjdk package based on the guidance in RHSA-2023:1900.");
