...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Git PHSA-2020-3.0-0093");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'git-2.23.3-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'git-lang-2.23.3-1.ph3')) flag++;
