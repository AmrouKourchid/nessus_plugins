...
# extracted from Fedora Security Advisory FEDORA-2025-82714dbb22
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-82714dbb22");

  script_name(english:"Fedora 41 : SDL2_sound (2025-82714dbb22)");
...
FEDORA-2025-82714dbb22 advisory.

    Latest stable release from upstream. Changelog: https://github.com/icculus/SDL_sound/releases/tag/v2.0.4 .
    NOTE: dr_libs are unbundled.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-82714dbb22");
  script_set_attribute(attribute:"solution", value:
"Update the affected SDL2_sound package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-45679");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:SDL2_sound");
...
var pkgs = [
    {'reference':'SDL2_sound-2.0.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'SDL2_sound');
}
