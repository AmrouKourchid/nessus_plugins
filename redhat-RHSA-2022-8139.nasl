...
# extracted from Red Hat Security Advisory RHSA-2022:8139. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8139");

  script_name(english:"RHEL 9 : wavpack (RHSA-2022:8139)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8139.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b35c9cab");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8139");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2064457");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL wavpack package based on the guidance in RHSA-2022:8139.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wavpack-5.4.0-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wavpack-devel-5.4.0-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
