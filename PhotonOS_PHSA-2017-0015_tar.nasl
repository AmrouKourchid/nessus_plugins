...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'tar-1.29-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'tar-debuginfo-1.29-1.ph1')) flag++;
