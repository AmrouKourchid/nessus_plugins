...
# extracted from Red Hat Security Advisory RHSA-2024:3830. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3830");
  script_xref(name:"IAVA", value:"2024-A-0356");

  script_name(english:"RHEL 9 : gvisor-tap-vsock (RHSA-2024:3830)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gvisor-tap-vsock.");
...
the RHSA-2024:3830 advisory.

    A replacement for libslirp and VPNKit, written in pure Go. It is based on the network stack of gVisor and
    is used to provide networking for podman-machine virtual machines. Compared to libslirp, gvisor-tap-vsock
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3830.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a085fea");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268017");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3830");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gvisor-tap-vsock package based on the guidance in RHSA-2024:3830.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gvisor-tap-vsock");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gvisor-tap-vsock-0.7.3-3.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'gvisor-tap-vsock-0.7.3-3.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gvisor-tap-vsock');
}
