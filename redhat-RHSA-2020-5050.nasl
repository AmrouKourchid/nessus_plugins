...
# extracted from Red Hat Security Advisory RHSA-2020:5050. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5050");

  script_name(english:"RHEL 7 : kpatch-patch (RHSA-2020:5050)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for kpatch-patch.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:5050 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5050.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?634af694");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5050");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1874800");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kpatch-patch package based on the guidance in RHSA-2020:5050.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2020-14385');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2020:5050');
  }
  else
  {
...
var kernel_live_checks = [
  {
    ...
    'kernels': {
      '3.10.0-1160.el7.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-3_10_0-1160-1-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '3.10.0-1160.el7.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-3_10_0-1160-1-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '3.10.0-1160.2.1.el7.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-3_10_0-1160_2_1-1-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '3.10.0-1160.2.1.el7.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-3_10_0-1160_2_1-1-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '3.10.0-1160.2.2.el7.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-3_10_0-1160_2_2-1-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '3.10.0-1160.2.2.el7.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-3_10_0-1160_2_2-1-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '3.10.0-1160.6.1.el7.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-3_10_0-1160_6_1-1-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '3.10.0-1160.6.1.el7.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-3_10_0-1160_6_1-1-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kpatch-patch-3_10_0-1160 / kpatch-patch-3_10_0-1160_2_1 / etc');
}
