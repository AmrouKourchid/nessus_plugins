...
# extracted from openSUSE Security Update openSUSE-2019-691.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ffmpeg-4 (openSUSE-2019-691)");
...
These non-security issues were fixed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1092241");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1100348");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1105869");
...
"Update the affected ffmpeg-4 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-13300");
...
if ( rpm_check(release:"SUSE15.0", reference:"ffmpeg-4-debugsource-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"ffmpeg-4-libavcodec-devel-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"ffmpeg-4-libavdevice-devel-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"ffmpeg-4-libavfilter-devel-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"ffmpeg-4-libavformat-devel-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"ffmpeg-4-libavresample-devel-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"ffmpeg-4-libavutil-devel-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"ffmpeg-4-libpostproc-devel-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"ffmpeg-4-libswresample-devel-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"ffmpeg-4-libswscale-devel-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"ffmpeg-4-private-devel-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavcodec58-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavcodec58-debuginfo-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavdevice58-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavdevice58-debuginfo-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavfilter7-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavfilter7-debuginfo-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavformat58-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavformat58-debuginfo-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavresample4-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavresample4-debuginfo-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavutil56-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libavutil56-debuginfo-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libpostproc55-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libpostproc55-debuginfo-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libswresample3-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libswresample3-debuginfo-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libswscale5-4.0.2-lp150.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libswscale5-debuginfo-4.0.2-lp150.13.1") ) flag++;
