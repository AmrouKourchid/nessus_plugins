...
# extracted from Red Hat Security Advisory RHSA-2023:0807. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0807");
  script_xref(name:"IAVA", value:"2023-A-0081-S");

  script_name(english:"RHEL 8 : Mozilla Firefox (RHSA-2023:0807)");
...
referenced in the RHSA-2023:0807 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0807.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc117b63");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0807");
...
"Update the RHEL Mozilla Firefox package based on the guidance in RHSA-2023:0807.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.8.0-2.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
