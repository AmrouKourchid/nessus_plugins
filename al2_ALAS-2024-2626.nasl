...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2626.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : linux-firmware (ALAS-2024-2626)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of linux-firmware installed on the remote host is prior to 20200421-82.git78c0348. It is, therefore,
affected by a vulnerability as referenced in the ALAS2-2024-2626 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2626.html");
...
var pkgs = [
    {'reference':'iwl100-firmware-39.31.5.1-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl1000-firmware-39.31.5.1-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl105-firmware-18.168.6.1-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl135-firmware-18.168.6.1-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl2000-firmware-18.168.6.1-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl2030-firmware-18.168.6.1-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl3160-firmware-25.30.13.0-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl3945-firmware-15.32.2.9-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl4965-firmware-228.61.2.24-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl5000-firmware-8.83.5.1_1-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl5150-firmware-8.24.2.2-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl6000-firmware-9.221.4.1-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl6000g2a-firmware-18.168.6.1-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl6000g2b-firmware-18.168.6.1-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl6050-firmware-41.28.5.1-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iwl7260-firmware-25.30.13.0-82.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'linux-firmware-20200421-82.git78c0348.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
