...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : avahi (EulerOS-SA-2019-1640)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1640
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ec895099");
...
pkgs = ["avahi-0.7-16.h1.eulerosv2r8",
        ...
        "avahi-gobject-0.7-16.h1.eulerosv2r8",
        "avahi-libs-0.7-16.h1.eulerosv2r8",
        "avahi-ui-gtk3-0.7-16.h1.eulerosv2r8",
        "python3-avahi-0.7-16.h1.eulerosv2r8"];
