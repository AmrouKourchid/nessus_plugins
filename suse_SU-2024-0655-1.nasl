...
# SUSE update advisory SUSE-SU-2024:0655-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0655-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 41 for SLE 12 SP5) (SUSE-SU-2024:0655-1)");
...
referenced in the SUSE-SU-2024:0655-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-February/018060.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8547659");
...
"Update the affected kernel-livepatch-5_14_21-150500_11-rt and / or kgraft-patch-4_12_14-122_153-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.153-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_153-default-10-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '5.14.21-150500.11-rt-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150500_11-rt-8-150500.3.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.5']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150500_11-rt / etc');
}
