...
# extracted from Debian Security Advisory dsa-5811. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5811 : libmpg123-0 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5811
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/mpg123");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'libmpg123-0', 'reference': '1.31.2-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libmpg123-dev', 'reference': '1.31.2-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libout123-0', 'reference': '1.31.2-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libsyn123-0', 'reference': '1.31.2-1+deb12u1'},
    {'release': '12.0', 'prefix': 'mpg123', 'reference': '1.31.2-1+deb12u1'}
];
