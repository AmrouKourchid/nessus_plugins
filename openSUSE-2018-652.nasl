...
# extracted from openSUSE Security Update openSUSE-2018-652.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : aubio (openSUSE-2018-652)");
...
"This update for aubio fixes the following security issue :
  ...
  - CVE-2017-17554: Prevent NULL pointer dereference in the
    ...
    (bsc#1072317).");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1072317");
...
"Update the affected aubio packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-17554");
