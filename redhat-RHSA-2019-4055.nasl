...
referenced in the RHSA-2019:4055 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_4055.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?acea5cdb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:4055");
...
"Update the RHEL OpenShift Container Platform 3.11 jenkins-2-plugins package based on the guidance in RHSA-2019:4055.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-3.11.1575261255-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
