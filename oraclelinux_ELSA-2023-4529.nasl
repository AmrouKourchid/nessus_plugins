...
# extracted from Oracle Linux Security Advisory ELSA-2023-4529.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libxml2 (ELSA-2023-4529)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2023-4529 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-4529.html");
...
var pkgs = [
    ...
    {'reference':'python3-libxml2-2.9.7-16.el8_8.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
