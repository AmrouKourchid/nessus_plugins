...
# extracted from Red Hat Security Advisory RHSA-2025:1920. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1920");

  script_name(english:"RHEL 9 : pki-servlet-engine (RHSA-2025:1920)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for pki-servlet-engine.");
...
the RHSA-2025:1920 advisory.

    Tomcat is the servlet engine that is used in the official Reference Implementation for the Java Servlet
    and JavaServer Pages technologies. The Java Servlet and JavaServer Pages specifications are developed by
    Sun under the Java Community Process.  Tomcat is developed in an open and participatory environment and
    released under the Apache Software License version 2.0. Tomcat is intended to be a collaboration of the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1920.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2460c357");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1920");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pki-servlet-engine package based on the guidance in RHSA-2025:1920.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pki-servlet-4.0-api-9.0.50-1.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'pki-servlet-engine-9.0.50-1.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'pki-servlet-4.0-api / pki-servlet-engine');
}
