...
# extracted from Red Hat Security Advisory RHSA-2021:2390. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2390");
  script_xref(name:"IAVB", value:"2021-B-0036-S");

  script_name(english:"RHEL 8 : postgresql:10 (RHSA-2021:2390)");
...
referenced in the RHSA-2021:2390 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2390.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f225d270");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2390");
...
"Update the RHEL postgresql:10 package based on the guidance in RHSA-2021:2390.");
  ...
  'postgresql:10': [
    {
      ...
      'pkgs': [
        {'reference':'postgresql-10.17-1.module+el8.2.0+11247+01f3c012', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-10.17-1.module+el8.2.0+11247+01f3c012', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-10.17-1.module+el8.2.0+11247+01f3c012', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-10.17-1.module+el8.2.0+11247+01f3c012', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-10.17-1.module+el8.2.0+11247+01f3c012', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-10.17-1.module+el8.2.0+11247+01f3c012', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-10.17-1.module+el8.2.0+11247+01f3c012', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-10.17-1.module+el8.2.0+11247+01f3c012', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-10.17-1.module+el8.2.0+11247+01f3c012', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-10.17-1.module+el8.2.0+11247+01f3c012', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-10.17-1.module+el8.2.0+11247+01f3c012', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-10.17-1.module+el8.2.0+11247+01f3c012', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-10.17-1.module+el8.2.0+11247+01f3c012', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
