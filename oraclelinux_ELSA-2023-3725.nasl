...
# extracted from Oracle Linux Security Advisory ELSA-2023-3725.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : less (ELSA-2023-3725)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-3725.html");
