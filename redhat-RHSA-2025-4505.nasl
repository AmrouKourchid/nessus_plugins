...
# extracted from Red Hat Security Advisory RHSA-2025:4505. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:4505");

  script_name(english:"RHEL 9 : yelp (RHSA-2025:4505)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4505.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7fcacf9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4505");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL yelp package based on the guidance in RHSA-2025:4505.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'yelp-40.3-2.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'yelp-devel-40.3-2.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'yelp-libs-40.3-2.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
