...
# extracted from Red Hat Security Advisory RHSA-2021:4426. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4426");

  script_name(english:"RHEL 8 : ncurses (RHSA-2021:4426)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for ncurses.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:4426 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4426.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a209f3c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4426");
...
"Update the RHEL ncurses package based on the guidance in RHSA-2021:4426.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ncurses-6.1-9.20180224.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-base-6.1-9.20180224.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-c++-libs-6.1-9.20180224.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-compat-libs-6.1-9.20180224.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-devel-6.1-9.20180224.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-libs-6.1-9.20180224.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
