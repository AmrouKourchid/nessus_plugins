...
the RHSA-2014:1390 advisory.
    ...
    This issue was discovered by Jan Pokorn of Red Hat.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?11bb2567");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_1390.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2642b39");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1390");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1026374");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1100817");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1117398");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=855112");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=982771");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=989005");
...
"Update the affected luci package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3593");
  script_cwe_id(77);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'luci-0.26.0-63.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'luci-0.26.0-63.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
