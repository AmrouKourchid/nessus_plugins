...
# extracted from Ubuntu Security Notice USN-2595-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2595-1");

  script_name(english:"Ubuntu 14.04 LTS : ppp vulnerability (USN-2595-1)");
...
USN-2595-1 advisory.
    ...
    It was discovered that ppp incorrectly handled large PIDs. When pppd is used with a RADIUS server, a
    remote attacker could use this issue to cause it to crash, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2595-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'ppp', 'pkgver': '2.4.5-5.1ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'ppp-dev', 'pkgver': '2.4.5-5.1ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'ppp-udeb', 'pkgver': '2.4.5-5.1ubuntu2.2'}
];
