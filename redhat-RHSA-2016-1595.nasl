...
# extracted from Red Hat Security Advisory RHSA-2016:1595. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:1595");

  script_name(english:"RHEL 7 : python-django (RHSA-2016:1595)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-django.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2016:1595 advisory.
    ...
    * A cross-site scripting (XSS) flaw was found in Django. An attacker could exploit the unsafe usage of
    JavaScript's Element.innerHTML to forge content in the admin's add/change related popup.
    Element.textContent is now used to prevent XSS data execution. (CVE-2016-6186)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1355663");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_1595.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91842ec3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:1595");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-django package based on the guidance in RHSA-2016:1595.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-6186");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-django-1.8.14-1.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-django-bash-completion-1.8.14-1.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-django-doc-1.8.14-1.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
