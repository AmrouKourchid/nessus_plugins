...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : python3 (EulerOS-SA-2023-2465)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2465
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?62a9d697");
...
var pkgs = [
  "python3-3.7.9-9.h31.eulerosv2r10",
  "python3-fgo-3.7.9-9.h31.eulerosv2r10",
  "python3-unversioned-command-3.7.9-9.h31.eulerosv2r10"
];
