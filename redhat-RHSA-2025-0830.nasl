...
# extracted from Red Hat Security Advisory RHSA-2025:0830. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-11218", "CVE-2024-56201", "CVE-2024-56326");
  script_xref(name:"RHSA", value:"2025:0830");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.16.33 (RHSA-2025:0830)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.16.33.");
...
referenced in the RHSA-2025:0830 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.16.33. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0830.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d851a6d3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0830");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.16.33 packages based on the guidance in RHSA-2025:0830.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-4.9.4-13.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-11218']},
      {'reference':'podman-catatonit-4.9.4-13.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-11218']},
      {'reference':'podman-docker-4.9.4-13.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-11218']},
      {'reference':'podman-gvproxy-4.9.4-13.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-11218']},
      {'reference':'podman-plugins-4.9.4-13.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-11218']},
      {'reference':'podman-remote-4.9.4-13.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-11218']},
      {'reference':'podman-tests-4.9.4-13.rhaos4.16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-11218']}
    ]
  },
  {
    'repo_relative_urls': [
      'content/dist/layered/rhel9/aarch64/rhocp-ironic/4.16/debug',
      'content/dist/layered/rhel9/aarch64/rhocp-ironic/4.16/os',
      'content/dist/layered/rhel9/aarch64/rhocp-ironic/4.16/source/SRPMS',
    ...
    'pkgs': [
      {'reference':'python3-jinja2-3.0.1-6.el9.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-56201', 'CVE-2024-56326']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'podman-4.9.4-15.rhaos4.16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-11218']},
      {'reference':'podman-docker-4.9.4-15.rhaos4.16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-11218']},
      {'reference':'podman-plugins-4.9.4-15.rhaos4.16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-11218']},
      {'reference':'podman-remote-4.9.4-15.rhaos4.16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-11218']},
      {'reference':'podman-tests-4.9.4-15.rhaos4.16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-11218']}
    ]
  }
];
