...
for-desktop advisory. Note that Nessus has not tested for this issue
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98006aee");
...
google_chrome_check_version(fix:'75.0.3770.80', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
