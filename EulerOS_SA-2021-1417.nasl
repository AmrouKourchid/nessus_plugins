...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : openldap (EulerOS-SA-2021-1417)");
...
the following vulnerability :
  ...
  - A NULL pointer dereference was found in OpenLDAP server
    ...
    Service.(CVE-2020-16592)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1417
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2c41fa89");
