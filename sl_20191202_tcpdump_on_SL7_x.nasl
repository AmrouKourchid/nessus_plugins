...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : tcpdump on SL7.x x86_64 (20191202)");
...
"Security Fix(es) :
  ...
  - tcpdump: Stack-based buffer over-read in
    print-hncp.c:print_prefix() via crafted pcap
    (CVE-2018-19519)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1912&L=SCIENTIFIC-LINUX-ERRATA&P=412
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e2e54219");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"tcpdump-4.9.2-4.el7_7.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"tcpdump-debuginfo-4.9.2-4.el7_7.1")) flag++;
