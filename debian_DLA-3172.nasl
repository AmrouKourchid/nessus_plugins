...
# extracted from Debian Security Advisory dla-3172. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3172 : libxml2 - security update");
...
dla-3172 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3172-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-40303");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-40304");
...
"Upgrade the libxml2 packages.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2022/10/30");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libxml2', 'reference': '2.9.4+dfsg1-7+deb10u5'},
    {'release': '10.0', 'prefix': 'libxml2-dbg', 'reference': '2.9.4+dfsg1-7+deb10u5'},
    {'release': '10.0', 'prefix': 'libxml2-dev', 'reference': '2.9.4+dfsg1-7+deb10u5'},
    {'release': '10.0', 'prefix': 'libxml2-doc', 'reference': '2.9.4+dfsg1-7+deb10u5'},
    {'release': '10.0', 'prefix': 'libxml2-utils', 'reference': '2.9.4+dfsg1-7+deb10u5'},
    {'release': '10.0', 'prefix': 'python-libxml2', 'reference': '2.9.4+dfsg1-7+deb10u5'},
    {'release': '10.0', 'prefix': 'python-libxml2-dbg', 'reference': '2.9.4+dfsg1-7+deb10u5'},
    {'release': '10.0', 'prefix': 'python3-libxml2', 'reference': '2.9.4+dfsg1-7+deb10u5'},
    {'release': '10.0', 'prefix': 'python3-libxml2-dbg', 'reference': '2.9.4+dfsg1-7+deb10u5'}
];
