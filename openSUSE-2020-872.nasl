...
# extracted from openSUSE Security Update openSUSE-2020-872.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : bluez (openSUSE-2020-872)");
...
"This update for bluez fixes the following issues :
  ...
  - CVE-2020-0556: Fixed an improper access control which
    could have allowed an unauthenticated user to
    potentially enable escalation of privilege and denial of
    service (bsc#1166751).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1166751");
...
if ( rpm_check(release:"SUSE15.2", reference:"bluez-5.48-lp152.12.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"bluez-auto-enable-devices-5.48-lp152.12.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"bluez-cups-5.48-lp152.12.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"bluez-cups-debuginfo-5.48-lp152.12.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"bluez-debuginfo-5.48-lp152.12.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"bluez-debugsource-5.48-lp152.12.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"bluez-devel-5.48-lp152.12.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"bluez-test-5.48-lp152.12.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"bluez-test-debuginfo-5.48-lp152.12.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libbluetooth3-5.48-lp152.12.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libbluetooth3-debuginfo-5.48-lp152.12.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"bluez-devel-32bit-5.48-lp152.12.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libbluetooth3-32bit-5.48-lp152.12.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libbluetooth3-32bit-debuginfo-5.48-lp152.12.3.1") ) flag++;
