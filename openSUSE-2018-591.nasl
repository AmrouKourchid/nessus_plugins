...
# extracted from openSUSE Security Update openSUSE-2018-591.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libvorbis (openSUSE-2018-591)");
...
if ( rpm_check(release:"SUSE42.3", reference:"libvorbis-debugsource-1.3.3-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbis-devel-1.3.3-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbis0-1.3.3-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbis0-debuginfo-1.3.3-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbisenc2-1.3.3-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbisenc2-debuginfo-1.3.3-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbisfile3-1.3.3-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libvorbisfile3-debuginfo-1.3.3-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libvorbis0-32bit-1.3.3-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libvorbis0-debuginfo-32bit-1.3.3-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libvorbisenc2-32bit-1.3.3-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libvorbisenc2-debuginfo-32bit-1.3.3-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libvorbisfile3-32bit-1.3.3-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libvorbisfile3-debuginfo-32bit-1.3.3-17.1") ) flag++;
