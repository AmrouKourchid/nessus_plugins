...
if (description)
{
  ...
  script_name(english:"Adobe InDesign 14.0.0 < 14.0.2 Arbitrary Code Execution (APSB19-23) (macOS)");
...
"The version of Adobe InDesign installed on the remote macOS host is prior to 14.0.2. It is, therefore, affected by a
