...
attacker has access to the Active Directory network.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K97733133");
...
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K97733133.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-5893");
...
var vmatrix = {
  'APM': {
    'affected': [
      '15.0.0-15.1.0','14.0.0-14.1.2','13.1.0-13.1.3','12.1.0-12.1.5','11.6.1-11.6.5'
    ],
    'unaffected': [
      '15.1.0.2','14.1.2.4','13.1.4','12.1.5.2','11.6.5.2'
    ],
  }
};
