...
# extracted from Fedora Security Advisory FEDORA-2025-29900cbe83
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-29900cbe83");

  script_name(english:"Fedora 41 : pam-u2f (2025-29900cbe83)");
...
FEDORA-2025-29900cbe83 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-29900cbe83");
...
var pkgs = [
    {'reference':'pam-u2f-1.3.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
