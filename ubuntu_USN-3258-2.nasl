...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Dovecot regression (USN-3258-2)");
...
USN-3258-2 advisory.
    ...
    USN-3258-1 intended to fix a vulnerability in Dovecot. Further investigation revealed that only Dovecot
    versions 2.2.26 and newer were affected by the vulnerability. Additionally, the change introduced a
    regression when Dovecot was configured to use the dict authentication database. This update reverts the
    change. We apologize for the inconvenience.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3258-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'dovecot-core', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'dovecot-dev', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'dovecot-gssapi', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'dovecot-imapd', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'dovecot-ldap', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'dovecot-lmtpd', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'dovecot-lucene', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'dovecot-managesieved', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'dovecot-mysql', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'dovecot-pgsql', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'dovecot-pop3d', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'dovecot-sieve', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'dovecot-solr', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'dovecot-sqlite', 'pkgver': '1:2.2.22-1ubuntu2.4'},
    {'osver': '16.04', 'pkgname': 'mail-stack-delivery', 'pkgver': '1:2.2.22-1ubuntu2.4'}
];
