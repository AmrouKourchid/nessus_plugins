...
# extracted from Red Hat Security Advisory RHSA-2018:1710. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2018-1087", "CVE-2018-3639", "CVE-2018-8897");
  script_xref(name:"RHSA", value:"2018:1710");
  script_xref(name:"IAVA", value:"2018-A-0170");

  script_name(english:"RHEL 7 : redhat-virtualization-host (RHSA-2018:1710)");
...
referenced in the RHSA-2018:1710 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1710.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00cd1167");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1580328");
...
"Update the RHEL redhat-virtualization-host package based on the guidance in RHSA-2018:1710.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-3.6-20180521.0.el7_3', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
