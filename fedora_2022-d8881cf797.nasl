...
# extracted from Fedora Security Advisory FEDORA-2022-d8881cf797
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d8881cf797");

  script_name(english:"Fedora 37 : golang-github-prometheus-client (2022-d8881cf797)");
...
FEDORA-2022-d8881cf797 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d8881cf797");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-github-prometheus-client package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-github-prometheus-client");
...
var pkgs = [
    {'reference':'golang-github-prometheus-client-1.12.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-prometheus-client');
}
