...
# extracted from Fedora Security Advisory FEDORA-2025-9ba0ebe67a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-9ba0ebe67a");
  script_xref(name:"IAVB", value:"2025-B-0062");

  script_name(english:"Fedora 40 : ImageMagick (2025-9ba0ebe67a)");
...
FEDORA-2025-9ba0ebe67a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-9ba0ebe67a");
...
var pkgs = [
    {'reference':'ImageMagick-7.1.1.47-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
