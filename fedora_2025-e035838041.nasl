...
# extracted from Fedora Security Advisory FEDORA-2025-e035838041
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e035838041");

  script_name(english:"Fedora 41 : buku (2025-e035838041)");
...
FEDORA-2025-e035838041 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e035838041");
  script_set_attribute(attribute:"solution", value:
"Update the affected buku package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:buku");
...
var pkgs = [
    {'reference':'buku-4.9-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'buku');
}
