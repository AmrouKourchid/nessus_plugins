...
# extracted from Oracle Linux Security Advisory ELSA-2011-1073.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : bash (ELSA-2011-1073)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-1073.html");
...
"Update the affected bash package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-5374");
...
var pkgs = [
    {'reference':'bash-3.2-32.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bash-3.2-32.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
