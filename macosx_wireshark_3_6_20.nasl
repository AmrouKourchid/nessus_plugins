...
if (description)
{
  ...
  script_name(english:"Wireshark 3.6.x < 3.6.20 Multiple Vulnerabilities (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote macOS / Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote macOS / Mac OS X host is prior to 3.6.20. It is, therefore, affected by
multiple vulnerabilities as referenced in the wireshark-3.6.20 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/docs/relnotes/wireshark-3.6.20.html");
...
var constraints = [
  { 'min_version' : '3.6.0', 'max_version' : '3.6.19', 'fixed_version' : '3.6.20' }
];
