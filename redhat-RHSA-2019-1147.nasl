...
# extracted from Red Hat Security Advisory RHSA-2019:1147. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1147");

  script_name(english:"RHEL 6 / 7 : rh-ror50-rubygem-actionpack (RHSA-2019:1147)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rh-ror50-rubygem-actionpack.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 / 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2019:1147 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1147.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fa4fafa6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1147");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-ror50-rubygem-actionpack package based on the guidance in RHSA-2019:1147.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-ror50-rubygem-actionpack");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-ror50-rubygem-actionpack-doc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-ror50-rubygem-actionpack-5.0.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-ror50-rubygem-actionpack-doc-5.0.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-ror50-rubygem-actionpack-5.0.1-2.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rh-ror50-rubygem-actionpack-doc-5.0.1-2.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-ror50-rubygem-actionpack / rh-ror50-rubygem-actionpack-doc');
}
