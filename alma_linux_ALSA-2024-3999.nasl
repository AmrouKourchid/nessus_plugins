...
# AlmaLinux Security Advisory ALSA-2024:3999.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:3999");
  script_xref(name:"IAVB", value:"2024-B-0074-S");

  script_name(english:"AlmaLinux 9 : ghostscript (ALSA-2024:3999)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-3999.html");
