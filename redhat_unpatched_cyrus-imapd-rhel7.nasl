...
# extracted from Red Hat Security Advisory cyrus-imapd. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-8076", "CVE-2019-19783");

  script_name(english:"RHEL 7 : cyrus-imapd (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-19783");
