...
the RHSA-2019:2731 advisory.
    ...
    are .NET Core SDK 2.1.509 and Runtime 2.1.13.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2731.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e55e28e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2731");
...
"Update the RHEL .NET Core on Red Hat Enterprise Linux package based on the guidance in RHSA-2019:2731.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dotnet-2.1.509-1.el8_0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-host-2.1.13-1.el8_0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-host-fxr-2.1-2.1.13-1.el8_0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-2.1-2.1.13-1.el8_0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-2.1-2.1.509-1.el8_0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-2.1.5xx-2.1.509-1.el8_0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
