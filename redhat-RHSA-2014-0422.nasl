...
# extracted from Red Hat Security Advisory RHSA-2014:0422. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0422");

  script_name(english:"RHEL 6 : openshift-origin-broker (RHSA-2014:0422)");
...
daemon for this update to take effect.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0422");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2014-0188");
...
rubygem-openshift-origin-auth-remote-user packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0188");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-broker-1.5.9-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-auth-remote-user-1.8.4-1.el6")) flag++;
