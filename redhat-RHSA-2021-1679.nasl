...
# extracted from Red Hat Security Advisory RHSA-2021:1679. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1679");

  script_name(english:"RHEL 8 : bash (RHSA-2021:1679)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for bash.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:1679 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1679.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?07d17a2d");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.4_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?862005a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1679");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1778309");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1890888");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bash package based on the guidance in RHSA-2021:1679.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bash-4.4.19-14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-doc-4.4.19-14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
