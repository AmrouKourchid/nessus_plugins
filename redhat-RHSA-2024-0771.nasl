...
# extracted from Red Hat Security Advisory RHSA-2024:0771. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0771");

  script_name(english:"RHEL 8 : squid:4 (RHSA-2024:0771)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for squid:4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:0771 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0771.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?48ce36f7");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0771");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid:4 package based on the guidance in RHSA-2024:0771.");
  ...
  'squid:4': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'squid-4.15-3.module+el8.6.0+21069+a1561e3d.4', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
      ]
    }
  ]
};
