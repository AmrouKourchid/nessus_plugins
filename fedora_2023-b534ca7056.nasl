...
# extracted from Fedora Security Advisory FEDORA-2023-b534ca7056
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b534ca7056");

  script_name(english:"Fedora 38 : mod_auth_openidc (2023-b534ca7056)");
...
FEDORA-2023-b534ca7056 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b534ca7056");
...
var pkgs = [
    {'reference':'mod_auth_openidc-2.4.13.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
