...
# extracted from Red Hat Security Advisory puppet. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-2785", "CVE-2017-2295");

  script_name(english:"RHEL 6 : puppet (Unpatched Vulnerability) (deprecated)");
