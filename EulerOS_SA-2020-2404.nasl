...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : vim (EulerOS-SA-2020-2404)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2404
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e63342c7");
...
pkgs = ["vim-X11-7.4.160-2.h10",
        "vim-common-7.4.160-2.h10",
        "vim-enhanced-7.4.160-2.h10",
        "vim-filesystem-7.4.160-2.h10",
        "vim-minimal-7.4.160-2.h10"];
