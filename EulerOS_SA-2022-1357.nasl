...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : numpy (EulerOS-SA-2022-1357)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the numpy packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1357
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d8d75f3e");
...
"Update the affected numpy packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python2-numpy");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python2-numpy-f2py");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python3-numpy");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python3-numpy-f2py");
...
var pkgs = [
  "python2-numpy-1.15.1-1.h1.eulerosv2r8",
  "python2-numpy-f2py-1.15.1-1.h1.eulerosv2r8",
  "python3-numpy-1.15.1-1.h1.eulerosv2r8",
  "python3-numpy-f2py-1.15.1-1.h1.eulerosv2r8"
];
