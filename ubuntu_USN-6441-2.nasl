...
# extracted from Ubuntu Security Notice USN-6441-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6441-2");

  script_name(english:"Ubuntu 18.04 ESM : Linux kernel (GCP) vulnerabilities (USN-6441-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6441-2");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6441-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6441-2');
  }
  else
  {
