...
if (description)
{
  ...
  script_name(english:"NuGet Package 'Azure.AI.OpenAI' Detection");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.nuget.org/packages/Azure.AI.OpenAI/");
  script_set_attribute(attribute:"solution", value:
"The Azure.AI.OpenAI package is installed on the remote host.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:microsoft:azure.ai.openai");
...
var app_info = vcf::nuget_package::get_app_info(pkg_name:"Azure.AI.OpenAI");
app_info.vendor = "Azure.AI.OpenAI";
app_info.cpe = "cpe:/a:microsoft:azure.ai.openai";
