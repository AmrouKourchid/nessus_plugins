...
# extracted from Red Hat Security Advisory RHSA-2024:3061. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3061");

  script_name(english:"RHEL 8 : pki-core:10.6 and pki-deps:10.6 (RHSA-2024:3061)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a4850f1b");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2064698");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-12764");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-12765");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-16724");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-19140");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-22445");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3061");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pki-core:10.6 / pki-deps:10.6 packages based on the guidance in RHSA-2024:3061.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:jackson-bom");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:jackson-modules-base");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:jackson-parent");
  ...
  'pki-deps:10.6': [
    {
      ...
      'pkgs': [
        {'reference':'apache-commons-collections-3.2.2-10.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'apache-commons-lang-2.6-21.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'apache-commons-net-3.6-3.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'bea-stax-api-1.2.0-16.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'fasterxml-oss-parent-49-1.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'glassfish-fastinfoset-1.2.13-9.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'glassfish-jaxb-api-2.2.12-8.module+el8.10.0+21035+a01f6469', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'glassfish-jaxb-core-2.2.11-12.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'glassfish-jaxb-runtime-2.2.11-12.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'glassfish-jaxb-txw2-2.2.11-12.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jackson-annotations-2.14.2-1.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jackson-bom-2.14.2-1.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jackson-core-2.14.2-1.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jackson-databind-2.14.2-1.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jackson-jaxrs-json-provider-2.14.2-1.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jackson-jaxrs-providers-2.14.2-1.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jackson-module-jaxb-annotations-2.14.2-2.module+el8.10.0+21055+7d27fa3b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jackson-modules-base-2.14.2-2.module+el8.10.0+21055+7d27fa3b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jackson-parent-2.14-1.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jakarta-commons-httpclient-3.1-28.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'javassist-3.18.1-8.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'javassist-javadoc-3.18.1-8.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-servlet-engine-9.0.62-1.module+el8.10.0+21257+2b5308b5', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'relaxngDatatype-2011.1-7.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'slf4j-1.7.25-4.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'slf4j-jdk14-1.7.25-4.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'stax-ex-1.7.7-8.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'velocity-1.7-24.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'xalan-j2-2.7.1-38.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'xerces-j2-2.11.0-34.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'xml-commons-apis-1.4.01-25.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'xml-commons-resolver-1.2-26.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'xmlstreambuffer-1.5.4-8.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'xsom-0-19.20110809svn.module+el8.10.0+20993+d0f024b0', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
