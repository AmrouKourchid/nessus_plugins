...
# extracted from Red Hat Security Advisory RHSA-2020:5583. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5583");

  script_name(english:"RHEL 7 : memcached (RHSA-2020:5583)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for memcached.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5583.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f4a4cfe0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5583");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1706001");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL memcached package based on the guidance in RHSA-2020:5583.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'memcached-1.4.39-3.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'memcached-1.4.39-3.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
