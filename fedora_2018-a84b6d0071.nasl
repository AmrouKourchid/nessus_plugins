...
# extracted from Fedora Security Advisory FEDORA-2018-a84b6d0071.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-a84b6d0071");

  script_name(english:"Fedora 29 : feh (2018-a84b6d0071)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a84b6d0071");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"feh-2.28-1.fc29")) flag++;
