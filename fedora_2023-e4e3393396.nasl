...
# extracted from Fedora Security Advisory FEDORA-2023-e4e3393396
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e4e3393396");

  script_name(english:"Fedora 38 : redis (2023-e4e3393396)");
...
FEDORA-2023-e4e3393396 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e4e3393396");
...
var pkgs = [
    {'reference':'redis-7.0.11-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
