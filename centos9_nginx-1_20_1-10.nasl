...
if (description)
{
  ...
  script_name(english:"CentOS 9 : nginx-1.20.1-10.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for nginx.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
nginx-1.20.1-10.el9 build changelog.

  - Application Layer Protocol Confusion (CVE-2021-3618)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=16715");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream nginx package.");
...
var pkgs = [
    {'reference':'nginx-1.20.1-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'nginx-all-modules-1.20.1-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'nginx-filesystem-1.20.1-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'nginx-mod-devel-1.20.1-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'nginx-mod-http-image-filter-1.20.1-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'nginx-mod-http-perl-1.20.1-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'nginx-mod-http-xslt-filter-1.20.1-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'nginx-mod-mail-1.20.1-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'nginx-mod-stream-1.20.1-10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
