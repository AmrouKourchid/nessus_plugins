...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Requests vulnerability (USN-2531-1)");
...
USN-2531-1 advisory.
    ...
    Matthew Daley discovered that Requests incorrectly handled cookies without host values when being
    redirected. A remote attacker could possibly use this issue to perform session fixation or cookie stealing
    attacks.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2531-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-requests', 'pkgver': '2.2.1-1ubuntu0.2'},
    {'osver': '14.04', 'pkgname': 'python3-requests', 'pkgver': '2.2.1-1ubuntu0.2'}
];
