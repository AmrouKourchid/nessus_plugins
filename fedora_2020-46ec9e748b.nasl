...
# extracted from Fedora Security Advisory FEDORA-2020-46ec9e748b.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : python-rtslib (2020-46ec9e748b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-46ec9e748b");
...
"Update the affected python-rtslib package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-rtslib");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"python-rtslib-2.1.73-1.fc32")) flag++;
