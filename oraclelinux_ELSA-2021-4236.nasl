...
# extracted from Oracle Linux Security Advisory ELSA-2021-4236.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : tcpdump (ELSA-2021-4236)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-4236.html");
