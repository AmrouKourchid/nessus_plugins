...
# extracted from Fedora Security Advisory FEDORA-2025-e6f20785e3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e6f20785e3");

  script_name(english:"Fedora 41 : java-11-openjdk (2025-e6f20785e3)");
...
FEDORA-2025-e6f20785e3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e6f20785e3");
...
var pkgs = [
    {'reference':'java-11-openjdk-11.0.26.0.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
