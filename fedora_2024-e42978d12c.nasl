...
# extracted from Fedora Security Advisory FEDORA-2024-e42978d12c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e42978d12c");
  script_xref(name:"IAVA", value:"2024-A-0052-S");

  script_name(english:"Fedora 38 : chromium (2024-e42978d12c)");
...
FEDORA-2024-e42978d12c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e42978d12c");
...
var pkgs = [
    {'reference':'chromium-121.0.6167.85-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
