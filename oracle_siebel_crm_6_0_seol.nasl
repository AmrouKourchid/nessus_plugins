...
if (description)
{
  ...
  script_name(english:"Oracle Siebel CRM SEoL (6.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Oracle Siebel CRM is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Oracle Siebel CRM is 6.0.x. It is, therefore, no longer maintained by its
vendor or provider.
...
"Upgrade to a version of Oracle Siebel CRM that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2007/12/31");
