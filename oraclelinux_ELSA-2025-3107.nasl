...
# extracted from Oracle Linux Security Advisory ELSA-2025-3107.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : libxslt (ELSA-2025-3107)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-3107.html");
...
var pkgs = [
    {'reference':'libxslt-1.1.34-9.0.1.el9_5.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-devel-1.1.34-9.0.1.el9_5.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-1.1.34-9.0.1.el9_5.1', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-devel-1.1.34-9.0.1.el9_5.1', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-1.1.34-9.0.1.el9_5.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-devel-1.1.34-9.0.1.el9_5.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
