...
# extracted from Debian Security Advisory dla-2838. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2838-1 : librecad - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2838");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'librecad', 'reference': '2.1.2-1+deb9u2'},
    {'release': '9.0', 'prefix': 'librecad-data', 'reference': '2.1.2-1+deb9u2'}
];
