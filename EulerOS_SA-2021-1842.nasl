...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : python-urllib3 (EulerOS-SA-2021-1842)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1842
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd9bccaf");
...
pkgs = ["python-urllib3-1.10.2-2.h3"];
