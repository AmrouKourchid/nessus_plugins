...
# extracted from Fedora Security Advisory FEDORA-2023-766cc7ab0f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-766cc7ab0f");

  script_name(english:"Fedora 36 : thunderbird (2023-766cc7ab0f)");
...
FEDORA-2023-766cc7ab0f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-766cc7ab0f");
...
var pkgs = [
    {'reference':'thunderbird-102.8.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
