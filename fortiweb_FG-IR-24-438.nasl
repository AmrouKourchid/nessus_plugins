...
if (description)
{
  ...
  script_cve_id("CVE-2024-50567", "CVE-2024-50569");

  script_name(english:"Fortinet FortiWeb OS Command Injections (FG-IR-24-438)");
...
vulnerabilities as referenced in the FG-IR-24-438 advisory.
  ...
  - An improper neutralization of special elements used in an os command ('os command injection') in Fortinet
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-24-438");
  script_set_attribute(attribute:"solution", value:
"Upgrade to FortiWeb version 7.0.999999 / 7.2.999999 / 7.4.6 / 7.6.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:M/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:H/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50569");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-50567");
