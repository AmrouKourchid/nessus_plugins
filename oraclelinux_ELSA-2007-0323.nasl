...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Important: / xen (ELSA-2007-0323)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0323.html");
...
"Update the affected xen, xen-devel and / or xen-libs packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-1321");
...
var pkgs = [
    {'reference':'xen-3.0.3-25.0.4.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-devel-3.0.3-25.0.4.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-libs-3.0.3-25.0.4.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-3.0.3-25.0.4.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-devel-3.0.3-25.0.4.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-libs-3.0.3-25.0.4.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
