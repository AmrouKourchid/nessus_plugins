...
# extracted from Red Hat Security Advisory RHSA-2021:0991. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0991.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56772a68");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0991");
...
"Update the RHEL firefox package based on the guidance in RHSA-2021:0991.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-78.9.0-1.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
