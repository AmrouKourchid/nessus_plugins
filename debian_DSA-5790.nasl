...
# extracted from Debian Security Advisory dsa-5790. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-47875");

  script_name(english:"Debian dsa-5790 : node-dompurify - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has a package installed that is affected by a vulnerability as referenced in the dsa-5790
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c175c830");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-47875");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/node-dompurify");
  script_set_attribute(attribute:"solution", value:
"Upgrade the node-dompurify packages.");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'node-dompurify', 'reference': '2.4.1+dfsg+~2.4.0-2'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'node-dompurify');
}
