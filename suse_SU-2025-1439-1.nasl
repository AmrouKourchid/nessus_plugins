...
# SUSE update advisory SUSE-SU-2025:1439-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:1439-1");

  script_name(english:"openSUSE 15 Security Update : libxml2 (SUSE-SU-2025:1439-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2025-May/039132.html");
...
var pkgs = [
    {'reference':'python3-libxml2-python-2.9.7-150000.3.79.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']}
];
