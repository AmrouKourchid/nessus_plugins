...
referenced in the RHSA-2017:0344 advisory.
    ...
    * An out-of-bounds read-access flaw was found in the QEMU emulator built with IP checksum routines. The
    flaw could occur when computing a TCP/UDP packet's checksum, because a QEMU function used the packet's
    payload length without checking against the data buffer's size. A user inside a guest could use this flaw
    to crash the QEMU process (denial of service). (CVE-2016-2857)

    Red Hat would like to thank Wjjzhang (Tencent.com Inc.) Li Qiang (360.cn Inc.) for reporting CVE-2017-2615
    and Ling Liu (Qihoo 360 Inc.) for reporting CVE-2016-2857.

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_0344.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cdef586a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:0344");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1296567");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1418200");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2017:0344.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-rhev-0.12.1.2-2.491.el6_8.6', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-rhev-0.12.1.2-2.491.el6_8.6', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-rhev-tools-0.12.1.2-2.491.el6_8.6', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ovirt-'}
    ]
  }
];
