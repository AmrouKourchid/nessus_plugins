...
to fix the configuration.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=947459");
  # https://security-tracker.debian.org/tracker/source-package/debian-lan-config
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bbd0d795");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/debian-lan-config");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/debian-lan-config");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2019/dsa-4595");
