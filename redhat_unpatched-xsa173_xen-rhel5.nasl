...
# extracted from Red Hat Security Advisory xsa173_xen. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : xsa173_xen (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-3960");
