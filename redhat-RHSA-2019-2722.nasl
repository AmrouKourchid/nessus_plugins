...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2722.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb73c530");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2722");
...
"Update the RHEL libwmf package based on the guidance in RHSA-2019:2722.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libwmf-0.2.9-8.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwmf-devel-0.2.9-8.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwmf-lite-0.2.9-8.el8_0', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
