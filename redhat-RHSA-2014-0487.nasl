...
# extracted from Red Hat Security Advisory RHSA-2014:0487. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2014-0234");
  script_xref(name:"RHSA", value:"2014:0487");

  script_name(english:"RHEL 6 : openshift (RHSA-2014:0487)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"Red Hat OpenShift Enterprise release 2.1, which fixes one security
...
It was discovered that openshift-origin-broker configured several
default user names and passwords for services if no user name or
password was specified during installation. A remote attacker could
use these default user names and passwords to access various parts of
the OpenShift Enterprise installation with the privileges of an
administrative user. (CVE-2014-0234)

This issue was discovered by Kurt Seifried of the Red Hat Security
Response Team.

The OpenShift Enterprise 2.1 Release Notes provide information about
...
All OpenShift Enterprise users are advised to upgrade to release 2.1.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0487");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2014-0234");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0234");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:jboss-eap6-index");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python27-numpy-debuginfo");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rsyslog7-crypto");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rsyslog7-libdbi");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rsyslog7-mmjsonparse");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ruby193-rubygem-net-ldap-doc");
...
else
{
  ...
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"haproxy15side-1.5-0.1.dev19.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"haproxy15side-debuginfo-1.5-0.1.dev19.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"jboss-eap6-index-6.0.1.GA-2.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"jenkins-1.509.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"jenkins-plugin-openshift-0.6.28-1.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libcgroup-debuginfo-0.40.rc1-5.el6_5.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libcgroup-pam-0.40.rc1-5.el6_5.1")) flag++;
  ...
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libestr-0.1.5-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libestr-debuginfo-0.1.5-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libestr-devel-0.1.5-1.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"mod_passenger-3.0.21-9.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"openshift-enterprise-release-2.1.0-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-enterprise-upgrade-broker-2.1.0-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-enterprise-upgrade-node-2.1.0-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-enterprise-yum-validator-2.1.0-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-broker-1.16.1.3-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-broker-util-1.23.8.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-cron-1.21.2-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-optional-jbosseap-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-optional-jbossews-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-optional-nodejs-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-optional-perl-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-optional-php-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-optional-python-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-optional-ruby-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-recommended-jbosseap-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-recommended-jbossews-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-recommended-nodejs-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-recommended-perl-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-recommended-php-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-recommended-python-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-dependencies-recommended-ruby-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-diy-1.21.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-haproxy-1.23.5.3-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-jbosseap-2.16.3.4-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-jbossews-1.22.3.4-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-jenkins-1.20.3.3-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-jenkins-client-1.19.3-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-mock-1.18.2-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-mock-plugin-1.18.2-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-mysql-1.23.4.3-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-nodejs-1.24.3.3-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-perl-1.22.5.3-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-php-1.23.3.4-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-postgresql-1.23.3.3-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-python-1.23.4.3-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-cartridge-ruby-1.23.3.3-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-console-1.16.2.3-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"openshift-origin-logshifter-1.5.2-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-msg-common-1.19.2-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-msg-node-mcollective-1.22.2-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-node-proxy-1.22.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-node-util-1.22.6.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-port-proxy-1.9.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openshift-origin-util-scl-1.17.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"pam_openshift-1.12.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"pam_openshift-debuginfo-1.12.1-1.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"python27-mod_wsgi-3.4-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"python27-mod_wsgi-debuginfo-3.4-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"python27-numpy-1.4.1-10.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"python27-numpy-debuginfo-1.4.1-10.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"python27-numpy-f2py-1.4.1-10.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"quartz-2.2.1.redhat_1-1.el6_5")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rhc-1.23.7.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rsyslog7-7.4.7-5.4.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rsyslog7-crypto-7.4.7-5.4.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rsyslog7-debuginfo-7.4.7-5.4.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rsyslog7-gnutls-7.4.7-5.4.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rsyslog7-libdbi-7.4.7-5.4.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rsyslog7-mmjsonparse-7.4.7-5.4.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rsyslog7-mmopenshift-7.4.7-5.4.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rsyslog7-mysql-7.4.7-5.4.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rsyslog7-pgsql-7.4.7-5.4.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rsyslog7-snmp-7.4.7-5.4.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"ruby193-mcollective-2.4.1-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"ruby193-mcollective-client-2.4.1-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"ruby193-mcollective-common-2.4.1-5.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"ruby193-rubygem-httpclient-2.3.4.1-1.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"ruby193-rubygem-net-ldap-doc-0.3.1-1.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"rubygem-httpclient-2.3.2-1.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-admin-console-1.20.2.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-auth-remote-user-1.19.6.2-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-common-1.22.5.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-console-1.23.4.2-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-container-selinux-0.8.1.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-controller-1.23.10.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-dns-nsupdate-1.16.2.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-frontend-apache-mod-rewrite-0.5.2.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-frontend-apache-vhost-0.5.2.2-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-frontend-apachedb-0.4.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-frontend-haproxy-sni-proxy-0.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-frontend-nodejs-websocket-0.4.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-msg-broker-mcollective-1.23.3.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-node-1.23.9.3-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-routing-activemq-0.4.1-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rubygem-parseconfig-0.5.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rubygem-passenger-3.0.21-9.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rubygem-passenger-debuginfo-3.0.21-9.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rubygem-passenger-devel-3.0.21-9.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rubygem-passenger-native-3.0.21-9.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rubygem-passenger-native-libs-3.0.21-9.el6")) flag++;
