...
# extracted from Red Hat Security Advisory RHSA-2024:1153. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1153");

  script_name(english:"RHEL 9 : squid (RHSA-2024:1153)");
...
referenced in the RHSA-2024:1153 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1153.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e41e7fcc");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1153");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid package based on the guidance in RHSA-2024:1153.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squid-5.2-1.el9_0.4', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
