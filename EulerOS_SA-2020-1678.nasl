...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : freerdp (EulerOS-SA-2020-1678)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1678
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9ade23b3");
...
"Update the affected freerdp package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-11046");
...
pkgs = ["freerdp-1.0.2-6.1.h5",
        "freerdp-libs-1.0.2-6.1.h5",
        "freerdp-plugins-1.0.2-6.1.h5"];
