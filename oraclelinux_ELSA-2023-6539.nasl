...
# extracted from Oracle Linux Security Advisory ELSA-2023-6539.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : perl-CPAN (ELSA-2023-6539)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6539.html");
...
var pkgs = [
    {'reference':'perl-CPAN-2.29-3.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
