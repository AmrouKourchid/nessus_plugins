...
# extracted from Fedora Security Advisory FEDORA-2024-2005708761
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2005708761");

  script_name(english:"Fedora 40 : python-jinja2 (2024-2005708761)");
...
FEDORA-2024-2005708761 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2005708761");
...
var pkgs = [
    {'reference':'python-jinja2-3.1.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
