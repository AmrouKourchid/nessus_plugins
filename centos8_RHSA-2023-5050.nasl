...
# Red Hat Security Advisory RHSA-2023:5050. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : httpd:2.4 (CESA-2023:5050)");
...
"Update the affected mod_md package.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mod_md');
}
