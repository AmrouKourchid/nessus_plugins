...
# extracted from Debian Security Advisory dla-4050. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4050 : bind9 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4050
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-11187");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'bind9', 'reference': '1:9.16.50-1~deb11u3'},
    {'release': '11.0', 'prefix': 'bind9-dev', 'reference': '1:9.16.50-1~deb11u3'},
    {'release': '11.0', 'prefix': 'bind9-dnsutils', 'reference': '1:9.16.50-1~deb11u3'},
    {'release': '11.0', 'prefix': 'bind9-doc', 'reference': '1:9.16.50-1~deb11u3'},
    {'release': '11.0', 'prefix': 'bind9-host', 'reference': '1:9.16.50-1~deb11u3'},
    {'release': '11.0', 'prefix': 'bind9-libs', 'reference': '1:9.16.50-1~deb11u3'},
    {'release': '11.0', 'prefix': 'bind9-utils', 'reference': '1:9.16.50-1~deb11u3'},
    {'release': '11.0', 'prefix': 'bind9utils', 'reference': '1:9.16.50-1~deb11u3'},
    {'release': '11.0', 'prefix': 'dnsutils', 'reference': '1:9.16.50-1~deb11u3'}
];
