...
# extracted from Fedora Security Advisory FEDORA-2023-f6ff3f85eb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f6ff3f85eb");

  script_name(english:"Fedora 37 : httpd (2023-f6ff3f85eb)");
...
FEDORA-2023-f6ff3f85eb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f6ff3f85eb");
...
var pkgs = [
    {'reference':'httpd-2.4.55-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
