...
# extracted from Red Hat Security Advisory RHSA-2022:2120. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:2120");

  script_name(english:"RHEL 8 : zsh (RHSA-2022:2120)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for zsh.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:2120 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_2120.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?920dd7ea");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.6_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9341665d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:2120");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2054089");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL zsh package based on the guidance in RHSA-2022:2120.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'zsh-5.5.1-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
