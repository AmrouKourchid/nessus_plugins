...
if (description)
{
  ...
  script_cve_id("CVE-2024-30875");
  script_xref(name:"IAVB", value:"2024-B-0159");

  script_name(english:"JQuery UI 1.13.1 XSS");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server is by a cross-site scripting vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of JQuery UI library hosted on the remote web server is prior to 1.13.1. It is, therefore, affected by
a cross-site scripting vulnerability in the JQuery UI that allows remote attackers to obtain sensitive information and 
execute arbitrary code by injecting a crafted payload into the window.addEventListener component.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/Ant1sec-ops/CVE-2024-30875");
...
"Upgrade to JQuery UI version 1.13.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-30875");
...
var constraints = [{'equal':'1.13.1', 'fixed_display':'Upgrade to a fixed release'}];
