...
# extracted from Red Hat Security Advisory RHSA-2022:9072.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2022:9072)");
...
var pkgs = [
    {'reference':'firefox-102.6.0-1.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.6.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
