...
# extracted from Debian Security Advisory dsa-5892. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5892 : atop - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has a package installed that is affected by a vulnerability as referenced in the dsa-5892
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/atop");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'atop', 'reference': '2.8.1-1+deb12u1'}
];
