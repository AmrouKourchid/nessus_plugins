...
# extracted from Fedora Security Advisory FEDORA-2023-638681260a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-638681260a");

  script_name(english:"Fedora 37 : kernel (2023-638681260a)");
...
FEDORA-2023-638681260a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-638681260a");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2023-20569', 'CVE-2023-34319');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-638681260a');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.4.9-100.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
