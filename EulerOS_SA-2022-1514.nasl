...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : python-pillow (EulerOS-SA-2022-1514)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1514
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8fc0f216");
...
var pkgs = [
  "python3-pillow-8.1.1-2.h6.eulerosv2r10"
];
