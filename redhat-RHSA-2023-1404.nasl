...
# extracted from Red Hat Security Advisory RHSA-2023:1404. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1404.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef7069d1");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1404");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2023:1404.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-102.9.0-1.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
