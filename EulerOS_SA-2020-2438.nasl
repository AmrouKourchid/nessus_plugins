...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-ipaddress (EulerOS-SA-2020-2438)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2438
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b100a80");
...
pkgs = ["python3-ipaddress-1.0.18-9.h1.eulerosv2r9"];
