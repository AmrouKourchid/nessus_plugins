...
# extracted from Red Hat Security Advisory imagemagick,_graphicsmagick. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : imagemagick,_graphicsmagick (Unpatched Vulnerability) (deprecated)");
