...
# extracted from Red Hat Security Advisory RHSA-2024:7854. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7854");

  script_name(english:"RHEL 8 : thunderbird (RHSA-2024:7854)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for thunderbird.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2024:7854 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f191a5f9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7854");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2024:7854.");
  ...
  script_cwe_id(94, 119, 120, 203, 346, 754, 789, 1021);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-128.3.0-1.el8_4', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-128.3.0-1.el8_4', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
