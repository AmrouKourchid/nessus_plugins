...
# extracted from Fedora Security Advisory FEDORA-2024-19882248ad
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-19882248ad");

  script_name(english:"Fedora 41 : python3.6 (2024-19882248ad)");
...
FEDORA-2024-19882248ad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-19882248ad");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-27.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
