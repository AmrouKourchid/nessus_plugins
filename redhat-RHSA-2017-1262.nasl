...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_1262.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9b422f9a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHBA-2017:1436");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:1262");
...
"Update the RHEL rpcbind package based on the guidance in RHSA-2017:1262.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rpcbind-0.2.0-38.el7_3', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
