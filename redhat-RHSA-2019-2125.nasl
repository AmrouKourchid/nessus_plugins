...
# extracted from Red Hat Security Advisory RHSA-2019:2125. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : ovmf (RHSA-2019:2125)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for ovmf.");
...
referenced in the RHSA-2019:2125 advisory.

    OVMF (Open Virtual Machine Firmware) is a project to enable UEFI support for Virtual Machines. This
    ...
    * edk2: Logic error in MdeModulePkg in EDK II firmware allows for privilege escalation by authenticated
    users (CVE-2018-3613)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?23ef5c27");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html/7.7_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc7115e8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2125");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1641433");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1641442");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1641446");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1641450");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1641458");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1641465");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1645695");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1686783");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1691640");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1694065");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ovmf package based on the guidance in RHSA-2019:2125.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'OVMF-20180508-6.gitee3198e672e2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
