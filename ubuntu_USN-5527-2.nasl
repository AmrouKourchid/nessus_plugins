...
# extracted from Ubuntu Security Notice USN-5527-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5527-2");

  script_name(english:"Ubuntu 16.04 ESM : Checkmk  vulnerabilities (USN-5527-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5527-2");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:check-mk-config-nagios3");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'check-mk-agent', 'pkgver': '1.2.6p12-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'check-mk-agent-logwatch', 'pkgver': '1.2.6p12-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'check-mk-config-icinga', 'pkgver': '1.2.6p12-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'check-mk-config-nagios3', 'pkgver': '1.2.6p12-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'check-mk-livestatus', 'pkgver': '1.2.6p12-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'check-mk-multisite', 'pkgver': '1.2.6p12-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'check-mk-server', 'pkgver': '1.2.6p12-1ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE}
];
