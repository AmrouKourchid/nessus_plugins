...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Go PHSA-2024-4.0-0704");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'go-1.21.13-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'go-md2man-2.0.0-26.ph4')) flag++;
