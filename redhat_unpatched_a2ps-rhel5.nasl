...
# extracted from Red Hat Security Advisory a2ps. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2014-0466", "CVE-2015-8107");

  script_name(english:"RHEL 5 : a2ps (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8107");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:a2ps");
