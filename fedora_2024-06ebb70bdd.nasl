...
# extracted from Fedora Security Advisory FEDORA-2024-06ebb70bdd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-06ebb70bdd");

  script_name(english:"Fedora 38 : podman (2024-06ebb70bdd)");
...
FEDORA-2024-06ebb70bdd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-06ebb70bdd");
...
var pkgs = [
    {'reference':'podman-4.8.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
