...
# extracted from Fedora Security Advisory FEDORA-2022-775c747e4a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-775c747e4a");

  script_name(english:"Fedora 35 : libreoffice (2022-775c747e4a)");
...
FEDORA-2022-775c747e4a advisory.

    LibreOffice supports Office URI Schemes to enable browser integration of LibreOffice with MS SharePoint
    server. An additional scheme 'vnd.libreoffice.command' specific to LibreOffice was added.

    In the affected versions of LibreOffice links using that scheme could be constructed to call internal
    macros with arbitrary arguments. Which when clicked on, or activated by document events, could result in
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-775c747e4a");
...
var pkgs = [
    {'reference':'libreoffice-7.2.7.2-2.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
