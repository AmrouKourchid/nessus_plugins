...
# extracted from Fedora Security Advisory FEDORA-2023-cf01e05114
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cf01e05114");

  script_name(english:"Fedora 37 : cjose (2023-cf01e05114)");
...
FEDORA-2023-cf01e05114 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cf01e05114");
...
var pkgs = [
    {'reference':'cjose-0.6.2.2-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
