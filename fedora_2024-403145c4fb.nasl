...
# extracted from Fedora Security Advisory FEDORA-2024-403145c4fb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-403145c4fb");

  script_name(english:"Fedora 38 : freeipa (2024-403145c4fb)");
...
FEDORA-2024-403145c4fb advisory.

    Upstream security release for CVE-2023-5455.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-403145c4fb");
...
var pkgs = [
    {'reference':'freeipa-4.10.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
