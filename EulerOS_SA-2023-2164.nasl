...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : pki-core (EulerOS-SA-2023-2164)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the pki-core packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2164
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6af3c406");
...
var pkgs = [
  "pki-base-10.5.1-14.h7.eulerosv2r7",
  "pki-base-java-10.5.1-14.h7.eulerosv2r7",
  "pki-ca-10.5.1-14.h7.eulerosv2r7",
  "pki-kra-10.5.1-14.h7.eulerosv2r7",
  "pki-server-10.5.1-14.h7.eulerosv2r7",
  "pki-symkey-10.5.1-14.h7.eulerosv2r7",
  "pki-tools-10.5.1-14.h7.eulerosv2r7"
];
