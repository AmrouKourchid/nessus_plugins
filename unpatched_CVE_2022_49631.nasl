...
if (description)
{
  ...
  script_cve_id("CVE-2022-49631");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49631");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: raw: Fix a data-race around
    sysctl_raw_l3mdev_accept. While reading sysctl_raw_l3mdev_accept, it can be changed concurrently. Thus, we
    need to add READ_ONCE() to its reader. (CVE-2022-49631)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49631");
