...
# extracted from Debian Security Advisory dla-3652. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3652 : ruby-sanitize - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3652
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3652-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/ruby-sanitize");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ruby-sanitize', 'reference': '4.6.6-2.1~deb10u2'}
];
