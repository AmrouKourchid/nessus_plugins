...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : golang (EulerOS-SA-2023-3006)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3006
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d3fd692d");
...
var pkgs = [
  "golang-1.17.3-1.h24.eulerosv2r11",
  "golang-devel-1.17.3-1.h24.eulerosv2r11",
  "golang-help-1.17.3-1.h24.eulerosv2r11"
];
