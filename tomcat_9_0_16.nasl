...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 9.0.0.M1 < 9.0.16");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 9.0.16. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_9.0.16_security-9 advisory.
...
number.");
  # https://github.com/apache/tomcat/commit/a1cb1ac77e3a8fec1b00eb0e944842555da14f7d
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c188e8f0");
  # https://tomcat.apache.org/security-9.html#Fixed_in_Apache_Tomcat_9.0.16
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f533113e");
...
var constraints = [
  { 'min_version' : '9.0.0.M1', 'max_version' : '9.0.14', 'fixed_version' : '9.0.16' }
];
