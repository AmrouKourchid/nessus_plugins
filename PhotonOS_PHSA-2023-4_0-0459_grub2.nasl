...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Grub2 PHSA-2023-4.0-0459");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'grub2-2.06-9.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'grub2-efi-2.06-9.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'grub2-efi-image-2.06-9.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'grub2-lang-2.06-9.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'grub2-pc-2.06-9.ph4')) flag++;
