...
"The version of Thunderbird installed on the remote Windows host is prior to 115.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2023-33 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'115.1', severity:SECURITY_HOLE);
