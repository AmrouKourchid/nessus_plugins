...
# SUSE update advisory SUSE-SU-2023:2708-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-1390", "CVE-2023-23455", "CVE-2023-31436");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2708-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 31 for SLE 12 SP4) (SUSE-SU-2023:2708-1)");
...
the SUSE-SU-2023:2708-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/030140.html");
...
"Update the affected kgraft-patch-4_12_14-95_111-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-95.111-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_111-default-8-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-95_111-default');
}
