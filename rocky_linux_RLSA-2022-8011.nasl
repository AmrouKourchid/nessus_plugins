...
# Rocky Linux Security Advisory RLSA-2022:8011.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:8011");

  script_name(english:"Rocky Linux 9 : fribidi (RLSA-2022:8011)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:8011");
...
var pkgs = [
    {'reference':'fribidi-1.0.10-6.el9.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fribidi-1.0.10-6.el9.2', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fribidi-1.0.10-6.el9.2', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fribidi-1.0.10-6.el9.2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fribidi-debuginfo-1.0.10-6.el9.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fribidi-debuginfo-1.0.10-6.el9.2', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fribidi-debuginfo-1.0.10-6.el9.2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fribidi-debugsource-1.0.10-6.el9.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fribidi-debugsource-1.0.10-6.el9.2', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fribidi-debugsource-1.0.10-6.el9.2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fribidi-devel-1.0.10-6.el9.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fribidi-devel-1.0.10-6.el9.2', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fribidi-devel-1.0.10-6.el9.2', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fribidi-devel-1.0.10-6.el9.2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
