...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2647.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python-dns (ALAS-2024-2647)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of python-dns installed on the remote host is prior to 1.12.0-4.20150617git465785f. It is, therefore,
affected by a vulnerability as referenced in the ALAS2-2024-2647 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2647.html");
...
"Run 'yum update python-dns' to update your system.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:python-dns");
...
var pkgs = [
    {'reference':'python-dns-1.12.0-4.20150617git465785f.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
