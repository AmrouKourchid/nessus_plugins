...
# extracted from Red Hat Security Advisory libjpeg. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-3616");

  script_name(english:"RHEL 7 : libjpeg (Unpatched Vulnerability) (deprecated)");
