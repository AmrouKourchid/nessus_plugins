...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : qt (EulerOS-SA-2020-2563)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2563
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a75c2c4f");
...
pkgs = ["qt-4.8.7-2.h8.eulerosv2r7",
        "qt-devel-4.8.7-2.h8.eulerosv2r7",
        "qt-mysql-4.8.7-2.h8.eulerosv2r7",
        "qt-odbc-4.8.7-2.h8.eulerosv2r7",
        "qt-postgresql-4.8.7-2.h8.eulerosv2r7",
        "qt-x11-4.8.7-2.h8.eulerosv2r7"];
