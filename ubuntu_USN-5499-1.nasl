...
the USN-5499-1 advisory.
    ...
    Florian Kohnhuser discovered that curl incorrectly handled returning a TLS servers certificate chain
    details. A remote attacker could possibly use this issue to cause curl to stop responding, resulting in a
    denial of service. (CVE-2022-27781)

    Harry Sintonen discovered that curl incorrectly handled certain FTP-KRB messages. An attacker could
    possibly use this to perform a machine-in-the-middle attack. (CVE-2022-32208)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'curl', 'pkgver': '7.47.0-1ubuntu2.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl3', 'pkgver': '7.47.0-1ubuntu2.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl3-gnutls', 'pkgver': '7.47.0-1ubuntu2.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl3-nss', 'pkgver': '7.47.0-1ubuntu2.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl4-gnutls-dev', 'pkgver': '7.47.0-1ubuntu2.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl4-nss-dev', 'pkgver': '7.47.0-1ubuntu2.19+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libcurl4-openssl-dev', 'pkgver': '7.47.0-1ubuntu2.19+esm4', 'ubuntu_pro': TRUE}
];
