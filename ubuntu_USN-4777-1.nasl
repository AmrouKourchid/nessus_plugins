...
# extracted from Ubuntu Security Notice USN-4777-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4777-1");

  script_name(english:"Ubuntu 16.04 ESM : node-tar vulnerability (USN-4777-1)");
...
USN-4777-1 advisory.
    ...
    It was discovered that node-tar mishandled certain tar archives. An attacker could use this vulnerability
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4777-1");
...
"Update the affected node-tar package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8860");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'node-tar', 'pkgver': '1.0.3-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
