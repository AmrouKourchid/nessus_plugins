...
# extracted from Red Hat Security Advisory RHSA-2022:7458. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7458");

  script_name(english:"RHEL 8 : flatpak-builder (RHSA-2022:7458)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for flatpak-builder.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7458.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c457acc");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.7_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?790bc9ea");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7458");
...
"Update the RHEL flatpak-builder package based on the guidance in RHSA-2022:7458.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flatpak-builder-1.0.14-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'flatpak-builder');
}
