...
# extracted from Fedora Security Advisory FEDORA-2022-b95f6a2db1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-b95f6a2db1");

  script_name(english:"Fedora 37 : firefox (2022-b95f6a2db1)");
...
FEDORA-2022-b95f6a2db1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-b95f6a2db1");
...
var pkgs = [
    {'reference':'firefox-107.0-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
