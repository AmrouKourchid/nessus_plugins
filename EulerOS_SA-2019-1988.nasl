...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : qemu-kvm (EulerOS-SA-2019-1988)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1988
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d75e7819");
...
"Update the affected qemu-kvm packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-4533");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-12617");
...
pkgs = ["qemu-img-1.5.3-156.5.h4.eulerosv2r7",
        "qemu-kvm-1.5.3-156.5.h4.eulerosv2r7",
        "qemu-kvm-common-1.5.3-156.5.h4.eulerosv2r7"];
