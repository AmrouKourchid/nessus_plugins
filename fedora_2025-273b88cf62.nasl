...
# extracted from Fedora Security Advisory FEDORA-2025-273b88cf62
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-273b88cf62");

  script_name(english:"Fedora 41 : lemonldap-ng (2025-273b88cf62)");
...
FEDORA-2025-273b88cf62 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-273b88cf62");
...
var pkgs = [
    {'reference':'lemonldap-ng-2.21.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
