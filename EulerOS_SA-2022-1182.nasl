...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : postgresql (EulerOS-SA-2022-1182)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1182
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd2379b9");
...
var pkgs = [
  "postgresql-9.2.24-1.h4",
  "postgresql-contrib-9.2.24-1.h4",
  "postgresql-devel-9.2.24-1.h4",
  "postgresql-docs-9.2.24-1.h4",
  "postgresql-libs-9.2.24-1.h4",
  "postgresql-plperl-9.2.24-1.h4",
  "postgresql-plpython-9.2.24-1.h4",
  "postgresql-pltcl-9.2.24-1.h4",
  "postgresql-server-9.2.24-1.h4",
  "postgresql-test-9.2.24-1.h4"
];
