...
# extracted from VMware Security Advisory PHSA-2021-4.0-0139. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Bluez PHSA-2021-4.0-0139");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the bluez package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-139.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'bluez-5.58-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'bluez-devel-5.58-2.ph4')) flag++;
