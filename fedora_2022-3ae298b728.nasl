...
# extracted from Fedora Security Advisory FEDORA-2022-3ae298b728
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-3ae298b728");

  script_name(english:"Fedora 37 : firefox (2022-3ae298b728)");
...
FEDORA-2022-3ae298b728 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3ae298b728");
...
var pkgs = [
    {'reference':'firefox-108.0-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
