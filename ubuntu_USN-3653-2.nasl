...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Linux kernel (HWE) vulnerabilities (USN-3653-2)");
...
the USN-3653-2 advisory.

    USN-3653-1 fixed vulnerabilities and added mitigations in the Linux kernel for Ubuntu 17.10. This update
    provides the corresponding updates for the Linux Hardware Enablement (HWE) kernel from Ubuntu 17.10 for
    Ubuntu 16.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3653-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.13.0-1017-gcp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.13.0-1018-azure");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.13.0-1028-oem");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.13.0-43-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.13.0-43-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.13.0-43-lowlatency");
...
var kernel_mappings = {
  '16.04': {
    '4.13.0': {
      'generic': '4.13.0-43',
      'generic-lpae': '4.13.0-43',
      'lowlatency': '4.13.0-43',
      'gcp': '4.13.0-1017',
      'azure': '4.13.0-1018',
      'oem': '4.13.0-1028'
    }
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3653-2');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2017-17449', 'CVE-2017-17975', 'CVE-2017-18203', 'CVE-2017-18208', 'CVE-2018-3639', 'CVE-2018-8822');
