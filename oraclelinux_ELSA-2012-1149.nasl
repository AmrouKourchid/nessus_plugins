...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-1149.html");
...
"Update the affected sudo package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-3440");
...
var pkgs = [
    {'reference':'sudo-1.7.2p1-14.el5_8.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.7.2p1-14.el5_8.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
