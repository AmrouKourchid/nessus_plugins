...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : vim (EulerOS-SA-2023-1403)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1403
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a735fe6");
...
var pkgs = [
  "vim-common-8.2-1.h62.eulerosv2r10",
  "vim-enhanced-8.2-1.h62.eulerosv2r10",
  "vim-filesystem-8.2-1.h62.eulerosv2r10",
  "vim-minimal-8.2-1.h62.eulerosv2r10"
];
