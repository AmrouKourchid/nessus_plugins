...
# extracted from openSUSE Security Update openSUSE-2019-731.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : bitcoin (openSUSE-2019-731)");
...
For additional changes please check the changelog.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1108992");
  script_set_attribute(attribute:"solution", value:
"Update the affected bitcoin packages.");
