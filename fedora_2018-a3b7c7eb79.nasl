...
# extracted from Fedora Security Advisory FEDORA-2018-a3b7c7eb79.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : PackageKit (2018-a3b7c7eb79)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"New upstream release - This release fixes CVE-2018-1106 which is a
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a3b7c7eb79");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"PackageKit-1.1.10-1.fc27")) flag++;
