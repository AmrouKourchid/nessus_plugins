...
if (description)
{
  ...
  script_cve_id("CVE-2023-52880");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-52880");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: tty: n_gsm: require CAP_NET_ADMIN to
    attach N_GSM0710 ldisc Any unprivileged user can attach N_GSM0710 ldisc, but it requires CAP_NET_ADMIN to
    create a GSM network anyway. Require initial namespace CAP_NET_ADMIN to do that. (CVE-2023-52880)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52880");
