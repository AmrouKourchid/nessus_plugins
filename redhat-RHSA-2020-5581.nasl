...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5581.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8011c92c");
...
"Update the RHEL python-XStatic-jQuery package based on the guidance in RHSA-2020:5581.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-XStatic-jQuery-2.2.4.1-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
