...
# extracted from Ubuntu Security Notice USN-7135-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7135-1");

  script_name(english:"Ubuntu 16.04 LTS : HAProxy vulnerability (USN-7135-1)");
...
USN-7135-1 advisory.
    ...
    Bahruz Jabiyev, Anthony Gavazzi, Engin Kirda, Kaan Onarlioglu, Adi Peleg, and Harvey Tuch discovered that
    HAProxy incorrectly handled empty header names. A remote attacker could possibly use this issue to
    manipulate headers and bypass certain authentication checks and restrictions.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7135-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'haproxy', 'pkgver': '1.6.3-1ubuntu0.3+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'vim-haproxy', 'pkgver': '1.6.3-1ubuntu0.3+esm2', 'ubuntu_pro': TRUE}
];
