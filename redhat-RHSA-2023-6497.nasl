...
# extracted from Red Hat Security Advisory RHSA-2023:6497. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6497");

  script_name(english:"RHEL 9 : libX11 (RHSA-2023:6497)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6497.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6a674880");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2213748");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6497");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libX11 package based on the guidance in RHSA-2023:6497.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libX11-1.7.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-common-1.7.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-devel-1.7.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-xcb-1.7.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
