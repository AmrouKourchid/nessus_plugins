...
# extracted from Fedora Security Advisory FEDORA-2018-16c8fdf9b8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : kubernetes (2018-16c8fdf9b8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-16c8fdf9b8");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"kubernetes-1.10.1-0.fc27")) flag++;
