...
# extracted from openSUSE Security Update openSUSE-2019-2435.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : nfs-utils (openSUSE-2019-2435)");
...
if ( rpm_check(release:"SUSE15.1", reference:"nfs-client-2.1.1-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"nfs-client-debuginfo-2.1.1-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"nfs-kernel-server-2.1.1-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"nfs-kernel-server-debuginfo-2.1.1-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"nfs-utils-debuginfo-2.1.1-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"nfs-utils-debugsource-2.1.1-lp151.7.3.1") ) flag++;
