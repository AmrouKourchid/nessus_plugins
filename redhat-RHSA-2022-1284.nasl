...
# extracted from Red Hat Security Advisory RHSA-2022:1284. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : firefox (RHSA-2022:1284)");
...
referenced in the RHSA-2022:1284 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1284.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?27127479");
...
"Update the RHEL firefox package based on the guidance in RHSA-2022:1284.");
  ...
  script_cwe_id(120, 125, 400, 416, 787, 1021);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-91.8.0-1.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.8.0-1.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.8.0-1.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.8.0-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-91.8.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
