...
# extracted from Red Hat Security Advisory RHSA-2024:9404. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9404");

  script_name(english:"RHEL 9 : libgcrypt (RHSA-2024:9404)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9404.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ec35153");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9404");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libgcrypt package based on the guidance in RHSA-2024:9404.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libgcrypt-1.10.0-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgcrypt-devel-1.10.0-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
