...
is, therefore, affected by a vulnerability as referenced in the K24624116 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K24624116");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '16.0.0-16.1.2','15.1.0-15.1.5','14.1.2-14.1.4','14.1.0.3-14.1.0.6','13.1.1-13.1.4','12.1.2 HF1-12.1.6'
    ],
    'unaffected': [
