...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : python-urllib3 (EulerOS-SA-2019-1620)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1620
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?df81e915");
...
pkgs = ["python-urllib3-1.10.2-2.h1"];
