...
# extracted from Red Hat Security Advisory RHSA-2018:3335. The text 
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3335.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9809beed");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3335");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xerces-c-3.1.1-9.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-devel-3.1.1-9.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xerces-c-doc-3.1.1-9.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
