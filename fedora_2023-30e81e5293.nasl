...
# extracted from Fedora Security Advisory FEDORA-2023-30e81e5293
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-30e81e5293");

  script_name(english:"Fedora 36 : c-ares (2023-30e81e5293)");
...
FEDORA-2023-30e81e5293 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-30e81e5293");
...
var pkgs = [
    {'reference':'c-ares-1.19.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
