...
# extracted from Fedora Security Advisory FEDORA-2023-42d6ba9bd6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-42d6ba9bd6");

  script_name(english:"Fedora 37 : postgresql-jdbc (2023-42d6ba9bd6)");
...
FEDORA-2023-42d6ba9bd6 advisory.

    Rebase to 42.4.3 with fix of CVE-2022-41946.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-42d6ba9bd6");
...
var pkgs = [
    {'reference':'postgresql-jdbc-42.4.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
