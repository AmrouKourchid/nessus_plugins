...
# extracted from Fedora Security Advisory FEDORA-2022-714b48d4d5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-714b48d4d5");

  script_name(english:"Fedora 37 : mod_auth_openidc (2022-714b48d4d5)");
...
FEDORA-2022-714b48d4d5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-714b48d4d5");
...
var pkgs = [
    {'reference':'mod_auth_openidc-2.4.9.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
