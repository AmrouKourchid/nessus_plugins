...
# extracted from Fedora Security Advisory FEDORA-2023-abc9ca1e7e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-abc9ca1e7e");
  script_xref(name:"IAVB", value:"2023-B-0063-S");

  script_name(english:"Fedora 38 : wireshark (2023-abc9ca1e7e)");
...
FEDORA-2023-abc9ca1e7e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-abc9ca1e7e");
...
var pkgs = [
    {'reference':'wireshark-4.0.8-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
