...
# extracted from Fedora Security Advisory FEDORA-2021-9107eeb95c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-9107eeb95c");

  script_name(english:"Fedora 33 : screen (2021-9107eeb95c)");
...
FEDORA-2021-9107eeb95c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-9107eeb95c");
...
"Update the affected screen package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:screen");
...
pkgs = [
    {'reference':'screen-4.8.0-5.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
