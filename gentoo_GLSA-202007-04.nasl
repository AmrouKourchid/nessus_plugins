...
# extracted from Gentoo Linux Security Advisory GLSA 202007-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-04");

  script_name(english:"GLSA-202007-04 : fwupd, libjcat: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-04
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-04");
...
"All fwupd users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:fwupd");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libjcat");
...
if (qpkg_check(package:"dev-libs/libjcat", unaffected:make_list("ge 0.1.3"), vulnerable:make_list("lt 0.1.3"))) flag++;
if (qpkg_check(package:"sys-apps/fwupd", unaffected:make_list("ge 1.3.10"), vulnerable:make_list("lt 1.3.10"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "fwupd / libjcat");
}
