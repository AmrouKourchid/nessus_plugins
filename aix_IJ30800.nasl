...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 4 : lpd (IJ30800)");
  script_summary(english:"Check for APAR IJ30800");
...
if (aix_check_ifix(release:"7.2", ml:"04", sp:"02", patch:"IJ30800s1a", package:"bos.rte.printers", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"03", patch:"IJ30800s1a", package:"bos.rte.printers", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.0") < 0) flag++;
