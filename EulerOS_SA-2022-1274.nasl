...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libtiff (EulerOS-SA-2022-1274)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1274
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6e2e6623");
...
var pkgs = [
  "libtiff-4.0.3-27.h28.eulerosv2r7",
  "libtiff-devel-4.0.3-27.h28.eulerosv2r7"
];
