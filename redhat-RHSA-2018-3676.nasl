...
if (description)
{
  ...
  script_name(english:"RHEL 7 : .NET Core on Red Hat Enterprise Linux (RHSA-2018:3676)");
...
the RHSA-2018:3676 advisory.
    ...
    A new version of .NET Core that addresses a security vulnerability is now available. The updated version
    is .NET Core 2.1.5.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3676.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?69cf01e2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3676");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1649693");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL .NET Core on Red Hat Enterprise Linux package based on the guidance in RHSA-2018:3676.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet21-dotnet-2.1.500-5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-host-2.1.6-5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-runtime-2.1-2.1.6-5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-sdk-2.1-2.1.500-5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-sdk-2.1.5xx-2.1.500-5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-dotnet21-dotnet / rh-dotnet21-dotnet-host / etc');
}
