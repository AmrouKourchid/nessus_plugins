...
# extracted from Fedora Security Advisory FEDORA-2024-d85494e836
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d85494e836");
  script_xref(name:"IAVA", value:"2024-A-0641-S");

  script_name(english:"Fedora 41 : firefox (2024-d85494e836)");
...
FEDORA-2024-d85494e836 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d85494e836");
...
var pkgs = [
    {'reference':'firefox-131.0.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
