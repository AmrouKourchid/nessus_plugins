...
referenced in the RHSA-2019:1791 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1791.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c4c07e2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1791");
...
"Update the RHEL libssh2 package based on the guidance in RHSA-2019:1791.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libssh2-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_5.1', 'sp':'5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-docs-1.4.3-11.el7_5.1', 'sp':'5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
