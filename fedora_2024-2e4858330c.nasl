...
# extracted from Fedora Security Advisory FEDORA-2024-2e4858330c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2e4858330c");

  script_name(english:"Fedora 39 : nginx (2024-2e4858330c)");
...
FEDORA-2024-2e4858330c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2e4858330c");
...
"Update the affected 1:nginx package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32760");
...
var pkgs = [
    {'reference':'nginx-1.26.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
