...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Bzr PHSA-2023-3.0-0611");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the bzr package has been released.");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:bzr");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'bzr-2.7.0-3.ph3')) flag++;
