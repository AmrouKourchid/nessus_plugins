...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : glibc (EulerOS-SA-2021-1537)");
...
affected by the following vulnerabilities :
  ...
  - A flaw was found in glibc. If an attacker provides the
    iconv function with invalid multi-byte input sequences
    in IBM1364, IBM1371, IBM1388, IBM1390, IBM1399
    encodings, it fails to advance the input state, which
    could lead to an infinite loop in applications,
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1537
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?96da8993");
