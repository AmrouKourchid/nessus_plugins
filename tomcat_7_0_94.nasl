...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 7.0.0 < 7.0.94 multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 7.0.94. It is, therefore, affected by multiple
vulnerabilities as referenced in the fixed_in_apache_tomcat_7.0.94_security-7 advisory.
...
number.");
  ...
  # https://github.com/apache/tomcat/commit/7f0221b904956359f2d739aa3a2b53f8c12ed8c7
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?41dddb4b");
  # https://github.com/apache/tomcat/commit/44ec74c44dcd05cd7e90967c04d40b51440ecd7e
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86be7b05");
...
var constraints = [
  { 'min_version' : '7.0.0', 'max_version' : '7.0.93', 'fixed_version' : '7.0.94' }
];
