...
# extracted from Fedora Security Advisory FEDORA-2020-339d413324.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-339d413324");

  script_name(english:"Fedora 31 : glib2 (2020-339d413324)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-339d413324");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"glib2-2.62.4-2.fc31")) flag++;
