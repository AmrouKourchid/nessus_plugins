...
# extracted from Fedora Security Advisory FEDORA-2024-e089551039
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e089551039");

  script_name(english:"Fedora 41 : wolfssl (2024-e089551039)");
...
FEDORA-2024-e089551039 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e089551039");
...
var pkgs = [
    {'reference':'wolfssl-5.7.2-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
