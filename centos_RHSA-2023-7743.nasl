...
# extracted from Red Hat Security Advisory RHSA-2023:7743.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : curl (RHSA-2023:7743)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2023:7743 advisory.
...
var pkgs = [
    {'reference':'curl-7.29.0-59.el7_9.2', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'curl-7.29.0-59.el7_9.2', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libcurl-7.29.0-59.el7_9.2', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libcurl-7.29.0-59.el7_9.2', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libcurl-devel-7.29.0-59.el7_9.2', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libcurl-devel-7.29.0-59.el7_9.2', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
