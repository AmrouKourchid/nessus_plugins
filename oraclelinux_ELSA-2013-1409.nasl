...
# Oracle Linux Security Advisory ELSA-2013-1409 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 / 6 : xinetd (ELSA-2013-1409)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-1409.html");
...
var pkgs = [
    {'reference':'xinetd-2.3.14-20.el5_10', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'xinetd-2.3.14-20.el5_10', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'xinetd-2.3.14-39.el6_4', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'xinetd-2.3.14-39.el6_4', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
