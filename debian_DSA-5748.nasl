...
# extracted from Debian Security Advisory dsa-5748. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5748 : ffmpeg - security update");
...
dsa-5748 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5748-1                   security@debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-7272");
...
"Upgrade the ffmpeg packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-7272");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'ffmpeg', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'ffmpeg-doc', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavcodec-dev', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavcodec-extra', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavcodec-extra59', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavcodec59', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavdevice-dev', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavdevice59', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavfilter-dev', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavfilter-extra', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavfilter-extra8', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavfilter8', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavformat-dev', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavformat-extra', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavformat-extra59', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavformat59', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavutil-dev', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libavutil57', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libpostproc-dev', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libpostproc56', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libswresample-dev', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libswresample4', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libswscale-dev', 'reference': '7:5.1.6-0+deb12u1'},
    {'release': '12.0', 'prefix': 'libswscale6', 'reference': '7:5.1.6-0+deb12u1'}
];
