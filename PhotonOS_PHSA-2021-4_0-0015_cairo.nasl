...
# extracted from VMware Security Advisory PHSA-2021-4.0-0015. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Cairo PHSA-2021-4.0-0015");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the cairo package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-15.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'cairo-1.17.2-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'cairo-devel-1.17.2-2.ph4')) flag++;
