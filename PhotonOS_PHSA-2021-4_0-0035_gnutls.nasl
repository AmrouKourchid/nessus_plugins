...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Gnutls PHSA-2021-4.0-0035");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'gnutls-3.7.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'gnutls-devel-3.7.1-1.ph4')) flag++;
