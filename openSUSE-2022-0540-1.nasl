...
# openSUSE Security Update openSUSE-SU-2022:0540-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : ImageMagick (openSUSE-SU-2022:0540-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2022:0540-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8afde12c");
...
var pkgs = [
    {'reference':'ImageMagick-7.0.7.34-10.21.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ImageMagick-config-7-SUSE-7.0.7.34-10.21.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ImageMagick-config-7-upstream-7.0.7.34-10.21.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ImageMagick-devel-32bit-7.0.7.34-10.21.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ImageMagick-devel-7.0.7.34-10.21.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ImageMagick-extra-7.0.7.34-10.21.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libMagick++-7_Q16HDRI4-32bit-7.0.7.34-10.21.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libMagick++-7_Q16HDRI4-7.0.7.34-10.21.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libMagick++-devel-32bit-7.0.7.34-10.21.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libMagick++-devel-7.0.7.34-10.21.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libMagickCore-7_Q16HDRI6-32bit-7.0.7.34-10.21.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libMagickCore-7_Q16HDRI6-7.0.7.34-10.21.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libMagickWand-7_Q16HDRI6-32bit-7.0.7.34-10.21.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libMagickWand-7_Q16HDRI6-7.0.7.34-10.21.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'perl-PerlMagick-7.0.7.34-10.21.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
