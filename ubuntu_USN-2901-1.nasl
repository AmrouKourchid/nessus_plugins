...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : xdelta3 vulnerability (USN-2901-1)");
...
USN-2901-1 advisory.
    ...
    It was discovered that xdelta3 incorrectly handled certain files. If a user or automated system were
    tricked into processing a specially-crafted file, a remote attacker could use this issue to cause xdelta3
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2901-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected xdelta3 package.");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'xdelta3', 'pkgver': '3.0.7-dfsg-2ubuntu0.2'}
];
