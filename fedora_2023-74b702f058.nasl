...
# extracted from Fedora Security Advisory FEDORA-2023-74b702f058
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-74b702f058");

  script_name(english:"Fedora 37 : php-symfony4 (2023-74b702f058)");
...
FEDORA-2023-74b702f058 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-74b702f058");
...
var pkgs = [
    {'reference':'php-symfony4-4.4.50-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
