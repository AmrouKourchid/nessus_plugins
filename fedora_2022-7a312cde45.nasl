...
# extracted from Fedora Security Advisory FEDORA-2022-7a312cde45
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7a312cde45");

  script_name(english:"Fedora 37 : keylime (2022-7a312cde45)");
...
FEDORA-2022-7a312cde45 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7a312cde45");
...
var pkgs = [
    {'reference':'keylime-6.4.3-5.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
