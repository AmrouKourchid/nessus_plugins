...
# extracted from Fedora Security Advisory FEDORA-2023-ebc3be7db1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ebc3be7db1");

  script_name(english:"Fedora 39 : python-flask (2023-ebc3be7db1)");
...
FEDORA-2023-ebc3be7db1 advisory.

    Automatic update for python-flask-2.2.5-1.fc39.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ebc3be7db1");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:python-flask package.");
...
var pkgs = [
    {'reference':'python-flask-2.2.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
