...
# extracted from Red Hat Security Advisory RHSA-2018:2267. The text 
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2267.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?efdd408f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2267");
...
"Update the RHEL procps package based on the guidance in RHSA-2018:2267.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'procps-3.2.8-35.el6_7.1', 'sp':'7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-3.2.8-35.el6_7.1', 'sp':'7', 'cpu':'ppc', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-3.2.8-35.el6_7.1', 'sp':'7', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-3.2.8-35.el6_7.1', 'sp':'7', 'cpu':'s390', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-3.2.8-35.el6_7.1', 'sp':'7', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-3.2.8-35.el6_7.1', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-devel-3.2.8-35.el6_7.1', 'sp':'7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-devel-3.2.8-35.el6_7.1', 'sp':'7', 'cpu':'ppc', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-devel-3.2.8-35.el6_7.1', 'sp':'7', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-devel-3.2.8-35.el6_7.1', 'sp':'7', 'cpu':'s390', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-devel-3.2.8-35.el6_7.1', 'sp':'7', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-devel-3.2.8-35.el6_7.1', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
