...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Ruby PHSA-2025-5.0-0468");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'ruby-3.1.4-8.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'ruby-devel-3.1.4-8.ph5')) flag++;
