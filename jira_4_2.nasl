...
if (description)
{
  ...
  script_name(english:"Atlassian JIRA < 4.2 Multiple Vulnerabilities");
...
Atlassian JIRA hosted on the remote web server is prior to 4.2. It is,
...
"Upgrade to Atlassian JIRA version 4.2 or later.");
