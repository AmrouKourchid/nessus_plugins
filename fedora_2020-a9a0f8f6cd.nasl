...
# extracted from Fedora Security Advisory FEDORA-2020-a9a0f8f6cd.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : mingw-OpenEXR (2020-a9a0f8f6cd)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-a9a0f8f6cd");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"mingw-OpenEXR-2.4.1-2.fc32")) flag++;
