...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : zsh (EulerOS-SA-2018-1396)");
...
vulnerabilities :
  ...
  - zsh: buffer overflow for very long fds in i1/4zi1/4+ fd
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1396
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12bcaee0");
