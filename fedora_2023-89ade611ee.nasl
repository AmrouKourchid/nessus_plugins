...
# extracted from Fedora Security Advisory FEDORA-2023-89ade611ee
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-89ade611ee");

  script_name(english:"Fedora 39 : gdb (2023-89ade611ee)");
...
FEDORA-2023-89ade611ee advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-89ade611ee");
...
var pkgs = [
    {'reference':'gdb-13.2-10.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
