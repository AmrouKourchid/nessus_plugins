...
# extracted from Debian Security Advisory DLA-1761-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1761-1 : ghostscript security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/04/msg00021.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"ghostscript", reference:"9.26a~dfsg-0+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"ghostscript-dbg", reference:"9.26a~dfsg-0+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"ghostscript-doc", reference:"9.26a~dfsg-0+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"ghostscript-x", reference:"9.26a~dfsg-0+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libgs-dev", reference:"9.26a~dfsg-0+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libgs9", reference:"9.26a~dfsg-0+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libgs9-common", reference:"9.26a~dfsg-0+deb8u2")) flag++;
