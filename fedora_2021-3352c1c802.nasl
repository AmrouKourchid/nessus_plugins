...
# extracted from Fedora Security Advisory FEDORA-2021-3352c1c802
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-3352c1c802");

  script_name(english:"Fedora 32 : python36 (2021-3352c1c802)");
...
FEDORA-2021-3352c1c802 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-3352c1c802");
...
pkgs = [
    {'reference':'python36-3.6.13-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
