...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtar-1.2.20-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtar-debuginfo-1.2.20-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtar-devel-1.2.20-5.ph2')) flag++;
