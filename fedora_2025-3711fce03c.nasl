...
# extracted from Fedora Security Advisory FEDORA-2025-3711fce03c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3711fce03c");

  script_name(english:"Fedora 40 : openvpn (2025-3711fce03c)");
...
FEDORA-2025-3711fce03c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3711fce03c");
...
var pkgs = [
    {'reference':'openvpn-2.6.14-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
