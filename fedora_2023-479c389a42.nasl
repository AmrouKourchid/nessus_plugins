...
# extracted from Fedora Security Advisory FEDORA-2023-479c389a42
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-479c389a42");

  script_name(english:"Fedora 39 : python3.10 (2023-479c389a42)");
...
FEDORA-2023-479c389a42 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-479c389a42");
...
var pkgs = [
    {'reference':'python3.10-3.10.13-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
