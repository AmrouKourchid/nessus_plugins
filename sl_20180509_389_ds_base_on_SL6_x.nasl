...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : 389-ds-base on SL6.x i386/x86_64 (20180509)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1805&L=scientific-linux-errata&F=&S=&P=1446
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?76c84323");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"389-ds-base-1.2.11.15-95.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"389-ds-base-debuginfo-1.2.11.15-95.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"389-ds-base-devel-1.2.11.15-95.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"389-ds-base-libs-1.2.11.15-95.el6_9")) flag++;
