...
# Red Hat Security Advisory RHSA-2023:2785. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : grafana-pcp (CESA-2023:2785)");
...
var pkgs = [
    {'reference':'grafana-pcp-3.2.0-3.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-pcp-3.2.0-3.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
