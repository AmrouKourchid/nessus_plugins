...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libxml2 PHSA-2023-4.0-0469");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libxml2-2.9.12-11.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libxml2-devel-2.9.12-11.ph4')) flag++;
