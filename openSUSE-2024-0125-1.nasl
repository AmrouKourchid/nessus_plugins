...
# openSUSE Security Update openSUSE-SU-2024:0125-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-Pillow (openSUSE-SU-2024:0125-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d52e3f9f");
...
var pkgs = [
    {'reference':'python3-Pillow-8.4.0-bp155.3.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-Pillow-tk-8.4.0-bp155.3.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE}
];
