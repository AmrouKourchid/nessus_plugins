...
# Rocky Linux Security Advisory RLSA-2024:2779.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:2779");

  script_name(english:"Rocky Linux 9 : nodejs:18 (RLSA-2024:2779)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:2779");
...
var appstreams = {
    'nodejs:18': [
      {'reference':'nodejs-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debuginfo-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debuginfo-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debuginfo-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debugsource-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debugsource-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debugsource-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-docs-18.20.2-2.module+el9.4.0+20107+1ce219be', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-18.20.2-2.module+el9.4.0+20107+1ce219be', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'npm-10.5.0-1.18.20.2.2.module+el9.4.0+20107+1ce219be', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'npm-10.5.0-1.18.20.2.2.module+el9.4.0+20107+1ce219be', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'npm-10.5.0-1.18.20.2.2.module+el9.4.0+20107+1ce219be', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
};
