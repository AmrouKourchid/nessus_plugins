...
# extracted from Fedora Security Advisory FEDORA-2022-ef4f57b072
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ef4f57b072");

  script_name(english:"Fedora 36 : systemd (2022-ef4f57b072)");
...
FEDORA-2022-ef4f57b072 advisory.

    - Latest bugfix release with a bunch of fixes (homed, networkd, manager, resolved, documentation):
    rhbz#2133792, rhbz#2135778, rhbz#2152685, and also #2031810, #2121106.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ef4f57b072");
...
var pkgs = [
    {'reference':'systemd-250.9-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
