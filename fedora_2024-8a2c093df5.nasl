...
# extracted from Fedora Security Advisory FEDORA-2024-8a2c093df5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8a2c093df5");

  script_name(english:"Fedora 38 : expat (2024-8a2c093df5)");
...
FEDORA-2024-8a2c093df5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8a2c093df5");
...
var pkgs = [
    {'reference':'expat-2.6.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
