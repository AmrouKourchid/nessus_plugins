...
# extracted from Red Hat Security Advisory RHSA-2017:1793 and 
# CentOS Errata and Security Advisory 2017:1793 respectively.
#
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:1793");

  script_name(english:"CentOS 7 : graphite2 (CESA-2017:1793)");
...
original reporters of these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2017-July/022510.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?979a90bf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"graphite2-1.3.10-1.el7_3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"graphite2-devel-1.3.10-1.el7_3")) flag++;
