...
# extracted from Red Hat Security Advisory fetchmail. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2010-1167", "CVE-2011-1947", "CVE-2012-3482");

  script_name(english:"RHEL 5 : fetchmail (Unpatched Vulnerability) (deprecated)");
