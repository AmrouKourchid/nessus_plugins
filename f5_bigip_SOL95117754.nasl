...
Virtual Edition (VE), or on single-bladed vCMP guests.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K95117754");
...
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K95117754.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-6684");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '15.0.0-15.0.1','14.0.0-14.1.2','13.0.0-13.1.3','12.1.0-12.1.5','11.5.2-11.6.5'
    ],
    'unaffected': [
      '15.1.0','15.0.1.3','14.1.2.3','13.1.3.2','12.1.5.1','11.6.5.2'
    ],
  },
  'AM': {
    'affected': [
