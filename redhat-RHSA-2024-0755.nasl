...
# extracted from Red Hat Security Advisory RHSA-2024:0755. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0755");

  script_name(english:"RHEL 9 : runc (RHSA-2024:0755)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf489df7");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0755");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL runc package based on the guidance in RHSA-2024:0755.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'runc-1.1.12-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
    ]
  }
];
