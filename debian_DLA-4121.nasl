...
# extracted from Debian Security Advisory dla-4121. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-25727", "CVE-2025-24529", "CVE-2025-24530");

  script_name(english:"Debian dla-4121 : phpmyadmin - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-25727");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-24529");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-24530");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/phpmyadmin");
...
"Upgrade the phpmyadmin packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-25727");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'phpmyadmin', 'reference': '4:5.0.4+dfsg2-2+deb11u2'}
];
