...
if (description)
{
  ...
  script_cve_id("CVE-2023-21928");
  script_xref(name:"IAVA", value:"2023-A-0215-S");

  script_name(english:"Oracle Solaris Critical Patch Update : apr2023_SRU11_4_54_138_1");
...
security update :
  ...
  - Vulnerability in the Oracle Solaris product of Oracle
    Systems (component: IPS repository daemon). The
    ...
    data. CVSS 3.1 Base Score 1.8 (Integrity impacts). CVSS
  ...
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:M/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:H/PR:H/UI:R/S:U/C:N/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-21928");
...
fix_release = "11.4-11.4.54.0.1.138.1";

flag = 0;

if (solaris_check_release(release:"11.4-11.4.54.0.1.138.1", sru:"11.4.54.138.1") > 0) flag++;
