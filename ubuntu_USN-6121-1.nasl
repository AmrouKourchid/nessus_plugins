...
the USN-6121-1 advisory.
    ...
    It was discovered that Nanopb incorrectly handled certain decode messages. An attacker could possibly use
    this cause a denial of service or expose sensitive information. (CVE-2020-26243)

    It was discovered that Nanopb incorrectly handled certain decode messages. An attacker could possibly use
    this issue to cause a denial of service or execute arbitrary code. (CVE-2021-21401)
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libnanopb-dev', 'pkgver': '0.4.1-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'nanopb', 'pkgver': '0.4.1-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
