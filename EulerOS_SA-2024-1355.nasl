...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : curl (EulerOS-SA-2024-1355)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1355
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0695218c");
...
var pkgs = [
  "curl-7.71.1-4.h29.eulerosv2r10",
  "libcurl-7.71.1-4.h29.eulerosv2r10"
];
