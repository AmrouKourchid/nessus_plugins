...
if (description)
{
  ...
  script_name(english:"Oracle MySQL Server 8.x < 8.4.2 (October 2024 CPU)");
...
October 2024 CPU advisory.
  ...
  - Vulnerability in the MySQL Server product of Oracle MySQL (component: InnoDB). Supported versions that are
    ...
    result in unauthorized ability to cause a hang or frequently repeatable crash (complete DOS) of MySQL Server. (CVE-2024-21185)
...
var constraints = [{ 'min_version' : '8.1', 'fixed_version' : '8.4.2'}];
