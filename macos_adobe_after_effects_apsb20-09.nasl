...
if (description)
{
  ...
  script_name(english:"Adobe After Effects < 17.0.4 Arbitrary code execution (APSB20-09) (macOS)");
...
"The version of Adobe After Effects installed on the remote macOS host is prior to 17.0.4. It is, therefore, affected by
a vulnerability as referenced in the APSB20-09 advisory.
