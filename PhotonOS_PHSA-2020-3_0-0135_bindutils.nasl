...
if (description)
{
  ...
  script_cve_id("CVE-2020-8623", "CVE-2020-8624");
  script_xref(name:"IAVA", value:"2020-A-0385-S");

  script_name(english:"Photon OS 3.0: Bindutils PHSA-2020-3.0-0135");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'bindutils-9.16.6-1.ph3')) flag++;
