...
if (description)
{
  ...
  script_name(english:"RHEL 5 : condor (RHSA-2013:1171)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2013/rhsa-2013_1171.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?04281f16");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:1171");
...
"Update the RHEL condor package based on the guidance in RHSA-2013:1171.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'condor-7.8.8-0.4.2.el5_9', 'cpu':'i386', 'release':'5', 'el_string':'el5_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'condor-7.8.8-0.4.2.el5_9', 'cpu':'x86_64', 'release':'5', 'el_string':'el5_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'condor-aviary-7.8.8-0.4.2.el5_9', 'cpu':'i386', 'release':'5', 'el_string':'el5_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'condor-aviary-7.8.8-0.4.2.el5_9', 'cpu':'x86_64', 'release':'5', 'el_string':'el5_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'condor-classads-7.8.8-0.4.2.el5_9', 'cpu':'i386', 'release':'5', 'el_string':'el5_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'condor-classads-7.8.8-0.4.2.el5_9', 'cpu':'x86_64', 'release':'5', 'el_string':'el5_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'condor-kbdd-7.8.8-0.4.2.el5_9', 'cpu':'i386', 'release':'5', 'el_string':'el5_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'condor-kbdd-7.8.8-0.4.2.el5_9', 'cpu':'x86_64', 'release':'5', 'el_string':'el5_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'condor-qmf-7.8.8-0.4.2.el5_9', 'cpu':'i386', 'release':'5', 'el_string':'el5_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'condor-qmf-7.8.8-0.4.2.el5_9', 'cpu':'x86_64', 'release':'5', 'el_string':'el5_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'condor-vm-gahp-7.8.8-0.4.2.el5_9', 'cpu':'i386', 'release':'5', 'el_string':'el5_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'condor-vm-gahp-7.8.8-0.4.2.el5_9', 'cpu':'x86_64', 'release':'5', 'el_string':'el5_9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
