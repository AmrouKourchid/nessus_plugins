...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : net-snmp (EulerOS-SA-2023-1478)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1478
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6cfa10a0");
...
var pkgs = [
  "net-snmp-5.8-8.h8.eulerosv2r9",
  "net-snmp-libs-5.8-8.h8.eulerosv2r9",
  "python3-net-snmp-5.8-8.h8.eulerosv2r9"
];
