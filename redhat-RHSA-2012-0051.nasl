...
referenced in the RHSA-2012:0051 advisory.

  - kernel: kvm: pit timer with no irqchip crashes the system (CVE-2011-4622)

  - qemu: e1000: process_tx_desc legacy mode packets heap overflow (CVE-2012-0029)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_0051.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6356e815");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:0051");
...
"Update the RHEL kvm package based on the guidance in RHSA-2012:0051.");
  script_set_cvss_base_vector("CVSS2#AV:A/AC:M/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-0029");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2011-4622");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'kmod-kvm-83-239.el5_7.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kmod-kvm-debug-83-239.el5_7.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kvm-83-239.el5_7.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kvm-qemu-img-83-239.el5_7.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kvm-tools-83-239.el5_7.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
