...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 60.8. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2019-23 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'60.8', xss:TRUE, severity:SECURITY_HOLE);
