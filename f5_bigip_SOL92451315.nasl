...
# extracted from F5 Networks BIG-IP Solution K92451315.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenSSL vulnerability (K92451315)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to 16.1.6 / 17.0.0. It is, therefore, affected
by a vulnerability as referenced in the K92451315 advisory.
    ...
    1.1.1 is not vulnerable to this issue. Fixed in OpenSSL 1.0.2w (Affected
    1.0.2-1.0.2v).(CVE-2020-1968)ImpactAn attacker may be able to exploit OpenSSL Transport Layer Security
    (TLS), which allows unauthorized exposure of information when Diffie-Hellman (DH) secrets are reused
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K92451315");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K92451315.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '16.0.0-16.1.5','15.1.0-15.1.10','14.1.0-14.1.5','13.1.0-13.1.5','12.1.0-12.1.5','11.6.1-11.6.5'
    ],
    'unaffected': [
      '17.0.0','16.1.6'
    ],
