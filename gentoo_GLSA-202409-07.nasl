...
# extracted from Gentoo Linux Security Advisory GLSA 202409-07.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-46176", "CVE-2023-38497");

  script_name(english:"GLSA-202409-07 : Rust: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202409-07 (Rust: Multiple Vulnerabilities)

    Multiple vulnerabilities have been discovered in Rust. Please review the CVE identifiers referenced below
    for details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202409-07");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=890371");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=911685");
...
var packages = [
  {
    'name' : 'dev-lang/rust',
    'unaffected' : make_list("ge 1.71.1"),
    'vulnerable' : make_list("lt 1.71.1")
  },
  {
