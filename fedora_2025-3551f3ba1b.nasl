...
# extracted from Fedora Security Advisory FEDORA-2025-3551f3ba1b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3551f3ba1b");

  script_name(english:"Fedora 41 : bind / bind-dyndb-ldap (2025-3551f3ba1b)");
...
FEDORA-2025-3551f3ba1b advisory.
    ...
    [Upstream Release Notes](https://downloads.isc.org/isc/bind9/9.18.33/doc/arm/html/notes.html#notes-for-
    bind-9-18-33)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3551f3ba1b");
...
var pkgs = [
    {'reference':'bind-9.18.33-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-dyndb-ldap-11.10-33.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
