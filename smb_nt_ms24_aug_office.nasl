...
if (description)
{
  ...
  script_cve_id("CVE-2024-38200");
  script_xref(name:"MSKB", value:"5002570");
  script_xref(name:"MSKB", value:"5002625");
  script_xref(name:"MSFT", value:"MS24-5002570");
  script_xref(name:"MSFT", value:"MS24-5002625");

  script_name(english:"Security Updates for Microsoft Office Products (August 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002570");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002625");
...
"Microsoft has released the following security updates to address this issue:  
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-38200");
...
var constraints = [
  {'product' : 'Microsoft Office 2016', 'kb':'5002625', 'file':'mso.dll', 'fixed_version': '16.0.5461.1001'},
  {'product' : 'Microsoft Office 2016', 'kb':'5002570', 'file':'mso99lwin32client.dll', 'fixed_version': '16.0.5460.1000'},
];
