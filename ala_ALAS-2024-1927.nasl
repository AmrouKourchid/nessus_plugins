...
# extracted from Amazon Linux AMI Security Advisory ALAS-2024-1927.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : tigervnc (ALAS-2024-1927)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of tigervnc installed on the remote host is prior to 1.8.0-21.36. It is, therefore, affected by a
vulnerability as referenced in the ALAS-2024-1927 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2024-1927.html");
...
var pkgs = [
    {'reference':'tigervnc-1.8.0-21.36.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-1.8.0-21.36.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-debuginfo-1.8.0-21.36.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-debuginfo-1.8.0-21.36.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-1.8.0-21.36.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-1.8.0-21.36.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-module-1.8.0-21.36.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-module-1.8.0-21.36.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
