...
# extracted from Red Hat Security Advisory RHSA-2025:1915. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1915");

  script_name(english:"RHEL 9 : emacs (RHSA-2025:1915)");
...
the RHSA-2025:1915 advisory.
    ...
    * emacs: Shell Injection Vulnerability in GNU Emacs via Custom man URI Scheme [rhel-9.5.z]
    (CVE-2025-1244)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1915.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6609cd2c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1915");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL emacs package based on the guidance in RHSA-2025:1915.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'emacs-27.2-11.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-common-27.2-11.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-filesystem-27.2-11.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-lucid-27.2-11.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'emacs-nox-27.2-11.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
