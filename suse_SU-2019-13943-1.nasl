...
# extracted from SUSE update advisory SUSE-SU-2019:13943-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : spice (SUSE-SU-2019:13943-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2019/suse-su-201913943-1.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8c06fa9");
...
patch sdksp4-spice-13943=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-spice-13943=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-spice-13943=1");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"libspice-server1-0.12.4-18.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"i586", reference:"libspice-server1-0.12.4-18.1")) flag++;
