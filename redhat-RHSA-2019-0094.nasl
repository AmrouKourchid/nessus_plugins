...
# extracted from Red Hat Security Advisory RHSA-2019:0094. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0094");

  script_name(english:"RHEL 7 : redis (RHSA-2019:0094)");
...
referenced in the RHSA-2019:0094 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0094.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?94a1b8ba");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0094");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis package based on the guidance in RHSA-2019:0094.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redis-3.2.8-3.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'redis-3.2.8-3.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
