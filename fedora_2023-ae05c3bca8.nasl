...
# extracted from Fedora Security Advisory FEDORA-2023-ae05c3bca8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ae05c3bca8");

  script_name(english:"Fedora 38 : optipng (2023-ae05c3bca8)");
...
FEDORA-2023-ae05c3bca8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ae05c3bca8");
...
var pkgs = [
    {'reference':'optipng-0.7.8-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
