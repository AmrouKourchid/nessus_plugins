...
# extracted from Red Hat Security Advisory RHSA-2023:5992. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5992.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6223abf2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2235789");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5992");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python27:2.7 package based on the guidance in RHSA-2023:5992.");
  ...
  'python27:2.7': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'python2-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-debug-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-debug-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-devel-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-devel-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-libs-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-libs-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-test-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-test-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tkinter-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tkinter-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tools-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tools-2.7.18-4.module+el8.4.0+20146+f164e92b.3', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
