...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : ntp (EulerOS-SA-2019-1213)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1213
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fa7c896e");
...
pkgs = ["ntp-4.2.6p5-28.h5",
        "ntpdate-4.2.6p5-28.h5",
        "sntp-4.2.6p5-28.h5"];
