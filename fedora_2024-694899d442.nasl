...
# extracted from Fedora Security Advisory FEDORA-2024-694899d442
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-694899d442");

  script_name(english:"Fedora 38 : redis (2024-694899d442)");
...
FEDORA-2024-694899d442 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-694899d442");
...
var pkgs = [
    {'reference':'redis-7.0.15-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
