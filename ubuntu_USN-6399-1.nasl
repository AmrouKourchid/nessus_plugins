...
# extracted from Ubuntu Security Notice USN-6399-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6399-1");

  script_name(english:"Ubuntu 23.04 : Puma vulnerability (USN-6399-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 23.04 host has a package installed that is affected by a vulnerability as referenced in the USN-6399-1
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6399-1");
...
var pkgs = [
    {'osver': '23.04', 'pkgname': 'puma', 'pkgver': '5.6.5-3ubuntu1.1'}
];
