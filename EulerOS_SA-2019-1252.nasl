...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : openssh (EulerOS-SA-2019-1252)");
...
the following vulnerability :
  ...
  - In OpenSSH 7.9, scp.c in the scp client allows remote
    ...
    the client side.i1/4^CVE-2018-20685i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1252
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a631dcff");
...
pkgs = ["openssh-7.4p1-13.h9",
        "openssh-clients-7.4P1-13.h9",
        "openssh-keycat-7.4p1-13.h9",
        "openssh-server-7.4p1-13.h9",
        "pam_ssh_agent_auth-0.10.3-1.13"];
