...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.1.0 : libpng12 (EulerOS-SA-2019-1391)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization for ARM 64 host is missing multiple security
updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libpng12 package installed, the
...
affected by the following vulnerabilities :
  ...
  - An array-indexing error was discovered in the
    ...
    image.i1/4^CVE-2015-7981i1/4%0
  ...
  - It was discovered that the png_get_PLTE() and
    ...
    library.i1/4^CVE-2015-8126i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1391
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?263aa9c7");
  script_set_attribute(attribute:"solution", value:
"Update the affected libpng12 packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:libpng12");
