...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libtasn1 PHSA-2020-2.0-0236");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtasn1-4.14-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtasn1-debuginfo-4.14-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libtasn1-devel-4.14-1.ph2')) flag++;
