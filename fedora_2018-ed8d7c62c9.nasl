...
# extracted from Fedora Security Advisory FEDORA-2018-ed8d7c62c9.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : patch (2018-ed8d7c62c9)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ed8d7c62c9");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"patch-2.7.6-4.fc28")) flag++;
