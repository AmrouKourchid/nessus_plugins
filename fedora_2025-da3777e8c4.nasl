...
# extracted from Fedora Security Advisory FEDORA-2025-da3777e8c4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-da3777e8c4");

  script_name(english:"Fedora 41 : python-django4.2 (2025-da3777e8c4)");
...
FEDORA-2025-da3777e8c4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-da3777e8c4");
...
var pkgs = [
    {'reference':'python-django4.2-4.2.20-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
