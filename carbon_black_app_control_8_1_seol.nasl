...
if (description)
{
  ...
  script_name(english:"VMware Carbon Black App Control SEoL (<= 8.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of VMware Carbon Black App Control is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, VMware Carbon Black App Control is less than or equal to 8.1.x. It is, therefore, no longer
...
contain security vulnerabilities.");
  ...
  # https://docs.vmware.com/en/VMware-Carbon-Black-App-Control/services/cb_appcontrol-support-lifecycle-policy/GUID-924B5431-EE90-4D50-B681-C3DCAC462D41.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38b682af");
...
"Upgrade to a version of VMware Carbon Black App Control that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2021/06/25");
