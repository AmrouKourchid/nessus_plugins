...
# extracted from Fedora Security Advisory FEDORA-2020-582515fa8a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : nodejs-set-value (2020-582515fa8a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-582515fa8a");
  script_set_attribute(attribute:"solution", value:
"Update the affected nodejs-set-value package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-10747");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"nodejs-set-value-2.0.1-1.fc31")) flag++;
