...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5028168");
  script_xref(name:"MSFT", value:"MS23-5028168");
  script_xref(name:"IAVA", value:"2023-A-0347-S");
  script_xref(name:"IAVA", value:"2023-A-0345-S");

  script_name(english:"KB5028168: Windows 10 version 1809 / Windows Server 2019 Security Update (July 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5028168");
