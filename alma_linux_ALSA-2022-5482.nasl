...
# AlmaLinux Security Advisory ALSA-2022:5482.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:5482");

  script_name(english:"AlmaLinux 9 : thunderbird (ALSA-2022:5482)");
...
ALSA-2022:5482 advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-5482.html");
...
var pkgs = [
    {'reference':'thunderbird-91.11.0-2.el9_0.alma', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-91.11.0-2.el9_0.alma', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
