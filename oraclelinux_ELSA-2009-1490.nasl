...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : squirrelmail (ELSA-2009-1490)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1490.html");
...
"Update the affected squirrelmail package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-2964");
...
var pkgs = [
    {'reference':'squirrelmail-1.4.8-5.0.1.el5_4.10', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'squirrelmail-1.4.8-5.0.1.el5_4.10', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
