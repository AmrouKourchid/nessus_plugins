...
# extracted from Red Hat Security Advisory RHSA-2024:3543. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3543");

  script_name(english:"RHEL 8 : python-idna (RHSA-2024:3543)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71260658");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2274779");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3543");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-idna package based on the guidance in RHSA-2024:3543.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-idna-2.5-5.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
