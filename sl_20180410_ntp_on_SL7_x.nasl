...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ntp on SL7.x x86_64 (20180410)");
...
Additional Changes :");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1804&L=scientific-linux-errata&F=&S=&P=6290
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7aab54b4");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ntp-4.2.6p5-28.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ntp-debuginfo-4.2.6p5-28.el7")) flag++;
if (rpm_check(release:"SL7", reference:"ntp-doc-4.2.6p5-28.el7")) flag++;
if (rpm_check(release:"SL7", reference:"ntp-perl-4.2.6p5-28.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ntpdate-4.2.6p5-28.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"sntp-4.2.6p5-28.el7")) flag++;
