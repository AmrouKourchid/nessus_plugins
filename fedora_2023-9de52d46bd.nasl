...
# extracted from Fedora Security Advisory FEDORA-2023-9de52d46bd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9de52d46bd");
  script_xref(name:"IAVA", value:"2023-A-0702-S");

  script_name(english:"Fedora 39 : firefox / nss (2023-9de52d46bd)");
...
FEDORA-2023-9de52d46bd advisory.

    Update NSS to 3.95
    Update Firefox to 121.0

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9de52d46bd");
...
var pkgs = [
    {'reference':'firefox-121.0-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'nss-3.95.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
