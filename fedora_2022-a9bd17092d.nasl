...
# extracted from Fedora Security Advisory FEDORA-2022-a9bd17092d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-a9bd17092d");

  script_name(english:"Fedora 35 : openvpn (2022-a9bd17092d)");
...
FEDORA-2022-a9bd17092d advisory.

    This is a maintenance release of OpenVPN 2.5 with a security fix when used in server mode
    ([CVE-2022-0547](https://community.openvpn.net/openvpn/wiki/CVE-2022-0547)). The other changes are
    available in [Changes.rst](https://github.com/OpenVPN/openvpn/blob/release/2.5/Changes.rst).

    **NOTE** Please read the CVE description carefully if you use authentication plug-ins with a server
    configuration.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-a9bd17092d");
...
var pkgs = [
    {'reference':'openvpn-2.5.6-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
