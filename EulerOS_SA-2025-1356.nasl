...
if (description)
{
  ...
  script_cve_id("CVE-2024-50349", "CVE-2024-52005", "CVE-2024-52006");

  script_name(english:"EulerOS 2.0 SP11 : git (EulerOS-SA-2025-1356)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1356
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28df14af");
...
"Update the affected git packages.");
  ...
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2024-52005");
...
var pkgs = [
  "git-2.33.0-1.h16.eulerosv2r11",
  "git-help-2.33.0-1.h16.eulerosv2r11"
];
