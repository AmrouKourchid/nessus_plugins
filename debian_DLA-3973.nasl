...
# extracted from Debian Security Advisory dla-3973. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-35977", "CVE-2024-31228");

  script_name(english:"Debian dla-3973 : redis - security update");
...
dla-3973 advisory.
    ...
    Multiple vulnerabilities have been fixed in the keyvalue database Redis.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-35977");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-31228");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'redis', 'reference': '5:6.0.16-1+deb11u4'},
    {'release': '11.0', 'prefix': 'redis-sentinel', 'reference': '5:6.0.16-1+deb11u4'},
    {'release': '11.0', 'prefix': 'redis-server', 'reference': '5:6.0.16-1+deb11u4'},
    {'release': '11.0', 'prefix': 'redis-tools', 'reference': '5:6.0.16-1+deb11u4'}
];
