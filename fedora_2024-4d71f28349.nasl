...
# extracted from Fedora Security Advisory FEDORA-2024-4d71f28349
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4d71f28349");

  script_name(english:"Fedora 40 : webkitgtk (2024-4d71f28349)");
...
FEDORA-2024-4d71f28349 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4d71f28349");
...
var pkgs = [
    {'reference':'webkitgtk-2.44.2-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
