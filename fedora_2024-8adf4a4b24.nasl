...
# extracted from Fedora Security Advisory FEDORA-2024-8adf4a4b24
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8adf4a4b24");

  script_name(english:"Fedora 40 : perl-Module-ScanDeps (2024-8adf4a4b24)");
...
FEDORA-2024-8adf4a4b24 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8adf4a4b24");
...
"Update the affected perl-Module-ScanDeps package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:perl-Module-ScanDeps");
...
var pkgs = [
    {'reference':'perl-Module-ScanDeps-1.37-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
