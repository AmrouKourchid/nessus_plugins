...
# extracted from Fedora Security Advisory FEDORA-2020-885e2343ed.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-885e2343ed");

  script_name(english:"Fedora 31 : glpi (2020-885e2343ed)");
...
"Last Upstream release, including (among others) :
  ...
  - (security) Prevent execution of SQL injection while
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-885e2343ed");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"glpi-9.4.6-1.fc31")) flag++;
