...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : docker-engine (EulerOS-SA-2024-1852)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1852
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cb754ba2");
...
var pkgs = [
  "docker-engine-18.09.0-400.h41.50.51.eulerosv2r12",
  "docker-engine-selinux-18.09.0-400.h41.50.51.eulerosv2r12"
];
