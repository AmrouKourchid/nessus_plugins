...
"The remote Ubuntu 22.04 ESM / 23.04 host has packages installed that are affected by multiple vulnerabilities as
referenced in the USN-6306-1 advisory.

    It was discovered that Fast DDS incorrectly handled certain inputs. A remote attacker could possibly use
    this issue to cause a denial of service and information exposure. This issue only affected Ubuntu 22.04
    LTS. (CVE-2021-38425)

    It was discovered that Fast DDS incorrectly handled certain inputs. An attacker could possibly use this
    issue to cause a crash. (CVE-2023-39534, CVE-2023-39945, CVE-2023-39946, CVE-2023-39947, CVE-2023-39948,
    CVE-2023-39949)
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'fastdds-tools', 'pkgver': '2.5.0+ds-3ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'libfastrtps-dev', 'pkgver': '2.5.0+ds-3ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'libfastrtps2.5', 'pkgver': '2.5.0+ds-3ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '23.04', 'pkgname': 'fastdds-tools', 'pkgver': '2.9.1+ds-1ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'libfastrtps-dev', 'pkgver': '2.9.1+ds-1ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.04', 'pkgname': 'libfastrtps2.9', 'pkgver': '2.9.1+ds-1ubuntu0.1', 'ubuntu_pro': FALSE}
];
