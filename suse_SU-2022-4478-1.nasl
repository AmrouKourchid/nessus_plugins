...
# SUSE update advisory SUSE-SU-2022:4478-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4478-1");

  script_name(english:"SUSE SLED15 / SLES15 Security Update : capnproto (SUSE-SU-2022:4478-1)");
...
vulnerability as referenced in the SUSE-SU-2022:4478-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1205968");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2022-46149");
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013236.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e74fff34");
  script_set_attribute(attribute:"solution", value:
"Update the affected libcapnp-0_9 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:libcapnp-0_9");
...
var pkgs = [
    {'reference':'libcapnp-0_9-0.9.1-150400.3.4.1', 'sp':'4', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'libcapnp-0_9-0.9.1-150400.3.4.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'libcapnp-0_9-0.9.1-150400.3.4.1', 'sp':'4', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-desktop-applications-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'libcapnp-0_9-0.9.1-150400.3.4.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-desktop-applications-release-15.4', 'sled-release-15.4', 'sles-release-15.4']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libcapnp-0_9');
}
