...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : freetype (EulerOS-SA-2022-2108)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2108
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?379a13aa");
...
var pkgs = [
  "freetype-2.10.2-2.h4.eulerosv2r10"
];
