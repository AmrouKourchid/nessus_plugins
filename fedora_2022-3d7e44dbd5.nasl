...
# extracted from Fedora Security Advisory FEDORA-2022-3d7e44dbd5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-3d7e44dbd5");

  script_name(english:"Fedora 37 : python3.12 (2022-3d7e44dbd5)");
...
FEDORA-2022-3d7e44dbd5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3d7e44dbd5");
...
var pkgs = [
    {'reference':'python3.12-3.12.0~a3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
