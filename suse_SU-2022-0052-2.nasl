...
# SUSE update advisory SUSE-SU-2022:0052-2. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:0052-2");

  script_name(english:"SUSE SLES15 Security Update : libsndfile (SUSE-SU-2022:0052-2)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ec9588e");
  script_set_attribute(attribute:"solution", value:
"Update the affected libsndfile-devel and / or libsndfile1 packages.");
...
var pkgs = [
    {'reference':'libsndfile-devel-1.0.28-5.15.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_RT-release-15.2']},
    {'reference':'libsndfile1-1.0.28-5.15.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_RT-release-15.2']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libsndfile-devel / libsndfile1');
}
