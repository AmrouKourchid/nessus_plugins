...
# extracted from Fedora Security Advisory FEDORA-2018-a042f795b2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : python-pip / python3 / python3-docs (2018-a042f795b2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a042f795b2");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-pip, python3 and / or python3-docs
packages.");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"python-pip-9.0.3-1.fc27")) flag++;
if (rpm_check(release:"FC27", reference:"python3-3.6.5-1.fc27")) flag++;
if (rpm_check(release:"FC27", reference:"python3-docs-3.6.5-1.fc27")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "python-pip / python3 / python3-docs");
}
