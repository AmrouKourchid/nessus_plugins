...
# extracted from Fedora Security Advisory FEDORA-2022-7ad73a633f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7ad73a633f");

  script_name(english:"Fedora 35 : dotnet6.0 (2022-7ad73a633f)");
...
FEDORA-2022-7ad73a633f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7ad73a633f");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.110-2.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
