...
if (description)
{
  ...
  script_name(english:"CentOS 9 : expat-2.5.0-1.el9");
...
expat-2.5.0-1.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=26519");
...
var pkgs = [
    {'reference':'expat-2.5.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.5.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-static-2.5.0-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
