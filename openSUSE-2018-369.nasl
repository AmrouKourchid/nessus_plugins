...
issues :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1088613");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-gunicorn / python3-gunicorn packages.");
