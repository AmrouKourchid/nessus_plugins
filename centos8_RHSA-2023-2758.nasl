...
# Red Hat Security Advisory RHSA-2023:2758. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : container-tools:rhel8 (CESA-2023:2758)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2023:2758 advisory.
...
"Update the affected fuse-overlayfs, oci-seccomp-bpf-hook and / or runc packages.");
...
var appstreams = {
    'container-tools:rhel8': [
      {'reference':'fuse-overlayfs-1.10-1.module_el8.8.0+1254+78119b6e', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fuse-overlayfs-1.10-1.module_el8.8.0+1254+78119b6e', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'oci-seccomp-bpf-hook-1.2.8-1.module_el8.8.0+1254+78119b6e', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'oci-seccomp-bpf-hook-1.2.8-1.module_el8.8.0+1254+78119b6e', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'fuse-overlayfs / oci-seccomp-bpf-hook / runc');
}
