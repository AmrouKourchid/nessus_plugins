...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : dovecot (EulerOS-SA-2020-2117)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2117
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?847a7b11");
...
pkgs = ["dovecot-2.2.10-5.h7",
        "dovecot-mysql-2.2.10-5.h7",
        "dovecot-pgsql-2.2.10-5.h7",
        "dovecot-pigeonhole-2.2.10-5.h7"];
