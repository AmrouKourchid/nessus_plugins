...
# extracted from Fedora Security Advisory FEDORA-2024-dd633679a9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-dd633679a9");

  script_name(english:"Fedora 40 : ColPack (2024-dd633679a9)");
...
FEDORA-2024-dd633679a9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-dd633679a9");
...
var pkgs = [
    {'reference':'ColPack-1.0.10-25.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
