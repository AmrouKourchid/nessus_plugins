...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002401");
  script_xref(name:"MSFT", value:"MS23-5002401");
  script_xref(name:"IAVA", value:"2023-A-0294-S");

  script_name(english:"Security Updates for Microsoft Office Online Server (June 2023)");
...
by the following vulnerability:
  ...
  - A remote code execution vulnerability. An attacker can exploit this to bypass authentication and execute
    unauthorized arbitrary commands. (CVE-2023-32029, CVE-2023-33133, CVE-2023-33137)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002401");
...
if (oos_path && (!isnull(oos_sp) && oos_sp == '0'))
{
  ...
  if (hotfix_check_fversion(file:'sword.dll', version:'16.0.10399.20000', min_version:'16.0.10000.0', path:path, kb:'5002401', product:'Office Online Server') == HCF_OLDER)
    vuln = TRUE;
}
