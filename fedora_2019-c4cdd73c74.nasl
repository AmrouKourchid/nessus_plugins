...
# extracted from Fedora Security Advisory FEDORA-2019-c4cdd73c74.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : mediawiki (2019-c4cdd73c74)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-c4cdd73c74");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"mediawiki-1.32.4-1.fc30")) flag++;
