...
# extracted from Red Hat Security Advisory RHSA-2021:5236. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:5236");
  script_xref(name:"IAVB", value:"2021-B-0067-S");

  script_name(english:"RHEL 8 : postgresql:13 (RHSA-2021:5236)");
...
referenced in the RHSA-2021:5236 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_5236.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f382d98e");
...
"Update the RHEL postgresql:13 package based on the guidance in RHSA-2021:5236.");
  ...
  'postgresql:13': [
    {
      ...
      'pkgs': [
        {'reference':'pg_repack-1.4.6-3.module+el8.5.0+11357+bcc62552', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pgaudit-1.5.0-1.module+el8.4.0+8873+b821c30a', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgres-decoderbufs-0.10.0-2.module+el8.4.0+8873+b821c30a', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-13.5-1.module+el8.5.0+13344+8c0fd184', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-13.5-1.module+el8.5.0+13344+8c0fd184', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-13.5-1.module+el8.5.0+13344+8c0fd184', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-13.5-1.module+el8.5.0+13344+8c0fd184', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-13.5-1.module+el8.5.0+13344+8c0fd184', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-13.5-1.module+el8.5.0+13344+8c0fd184', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-13.5-1.module+el8.5.0+13344+8c0fd184', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-13.5-1.module+el8.5.0+13344+8c0fd184', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-13.5-1.module+el8.5.0+13344+8c0fd184', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-13.5-1.module+el8.5.0+13344+8c0fd184', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-13.5-1.module+el8.5.0+13344+8c0fd184', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-13.5-1.module+el8.5.0+13344+8c0fd184', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-13.5-1.module+el8.5.0+13344+8c0fd184', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
