...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : curl (EulerOS-SA-2024-2460)");
...
following vulnerabilities :
    ...
    Further, this error condition fails silently and is therefore not easily detected by an
    application.(CVE-2024-2398)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2460
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?51dddd4b");
...
var pkgs = [
  "curl-7.61.1-2.h34.eulerosv2r8",
  "libcurl-7.61.1-2.h34.eulerosv2r8",
  "libcurl-devel-7.61.1-2.h34.eulerosv2r8"
];
