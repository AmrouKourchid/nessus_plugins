...
# extracted from Debian Security Advisory dla-3719. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3719 : php-seclib - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3719
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'php-seclib', 'reference': '1.0.19-3~deb10u2'}
];
