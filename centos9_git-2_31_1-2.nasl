...
if (description)
{
  ...
  script_name(english:"CentOS 9 : git-2.31.1-2.el9.2 (deprecated)");
...
"This plugin was deprecated due to incorrect CVE matches for the build.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=11159");
