...
# extracted from Gentoo Linux Security Advisory GLSA 201812-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201812-05");

  script_name(english:"GLSA-201812-05 : EDE: Privilege escalation");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201812-05
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201812-05");
...
"All EDE users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-0035");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:ede");
...
if (qpkg_check(package:"app-xemacs/ede", unaffected:make_list("ge 1.07"), vulnerable:make_list("lt 1.07"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "EDE");
}
