...
# extracted from Red Hat Security Advisory RHSA-2025:7241. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7241");

  script_name(english:"RHEL 9 : rust-bootupd (RHSA-2025:7241)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rust-bootupd.");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-71040");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7241.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e51d21b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7241");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rust-bootupd package based on the guidance in RHSA-2025:7241.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bootupd-0.2.27-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bootupd');
}
