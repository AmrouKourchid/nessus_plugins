...
# extracted from Fedora Security Advisory FEDORA-2023-65f2712f28
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-65f2712f28");

  script_name(english:"Fedora 39 : golang-honnef-tools (2023-65f2712f28)");
...
FEDORA-2023-65f2712f28 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-65f2712f28");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-honnef-tools package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-honnef-tools");
...
var pkgs = [
    {'reference':'golang-honnef-tools-2023.1.3-1.20230802git0e3cc29.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-honnef-tools');
}
