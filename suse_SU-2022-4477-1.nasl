...
# SUSE update advisory SUSE-SU-2022:4477-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4477-1");

  script_name(english:"SUSE SLES12 Security Update : zabbix (SUSE-SU-2022:4477-1)");
...
in the SUSE-SU-2022:4477-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1206083");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2022-43515");
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013237.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?42321fbe");
...
"Update the affected zabbix-agent package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-43515");
...
var pkgs = [
    {'reference':'zabbix-agent-4.0.12-4.21.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
    {'reference':'zabbix-agent-4.0.12-4.21.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'zabbix-agent-4.0.12-4.21.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
