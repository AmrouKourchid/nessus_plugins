...
# extracted from Red Hat Security Advisory RHSA-2017:2726. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:2726");

  script_name(english:"RHEL 7 : instack-undercloud (RHSA-2017:2726)");
...
the RHSA-2017:2726 advisory.
    ...
    The following packages have been upgraded to a later upstream version: instack-undercloud (6.1.0).
    (BZ#1481793)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2726.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?839e3ca0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1477403");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1481793");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2726");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'instack-undercloud-6.1.0-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
