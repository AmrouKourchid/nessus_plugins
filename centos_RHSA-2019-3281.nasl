...
# extracted from Red Hat Security Advisory RHSA-2019:3281 and 
# CentOS Errata and Security Advisory 2019:3281 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (CESA-2019:3281)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2019-November/023501.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4001e65e");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"firefox-68.2.0-4.el6.centos", allowmaj:TRUE)) flag++;
