...
vulnerabilities as referenced in the ALAS2MARIADB10.5-2023-003 advisory.
    ...
    2024-01-19: CVE-2023-5157 was added to this advisory.
    ...
    A use-after-free vulnerability was found in MariaDB. This flaw allows attackers to trigger a
    convert_const_to_int() use-after-free when the BIGINT data type is used, resulting in a denial of service.
    (CVE-2021-46669)
    ...
    An issue in MariaDB Galera can result in a crash of the mysqld process with a signal 6. (CVE-2023-5157)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2023-5157.html");
