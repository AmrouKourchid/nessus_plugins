...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 16.x < 16.0.2.7.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 16 < 16.0.2.7.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-jdk16-2021-Jul-20 advisory.
...
number.");
  # https://github.com/corretto/corretto-jdk/blob/develop-jdk16/CHANGELOG.md#corretto-version-160271
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26d09908");
  script_set_attribute(attribute:"solution", value:
"Update to Amazon Corretto Java 16.0.2.7.1 or later");
...
var constraints = [
  { 'min_version' : '16.0', 'fixed_version' : '16.0.2.7.1' }
];
