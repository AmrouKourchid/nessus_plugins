...
# extracted from Fedora Security Advisory FEDORA-2024-262ad83644
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-262ad83644");

  script_name(english:"Fedora 39 : python-nikola (2024-262ad83644)");
...
FEDORA-2024-262ad83644 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-262ad83644");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-nikola package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-22467");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2024/02/11");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:fedoraproject:fedora:39");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-nikola");
...
var pkgs = [
    {'reference':'python-nikola-8.3.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-nikola');
}
