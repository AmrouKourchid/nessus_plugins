...
# AlmaLinux Security Advisory ALSA-2023:0282.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:0282");

  script_name(english:"AlmaLinux 9 : sudo (ALSA-2023:0282)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-0282.html");
...
"Update the affected sudo and / or sudo-python-plugin packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:sudo-python-plugin");
