...
# openSUSE Security Update openSUSE-SU-2023:0215-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : perl-Net-Netmask (openSUSE-SU-2023:0215-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6635e0eb");
...
var pkgs = [
    {'reference':'perl-Net-Netmask-1.9022-bp154.2.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
