...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : openssl111d (EulerOS-SA-2024-2074)");
...
Tenable has extracted the preceding description block directly from the EulerOS openssl111d security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2074
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7b1aeaf");
...
var pkgs = [
  "openssl111d-1.1.1d-2.h21.eulerosv2r7",
  "openssl111d-devel-1.1.1d-2.h21.eulerosv2r7",
  "openssl111d-libs-1.1.1d-2.h21.eulerosv2r7",
  "openssl111d-static-1.1.1d-2.h21.eulerosv2r7"
];
