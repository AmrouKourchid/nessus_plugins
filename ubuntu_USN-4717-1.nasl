...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Firefox vulnerabilities (USN-4717-1)");
...
vulnerabilities as referenced in the USN-4717-1 advisory.
    ...
    sensitive information, conduct clickjacking attacks, or execute arbitrary code.
