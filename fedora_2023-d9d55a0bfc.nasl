...
# extracted from Fedora Security Advisory FEDORA-2023-d9d55a0bfc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d9d55a0bfc");

  script_name(english:"Fedora 39 : openvpn (2023-d9d55a0bfc)");
...
FEDORA-2023-d9d55a0bfc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d9d55a0bfc");
...
var pkgs = [
    {'reference':'openvpn-2.6.8-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
