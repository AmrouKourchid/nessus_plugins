...
# extracted from Debian Security Advisory DLA-2601-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2601-1 : cloud-init security update");
...
for system users. This functionality is enabled at runtime by passing
...
For the detailed security status of cloud-init please refer to its
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/03/msg00025.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/cloud-init"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/source-package/cloud-init"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"cloud-init", reference:"0.7.9-2+deb9u1")) flag++;
