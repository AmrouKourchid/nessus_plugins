...
# extracted from Red Hat Security Advisory vixie-cron. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-9705");

  script_name(english:"RHEL 5 : vixie-cron (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:cronie");
