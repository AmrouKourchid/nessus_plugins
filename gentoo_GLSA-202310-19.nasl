...
# extracted from Gentoo Linux Security Advisory GLSA 202310-19.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202310-19 : Dovecot: Privilege Escalation");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202310-19 (Dovecot: Privilege Escalation)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202310-19");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=856733");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 2.3.19.1-r1"),
    'vulnerable' : make_list("lt 2.3.19.1-r1")
  }
];
