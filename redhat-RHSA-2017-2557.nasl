...
# extracted from Red Hat Security Advisory RHSA-2017:2557. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:2557");

  script_name(english:"RHEL 7 : instack-undercloud (RHSA-2017:2557)");
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_2557.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?07d2d61a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2557");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL instack-undercloud package based on the guidance in RHSA-2017:2557.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'instack-undercloud-4.0.0-17.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
