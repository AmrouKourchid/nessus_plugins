...
# extracted from Fedora Security Advisory FEDORA-2024-826bf5a09a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-826bf5a09a");

  script_name(english:"Fedora 39 : webkitgtk (2024-826bf5a09a)");
...
FEDORA-2024-826bf5a09a advisory.
     ...
     * Use the geolocation portal where available, with the existing geoclue as fallback if the portal is not
    usable.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-826bf5a09a");
...
"Update the affected webkitgtk package.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2024/06/09");
...
var pkgs = [
    {'reference':'webkitgtk-2.44.2-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
