...
# extracted from Debian Security Advisory dla-4001. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-43859", "CVE-2024-47072");

  script_name(english:"Debian dla-4001 : libxstream-java - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-47072");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libxstream-java', 'reference': '1.4.15-3+deb11u3'}
];
