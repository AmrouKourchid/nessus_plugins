...
# extracted from Debian Security Advisory dla-3072. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3072 : libecpg-compat3 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3072
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-2625");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libecpg-compat3', 'reference': '11.17-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libecpg-dev', 'reference': '11.17-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libecpg6', 'reference': '11.17-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libpgtypes3', 'reference': '11.17-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libpq-dev', 'reference': '11.17-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libpq5', 'reference': '11.17-0+deb10u1'},
    {'release': '10.0', 'prefix': 'postgresql-11', 'reference': '11.17-0+deb10u1'},
    {'release': '10.0', 'prefix': 'postgresql-client-11', 'reference': '11.17-0+deb10u1'},
    {'release': '10.0', 'prefix': 'postgresql-doc-11', 'reference': '11.17-0+deb10u1'},
    {'release': '10.0', 'prefix': 'postgresql-plperl-11', 'reference': '11.17-0+deb10u1'},
    {'release': '10.0', 'prefix': 'postgresql-plpython-11', 'reference': '11.17-0+deb10u1'},
    {'release': '10.0', 'prefix': 'postgresql-plpython3-11', 'reference': '11.17-0+deb10u1'},
    {'release': '10.0', 'prefix': 'postgresql-pltcl-11', 'reference': '11.17-0+deb10u1'},
    {'release': '10.0', 'prefix': 'postgresql-server-dev-11', 'reference': '11.17-0+deb10u1'}
];
