...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.1.0 : libvirt (EulerOS-SA-2019-1456)");
...
the following vulnerabilities :
  ...
  - libvirt version 2.3.0 and later is vulnerable to a bad
    default configuration of 'verify-peer=no' passed to
    QEMU by libvirt resulting in a failure to validate
    SSL/TLS certificates by default. (CVE-2019-3840)

  - libvirt version 2.3.0 and later is vulnerable to a bad
    default configuration of 'verify-peer=no' passed to
    QEMU by libvirt resulting in a failure to validate
    SSL/TLS certificates by default.(CVE-2017-1000256)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1456
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3b8443dc");
...
pkgs = ["libvirt-3.2.0-232",
        "libvirt-admin-3.2.0-232",
        "libvirt-client-3.2.0-232",
        "libvirt-daemon-3.2.0-232",
        "libvirt-daemon-config-network-3.2.0-232",
        "libvirt-daemon-config-nwfilter-3.2.0-232",
        "libvirt-daemon-driver-interface-3.2.0-232",
        "libvirt-daemon-driver-network-3.2.0-232",
        "libvirt-daemon-driver-nodedev-3.2.0-232",
        "libvirt-daemon-driver-nwfilter-3.2.0-232",
        "libvirt-daemon-driver-qemu-3.2.0-232",
        "libvirt-daemon-driver-secret-3.2.0-232",
        "libvirt-daemon-driver-storage-3.2.0-232",
        "libvirt-daemon-driver-storage-core-3.2.0-232",
        "libvirt-daemon-driver-storage-disk-3.2.0-232",
        "libvirt-daemon-driver-storage-gluster-3.2.0-232",
        "libvirt-daemon-driver-storage-iscsi-3.2.0-232",
        "libvirt-daemon-driver-storage-logical-3.2.0-232",
        "libvirt-daemon-driver-storage-mpath-3.2.0-232",
        "libvirt-daemon-driver-storage-rbd-3.2.0-232",
        "libvirt-daemon-driver-storage-scsi-3.2.0-232",
        "libvirt-daemon-kvm-3.2.0-232",
        "libvirt-devel-3.2.0-232",
        "libvirt-docs-3.2.0-232",
        "libvirt-libs-3.2.0-232"];
