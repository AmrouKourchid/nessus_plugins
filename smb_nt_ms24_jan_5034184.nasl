...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5034184");
  script_xref(name:"MSFT", value:"MS24-5034184");
  script_xref(name:"IAVA", value:"2024-A-0015-S");
  script_xref(name:"IAVA", value:"2024-A-0016-S");

  script_name(english:"KB5034184: Windows Server 2012 Security Update (January 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5034184. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034184");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5034184");
