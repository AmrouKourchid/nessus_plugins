...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002189");
  script_xref(name:"MSFT", value:"MS22-5002189");
  script_xref(name:"IAVA", value:"2022-A-0141-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2013 (April 2022)");
...
unauthorized arbitrary commands. (CVE-2022-26901)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002189");
