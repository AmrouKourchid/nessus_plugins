...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : dpdk (EulerOS-SA-2020-1039)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the dpdk packages installed, the EulerOS
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1039
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dfdfa89b");
  script_set_attribute(attribute:"solution", value:
"Update the affected dpdk package.");
...
pkgs = ["dpdk-18.11-0.h36.eulerosv2r8",
        "dpdk-devel-18.11-0.h36.eulerosv2r8",
        "dpdk-tools-18.11-0.h36.eulerosv2r8"];
