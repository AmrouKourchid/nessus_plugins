...
# extracted from Red Hat Security Advisory RHSA-2022:7090. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7090");
  script_xref(name:"IAVA", value:"2023-A-0072");

  script_name(english:"RHEL 9 : libksba (RHSA-2022:7090)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7090.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ce4106b4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7090");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2135610");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libksba package based on the guidance in RHSA-2022:7090.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libksba-1.5.1-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libksba-devel-1.5.1-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libksba-1.5.1-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libksba-devel-1.5.1-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
