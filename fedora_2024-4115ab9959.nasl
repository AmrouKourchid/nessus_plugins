...
# extracted from Fedora Security Advisory FEDORA-2024-4115ab9959
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-24476", "CVE-2024-24479");
  script_xref(name:"IAVB", value:"2024-B-0001-S");
  script_xref(name:"FEDORA", value:"2024-4115ab9959");

  script_name(english:"Fedora 40 : wireshark (2024-4115ab9959)");
...
FEDORA-2024-4115ab9959 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4115ab9959");
...
"Update the affected 1:wireshark package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-24479");
...
var pkgs = [
    {'reference':'wireshark-4.2.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
