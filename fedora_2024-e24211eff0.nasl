...
# extracted from Fedora Security Advisory FEDORA-2024-e24211eff0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e24211eff0");

  script_name(english:"Fedora 39 : dnsmasq (2024-e24211eff0)");
...
FEDORA-2024-e24211eff0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e24211eff0");
...
var pkgs = [
    {'reference':'dnsmasq-2.90-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
