...
# extracted from Red Hat Security Advisory RHSA-2024:3233. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3233.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?769d37e9");
...
"Update the RHEL libssh package based on the guidance in RHSA-2024:3233.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libssh-0.9.6-14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-config-0.9.6-14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-devel-0.9.6-14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
