...
# extracted from Red Hat Security Advisory RHSA-2022:8112. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8112");

  script_name(english:"RHEL 9 : frr (RHSA-2022:8112)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8112.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e981b72a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8112");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'frr-8.2.2-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
