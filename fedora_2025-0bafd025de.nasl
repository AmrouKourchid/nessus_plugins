...
# extracted from Fedora Security Advisory FEDORA-2025-0bafd025de
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-0bafd025de");
  script_xref(name:"IAVB", value:"2025-B-0056");

  script_name(english:"Fedora 40 : corosync (2025-0bafd025de)");
...
FEDORA-2025-0bafd025de advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-0bafd025de");
...
var pkgs = [
    {'reference':'corosync-3.1.9-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
