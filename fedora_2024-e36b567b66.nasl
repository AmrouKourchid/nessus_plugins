...
# extracted from Fedora Security Advisory FEDORA-2024-e36b567b66
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e36b567b66");

  script_name(english:"Fedora 40 : mosquitto (2024-e36b567b66)");
...
FEDORA-2024-e36b567b66 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e36b567b66");
...
var pkgs = [
    {'reference':'mosquitto-2.0.19-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
