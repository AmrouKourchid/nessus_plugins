...
# extracted from Fedora Security Advisory FEDORA-2021-56a49b0bc6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-56a49b0bc6");

  script_name(english:"Fedora 32 : mingw-jasper (2021-56a49b0bc6)");
...
FEDORA-2021-56a49b0bc6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-56a49b0bc6");
...
pkgs = [
    {'reference':'mingw-jasper-2.0.26-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
