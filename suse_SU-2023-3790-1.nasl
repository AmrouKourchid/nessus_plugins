...
# SUSE update advisory SUSE-SU-2023:3790-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3790-1");

  script_name(english:"openSUSE 15 Security Update : wire (SUSE-SU-2023:3790-1)");
...
SU-2023:3790-1 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1212475");
  # https://lists.suse.com/pipermail/sle-security-updates/2023-September/016331.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9428dc45");
  script_set_attribute(attribute:"solution", value:
"Update the affected wire package.");
...
var pkgs = [
    {'reference':'wire-0.5.0-150000.1.14.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'wire-0.5.0-150000.1.14.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'wire');
}
