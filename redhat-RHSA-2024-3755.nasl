...
# extracted from Red Hat Security Advisory RHSA-2024:3755. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3755");

  script_name(english:"RHEL 8 : idm:DL1 (RHSA-2024:3755)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for idm:DL1.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:3755 advisory.
    ...
    * CVE-2024-2698 freeipa: delegation rules allow a proxy service to impersonate any user to access another
    target service
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3755.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8bc84afb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2270353");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2270685");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3755");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL idm:DL1 package based on the guidance in RHSA-2024:3755.");
  ...
  'idm:DL1': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'ipa-client-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-common-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-epn-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-samba-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-common-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'ipa-python-compat-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-selinux-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-common-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-dns-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-trust-ad-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python3-ipaclient-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipalib-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipaserver-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipatests-4.9.13-10.module+el8.10.0+21944+3943ad77', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
