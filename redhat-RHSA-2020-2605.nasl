...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 / 8 : AMQ Clients 2.7.0 Release (Low) (RHSA-2020:2605)");
...
referenced in the RHSA-2020:2605 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?410a4cf0");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2605.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9e032861");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/ENTMQCL-1107");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/ENTMQCL-1150");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/ENTMQCL-1297");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/ENTMQCL-1736");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/ENTMQCL-1737");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/ENTMQCL-1738");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/ENTMQCL-1739");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/ENTMQCL-1854");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/ENTMQCL-1861");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/ENTMQCL-1922");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/ENTMQCL-1985");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/ENTMQCL-761");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/ENTMQCL-797");
...
var constraints = [
  ...
  },
  {
    ...
    'pkgs': [
      {'reference':'python-qpid-proton-0.31.0-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-qpid-proton-docs-0.31.0-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qpid-cpp-client-1.36.0-30.el7amq', 'cpu':'x86_64', 'release':'7', 'el_string':'el7amq', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qpid-cpp-client-devel-1.36.0-30.el7amq', 'cpu':'x86_64', 'release':'7', 'el_string':'el7amq', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qpid-cpp-client-docs-1.36.0-30.el7amq', 'release':'7', 'el_string':'el7amq', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qpid-proton-c-0.31.0-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qpid-proton-c-devel-0.31.0-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qpid-proton-c-docs-0.31.0-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qpid-proton-cpp-0.31.0-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qpid-proton-cpp-devel-0.31.0-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qpid-proton-cpp-docs-0.31.0-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qpid-proton-tests-0.31.0-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-qpid_proton-0.31.0-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
