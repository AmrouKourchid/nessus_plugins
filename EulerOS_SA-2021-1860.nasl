...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : wpa_supplicant (EulerOS-SA-2021-1860)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1860
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b991a7e");
...
pkgs = ["wpa_supplicant-2.6-5.1.h14"];
