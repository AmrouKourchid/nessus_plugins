...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.0.1 < 1.0.1c Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.0.1c. It is, therefore, affected by a vulnerability as
referenced in the 1.0.1c advisory.
...
"Upgrade to OpenSSL version 1.0.1c or later.");
...
var constraints = [
  { 'min_version' : '1.0.1', 'fixed_version' : '1.0.1c' }
];
