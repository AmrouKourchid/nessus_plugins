...
# extracted from Fedora Security Advisory FEDORA-2023-7c6c696102
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7c6c696102");

  script_name(english:"Fedora 39 : unrealircd (2023-7c6c696102)");
...
FEDORA-2023-7c6c696102 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7c6c696102");
...
var pkgs = [
    {'reference':'unrealircd-6.1.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
