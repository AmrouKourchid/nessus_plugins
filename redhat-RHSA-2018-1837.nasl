...
# extracted from Red Hat Security Advisory RHSA-2018:1837. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1837");

  script_name(english:"RHEL 6 / 7 : rh-maven33-plexus-archiver and rh-maven35-plexus-archiver (RHSA-2018:1837)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-maven33-plexus-archiver / rh-maven35-plexus-archiver.");
...
in the RHSA-2018:1837 advisory.

    The Plexus project provides a full software stack for creating and executing software projects. Based on
    the Plexus container, the applications can utilise component-oriented programming to build modular,
    reusable components that can easily be assembled and reused. The plexus-archiver component provides
    functions to create and extract archives.

    Security Fix(es):

    * plexus-archiver: arbitrary file write vulnerability / arbitrary code execution using a specially crafted
    zip file (CVE-2018-1002200)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1584392");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1837.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2d0047c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1837");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-maven33-plexus-archiver / rh-maven35-plexus-archiver packages based on the guidance in
RHSA-2018:1837.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-maven33-plexus-archiver");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-maven33-plexus-archiver-javadoc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-maven35-plexus-archiver");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-maven35-plexus-archiver-javadoc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-maven33-plexus-archiver-2.4.2-5.1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven33-plexus-archiver-javadoc-2.4.2-5.1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven35-plexus-archiver-3.4-4.1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven35-plexus-archiver-javadoc-3.4-4.1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-maven33-plexus-archiver-2.4.2-5.1.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven33-plexus-archiver-javadoc-2.4.2-5.1.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-maven33-plexus-archiver / rh-maven33-plexus-archiver-javadoc / etc');
}
