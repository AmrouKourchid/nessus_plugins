...
# extracted from Ubuntu Security Notice USN-3132-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : tar vulnerability (USN-3132-1)");
...
in the USN-3132-1 advisory.

    Harry Sintonen discovered that tar incorrectly handled extracting files when path names are specified on
    the command line. If a user or automated system were tricked into processing a specially crafted archive,
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3132-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'tar', 'pkgver': '1.27.1-1ubuntu0.1'},
    {'osver': '14.04', 'pkgname': 'tar-scripts', 'pkgver': '1.27.1-1ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'tar', 'pkgver': '1.28-2.1ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'tar-scripts', 'pkgver': '1.28-2.1ubuntu0.1'}
];
