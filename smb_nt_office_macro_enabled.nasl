...
mode to check these registry keys.");
  ...
  # https://learn.microsoft.com/en-us/previous-versions/office/troubleshoot/office-developer/turn-off-visual-basic-for-application
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b8542dc");
  # https://learn.microsoft.com/en-us/previous-versions/office/office-2007-resource-kit/cc178946(v=office.12)
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?308194e9");
...
var ver, vba_item, vba_val;
foreach ver (office_vers)
{
  # VBAOff diables VB for apps
  vba_item = "Software\Microsoft\Office\" + ver + "\Common\VBAOff";
  vba_val = get_registry_value(handle:hklm, item:vba_item);

  # check and exit if set
  if (vba_val == 1)
  {
    exit_msg += 'The remote host is not affected, as the HKLM\\' + vba_item + ' registry key is set.';
