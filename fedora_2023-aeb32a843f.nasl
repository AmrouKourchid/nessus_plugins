...
# extracted from Fedora Security Advisory FEDORA-2023-aeb32a843f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-aeb32a843f");

  script_name(english:"Fedora 37 : python3-docs / python3.11 (2023-aeb32a843f)");
...
FEDORA-2023-aeb32a843f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-aeb32a843f");
...
var pkgs = [
    {'reference':'python3-docs-3.11.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-3.11.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
