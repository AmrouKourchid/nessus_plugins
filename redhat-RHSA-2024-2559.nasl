...
# extracted from Red Hat Security Advisory RHSA-2024:2559. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2559");

  script_name(english:"RHEL 9 : python-jwcrypto (RHSA-2024:2559)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2559.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9077d59f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2559");
...
"Update the RHEL python-jwcrypto package based on the guidance in RHSA-2024:2559.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-jwcrypto-0.8-5.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-jwcrypto-0.8-5.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
