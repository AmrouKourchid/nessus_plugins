...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 10.0.0.M1 < 10.0.7");
...
referenced in the fixed_in_apache_tomcat_10.0.7_security-10 advisory.
...
var constraints = [
  { 'min_version' : '10.0.0.M1', 'max_version' : '10.0.6', 'fixed_version' : '10.0.7' }
];
