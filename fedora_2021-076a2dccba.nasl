...
# extracted from Fedora Security Advisory FEDORA-2021-076a2dccba
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-076a2dccba");

  script_name(english:"Fedora 32 : python3 (2021-076a2dccba)");
...
FEDORA-2021-076a2dccba advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-076a2dccba");
...
pkgs = [
    {'reference':'python3-3.8.7-2.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
