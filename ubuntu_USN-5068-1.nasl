...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS : GD library vulnerabilities (USN-5068-1)");
...
vulnerabilities as referenced in the USN-5068-1 advisory.
    ...
    and GD2 files. An attacker could possibly use this issue to cause a crash or expose sensitive information.
    This issue only affected Ubuntu 20.04 LTS, Ubuntu 18.04 LTS, Ubuntu 16.04 ESM, and Ubuntu 14.04 ESM.
    (CVE-2017-6363)

    It was discovered that GD Graphics Library incorrectly handled certain TGA files. An attacker could
    possibly use this issue to cause a denial of service or expose sensitive information. (CVE-2021-381)

    It was discovered that GD Graphics Library incorrectly handled certain files. An attacker could possibly
    use this issue to cause a crash. (CVE-2021-40145)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libgd-dev', 'pkgver': '2.1.1-4ubuntu0.16.04.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libgd-tools', 'pkgver': '2.1.1-4ubuntu0.16.04.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libgd3', 'pkgver': '2.1.1-4ubuntu0.16.04.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libgd-dev', 'pkgver': '2.2.5-4ubuntu0.5', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'libgd-tools', 'pkgver': '2.2.5-4ubuntu0.5', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'libgd3', 'pkgver': '2.2.5-4ubuntu0.5', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libgd-dev', 'pkgver': '2.2.5-5.2ubuntu2.1', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libgd-tools', 'pkgver': '2.2.5-5.2ubuntu2.1', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libgd3', 'pkgver': '2.2.5-5.2ubuntu2.1', 'ubuntu_pro': FALSE}
];
