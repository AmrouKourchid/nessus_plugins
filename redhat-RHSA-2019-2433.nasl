...
if (description)
{
  ...
  script_name(english:"RHEL 7 : cockpit-ovirt (RHSA-2019:2433)");
...
the RHSA-2019:2433 advisory.

    Cockpit is a Linux system adminstration tool with a web UI, easy setup, and minimal system footprint at
    runtime. When installed on hosts in Red Hat Virtualization, it provides monitoring and management
    functions beyond those available in the Administration Portal. Cockpit is installed by default on Red Hat
    Virtualization Host (RHVH).

    The following packages have been upgraded to a later upstream version: cockpit-ovirt (0.13.5).
    (BZ#1705911, BZ#1711192, BZ#1719317, BZ#1723322)
    ...
    * In this release, the directory /var/lib/ovirt-hosted-engine-setup/cockpit is created with read
    permissions only for user 'root'. Non 'root' users cannot view this directory. (BZ#1723322)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2433.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0536d260");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2433");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1705911");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1709829");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1709938");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1719317");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1719327");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1723322");
...
"Update the affected cockpit-ovirt-dashboard package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-10139");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cockpit-ovirt-dashboard-0.13.5-1.el7ev', 'release':'7', 'el_string':'el7ev', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
