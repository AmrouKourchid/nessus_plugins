...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : libcroco Vulnerability (NS-SA-2021-0056)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has libcroco packages installed that are affected by a
vulnerability:
...
pkgs = {
  'CGSL MAIN 6.02': [
    ...
    'libcroco-debuginfo-0.6.12-4.el8_2.1',
    'libcroco-debugsource-0.6.12-4.el8_2.1',
