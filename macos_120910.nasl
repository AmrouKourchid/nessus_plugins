...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"120910");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/03/27");
  script_xref(name:"IAVA", value:"2024-A-0578-S");

  script_name(english:"macOS 12.x < 12.7.6 Multiple Vulnerabilities (120910)");
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/120910");
