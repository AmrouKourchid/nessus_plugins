...
# extracted from Red Hat Security Advisory dpdk. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-1059", "CVE-2021-3839", "CVE-2022-28199");

  script_name(english:"RHEL 7 : dpdk (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_cvss3_base_vector("CVSS:3.0/AV:A/AC:L/PR:N/UI:N/S:C/C:H/I:N/A:N");
