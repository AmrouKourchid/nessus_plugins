...
# extracted from Fedora Security Advisory FEDORA-2024-77a0ab280f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-77a0ab280f");

  script_name(english:"Fedora 40 : buildah (2024-77a0ab280f)");
...
FEDORA-2024-77a0ab280f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-77a0ab280f");
...
var pkgs = [
    {'reference':'buildah-1.35.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
