...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002002");
  script_xref(name:"MSFT", value:"MS21-5002002");
  script_xref(name:"IAVA", value:"2021-A-0371-S");

  script_name(english:"Security Updates for Microsoft Sharepoint 2016 (August 2021)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002002");
