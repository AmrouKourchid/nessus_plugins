...
# extracted from Oracle Linux Security Advisory ELSA-2023-2249.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : xorg-x11-server-Xwayland (ELSA-2023-2249)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2249.html");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-21.1.3-7.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xwayland-21.1.3-7.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
