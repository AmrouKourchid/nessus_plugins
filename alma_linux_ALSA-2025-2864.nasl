...
# AlmaLinux Security Advisory ALSA-2025:2864.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:2864");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/04/03");
  script_xref(name:"RHSA", value:"2025:2864");

  script_name(english:"AlmaLinux 9 : webkit2gtk3 (ALSA-2025:2864)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2025-2864.html");
...
var pkgs = [
    {'reference':'webkit2gtk3-2.46.6-2.el9_5', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-devel-2.46.6-2.el9_5', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-2.46.6-2.el9_5', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-devel-2.46.6-2.el9_5', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
