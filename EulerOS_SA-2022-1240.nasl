...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : glibc (EulerOS-SA-2022-1240)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1240
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37c3c745");
...
var pkgs = [
  "glibc-2.28-63.h55.eulerosv2r10",
  "glibc-all-langpacks-2.28-63.h55.eulerosv2r10",
  "glibc-common-2.28-63.h55.eulerosv2r10",
  "glibc-locale-source-2.28-63.h55.eulerosv2r10",
  "libnsl-2.28-63.h55.eulerosv2r10",
  "nscd-2.28-63.h55.eulerosv2r10"
];
