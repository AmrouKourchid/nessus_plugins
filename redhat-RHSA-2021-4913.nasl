...
# extracted from Red Hat Security Advisory RHSA-2021:4913. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4913");

  script_name(english:"RHEL 7 : mailman (RHSA-2021:4913)");
...
referenced in the RHSA-2021:4913 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4913.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a0626694");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4913");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1370155");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2020568");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2026862");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mailman package based on the guidance in RHSA-2021:4913.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mailman-2.1.15-30.el7_9.2', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.15-30.el7_9.2', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.15-30.el7_9.2', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.15-30.el7_9.2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
  }
];
