...
# extracted from Oracle Linux Security Advisory ELSA-2023-12988.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : microcode_ctl (ELSA-2023-12988)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-12988.html");
...
var pkgs = [
    {'reference':'microcode_ctl-20230808-2.0.2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
