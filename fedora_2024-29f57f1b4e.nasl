...
# extracted from Fedora Security Advisory FEDORA-2024-29f57f1b4e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-29f57f1b4e");
  script_xref(name:"IAVB", value:"2023-B-0090-S");

  script_name(english:"Fedora 38 : xen (2024-29f57f1b4e)");
...
FEDORA-2024-29f57f1b4e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-29f57f1b4e");
...
var pkgs = [
    {'reference':'xen-4.17.2-8.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
