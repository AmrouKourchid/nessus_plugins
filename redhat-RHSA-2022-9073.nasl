...
# extracted from Red Hat Security Advisory RHSA-2022:9073. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : nodejs:16 (RHSA-2022:9073)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:9073 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_9073.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f2f5d20");
...
"Update the affected packages.");
  ...
  script_cwe_id(295, 350, 915, 1321, 1333);
  ...
  'nodejs:16': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-16.18.1-3.module+el8.7.0+17465+1a1abd74', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-16.18.1-3.module+el8.7.0+17465+1a1abd74', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-16.18.1-3.module+el8.7.0+17465+1a1abd74', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-16.18.1-3.module+el8.7.0+17465+1a1abd74', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-nodemon-2.0.20-2.module+el8.7.0+17412+bb0e4a6b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-25-1.module+el8.5.0+10992+fac5fe06', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'npm-8.19.2-1.16.18.1.3.module+el8.7.0+17465+1a1abd74', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
