...
# extracted from Ubuntu Security Notice USN-6194-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6194-1");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (OEM) vulnerabilities (USN-6194-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6194-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.1.0-1015-oem");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6194-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-2176', 'CVE-2023-2430', 'CVE-2023-35788');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6194-1');
  }
  else
  {
