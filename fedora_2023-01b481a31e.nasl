...
# extracted from Fedora Security Advisory FEDORA-2023-01b481a31e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-01b481a31e");

  script_name(english:"Fedora 38 : python2.7 (2023-01b481a31e)");
...
FEDORA-2023-01b481a31e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-01b481a31e");
...
var pkgs = [
    {'reference':'python2.7-2.7.18-28.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
