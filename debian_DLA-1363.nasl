...
# extracted from Debian Security Advisory DLA-1363-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1363-1 : ghostscript security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/04/msg00028.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/wheezy/ghostscript");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"ghostscript", reference:"9.05~dfsg-6.3+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"ghostscript-cups", reference:"9.05~dfsg-6.3+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"ghostscript-dbg", reference:"9.05~dfsg-6.3+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"ghostscript-doc", reference:"9.05~dfsg-6.3+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"ghostscript-x", reference:"9.05~dfsg-6.3+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"libgs-dev", reference:"9.05~dfsg-6.3+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"libgs9", reference:"9.05~dfsg-6.3+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"libgs9-common", reference:"9.05~dfsg-6.3+deb7u8")) flag++;
