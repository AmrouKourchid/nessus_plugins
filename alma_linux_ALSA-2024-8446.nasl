...
# AlmaLinux Security Advisory ALSA-2024:8446.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:8446");
  script_xref(name:"RHSA", value:"2024:8446");

  script_name(english:"AlmaLinux 9 : python3.9 (ALSA-2024:8446)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-8446.html");
...
var pkgs = [
    ...
    {'reference':'python3-3.9.18-3.el9_4.6', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-debug-3.9.18-3.el9_4.6', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-devel-3.9.18-3.el9_4.6', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-idle-3.9.18-3.el9_4.6', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-libs-3.9.18-3.el9_4.6', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-test-3.9.18-3.el9_4.6', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'python3-tkinter-3.9.18-3.el9_4.6', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
