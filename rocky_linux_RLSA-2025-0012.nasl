...
# Rocky Linux Security Advisory RLSA-2025:0012.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2025:0012");

  script_name(english:"RockyLinux 8 : python-requests (RLSA-2025:0012)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2025:0012");
...
"Update the affected python3-requests package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:python3-requests");
...
var pkgs = [
    {'reference':'python3-requests-2.20.0-5.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
