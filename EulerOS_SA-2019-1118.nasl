...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : libvirt (EulerOS-SA-2019-1118)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1118
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc37e9c2");
...
pkgs = ["libvirt-2.0.0-10.10.h1",
        "libvirt-client-2.0.0-10.10.h1",
        "libvirt-daemon-2.0.0-10.10.h1",
        "libvirt-daemon-config-network-2.0.0-10.10.h1",
        "libvirt-daemon-config-nwfilter-2.0.0-10.10.h1",
        "libvirt-daemon-driver-interface-2.0.0-10.10.h1",
        "libvirt-daemon-driver-lxc-2.0.0-10.10.h1",
        "libvirt-daemon-driver-network-2.0.0-10.10.h1",
        "libvirt-daemon-driver-nodedev-2.0.0-10.10.h1",
        "libvirt-daemon-driver-nwfilter-2.0.0-10.10.h1",
        "libvirt-daemon-driver-qemu-2.0.0-10.10.h1",
        "libvirt-daemon-driver-secret-2.0.0-10.10.h1",
        "libvirt-daemon-driver-storage-2.0.0-10.10.h1",
        "libvirt-daemon-kvm-2.0.0-10.10.h1"];
