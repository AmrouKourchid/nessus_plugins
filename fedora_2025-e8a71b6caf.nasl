...
# extracted from Fedora Security Advisory FEDORA-2025-e8a71b6caf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e8a71b6caf");
  script_xref(name:"IAVA", value:"2025-A-0009-S");

  script_name(english:"Fedora 40 : firefox (2025-e8a71b6caf)");
...
FEDORA-2025-e8a71b6caf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e8a71b6caf");
...
var pkgs = [
    {'reference':'firefox-134.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
