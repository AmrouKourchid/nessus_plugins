...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2173.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2020-21682", "CVE-2021-32280");

  script_name(english:"Amazon Linux 2 : transfig (ALAS-2023-2173)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of transfig installed on the remote host is prior to 3.2.8b-7. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2-2023-2173 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2173.html");
...
var pkgs = [
    {'reference':'transfig-3.2.8b-7.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'transfig-3.2.8b-7.amzn2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'transfig-3.2.8b-7.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'transfig-debuginfo-3.2.8b-7.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'transfig-debuginfo-3.2.8b-7.amzn2', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'transfig-debuginfo-3.2.8b-7.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
