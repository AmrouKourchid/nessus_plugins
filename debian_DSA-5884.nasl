...
# extracted from Debian Security Advisory dsa-5884. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5884 : libxslt1-dev - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-55549");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-24855");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/libxslt");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'libxslt1-dev', 'reference': '1.1.35-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libxslt1.1', 'reference': '1.1.35-1+deb12u1'},
    {'release': '12.0', 'prefix': 'xsltproc', 'reference': '1.1.35-1+deb12u1'}
];
