...
# extracted from Red Hat Security Advisory RHSA-2017:2908. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-11499", "CVE-2017-1000381");
  script_xref(name:"RHSA", value:"2017:2908");

  script_name(english:"RHEL 6 / 7 : rh-nodejs6-nodejs (RHSA-2017:2908)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rh-nodejs6-nodejs.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 / 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2017:2908 advisory.

    Node.js is a software development platform for building fast and scalable network applications in the
    JavaScript programming language.

    The following packages have been upgraded to a later upstream version: rh-nodejs6-nodejs (6.11.3).
    (BZ#1476317)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2908.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?006f0f91");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2908");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-nodejs6-nodejs package based on the guidance in RHSA-2017:2908.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-1000381");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-nodejs6-nodejs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-nodejs6-nodejs-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-nodejs6-nodejs-docs");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs6-nodejs-6.11.3-2.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs6-nodejs-devel-6.11.3-2.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs6-nodejs-docs-6.11.3-2.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-nodejs6-nodejs-6.11.3-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs6-nodejs-devel-6.11.3-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs6-nodejs-docs-6.11.3-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-nodejs6-nodejs / rh-nodejs6-nodejs-devel / etc');
}
