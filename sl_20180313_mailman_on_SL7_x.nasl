...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mailman on SL7.x x86_64 (20180313)");
...
"Security Fix(es) :
  ...
  - mailman: Cross-site scripting (XSS) vulnerability in web
    UI (CVE-2018-5950)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1803&L=scientific-linux-errata&F=&S=&P=7532
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f36e32b6");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"mailman-2.1.15-26.el7_4.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"mailman-debuginfo-2.1.15-26.el7_4.1")) flag++;
