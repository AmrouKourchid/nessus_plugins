...
# SUSE update advisory SUSE-SU-2024:3159-2. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:3159-2");

  script_name(english:"SUSE SLES15 Security Update : postgresql16 (SUSE-SU-2024:3159-2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2024:3159-2 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-October/019677.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f8457b8");
...
"Update the affected postgresql16-llvmjit and / or postgresql16-test packages.");
...
var pkgs = [
    {'reference':'postgresql16-llvmjit-16.4-150600.16.5.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.6']},
    {'reference':'postgresql16-test-16.4-150600.16.5.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.6']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'postgresql16-llvmjit / postgresql16-test');
}
