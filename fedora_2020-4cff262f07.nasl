...
# extracted from Fedora Security Advisory FEDORA-2020-4cff262f07.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : 1:wireshark (2020-4cff262f07)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-4cff262f07");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"wireshark-3.4.0-1.fc33", epoch:"1")) flag++;
