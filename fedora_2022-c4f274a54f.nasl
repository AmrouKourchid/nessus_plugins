...
# extracted from Fedora Security Advisory FEDORA-2022-c4f274a54f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c4f274a54f");

  script_name(english:"Fedora 35 : dhcp (2022-c4f274a54f)");
...
FEDORA-2022-c4f274a54f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c4f274a54f");
...
var pkgs = [
    {'reference':'dhcp-4.4.3-4.P1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'}
];
