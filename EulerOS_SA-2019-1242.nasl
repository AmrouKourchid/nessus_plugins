...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : systemd (EulerOS-SA-2019-1242)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1242
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9fcf3004");
...
pkgs = ["libgudev1-devel-219-57.h71",
        "systemd-219-57.h71",
