...
# extracted from Debian Security Advisory DLA-1348-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1348-1 : patch security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It was discovered that there was an input validation vulnerability in
the patch(1) utility where an ed(1) script embedded in a regular input
file could result in arbitrary code execution. This was reported by
Rachel Kroll [0] et al.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/04/msg00013.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/wheezy/patch");
  script_set_attribute(attribute:"see_also", value:"https://rachelbythebay.com/w/2018/04/05/bangpatch/");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"patch", reference:"2.6.1-3+deb7u1")) flag++;
