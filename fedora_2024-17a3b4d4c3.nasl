...
# extracted from Fedora Security Advisory FEDORA-2024-17a3b4d4c3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-17a3b4d4c3");

  script_name(english:"Fedora 41 : python-rpyc (2024-17a3b4d4c3)");
...
FEDORA-2024-17a3b4d4c3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-17a3b4d4c3");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-rpyc package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-27758");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-rpyc");
...
var pkgs = [
    {'reference':'python-rpyc-6.0.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-rpyc');
}
