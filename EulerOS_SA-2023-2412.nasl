...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libxml2 (EulerOS-SA-2023-2412)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2412
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7987533a");
...
var pkgs = [
  "libxml2-2.9.1-6.3.h33.eulerosv2r7",
  "libxml2-devel-2.9.1-6.3.h33.eulerosv2r7",
  "libxml2-python-2.9.1-6.3.h33.eulerosv2r7"
];
