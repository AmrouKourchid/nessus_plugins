...
# extracted from Red Hat Security Advisory file-roller. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-16680", "CVE-2020-11736", "CVE-2020-36314");

  script_name(english:"RHEL 6 : file-roller (Unpatched Vulnerability) (deprecated)");
