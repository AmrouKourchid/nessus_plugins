...
# extracted from Red Hat Security Advisory RHSA-2018:2317. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2317");

  script_name(english:"RHEL 7 : xmlrpc (RHSA-2018:2317)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for xmlrpc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:2317 advisory.

    XML-RPC is a way to make remote procedure calls over the Internet. It converts procedure calls into XML
    documents, sends them to a remote server using the HTTP protocol, and gets back the response as XML.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_2317.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c4e9a760");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2317");
...
"Update the RHEL xmlrpc package based on the guidance in RHSA-2018:2317.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xmlrpc-client");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xmlrpc-common");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xmlrpc-javadoc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xmlrpc-server");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:redhat:enterprise_linux:7");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xmlrpc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xmlrpc-client-3.1.3-9.el7_5', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'ovirt-'},
      {'reference':'xmlrpc-common-3.1.3-9.el7_5', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'ovirt-'},
      {'reference':'xmlrpc-javadoc-3.1.3-9.el7_5', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'ovirt-'},
      {'reference':'xmlrpc-server-3.1.3-9.el7_5', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'ovirt-'}
    ]
  }
];
