...
if (description)
{
  ...
  script_name(english:"Prefect Detection");

  script_set_attribute(attribute:"synopsis", value:
"A Prefect Python library is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"A Prefect Python library is installed on the remote host. 

Note that Nessus has relied upon on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/PrefectHQ/prefect");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:prefecthq:prefect");
