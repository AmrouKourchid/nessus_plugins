...
if (description)
{
  ...
  script_cve_id("CVE-2024-46805");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46805");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amdgpu: fix the waring
    dereferencing hive Check the amdgpu_hive_info *hive that maybe is NULL. (CVE-2024-46805)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46805");
