...
# extracted from Gentoo Linux Security Advisory GLSA 202210-19.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-39237");

  script_name(english:"GLSA-202210-19 : Apptainer: Lack of Digital Signature Hash Verification");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202210-19 (Apptainer: Lack of Digital Signature Hash
Verification)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202210-19");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=875869");
...
"All Apptainer users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-39237");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.1.2", "lt 1.0.0"),
    'vulnerable' : make_list("lt 1.1.2")
  }
];
