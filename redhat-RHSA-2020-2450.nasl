...
"The remote Red Hat host is missing a security update for .NET Core 3.1 on Red Hat Enterprise Linux 8.");
...
the RHSA-2020:2450 advisory.
    ...
    are .NET Core SDK 3.1.105 and .NET Core Runtime 3.1.5.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2450.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dbec9ca9");
...
"Update the RHEL .NET Core 3.1 on Red Hat Enterprise Linux 8 package based on the guidance in RHSA-2020:2450.");
