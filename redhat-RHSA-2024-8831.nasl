...
# extracted from Red Hat Security Advisory RHSA-2024:8831. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8831.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26872db2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8831");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bcc package based on the guidance in RHSA-2024:8831.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bcc-0.25.0-9.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bcc-devel-0.25.0-9.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bcc-doc-0.25.0-9.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bcc-tools-0.25.0-9.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-bcc-0.25.0-9.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bcc / bcc-devel / bcc-doc / bcc-tools / python3-bcc');
}
