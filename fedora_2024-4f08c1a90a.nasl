...
# extracted from Fedora Security Advisory FEDORA-2024-4f08c1a90a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4f08c1a90a");

  script_name(english:"Fedora 41 : age (2024-4f08c1a90a)");
...
FEDORA-2024-4f08c1a90a advisory.

    Update to 1.2.1 to fix https://github.com/FiloSottile/age/security/advisories/GHSA-32gq-x56h-299c security
    issue.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4f08c1a90a");
...
var pkgs = [
    {'reference':'age-1.2.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
