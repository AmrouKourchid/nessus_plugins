...
# Rocky Linux Security Advisory RLSA-2023:5435.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:5435");
  script_xref(name:"IAVA", value:"2023-A-0522-S");

  script_name(english:"Rocky Linux 9 : thunderbird (RLSA-2023:5435)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:5435");
...
var pkgs = [
    {'reference':'thunderbird-115.3.1-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-115.3.1-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debugsource-115.3.1-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
