...
# extracted from Fedora Security Advisory FEDORA-2023-52460bedda
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-52460bedda");

  script_name(english:"Fedora 39 : tigervnc / xorg-x11-server (2023-52460bedda)");
...
FEDORA-2023-52460bedda advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-52460bedda");
...
var pkgs = [
    {'reference':'tigervnc-1.13.1-9.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-1.20.14-28.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
