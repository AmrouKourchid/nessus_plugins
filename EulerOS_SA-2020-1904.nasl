...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : haproxy (EulerOS-SA-2020-1904)");
...
affected by the following vulnerabilities :
  ...
  - The HTTP/2 implementation in HAProxy before 2.0.10
    mishandles headers, as demonstrated by carriage return
    (CR, ASCII 0xd), line feed (LF, ASCII 0xa), and the
    zero character (NUL, ASCII 0x0), aka Intermediary
  ...
  - A flaw was found in HAProxy before 2.0.6. In legacy
    ...
    according to the specification).(CVE-2019-18277)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1904
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b40234df");
...
pkgs = ["haproxy-1.8.14-1.h3.eulerosv2r8"];
