...
# extracted from Gentoo Linux Security Advisory GLSA 202102-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202102-02");

  script_name(english:"GLSA-202102-02 : Mozilla Thunderbird: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202102-02
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202102-02");
...
if (qpkg_check(package:"mail-client/thunderbird", unaffected:make_list("ge 78.7.0"), vulnerable:make_list("lt 78.7.0"))) flag++;
if (qpkg_check(package:"mail-client/thunderbird-bin", unaffected:make_list("ge 78.7.0"), vulnerable:make_list("lt 78.7.0"))) flag++;
