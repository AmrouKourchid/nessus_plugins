...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 : bash (RHSA-2014:1293)");
...
in the RHSA-2014:1293 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_1293.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b2a1b4d8");
...
"Update the RHEL bash package based on the guidance in RHSA-2014:1293.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bash-4.2.45-5.el7_0.2', 'cpu':'ppc64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-4.2.45-5.el7_0.2', 'cpu':'s390x', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-4.2.45-5.el7_0.2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-doc-4.2.45-5.el7_0.2', 'cpu':'ppc64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-doc-4.2.45-5.el7_0.2', 'cpu':'s390x', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-doc-4.2.45-5.el7_0.2', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'bash-4.1.2-15.el6_5.1', 'cpu':'i686', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-4.1.2-15.el6_5.1', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-4.1.2-15.el6_5.1', 'cpu':'s390x', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-4.1.2-15.el6_5.1', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-doc-4.1.2-15.el6_5.1', 'cpu':'i686', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-doc-4.1.2-15.el6_5.1', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-doc-4.1.2-15.el6_5.1', 'cpu':'s390x', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bash-doc-4.1.2-15.el6_5.1', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
