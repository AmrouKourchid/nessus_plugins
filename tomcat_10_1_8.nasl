...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 10.1.5 < 10.1.8 DoS");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a denial of service vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 10.1.8. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_10.1.8_security-10 advisory. The fix for CVE-2023-24998 was incomplete for
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d11843f");
  # https://tomcat.apache.org/security-10.html#Fixed_in_Apache_Tomcat_10.1.8
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3331e5a7");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 10.1.8 or later.");
...
tomcat_check_version(fixed: '10.1.8', min:'10.1.5', severity:SECURITY_HOLE, granularity_regex: "^10(\.1)?$");
