...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : exiv2 (EulerOS-SA-2019-1830)");
...
vulnerabilities :
  ...
  - http.c in Exiv2 through 0.27.1 allows a malicious http
    server to cause a denial of service (crash due to a
    NULL pointer dereference) by returning a crafted
    response that lacks a space character.(CVE-2019-13114)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1830
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7921b988");
...
pkgs = ["exiv2-0.26-12.h3.eulerosv2r8",
        "exiv2-libs-0.26-12.h3.eulerosv2r8"];
