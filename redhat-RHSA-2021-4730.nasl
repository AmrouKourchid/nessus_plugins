...
# extracted from Red Hat Security Advisory RHSA-2021:4730. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4730");
  script_xref(name:"IAVA", value:"2021-A-0528");

  script_name(english:"RHEL 7 : devtoolset-11-binutils (RHSA-2021:4730)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for devtoolset-11-binutils.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4730 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4730.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d0dd480");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4730");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2005819");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL devtoolset-11-binutils package based on the guidance in RHSA-2021:4730.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:devtoolset-11-binutils");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:devtoolset-11-binutils-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'devtoolset-11-binutils-2.36.1-1.el7.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-11-binutils-2.36.1-1.el7.1', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-11-binutils-2.36.1-1.el7.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-11-binutils-2.36.1-1.el7.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-11-binutils-devel-2.36.1-1.el7.1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-11-binutils-devel-2.36.1-1.el7.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-11-binutils-devel-2.36.1-1.el7.1', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-11-binutils-devel-2.36.1-1.el7.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-11-binutils-devel-2.36.1-1.el7.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'devtoolset-11-binutils / devtoolset-11-binutils-devel');
}
