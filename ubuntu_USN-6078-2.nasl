...
# extracted from Ubuntu Security Notice USN-6078-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6078-2");

  script_name(english:"Ubuntu 16.04 ESM : libwebp vulnerability (USN-6078-2)");
...
USN-6078-2 advisory.
    ...
    USN-6078-1 fixed a vulnerability in libwebp. This update provides the corresponding update for Ubuntu
    16.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6078-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libwebp-dev', 'pkgver': '0.4.4-1ubuntu0.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libwebp5', 'pkgver': '0.4.4-1ubuntu0.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libwebpdemux1', 'pkgver': '0.4.4-1ubuntu0.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libwebpmux1', 'pkgver': '0.4.4-1ubuntu0.1~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'webp', 'pkgver': '0.4.4-1ubuntu0.1~esm2', 'ubuntu_pro': TRUE}
];
