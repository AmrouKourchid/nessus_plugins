...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3460.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a9c2e8a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3460");
...
"Update the RHEL [ansible] package based on the guidance in RHSA-2018:3460.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.6.7-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.6'}
    ]
  }
];
