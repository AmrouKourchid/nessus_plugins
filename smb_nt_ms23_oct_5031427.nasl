...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5031427");
  script_xref(name:"MSKB", value:"5031442");
  script_xref(name:"MSFT", value:"MS23-5031427");
  script_xref(name:"MSFT", value:"MS23-5031442");
  ...
  script_name(english:"KB5031427: Windows Server 2012 Security Update (October 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5031427. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5031427");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5031442");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5031427 or Cumulative Update 5031442");
...
if (
  smb_check_rollup(os:'6.2',
                   ...
                   rollup_date:'10_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5031442, 5031427])
)
{
