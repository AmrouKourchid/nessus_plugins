...
# extracted from Red Hat Security Advisory RHSA-2024:3700. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3700");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.14.29 (RHSA-2024:3700)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.14.29.");
...
in the RHSA-2024:3700 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.14.29. See the
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3700.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b97516a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3700");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.14.29 packages based on the guidance in RHSA-2024:3700.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.27.7-3.rhaos4.14.git674563e.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.27.7-3.rhaos4.14.git674563e.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
