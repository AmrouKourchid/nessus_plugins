...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2023-A-0290-S");
...
multiple vulnerabilities as referenced in the APSB23-31 advisory.
  ...
  - Adobe Experience Manager versions 6.5.16.0 (and earlier) is affected by a reflected Cross-Site Scripting
    ...
    browser. (CVE-2023-29302, CVE-2023-29304, CVE-2023-29322)

  - A shortcoming in the HMEF package of poi-scratchpad (Apache POI) allows an attacker to cause an Out of
    Memory exception. This package is used to read TNEF files (Microsoft Outlook and Microsoft Exchange
    Server). If an application uses poi-scratchpad to parse TNEF files and the application allows untrusted
    users to supply them, then a carefully crafted file can cause an Out of Memory exception. This issue
    affects poi-scratchpad version 5.2.0 and prior versions. Users are recommended to upgrade to poi-
    scratchpad 5.2.1. (CVE-2022-26336)

  - Excessive Iteration vulnerability in Apache Software Foundation Apache Sling Resource Merger.This issue
    affects Apache Sling Resource Merger: from 1.2.0 before 1.4.2. (CVE-2023-26513)

  - Adobe Experience Manager versions 6.5.16.0 (and earlier) is affected by a URL Redirection to Untrusted
    Site ('Open Redirect') vulnerability. A low-privilege authenticated attacker could leverage this
    vulnerability to redirect users to malicious websites. Exploitation of this issue requires user
    interaction. (CVE-2023-29307)
...
"Upgrade to Adobe Experience Manager version 6.5.17.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-26336");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-29322");
