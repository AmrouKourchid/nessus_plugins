...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.14.11 (RHSA-2024:0645)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.14.11.");
...
referenced in the RHSA-2024:0645 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.14.11 packages based on the guidance in RHSA-2024:0645.");
...
var pkgs = [
    {'reference':'runc-1.1.12-1.rhaos4.14.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'},
    {'reference':'runc-1.1.12-1.rhaos4.14.el9', 'release':'4', 'el_string':'el9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'}
];
