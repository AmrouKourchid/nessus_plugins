...
# extracted from Fedora Security Advisory FEDORA-2022-74fe01686a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-74fe01686a");

  script_name(english:"Fedora 35 : drupal7-link (2022-74fe01686a)");
...
FEDORA-2022-74fe01686a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-74fe01686a");
...
var pkgs = [
    {'reference':'drupal7-link-1.11-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
