...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : libwebp vulnerabilities (USN-4971-2)");
...
the USN-4971-2 advisory.
    ...
    USN-4971-1 fixed several vulnerabilities in libwebp. This update provides the corresponding update for
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libwebp-dev', 'pkgver': '0.4.4-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libwebp5', 'pkgver': '0.4.4-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libwebpdemux1', 'pkgver': '0.4.4-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libwebpmux1', 'pkgver': '0.4.4-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'webp', 'pkgver': '0.4.4-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
