...
# SUSE update advisory SUSE-SU-2023:2703-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-28466", "CVE-2023-31436");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2703-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 42 for SLE 12 SP5) (SUSE-SU-2023:2703-1)");
...
referenced in the SUSE-SU-2023:2703-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1210452");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1210989");
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/030141.html");
...
"Update the affected kernel-livepatch-5_14_21-150400_24_46-default and / or kgraft-patch-4_12_14-122_156-default
packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.156-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_156-default-3-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '5.14.21-150400.24.46-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_46-default-5-150400.2.3', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_24_46-default / etc');
}
