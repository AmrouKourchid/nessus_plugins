...
# extracted from Red Hat Security Advisory RHSA-2016:1857. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:1857");

  script_name(english:"RHEL 6 / 7 : ror40-rubygem-actionpack (RHSA-2016:1857)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ror40-rubygem-actionpack.");
...
in the RHSA-2016:1857 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2016/rhsa-2016_1857.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?484aaf0d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:1857");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ror40-rubygem-actionpack package based on the guidance in RHSA-2016:1857.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ror40-rubygem-actionpack");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ror40-rubygem-actionpack-doc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ror40-rubygem-actionpack-4.0.2-8.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ror40-rubygem-actionpack-doc-4.0.2-8.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ror40-rubygem-actionpack-4.0.2-8.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'ror40-rubygem-actionpack-doc-4.0.2-8.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ror40-rubygem-actionpack / ror40-rubygem-actionpack-doc');
}
