...
# extracted from Red Hat Security Advisory RHSA-2018:2524. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2524");

  script_name(english:"RHEL 7 : openvswitch (RHSA-2018:2524)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openvswitch.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:2524 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1547518");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1561969");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1583749");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2524.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?178c3e53");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2524");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openvswitch package based on the guidance in RHSA-2018:2524.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openvswitch-2.9.0-19.el7fdp.1', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      ...
      {'reference':'openvswitch-ovn-central-2.9.0-19.el7fdp.1', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      ...
      {'reference':'openvswitch-ovn-common-2.9.0-19.el7fdp.1', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      ...
      {'reference':'openvswitch-ovn-host-2.9.0-19.el7fdp.1', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      ...
      {'reference':'openvswitch-ovn-vtep-2.9.0-19.el7fdp.1', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
