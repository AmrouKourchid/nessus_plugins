...
if (description)
{
  ...
  script_cve_id("CVE-2011-4355", "CVE-2017-9778");

  script_name(english:"RHEL 5 : gdb (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2017-9778");
