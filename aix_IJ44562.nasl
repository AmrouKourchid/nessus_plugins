...
if (description)
{
  ...
  script_name(english:"AIX (IJ44562)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ44562. It is, therefore, affected by a vulnerability
as referenced in the IJ44562 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ44562");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6848309");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ44562.");
...
var constraints = [
    {'release': '7.3', 'ml': '00', 'sp': '03', 'patch': 'IJ44562s3a', 'package': 'bos.rte.printers', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.0'},
    {'release': '7.3', 'ml': '00', 'sp': '03', 'patch': 'IJ44562s3a', 'package': 'printers.rte', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.1'}
];
