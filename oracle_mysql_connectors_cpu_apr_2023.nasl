...
if (description)
{
  ...
  script_name(english:"Oracle MySQL ODBC and C++ Connectors (Apr 2023 CPU)");
...
OpenSSL component as referenced in the April 2023 CPU advisory. Supported versions that are affected are 8.0.32
and prior. Easily exploitable vulnerability allows unauthenticated attacker with network access via multiple protocols
to compromise MySQL Connectors. Successful attacks of this vulnerability can result in unauthorized ability to cause a
hang or frequently repeatable crash (complete DOS) of MySQL Connectors.
