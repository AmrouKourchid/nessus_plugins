...
# extracted from VMware Security Advisory PHSA-2020-1.0-0340. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-25694", "CVE-2020-25695");
  script_xref(name:"IAVB", value:"2020-B-0069-S");

  script_name(english:"Photon OS 1.0: Postgresql PHSA-2020-1.0-0340");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the postgresql package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-340.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'postgresql-9.6.20-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'postgresql-devel-9.6.20-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'postgresql-libs-9.6.20-1.ph1')) flag++;
