...
# extracted from VMware Security Advisory PHSA-2023-3.0-0549. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Redis PHSA-2023-3.0-0549");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the redis package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-549.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'redis-6.2.7-4.ph3')) flag++;
