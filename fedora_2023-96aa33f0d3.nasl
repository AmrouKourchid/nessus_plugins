...
# extracted from Fedora Security Advisory FEDORA-2023-96aa33f0d3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-96aa33f0d3");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 38 : python2.7 (2023-96aa33f0d3)");
...
FEDORA-2023-96aa33f0d3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-96aa33f0d3");
...
var pkgs = [
    {'reference':'python2.7-2.7.18-31.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
