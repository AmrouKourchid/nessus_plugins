...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : glib2 (EulerOS-SA-2021-2030)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2030
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8ba9ca9");
...
pkgs = ["glib2-2.54.2-2.h6.eulerosv2r7",
        "glib2-devel-2.54.2-2.h6.eulerosv2r7"];
