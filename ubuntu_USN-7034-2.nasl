...
# extracted from Ubuntu Security Notice USN-7034-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7034-2");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : ca-certificates update (USN-7034-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7034-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ca-certificates', 'pkgver': '202402031~16.04.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'ca-certificates', 'pkgver': '202402031ubuntu0.18.04.1+esm1', 'ubuntu_pro': TRUE}
];
