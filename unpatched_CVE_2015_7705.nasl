...
if (description)
{
  ...
  script_cve_id("CVE-2015-7705");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-7705");
...
patch available.
  ...
  - The rate limiting feature in NTP 4.x before 4.2.8p4 and 4.3.x before 4.3.77 allows remote attackers to
    have unspecified impact via a large number of crafted requests. (CVE-2015-7705)
