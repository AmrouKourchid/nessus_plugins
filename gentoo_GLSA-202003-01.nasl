...
# extracted from Gentoo Linux Security Advisory GLSA 202003-01.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-01");

  script_name(english:"GLSA-202003-01 : Groovy: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-01
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-01");
...
if (qpkg_check(package:"dev-java/groovy", unaffected:make_list(), vulnerable:make_list("le 2.4.5"))) flag++;
