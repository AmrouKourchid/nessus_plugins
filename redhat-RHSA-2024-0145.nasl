...
# extracted from Red Hat Security Advisory RHSA-2024:0145. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0145.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e88c14c");
...
"Update the RHEL ipa package based on the guidance in RHSA-2024:0145.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ipa-client-4.6.8-5.el7_9.16', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-4.6.8-5.el7_9.16', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-4.6.8-5.el7_9.16', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-4.6.8-5.el7_9.16', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-common-4.6.8-5.el7_9.16', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-common-4.6.8-5.el7_9.16', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-python-compat-4.6.8-5.el7_9.16', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-4.6.8-5.el7_9.16', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-common-4.6.8-5.el7_9.16', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-dns-4.6.8-5.el7_9.16', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-trust-ad-4.6.8-5.el7_9.16', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-ipaclient-4.6.8-5.el7_9.16', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-ipalib-4.6.8-5.el7_9.16', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-ipaserver-4.6.8-5.el7_9.16', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
