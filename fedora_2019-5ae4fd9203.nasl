...
# extracted from Fedora Security Advisory FEDORA-2019-5ae4fd9203.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-5ae4fd9203");

  script_name(english:"Fedora 31 : php-symfony (2019-5ae4fd9203)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5ae4fd9203");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"php-symfony-2.8.52-1.fc31")) flag++;
