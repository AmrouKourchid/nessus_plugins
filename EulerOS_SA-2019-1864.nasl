...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : perl (EulerOS-SA-2019-1864)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1864
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32f96d95");
...
pkgs = ["perl-5.16.3-285.h4",
        "perl-core-5.16.3-285.h4",
        "perl-devel-5.16.3-285.h4",
        "perl-libs-5.16.3-285.h4",
        "perl-macros-5.16.3-285.h4"];
