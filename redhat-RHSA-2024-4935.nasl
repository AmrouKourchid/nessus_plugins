...
# extracted from Red Hat Security Advisory RHSA-2024:4935. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4935");

  script_name(english:"RHEL 9 : freeradius (RHSA-2024:4935)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4935.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?130598ed");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2263240");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4935");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL freeradius package based on the guidance in RHSA-2024:4935.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freeradius-3.0.21-40.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-devel-3.0.21-40.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-doc-3.0.21-40.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-krb5-3.0.21-40.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-ldap-3.0.21-40.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-mysql-3.0.21-40.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-perl-3.0.21-40.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-postgresql-3.0.21-40.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-rest-3.0.21-40.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-sqlite-3.0.21-40.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-unixODBC-3.0.21-40.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-utils-3.0.21-40.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-freeradius-3.0.21-40.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'freeradius-3.0.21-40.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-devel-3.0.21-40.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-doc-3.0.21-40.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-krb5-3.0.21-40.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-ldap-3.0.21-40.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-mysql-3.0.21-40.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-perl-3.0.21-40.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-postgresql-3.0.21-40.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-rest-3.0.21-40.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-sqlite-3.0.21-40.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-unixODBC-3.0.21-40.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-utils-3.0.21-40.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-freeradius-3.0.21-40.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
