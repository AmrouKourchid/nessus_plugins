...
# extracted from Ubuntu Security Notice USN-5193-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5193-2");

  script_name(english:"Ubuntu 16.04 ESM : X.Org X Server vulnerabilities (USN-5193-2)");
...
the USN-5193-2 advisory.

    USN-5193-1 fixed several vulnerabilities in X.Org. This update provides the corresponding update for
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5193-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'xdmx', 'pkgver': '2:1.18.4-0ubuntu0.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xdmx-tools', 'pkgver': '2:1.18.4-0ubuntu0.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xmir', 'pkgver': '2:1.18.4-0ubuntu0.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xnest', 'pkgver': '2:1.18.4-0ubuntu0.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xorg-server-source', 'pkgver': '2:1.18.4-0ubuntu0.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xserver-common', 'pkgver': '2:1.18.4-0ubuntu0.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xserver-xephyr', 'pkgver': '2:1.18.4-0ubuntu0.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xserver-xorg-core', 'pkgver': '2:1.18.4-0ubuntu0.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xserver-xorg-dev', 'pkgver': '2:1.18.4-0ubuntu0.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xserver-xorg-legacy', 'pkgver': '2:1.18.4-0ubuntu0.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xserver-xorg-xmir', 'pkgver': '2:1.18.4-0ubuntu0.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xvfb', 'pkgver': '2:1.18.4-0ubuntu0.12+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xwayland', 'pkgver': '2:1.18.4-0ubuntu0.12+esm1', 'ubuntu_pro': TRUE}
];
