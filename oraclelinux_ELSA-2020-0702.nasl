...
# Oracle Linux Security Advisory ELSA-2020-0702 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : xerces-c (ELSA-2020-0702)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0702.html");
...
var pkgs = [
    ...
    {'reference':'xerces-c-doc-3.0.1-21.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'xerces-c-doc-3.0.1-21.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
