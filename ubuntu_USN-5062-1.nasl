...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : Linux kernel vulnerability (USN-5062-1)");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5062-1');
}
