...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : dnsmasq / dnsmasq-utils (VZLSA-2017-2838)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2017-2838.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e5798885");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2838");
  script_set_attribute(attribute:"solution", value:
"Update the affected dnsmasq / dnsmasq-utils package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:dnsmasq");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:dnsmasq-utils");
...
pkgs = ["dnsmasq-2.48-18.vl6",
        "dnsmasq-utils-2.48-18.vl6"];
