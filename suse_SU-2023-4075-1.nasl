...
# SUSE update advisory SUSE-SU-2023:4075-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4075-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : cni-plugins (SUSE-SU-2023:4075-1)");
...
as referenced in the SUSE-SU-2023:4075-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-October/016683.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?87e419f4");
...
var pkgs = [
    {'reference':'cni-plugins-1.1.1-150500.3.2.1', 'sp':'5', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'cni-plugins-1.1.1-150500.3.2.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-containers-release-15.5', 'sles-release-15.5']},
    {'reference':'cni-plugins-1.1.1-150500.3.2.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
