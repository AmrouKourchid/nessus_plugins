...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libxslt (EulerOS-SA-2023-2399)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libxslt packages installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2399
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7319604b");
...
var pkgs = [
  "libxslt-1.1.28-5.h9.eulerosv2r7",
  "libxslt-devel-1.1.28-5.h9.eulerosv2r7",
  "libxslt-python-1.1.28-5.h9.eulerosv2r7"
];
