...
# extracted from Red Hat Security Advisory RHSA-2022:5251. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5251");

  script_name(english:"RHEL 9 : pcre2 (RHSA-2022:5251)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for pcre2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:5251 advisory.

    The pcre2 package contains a new generation of the Perl Compatible Regular Expression libraries for
    implementing regular expression pattern matching using the same syntax and semantics as Perl.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5251.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0f2e8211");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5251");
...
"Update the RHEL pcre2 package based on the guidance in RHSA-2022:5251.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pcre2");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pcre2-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pcre2-syntax");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pcre2-utf16");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pcre2-utf32");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pcre2-10.37-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcre2-devel-10.37-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcre2-syntax-10.37-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcre2-utf16-10.37-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcre2-utf32-10.37-5.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'pcre2-10.37-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcre2-devel-10.37-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcre2-syntax-10.37-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcre2-utf16-10.37-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcre2-utf32-10.37-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'pcre2 / pcre2-devel / pcre2-syntax / pcre2-utf16 / pcre2-utf32');
}
