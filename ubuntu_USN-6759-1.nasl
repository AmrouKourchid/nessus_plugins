...
# extracted from Ubuntu Security Notice USN-6759-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6759-1");

  script_name(english:"Ubuntu 24.04 LTS. : FreeRDP vulnerabilities (USN-6759-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6759-1");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'freerdp3-dev', 'pkgver': '3.5.1+dfsg1-0ubuntu1'},
    {'osver': '24.04', 'pkgname': 'freerdp3-shadow-x11', 'pkgver': '3.5.1+dfsg1-0ubuntu1'},
    {'osver': '24.04', 'pkgname': 'freerdp3-wayland', 'pkgver': '3.5.1+dfsg1-0ubuntu1'},
    {'osver': '24.04', 'pkgname': 'freerdp3-x11', 'pkgver': '3.5.1+dfsg1-0ubuntu1'},
    {'osver': '24.04', 'pkgname': 'libfreerdp-client3-3', 'pkgver': '3.5.1+dfsg1-0ubuntu1'},
    {'osver': '24.04', 'pkgname': 'libfreerdp-server3-3', 'pkgver': '3.5.1+dfsg1-0ubuntu1'},
    {'osver': '24.04', 'pkgname': 'libfreerdp-shadow-subsystem3-3', 'pkgver': '3.5.1+dfsg1-0ubuntu1'},
    {'osver': '24.04', 'pkgname': 'libfreerdp-shadow3-3', 'pkgver': '3.5.1+dfsg1-0ubuntu1'},
    {'osver': '24.04', 'pkgname': 'libfreerdp3-3', 'pkgver': '3.5.1+dfsg1-0ubuntu1'},
    {'osver': '24.04', 'pkgname': 'libwinpr-tools3-3', 'pkgver': '3.5.1+dfsg1-0ubuntu1'},
    {'osver': '24.04', 'pkgname': 'libwinpr3-3', 'pkgver': '3.5.1+dfsg1-0ubuntu1'},
    {'osver': '24.04', 'pkgname': 'libwinpr3-dev', 'pkgver': '3.5.1+dfsg1-0ubuntu1'},
    {'osver': '24.04', 'pkgname': 'winpr3-utils', 'pkgver': '3.5.1+dfsg1-0ubuntu1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'freerdp3-dev / freerdp3-shadow-x11 / freerdp3-wayland / etc');
}
