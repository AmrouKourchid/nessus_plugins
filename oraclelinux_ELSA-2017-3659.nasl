...
ELSA-2017-3659 advisory.
    ...
    - mm, thp: Do not make page table dirty unconditionally in follow_trans_huge_pmd() (Kirill A. Shutemov)
    [Orabug: 27200880]  {CVE-2017-1000405}
    - ALSA: usb-audio: Kill stray URB at exiting (Takashi Iwai)  [Orabug: 27148272]  {CVE-2017-16527}
    - packet: in packet_do_bind, test fanout with bind_lock held (Willem de Bruijn)  [Orabug: 27069060]
    {CVE-2017-15649}
    - packet: hold bind lock when rebinding to fanout hook (Willem de Bruijn)  [Orabug: 27069060]
    {CVE-2017-15649}
    - net: convert packet_fanout.sk_ref from atomic_t to refcount_t (Reshetova, Elena)  [Orabug: 27069060]
    {CVE-2017-15649}
    - packet: fix races in fanout_add() (Eric Dumazet)  [Orabug: 27069060]  {CVE-2017-15649}
    - refcount_t: Introduce a special purpose refcount type (Peter Zijlstra)  [Orabug: 27069060]
    {CVE-2017-15649}
    - locking/atomics: Add _{acquire|release|relaxed}() variants of some atomic operations (Will Deacon)
    [Orabug: 27069060]  {CVE-2017-15649}
    - fix unbalanced page refcounting in bio_map_user_iov (Vitaly Mayatskikh)  [Orabug: 27069034]
    {CVE-2017-12190}
    ...
    - sysctl: Drop reference added by grab_header in proc_sys_readdir (Zhou Chengming)  [Orabug: 27036905]
    {CVE-2016-9191} {CVE-2016-9191} {CVE-2016-9191}
    - selinux: fix off-by-one in setprocattr (Stephen Smalley)  [Orabug: 27001687]  {CVE-2017-2618}
    {CVE-2017-2618} {CVE-2017-2618}
    - udp: consistently apply ufo or fragmentation (Willem de Bruijn)  [Orabug: 26921314]  {CVE-2017-1000112}
    - ipv6: avoid overflow of offset in ip6_find_1stfragopt (Sabrina Dubroca)  [Orabug: 27011248]
    {CVE-2017-7542}
    - scsi: scsi_transport_iscsi: fix the issue that iscsi_if_rx doesnt parse nlmsg properly (Xin Long)
    [Orabug: 26988631]  {CVE-2017-14489}
    - CVE-2016-10318 missing authorization check fscrypt_process_policy (Jack Vogel)  [Orabug: 26989776]
    - timerfd: Protect the might cancel mechanism proper (Thomas Gleixner)  [Orabug: 26673877]
    {CVE-2017-10661}
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-4.1.12-112.14.1.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-112.14.1.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'},
    ...
    {'reference':'kernel-uek-doc-4.1.12-112.14.1.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-112.14.1.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'}
];
