...
if (description)
{
  ...
  script_cve_id("CVE-2021-4023");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-4023");
...
patch available.
  ...
  - A flaw was found in the io-workqueue implementation in the Linux kernel versions prior to 5.15-rc1. The
    kernel can panic when an improper cancellation operation triggers the submission of new io-uring
    operations during a shortage of free space. This flaw allows a local user with permissions to execute io-
    uring requests to possibly crash the system. (CVE-2021-4023)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-4023");
