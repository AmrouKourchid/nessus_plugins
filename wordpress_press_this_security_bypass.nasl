...
only on the application's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://codex.wordpress.org/Version_3.0.6");
  script_set_attribute(attribute:"see_also", value:"https://codex.wordpress.org/Version_3.1.2");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/news/2011/04/wordpress-3-1-2/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to WordPress 3.0.6 / 3.1.2 or later.");
