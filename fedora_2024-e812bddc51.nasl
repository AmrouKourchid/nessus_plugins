...
# extracted from Fedora Security Advisory FEDORA-2024-e812bddc51
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e812bddc51");

  script_name(english:"Fedora 39 : tkimg (2024-e812bddc51)");
...
FEDORA-2024-e812bddc51 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e812bddc51");
...
var pkgs = [
    {'reference':'tkimg-1.4.16-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
