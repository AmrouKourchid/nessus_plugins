...
# extracted from Fedora Security Advisory FEDORA-2019-4c0d6e1784.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-4c0d6e1784");

  script_name(english:"Fedora 29 : openconnect (2019-4c0d6e1784)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-4c0d6e1784");
  script_set_attribute(attribute:"solution", value:
"Update the affected openconnect package.");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"openconnect-8.05-1.fc29")) flag++;
