...
# extracted from Red Hat Security Advisory RHSA-2023:3142. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3142");

  script_name(english:"RHEL 9 : firefox (RHSA-2023:3142)");
...
referenced in the RHSA-2023:3142 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3142.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77bc3d56");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3142");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2023:3142.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.11.0-2.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
