...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : glib2 (EulerOS-SA-2023-2540)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2540
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c7997258");
...
var pkgs = [
  "glib2-2.62.5-6.h16.eulerosv2r10"
];
