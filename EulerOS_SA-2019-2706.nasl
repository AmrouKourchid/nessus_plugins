...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libsrtp (EulerOS-SA-2019-2706)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the libsrtp package installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2706
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7914108d");
  script_set_attribute(attribute:"solution", value:
"Update the affected libsrtp package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-2139");
...
pkgs = ["libsrtp-1.4.4-10.h120101004cvs.eulerosv2r7"];
