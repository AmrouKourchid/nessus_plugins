...
# extracted from Fedora Security Advisory FEDORA-2018-839720583a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : xorg-x11-server (2018-839720583a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-839720583a");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"xorg-x11-server-1.19.6-10.fc28")) flag++;
