...
if (description)
{
  ...
  script_cve_id("CVE-2018-12207", "CVE-2019-11135", "CVE-2019-11139");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-4868.html");
...
var pkgs = [
    {'reference':'microcode_ctl-1.17-33.19.0.4.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
    {'reference':'microcode_ctl-1.17-33.19.0.4.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
