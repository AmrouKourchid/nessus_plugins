...
# extracted from Fedora Security Advisory FEDORA-2024-3ab90a5b01
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3ab90a5b01");

  script_name(english:"Fedora 38 : python2.7 (2024-3ab90a5b01)");
...
FEDORA-2024-3ab90a5b01 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3ab90a5b01");
...
var pkgs = [
    {'reference':'python2.7-2.7.18-37.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
