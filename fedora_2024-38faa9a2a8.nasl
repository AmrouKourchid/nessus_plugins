...
# extracted from Fedora Security Advisory FEDORA-2024-38faa9a2a8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-38faa9a2a8");

  script_name(english:"Fedora 38 : iwd / libell (2024-38faa9a2a8)");
...
FEDORA-2024-38faa9a2a8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-38faa9a2a8");
...
var pkgs = [
    {'reference':'iwd-2.15-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libell-0.63-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
