...
# extracted from Fedora Security Advisory FEDORA-2023-419ca55dd3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-419ca55dd3");

  script_name(english:"Fedora 37 : sympa (2023-419ca55dd3)");
...
FEDORA-2023-419ca55dd3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-419ca55dd3");
...
var pkgs = [
    {'reference':'sympa-6.2.72-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
