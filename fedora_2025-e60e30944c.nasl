...
# extracted from Fedora Security Advisory FEDORA-2025-e60e30944c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e60e30944c");

  script_name(english:"Fedora 40 : python3.6 (2025-e60e30944c)");
...
FEDORA-2025-e60e30944c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e60e30944c");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-43.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
