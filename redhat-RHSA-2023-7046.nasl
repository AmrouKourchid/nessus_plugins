...
# extracted from Red Hat Security Advisory RHSA-2023:7046. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7046");

  script_name(english:"RHEL 8 : dnsmasq (RHSA-2023:7046)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for dnsmasq.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:7046 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7046.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9e834372");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2178948");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2186481");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2207798");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2233542");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7046");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dnsmasq package based on the guidance in RHSA-2023:7046.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dnsmasq-2.79-31.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-utils-2.79-31.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
