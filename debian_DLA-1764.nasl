...
# extracted from Debian Security Advisory DLA-1764-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1764-1 : mercurial security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It was discovered that there was a path traversal vulnerability in the
'mercurial' distributed revision version control system.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/04/msg00024.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/mercurial");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"mercurial", reference:"3.1.2-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"mercurial-common", reference:"3.1.2-2+deb8u7")) flag++;
