...
# extracted from Debian Security Advisory dsa-5275. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5275-1 : chromium - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1015931");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/chromium");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5275");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-3885");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-3886");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-3887");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-3888");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-3889");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-3890");
...
For the stable distribution (bullseye), these problems have been fixed in version 107.0.5304.110-1~deb11u1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-3890");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'chromium', 'reference': '107.0.5304.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-common', 'reference': '107.0.5304.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-driver', 'reference': '107.0.5304.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-l10n', 'reference': '107.0.5304.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-sandbox', 'reference': '107.0.5304.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-shell', 'reference': '107.0.5304.110-1~deb11u1'}
];
