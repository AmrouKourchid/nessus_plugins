...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : poppler (EulerOS-SA-2023-2414)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the poppler packages installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2414
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86af891d");
...
var pkgs = [
  "poppler-0.26.5-17.h29.eulerosv2r7",
  "poppler-glib-0.26.5-17.h29.eulerosv2r7",
  "poppler-qt-0.26.5-17.h29.eulerosv2r7",
  "poppler-utils-0.26.5-17.h29.eulerosv2r7"
];
