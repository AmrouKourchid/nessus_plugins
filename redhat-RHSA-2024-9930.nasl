...
# extracted from Red Hat Security Advisory RHSA-2024:9930. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9930");

  script_name(english:"RHEL 9 : edk2 (RHSA-2024:9930)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9930.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c87d3dc8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9930");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL edk2 package based on the guidance in RHSA-2024:9930.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'edk2-aarch64-20220126gitbb1bba3d77-3.el9_0.6', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'edk2-ovmf-20220126gitbb1bba3d77-3.el9_0.6', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
