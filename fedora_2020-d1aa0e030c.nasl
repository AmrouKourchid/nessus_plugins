...
# extracted from Fedora Security Advisory FEDORA-2020-d1aa0e030c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : awstats (2020-d1aa0e030c)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-d1aa0e030c");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"awstats-7.8-2.fc32")) flag++;
