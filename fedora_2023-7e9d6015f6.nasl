...
# extracted from Fedora Security Advisory FEDORA-2023-7e9d6015f6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7e9d6015f6");

  script_name(english:"Fedora 39 : mediawiki (2023-7e9d6015f6)");
...
FEDORA-2023-7e9d6015f6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7e9d6015f6");
...
var pkgs = [
    {'reference':'mediawiki-1.39.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
