...
# extracted from Red Hat Security Advisory taglib. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2012-1108", "CVE-2017-12678", "CVE-2018-11439");

  script_name(english:"RHEL 6 : taglib (Unpatched Vulnerability) (deprecated)");
