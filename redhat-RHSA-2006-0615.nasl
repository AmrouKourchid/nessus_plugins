...
if (description)
{
  ...
  script_name(english:"RHEL 4 : gnupg (RHSA-2006:0615)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gnupg.");
...
the RHSA-2006:0615 advisory.

  - GnuPG Parse_Comment Remote Buffer Overflow (CVE-2006-3746)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2006/rhsa-2006_0615.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?acc480a0");
  script_set_attribute(attribute:"see_also", value:"http://www.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=200502");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2006:0615");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gnupg package based on the guidance in RHSA-2006:0615.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2006-3746");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnupg-1.2.6-6', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg-1.2.6-6', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg-1.2.6-6', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg-1.2.6-6', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg-1.2.6-6', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
