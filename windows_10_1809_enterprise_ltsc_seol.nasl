...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 1809 Enterprise LTSC SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 1809 Enterprise LTSC is no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # https://learn.microsoft.com/en-us/windows/release-health/release-information
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2eab71db");
...
var os = ucf::get_os_cpe(vendor:'microsoft', product:'windows_10_1809', type:'local');

var constraints = [
  { seol : 20290109, cpe_attributes : [{'edition': 'enterprise_ltsc*'}] }
];
