...
# extracted from Red Hat Security Advisory xchat. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2009-0315", "CVE-2013-7449");

  script_name(english:"RHEL 5 : xchat (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2013-7449");
