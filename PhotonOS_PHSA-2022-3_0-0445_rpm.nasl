...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Rpm PHSA-2022-3.0-0445");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'rpm-4.14.3-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'rpm-build-4.14.3-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'rpm-devel-4.14.3-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'rpm-lang-4.14.3-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'rpm-libs-4.14.3-4.ph3')) flag++;
