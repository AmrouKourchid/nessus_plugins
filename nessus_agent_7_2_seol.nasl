...
if (description)
{
  ...
  script_name(english:"Tenable Nessus Agent SEoL (7.2.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus Agent is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus Agent is 7.2.x. It is, therefore, no longer maintained by its vendor or
provider.
...
var constraints = [
  { max_branch : '7.2', min_branch : '7.2', seol : 20200630, eseol : 20201231 }
];
