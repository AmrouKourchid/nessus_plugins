...
# extracted from Fedora Security Advisory FEDORA-2024-da8cdd8414
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-da8cdd8414");

  script_name(english:"Fedora 40 : nghttp2 (2024-da8cdd8414)");
...
FEDORA-2024-da8cdd8414 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-da8cdd8414");
...
var pkgs = [
    {'reference':'nghttp2-1.59.0-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
