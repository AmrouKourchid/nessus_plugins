...
# SUSE update advisory SUSE-SU-2025:0581-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0581-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : buildah (SUSE-SU-2025:0581-1)");
...
as referenced in the SUSE-SU-2025:0581-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-February/020366.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5116179b");
...
var pkgs = [
    {'reference':'buildah-1.35.5-150500.3.28.1', 'sp':'6', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.6']},
    {'reference':'buildah-1.35.5-150500.3.28.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.6', 'sle-module-containers-release-15.6', 'sles-release-15.6']},
    {'reference':'buildah-1.35.5-150500.3.28.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']}
];
