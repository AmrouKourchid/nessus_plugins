...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : docker-engine (EulerOS-SA-2023-2352)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2352
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?35857639");
...
var pkgs = [
  "docker-engine-1:18.09.0-200.h69.35.22.eulerosv2r10"
];
