...
if (description)
{
  ...
  script_cve_id("CVE-2022-49095");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49095");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: scsi: zorro7xx: Fix a resource leak in
    zorro7xx_remove_one() The error handling path of the probe releases a resource that is not freed in the
    remove function. In some cases, a ioremap() must be undone. Add the missing iounmap() call in the remove
    function. (CVE-2022-49095)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49095");
