...
if (description)
{
  ...
  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.14.18 (RHSA-2024:1461)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.14.18.");
...
in the RHSA-2024:1461 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.14.18. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1461.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eedcc0b7");
...
"Update the RHEL OpenShift Container Platform 4.14.18 packages based on the guidance in RHSA-2024:1461.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.27.4-5.rhaos4.14.git8d40fed.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.27.4-5.rhaos4.14.git8d40fed.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
