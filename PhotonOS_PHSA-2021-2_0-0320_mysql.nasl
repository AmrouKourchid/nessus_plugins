...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Mysql PHSA-2021-2.0-0320");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'mysql-5.7.33-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'mysql-devel-5.7.33-1.ph2')) flag++;
