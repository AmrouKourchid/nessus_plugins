...
# extracted from Fedora Security Advisory FEDORA-2023-5416cd3040
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5416cd3040");

  script_name(english:"Fedora 37 : chromium (2023-5416cd3040)");
...
FEDORA-2023-5416cd3040 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5416cd3040");
...
var pkgs = [
    {'reference':'chromium-116.0.5845.96-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
