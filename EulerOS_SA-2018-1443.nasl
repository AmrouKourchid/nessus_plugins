...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : python-paramiko (EulerOS-SA-2018-1443)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1443
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91ac5a8e");
...
pkgs = ["python-paramiko-1.15.1-1.h1"];
