...
# extracted from Red Hat Security Advisory RHSA-2016:1628. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:1628");

  script_name(english:"RHEL 6 / 7 : python27-python (RHSA-2016:1628)");
...
referenced in the RHSA-2016:1628 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2016/rhsa-2016_1628.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06b83478");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:1628");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python27-python package based on the guidance in RHSA-2016:1628.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python27-python-2.7.8-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python27-python-debug-2.7.8-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python27-python-devel-2.7.8-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python27-python-libs-2.7.8-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python27-python-test-2.7.8-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python27-python-tools-2.7.8-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python27-tkinter-2.7.8-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python27-python-2.7.8-16.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python27-python-debug-2.7.8-16.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python27-python-devel-2.7.8-16.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python27-python-libs-2.7.8-16.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python27-python-test-2.7.8-16.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python27-python-tools-2.7.8-16.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python27-tkinter-2.7.8-16.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
