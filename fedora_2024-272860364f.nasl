...
# extracted from Fedora Security Advisory FEDORA-2024-272860364f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-272860364f");

  script_name(english:"Fedora 39 : tcpdump (2024-272860364f)");
...
FEDORA-2024-272860364f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-272860364f");
...
var pkgs = [
    {'reference':'tcpdump-4.99.4-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'}
];
