...
# extracted from Ubuntu Security Notice USN-3039-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3039-1");

  script_name(english:"Ubuntu 16.04 LTS : Django vulnerability (USN-3039-1)");
...
USN-3039-1 advisory.
    ...
    It was discovered that Django incorrectly handled the admin's add/change related popup. A remote attacker
    could possibly use this issue to perform a cross-site scripting attack.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3039-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-django', 'pkgver': '1.8.7-1ubuntu5.1'},
    {'osver': '16.04', 'pkgname': 'python-django-common', 'pkgver': '1.8.7-1ubuntu5.1'},
    {'osver': '16.04', 'pkgname': 'python3-django', 'pkgver': '1.8.7-1ubuntu5.1'}
];
