...
# extracted from Red Hat Security Advisory RHSA-2021:0788. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0788");
  script_xref(name:"IAVA", value:"2021-A-0091-S");

  script_name(english:"RHEL 8 : dotnet (RHSA-2021:0788)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:0788 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0788.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1ee2924");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0788");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dotnet-host-fxr-2.1-2.1.26-1.el8_3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-2.1-2.1.26-1.el8_3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-2.1-2.1.522-1.el8_3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-2.1.5xx-2.1.522-1.el8_3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
