...
if (description)
{
  ...
  script_cve_id("CVE-2017-6829");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-6829");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-6829");
