...
# extracted from VMware Security Advisory PHSA-2019-3.0-0025. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Patch PHSA-2019-3.0-0025");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the patch package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-25.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'patch-2.7.6-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'patch-debuginfo-2.7.6-4.ph3')) flag++;
