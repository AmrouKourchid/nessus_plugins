...
# extracted from Fedora Security Advisory FEDORA-2024-ed93e6d44f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ed93e6d44f");
  script_xref(name:"IAVB", value:"2024-B-0061-S");

  script_name(english:"Fedora 39 : wireshark (2024-ed93e6d44f)");
...
FEDORA-2024-ed93e6d44f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ed93e6d44f");
...
var pkgs = [
    {'reference':'wireshark-4.0.15-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
