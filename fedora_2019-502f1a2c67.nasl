...
# extracted from Fedora Security Advisory FEDORA-2019-502f1a2c67.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-502f1a2c67");

  script_name(english:"Fedora 31 : cobbler (2019-502f1a2c67)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Update to current release. Python3 compatible Installable with f31+
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-502f1a2c67");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"cobbler-3.0.1-1.fc31")) flag++;
