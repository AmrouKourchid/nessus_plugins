...
if (description)
{
  ...
  script_cve_id("CVE-2022-48766");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-48766");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Wrap
    dcn301_calculate_wm_and_dlg for FPU. Mirrors the logic for dcn30. Cue lots of WARNs and some kernel panics
    without this fix. (CVE-2022-48766)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-48766");
