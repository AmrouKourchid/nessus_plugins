...
# extracted from Oracle Linux Security Advisory ELSA-2022-4765.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : firefox (ELSA-2022-4765)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-4765.html");
...
var pkgs = [
    {'reference':'firefox-91.9.1-1.0.1.el9_0', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-91.9.1-1.0.1.el9_0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
