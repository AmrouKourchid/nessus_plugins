...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : tomcat (EulerOS-SA-2018-1415)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1415
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3e24fec");
...
pkgs = ["tomcat-7.0.76-8.h1",
        "tomcat-admin-webapps-7.0.76-8.h1",
        "tomcat-el-2.2-api-7.0.76-8.h1",
        "tomcat-jsp-2.2-api-7.0.76-8.h1",
        "tomcat-lib-7.0.76-8.h1",
        "tomcat-servlet-3.0-api-7.0.76-8.h1",
        "tomcat-webapps-7.0.76-8.h1"];
