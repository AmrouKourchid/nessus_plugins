...
# extracted from Red Hat Security Advisory helm. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-28131", "CVE-2022-30632", "CVE-2022-30633");

  script_name(english:"RHEL 9 : helm (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-30633");
