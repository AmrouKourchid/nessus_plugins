...
if (description)
{
  ...
  script_name(english:"MariaDB 5.5.0 < 5.5.38 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 5.5.38. It is, therefore, affected by multiple
vulnerabilities as referenced in the mariadb-5-5-38-release-notes advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mariadb-5-5-38-release-notes");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 5.5.38 or later.");
...
var constraints = [
  { 'min_version' : '5.5', 'fixed_version' : '5.5.38' }
];
