...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-0175.html");
...
var pkgs = [
    {'reference':'glibc-2.12-1.166.el6_7.7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glibc-common-2.12-1.166.el6_7.7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glibc-devel-2.12-1.166.el6_7.7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glibc-headers-2.12-1.166.el6_7.7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glibc-static-2.12-1.166.el6_7.7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glibc-utils-2.12-1.166.el6_7.7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nscd-2.12-1.166.el6_7.7', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glibc-2.12-1.166.el6_7.7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glibc-common-2.12-1.166.el6_7.7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glibc-devel-2.12-1.166.el6_7.7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glibc-headers-2.12-1.166.el6_7.7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glibc-static-2.12-1.166.el6_7.7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glibc-utils-2.12-1.166.el6_7.7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nscd-2.12-1.166.el6_7.7', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
