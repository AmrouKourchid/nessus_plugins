...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Icu PHSA-2020-3.0-0153");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'icu-67.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'icu-devel-67.1-1.ph3')) flag++;
