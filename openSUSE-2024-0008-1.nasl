...
# openSUSE Security Update openSUSE-SU-2024:0008-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : proftpd (openSUSE-SU-2024:0008-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote openSUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote openSUSE 15 host has packages installed that are affected by multiple vulnerabilities as referenced in the
openSUSE-SU-2024:0008-1 advisory.
  ...
  - make_ftp_cmd in main.c in ProFTPD before 1.3.8a has a one-byte out-of-bounds read, and daemon crash,
    because of mishandling of quote/backslash semantics. (CVE-2023-51713)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1218144");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1218344");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/L45IOOVVBSIBE7RRRVUWOWDGUABBZE4Q/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?61f4fa36");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-48795");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2023-51713");
...
var pkgs = [
    {'reference':'proftpd-1.3.8b-bp155.2.6.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-devel-1.3.8b-bp155.2.6.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-lang-1.3.8b-bp155.2.6.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-ldap-1.3.8b-bp155.2.6.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-mysql-1.3.8b-bp155.2.6.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-pgsql-1.3.8b-bp155.2.6.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-radius-1.3.8b-bp155.2.6.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'proftpd-sqlite-1.3.8b-bp155.2.6.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE}
];
