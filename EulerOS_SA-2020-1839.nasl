...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : ceph (EulerOS-SA-2020-1839)");
...
vulnerability :
  ...
  - An issue was discovered in Ceph through 13.2.9. A POST
    request with an invalid tagging XML can crash the RGW
    process by triggering a NULL pointer
    exception.(CVE-2020-12059)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1839
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c83bd2e5");
...
pkgs = ["librados2-12.2.8-1.h7.eulerosv2r8",
        "librbd1-12.2.8-1.h7.eulerosv2r8",
        "python-rados-12.2.8-1.h7.eulerosv2r8",
        "python-rbd-12.2.8-1.h7.eulerosv2r8"];
