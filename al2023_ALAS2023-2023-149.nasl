...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-149.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-23934");

  script_name(english:"Amazon Linux 2023 : python3-werkzeug (ALAS2023-2023-149)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2023-149 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-149.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2023-23934.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/faqs.html");
  script_set_attribute(attribute:"solution", value:
"Run 'dnf update python-werkzeug --releasever=2023.0.20230329' to update your system.");
...
var pkgs = [
    {'reference':'python3-werkzeug-1.0.1-5.amzn2023.0.4', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-werkzeug-doc-1.0.1-5.amzn2023.0.4', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
