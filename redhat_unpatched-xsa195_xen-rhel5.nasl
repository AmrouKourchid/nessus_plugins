...
# extracted from Red Hat Security Advisory xsa195_xen. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-9383");

  script_name(english:"RHEL 5 : xsa195_xen (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-9383");
