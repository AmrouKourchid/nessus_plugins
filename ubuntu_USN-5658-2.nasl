...
# extracted from Ubuntu Security Notice USN-5658-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5658-2");

  script_name(english:"Ubuntu 16.04 ESM : DHCP vulnerabilities (USN-5658-2)");
...
the USN-5658-2 advisory.

    USN-5658-1 fixed vulnerabilities in DHCP. This update provides the corresponding updates for Ubuntu 16.04
    ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5658-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'isc-dhcp-client', 'pkgver': '4.3.3-5ubuntu12.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'isc-dhcp-client-ddns', 'pkgver': '4.3.3-5ubuntu12.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'isc-dhcp-common', 'pkgver': '4.3.3-5ubuntu12.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'isc-dhcp-dev', 'pkgver': '4.3.3-5ubuntu12.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'isc-dhcp-relay', 'pkgver': '4.3.3-5ubuntu12.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'isc-dhcp-server', 'pkgver': '4.3.3-5ubuntu12.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'isc-dhcp-server-ldap', 'pkgver': '4.3.3-5ubuntu12.10+esm2', 'ubuntu_pro': TRUE}
];
