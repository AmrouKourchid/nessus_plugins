...
if (description)
{
  ...
  script_cve_id("CVE-2024-29161");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-29161");
...
patch available.
  ...
  - HDF5 through 1.14.3 contains a heap buffer overflow in H5A__attr_release_table, resulting in the
    corruption of the instruction pointer and causing denial of service or potential code execution.
    (CVE-2024-29161)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-29161");
