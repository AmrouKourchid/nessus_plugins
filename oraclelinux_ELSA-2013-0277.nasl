...
# Oracle Linux Security Advisory ELSA-2013-0277 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : dnsmasq (ELSA-2013-0277)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-0277.html");
