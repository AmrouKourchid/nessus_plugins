...
referenced in the RHSA-2021:2522 advisory.
    ...
    * Previously, systemtap dependencies were not included in the RHV-H channel. Therefore, systemtap could
    not be installed.
    In this release, the systemtap dependencies have been included in the channel, resolving the issue.
    (BZ#1903997)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2522.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e1f55cbf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2522");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1903997");
...
"Update the RHEL Red Hat Virtualization Host package based on the guidance in RHSA-2021:2522.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.4.6-20210615.0.el8_4', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
