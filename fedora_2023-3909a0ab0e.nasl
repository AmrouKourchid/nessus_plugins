...
# extracted from Fedora Security Advisory FEDORA-2023-3909a0ab0e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3909a0ab0e");

  script_name(english:"Fedora 39 : rdiff-backup (2023-3909a0ab0e)");
...
FEDORA-2023-3909a0ab0e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3909a0ab0e");
  script_set_attribute(attribute:"solution", value:
"Update the affected rdiff-backup package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-49797");
...
var pkgs = [
    {'reference':'rdiff-backup-2.2.6-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rdiff-backup');
}
