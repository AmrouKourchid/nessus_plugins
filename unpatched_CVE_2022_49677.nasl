...
if (description)
{
  ...
  script_cve_id("CVE-2022-49677");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49677");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ARM: cns3xxx: Fix refcount leak in
    cns3xxx_init of_find_compatible_node() returns a node pointer with refcount incremented, we should use
    of_node_put() on it when done. Add missing of_node_put() to avoid refcount leak. (CVE-2022-49677)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49677");
