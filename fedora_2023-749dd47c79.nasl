...
# extracted from Fedora Security Advisory FEDORA-2023-749dd47c79
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-749dd47c79");

  script_name(english:"Fedora 38 : python-cryptography (2023-749dd47c79)");
...
FEDORA-2023-749dd47c79 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-749dd47c79");
...
var pkgs = [
    {'reference':'python-cryptography-37.0.2-8.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
