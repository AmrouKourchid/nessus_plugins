...
if (description)
{
  ...
  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.12.9 (RHSA-2023:1408)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.12.9.");
...
in the RHSA-2023:1408 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.9. See the following
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1408.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9478625");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2150074");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/OCPBUGS-9977");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1408");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.12.9 packages based on the guidance in RHSA-2023:1408.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'conmon-rs-0.5.1-3.rhaos4.12.git.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'conmon-rs-0.5.1-3.rhaos4.12.git.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
