...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate - SMTP password ciphertext exposure in Log (FG-IR-22-455)");
...
"Please upgrade to FortiOS version 7.2.6, 7.4.0 or above.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:fortinet:fortigate");
...
var constraints = [
  { 'min_version' : '6.0', 'fixed_version' : '7.2.6', 'fixed_display' : '7.2.6 / 7.4.0' }
];
