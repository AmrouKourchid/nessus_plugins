...
# extracted from Fedora Security Advisory FEDORA-2023-1f11546a48
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1f11546a48");

  script_name(english:"Fedora 38 : youtube-dl (2023-1f11546a48)");
...
FEDORA-2023-1f11546a48 advisory.

    Update to latest upstream git snapshot.
    Various changes, including bug fix for cookie leak vulnerability.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1f11546a48");
  script_set_attribute(attribute:"solution", value:
"Update the affected youtube-dl package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:youtube-dl");
...
var pkgs = [
    {'reference':'youtube-dl-2023.08.04.git86e3cf5-1.20230815git86e3cf5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'youtube-dl');
}
