...
# extracted from Fedora Security Advisory FEDORA-2024-e77ad5f585
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e77ad5f585");
  script_xref(name:"IAVA", value:"2024-A-0550-S");

  script_name(english:"Fedora 39 : thunderbird (2024-e77ad5f585)");
...
FEDORA-2024-e77ad5f585 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e77ad5f585");
...
var pkgs = [
    {'reference':'thunderbird-115.15.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
