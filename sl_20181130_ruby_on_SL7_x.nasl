...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ruby on SL7.x x86_64 (20181130)");
...
"Security Fix(es) :
  ...
  - ruby: OpenSSL::X509::Name equality check does not work
    correctly (CVE-2018-16395)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1812&L=scientific-linux-errata&F=&S=&P=496
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cb375f0d");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ruby-2.0.0.648-34.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ruby-debuginfo-2.0.0.648-34.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ruby-devel-2.0.0.648-34.el7_6")) flag++;
if (rpm_check(release:"SL7", reference:"ruby-doc-2.0.0.648-34.el7_6")) flag++;
if (rpm_check(release:"SL7", reference:"ruby-irb-2.0.0.648-34.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ruby-libs-2.0.0.648-34.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ruby-tcltk-2.0.0.648-34.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"rubygem-bigdecimal-1.2.0-34.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"rubygem-io-console-0.4.2-34.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"rubygem-json-1.7.7-34.el7_6")) flag++;
if (rpm_check(release:"SL7", reference:"rubygem-minitest-4.3.2-34.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"rubygem-psych-2.0.0-34.el7_6")) flag++;
if (rpm_check(release:"SL7", reference:"rubygem-rake-0.9.6-34.el7_6")) flag++;
if (rpm_check(release:"SL7", reference:"rubygem-rdoc-4.0.0-34.el7_6")) flag++;
if (rpm_check(release:"SL7", reference:"rubygems-2.0.14.1-34.el7_6")) flag++;
if (rpm_check(release:"SL7", reference:"rubygems-devel-2.0.14.1-34.el7_6")) flag++;
