...
# extracted from Gentoo Linux Security Advisory GLSA 202107-13.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-13");

  script_name(english:"GLSA-202107-13 : GLib: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-13"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"dev-libs/glib", unaffected:make_list("ge 2.66.8"), vulnerable:make_list("lt 2.66.8"))) flag++;
