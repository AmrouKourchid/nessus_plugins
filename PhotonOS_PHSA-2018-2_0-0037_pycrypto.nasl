...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Pycrypto PHSA-2018-2.0-0037");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the pycrypto package has been released.");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'pycrypto-2.6.1-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'pycrypto-debuginfo-2.6.1-4.ph2')) flag++;
