...
FEDORA-2021-234d14bfcc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-234d14bfcc");
...
pkgs = [
    {'reference':'sudo-1.9.5p1-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
