...
# extracted from Debian Security Advisory dla-3082. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3082 : exim4 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3082
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3082-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Sylvain Beucler
    August 27, 2022                               https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------

    Package        : exim4
    Version        : 4.92-8+deb10u7
    CVE ID         : CVE-2022-37452

    It was discovered that in Exim, a mail transport agent, handling an
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-37452");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/exim4");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'exim4', 'reference': '4.92-8+deb10u7'},
    {'release': '10.0', 'prefix': 'exim4-base', 'reference': '4.92-8+deb10u7'},
    {'release': '10.0', 'prefix': 'exim4-config', 'reference': '4.92-8+deb10u7'},
    {'release': '10.0', 'prefix': 'exim4-daemon-heavy', 'reference': '4.92-8+deb10u7'},
    {'release': '10.0', 'prefix': 'exim4-daemon-light', 'reference': '4.92-8+deb10u7'},
    {'release': '10.0', 'prefix': 'exim4-dev', 'reference': '4.92-8+deb10u7'},
    {'release': '10.0', 'prefix': 'eximon4', 'reference': '4.92-8+deb10u7'}
];
