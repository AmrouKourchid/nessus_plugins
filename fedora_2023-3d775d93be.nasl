...
# extracted from Fedora Security Advisory FEDORA-2023-3d775d93be
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3d775d93be");

  script_name(english:"Fedora 36 : python-django3 (2023-3d775d93be)");
...
FEDORA-2023-3d775d93be advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3d775d93be");
...
"Update the affected python-django3 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-41323");
...
var pkgs = [
    {'reference':'python-django3-3.2.18-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
