...
"The version of Adobe Experience Manager installed on the remote host is prior to 6.5.10.0. It is, therefore, affected by
multiple vulnerabilities as referenced in the APSB21-82 advisory.
  ...
  - Adobe Bridge version 11.1.1 (and earlier) is affected by a memory corruption vulnerability due to insecure
    ...
    current user. User interaction is required to exploit this vulnerability. (CVE-2021-42725)
...
"Upgrade to Adobe Experience Manager version 6.5.10.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-42725");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-40714");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(20, 284, 79, 295);
