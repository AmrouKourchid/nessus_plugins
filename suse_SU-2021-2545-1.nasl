...
# SUSE update advisory SUSE-SU-2021:2545-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2545-1");

  script_name(english:"SUSE SLES12 Security Update : linuxptp (SUSE-SU-2021:2545-1)");
...
in the SUSE-SU-2021:2545-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-July/009224.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c40347c5");
...
var pkgs = [
    {'reference':'linuxptp-1.8+git65.g303b08c-3.3.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'linuxptp-1.8+git65.g303b08c-3.3.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
