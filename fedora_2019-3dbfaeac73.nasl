...
# extracted from Fedora Security Advisory FEDORA-2019-3dbfaeac73.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : kernel / kernel-headers (2019-3dbfaeac73)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-3dbfaeac73");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2019-3dbfaeac73");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC29", reference:"kernel-5.1.20-200.fc29")) flag++;
if (rpm_check(release:"FC29", reference:"kernel-headers-5.1.20-200.fc29")) flag++;
