...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5027215");
  script_xref(name:"MSFT", value:"MS23-5027215");
  script_xref(name:"IAVA", value:"2023-A-0305-S");
  script_xref(name:"IAVA", value:"2023-A-0306-S");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/03/21");

  script_name(english:"KB5027215: Windows 10 Version 21H2 / Windows 10 Version 22H2 Security Update (June 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5027215. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5027215");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5027215");
