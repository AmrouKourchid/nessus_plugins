...
if (description)
{
  ...
  script_cve_id("CVE-2019-3403");

  script_name(english:"Atlassian Jira 7.13.x < 7.13.3 / 8.0.x < 8.0.4 / 8.1.x < 8.1.1 Information Disclosure Vulnerability");
...
potentially affected by an information disclosure vulnerability in the /rest/api/2/user/picker rest resource due to
incorrect authorization checks. An unauthenticated, remote attacker can exploit this to enumerate usernames.
(CVE-2019-3403)");
  # https://jira.atlassian.com/browse/JRASERVER-69242
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9cfd6d45");
...
"Upgrade to Atlassian Jira version 7.13.3 / 8.1.1 / 8.2.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-3403");
