...
# extracted from Red Hat Security Advisory RHSA-2021:0966. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0966.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6dc805e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1933146");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pki-core:10.6 package based on the guidance in RHSA-2021:0966.");
  ...
  'pki-core:10.6': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'pki-base-10.9.4-3.module+el8.3.0+10353+73f6df5b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-base-java-10.9.4-3.module+el8.3.0+10353+73f6df5b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-ca-10.9.4-3.module+el8.3.0+10353+73f6df5b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-kra-10.9.4-3.module+el8.3.0+10353+73f6df5b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-server-10.9.4-3.module+el8.3.0+10353+73f6df5b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-symkey-10.9.4-3.module+el8.3.0+10353+73f6df5b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-tools-10.9.4-3.module+el8.3.0+10353+73f6df5b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-pki-10.9.4-3.module+el8.3.0+10353+73f6df5b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
