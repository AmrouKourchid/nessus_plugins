...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : gstreamer1-plugins-good (EulerOS-SA-2021-2219)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the gstreamer1-plugins-good package
installed, the EulerOS installation on the remote host is affected by
the following vulnerability :

  - GStreamer before 1.18.4 might access already-freed
    memory in error code paths when demuxing certain
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2219
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4a63c78c");
...
pkgs = ["gstreamer1-plugins-good-1.10.4-2.h1.eulerosv2r7"];
