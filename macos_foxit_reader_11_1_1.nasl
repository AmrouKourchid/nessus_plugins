...
if (description)
{
  ...
  script_name(english:"Foxit PDF Reader for Mac < 11.1.1 Multiple Vulnerabilities");
...
the remote macOS host is prior to 11.1.1. It is, therefore affected by multiple vulnerabilities:

  - An out-of-bounds read error exists in Foxit PDF Reader for Mac due to the application failing to validate
  ...
  - An out-of-bounds read error exists in Foxit PDF Reader for Mac due to the application failing to delete
...
"Upgrade to Foxit PDF Reader for Mac version 11.1.1 or later");
