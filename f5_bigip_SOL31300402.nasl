...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Virtual Machine Manager L1 Terminal Fault vulnerability (K31300402)");
...
side-channel attacks.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K31300402");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K31300402.");
