...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-189.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : microcode_ctl (ALAS2023-2023-189)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2023-189 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-189.html");
...
"Run 'dnf update microcode_ctl --releasever 2023.0.20230607' to update your system.");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-53.amzn2023.0.1', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
