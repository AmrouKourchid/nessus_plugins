...
# SUSE update advisory SUSE-SU-2021:3840-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:3840-1");

  script_name(english:"SUSE SLED15 / SLES15 Security Update : python-Pygments (SUSE-SU-2021:3840-1)");
...
referenced in the SUSE-SU-2021:3840-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-December/009782.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cd01d8d1");
...
var pkgs = [
    {'reference':'python3-Pygments-2.6.1-7.10.1', 'sp':'1', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
    {'reference':'python3-Pygments-2.6.1-7.10.1', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-ESPOS-release-1', 'sles-release-15.1']},
    {'reference':'python3-Pygments-2.6.1-7.10.1', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.1', 'sles-ltss-release-15.1']},
    {'reference':'python3-Pygments-2.6.1-7.10.1', 'sp':'2', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-basesystem-release-15.2']},
    {'reference':'python3-Pygments-2.6.1-7.10.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-basesystem-release-15.2']}
];
