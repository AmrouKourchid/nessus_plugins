...
# extracted from Oracle Linux Security Advisory ELSA-2022-5904.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : php (ELSA-2022-5904)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-5904.html");
