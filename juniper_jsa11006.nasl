...
self-reported version number.");
  # https://supportportal.juniper.net/s/article/2020-04-Security-Bulletin-Junos-OS-vMX-and-MX150-Denial-of-Service-vulnerability-in-packet-processing-CVE-2020-1627
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c45ce053");
...
var vuln_ranges = [
  {'min_ver':'18.1', 'fixed_ver':'18.1R3', 'model':'^(MX150|vMX)'},
  {'min_ver':'18.2', 'fixed_ver':'18.2R3', 'model':'^(MX150|vMX)'},
  {'min_ver':'18.2X75', 'fixed_ver':'18.2X75-D60', 'model':'^(MX150|vMX)'},
  {'min_ver':'18.3', 'fixed_ver':'18.3R3', 'model':'^(MX150|vMX)'},
  {'min_ver':'18.4', 'fixed_ver':'18.4R2', 'model':'^(MX150|vMX)'},
  {'min_ver':'19.1', 'fixed_ver':'19.1R2', 'model':'^(MX150|vMX)'}
];
