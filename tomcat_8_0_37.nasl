...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.0.0.RC1 < 8.0.37 multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 8.0.37. It is, therefore, affected by multiple
...
"Upgrade to Apache Tomcat version 8.0.37 or later.");
...
var constraints = [
  { 'min_version' : '8.0.0.RC1', 'max_version' : '8.0.36', 'fixed_version' : '8.0.37' }
];
