...
# extracted from Fedora Security Advisory FEDORA-2025-9cee4b3ac0
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-6918", "CVE-2023-48795");
  script_xref(name:"IAVA", value:"2023-A-0703");
  script_xref(name:"FEDORA", value:"2025-9cee4b3ac0");

  script_name(english:"Fedora 41 : libssh2 (2025-9cee4b3ac0)");
...
FEDORA-2025-9cee4b3ac0 advisory.
    ...
    It also removes support for a number of legacy algorithms that were disabled by default or removed from
    OpenSSH in the 2015-2018 time period. See the `RELEASE_NOTES` file for full details.

    In addition, there are a large number of bug fixes and enhancements, which again are described in the
    `RELEASE_NOTES` file.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-9cee4b3ac0");
...
var pkgs = [
    {'reference':'libssh2-1.11.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
