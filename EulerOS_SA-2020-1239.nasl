...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : glib2 (EulerOS-SA-2020-1239)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1239
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?df2af217");
...
pkgs = ["glib2-2.54.2-2.h2",
        "glib2-devel-2.54.2-2.h2"];
