...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Kubernetes PHSA-2021-1.0-0376");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'kubernetes-1.17.11-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'kubernetes-kubeadm-1.17.11-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'kubernetes-kubectl-extras-1.17.11-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'kubernetes-pause-1.17.11-3.ph1')) flag++;
