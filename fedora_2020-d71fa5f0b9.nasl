...
# extracted from Fedora Security Advisory FEDORA-2020-d71fa5f0b9.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : xen (2020-d71fa5f0b9)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-d71fa5f0b9");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"xen-4.14.0-12.fc33")) flag++;
