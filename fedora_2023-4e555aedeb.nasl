...
# extracted from Fedora Security Advisory FEDORA-2023-4e555aedeb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4e555aedeb");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/12/21");
  script_xref(name:"IAVA", value:"2023-A-0660-S");

  script_name(english:"Fedora 38 : chromium (2023-4e555aedeb)");
...
FEDORA-2023-4e555aedeb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4e555aedeb");
...
var pkgs = [
    {'reference':'chromium-119.0.6045.199-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
