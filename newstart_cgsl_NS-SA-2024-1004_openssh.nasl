...
# extracted from ZTE advisory NS-SA-2024-1004. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : openssh Vulnerability (NS-SA-2024-1004)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.06, has openssh packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2024-1004");
...
var pkgs = {
  'CGSL MAIN 6.06': [
    'openssh-8.5p1-3.zncgsl6.t1.8',
    'openssh-askpass-8.5p1-3.zncgsl6.t1.8',
    'openssh-clients-8.5p1-3.zncgsl6.t1.8',
    'openssh-server-8.5p1-3.zncgsl6.t1.8'
  ]
};
