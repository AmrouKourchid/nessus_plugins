...
# extracted from Fedora Security Advisory FEDORA-2024-146ef211bc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-146ef211bc");
  script_xref(name:"IAVB", value:"2024-B-0124-S");

  script_name(english:"Fedora 40 : ruby (2024-146ef211bc)");
...
FEDORA-2024-146ef211bc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-146ef211bc");
...
var pkgs = [
    {'reference':'ruby-3.3.5-14.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
