...
if (description)
{
  ...
  script_cve_id("CVE-2020-12604");

  script_name(english:"Photon OS 2.0: Envoy PHSA-2020-2.0-0265");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-12604");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'envoy-1.13.1-3.ph2')) flag++;
