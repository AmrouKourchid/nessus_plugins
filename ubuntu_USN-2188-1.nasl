...
# extracted from Ubuntu Security Notice USN-2188-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(66714);
  script_xref(name:"USN", value:"2188-1");

  script_name(english:"Ubuntu 14.04 LTS : elfutils vulnerability (USN-2188-1)");
...
USN-2188-1 advisory.
    ...
    Florian Weimer discovered that the elfutils libdw library incorrectly handled malformed compressed debug
    sections in ELF files. If a user or automated system were tricked into processing a specially crafted ELF
    file, applications linked against libdw could be made to crash, or possibly execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2188-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0172");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'elfutils', 'pkgver': '0.158-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'libasm-dev', 'pkgver': '0.158-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'libasm1', 'pkgver': '0.158-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'libdw-dev', 'pkgver': '0.158-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'libdw1', 'pkgver': '0.158-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'libelf-dev', 'pkgver': '0.158-0ubuntu5.1'},
    {'osver': '14.04', 'pkgname': 'libelf1', 'pkgver': '0.158-0ubuntu5.1'}
];
