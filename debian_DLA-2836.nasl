...
advisory.
    ...
    potentially the execution of arbitrary code. For Debian 9 stretch, this problem has been fixed in version
    2:3.26.2-1.1+deb9u3. We recommend that you upgrade your nss packages. For the detailed security status of
    nss please refer to its security tracker page at: https://security-tracker.debian.org/tracker/nss Further
