...
if (description)
{
  ...
  script_cve_id("CVE-2016-4020");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-4020");
...
patch available.
  ...
  - The patch_instruction function in hw/i386/kvmvapic.c in QEMU does not initialize the imm32 variable, which
    allows local guest OS administrators to obtain sensitive information from host stack memory by accessing
    the Task Priority Register (TPR). (CVE-2016-4020)
