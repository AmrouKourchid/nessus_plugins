...
# extracted from Red Hat Security Advisory eclipse-birt. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-0100");

  script_name(english:"RHEL 6 : eclipse-birt (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-0100");
