...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : cups (EulerOS-SA-2024-1646)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1646
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cb64e38a");
...
var pkgs = [
  "cups-1.6.3-35.h12.eulerosv2r7",
  "cups-client-1.6.3-35.h12.eulerosv2r7",
  "cups-devel-1.6.3-35.h12.eulerosv2r7",
  "cups-filesystem-1.6.3-35.h12.eulerosv2r7",
  "cups-libs-1.6.3-35.h12.eulerosv2r7",
  "cups-lpd-1.6.3-35.h12.eulerosv2r7"
];
