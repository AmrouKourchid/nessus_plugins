...
# extracted from Red Hat Security Advisory RHSA-2024:9093. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9093");

  script_name(english:"RHEL 9 : xorg-x11-server-Xwayland (RHSA-2024:9093)");
...
referenced in the RHSA-2024:9093 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-25083");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9093.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?31e9fffc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9093");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xorg-x11-server-Xwayland packages based on the guidance in RHSA-2024:9093.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xorg-x11-server-Xwayland-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-Xwayland-23.2.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xwayland-devel-23.2.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
