...
if (description)
{
  ...
  script_name(english:"Adobe InDesign < 18.5.3 / 19.0 < 19.4.0 Multiple Vulnerabilities (APSB24-48)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe InDesign instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe InDesign installed on the remote Windows host is prior to 18.5.3, 19.4.0. It is, therefore,
affected by multiple vulnerabilities as referenced in the APSB24-48 advisory.
...
var constraints = [
  { 'fixed_version' : '18.5.3', 'fixed_display' : 'ID18.5.3' },
