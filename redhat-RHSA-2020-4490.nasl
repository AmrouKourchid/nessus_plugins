...
# extracted from Red Hat Security Advisory RHSA-2020:4490. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4490");

  script_name(english:"RHEL 8 : gnupg2 (RHSA-2020:4490)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:4490 advisory.
    ...
    * GnuPG: interaction between the sks-keyserver code and GnuPG allows for a Certificate Spamming Attack
    which leads to persistent DoS (CVE-2019-13050)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4490.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?15310a95");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.3_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7e37d18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4490");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnupg2-2.2.20-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnupg2-smime-2.2.20-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
