...
# extracted from Red Hat Security Advisory RHSA-2020:1406. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1406");
  script_xref(name:"IAVA", value:"2020-A-0128-S");

  script_name(english:"RHEL 8 : firefox (RHSA-2020:1406)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1406.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06977a35");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1406");
...
"Update the RHEL firefox package based on the guidance in RHSA-2020:1406.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-68.7.0-2.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'firefox-68.7.0-2.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
