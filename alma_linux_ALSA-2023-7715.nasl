...
# AlmaLinux Security Advisory ALSA-2023:7715.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:7715");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/12/25");

  script_name(english:"AlmaLinux 9 : webkit2gtk3 (ALSA-2023:7715)");
...
ALSA-2023:7715 advisory.

  - A memory corruption vulnerability was addressed with improved locking. (CVE-2023-42917)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-7715.html");
