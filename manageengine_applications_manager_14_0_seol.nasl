...
if (description)
{
  ...
  script_name(english:"ManageEngine Applications Manager SEoL (14.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of ManageEngine Applications Manager is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, ManageEngine Applications Manager is 14.0.x. It is, therefore, no longer maintained by its
vendor or provider.
