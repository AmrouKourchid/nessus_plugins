...
# extracted from Red Hat Security Advisory RHSA-2019:1208. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1208");
  script_xref(name:"IAVA", value:"2019-A-0166");
  script_xref(name:"CEA-ID", value:"CEA-2019-0547");
  script_xref(name:"CEA-ID", value:"CEA-2019-0324");

  script_name(english:"RHEL 7 : rhvm-appliance (RHSA-2019:1208)");
...
referenced in the RHSA-2019:1208 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1208.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b95c23d3");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1208");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rhvm-appliance package based on the guidance in RHSA-2019:1208.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhvm-appliance-4.3-20190506.0.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ovirt-'}
    ]
  }
];
