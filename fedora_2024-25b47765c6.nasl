...
# extracted from Fedora Security Advisory FEDORA-2024-25b47765c6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-25b47765c6");

  script_name(english:"Fedora 39 : kitty (2024-25b47765c6)");
...
FEDORA-2024-25b47765c6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-25b47765c6");
...
"Update the affected kitty package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-36308");
...
var pkgs = [
    {'reference':'kitty-0.31.0-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
