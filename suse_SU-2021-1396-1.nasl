...
# extracted from SUSE update advisory SUSE-SU-2021:1396-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : curl (SUSE-SU-2021:1396-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf6125f0");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"curl-7.60.0-11.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"curl-debuginfo-7.60.0-11.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"curl-debugsource-7.60.0-11.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libcurl4-32bit-7.60.0-11.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libcurl4-7.60.0-11.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libcurl4-debuginfo-32bit-7.60.0-11.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libcurl4-debuginfo-7.60.0-11.15.1")) flag++;
