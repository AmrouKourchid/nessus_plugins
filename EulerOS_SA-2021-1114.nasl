...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : python (EulerOS-SA-2021-1114)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1114
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73a19b07");
...
pkgs = ["python-2.7.5-58.h29",
        "python-devel-2.7.5-58.h29",
        "python-libs-2.7.5-58.h29",
        "tkinter-2.7.5-58.h29"];
