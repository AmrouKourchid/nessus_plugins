...
# extracted from Fedora Security Advisory FEDORA-2024-75863445ff
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-75863445ff");

  script_name(english:"Fedora 40 : libcoap (2024-75863445ff)");
...
FEDORA-2024-75863445ff advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-75863445ff");
...
var pkgs = [
    {'reference':'libcoap-4.3.4a-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
