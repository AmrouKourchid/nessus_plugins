...
# extracted from Fedora Security Advisory FEDORA-2023-275c12e496
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-275c12e496");

  script_name(english:"Fedora 37 : composer (2023-275c12e496)");
...
FEDORA-2023-275c12e496 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-275c12e496");
...
var pkgs = [
    {'reference':'composer-2.6.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
