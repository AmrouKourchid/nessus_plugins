...
# extracted from Red Hat Security Advisory RHSA-2024:0420. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0420");

  script_name(english:"RHEL 8 : freetype (RHSA-2024:0420)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for freetype.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:0420 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0420.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a69553e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0420");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL freetype package based on the guidance in RHSA-2024:0420.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freetype-2.9.1-5.el8_6.3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-devel-2.9.1-5.el8_6.3', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
