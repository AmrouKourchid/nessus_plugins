...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : net-snmp (EulerOS-SA-2021-1501)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1501
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?74a18e94");
...
pkgs = ["net-snmp-5.7.2-33.2.h6.eulerosv2r7",
        "net-snmp-agent-libs-5.7.2-33.2.h6.eulerosv2r7",
        "net-snmp-devel-5.7.2-33.2.h6.eulerosv2r7",
        "net-snmp-libs-5.7.2-33.2.h6.eulerosv2r7",
        "net-snmp-utils-5.7.2-33.2.h6.eulerosv2r7"];
