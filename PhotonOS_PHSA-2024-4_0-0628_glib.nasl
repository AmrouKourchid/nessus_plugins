...
# extracted from VMware Security Advisory PHSA-2024-4.0-0628. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Glib PHSA-2024-4.0-0628");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the glib package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-628.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'glib-2.68.4-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'glib-devel-2.68.4-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', reference:'glib-doc-2.68.4-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'glib-schemas-2.68.4-2.ph4')) flag++;
