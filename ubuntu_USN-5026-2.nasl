...
# extracted from Ubuntu Security Notice USN-5026-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5026-2");

  script_name(english:"Ubuntu 16.04 ESM : QPDF vulnerabilities (USN-5026-2)");
...
the USN-5026-2 advisory.

    USN-5026-1 fixed several vulnerabilities in QPDF. This update provides the corresponding update for Ubuntu
    16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5026-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libqpdf-dev', 'pkgver': '8.0.2-3~16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libqpdf21', 'pkgver': '8.0.2-3~16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'qpdf', 'pkgver': '8.0.2-3~16.04.1+esm1', 'ubuntu_pro': TRUE}
];
