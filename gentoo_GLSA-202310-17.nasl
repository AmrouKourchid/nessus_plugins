...
# extracted from Gentoo Linux Security Advisory GLSA 202310-17.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202310-17 : UnZip: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202310-17 (UnZip: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202310-17");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=831190");
...
var packages = [
  {
    'name' : 'app-arch/unzip',
    'unaffected' : make_list("ge 6.0_p27"),
    'vulnerable' : make_list("lt 6.0_p27")
  }
];
