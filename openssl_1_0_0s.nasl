...
"The version of OpenSSL installed on the remote host is prior to 1.0.0s. It is, therefore, affected by multiple
vulnerabilities as referenced in the 1.0.0s advisory.
...
"Upgrade to OpenSSL version 1.0.0s or later.");
...
var constraints = [
  { 'min_version' : '1.0.0', 'fixed_version' : '1.0.0s' }
];
