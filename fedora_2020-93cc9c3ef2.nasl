...
# extracted from Fedora Security Advisory FEDORA-2020-93cc9c3ef2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : 1:java-11-openjdk (2020-93cc9c3ef2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-93cc9c3ef2");
  script_set_attribute(attribute:"see_also", value:"https://bugs.openjdk.java.net/browse/JDK-8240191");
  script_set_attribute(attribute:"see_also", value:"https://bugs.openjdk.java.net/browse/JDK-8242147");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugs.openjdk.java.net/browse/JDK-8245077");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"java-11-openjdk-11.0.8.10-2.fc31", epoch:"1")) flag++;
