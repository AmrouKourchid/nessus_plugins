...
# extracted from Red Hat Security Advisory RHSA-2024:0143. The text
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6461b164");
...
"Update the RHEL idm:DL1 package based on the guidance in RHSA-2024:0143.");
  ...
  'idm:DL1': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'ipa-client-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-common-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-epn-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-client-samba-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-common-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'ipa-python-compat-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-selinux-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-common-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-dns-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ipa-server-trust-ad-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python3-ipaclient-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipalib-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipaserver-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-ipatests-4.9.12-11.module+el8.9.0+20824+f2605038', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'slapi-nis-0.60.0-4.module+el8.9.0+20420+fef9eb45', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
