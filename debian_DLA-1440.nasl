...
# extracted from Debian Security Advisory DLA-1440-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1440-1 : libarchive-zip-perl security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/07/msg00032.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/libarchive-zip-perl");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected libarchive-zip-perl package.");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libarchive-zip-perl", reference:"1.39-1+deb8u1")) flag++;
