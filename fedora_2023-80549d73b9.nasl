...
# extracted from Fedora Security Advisory FEDORA-2023-80549d73b9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-80549d73b9");
  script_xref(name:"IAVA", value:"2023-A-0449-S");
  script_xref(name:"IAVA", value:"2023-A-0585-S");

  script_name(english:"Fedora 37 : firefox (2023-80549d73b9)");
...
FEDORA-2023-80549d73b9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-80549d73b9");
...
var pkgs = [
    {'reference':'firefox-117.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
