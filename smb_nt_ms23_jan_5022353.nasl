...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5022340");
  script_xref(name:"MSKB", value:"5022353");
  script_xref(name:"MSFT", value:"MS23-5022340");
  script_xref(name:"MSFT", value:"MS23-5022353");
  script_xref(name:"IAVA", value:"2023-A-0025-S");
  script_xref(name:"IAVA", value:"2023-A-0027-S");

  script_name(english:"KB5022353: Windows Server 2008 Security Update (January 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5022353. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5022340");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5022353");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5022353 or Cumulative Update 5022340");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'01_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5022353, 5022340])
)
{
