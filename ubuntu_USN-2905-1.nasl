...
# extracted from Ubuntu Security Notice USN-2905-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2905-1");

  script_name(english:"Ubuntu 14.04 LTS : Oxide vulnerability (USN-2905-1)");
...
USN-2905-1 advisory.
    ...
    A security issue was discovered in Chromium. If a user were tricked in to opening a specially crafted
    website, an attacker could potentially exploit this to bypass same-origin restrictions or a sandbox
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2905-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'liboxideqt-qmlplugin', 'pkgver': '1.12.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'liboxideqtcore0', 'pkgver': '1.12.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'liboxideqtquick0', 'pkgver': '1.12.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'oxideqmlscene', 'pkgver': '1.12.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'oxideqt-chromedriver', 'pkgver': '1.12.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'oxideqt-codecs', 'pkgver': '1.12.7-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'oxideqt-codecs-extra', 'pkgver': '1.12.7-0ubuntu0.14.04.1'}
];
