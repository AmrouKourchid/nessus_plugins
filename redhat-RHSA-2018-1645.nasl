...
# extracted from Red Hat Security Advisory RHSA-2018:1645. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1645");

  script_name(english:"RHEL 7 : qemu-kvm-rhev (RHSA-2018:1645)");
...
referenced in the RHSA-2018:1645 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_1645.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2318e6f1");
...
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2018:1645.");
