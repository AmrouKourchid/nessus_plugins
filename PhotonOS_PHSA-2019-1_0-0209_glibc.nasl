...
if (description)
{
  ...
  script_bugtraq_id(106037);

  script_name(english:"Photon OS 1.0: Glibc PHSA-2019-1.0-0209");
...
if (rpm_exists(rpm:"glibc-2.22", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"glibc-2.22-24.ph1")) flag++;
if (rpm_exists(rpm:"glibc-2.22", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"src", reference:"glibc-2.22-24.ph1.src")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"glibc-devel-2.22-24.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"glibc-lang-2.22-24.ph1")) flag++;
