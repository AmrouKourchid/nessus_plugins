...
# extracted from Fedora Security Advisory FEDORA-2024-c07e065747
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-8508", "CVE-2024-43167");
  script_xref(name:"FEDORA", value:"2024-c07e065747");
  script_xref(name:"IAVA", value:"2024-A-0682");

  script_name(english:"Fedora 40 : unbound (2024-c07e065747)");
...
FEDORA-2024-c07e065747 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c07e065747");
...
var pkgs = [
    {'reference':'unbound-1.21.1-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
