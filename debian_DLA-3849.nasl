...
# extracted from Debian Security Advisory dla-3849. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3849 : emacs - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3849
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'emacs', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs-bin-common', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs-common', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs-el', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs-gtk', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs-lucid', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs-nox', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs21', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs21-nox', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs22', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs22-gtk', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs22-nox', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs23', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs23-lucid', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs23-nox', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs24', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs24-lucid', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs24-nox', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs25', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs25-lucid', 'reference': '1:26.1+1-3.2+deb10u6'},
    {'release': '10.0', 'prefix': 'emacs25-nox', 'reference': '1:26.1+1-3.2+deb10u6'}
];
