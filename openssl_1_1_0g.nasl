...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.1.0 < 1.1.0g Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.1.0g. It is, therefore, affected by multiple
vulnerabilities as referenced in the 1.1.0g advisory.
...
number.");
  # https://git.openssl.org/gitweb/?p=openssl.git;a=commitdiff;h=4443cf7aa0099e5ce615c18cee249fff77fb0871
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12a020d4");
  # https://git.openssl.org/gitweb/?p=openssl.git;a=commitdiff;h=068b963bb7afc57f5bdd723de0dd15e7795d5822
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?95da70e7");
...
var constraints = [
  { 'min_version' : '1.1.0', 'fixed_version' : '1.1.0g' }
];
