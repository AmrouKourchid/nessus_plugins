...
if (description)
{
  ...
  script_cve_id("CVE-2014-1236");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-1236");
...
patch available.
  ...
  - Stack-based buffer overflow in the chkNum function in lib/cgraph/scan.l in Graphviz 2.34.0 allows remote
    attackers to have unspecified impact via vectors related to a badly formed number and a long digit
    list. (CVE-2014-1236)
