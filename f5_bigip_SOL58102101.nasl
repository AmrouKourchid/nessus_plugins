...
profile with parameter parsing (enabled by default) are affected.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K58102101");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K58102101.");
...
var vmatrix = {
  'ASM': {
    'affected': [
      '16.0.0','15.0.0-15.1.0','14.1.0-14.1.3','13.1.0-13.1.3','12.1.0-12.1.5','11.6.1-11.6.5'
    ],
    'unaffected': [
