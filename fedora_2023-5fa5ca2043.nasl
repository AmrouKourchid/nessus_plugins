...
# extracted from Fedora Security Advisory FEDORA-2023-5fa5ca2043
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5fa5ca2043");
  script_xref(name:"IAVA", value:"2023-A-0517-S");

  script_name(english:"Fedora 37 : libssh (2023-5fa5ca2043)");
...
FEDORA-2023-5fa5ca2043 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5fa5ca2043");
...
var pkgs = [
    {'reference':'libssh-0.10.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
