...
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2023-081 advisory.
    ...
    function and a bad patch of the libmagic library. This flaw allows an attacker or malicious actor to
    execute a heap buffer overflow successfully, causing a memory crash. (CVE-2022-31627)
