...
"The remote Red Hat host is missing a security update for lldpad.");
...
the RHSA-2019:3673 advisory.

    The lldpad packages provide the Linux user space daemon and configuration tool for Intel's Link Layer
    Discovery Protocol (LLDP) Agent with Enhanced Ethernet support.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3673.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52c0cdcd");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.1_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8d3b26b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3673");
...
"Update the RHEL lldpad package based on the guidance in RHSA-2019:3673.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lldpad-1.0.1-13.git036e314.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
