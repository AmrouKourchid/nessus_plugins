...
# extracted from Oracle Linux Security Advisory ELSA-2023-3423.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : cups-filters (ELSA-2023-3423)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-3423.html");
...
var pkgs = [
    {'reference':'cups-filters-1.28.7-11.0.1.el9_2.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-devel-1.28.7-11.0.1.el9_2.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-libs-1.28.7-11.0.1.el9_2.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-devel-1.28.7-11.0.1.el9_2.1', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-libs-1.28.7-11.0.1.el9_2.1', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-1.28.7-11.0.1.el9_2.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-devel-1.28.7-11.0.1.el9_2.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-libs-1.28.7-11.0.1.el9_2.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
