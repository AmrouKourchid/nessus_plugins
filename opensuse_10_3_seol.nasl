...
if (description)
{
  ...
  script_name(english:"openSUSE SEoL (10.3.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of openSUSE is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, openSUSE is 10.3.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of openSUSE that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2009/10/31");
...
var constraints = [
  { max_branch : '10.3', min_branch : '10.3', seol : 20091031 }
];
