...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : openldap (EulerOS-SA-2019-1914)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1914
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?653b5b71");
...
"Update the affected openldap package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-13057");
...
pkgs = ["openldap-2.4.44-15.h6.eulerosv2r7",
        "openldap-clients-2.4.44-15.h6.eulerosv2r7",
        "openldap-devel-2.4.44-15.h6.eulerosv2r7",
        "openldap-servers-2.4.44-15.h6.eulerosv2r7"];
