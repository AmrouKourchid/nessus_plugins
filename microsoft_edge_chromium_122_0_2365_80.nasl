...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2024-A-0143-S");
  script_xref(name:"IAVA", value:"2024-A-0173-S");

  script_name(english:"Microsoft Edge (Chromium) < 122.0.2365.80 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an web browser installed that is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft Edge installed on the remote Windows host is prior to 122.0.2365.80. It is, therefore, affected
by multiple vulnerabilities as referenced in the March 7, 2024 advisory.
...
number.");
  # https://docs.microsoft.com/en-us/DeployEdge/microsoft-edge-relnotes-security#march-7-2024
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2bc92dd5");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-2173");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-2174");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-2176");
