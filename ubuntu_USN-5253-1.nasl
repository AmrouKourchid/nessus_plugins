...
# extracted from Ubuntu Security Notice USN-5253-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5253-1");

  script_name(english:"Ubuntu 16.04 ESM / 18.04 ESM / 20.04 ESM : Rack vulnerabilities (USN-5253-1)");
...
vulnerabilities as referenced in the USN-5253-1 advisory.

    It was discovered that Rack insecurely handled session ids. An unauthenticated remote attacker could
    possibly use this issue to perform a timing attack and hijack sessions. (CVE-2019-16782)

    It was discovered that Rack was incorrectly handling cookies during parsing, not validating them or
    performing the necessary integrity checks. An attacker could possibly use this issue to overwrite existing
    cookie data and gain control over a remote system's behaviour. This issue only affected Ubuntu 14.04 ESM.
    (CVE-2020-8184)
    ...
    application using Rack, a remote attacker could possibly use this issue to cause a denial of service. This
    issue was only fixed in Ubuntu 14.04 ESM and Ubuntu 16.04 ESM. (CVE-2022-30122)
    ...
    possibly use this issue to execute arbitrary code in the machine running the application. This issue was
    only fixed in Ubuntu 14.04 ESM and Ubuntu 16.04 ESM. (CVE-2022-30123)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5253-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ruby-rack', 'pkgver': '1.6.4-3ubuntu0.2+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'ruby-rack', 'pkgver': '1.6.4-4ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'ruby-rack', 'pkgver': '2.0.7-2ubuntu0.1+esm1', 'ubuntu_pro': TRUE}
];
