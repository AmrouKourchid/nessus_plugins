...
if (description)
{
  ...
  script_cve_id("CVE-2018-16999");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-16999");
...
patch available.
  ...
  - Netwide Assembler (NASM) 2.14rc15 has an invalid memory write (segmentation fault) in expand_smacro in
    preproc.c, which allows attackers to cause a denial of service via a crafted input file. (CVE-2018-16999)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-16999");
