...
# extracted from Red Hat Security Advisory RHSA-2018:2949. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2949");

  script_name(english:"RHEL 7 : rh-nodejs8-nodejs (RHSA-2018:2949)");
...
referenced in the RHSA-2018:2949 advisory.

    Node.js is a software development platform for building fast and scalable network applications in the
    JavaScript programming language.

    The following packages have been upgraded to a later upstream version: rh-nodejs8-nodejs (8.11.4).
    (BZ#1621761)
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2949.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2cb0daf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2949");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-nodejs8-nodejs package based on the guidance in RHSA-2018:2949.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs8-nodejs-8.11.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs8-nodejs-devel-8.11.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs8-nodejs-docs-8.11.4-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs8-npm-5.6.0-8.11.4.1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
