...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : shim (EulerOS-SA-2024-1497)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1497
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?de11f332");
...
var pkgs = [
  "shim-15-19.h21.eulerosv2r9",
  "shim-aa64-storage-15-19.h21.eulerosv2r9"
];
