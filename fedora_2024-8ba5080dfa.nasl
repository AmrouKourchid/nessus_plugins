...
# extracted from Fedora Security Advisory FEDORA-2024-8ba5080dfa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8ba5080dfa");

  script_name(english:"Fedora 39 : nginx / nginx-mod-fancyindex / nginx-mod-modsecurity / etc (2024-8ba5080dfa)");
...
FEDORA-2024-8ba5080dfa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8ba5080dfa");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2024/08/17");
...
var pkgs = [
    {'reference':'nginx-1.26.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'nginx-mod-fancyindex-0.5.2-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nginx-mod-modsecurity-1.0.3-13.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nginx-mod-naxsi-1.6-6.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nginx-mod-vts-0.2.2-9.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
