...
# extracted from Debian Security Advisory dla-3330. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3330 : amanda-client - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3330
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3330-1                debian-lts@lists.debian.org
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-37704");
...
"Upgrade the amanda-client packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-37704");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'amanda-client', 'reference': '1:3.5.1-2+deb10u1'},
    {'release': '10.0', 'prefix': 'amanda-common', 'reference': '1:3.5.1-2+deb10u1'},
    {'release': '10.0', 'prefix': 'amanda-server', 'reference': '1:3.5.1-2+deb10u1'}
];
