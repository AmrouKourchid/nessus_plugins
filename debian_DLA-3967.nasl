...
# extracted from Debian Security Advisory dla-3967. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3967 : libmpg123-0 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-3967
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/mpg123");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-10573");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/mpg123");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libmpg123-0 packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libout123-0");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libsyn123-0");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libmpg123-0', 'reference': '1.26.4-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libmpg123-dev', 'reference': '1.26.4-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libout123-0', 'reference': '1.26.4-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libsyn123-0', 'reference': '1.26.4-1+deb11u1'},
    {'release': '11.0', 'prefix': 'mpg123', 'reference': '1.26.4-1+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libmpg123-0 / libmpg123-dev / libout123-0 / libsyn123-0 / mpg123');
}
