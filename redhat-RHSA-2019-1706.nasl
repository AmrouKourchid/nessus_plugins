...
# extracted from Red Hat Security Advisory RHSA-2019:1706. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1706");

  script_name(english:"RHEL 7 / 8 : ansible (RHSA-2019:1706)");
...
in the RHSA-2019:1706 advisory.
    ...
    * ansible: unsafe template evaluation of returned module data can lead to information disclosure
    ...
    See: https://github.com/ansible/ansible/blob/v2.8.2/changelogs/CHANGELOG-v2.8.rst for details on bug fixes
    in this release.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c022613");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1706.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e7e29766");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1706");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1717311");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ansible package based on the guidance in RHSA-2019:1706.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-10156");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.8.2-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-2.8.2-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2'}
    ]
  }
];
