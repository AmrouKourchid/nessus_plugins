...
# extracted from Gentoo Linux Security Advisory GLSA 201908-23.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2019-12874", "CVE-2019-5439");
  script_xref(name:"GLSA", value:"201908-23");
  script_xref(name:"CEA-ID", value:"CEA-2019-0487");

  script_name(english:"GLSA-201908-23 : VLC: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201908-23
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201908-23");
...
if (qpkg_check(package:"media-video/vlc", unaffected:make_list("ge 3.0.7"), vulnerable:make_list("lt 3.0.7"))) flag++;
