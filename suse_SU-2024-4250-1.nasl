...
# SUSE update advisory SUSE-SU-2024:4250-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:4250-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 48 for SLE 15 SP2) (SUSE-SU-2024:4250-1)");
...
the SUSE-SU-2024:4250-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1227472");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-December/019952.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?122ab6ec");
...
"Update the affected kernel-livepatch-5_3_18-150200_24_191-default package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-35864");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150200.24.191-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150200_24_191-default-8-150200.5.6.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150200_24_191-default');
}
