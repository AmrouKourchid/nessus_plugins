...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : X.Org X Server vulnerabilities (USN-4656-1)");
...
vulnerabilities as referenced in the USN-4656-1 advisory.

    Jan-Niklas Sohn discovered that the X.Org X Server XKB extension incorrectly handled certain inputs. A
