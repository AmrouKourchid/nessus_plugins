...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2021-A-0591-S");

  script_name(english:"Adobe Media Encoder < 15.4.3 / 22.0.0 < 22.1.1 Multiple Vulnerabilities (APSB21-118)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Media Encoder instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Media Encoder installed on the remote Windows host is prior to 15.4.3, 22.1.1. It is, therefore,
