...
# extracted from Red Hat Security Advisory RHSA-2018:1099. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1099");

  script_name(english:"RHEL 7 : firefox (RHSA-2018:1099)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1099.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f12b172");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2018-10/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1099");
...
"Update the RHEL firefox package based on the guidance in RHSA-2018:1099.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-52.7.3-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
