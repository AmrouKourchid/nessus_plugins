...
referenced in the RHSA-2012:0475 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_0475.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b26d4815");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:0475");
...
"Update the RHEL tomcat6 package based on the guidance in RHSA-2012:0475.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tomcat6-6.0.24-36.el6_2', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-admin-webapps-6.0.24-36.el6_2', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-docs-webapp-6.0.24-36.el6_2', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-el-2.1-api-6.0.24-36.el6_2', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-javadoc-6.0.24-36.el6_2', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-jsp-2.1-api-6.0.24-36.el6_2', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-lib-6.0.24-36.el6_2', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-servlet-2.5-api-6.0.24-36.el6_2', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-webapps-6.0.24-36.el6_2', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
