...
# SUSE update advisory SUSE-SU-2022:1268-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:1268-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 25 for SLE 12 SP4) (SUSE-SU-2022:1268-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-April/010772.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c292b1d");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-95_93-default-2-2.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
];
