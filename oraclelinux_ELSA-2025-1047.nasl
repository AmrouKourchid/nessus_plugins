...
# extracted from Oracle Linux Security Advisory ELSA-2025-1047.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : libsoup (ELSA-2025-1047)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2025-1047 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-1047.html");
...
var pkgs = [
    {'reference':'libsoup-2.62.2-2.0.3.el7', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libsoup-devel-2.62.2-2.0.3.el7', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libsoup-2.62.2-2.0.3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libsoup-devel-2.62.2-2.0.3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
