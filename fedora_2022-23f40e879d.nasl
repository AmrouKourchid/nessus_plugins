...
# extracted from Fedora Security Advisory FEDORA-2022-23f40e879d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-23f40e879d");

  script_name(english:"Fedora 38 : pcs (2022-23f40e879d)");
...
FEDORA-2022-23f40e879d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-23f40e879d");
...
var pkgs = [
    {'reference':'pcs-0.11.3-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
