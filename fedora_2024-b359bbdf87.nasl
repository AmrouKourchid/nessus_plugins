...
# extracted from Fedora Security Advisory FEDORA-2024-b359bbdf87
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b359bbdf87");

  script_name(english:"Fedora 39 : dnsmasq (2024-b359bbdf87)");
...
FEDORA-2024-b359bbdf87 advisory.

    Change initial configuration to use ``local-service=host`` for initial listening on localhost. It auto-
    disables itself as soon as other explicit interface or listen-address is configured.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b359bbdf87");
...
var pkgs = [
    {'reference':'dnsmasq-2.89-7.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
