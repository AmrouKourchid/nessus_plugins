...
# extracted from Red Hat Security Advisory RHSA-2022:7643. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7643");

  script_name(english:"RHEL 8 : bind9.16 (RHSA-2022:7643)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for bind9.16.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:7643 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7643.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ccc5b7a0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7643");
...
"Update the RHEL bind9.16 package based on the guidance in RHSA-2022:7643.");
