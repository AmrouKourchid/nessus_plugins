...
if (description)
{
  ...
  script_cve_id("CVE-2024-25156");

  script_name(english:"Fortra GoAnywhere Managed File Transfer (MFT) < 7.4.2 Path Traversal (CVE-2024-25156)");

  script_set_attribute(attribute:"synopsis", value:
"A web application running on the remote server is affected by an Path Traversal vulnerability.");
...
remote web server is < 7.4.2. It is, therefore, affected by an Path Traversal vulnerability. This can allow an
unauthenticated attacker to create an admin user via the administration portal.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://www.fortra.com/security/advisories/product-security/fi-2024-004
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98ed3014");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Fortra GoAnywhere Managed File Transfer (MFT) 7.4.2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-25156");
...
var constraints = [
  { 'min_version': '6.0.1', 'fixed_version':'7.4.2'}
];
