...
if (description)
{
  ...
  script_name(english:"Oracle Siebel Server <= 21.1 (April 2021 CPU)");
...
April 2021 CPU advisory.
  ...
  - Vulnerability in the Siebel Engineering - Installer and Deployment product of Oracle Siebel CRM
    (component: Siebel Approval Manager (Spring Framework)). Supported versions that are affected are 21.1 and
    prior. Difficult to exploit vulnerability allows unauthenticated attacker with network access via HTTP to
    ...
    Siebel Engineering - Installer and Deployment. (CVE-2020-5398)
...
var constraints = [
  { 'max_version' : '21.1.999', 'fixed_version' : '21.3' }
];
