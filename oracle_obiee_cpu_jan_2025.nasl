...
if (description)
{
  ...
  script_name(english:"Oracle Business Intelligence Enterprise Edition (January 2025 CPU)");
...
multiple vulnerabilities as referenced in the January 2025 CPU advisory, including the following:

  - Vulnerability in the Oracle Business Intelligence Enterprise Edition product of Oracle Analytics 
    (component: Analytics Server (Apache Commons FileUpload)). The supported version that is affected is 
    ...
    Business Intelligence Enterprise Edition. (CVE-2023-24998)
...
var constraints = [
  {'min_version': '12.2.1.4', 'fixed_version': '12.2.1.4.241230', 'fixed_display': '12.2.1.4.241230 patch: 37432843'}
];
