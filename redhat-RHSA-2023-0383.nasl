...
# extracted from Red Hat Security Advisory RHSA-2023:0383. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0383");

  script_name(english:"RHEL 9 : libXpm (RHSA-2023:0383)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libXpm.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:0383 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0383.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72c31fdb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0383");
...
"Update the RHEL libXpm package based on the guidance in RHSA-2023:0383.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libXpm-3.5.13-8.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libXpm-devel-3.5.13-8.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
