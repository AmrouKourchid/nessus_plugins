...
# extracted from Red Hat Security Advisory RHSA-2024:0213. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0213");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (python-eventlet) (RHSA-2024:0213)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0213.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f72bdf1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0213");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2244717");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1 (python-eventlet) package based on the guidance in RHSA-2024:0213.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-eventlet-0.30.2-4.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
