...
# extracted from Debian Security Advisory DLA-1408-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1408-1 : simplesamlphp security update");
...
CVE-2017-12868 was a about an improper fix of CVE-2017-12872
in the initial patch released by upstream. We have used the
correct patch.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/06/msg00017.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/simplesamlphp");
...
"Upgrade the affected simplesamlphp package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-12868");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"simplesamlphp", reference:"1.13.1-2+deb8u2")) flag++;
