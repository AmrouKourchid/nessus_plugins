...
# extracted from Ubuntu Security Notice USN-3526-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : SSSD vulnerability (USN-3526-1)");
...
USN-3526-1 advisory.
    ...
    It was discovered that SSSD incorrectly handled certain inputs when querying its local cache. An attacker
    could use this to inject arbitrary code and expose sensitive information.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3526-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libipa-hbac-dev', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'libipa-hbac0', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'libnss-sss', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'libpam-sss', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'libsss-idmap-dev', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'libsss-idmap0', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'libsss-nss-idmap-dev', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'libsss-nss-idmap0', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'libsss-simpleifp-dev', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'libsss-simpleifp0', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'libsss-sudo', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'libwbclient-sssd', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'libwbclient-sssd-dev', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'python-libipa-hbac', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'python-libsss-nss-idmap', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'python-sss', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'python3-libipa-hbac', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'python3-libsss-nss-idmap', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'python3-sss', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'sssd', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'sssd-ad', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'sssd-ad-common', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'sssd-common', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'sssd-dbus', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'sssd-ipa', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'sssd-krb5', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'sssd-krb5-common', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'sssd-ldap', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'sssd-proxy', 'pkgver': '1.13.4-1ubuntu1.10'},
    {'osver': '16.04', 'pkgname': 'sssd-tools', 'pkgver': '1.13.4-1ubuntu1.10'}
];
