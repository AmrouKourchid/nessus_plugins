...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libssh2 PHSA-2019-1.0-0263");
...
if (rpm_exists(rpm:"libssh2-1.9", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"libssh2-1.9.0-2.ph1")) flag++;
if (rpm_exists(rpm:"libssh2-1.9", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"src", reference:"libssh2-1.9.0-2.ph1.src")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"libssh2-debuginfo-1.9.0-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"libssh2-devel-1.9.0-2.ph1")) flag++;
