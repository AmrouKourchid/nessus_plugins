...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2018-B-0143-S");

  script_name(english:"Photon OS 3.0: Nginx PHSA-2019-3.0-0002");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nginx-1.15.3-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nginx-debuginfo-1.15.3-4.ph3')) flag++;
