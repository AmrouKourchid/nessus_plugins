...
# extracted from Fedora Security Advisory FEDORA-2024-8f1374ecfb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8f1374ecfb");

  script_name(english:"Fedora 41 : mbedtls3.6 (2024-8f1374ecfb)");
...
FEDORA-2024-8f1374ecfb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8f1374ecfb");
...
var pkgs = [
    {'reference':'mbedtls3.6-3.6.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
