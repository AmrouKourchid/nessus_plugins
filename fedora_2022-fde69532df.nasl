...
# extracted from Fedora Security Advisory FEDORA-2022-fde69532df
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-fde69532df");

  script_name(english:"Fedora 35 : pypy3.8 (2022-fde69532df)");
...
FEDORA-2022-fde69532df advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-fde69532df");
...
var pkgs = [
    {'reference':'pypy3.8-7.3.9-5.3.8.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
