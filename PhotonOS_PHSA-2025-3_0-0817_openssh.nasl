...
# extracted from VMware Security Advisory PHSA-2025-3.0-0817. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Openssh PHSA-2025-3.0-0817");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openssh package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-817.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssh-7.8p1-19.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssh-clients-7.8p1-19.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssh-server-7.8p1-19.ph3')) flag++;
