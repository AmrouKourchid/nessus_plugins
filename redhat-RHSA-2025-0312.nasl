...
# extracted from Red Hat Security Advisory RHSA-2025:0312. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0312");

  script_name(english:"RHEL 9 : raptor2 (RHSA-2025:0312)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0312.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e415802e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0312");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL raptor2 package based on the guidance in RHSA-2025:0312.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'raptor2-2.0.15-32.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'raptor2-devel-2.0.15-32.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
