...
# extracted from Fedora Security Advisory FEDORA-2018-f6adf1cb62.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : libcgroup (2018-f6adf1cb62)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Fix for **CVE-2018-14348**.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f6adf1cb62");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"libcgroup-0.41-20.fc28")) flag++;
