...
# SUSE update advisory SUSE-SU-2021:14836-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14836-1");

  script_name(english:"SUSE SLES11 Security Update : transfig (SUSE-SU-2021:14836-1)");
...
the SUSE-SU-2021:14836-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-November/009686.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c4451c7");
...
var pkgs = [
    {'reference':'transfig-3.2.8b-160.16.2', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
