...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : numpy (EulerOS-SA-2022-1684)");
...
affected by the following vulnerabilities :
    ...
    attackers to conduct a Denial of Service attacks by carefully constructing an array with negative
    values.(CVE-2021-41496)

Tenable has extracted the preceding description block directly from the EulerOS Virtualization numpy security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1684
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bfcc1982");
