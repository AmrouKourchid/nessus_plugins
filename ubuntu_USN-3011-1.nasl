...
# extracted from Ubuntu Security Notice USN-3011-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : HAProxy vulnerability (USN-3011-1)");
...
USN-3011-1 advisory.
    ...
    Falco Schmutz discovered that HAProxy incorrectly handled the reqdeny filter. A remote attacker could use
    this issue to cause HAProxy to crash, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3011-1");
...
"Update the affected haproxy and / or vim-haproxy packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-5360");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'haproxy', 'pkgver': '1.6.3-1ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'vim-haproxy', 'pkgver': '1.6.3-1ubuntu0.1'}
];
