...
if (description)
{
  ...
  script_name(english:"CentOS 9 : subversion-1.14.1-5.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for mod_dav_svn.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
subversion-1.14.1-5.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=23074");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream mod_dav_svn package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:python3-subversion");
...
var pkgs = [
    {'reference':'mod_dav_svn-1.14.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-subversion-1.14.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'subversion-1.14.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'subversion-devel-1.14.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'subversion-gnome-1.14.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'subversion-javahl-1.14.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'subversion-libs-1.14.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'subversion-perl-1.14.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'subversion-ruby-1.14.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'subversion-tools-1.14.1-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
