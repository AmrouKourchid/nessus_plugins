...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 115.2.2");

  script_set_attribute(attribute:"synopsis", value:
"A mail client installed on the remote macOS or Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 115.2.2. It is, therefore,
...
"Upgrade to Mozilla Thunderbird version 115.2.2 or later.");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'115.2.2', min:'115.0.0', severity:SECURITY_HOLE);
