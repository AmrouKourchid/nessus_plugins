...
# extracted from Red Hat Security Advisory RHSA-2023:6523. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6523");

  script_name(english:"RHEL 9 : python-tornado (RHSA-2023:6523)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6523.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32bf293c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2210199");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6523");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-tornado package based on the guidance in RHSA-2023:6523.");
