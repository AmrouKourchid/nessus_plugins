...
# extracted from Fedora Security Advisory FEDORA-2020-94407454d7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : python-django (2020-94407454d7)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-94407454d7");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"python-django-3.0.10-3.fc32")) flag++;
