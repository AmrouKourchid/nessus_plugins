...
"The version of Firefox ESR installed on the remote Windows host is prior to 115.16.1. It is, therefore, affected by a
vulnerability as referenced in the mfsa2024-51 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'115.16.1', min:'115.0.0', severity:SECURITY_HOLE);
