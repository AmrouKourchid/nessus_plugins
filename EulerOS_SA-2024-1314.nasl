...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : haproxy (EulerOS-SA-2024-1314)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1314
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ad4a823");
...
var pkgs = [
  "haproxy-2.0.14-2.h11.eulerosv2r10"
];
