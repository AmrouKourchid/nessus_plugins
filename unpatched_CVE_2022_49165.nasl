...
if (description)
{
  ...
  script_cve_id("CVE-2022-49165");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49165");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: media: imx-jpeg: Prevent decoding
    NV12M jpegs into single-planar buffers If the application queues an NV12M jpeg as output buffer, but then
    queues a single planar capture buffer, the kernel will crash with Unable to handle kernel NULL pointer
    dereference in mxc_jpeg_addrs, prevent this by finishing the job with error. (CVE-2022-49165)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49165");
