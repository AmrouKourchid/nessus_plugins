...
# extracted from Fedora Security Advisory FEDORA-2023-65f751f76d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-65f751f76d");

  script_name(english:"Fedora 38 : iniparser (2023-65f751f76d)");
...
FEDORA-2023-65f751f76d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-65f751f76d");
...
var pkgs = [
    {'reference':'iniparser-4.1-12.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
