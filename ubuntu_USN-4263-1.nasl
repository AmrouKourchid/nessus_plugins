...
# extracted from Ubuntu Security Notice USN-4263-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : Sudo vulnerability (USN-4263-1)");
...
in the USN-4263-1 advisory.

    Joe Vennix discovered that Sudo incorrectly handled memory operations when the pwfeedback option is
    enabled. A local attacker could possibly use this issue to obtain unintended access to the administrator
    account.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4263-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'sudo', 'pkgver': '1.8.16-0ubuntu1.9'},
    {'osver': '16.04', 'pkgname': 'sudo-ldap', 'pkgver': '1.8.16-0ubuntu1.9'},
    {'osver': '18.04', 'pkgname': 'sudo', 'pkgver': '1.8.21p2-3ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'sudo-ldap', 'pkgver': '1.8.21p2-3ubuntu1.2'}
];
