...
# extracted from ZTE advisory NS-SA-2023-0087. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : cyrus-sasl Multiple Vulnerabilities (NS-SA-2023-0087)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.06, has cyrus-sasl packages installed that are affected by
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0087");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2019-19906");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-24407");
...
var pkgs = {
  'CGSL MAIN 6.06': [
    'cyrus-sasl-2.1.27-6.zncgsl6_5',
    'cyrus-sasl-devel-2.1.27-6.zncgsl6_5',
    'cyrus-sasl-gssapi-2.1.27-6.zncgsl6_5',
    'cyrus-sasl-lib-2.1.27-6.zncgsl6_5',
    'cyrus-sasl-md5-2.1.27-6.zncgsl6_5',
    'cyrus-sasl-plain-2.1.27-6.zncgsl6_5'
  ]
};
