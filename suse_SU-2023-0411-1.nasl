...
# SUSE update advisory SUSE-SU-2023:0411-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0411-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : haproxy (SUSE-SU-2023:0411-1)");
...
referenced in the SUSE-SU-2023:0411-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013760.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2bdcc322");
...
var pkgs = [
    {'reference':'haproxy-2.4.8+git0.d1f8d41e0-150400.3.10.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'haproxy-2.4.8+git0.d1f8d41e0-150400.3.10.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.4']}
];
