...
# extracted from Fedora Security Advisory FEDORA-2019-f0435555ac.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : cyrus-imapd (2019-f0435555ac)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-f0435555ac");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"cyrus-imapd-3.0.10-1.fc29")) flag++;
