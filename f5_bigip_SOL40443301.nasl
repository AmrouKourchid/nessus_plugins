...
disallowed by default.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K40443301");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K40443301.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-6640");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '14.1.0-14.1.0.5','14.0.0-14.0.0.4','13.0.0-13.1.1','12.1.0-12.1.4','11.6.1-11.6.3','11.5.1-11.5.8'
    ],
    'unaffected': [
      '15.0.0','14.1.0.6','14.0.0.5','13.1.1.5','12.1.4.1','11.6.4','11.5.9'
    ],
  },
  'AM': {
    'affected': [
