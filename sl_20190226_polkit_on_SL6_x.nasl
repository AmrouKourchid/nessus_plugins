...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : polkit on SL6.x i386/x86_64 (20190226)");
...
"Security Fix(es) :
  ...
  - polkit: Temporary auth hijacking via PID reuse and
    non-atomic fork (CVE-2019-6133)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1902&L=SCIENTIFIC-LINUX-ERRATA&P=9562
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dacef18f");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:polkit-desktop-policy");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"polkit-0.96-11.el6_10.1")) flag++;
if (rpm_check(release:"SL6", reference:"polkit-debuginfo-0.96-11.el6_10.1")) flag++;
if (rpm_check(release:"SL6", reference:"polkit-desktop-policy-0.96-11.el6_10.1")) flag++;
if (rpm_check(release:"SL6", reference:"polkit-devel-0.96-11.el6_10.1")) flag++;
if (rpm_check(release:"SL6", reference:"polkit-docs-0.96-11.el6_10.1")) flag++;
