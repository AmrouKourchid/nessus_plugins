...
# extracted from Red Hat Security Advisory qci. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-6340");

  script_name(english:"RHEL 7 : qci (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-6340");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:Distribution");
