...
# extracted from Fedora Security Advisory FEDORA-2023-b52438b698
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b52438b698");

  script_name(english:"Fedora 39 : dotnet7.0 (2023-b52438b698)");
...
FEDORA-2023-b52438b698 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b52438b698");
...
var pkgs = [
    {'reference':'dotnet7.0-7.0.112-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
