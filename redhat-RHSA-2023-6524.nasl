...
# extracted from Red Hat Security Advisory RHSA-2023:6524. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6524");

  script_name(english:"RHEL 9 : dnsmasq (RHSA-2023:6524)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6524.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc22cc60");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2156789");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2178948");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2209031");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6524");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dnsmasq package based on the guidance in RHSA-2023:6524.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dnsmasq-2.85-14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-utils-2.85-14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
