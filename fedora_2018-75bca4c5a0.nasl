...
# extracted from Fedora Security Advisory FEDORA-2018-75bca4c5a0.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-6926");
  script_xref(name:"FEDORA", value:"2018-75bca4c5a0");

  script_name(english:"Fedora 28 : drupal7 (2018-75bca4c5a0)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-75bca4c5a0");
...
"Update the affected drupal7 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-6926");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"drupal7-7.58-1.fc28")) flag++;
