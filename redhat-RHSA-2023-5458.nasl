...
# extracted from Red Hat Security Advisory RHSA-2023:5458. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-30079");
  script_xref(name:"RHSA", value:"2023:5458");

  script_name(english:"RHEL 9 : libeconf (RHSA-2023:5458)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libeconf.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5458.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7cc1a2b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2234595");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5458");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libeconf package based on the guidance in RHSA-2023:5458.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libeconf-0.4.1-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
