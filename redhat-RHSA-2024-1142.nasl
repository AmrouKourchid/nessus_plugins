...
# extracted from Red Hat Security Advisory RHSA-2024:1142. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1142");

  script_name(english:"RHEL 9 : haproxy (RHSA-2024:1142)");
...
referenced in the RHSA-2024:1142 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1142.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3907d841");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1142");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL haproxy package based on the guidance in RHSA-2024:1142.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy-2.4.22-3.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
