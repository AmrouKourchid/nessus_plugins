...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Syslog PHSA-2023-5.0-0093");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'syslog-ng-3.37.1-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'syslog-ng-devel-3.37.1-3.ph5')) flag++;
