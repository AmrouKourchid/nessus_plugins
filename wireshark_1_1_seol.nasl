...
if (description)
{
  ...
  script_name(english:"Wireshark SEoL (1.1.x <= x <= 1.2.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Wireshark is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Wireshark is between 1.1.x and 1.2.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of Wireshark that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2011/06/30");
...
var constraints = [
  { max_branch : '1.2', min_branch : '1.1', seol : 20110630 }
];
