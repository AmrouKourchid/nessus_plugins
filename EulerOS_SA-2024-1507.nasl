...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : gnutls (EulerOS-SA-2024-1507)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1507
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e044adea");
...
var pkgs = [
  "gnutls-3.6.9-6.h14.eulerosv2r9",
  "gnutls-utils-3.6.9-6.h14.eulerosv2r9"
];
