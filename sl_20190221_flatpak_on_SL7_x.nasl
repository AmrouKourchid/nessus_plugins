...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : flatpak on SL7.x x86_64 (20190221)");
...
"Security Fix(es) :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?869fdc5a");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-60.5.1-1.el7_6", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-debuginfo-60.5.1-1.el7_6", allowmaj:TRUE)) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "firefox / firefox-debuginfo / flatpak / flatpak-builder / etc");
}
