...
# Oracle Linux Security Advisory ELSA-2018-0012 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : microcode_ctl (ELSA-2018-0012)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-0012.html");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-22.2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
