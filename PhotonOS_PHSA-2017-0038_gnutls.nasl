...
if (description)
{
  ...
  script_cve_id("CVE-2017-10790", "CVE-2017-7507");

  script_name(english:"Photon OS 1.0: Gnutls PHSA-2017-0038");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-7507");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'gnutls-3.5.15-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'gnutls-debuginfo-3.5.15-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'gnutls-devel-3.5.15-1.ph1')) flag++;
