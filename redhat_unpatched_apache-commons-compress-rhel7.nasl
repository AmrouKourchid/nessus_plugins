...
# extracted from Red Hat Security Advisory apache-commons-compress. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : apache-commons-compress (Unpatched Vulnerability) (deprecated)");
