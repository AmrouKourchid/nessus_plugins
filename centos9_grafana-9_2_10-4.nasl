...
if (description)
{
  ...
  script_name(english:"CentOS 9 : grafana-9.2.10-4.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for grafana.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has a package installed that is affected by a vulnerability as referenced in the
grafana-9.2.10-4.el9 build changelog.

  - account takeover possible when using Azure AD OAuth (CVE-2023-3128)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=35149");
...
var pkgs = [
    {'reference':'grafana-9.2.10-4.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
