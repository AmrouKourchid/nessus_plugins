...
# extracted from Fedora Security Advisory FEDORA-2022-45d2cfdfa4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-45d2cfdfa4");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"Fedora 36 : mingw-python3 (2022-45d2cfdfa4)");
...
FEDORA-2022-45d2cfdfa4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-45d2cfdfa4");
...
var pkgs = [
    {'reference':'mingw-python3-3.10.8-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
