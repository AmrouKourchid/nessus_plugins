...
# extracted from Debian Security Advisory dsa-5905. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5905 : graphicsmagick - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-27795");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-32460");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/graphicsmagick");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'graphicsmagick', 'reference': '1.4+really1.3.40-4+deb12u1'},
    {'release': '12.0', 'prefix': 'graphicsmagick-dbg', 'reference': '1.4+really1.3.40-4+deb12u1'},
    {'release': '12.0', 'prefix': 'graphicsmagick-imagemagick-compat', 'reference': '1.4+really1.3.40-4+deb12u1'},
    {'release': '12.0', 'prefix': 'graphicsmagick-libmagick-dev-compat', 'reference': '1.4+really1.3.40-4+deb12u1'},
    {'release': '12.0', 'prefix': 'libgraphics-magick-perl', 'reference': '1.4+really1.3.40-4+deb12u1'},
    {'release': '12.0', 'prefix': 'libgraphicsmagick++-q16-12', 'reference': '1.4+really1.3.40-4+deb12u1'},
    {'release': '12.0', 'prefix': 'libgraphicsmagick++1-dev', 'reference': '1.4+really1.3.40-4+deb12u1'},
    {'release': '12.0', 'prefix': 'libgraphicsmagick-q16-3', 'reference': '1.4+really1.3.40-4+deb12u1'},
    {'release': '12.0', 'prefix': 'libgraphicsmagick1-dev', 'reference': '1.4+really1.3.40-4+deb12u1'}
];
