...
# extracted from Debian Security Advisory dsa-5859. The text
...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2025-A-0080-S");

  script_name(english:"Debian dsa-5859 : chromium - security update");
...
dsa-5859 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5859-1                   security@debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-0444");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-0445");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-0451");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'chromium', 'reference': '133.0.6943.53-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-common', 'reference': '133.0.6943.53-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-driver', 'reference': '133.0.6943.53-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-l10n', 'reference': '133.0.6943.53-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-sandbox', 'reference': '133.0.6943.53-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-shell', 'reference': '133.0.6943.53-1~deb12u1'}
];
