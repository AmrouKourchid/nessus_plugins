...
# extracted from Fedora Security Advisory FEDORA-2023-e7ed15ab9e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e7ed15ab9e");

  script_name(english:"Fedora 37 : mosquitto (2023-e7ed15ab9e)");
...
FEDORA-2023-e7ed15ab9e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e7ed15ab9e");
...
var pkgs = [
    {'reference':'mosquitto-2.0.17-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
