...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1355.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1355");

  script_name(english:"Amazon Linux 2 : unzip (ALAS-2019-1355)");
...
to be 12.(CVE-2018-18384)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1355.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"unzip-6.0-20.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"unzip-debuginfo-6.0-20.amzn2")) flag++;
