...
# extracted from VMware Security Advisory PHSA-2021-4.0-0059. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Linuxptp PHSA-2021-4.0-0059");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the linuxptp package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-59.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'linuxptp-3.1-3.ph4')) flag++;
