...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-1213.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected gdm, gdm-docs and / or initscripts packages.");
...
var pkgs = [
    {'reference':'gdm-2.16.0-59.0.1.el5_9.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'gdm-docs-2.16.0-59.0.1.el5_9.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'initscripts-8.45.42-2.0.1.el5_9.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gdm-2.16.0-59.0.1.el5_9.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'gdm-docs-2.16.0-59.0.1.el5_9.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'initscripts-8.45.42-2.0.1.el5_9.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
