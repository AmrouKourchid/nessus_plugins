...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : ghostscript Vulnerability (NS-SA-2019-0097)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has ghostscript packages installed that are affected by a
vulnerability:
