...
# AlmaLinux Security Advisory ALSA-2024:0340.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:0340");

  script_name(english:"AlmaLinux 9 : kpatch-patch (ALSA-2024:0340)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-0340.html");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for ALSA-2024:0340');
  }
  else
  {
