...
# extracted from Fedora Security Advisory FEDORA-2023-f0be0daaa5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f0be0daaa5");
  script_xref(name:"IAVB", value:"2023-B-0075-S");

  script_name(english:"Fedora 37 : poppler (2023-f0be0daaa5)");
...
FEDORA-2023-f0be0daaa5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f0be0daaa5");
...
var pkgs = [
    {'reference':'poppler-22.08.0-5.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
