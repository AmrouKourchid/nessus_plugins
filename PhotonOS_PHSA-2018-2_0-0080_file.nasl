...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: File PHSA-2018-2.0-0080");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'file-5.30-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'file-debuginfo-5.30-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'file-devel-5.30-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'file-libs-5.30-4.ph2')) flag++;
