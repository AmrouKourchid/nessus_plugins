...
# Oracle Linux Security Advisory ELSA-2019-0420 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : polkit (ELSA-2019-0420)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-0420.html");
...
var pkgs = [
    ...
    {'reference':'polkit-desktop-policy-0.96-11.el6_10.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'polkit-desktop-policy-0.96-11.el6_10.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
