...
# Red Hat Security Advisory RHSA-2020:1576. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : memcached (CESA-2020:1576)");
...
pkgs = [
    {'reference':'memcached-1.5.9-3.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'memcached-1.5.9-3.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
