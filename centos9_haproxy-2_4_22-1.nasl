...
if (description)
{
  ...
  script_name(english:"CentOS 9 : haproxy-2.4.22-1.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for haproxy.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has a package installed that is affected by a vulnerability as referenced in the
haproxy-2.4.22-1.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=33526");
