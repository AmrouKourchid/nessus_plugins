...
# extracted from Ubuntu Security Notice USN-4195-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : MariaDB vulnerabilities (USN-4195-2)");
...
the USN-4195-2 advisory.

    USN-4195-1 fixed multiple vulnerabilities in MySQL. This update provides the corresponding fixes for
    CVE-2019-2974 in MariaDB 10.1 and CVE-2019-2938, CVE-2019-2974 for MariaDB 10.3.

    Ubuntu 18.04 LTS has been updated to MariaDB 10.1.43. Ubuntu 19.04 and 19.10 has been updated to MariaDB
    10.3.20.

    In addition to security fixes, the updated package contain bug fixes, new features, and possibly
    incompatible changes.

    Please see the following for more information: https://mariadb.com/kb/en/library/mariadb-10143-changelog/
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4195-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libmariadbclient-dev', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libmariadbclient-dev-compat', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libmariadbclient18', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libmariadbd-dev', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libmariadbd18', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-client', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-client-10.1', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-client-core-10.1', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-common', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-plugin-connect', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-plugin-cracklib-password-check', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-plugin-gssapi-client', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-plugin-gssapi-server', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-plugin-mroonga', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-plugin-oqgraph', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-plugin-spider', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-plugin-tokudb', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-server', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-server-10.1', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-server-core-10.1', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-test', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'mariadb-test-data', 'pkgver': '1:10.1.43-0ubuntu0.18.04.1'}
];
