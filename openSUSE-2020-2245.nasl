...
# extracted from openSUSE Security Update openSUSE-2020-2245.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openssl-1_1 (openSUSE-2020-2245)");
...
if ( rpm_check(release:"SUSE15.1", reference:"libopenssl-1_1-devel-1.1.0i-lp151.8.12.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libopenssl1_1-1.1.0i-lp151.8.12.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libopenssl1_1-debuginfo-1.1.0i-lp151.8.12.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libopenssl1_1-hmac-1.1.0i-lp151.8.12.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openssl-1_1-1.1.0i-lp151.8.12.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openssl-1_1-debuginfo-1.1.0i-lp151.8.12.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"openssl-1_1-debugsource-1.1.0i-lp151.8.12.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libopenssl-1_1-devel-32bit-1.1.0i-lp151.8.12.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libopenssl1_1-32bit-1.1.0i-lp151.8.12.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libopenssl1_1-32bit-debuginfo-1.1.0i-lp151.8.12.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libopenssl1_1-hmac-32bit-1.1.0i-lp151.8.12.2") ) flag++;
