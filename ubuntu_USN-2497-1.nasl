...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : NTP vulnerabilities (USN-2497-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2497-1 advisory.

    Stephen Roettger, Sebastian Krahmer, and Harlan Stenn discovered that NTP incorrectly handled the length
    value in extension fields. A remote attacker could use this issue to possibly obtain leaked information,
    or cause the NTP daemon to crash, resulting in a denial of service. (CVE-2014-9297)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2497-1");
...
"Update the affected ntp and / or ntpdate packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9298");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'ntp', 'pkgver': '1:4.2.6.p5+dfsg-3ubuntu2.14.04.2'},
    {'osver': '14.04', 'pkgname': 'ntpdate', 'pkgver': '1:4.2.6.p5+dfsg-3ubuntu2.14.04.2'}
];
