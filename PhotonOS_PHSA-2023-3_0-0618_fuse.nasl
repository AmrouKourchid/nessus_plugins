...
# extracted from VMware Security Advisory PHSA-2023-3.0-0618. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Fuse PHSA-2023-3.0-0618");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the fuse package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-618.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'fuse-overlayfs-snapshotter-1.0.6-1.ph3')) flag++;
