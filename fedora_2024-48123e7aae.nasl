...
# extracted from Fedora Security Advisory FEDORA-2024-48123e7aae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-48123e7aae");

  script_name(english:"Fedora 38 : mingw-python-werkzeug (2024-48123e7aae)");
...
FEDORA-2024-48123e7aae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-48123e7aae");
...
var pkgs = [
    {'reference':'mingw-python-werkzeug-2.2.3-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
