...
# extracted from Fedora Security Advisory FEDORA-2020-d0f892b069.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : sqlite (2020-d0f892b069)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-d0f892b069");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"sqlite-3.33.0-1.fc32")) flag++;
