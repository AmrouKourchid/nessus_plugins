...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.04 : Flask vulnerability (USN-6111-1)");
...
referenced in the USN-6111-1 advisory.

    It was discovered that Flask incorrectly handled certain data responses. An attacker could possibly use
