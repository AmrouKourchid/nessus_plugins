...
if (description)
{
  ...
  script_name(english:"Google Chrome < 122.0.6261.128 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 122.0.6261.128. It is, therefore, affected
by a vulnerability as referenced in the 2024_03_stable-channel-update-for-desktop_12 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?87e415d2");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/327696052");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome version 122.0.6261.128 or later.");
...
google_chrome_check_version(installs:installs, fix:'122.0.6261.128', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
