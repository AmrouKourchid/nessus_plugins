...
# extracted from Gentoo Linux Security Advisory GLSA 202401-09.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202401-09 : Eclipse Mosquitto: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202401-09 (Eclipse Mosquitto: Multiple
Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202401-09");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=918540");
...
"All Eclipse Mosquitto users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:mosquitto");
...
var packages = [
  {
    'name' : 'app-misc/mosquitto',
    'unaffected' : make_list("ge 2.0.17"),
    'vulnerable' : make_list("lt 2.0.17")
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'Eclipse Mosquitto');
}
