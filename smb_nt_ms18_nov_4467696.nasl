...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4467696");
  script_xref(name:"MSFT", value:"MS18-4467696");

  script_name(english:"KB4467696: Windows 10 Version 1703 November 2018 Security Update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 4467696.
It is, therefore, affected by multiple vulnerabilities :
  ...
  - A remote code execution vulnerability exists in the way
    ...
    CVE-2018-8551, CVE-2018-8555, CVE-2018-8556,
    CVE-2018-8557, CVE-2018-8588)
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e344f65e");
  script_set_attribute(attribute:"solution", value:
"Apply Cumulative Update KB4467696.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-8544");
