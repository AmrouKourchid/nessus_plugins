...
# extracted from Debian Security Advisory DLA-2349-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2349-1 : php-horde security update");
...
For the detailed security status of php-horde please refer to its
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00046.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/php-horde");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/php-horde");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"php-horde", reference:"5.2.13+debian0-1+deb9u3")) flag++;
