...
if (description)
{
  ...
  script_cve_id("CVE-2015-8391");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-8391");
...
patch available.
  ...
  - The pcre_compile function in pcre_compile.c in PCRE before 8.38 mishandles certain [: nesting, which
    allows remote attackers to cause a denial of service (CPU consumption) or possibly have unspecified other
    impact via a crafted regular expression, as demonstrated by a JavaScript RegExp object encountered by
