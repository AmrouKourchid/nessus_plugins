...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libsolv (EulerOS-SA-2022-1077)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libsolv package installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1077
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b959e480");
...
var pkgs = [
  "libsolv-0.6.35-3.h5.eulerosv2r8"
];
