...
if (description)
{
  ...
  script_name(english:"CentOS 9 : toolbox-0.0.99.4-5.el9");
...
toolbox-0.0.99.4-5.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=36385");
...
var pkgs = [
    {'reference':'toolbox-0.0.99.4-5.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'toolbox-0.0.99.4-5.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'toolbox-0.0.99.4-5.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'toolbox-tests-0.0.99.4-5.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'toolbox-tests-0.0.99.4-5.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'toolbox-tests-0.0.99.4-5.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
