...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : sqlite3 (EulerOS-SA-2021-2169)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the sqlite3 package installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2169
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc6483b6");
  script_set_attribute(attribute:"solution", value:
"Update the affected sqlite3 package.");
