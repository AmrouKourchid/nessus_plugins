...
# extracted from Red Hat Security Advisory RHSA-2025:7315. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7315");

  script_name(english:"RHEL 9 : php (RHSA-2025:7315)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for php.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:7315 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-71275");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7315.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b6fd0464");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7315");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL php package based on the guidance in RHSA-2025:7315.");
  ...
  script_cwe_id(20, 122, 158, 200, 626, 1220, 1286);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'php-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-bcmath-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-cli-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-common-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-dba-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-dbg-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-devel-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-embedded-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-enchant-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-ffi-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-fpm-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-gd-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-gmp-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-intl-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-ldap-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-mbstring-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-mysqlnd-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-odbc-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-opcache-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-pdo-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-pgsql-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-process-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-snmp-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-soap-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'php-xml-8.0.30-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
