...
if (description)
{
  ...
  script_cve_id("CVE-2024-49921");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-49921");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Check null pointers
    before used [WHAT & HOW] Poniters, such as dc->clk_mgr, are null checked previously in the same function,
    so Coverity warns implies that dc->clk_mgr might be null. As a result, these pointers need to be
    checked when used again. This fixes 10 FORWARD_NULL issues reported by Coverity. (CVE-2024-49921)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-49921");
