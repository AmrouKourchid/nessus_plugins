...
if (description)
{
  ...
  script_cve_id("CVE-2020-12758", "CVE-2020-13170", "CVE-2020-13250");

  script_name(english:"Photon OS 3.0: Consul PHSA-2020-3.0-0151");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-13170");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'consul-1.7.8-1.ph3')) flag++;
