...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Evince vulnerability (USN-3503-1)");
...
in the USN-3503-1 advisory.

    It was discovered that Evince incorrectly handled printing certain DVI files. If a user were tricked into
    opening and printing a specially-named DVI file, an attacker could use this issue to execute arbitrary
    code.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3503-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'evince', 'pkgver': '3.10.3-0ubuntu10.4'},
    {'osver': '14.04', 'pkgname': 'evince-common', 'pkgver': '3.10.3-0ubuntu10.4'},
    {'osver': '14.04', 'pkgname': 'evince-gtk', 'pkgver': '3.10.3-0ubuntu10.4'},
    {'osver': '14.04', 'pkgname': 'gir1.2-evince-3.0', 'pkgver': '3.10.3-0ubuntu10.4'},
    {'osver': '14.04', 'pkgname': 'libevdocument3-4', 'pkgver': '3.10.3-0ubuntu10.4'},
    {'osver': '14.04', 'pkgname': 'libevince-dev', 'pkgver': '3.10.3-0ubuntu10.4'},
    {'osver': '14.04', 'pkgname': 'libevview3-3', 'pkgver': '3.10.3-0ubuntu10.4'},
    {'osver': '16.04', 'pkgname': 'evince', 'pkgver': '3.18.2-1ubuntu4.3'},
    {'osver': '16.04', 'pkgname': 'evince-common', 'pkgver': '3.18.2-1ubuntu4.3'},
    {'osver': '16.04', 'pkgname': 'evince-gtk', 'pkgver': '3.18.2-1ubuntu4.3'},
    {'osver': '16.04', 'pkgname': 'gir1.2-evince-3.0', 'pkgver': '3.18.2-1ubuntu4.3'},
    {'osver': '16.04', 'pkgname': 'libevdocument3-4', 'pkgver': '3.18.2-1ubuntu4.3'},
    {'osver': '16.04', 'pkgname': 'libevince-dev', 'pkgver': '3.18.2-1ubuntu4.3'},
    {'osver': '16.04', 'pkgname': 'libevview3-3', 'pkgver': '3.18.2-1ubuntu4.3'}
];
