...
# extracted from Debian Security Advisory dla-3642. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3642 : request-tracker4 - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'request-tracker4', 'reference': '4.4.3-2+deb10u3'},
    {'release': '10.0', 'prefix': 'rt4-apache2', 'reference': '4.4.3-2+deb10u3'},
    {'release': '10.0', 'prefix': 'rt4-clients', 'reference': '4.4.3-2+deb10u3'},
    {'release': '10.0', 'prefix': 'rt4-db-mysql', 'reference': '4.4.3-2+deb10u3'},
    {'release': '10.0', 'prefix': 'rt4-db-postgresql', 'reference': '4.4.3-2+deb10u3'},
    {'release': '10.0', 'prefix': 'rt4-db-sqlite', 'reference': '4.4.3-2+deb10u3'},
    {'release': '10.0', 'prefix': 'rt4-doc-html', 'reference': '4.4.3-2+deb10u3'},
    {'release': '10.0', 'prefix': 'rt4-fcgi', 'reference': '4.4.3-2+deb10u3'},
    {'release': '10.0', 'prefix': 'rt4-standalone', 'reference': '4.4.3-2+deb10u3'}
];
