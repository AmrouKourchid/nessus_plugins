...
# extracted from Red Hat Security Advisory RHSA-2024:6240. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6240");

  script_name(english:"RHEL 9 : python-urllib3 (RHSA-2024:6240)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6240.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?63d3050b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6240");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-urllib3 package based on the guidance in RHSA-2024:6240.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-urllib3-1.26.5-3.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
