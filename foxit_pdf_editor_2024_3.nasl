...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 2024.3 Multiple Vulnerabilities");
...
Windows host is prior to 2024.3. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor version 2024.3 or later");
...
var constraints = [
  { 'max_version' : '11.2.10.53951', 'fixed_version' : '2024.3' },
  { 'min_version' : '12.0', 'max_version' : '12.1.7.15526', 'fixed_version' : '2024.3' },
  { 'min_version' : '13.0', 'max_version' : '13.1.3.22478', 'fixed_version' : '2024.3' },
  { 'min_version' : '2023.0', 'max_version' : '2023.3.0.23028', 'fixed_version' : '2024.3' },
  { 'min_version' : '2024.0', 'max_version' : '2024.2.3.25184', 'fixed_version' : '2024.3' }
];
