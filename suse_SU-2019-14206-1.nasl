...
# SUSE update advisory SUSE-SU-2019:14206-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2019:14206-1");

  script_name(english:"SUSE SLES11 Security Update : libssh2_org (SUSE-SU-2019:14206-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1154862");
  # https://lists.suse.com/pipermail/sle-security-updates/2019-November/006093.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56608164");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2019-17498");
  script_set_attribute(attribute:"solution", value:
"Update the affected libssh2-1 package.");
...
pkgs = [
    {'reference':'libssh2-1-1.4.3-17.12', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.4'},
    {'reference':'libssh2-1-1.4.3-17.12', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.4'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libssh2-1');
}
