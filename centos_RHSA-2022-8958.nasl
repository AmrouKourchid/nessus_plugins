...
# extracted from Red Hat Security Advisory RHSA-2022:8958 and
# CentOS Errata and Security Advisory 2022:8958 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : bcel (RHSA-2022:8958)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2022:8958 advisory.
...
var pkgs = [
    {'reference':'bcel-5.2-19.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bcel-javadoc-5.2-19.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
