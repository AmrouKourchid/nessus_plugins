...
# extracted from Red Hat Security Advisory RHSA-2025:4493. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:4493");

  script_name(english:"RHEL 9 : ruby:3.3 (RHSA-2025:4493)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for ruby:3.3.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:4493 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2344680");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4493.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92e83878");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4493");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ruby:3.3 package based on the guidance in RHSA-2025:4493.");
  ...
  'ruby:3.3': [
    {
      ...
      'pkgs': [
        {'reference':'ruby-3.3.8-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-bundled-gems-3.3.8-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-default-gems-3.3.8-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-devel-3.3.8-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-doc-3.3.8-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-libs-3.3.8-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-bigdecimal-3.1.5-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-bundler-2.5.22-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-io-console-0.7.1-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-irb-1.13.1-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-json-2.7.2-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-minitest-5.20.0-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-power_assert-2.0.3-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-psych-5.1.2-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-racc-1.7.3-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rake-13.1.0-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rbs-3.4.0-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rdoc-6.6.3.1-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rexml-3.3.9-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rss-0.3.1-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-test-unit-3.6.1-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-typeprof-0.21.9-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-3.5.22-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-devel-3.5.22-4.module+el9.5.0+23030+26c9b8e1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
