...
# extracted from Fedora Security Advisory FEDORA-2024-bd9e53683a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bd9e53683a");

  script_name(english:"Fedora 39 : csmock (2024-bd9e53683a)");
...
FEDORA-2024-bd9e53683a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bd9e53683a");
  script_set_attribute(attribute:"solution", value:
"Update the affected csmock package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:L/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-2243");
...
var pkgs = [
    {'reference':'csmock-3.5.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'csmock');
}
