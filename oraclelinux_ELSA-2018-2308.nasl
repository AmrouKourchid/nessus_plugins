...
# Oracle Linux Security Advisory ELSA-2018-2308 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : openslp (ELSA-2018-2308)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-2308.html");
