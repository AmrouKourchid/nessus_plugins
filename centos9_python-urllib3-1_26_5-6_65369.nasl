...
if (description)
{
  ...
  script_name(english:"CentOS 9 : python-urllib3-1.26.5-6.el9");
...
urllib3-1.26.5-6.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=65369");
...
var pkgs = [
    {'reference':'python3-urllib3-1.26.5-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
