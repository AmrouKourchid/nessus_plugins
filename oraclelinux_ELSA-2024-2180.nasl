...
# extracted from Oracle Linux Security Advisory ELSA-2024-2180.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : runc (ELSA-2024-2180)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2180.html");
...
var pkgs = [
    {'reference':'runc-1.1.12-2.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'runc-1.1.12-2.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
