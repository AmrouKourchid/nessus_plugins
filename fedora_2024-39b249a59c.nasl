...
# extracted from Fedora Security Advisory FEDORA-2024-39b249a59c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-39b249a59c");

  script_name(english:"Fedora 39 : chromium (2024-39b249a59c)");
...
FEDORA-2024-39b249a59c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-39b249a59c");
...
var pkgs = [
    {'reference':'chromium-123.0.6312.105-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
