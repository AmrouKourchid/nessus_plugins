...
# Oracle Linux Security Advisory ELSA-2013-1732 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : busybox (ELSA-2013-1732)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-1732.html");
...
var pkgs = [
    {'reference':'busybox-1.15.1-20.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'busybox-petitboot-1.15.1-20.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'busybox-1.15.1-20.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'busybox-petitboot-1.15.1-20.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
