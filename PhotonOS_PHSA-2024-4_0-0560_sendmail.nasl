...
# extracted from VMware Security Advisory PHSA-2024-4.0-0560. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Sendmail PHSA-2024-4.0-0560");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the sendmail package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-560.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'sendmail-8.18.0.2-1.ph4')) flag++;
