...
# extracted from Ubuntu Security Notice USN-6173-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6173-1");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (OEM) vulnerabilities (USN-6173-1)");
...
the USN-6173-1 advisory.
    ...
    crash) or possibly execute arbitrary code. (CVE-2023-32250)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6173-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.1.0-1014-oem");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6173-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-1380', 'CVE-2023-2002', 'CVE-2023-2156', 'CVE-2023-2269', 'CVE-2023-31436', 'CVE-2023-32250', 'CVE-2023-32254');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6173-1');
  }
  else
  {
