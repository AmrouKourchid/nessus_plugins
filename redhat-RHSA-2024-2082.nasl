...
# extracted from Red Hat Security Advisory RHSA-2024:2082. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2082");

  script_name(english:"RHEL 8 : libreswan (RHSA-2024:2082)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2082.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c526cb02");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2082");
...
"Update the RHEL libreswan package based on the guidance in RHSA-2024:2082.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.5-1.el8_6.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
