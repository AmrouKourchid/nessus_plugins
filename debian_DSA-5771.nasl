...
# extracted from Debian Security Advisory dsa-5771. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5771 : php-twig - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5771
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-45411");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/php-twig");
...
"Upgrade the php-twig packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:php-twig-cache-extra");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:php-twig-string-extra");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'php-twig', 'reference': '3.5.1-1+deb12u1'},
    {'release': '12.0', 'prefix': 'php-twig-cache-extra', 'reference': '3.5.1-1+deb12u1'},
    {'release': '12.0', 'prefix': 'php-twig-cssinliner-extra', 'reference': '3.5.1-1+deb12u1'},
    {'release': '12.0', 'prefix': 'php-twig-doc', 'reference': '3.5.1-1+deb12u1'},
    {'release': '12.0', 'prefix': 'php-twig-extra-bundle', 'reference': '3.5.1-1+deb12u1'},
    {'release': '12.0', 'prefix': 'php-twig-html-extra', 'reference': '3.5.1-1+deb12u1'},
    {'release': '12.0', 'prefix': 'php-twig-inky-extra', 'reference': '3.5.1-1+deb12u1'},
    {'release': '12.0', 'prefix': 'php-twig-intl-extra', 'reference': '3.5.1-1+deb12u1'},
    {'release': '12.0', 'prefix': 'php-twig-markdown-extra', 'reference': '3.5.1-1+deb12u1'},
    {'release': '12.0', 'prefix': 'php-twig-string-extra', 'reference': '3.5.1-1+deb12u1'}
];
