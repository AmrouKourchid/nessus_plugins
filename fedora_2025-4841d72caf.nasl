...
# extracted from Fedora Security Advisory FEDORA-2025-4841d72caf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-4841d72caf");
  script_xref(name:"IAVA", value:"2025-A-0213-S");

  script_name(english:"Fedora 40 : thunderbird (2025-4841d72caf)");
...
FEDORA-2025-4841d72caf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-4841d72caf");
...
var pkgs = [
    {'reference':'thunderbird-128.9.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
