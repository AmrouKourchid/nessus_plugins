...
# openSUSE Security Update openSUSE-SU-2022:0210-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : qemu (openSUSE-SU-2022:0210-1)");
...
the openSUSE-SU-2022:0210-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?24361fcf");
...
var pkgs = [
    {'reference':'qemu-s390-4.2.1-11.34.2', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
