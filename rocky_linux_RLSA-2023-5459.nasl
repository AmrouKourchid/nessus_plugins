...
# Rocky Linux Security Advisory RLSA-2023:5459.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:5459");

  script_name(english:"Rocky Linux 9 : ghostscript (RLSA-2023:5459)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:5459");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2217798");
...
var pkgs = [
    ...
    {'reference':'ghostscript-debuginfo-9.54.0-10.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-debugsource-9.54.0-10.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-doc-9.54.0-10.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'ghostscript-x11-debuginfo-9.54.0-10.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libgs-9.54.0-10.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libgs-debuginfo-9.54.0-10.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
