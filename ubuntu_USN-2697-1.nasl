...
# extracted from Ubuntu Security Notice USN-2697-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2697-1");

  script_name(english:"Ubuntu 14.04 LTS : Ghostscript vulnerability (USN-2697-1)");
...
USN-2697-1 advisory.
    ...
    William Robinet and Stefan Cornelius discovered that Ghostscript did not correctly handle certain
    Postscript files. If a user or automated system were tricked into opening a specially crafted file, an
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2697-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-3228");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'ghostscript', 'pkgver': '9.10~dfsg-0ubuntu10.4'},
    {'osver': '14.04', 'pkgname': 'ghostscript-x', 'pkgver': '9.10~dfsg-0ubuntu10.4'},
    {'osver': '14.04', 'pkgname': 'libgs-dev', 'pkgver': '9.10~dfsg-0ubuntu10.4'},
    {'osver': '14.04', 'pkgname': 'libgs9', 'pkgver': '9.10~dfsg-0ubuntu10.4'},
    {'osver': '14.04', 'pkgname': 'libgs9-common', 'pkgver': '9.10~dfsg-0ubuntu10.4'}
];
