...
# extracted from Fedora Security Advisory FEDORA-2019-817ff2201f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : pspp (2019-817ff2201f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-817ff2201f");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"pspp-1.2.0-2.fc29")) flag++;
