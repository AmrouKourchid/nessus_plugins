...
# Rocky Linux Security Advisory RLSA-2024:5533.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:5533");

  script_name(english:"Rocky Linux 9 : python3.12-setuptools (RLSA-2024:5533)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:5533");
...
"Update the affected python3.12-setuptools and / or python3.12-setuptools-wheel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:python3.12-setuptools");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:python3.12-setuptools-wheel");
