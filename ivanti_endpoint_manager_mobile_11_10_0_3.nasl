...
if (description)
{
  ...
  script_cve_id("CVE-2023-35081");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/08/21");

  script_name(english:"Ivanti Endpoint Manager Mobile < 11.8.1.2 / 11.9.x < 11.9.1.2 / 11.10.x < 11.10.0.3 Arbitrary File Write (CVE-2023-35081)");
...
"The version of Ivanti Endpoint Manager Mobile, formerly MobileIron Core, running on the remote host is < 11.8.1.2,
11.9.x < 11.9.1.2, or 11.10.x < 11.10.0.3. It is, therefore, affected by an authenticated arbitrary file write vulnerability.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?09179398");
  script_set_attribute(attribute:"solution", value:
"Update to Ivanti Endpoint Manager Mobile version 11.8.1.2, 11.9.1.2, or 11.10.0.3 or later");
  script_set_attribute(attribute:"agent", value:"unix");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:M/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:H/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:F/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-35081");
...
var constraints = [
  { 'fixed_version':'11.8', 'fixed_display':'11.8.1.2'}, 
  { 'min_version':'11.8', 'fixed_version':'11.8.1.2'},
  { 'min_version':'11.9', 'fixed_version':'11.9.1.2'},
  { 'min_version':'11.10', 'fixed_version':'11.10.0.3'}
];
