...
# extracted from Fedora Security Advisory FEDORA-2025-8fdc09e745
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-8fdc09e745");

  script_name(english:"Fedora 40 : chromium (2025-8fdc09e745)");
...
FEDORA-2025-8fdc09e745 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-8fdc09e745");
...
var pkgs = [
    {'reference':'chromium-134.0.6998.88-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
