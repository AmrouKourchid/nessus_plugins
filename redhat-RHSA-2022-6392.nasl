...
# extracted from Red Hat Security Advisory RHSA-2022:6392. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6392");

  script_name(english:"RHEL 8 : RHV Host (ovirt-host) (RHSA-2022:6392)");
...
the RHSA-2022:6392 advisory.
    ...
    * The hosted-engine-ha binaries have been moved from /usr/share to /usr/libexec. As a result, the hosted-
    engine --clean-metadata command fails. With this release, you must use the new path for the command to
    succeed: /usr/libexec/ovirt-hosted-engine-ha/ovirt-ha-agent (BZ#2105781)

    * A new warning has been added to the vdsm-tool to protect users from using the unsupported
    user_friendly_names multipath configuration. The following is an example of the output:
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6392.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fca6e31c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6392");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1793207");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2105075");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2105781");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2117558");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cockpit-ovirt-dashboard-0.16.2-1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
