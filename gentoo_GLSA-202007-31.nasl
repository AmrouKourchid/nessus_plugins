...
# extracted from Gentoo Linux Security Advisory GLSA 202007-31.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-31");

  script_name(english:"GLSA-202007-31 : Icinga: Root privilege escalation");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-31
(Icinga: Root privilege escalation)

    It was discovered that Icinga&rsquo;s installed files have insecure
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-31");
...
"Gentoo has discontinued support for Icinga. We recommend that users
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-16882");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");

  script_set_attribute(attribute:"vuln_publication_date", value:"2017/11/18");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:icinga");
...
if (qpkg_check(package:"net-analyzer/icinga", unaffected:make_list(), vulnerable:make_list("lt 1.14.2"))) flag++;
