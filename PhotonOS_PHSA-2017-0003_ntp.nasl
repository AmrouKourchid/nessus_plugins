...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ntp-4.2.8p9-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ntp-debuginfo-4.2.8p9-1.ph1')) flag++;
