...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : polkit vulnerability (USN-4980-1)");
...
USN-4980-1 advisory.
    ...
    polkit_system_bus_name_get_creds_sync function. A local attacker could possibly use this issue to escalate
    privileges.
