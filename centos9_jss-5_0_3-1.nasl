...
if (description)
{
  ...
  script_name(english:"CentOS 9 : jss-5.0.3-1.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for jss.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
jss-5.0.3-1.el9 build changelog.

  - memory leak in TLS connection leads to OOM [rhel-9.0] (CVE-2021-4213)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=17028");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream jss package.");
...
var pkgs = [
    {'reference':'jss-5.0.3-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jss-javadoc-5.0.3-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
