...
# extracted from Fedora Security Advisory FEDORA-2023-0d6aa10621
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-20593", "CVE-2023-34320");
  script_xref(name:"FEDORA", value:"2023-0d6aa10621");

  script_name(english:"Fedora 38 : xen (2023-0d6aa10621)");
...
FEDORA-2023-0d6aa10621 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0d6aa10621");
...
var pkgs = [
    {'reference':'xen-4.17.1-9.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
