...
# extracted from Gentoo Linux Security Advisory GLSA 202210-11.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202210-11 : schroot: Denial of Service");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202210-11 (schroot: Denial of Service)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202210-11");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=867016");
...
"All schroot users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:schroot");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.6.13_p2", "lt 1.0.0"),
    'vulnerable' : make_list("lt 1.6.13_p2")
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'schroot');
}
