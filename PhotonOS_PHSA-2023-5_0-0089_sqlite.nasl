...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Sqlite PHSA-2023-5.0-0089");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'sqlite-3.40.1-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'sqlite-devel-3.40.1-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'sqlite-libs-3.40.1-2.ph5')) flag++;
