...
# extracted from Fedora Security Advisory FEDORA-2023-50429a3169
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-50429a3169");

  script_name(english:"Fedora 37 : thunderbird (2023-50429a3169)");
...
FEDORA-2023-50429a3169 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-50429a3169");
...
var pkgs = [
    {'reference':'thunderbird-102.8.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
