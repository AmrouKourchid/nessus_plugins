...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : graphite2 (EulerOS-SA-2020-2006)");
...
affected by the following vulnerability :
  ...
  - ** RESERVED ** This candidate has been reserved by an
    ...
    will be provided.(CVE-2017-7778)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2006
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0e798734");
...
pkgs = ["graphite2-1.3.10-6.h2.eulerosv2r8"];
