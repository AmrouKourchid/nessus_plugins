...
# extracted from Fedora Security Advisory FEDORA-2024-515180fdb3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-515180fdb3");

  script_name(english:"Fedora 40 : thunderbird (2024-515180fdb3)");
...
FEDORA-2024-515180fdb3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-515180fdb3");
...
var pkgs = [
    {'reference':'thunderbird-128.5.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
