...
# extracted from Amazon Linux 2 Security Advisory ALASSQUID4-2023-009.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : squid (ALASSQUID4-2023-009)");
...
vulnerabilities as referenced in the ALAS2SQUID4-2023-009 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASSQUID4-2023-009.html");
