...
# extracted from Fedora Security Advisory FEDORA-2024-cd5c1dfa94
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-cd5c1dfa94");

  script_name(english:"Fedora 41 : micropython (2024-cd5c1dfa94)");
...
FEDORA-2024-cd5c1dfa94 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-cd5c1dfa94");
...
"Update the affected micropython package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-8947");
...
var pkgs = [
    {'reference':'micropython-1.23.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
