...
# extracted from Gentoo Linux Security Advisory GLSA 202007-22.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-22");

  script_name(english:"GLSA-202007-22 : sysstat: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-22
(sysstat: Arbitrary code execution)

    A double-free in sysstat&rsquo;s check_file_actlst() function was
      discovered.
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-22");
...
if (qpkg_check(package:"app-admin/sysstat", unaffected:make_list("ge 12.2.1"), vulnerable:make_list("lt 12.2.1"))) flag++;
