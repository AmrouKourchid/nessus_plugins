...
# extracted from Red Hat Security Advisory RHSA-2024:2982. The text
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bbc60393");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2982.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd22fe5c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-3961");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2982");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL webkit2gtk3 package based on the guidance in RHSA-2024:2982.");
  ...
  script_cwe_id(20, 119, 400, 416, 787);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'webkit2gtk3-2.42.5-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-devel-2.42.5-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-2.42.5-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-devel-2.42.5-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
