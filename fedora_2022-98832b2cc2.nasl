...
# extracted from Fedora Security Advisory FEDORA-2022-98832b2cc2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-98832b2cc2");

  script_name(english:"Fedora 36 : freeradius (2022-98832b2cc2)");
...
FEDORA-2022-98832b2cc2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-98832b2cc2");
...
var pkgs = [
    {'reference':'freeradius-3.0.26-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
