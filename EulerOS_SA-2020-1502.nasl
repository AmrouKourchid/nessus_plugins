...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : exiv2 (EulerOS-SA-2020-1502)");
...
vulnerabilities :
  ...
  - An integer overflow in Exiv2 through 0.27.1 allows an
    attacker to cause a denial of service (SIGSEGV) via a
    crafted PNG image file, because PngImage::readMetadata
    mishandles a chunkLength - iccOffset
    subtraction.(CVE-2019-13109)

  - In Exiv2 0.26, the Exiv2::PngImage::printStructure
    function in pngimage.cpp allows remote attackers to
    cause an information leak via a crafted
    file.(CVE-2018-11037)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1502
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed03cac4");
...
"Update the affected exiv2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-11037");
...
pkgs = ["exiv2-0.26-12.h11.eulerosv2r8",
        "exiv2-libs-0.26-12.h11.eulerosv2r8"];
