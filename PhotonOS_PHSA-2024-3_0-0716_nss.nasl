...
# extracted from VMware Security Advisory PHSA-2024-3.0-0716. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Nss PHSA-2024-3.0-0716");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the nss package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-716.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nss-3.44-13.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nss-devel-3.44-13.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nss-libs-3.44-13.ph3')) flag++;
