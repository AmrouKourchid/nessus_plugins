...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : polkit (EulerOS-SA-2020-1424)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1424
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a4c123b");
...
pkgs = ["polkit-0.112-12.h11",
        "polkit-devel-0.112-12.h11",
        "polkit-docs-0.112-12.h11"];
