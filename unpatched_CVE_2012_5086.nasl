...
if (description)
{
  ...
  script_cve_id("CVE-2012-5086");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-5086");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment (JRE) component in Oracle Java SE 7 Update 7 and
    ...
    availability via unknown vectors related to Beans. (CVE-2012-5086)
