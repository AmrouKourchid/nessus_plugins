...
if (description)
{
  ...
  script_cve_id("CVE-2024-36020");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-36020");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: i40e: fix vf may be used uninitialized
    ...
    variable and iterate via single VF pointer across whole function instead to guarantee VF pointer validity.
    (CVE-2024-36020)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-36020");
