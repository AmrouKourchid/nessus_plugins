...
# extracted from Fedora Security Advisory FEDORA-2023-de4eba8d86
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-de4eba8d86");

  script_name(english:"Fedora 38 : httpd (2023-de4eba8d86)");
...
FEDORA-2023-de4eba8d86 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-de4eba8d86");
...
var pkgs = [
    {'reference':'httpd-2.4.58-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
