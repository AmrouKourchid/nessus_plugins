...
if (description)
{
  ...
  script_name(english:"IBM WebSphere Application Server 8.5.0.0 < 8.5.5.24, 9.0.0.0 < 9.0.5.16 XSS (6986333)");
...
"Update to IBM WebSphere Application Server versions 8.5.5.24, 9.0.5.16 or later or apply Interim Fix PH52785.");
