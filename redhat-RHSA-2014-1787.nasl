...
# extracted from Red Hat Security Advisory RHSA-2014:1787. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2014-3641", "CVE-2014-7230", "CVE-2014-7231");
  script_xref(name:"RHSA", value:"2014:1787");

  script_name(english:"RHEL 6 : openstack-cinder (RHSA-2014:1787)");
...
referenced in the RHSA-2014:1787 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://wiki.openstack.org/wiki/ReleaseNotes/2014.1.3");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1141996");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1149750");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2014/rhsa-2014_1787.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?75ac1d07");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1787");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-cinder package based on the guidance in RHSA-2014:1787.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-cinder-2014.1.3-1.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-cinder-doc-2014.1.3-1.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-cinder-2014.1.3-1.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
