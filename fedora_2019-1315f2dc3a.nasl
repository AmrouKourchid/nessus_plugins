...
# extracted from Fedora Security Advisory FEDORA-2019-1315f2dc3a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-1315f2dc3a");

  script_name(english:"Fedora 30 : wavpack (2019-1315f2dc3a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1315f2dc3a");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"wavpack-5.1.0-12.fc30")) flag++;
