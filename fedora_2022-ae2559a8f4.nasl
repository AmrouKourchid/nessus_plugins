...
# extracted from Fedora Security Advisory FEDORA-2022-ae2559a8f4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ae2559a8f4");

  script_name(english:"Fedora 35 : mingw-pixman (2022-ae2559a8f4)");
...
FEDORA-2022-ae2559a8f4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ae2559a8f4");
...
var pkgs = [
    {'reference':'mingw-pixman-0.42.2-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
