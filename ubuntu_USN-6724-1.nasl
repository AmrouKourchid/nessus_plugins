...
# extracted from Ubuntu Security Notice USN-6724-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6724-1");

  script_name(english:"Ubuntu 22.04 LTS / 23.10 : Linux kernel vulnerabilities (USN-6724-1)");
...
referenced in the USN-6724-1 advisory.
    ...
    - Networking core; (CVE-2023-52434, CVE-2023-52436, CVE-2023-52435, CVE-2023-52439, CVE-2023-52438)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6724-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-1011-starfive");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-1013-laptop");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-1017-aws");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-1017-gcp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-1018-azure");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-1018-azure-fde");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-1019-oem");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-1020-oracle");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-1020-oracle-64k");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-27-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-27-generic-64k");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-27-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-27-lowlatency-64k");
...
var kernel_mappings = {
  '22.04': {
    '6.5.0': {
      'generic': '6.5.0-27',
      'generic-64k': '6.5.0-27',
      'starfive': '6.5.0-1011',
      'gcp': '6.5.0-1017',
      'azure': '6.5.0-1018',
      'azure-fde': '6.5.0-1018',
      'oem': '6.5.0-1019',
      'oracle': '6.5.0-1020',
      'oracle-64k': '6.5.0-1020'
    }
  },
  '23.10': {
    '6.5.0': {
      'lowlatency': '6.5.0-27',
      'lowlatency-64k': '6.5.0-27',
      'starfive': '6.5.0-1011',
      'laptop': '6.5.0-1013',
      'aws': '6.5.0-1017',
      'gcp': '6.5.0-1017',
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6724-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-6610', 'CVE-2023-46838', 'CVE-2023-50431', 'CVE-2023-52429', 'CVE-2023-52434', 'CVE-2023-52435', 'CVE-2023-52436', 'CVE-2023-52438', 'CVE-2023-52439', 'CVE-2024-22705', 'CVE-2024-23850', 'CVE-2024-23851');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6724-1');
  }
  else
  {
