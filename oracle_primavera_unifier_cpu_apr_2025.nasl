...
if (description)
{
  ...
  script_name(english:"Oracle Primavera Unifier Multiple Vulnerabilities (Apr 2025 CPU)");
...
in the April 2025 CPU advisory.
  ...
  - Vulnerability in the Primavera Unifier product of Oracle Construction and Engineering (component: Document
    Management (Spring Framework)). Supported versions that are affected are 22.12.0-22.12.15,
    23.12.0-23.12.13 and 24.12.0-24.12.3. Easily exploitable vulnerability allows unauthenticated attacker
    with network access via HTTP to compromise Primavera Unifier. Successful attacks of this vulnerability can
    result in unauthorized access to critical data or complete access to all Primavera Unifier accessible
    data. (CVE-2024-38819)

  - Vulnerability in the Primavera Unifier product of Oracle Construction and Engineering (component: Not
    Provided (Spring Framework)). Supported versions that are affected are 22.12.0-22.12.15, 23.12.0-23.12.13
    and 24.12.0-24.12.3. Easily exploitable vulnerability allows unauthenticated attacker with network access
    to compromise Primavera Unifier. Successful attacks of this vulnerability can result in unauthorized
    update, insert or delete access to some of Primavera Unifier accessible data. (CVE-2024-38820)
...
var constraints = [
  { 'min_version' : '22.12.0', 'fixed_version' : '22.12.15.2', 'fixed_display' : '22.12.15.2 (Patch 37732013)' },
  { 'min_version' : '23.12.0', 'fixed_version' : '23.12.14',   'fixed_display' : '23.12.14 (Patch 37732019)' },
  { 'min_version' : '24.12.0', 'fixed_version' : '24.12.4',    'fixed_display' : '24.12.4 (Patch 37732025)' }
];
