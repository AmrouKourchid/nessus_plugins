...
# extracted from Oracle Linux Security Advisory ELSA-2024-9277.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : oci-seccomp-bpf-hook (ELSA-2024-9277)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9277.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected oci-seccomp-bpf-hook package.");
...
var pkgs = [
    {'reference':'oci-seccomp-bpf-hook-1.2.10-2.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'oci-seccomp-bpf-hook-1.2.10-2.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
