...
# AlmaLinux Security Advisory ALSA-2023:7711.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:7711");

  script_name(english:"AlmaLinux 9 : apr (ALSA-2023:7711)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-7711.html");
...
"Update the affected apr and / or apr-devel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:apr");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:apr-devel");
