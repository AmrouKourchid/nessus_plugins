...
# extracted from Red Hat Security Advisory RHSA-2023:3195. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3195");

  script_name(english:"RHEL 8 : jenkins and jenkins-2-plugins (RHSA-2023:3195)");
...
referenced in the RHSA-2023:3195 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3195.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0082a66c");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1535127a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3195");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL jenkins / jenkins-2-plugins packages based on the guidance in RHSA-2023:3195.");
  ...
  script_cwe_id(20, 79, 200, 266, 1188);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.12.1683009955-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-42889', 'CVE-2023-24422', 'CVE-2023-25761', 'CVE-2023-25762']},
      {'reference':'jenkins-2.387.1.1683009767-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-27903', 'CVE-2023-27904']}
    ]
  }
];
