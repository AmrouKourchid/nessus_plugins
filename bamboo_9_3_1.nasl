...
if (description)
{
  ...
  script_cve_id("CVE-2023-22506");

  script_name(english:"Atlassian Bamboo 8.0 < 9.2.3 / 9.3 < 9.3.1 RCE");

  script_set_attribute(attribute:"synopsis", value:
"The remote Atlassian Bamboo host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of Atlassian Bamboo installed on the remote host is prior to 9.2.3 or 9.3.1. It is, therefore, affected by
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/BAM-22400");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Atlassian Bamboo version 9.2.3, 9.3.1, or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-22506");
...
var constraints = [
  { 'min_version' : '8.0', 'fixed_version' : '9.2.3'},
  { 'min_version' : '9.3', 'fixed_version' : '9.3.1'}
];
