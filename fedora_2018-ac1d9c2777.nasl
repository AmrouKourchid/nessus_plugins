...
# extracted from Fedora Security Advisory FEDORA-2018-ac1d9c2777.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : zsh (2018-ac1d9c2777)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"- fix stack-based buffer overflow in
    utils.c:checkmailpath() (CVE-2018-1100)

  - fix stack-based buffer overflow in gen_matches_files()
    (CVE-2018-1083)

  - fix stack-based buffer overflow in exec.c:hashcmd()
    (CVE-2018-1071)
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ac1d9c2777");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"zsh-5.4.1-3.fc27")) flag++;
