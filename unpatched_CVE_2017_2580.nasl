...
if (description)
{
  ...
  script_cve_id("CVE-2017-2580");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-2580");
...
patch available.
  ...
  - An out-of-bounds write vulnerability was found in netpbm before 10.61. A maliciously crafted file could
    cause the application to crash or possibly allow code execution. (CVE-2017-2580)
