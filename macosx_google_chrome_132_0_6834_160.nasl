...
if (description)
{
  ...
  script_name(english:"Google Chrome < 132.0.6834.160 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote macOS host is prior to 132.0.6834.160. It is, therefore, affected
by a vulnerability as referenced in the 2025_01_stable-channel-update-for-desktop_28 advisory.
...
"Upgrade to Google Chrome version 132.0.6834.160 or later.");
...
google_chrome_check_version(fix:'132.0.6834.160', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
