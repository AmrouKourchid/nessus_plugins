...
# extracted from Fedora Security Advisory FEDORA-2023-c0bf8c0c4e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c0bf8c0c4e");

  script_name(english:"Fedora 38 : python3.12 (2023-c0bf8c0c4e)");
...
FEDORA-2023-c0bf8c0c4e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c0bf8c0c4e");
...
var pkgs = [
    {'reference':'python3.12-3.12.1-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
