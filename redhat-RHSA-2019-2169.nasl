...
the RHSA-2019:2169 advisory.
    ...
    * kernel: Bluetooth implementations may not sufficiently validate elliptic curve parameters during Diffie-
    Hellman key exchange (CVE-2018-5383)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2169.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ffcfa78e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2169");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1614159");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1654809");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1671610");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1698960");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1702330");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'iwl100-firmware-39.31.5.1-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl1000-firmware-39.31.5.1-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'iwl105-firmware-18.168.6.1-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl135-firmware-18.168.6.1-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl2000-firmware-18.168.6.1-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl2030-firmware-18.168.6.1-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl3160-firmware-22.0.7.0-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl3945-firmware-15.32.2.9-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl4965-firmware-228.61.2.24-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl5000-firmware-8.83.5.1_1-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl5150-firmware-8.24.2.2-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6000-firmware-9.221.4.1-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6000g2a-firmware-17.168.5.3-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6000g2b-firmware-17.168.5.2-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6050-firmware-41.28.5.1-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl7260-firmware-22.0.7.0-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl7265-firmware-22.0.7.0-72.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'linux-firmware-20190429-72.gitddde598.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
