...
# extracted from Red Hat Security Advisory oci-register-machine. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : oci-register-machine (Unpatched Vulnerability) (deprecated)");
