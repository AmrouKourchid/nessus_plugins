...
# extracted from Fedora Security Advisory FEDORA-2023-a2922bf669
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a2922bf669");

  script_name(english:"Fedora 37 : java-1.8.0-openjdk (2023-a2922bf669)");
...
FEDORA-2023-a2922bf669 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a2922bf669");
...
var pkgs = [
    {'reference':'java-1.8.0-openjdk-1.8.0.382.b05-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
