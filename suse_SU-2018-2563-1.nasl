...
# extracted from SUSE update advisory SUSE-SU-2018:2563-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : spice (SUSE-SU-2018:2563-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5e4d7a0a");
...
patch sdksp4-spice-13762=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-spice-13762=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-spice-13762=1");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"libspice-server1-0.12.4-15.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"i586", reference:"libspice-server1-0.12.4-15.1")) flag++;
