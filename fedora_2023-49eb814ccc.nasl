...
# extracted from Fedora Security Advisory FEDORA-2023-49eb814ccc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-49eb814ccc");

  script_name(english:"Fedora 36 : moodle (2023-49eb814ccc)");
...
FEDORA-2023-49eb814ccc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-49eb814ccc");
...
"Update the affected moodle package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-30944");
...
var pkgs = [
    {'reference':'moodle-3.11.14-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
