...
# extracted from Fedora Security Advisory FEDORA-2024-638f25a317
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-638f25a317");

  script_name(english:"Fedora 39 : rust-h2 (2024-638f25a317)");
...
FEDORA-2024-638f25a317 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-638f25a317");
...
var pkgs = [
    {'reference':'rust-h2-0.3.26-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
