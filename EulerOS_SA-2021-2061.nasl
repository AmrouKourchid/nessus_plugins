...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : golang (EulerOS-SA-2021-2061)");
...
vulnerability :
  ...
  - encoding/xml in Go before 1.15.9 and 1.16.x before
    1.16.1 has an infinite loop if a custom TokenReader
    (for xml.NewTokenDecoder) returns EOF in the middle of
    an element. This can occur in the Decode,
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2061
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be98a540");
...
pkgs = ["golang-1.13.3-10.h7.eulerosv2r9",
        "golang-devel-1.13.3-10.h7.eulerosv2r9",
        "golang-help-1.13.3-10.h7.eulerosv2r9"];
