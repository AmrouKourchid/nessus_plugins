...
# extracted from Red Hat Security Advisory RHSA-2025:1191. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1191");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (python-waitress) (RHSA-2025:1191)");
...
referenced in the RHSA-2025:1191 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1191.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d380fa2b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1191");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1 (python-waitress) package based on the guidance in RHSA-2025:1191.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-waitress-2.0.0-4.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
