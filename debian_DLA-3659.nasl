...
# extracted from Debian Security Advisory dla-3659. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3659 : gimp - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-30067");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/gimp");
...
"Upgrade the gimp packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:gimp-python");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'gimp', 'reference': '2.10.8-2+deb10u1'},
    {'release': '10.0', 'prefix': 'gimp-data', 'reference': '2.10.8-2+deb10u1'},
    {'release': '10.0', 'prefix': 'gimp-python', 'reference': '2.10.8-2+deb10u1'},
    {'release': '10.0', 'prefix': 'libgimp2.0', 'reference': '2.10.8-2+deb10u1'},
    {'release': '10.0', 'prefix': 'libgimp2.0-dev', 'reference': '2.10.8-2+deb10u1'},
    {'release': '10.0', 'prefix': 'libgimp2.0-doc', 'reference': '2.10.8-2+deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gimp / gimp-data / gimp-python / libgimp2.0 / libgimp2.0-dev / etc');
}
