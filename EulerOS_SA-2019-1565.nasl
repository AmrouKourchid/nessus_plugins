...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : bash (EulerOS-SA-2019-1565)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1565
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?76b5a2a2");
...
pkgs = ["bash-4.2.46-30.h5.eulerosv2r7"];
