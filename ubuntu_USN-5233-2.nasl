...
# extracted from Ubuntu Security Notice USN-5233-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5233-2");

  script_name(english:"Ubuntu 16.04 ESM : ClamAV vulnerability (USN-5233-2)");
...
USN-5233-2 advisory.
    ...
    USN-5233-1 fixed a vulnerability in ClamAV. This update provides the corresponding update for Ubuntu 14.04
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5233-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'clamav', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'clamav-base', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'clamav-daemon', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'clamav-freshclam', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'clamav-milter', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'clamav-testfiles', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'clamdscan', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libclamav-dev', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libclamav9', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1', 'ubuntu_pro': TRUE}
];
