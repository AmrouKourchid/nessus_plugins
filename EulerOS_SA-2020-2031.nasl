...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : curl (EulerOS-SA-2020-2031)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2031
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58c60023");
...
pkgs = ["curl-7.61.1-2.h10.eulerosv2r8",
        "libcurl-7.61.1-2.h10.eulerosv2r8"];
