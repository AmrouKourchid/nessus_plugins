...
# extracted from Red Hat Security Advisory strongswan. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-9023", "CVE-2018-5388", "CVE-2021-41991");

  script_name(english:"RHEL 7 : strongswan (Unpatched Vulnerability) (deprecated)");
