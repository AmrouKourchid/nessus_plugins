...
# extracted from Fedora Security Advisory FEDORA-2023-0d4b3316f6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0d4b3316f6");

  script_name(english:"Fedora 38 : qt (2023-0d4b3316f6)");
...
FEDORA-2023-0d4b3316f6 advisory.

    Security fix for CVE-2023-34410

    ----

    Security fix for CVE-2023-32573
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0d4b3316f6");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:qt package.");
...
var pkgs = [
    {'reference':'qt-4.8.7-73.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
