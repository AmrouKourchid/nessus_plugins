...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Linux kernel (GKE) vulnerabilities (USN-5297-1)");
...
referenced in the USN-5297-1 advisory.
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5297-1');
}
