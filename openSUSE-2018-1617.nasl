...
# extracted from openSUSE Security Update openSUSE-2018-1617.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : polkit (openSUSE-2018-1617)");
...
if ( rpm_check(release:"SUSE42.3", reference:"libpolkit0-0.113-14.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libpolkit0-debuginfo-0.113-14.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"polkit-0.113-14.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"polkit-debuginfo-0.113-14.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"polkit-debugsource-0.113-14.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"polkit-devel-0.113-14.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"polkit-devel-debuginfo-0.113-14.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"typelib-1_0-Polkit-1_0-0.113-14.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libpolkit0-32bit-0.113-14.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libpolkit0-debuginfo-32bit-0.113-14.6.1") ) flag++;
