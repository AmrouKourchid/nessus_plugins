...
# extracted from Fedora Security Advisory FEDORA-2023-d88521bfc5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d88521bfc5");

  script_name(english:"Fedora 39 : clevis-pin-tpm2 / greetd / keyring-ima-signer / libkrun / etc (2023-d88521bfc5)");
...
FEDORA-2023-d88521bfc5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d88521bfc5");
...
var pkgs = [
    {'reference':'clevis-pin-tpm2-0.5.2-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'greetd-0.9.0-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'keyring-ima-signer-0.1.0-9.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libkrun-1.5.0-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mirrorlist-server-3.0.6-6.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nispor-1.2.10-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nmstate-2.2.10-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-afterburn-5.4.0-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-below-0.6.3-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-bodhi-cli-2.1.0-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-cargo-c-0.9.12-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-coreos-installer-0.17.0-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-fedora-update-feedback-2.1.2-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-git-delta-0.13.0-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-gst-plugin-reqwest-0.10.4-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-pore-0.1.8-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-rpm-sequoia-1.4.0-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-sequoia-octopus-librnp-1.4.1-8.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-sequoia-policy-config-0.6.0-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-sequoia-sq-0.26.0-7.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-sevctl-0.3.2-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-tealdeer-1.6.1-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-ybaas-0.0.10-7.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
