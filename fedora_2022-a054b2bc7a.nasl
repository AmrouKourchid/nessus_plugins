...
# extracted from Fedora Security Advisory FEDORA-2022-a054b2bc7a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-a054b2bc7a");

  script_name(english:"Fedora 37 : grafana (2022-a054b2bc7a)");
...
FEDORA-2022-a054b2bc7a advisory.
    ...
    * Sun Jun 19 2022 Robert-Andr Mauchin <zebob.m@gmail.com> - 7.5.15-3
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-a054b2bc7a");
...
var pkgs = [
    {'reference':'grafana-8.5.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
