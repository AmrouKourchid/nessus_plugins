...
# extracted from Debian Security Advisory dla-3545. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3545 : python3-flask-security - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3545
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3545-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed4301b7");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-23385");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/flask-security");
  script_set_attribute(attribute:"solution", value:
"Upgrade the python3-flask-security packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:python3-flask-security");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'python3-flask-security', 'reference': '1.7.5-2+deb10u1'}
];
