...
# extracted from Fedora Security Advisory FEDORA-2024-1230cb2cd6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1230cb2cd6");

  script_name(english:"Fedora 40 : mingw-python-idna (2024-1230cb2cd6)");
...
FEDORA-2024-1230cb2cd6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1230cb2cd6");
...
var pkgs = [
    {'reference':'mingw-python-idna-3.7-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
