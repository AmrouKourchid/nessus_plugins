...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / ipsec-tools (ELSA-2007-0342)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0342.html");
...
"Update the affected ipsec-tools package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-1841");
...
var pkgs = [
    {'reference':'ipsec-tools-0.6.5-8.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipsec-tools-0.6.5-8.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
