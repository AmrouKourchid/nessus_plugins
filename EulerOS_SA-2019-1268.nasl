...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : libidn (EulerOS-SA-2019-1268)");
...
following vulnerability :
  ...
  - The stringprep_utf8_nfkc_normalize function in
    ...
    UTF-8 data.i1/4^CVE-2016-6263i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1268
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a55b418");
...
"Update the affected libidn package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-6263");
