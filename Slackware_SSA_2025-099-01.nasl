...
# extracted from Slackware Security Advisory SSA:2025-099-01. The text
...
if (description)
{
  ...
  script_name(english:"Slackware Linux 15.0 python3  Vulnerability (SSA:2025-099-01)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Slackware Linux host is missing a security update to python3.");
  script_set_attribute(attribute:"description", value:
"The version of python3 installed on the remote host is prior to 3.9.22. It is, therefore, affected by a vulnerability as
referenced in the SSA:2025-099-01 advisory.

    New python3 packages are available for Slackware 15.0 to fix security issues.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf479cbb");
...
var flag = 0;
var constraints = [
    { 'fixed_version' : '3.9.22', 'product' : 'python3', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'i586' },
    { 'fixed_version' : '3.9.22', 'product' : 'python3', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'x86_64' }
];
