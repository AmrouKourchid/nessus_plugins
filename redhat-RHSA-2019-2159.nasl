...
# extracted from Red Hat Security Advisory RHSA-2019:2159. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2159");

  script_name(english:"RHEL 7 : unzip (RHSA-2019:2159)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2159.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?95811e67");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html/7.7_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc7115e8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2159");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1642931");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL unzip package based on the guidance in RHSA-2019:2159.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'unzip-6.0-20.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unzip-6.0-20.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unzip-6.0-20.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unzip-6.0-20.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
