...
if (description)
{
  ...
  script_cve_id("CVE-2019-10214", "CVE-2019-14378", "CVE-2019-9946");
...
referenced in the RHSA-2019:3403 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3403.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01e0c1c5");
  ...
  'container-tools:rhel8': [
    {
      ...
      'pkgs': [
        {'reference':'buildah-1.9.0-5.module+el8.1.0+4240+893c1ab8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'buildah-tests-1.9.0-5.module+el8.1.0+4240+893c1ab8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'cockpit-podman-4-1.module+el8.1.0+4081+b29780af', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'container-selinux-2.107-2.module+el8.1.0+4081+b29780af', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'containernetworking-plugins-0.8.1-2.module+el8.1.0+4081+b29780af', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'containers-common-0.1.37-5.module+el8.1.0+4240+893c1ab8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'fuse-overlayfs-0.4.1-1.module+el8.1.0+4081+b29780af', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'oci-systemd-hook-0.1.15-2.git2d0b8a3.module+el8.1.0+4081+b29780af', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'oci-umount-2.3.4-2.git87f9237.module+el8.1.0+4081+b29780af', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-1.4.2-5.module+el8.1.0+4240+893c1ab8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-docker-1.4.2-5.module+el8.1.0+4240+893c1ab8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-manpages-1.4.2-5.module+el8.1.0+4240+893c1ab8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-remote-1.4.2-5.module+el8.1.0+4240+893c1ab8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-tests-1.4.2-5.module+el8.1.0+4240+893c1ab8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-podman-api-1.2.0-0.1.gitd0a45fe.module+el8.1.0+4081+b29780af', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'runc-1.0.0-60.rc8.module+el8.1.0+4081+b29780af', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'skopeo-0.1.37-5.module+el8.1.0+4240+893c1ab8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'skopeo-tests-0.1.37-5.module+el8.1.0+4240+893c1ab8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'slirp4netns-0.3.0-4.module+el8.1.0+4306+1d917805', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'toolbox-0.0.4-1.module+el8.1.0+4081+b29780af', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
