...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : openldap (EulerOS-SA-2023-2939)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2939
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c9381695");
...
var pkgs = [
  "openldap-2.4.50-3.h14.eulerosv2r10",
  "openldap-clients-2.4.50-3.h14.eulerosv2r10",
  "openldap-servers-2.4.50-3.h14.eulerosv2r10"
];
