...
# extracted from Fedora Security Advisory FEDORA-2020-e2deb72e0f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : dotnet3.1 (2020-e2deb72e0f)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This update updates .NET Core 3.1 to SDK 3.1.108 and Runtime 3.1.8.

This update includes a fix for CVE-2020-1045

Release Notes:
https://github.com/dotnet/core/blob/master/release-notes/3.1/3.1.8/3.1
.8.md
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-e2deb72e0f");
  # https://github.com/dotnet/core/blob/master/release-notes/3.1/3.1.8/3.1.8.md
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d41ca37");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"dotnet3.1-3.1.108-1.fc32")) flag++;
