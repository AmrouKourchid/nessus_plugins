...
# extracted from Fedora Security Advisory FEDORA-2024-a4c978fa1c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a4c978fa1c");

  script_name(english:"Fedora 39 : python3.11 (2024-a4c978fa1c)");
...
FEDORA-2024-a4c978fa1c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a4c978fa1c");
...
var pkgs = [
    {'reference':'python3.11-3.11.9-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
