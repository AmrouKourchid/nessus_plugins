...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Elasticsearch PHSA-2020-1.0-0321");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'elasticsearch-6.8.12-1.ph1')) flag++;
