...
# extracted from Red Hat Security Advisory RHSA-2024:2891. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-45802", "CVE-2024-27316");
  script_xref(name:"RHSA", value:"2024:2891");

  script_name(english:"RHEL 8 : httpd:2.4 (RHSA-2024:2891)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for httpd:2.4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2891 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2891.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?302b5cda");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2891");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL httpd:2.4 package based on the guidance in RHSA-2024:2891.");
  ...
  'httpd:2.4': [
    {
      ...
      'pkgs': [
        {'reference':'httpd-2.4.37-56.module+el8.8.0+19808+379766d6.7', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-devel-2.4.37-56.module+el8.8.0+19808+379766d6.7', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-filesystem-2.4.37-56.module+el8.8.0+19808+379766d6.7', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-manual-2.4.37-56.module+el8.8.0+19808+379766d6.7', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-tools-2.4.37-56.module+el8.8.0+19808+379766d6.7', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_http2-1.15.7-8.module+el8.8.0+21773+20528f83.5', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ldap-2.4.37-56.module+el8.8.0+19808+379766d6.7', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_md-2.0.8-8.module+el8.3.0+6814+67d1e611', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_proxy_html-2.4.37-56.module+el8.8.0+19808+379766d6.7', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_session-2.4.37-56.module+el8.8.0+19808+379766d6.7', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ssl-2.4.37-56.module+el8.8.0+19808+379766d6.7', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
