...
# extracted from Red Hat Security Advisory RHSA-2023:3441. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-28235", "CVE-2023-32082");
  script_xref(name:"RHSA", value:"2023:3441");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.0 (etcd) (RHSA-2023:3441)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 17.0 (etcd).");
...
referenced in the RHSA-2023:3441 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2184441");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2208131");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3441.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3d2f2b0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3441");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.0 (etcd) package based on the guidance in RHSA-2023:3441.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'etcd-3.4.26-1.el9ost', 'cpu':'x86_64', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
