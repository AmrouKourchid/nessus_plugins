...
# extracted from Fedora Security Advisory FEDORA-2024-3d29b1647b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3d29b1647b");

  script_name(english:"Fedora 39 : chromium (2024-3d29b1647b)");
...
FEDORA-2024-3d29b1647b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3d29b1647b");
...
var pkgs = [
    {'reference':'chromium-129.0.6668.58-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
