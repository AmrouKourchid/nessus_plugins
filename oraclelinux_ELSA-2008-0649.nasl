...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : libxslt (ELSA-2008-0649)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0649.html");
...
"Update the affected libxslt, libxslt-devel and / or libxslt-python packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-2935");
...
var pkgs = [
    {'reference':'libxslt-1.1.17-2.0.1.el5_2.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-devel-1.1.17-2.0.1.el5_2.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-python-1.1.17-2.0.1.el5_2.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-1.1.17-2.0.1.el5_2.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-devel-1.1.17-2.0.1.el5_2.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-python-1.1.17-2.0.1.el5_2.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
