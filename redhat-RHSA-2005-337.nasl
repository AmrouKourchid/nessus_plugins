...
# extracted from Red Hat Security Advisory RHSA-2005:337. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2005:337");

  script_name(english:"RHEL 4 : thunderbird (RHSA-2005:337)");
...
referenced in the RHSA-2005:337 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_337.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3f0ba578");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=149883");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=150874");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:337");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2005:337.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-0399");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-1.0.2-1.4.1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-1.0.2-1.4.1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-1.0.2-1.4.1', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-1.0.2-1.4.1', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-1.0.2-1.4.1', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
