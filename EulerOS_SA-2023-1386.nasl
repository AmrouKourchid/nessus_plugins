...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : grub2 (EulerOS-SA-2023-1386)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1386
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4fbebbb9");
...
"Update the affected grub2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-27779");
...
var pkgs = [
  "grub2-common-2.04-16.h43.eulerosv2r10",
  "grub2-efi-x64-2.04-16.h43.eulerosv2r10",
  "grub2-efi-x64-modules-2.04-16.h43.eulerosv2r10",
  "grub2-pc-2.04-16.h43.eulerosv2r10",
  "grub2-pc-modules-2.04-16.h43.eulerosv2r10",
  "grub2-tools-2.04-16.h43.eulerosv2r10",
  "grub2-tools-efi-2.04-16.h43.eulerosv2r10",
  "grub2-tools-extra-2.04-16.h43.eulerosv2r10",
  "grub2-tools-minimal-2.04-16.h43.eulerosv2r10"
];
