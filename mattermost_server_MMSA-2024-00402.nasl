...
if (description)
{
  ...
  script_cve_id("CVE-2025-21088");
  script_xref(name:"IAVA", value:"2025-A-0017-S");

  script_name(english:"Mattermost Server 9.11.x < 9.11.6 / 10.0.x < 10.0.4 / 10.1.x < 10.1.4 / 10.2.x < 10.2.1 DoS (MMSA-2024-00402)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of Mattermost Server installed on the remote host is 9.11.x prior to 9.11.6, 10.0.x prior 
to 10.0.4, 10.1.x prior to 10.1.4, or 10.2.x prior to 10.2.0. It is, therefore, affected by a 
denial of service vulnerability due to a failure to properly validate the style of proto supplied to 
an action's style in post.props.attachments, which allows an attacker to crash the frontend via 
...
"Upgrade to Mattermost Server version 9.11.6, 10.0.4,  10.1.4, 10.2.1, 10.3.0, or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21088");
