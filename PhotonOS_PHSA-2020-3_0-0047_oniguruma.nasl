...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'oniguruma-6.9.3-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'oniguruma-devel-6.9.3-2.ph3')) flag++;
