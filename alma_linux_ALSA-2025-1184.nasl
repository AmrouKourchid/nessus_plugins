...
# AlmaLinux Security Advisory ALSA-2025:1184.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:1184");
  script_xref(name:"RHSA", value:"2025:1184");

  script_name(english:"AlmaLinux 9 : thunderbird (ALSA-2025:1184)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2025-1184.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1184");
...
var pkgs = [
    {'reference':'thunderbird-128.7.0-1.el9_5.alma.1', 'cpu':'aarch64', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'thunderbird-128.7.0-1.el9_5.alma.1', 'cpu':'ppc64le', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'thunderbird-128.7.0-1.el9_5.alma.1', 'cpu':'s390x', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'thunderbird-128.7.0-1.el9_5.alma.1', 'cpu':'x86_64', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE}
];
