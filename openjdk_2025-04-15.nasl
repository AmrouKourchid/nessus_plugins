...
if (description)
{
  ...
  script_name(english:"OpenJDK 8 <= 8u442 / 11.0.0 <= 11.0.26 / 17.0.0 <= 17.0.14 / 21.0.0 <= 21.0.6 / 24.0.0 <= 24.0.0 Multiple Vulnerabilities (2025-04-15)");

  script_set_attribute(attribute:"synopsis", value:
"OpenJDK is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenJDK installed on the remote host is 8 prior to 8u442 / 11.0.0 prior to 11.0.26 / 17.0.0 prior to
17.0.14 / 21.0.0 prior to 21.0.6 / 24.0.0 prior to 24.0.0. It is, therefore, affected by multiple vulnerabilities as
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://openjdk.java.net/groups/vulnerability/advisories/2025-04-15");
...
var constraints = [
  { 'min_version' : '8.0.0', 'max_version' : '8.0.442', 'fixed_display' : 'Upgrade to a version greater than 8u442' },
  { 'min_version' : '11.0.0', 'max_version' : '11.0.26', 'fixed_display' : 'Upgrade to a version greater than 11.0.26' },
  { 'min_version' : '17.0.0', 'max_version' : '17.0.14', 'fixed_display' : 'Upgrade to a version greater than 17.0.14' },
  { 'min_version' : '21.0.0', 'max_version' : '21.0.6', 'fixed_display' : 'Upgrade to a version greater than 21.0.6' },
  { 'min_version' : '24.0.0', 'max_version' : '24.0.0', 'fixed_display' : 'Upgrade to a version greater than 24.0.0' }
];
