...
if (description)
{
  ...
  script_cve_id("CVE-2017-15646");

  script_name(english:"Webmin < 1.860 Cross Site Scripting Vulnerability");
...
the remote host is prior to 1.860. It is, therefore, affected by 
...
"Upgrade to Webmin 1.860 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-15646");
