...
# extracted from Fedora Security Advisory FEDORA-2019-ec55814c1c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-ec55814c1c");

  script_name(english:"Fedora 29 : python-django (2019-ec55814c1c)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"fix CVE-2019-6975: Memory exhaustion in
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-ec55814c1c");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"python-django-2.0.13-1.fc29")) flag++;
