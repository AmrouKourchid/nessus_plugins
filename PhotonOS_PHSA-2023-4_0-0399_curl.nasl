...
# extracted from VMware Security Advisory PHSA-2023-4.0-0399. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-28322");
  script_xref(name:"IAVA", value:"2023-A-0259-S");

  script_name(english:"Photon OS 4.0: Curl PHSA-2023-4.0-0399");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the curl package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-399.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-28322");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-8.1.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-devel-8.1.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-libs-8.1.1-1.ph4')) flag++;
