...
# extracted from Debian Security Advisory dla-3614. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3614 : idle-python3.7 - security update");
...
dla-3614 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3614-1                debian-lts@lists.debian.org
    ...
    CVE ID         : CVE-2022-48560 CVE-2022-48564 CVE-2022-48565 CVE-2022-48566
                     CVE-2023-40217
    ...
    CVE-2022-48566
        ...
        discovered in the accumulator variable in hmac.compare_digest.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-48564");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'idle-python3.7', 'reference': '3.7.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'libpython3.7', 'reference': '3.7.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'libpython3.7-dbg', 'reference': '3.7.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'libpython3.7-dev', 'reference': '3.7.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'libpython3.7-minimal', 'reference': '3.7.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'libpython3.7-stdlib', 'reference': '3.7.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'libpython3.7-testsuite', 'reference': '3.7.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python3.7', 'reference': '3.7.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python3.7-dbg', 'reference': '3.7.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python3.7-dev', 'reference': '3.7.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python3.7-doc', 'reference': '3.7.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python3.7-examples', 'reference': '3.7.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python3.7-minimal', 'reference': '3.7.3-2+deb10u6'},
    {'release': '10.0', 'prefix': 'python3.7-venv', 'reference': '3.7.3-2+deb10u6'}
];
