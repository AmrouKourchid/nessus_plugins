...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Openssh PHSA-2025-4.0-0790");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-8.9p1-10.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-clients-8.9p1-10.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-server-8.9p1-10.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-socket-8.9p1-10.ph4')) flag++;
