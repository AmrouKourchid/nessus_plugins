...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Curl PHSA-2021-2.0-0349");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'curl-7.75.0-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'curl-devel-7.75.0-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'curl-libs-7.75.0-2.ph2')) flag++;
