...
# extracted from Red Hat Security Advisory RHSA-2024:7103. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7103");

  script_name(english:"RHEL 9 : grafana-pcp (RHSA-2024:7103)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7103.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52440689");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2310528");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7103");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana-pcp package based on the guidance in RHSA-2024:7103.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-pcp-3.2.0-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
