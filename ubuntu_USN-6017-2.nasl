...
# extracted from Ubuntu Security Notice USN-6017-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6017-2");
  script_xref(name:"IAVB", value:"2023-B-0023-S");

  script_name(english:"Ubuntu 23.04 : Ghostscript vulnerability (USN-6017-2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 23.04 host has packages installed that are affected by a vulnerability as referenced in the USN-6017-2
advisory.

    USN-6017-1 fixed vulnerabilities in Ghostscript. This update provides the corresponding updates for Ubuntu
    23.04.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6017-2");
...
var pkgs = [
    {'osver': '23.04', 'pkgname': 'ghostscript', 'pkgver': '10.0.0~dfsg1-0ubuntu1.1'},
    {'osver': '23.04', 'pkgname': 'ghostscript-x', 'pkgver': '10.0.0~dfsg1-0ubuntu1.1'},
    {'osver': '23.04', 'pkgname': 'libgs-common', 'pkgver': '10.0.0~dfsg1-0ubuntu1.1'},
    {'osver': '23.04', 'pkgname': 'libgs-dev', 'pkgver': '10.0.0~dfsg1-0ubuntu1.1'},
    {'osver': '23.04', 'pkgname': 'libgs10', 'pkgver': '10.0.0~dfsg1-0ubuntu1.1'},
    {'osver': '23.04', 'pkgname': 'libgs10-common', 'pkgver': '10.0.0~dfsg1-0ubuntu1.1'},
    {'osver': '23.04', 'pkgname': 'libgs9-common', 'pkgver': '10.0.0~dfsg1-0ubuntu1.1'}
];
