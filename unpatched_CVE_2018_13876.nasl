...
if (description)
{
  ...
  script_cve_id("CVE-2018-13876");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-13876");
...
patch available.
  ...
  - An issue was discovered in the HDF HDF5 1.8.20 library. There is a stack-based buffer overflow in the
    function H5FD_sec2_read in H5FDsec2.c, related to HDread. (CVE-2018-13876)
