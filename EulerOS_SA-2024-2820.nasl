...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-setuptools (EulerOS-SA-2024-2820)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2820
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b20f5376");
...
var pkgs = [
  "python-setuptools-40.4.3-4.h3.eulerosv2r9",
  "python3-setuptools-40.4.3-4.h3.eulerosv2r9"
];
