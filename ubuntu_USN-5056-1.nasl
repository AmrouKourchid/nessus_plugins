...
USN-5056-1 advisory.
    ...
    It was discovered that APR incorrectly handled certain inputs. An attacker could possibly use this issue
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libapr1', 'pkgver': '1.5.2-3ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libapr1-dev', 'pkgver': '1.5.2-3ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
