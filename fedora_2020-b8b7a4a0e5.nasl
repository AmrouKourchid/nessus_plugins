...
# extracted from Fedora Security Advisory FEDORA-2020-b8b7a4a0e5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-b8b7a4a0e5");

  script_name(english:"Fedora 30 : poppler (2020-b8b7a4a0e5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-b8b7a4a0e5");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"poppler-0.73.0-16.fc30")) flag++;
