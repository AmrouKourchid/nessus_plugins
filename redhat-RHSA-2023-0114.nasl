...
# extracted from Red Hat Security Advisory RHSA-2023:0114. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0114");

  script_name(english:"RHEL 8 : kernel-rt (RHSA-2023:0114)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for kernel-rt.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:0114 advisory.
    ...
    * The latest RHEL 8.7.z1 kernel changes need to be merged into the RT source tree to keep source parity
    between the two kernels. (BZ#2137411)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0114.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e61c6b74");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0114");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kernel-rt package based on the guidance in RHSA-2023:0114.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2023:0114');
  }
  else
  {
