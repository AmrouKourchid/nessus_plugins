...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2007.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : xstream (ALAS-2023-2007)");
...
as referenced in the ALAS2-2023-2007 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2007.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2022-41966.html");
...
var pkgs = [
    {'reference':'xstream-1.3.1-16.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xstream-javadoc-1.3.1-16.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
