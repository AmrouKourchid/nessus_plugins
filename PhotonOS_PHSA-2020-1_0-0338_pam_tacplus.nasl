...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Pam_Tacplus PHSA-2020-1.0-0338");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'pam_tacplus-1.6.1-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'pam_tacplus-devel-1.6.1-1.ph1')) flag++;
