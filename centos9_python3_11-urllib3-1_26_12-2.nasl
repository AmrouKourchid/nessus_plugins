...
if (description)
{
  ...
  script_name(english:"CentOS 9 : python3.11-urllib3-1.26.12-2.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for python3.11-urllib3.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has a package installed that is affected by a vulnerability as referenced in the
python3.11-urllib3-1.26.12-2.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=39905");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream python3.11-urllib3 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:python3.11-urllib3");
