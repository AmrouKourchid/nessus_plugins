...
# extracted from Fedora Security Advisory FEDORA-2018-f91531043d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : elfutils (2018-f91531043d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f91531043d");
...
"Update the affected elfutils package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-8769");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"elfutils-0.171-1.fc28")) flag++;
