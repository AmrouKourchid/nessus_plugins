...
# extracted from Fedora Security Advisory FEDORA-2018-3dfee621af.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-3dfee621af");

  script_name(english:"Fedora 28 : 1:wireshark (2018-3dfee621af)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-3dfee621af");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"wireshark-2.6.1-1.fc28", epoch:"1")) flag++;
