...
# extracted from Red Hat Security Advisory RHSA-2023:6372. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6372");

  script_name(english:"RHEL 9 : gdb (RHSA-2023:6372)");
...
the RHSA-2023:6372 advisory.

    The GNU Debugger (GDB) allows users to debug programs written in various programming languages including
    C, C++, and Fortran.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6372.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1fd7eb5a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2130624");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6372");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gdb package based on the guidance in RHSA-2023:6372.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gdb-minimal");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gdb-10.2-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdb-doc-10.2-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdb-gdbserver-10.2-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdb-headless-10.2-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdb-minimal-10.2-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gdb / gdb-doc / gdb-gdbserver / gdb-headless / gdb-minimal');
}
