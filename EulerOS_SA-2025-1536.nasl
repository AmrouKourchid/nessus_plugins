...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : rsync (EulerOS-SA-2025-1536)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1536
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc926595");
...
var pkgs = [
  "rsync-3.1.3-6.h10.eulerosv2r10"
];
