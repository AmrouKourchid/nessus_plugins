...
if (description)
{
  ...
  script_cve_id("CVE-2019-3867");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-3867 (deprecated)");
...
"n/a");
  ...
  script_set_cvss3_base_vector("CVSS:3.0/AV:P/AC:L/PR:N/UI:R/S:U/C:L/I:L/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-3867");
