...
# AlmaLinux Security Advisory ALSA-2024:3627.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:3627");

  script_name(english:"AlmaLinux 8 : kernel-rt (ALSA-2024:3627)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:3627 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-3627.html");
...
"Update the affected packages.");
  ...
  script_cwe_id(1050, 119, 125, 1260, 190, 20, 200, 203, 252, 362, 401, 402, 415, 416, 459, 476, 680, 703, 835, 99);
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for ALSA-2024:3627');
  }
  else
  {
