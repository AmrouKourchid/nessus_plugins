...
# extracted from Red Hat Security Advisory RHSA-2020:5165.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : chromium-browser (RHSA-2020:5165)");
...
RHSA-2020:5165 advisory.

  - Inappropriate implementation in V8 in Google Chrome prior to 86.0.4240.198 allowed a remote attacker to
    potentially exploit heap corruption via a crafted HTML page. (CVE-2020-16013)

  - Inappropriate implementation in base in Google Chrome prior to 86.0.4240.193 allowed a remote attacker who
    had compromised the renderer process to potentially perform a sandbox escape via a crafted HTML page.
    (CVE-2020-16016)

  - Use after free in site isolation in Google Chrome prior to 86.0.4240.198 allowed a remote attacker who had
...
var pkgs = [
    {'reference':'chromium-browser-86.0.4240.198-1.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
