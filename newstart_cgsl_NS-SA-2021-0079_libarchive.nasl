...
# extracted from ZTE advisory NS-SA-2021-0079. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : libarchive Vulnerability (NS-SA-2021-0079)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has libarchive packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0079");
...
pkgs = {
  'CGSL MAIN 6.02': [
    'bsdcat-3.3.2-9.el8',
    'bsdcat-debuginfo-3.3.2-9.el8',
    'bsdcpio-3.3.2-9.el8',
    'bsdcpio-debuginfo-3.3.2-9.el8',
    'bsdtar-3.3.2-9.el8',
    'bsdtar-debuginfo-3.3.2-9.el8',
    'libarchive-3.3.2-9.el8',
    'libarchive-debuginfo-3.3.2-9.el8',
    'libarchive-debugsource-3.3.2-9.el8',
    'libarchive-devel-3.3.2-9.el8'
  ]
};
