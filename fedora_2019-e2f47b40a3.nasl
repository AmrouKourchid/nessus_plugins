...
# extracted from Fedora Security Advisory FEDORA-2019-e2f47b40a3.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-e2f47b40a3");

  script_name(english:"Fedora 29 : libexif (2019-e2f47b40a3)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Fix for CVE-2018-20030
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e2f47b40a3");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1663878");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libexif-0.6.21-19.fc29")) flag++;
