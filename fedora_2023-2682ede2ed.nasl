...
# extracted from Fedora Security Advisory FEDORA-2023-2682ede2ed
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2682ede2ed");

  script_name(english:"Fedora 36 : mingw-freeimage (2023-2682ede2ed)");
...
FEDORA-2023-2682ede2ed advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2682ede2ed");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-freeimage package.");
...
var pkgs = [
    {'reference':'mingw-freeimage-3.19.0-0.14.svn1889.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
