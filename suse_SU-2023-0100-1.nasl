...
# SUSE update advisory SUSE-SU-2023:0100-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0100-1");

  script_name(english:"SUSE SLES12 Security Update : sudo (SUSE-SU-2023:0100-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-January/013478.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0b80ebbe");
...
var pkgs = [
    {'reference':'sudo-1.8.10p3-10.44.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']}
];
