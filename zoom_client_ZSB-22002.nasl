...
if (description)
{
  ...
  script_name(english:"Zoom Client for Meetings < 5.8.6 Vulnerability (ZSB-22002)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an application installed that is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Zoom Client for Meetings installed on the remote host is prior to 5.8.6. It is, therefore, affected by a
...
"Upgrade to Zoom Client for Meetings 5.8.6 or later.");
