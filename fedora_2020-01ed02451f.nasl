...
# extracted from Fedora Security Advisory FEDORA-2020-01ed02451f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-01ed02451f");

  script_name(english:"Fedora 30 : e2fsprogs (2020-01ed02451f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-01ed02451f");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"e2fsprogs-1.44.6-2.fc30")) flag++;
