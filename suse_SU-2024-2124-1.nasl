...
# SUSE update advisory SUSE-SU-2024:2124-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-46955", "CVE-2023-52628", "CVE-2024-26852");
  script_xref(name:"SuSE", value:"SUSE-SU-2024:2124-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 33 for SLE 15 SP3) (SUSE-SU-2024:2124-1)");
...
referenced in the SUSE-SU-2024:2124-1 advisory.

    This update for the Linux Kernel 4.12.14-122_162 fixes several issues.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1222118");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1223059");
  # https://lists.suse.com/pipermail/sle-security-updates/2024-June/018775.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?23256f73");
...
"Update the affected kernel-livepatch-5_3_18-150300_59_124-default and / or kgraft-patch-4_12_14-122_162-default
packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.162-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_162-default-14-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '5.3.18-150300.59.124-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_124-default-13-150300.2.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150300_59_124-default / etc');
}
