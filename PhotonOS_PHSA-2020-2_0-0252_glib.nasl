...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Glib PHSA-2020-2.0-0252");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glib-networking-2.50.0-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glib-networking-lang-2.50.0-2.ph2')) flag++;
