...
# extracted from Debian Security Advisory dla-2976. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2976-1 : gzip - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2976
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2976");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-1271");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/gzip");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'gzip', 'reference': '1.6-5+deb9u1'},
    {'release': '9.0', 'prefix': 'gzip-win32', 'reference': '1.6-5+deb9u1'}
];
