...
# extracted from Fedora Security Advisory FEDORA-2024-4862425658
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4862425658");

  script_name(english:"Fedora 39 : mingw-libxml2 (2024-4862425658)");
...
FEDORA-2024-4862425658 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4862425658");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-libxml2 package.");
...
var pkgs = [
    {'reference':'mingw-libxml2-2.12.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
