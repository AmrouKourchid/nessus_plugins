...
# extracted from F5 Networks BIG-IP Solution K33101555.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Nettle cryptography library vulnerability (K33101555)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K33101555 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K33101555");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K33101555.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '16.0.0-16.1.1','15.1.0-15.1.4','14.1.0-14.1.4'
    ],
    'unaffected': [
