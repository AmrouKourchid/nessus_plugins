...
# extracted from Debian Security Advisory dla-3530. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3530 : libssl-dev - security update");
...
dla-3530 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3530-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-3446");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-3817");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libssl-dev', 'reference': '1.1.1n-0+deb10u6'},
    {'release': '10.0', 'prefix': 'libssl-doc', 'reference': '1.1.1n-0+deb10u6'},
    {'release': '10.0', 'prefix': 'libssl1.1', 'reference': '1.1.1n-0+deb10u6'},
    {'release': '10.0', 'prefix': 'openssl', 'reference': '1.1.1n-0+deb10u6'}
];
