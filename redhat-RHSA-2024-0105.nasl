...
# extracted from Red Hat Security Advisory RHSA-2024:0105. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0105.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7c879df");
...
"Update the RHEL nss package based on the guidance in RHSA-2024:0105.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nss-3.90.0-4.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-devel-3.90.0-4.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-3.90.0-4.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-devel-3.90.0-4.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-freebl-3.90.0-4.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-freebl-devel-3.90.0-4.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-sysinit-3.90.0-4.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-tools-3.90.0-4.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-util-3.90.0-4.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-util-devel-3.90.0-4.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
