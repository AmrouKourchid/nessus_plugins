...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Critical Patch Update : apr2024_SRU11_3_36_33_1");

  script_set_attribute(attribute:"synopsis", value:
"The remote Solaris system is missing a security patch from CPU Apr2024.");
  script_set_attribute(attribute:"description", value:
"The version of Solaris installed on the remote host is prior to 11.3.36.33.1. It is, therefore, affected by a
vulnerability as referenced in the solaris11_apr2024_SRU11_3_36_33_1 advisory.

  - Vulnerability in the Oracle Solaris product of Oracle Systems (component: Utility). The supported version
    that is affected is 11. Difficult to exploit vulnerability allows low privileged attacker with logon to
    the infrastructure where Oracle Solaris executes to compromise Oracle Solaris. While the vulnerability is
    in Oracle Solaris, attacks may significantly impact additional products (scope change). Successful attacks
    of this vulnerability can result in takeover of Oracle Solaris. (CVE-2024-21059)
...
var fix_release = "0.5.11-0.175.3.36.0.33.1";

var flag = 0;

if (solaris_check_release(release:fix_release, sru:"11.3.36.33.1") > 0) flag++;
