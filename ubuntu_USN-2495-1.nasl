...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Oxide vulnerabilities (USN-2495-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2495-1 advisory.

    A use-after-free bug was discovered in the DOM implementation in Blink. If a user were tricked in to
    ...
    It was discovered that V8 did not properly consider frame access restrictions when throwing exceptions in
    some circumstances. If a user were tricked in to opening a specially crafted website, an attacker could
    potentially exploit this to bypass same origin restrictions. (CVE-2015-1210)

    It was discovered that Chromium did not properly restrict the URI scheme during ServiceWorker
    registration. If a user were tricked in to downloading and opening a specially crafted HTML file, an
    attacker could potentially exploit this to bypass security restrictions. (CVE-2015-1211)
    ...
    program. (CVE-2015-1212)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2495-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-1212");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2015-1210");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'liboxideqt-qmlplugin', 'pkgver': '1.4.3-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'liboxideqtcore0', 'pkgver': '1.4.3-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'liboxideqtquick0', 'pkgver': '1.4.3-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'oxideqmlscene', 'pkgver': '1.4.3-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'oxideqt-chromedriver', 'pkgver': '1.4.3-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'oxideqt-codecs', 'pkgver': '1.4.3-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'oxideqt-codecs-extra', 'pkgver': '1.4.3-0ubuntu0.14.04.1'}
];
