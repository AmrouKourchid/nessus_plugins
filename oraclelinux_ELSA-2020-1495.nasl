...
# extracted from Red Hat Security Advisory RHSA-2020:1495 and 
# Oracle Linux Security Advisory ELSA-2020-1495 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : thunderbird (ELSA-2020-1495)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1495.html");
...
var pkgs = [
    {'reference':'thunderbird-68.7.0-1.0.1.el8_1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
