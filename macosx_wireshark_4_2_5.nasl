...
if (description)
{
  ...
  script_name(english:"Wireshark 4.2.x < 4.2.5 Multiple Vulnerabilities (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote macOS / Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote macOS / Mac OS X host is prior to 4.2.5. It is, therefore, affected by
multiple vulnerabilities as referenced in the wireshark-4.2.5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/docs/relnotes/wireshark-4.2.5.html");
...
"Upgrade to Wireshark version 4.2.5 or later.");
...
var constraints = [
  { 'min_version' : '4.2.0', 'max_version' : '4.2.4', 'fixed_version' : '4.2.5' }
];
