...
vulnerabilities as referenced in the mfsa2019-08 advisory.
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'60.6', min:'60.0.0', severity:SECURITY_HOLE);
