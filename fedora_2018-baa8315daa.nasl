...
# extracted from Fedora Security Advisory FEDORA-2018-baa8315daa.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : mingw-LibRaw (2018-baa8315daa)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-baa8315daa");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"mingw-LibRaw-0.18.13-2.fc27")) flag++;
