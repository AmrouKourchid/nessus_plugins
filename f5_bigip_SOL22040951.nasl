...
# extracted from F5 Networks BIG-IP Solution K22040951.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : systemd-journald vulnerability (K22040951)");
...
A local attacker may be able to cause excessive resource consumption
on the BIG-IP system, potentially leading to a failover event.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K22040951");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K22040951.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '15.1.0','14.1.2.1-14.1.2.4'
    ],
    'unaffected': [
      '16.0.0','15.1.1','14.1.2.5'
    ],
  },
  'AM': {
    'affected': [
