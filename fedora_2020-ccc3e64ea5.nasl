...
# extracted from Fedora Security Advisory FEDORA-2020-ccc3e64ea5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-ccc3e64ea5");

  script_name(english:"Fedora 30 : 2:podman (2020-ccc3e64ea5)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"use crun only for f31+

----

Suggests: crun for f30

----

bump to v1.8.0, Security fix for CVE-2020-8945

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-ccc3e64ea5");
  script_set_attribute(attribute:"solution", value:
"Update the affected 2:podman package.");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"podman-1.8.0-4.fc30", epoch:"2")) flag++;
