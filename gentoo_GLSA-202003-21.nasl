...
# extracted from Gentoo Linux Security Advisory GLSA 202003-21.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2019-16884", "CVE-2019-19921", "CVE-2019-5736");
  script_xref(name:"GLSA", value:"202003-21");

  script_name(english:"GLSA-202003-21 : runC: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-21
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-21");
...
if (qpkg_check(package:"app-emulation/runc", unaffected:make_list("ge 1.0.0_rc10"), vulnerable:make_list("lt 1.0.0_rc10"))) flag++;
