...
# extracted from Fedora Security Advisory FEDORA-2023-9adeb354af
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9adeb354af");

  script_name(english:"Fedora 38 : samba (2023-9adeb354af)");
...
FEDORA-2023-9adeb354af advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9adeb354af");
...
var pkgs = [
    {'reference':'samba-4.18.9-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
