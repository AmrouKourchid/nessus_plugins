...
# extracted from Fedora Security Advisory FEDORA-2024-36d2be00d0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-36d2be00d0");

  script_name(english:"Fedora 38 : wpa_supplicant (2024-36d2be00d0)");
...
FEDORA-2024-36d2be00d0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-36d2be00d0");
...
var pkgs = [
    {'reference':'wpa_supplicant-2.10-7.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
