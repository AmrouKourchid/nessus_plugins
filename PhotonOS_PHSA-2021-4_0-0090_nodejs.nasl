...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Nodejs PHSA-2021-4.0-0090");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nodejs-14.17.5-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nodejs-devel-14.17.5-1.ph4')) flag++;
