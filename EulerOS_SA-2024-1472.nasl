...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : libXpm (EulerOS-SA-2024-1472)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1472
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?14b1e487");
...
var pkgs = [
  "libXpm-3.5.12-11.h4.eulerosv2r9"
];
