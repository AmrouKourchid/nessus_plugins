...
# extracted from Red Hat Security Advisory RHSA-2019:4097. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:4097");

  script_name(english:"RHEL 7 : OpenShift Container Platform 4.2 jenkins-2-plugins (RHSA-2019:4097)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.2 jenkins-2-plugins.");
...
referenced in the RHSA-2019:4097 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_4097.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d0b8481d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:4097");
...
"Update the RHEL OpenShift Container Platform 4.2 jenkins-2-plugins package based on the guidance in RHSA-2019:4097.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.2.1574873592-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
