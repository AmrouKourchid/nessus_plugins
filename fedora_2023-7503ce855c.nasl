...
# extracted from Fedora Security Advisory FEDORA-2023-7503ce855c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7503ce855c");

  script_name(english:"Fedora 38 : libX11 (2023-7503ce855c)");
...
FEDORA-2023-7503ce855c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7503ce855c");
...
var pkgs = [
    {'reference':'libX11-1.8.6-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
