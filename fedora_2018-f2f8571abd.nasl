...
# extracted from Fedora Security Advisory FEDORA-2018-f2f8571abd.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : sos-collector (2018-f2f8571abd)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f2f8571abd");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"sos-collector-1.5-3.fc27")) flag++;
