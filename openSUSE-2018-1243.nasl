...
# extracted from openSUSE Security Update openSUSE-2018-1243.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : net-snmp (openSUSE-2018-1243)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1027353");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1081164");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1102775");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1111122");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libsnmp30 / libsnmp30-debuginfo / net-snmp / net-snmp-debuginfo / etc");
}
