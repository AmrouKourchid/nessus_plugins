...
# extracted from VMware Security Advisory PHSA-2024-5.0-0240. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Gnutls PHSA-2024-5.0-0240");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the gnutls package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-240.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'gnutls-3.7.10-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'gnutls-devel-3.7.10-3.ph5')) flag++;
