...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : pcre (EulerOS-SA-2019-1802)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1802
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ea7cb85");
...
pkgs = ["pcre-8.32-17.h9.eulerosv2r7",
        "pcre-devel-8.32-17.h9.eulerosv2r7"];
