...
# extracted from Fedora Security Advisory FEDORA-2022-9100b7aafd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-9100b7aafd");

  script_name(english:"Fedora 35 : xorg-x11-server (2022-9100b7aafd)");
...
FEDORA-2022-9100b7aafd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-9100b7aafd");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-9.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
