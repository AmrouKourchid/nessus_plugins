...
# extracted from Fedora Security Advisory FEDORA-2023-4926525509
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4926525509");

  script_name(english:"Fedora 37 : caddy (2023-4926525509)");
...
FEDORA-2023-4926525509 advisory.

    This update takes caddy from 2.5.2 to 2.6.4. The primary purpose is to resolve CVE-2022-41721. This is a
    fairly significant upgrade with lots of new features and fixes, but after reviewing the upstream release
    notes I believe it should comply with the Fedora updates policy. The upgrade warnings in the release notes
    are described as either backwards compatible, marking a directive as deprecated without removing it, or
    changes to features that are marked as experimental.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4926525509");
...
var pkgs = [
    {'reference':'caddy-2.6.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
