...
if (description)
{
  ...
  script_cve_id("CVE-2019-10166", "CVE-2019-10167", "CVE-2019-10168");

  script_name(english:"Photon OS 3.0: Libvirt PHSA-2019-3.0-0032");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-10168");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-4.7.0-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-debuginfo-4.7.0-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-devel-4.7.0-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-docs-4.7.0-4.ph3')) flag++;
