...
# extracted from Red Hat Security Advisory RHSA-2025:3615. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3615");

  script_name(english:"RHEL 8 : libxslt (RHSA-2025:3615)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libxslt.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:3615 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3615.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ec7ea85e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3615");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxslt-1.1.32-6.1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxslt-devel-1.1.32-6.1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
