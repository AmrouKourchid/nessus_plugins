...
# extracted from Ubuntu Security Notice USN-3304-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3304-1");

  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Sudo vulnerability (USN-3304-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3304-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'sudo', 'pkgver': '1.8.9p5-1ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'sudo-ldap', 'pkgver': '1.8.9p5-1ubuntu1.4'},
    {'osver': '16.04', 'pkgname': 'sudo', 'pkgver': '1.8.16-0ubuntu1.4'},
    {'osver': '16.04', 'pkgname': 'sudo-ldap', 'pkgver': '1.8.16-0ubuntu1.4'}
];
