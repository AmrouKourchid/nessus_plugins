...
# extracted from Ubuntu Security Notice USN-5355-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5355-2");

  script_name(english:"Ubuntu 16.04 ESM : zlib vulnerability (USN-5355-2)");
...
USN-5355-2 advisory.
    ...
    USN-5355-1 fixed a vulnerability in zlib. This update provides the corresponding update for Ubuntu 14.04
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5355-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'lib32z1', 'pkgver': '1:1.2.8.dfsg-2ubuntu4.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'lib32z1-dev', 'pkgver': '1:1.2.8.dfsg-2ubuntu4.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'lib64z1', 'pkgver': '1:1.2.8.dfsg-2ubuntu4.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'lib64z1-dev', 'pkgver': '1:1.2.8.dfsg-2ubuntu4.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libx32z1', 'pkgver': '1:1.2.8.dfsg-2ubuntu4.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libx32z1-dev', 'pkgver': '1:1.2.8.dfsg-2ubuntu4.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'zlib1g', 'pkgver': '1:1.2.8.dfsg-2ubuntu4.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'zlib1g-dev', 'pkgver': '1:1.2.8.dfsg-2ubuntu4.3+esm1', 'ubuntu_pro': TRUE}
];
