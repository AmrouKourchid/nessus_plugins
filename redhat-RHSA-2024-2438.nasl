...
# extracted from Red Hat Security Advisory RHSA-2024:2438. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2438");

  script_name(english:"RHEL 9 : pam (RHSA-2024:2438)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for pam.");
...
the RHSA-2024:2438 advisory.

    Pluggable Authentication Modules (PAM) provide a system to set up authentication policies without the need
    to recompile programs to handle authentication.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2438.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?51b9eb21");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2438");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2257722");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-16727");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-20943");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-22300");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5099");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5100");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pam package based on the guidance in RHSA-2024:2438.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pam-docs");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pam-1.5.1-19.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pam-devel-1.5.1-19.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pam-docs-1.5.1-19.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'pam / pam-devel / pam-docs');
}
