...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : freetype (EulerOS-SA-2023-2558)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2558
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f1975921");
...
var pkgs = [
  "freetype-2.10.2-2.h5.eulerosv2r10"
];
