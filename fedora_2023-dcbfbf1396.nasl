...
# extracted from Fedora Security Advisory FEDORA-2023-dcbfbf1396
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dcbfbf1396");

  script_name(english:"Fedora 38 : trafficserver (2023-dcbfbf1396)");
...
FEDORA-2023-dcbfbf1396 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dcbfbf1396");
...
var pkgs = [
    {'reference':'trafficserver-9.2.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
