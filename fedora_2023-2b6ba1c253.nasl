...
# extracted from Fedora Security Advisory FEDORA-2023-2b6ba1c253
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2b6ba1c253");

  script_name(english:"Fedora 37 : chromium (2023-2b6ba1c253)");
...
FEDORA-2023-2b6ba1c253 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2b6ba1c253");
...
var pkgs = [
    {'reference':'chromium-112.0.5615.165-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
