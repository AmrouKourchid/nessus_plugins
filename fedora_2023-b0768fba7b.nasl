...
# extracted from Fedora Security Advisory FEDORA-2023-b0768fba7b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b0768fba7b");

  script_name(english:"Fedora 38 : redis (2023-b0768fba7b)");
...
FEDORA-2023-b0768fba7b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b0768fba7b");
...
var pkgs = [
    {'reference':'redis-7.0.9-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
