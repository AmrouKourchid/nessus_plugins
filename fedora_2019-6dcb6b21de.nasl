...
# extracted from Fedora Security Advisory FEDORA-2019-6dcb6b21de.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-6dcb6b21de");

  script_name(english:"Fedora 30 : pspp (2019-6dcb6b21de)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-6dcb6b21de");
  script_set_attribute(attribute:"solution", value:
"Update the affected pspp package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-9211");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"pspp-1.2.0-2.fc30")) flag++;
