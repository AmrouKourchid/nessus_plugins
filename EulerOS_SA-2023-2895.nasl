...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : ghostscript (EulerOS-SA-2023-2895)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2895
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2d8987a7");
...
var pkgs = [
  "ghostscript-9.52-1.h8.eulerosv2r9",
  "ghostscript-help-9.52-1.h8.eulerosv2r9"
];
