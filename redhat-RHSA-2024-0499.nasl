...
# extracted from Red Hat Security Advisory RHSA-2024:0499. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0499");

  script_name(english:"RHEL 9 : libssh (RHSA-2024:0499)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0499.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aa1bea03");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2254210");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0499");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libssh package based on the guidance in RHSA-2024:0499.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libssh-0.10.4-9.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-config-0.10.4-9.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-devel-0.10.4-9.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
