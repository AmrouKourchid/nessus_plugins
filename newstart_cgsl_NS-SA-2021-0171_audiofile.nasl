...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : audiofile Multiple Vulnerabilities (NS-SA-2021-0171)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has audiofile packages installed that are affected
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2018-13440");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2018-17095");
...
for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:audiofile");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:audiofile-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:audiofile");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:audiofile-devel");
