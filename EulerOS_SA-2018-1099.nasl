...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : binutils (EulerOS-SA-2018-1099)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1099
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25f9a75b");
...
pkgs = ["binutils-2.23.52.0.1-55.h12",
        "binutils-devel-2.23.52.0.1-55.h12"];
