...
"The remote Red Hat host is missing a security update for perl-DBI.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_072.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?97c6e6d3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=145577");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:072");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL perl-DBI package based on the guidance in RHSA-2005:072.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-0077");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'perl-DBI-1.40-8', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-DBI-1.40-8', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-DBI-1.40-8', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-DBI-1.40-8', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-DBI-1.40-8', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
