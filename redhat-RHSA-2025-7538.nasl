...
# extracted from Red Hat Security Advisory RHSA-2025:7538. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7538");

  script_name(english:"RHEL 9 : redis:7 (RHSA-2025:7538)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for redis:7.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7538.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b52983ff");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7538");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis:7 package based on the guidance in RHSA-2025:7538.");
  ...
  'redis:7': [
    {
      ...
      'pkgs': [
        {'reference':'redis-7.0.12-1.module+el9.4.0+23090+d27b104d.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-7.0.12-1.module+el9.4.0+23090+d27b104d.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-doc-7.0.12-1.module+el9.4.0+23090+d27b104d.3', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
