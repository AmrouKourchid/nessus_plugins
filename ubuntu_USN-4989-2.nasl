...
# extracted from Ubuntu Security Notice USN-4989-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4989-2");

  script_name(english:"Ubuntu 16.04 ESM : BlueZ vulnerabilities (USN-4989-2)");
...
the USN-4989-2 advisory.

    USN-4989-1 fixed several vulnerabilities in BlueZ. This update provides the corresponding update for
    Ubuntu 16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4989-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'bluetooth', 'pkgver': '5.37-0ubuntu5.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'bluez', 'pkgver': '5.37-0ubuntu5.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'bluez-cups', 'pkgver': '5.37-0ubuntu5.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'bluez-hcidump', 'pkgver': '5.37-0ubuntu5.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'bluez-obexd', 'pkgver': '5.37-0ubuntu5.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'bluez-tests', 'pkgver': '5.37-0ubuntu5.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libbluetooth-dev', 'pkgver': '5.37-0ubuntu5.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libbluetooth3', 'pkgver': '5.37-0ubuntu5.3+esm1', 'ubuntu_pro': TRUE}
];
