...
# extracted from Fedora Security Advisory FEDORA-2023-f1c8e4c1cc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f1c8e4c1cc");
  script_xref(name:"IAVA", value:"2023-A-0521-S");

  script_name(english:"Fedora 39 : exim (2023-f1c8e4c1cc)");
...
FEDORA-2023-f1c8e4c1cc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f1c8e4c1cc");
...
var pkgs = [
    {'reference':'exim-4.96.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
