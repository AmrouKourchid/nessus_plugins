...
if (description)
{
  ...
  script_cve_id("CVE-2024-53115");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-53115");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/vmwgfx: avoid null_ptr_deref in
    vmw_framebuffer_surface_create_handle The 'vmw_user_object_buffer' function may return NULL with incorrect
    inputs. To avoid possible null pointer dereference, add a check whether the 'bo' is NULL in the
    vmw_framebuffer_surface_create_handle. (CVE-2024-53115)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53115");
