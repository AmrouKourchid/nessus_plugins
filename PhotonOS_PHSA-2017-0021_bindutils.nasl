...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Bindutils PHSA-2017-0021");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'bindutils-9.10.4-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'bindutils-debuginfo-9.10.4-2.ph1')) flag++;
