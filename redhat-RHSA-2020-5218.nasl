...
# extracted from Red Hat Security Advisory RHSA-2020:5218. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5218");

  script_name(english:"RHEL 8 : Red Hat Virtualization (RHSA-2020:5218)");
...
the RHSA-2020:5218 advisory.
    ...
    The following packages have been upgraded to a later upstream version: imgbased (1.2.13), redhat-release-
    virtualization-host (4.4.3), redhat-virtualization-host (4.4.3). (BZ#1814517, BZ#1868293, BZ#1886484)
    ...
    * [security] gnutls_set_default_priority() (and thus Cockpit logins) fails when selecting VPP profile
    during RHVH installation (BZ#1835661)

    * Unable to upgrade from rhvh 4.4.1 to 4.4.2 as block storage domains are detected as local storage
    domains. (BZ#1886647)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5218.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?334f527d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5218");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1801998");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1833254");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1868293");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1886484");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1886647");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1886695");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.4.3-20201116.0.el8_3', 'release':'8', 'el_string':'el8_3', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
