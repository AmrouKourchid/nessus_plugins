...
if (description)
{
  ...
  script_name(english:"Canonical Ubuntu Linux SEoL (4.10.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Canonical Ubuntu Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Canonical Ubuntu Linux is 4.10.x. It is, therefore, no longer maintained by its vendor or
provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/blog/ubuntu-4-10-end-of-support-cycle");
...
"Upgrade to a version of Canonical Ubuntu Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2006/04/30");
...
var constraints = [
  { max_branch : '4.10', min_branch : '4.10', seol : 20060430 }
];
