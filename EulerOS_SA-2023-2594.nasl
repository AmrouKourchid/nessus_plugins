...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : perl (EulerOS-SA-2023-2594)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2594
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?188bedb2");
...
var pkgs = [
  "perl-5.28.0-434.h10.eulerosv2r9",
  "perl-libs-5.28.0-434.h10.eulerosv2r9"
];
