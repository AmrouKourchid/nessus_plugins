...
number.");
  # https://supportportal.juniper.net/s/article/2022-01-Security-Bulletin-Junos-OS-MX104-might-become-unresponsive-if-the-out-of-band-management-port-receives-a-flood-of-traffic-CVE-2022-22161
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c0b4d591");
...
var vuln_ranges = [
  {'min_ver':'0.0', 'fixed_ver':'18.3R3-S6', 'model':'^MX104'},
