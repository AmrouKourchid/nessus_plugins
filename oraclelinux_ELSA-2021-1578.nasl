...
ELSA-2021-1578 advisory.
    ...
    - scsi: iscsi: Restrict sessions and handles to admin capabilities (Chris Leech) [1930809]
    {CVE-2021-27364}
    - vt: Disable KD_FONT_OP_COPY (Dave Airlie) [1903937] {CVE-2020-28974}
    - fix regression in 'epoll: Keep a reference on files added to the check list' (Carlos Maiolino) [1920776]
    {CVE-2020-0466}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-stablelists-4.18.0-305.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-stablelists-4.18.0'},
