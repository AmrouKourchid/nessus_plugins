...
# extracted from Red Hat Security Advisory RHSA-2016:2101. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2016-5325", "CVE-2016-1000232");
  script_xref(name:"RHSA", value:"2016:2101");

  script_name(english:"RHEL 7 : nodejs and nodejs-tough-cookie (RHSA-2016:2101)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2016:2101 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_2101.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?74ee9210");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:2101");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1382854");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-5325");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nodejs-0.10.47-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'nodejs-devel-0.10.47-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'nodejs-docs-0.10.47-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'nodejs / nodejs-devel / nodejs-docs / nodejs-tough-cookie');
}
