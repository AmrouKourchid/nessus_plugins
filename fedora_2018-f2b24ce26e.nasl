...
# extracted from Fedora Security Advisory FEDORA-2018-f2b24ce26e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : phpMyAdmin (2018-f2b24ce26e)");
...
version 4.8.2. Among other bug fixes, this contains a security fix for
an issue that can be exploited when importing files.

A flaw was discovered with how warning messages are displayed while
importing a file. This attack requires a specially crafted file but
can allow an attacker to trick the user in to executing a cross-site
...
bug fixes and more as part of our regular release cycle :
  ...
  - Two-factor authentication (2FA) fails if the GD PHP
    library is missing
  ...
  - PHP 7.3 warning: 'continue' in 'switch' is equal to
    'break'
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f2b24ce26e");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"phpMyAdmin-4.8.3-1.fc28")) flag++;
