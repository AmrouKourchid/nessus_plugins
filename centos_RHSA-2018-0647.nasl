...
# extracted from Red Hat Security Advisory RHSA-2018:0647 and 
# CentOS Errata and Security Advisory 2018:0647 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : thunderbird (CESA-2018:0647)");
...
reporters.");
  # https://lists.centos.org/pipermail/centos-announce/2018-April/022813.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aa07c233");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-52.7.0-1.el6.centos", allowmaj:TRUE)) flag++;
