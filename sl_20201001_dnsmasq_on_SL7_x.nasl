...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : dnsmasq on SL7.x x86_64 (20201001)");
...
"Security Fix(es) :
  ...
  - dnsmasq: memory leak in the create_helper() function in
    /src/helper.c (CVE-2019-14834)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=17636
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c98a22e6");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dnsmasq-2.76-16.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dnsmasq-debuginfo-2.76-16.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dnsmasq-utils-2.76-16.el7")) flag++;
