...
# extracted from Fedora Security Advisory FEDORA-2024-bc590cb3f1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bc590cb3f1");

  script_name(english:"Fedora 38 : R (2024-bc590cb3f1)");
...
FEDORA-2024-bc590cb3f1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bc590cb3f1");
  script_set_attribute(attribute:"solution", value:
"Update the affected R package.");
...
var pkgs = [
    {'reference':'R-4.3.3-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
