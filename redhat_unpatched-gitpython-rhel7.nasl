...
# extracted from Red Hat Security Advisory gitpython. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-40267", "CVE-2023-41040");

  script_name(english:"RHEL 7 : gitpython (Unpatched Vulnerability) (deprecated)");
