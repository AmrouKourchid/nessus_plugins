...
# extracted from Fedora Security Advisory FEDORA-2023-129178fd27
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-129178fd27");

  script_name(english:"Fedora 37 : pypy (2023-129178fd27)");
...
FEDORA-2023-129178fd27 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-129178fd27");
...
var pkgs = [
    {'reference':'pypy-7.3.12-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
