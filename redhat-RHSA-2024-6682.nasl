...
# extracted from Red Hat Security Advisory RHSA-2024:6682. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6682");

  script_name(english:"RHEL 8 : firefox (RHSA-2024:6682)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for firefox.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2024:6682 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6682.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0083e786");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6682");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2024:6682.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-128.2.0-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
