...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Dnsmasq vulnerability (USN-3009-1)");
...
USN-3009-1 advisory.
    ...
    Edwin Trk discovered that Dnsmasq incorrectly handled certain CNAME responses. A remote attacker could
    use this issue to cause Dnsmasq to crash, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3009-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'dnsmasq', 'pkgver': '2.75-1ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'dnsmasq-base', 'pkgver': '2.75-1ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'dnsmasq-utils', 'pkgver': '2.75-1ubuntu0.16.04.1'}
];
