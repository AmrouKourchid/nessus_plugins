...
# extracted from Fedora Security Advisory FEDORA-2022-245db0c060
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-245db0c060");

  script_name(english:"Fedora 37 : wordpress (2022-245db0c060)");
...
FEDORA-2022-245db0c060 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-245db0c060");
...
var pkgs = [
    {'reference':'wordpress-6.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
