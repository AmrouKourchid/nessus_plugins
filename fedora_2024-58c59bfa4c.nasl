...
# extracted from Fedora Security Advisory FEDORA-2024-58c59bfa4c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-58c59bfa4c");

  script_name(english:"Fedora 40 : iwd / libell (2024-58c59bfa4c)");
...
FEDORA-2024-58c59bfa4c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-58c59bfa4c");
...
var pkgs = [
    {'reference':'iwd-2.15-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libell-0.63-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
