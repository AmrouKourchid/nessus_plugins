...
# extracted from Gentoo Linux Security Advisory GLSA 202009-12.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202009-12");

  script_name(english:"GLSA-202009-12 : ZeroMQ: Denial of service");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202009-12
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202009-12");
...
"All ZeroMQ users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:zeromq");
...
if (qpkg_check(package:"net-libs/zeromq", unaffected:make_list("ge 4.3.3"), vulnerable:make_list("lt 4.3.3"))) flag++;
