...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : dpdk (EulerOS-SA-2022-2843)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2843
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c84246ca");
...
var pkgs = [
  "dpdk-19.11-5.h13.eulerosv2r10",
  "dpdk-tools-19.11-5.h13.eulerosv2r10"
];
