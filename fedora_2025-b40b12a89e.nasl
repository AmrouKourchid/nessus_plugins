...
# extracted from Fedora Security Advisory FEDORA-2025-b40b12a89e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-b40b12a89e");

  script_name(english:"Fedora 41 : xorg-x11-server (2025-b40b12a89e)");
...
FEDORA-2025-b40b12a89e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b40b12a89e");
...
var pkgs = [
    {'reference':'xorg-x11-server-21.1.16-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
