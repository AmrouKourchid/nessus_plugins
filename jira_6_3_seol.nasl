...
if (description)
{
  ...
  script_name(english:"Atlassian JIRA SEoL (6.3.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Atlassian JIRA is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Atlassian JIRA is 6.3.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of Atlassian JIRA that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2016/07/08");
...
var constraints = [
  { max_branch : '6.3', min_branch : '6.3', seol : 20160708 }
];
