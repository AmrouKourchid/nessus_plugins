...
# extracted from Red Hat Security Advisory xsa227_xen. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-12137");

  script_name(english:"RHEL 5 : xsa227_xen (Unpatched Vulnerability) (deprecated)");
