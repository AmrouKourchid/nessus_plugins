...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Exuberant Ctags vulnerability (USN-2371-1)");
...
USN-2371-1 advisory.
    ...
    It was discovered that Exuberant Ctags incorrectly handled certain minified js files. An attacker could
    use this issue to possibly cause Exuberant Ctags to consume resources, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2371-1");
...
"Update the affected exuberant-ctags package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-7204");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'exuberant-ctags', 'pkgver': '1:5.9~svn20110310-7ubuntu0.1'}
];
