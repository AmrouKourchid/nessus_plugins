...
# extracted from Fedora Security Advisory FEDORA-2023-0c012f6245
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0c012f6245");

  script_name(english:"Fedora 38 : maradns (2023-0c012f6245)");
...
FEDORA-2023-0c012f6245 advisory.

    Security fix for CVE-2023-31137, CVE-2022-30256

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0c012f6245");
...
var pkgs = [
    {'reference':'maradns-3.5.0036-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
