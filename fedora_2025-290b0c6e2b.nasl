...
# extracted from Fedora Security Advisory FEDORA-2025-290b0c6e2b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-290b0c6e2b");

  script_name(english:"Fedora 40 : redis (2025-290b0c6e2b)");
...
FEDORA-2025-290b0c6e2b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-290b0c6e2b");
...
var pkgs = [
    {'reference':'redis-7.2.8-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
