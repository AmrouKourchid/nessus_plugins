...
if (description)
{
  ...
  script_cve_id("CVE-2018-14035");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-14035");
...
patch available.
  ...
  - An issue was discovered in the HDF HDF5 1.8.20 library. There is a heap-based buffer over-read in the
    function H5VM_memcpyvv in H5VM.c. (CVE-2018-14035)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-14035");
