...
if (description)
{
  ...
  script_name(english:"Fortinet FortiClient - Lack of client-side certificate validation in ZTNA service (FG-IR-22-282) (macOS)");
...
"Upgrade to FortiClient version 7.0.12 / 7.2.5 or later.");
