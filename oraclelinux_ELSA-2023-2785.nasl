...
# extracted from Oracle Linux Security Advisory ELSA-2023-2785.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : grafana-pcp (ELSA-2023-2785)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2785.html");
