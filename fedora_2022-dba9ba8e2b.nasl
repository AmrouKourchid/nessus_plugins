...
# extracted from Fedora Security Advisory FEDORA-2022-dba9ba8e2b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-dba9ba8e2b");

  script_name(english:"Fedora 36 : heimdal (2022-dba9ba8e2b)");
...
FEDORA-2022-dba9ba8e2b advisory.
    ...
    * CVE-2022-44640 Heimdal KDC: invalid free in ASN.1 codec
    ...
    Note that CVE-2022-44640 is a severe vulnerability, possibly a 10.0 on the Common Vulnerability Scoring
    System (CVSS) v3.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-dba9ba8e2b");
...
var pkgs = [
    {'reference':'heimdal-7.7.1-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
