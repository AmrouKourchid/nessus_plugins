...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-1447.html");
...
"Update the affected grep package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2015-1345");
...
var pkgs = [
    {'reference':'grep-2.20-3.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grep-2.20-3.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
