...
if (description)
{
  ...
  script_name(english:"Debian dla-3396 : redis - security update");
...
advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3396-1                debian-lts@lists.debian.org
    ...
    create an invalid hash field that would have crashed the Redis server
    on access.
