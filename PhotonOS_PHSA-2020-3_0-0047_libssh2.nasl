...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libssh2 PHSA-2020-3.0-0047");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libssh2-1.9.0-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libssh2-devel-1.9.0-2.ph3')) flag++;
