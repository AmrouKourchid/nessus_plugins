...
# extracted from Red Hat Security Advisory RHSA-2024:3625. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3625");

  script_name(english:"RHEL 9 : libxml2 (RHSA-2024:3625)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3625.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2283570a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2262726");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3625");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libxml2 package based on the guidance in RHSA-2024:3625.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxml2-2.9.13-3.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.9.13-3.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libxml2-2.9.13-3.el9_2.3', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
