...
if (description)
{
  ...
  script_cve_id("CVE-2021-31162");

  script_name(english:"Photon OS 3.0: Rust PHSA-2021-3.0-0223");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'rust-1.51.0-1.ph3')) flag++;
