...
# extracted from openSUSE Security Update openSUSE-2019-683.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : qemu (openSUSE-2019-683)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1103628");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1105279");
