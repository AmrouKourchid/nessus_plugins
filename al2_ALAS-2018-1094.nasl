...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-1094.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : 389-ds-base (ALAS-2018-1094)");
...
sort.(CVE-2018-10935)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-1094.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"389-ds-base-1.3.7.5-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-debuginfo-1.3.7.5-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-devel-1.3.7.5-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-libs-1.3.7.5-28.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-snmp-1.3.7.5-28.amzn2.0.1")) flag++;
