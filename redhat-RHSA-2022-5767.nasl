...
# extracted from Red Hat Security Advisory RHSA-2022:5767. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5767");
  script_xref(name:"IAVA", value:"2022-A-0298-S");

  script_name(english:"RHEL 9 : firefox (RHSA-2022:5767)");
...
referenced in the RHSA-2022:5767 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5767.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?505d6cf3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5767");
...
"Update the RHEL firefox package based on the guidance in RHSA-2022:5767.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-91.12.0-2.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'firefox-91.12.0-2.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
