...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Ntp PHSA-2023-5.0-0040");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'ntp-4.2.8p17-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'ntp-perl-4.2.8p17-1.ph5')) flag++;
