...
# AlmaLinux Security Advisory ALSA-2024:3846.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:3846");

  script_name(english:"AlmaLinux 9 : python-idna (ALSA-2024:3846)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-3846.html");
...
"Update the affected python3-idna package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:python3-idna");
