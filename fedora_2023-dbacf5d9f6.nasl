...
# extracted from Fedora Security Advisory FEDORA-2023-dbacf5d9f6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dbacf5d9f6");

  script_name(english:"Fedora 38 : tigervnc (2023-dbacf5d9f6)");
...
FEDORA-2023-dbacf5d9f6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dbacf5d9f6");
...
var pkgs = [
    {'reference':'tigervnc-1.13.1-6.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
