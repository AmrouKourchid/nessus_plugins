...
# SUSE update advisory SUSE-SU-2024:0461-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0461-1");

  script_name(english:"openSUSE 15 Security Update : libxml2 (SUSE-SU-2024:0461-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-February/017908.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9631e757");
