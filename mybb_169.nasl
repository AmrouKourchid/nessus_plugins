...
relied only on the application's self-reported version number.");
  # https://packetstormsecurity.com/files/119199/MyBB-editpost.php-SQL-Injection.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?706d0129");
  script_set_attribute(attribute:"see_also", value:"https://blog.mybb.com/2012/12/14/mybb-1-6-9-security-release/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MyBB version 1.6.9 or later.");
