...
# extracted from Debian Security Advisory dla-4015. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4015 : rsync - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-4015
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-4015-2                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                    Thorsten Alteholz
    January 18, 2025                              https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------
    ...
    The update for rsync announced in DLA 4015-1 introduced a regression
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/rsync");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'rsync', 'reference': '3.2.3-4+deb11u3'}
];
