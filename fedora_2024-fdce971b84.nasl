...
# extracted from Fedora Security Advisory FEDORA-2024-fdce971b84
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fdce971b84");

  script_name(english:"Fedora 39 : iwd / libell (2024-fdce971b84)");
...
FEDORA-2024-fdce971b84 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fdce971b84");
...
var pkgs = [
    {'reference':'iwd-2.15-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libell-0.63-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
