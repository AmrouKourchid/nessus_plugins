...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : ghostscript (EulerOS-SA-2023-2311)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2311
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba0f8d64");
...
var pkgs = [
  "ghostscript-9.52-1.h6.eulerosv2r9",
  "ghostscript-help-9.52-1.h6.eulerosv2r9"
];
