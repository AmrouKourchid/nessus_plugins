...
# extracted from Red Hat Security Advisory usrsctp. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-20503", "CVE-2020-6831");

  script_name(english:"RHEL 5 : usrsctp (Unpatched Vulnerability) (deprecated)");
