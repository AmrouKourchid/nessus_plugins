...
# extracted from Fedora Security Advisory FEDORA-2024-7908ee39a9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7908ee39a9");

  script_name(english:"Fedora 41 : aws (2024-7908ee39a9)");
...
FEDORA-2024-7908ee39a9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7908ee39a9");
  script_set_attribute(attribute:"solution", value:
"Update the affected 2:aws package.");
...
var pkgs = [
    {'reference':'aws-24.0.0-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
