...
# extracted from Red Hat Security Advisory RHSA-2020:5184. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5184");

  script_name(english:"RHEL 6 : microcode_ctl (RHSA-2020:5184)");
...
referenced in the RHSA-2020:5184 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5184.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71b43f4c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5184");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'microcode_ctl-1.17-19.32.el6_6', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
