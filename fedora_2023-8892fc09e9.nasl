...
# extracted from Fedora Security Advisory FEDORA-2023-8892fc09e9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8892fc09e9");

  script_name(english:"Fedora 39 : libldb / samba (2023-8892fc09e9)");
...
FEDORA-2023-8892fc09e9 advisory.

    Update to ldb 2.7.2 and samba 4.18.1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8892fc09e9");
...
var pkgs = [
    {'reference':'libldb-2.7.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'samba-4.18.1-0.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
