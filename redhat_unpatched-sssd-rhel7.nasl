...
# extracted from Red Hat Security Advisory sssd. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-16883", "CVE-2023-3758");

  script_name(english:"RHEL 7 : sssd (Unpatched Vulnerability) (deprecated)");
