...
# extracted from Fedora Security Advisory FEDORA-2022-c6922f983b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c6922f983b");

  script_name(english:"Fedora 37 : thunderbird (2022-c6922f983b)");
...
FEDORA-2022-c6922f983b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c6922f983b");
...
var pkgs = [
    {'reference':'thunderbird-102.5.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
