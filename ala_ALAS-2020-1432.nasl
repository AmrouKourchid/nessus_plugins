...
"The version of python34 installed on the remote host is prior to 3.4.10-1.52. The version of python35 installed on the
remote host is prior to 3.5.9-1.28. The version of python36 installed on the remote host is prior to 3.6.12-1.19. It is,
therefore, affected by multiple vulnerabilities as referenced in the ALAS-2020-1432 advisory.
