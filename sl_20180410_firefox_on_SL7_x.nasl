...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL7.x x86_64 (20180410)");
...
Security Fix(es) :
  ...
  - firefox: Use-after-free in compositor potentially allows
    code execution (CVE-2018-5148)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1804&L=scientific-linux-errata&F=&S=&P=3068
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d684ca87");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-52.7.3-1.el7_5", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-debuginfo-52.7.3-1.el7_5", allowmaj:TRUE)) flag++;
