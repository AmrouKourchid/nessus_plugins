...
# extracted from Red Hat Security Advisory RHSA-2025:0288. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : Bug fix of NetworkManager (Moderate) (RHSA-2025:0288)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:0288 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-73052");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0288.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f243716");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'NetworkManager-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-adsl-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-bluetooth-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-cloud-setup-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-config-connectivity-redhat-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-config-server-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-dispatcher-routing-rules-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-initscripts-updown-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-libnm-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-libnm-devel-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-ovs-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-ppp-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-team-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-tui-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-wifi-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-wwan-1.40.16-18.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
