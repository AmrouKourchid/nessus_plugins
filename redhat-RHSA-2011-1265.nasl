...
# extracted from Red Hat Security Advisory RHSA-2011:1265. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2011:1265");

  script_name(english:"RHEL 5 : java-1.4.2-ibm-sap (RHSA-2011:1265)");
...
referenced in the RHSA-2011:1265 advisory.

  - IBM JDK Class file parsing denial-of-service (CVE-2011-0311)
  ...
  - java-1.4.2-ibm: DoS via class file parser in IBM Java 1.4.2.SR13.FP9 (CVE-2011-3387)
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2011/rhsa-2011_1265.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae8da0c8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:1265");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL java-1.4.2-ibm-sap package based on the guidance in RHSA-2011:1265.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.4.2-ibm-sap-1.4.2.13.10.sap-1jpp.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'java-1.4.2-ibm-sap-demo-1.4.2.13.10.sap-1jpp.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'java-1.4.2-ibm-sap-devel-1.4.2.13.10.sap-1jpp.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'java-1.4.2-ibm-sap-javacomm-1.4.2.13.10.sap-1jpp.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'java-1.4.2-ibm-sap-src-1.4.2.13.10.sap-1jpp.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
