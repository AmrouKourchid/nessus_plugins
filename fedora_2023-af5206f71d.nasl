...
# extracted from Fedora Security Advisory FEDORA-2023-af5206f71d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-af5206f71d");

  script_name(english:"Fedora 37 : pypy3.9 (2023-af5206f71d)");
...
FEDORA-2023-af5206f71d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-af5206f71d");
...
var pkgs = [
    {'reference':'pypy3.9-7.3.11-1.3.9.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
