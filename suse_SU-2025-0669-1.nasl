...
# SUSE update advisory SUSE-SU-2025:0669-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-36974", "CVE-2024-53104");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/02/26");
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0669-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 2 for SLE 15 SP6) (SUSE-SU-2025:0669-1)");
...
the SUSE-SU-2025:0669-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-February/020416.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a93f979f");
...
var kernel_live_checks = [
  {
    'kernels': {
      '6.4.0-150600.23.14-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-6_4_0-150600_23_14-default-9-150600.2.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.6']}
        ]
      }
    }
  }
