...
# extracted from Fedora Security Advisory FEDORA-2018-e14840a7f5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-e14840a7f5");

  script_name(english:"Fedora 29 : pdns-recursor (2018-e14840a7f5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-e14840a7f5");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"pdns-recursor-4.1.8-1.fc29")) flag++;
