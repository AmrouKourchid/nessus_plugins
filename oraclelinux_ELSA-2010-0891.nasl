...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0891.html");
...
"Update the affected pam and / or pam-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-4708");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2010-3435");
...
var pkgs = [
    {'reference':'pam-1.1.1-4.el6_0.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pam-devel-1.1.1-4.el6_0.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pam-1.1.1-4.el6_0.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pam-devel-1.1.1-4.el6_0.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
