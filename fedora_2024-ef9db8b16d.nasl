...
# extracted from Fedora Security Advisory FEDORA-2024-ef9db8b16d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ef9db8b16d");

  script_name(english:"Fedora 41 : perl-App-cpanminus (2024-ef9db8b16d)");
...
FEDORA-2024-ef9db8b16d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ef9db8b16d");
...
var pkgs = [
    {'reference':'perl-App-cpanminus-1.7047-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
