...
# extracted from openSUSE Security Update openSUSE-2018-769.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libgcrypt (openSUSE-2018-769)");
...
if ( rpm_check(release:"SUSE15.0", reference:"libgcrypt-cavs-1.8.2-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libgcrypt-cavs-debuginfo-1.8.2-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libgcrypt-debugsource-1.8.2-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libgcrypt-devel-1.8.2-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libgcrypt-devel-debuginfo-1.8.2-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libgcrypt20-1.8.2-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libgcrypt20-debuginfo-1.8.2-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libgcrypt20-hmac-1.8.2-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libgcrypt-devel-32bit-1.8.2-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libgcrypt-devel-32bit-debuginfo-1.8.2-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libgcrypt20-32bit-1.8.2-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libgcrypt20-32bit-debuginfo-1.8.2-lp150.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libgcrypt20-hmac-32bit-1.8.2-lp150.5.3.1") ) flag++;
