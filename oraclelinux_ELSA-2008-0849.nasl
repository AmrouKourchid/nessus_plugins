...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : ipsec-tools (ELSA-2008-0849)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0849.html");
...
"Update the affected ipsec-tools package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-3652");
...
var pkgs = [
    {'reference':'ipsec-tools-0.6.5-9.el5_2.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ipsec-tools-0.6.5-9.el5_2.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
