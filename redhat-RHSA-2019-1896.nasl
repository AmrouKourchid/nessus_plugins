...
# extracted from Red Hat Security Advisory RHSA-2019:1896. The text 
...
the RHSA-2019:1896 advisory.
    ...
    * Previously, if you were using the PAM plugin and attempted to bind as a dn that doesn't exist, the
    server would crash. This has now been fixed. (BZ#1718184)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1896.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?de73bfc0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1896");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1693612");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1718184");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL 389-ds-base package based on the guidance in RHSA-2019:1896.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'389-ds-base-1.3.8.4-25.1.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-devel-1.3.8.4-25.1.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-libs-1.3.8.4-25.1.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-snmp-1.3.8.4-25.1.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
