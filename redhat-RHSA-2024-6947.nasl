...
# extracted from Red Hat Security Advisory RHSA-2024:6947. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6947");

  script_name(english:"RHEL 9 : grafana (RHSA-2024:6947)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6947.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ff81f79");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6947");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana package based on the guidance in RHSA-2024:6947.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-9.2.10-17.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-selinux-9.2.10-17.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'grafana-9.2.10-17.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-selinux-9.2.10-17.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
