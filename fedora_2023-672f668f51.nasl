...
# extracted from Fedora Security Advisory FEDORA-2023-672f668f51
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-672f668f51");

  script_name(english:"Fedora 36 : python-cryptography (2023-672f668f51)");
...
FEDORA-2023-672f668f51 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-672f668f51");
...
var pkgs = [
    {'reference':'python-cryptography-36.0.0-4.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
