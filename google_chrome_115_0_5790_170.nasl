...
"The version of Google Chrome installed on the remote Windows host is prior to 115.0.5790.170. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'115.0.5790.170', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
