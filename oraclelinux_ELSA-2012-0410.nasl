...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-0410.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected raptor and / or raptor-devel packages.");
...
var pkgs = [
    {'reference':'raptor-1.4.18-5.el6_2.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'raptor-devel-1.4.18-5.el6_2.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'raptor-1.4.18-5.el6_2.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'raptor-devel-1.4.18-5.el6_2.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
