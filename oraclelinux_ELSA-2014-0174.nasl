...
# Oracle Linux Security Advisory ELSA-2014-0174 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : piranha (ELSA-2014-0174)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-0174.html");
...
"Update the affected piranha package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:piranha");
...
var pkgs = [
    {'reference':'piranha-0.8.4-26.0.1.el5_10.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'piranha-0.8.4-26.0.1.el5_10.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
