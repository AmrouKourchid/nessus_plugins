...
against the affected application.");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/446227/30/0/threaded");
  script_set_attribute(attribute:"see_also", value:"https://docs.moodle.org/35/en/Release_Notes#Moodle_1.6.2");
