...
# extracted from Fedora Security Advisory FEDORA-2023-e9c04d81c1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e9c04d81c1");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 37 : nodejs18 (2023-e9c04d81c1)");
...
FEDORA-2023-e9c04d81c1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e9c04d81c1");
...
var pkgs = [
    {'reference':'nodejs18-18.18.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
