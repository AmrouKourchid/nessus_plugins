...
# extracted from Fedora Security Advisory FEDORA-2023-1ba7a77530
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1ba7a77530");

  script_name(english:"Fedora 37 : liferea (2023-1ba7a77530)");
...
FEDORA-2023-1ba7a77530 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1ba7a77530");
...
var pkgs = [
    {'reference':'liferea-1.14.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
