...
# extracted from VMware Security Advisory PHSA-2023-4.0-0400. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libcap PHSA-2023-4.0-0400");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libcap package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-400.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:libcap");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libcap-2.43-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libcap-devel-2.43-3.ph4')) flag++;
