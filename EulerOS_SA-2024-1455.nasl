...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : libssh2 (EulerOS-SA-2024-1455)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1455
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92b4049a");
...
var pkgs = [
  "libssh2-1.9.0-2.h8.eulerosv2r9"
];
