...
# extracted from Fedora Security Advisory FEDORA-2023-1bcbb1db39
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1bcbb1db39");

  script_name(english:"Fedora 36 : runc (2023-1bcbb1db39)");
...
FEDORA-2023-1bcbb1db39 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1bcbb1db39");
...
var pkgs = [
    {'reference':'runc-1.1.6-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
