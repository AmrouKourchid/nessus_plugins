...
# extracted from Fedora Security Advisory FEDORA-2018-d547a126e7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : patch (2018-d547a126e7)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d547a126e7");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"patch-2.7.6-5.fc27")) flag++;
