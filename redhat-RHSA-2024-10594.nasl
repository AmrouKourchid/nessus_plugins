...
# extracted from Red Hat Security Advisory RHSA-2024:10594. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10594");

  script_name(english:"RHEL 9 : libreswan (RHSA-2024:10594)");
...
referenced in the RHSA-2024:10594 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2173610");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2215952");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2225368");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2225369");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268952");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10594.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0b6cf70d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10594");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libreswan package based on the guidance in RHSA-2024:10594.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.6-3.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
