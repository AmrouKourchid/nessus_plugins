...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Go PHSA-2022-3.0-0364");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-1.17.2-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-md2man-2.0.0-11.ph3')) flag++;
