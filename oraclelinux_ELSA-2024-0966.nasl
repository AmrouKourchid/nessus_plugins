...
# extracted from Oracle Linux Security Advisory ELSA-2024-0966.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : opensc (ELSA-2024-0966)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-0966.html");
...
var pkgs = [
    {'reference':'opensc-0.23.0-4.el9_3', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'opensc-0.23.0-4.el9_3', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'opensc-0.23.0-4.el9_3', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
