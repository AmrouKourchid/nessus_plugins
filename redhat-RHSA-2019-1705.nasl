...
# extracted from Red Hat Security Advisory RHSA-2019:1705. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1705");

  script_name(english:"RHEL 7 : ansible (RHSA-2019:1705)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1705.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26eed4d8");
  # https://github.com/ansible/ansible/blob/v2.7.12/changelogs/CHANGELOG-v2.7.rst
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?837e01b8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1705");
...
"Update the RHEL ansible package based on the guidance in RHSA-2019:1705.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.7.12-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.7'}
    ]
  }
];
