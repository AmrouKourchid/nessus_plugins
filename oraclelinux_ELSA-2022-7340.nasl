...
# extracted from Oracle Linux Security Advisory ELSA-2022-7340.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : php-pear (ELSA-2022-7340)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-7340.html");
...
var pkgs = [
    {'reference':'php-pear-1.9.4-23.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
