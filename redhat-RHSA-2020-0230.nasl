...
# extracted from Red Hat Security Advisory RHSA-2020:0230. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0230");

  script_name(english:"RHEL 8 : python-reportlab (RHSA-2020:0230)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0230.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?460aefc5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0230");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1769661");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-reportlab package based on the guidance in RHSA-2020:0230.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-reportlab-3.4.0-6.el8_0.2', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-reportlab-3.4.0-6.el8_0.2', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
