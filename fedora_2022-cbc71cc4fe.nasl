...
# extracted from Fedora Security Advisory FEDORA-2022-cbc71cc4fe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-cbc71cc4fe");

  script_name(english:"Fedora 38 : emacs (2022-cbc71cc4fe)");
...
FEDORA-2022-cbc71cc4fe advisory.

    Automatic update for emacs-28.2-1.fc38.

    ##### **Changelog**

    ```
    * Tue Nov  1 2022 Dan ermk <dan.cermak@cgc-instruments.com> - 1:28.2-1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-cbc71cc4fe");
...
var pkgs = [
    {'reference':'emacs-28.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
