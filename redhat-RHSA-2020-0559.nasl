...
# extracted from Red Hat Security Advisory RHSA-2020:0559. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0559");

  script_name(english:"RHEL 8 : ksh (RHSA-2020:0559)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0559.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef762cec");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0559");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1757324");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ksh package based on the guidance in RHSA-2020:0559.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ksh-20120801-253.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ksh-20120801-253.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
