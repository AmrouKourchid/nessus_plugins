...
# SUSE update advisory SUSE-SU-2022:14951-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:14951-1");

  script_name(english:"SUSE SLES11 Security Update : cifs-utils (SUSE-SU-2022:14951-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-April/010847.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c83da308");
...
var pkgs = [
    {'reference':'cifs-utils-5.1-0.16.3.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
