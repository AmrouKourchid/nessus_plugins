...
# extracted from Fedora Security Advisory FEDORA-2020-d808fdd597.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : python3 (2020-d808fdd597)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-d808fdd597");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"python3-3.7.8-2.fc31")) flag++;
