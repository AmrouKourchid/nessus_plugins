...
# extracted from SUSE update advisory SUSE-SU-2018:1450-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : perl-DBD-mysql (SUSE-SU-2018:1450-1) (BACKRONYM)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20181450-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?deae703c");
...
SUSE-SLE-SERVER-12-SP3-2018-991=1");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:perl-DBD-mysql-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:perl-DBD-mysql-debugsource");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"perl-DBD-mysql-4.021-12.5.2")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"perl-DBD-mysql-debuginfo-4.021-12.5.2")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"perl-DBD-mysql-debugsource-4.021-12.5.2")) flag++;
