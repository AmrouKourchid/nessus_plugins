...
# extracted from openSUSE Security Update openSUSE-2019-1637.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : compat-openssl098 (openSUSE-2019-1637)");
...
"This update for compat-openssl098 fixes the following issues :
  ...
  - CVE-2019-1559: Fix 0-byte record padding oracle via
    SSL_shutdown (bsc#1127080)

  - Reject invalid EC point coordinates (bsc#1131291)

  - Fixed 'The 9 Lives of Bleichenbacher's CAT: Cache
    ATtacks on TLS Implementations' (bsc#1117951)
...
if ( rpm_check(release:"SUSE42.3", reference:"compat-openssl098-debugsource-0.9.8j-30.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libopenssl0_9_8-0.9.8j-30.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libopenssl0_9_8-debuginfo-0.9.8j-30.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libopenssl0_9_8-32bit-0.9.8j-30.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libopenssl0_9_8-debuginfo-32bit-0.9.8j-30.1") ) flag++;
