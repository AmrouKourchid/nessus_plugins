...
# extracted from Fedora Security Advisory FEDORA-2019-5628767261.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-5628767261");

  script_name(english:"Fedora 29 : libextractor (2019-5628767261)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5628767261");
  script_set_attribute(attribute:"solution", value:
"Update the affected libextractor package.");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libextractor-1.9-5.fc29")) flag++;
