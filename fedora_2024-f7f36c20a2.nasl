...
# extracted from Fedora Security Advisory FEDORA-2024-f7f36c20a2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f7f36c20a2");

  script_name(english:"Fedora 40 : python3.11 (2024-f7f36c20a2)");
...
FEDORA-2024-f7f36c20a2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f7f36c20a2");
...
var pkgs = [
    {'reference':'python3.11-3.11.10-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
