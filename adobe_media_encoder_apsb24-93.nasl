...
if (description)
{
  ...
  script_name(english:"Adobe Media Encoder < 24.6.4 / 25.0 < 25.1 Multiple Vulnerabilities (APSB24-93)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Media Encoder instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Media Encoder installed on the remote Windows host is prior to 24.6.4, 25.1. It is, therefore,
