...
# extracted from openSUSE Security Update openSUSE-2020-906.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : graphviz (openSUSE-2020-906)");
...
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-addons-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-addons-debugsource-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-debugsource-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-devel-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-gd-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-gd-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-gnome-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-gnome-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-guile-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-guile-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-gvedit-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-gvedit-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-java-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-java-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-lua-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-lua-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-perl-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-perl-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-php-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-php-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-plugins-core-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-plugins-core-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-python-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-python-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-ruby-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-ruby-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-smyrna-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-smyrna-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-tcl-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"graphviz-tcl-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgraphviz6-2.40.1-lp152.7.4.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libgraphviz6-debuginfo-2.40.1-lp152.7.4.2") ) flag++;
