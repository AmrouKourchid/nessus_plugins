...
ELSA-2013-0744 advisory.
    ...
    - [virt] kvm: do not #GP on unaligned MSR_KVM_SYSTEM_TIME write (Gleb Natapov) [917020 917021]
    {CVE-2013-1796}
    - [drm] i915: bounds check execbuffer relocation count (Nikola Pajkovsky) [920523 920525] {CVE-2013-0913}
    - [kvm] Convert MSR_KVM_SYSTEM_TIME to use gfn_to_hva_cache functions (Gleb Natapov) [917024 917025]
    {CVE-2013-1797}
    - [kvm] Fix for buffer overflow in handling of MSR_KVM_SYSTEM_TIME (Gleb Natapov) [917020 917021]
    {CVE-2013-1796}
    - [kvm] Fix bounds checking in ioapic indirect register reads (Gleb Natapov) [917030 917032]
    {CVE-2013-1798}
    - [kvm] x86: release kvmclock page on reset (Gleb Natapov) [917024 917025] {CVE-2013-1797}
    - [security] keys: Fix race with concurrent install_user_keyrings() (David Howells) [916681 913258]
    {CVE-2013-1792}
    ...
    - [fs] nls: improve UTF8 -> UTF16 string conversion routine (Nikola Pajkovsky) [916118 916119]
    {CVE-2013-1773}
    ...
    - [net] bluetooth: Fix incorrect strncpy() in hidp_setup_hid() (Nikola Pajkovsky) [914690 914691]
    {CVE-2013-0349}
...
var pkgs = [
    ...
    {'reference':'kernel-firmware-2.6.32-358.6.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-358.6.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
