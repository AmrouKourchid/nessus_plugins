...
if (description)
{
  ...
  script_cve_id("CVE-2024-36023");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-36023");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: Julia Lawall reported this null
    pointer dereference, this should fix it. (CVE-2024-36023)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-36023");
