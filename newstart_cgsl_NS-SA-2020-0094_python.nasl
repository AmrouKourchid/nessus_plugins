...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : python Multiple Vulnerabilities (NS-SA-2020-0094)");
...
pkgs = {
  'CGSL CORE 5.05': [
    'python-2.7.5-88.el7.cgslv5_5.0.2.gce2a955.lite',
    'python-debug-2.7.5-88.el7.cgslv5_5.0.2.gce2a955.lite',
    'python-debuginfo-2.7.5-88.el7.cgslv5_5.0.2.gce2a955.lite',
    'python-devel-2.7.5-88.el7.cgslv5_5.0.2.gce2a955.lite',
    'python-libs-2.7.5-88.el7.cgslv5_5.0.2.gce2a955.lite',
    'python-test-2.7.5-88.el7.cgslv5_5.0.2.gce2a955.lite',
    'python-tools-2.7.5-88.el7.cgslv5_5.0.2.gce2a955.lite',
    'tkinter-2.7.5-88.el7.cgslv5_5.0.2.gce2a955.lite'
  ],
  'CGSL MAIN 5.05': [
    'python-2.7.5-88.el7.cgslv5_5.0.2.gab0f155',
    'python-debug-2.7.5-88.el7.cgslv5_5.0.2.gab0f155',
    'python-debuginfo-2.7.5-88.el7.cgslv5_5.0.2.gab0f155',
    'python-devel-2.7.5-88.el7.cgslv5_5.0.2.gab0f155',
    'python-libs-2.7.5-88.el7.cgslv5_5.0.2.gab0f155',
    'python-test-2.7.5-88.el7.cgslv5_5.0.2.gab0f155',
    'python-tools-2.7.5-88.el7.cgslv5_5.0.2.gab0f155',
    'tkinter-2.7.5-88.el7.cgslv5_5.0.2.gab0f155'
  ]
};
