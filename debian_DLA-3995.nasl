...
# extracted from Debian Security Advisory dla-3995. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-31197", "CVE-2022-41946", "CVE-2024-1597");

  script_name(english:"Debian dla-3995 : libpostgresql-jdbc-java - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-1597");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libpostgresql-jdbc-java', 'reference': '42.2.15-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libpostgresql-jdbc-java-doc', 'reference': '42.2.15-1+deb11u2'}
];
