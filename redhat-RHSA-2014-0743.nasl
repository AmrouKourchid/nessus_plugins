...
referenced in the RHSA-2014:0743 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_0743.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f32eea5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0743");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1100575");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qemu-kvm package based on the guidance in RHSA-2014:0743.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-guest-agent-0.12.1.2-2.415.el6_5.10', 'cpu':'i686', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-guest-agent-0.12.1.2-2.415.el6_5.10', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-img-0.12.1.2-2.415.el6_5.10', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-kvm-0.12.1.2-2.415.el6_5.10', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-kvm-tools-0.12.1.2-2.415.el6_5.10', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
