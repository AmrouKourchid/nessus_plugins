...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : ntp (EulerOS-SA-2019-1014)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1014
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7eef1358");
...
pkgs = ["ntp-4.2.6p5-28.h5.eulerosv2r7",
        "ntpdate-4.2.6p5-28.h5.eulerosv2r7"];
