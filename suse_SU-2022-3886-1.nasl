...
# SUSE update advisory SUSE-SU-2022:3886-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3886-1");

  script_name(english:"SUSE SLES12 Security Update : sudo (SUSE-SU-2022:3886-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?36e6b9ca");
...
var pkgs = [
    {'reference':'sudo-1.8.10p3-10.38.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']}
];
