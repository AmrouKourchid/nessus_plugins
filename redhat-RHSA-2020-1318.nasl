...
# extracted from Red Hat Security Advisory RHSA-2020:1318. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1318");
  script_xref(name:"IAVA", value:"2020-A-0293");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"RHEL 8 : telnet (RHSA-2020:1318)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1318.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92592b44");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1318");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1811673");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL telnet package based on the guidance in RHSA-2020:1318.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'telnet-server-0.17-73.el8_1.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'telnet-server-0.17-73.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
