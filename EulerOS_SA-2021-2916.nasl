...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : haproxy (EulerOS-SA-2021-2916)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2916
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e2856511");
...
var pkgs = [
  "haproxy-2.0.14-1.h4.eulerosv2r9"
];
