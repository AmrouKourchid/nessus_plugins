...
# extracted from Ubuntu Security Notice USN-6435-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6435-2");

  script_name(english:"Ubuntu 20.04 LTS : OpenSSL vulnerabilities (USN-6435-2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 20.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-6435-2 advisory.

    USN-6435-1 fixed vulnerabilities in OpenSSL. This update provides the corresponding updates for Ubuntu
    20.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6435-2");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libssl-dev', 'pkgver': '1.1.1f-1ubuntu2.20'},
    {'osver': '20.04', 'pkgname': 'libssl1.1', 'pkgver': '1.1.1f-1ubuntu2.20'},
    {'osver': '20.04', 'pkgname': 'openssl', 'pkgver': '1.1.1f-1ubuntu2.20'}
];
