...
# AlmaLinux Security Advisory ALSA-2024:8800.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:8800");
  script_xref(name:"RHSA", value:"2024:8800");

  script_name(english:"AlmaLinux 9 : openexr (ALSA-2024:8800)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-8800.html");
...
"Update the affected openexr, openexr-devel and / or openexr-libs packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:openexr");
...
var pkgs = [
    {'reference':'openexr-3.1.1-2.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'openexr-devel-3.1.1-2.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'openexr-libs-3.1.1-2.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
