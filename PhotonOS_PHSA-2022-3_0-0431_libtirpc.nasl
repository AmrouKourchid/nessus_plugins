...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libtirpc PHSA-2022-3.0-0431");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtirpc-1.1.4-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtirpc-devel-1.1.4-2.ph3')) flag++;
