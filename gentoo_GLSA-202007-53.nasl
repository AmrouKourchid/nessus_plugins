...
# extracted from Gentoo Linux Security Advisory GLSA 202007-53.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-0739", "CVE-2018-12437", "CVE-2018-20685");
  script_xref(name:"GLSA", value:"202007-53");

  script_name(english:"GLSA-202007-53 : Dropbear: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-53
...
if (qpkg_check(package:"net-misc/dropbear", unaffected:make_list("ge 2020.80"), vulnerable:make_list("lt 2020.80"))) flag++;
