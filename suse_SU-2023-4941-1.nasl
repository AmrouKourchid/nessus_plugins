...
# SUSE update advisory SUSE-SU-2023:4941-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2017-7511", "CVE-2018-20662");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4941-1");

  script_name(english:"SUSE SLES12 Security Update : poppler (SUSE-SU-2023:4941-1)");
...
referenced in the SUSE-SU-2023:4941-1 advisory.

  - poppler since version 0.17.3 has been vulnerable to NULL pointer dereference in pdfunite triggered by
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1041783");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1120956");
  # https://lists.suse.com/pipermail/sle-security-updates/2023-December/017519.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d872806");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2017-7511");
...
var pkgs = [
    {'reference':'libpoppler44-0.24.4-14.44.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'libpoppler44-0.24.4-14.44.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-sdk-release-12.5', 'sles-release-12.5']}
];
