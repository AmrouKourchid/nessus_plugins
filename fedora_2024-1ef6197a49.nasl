...
# extracted from Fedora Security Advisory FEDORA-2024-1ef6197a49
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1ef6197a49");
  script_xref(name:"IAVA", value:"2024-A-0002-S");

  script_name(english:"Fedora 39 : exim (2024-1ef6197a49)");
...
FEDORA-2024-1ef6197a49 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1ef6197a49");
...
var pkgs = [
    {'reference':'exim-4.97.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
