...
# extracted from Fedora Security Advisory FEDORA-2024-69933b0732
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-69933b0732");

  script_name(english:"Fedora 39 : efifs (2024-69933b0732)");
...
FEDORA-2024-69933b0732 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-69933b0732");
  script_set_attribute(attribute:"solution", value:
"Update the affected efifs package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:efifs");
...
var pkgs = [
    {'reference':'efifs-1.9-6.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'efifs');
}
