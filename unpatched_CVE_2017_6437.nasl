...
if (description)
{
  ...
  script_cve_id("CVE-2017-6437");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-6437");
...
patch available.
  ...
  - The base64encode function in base64.c in libimobiledevice libplist 1.12 allows local users to cause a
    denial of service (out-of-bounds read) via a crafted plist file. (CVE-2017-6437)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-6437");
