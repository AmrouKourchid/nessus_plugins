...
# extracted from Debian Security Advisory dla-3736. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3736 : libunbound-dev - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libunbound-dev', 'reference': '1.9.0-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libunbound8', 'reference': '1.9.0-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python-unbound', 'reference': '1.9.0-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python3-unbound', 'reference': '1.9.0-2+deb10u4'},
    {'release': '10.0', 'prefix': 'unbound', 'reference': '1.9.0-2+deb10u4'},
    {'release': '10.0', 'prefix': 'unbound-anchor', 'reference': '1.9.0-2+deb10u4'},
    {'release': '10.0', 'prefix': 'unbound-host', 'reference': '1.9.0-2+deb10u4'}
];
