...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002492");
  script_xref(name:"MSFT", value:"MS24-5002492");
  script_xref(name:"IAVA", value:"2024-A-0101-S");
  script_xref(name:"IAVA", value:"2024-A-0094-S");

  script_name(english:"Security Updates for Microsoft Publisher Products (February 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Publisher Products are missing a security update.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Publisher Products are missing a security update. They are, therefore, affected by a remote code
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002492");
...
var constraints = [
  { 'kb':'5002492', 'channel':'MSI', 'fixed_version': '16.0.5435.1000', 'sp' : 0}
];
