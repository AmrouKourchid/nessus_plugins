...
if (description)
{
  ...
  script_cve_id("CVE-2023-48039");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-48039");
...
patch available.
  ...
  - GPAC 2.3-DEV-rev617-g671976fcc-master is vulnerable to memory leak in gf_mpd_parse_string
    media_tools/mpd.c:75. (CVE-2023-48039)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-48039");
