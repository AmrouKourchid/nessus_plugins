...
# extracted from Fedora Security Advisory FEDORA-2023-a3d608daf4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a3d608daf4");

  script_name(english:"Fedora 36 : bind / bind-dyndb-ldap (2023-a3d608daf4)");
...
FEDORA-2023-a3d608daf4 advisory.

    - [Release notes](https://downloads.isc.org/isc/bind9/9.16.37/RELEASE-NOTES-bind-9.16.37.html)

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a3d608daf4");
...
var pkgs = [
    {'reference':'bind-9.16.37-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-dyndb-ldap-11.9-21.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
