...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor for Mac < 12.1.2 Multiple Vulnerabilities");
...
on the remote macOS host is prior to 12.1.2. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor for Mac version 12.1.2 or later");
...
var constraints = [
  { 'max_version' : '11.1.5.0913', 'fixed_version' : '12.1.2' },
  { 'min_version' : '12.0', 'max_version' : '12.1.1.55342', 'fixed_version' : '12.1.2' }
];
