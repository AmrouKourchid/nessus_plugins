...
# extracted from Fedora Security Advisory FEDORA-2023-7a98e2d545
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7a98e2d545");

  script_name(english:"Fedora 36 : redis (2023-7a98e2d545)");
...
FEDORA-2023-7a98e2d545 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7a98e2d545");
...
var pkgs = [
    {'reference':'redis-6.2.11-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
