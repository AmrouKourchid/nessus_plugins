...
if (description)
{
  ...
  script_cve_id("CVE-2023-0464", "CVE-2023-37580", "CVE-2023-38750");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/08/17");
  script_xref(name:"IAVA", value:"2023-A-0386-S");

  script_name(english:"Zimbra Collaboration Server 8.x < 8.8.15 Patch 41 Multiple Vulnerabilities");
...
including:
 ...
 - A cross-site scripting (XSS) vulnerability in the Zimbra Classic Web Client. (CVE-2023-37580)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://wiki.zimbra.com/wiki/Zimbra_Releases/8.8.15/P41");
...
"Upgrade to version 8.8.15 Patch 41, or later.");
...
var constraints = [
  {'min_version':'8.0', 'max_version':'8.8.15', 'fixed_display':'8.8.15 Patch 41', 'Patch':'41'}
];
