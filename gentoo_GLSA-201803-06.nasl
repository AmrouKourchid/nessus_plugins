...
# extracted from Gentoo Linux Security Advisory GLSA 201803-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201803-06");

  script_name(english:"GLSA-201803-06 : Oracle JDK/JRE: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201803-06
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201803-06");
...
if (qpkg_check(package:"dev-java/oracle-jdk-bin", unaffected:make_list("ge 1.8.0.162"), vulnerable:make_list("lt 1.8.0.162"))) flag++;
if (qpkg_check(package:"dev-java/oracle-jre-bin", unaffected:make_list("ge 1.8.0.162"), vulnerable:make_list("lt 1.8.0.162"))) flag++;
