...
# extracted from Red Hat Security Advisory RHSA-2021:5080. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:5080");

  script_name(english:"RHEL 8 : mailman:2.1 (RHSA-2021:5080)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_5080.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3900333e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:5080");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2026862");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mailman:2.1 package based on the guidance in RHSA-2021:5080.");
  ...
  'mailman:2.1': [
    {
      ...
      'pkgs': [
        {'reference':'mailman-2.1.29-6.module+el8.2.0+13543+86b2c701', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
      ]
    }
  ]
};
