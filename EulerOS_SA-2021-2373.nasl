...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : glib2 (EulerOS-SA-2021-2373)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2373
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6fecc9fb");
...
pkgs = ["glib2-2.50.3-3.h8",
        "glib2-devel-2.50.3-3.h8"];
