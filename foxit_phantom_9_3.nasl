...
if (description)
{
  ...
  script_name(english:"Foxit PhantomPDF < 9.3 Multiple Vulnerabilities");
...
9.3. It is, therefore, affected by multiple vulnerabilities.");
...
var constraints = [
  { 'max_version' : '8.3.7.38093', 'fixed_version' : '9.3' },
  { 'min_version' : '9.0', 'max_version' : '9.2.0.9297', 'fixed_version' : '9.3' }
];
