...
# extracted from Red Hat Security Advisory RHSA-2025:7050. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-12087", "CVE-2024-12088", "CVE-2024-12747");
  script_xref(name:"RHSA", value:"2025:7050");

  script_name(english:"RHEL 9 : rsync (RHSA-2025:7050)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rsync.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:7050 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2330672");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2330676");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2332968");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-18216");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-67142");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-70265");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7050.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?113a818a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7050");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rsync package based on the guidance in RHSA-2025:7050.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-12087");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-12088");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(35, 362);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rsync-3.2.5-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsync-daemon-3.2.5-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsync-rrsync-3.2.5-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rsync / rsync-daemon / rsync-rrsync');
}
