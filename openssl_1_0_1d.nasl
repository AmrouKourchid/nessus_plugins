...
"The version of OpenSSL installed on the remote host is prior to 1.0.1d. It is, therefore, affected by multiple
vulnerabilities as referenced in the 1.0.1d advisory.
  ...
  - crypto/evp/e_aes_cbc_hmac_sha1.c in the AES-NI functionality in the TLS 1.1 and 1.2 implementations in
    OpenSSL 1.0.1 before 1.0.1d allows remote attackers to cause a denial of service (application crash) via
    crafted CBC data. (CVE-2012-2686)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.cve.org/CVERecord?id=CVE-2012-2686");
...
"Upgrade to OpenSSL version 1.0.1d or later.");
...
var constraints = [
  { 'min_version' : '1.0.1', 'fixed_version' : '1.0.1d' }
];
