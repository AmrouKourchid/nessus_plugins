...
# extracted from Fedora Security Advisory FEDORA-2022-59a20edab2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-59a20edab2");

  script_name(english:"Fedora 37 : golang (2022-59a20edab2)");
...
FEDORA-2022-59a20edab2 advisory.

    This release includes security fixes to the archive/tar, net/http/httputil, and regexp packages, as well
    as bug fixes to the compiler, the linker, the runtime, and the go/types package. See the [Go 1.19.2
    milestone](https://github.com/golang/go/issues?q=milestone%3AGo1.19.2+label%3ACherryPickApproved) on the
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-59a20edab2");
...
var pkgs = [
    {'reference':'golang-1.19.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
