...
# extracted from Fedora Security Advisory FEDORA-2023-1c6a20aa0a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1c6a20aa0a");

  script_name(english:"Fedora 37 : chromium (2023-1c6a20aa0a)");
...
FEDORA-2023-1c6a20aa0a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1c6a20aa0a");
...
var pkgs = [
    {'reference':'chromium-118.0.5993.70-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
