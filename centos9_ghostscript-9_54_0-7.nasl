...
if (description)
{
  ...
  script_cve_id("CVE-2021-45949");

  script_name(english:"CentOS 9 : ghostscript-9.54.0-7.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for ghostscript.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
ghostscript-9.54.0-7.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=17368");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream ghostscript package.");
...
var pkgs = [
    {'reference':'ghostscript-9.54.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-doc-9.54.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-gtk-9.54.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-tools-dvipdf-9.54.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-tools-fonts-9.54.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-tools-printing-9.54.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-x11-9.54.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libgs-9.54.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libgs-devel-9.54.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ghostscript / ghostscript-doc / ghostscript-gtk / etc');
}
