...
# extracted from Red Hat Security Advisory RHSA-2023:7174. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7174");

  script_name(english:"RHEL 8 : perl-HTTP-Tiny (RHSA-2023:7174)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7174.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3fe97237");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7174");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL perl-HTTP-Tiny package based on the guidance in RHSA-2023:7174.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'perl-HTTP-Tiny-0.074-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
