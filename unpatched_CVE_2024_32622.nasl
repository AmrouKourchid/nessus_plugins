...
if (description)
{
  ...
  script_cve_id("CVE-2024-32622");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-32622");
...
patch available.
  ...
  - HDF5 Library through 1.14.3 contains a out-of-bounds read operation in H5FL_arr_malloc in H5FL.c (called
    from H5S_set_extent_simple in H5S.c). (CVE-2024-32622)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32622");
