...
# extracted from Red Hat Security Advisory RHSA-2019:4192. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-17531");
  script_xref(name:"RHSA", value:"2019:4192");

  script_name(english:"RHEL 7 : rh-maven35-jackson-databind (RHSA-2019:4192)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-maven35-jackson-databind.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:4192 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_4192.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16a2ce7d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1775293");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:4192");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-maven35-jackson-databind package based on the guidance in RHSA-2019:4192.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-maven35-jackson-databind-2.7.6-2.8.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven35-jackson-databind-javadoc-2.7.6-2.8.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
