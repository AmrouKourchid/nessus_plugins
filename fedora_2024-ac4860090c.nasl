...
# extracted from Fedora Security Advisory FEDORA-2024-ac4860090c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ac4860090c");

  script_name(english:"Fedora 40 : libopenmpt (2024-ac4860090c)");
...
FEDORA-2024-ac4860090c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ac4860090c");
...
var pkgs = [
    {'reference':'libopenmpt-0.7.8-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
