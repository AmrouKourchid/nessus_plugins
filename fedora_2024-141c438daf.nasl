...
# extracted from Fedora Security Advisory FEDORA-2024-141c438daf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-141c438daf");

  script_name(english:"Fedora 40 : chromium (2024-141c438daf)");
...
FEDORA-2024-141c438daf advisory.

    - fix crash on ppc64le

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-141c438daf");
...
var pkgs = [
    {'reference':'chromium-126.0.6478.182-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
