...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : golang (EulerOS-SA-2021-2633)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2633
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a9a6b174");
...
var pkgs = [
  "golang-1.11.2-17.h9.eulerosv2r8",
  "golang-bin-1.11.2-17.h9.eulerosv2r8",
  "golang-src-1.11.2-17.h9.eulerosv2r8"
];
