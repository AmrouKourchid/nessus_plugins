...
# extracted from Fedora Security Advisory FEDORA-2025-3e5228ee23
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3e5228ee23");

  script_name(english:"Fedora 41 : krb5 (2025-3e5228ee23)");
...
FEDORA-2025-3e5228ee23 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3e5228ee23");
...
var pkgs = [
    {'reference':'krb5-1.21.3-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
