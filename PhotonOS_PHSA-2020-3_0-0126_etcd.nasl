...
# extracted from VMware Security Advisory PHSA-2020-3.0-0126. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-15113", "CVE-2020-15114");

  script_name(english:"Photon OS 3.0: Etcd PHSA-2020-3.0-0126");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the etcd package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-126.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'etcd-3.4.10-1.ph3')) flag++;
