...
# extracted from Fedora Security Advisory FEDORA-2022-3fd94cef3e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-3fd94cef3e");
  script_xref(name:"IAVA", value:"2022-A-0299-S");

  script_name(english:"Fedora 37 : libldb / samba (2022-3fd94cef3e)");
...
FEDORA-2022-3fd94cef3e advisory.

    Update to version 4.16.4 to address security fixes for CVE-2022-32742, CVE-2022-32744, CVE-2022-32745,
    CVE-2022-32746
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3fd94cef3e");
...
var pkgs = [
    {'reference':'libldb-2.5.2-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'samba-4.16.4-0.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
