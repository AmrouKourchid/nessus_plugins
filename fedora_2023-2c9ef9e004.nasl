...
# extracted from Fedora Security Advisory FEDORA-2023-2c9ef9e004
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2c9ef9e004");

  script_name(english:"Fedora 38 : netconsd (2023-2c9ef9e004)");
...
FEDORA-2023-2c9ef9e004 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2c9ef9e004");
...
var pkgs = [
    {'reference':'netconsd-0.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
