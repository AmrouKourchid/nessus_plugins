...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL6.x i386/x86_64 (20200224)");
...
(CVE-2020-6792)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2002&L=SCIENTIFIC-LINUX-ERRATA&P=10320
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af710c4b");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"thunderbird-68.5.0-1.el6_10", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"thunderbird-debuginfo-68.5.0-1.el6_10", allowmaj:TRUE)) flag++;
