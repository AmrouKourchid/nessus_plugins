...
# extracted from Fedora Security Advisory FEDORA-2024-a6817a2e80
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a6817a2e80");

  script_name(english:"Fedora 40 : python-webob (2024-a6817a2e80)");
...
FEDORA-2024-a6817a2e80 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a6817a2e80");
...
"Update the affected python-webob package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-webob");
...
var pkgs = [
    {'reference':'python-webob-1.8.8-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
