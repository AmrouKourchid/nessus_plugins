...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 11.2.12 / 12.1.9 Multiple Vulnerabilities");
...
Windows host is prior to 12.1.9/11.2.12. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor version 11.2.12 / 12.1.9 or later");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-47810");
...
var constraints = [
  { 'max_version' : '11.2.11.54113', 'fixed_version' : '11.2.12', 'fixed_display' : '12.1.9/11.2.12' },
  { 'min_version' : '12.0', 'max_version' : '12.1.8.15703', 'fixed_version' : '12.1.9' }
];
