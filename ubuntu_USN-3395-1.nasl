...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : c-ares vulnerability (USN-3395-1)");
...
in the USN-3395-1 advisory.

    It was discovered that c-ares incorrectly handled certain NAPTR responses. A remote attacker could
    possibly use this issue to cause applications using c-ares to crash, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3395-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.10.0-2ubuntu0.2'},
    {'osver': '14.04', 'pkgname': 'libc-ares2', 'pkgver': '1.10.0-2ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.10.0-3ubuntu0.2'},
    {'osver': '16.04', 'pkgname': 'libc-ares2', 'pkgver': '1.10.0-3ubuntu0.2'}
];
