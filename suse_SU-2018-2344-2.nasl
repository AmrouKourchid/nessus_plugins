...
# extracted from SUSE update advisory SUSE-SU-2018:2344-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (SUSE-SU-2018:2344-2) (Foreshadow)");
...
CVE-2018-5390 aka 'SegmentSmack': The Linux Kernel can be forced to
...
ucma_leave_multicast to access a certain data structure after a
...
scenario where a directory is SGID to a certain group and is writable
...
The intended behavior was that the non-member can trigger creation of
a directory (but not a plain file) whose group ownership is that
group. The non-member can escalate privileges by making the plain file
executable and SGID (bnc#1100416).

CVE-2018-13406: An integer overflow in the uvesafb_setcmap function in
drivers/video/fbdev/uvesafb.c could result in local attackers being
able to crash the kernel or potentially elevate privileges because
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1094248");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1096130");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1097140");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c35a6b5");
...
SUSE-SLE-SERVER-12-SP2-BCL-2018-1603=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"kernel-default-4.4.121-92.92.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"kernel-default-base-4.4.121-92.92.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"kernel-default-base-debuginfo-4.4.121-92.92.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"kernel-default-debuginfo-4.4.121-92.92.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"kernel-default-debugsource-4.4.121-92.92.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"kernel-default-devel-4.4.121-92.92.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"kernel-syms-4.4.121-92.92.1")) flag++;
