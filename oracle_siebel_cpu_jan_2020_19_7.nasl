...
if (description)
{
  ...
  script_cve_id("CVE-2020-2559");

  script_name(english:"Oracle Siebel Server <= 19.7 (January 2020 CPU)");
...
January 2020 CPU advisory.

  - Vulnerability in the Siebel UI Framework product of Oracle Siebel CRM (component: UIF Open UI). Supported
    versions that are affected are 19.7 and prior. Easily exploitable vulnerability allows unauthenticated
    attacker with network access via HTTP to compromise Siebel UI Framework. Successful attacks of this
    vulnerability can result in unauthorized read access to a subset of Siebel UI Framework accessible data.
    (CVE-2020-2559)
...
"Apply the appropriate patch according to the January 2020 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-2559");
...
var constraints = [
  { 'max_version' : '19.7.999', 'fixed_version' : '19.11' }
];
