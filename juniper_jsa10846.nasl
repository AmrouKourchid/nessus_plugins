...
if (description)
{
  ...
  script_cve_id("CVE-2018-0018");
  script_bugtraq_id(103748);
  script_xref(name:"JSA", value:"JSA10846");

  script_name(english:"Juniper Junos IDP Policy Compilation Packet Handling Firewall Rule Bypass Remote Information Disclosure (JSA10846)");
...
is affected by an information disclosure vulnerability.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf29f95d");
  script_set_attribute(attribute:"solution", value:
"Apply the relevant Junos software release referenced in
Juniper advisory JSA10846.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-0018");
