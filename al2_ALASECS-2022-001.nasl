...
# extracted from Amazon Linux 2 Security Advisory ALASECS-2022-001.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2022-23648", "CVE-2022-24769", "CVE-2022-31030");

  script_name(english:"Amazon Linux 2 : ecs-init, docker, containerd, runc (ALASECS-2022-001)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of containerd installed on the remote host is prior to 1.4.13-3. The version of docker installed on the
remote host is prior to 20.10.13-2. The version of ecs-init installed on the remote host is prior to 1.61.1-1. The
version of runc installed on the remote host is prior to 1.0.3-3. It is, therefore, affected by multiple vulnerabilities
as referenced in the ALAS2ECS-2022-001 advisory.

    A bug was found in containerd where containers launched through containerd's CRI implementation with a
    specially-crafted image configuration could gain access to read-only copies of arbitrary files and
    directories on the host. This may bypass any policy-based enforcement on container setup (including a
    Kubernetes Pod Security Policy) and expose potentially sensitive information. Kubernetes and crictl can
    both be configured to use containerd's CRI implementation. (CVE-2022-23648)
    ...
    A bug was found in containerd's CRI implementation where programs inside a container can cause the
    containerd daemon to consume memory without bound during invocation of the ExecSync API. This can cause
    containerd to consume all available memory on the computer, denying service to other legitimate workloads.
    Kubernetes and crictl can both be configured to use containerd's CRI implementation; ExecSync may be used
    when running probes or when executing processes via an exec facility. (CVE-2022-31030)

Tenable has extracted the preceding description block directly from the tested product security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASECS-2022-001.html");
...
"Run 'yum update ecs-init' to update your system.
 ...
 Run 'yum update runc' to update your system.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:ecs-init");
...
var pkgs = [
    {'reference':'containerd-1.4.13-3.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'containerd-1.4.13-3.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'containerd-debuginfo-1.4.13-3.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'containerd-debuginfo-1.4.13-3.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'containerd-stress-1.4.13-3.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'containerd-stress-1.4.13-3.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-20.10.13-2.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-20.10.13-2.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-debuginfo-20.10.13-2.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-debuginfo-20.10.13-2.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ecs-init-1.61.1-1.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ecs-init-1.61.1-1.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'runc-1.0.3-3.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'runc-1.0.3-3.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'runc-debuginfo-1.0.3-3.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'runc-debuginfo-1.0.3-3.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
