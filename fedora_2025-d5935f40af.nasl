...
# extracted from Fedora Security Advisory FEDORA-2025-d5935f40af
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d5935f40af");

  script_name(english:"Fedora 41 : chromium (2025-d5935f40af)");
...
FEDORA-2025-d5935f40af advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d5935f40af");
...
var pkgs = [
    {'reference':'chromium-134.0.6998.88-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
