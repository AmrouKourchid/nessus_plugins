...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 11.x < 11.0.27.6.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is 11 prior to 11.0.27.6.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-11-2025-Apr-15 advisory.
...
"Update to Amazon Corretto Java 11.0.27.6.1 or later");
...
var constraints = [
  { 'min_version' : '11.0', 'fixed_version' : '11.0.27.6.1' }
];
