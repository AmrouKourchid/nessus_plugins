...
# Oracle Linux Security Advisory ELSA-2018-1060 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : pcs (ELSA-2018-1060)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2018-1060 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-1060.html");
...
var pkgs = [
    {'reference':'pcs-0.9.162-5.0.3.el7_5.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pcs-snmp-0.9.162-5.0.3.el7_5.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
