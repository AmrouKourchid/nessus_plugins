...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5034809");
  script_xref(name:"MSKB", value:"5034831");
  script_xref(name:"MSFT", value:"MS24-5034809");
  script_xref(name:"MSFT", value:"MS24-5034831");
  script_xref(name:"IAVA", value:"2024-A-0092-S");
  script_xref(name:"IAVA", value:"2024-A-0091-S");

  script_name(english:"KB5034809: Windows Server 2008 R2 Security Update (February 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034809");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034831");
...
if (("windows server 2008 r2" >< tolower(os_name)) &&
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'02_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5034831, 5034809])
)
{
