...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : Linux kernel vulnerability (USN-5039-1)");
...
USN-5039-1 advisory.
    ...
    Andy Nguyen discovered that the netfilter subsystem in the Linux kernel contained an out-of-bounds write
    in its setsockopt() implementation. A local attacker could use this to cause a denial of service (system
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5039-1');
}
