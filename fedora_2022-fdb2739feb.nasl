...
# extracted from Fedora Security Advisory FEDORA-2022-fdb2739feb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-fdb2739feb");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"Fedora 35 : python3.7 (2022-fdb2739feb)");
...
FEDORA-2022-fdb2739feb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-fdb2739feb");
...
var pkgs = [
    {'reference':'python3.7-3.7.16-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
