...
# extracted from Red Hat Security Advisory RHSA-2023:4030. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4030");
  script_xref(name:"IAVB", value:"2023-B-0044-S");

  script_name(english:"RHEL 9 : grafana (RHSA-2023:4030)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4030.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b189cb8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2213626");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4030");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana package based on the guidance in RHSA-2023:4030.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-9.0.9-3.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'grafana-9.0.9-3.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
