...
vulnerabilities as referenced in the ALAS2KERNEL-5.4-2022-002 advisory.
    ...
    2024-09-12: CVE-2021-4442 was added to this advisory.

    An issue was discovered in the Linux kernel. Fastrpc_internal_invoke in drivers/misc/fastrpc.c does not
    prevent user applications from sending kernel RPC messages. This is a related issue to CVE-2019-2308.
    (CVE-2021-28375)
    ...
    tcp: add sanity tests to TCP_QUEUE_SEQ (CVE-2021-4442)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-4442.html");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2021-4442", "CVE-2021-28375", "CVE-2021-28660", "CVE-2021-28688", "CVE-2021-28964", "CVE-2021-28971", "CVE-2021-29650");
