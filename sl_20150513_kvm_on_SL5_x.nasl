...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : kvm on SL5.x x86_64 (20150513) (Venom)");
...
3) Restart the KVM guest virtual machines.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2829f909");
