...
# openSUSE Security Update openSUSE-SU-2023:0411-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : putty (openSUSE-SU-2023:0411-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1218128");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/S7UNBVBZXNPUVRYGXMQJVWO63X7TAJUV/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f38543ba");
...
var pkgs = [
    {'reference':'putty-0.80-bp155.2.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE}
];
