...
# extracted from Debian Security Advisory DSA-4273. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4273");

  script_name(english:"Debian DSA-4273-1 : intel-microcode - security update (Spectre)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"This update ships updated CPU microcode for some types of Intel CPUs
and provides SSBD support (needed to address 'Spectre v4') and fixes
for'Spectre v3a'.");
...
in version 3.20180703.2~deb9u1.");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"intel-microcode", reference:"3.20180703.2~deb9u1")) flag++;
