...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : poppler (EulerOS-SA-2019-1335)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1335
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8fc62a08");
...
pkgs = ["poppler-0.26.5-17.h15",
        "poppler-glib-0.26.5-17.h15",
        "poppler-qt-0.26.5-17.h15",
        "poppler-utils-0.26.5-17.h15"];
