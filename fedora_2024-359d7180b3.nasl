...
# extracted from Fedora Security Advisory FEDORA-2024-359d7180b3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-359d7180b3");

  script_name(english:"Fedora 39 : zabbix (2024-359d7180b3)");
...
FEDORA-2024-359d7180b3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-359d7180b3");
...
var pkgs = [
    {'reference':'zabbix-6.0.25-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
