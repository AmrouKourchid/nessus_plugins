...
"The version of Google Chrome installed on the remote Windows host is prior to 123.0.6312.122. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'123.0.6312.122', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
