...
# extracted from Debian Security Advisory DLA-2130-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2130-1 : libapache2-mod-auth-openidc security");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"An issue has been found in libapache2-mod-auth-openidc, an OpenID
Connect authentication module for Apache.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/02/msg00035.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libapache2-mod-auth-openidc", reference:"1.6.0-1+deb8u3")) flag++;
