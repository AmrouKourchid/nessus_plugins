...
# extracted from openSUSE Security Update openSUSE-2019-574.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : sssd (openSUSE-2019-574)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1098163");
...
if ( rpm_check(release:"SUSE15.0", reference:"libipa_hbac-devel-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libipa_hbac0-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libipa_hbac0-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libnfsidmap-sss-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libnfsidmap-sss-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsss_certmap-devel-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsss_certmap0-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsss_certmap0-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsss_idmap-devel-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsss_idmap0-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsss_idmap0-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsss_nss_idmap-devel-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsss_nss_idmap0-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsss_nss_idmap0-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsss_simpleifp-devel-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsss_simpleifp0-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libsss_simpleifp0-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-ipa_hbac-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-ipa_hbac-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-sss-murmur-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-sss-murmur-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-sss_nss_idmap-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-sss_nss_idmap-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-sssd-config-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-sssd-config-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-ad-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-ad-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-dbus-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-dbus-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-debugsource-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-ipa-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-ipa-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-krb5-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-krb5-common-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-krb5-common-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-krb5-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-ldap-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-ldap-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-proxy-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-proxy-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-tools-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-tools-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-wbclient-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-wbclient-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-wbclient-devel-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-winbind-idmap-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"sssd-winbind-idmap-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"sssd-32bit-1.16.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"sssd-32bit-debuginfo-1.16.1-lp150.2.3.1") ) flag++;
