...
# extracted from Red Hat Security Advisory RHSA-2018:2245. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2245");

  script_name(english:"RHEL 6 / 7 : rh-ror50-rubygem-sprockets (RHSA-2018:2245)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-ror50-rubygem-sprockets.");
...
in the RHSA-2018:2245 advisory.

    Sprockets is a Ruby library for compiling and serving web assets. It features declarative dependency
    management for JavaScript and CSS assets, as well as a powerful preprocessor pipeline that allows to write
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2245.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8564c8e2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2245");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-ror50-rubygem-sprockets package based on the guidance in RHSA-2018:2245.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-3760");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-ror50-rubygem-sprockets");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-ror50-rubygem-sprockets-doc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-ror50-rubygem-sprockets-3.7.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-ror50-rubygem-sprockets-doc-3.7.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-ror50-rubygem-sprockets-3.7.1-2.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-ror50-rubygem-sprockets-doc-3.7.1-2.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-ror50-rubygem-sprockets / rh-ror50-rubygem-sprockets-doc');
}
