...
# extracted from Fedora Security Advisory FEDORA-2022-49b20342c0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-49b20342c0");

  script_name(english:"Fedora 35 : nextcloud (2022-49b20342c0)");
...
FEDORA-2022-49b20342c0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-49b20342c0");
...
var pkgs = [
    {'reference':'nextcloud-25.0.1-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
