...
# extracted from Fedora Security Advisory FEDORA-2023-6550d9323b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6550d9323b");

  script_name(english:"Fedora 36 : golang-github-need-being-tree / golang-helm-3 / golang-oras / etc (2023-6550d9323b)");
...
FEDORA-2023-6550d9323b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6550d9323b");
...
var pkgs = [
    {'reference':'golang-github-need-being-tree-0.1.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-helm-3-3.11.1-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-oras-0.15.1-1.20221105git690716b.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-oras-1-1.2.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-oras-2-2.0.0~rc.4-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
