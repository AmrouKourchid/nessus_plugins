...
referenced in the RHSA-2023:6793 advisory.
    ...
    The following packages have been upgraded to a later upstream version: rh-python38-python (3.8.18), rh-
    python38-python-cryptography (2.8), rh-python38-python-pip (19.3.1), rh-python38-python-requests (2.22.0),
    rh-python38-python-setuptools (41.6.0), rh-python38-python-wheel (0.33.6).
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?48521c10");
