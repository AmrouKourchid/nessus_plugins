...
if (description)
{
  ...
  script_name(english:"CentOS 7 : python-twisted-web (RHSA-2020:1561)");
...
var pkgs = [
    {'reference':'python-twisted-web-12.1.0-7.el7_8', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-twisted-web-12.1.0-7.el7_8', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
