...
# extracted from Fedora Security Advisory FEDORA-2023-20feb865d8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-20feb865d8");

  script_name(english:"Fedora 39 : podman-tui (2023-20feb865d8)");
...
FEDORA-2023-20feb865d8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-20feb865d8");
...
var pkgs = [
    {'reference':'podman-tui-0.15.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
