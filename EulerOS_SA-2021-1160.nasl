...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : openssl (EulerOS-SA-2021-1160)");
...
vulnerability :
  ...
  - The OpenSSL toolkit provides support for secure
    ...
    protocols.Security Fix(es):The X.509 GeneralName type
    is a generic type for representing different types of
    names. One of those name types is known as
    EDIPartyName. OpenSSL provides a function
    GENERAL_NAME_cmp which compares different instances of
    a GENERAL_NAME to see if they are equal or not. This
    function behaves incorrectly when both GENERAL_NAMEs
    contain an EDIPARTYNAME. A NULL pointer dereference and
    a crash may occur leading to a possible denial of
    service attack. OpenSSL itself uses the
    ...
    attack.(CVE-2020-1971)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1160
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?db2222d9");
...
pkgs = ["openssl-1.1.1-3.h13.eulerosv2r8",
        ...
        "openssl-perl-1.1.1-3.h13.eulerosv2r8"];
