...
# extracted from Fedora Security Advisory FEDORA-2023-98dff7aae5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-98dff7aae5");
  script_xref(name:"IAVA", value:"2023-A-0485-S");

  script_name(english:"Fedora 37 : curl (2023-98dff7aae5)");
...
FEDORA-2023-98dff7aae5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-98dff7aae5");
...
var pkgs = [
    {'reference':'curl-7.85.0-11.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
