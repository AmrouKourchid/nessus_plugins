...
the USN-5340-2 advisory.
    ...
    USN-5340-1 fixed several vulnerabilities in CKEditor. This update provides the fixes for CVE-2018-9861,
    CVE-2020-9281, CVE-2021-32809, CVE-2021-33829 and CVE-2021-37695 for Ubuntu 16.04 ESM.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ckeditor', 'pkgver': '4.5.7+dfsg-2ubuntu0.16.04.1~esm1', 'ubuntu_pro': TRUE}
];
