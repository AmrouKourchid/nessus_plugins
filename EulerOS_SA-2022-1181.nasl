...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openssl (EulerOS-SA-2022-1181)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1181
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ed97938");
...
var pkgs = [
  "openssl-1.0.2k-16.h17",
  "openssl-devel-1.0.2k-16.h17",
  "openssl-libs-1.0.2k-16.h17"
];
