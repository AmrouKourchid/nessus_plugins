...
# extracted from Red Hat Security Advisory flatpak_libreoffice. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : flatpak_libreoffice (Unpatched Vulnerability) (deprecated)");
