...
# extracted from Debian Security Advisory dla-3447. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3447 : libruby2.5 - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libruby2.5', 'reference': '2.5.5-3+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby2.5', 'reference': '2.5.5-3+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby2.5-dev', 'reference': '2.5.5-3+deb10u5'},
    {'release': '10.0', 'prefix': 'ruby2.5-doc', 'reference': '2.5.5-3+deb10u5'}
];
