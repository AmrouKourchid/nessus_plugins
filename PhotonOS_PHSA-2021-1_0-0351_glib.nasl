...
# extracted from VMware Security Advisory PHSA-2021-1.0-0351. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Glib PHSA-2021-1.0-0351");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the glib package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-351.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'glib-2.58.3-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'glib-devel-2.58.3-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'glib-schemas-2.58.3-2.ph1')) flag++;
