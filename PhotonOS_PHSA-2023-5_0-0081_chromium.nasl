...
# extracted from VMware Security Advisory PHSA-2023-5.0-0081. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Chromium PHSA-2023-5.0-0081");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the chromium package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-81.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-4354");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'chromium-116.0.5845.96-1.ph5')) flag++;
