...
# extracted from openSUSE Security Update openSUSE-2019-640.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : nextcloud (openSUSE-2019-640)");
...
Other bugs fixed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1105598");
