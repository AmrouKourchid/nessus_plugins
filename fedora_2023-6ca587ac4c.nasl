...
# extracted from Fedora Security Advisory FEDORA-2023-6ca587ac4c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6ca587ac4c");

  script_name(english:"Fedora 38 : cups-filters (2023-6ca587ac4c)");
...
FEDORA-2023-6ca587ac4c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6ca587ac4c");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:cups-filters package.");
...
var pkgs = [
    {'reference':'cups-filters-2.0~rc1-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
