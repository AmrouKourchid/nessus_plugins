...
# extracted from Red Hat Security Advisory RHSA-2020:5499. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5499.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b54c193");
...
"Update the RHEL nodejs:12 package based on the guidance in RHSA-2020:5499.");
  ...
  'nodejs:12': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-12.19.1-1.module+el8.3.0+8851+b7b41ca0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-12.19.1-1.module+el8.3.0+8851+b7b41ca0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-12.19.1-1.module+el8.3.0+8851+b7b41ca0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-12.19.1-1.module+el8.3.0+8851+b7b41ca0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-6.14.8-1.12.19.1.1.module+el8.3.0+8851+b7b41ca0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
