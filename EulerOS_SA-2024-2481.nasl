...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : nghttp2 (EulerOS-SA-2024-2481)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2481
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe590bd1");
...
var pkgs = [
  "libnghttp2-1.34.0-1.h4.eulerosv2r8"
];
