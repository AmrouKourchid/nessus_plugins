...
# extracted from Ubuntu Security Notice USN-4212-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : HAProxy vulnerability (USN-4212-1)");
...
USN-4212-1 advisory.
    ...
    Tim Dsterhus discovered that HAProxy incorrectly handled certain HTTP/2 headers. An attacker could
    possibly use this issue to execute arbitrary code through CRLF injection.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4212-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'haproxy', 'pkgver': '1.8.8-1ubuntu0.9'},
    {'osver': '18.04', 'pkgname': 'vim-haproxy', 'pkgver': '1.8.8-1ubuntu0.9'}
];
