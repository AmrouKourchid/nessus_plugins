...
the RHSA-2018:0260 advisory.
    ...
    * A race condition was found in systemd. This could result in automount requests not being serviced and
    processes using them could hang, causing denial of service. (CVE-2018-1049)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0260.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a73a145");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0260");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1534701");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL systemd package based on the guidance in RHSA-2018:0260.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libgudev1-219-42.el7_4.7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgudev1-devel-219-42.el7_4.7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-219-42.el7_4.7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-devel-219-42.el7_4.7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-journal-gateway-219-42.el7_4.7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-libs-219-42.el7_4.7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-networkd-219-42.el7_4.7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-python-219-42.el7_4.7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-resolved-219-42.el7_4.7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-sysv-219-42.el7_4.7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
