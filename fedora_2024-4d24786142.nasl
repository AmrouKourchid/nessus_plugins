...
# extracted from Fedora Security Advisory FEDORA-2024-4d24786142
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4d24786142");

  script_name(english:"Fedora 40 : syncthing (2024-4d24786142)");
...
FEDORA-2024-4d24786142 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4d24786142");
...
var pkgs = [
    {'reference':'syncthing-1.28.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
