...
# extracted from Fedora Security Advisory FEDORA-2020-9c19202d55.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-9c19202d55");

  script_name(english:"Fedora 31 : monit (2020-9c19202d55)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Update to 5.26.0 (includes security fix for CVE-2019-11454 and
CVE-2019-11455)
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-9c19202d55");
...
"Update the affected monit package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:monit");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"monit-5.26.0-1.fc31")) flag++;
