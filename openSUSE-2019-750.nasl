...
# extracted from openSUSE Security Update openSUSE-2019-750.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libX11 (openSUSE-2019-750)");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libX11-6 / libX11-6-32bit / libX11-6-32bit-debuginfo / etc");
}
