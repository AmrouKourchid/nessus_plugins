...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libvirt PHSA-2019-2.0-0161");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libvirt-3.2.0-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libvirt-debuginfo-3.2.0-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libvirt-devel-3.2.0-6.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libvirt-docs-3.2.0-6.ph2')) flag++;
