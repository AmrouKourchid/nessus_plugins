...
# extracted from Red Hat Security Advisory RHSA-2021:5206. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 : log4j (RHSA-2021:5206)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for log4j.");
...
in the RHSA-2021:5206 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_5206.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4b646e5c");
...
"Update the RHEL log4j package based on the guidance in RHSA-2021:5206.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'log4j-1.2.17-16.el7_3', 'sp':'3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-javadoc-1.2.17-16.el7_3', 'sp':'3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-manual-1.2.17-16.el7_3', 'sp':'3', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'log4j-1.2.17-17.el7_4', 'sp':'4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-javadoc-1.2.17-17.el7_4', 'sp':'4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-manual-1.2.17-17.el7_4', 'sp':'4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'log4j-1.2.17-17.el7_4', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-javadoc-1.2.17-17.el7_4', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-manual-1.2.17-17.el7_4', 'sp':'6', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'log4j-1.2.17-17.el7_4', 'sp':'7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-javadoc-1.2.17-17.el7_4', 'sp':'7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-manual-1.2.17-17.el7_4', 'sp':'7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
  ...
  },
  {
    ...
    'pkgs': [
      {'reference':'log4j-1.2.14-6.5.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-1.2.14-6.5.el6_10', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-1.2.14-6.5.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-javadoc-1.2.14-6.5.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-javadoc-1.2.14-6.5.el6_10', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-javadoc-1.2.14-6.5.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-manual-1.2.14-6.5.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-manual-1.2.14-6.5.el6_10', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-manual-1.2.14-6.5.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
