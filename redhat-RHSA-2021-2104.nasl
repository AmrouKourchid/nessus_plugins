...
referenced in the RHSA-2021:2104 advisory.
    ...
    The following packages have been upgraded to a later upstream version: rh-ruby25-ruby (2.5.9).
    (BZ#1952998)
    ...
    * rh-ruby25-ruby: Resolv::DNS: timeouts if multiple IPv6 name servers are given and address contains
    leading zero [rhscl-3] (BZ#1953001)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2104.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c37e750c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1952998");
...
"Update the affected packages.");
  ...
  script_cwe_id(41, 94, 113, 200, 400, 444, 611);
