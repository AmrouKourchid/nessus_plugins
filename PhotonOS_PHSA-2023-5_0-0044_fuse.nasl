...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Fuse PHSA-2023-5.0-0044");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'fuse-overlayfs-snapshotter-1.0.6-1.ph5')) flag++;
