...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : LibTIFF vulnerabilities (USN-3606-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS / 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as
referenced in the USN-3606-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3606-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libtiff-opengl', 'pkgver': '4.0.3-7ubuntu0.9'},
    {'osver': '14.04', 'pkgname': 'libtiff-tools', 'pkgver': '4.0.3-7ubuntu0.9'},
    {'osver': '14.04', 'pkgname': 'libtiff4-dev', 'pkgver': '4.0.3-7ubuntu0.9'},
    {'osver': '14.04', 'pkgname': 'libtiff5', 'pkgver': '4.0.3-7ubuntu0.9'},
    {'osver': '14.04', 'pkgname': 'libtiff5-alt-dev', 'pkgver': '4.0.3-7ubuntu0.9'},
    {'osver': '14.04', 'pkgname': 'libtiff5-dev', 'pkgver': '4.0.3-7ubuntu0.9'},
    {'osver': '14.04', 'pkgname': 'libtiffxx5', 'pkgver': '4.0.3-7ubuntu0.9'},
    {'osver': '16.04', 'pkgname': 'libtiff-opengl', 'pkgver': '4.0.6-1ubuntu0.4'},
    {'osver': '16.04', 'pkgname': 'libtiff-tools', 'pkgver': '4.0.6-1ubuntu0.4'},
    {'osver': '16.04', 'pkgname': 'libtiff5', 'pkgver': '4.0.6-1ubuntu0.4'},
    {'osver': '16.04', 'pkgname': 'libtiff5-dev', 'pkgver': '4.0.6-1ubuntu0.4'},
    {'osver': '16.04', 'pkgname': 'libtiffxx5', 'pkgver': '4.0.6-1ubuntu0.4'}
];
