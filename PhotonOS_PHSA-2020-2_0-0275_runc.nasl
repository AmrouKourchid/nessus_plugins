...
# extracted from VMware Security Advisory PHSA-2020-2.0-0275. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Runc PHSA-2020-2.0-0275");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the runc package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-275.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'runc-1.0.0.rc9-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'runc-doc-1.0.0.rc9-4.ph2')) flag++;
