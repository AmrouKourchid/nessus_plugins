...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Bluez PHSA-2022-3.0-0374");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-3658");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'bluez-5.58-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'bluez-devel-5.58-3.ph3')) flag++;
