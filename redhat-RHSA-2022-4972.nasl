...
# extracted from Red Hat Security Advisory RHSA-2022:4972. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:4972");

  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.9.38 (RHSA-2022:4972)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.9.38.");
...
in the RHSA-2022:4972 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4972.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0028cde8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4972");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2085361");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.9.38 packages based on the guidance in RHSA-2022:4972.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'conmon-2.0.29-3.rhaos4.9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube'},
      {'reference':'cri-o-1.22.5-3.rhaos4.9.gitb6d3a87.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'conmon-2.0.29-3.rhaos4.9.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube'},
      {'reference':'cri-o-1.22.5-3.rhaos4.9.gitb6d3a87.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
