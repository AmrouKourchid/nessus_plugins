...
# extracted from Fedora Security Advisory FEDORA-2023-36344fb44b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-36344fb44b");

  script_name(english:"Fedora 39 : tor (2023-36344fb44b)");
...
FEDORA-2023-36344fb44b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-36344fb44b");
...
var pkgs = [
    {'reference':'tor-0.4.8.9-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
