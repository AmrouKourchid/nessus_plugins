...
# extracted from Fedora Security Advisory FEDORA-2024-eef12396fc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-eef12396fc");

  script_name(english:"Fedora 40 : yarnpkg (2024-eef12396fc)");
...
FEDORA-2024-eef12396fc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-eef12396fc");
...
"Update the affected yarnpkg package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-4067");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.22-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
