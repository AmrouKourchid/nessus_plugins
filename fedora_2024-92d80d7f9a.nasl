...
# extracted from Fedora Security Advisory FEDORA-2024-92d80d7f9a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-92d80d7f9a");

  script_name(english:"Fedora 41 : webkit2gtk4.0 (2024-92d80d7f9a)");
...
FEDORA-2024-92d80d7f9a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-92d80d7f9a");
...
var pkgs = [
    {'reference':'webkit2gtk4.0-2.46.1-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
