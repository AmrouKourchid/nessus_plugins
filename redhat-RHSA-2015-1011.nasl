...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 : rhev-hypervisor (RHSA-2015:1011)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rhev-hypervisor.");
...
in the RHSA-2015:1011 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2015/rhsa-2015_1011.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?83a03d16");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1011");
...
"Update the RHEL rhev-hypervisor package based on the guidance in RHSA-2015:1011.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhev-hypervisor7-7.1-20150512.1.el7ev', 'release':'7', 'el_string':'el7ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rhev-hypervisor6-6.6-20150512.0.el6ev', 'release':'6', 'el_string':'el6ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
