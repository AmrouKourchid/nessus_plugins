...
# extracted from openSUSE Security Update openSUSE-2019-2067.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : wavpack (openSUSE-2019-2067)");
...
Security issues fixed :
  ...
  - CVE-2019-1010319: Fixed use of uninitialized variable in
    ParseWave64HeaderConfig that can result in unexpected
    control flow, crashes, and segfaults (bsc#1141334).

  - CVE-2019-11498: Fixed possible denial of service
    (application crash) in WavpackSetConfiguration64 via a
    DFF file that lacks valid sample-rate data
    (bsc#1133384).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1133384");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1141334");
...
if ( rpm_check(release:"SUSE15.1", reference:"libwavpack1-5.1.0-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libwavpack1-debuginfo-5.1.0-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"wavpack-5.1.0-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"wavpack-debuginfo-5.1.0-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"wavpack-debugsource-5.1.0-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"wavpack-devel-5.1.0-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libwavpack1-32bit-5.1.0-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libwavpack1-32bit-debuginfo-5.1.0-lp151.5.3.1") ) flag++;
