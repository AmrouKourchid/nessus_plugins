...
# extracted from Fedora Security Advisory FEDORA-2023-4df366ee80
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4df366ee80");

  script_name(english:"Fedora 39 : kernel (2023-4df366ee80)");
...
FEDORA-2023-4df366ee80 advisory.

    The 6.6.6 stable kernel update reverts the problematic cfg80211 patch that was brought into the 6.6.5
    kernel
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4df366ee80");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-6560");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2023-6560');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-4df366ee80');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.6.6-200.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
