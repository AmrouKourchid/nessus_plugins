...
# extracted from Amazon Linux 2 Security Advisory ALASECS-2023-024.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : containerd (ALASECS-2023-024)");
...
vulnerability as referenced in the ALAS2ECS-2023-024 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASECS-2023-024.html");
