...
# extracted from Fedora Security Advisory FEDORA-2020-35087800be.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : libxml2 (2020-35087800be)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-35087800be");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"libxml2-2.9.10-7.fc32")) flag++;
