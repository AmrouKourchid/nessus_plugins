...
the RHSA-2019:1907 advisory.
    ...
    * podman: Improper symlink resolution allows access to host files when executing `podman cp` on running
    containers (CVE-2019-10152)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1907.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?641a50c9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1907");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1715667");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1717919");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1727873");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1728242");
...
"Update the affected podman and / or podman-docker packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-10152");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-1.4.4-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-docker-1.4.4-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
