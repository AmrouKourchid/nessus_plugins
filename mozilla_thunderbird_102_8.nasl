...
"The version of Thunderbird installed on the remote Windows host is prior to 102.8. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2023-07 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'102.8', severity:SECURITY_HOLE);
