...
# extracted from Fedora Security Advisory FEDORA-2024-c4b84c1215
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c4b84c1215");
  script_xref(name:"IAVA", value:"2024-A-0695-S");

  script_name(english:"Fedora 39 : firefox (2024-c4b84c1215)");
...
FEDORA-2024-c4b84c1215 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c4b84c1215");
...
var pkgs = [
    {'reference':'firefox-132.0-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
