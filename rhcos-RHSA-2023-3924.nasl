...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.12.23 (RHSA-2023:3924)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.12.23.");
...
referenced in the RHSA-2023:3924 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.12.23 package based on the guidance in RHSA-2023:3924.");
...
var pkgs = [
    {'reference':'openshift-ansible-4.12.0-202306230041.p0.g74dc7b3.assembly.stream.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-ansible-test-4.12.0-202306230041.p0.g74dc7b3.assembly.stream.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-hyperkube-4.12.0-202306251254.p0.gc43ddea.assembly.stream.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-hyperkube-4.12.0-202306251254.p0.gc43ddea.assembly.stream.el9', 'release':'4', 'el_string':'el9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
