...
# extracted from Fedora Security Advisory FEDORA-2023-7342330743
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7342330743");

  script_name(english:"Fedora 38 : icecat (2023-7342330743)");
...
FEDORA-2023-7342330743 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7342330743");
...
var pkgs = [
    {'reference':'icecat-115.3.1-7.rh2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
