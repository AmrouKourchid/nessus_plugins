...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Simple Streams vulnerability (USN-2746-1)");
...
USN-2746-1 advisory.
    ...
    It was discovered that Simple Streams did not properly perform gpg verification in some situations. A
    remote attacker could use this to perform a machine-in-the-middle attack and inject malicious content into
    the stream.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2746-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-1337");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-simplestreams', 'pkgver': '0.1.0~bzr341-0ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'python-simplestreams-openstack', 'pkgver': '0.1.0~bzr341-0ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'python3-simplestreams', 'pkgver': '0.1.0~bzr341-0ubuntu2.2'},
    {'osver': '14.04', 'pkgname': 'simplestreams', 'pkgver': '0.1.0~bzr341-0ubuntu2.2'}
];
