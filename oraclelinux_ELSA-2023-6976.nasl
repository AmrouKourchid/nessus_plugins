...
# extracted from Oracle Linux Security Advisory ELSA-2023-6976.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libfastjson (ELSA-2023-6976)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6976.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected libfastjson package.");
...
var pkgs = [
    {'reference':'libfastjson-0.99.9-2.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libfastjson-0.99.9-2.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libfastjson-0.99.9-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
