...
# extracted from Red Hat Security Advisory RHSA-2021:2354. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2354");

  script_name(english:"RHEL 8 : libwebp (RHSA-2021:2354)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libwebp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:2354 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2354.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f894233a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2354");
...
"Update the RHEL libwebp package based on the guidance in RHSA-2021:2354.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libwebp-1.0.0-3.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-devel-1.0.0-3.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libwebp-1.0.0-3.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-devel-1.0.0-3.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
