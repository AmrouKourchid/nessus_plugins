...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Tar PHSA-2019-3.0-0016");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'tar-1.30-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'tar-debuginfo-1.30-3.ph3')) flag++;
