...
# SUSE update advisory SUSE-SU-2022:4485-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4485-1");

  script_name(english:"SUSE SLES12 Security Update : xorg-x11-server (SUSE-SU-2022:4485-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES12 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2022:4485-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013238.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28bcc6e4");
  script_set_attribute(attribute:"solution", value:
"Update the affected xorg-x11-server and / or xorg-x11-server-extra packages.");
...
var pkgs = [
    {'reference':'xorg-x11-server-7.6_1.18.3-76.57.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'xorg-x11-server-extra-7.6_1.18.3-76.57.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.2']},
    {'reference':'xorg-x11-server-7.6_1.18.3-76.57.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.3']},
    {'reference':'xorg-x11-server-extra-7.6_1.18.3-76.57.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-bcl-release-12.3']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'xorg-x11-server / xorg-x11-server-extra');
}
