...
# extracted from Red Hat Security Advisory RHSA-2024:9945. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9945");

  script_name(english:"RHEL 8 : haproxy (RHSA-2024:9945)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9945.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2473f3f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9945");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL haproxy package based on the guidance in RHSA-2024:9945.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy-1.8.23-3.el8_2.1', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
