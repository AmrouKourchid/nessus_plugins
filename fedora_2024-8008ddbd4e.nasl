...
# extracted from Fedora Security Advisory FEDORA-2024-8008ddbd4e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8008ddbd4e");

  script_name(english:"Fedora 41 : chromium (2024-8008ddbd4e)");
...
FEDORA-2024-8008ddbd4e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8008ddbd4e");
...
var pkgs = [
    {'reference':'chromium-129.0.6668.70-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
