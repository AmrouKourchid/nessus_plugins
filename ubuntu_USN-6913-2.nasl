...
# extracted from Ubuntu Security Notice USN-6913-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6913-2");

  script_name(english:"Ubuntu 16.04 LTS : phpCAS vulnerability (USN-6913-2)");
...
USN-6913-2 advisory.
    ...
    USN-6913-1 fixed CVE-2022-39369 for Ubuntu 20.04 LTS and Ubuntu 22.04 LTS. This update provides the
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6913-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'php-cas', 'pkgver': '1.3.3-2ubuntu1+esm1', 'ubuntu_pro': TRUE}
];
