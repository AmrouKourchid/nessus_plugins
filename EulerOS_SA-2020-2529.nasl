...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : python-lxml (EulerOS-SA-2020-2529)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the python-lxml packages installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2529
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d28cd2b4");
...
pkgs = ["python-lxml-4.2.3-2.h1.eulerosv2r8",
        "python2-lxml-4.2.3-2.h1.eulerosv2r8",
        "python3-lxml-4.2.3-2.h1.eulerosv2r8"];
