...
# extracted from Ubuntu Security Notice USN-4149-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4149-1");

  script_name(english:"Ubuntu 19.04 : unbound vulnerability (USN-4149-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"It was discovered that Unbound incorrectly handled certain NOTIFY
queries. An attacker could possibly use this issue to cause a denial
of service.
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/4149-1/");
  script_set_attribute(attribute:"solution", value:
"Update the affected libunbound8 and / or unbound packages.");
...
if (ubuntu_check(osver:"19.04", pkgname:"libunbound8", pkgver:"1.9.0-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"unbound", pkgver:"1.9.0-2ubuntu0.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libunbound8 / unbound");
}
