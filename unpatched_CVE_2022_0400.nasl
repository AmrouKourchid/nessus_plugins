...
if (description)
{
  ...
  script_cve_id("CVE-2022-0400");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-0400");
...
patch available.
  ...
  - An out-of-bounds read vulnerability was discovered in linux kernel in the smc protocol stack, causing
    remote dos. (CVE-2022-0400)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-0400");
