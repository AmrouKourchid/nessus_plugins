...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS : Bash vulnerability (USN-5380-1)");
...
referenced in the USN-5380-1 advisory.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'bash', 'pkgver': '4.3-14ubuntu1.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'bash-builtins', 'pkgver': '4.3-14ubuntu1.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'bash-static', 'pkgver': '4.3-14ubuntu1.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'bash', 'pkgver': '4.4.18-2ubuntu1.3', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'bash-builtins', 'pkgver': '4.4.18-2ubuntu1.3', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'bash-static', 'pkgver': '4.4.18-2ubuntu1.3', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'bash', 'pkgver': '5.0-6ubuntu1.2', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'bash-builtins', 'pkgver': '5.0-6ubuntu1.2', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'bash-static', 'pkgver': '5.0-6ubuntu1.2', 'ubuntu_pro': FALSE}
];
