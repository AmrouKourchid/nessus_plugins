...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.9.59 (RHSA-2023:1524)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.9.59.");
...
referenced in the RHSA-2023:1524 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.9.59 package based on the guidance in RHSA-2023:1524.");
...
var pkgs = [
    {'reference':'jenkins-2-plugins-4.9.1680069756-1.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
