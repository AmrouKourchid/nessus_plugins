...
# extracted from Red Hat Security Advisory RHSA-2024:8801. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8801");

  script_name(english:"RHEL 9 : openexr (RHSA-2024:8801)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8801.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b170bdc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8801");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openexr package based on the guidance in RHSA-2024:8801.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openexr-3.1.1-2.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openexr-devel-3.1.1-2.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openexr-libs-3.1.1-2.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
