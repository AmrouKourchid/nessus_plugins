...
# extracted from Fedora Security Advisory FEDORA-2023-f29e9560a1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f29e9560a1");

  script_name(english:"Fedora 38 : chromium (2023-f29e9560a1)");
...
FEDORA-2023-f29e9560a1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f29e9560a1");
...
var pkgs = [
    {'reference':'chromium-119.0.6045.123-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
