...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2880-1");

  script_name(english:"SUSE SLES12 Security Update : curl (SUSE-SU-2023:2880-1) (deprecated)");
...
"This plugin has been deprecated as the CVE that is assessed by the plugin has been rejected.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-July/015530.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7227eb91");
