...
# extracted from Red Hat Security Advisory RHSA-2022:0443. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-25717", "CVE-2021-4034");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/07/18");
  script_xref(name:"IAVA", value:"2022-A-0055");
  script_xref(name:"RHSA", value:"2022:0443");

  script_name(english:"RHEL 7 : RHV-H security update (redhat-virtualization-host) 4.3.21 (Important) (RHSA-2022:0443)");
...
referenced in the RHSA-2022:0443 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0443.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?49a9f287");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0443");
...
"Update the RHEL RHV-H package based on the guidance in RHSA-2022:0443.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.3.21-20220126.0.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
