...
advisory.
  ...
  - A vulnerability in the processing of TCP MD5 authentication in Juniper Networks Junos OS Evolved may allow
    ...
    in an impact on confidentiality or stability of the network. (CVE-2021-0297)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://supportportal.juniper.net/s/article/2021-10-Security-Bulletin-Junos-OS-Evolved-BGP-and-LDP-sessions-with-TCP-MD5-authentication-established-with-peers-not-configured-for-authentication-CVE-2021-0297
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c06a4ad");
...
var vuln_ranges = [
  {'min_ver':'0.0-EVO', 'fixed_ver':'20.3R2-S1-EVO'},
  {'min_ver':'20.4-EVO', 'fixed_ver':'20.4R2-EVO'},
