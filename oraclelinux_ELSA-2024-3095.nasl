...
# extracted from Oracle Linux Security Advisory ELSA-2024-3095.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : vorbis-tools (ELSA-2024-3095)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-3095.html");
...
"Update the affected vorbis-tools package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:vorbis-tools");
