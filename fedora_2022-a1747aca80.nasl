...
# extracted from Fedora Security Advisory FEDORA-2022-a1747aca80
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-a1747aca80");

  script_name(english:"Fedora 37 : krb5 (2022-a1747aca80)");
...
FEDORA-2022-a1747aca80 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-a1747aca80");
...
var pkgs = [
    {'reference':'krb5-1.19.2-13.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
