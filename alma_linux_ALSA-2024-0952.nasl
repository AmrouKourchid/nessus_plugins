...
# AlmaLinux Security Advisory ALSA-2024:0952.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:0952");
  script_xref(name:"IAVA", value:"2024-A-0108-S");

  script_name(english:"AlmaLinux 9 : firefox (ALSA-2024:0952)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:0952 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-0952.html");
...
var pkgs = [
    {'reference':'firefox-115.8.0-1.el9_3.alma', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-115.8.0-1.el9_3.alma', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-x11-115.8.0-1.el9_3.alma', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-x11-115.8.0-1.el9_3.alma', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
