...
if (description)
{
  ...
  script_cve_id("CVE-2022-49097");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49097");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: NFS: Avoid writeback threads getting
    stuck in mempool_alloc() In a low memory situation, allow the NFS writeback code to fail without getting
    stuck in infinite loops in mempool_alloc(). (CVE-2022-49097)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49097");
