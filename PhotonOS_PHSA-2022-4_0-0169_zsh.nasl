...
# extracted from VMware Security Advisory PHSA-2022-4.0-0169. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Zsh PHSA-2022-4.0-0169");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the zsh package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-169.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'zsh-5.8.1-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'zsh-html-5.8.1-1.ph4')) flag++;
