...
# extracted from Red Hat Security Advisory nbdkit. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-14850", "CVE-2021-3716");

  script_name(english:"RHEL 8 : nbdkit (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-14850");
