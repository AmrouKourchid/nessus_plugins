...
# extracted from Fedora Security Advisory FEDORA-2023-f07892dd59
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f07892dd59");

  script_name(english:"Fedora 38 : chromium (2023-f07892dd59)");
...
FEDORA-2023-f07892dd59 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f07892dd59");
...
var pkgs = [
    {'reference':'chromium-112.0.5615.49-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
