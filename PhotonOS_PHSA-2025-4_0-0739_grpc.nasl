...
# extracted from VMware Security Advisory PHSA-2025-4.0-0739. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Grpc PHSA-2025-4.0-0739");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the grpc package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-739.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:grpc");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'grpc-1.59.3-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'grpc-devel-1.59.3-2.ph4')) flag++;
