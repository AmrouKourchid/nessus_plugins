...
# extracted from Red Hat Security Advisory RHSA-2019:2004 and 
# Oracle Linux Security Advisory ELSA-2019-2004 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : icedtea-web (ELSA-2019-2004)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2019-2004 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-2004.html");
...
var pkgs = [
    {'reference':'icedtea-web-1.7.1-17.el8_0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'icedtea-web-javadoc-1.7.1-17.el8_0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
