...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : 389-ds-base (EulerOS-SA-2019-1046)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1046
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3c6dd2f");
...
"Update the affected 389-ds-base package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-10935");
...
pkgs = ["389-ds-base-1.3.5.10-20.h9",
        "389-ds-base-libs-1.3.5.10-20.h9"];
