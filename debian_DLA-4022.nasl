...
# extracted from Debian Security Advisory dla-4022. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4022 : tryton-server - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4022
advisory.
...
var pkgs = [
    {'release': '11.0', 'prefix': 'tryton-server', 'reference': '5.0.33-2+deb11u3'},
    {'release': '11.0', 'prefix': 'tryton-server-doc', 'reference': '5.0.33-2+deb11u3'}
];
