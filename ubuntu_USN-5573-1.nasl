...
# extracted from Ubuntu Security Notice USN-5573-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5573-1");

  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS : rsync vulnerability (USN-5573-1)");
...
referenced in the USN-5573-1 advisory.

    Evgeny Legerov discovered that zlib incorrectly handled memory when performing certain inflate operations.
    An attacker could use this issue to cause rsync to crash, resulting in a denial of service, or possibly
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5573-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'rsync', 'pkgver': '3.1.1-3ubuntu1.3+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'rsync', 'pkgver': '3.1.2-2.1ubuntu1.5', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'rsync', 'pkgver': '3.1.3-8ubuntu0.4', 'ubuntu_pro': FALSE}
];
