...
# extracted from Red Hat Security Advisory RHSA-2020:4484. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4484");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"RHEL 8 : expat (RHSA-2020:4484)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for expat.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:4484 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4484.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06193e46");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.3_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7e37d18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4484");
...
"Update the RHEL expat package based on the guidance in RHSA-2020:4484.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'expat-2.2.5-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-devel-2.2.5-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
