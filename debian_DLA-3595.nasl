...
# extracted from Debian Security Advisory dla-3595. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3595 : trafficserver - security update");
...
dla-3595 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3595-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'trafficserver', 'reference': '8.1.7-0+deb10u2'},
    {'release': '10.0', 'prefix': 'trafficserver-dev', 'reference': '8.1.7-0+deb10u2'},
    {'release': '10.0', 'prefix': 'trafficserver-experimental-plugins', 'reference': '8.1.7-0+deb10u2'}
];
