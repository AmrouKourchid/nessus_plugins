...
# extracted from Fedora Security Advisory FEDORA-2020-0fc6dd0fd2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-0fc6dd0fd2");

  script_name(english:"Fedora 30 : cacti / cacti-spine (2020-0fc6dd0fd2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-0fc6dd0fd2");
  script_set_attribute(attribute:"see_also", value:"https://www.cacti.net/release_notes.php?version=1.2.9");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"cacti-1.2.9-1.fc30")) flag++;
if (rpm_check(release:"FC30", reference:"cacti-spine-1.2.9-1.fc30")) flag++;
