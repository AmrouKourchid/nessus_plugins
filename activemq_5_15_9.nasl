...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2019-B-0023-S");
...
broker to stop responding.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0ea46105");
...
var constraints = [{"min_version" : "5.0", "fixed_version" : "5.15.9"}];
