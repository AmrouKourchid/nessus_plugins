...
# extracted from Amazon Linux AMI Security Advisory ALAS-2018-1084.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-1084");

  script_name(english:"Amazon Linux AMI : procmail (ALAS-2018-1084)");
...
execute arbitrary code as the user running formail.(CVE-2017-16844)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2018-1084.html");
...
"Run 'yum update procmail' to update your system.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:procmail");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:procmail-debuginfo");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"procmail-3.22-25.1.7.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"procmail-debuginfo-3.22-25.1.7.amzn1")) flag++;
