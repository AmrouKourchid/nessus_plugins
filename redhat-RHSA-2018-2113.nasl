...
referenced in the RHSA-2018:2113 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2113.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0be8c0c");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2018-16/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2113");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1584035");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1590493");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1595037");
...
"Update the RHEL firefox package based on the guidance in RHSA-2018:2113.");
  ...
  script_cwe_id(120, 125, 290, 416, 552, 829);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-60.1.0-4.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
