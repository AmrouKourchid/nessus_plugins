...
# extracted from Ubuntu Security Notice USN-3688-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : Spidermonkey vulnerabilities (USN-3688-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3688-1");
...
"Update the affected libmozjs-52-0 and / or libmozjs-52-dev packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-5150");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libmozjs-52-0', 'pkgver': '52.8.1-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libmozjs-52-dev', 'pkgver': '52.8.1-0ubuntu0.18.04.1'}
];
