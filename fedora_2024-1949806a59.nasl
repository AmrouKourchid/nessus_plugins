...
# extracted from Fedora Security Advisory FEDORA-2024-1949806a59
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1949806a59");
  script_xref(name:"IAVB", value:"2024-B-0153-S");

  script_name(english:"Fedora 40 : wireshark (2024-1949806a59)");
...
FEDORA-2024-1949806a59 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1949806a59");
...
var pkgs = [
    {'reference':'wireshark-4.2.8-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
