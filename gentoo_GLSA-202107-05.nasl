...
# extracted from Gentoo Linux Security Advisory GLSA 202107-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-05");

  script_name(english:"GLSA-202107-05 : libxml2: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202107-05
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202107-05");
...
if (qpkg_check(package:"dev-libs/libxml2", unaffected:make_list("ge 2.9.11"), vulnerable:make_list("lt 2.9.11"))) flag++;
