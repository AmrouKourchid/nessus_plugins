...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3408.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?23d21b18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3408");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1636619");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL git package based on the guidance in RHSA-2018:3408.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'emacs-git-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'emacs-git-el-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-all-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-bzr-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-cvs-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-daemon-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-email-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-gnome-keyring-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-gui-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-hg-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-instaweb-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-p4-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-svn-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitk-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitweb-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Git-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Git-SVN-1.8.3.1-20.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
