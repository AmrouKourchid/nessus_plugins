...
# extracted from Debian Security Advisory dla-3888. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3888 : php-twig - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-3888
advisory.
...
var pkgs = [
    {'release': '11.0', 'prefix': 'php-twig', 'reference': '2.14.3-1+deb11u3'},
    {'release': '11.0', 'prefix': 'php-twig-cssinliner-extra', 'reference': '2.14.3-1+deb11u3'},
    {'release': '11.0', 'prefix': 'php-twig-doc', 'reference': '2.14.3-1+deb11u3'},
    {'release': '11.0', 'prefix': 'php-twig-extra-bundle', 'reference': '2.14.3-1+deb11u3'},
    {'release': '11.0', 'prefix': 'php-twig-html-extra', 'reference': '2.14.3-1+deb11u3'},
    {'release': '11.0', 'prefix': 'php-twig-inky-extra', 'reference': '2.14.3-1+deb11u3'},
    {'release': '11.0', 'prefix': 'php-twig-intl-extra', 'reference': '2.14.3-1+deb11u3'},
    {'release': '11.0', 'prefix': 'php-twig-markdown-extra', 'reference': '2.14.3-1+deb11u3'}
];
