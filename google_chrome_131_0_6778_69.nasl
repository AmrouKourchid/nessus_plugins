...
"The version of Google Chrome installed on the remote Windows host is prior to 131.0.6778.69. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2024_11_stable-channel-update-for-desktop_12 advisory.
...
google_chrome_check_version(installs:installs, fix:'131.0.6778.69', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
