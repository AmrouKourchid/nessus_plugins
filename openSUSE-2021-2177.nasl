...
# openSUSE Security Update openSUSE-SU-2021:2177-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : arpwatch (openSUSE-SU-2021:2177-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:2177-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/DE7IGDIJ6QCS3LA5C7SC67VRDUWKSAEV/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?902a5582");
...
pkgs = [
    {'reference':'arpwatch-2.1a15-5.12.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'arpwatch-ethercodes-build-2.1a15-5.12.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
