...
# extracted from Fedora Security Advisory FEDORA-2023-b41b7b1f37
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b41b7b1f37");

  script_name(english:"Fedora 36 : zchunk (2023-b41b7b1f37)");
...
FEDORA-2023-b41b7b1f37 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b41b7b1f37");
  script_set_attribute(attribute:"solution", value:
"Update the affected zchunk package.");
...
var pkgs = [
    {'reference':'zchunk-1.3.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
