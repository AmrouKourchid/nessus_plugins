...
# extracted from Red Hat Security Advisory RHSA-2021:4510. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4510");

  script_name(english:"RHEL 8 : lua (RHSA-2021:4510)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for lua.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4510 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4510.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?83dc2aa3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4510");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1870290");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL lua package based on the guidance in RHSA-2021:4510.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lua-5.3.4-12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lua-devel-5.3.4-12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lua-libs-5.3.4-12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
