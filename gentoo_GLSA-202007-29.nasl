...
# extracted from Gentoo Linux Security Advisory GLSA 202007-29.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-29");

  script_name(english:"GLSA-202007-29 : rssh: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-29
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-29");
...
if (qpkg_check(package:"app-shells/rssh", unaffected:make_list(), vulnerable:make_list("le 2.3.4_p3"))) flag++;
