...
if (description)
{
  ...
  script_cve_id("CVE-2024-44254");

  script_name(english:"Fortinet FortiManager Authorization Bypass (FG-IR-23-204)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is affected by a buffer overflow vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of FortiManager that is 6.2.x, 6.4.x 7.0.x, 7.2.x through 7.2.4, or
7.4.x through 7.4.1. It is, therefore, affected by an authorization bypass vulnerability through user-controlled key 
...
"Update FortiManager to version 7.4.1, 7.2.5 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-44254");
...
var constraints = [
  ...
  { 'min_version': '7.4', 'fixed_version' : '7.4.1' }
];
