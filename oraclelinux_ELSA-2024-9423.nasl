...
# extracted from Oracle Linux Security Advisory ELSA-2024-9423.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python-dns (ELSA-2024-9423)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9423.html");
...
var pkgs = [
    {'reference':'python3-dns-2.6.1-3.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
