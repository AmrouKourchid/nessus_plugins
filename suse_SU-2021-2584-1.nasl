...
# SUSE update advisory SUSE-SU-2021:2584-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2584-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 18 for SLE 12 SP4) (SUSE-SU-2021:2584-1)");
...
the SUSE-SU-2021:2584-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-August/009239.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae58c676");
  script_set_attribute(attribute:"solution", value:
"Update the affected kgraft-patch-4_12_14-95_68-default package.");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-95_68-default-8-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-95_68-default');
}
