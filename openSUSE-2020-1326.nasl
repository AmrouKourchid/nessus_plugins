...
# extracted from openSUSE Security Update openSUSE-2020-1326.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : postgresql10 (openSUSE-2020-1326)");
...
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-contrib-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-contrib-debuginfo-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-debuginfo-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-debugsource-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-devel-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-devel-debuginfo-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-plperl-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-plperl-debuginfo-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-plpython-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-plpython-debuginfo-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-pltcl-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-pltcl-debuginfo-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-server-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-server-debuginfo-10.14-lp152.2.6.2") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"postgresql10-test-10.14-lp152.2.6.2") ) flag++;
