...
# extracted from F5 Networks BIG-IP Solution K37442533.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-5516");

  script_name(english:"F5 Networks BIG-IP : TMOS Shell vulnerability (K37442533)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"Authenticated users granted TMOS Shell (tmsh) access can access
...
to exfiltrate objects on the file system which should not be allowed.
(CVE-2018-5516)
...
administrative users with tmsh access.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K37442533");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K37442533.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '13.0.0-13.1.0','12.1.0-12.1.2','11.2.1-11.6.3'
    ],
    'unaffected': [
      '14.0.0','13.1.1','13.1.0.6','13.0.1','12.1.3'
    ],
  },
  'AM': {
    'affected': [
