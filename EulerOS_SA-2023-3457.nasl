...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : sysstat (EulerOS-SA-2023-3457)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the sysstat package installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3457
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d489645f");
...
var pkgs = [
  "sysstat-11.7.3-2.h11.eulerosv2r8"
];
