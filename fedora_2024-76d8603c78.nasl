...
# extracted from Fedora Security Advisory FEDORA-2024-76d8603c78
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-76d8603c78");

  script_name(english:"Fedora 40 : cobbler (2024-76d8603c78)");
...
FEDORA-2024-76d8603c78 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-76d8603c78");
...
var pkgs = [
    {'reference':'cobbler-3.3.7-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
