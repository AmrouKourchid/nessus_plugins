...
if (description)
{
  ...
  script_name(english:"RHEL 8 : OpenShift Container Platform 4.10.51 (RHSA-2023:0560)");
...
referenced in the RHSA-2023:0560 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0560.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ab4c65ac");
...
"Update the RHEL OpenShift Container Platform 4.10.51 package based on the guidance in RHSA-2023:0560.");
  ...
  script_cwe_id(22, 79, 200, 208, 328, 352, 358, 400, 502, 668, 693, 838, 862);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.10.1675144701-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
