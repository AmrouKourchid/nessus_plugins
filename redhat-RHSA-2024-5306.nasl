...
# extracted from Red Hat Security Advisory RHSA-2024:5306. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5306");

  script_name(english:"RHEL 8 : orc (RHSA-2024:5306)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for orc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:5306 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5306.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c3f7a3f2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5306");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL orc package based on the guidance in RHSA-2024:5306.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'orc-0.4.28-4.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'orc-compiler-0.4.28-4.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'orc-devel-0.4.28-4.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
