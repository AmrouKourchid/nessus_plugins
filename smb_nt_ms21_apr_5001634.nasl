...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5001634");
  script_xref(name:"MSFT", value:"MS21-5001634");

  script_name(english:"KB5001634: Windows 10 version 1803 OOB Update (Mar 2021) (deprecated)");
...
Nessus has not tested for this issue but has instead relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5001634");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5001634 to address this issue.");
