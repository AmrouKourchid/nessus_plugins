...
# extracted from Fedora Security Advisory FEDORA-2023-e51479556c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e51479556c");

  script_name(english:"Fedora 38 : php-phpmailer6 (2023-e51479556c)");
...
FEDORA-2023-e51479556c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e51479556c");
...
var pkgs = [
    {'reference':'php-phpmailer6-6.8.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
