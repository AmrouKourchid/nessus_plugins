...
# extracted from Fedora Security Advisory FEDORA-2024-c702ea0fb1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c702ea0fb1");

  script_name(english:"Fedora 38 : freerdp (2024-c702ea0fb1)");
...
FEDORA-2024-c702ea0fb1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c702ea0fb1");
...
var pkgs = [
    {'reference':'freerdp-2.11.7-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
