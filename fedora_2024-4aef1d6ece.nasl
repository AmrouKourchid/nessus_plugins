...
# extracted from Fedora Security Advisory FEDORA-2024-4aef1d6ece
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4aef1d6ece");

  script_name(english:"Fedora 40 : suricata (2024-4aef1d6ece)");
...
FEDORA-2024-4aef1d6ece advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4aef1d6ece");
...
var pkgs = [
    {'reference':'suricata-7.0.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
