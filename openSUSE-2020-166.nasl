...
# extracted from openSUSE Security Update openSUSE-2020-166.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : e2fsprogs (openSUSE-2020-166)");
...
"This update for e2fsprogs fixes the following issues :
  ...
  - CVE-2019-5188: Fixed a code execution vulnerability in
    the directory rehashing functionality (bsc#1160571).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1160571");
...
if ( rpm_check(release:"SUSE15.1", reference:"e2fsprogs-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"e2fsprogs-debuginfo-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"e2fsprogs-debugsource-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"e2fsprogs-devel-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libcom_err-devel-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libcom_err-devel-static-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libcom_err2-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libcom_err2-debuginfo-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libext2fs-devel-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libext2fs-devel-static-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libext2fs2-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libext2fs2-debuginfo-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"e2fsprogs-32bit-debuginfo-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libcom_err-devel-32bit-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libcom_err2-32bit-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libcom_err2-32bit-debuginfo-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libext2fs-devel-32bit-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libext2fs2-32bit-1.43.8-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libext2fs2-32bit-debuginfo-1.43.8-lp151.5.12.1") ) flag++;
