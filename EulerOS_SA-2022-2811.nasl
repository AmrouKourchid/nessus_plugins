...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : wavpack (EulerOS-SA-2022-2811)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2811
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3fce0cd3");
...
var pkgs = [
  "wavpack-5.1.0-9.h7.eulerosv2r8"
];
