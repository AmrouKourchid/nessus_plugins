...
# extracted from Amazon Linux 2 Security Advisory ALASECS-2023-006.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : ecs-service-connect-agent (ALASECS-2023-006)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of ecs-service-connect-agent installed on the remote host is prior to v1.26.4.0-1. It is, therefore,
affected by multiple vulnerabilities as referenced in the ALAS2ECS-2023-006 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASECS-2023-006.html");
...
var pkgs = [
    {'reference':'ecs-service-connect-agent-v1.26.4.0-1.amzn2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ecs-service-connect-agent-v1.26.4.0-1.amzn2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
