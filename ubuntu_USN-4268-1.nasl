...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : OpenSMTPD vulnerability (USN-4268-1)");
...
USN-4268-1 advisory.
    ...
    certain conditions. An attacker could use this vulnerability to execute arbitrary commands as root.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4268-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'opensmtpd', 'pkgver': '6.0.3p1-1ubuntu0.1'}
];
