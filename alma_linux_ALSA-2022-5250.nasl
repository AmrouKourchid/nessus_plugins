...
# AlmaLinux Security Advisory ALSA-2022:5250.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:5250");

  script_name(english:"AlmaLinux 9 : libxml2 (ALSA-2022:5250)");
...
ALSA-2022:5250 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-5250.html");
