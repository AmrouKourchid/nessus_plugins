...
if (description)
{
  ...
  script_cve_id("CVE-2024-58010");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-58010");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: binfmt_flat: Fix integer overflow bug
    on 32 bit systems Most of these sizes and counts are capped at 256MB so the math doesn't result in an
    integer overflow. The relocs count needs to be checked as well. Otherwise on 32bit systems the
    calculation of full_data could be wrong. full_data = data_len + relocs * sizeof(unsigned long);
    (CVE-2024-58010)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-58010");
