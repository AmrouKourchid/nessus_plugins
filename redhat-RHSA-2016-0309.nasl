...
# extracted from Red Hat Security Advisory RHSA-2016:0309. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-0757");
  script_xref(name:"RHSA", value:"2016:0309");

  script_name(english:"RHEL 7 : openstack-glance (RHSA-2016:0309)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openstack-glance.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2016:0309 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1302607");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_0309.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?044e3999");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:0309");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-glance package based on the guidance in RHSA-2016:0309.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0757");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-glance-2014.2.3-4.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-glance-doc-2014.2.3-4.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-glance-2014.2.3-4.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
