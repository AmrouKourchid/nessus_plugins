...
vulnerabilities as referenced in the ALAS2KERNEL-5.4-2022-009 advisory.
    ...
    References to CVE-2021-20322 have been added after the original release of this advisory, however those
    vulnerabilities were fixed by the packages referenced by this advisory's initial release on 2022-01-20.
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2021-3744", "CVE-2021-3764", "CVE-2021-20322", "CVE-2021-41864");
