...
if (description)
{
  ...
  script_name(english:"AIX (IJ50827)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ50827. It is, therefore, affected by a vulnerability
as referenced in the IJ50827 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ50827");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7150641");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ50827.");
...
var constraints = [
    {'release': '7.3', 'ml': '00', 'sp': '02', 'patch': 'IJ50827m4a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.3'},
    {'release': '7.3', 'ml': '00', 'sp': '03', 'patch': 'IJ50827m4a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.3'},
    {'release': '7.3', 'ml': '00', 'sp': '04', 'patch': 'IJ50827m4a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.3'}
];
