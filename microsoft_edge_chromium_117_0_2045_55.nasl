...
if (description)
{
  ...
  script_name(english:"Microsoft Edge (Chromium) < 117.0.2045.55 (CVE-2023-5346)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an web browser installed that is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft Edge installed on the remote Windows host is prior to 117.0.2045.55. It is, therefore, affected
by a vulnerability as referenced in the October 4, 2023 advisory.

  - Type Confusion in V8. (CVE-2023-5346)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://docs.microsoft.com/en-us/DeployEdge/microsoft-edge-relnotes-security#october-4-2023
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91471929");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2023-5346");
