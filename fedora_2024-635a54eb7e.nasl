...
# extracted from Fedora Security Advisory FEDORA-2024-635a54eb7e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-635a54eb7e");

  script_name(english:"Fedora 40 : glib2 / gnome-shell (2024-635a54eb7e)");
...
FEDORA-2024-635a54eb7e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-635a54eb7e");
...
var pkgs = [
    {'reference':'glib2-2.80.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnome-shell-46.1-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
