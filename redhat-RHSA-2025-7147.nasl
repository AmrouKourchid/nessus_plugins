...
# extracted from Red Hat Security Advisory RHSA-2025:7147. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7147");

  script_name(english:"RHEL 9 : rpm-ostree (RHSA-2025:7147)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rpm-ostree.");
...
the RHSA-2025:7147 advisory.

    The rpm-ostree tool binds together the RPM packaging model with the OSTree model of bootable file system
    trees. It provides commands that can be used both on client systems and on server-side composes. The rpm-
    ostree-client package provides commands for client systems to perform upgrades and rollbacks.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2343573");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-59716");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-68131");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7147.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cd7c03f5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7147");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rpm-ostree package based on the guidance in RHSA-2025:7147.");
  ...
  script_set_attribute(attribute:"cvss4_vector", value:"CVSS:4.0/AV:N/AC:H/AT:P/PR:N/UI:N/VC:L/VI:N/VA:L/SC:N/SI:N/SA:N");
  script_set_attribute(attribute:"cvss4_threat_vector", value:"CVSS:4.0/E:U");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-24898");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rpm-ostree-2025.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-ostree-libs-2025.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rpm-ostree / rpm-ostree-libs');
}
