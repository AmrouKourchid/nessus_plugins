...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Linux kernel vulnerabilities (USN-5113-1)");
...
var kernel_mappings = {
  '20.04': {
    '5.11.0': {
      'generic': '5.11.0-38',
      'generic-64k': '5.11.0-38',
      'generic-lpae': '5.11.0-38',
      'lowlatency': '5.11.0-38',
      'aws': '5.11.0-1020',
      'gcp': '5.11.0-1021'
    }
  }
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5113-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2020-3702', 'CVE-2021-3732', 'CVE-2021-3739', 'CVE-2021-3743', 'CVE-2021-3753', 'CVE-2021-38166', 'CVE-2021-40490', 'CVE-2021-42008');
