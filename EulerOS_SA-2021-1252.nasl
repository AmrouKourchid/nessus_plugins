...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : poppler (EulerOS-SA-2021-1252)");
...
vulnerabilities :
  ...
  - XRef::getEntry in XRef.cc in Poppler 0.72.0 mishandles
    ...
    XRef.h is called from Parser::makeStream in
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1252
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?028df2ed");
...
pkgs = ["poppler-0.67.0-5.h3.eulerosv2r9",
        "poppler-cpp-0.67.0-5.h3.eulerosv2r9",
        "poppler-help-0.67.0-5.h3.eulerosv2r9"];
