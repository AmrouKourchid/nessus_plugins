...
# extracted from Red Hat Security Advisory RHSA-2024:10831. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10831");

  script_name(english:"RHEL 8 : postgresql:16 (RHSA-2024:10831)");
...
referenced in the RHSA-2024:10831 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10831.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72192ada");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10831");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:16 package based on the guidance in RHSA-2024:10831.");
  ...
  'postgresql:16': [
    {
      ...
      'pkgs': [
        {'reference':'pg_repack-1.5.1-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pgaudit-16.0-1.module+el8.10.0+20413+d8116364', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgres-decoderbufs-2.4.0-1.Final.module+el8.10.0+20413+d8116364', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-16.6-1.module+el8.10.0+22551+c0330dc9', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
