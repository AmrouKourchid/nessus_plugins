...
# extracted from Amazon Linux AMI Security Advisory ALAS-2018-1024.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-1024");
  script_xref(name:"IAVA", value:"2018-A-0162");

  script_name(english:"Amazon Linux AMI : dhcp (ALAS-2018-1024)");
...
Note: As mentioned above, the fix for this issue is in the
NetworkManager integration script included with the dhcp package. The
severity of this advisory has been lowered to a low as the Amazon
Linux AMI does not use NetworkManager.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2018-1024.html");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"dhclient-4.1.1-53.P1.28.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"dhcp-4.1.1-53.P1.28.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"dhcp-common-4.1.1-53.P1.28.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"dhcp-debuginfo-4.1.1-53.P1.28.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"dhcp-devel-4.1.1-53.P1.28.amzn1")) flag++;
