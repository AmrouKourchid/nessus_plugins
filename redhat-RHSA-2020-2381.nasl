...
# extracted from Red Hat Security Advisory RHSA-2020:2381. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2381");
  script_xref(name:"IAVA", value:"2020-A-0238-S");
  script_xref(name:"IAVA", value:"2020-A-0344-S");

  script_name(english:"RHEL 7 : firefox (RHSA-2020:2381)");
...
referenced in the RHSA-2020:2381 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2381.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d140b0e8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2381");
...
"Update the RHEL firefox package based on the guidance in RHSA-2020:2381.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-68.9.0-1.el7_8', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.9.0-1.el7_8', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.9.0-1.el7_8', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.9.0-1.el7_8', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.9.0-1.el7_8', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
