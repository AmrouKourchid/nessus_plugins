...
if (description)
{
  ...
  script_cve_id("CVE-2023-46930");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-46930");
...
patch available.
  ...
  - GPAC 2.3-DEV-rev605-gfc9e29089-master contains a SEGV in gpac/MP4Box in gf_isom_find_od_id_for_track
    /afltest/gpac/src/isomedia/media_odf.c:522:14. (CVE-2023-46930)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-46930");
