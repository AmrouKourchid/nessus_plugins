...
# Oracle Linux Security Advisory ELSA-2019-1603 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : firefox (ELSA-2019-1603)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-1603.html");
...
var pkgs = [
    {'reference':'firefox-60.7.2-1.0.1.el7_6', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-60.7.2-1.0.1.el7_6', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-60.7.2-1.0.1.el7_6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
