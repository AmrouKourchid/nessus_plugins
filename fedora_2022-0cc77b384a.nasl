...
# extracted from Fedora Security Advisory FEDORA-2022-0cc77b384a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-0cc77b384a");

  script_name(english:"Fedora 36 : efl / enlightenment (2022-0cc77b384a)");
...
FEDORA-2022-0cc77b384a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-0cc77b384a");
...
var pkgs = [
    {'reference':'efl-1.26.3-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'enlightenment-0.25.4-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
