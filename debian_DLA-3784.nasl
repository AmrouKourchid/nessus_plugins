...
# extracted from Debian Security Advisory dla-3784. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3784 : caca-utils - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/libcaca");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-30498");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-30499");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/libcaca");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'caca-utils', 'reference': '0.99.beta19-2.1+deb10u1'},
    {'release': '10.0', 'prefix': 'libcaca-dev', 'reference': '0.99.beta19-2.1+deb10u1'},
    {'release': '10.0', 'prefix': 'libcaca0', 'reference': '0.99.beta19-2.1+deb10u1'}
];
