...
if (description)
{
  ...
  script_cve_id("CVE-2017-12187");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-12187");
...
patch available.
  ...
  - xorg-x11-server before 1.19.5 was missing length validation in RENDER extension allowing malicious X
    client to cause X server to crash or possibly execute arbitrary code. (CVE-2017-12187)
