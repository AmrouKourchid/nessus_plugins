...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : cups (EulerOS-SA-2021-2363)");
...
vulnerability :
  ...
  - A Incorrect Default Permissions vulnerability in the
    ...
    to set the content.(CVE-2021-25317)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2363
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3ab4ea7");
...
pkgs = ["cups-1.6.3-26.h7",
        "cups-client-1.6.3-26.h7",
        "cups-devel-1.6.3-26.h7",
        "cups-filesystem-1.6.3-26.h7",
        "cups-libs-1.6.3-26.h7",
        "cups-lpd-1.6.3-26.h7"];
