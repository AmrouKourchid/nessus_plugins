...
"The version of nghttp2 installed on the remote host is prior to 1.33.0-1.1.6. It is, therefore, affected by a
vulnerability as referenced in the ALAS-2020-1404 advisory.
...
var pkgs = [
    {'reference':'libnghttp2-1.33.0-1.1.6.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libnghttp2-1.33.0-1.1.6.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libnghttp2-devel-1.33.0-1.1.6.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libnghttp2-devel-1.33.0-1.1.6.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nghttp2-1.33.0-1.1.6.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nghttp2-1.33.0-1.1.6.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nghttp2-debuginfo-1.33.0-1.1.6.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nghttp2-debuginfo-1.33.0-1.1.6.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
