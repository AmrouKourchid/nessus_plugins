...
# extracted from Fedora Security Advisory FEDORA-2025-77ace1a41b
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-24788", "CVE-2025-22870", "CVE-2025-22871");
  script_xref(name:"IAVB", value:"2024-B-0052-S");
  script_xref(name:"FEDORA", value:"2025-77ace1a41b");
  script_xref(name:"IAVB", value:"2025-B-0048-S");

  script_name(english:"Fedora 41 : golang (2025-77ace1a41b)");
...
FEDORA-2025-77ace1a41b advisory.

    Includes security fixes to the net/http package, as well as bug fixes to the runtime and the go command.
    [Full changelog](https://github.com/golang/go/issues?q=milestone%3AGo1.23.8+label%3ACherryPickApproved).

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-77ace1a41b");
...
"Update the affected golang package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2025-22870");
...
var pkgs = [
    {'reference':'golang-1.23.8-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
