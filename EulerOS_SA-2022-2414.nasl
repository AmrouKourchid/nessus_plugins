...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : docker-engine (EulerOS-SA-2022-2414)");
...
issues.");
  # https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2022-2414#:~:text=EulerOS%2DSA%2D2022%2D2414
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b35b9d62");
...
var pkgs = [
  "docker-engine-18.09.0.200-200.h55.31.17.eulerosv2r10.src.rpm",
  "docker-engine-18.09.0.200-200.h55.31.17.eulerosv2r10.aarch64.rpm"
];
