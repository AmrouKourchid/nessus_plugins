...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : curl (EulerOS-SA-2019-1695)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1695
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d5b23d0");
...
pkgs = ["curl-7.29.0-46.h11",
        "libcurl-7.29.0-46.h11"];
