...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-723.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-47076", "CVE-2024-47176", "CVE-2024-47850");

  script_name(english:"Amazon Linux 2023 : cups-filters, cups-filters-devel, cups-filters-libs (ALAS2023-2024-723)");
...
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2024-723 advisory.
    ...
    conversion tasks needed in Printer Applications. The `cfGetPrinterAttributes5` function in
    `libcupsfilters` does not sanitize IPP attributes returned from an IPP server. When these IPP attributes
    are used, for instance, to generate a PPD file, this can lead to attacker controlled data to be provided
    to the rest of the CUPS system. (CVE-2024-47076)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-723.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/faqs.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2024-47076.html");
...
var pkgs = [
    {'reference':'cups-filters-1.28.16-3.amzn2023.0.3', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-1.28.16-3.amzn2023.0.3', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-debuginfo-1.28.16-3.amzn2023.0.3', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-debuginfo-1.28.16-3.amzn2023.0.3', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-debugsource-1.28.16-3.amzn2023.0.3', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-debugsource-1.28.16-3.amzn2023.0.3', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-devel-1.28.16-3.amzn2023.0.3', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-devel-1.28.16-3.amzn2023.0.3', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-libs-1.28.16-3.amzn2023.0.3', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-libs-1.28.16-3.amzn2023.0.3', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-libs-debuginfo-1.28.16-3.amzn2023.0.3', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-libs-debuginfo-1.28.16-3.amzn2023.0.3', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
