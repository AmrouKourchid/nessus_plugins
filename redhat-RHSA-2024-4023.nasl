...
# extracted from Red Hat Security Advisory RHSA-2024:4023. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4023");

  script_name(english:"RHEL 8 : Release of openshift-serverless-clients kn 1.33.0 security update & s (Important) (RHSA-2024:4023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Release of openshift-serverless-clients kn 1.33.0.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2024:4023 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2277862");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4023.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?60a72d82");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4023");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Release of openshift-serverless-clients kn 1.33.0 package based on the guidance in RHSA-2024:4023.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-serverless-clients-1.12.0-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
