...
# extracted from Fedora Security Advisory FEDORA-2024-2815d55cdf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2815d55cdf");

  script_name(english:"Fedora 39 : xorg-x11-server (2024-2815d55cdf)");
...
FEDORA-2024-2815d55cdf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2815d55cdf");
...
"Update the affected xorg-x11-server package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21886");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-30.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
