...
# extracted from Ubuntu Security Notice USN-5478-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5478-1");

  script_name(english:"Ubuntu 16.04 ESM : util-linux vulnerability (USN-5478-1)");
...
USN-5478-1 advisory.
    ...
    Christian Moch and Michael Gruhn discovered that the libblkid library of util-linux did not properly
    manage memory under certain circumstances. A local attacker could possibly use this issue
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5478-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'bsdutils', 'pkgver': '1:2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libblkid-dev', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libblkid1', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libfdisk-dev', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libfdisk1', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libmount-dev', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libmount1', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsmartcols-dev', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsmartcols1', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libuuid1', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'mount', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'util-linux', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'util-linux-locales', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'uuid-dev', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'uuid-runtime', 'pkgver': '2.27.1-6ubuntu3.10+esm2', 'ubuntu_pro': TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bsdutils / libblkid-dev / libblkid1 / libfdisk-dev / libfdisk1 / etc');
}
