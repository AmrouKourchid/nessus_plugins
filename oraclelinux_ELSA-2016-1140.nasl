...
# extracted from Red Hat Security Advisory RHSA-2016:1140 and 
# Oracle Linux Security Advisory ELSA-2016-1140 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : squid34 (ELSA-2016-1140)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-1140.html");
...
var pkgs = [
    {'reference':'squid34-3.4.14-9.el6_8.3', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
    {'reference':'squid34-3.4.14-9.el6_8.3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
