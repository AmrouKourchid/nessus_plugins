...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : python3 (EulerOS-SA-2020-2528)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2528
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed349fba");
...
pkgs = ["python3-3.7.0-9.h32.eulerosv2r8",
        "python3-devel-3.7.0-9.h32.eulerosv2r8",
        "python3-libs-3.7.0-9.h32.eulerosv2r8",
        "python3-test-3.7.0-9.h32.eulerosv2r8",
        "python3-unversioned-command-3.7.0-9.h32.eulerosv2r8"];
