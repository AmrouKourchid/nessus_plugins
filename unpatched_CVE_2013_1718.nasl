...
if (description)
{
  ...
  script_cve_id("CVE-2013-1718");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-1718");
...
patch available.
  ...
  - Multiple unspecified vulnerabilities in the browser engine in Mozilla Firefox before 24.0, Firefox ESR
    ...
    execute arbitrary code via unknown vectors. (CVE-2013-1718)
