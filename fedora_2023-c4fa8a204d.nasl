...
# extracted from Fedora Security Advisory FEDORA-2023-c4fa8a204d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c4fa8a204d");

  script_name(english:"Fedora 38 : libwebp (2023-c4fa8a204d)");
...
FEDORA-2023-c4fa8a204d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c4fa8a204d");
...
var pkgs = [
    {'reference':'libwebp-1.3.1-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
