...
# extracted from Fedora Security Advisory FEDORA-2020-40c35d7b37.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-40c35d7b37");
  script_xref(name:"IAVA", value:"2021-A-0463");

  script_name(english:"Fedora 30 : PyYAML (2020-40c35d7b37)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-40c35d7b37");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"PyYAML-5.3.1-1.fc30")) flag++;
