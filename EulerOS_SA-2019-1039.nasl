...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : perl (EulerOS-SA-2019-1039)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1039
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6df249c6");
...
pkgs = ["perl-5.16.3-292.h5.eulerosv2r7",
        "perl-core-5.16.3-292.h5.eulerosv2r7",
        "perl-devel-5.16.3-292.h5.eulerosv2r7",
        "perl-libs-5.16.3-292.h5.eulerosv2r7",
        "perl-macros-5.16.3-292.h5.eulerosv2r7"];
