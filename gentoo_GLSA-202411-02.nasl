...
# extracted from Gentoo Linux Security Advisory GLSA 202411-02.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202411-02 : Flatpak: Sandbox Escape");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202411-02 (Flatpak: Sandbox Escape)

    A vulnerability has been discovered in Flatpak. Please review the CVE identifier referenced below for
    details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202411-02");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=937936");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.4.10"),
    'vulnerable' : make_list("lt 1.4.10")
  }
];
