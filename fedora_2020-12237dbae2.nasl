...
# extracted from Fedora Security Advisory FEDORA-2020-12237dbae2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : znc (2020-12237dbae2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Update to 1.8.1 Fix CVE-2020-13775 possible crash/NULL pointer
dereference
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-12237dbae2");
...
"Update the affected znc package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-13775");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"znc-1.8.1-1.fc31")) flag++;
