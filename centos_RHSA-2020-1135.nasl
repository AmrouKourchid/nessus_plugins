...
# extracted from Red Hat Security Advisory RHSA-2020:1135 and 
# CentOS Errata and Security Advisory 2020:1135 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : polkit (RHSA-2020:1135)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2020:1135 advisory.
...
var pkgs = [
    {'reference':'polkit-0.112-26.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'polkit-0.112-26.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'polkit-devel-0.112-26.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'polkit-devel-0.112-26.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'polkit-docs-0.112-26.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'polkit-docs-0.112-26.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
