...
# extracted from Debian Security Advisory dla-3981. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3981 : simplesamlphp - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-3981
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/simplesamlphp");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'simplesamlphp', 'reference': '1.19.0-1+deb11u1'}
];
