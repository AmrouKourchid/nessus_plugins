...
# extracted from Red Hat Security Advisory RHSA-2022:6595. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6595");
  script_xref(name:"IAVB", value:"2022-B-0036-S");

  script_name(english:"RHEL 9 : nodejs and nodejs-nodemon (RHSA-2022:6595)");
...
referenced in the RHSA-2022:6595 advisory.

    Node.js is a software development platform for building fast and scalable network applications in the
    JavaScript programming language.

    The following packages have been upgraded to a later upstream version: nodejs (16.16.0), nodejs-nodemon
    (2.0.19). (BZ#2124230, BZ#2124233)
    ...
    * nodejs: npm pack ignores root-level .gitignore and .npmignore file exclusion directives when run in a
    workspace (CVE-2022-29244)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a683a3b0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6595");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nodejs-16.16.0-1.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2022-29244', 'CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'nodejs-docs-16.16.0-1.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2022-29244', 'CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'nodejs-full-i18n-16.16.0-1.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2022-29244', 'CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'nodejs-libs-16.16.0-1.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2022-29244', 'CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'nodejs-nodemon-2.0.19-1.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2020-7788', 'CVE-2020-28469', 'CVE-2021-3807', 'CVE-2021-33502', 'CVE-2022-33987']},
      {'reference':'npm-8.11.0-1.16.16.0.1.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2022-29244', 'CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'nodejs-16.16.0-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2022-29244', 'CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'nodejs-docs-16.16.0-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2022-29244', 'CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'nodejs-full-i18n-16.16.0-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2022-29244', 'CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'nodejs-libs-16.16.0-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2022-29244', 'CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']},
      {'reference':'nodejs-nodemon-2.0.19-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2020-7788', 'CVE-2020-28469', 'CVE-2021-3807', 'CVE-2021-33502', 'CVE-2022-33987']},
      {'reference':'npm-8.11.0-1.16.16.0.1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'cves':['CVE-2022-29244', 'CVE-2022-32212', 'CVE-2022-32213', 'CVE-2022-32214', 'CVE-2022-32215']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'nodejs / nodejs-docs / nodejs-full-i18n / nodejs-libs / etc');
}
