...
# extracted from Fedora Security Advisory FEDORA-2019-d5ad4a435c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-d5ad4a435c");

  script_name(english:"Fedora 29 : znc (2019-d5ad4a435c)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d5ad4a435c");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"znc-1.7.3-1.fc29")) flag++;
