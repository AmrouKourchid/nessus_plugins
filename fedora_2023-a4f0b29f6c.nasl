...
# extracted from Fedora Security Advisory FEDORA-2023-a4f0b29f6c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a4f0b29f6c");

  script_name(english:"Fedora 36 : yarnpkg (2023-a4f0b29f6c)");
...
FEDORA-2023-a4f0b29f6c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a4f0b29f6c");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.19-5.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
