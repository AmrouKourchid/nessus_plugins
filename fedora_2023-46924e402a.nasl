...
# extracted from Fedora Security Advisory FEDORA-2023-46924e402a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-46924e402a");

  script_name(english:"Fedora 38 : perl-CPAN (2023-46924e402a)");
...
FEDORA-2023-46924e402a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-46924e402a");
...
var pkgs = [
    {'reference':'perl-CPAN-2.36-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
