...
# extracted from Red Hat Security Advisory RHSA-2021:2724. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2724");
  script_xref(name:"IAVA", value:"2021-A-0350");

  script_name(english:"RHEL 8 : systemd (RHSA-2021:2724)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for systemd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:2724 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2724.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0822d96");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2724");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1970887");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL systemd package based on the guidance in RHSA-2021:2724.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'systemd-239-18.el8_1.8', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-container-239-18.el8_1.8', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-devel-239-18.el8_1.8', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-journal-remote-239-18.el8_1.8', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-libs-239-18.el8_1.8', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-pam-239-18.el8_1.8', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-tests-239-18.el8_1.8', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-udev-239-18.el8_1.8', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
