...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Glib PHSA-2019-2.0-0161");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glib-2.52.1-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glib-debuginfo-2.52.1-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glib-devel-2.52.1-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glib-schemas-2.52.1-4.ph2')) flag++;
