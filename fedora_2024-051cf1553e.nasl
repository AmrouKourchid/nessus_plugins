...
# extracted from Fedora Security Advisory FEDORA-2024-051cf1553e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-051cf1553e");
  script_xref(name:"IAVB", value:"2024-B-0095-S");

  script_name(english:"Fedora 40 : xen (2024-051cf1553e)");
...
FEDORA-2024-051cf1553e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-051cf1553e");
...
var pkgs = [
    {'reference':'xen-4.18.3-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
