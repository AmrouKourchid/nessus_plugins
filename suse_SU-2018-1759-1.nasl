...
# extracted from SUSE update advisory SUSE-SU-2018:1759-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : microcode_ctl (SUSE-SU-2018:1759-1) (Spectre)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20181759-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?144ca8b1");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"microcode_ctl-1.17-102.83.21.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"i586", reference:"microcode_ctl-1.17-102.83.21.1")) flag++;
