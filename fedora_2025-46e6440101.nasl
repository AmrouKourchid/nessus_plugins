...
# extracted from Fedora Security Advisory FEDORA-2025-46e6440101
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-46e6440101");

  script_name(english:"Fedora 41 : ovn (2025-46e6440101)");
...
FEDORA-2025-46e6440101 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-46e6440101");
...
var pkgs = [
    {'reference':'ovn-24.09.2-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
