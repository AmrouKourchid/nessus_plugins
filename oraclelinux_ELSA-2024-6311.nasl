...
# extracted from Oracle Linux Security Advisory ELSA-2024-6311.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : resource-agents (ELSA-2024-6311)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-6311.html");
...
var pkgs = [
    {'reference':'resource-agents-4.9.0-54.el8_10.4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'resource-agents-4.9.0-54.el8_10.4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
