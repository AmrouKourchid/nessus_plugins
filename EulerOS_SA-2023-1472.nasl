...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libksba (EulerOS-SA-2023-1472)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1472
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a45dc70");
...
var pkgs = [
  "libksba-1.3.5-12.h2.eulerosv2r9"
];
