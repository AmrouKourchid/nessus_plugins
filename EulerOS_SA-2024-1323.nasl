...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : proftpd (EulerOS-SA-2024-1323)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1323
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0ee7b531");
...
var pkgs = [
  "proftpd-1.3.7a-1.h11.eulerosv2r10"
];
