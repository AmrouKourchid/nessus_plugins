...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libgcrypt-1.7.6-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libgcrypt-debuginfo-1.7.6-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libgcrypt-devel-1.7.6-1.ph1')) flag++;
