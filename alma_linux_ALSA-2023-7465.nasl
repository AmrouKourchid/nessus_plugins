...
# AlmaLinux Security Advisory ALSA-2023:7465.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:7465");

  script_name(english:"AlmaLinux 9 : squid (ALSA-2023:7465)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-7465.html");
...
var pkgs = [
    {'reference':'squid-5.5-6.el9_3.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
    {'reference':'squid-5.5-6.el9_3.2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
