...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libjpeg-turbo (EulerOS-SA-2020-2126)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2126
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?13b54d13");
...
pkgs = ["libjpeg-turbo-1.2.90-5.h6",
        "libjpeg-turbo-devel-1.2.90-5.h6"];
