...
# extracted from Fedora Security Advisory FEDORA-2024-1c85d5b179
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1c85d5b179");

  script_name(english:"Fedora 38 : vim (2024-1c85d5b179)");
...
FEDORA-2024-1c85d5b179 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1c85d5b179");
...
var pkgs = [
    {'reference':'vim-9.1.076-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
