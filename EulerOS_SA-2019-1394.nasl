...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.1.0 : libvirt (EulerOS-SA-2019-1394)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1394
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e694ca82");
...
pkgs = ["libvirt-3.2.0-228",
        "libvirt-admin-3.2.0-228",
        "libvirt-client-3.2.0-228",
        "libvirt-daemon-3.2.0-228",
        "libvirt-daemon-config-network-3.2.0-228",
        "libvirt-daemon-config-nwfilter-3.2.0-228",
        "libvirt-daemon-driver-interface-3.2.0-228",
        "libvirt-daemon-driver-network-3.2.0-228",
        "libvirt-daemon-driver-nodedev-3.2.0-228",
        "libvirt-daemon-driver-nwfilter-3.2.0-228",
        "libvirt-daemon-driver-qemu-3.2.0-228",
        "libvirt-daemon-driver-secret-3.2.0-228",
        "libvirt-daemon-driver-storage-3.2.0-228",
        "libvirt-daemon-driver-storage-core-3.2.0-228",
        "libvirt-daemon-driver-storage-disk-3.2.0-228",
        "libvirt-daemon-driver-storage-iscsi-3.2.0-228",
        "libvirt-daemon-driver-storage-logical-3.2.0-228",
        "libvirt-daemon-driver-storage-mpath-3.2.0-228",
        "libvirt-daemon-driver-storage-scsi-3.2.0-228",
        "libvirt-daemon-kvm-3.2.0-228",
        "libvirt-devel-3.2.0-228",
        "libvirt-docs-3.2.0-228",
        "libvirt-libs-3.2.0-228"];
