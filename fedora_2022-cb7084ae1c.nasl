...
# extracted from Fedora Security Advisory FEDORA-2022-cb7084ae1c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-cb7084ae1c");

  script_name(english:"Fedora 35 : moodle (2022-cb7084ae1c)");
...
FEDORA-2022-cb7084ae1c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-cb7084ae1c");
...
var pkgs = [
    {'reference':'moodle-3.11.11-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
