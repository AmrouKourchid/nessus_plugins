...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : zlib (EulerOS-SA-2024-1710)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1710
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?da427dd1");
...
var pkgs = [
  "zlib-1.2.11-14.h4.eulerosv2r8",
  "zlib-devel-1.2.11-14.h4.eulerosv2r8"
];
