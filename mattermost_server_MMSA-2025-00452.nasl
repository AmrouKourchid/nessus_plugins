...
if (description)
{
  ...
  script_cve_id("CVE-2025-27571");
  script_xref(name:"IAVA", value:"2025-A-0289");

  script_name(english:"Mattermost Server 9.11.x < 9.11.10 / 10.4.x < 10.4.4 / 10.5.x < 10.5.2 / 10.6.0 (MMSA-2025-00452)");
...
therefore, affected by a vulnerability as referenced in the MMSA-2025-00452 advisory.

  - Mattermost versions 10.5.x <= 10.5.1, 10.4.x <= 10.4.3, 9.11.x <= 9.11.9 fail to check the Allow Users to
    View Archived Channels configuration when fetching channel metadata of a post from archived channels,
    which allows authenticated users to access such information when a channel is archived. (CVE-2025-27571)
...
"Upgrade to Mattermost Server version 9.11.10 / 10.4.4 / 10.5.2 / 10.6.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-27571");
