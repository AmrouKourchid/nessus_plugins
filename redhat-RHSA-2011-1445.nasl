...
# extracted from Red Hat Security Advisory RHSA-2011:1445. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2011:1445");

  script_name(english:"RHEL 6 : flash-plugin (RHSA-2011:1445)");
...
referenced in the RHSA-2011:1445 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2011/rhsa-2011_1445.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f1b3db8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=752983");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:1445");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flash-plugin package based on the guidance in RHSA-2011:1445.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-2460");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2011-2457");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flash-plugin-10.3.183.11-1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
