...
# extracted from SUSE update advisory SUSE-SU-2019:2748-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : python (SUSE-SU-2019:2748-2)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4e4c339");
...
SUSE-SLE-WE-12-SP5-2019-2748=1

SUSE Linux Enterprise Server 12-SP5:zypper in -t patch
SUSE-SLE-SERVER-12-SP5-2019-2748=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"libpython2_7-1_0-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libpython2_7-1_0-32bit-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libpython2_7-1_0-debuginfo-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libpython2_7-1_0-debuginfo-32bit-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-32bit-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-base-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-base-32bit-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-base-debuginfo-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-base-debuginfo-32bit-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-base-debugsource-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-curses-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-curses-debuginfo-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-debuginfo-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-debuginfo-32bit-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-debugsource-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-demo-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-devel-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-gdbm-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-gdbm-debuginfo-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-idle-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-tk-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-tk-debuginfo-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-xml-2.7.13-28.36.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python-xml-debuginfo-2.7.13-28.36.1")) flag++;
