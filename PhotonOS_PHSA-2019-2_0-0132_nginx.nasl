...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nginx-1.13.10-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'nginx-debuginfo-1.13.10-2.ph2')) flag++;
