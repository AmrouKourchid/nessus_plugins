...
# extracted from Red Hat Security Advisory quay. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-3864", "CVE-2019-3865", "CVE-2019-3867");

  script_name(english:"RHEL 7 : quay (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-3864");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:quay");
