...
# extracted from Fedora Security Advisory FEDORA-2025-73800111e8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-73800111e8");

  script_name(english:"Fedora 41 : golang-github-openprinting-ipp-usb (2025-73800111e8)");
...
FEDORA-2025-73800111e8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-73800111e8");
...
var pkgs = [
    {'reference':'golang-github-openprinting-ipp-usb-0.9.30-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
