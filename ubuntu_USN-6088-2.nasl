...
the USN-6088-2 advisory.
    ...
    USN-6088-1 fixed vulnerabilities in runC. This update provides the corresponding updates for Ubuntu 16.04
    LTS.

    It was discovered that runC incorrectly performed access control when mounting /proc to non-directories.
    An attacker could possibly use this issue to escalate privileges. (CVE-2019-19921)

    Felix Wilhelm discovered that runC incorrecly handled netlink

    messages. An attacker could possibly use this issue to escalate privileges. (CVE-2021-43784)

    Andrew G. Morgan discovered that runC incorrectly set inherited process capabilities inside the container.
    An attacker could possibly use this issue to escalate privileges. (CVE-2022-29162)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'golang-github-opencontainers-runc-dev', 'pkgver': '1.0.0~rc7+git20190403.029124da-0ubuntu1~16.04.4+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'runc', 'pkgver': '1.0.0~rc7+git20190403.029124da-0ubuntu1~16.04.4+esm4', 'ubuntu_pro': TRUE}
];
