...
# extracted from Red Hat Security Advisory RHSA-2023:4061. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4061");
  script_xref(name:"IAVA", value:"2023-A-0340-S");

  script_name(english:"RHEL 7 : .NET 6.0 (RHSA-2023:4061)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:4061 advisory.
    ...
    The following packages have been upgraded to a later upstream version: rh-dotnet60-dotnet (SDK 6.0.120,
    Runtime 6.0.20). (BZ#2219635)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4061.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?08e26c15");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2221854");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4061");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet60-aspnetcore-runtime-6.0-6.0.20-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet60'},
      {'reference':'rh-dotnet60-aspnetcore-targeting-pack-6.0-6.0.20-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet60'},
      {'reference':'rh-dotnet60-dotnet-6.0.120-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet60'},
      {'reference':'rh-dotnet60-dotnet-apphost-pack-6.0-6.0.20-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet60'},
      {'reference':'rh-dotnet60-dotnet-host-6.0.20-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet60'},
      {'reference':'rh-dotnet60-dotnet-hostfxr-6.0-6.0.20-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet60'},
      {'reference':'rh-dotnet60-dotnet-runtime-6.0-6.0.20-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet60'},
      {'reference':'rh-dotnet60-dotnet-sdk-6.0-6.0.120-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet60'},
      {'reference':'rh-dotnet60-dotnet-sdk-6.0-source-built-artifacts-6.0.120-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet60'},
      {'reference':'rh-dotnet60-dotnet-targeting-pack-6.0-6.0.20-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet60'},
      {'reference':'rh-dotnet60-dotnet-templates-6.0-6.0.120-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet60'},
      {'reference':'rh-dotnet60-netstandard-targeting-pack-2.1-6.0.120-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet60'}
    ]
  }
];
