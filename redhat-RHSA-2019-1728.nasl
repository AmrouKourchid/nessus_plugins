...
# extracted from Red Hat Security Advisory RHSA-2019:1728. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-10138");
  script_xref(name:"RHSA", value:"2019:1728");

  script_name(english:"RHEL 7 : python-novajoin (RHSA-2019:1728)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-novajoin.");
...
the RHSA-2019:1728 advisory.

    This Python package provides a dynamic vendordata plugin for the OpenStack nova metadata service to manage
    host instantiation in an IPA server.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1608273");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1670573");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1717237");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1728.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b310919c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1728");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-novajoin package based on the guidance in RHSA-2019:1728.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-10138");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-novajoin-1.1.1-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-novajoin');
}
