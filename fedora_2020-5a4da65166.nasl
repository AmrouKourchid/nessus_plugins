...
# extracted from Fedora Security Advisory FEDORA-2020-5a4da65166.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-5a4da65166");

  script_name(english:"Fedora 30 : 1:cups (2020-5a4da65166)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2020-3898
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-5a4da65166");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"cups-2.2.12-8.fc30", epoch:"1")) flag++;
