...
# extracted from Red Hat Security Advisory RHSA-2022:7071. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7071");
  script_xref(name:"IAVA", value:"2022-A-0435-S");
  script_xref(name:"IAVA", value:"2023-A-0132-S");

  script_name(english:"RHEL 9 : firefox (RHSA-2022:7071)");
...
referenced in the RHSA-2022:7071 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7071.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aef02ab3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7071");
...
"Update the RHEL firefox package based on the guidance in RHSA-2022:7071.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.4.0-1.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'firefox-102.4.0-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
