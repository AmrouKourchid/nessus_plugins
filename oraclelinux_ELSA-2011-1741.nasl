...
# extracted from Oracle Linux Security Advisory ELSA-2011-1741.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : php-pear (ELSA-2011-1741)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-1741.html");
...
var pkgs = [
    {'reference':'php-pear-1.9.4-4.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
