...
"The remote Red Hat host is missing a security update for Red Hat JBoss Core Services Apache HTTP Server 2.4.37 SP6.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:0486 advisory.

    This release adds the new Apache HTTP Server 2.4.37 Service Pack 6 packages that are part of the JBoss
    ...
    Pack 5 and includes bug fixes and enhancements. Refer to the Release Notes for information on the most
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0486.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ca4e252e");
...
"Update the RHEL Red Hat JBoss Core Services Apache HTTP Server 2.4.37 SP6 package based on the guidance in
RHSA-2021:0486.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'jbcs-httpd24-brotli / jbcs-httpd24-brotli-devel / etc');
}
