...
# extracted from Ubuntu Security Notice USN-4762-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4762-1");
  script_xref(name:"IAVA", value:"2021-A-0121-S");

  script_name(english:"Ubuntu 20.04 LTS : OpenSSH vulnerability (USN-4762-1)");
...
USN-4762-1 advisory.
    ...
    It was discovered that the OpenSSH ssh-agent incorrectly handled memory. A remote attacker able to connect
    to the agent could use this issue to cause it to crash, resulting in a denial of service, or possibly
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4762-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'openssh-client', 'pkgver': '1:8.2p1-4ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'openssh-client-udeb', 'pkgver': '1:8.2p1-4ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'openssh-server', 'pkgver': '1:8.2p1-4ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'openssh-server-udeb', 'pkgver': '1:8.2p1-4ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'openssh-sftp-server', 'pkgver': '1:8.2p1-4ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'openssh-tests', 'pkgver': '1:8.2p1-4ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'ssh', 'pkgver': '1:8.2p1-4ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'ssh-askpass-gnome', 'pkgver': '1:8.2p1-4ubuntu0.2'}
];
