...
# extracted from Red Hat Security Advisory RHSA-2023:5353. The text
...
referenced in the RHSA-2023:5353 advisory.
    ...
    * libtiff: out-of-bounds write in _TIFFmemcpy() in libtiff/tif_unix.c when called by functions in
    tools/tiffcrop.c (CVE-2023-0801)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5353.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?87207df8");
...
"Update the RHEL libtiff package based on the guidance in RHSA-2023:5353.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libtiff-4.0.9-29.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-4.0.9-29.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-tools-4.0.9-29.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libtiff-4.0.9-29.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-4.0.9-29.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-tools-4.0.9-29.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
