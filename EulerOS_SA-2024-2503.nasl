...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : glib2 (EulerOS-SA-2024-2503)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2503
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1bdfc111");
...
var pkgs = [
  "glib2-2.72.2-5.h17.eulerosv2r12"
];
