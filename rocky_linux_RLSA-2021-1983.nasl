...
# Rocky Linux Security Advisory RLSA-2021:1983.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2021:1983");

  script_name(english:"Rocky Linux 8 : idm:DL1 (RLSA-2021:1983)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2021:1983 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2021:1983");
...
var pkgs = [
    ...
    {'reference':'slapi-nis-0.56.6-2.module+el8.4.0+429+6bd33fea', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'slapi-nis-0.56.6-2.module+el8.4.0+429+6bd33fea', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'slapi-nis-debuginfo-0.56.6-2.module+el8.4.0+429+6bd33fea', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'slapi-nis-debuginfo-0.56.6-2.module+el8.4.0+429+6bd33fea', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'slapi-nis-debugsource-0.56.6-2.module+el8.4.0+429+6bd33fea', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'slapi-nis-debugsource-0.56.6-2.module+el8.4.0+429+6bd33fea', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
