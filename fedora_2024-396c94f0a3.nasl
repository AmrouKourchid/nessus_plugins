...
# extracted from Fedora Security Advisory FEDORA-2024-396c94f0a3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-396c94f0a3");

  script_name(english:"Fedora 41 : python-django (2024-396c94f0a3)");
...
FEDORA-2024-396c94f0a3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-396c94f0a3");
...
var pkgs = [
    {'reference':'python-django-4.2.16-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
