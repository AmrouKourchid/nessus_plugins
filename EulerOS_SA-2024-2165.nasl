...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : emacs (EulerOS-SA-2024-2165)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2165
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?11f6e9f1");
...
var pkgs = [
  "emacs-filesystem-27.2-3.h7.eulerosv2r11"
];
