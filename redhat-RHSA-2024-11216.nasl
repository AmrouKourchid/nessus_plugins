...
# extracted from Red Hat Security Advisory RHSA-2024:11216. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:11216");

  script_name(english:"RHEL 9 : containernetworking-plugins (RHSA-2024:11216)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_11216.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2fa36773");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11216");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL containernetworking-plugins package based on the guidance in RHSA-2024:11216.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'containernetworking-plugins-1.5.1-3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
