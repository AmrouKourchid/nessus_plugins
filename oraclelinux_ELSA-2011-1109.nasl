...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : foomatic (ELSA-2011-1109)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-1109.html");
...
"Update the affected foomatic package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-2697");
...
var pkgs = [
    {'reference':'foomatic-3.0.2-38.3.el5_7.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'foomatic-3.0.2-38.3.el5_7.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
