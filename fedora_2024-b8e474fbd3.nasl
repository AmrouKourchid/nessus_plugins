...
# extracted from Fedora Security Advisory FEDORA-2024-b8e474fbd3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b8e474fbd3");

  script_name(english:"Fedora 40 : glances (2024-b8e474fbd3)");
...
FEDORA-2024-b8e474fbd3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b8e474fbd3");
...
"Update the affected glances package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21501");
...
var pkgs = [
    {'reference':'glances-4.0.5-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
