...
# SUSE update advisory SUSE-SU-2024:2904-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:2904-1");

  script_name(english:"SUSE SLED15 / SLES15 Security Update : python312-setuptools (SUSE-SU-2024:2904-1)");
...
vulnerability as referenced in the SUSE-SU-2024:2904-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-August/019192.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5fb6d018");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2024-6345");
  script_set_attribute(attribute:"solution", value:
"Update the affected python312-setuptools package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:python312-setuptools");
...
var pkgs = [
    {'reference':'python312-setuptools-68.1.2-150600.3.3.1', 'sp':'6', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.6']},
    {'reference':'python312-setuptools-68.1.2-150600.3.3.1', 'sp':'6', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.6']},
    {'reference':'python312-setuptools-68.1.2-150600.3.3.1', 'sp':'6', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.6', 'sle-module-python3-release-15.6', 'sled-release-15.6', 'sles-release-15.6']},
    {'reference':'python312-setuptools-68.1.2-150600.3.3.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.6', 'sle-module-python3-release-15.6', 'sled-release-15.6', 'sles-release-15.6']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python312-setuptools');
}
