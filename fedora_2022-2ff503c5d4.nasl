...
# extracted from Fedora Security Advisory FEDORA-2022-2ff503c5d4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-2ff503c5d4");

  script_name(english:"Fedora 35 : apptainer (2022-2ff503c5d4)");
...
FEDORA-2022-2ff503c5d4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-2ff503c5d4");
...
var pkgs = [
    {'reference':'apptainer-1.1.2-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
