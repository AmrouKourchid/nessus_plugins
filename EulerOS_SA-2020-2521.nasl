...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : nasm (EulerOS-SA-2020-2521)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2521
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6e5b47ec");
...
"Update the affected nasm packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-19215");
...
pkgs = ["nasm-2.13.03-2.h6.eulerosv2r8"];
