...
if (description)
{
  ...
  script_name(english:"Adobe After Effects < 24.6.3 / 25.0.0 < 25.1.0 Memory leak (APSB24-95) (macOS)");
...
"The version of Adobe After Effects installed on the remote macOS host is prior to 24.6.3, 25.1.0. It is, therefore,
