...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-384.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : composer (ALAS2023-2023-384)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-384.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2023-43655.html");
...
var pkgs = [
    {'reference':'composer-2.5.8-2.amzn2023.0.1', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
