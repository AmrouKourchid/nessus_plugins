...
# extracted from Oracle Linux Security Advisory ELSA-2024-1690.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : varnish (ELSA-2024-1690)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2024-1690 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1690.html");
...
var appstreams = {
    'varnish:6': [
      {'reference':'varnish-6.0.13-1.module+el8.9.0+90264+d552af1c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-devel-6.0.13-1.module+el8.9.0+90264+d552af1c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-docs-6.0.13-1.module+el8.9.0+90264+d552af1c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-modules-0.15.0-6.module+el8.9.0+90264+d552af1c', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-6.0.13-1.module+el8.9.0+90264+d552af1c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-devel-6.0.13-1.module+el8.9.0+90264+d552af1c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-docs-6.0.13-1.module+el8.9.0+90264+d552af1c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-modules-0.15.0-6.module+el8.9.0+90264+d552af1c', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
