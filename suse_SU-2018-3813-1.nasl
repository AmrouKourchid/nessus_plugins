...
# extracted from SUSE update advisory SUSE-SU-2018:3813-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : salt (SUSE-SU-2018:3813-1)");
...
Salt was updated to version 2016.11.10 and contains the following
fixes :
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20183813-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?532b4d10");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"salt-2016.11.10-43.38.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"salt-doc-2016.11.10-43.38.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"salt-minion-2016.11.10-43.38.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"salt-2016.11.10-43.38.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"salt-doc-2016.11.10-43.38.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"salt-minion-2016.11.10-43.38.1")) flag++;
