...
if (description)
{
  ...
  script_cve_id("CVE-2013-0272");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-0272");
...
patch available.
  ...
  - Buffer overflow in http.c in the MXit protocol plugin in libpurple in Pidgin before 2.10.7 allows remote
    servers to execute arbitrary code via a long HTTP header. (CVE-2013-0272)
