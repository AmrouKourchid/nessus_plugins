...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Perl PHSA-2019-1.0-0212");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"perl-5.24.1-3.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"perl-debuginfo-5.24.1-3.ph1")) flag++;
