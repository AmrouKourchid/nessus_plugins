...
"The version of Google Chrome installed on the remote Windows host is prior to 84.0.4147.105. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2020_07_stable-channel-update-for-desktop_27 advisory.
...
google_chrome_check_version(installs:installs, fix:'84.0.4147.105', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
