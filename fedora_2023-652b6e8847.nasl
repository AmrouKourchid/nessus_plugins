...
# extracted from Fedora Security Advisory FEDORA-2023-652b6e8847
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-652b6e8847");

  script_name(english:"Fedora 37 : dav1d (2023-652b6e8847)");
...
FEDORA-2023-652b6e8847 advisory.

    Update to version 1.2.1.

    This version includes a fix for CVE-2023-32570 (race condition that can lead to an application crash).

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-652b6e8847");
  script_set_attribute(attribute:"solution", value:
"Update the affected dav1d package.");
...
var pkgs = [
    {'reference':'dav1d-1.2.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
