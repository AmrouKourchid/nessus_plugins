...
# extracted from Fedora Security Advisory FEDORA-2018-dd98177cad.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : python-markdown2 (2018-dd98177cad)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-dd98177cad");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"python-markdown2-2.3.6-1.fc28")) flag++;
