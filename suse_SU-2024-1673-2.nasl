...
# SUSE update advisory SUSE-SU-2024:1673-2. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:1673-2");

  script_name(english:"SUSE SLES15 Security Update : python-Pillow (SUSE-SU-2024:1673-2)");
...
the SUSE-SU-2024:1673-2 advisory.
    ...
    - Fix Memory DOS in Icns, Ico and Blp Image Plugins. (bsc#1183110, CVE-2021-27921, bsc#1183108,
    CVE-2021-27922, bsc#1183107, CVE-2021-27923)
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-June/018714.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5fdd1055");
...
var pkgs = [
    {'reference':'python3-Pillow-7.2.0-150300.3.15.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.6']}
];
