...
# SUSE update advisory SUSE-SU-2023:3585-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3585-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 44 for SLE 12 SP5) (SUSE-SU-2023:3585-1)");
...
the SUSE-SU-2023:3585-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-September/016134.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4aadbfd");
...
"Update the affected kgraft-patch-4_12_14-122_162-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.162-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_162-default-3-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-122_162-default');
}
