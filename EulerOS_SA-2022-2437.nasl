...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : 389-ds-base (EulerOS-SA-2022-2437)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the 389-ds-base packages installed, the EulerOS installation on the remote host is affected
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2437
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52874c53");
...
var pkgs = [
  "389-ds-base-1.3.7.5-28.h8.eulerosv2r7",
  "389-ds-base-libs-1.3.7.5-28.h8.eulerosv2r7"
];
