...
# SUSE update advisory SUSE-SU-2021:2435-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2435-1");

  script_name(english:"SUSE SLES15 Security Update : crmsh (SUSE-SU-2021:2435-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2021-July/019664.html");
...
var pkgs = [
    {'reference':'crmsh-4.3.1+20210702.4e0ee8fb-5.59.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.2']},
    {'reference':'crmsh-scripts-4.3.1+20210702.4e0ee8fb-5.59.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.2']},
    {'reference':'crmsh-4.3.1+20210702.4e0ee8fb-5.59.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.3']},
    {'reference':'crmsh-scripts-4.3.1+20210702.4e0ee8fb-5.59.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.3']}
];
