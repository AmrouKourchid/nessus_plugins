...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : gtk-vnc (EulerOS-SA-2020-2010)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization for ARM 64 host is missing multiple security
updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the gtk-vnc packages installed, the
...
affected by the following vulnerabilities :
  ...
  - An integer overflow flaw was found in gtk-vnc. A remote
    ...
    viewers which are based on the gtk-vnc
    library.(CVE-2017-5885)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2010
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aae54380");
...
"Update the affected gtk-vnc packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:gvnc");
...
pkgs = ["gtk-vnc2-0.9.0-2.eulerosv2r8",
        "gvnc-0.9.0-2.eulerosv2r8"];
