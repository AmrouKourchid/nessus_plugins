...
# extracted from Fedora Security Advisory FEDORA-2023-440c8694e5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-440c8694e5");

  script_name(english:"Fedora 37 : libheif (2023-440c8694e5)");
...
FEDORA-2023-440c8694e5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-440c8694e5");
...
var pkgs = [
    {'reference':'libheif-1.15.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
