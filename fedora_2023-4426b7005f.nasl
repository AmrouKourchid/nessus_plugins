...
# extracted from Fedora Security Advisory FEDORA-2023-4426b7005f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4426b7005f");

  script_name(english:"Fedora 37 : kernel (2023-4426b7005f)");
...
FEDORA-2023-4426b7005f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4426b7005f");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-31084");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2023-31084');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-4426b7005f');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.3.7-100.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
