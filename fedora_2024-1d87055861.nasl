...
# extracted from Fedora Security Advisory FEDORA-2024-1d87055861
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1d87055861");

  script_name(english:"Fedora 38 : amavis (2024-1d87055861)");
...
FEDORA-2024-1d87055861 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1d87055861");
...
var pkgs = [
    {'reference':'amavis-2.13.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
