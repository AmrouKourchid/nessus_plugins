...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : openssl (EulerOS-SA-2024-1512)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1512
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?841142d5");
...
var pkgs = [
  "openssl-1.1.1f-7.h41.eulerosv2r9",
  "openssl-libs-1.1.1f-7.h41.eulerosv2r9",
  "openssl-perl-1.1.1f-7.h41.eulerosv2r9"
];
