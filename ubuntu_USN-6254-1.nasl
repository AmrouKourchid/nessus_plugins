...
# extracted from Ubuntu Security Notice USN-6254-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6254-1");

  script_name(english:"Ubuntu 16.04 ESM : Linux kernel vulnerabilities (USN-6254-1)");
...
the USN-6254-1 advisory.
    ...
    extra inode size for extended attributes, leading to a use-after-free vulnerability. A privileged attacker
    could possibly use this to cause a denial of service (system crash) or possibly execute arbitrary code.
    (CVE-2023-2513)
    ...
    It was discovered that a use-after-free vulnerability existed in the IEEE 1394 (Firewire) implementation
    in the Linux kernel. A privileged attacker could use this to cause a denial of service (system crash) or
    possibly execute arbitrary code. (CVE-2023-3159)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6254-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-1122-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-1159-aws");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-243-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-243-lowlatency");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6254-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-0458', 'CVE-2023-1611', 'CVE-2023-2124', 'CVE-2023-2162', 'CVE-2023-2513', 'CVE-2023-3090', 'CVE-2023-3141', 'CVE-2023-3159', 'CVE-2023-3161', 'CVE-2023-3268', 'CVE-2023-3390', 'CVE-2023-35001');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6254-1');
  }
  else
  {
