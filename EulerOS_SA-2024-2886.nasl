...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : ghostscript (EulerOS-SA-2024-2886)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2886
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a4397ffd");
...
var pkgs = [
  "ghostscript-9.52-4.h10.eulerosv2r10",
  "ghostscript-help-9.52-4.h10.eulerosv2r10"
];
