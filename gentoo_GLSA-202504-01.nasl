...
# extracted from Gentoo Linux Security Advisory GLSA 202504-01.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202504-01 : XZ Utils: Use after free");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202504-01 (XZ Utils: Use after free)

    A use-after-free has been discovered in XZ utils. Please review the CVE identifier referenced below for
    details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202504-01");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=953086");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 5.6.4-r1"),
    'vulnerable' : make_list("lt 5.6.4-r1")
  }
];
