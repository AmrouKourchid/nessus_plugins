...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0627.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-2784");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2010-0431");
...
var pkgs = [
    {'reference':'kmod-kvm-83-164.0.1.el5_5.21', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-83-164.0.1.el5_5.21', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-qemu-img-83-164.0.1.el5_5.21', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kvm-tools-83-164.0.1.el5_5.21', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
