...
USN-3663-1 advisory.
    ...
    It was discovered that HAProxy incorrectly handled certain resquests. An attacker could possibly use this
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3663-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'haproxy', 'pkgver': '1.8.8-1ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'vim-haproxy', 'pkgver': '1.8.8-1ubuntu0.1'}
];
