...
if (description)
{
  ...
  script_name(english:"AIX : Multiple Vulnerabilities (IJ37355)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ37355. It is, therefore, affected by multiple
vulnerabilities as referenced in the IJ37355 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ37355");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6560390");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ37355.");
...
var constraints = [
    {'release': '7.1', 'ml': '05', 'sp': '07', 'patch': 'IJ37355s7a', 'package': 'bos.cluster.rte', 'minfilesetver': '7.1.5.0', 'maxfilesetver': '7.1.5.38'},
    {'release': '7.1', 'ml': '05', 'sp': '08', 'patch': 'IJ37355s8a', 'package': 'bos.cluster.rte', 'minfilesetver': '7.1.5.0', 'maxfilesetver': '7.1.5.38'},
    {'release': '7.1', 'ml': '05', 'sp': '09', 'patch': '(IJ37355s9a|IJ37355s9b)', 'package': 'bos.cluster.rte', 'minfilesetver': '7.1.5.0', 'maxfilesetver': '7.1.5.38'}
];
