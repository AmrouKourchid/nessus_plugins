...
# extracted from Debian Security Advisory dla-3375. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3375 : xrdp - security update");
...
"Upgrade the xrdp packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-23480");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'xrdp', 'reference': '0.9.9-1+deb10u3'}
];
