...
if (description)
{
  ...
  script_name(english:"OpenSSL 3.3.0 < 3.3.2 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 3.3.2. It is, therefore, affected by a vulnerability as
referenced in the 3.3.2 advisory.
  ...
  - Issue summary: Calling the OpenSSL API function SSL_select_next_proto with an empty supported client
    ...
    (Google). Fix developed by Matt Caswell. Fixed in OpenSSL 3.3.2 (Affected since 3.3.0). (CVE-2024-5535)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://github.com/openssl/openssl/commit/e86ac436f0bd54d4517745483e2315650fae7b2c
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?671f5f15");
  script_set_attribute(attribute:"see_also", value:"https://www.cve.org/CVERecord?id=CVE-2024-5535");
  script_set_attribute(attribute:"solution", value:
"Upgrade to OpenSSL version 3.3.2 or later.");
