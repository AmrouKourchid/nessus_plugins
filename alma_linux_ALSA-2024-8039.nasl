...
# AlmaLinux Security Advisory ALSA-2024:8039.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:8039");
  script_xref(name:"IAVB", value:"2024-B-0132-S");

  script_name(english:"AlmaLinux 9 : podman (ALSA-2024:8039)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:8039 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-8039.html");
