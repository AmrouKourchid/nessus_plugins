...
# extracted from Fedora Security Advisory FEDORA-2023-0418511dfe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0418511dfe");

  script_name(english:"Fedora 38 : kitty (2023-0418511dfe)");
...
FEDORA-2023-0418511dfe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0418511dfe");
...
var pkgs = [
    {'reference':'kitty-0.28.1-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
