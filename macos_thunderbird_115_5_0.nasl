...
# extracted from Mozilla Foundation Security Advisory mfsa2023-52.
...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 115.5.0");

  script_set_attribute(attribute:"synopsis", value:
"A mail client installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 115.5.0. It is, therefore,
affected by multiple vulnerabilities as referenced in the mfsa2023-52 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2023-52/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Mozilla Thunderbird version 115.5.0 or later.");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'115.5.0', severity:SECURITY_HOLE);
