...
# extracted from Debian Security Advisory dsa-5786. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5786 : gir1.2-gsf-1 - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/libgsf");
...
"Upgrade the gir1.2-gsf-1 packages.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2024/10/05");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'gir1.2-gsf-1', 'reference': '1.14.50-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libgsf-1-114', 'reference': '1.14.50-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libgsf-1-common', 'reference': '1.14.50-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libgsf-1-dev', 'reference': '1.14.50-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libgsf-bin', 'reference': '1.14.50-1+deb12u1'}
];
