...
# extracted from Red Hat Security Advisory RHSA-2025:0912. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 9 : mariadb:10.11 (RHSA-2025:0912)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-25575");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-26140");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-40863");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0912.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e6b6a7eb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0912");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mariadb:10.11 package based on the guidance in RHSA-2025:0912.");
  ...
  'mariadb:10.11': [
    {
      ...
      'pkgs': [
        {'reference':'galera-26.4.20-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mariadb-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-backup-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-common-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-devel-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-embedded-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-embedded-devel-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-errmsg-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-gssapi-server-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-oqgraph-engine-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-pam-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-server-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-server-galera-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-server-utils-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
        {'reference':'mariadb-test-10.11.10-1.module+el9.5.0+22578+dc54e53f', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
      ]
    }
  ]
};
