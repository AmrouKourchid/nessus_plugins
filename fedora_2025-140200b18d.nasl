...
# extracted from Fedora Security Advisory FEDORA-2025-140200b18d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-140200b18d");

  script_name(english:"Fedora 41 : chromium (2025-140200b18d)");
...
FEDORA-2025-140200b18d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-140200b18d");
...
var pkgs = [
    {'reference':'chromium-136.0.7103.92-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
