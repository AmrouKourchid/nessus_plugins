...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : mod_security (EulerOS-SA-2022-1332)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1332
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3e8265d2");
...
var pkgs = [
  "mod_security-2.9.2-1.h1.eulerosv2r7"
];
