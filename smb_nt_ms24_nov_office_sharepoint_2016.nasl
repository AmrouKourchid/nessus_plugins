...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002654");
  script_xref(name:"MSFT", value:"MS23-5002654");
  script_xref(name:"IAVA", value:"2024-A-0746-S");

  script_name(english:"Defense-in-Depth Security Updates for Microsoft SharePoint Server 2016 (November 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft SharePoint Server 2016 is missing defense-in-depth security updates to help improve security-related features.");
...
"Microsoft has released KB5002654 to address this issue.");
