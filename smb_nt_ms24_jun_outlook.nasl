...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002600");
  script_xref(name:"MSFT", value:"MS24-5002600");
  script_xref(name:"IAVA", value:"2024-A-0340-S");

  script_name(english:"Security Updates for Outlook (June 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002600");
...
var constraints = [
  { 'kb':'5002600', 'channel':'MSI', 'fixed_version': '16.0.5450.1000', 'sp' : 0}
];
