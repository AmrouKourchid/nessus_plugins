...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : cups (EulerOS-SA-2021-1867)");
...
vulnerability :
  ...
  - CUPS printing system provides a portable printing layer
    ...
    and Berkeley command-line interfaces.Security
    Fix(es):An input validation issue was addressed with
    improved memory handling. This issue is fixed in macOS
    Big Sur 11.1, Security Update 2020-001 Catalina,
    Security Update 2020-007 Mojave. A malicious
    application may be able to read restricted
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1867
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71810e55");
...
pkgs = ["cups-2.2.8-5.h7.eulerosv2r8",
        "cups-client-2.2.8-5.h7.eulerosv2r8",
        "cups-devel-2.2.8-5.h7.eulerosv2r8",
        "cups-filesystem-2.2.8-5.h7.eulerosv2r8",
        "cups-libs-2.2.8-5.h7.eulerosv2r8",
        "cups-lpd-2.2.8-5.h7.eulerosv2r8"];
