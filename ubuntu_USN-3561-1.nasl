...
# extracted from Ubuntu Security Notice USN-3561-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : libvirt update (USN-3561-1)");
...
in the USN-3561-1 advisory.
    ...
    This update allows libvirt to expose new CPU features added by microcode updates to guests. On amd64 and
    i386, new CPU models that match the updated microcode features were added with an -IBRS suffix. Certain
    environments will require guests to be switched manually to the new CPU models after microcode updates
    have been applied to the host.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3561-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libvirt-bin', 'pkgver': '1.2.2-0ubuntu13.1.25'},
    {'osver': '14.04', 'pkgname': 'libvirt-dev', 'pkgver': '1.2.2-0ubuntu13.1.25'},
    {'osver': '14.04', 'pkgname': 'libvirt0', 'pkgver': '1.2.2-0ubuntu13.1.25'},
    {'osver': '16.04', 'pkgname': 'libvirt-bin', 'pkgver': '1.3.1-1ubuntu10.17'},
    {'osver': '16.04', 'pkgname': 'libvirt-dev', 'pkgver': '1.3.1-1ubuntu10.17'},
    {'osver': '16.04', 'pkgname': 'libvirt0', 'pkgver': '1.3.1-1ubuntu10.17'}
];
