...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.13.17 (RHSA-2023:5675)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.13.17.");
...
referenced in the RHSA-2023:5675 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.13.17 packages based on the guidance in RHSA-2023:5675.");
...
var pkgs = [
    {'reference':'openshift-hyperkube-4.13.0-202310140746.p0.gc7606e7.assembly.stream.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'openshift-hyperkube-4.13.0-202310140746.p0.gc7606e7.assembly.stream.el9', 'release':'4', 'el_string':'el9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
