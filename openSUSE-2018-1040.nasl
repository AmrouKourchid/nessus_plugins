...
# extracted from openSUSE Security Update openSUSE-2018-1040.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openslp (openSUSE-2018-1040)");
...
"This update for openslp fixes the following issues :
  ...
  - Prevent out of bounds reads in message parsing This
...
if ( rpm_check(release:"SUSE42.3", reference:"openslp-2.0.0-18.7.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"openslp-debuginfo-2.0.0-18.7.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"openslp-debugsource-2.0.0-18.7.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"openslp-devel-2.0.0-18.7.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"openslp-server-2.0.0-18.7.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"openslp-server-debuginfo-2.0.0-18.7.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"openslp-32bit-2.0.0-18.7.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"openslp-debuginfo-32bit-2.0.0-18.7.1") ) flag++;
