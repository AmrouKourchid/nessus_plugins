...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : lua (EulerOS-SA-2020-1477)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the lua package installed, the EulerOS
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1477
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67a8b582");
...
pkgs = ["lua-5.1.4-15.h1.eulerosv2r7"];
