...
# extracted from Oracle Linux Security Advisory ELSA-2023-6518.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : flatpak (ELSA-2023-6518)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2023-6518 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6518.html");
...
var pkgs = [
    ...
    {'reference':'flatpak-selinux-1.12.8-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'flatpak-selinux-1.12.8-1.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'flatpak-selinux-1.12.8-1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
