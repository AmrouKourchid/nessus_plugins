...
# extracted from Fedora Security Advisory FEDORA-2023-d12ff09d38
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d12ff09d38");
  script_xref(name:"IAVA", value:"2023-A-0423-S");

  script_name(english:"Fedora 36 : php (2023-d12ff09d38)");
...
FEDORA-2023-d12ff09d38 advisory.

    **PHP version 8.1.16** (14 Feb 2023)

    **Core:**

    * Fixed bug php#81744 (Password_verify() always return true with some hash). (**CVE-2023-0567**). (Tim
    Dsterhus)
    * Fixed bug php#81746 (1-byte array overrun in common path resolve code). (**CVE-2023-0568**). (Niels
    Dossche)
    * Fixed bug [GHSA-54hq-v5wp-fqgv](https://github.com/php/php-src/security/advisories/GHSA-54hq-v5wp-fqgv)
    (DOS vulnerability when parsing multipart request body). (**CVE-2023-0662**) (Jakub Zelenka)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d12ff09d38");
...
var pkgs = [
    {'reference':'php-8.1.16-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
