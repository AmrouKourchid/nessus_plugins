...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Grub2 PHSA-2020-3.0-0120");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'grub2-2.04-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'grub2-efi-2.04-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'grub2-lang-2.04-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'grub2-pc-2.04-1.ph3')) flag++;
