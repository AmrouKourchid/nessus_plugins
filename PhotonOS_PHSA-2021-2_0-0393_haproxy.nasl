...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Haproxy PHSA-2021-2.0-0393");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'haproxy-2.0.10-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'haproxy-doc-2.0.10-3.ph2')) flag++;
