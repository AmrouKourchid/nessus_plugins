...
# extracted from Amazon Linux 2 Security Advisory ALASPYTHON3.8-2024-017.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python38-pip (ALASPYTHON3.8-2024-017)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of python38-pip installed on the remote host is prior to 21.0.1-4. It is, therefore, affected by a
vulnerability as referenced in the ALAS2PYTHON3.8-2024-017 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASPYTHON3.8-2024-017.html");
...
"Run 'yum update python38-pip' to update your system.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:python38-pip");
...
var pkgs = [
    {'reference':'python38-pip-21.0.1-4.amzn2.0.4', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'python3.8'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "python38-pip");
}
