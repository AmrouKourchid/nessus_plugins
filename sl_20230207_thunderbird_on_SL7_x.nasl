...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2023:0600");

  script_name(english:"Scientific Linux Security Update : thunderbird on SL7.x x86_64 (2023:0600)");
...
SLSA-2023:0600-1 advisory.

  - Mozilla: Revocation status of S/Mime signature certificates was not checked (CVE-2023-0430)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20230600-1");
...
var pkgs = [
    {'reference':'thunderbird-102.7.1-2.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-102.7.1-2.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
