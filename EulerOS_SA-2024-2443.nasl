...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : libarchive (EulerOS-SA-2024-2443)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2443
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e14f3d33");
...
var pkgs = [
  "libarchive-3.4.3-2.h7.eulerosv2r10"
];
