...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.12.45 (RHSA-2023:7610)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing one or more security updates for OpenShift Container Platform 4.12.45.");
...
as referenced in the RHSA-2023:7610 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.12.45 packages based on the guidance in RHSA-2023:7610.");
...
var pkgs = [
    {'reference':'cri-o-1.25.5-2.rhaos4.12.git0217273.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
