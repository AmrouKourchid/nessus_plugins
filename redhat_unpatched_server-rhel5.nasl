...
# extracted from Red Hat Security Advisory server. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2008-5356", "CVE-2008-5357");

  script_name(english:"RHEL 5 : server (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2008-5356");
