...
if (description)
{
  ...
  script_cve_id("CVE-2024-46731");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46731");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/pm: fix the Out-of-bounds read
    warning using index i - 1U may beyond element index for mc_data[] when i = 0. (CVE-2024-46731)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46731");
