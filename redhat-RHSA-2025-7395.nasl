...
# extracted from Red Hat Security Advisory RHSA-2025:7395. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2025-2487");
  script_xref(name:"RHSA", value:"2025:7395");

  script_name(english:"RHEL 9 : 389-ds-base (RHSA-2025:7395)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2353071");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7395.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ae8e72d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7395");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL 389-ds-base package based on the guidance in RHSA-2025:7395.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-2487");
...
var constraints = [
  {
    'repo_relative_urls': [
      ...
      'content/eus/rhel9/9.6/aarch64/codeready-builder/debug',
      'content/eus/rhel9/9.6/aarch64/codeready-builder/os',
      'content/eus/rhel9/9.6/aarch64/codeready-builder/source/SRPMS',
      ...
      'content/eus/rhel9/9.6/ppc64le/codeready-builder/debug',
      'content/eus/rhel9/9.6/ppc64le/codeready-builder/os',
      'content/eus/rhel9/9.6/ppc64le/codeready-builder/source/SRPMS',
      ...
      'content/eus/rhel9/9.6/s390x/codeready-builder/debug',
      'content/eus/rhel9/9.6/s390x/codeready-builder/os',
      'content/eus/rhel9/9.6/s390x/codeready-builder/source/SRPMS',
      ...
      'content/eus/rhel9/9.6/x86_64/codeready-builder/debug',
      'content/eus/rhel9/9.6/x86_64/codeready-builder/os',
      'content/eus/rhel9/9.6/x86_64/codeready-builder/source/SRPMS'
    ],
    'pkgs': [
      {'reference':'389-ds-base-2.6.1-8.el9_6', 'sp':'6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-devel-2.6.1-8.el9_6', 'sp':'6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-libs-2.6.1-8.el9_6', 'sp':'6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-snmp-2.6.1-8.el9_6', 'sp':'6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-lib389-2.6.1-8.el9_6', 'sp':'6', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'389-ds-base-2.6.1-8.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-devel-2.6.1-8.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-libs-2.6.1-8.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-snmp-2.6.1-8.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-lib389-2.6.1-8.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
