...
# extracted from Fedora Security Advisory FEDORA-2023-14b8d5c44f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-14b8d5c44f");

  script_name(english:"Fedora 37 : chromium (2023-14b8d5c44f)");
...
FEDORA-2023-14b8d5c44f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-14b8d5c44f");
...
var pkgs = [
    {'reference':'chromium-119.0.6045.105-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
