...
# extracted from Fedora Security Advisory FEDORA-2021-a2d3ad5dda
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-a2d3ad5dda");

  script_name(english:"Fedora 33 : kernel / kernel-headers / kernel-tools (2021-a2d3ad5dda)");
...
FEDORA-2021-a2d3ad5dda advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-a2d3ad5dda");
...
"Update the affected kernel, kernel-headers and / or kernel-tools packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-25639");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  cve_list = make_list('CVE-2020-25639');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2021-a2d3ad5dda');
  }
  else
  {
...
pkgs = [
    {'reference':'kernel-5.10.20-200.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-headers-5.10.20-200.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-tools-5.10.20-200.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
