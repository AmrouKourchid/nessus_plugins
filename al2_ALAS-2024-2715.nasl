...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2715.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python-pip (ALAS-2024-2715)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2-2024-2715 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2715.html");
...
var pkgs = [
    {'reference':'python-pip-wheel-20.2.2-1.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python2-pip-20.2.2-1.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-pip-20.2.2-1.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
