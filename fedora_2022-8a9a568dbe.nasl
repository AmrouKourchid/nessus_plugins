...
# extracted from Fedora Security Advisory FEDORA-2022-8a9a568dbe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8a9a568dbe");

  script_name(english:"Fedora 37 : samba (2022-8a9a568dbe)");
...
FEDORA-2022-8a9a568dbe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8a9a568dbe");
...
var pkgs = [
    {'reference':'samba-4.17.2-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
