...
if (description)
{
  ...
  script_name(english:"Apache Tomcat SEoL (10.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Apache Tomcat is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Apache Tomcat is 10.0.x. It is, therefore, no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://tomcat.apache.org/tomcat-10.0-eol.html");
...
"Upgrade to a version of Apache Tomcat that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2022/10/31");
...
var constraints = [
  { max_branch : '10.0', min_branch : '10.0', seol : 20221031 }
];
