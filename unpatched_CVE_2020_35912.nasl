...
if (description)
{
  ...
  script_cve_id("CVE-2020-35912");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-35912");
...
patch available.
  ...
  - An issue was discovered in the lock_api crate before 0.4.2 for Rust. A data race can occur because of
    MappedRwLockWriteGuard unsoundness. (CVE-2020-35912)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-35912");
