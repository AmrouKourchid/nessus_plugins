...
# extracted from Red Hat Security Advisory RHSA-2018:3757. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3757");

  script_name(english:"RHEL 7 : rh-postgresql10-postgresql (RHSA-2018:3757)");
...
the RHSA-2018:3757 advisory.

    PostgreSQL is an advanced object-relational database management system (DBMS).

    The following packages have been upgraded to a later upstream version: rh-postgresql10-postgresql (10.6).
    (BZ#1649369)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1645937");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3757.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eccd78e7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3757");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-postgresql10-postgresql package based on the guidance in RHSA-2018:3757.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-postgresql10-postgresql-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-contrib-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-contrib-syspaths-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-devel-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-docs-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-libs-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-plperl-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-plpython-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-pltcl-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-server-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-server-syspaths-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-static-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-syspaths-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-postgresql10-postgresql-test-10.6-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
