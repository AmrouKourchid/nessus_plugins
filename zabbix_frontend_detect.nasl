...
foreach var dir (sort(dirs))
{
  ...
  dbg::detailed_log(lvl:4, msg:'request: ' + obj_rep(http_last_sent_request()));
  dbg::detailed_log(lvl:4, msg:'response: ' + obj_rep(res));
  ...
  )
  {
    ...
    dbg::detailed_log(lvl:4, msg:'API request:' + obj_rep(http_last_sent_request()));
    dbg::detailed_log(lvl:4, msg:'API response:' + obj_rep(api_res));
