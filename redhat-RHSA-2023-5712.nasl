...
# extracted from Red Hat Security Advisory RHSA-2023:5712. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5712.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c465c9bc");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5712");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nginx:1.20 package based on the guidance in RHSA-2023:5712.");
  ...
  'nginx:1.20': [
    {
      ...
      'pkgs': [
        {'reference':'nginx-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-all-modules-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-filesystem-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-devel-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-image-filter-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-perl-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-xslt-filter-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-mail-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-stream-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'nginx-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-all-modules-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-filesystem-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-devel-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-image-filter-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-perl-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-xslt-filter-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-mail-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-stream-1.20.1-1.module+el8.8.0+20359+9bd89172.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
