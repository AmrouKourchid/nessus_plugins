...
# extracted from Fedora Security Advisory FEDORA-2024-661a8bb3b0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-661a8bb3b0");

  script_name(english:"Fedora 39 : tinyproxy (2024-661a8bb3b0)");
...
FEDORA-2024-661a8bb3b0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-661a8bb3b0");
...
var pkgs = [
    {'reference':'tinyproxy-1.10.0-14.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
