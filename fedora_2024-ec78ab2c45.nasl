...
# extracted from Fedora Security Advisory FEDORA-2024-ec78ab2c45
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ec78ab2c45");

  script_name(english:"Fedora 39 : p7zip (2024-ec78ab2c45)");
...
FEDORA-2024-ec78ab2c45 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ec78ab2c45");
...
var pkgs = [
    {'reference':'p7zip-16.02-31.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
