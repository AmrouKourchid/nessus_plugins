...
# extracted from Red Hat Security Advisory RHSA-2024:3842. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3842");
  script_xref(name:"IAVA", value:"2024-A-0356");

  script_name(english:"RHEL 9 : c-ares (RHSA-2024:3842)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3842.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?120aae54");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2265713");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3842");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL c-ares package based on the guidance in RHSA-2024:3842.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'c-ares-1.19.1-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'c-ares-devel-1.19.1-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'c-ares-1.19.1-2.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'c-ares-devel-1.19.1-2.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
