...
# extracted from Red Hat Security Advisory RHSA-2025:0220. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0220");

  script_name(english:"RHEL 8 : dpdk (RHSA-2025:0220)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for dpdk.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:0220 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0220.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3289b1b8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0220");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dpdk package based on the guidance in RHSA-2025:0220.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dpdk-21.11-4.el8_8', 'sp':'8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dpdk-21.11-4.el8_8', 'sp':'8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dpdk-21.11-4.el8_8', 'sp':'8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dpdk-devel-21.11-4.el8_8', 'sp':'8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dpdk-devel-21.11-4.el8_8', 'sp':'8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dpdk-devel-21.11-4.el8_8', 'sp':'8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dpdk-doc-21.11-4.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dpdk-tools-21.11-4.el8_8', 'sp':'8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dpdk-tools-21.11-4.el8_8', 'sp':'8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dpdk-tools-21.11-4.el8_8', 'sp':'8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
