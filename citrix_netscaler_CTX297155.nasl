...
12.1-62.23, 12.1-FIPS prior to 12.1-55.238 or 13.0.x prior to 13.0-82.41. It is, therefore, affected by multiple vulnerabilities:
...
"For versions 11.1.x, 12.1.x, 12.1-FIPS and 13.0.x, upgrade to 11.1-65.20, 12.1-62.23, 12.1-55.238-FIPS and 13.0-82.41, or later, respectively.");
...
if (app_info['fips_status'] == 1)
{
  if (preg(pattern:"^12.1.*", string:app_info['version']))
    constraints = [ {'min_version': '12.1', 'fixed_version': '12.1.55.238', 'fixed_display': '12.1-55.238 and later releases of 12.1-FIPS.'} ];
}
else
{
  constraints = [
