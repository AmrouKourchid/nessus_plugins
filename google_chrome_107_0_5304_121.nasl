...
"The version of Google Chrome installed on the remote Windows host is prior to 107.0.5304.121. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'107.0.5304.121', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
