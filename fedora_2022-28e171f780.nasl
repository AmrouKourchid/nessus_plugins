...
# extracted from Fedora Security Advisory FEDORA-2022-28e171f780
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-28e171f780");

  script_name(english:"Fedora 37 : pcs (2022-28e171f780)");
...
FEDORA-2022-28e171f780 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-28e171f780");
...
var pkgs = [
    {'reference':'pcs-0.11.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
