...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : NSS vulnerability (USN-5168-3)");
...
USN-5168-3 advisory.
    ...
    USN-5168-1 fixed a vulnerability in NSS. This update provides the corresponding update for Ubuntu 14.04
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libnss3', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss3-1d', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss3-dev', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss3-nssdb', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss3-tools', 'pkgver': '2:3.28.4-0ubuntu0.16.04.14+esm1', 'ubuntu_pro': TRUE}
];
