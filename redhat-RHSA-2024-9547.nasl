...
# extracted from Red Hat Security Advisory RHSA-2024:9547. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9547");

  script_name(english:"RHEL 9 : krb5 (RHSA-2024:9547)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9547.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f77c038");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9547");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL krb5 package based on the guidance in RHSA-2024:9547.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'krb5-devel-1.21.1-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-libs-1.21.1-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-pkinit-1.21.1-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-server-1.21.1-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-server-ldap-1.21.1-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-workstation-1.21.1-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libkadm5-1.21.1-2.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
