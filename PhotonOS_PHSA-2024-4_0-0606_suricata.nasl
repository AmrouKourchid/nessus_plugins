...
# extracted from VMware Security Advisory PHSA-2024-4.0-0606. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Suricata PHSA-2024-4.0-0606");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the suricata package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-606.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'suricata-6.0.19-1.ph4')) flag++;
