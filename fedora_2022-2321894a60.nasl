...
# extracted from Fedora Security Advisory FEDORA-2022-2321894a60
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-2321894a60");

  script_name(english:"Fedora 36 : firefox (2022-2321894a60)");
...
FEDORA-2022-2321894a60 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-2321894a60");
...
var pkgs = [
    {'reference':'firefox-107.0-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
