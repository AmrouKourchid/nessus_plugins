...
# extracted from Fedora Security Advisory FEDORA-2025-47818d27ba
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-47818d27ba");

  script_name(english:"Fedora 41 : ghostscript (2025-47818d27ba)");
...
FEDORA-2025-47818d27ba advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-47818d27ba");
...
var pkgs = [
    {'reference':'ghostscript-10.03.1-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
