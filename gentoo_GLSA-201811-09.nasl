...
# extracted from Gentoo Linux Security Advisory GLSA 201811-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201811-09");

  script_name(english:"GLSA-201811-09 : Icecast: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201811-09
(Icecast: Arbitrary code execution)

    Multiple buffer overflows have been discovered in Icecast. Please review
      the CVE identifier referenced below for details.
  
Impact :

    A remote attacker, by sending a specially crafted request using
      authentication type &ldquo;url&rdquo;, could possibly execute arbitrary code with
      the privileges of the process, or cause a Denial of Service condition.
  
Workaround :

    There is no known workaround at this time.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201811-09");
...
if (qpkg_check(package:"net-misc/icecast", unaffected:make_list("ge 2.4.4"), vulnerable:make_list("lt 2.4.4"))) flag++;
