...
# extracted from Red Hat Security Advisory RHSA-2024:6205. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6205");

  script_name(english:"RHEL 8 : libproxy (RHSA-2024:6205)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libproxy.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:6205 advisory.

    The libproxy packages provide a library that handles all the details of proxy configuration. The libproxy
    library provides a stable external API, dynamic adjustment to changing network topology, and small core
    footprint. It does not use external dependencies within the libproxy core, however libproxy plug-ins may
    have dependencies.

    Security Fix(es):

    * libproxy: sending more than 102400 bytes in PAC without a Content-Length present could result in buffer
    overflow (CVE-2020-26154)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6205.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a57653ba");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1869639");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1880349");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6205");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libproxy package based on the guidance in RHSA-2024:6205.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libproxy-networkmanager");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libproxy-webkitgtk4");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-libproxy");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libproxy-0.4.15-5.4.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libproxy-bin-0.4.15-5.4.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libproxy-devel-0.4.15-5.4.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libproxy-gnome-0.4.15-5.4.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libproxy-networkmanager-0.4.15-5.4.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libproxy-webkitgtk4-0.4.15-5.4.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libproxy-0.4.15-5.4.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
