...
# extracted from Red Hat Security Advisory RHSA-2024:3496. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-3154");
  script_xref(name:"RHSA", value:"2024:3496");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.13.43 (RHSA-2024:3496)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.13.43.");
...
in the RHSA-2024:3496 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.13.43. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3496.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?53128b36");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2272532");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3496");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.13.43 package based on the guidance in RHSA-2024:3496.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.26.5-16.2.rhaos4.13.git67e2a9d.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.26.5-16.2.rhaos4.13.git67e2a9d.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
