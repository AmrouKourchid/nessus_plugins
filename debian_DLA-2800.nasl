...
# extracted from Debian Security Advisory dla-2800. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2800-1 : cups - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2800
advisory.

    An issue has been found in cups, the Common UNIX Printing System. Due to an input validation issue a
    malicious application might be allowed to read restricted memory. For Debian 9 stretch, this problem has
    been fixed in version 2.2.1-8+deb9u7. We recommend that you upgrade your cups packages. For the detailed
    security status of cups please refer to its security tracker page at: https://security-
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2800");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-10001");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'cups', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'cups-bsd', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'cups-client', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'cups-common', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'cups-core-drivers', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'cups-daemon', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'cups-ipp-utils', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'cups-ppdc', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'cups-server-common', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'libcups2', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'libcups2-dev', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'libcupscgi1', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'libcupsimage2', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'libcupsimage2-dev', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'libcupsmime1', 'reference': '2.2.1-8+deb9u7'},
    {'release': '9.0', 'prefix': 'libcupsppdc1', 'reference': '2.2.1-8+deb9u7'}
];
