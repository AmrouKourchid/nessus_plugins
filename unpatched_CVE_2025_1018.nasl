...
if (description)
{
  ...
  script_cve_id("CVE-2025-1018");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-1018");
...
patch available.
  ...
  - The fullscreen notification is prematurely hidden when fullscreen is re-requested quickly by the user.
    This could have been leveraged to perform a potential spoofing attack. This vulnerability affects Firefox
    < 135 and Thunderbird < 135. (CVE-2025-1018)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-1018");
