...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2494.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : c-ares (ALAS-2024-2494)");
...
as referenced in the ALAS2-2024-2494 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2494.html");
...
var pkgs = [
    {'reference':'c-ares-1.10.0-3.amzn2.0.6', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-1.10.0-3.amzn2.0.6', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-1.10.0-3.amzn2.0.6', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-debuginfo-1.10.0-3.amzn2.0.6', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-debuginfo-1.10.0-3.amzn2.0.6', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-debuginfo-1.10.0-3.amzn2.0.6', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-devel-1.10.0-3.amzn2.0.6', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-devel-1.10.0-3.amzn2.0.6', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-devel-1.10.0-3.amzn2.0.6', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
