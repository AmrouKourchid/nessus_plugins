...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5022291");
  script_xref(name:"MSFT", value:"MS23-5022291");
  ...
  script_name(english:"KB5022291: Windows Server 2022 Security Update (January 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5022291. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5022291");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5022291");
