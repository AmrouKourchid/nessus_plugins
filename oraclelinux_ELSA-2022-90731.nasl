...
var appstreams = {
    'all': [
      ...
      {'reference':'nodejs-docs-16.18.1-3.module+el8.7.0+20893+df13f383', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-16.18.1-3.module+el8.7.0+20893+df13f383', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-nodemon-2.0.20-2.module+el8.7.0+20893+df13f383', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'nodejs-docs-16.18.1-3.module+el8.7.0+20893+df13f383', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-16.18.1-3.module+el8.7.0+20893+df13f383', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-nodemon-2.0.20-2.module+el8.7.0+20893+df13f383', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
