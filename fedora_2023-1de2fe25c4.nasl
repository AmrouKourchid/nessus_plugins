...
# extracted from Fedora Security Advisory FEDORA-2023-1de2fe25c4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1de2fe25c4");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/01/23");
  script_xref(name:"IAVA", value:"2023-A-0705-S");

  script_name(english:"Fedora 39 : chromium (2023-1de2fe25c4)");
...
FEDORA-2023-1de2fe25c4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1de2fe25c4");
...
var pkgs = [
    {'reference':'chromium-120.0.6099.129-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
