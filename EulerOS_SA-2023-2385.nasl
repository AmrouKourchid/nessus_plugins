...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : libwebp (EulerOS-SA-2023-2385)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2385
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d9f54169");
...
var pkgs = [
  "libwebp-1.1.0-2.h2.eulerosv2r10"
];
