...
# extracted from Fedora Security Advisory FEDORA-2025-1290a47fff
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-1290a47fff");

  script_name(english:"Fedora 41 : cutter-re / rizin (2025-1290a47fff)");
...
FEDORA-2025-1290a47fff advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-1290a47fff");
...
"Update the affected cutter-re and / or rizin packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-40022");
...
var pkgs = [
    {'reference':'cutter-re-2.3.4-6.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rizin-0.7.4-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
