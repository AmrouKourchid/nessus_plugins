...
# SUSE update advisory SUSE-SU-2022:4518-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4518-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 1 for SLE 15 SP4) (SUSE-SU-2022:4518-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 / SLES_SAP15 host has packages installed that are affected by multiple vulnerabilities as
referenced in the SUSE-SU-2022:4518-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013257.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c5c3001");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-5_14_21-150400_24_11-default and / or kernel-livepatch-5_14_21-150400_24_18-default
packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.24.11-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_11-default-6-150400.2.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
          {'reference':'kernel-livepatch-5_14_21-150400_24_11-default-6-150400.2.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-live-patching-release-15.4', 'sles-release-15.4']}
        ]
      },
      '5.14.21-150400.24.18-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_18-default-6-150400.2.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
          {'reference':'kernel-livepatch-5_14_21-150400_24_18-default-6-150400.2.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-live-patching-release-15.4', 'sles-release-15.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_24_11-default / etc');
}
