...
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 102.10. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2023-14 advisory.
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'102.10', min:'102.0.0', severity:SECURITY_HOLE);
