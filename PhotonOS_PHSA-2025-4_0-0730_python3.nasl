...
# extracted from VMware Security Advisory PHSA-2025-4.0-0730. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Python3 PHSA-2025-4.0-0730");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the python3 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-730.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'python3-gevent-21.8.0-3.ph4')) flag++;
