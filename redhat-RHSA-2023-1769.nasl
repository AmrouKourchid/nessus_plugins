...
# extracted from Red Hat Security Advisory RHSA-2023:1769. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1769");

  script_name(english:"RHEL 9 : openvswitch2.17 (RHSA-2023:1769)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1769.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?955e1f70");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2137666");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2177686");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2178203");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1769");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openvswitch2.17 package based on the guidance in RHSA-2023:1769.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openvswitch2.17-2.17.0-77.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'openvswitch2.17-devel-2.17.0-77.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'openvswitch2.17-ipsec-2.17.0-77.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'openvswitch2.17-test-2.17.0-77.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'python3-openvswitch2.17-2.17.0-77.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openvswitch2.17 / openvswitch2.17-devel / openvswitch2.17-ipsec / etc');
}
