...
if (description)
{
  ...
  script_name(english:"Tenable Security Center 6.0.0 / 6.1.0 / 6.1.1 Multiple Vulnerabilities (TNS-2023-26)");
...
"According to its self-reported version, the Tenable Security Center running on the remote host is either 6.0.0, 6.1.0
or 6.1.1. It is, therefore, affected by multiple vulnerabilities as referenced in the TNS-2023-26 advisory.
  ...
  - Tenable Security Center leverages third-party software to help provide underlying functionality. One of
    ...
    SC-202307.1-6.x updates OpenSSL to 3.0.9 to address the identified vulnerabilities.   Tenable has released
    Patch SC-202307.1-6.x to address these issues. The installation files can be obtained from the Tenable
    Downloads Portal: https://www.tenable.com/downloads/security-center   (CVE-2023-0465, CVE-2023-0466,
    CVE-2023-1255, CVE-2023-2650)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://docs.tenable.com/release-notes/Content/security-center/tenablesc2023.htm#2023071-6
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a54454a9");
  script_set_attribute(attribute:"see_also", value:"https://www.tenable.com/security/TNS-2023-26");
  script_set_attribute(attribute:"solution", value:
"Apply Tenable Security Center Patch SC-202307.1-6.x.");
...
var constraints = [
  { 'min_version' : '6.0', 'max_version' : '6.1.1', 'fixed_display' : 'Apply Patch SC-202307.1-6.x' }
];
