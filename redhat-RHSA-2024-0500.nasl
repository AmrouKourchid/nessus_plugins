...
# extracted from Red Hat Security Advisory RHSA-2024:0500. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0500");
  script_xref(name:"IAVA", value:"2023-A-0582-S");

  script_name(english:"RHEL 9 : openssl (RHSA-2024:0500)");
...
the RHSA-2024:0500 advisory.
    ...
    * In FIPS mode, OpenSSL must not perform any cryptographic operations when rsa_keygen_pairwise_test fails
    (RHEL-17110)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0500.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?757b8f42");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2243839");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-14578");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-15992");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0500");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openssl package based on the guidance in RHSA-2024:0500.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssl-3.0.7-18.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-devel-3.0.7-18.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-libs-3.0.7-18.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-perl-3.0.7-18.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
