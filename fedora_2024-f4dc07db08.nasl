...
# extracted from Fedora Security Advisory FEDORA-2024-f4dc07db08
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f4dc07db08");

  script_name(english:"Fedora 41 : trafficserver (2024-f4dc07db08)");
...
FEDORA-2024-f4dc07db08 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f4dc07db08");
...
var pkgs = [
    {'reference':'trafficserver-9.2.6-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
