...
# extracted from Fedora Security Advisory FEDORA-2019-7d689dd314.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-7d689dd314");

  script_name(english:"Fedora 30 : tcpreplay (2019-7d689dd314)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-7d689dd314");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"tcpreplay-4.3.2-1.fc30")) flag++;
