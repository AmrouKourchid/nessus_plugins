...
# extracted from Red Hat Security Advisory RHSA-2018:3650. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3650.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d8ac5a16");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3650");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1619756");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1621359");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1621361");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1625839");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ghostscript package based on the guidance in RHSA-2018:3650.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ghostscript-9.07-31.el7_6.1', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-cups-9.07-31.el7_6.1', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-devel-9.07-31.el7_6.1', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-doc-9.07-31.el7_6.1', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-gtk-9.07-31.el7_6.1', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
