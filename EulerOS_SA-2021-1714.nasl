...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : grub2 (EulerOS-SA-2021-1714)");
...
the following vulnerabilities :
  ...
  - ** RESERVED ** This candidate has been reserved by an
    ...
    will be provided.(CVE-2020-17779)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1714
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12c3d4f6");
