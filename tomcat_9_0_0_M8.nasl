...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 9.0.0.M1 < 9.0.0.M8");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 9.0.0.M8. It is, therefore, affected by a vulnerability
as referenced in the fixed_in_apache_tomcat_9.0.0.m8_security-9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://svn.apache.org/viewvc?view=rev&rev=1743700");
  # https://tomcat.apache.org/security-9.html#Fixed_in_Apache_Tomcat_9.0.0.M8
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?515ce9b9");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 9.0.0.M8 or later.");
...
var constraints = [
  { 'min_version' : '9.0.0.M1', 'max_version' : '9.0.0.M7', 'fixed_version' : '9.0.0.M8' }
];
