...
# extracted from openSUSE Security Update openSUSE-2019-2263.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : bind (openSUSE-2019-2263)");
...
if ( rpm_check(release:"SUSE15.0", reference:"bind-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"bind-chrootenv-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"bind-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"bind-debugsource-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"bind-devel-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"bind-lwresd-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"bind-lwresd-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"bind-utils-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"bind-utils-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libbind9-160-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libbind9-160-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libdns169-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libdns169-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libirs-devel-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libirs160-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libirs160-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libisc166-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libisc166-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libisccc160-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libisccc160-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libisccfg160-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libisccfg160-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"liblwres160-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"liblwres160-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"python3-bind-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"bind-devel-32bit-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libbind9-160-32bit-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libbind9-160-32bit-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libdns169-32bit-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libdns169-32bit-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libirs160-32bit-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libirs160-32bit-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libisc166-32bit-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libisc166-32bit-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libisccc160-32bit-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libisccc160-32bit-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libisccfg160-32bit-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libisccfg160-32bit-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"liblwres160-32bit-9.11.2-lp150.8.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"liblwres160-32bit-debuginfo-9.11.2-lp150.8.16.1") ) flag++;
