...
# extracted from Red Hat Security Advisory RHSA-2023:0100. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0100");

  script_name(english:"RHEL 8 : systemd (RHSA-2023:0100)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for systemd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:0100 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0100.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?843e41bc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2127170");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2139327");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0100");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL systemd package based on the guidance in RHSA-2023:0100.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'systemd-239-68.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-container-239-68.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-devel-239-68.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-journal-remote-239-68.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-libs-239-68.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-pam-239-68.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-tests-239-68.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'systemd-udev-239-68.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
