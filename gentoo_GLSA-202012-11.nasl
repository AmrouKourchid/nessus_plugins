...
# extracted from Gentoo Linux Security Advisory GLSA 202012-11.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202012-11");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"GLSA-202012-11 : c-ares: Denial of service");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202012-11
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202012-11");
...
if (qpkg_check(package:"net-dns/c-ares", unaffected:make_list("ge 1.17.1"), vulnerable:make_list("lt 1.17.1"))) flag++;
