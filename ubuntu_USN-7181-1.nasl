...
# extracted from Ubuntu Security Notice USN-7181-1. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-16846");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/05/03");
  script_xref(name:"USN", value:"7181-1");
  script_xref(name:"CEA-ID", value:"CEA-2020-0134");

  script_name(english:"Ubuntu 14.04 LTS : Salt vulnerability (USN-7181-1)");
...
USN-7181-1 advisory.
    ...
    It was discovered that Salt incorrectly handled web requests when the SSH client was enabled. An attacker
    could possibly use this issue to achieve remote code execution or obtain sensitive information.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7181-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'salt-common', 'pkgver': '0.17.5+ds-1ubuntu0.1~esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'salt-master', 'pkgver': '0.17.5+ds-1ubuntu0.1~esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'salt-minion', 'pkgver': '0.17.5+ds-1ubuntu0.1~esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'salt-ssh', 'pkgver': '0.17.5+ds-1ubuntu0.1~esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'salt-syndic', 'pkgver': '0.17.5+ds-1ubuntu0.1~esm4', 'ubuntu_pro': TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'salt-common / salt-master / salt-minion / salt-ssh / salt-syndic');
}
