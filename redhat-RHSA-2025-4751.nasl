...
# extracted from Red Hat Security Advisory RHSA-2025:4751. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:4751");

  script_name(english:"RHEL 7 : firefox (RHSA-2025:4751)");
...
referenced in the RHSA-2025:4751 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4751.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67b23854");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4751");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2025:4751.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-128.10.0-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-128.10.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
