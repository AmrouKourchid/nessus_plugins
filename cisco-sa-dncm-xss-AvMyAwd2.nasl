...
if (description)
{
  ...
  script_cve_id("CVE-2020-3348", "CVE-2020-3349");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvt25279");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvt27497");
  script_xref(name:"CISCO-SA", value:"cisco-sa-dncm-xss-AvMyAwd2");
  script_xref(name:"IAVA", value:"2020-A-0279-S");

  script_name(english:"Cisco Data Center Network Manager XSS (cisco-sa-dncm-xss-AvMyAwd2)");
...
Please see the included Cisco BID and Cisco Security Advisory for more information.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?64dc8c39");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvt25279");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvt27497");
  script_set_attribute(attribute:"solution", value:
"Upgrade to the relevant fixed version referenced in Cisco bug IDs CSCvt25279, CSCvt27497");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:H/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-3349");
