...
# extracted from Red Hat Security Advisory RHSA-2020:2732. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-12689", "CVE-2020-12691", "CVE-2020-12692");
  script_xref(name:"RHSA", value:"2020:2732");

  script_name(english:"RHEL 7 : openstack-keystone (RHSA-2020:2732)");
...
referenced in the RHSA-2020:2732 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2732.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d496da52");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2732");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1831566");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1833164");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-keystone package based on the guidance in RHSA-2020:2732.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-keystone-13.0.4-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python-keystone-13.0.4-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openstack-keystone / python-keystone');
}
