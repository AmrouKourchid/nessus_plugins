...
# extracted from Fedora Security Advisory FEDORA-2024-450b75e4a0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-450b75e4a0");

  script_name(english:"Fedora 39 : libcoap (2024-450b75e4a0)");
...
FEDORA-2024-450b75e4a0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-450b75e4a0");
...
"Update the affected libcoap package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-31031");
...
var pkgs = [
    {'reference':'libcoap-4.3.4a-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
