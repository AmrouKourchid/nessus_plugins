...
# extracted from Red Hat Security Advisory RHSA-2024:0254. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0254");

  script_name(english:"RHEL 8 : rsync (RHSA-2024:0254)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rsync.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:0254 advisory.
    ...
    * rsync: zlib: heap-based buffer over-read and overflow in inflate() in inflate.c via a large gzip header
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0254.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9ad9ad57");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2116639");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0254");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rsync package based on the guidance in RHSA-2024:0254.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rsync-3.1.3-14.el8_6.5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsync-daemon-3.1.3-14.el8_6.5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
