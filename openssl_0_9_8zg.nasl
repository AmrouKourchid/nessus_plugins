...
"The version of OpenSSL installed on the remote host is prior to 0.9.8zg. It is, therefore, affected by multiple
vulnerabilities as referenced in the 0.9.8zg advisory.
...
var constraints = [
  { 'min_version' : '0.9.8', 'fixed_version' : '0.9.8zg' }
];
