...
# extracted from Ubuntu Security Notice USN-2558-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2558-1");

  script_name(english:"Ubuntu 14.04 LTS : Mailman vulnerability (USN-2558-1)");
...
USN-2558-1 advisory.
    ...
    It was discovered that Mailman incorrectly handled special characters in list names. A local attacker
    could use this issue to perform a path traversal attack and execute arbitrary code as the Mailman user.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2558-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'mailman', 'pkgver': '1:2.1.16-2ubuntu0.1'}
];
