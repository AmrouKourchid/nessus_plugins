...
if (description)
{
  ...
  script_cve_id("CVE-2024-7264", "CVE-2024-8096");
  script_xref(name:"IAVA", value:"2024-A-0457-S");
  script_xref(name:"IAVA", value:"2024-A-0571-S");

  script_name(english:"EulerOS 2.0 SP10 : curl (EulerOS-SA-2024-2901)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2901
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d3a1855");
...
var pkgs = [
  "curl-7.71.1-4.h31.r3.eulerosv2r10",
  "libcurl-7.71.1-4.h31.r3.eulerosv2r10"
];
