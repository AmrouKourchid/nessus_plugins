...
# extracted from Fedora Security Advisory FEDORA-2023-920a3ab4ee
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-920a3ab4ee");
  script_xref(name:"IAVB", value:"2023-B-0063-S");

  script_name(english:"Fedora 37 : wireshark (2023-920a3ab4ee)");
...
FEDORA-2023-920a3ab4ee advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-920a3ab4ee");
...
var pkgs = [
    {'reference':'wireshark-4.0.8-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
