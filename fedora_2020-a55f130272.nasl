...
# extracted from Fedora Security Advisory FEDORA-2020-a55f130272.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : golang (2020-a55f130272)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-a55f130272");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"golang-1.14.7-1.fc32")) flag++;
