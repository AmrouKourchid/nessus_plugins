...
# extracted from Fedora Security Advisory FEDORA-2019-992622684b.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : gnome-desktop3 (2019-992622684b)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"gnome-desktop 3.30.2.3 release, fixing thumbnailer sandbox escape,
CVE-2019-11460
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-992622684b");
  script_set_attribute(attribute:"solution", value:
"Update the affected gnome-desktop3 package.");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"gnome-desktop3-3.30.2.3-1.fc29")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "gnome-desktop3");
}
