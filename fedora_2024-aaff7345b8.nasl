...
# extracted from Fedora Security Advisory FEDORA-2024-aaff7345b8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-aaff7345b8");

  script_name(english:"Fedora 40 : chromium (2024-aaff7345b8)");
...
FEDORA-2024-aaff7345b8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-aaff7345b8");
...
var pkgs = [
    {'reference':'chromium-129.0.6668.70-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
