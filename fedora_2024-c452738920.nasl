...
# extracted from Fedora Security Advisory FEDORA-2024-c452738920
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c452738920");

  script_name(english:"Fedora 39 : python3.13 (2024-c452738920)");
...
FEDORA-2024-c452738920 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c452738920");
...
var pkgs = [
    {'reference':'python3.13-3.13.0~rc1-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
