...
# extracted from Fedora Security Advisory FEDORA-2024-16a71b7cf5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-16a71b7cf5");

  script_name(english:"Fedora 41 : php-bartlett-PHP-CompatInfo (2024-16a71b7cf5)");
...
FEDORA-2024-16a71b7cf5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-16a71b7cf5");
...
var pkgs = [
    {'reference':'php-bartlett-PHP-CompatInfo-7.1.4-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
