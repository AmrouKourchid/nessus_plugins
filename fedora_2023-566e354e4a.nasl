...
# extracted from Fedora Security Advisory FEDORA-2023-566e354e4a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-566e354e4a");

  script_name(english:"Fedora 37 : amanda (2023-566e354e4a)");
...
FEDORA-2023-566e354e4a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-566e354e4a");
...
var pkgs = [
    {'reference':'amanda-3.5.4-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
