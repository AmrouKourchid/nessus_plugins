...
# extracted from Fedora Security Advisory FEDORA-2024-b5da13e80a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b5da13e80a");

  script_name(english:"Fedora 41 : suricata (2024-b5da13e80a)");
...
FEDORA-2024-b5da13e80a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b5da13e80a");
...
var pkgs = [
    {'reference':'suricata-7.0.7-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
