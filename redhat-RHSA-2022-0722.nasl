...
"The remote Red Hat host is missing a security update for rh-maven36-httpcomponents-client.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:0722 advisory.

    HttpClient is a HTTP/1.1 compliant HTTP agent implementation based on httpcomponents HttpCore. It also
    provides reusable components for client-side authentication, HTTP state management, and HTTP connection
    management.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0722.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3a9a729");
...
"Update the RHEL rh-maven36-httpcomponents-client package based on the guidance in RHSA-2022:0722.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-maven36-httpcomponents-client-4.5.9-1.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven36-httpcomponents-client-javadoc-4.5.9-1.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
