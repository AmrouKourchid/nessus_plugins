...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : bzip2 (ELSA-2008-0893)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0893.html");
...
"Update the affected bzip2, bzip2-devel and / or bzip2-libs packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-1372");
...
var pkgs = [
    {'reference':'bzip2-1.0.3-4.el5_2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bzip2-devel-1.0.3-4.el5_2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bzip2-libs-1.0.3-4.el5_2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bzip2-1.0.3-4.el5_2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bzip2-devel-1.0.3-4.el5_2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bzip2-libs-1.0.3-4.el5_2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
