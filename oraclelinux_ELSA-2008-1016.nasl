...
# Oracle Linux Security Advisory ELSA-2008-1016 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : enscript (ELSA-2008-1016)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-1016.html");
...
"Update the affected enscript package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-4306");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2008-3863");
...
var pkgs = [
    {'reference':'enscript-1.6.4-4.1.1.el5_2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'enscript-1.6.4-4.1.1.el5_2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
