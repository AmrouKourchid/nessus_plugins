...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libsoup (EulerOS-SA-2020-1309)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1309
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c7170a86");
...
pkgs = ["libsoup-2.56.0-6.h2.eulerosv2r7",
        "libsoup-devel-2.56.0-6.h2.eulerosv2r7"];
