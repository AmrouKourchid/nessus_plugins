...
# extracted from Fedora Security Advisory FEDORA-2022-613e993500
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-613e993500");

  script_name(english:"Fedora 36 : xorg-x11-server (2022-613e993500)");
...
FEDORA-2022-613e993500 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-613e993500");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-9.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
