...
# extracted from Oracle Linux Security Advisory ELSA-2023-2234.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : sysstat (ELSA-2023-2234)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-2234.html");
...
var pkgs = [
    {'reference':'sysstat-12.5.4-5.0.1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sysstat-12.5.4-5.0.1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
