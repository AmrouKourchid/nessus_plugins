...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0945.html");
...
"Update the affected quagga, quagga-contrib and / or quagga-devel packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2010-2949");
...
var pkgs = [
    {'reference':'quagga-0.99.15-5.el6_0.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'quagga-contrib-0.99.15-5.el6_0.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'quagga-devel-0.99.15-5.el6_0.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'quagga-0.99.15-5.el6_0.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'quagga-contrib-0.99.15-5.el6_0.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'quagga-devel-0.99.15-5.el6_0.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
