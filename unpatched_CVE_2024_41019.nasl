...
if (description)
{
  ...
  script_cve_id("CVE-2024-41019");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-41019");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: fs/ntfs3: Validate ff offset This adds
    sanity checks for ff offset. There is a check on rt->first_free at first, but walking through by ff
    without any check. If the second ff is a large offset. We may encounter an out-of-bound read.
    (CVE-2024-41019)
