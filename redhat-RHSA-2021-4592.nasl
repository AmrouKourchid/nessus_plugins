...
# extracted from Red Hat Security Advisory RHSA-2021:4592. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : gcc-toolset-10-annobin (RHSA-2021:4592)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4592.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?529bb234");
...
"Update the RHEL gcc-toolset-10-annobin package based on the guidance in RHSA-2021:4592.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gcc-toolset-10-annobin-9.29-1.el8_5.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
