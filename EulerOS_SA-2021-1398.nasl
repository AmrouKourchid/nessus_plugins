...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : openssh (EulerOS-SA-2021-1398)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1398
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b2251c18");
...
pkgs = ["openssh-7.4p1-16.h20",
        "openssh-clients-7.4p1-16.h20",
        "openssh-keycat-7.4p1-16.h20",
        "openssh-server-7.4p1-16.h20"];
