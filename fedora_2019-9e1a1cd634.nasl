...
# extracted from Fedora Security Advisory FEDORA-2019-9e1a1cd634.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : putty (2019-9e1a1cd634)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-9e1a1cd634");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"putty-0.71-1.fc28")) flag++;
