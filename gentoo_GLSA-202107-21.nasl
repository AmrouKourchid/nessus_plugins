...
# extracted from Gentoo Linux Security Advisory GLSA 202107-21.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-22173", "CVE-2021-22174", "CVE-2021-22191", "CVE-2021-22207", "CVE-2021-22222");
  script_xref(name:"GLSA", value:"202107-21");

  script_name(english:"GLSA-202107-21 : Wireshark: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-21
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-21"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-analyzer/wireshark", unaffected:make_list("ge 3.4.6"), vulnerable:make_list("lt 3.4.6"))) flag++;
