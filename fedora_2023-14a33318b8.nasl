...
# extracted from Fedora Security Advisory FEDORA-2023-14a33318b8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-14a33318b8");

  script_name(english:"Fedora 40 : golang-github-prometheus-prom2json (2023-14a33318b8)");
...
FEDORA-2023-14a33318b8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-14a33318b8");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-github-prometheus-prom2json package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-github-prometheus-prom2json");
...
var pkgs = [
    {'reference':'golang-github-prometheus-prom2json-1.3.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-prometheus-prom2json');
}
