...
# extracted from Fedora Security Advisory FEDORA-2018-199e6065ee.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : libcdio (2018-199e6065ee)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Added patch to fix: CVE-2017-18198 (#1549644) Added patch to fix:
CVE-2017-18199 (#1549701) Added patches to fix: CVE-2017-18201
(#1549707)
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-199e6065ee");
...
"Update the affected libcdio package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libcdio");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libcdio-0.94-5.fc26")) flag++;
