...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : ntp (EulerOS-SA-2020-2450)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2450
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?246513ea");
...
pkgs = ["ntp-4.2.6p5-28.h16.eulerosv2r7",
        "ntpdate-4.2.6p5-28.h16.eulerosv2r7",
        "sntp-4.2.6p5-28.h16.eulerosv2r7"];
