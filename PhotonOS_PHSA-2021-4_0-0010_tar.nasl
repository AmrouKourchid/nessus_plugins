...
# extracted from VMware Security Advisory PHSA-2021-4.0-0010. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Tar PHSA-2021-4.0-0010");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the tar package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-10.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'tar-1.34-1.ph4')) flag++;
