...
# Oracle Linux Security Advisory ELSA-2018-2241 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : java-1.8.0-openjdk (ELSA-2018-2241)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-2241.html");
...
var pkgs = [
    ...
    {'reference':'java-1.8.0-openjdk-javadoc-1.8.0.181-3.b13.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'java-1.8.0-openjdk-javadoc-debug-1.8.0.181-3.b13.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    ...
    {'reference':'java-1.8.0-openjdk-javadoc-1.8.0.181-3.b13.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'java-1.8.0-openjdk-javadoc-debug-1.8.0.181-3.b13.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
