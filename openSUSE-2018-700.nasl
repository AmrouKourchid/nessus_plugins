...
# extracted from openSUSE Security Update openSUSE-2018-700.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ucode-intel (openSUSE-2018-700) (Spectre)");
...
0b00002c->0b00002e Xeon E5/E7 v4; Core i7-69xx/68xx");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1087083");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1100147");
  # https://downloadcenter.intel.com/download/27945/Linux-Processor-Microcode-Data-File
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6521bf44");
...
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"ucode-intel-20180703-lp150.2.4.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ucode-intel-20180703-25.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ucode-intel-blob-20180703-25.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ucode-intel-debuginfo-20180703-25.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ucode-intel-debugsource-20180703-25.1") ) flag++;
