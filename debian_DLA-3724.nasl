...
# extracted from Debian Security Advisory dla-3724. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3724 : python-pil - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3724
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3724-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/pillow");
  script_set_attribute(attribute:"solution", value:
"Upgrade the python-pil packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'python-pil', 'reference': '5.4.1-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python-pil-dbg', 'reference': '5.4.1-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python-pil-doc', 'reference': '5.4.1-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python-pil.imagetk', 'reference': '5.4.1-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python-pil.imagetk-dbg', 'reference': '5.4.1-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python3-pil', 'reference': '5.4.1-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python3-pil-dbg', 'reference': '5.4.1-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python3-pil.imagetk', 'reference': '5.4.1-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python3-pil.imagetk-dbg', 'reference': '5.4.1-2+deb10u4'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-pil / python-pil-dbg / python-pil-doc / python-pil.imagetk / etc');
}
