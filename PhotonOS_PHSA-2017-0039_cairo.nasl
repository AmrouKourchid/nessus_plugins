...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Cairo PHSA-2017-0039");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'cairo-1.14.8-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'cairo-debuginfo-1.14.8-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'cairo-devel-1.14.8-2.ph1')) flag++;
