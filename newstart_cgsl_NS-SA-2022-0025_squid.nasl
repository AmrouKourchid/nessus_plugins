...
# extracted from ZTE advisory NS-SA-2022-0025. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : squid Vulnerability (NS-SA-2022-0025)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2022-0025");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2020-25097");
...
more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:squid-debuginfo");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:squid-debuginfo");
...
var pkgs = {
  'CGSL CORE 5.05': [
    'squid-3.5.20-17.el7_9.6',
    'squid-debuginfo-3.5.20-17.el7_9.6',
    'squid-migration-script-3.5.20-17.el7_9.6',
    'squid-sysvinit-3.5.20-17.el7_9.6'
  ],
  'CGSL MAIN 5.05': [
    'squid-3.5.20-17.el7_9.6',
    'squid-debuginfo-3.5.20-17.el7_9.6',
