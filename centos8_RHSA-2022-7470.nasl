...
# Red Hat Security Advisory RHSA-2022:7470. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : pki-core:10.6 and pki-deps:10.6 (CESA-2022:7470)");
...
"Update the affected ldapjdk-javadoc package.");
...
var appstreams = {
    'pki-core:10.6': [
      {'reference':'ldapjdk-javadoc-4.23.0-1.module_el8.5.0+876+d4bb8aa6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ldapjdk-javadoc');
}
