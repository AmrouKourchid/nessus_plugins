...
if (description)
{
  ...
  script_name(english:"Ubuntu 22.04 LTS : .NET 6 vulnerability (USN-5798-1)");
...
USN-5798-1 advisory.
    ...
    Johan Gorter discovered that .NET 6 incorrectly processed certain invalid HTTP requests. An attacker could
    possibly use this issue to cause a denial of service condition for an exposed endpoint.
