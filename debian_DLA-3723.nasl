...
# extracted from Debian Security Advisory dla-3723. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3723 : libspreadsheet-parsexlsx-perl - security update");
...
dla-3723 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3723-1                debian-lts@lists.debian.org
...
number.");
  # https://security-tracker.debian.org/tracker/source-package/libspreadsheet-parsexlsx-perl
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc2599f8");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-22368");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-23525");
  # https://packages.debian.org/source/buster/libspreadsheet-parsexlsx-perl
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?204a1414");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libspreadsheet-parsexlsx-perl packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libspreadsheet-parsexlsx-perl");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libspreadsheet-parsexlsx-perl', 'reference': '0.27-2+deb10u1'}
];
