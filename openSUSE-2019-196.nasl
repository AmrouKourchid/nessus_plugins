...
# extracted from openSUSE Security Update openSUSE-2019-196.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : LibVNCServer (openSUSE-2019-196)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1123823");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1123828");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1123832");
...
if ( rpm_check(release:"SUSE15.0", reference:"LibVNCServer-debugsource-0.9.10-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"LibVNCServer-devel-0.9.10-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libvncclient0-0.9.10-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libvncclient0-debuginfo-0.9.10-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libvncserver0-0.9.10-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libvncserver0-debuginfo-0.9.10-lp150.3.6.1") ) flag++;
