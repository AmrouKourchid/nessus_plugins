...
if (description)
{
  ...
  script_cve_id("CVE-2023-43786", "CVE-2023-43787", "CVE-2023-43788");

  script_name(english:"EulerOS Virtualization 3.0.6.0 : libXpm (EulerOS-SA-2024-1691)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1691
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b0022a67");
...
var pkgs = [
  "libXpm-3.5.12-8.h3.eulerosv2r8",
  "libXpm-devel-3.5.12-8.h3.eulerosv2r8"
];
