...
# extracted from Ubuntu Security Notice USN-6875-1. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-21823", "CVE-2024-26924", "CVE-2024-35901");
  script_xref(name:"USN", value:"6875-1");

  script_name(english:"Ubuntu 24.04 LTS : Linux kernel (Azure) vulnerabilities (USN-6875-1)");
...
the USN-6875-1 advisory.
    ...
    - Netfilter; (CVE-2024-35901, CVE-2024-26924)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6875-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.8.0-1009-azure");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.8.0-1009-azure-fde");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6875-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2024-21823', 'CVE-2024-26924', 'CVE-2024-35901');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6875-1');
  }
  else
  {
