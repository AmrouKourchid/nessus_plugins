...
# extracted from Red Hat Security Advisory RHSA-2024:4713. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4713");

  script_name(english:"RHEL 9 : kpatch-patch (RHSA-2024:4713)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4713.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea1e2f2b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4713");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL kpatch-patch package based on the guidance in RHSA-2024:4713.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2024:4713');
  }
  else
  {
...
var kernel_live_checks = [
  {
    ...
    'kernels': {
      '5.14.0-427.13.1.el9_4.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-427_13_1-1-1.el9_4', 'sp':'4', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '5.14.0-427.13.1.el9_4.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-427_13_1-1-1.el9_4', 'sp':'4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
        ]
      }
    }
  },
  {
    ...
    'kernels': {
      '5.14.0-427.13.1.el9_4.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-427_13_1-1-1.el9_4', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '5.14.0-427.13.1.el9_4.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-5_14_0-427_13_1-1-1.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
        ]
      }
    }
  }
