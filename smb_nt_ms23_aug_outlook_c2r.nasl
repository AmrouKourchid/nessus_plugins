...
if (description)
{
  ...
  script_name(english:"Security Updates for Outlook C2R Session Spoofing Vulnerability (August 2023)");
...
affected by a session spoofing vulnerability, as follows:

  - A spoofing vulnerability. (CVE-2023-36893)
