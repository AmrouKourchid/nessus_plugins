...
# extracted from Fedora Security Advisory FEDORA-2025-166f075581
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-166f075581");

  script_name(english:"Fedora 40 : crun (2025-166f075581)");
...
FEDORA-2025-166f075581 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-166f075581");
...
var pkgs = [
    {'reference':'crun-1.20-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
