...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Critical: / firefox (ELSA-2007-1082)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-1082.html");
...
"Update the affected firefox and / or firefox-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-5959");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2007-5947");
...
var pkgs = [
    {'reference':'firefox-1.5.0.12-7.el5.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-devel-1.5.0.12-7.el5.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-1.5.0.12-7.el5.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-devel-1.5.0.12-7.el5.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
