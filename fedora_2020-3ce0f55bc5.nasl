...
# extracted from Fedora Security Advisory FEDORA-2020-3ce0f55bc5.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : ant (2020-3ce0f55bc5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-3ce0f55bc5");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"ant-1.10.9-1.fc31")) flag++;
