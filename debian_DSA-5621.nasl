...
# extracted from Debian Security Advisory dsa-5621. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5621 : bind9 - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-4408");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-5517");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-5679");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-6516");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'bind9', 'reference': '1:9.16.48-1'},
    {'release': '11.0', 'prefix': 'bind9-dev', 'reference': '1:9.16.48-1'},
    {'release': '11.0', 'prefix': 'bind9-dnsutils', 'reference': '1:9.16.48-1'},
    {'release': '11.0', 'prefix': 'bind9-doc', 'reference': '1:9.16.48-1'},
    {'release': '11.0', 'prefix': 'bind9-host', 'reference': '1:9.16.48-1'},
    {'release': '11.0', 'prefix': 'bind9-libs', 'reference': '1:9.16.48-1'},
    {'release': '11.0', 'prefix': 'bind9-utils', 'reference': '1:9.16.48-1'},
    {'release': '11.0', 'prefix': 'bind9utils', 'reference': '1:9.16.48-1'},
    {'release': '11.0', 'prefix': 'dnsutils', 'reference': '1:9.16.48-1'},
    {'release': '12.0', 'prefix': 'bind9', 'reference': '1:9.18.24-1'},
    {'release': '12.0', 'prefix': 'bind9-dev', 'reference': '1:9.18.24-1'},
    {'release': '12.0', 'prefix': 'bind9-dnsutils', 'reference': '1:9.18.24-1'},
    {'release': '12.0', 'prefix': 'bind9-doc', 'reference': '1:9.18.24-1'},
    {'release': '12.0', 'prefix': 'bind9-host', 'reference': '1:9.18.24-1'},
    {'release': '12.0', 'prefix': 'bind9-libs', 'reference': '1:9.18.24-1'},
    {'release': '12.0', 'prefix': 'bind9-utils', 'reference': '1:9.18.24-1'},
    {'release': '12.0', 'prefix': 'bind9utils', 'reference': '1:9.18.24-1'},
    {'release': '12.0', 'prefix': 'dnsutils', 'reference': '1:9.18.24-1'}
];
