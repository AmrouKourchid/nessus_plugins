...
# extracted from Fedora Security Advisory FEDORA-2024-0078a55acf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0078a55acf");

  script_name(english:"Fedora 41 : mosquitto (2024-0078a55acf)");
...
FEDORA-2024-0078a55acf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0078a55acf");
...
var pkgs = [
    {'reference':'mosquitto-2.0.19-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
