...
# extracted from Fedora Security Advisory FEDORA-2024-810afc5c2e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-810afc5c2e");
  script_xref(name:"IAVB", value:"2024-B-0041-S");

  script_name(english:"Fedora 40 : ffmpeg (2024-810afc5c2e)");
...
FEDORA-2024-810afc5c2e advisory.

    Backport fix for CVE-2023-49528 and backport fixes for compatibility with Mesa 24.0.6+ / 24.1.4+ for VA-
    API
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-810afc5c2e");
...
"Update the affected ffmpeg package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-49528");
...
var pkgs = [
    {'reference':'ffmpeg-6.1.1-19.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
