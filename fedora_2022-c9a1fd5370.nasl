...
# extracted from Fedora Security Advisory FEDORA-2022-c9a1fd5370
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c9a1fd5370");

  script_name(english:"Fedora 36 : mingw-gcc (2022-c9a1fd5370)");
...
FEDORA-2022-c9a1fd5370 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c9a1fd5370");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-gcc package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-27943");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-3826");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mingw-gcc");
...
var pkgs = [
    {'reference':'mingw-gcc-11.2.1-6.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw-gcc');
}
