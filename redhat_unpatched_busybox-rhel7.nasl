...
if (description)
{
  ...
  script_cve_id("CVE-2017-15873", "CVE-2017-15874");

  script_name(english:"RHEL 7 : busybox (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-15874");
