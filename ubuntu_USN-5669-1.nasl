...
# extracted from Ubuntu Security Notice USN-5669-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5669-1");

  script_name(english:"Ubuntu 18.04 LTS : Linux kernel vulnerabilities (USN-5669-1)");
...
the USN-5669-1 advisory.

    It was discovered that the SUNRPC RDMA protocol implementation in the Linux kernel did not properly
    calculate the header size of a RPC message payload. A local attacker could use this to expose sensitive
    information (kernel memory). (CVE-2022-0812)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5669-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1054-dell300x");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1107-oracle");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1120-raspi2");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1128-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1138-snapdragon");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-194-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-194-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-194-lowlatency");
...
var kernel_mappings = {
  '18.04': {
    '4.15.0': {
      'generic': '4.15.0-194',
      'generic-lpae': '4.15.0-194',
      'lowlatency': '4.15.0-194',
      'dell300x': '4.15.0-1054',
      'oracle': '4.15.0-1107',
      'raspi2': '4.15.0-1120',
      'kvm': '4.15.0-1128',
      'snapdragon': '4.15.0-1138'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5669-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5669-1');
  }
  else
  {
