...
# extracted from Red Hat Security Advisory RHSA-2017:3080. The text 
...
referenced in the RHSA-2017:3080 advisory.
    ...
    * Two vulnerabilities were discovered in Tomcat where if a servlet context was configured with
    readonly=false and HTTP PUT requests were allowed, an attacker could upload a JSP file to that context and
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71691c54");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:3080");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1461851");
...
"Update the RHEL tomcat6 package based on the guidance in RHSA-2017:3080.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tomcat6-6.0.24-111.el6_9', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-admin-webapps-6.0.24-111.el6_9', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-docs-webapp-6.0.24-111.el6_9', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-el-2.1-api-6.0.24-111.el6_9', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-javadoc-6.0.24-111.el6_9', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-jsp-2.1-api-6.0.24-111.el6_9', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-lib-6.0.24-111.el6_9', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-servlet-2.5-api-6.0.24-111.el6_9', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat6-webapps-6.0.24-111.el6_9', 'release':'6', 'el_string':'el6_9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
