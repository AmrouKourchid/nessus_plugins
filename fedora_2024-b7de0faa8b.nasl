...
# extracted from Fedora Security Advisory FEDORA-2024-b7de0faa8b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b7de0faa8b");

  script_name(english:"Fedora 39 : python3.9 (2024-b7de0faa8b)");
...
FEDORA-2024-b7de0faa8b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b7de0faa8b");
...
var pkgs = [
    {'reference':'python3.9-3.9.19-5.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
