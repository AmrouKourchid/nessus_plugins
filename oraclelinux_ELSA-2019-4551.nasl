...
# extracted from Oracle Linux Security Advisory ELSA-2019-4551.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2019-5736", "CVE-2019-6486");

  script_name(english:"Oracle Linux 7 : docker-engine (ELSA-2019-4551)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-4551.html");
...
var pkgs = [
    {'reference':'docker-engine-18.03.1.ol-0.0.12.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
