...
# SUSE update advisory SUSE-SU-2024:0329-2. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0329-2");
  script_xref(name:"IAVA", value:"2023-A-0442-S");

  script_name(english:"SUSE SLES15 Security Update : python (SUSE-SU-2024:0329-2)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5702c7c2");
...
var pkgs = [
    {'reference':'libpython2_7-1_0-2.7.18-150000.60.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.4']},
    {'reference':'python-2.7.18-150000.60.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.4']},
    {'reference':'python-base-2.7.18-150000.60.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.4']},
    {'reference':'python-curses-2.7.18-150000.60.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.4']},
    {'reference':'python-devel-2.7.18-150000.60.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.4']},
    {'reference':'python-gdbm-2.7.18-150000.60.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.4']},
    {'reference':'python-tk-2.7.18-150000.60.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.4']},
    {'reference':'python-xml-2.7.18-150000.60.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-packagehub-subpackages-release-15.4']}
];
