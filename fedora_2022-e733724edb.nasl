...
# extracted from Fedora Security Advisory FEDORA-2022-e733724edb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e733724edb");

  script_name(english:"Fedora 35 : freerdp (2022-e733724edb)");
...
FEDORA-2022-e733724edb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e733724edb");
...
var pkgs = [
    {'reference':'freerdp-2.8.1-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
