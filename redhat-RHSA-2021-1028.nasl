...
referenced in the RHSA-2021:1028 advisory.
    ...
    * Openstack network node reports unregister_netdevice: waiting for qr-3cec0c92-9a to become free. Usage
    count = 1 (BZ#1908539)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1028.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a321c63d");
...
"Update the RHEL kernel package based on the guidance in RHSA-2021:1028.");
