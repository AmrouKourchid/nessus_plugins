...
# extracted from Fedora Security Advisory FEDORA-2023-555f9fac30
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-555f9fac30");

  script_name(english:"Fedora 38 : borgbackup (2023-555f9fac30)");
...
FEDORA-2023-555f9fac30 advisory.
    ...
    https://github.com/borgbackup/borg/blob/1.2.6/docs/changes.rst#pre-125-archives-spoofing-vulnerability-
    cve-2023-36811
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-555f9fac30");
  script_set_attribute(attribute:"solution", value:
"Update the affected borgbackup package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:borgbackup");
...
var pkgs = [
    {'reference':'borgbackup-1.2.6-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'borgbackup');
}
