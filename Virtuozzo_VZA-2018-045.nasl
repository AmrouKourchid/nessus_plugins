...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : readykernel-patch (VZA-2018-045)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://help.virtuozzo.com/customer/portal/articles/2947842");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-30.10-54.0-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e3593ca7");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-30.15-54.0-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d0ec8c51");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-33.22-54.0-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7d45f65");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-37.30-54.0-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8948cd8");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-40.4-54.0-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fef54e5c");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-43.10-54.0-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1be47947");
...
checks = make_list2(
  make_array(
    ...
    "patch","readykernel-patch-30.10-54.0-1.vl7"
  ),
  make_array(
    "kernel","vzkernel-3.10.0-514.16.1.vz7.30.15",
    "patch","readykernel-patch-30.15-54.0-1.vl7"
  ),
  make_array(
    "kernel","vzkernel-3.10.0-514.26.1.vz7.33.22",
    "patch","readykernel-patch-33.22-54.0-1.vl7"
  ),
  make_array(
    "kernel","vzkernel-3.10.0-693.1.1.vz7.37.30",
    "patch","readykernel-patch-37.30-54.0-1.vl7"
  ),
  make_array(
    "kernel","vzkernel-3.10.0-693.11.6.vz7.40.4",
    "patch","readykernel-patch-40.4-54.0-1.vl7"
  ),
  make_array(
    "kernel","vzkernel-3.10.0-693.17.1.vz7.43.10",
    "patch","readykernel-patch-43.10-54.0-1.vl7"
  )
);
