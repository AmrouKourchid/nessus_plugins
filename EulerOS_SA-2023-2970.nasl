...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : shim (EulerOS-SA-2023-2970)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2970
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?20184d52");
...
var pkgs = [
  "shim-15-19.h14.eulerosv2r9",
  "shim-aa64-storage-15-19.h14.eulerosv2r9"
];
