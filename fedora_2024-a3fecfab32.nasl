...
# extracted from Fedora Security Advisory FEDORA-2024-a3fecfab32
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a3fecfab32");

  script_name(english:"Fedora 40 : emacs (2024-a3fecfab32)");
...
FEDORA-2024-a3fecfab32 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a3fecfab32");
...
var pkgs = [
    {'reference':'emacs-29.4-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
