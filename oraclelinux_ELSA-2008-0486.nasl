...
# Oracle Linux Security Advisory ELSA-2008-0486 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : nfs-utils (ELSA-2008-0486)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0486.html");
