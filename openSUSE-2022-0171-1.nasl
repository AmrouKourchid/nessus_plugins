...
# openSUSE Security Update openSUSE-SU-2022:0171-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : rust1.55 (openSUSE-SU-2022:0171-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2022:0171-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?35ee2d4f");
...
"Update the affected cargo1.55 and / or rust1.55 packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:cargo1.55");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:rust1.55");
...
var pkgs = [
    {'reference':'cargo1.55-1.55.0-150300.7.6.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust1.55-1.55.0-150300.7.6.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
