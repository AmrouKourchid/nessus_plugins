...
# extracted from openSUSE Security Update openSUSE-2020-719.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dom4j (openSUSE-2020-719)");
...
"This update for dom4j fixes the following issues :
  ...
  - CVE-2020-10683: Fixed an XML External Entity
    vulnerability in default SAX parser (bsc#1169760).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1169760");
...
if ( rpm_check(release:"SUSE15.1", reference:"dom4j-1.6.1-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dom4j-demo-1.6.1-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dom4j-javadoc-1.6.1-lp151.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"dom4j-manual-1.6.1-lp151.6.3.1") ) flag++;
