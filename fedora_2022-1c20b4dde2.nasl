...
# extracted from Fedora Security Advisory FEDORA-2022-1c20b4dde2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1c20b4dde2");
  script_xref(name:"IAVA", value:"2022-A-0257-S");

  script_name(english:"Fedora 37 : openssl (2022-1c20b4dde2)");
...
FEDORA-2022-1c20b4dde2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1c20b4dde2");
...
var pkgs = [
    {'reference':'openssl-3.0.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
