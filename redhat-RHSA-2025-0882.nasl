...
# extracted from Red Hat Security Advisory RHSA-2025:0882. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0882");

  script_name(english:"RHEL 9 : libsoup (RHSA-2025:0882)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0882.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3d472295");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0882");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsoup package based on the guidance in RHSA-2025:0882.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsoup-2.72.0-8.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.72.0-8.el9_0.3', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
