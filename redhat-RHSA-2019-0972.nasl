...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0972.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad869d45");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0972");
...
"Update the RHEL openwsman package based on the guidance in RHSA-2019:0972.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libwsman-devel-2.6.5-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwsman1-2.6.5-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openwsman-client-2.6.5-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openwsman-python3-2.6.5-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openwsman-server-2.6.5-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libwsman-devel / libwsman1 / openwsman-client / openwsman-python3 / etc');
}
