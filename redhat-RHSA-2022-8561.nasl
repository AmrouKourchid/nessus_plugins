...
# extracted from Red Hat Security Advisory RHSA-2022:8561. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8561");
  script_xref(name:"IAVA", value:"2022-A-0492-S");

  script_name(english:"RHEL 9 : thunderbird (RHSA-2022:8561)");
...
referenced in the RHSA-2022:8561 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8561.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f71928fc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8561");
...
"Update the RHEL thunderbird package based on the guidance in RHSA-2022:8561.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-102.5.0-2.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
