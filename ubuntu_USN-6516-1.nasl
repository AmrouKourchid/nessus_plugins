...
# extracted from Ubuntu Security Notice USN-6516-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6516-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : Linux kernel (Intel IoTG) vulnerabilities (USN-6516-1)");
...
referenced in the USN-6516-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6516-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1045-intel-iotg");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6516-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-3772', 'CVE-2023-25775', 'CVE-2023-31083', 'CVE-2023-31085', 'CVE-2023-45871');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6516-1');
  }
  else
  {
