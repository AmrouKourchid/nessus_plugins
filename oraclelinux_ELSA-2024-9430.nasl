...
# extracted from Oracle Linux Security Advisory ELSA-2024-9430.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : nano (ELSA-2024-9430)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9430.html");
...
var pkgs = [
    {'reference':'nano-5.6.1-6.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nano-5.6.1-6.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
