...
# extracted from Red Hat Security Advisory RHSA-2024:0256. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0256");

  script_name(english:"RHEL 8 : python3 (RHSA-2024:0256)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python3.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:0256 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0256.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?077b4a0a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2196183");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0256");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3 package based on the guidance in RHSA-2024:0256.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'platform-python-3.6.8-56.el8_9.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'platform-python-debug-3.6.8-56.el8_9.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'platform-python-devel-3.6.8-56.el8_9.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-idle-3.6.8-56.el8_9.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libs-3.6.8-56.el8_9.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-test-3.6.8-56.el8_9.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-tkinter-3.6.8-56.el8_9.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
