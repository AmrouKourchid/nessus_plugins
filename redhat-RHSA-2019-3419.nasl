...
# extracted from Red Hat Security Advisory RHSA-2019:3419. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2018-12900");
  script_xref(name:"RHSA", value:"2019:3419");

  script_name(english:"RHEL 8 : libtiff (RHSA-2019:3419)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libtiff.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:3419 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3419.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cef09c7b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3419");
...
"Update the RHEL libtiff package based on the guidance in RHSA-2019:3419.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libtiff-4.0.9-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-4.0.9-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-tools-4.0.9-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
