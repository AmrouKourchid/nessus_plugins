...
# extracted from Fedora Security Advisory FEDORA-2024-7250fa4a78
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7250fa4a78");

  script_name(english:"Fedora 39 : neatvnc (2024-7250fa4a78)");
...
FEDORA-2024-7250fa4a78 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7250fa4a78");
...
var pkgs = [
    {'reference':'neatvnc-0.8.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
