...
if (description)
{
  ...
  script_cve_id("CVE-2019-10161", "CVE-2020-25637");

  script_name(english:"Photon OS 4.0: Libvirt PHSA-2021-4.0-0007");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-10161");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libvirt-7.1.0-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libvirt-devel-7.1.0-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libvirt-docs-7.1.0-1.ph4')) flag++;
