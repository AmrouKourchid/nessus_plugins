...
# extracted from Red Hat Security Advisory RHSA-2023:1018. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1018");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.0 (python-werkzeug) (RHSA-2023:1018)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 17.0 (python-werkzeug).");
...
referenced in the RHSA-2023:1018 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1018.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?869463f9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2170242");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1018");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.0 (python-werkzeug) package based on the guidance in RHSA-2023:1018.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-werkzeug-2.0.1-5.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
