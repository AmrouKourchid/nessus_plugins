...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1251.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a105975");
...
"Update the RHEL kpatch-patch package based on the guidance in RHSA-2023:1251.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2023:1251');
  }
  else
  {
