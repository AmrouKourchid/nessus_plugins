...
# extracted from openSUSE Security Update openSUSE-2020-1990.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : SDL (openSUSE-2020-1990)");
...
Security issue fixed :
  ...
  - CVE-2019-13616: Fixed heap-based buffer over-read in
    BlitNtoN in video/SDL_blit_N.c when called from
    SDL_SoftBlit (bsc#1141844).
...
if ( rpm_check(release:"SUSE15.1", reference:"SDL-debugsource-1.2.15-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libSDL-1_2-0-1.2.15-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libSDL-1_2-0-debuginfo-1.2.15-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libSDL-devel-1.2.15-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libSDL-1_2-0-32bit-1.2.15-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libSDL-1_2-0-32bit-debuginfo-1.2.15-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libSDL-devel-32bit-1.2.15-lp151.4.3.1") ) flag++;
