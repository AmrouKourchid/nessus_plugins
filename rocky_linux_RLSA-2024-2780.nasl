...
# Rocky Linux Security Advisory RLSA-2024:2780.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:2780");

  script_name(english:"Rocky Linux 8 : nodejs:18 (RLSA-2024:2780)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2024:2780 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:2780");
...
var appstreams = {
    'nodejs:18': [
      {'reference':'nodejs-18.20.2-1.module+el8.9.0+1803+9ac8b495', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-18.20.2-1.module+el8.9.0+1803+9ac8b495', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debuginfo-18.20.2-1.module+el8.9.0+1803+9ac8b495', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debuginfo-18.20.2-1.module+el8.9.0+1803+9ac8b495', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debugsource-18.20.2-1.module+el8.9.0+1803+9ac8b495', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debugsource-18.20.2-1.module+el8.9.0+1803+9ac8b495', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-18.20.2-1.module+el8.9.0+1803+9ac8b495', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-18.20.2-1.module+el8.9.0+1803+9ac8b495', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-docs-18.20.2-1.module+el8.9.0+1803+9ac8b495', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-18.20.2-1.module+el8.9.0+1803+9ac8b495', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-18.20.2-1.module+el8.9.0+1803+9ac8b495', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'npm-10.5.0-1.18.20.2.1.module+el8.9.0+1803+9ac8b495', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'npm-10.5.0-1.18.20.2.1.module+el8.9.0+1803+9ac8b495', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
};
