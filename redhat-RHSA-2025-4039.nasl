...
# extracted from Red Hat Security Advisory RHSA-2025:4039. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-57656");
  script_xref(name:"RHSA", value:"2025:4039");

  script_name(english:"RHEL 7 : virtuoso-opensource (RHSA-2025:4039)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for virtuoso-opensource.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:4039 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2337539");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4039.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d92f90cc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4039");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL virtuoso-opensource package based on the guidance in RHSA-2025:4039.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-57656");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'virtuoso-opensource-6.1.6-8.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'virtuoso-opensource-6.1.6-8.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'virtuoso-opensource-6.1.6-8.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'virtuoso-opensource-6.1.6-8.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'virtuoso-opensource-utils-6.1.6-8.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'virtuoso-opensource-utils-6.1.6-8.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'virtuoso-opensource-utils-6.1.6-8.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'virtuoso-opensource-utils-6.1.6-8.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'virtuoso-opensource / virtuoso-opensource-utils');
}
