...
# extracted from Fedora Security Advisory FEDORA-2019-5e54d5e6e9.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-5e54d5e6e9");

  script_name(english:"Fedora 31 : 2:ceph (2019-5e54d5e6e9)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5e54d5e6e9");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"ceph-14.2.3-1.fc31", epoch:"2")) flag++;
