...
# extracted from Fedora Security Advisory FEDORA-2019-d5d9cfd359.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-d5d9cfd359");

  script_name(english:"Fedora 30 : ghostscript (2019-d5d9cfd359)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d5d9cfd359");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"ghostscript-9.26-4.fc30")) flag++;
