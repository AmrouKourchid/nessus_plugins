...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : gnutls (ELSA-2009-1232)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1232.html");
...
"Update the affected gnutls, gnutls-devel and / or gnutls-utils packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-2730");
...
var pkgs = [
    {'reference':'gnutls-1.4.1-3.el5_3.5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-devel-1.4.1-3.el5_3.5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-utils-1.4.1-3.el5_3.5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-1.4.1-3.el5_3.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-devel-1.4.1-3.el5_3.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-utils-1.4.1-3.el5_3.5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
