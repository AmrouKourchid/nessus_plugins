...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Wget vulnerability (USN-3012-1)");
...
in the USN-3012-1 advisory.

    Dawid Golunski discovered that Wget incorrectly handled filenames when being redirected from an HTTP to an
    FTP URL. A malicious server could possibly use this issue to overwrite local files.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3012-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'wget', 'pkgver': '1.15-1ubuntu1.14.04.2'},
    {'osver': '14.04', 'pkgname': 'wget-udeb', 'pkgver': '1.15-1ubuntu1.14.04.2'},
    {'osver': '16.04', 'pkgname': 'wget', 'pkgver': '1.17.1-1ubuntu1.1'},
    {'osver': '16.04', 'pkgname': 'wget-udeb', 'pkgver': '1.17.1-1ubuntu1.1'}
];
