...
# extracted from Debian Security Advisory DLA-2100-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2100-1 : libexif security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"an out-of-bounds write vulnerability due to an integer overflow was
reported in libexif, a library to parse exif files. This flaw might be
leveraged by remote attackers to cause denial of service, or
potentially execute arbitrary code via crafted image files.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/02/msg00007.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libexif-dev", reference:"0.6.21-2+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libexif12", reference:"0.6.21-2+deb8u1")) flag++;
