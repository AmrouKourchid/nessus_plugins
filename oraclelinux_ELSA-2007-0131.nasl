...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / squid (ELSA-2007-0131)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0131.html");
...
"Update the affected squid package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-1560");
...
var pkgs = [
    {'reference':'squid-2.6.STABLE6-4.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
    {'reference':'squid-2.6.STABLE6-4.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
