...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : freerdp (EulerOS-SA-2021-1785)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1785
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4da17997");
...
pkgs = ["freerdp-1.0.2-6.1.h11",
        "freerdp-libs-1.0.2-6.1.h11",
        "freerdp-plugins-1.0.2-6.1.h11"];
