...
# extracted from Red Hat Security Advisory RHSA-2024:0645. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0645");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.14.11 (RHSA-2024:0645)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.14.11.");
...
in the RHSA-2024:0645 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8284d199");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0645");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.14.11 packages based on the guidance in RHSA-2024:0645.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'runc-1.1.12-1.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'runc-1.1.12-1.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4', 'exists_check':'openshift-hyperkube'}
    ]
  }
];
