...
# extracted from Ubuntu Security Notice USN-3689-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS : Libgcrypt vulnerability (USN-3689-1)");
...
referenced in the USN-3689-1 advisory.

    Keegan Ryan discovered that Libgcrypt was susceptible to a side-channel attack. A local attacker could
    possibly use this attack to recover ECDSA private keys.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3689-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:libgcrypt-mingw-w64-dev");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libgcrypt11', 'pkgver': '1.5.3-2ubuntu4.6'},
    {'osver': '14.04', 'pkgname': 'libgcrypt11-dev', 'pkgver': '1.5.3-2ubuntu4.6'},
    {'osver': '14.04', 'pkgname': 'libgcrypt11-udeb', 'pkgver': '1.5.3-2ubuntu4.6'},
    {'osver': '16.04', 'pkgname': 'libgcrypt11-dev', 'pkgver': '1.5.4-3+really1.6.5-2ubuntu0.5'},
    {'osver': '16.04', 'pkgname': 'libgcrypt20', 'pkgver': '1.6.5-2ubuntu0.5'},
    {'osver': '16.04', 'pkgname': 'libgcrypt20-dev', 'pkgver': '1.6.5-2ubuntu0.5'},
    {'osver': '16.04', 'pkgname': 'libgcrypt20-udeb', 'pkgver': '1.6.5-2ubuntu0.5'},
    {'osver': '18.04', 'pkgname': 'libgcrypt-mingw-w64-dev', 'pkgver': '1.8.1-4ubuntu1.1'},
    {'osver': '18.04', 'pkgname': 'libgcrypt11-dev', 'pkgver': '1.5.4-3+really1.8.1-4ubuntu1.1'},
    {'osver': '18.04', 'pkgname': 'libgcrypt20', 'pkgver': '1.8.1-4ubuntu1.1'},
    {'osver': '18.04', 'pkgname': 'libgcrypt20-dev', 'pkgver': '1.8.1-4ubuntu1.1'},
    {'osver': '18.04', 'pkgname': 'libgcrypt20-udeb', 'pkgver': '1.8.1-4ubuntu1.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libgcrypt-mingw-w64-dev / libgcrypt11 / libgcrypt11-dev / etc');
}
