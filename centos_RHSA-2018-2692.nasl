...
# CentOS Errata and Security Advisory 2018:2692 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2018:2692)");
...
Zhanjia Song, and Holger Fuhrmannek as the original reporters.");
  # https://lists.centos.org/pipermail/centos-announce/2018-September/023022.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9cf36605");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-60.2.0-1.el7.centos", allowmaj:TRUE)) flag++;
