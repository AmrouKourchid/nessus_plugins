...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate Flaws over keytab encryption scheme (FG-IR-22-158)");
...
vulnerability as referenced in the FG-IR-22-158 advisory.
  ...
  - A missing cryptographic steps vulnerability [CWE-325] in the functions that encrypt the keytab files in
    FortiOS version 7.2.0, 7.0.0 through 7.0.5 and below 7.0.0 may allow an attacker in possession of the
    encrypted file to decipher it. (CVE-2022-29053)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-22-158");
  script_set_attribute(attribute:"solution", value:
"Please upgrade to FortiOS version 7.0.6/7.2.1 or later.");
...
var constraints = [
  { 'min_version' : '6.0', 'max_version' : '6.4', 'fixed_version' : '7.0.6' },
