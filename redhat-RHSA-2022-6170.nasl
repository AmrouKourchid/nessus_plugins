...
# extracted from Red Hat Security Advisory RHSA-2022:6170. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6170");

  script_name(english:"RHEL 7 : rsync (RHSA-2022:6170)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6170.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ef281f9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6170");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2110928");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rsync package based on the guidance in RHSA-2022:6170.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rsync-3.1.2-11.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsync-3.1.2-11.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsync-3.1.2-11.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rsync-3.1.2-11.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
