...
# extracted from Red Hat Security Advisory RHSA-2020:0707. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0707");

  script_name(english:"RHEL 8 : http-parser (RHSA-2020:0707)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0707.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a832e64c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0707");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1800364");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL http-parser package based on the guidance in RHSA-2020:0707.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'http-parser-2.8.0-2.el8_0.2', 'sp':'0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.8.0-2.el8_0.2', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'http-parser-2.8.0-2.el8_0.2', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
