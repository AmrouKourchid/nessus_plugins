...
# extracted from Fedora Security Advisory FEDORA-2018-ed907ef9a0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : 1:ceph (2018-ed907ef9a0)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"New release (1:12.2.4-1), includes Security fix for CVE-2018-7262

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ed907ef9a0");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:ceph package.");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"ceph-12.2.4-1.fc27", epoch:"1")) flag++;
