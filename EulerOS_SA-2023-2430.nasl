...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libXpm (EulerOS-SA-2023-2430)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2430
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cdd8a0c3");
...
var pkgs = [
  "libXpm-3.5.12-1.h1.eulerosv2r7",
  "libXpm-devel-3.5.12-1.h1.eulerosv2r7"
];
