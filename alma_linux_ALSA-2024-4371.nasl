...
# AlmaLinux Security Advisory ALSA-2024:4371.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4371");

  script_name(english:"AlmaLinux 9 : buildah (ALSA-2024:4371)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-4371.html");
...
var pkgs = [
    {'reference':'buildah-1.33.7-3.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-1.33.7-3.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-tests-1.33.7-3.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-tests-1.33.7-3.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
