...
# extracted from Fedora Security Advisory FEDORA-2024-4c8a159e6e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4c8a159e6e");

  script_name(english:"Fedora 40 : python2.7 (2024-4c8a159e6e)");
...
FEDORA-2024-4c8a159e6e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4c8a159e6e");
...
var pkgs = [
    {'reference':'python2.7-2.7.18-43.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
