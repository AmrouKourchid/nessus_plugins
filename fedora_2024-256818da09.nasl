...
# extracted from Fedora Security Advisory FEDORA-2024-256818da09
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-256818da09");

  script_name(english:"Fedora 41 : iwd / libell (2024-256818da09)");
...
FEDORA-2024-256818da09 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-256818da09");
  script_set_attribute(attribute:"solution", value:
"Update the affected iwd and / or libell packages.");
...
var pkgs = [
    {'reference':'iwd-3.3-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libell-0.71-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'iwd / libell');
}
