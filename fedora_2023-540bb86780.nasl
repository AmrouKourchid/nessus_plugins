...
# extracted from Fedora Security Advisory FEDORA-2023-540bb86780
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-540bb86780");

  script_name(english:"Fedora 38 : webkitgtk (2023-540bb86780)");
...
FEDORA-2023-540bb86780 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-540bb86780");
...
var pkgs = [
    {'reference':'webkitgtk-2.42.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
