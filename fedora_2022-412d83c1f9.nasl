...
# extracted from Fedora Security Advisory FEDORA-2022-412d83c1f9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-412d83c1f9");

  script_name(english:"Fedora 37 : openssl1.1 (2022-412d83c1f9)");
...
FEDORA-2022-412d83c1f9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-412d83c1f9");
...
var pkgs = [
    {'reference':'openssl1.1-1.1.1o-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
