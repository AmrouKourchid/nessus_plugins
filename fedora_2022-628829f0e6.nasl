...
# extracted from Fedora Security Advisory FEDORA-2022-628829f0e6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-628829f0e6");

  script_name(english:"Fedora 37 : jhead (2022-628829f0e6)");
...
FEDORA-2022-628829f0e6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-628829f0e6");
...
var pkgs = [
    {'reference':'jhead-3.06.0.1-5.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
