...
# extracted from Debian Security Advisory dla-3215. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3215 : golang-github-snapcore-snapd-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3215
advisory.
...
"Upgrade the golang-github-snapcore-snapd-dev packages.");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'golang-github-snapcore-snapd-dev', 'reference': '2.37.4-1+deb10u2'},
    {'release': '10.0', 'prefix': 'golang-github-ubuntu-core-snappy-dev', 'reference': '2.37.4-1+deb10u2'},
    {'release': '10.0', 'prefix': 'snap-confine', 'reference': '2.37.4-1+deb10u2'},
    {'release': '10.0', 'prefix': 'snapd', 'reference': '2.37.4-1+deb10u2'},
    {'release': '10.0', 'prefix': 'ubuntu-core-launcher', 'reference': '2.37.4-1+deb10u2'}
];
