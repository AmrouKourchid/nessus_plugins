...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2016-B-0053-S");
...
"The version of Apple Software Update installed on the remote Windows
...
"Upgrade to Apple Software Update version 2.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-1731");
