...
# extracted from Fedora Security Advisory FEDORA-2025-07901b1995
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-07901b1995");

  script_name(english:"Fedora 40 : lemonldap-ng (2025-07901b1995)");
...
FEDORA-2025-07901b1995 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-07901b1995");
...
"Update the affected lemonldap-ng package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-52948");
...
var pkgs = [
    {'reference':'lemonldap-ng-2.20.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
