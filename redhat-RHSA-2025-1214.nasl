...
# extracted from Red Hat Security Advisory RHSA-2025:1214. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1214");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"RHEL 8 : tbb (RHSA-2025:1214)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for tbb.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:1214 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1214.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d5475ef7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1214");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tbb package based on the guidance in RHSA-2025:1214.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-tbb-2018.2-10.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tbb-2018.2-10.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tbb-devel-2018.2-10.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tbb-doc-2018.2-10.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
