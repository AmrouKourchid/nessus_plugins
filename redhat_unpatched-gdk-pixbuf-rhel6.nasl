...
# extracted from Red Hat Security Advisory gdk-pixbuf. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-6352", "CVE-2017-6312", "CVE-2017-6314");

  script_name(english:"RHEL 6 : gdk-pixbuf (Unpatched Vulnerability) (deprecated)");
