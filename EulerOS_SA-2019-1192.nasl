...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : glusterfs (EulerOS-SA-2019-1192)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1192
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b67ca94c");
...
pkgs = ["glusterfs-3.8.4-54.15.h1.eulerosv2r7",
        "glusterfs-api-3.8.4-54.15.h1.eulerosv2r7",
        "glusterfs-cli-3.8.4-54.15.h1.eulerosv2r7",
        "glusterfs-client-xlators-3.8.4-54.15.h1.eulerosv2r7",
        "glusterfs-libs-3.8.4-54.15.h1.eulerosv2r7"];
