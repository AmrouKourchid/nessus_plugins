...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : unattended-upgrades vulnerability (USN-2657-1)");
...
USN-2657-1 advisory.
    ...
    It was discovered that unattended-upgrades incorrectly performed authentication checks in certain
    configurations. If a remote attacker were able to perform a machine-in-the-middle attack, this flaw could
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2657-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected unattended-upgrades package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-1330");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'unattended-upgrades', 'pkgver': '0.82.1ubuntu2.3'}
];
