...
# extracted from Fedora Security Advisory FEDORA-2024-9205c35b11
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9205c35b11");

  script_name(english:"Fedora 39 : stalld (2024-9205c35b11)");
...
FEDORA-2024-9205c35b11 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9205c35b11");
...
var pkgs = [
    {'reference':'stalld-1.19.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
