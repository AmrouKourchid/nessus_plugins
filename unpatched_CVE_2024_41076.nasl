...
if (description)
{
  ...
  script_cve_id("CVE-2024-41076");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-41076");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: NFSv4: Fix memory leak in
    nfs4_set_security_label We leak nfs_fattr and nfs4_label every time we set a security xattr.
    (CVE-2024-41076)
