...
# extracted from Fedora Security Advisory FEDORA-2019-28d3cd20c0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-28d3cd20c0");

  script_name(english:"Fedora 29 : mingw-libidn2 (2019-28d3cd20c0)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-28d3cd20c0");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"mingw-libidn2-2.3.0-1.fc29")) flag++;
