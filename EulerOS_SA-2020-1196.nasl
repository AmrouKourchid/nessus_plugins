...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : perl (EulerOS-SA-2020-1196)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1196
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c1ff8fa");
...
"Update the affected perl packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-1238");
...
pkgs = ["perl-5.16.3-292.h10",
        "perl-Pod-Escapes-1.04-292.h10",
        "perl-libs-5.16.3-292.h10",
        "perl-macros-5.16.3-292.h10"];
