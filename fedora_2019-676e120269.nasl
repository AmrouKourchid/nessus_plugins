...
# extracted from Fedora Security Advisory FEDORA-2019-676e120269.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-676e120269");

  script_name(english:"Fedora 30 : cronie (2019-676e120269)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-676e120269");
  script_set_attribute(attribute:"solution", value:
"Update the affected cronie package.");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"cronie-1.5.4-1.fc30")) flag++;
