...
# extracted from Fedora Security Advisory FEDORA-2024-846e191001
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-12455");
  script_xref(name:"FEDORA", value:"2024-846e191001");
  script_xref(name:"IAVA", value:"2025-A-0062");

  script_name(english:"Fedora 41 : glibc (2024-846e191001)");
...
FEDORA-2024-846e191001 advisory.

    This update addresses a [security vulnerability in the `getrandom` and `arc4random`
    implementation](https://sourceware.org/bugzilla/show_bug.cgi?id=32440) (CVE-2024-12455) on POWER systems
    (pcpc64le). Other architectures are not affected.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-846e191001");
...
"Update the affected glibc package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-12455");
...
var pkgs = [
    {'reference':'glibc-2.40-14.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
