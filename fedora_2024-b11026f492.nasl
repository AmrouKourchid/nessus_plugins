...
# extracted from Fedora Security Advisory FEDORA-2024-b11026f492
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b11026f492");

  script_name(english:"Fedora 40 : osc (2024-b11026f492)");
...
FEDORA-2024-b11026f492 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b11026f492");
...
var pkgs = [
    {'reference':'osc-1.9.1-420.1.1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
