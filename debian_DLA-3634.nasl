...
# extracted from Debian Security Advisory dla-3634. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3634 : libnss3 - security update");
...
dla-3634 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3634-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-25648");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-4421");
...
"Upgrade the libnss3 packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-4421");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libnss3', 'reference': '2:3.42.1-1+deb10u7'},
    {'release': '10.0', 'prefix': 'libnss3-dev', 'reference': '2:3.42.1-1+deb10u7'},
    {'release': '10.0', 'prefix': 'libnss3-tools', 'reference': '2:3.42.1-1+deb10u7'}
];
