...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002424");
  script_xref(name:"MSFT", value:"MS23-5002424");
  script_xref(name:"IAVA", value:"2023-A-0342-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server Subscription Edition (July 2023)");
...
vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002424");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002424 to address this issue.");
