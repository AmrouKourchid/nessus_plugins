...
# extracted from Red Hat Security Advisory RHSA-2021:1086. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1086.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e967a298");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1908705");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1912481");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1936461");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL 389-ds:1.4 package based on the guidance in RHSA-2021:1086.");
  ...
  '389-ds:1.4': [
    {
      ...
      'pkgs': [
        {'reference':'389-ds-base-1.4.3.8-7.module+el8.3.0+10310+6e88d919', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-devel-1.4.3.8-7.module+el8.3.0+10310+6e88d919', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-legacy-tools-1.4.3.8-7.module+el8.3.0+10310+6e88d919', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-libs-1.4.3.8-7.module+el8.3.0+10310+6e88d919', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-snmp-1.4.3.8-7.module+el8.3.0+10310+6e88d919', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-lib389-1.4.3.8-7.module+el8.3.0+10310+6e88d919', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
