...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : sqlite Vulnerability (NS-SA-2024-0011)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has sqlite packages installed that are affected by
a vulnerability:
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2019-13734");
...
more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:lemon");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:sqlite");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:sqlite-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:sqlite-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:sqlite-doc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:sqlite-tcl");
...
var pkgs = {
  'CGSL CORE 5.04': [
    'lemon-3.7.17-8.el7_7.1.cgslv5',
    'sqlite-3.7.17-8.el7_7.1.cgslv5',
    'sqlite-debuginfo-3.7.17-8.el7_7.1.cgslv5',
    'sqlite-devel-3.7.17-8.el7_7.1.cgslv5',
    'sqlite-doc-3.7.17-8.el7_7.1.cgslv5',
    'sqlite-tcl-3.7.17-8.el7_7.1.cgslv5'
  ],
  'CGSL MAIN 5.04': [
    'lemon-3.7.17-8.el7_7.1.cgslv5',
    'sqlite-3.7.17-8.el7_7.1.cgslv5',
