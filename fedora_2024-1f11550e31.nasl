...
# extracted from Fedora Security Advisory FEDORA-2024-1f11550e31
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1f11550e31");

  script_name(english:"Fedora 38 : mod_http2 (2024-1f11550e31)");
...
FEDORA-2024-1f11550e31 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1f11550e31");
...
var pkgs = [
    {'reference':'mod_http2-2.0.27-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
