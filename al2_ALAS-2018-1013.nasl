...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-1013.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-1013");

  script_name(english:"Amazon Linux 2 : zsh (ALAS-2018-1013)");
...
Buffer overflow in utils.c:checkmailpath() can lead to local arbitrary
code execution
...
to privilege escalation.(CVE-2018-1100)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-1013.html");
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"zsh-5.5.1-1.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"zsh-debuginfo-5.5.1-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"zsh-html-5.5.1-1.amzn2")) flag++;
