...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL7.x x86_64 (20200714)");
...
"Security Fix(es) :
  ...
  - Mozilla: Add-On updates did not respect the same
    ...
    (CVE-2020-12421)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2007&L=SCIENTIFIC-LINUX-ERRATA&P=2970
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c1b677c");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"thunderbird-68.10.0-1.el7_8", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"thunderbird-debuginfo-68.10.0-1.el7_8", allowmaj:TRUE)) flag++;
