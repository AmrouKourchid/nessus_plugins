...
# extracted from Ubuntu Security Notice USN-2319-3. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : OpenJDK 7 update (USN-2319-3)");
...
USN-2319-3 advisory.
    ...
    USN-2319-1 fixed vulnerabilities in OpenJDK 7. This update provides stability fixes for the arm64 and
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2319-3");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'icedtea-7-jre-jamvm', 'pkgver': '7u65-2.5.2-3~14.04'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-demo', 'pkgver': '7u65-2.5.2-3~14.04'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jdk', 'pkgver': '7u65-2.5.2-3~14.04'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre', 'pkgver': '7u65-2.5.2-3~14.04'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-headless', 'pkgver': '7u65-2.5.2-3~14.04'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-lib', 'pkgver': '7u65-2.5.2-3~14.04'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-zero', 'pkgver': '7u65-2.5.2-3~14.04'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-source', 'pkgver': '7u65-2.5.2-3~14.04'}
];
