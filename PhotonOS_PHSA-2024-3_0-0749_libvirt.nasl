...
if (description)
{
  ...
  script_cve_id("CVE-2024-2494", "CVE-2024-2496");
  script_xref(name:"IAVA", value:"2024-A-0184");

  script_name(english:"Photon OS 3.0: Libvirt PHSA-2024-3.0-0749");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-4.7.0-14.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-devel-4.7.0-14.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libvirt-docs-4.7.0-14.ph3')) flag++;
