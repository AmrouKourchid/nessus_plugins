...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : edk2 (EulerOS-SA-2021-1736)");
...
following vulnerabilities :
  ...
  - Integer overflow in DxeImageVerificationHandler() EDK
    II may allow an authenticated user to potentially
    enable denial of service via local
    access.(CVE-2019-14562)

  - The LzmaUefiDecompressGetInfo function fetches 8 bytes
    (64bit-wide) of the uncompressed data size from the
    LZMA header then silently drops the upper 32bit by
    casting it to UINT32.(CVE-2021-28211)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1736
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3906384f");
...
pkgs = ["edk2-aarch64-201903-2.9.1.2.41"];
