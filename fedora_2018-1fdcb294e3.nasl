...
# extracted from Fedora Security Advisory FEDORA-2018-1fdcb294e3.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-1fdcb294e3");

  script_name(english:"Fedora 28 : python-notebook (2018-1fdcb294e3)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-1fdcb294e3");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"python-notebook-5.4.0-2.fc28")) flag++;
