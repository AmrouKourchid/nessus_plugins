...
# extracted from Red Hat Security Advisory RHSA-2023:5989. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5989");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"RHEL 8 : varnish (RHSA-2023:5989)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for varnish.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:5989 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5989.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?598459c5");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5989");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL varnish package based on the guidance in RHSA-2023:5989.");
  ...
  'varnish:6': [
    {
      ...
      'pkgs': [
        {'reference':'varnish-6.0.8-3.module+el8.8.0+20455+bdc2c048.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-devel-6.0.8-3.module+el8.8.0+20455+bdc2c048.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-docs-6.0.8-3.module+el8.8.0+20455+bdc2c048.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-modules-0.15.0-6.module+el8.5.0+11976+0b4af72d', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'varnish-6.0.8-3.module+el8.8.0+20455+bdc2c048.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-devel-6.0.8-3.module+el8.8.0+20455+bdc2c048.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-docs-6.0.8-3.module+el8.8.0+20455+bdc2c048.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-modules-0.15.0-6.module+el8.5.0+11976+0b4af72d', 'sp':'8', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
