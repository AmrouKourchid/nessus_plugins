...
# extracted from Fedora Security Advisory FEDORA-2023-6436d808d4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6436d808d4");
  script_xref(name:"IAVB", value:"2023-B-0066-S");

  script_name(english:"Fedora 37 : vim (2023-6436d808d4)");
...
FEDORA-2023-6436d808d4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6436d808d4");
...
var pkgs = [
    {'reference':'vim-9.0.1872-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
