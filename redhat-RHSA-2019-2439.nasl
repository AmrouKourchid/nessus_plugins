...
# extracted from Red Hat Security Advisory RHSA-2019:2439. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2018-16881", "CVE-2019-1559", "CVE-2019-3888");
  script_xref(name:"RHSA", value:"2019:2439");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"RHEL 7 : rhvm-appliance (RHSA-2019:2439)");
...
referenced in the RHSA-2019:2439 advisory.
    ...
    The following packages have been upgraded to a later upstream version: rhvm-appliance (4.3). (BZ#1669364,
    BZ#1684987, BZ#1697231, BZ#1720255)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2439.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a196fe87");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2439");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1720255");
...
"Update the affected rhvm-appliance package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-3888");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_cwe_id(190, 325, 532);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhvm-appliance-4.3-20190722.0.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ovirt-'}
    ]
  }
];
