...
# extracted from Red Hat Security Advisory RHSA-2023:6298. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6298");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"RHEL 8 : Release of OpenShift Serverless Client kn 1.30.2 (RHSA-2023:6298)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Release of OpenShift Serverless Client kn 1.30.2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2023:6298 advisory.

    Red Hat OpenShift Serverless Client kn 1.30.2 provides a CLI to interact with Red Hat OpenShift Serverless
    1.30.2. The kn CLI is delivered as an RPM package for installation on RHEL platforms, and as binaries for
    non-Linux platforms.
...
number.");
  ...
  # https://access.redhat.com/documentation/en-us/red_hat_openshift_serverless/1.30
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33721754");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6298.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9cccd0a5");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6298");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Release of OpenShift Serverless Client kn 1.30.2 package based on the guidance in RHSA-2023:6298.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-serverless-clients-1.9.2-4.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-1.9.2-4.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-1.9.2-4.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
