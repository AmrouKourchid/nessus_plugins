...
if (description)
{
  ...
  script_cve_id("CVE-2023-52479");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-52479");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ksmbd: fix uaf in
    smb20_oplock_break_ack drop reference after use opinfo. (CVE-2023-52479)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52479");
