...
# extracted from Fedora Security Advisory FEDORA-2020-5d9f0ce2b3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : 1:livecd-tools / createrepo_c / dnf / dnf-plugins-core / etc (2020-5d9f0ce2b3)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-5d9f0ce2b3");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"livecd-tools-27.1-8.fc32", epoch:"1")) flag++;
if (rpm_check(release:"FC32", reference:"createrepo_c-0.16.1-2.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"dnf-4.4.0-1.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"dnf-plugins-core-4.0.18-1.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"dnf-plugins-extras-4.0.12-1.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"libdnf-0.54.2-1.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"librepo-1.12.1-1.fc32")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "1:livecd-tools / createrepo_c / dnf / dnf-plugins-core / etc");
}
