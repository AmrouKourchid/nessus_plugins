...
# extracted from Ubuntu Security Notice USN-3303-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : WebKitGTK+ vulnerabilities (USN-3303-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-3303-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3303-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-2539");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'gir1.2-javascriptcoregtk-4.0', 'pkgver': '2.16.3-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'gir1.2-webkit2-4.0', 'pkgver': '2.16.3-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libjavascriptcoregtk-4.0-18', 'pkgver': '2.16.3-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libjavascriptcoregtk-4.0-bin', 'pkgver': '2.16.3-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libjavascriptcoregtk-4.0-dev', 'pkgver': '2.16.3-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libwebkit2gtk-4.0-37', 'pkgver': '2.16.3-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libwebkit2gtk-4.0-37-gtk2', 'pkgver': '2.16.3-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'libwebkit2gtk-4.0-dev', 'pkgver': '2.16.3-0ubuntu0.16.04.1'}
];
