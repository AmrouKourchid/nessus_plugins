...
# extracted from Fedora Security Advisory FEDORA-2019-76fbe24cab.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-76fbe24cab");

  script_name(english:"Fedora 29 : libwmf (2019-76fbe24cab)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"- CVE-2019-6978: double free in the gdImage*Ptr in
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-76fbe24cab");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libwmf-0.2.12-1.fc29")) flag++;
