...
# extracted from Oracle Linux Security Advisory ELSA-2021-2988.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : varnish:6 (ELSA-2021-2988)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2021-2988 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-2988.html");
...
var appstreams = {
    'varnish:6': [
      {'reference':'varnish-6.0.6-2.module+el8.4.0+20258+f99218b2.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-devel-6.0.6-2.module+el8.4.0+20258+f99218b2.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-docs-6.0.6-2.module+el8.4.0+20258+f99218b2.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-modules-0.15.0-5.module+el8.3.0+7653+45014445', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-6.0.6-2.module+el8.4.0+20258+f99218b2.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-devel-6.0.6-2.module+el8.4.0+20258+f99218b2.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'varnish-docs-6.0.6-2.module+el8.4.0+20258+f99218b2.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
