...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Python3 PHSA-2025-5.0-0511");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2024-49767");
...
if (rpm_check(release:'PhotonOS-5.0', reference:'python3-werkzeug-2.2.2-4.ph5')) flag++;
