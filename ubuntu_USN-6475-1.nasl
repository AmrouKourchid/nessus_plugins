...
the USN-6475-1 advisory.
    ...
    It was discovered that Cobbler did not properly handle user input, which could result in an absolute path
    traversal. An attacker could possibly

    use this issue to read arbitrary files. (CVE-2014-3225)

    It was discovered that Cobbler did not properly handle user input, which could result in command
    injection. An attacker could possibly use this

    issue to execute arbitrary code with high privileges.

    (CVE-2017-1000469, CVE-2021-45082)

    It was discovered that Cobbler did not properly hide private functions in a class. A remote attacker could
    possibly use this issue to gain high
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'cobbler', 'pkgver': '2.4.1-0ubuntu2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cobbler-common', 'pkgver': '2.4.1-0ubuntu2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'cobbler-web', 'pkgver': '2.4.1-0ubuntu2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'koan', 'pkgver': '2.4.1-0ubuntu2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-cobbler', 'pkgver': '2.4.1-0ubuntu2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-koan', 'pkgver': '2.4.1-0ubuntu2+esm1', 'ubuntu_pro': TRUE}
];
