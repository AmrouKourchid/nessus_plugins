...
# extracted from Fedora Security Advisory FEDORA-2020-47efc31973.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : 1:libuv / nghttp2 (2020-47efc31973)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-47efc31973");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:libuv and / or nghttp2 packages.");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"libuv-1.34.2-1.fc30", epoch:"1")) flag++;
if (rpm_check(release:"FC30", reference:"nghttp2-1.40.0-1.fc30")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "1:libuv / nghttp2");
}
