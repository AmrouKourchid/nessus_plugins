...
# extracted from Fedora Security Advisory FEDORA-2019-03be160f9c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : cyrus-imapd (2019-03be160f9c)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-03be160f9c");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"cyrus-imapd-3.0.12-1.fc31")) flag++;
