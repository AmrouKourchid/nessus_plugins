...
# SUSE update advisory SUSE-SU-2023:4260-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4260-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 35 for SLE 15 SP3) (SUSE-SU-2023:4260-1)");
...
the SUSE-SU-2023:4260-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?08a159a6");
...
"Update the affected kernel-livepatch-5_3_18-150300_59_130-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150300.59.130-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_130-default-3-150300.2.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150300_59_130-default');
}
