...
# extracted from Fedora Security Advisory FEDORA-2023-d8b0003ecd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d8b0003ecd");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 38 : python3.8 (2023-d8b0003ecd)");
...
FEDORA-2023-d8b0003ecd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d8b0003ecd");
...
var pkgs = [
    {'reference':'python3.8-3.8.16-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
