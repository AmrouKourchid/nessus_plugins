...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3280.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?358a7604");
...
"Update the RHEL rh-git227-git package based on the guidance in RHSA-2023:3280.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-git227-git-2.27.0-6.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-git227-git-core-2.27.0-6.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-git227-git-credential-libsecret-2.27.0-6.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-git227-git-daemon-2.27.0-6.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-git227-git-subtree-2.27.0-6.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
