...
# SUSE update advisory SUSE-SU-2022:0576-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:0576-1");

  script_name(english:"SUSE SLES12 Security Update : ucode-intel (SUSE-SU-2022:0576-1)");
...
referenced in the SUSE-SU-2022:0576-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-February/010309.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a027577b");
...
var pkgs = [
    {'reference':'ucode-intel-20220207-3.38.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'ucode-intel-20220207-3.38.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
