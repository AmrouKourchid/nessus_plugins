...
# extracted from Fedora Security Advisory FEDORA-2024-92664ae6fe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-92664ae6fe");

  script_name(english:"Fedora 40 : kernel (2024-92664ae6fe)");
...
FEDORA-2024-92664ae6fe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-92664ae6fe");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2024-21823', 'CVE-2024-27398', 'CVE-2024-27399', 'CVE-2024-27400', 'CVE-2024-27401', 'CVE-2024-35947', 'CVE-2024-35949');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2024-92664ae6fe');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.8.10-300.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
