...
# extracted from Fedora Security Advisory FEDORA-2023-0e77b3d321
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0e77b3d321");

  script_name(english:"Fedora 37 : chromium (2023-0e77b3d321)");
...
FEDORA-2023-0e77b3d321 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0e77b3d321");
...
var pkgs = [
    {'reference':'chromium-111.0.5563.110-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
