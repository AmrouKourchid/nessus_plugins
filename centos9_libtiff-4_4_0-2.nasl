...
if (description)
{
  ...
  script_name(english:"CentOS 9 : libtiff-4.4.0-2.el9");
...
libtiff-4.4.0-2.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=23670");
...
var pkgs = [
    ...
    {'reference':'libtiff-static-4.4.0-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
