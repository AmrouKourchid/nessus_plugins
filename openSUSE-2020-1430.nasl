...
# extracted from openSUSE Security Update openSUSE-2020-1430.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libxml2 (openSUSE-2020-1430)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176179");
...
if ( rpm_check(release:"SUSE15.1", reference:"libxml2-2-2.9.7-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libxml2-2-debuginfo-2.9.7-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libxml2-debugsource-2.9.7-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libxml2-devel-2.9.7-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libxml2-tools-2.9.7-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libxml2-tools-debuginfo-2.9.7-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python-libxml2-python-debugsource-2.9.7-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python2-libxml2-python-2.9.7-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python2-libxml2-python-debuginfo-2.9.7-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-libxml2-python-2.9.7-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"python3-libxml2-python-debuginfo-2.9.7-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libxml2-2-32bit-2.9.7-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libxml2-2-32bit-debuginfo-2.9.7-lp151.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libxml2-devel-32bit-2.9.7-lp151.5.15.1") ) flag++;
