...
if (description)
{
  ...
  script_cve_id("CVE-2019-2692");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-2692");
...
patch available.
  ...
  - Vulnerability in the MySQL Connectors component of Oracle MySQL (subcomponent: Connector/J). Supported
    ...
    attacker with logon to the infrastructure where MySQL Connectors executes to compromise MySQL Connectors.
    Successful attacks require human interaction from a person other than the attacker. Successful attacks of
    this vulnerability can result in takeover of MySQL Connectors. (CVE-2019-2692)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-2692");
