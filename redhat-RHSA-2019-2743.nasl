...
# extracted from Red Hat Security Advisory RHSA-2019:2743. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-14379");
  script_xref(name:"RHSA", value:"2019:2743");

  script_name(english:"RHEL 7 : rh-maven35-jackson-databind (RHSA-2019:2743)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?81366659");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1737517");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2743");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-maven35-jackson-databind package based on the guidance in RHSA-2019:2743.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-maven35-jackson-databind-2.7.6-2.7.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven35-jackson-databind-javadoc-2.7.6-2.7.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
