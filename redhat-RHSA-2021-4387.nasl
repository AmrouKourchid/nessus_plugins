...
# extracted from Red Hat Security Advisory RHSA-2021:4387. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4387");

  script_name(english:"RHEL 8 : libssh (RHSA-2021:4387)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libssh.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4387 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4387.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2c9adb7c");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.5_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7240878e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4387");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1862456");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libssh package based on the guidance in RHSA-2021:4387.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libssh-0.9.4-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-config-0.9.4-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-devel-0.9.4-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
