...
# extracted from Fedora Security Advisory FEDORA-2024-000a25f3fc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-000a25f3fc");

  script_name(english:"Fedora 40 : python-aiohttp / python-openapi-core (2024-000a25f3fc)");
...
FEDORA-2024-000a25f3fc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-000a25f3fc");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-aiohttp and / or python-openapi-core packages.");
...
var pkgs = [
    {'reference':'python-aiohttp-3.9.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-openapi-core-0.19.1-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-aiohttp / python-openapi-core');
}
