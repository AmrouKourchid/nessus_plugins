...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop 21.x < 21.2.11 / 22.x < 22.5 Multiple Vulnerabilities (macOS APSB21-68)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop installed on the remote macOS or Mac OS X host is prior to 21.2.11/22.5. It is,
therefore, affected by multiple vulnerabilities as referenced in the apsb21-68 advisory.
