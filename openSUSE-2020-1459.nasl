...
# extracted from openSUSE Security Update openSUSE-2020-1459.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openldap2 (openSUSE-2020-1459)");
...
if ( rpm_check(release:"SUSE15.2", reference:"libldap-2_4-2-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libldap-2_4-2-debuginfo-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libldap-data-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-back-meta-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-back-meta-debuginfo-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-back-perl-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-back-perl-debuginfo-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-back-sock-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-back-sock-debuginfo-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-back-sql-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-back-sql-debuginfo-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-client-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-client-debuginfo-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-contrib-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-contrib-debuginfo-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-debuginfo-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-debugsource-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-devel-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-devel-static-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-ppolicy-check-password-1.2-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"openldap2-ppolicy-check-password-debuginfo-1.2-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libldap-2_4-2-32bit-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libldap-2_4-2-32bit-debuginfo-2.4.46-lp152.14.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"openldap2-devel-32bit-2.4.46-lp152.14.6.1") ) flag++;
