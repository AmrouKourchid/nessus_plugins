...
# extracted from Red Hat Security Advisory gtk2. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2012-2370", "CVE-2013-7447");

  script_name(english:"RHEL 6 : gtk2 (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2013-7447");
