...
# extracted from Debian Security Advisory dla-3766. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3766 : libnvpair1linux - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/zfs-linux");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libnvpair1linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libnvpair1linux");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libuutil1linux");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libzfs2linux");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libzfslinux-dev");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libzpool2linux");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:zfs-dbg");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libnvpair1linux', 'reference': '0.7.12-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libuutil1linux', 'reference': '0.7.12-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libzfs2linux', 'reference': '0.7.12-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libzfslinux-dev', 'reference': '0.7.12-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libzpool2linux', 'reference': '0.7.12-2+deb10u3'},
    {'release': '10.0', 'prefix': 'zfs-dbg', 'reference': '0.7.12-2+deb10u3'},
    {'release': '10.0', 'prefix': 'zfs-dkms', 'reference': '0.7.12-2+deb10u3'},
    {'release': '10.0', 'prefix': 'zfs-dracut', 'reference': '0.7.12-2+deb10u3'},
    {'release': '10.0', 'prefix': 'zfs-initramfs', 'reference': '0.7.12-2+deb10u3'},
    {'release': '10.0', 'prefix': 'zfs-test', 'reference': '0.7.12-2+deb10u3'},
    {'release': '10.0', 'prefix': 'zfs-zed', 'reference': '0.7.12-2+deb10u3'},
    {'release': '10.0', 'prefix': 'zfsutils-linux', 'reference': '0.7.12-2+deb10u3'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libnvpair1linux / libuutil1linux / libzfs2linux / libzfslinux-dev / etc');
}
