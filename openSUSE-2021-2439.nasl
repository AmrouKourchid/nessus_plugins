...
# openSUSE Security Update openSUSE-SU-2021:2439-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : curl (openSUSE-SU-2021:2439-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the openSUSE-SU-2021:2439-1 advisory. Note that Nessus has not tested for this issue but has instead relied only on the
application's self-reported version number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/SZEKWBHHW6CCB43EQZT3OXNG7LXABDJB/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?84feaad1");
...
pkgs = [
    {'reference':'curl-7.66.0-4.22.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libcurl-devel-32bit-7.66.0-4.22.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libcurl-devel-7.66.0-4.22.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libcurl4-32bit-7.66.0-4.22.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libcurl4-7.66.0-4.22.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
