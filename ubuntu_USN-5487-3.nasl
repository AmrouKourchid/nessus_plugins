...
# extracted from Ubuntu Security Notice USN-5487-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5487-3");
  script_xref(name:"IAVA", value:"2022-A-0230-S");

  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS : Apache HTTP Server regression (USN-5487-3)");
...
referenced in the USN-5487-3 advisory.
    ...
    This update re-adds the security fixes for Ubuntu 14.04 ESM and fixes two different regressions: one
    affecting mod_proxy only in Ubuntu 14.04 ESM and another in mod_sed affecting also Ubuntu 16.04 ESM and
    Ubuntu 18.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5487-3");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'apache2', 'pkgver': '2.4.18-2ubuntu3.17+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-bin', 'pkgver': '2.4.18-2ubuntu3.17+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-data', 'pkgver': '2.4.18-2ubuntu3.17+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-dev', 'pkgver': '2.4.18-2ubuntu3.17+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-suexec-custom', 'pkgver': '2.4.18-2ubuntu3.17+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-suexec-pristine', 'pkgver': '2.4.18-2ubuntu3.17+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-utils', 'pkgver': '2.4.18-2ubuntu3.17+esm7', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'apache2', 'pkgver': '2.4.29-1ubuntu4.25', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'apache2-bin', 'pkgver': '2.4.29-1ubuntu4.25', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'apache2-data', 'pkgver': '2.4.29-1ubuntu4.25', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'apache2-dev', 'pkgver': '2.4.29-1ubuntu4.25', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'apache2-ssl-dev', 'pkgver': '2.4.29-1ubuntu4.25', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'apache2-suexec-custom', 'pkgver': '2.4.29-1ubuntu4.25', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'apache2-suexec-pristine', 'pkgver': '2.4.29-1ubuntu4.25', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'apache2-utils', 'pkgver': '2.4.29-1ubuntu4.25', 'ubuntu_pro': FALSE}
];
