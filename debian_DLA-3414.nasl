...
# extracted from Debian Security Advisory dla-3414. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3414 : avahi-autoipd - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3414
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'avahi-autoipd', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'avahi-daemon', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'avahi-discover', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'avahi-dnsconfd', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'avahi-ui-utils', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'avahi-utils', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'gir1.2-avahi-0.6', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-client-dev', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-client3', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-common-data', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-common-dev', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-common3', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-compat-libdnssd-dev', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-compat-libdnssd1', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-core-dev', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-core7', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-glib-dev', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-glib1', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-gobject-dev', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-gobject0', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-ui-gtk3-0', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libavahi-ui-gtk3-dev', 'reference': '0.7-4+deb10u2'},
    {'release': '10.0', 'prefix': 'python-avahi', 'reference': '0.7-4+deb10u2'}
];
