...
# extracted from Red Hat Security Advisory RHSA-2022:0114. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-39241", "CVE-2021-40346");
  script_xref(name:"RHSA", value:"2022:0114");
  script_xref(name:"IAVB", value:"2021-B-0056");

  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.7.41 (RHSA-2022:0114)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.7.41.");
...
referenced in the RHSA-2022:0114 advisory.

    Red Hat OpenShift Container Platform is Red Hat's cloud computing
    Kubernetes application platform solution designed for on-premise or private
    cloud deployments.

    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.7.41. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0114.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?addcd56a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0114");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1995107");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2000599");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.7.41 package based on the guidance in RHSA-2022:0114.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy20-2.0.19-2.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'haproxy20-2.0.19-2.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'haproxy20-2.0.19-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'haproxy20-2.0.19-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'haproxy20');
}
