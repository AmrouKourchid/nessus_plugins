...
# extracted from Fedora Security Advisory FEDORA-2022-c30d362ce5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c30d362ce5");

  script_name(english:"Fedora 37 : woff (2022-c30d362ce5)");
...
FEDORA-2022-c30d362ce5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c30d362ce5");
...
var pkgs = [
    {'reference':'woff-0.20091126-35.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
