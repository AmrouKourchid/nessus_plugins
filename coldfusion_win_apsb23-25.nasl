...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2023-A-0142-S");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/09/11");
...
"Update to Adobe ColdFusion version 2018 Update 16 / 2021 Update 6 or later.");
  ...
  script_set_attribute(attribute:"metasploit_name", value:'Adobe ColdFusion Unauthenticated Remote Code Execution');
