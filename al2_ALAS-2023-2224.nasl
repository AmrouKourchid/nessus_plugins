...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2224.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : ca-certificates (ALAS-2023-2224)");
...
vulnerability as referenced in the ALAS2-2023-2224 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2224.html");
...
var pkgs = [
    {'reference':'ca-certificates-2021.2.50-72.amzn2.0.8', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
