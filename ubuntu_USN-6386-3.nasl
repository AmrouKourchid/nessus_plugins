...
# extracted from Ubuntu Security Notice USN-6386-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6386-3");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : Linux kernel vulnerabilities (USN-6386-3)");
...
referenced in the USN-6386-3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6386-3");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1040-intel-iotg");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1044-oracle");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6386-3');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6386-3');
  }
  else
  {
