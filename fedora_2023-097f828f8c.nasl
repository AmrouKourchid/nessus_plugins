...
# extracted from Fedora Security Advisory FEDORA-2023-097f828f8c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-097f828f8c");

  script_name(english:"Fedora 37 : java-latest-openjdk (2023-097f828f8c)");
...
FEDORA-2023-097f828f8c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-097f828f8c");
...
var pkgs = [
    {'reference':'java-latest-openjdk-19.0.2.0.7-1.rolling.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
