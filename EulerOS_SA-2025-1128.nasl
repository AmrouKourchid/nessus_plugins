...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : python-urllib3 (EulerOS-SA-2025-1128)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-urllib3 packages installed, the EulerOS installation on the remote host is
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1128
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f9a6486");
...
var pkgs = [
  "python2-urllib3-1.23-4.h8.eulerosv2r8",
  "python3-urllib3-1.23-4.h8.eulerosv2r8"
];
