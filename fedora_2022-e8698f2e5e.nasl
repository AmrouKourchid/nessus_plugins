...
# extracted from Fedora Security Advisory FEDORA-2022-e8698f2e5e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e8698f2e5e");

  script_name(english:"Fedora 36 : java-latest-openjdk (2022-e8698f2e5e)");
...
FEDORA-2022-e8698f2e5e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e8698f2e5e");
...
var pkgs = [
    {'reference':'java-latest-openjdk-19.0.1.0.10-2.rolling.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
