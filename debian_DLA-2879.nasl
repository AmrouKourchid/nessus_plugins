...
# extracted from Debian Security Advisory dla-2879. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2879-1 : ghostscript - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2879");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'ghostscript', 'reference': '9.26a~dfsg-0+deb9u8'},
    {'release': '9.0', 'prefix': 'ghostscript-dbg', 'reference': '9.26a~dfsg-0+deb9u8'},
    {'release': '9.0', 'prefix': 'ghostscript-doc', 'reference': '9.26a~dfsg-0+deb9u8'},
    {'release': '9.0', 'prefix': 'ghostscript-x', 'reference': '9.26a~dfsg-0+deb9u8'},
    {'release': '9.0', 'prefix': 'libgs-dev', 'reference': '9.26a~dfsg-0+deb9u8'},
    {'release': '9.0', 'prefix': 'libgs9', 'reference': '9.26a~dfsg-0+deb9u8'},
    {'release': '9.0', 'prefix': 'libgs9-common', 'reference': '9.26a~dfsg-0+deb9u8'}
];
