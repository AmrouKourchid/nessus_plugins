...
# extracted from Red Hat Security Advisory RHSA-2023:2258. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2258");

  script_name(english:"RHEL 9 : python-mako (RHSA-2023:2258)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2258.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c62df5c2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2258");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-mako package based on the guidance in RHSA-2023:2258.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-mako-1.1.4-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
