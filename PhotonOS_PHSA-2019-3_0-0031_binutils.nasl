...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-12934");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'binutils-2.32-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'binutils-debuginfo-2.32-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'binutils-devel-2.32-1.ph3')) flag++;
