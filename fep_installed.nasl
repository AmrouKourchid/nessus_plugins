...
var path = NULL;
var avsignatures = NULL;
var assignatures = NULL;
var engine_version = NULL;

var key = "SOFTWARE\Microsoft\Microsoft Antimalware";
...
var scep_ver = NULL;
var ukey, display_names, version_key, install_location_key, tmp_path;
...
var defender_install_count = get_install_count(app_name:'Windows Defender', exit_if_zero:FALSE);

var install, defender_path, defender_ver, defender_engine_version, defender_avsignatures, ver;
...
var signature_keys = make_list("SOFTWARE\Microsoft\Microsoft Antimalware",
...
var info = get_av_info("fep");
if (isnull(info)) exit(1, "Failed to get Forefront Endpoint Protection info from antivirus.inc.");
var latest_av_sigs = info["latest_av_sigs"];
var latest_as_sigs = info["latest_as_sigs"];
var latest_engine_version = info["latest_engine_version"];
