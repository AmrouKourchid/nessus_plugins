...
# extracted from Red Hat Security Advisory RHSA-2023:3725. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3725");

  script_name(english:"RHEL 9 : less (RHSA-2023:3725)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3725.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd8ea126");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2169621");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3725");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL less package based on the guidance in RHSA-2023:3725.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'less-590-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'less-590-2.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
