...
if (description)
{
  ...
  script_cve_id("CVE-2024-31584");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-31584");
...
patch available.
  ...
  - Pytorch before v2.2.0 has an Out-of-bounds Read vulnerability via the component
    torch/csrc/jit/mobile/flatbuffer_loader.cpp. (CVE-2024-31584)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-31584");
