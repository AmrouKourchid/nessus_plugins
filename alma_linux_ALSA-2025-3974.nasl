...
# AlmaLinux Security Advisory ALSA-2025:3974.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:3974");
  script_xref(name:"RHSA", value:"2025:3974");

  script_name(english:"AlmaLinux 8 : webkit2gtk3 (ALSA-2025:3974)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2025:3974 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2025-3974.html");
...
"Update the affected packages.");
  ...
  script_cwe_id(119, 120, 20, 200, 416, 79);
...
var pkgs = [
    {'reference':'webkit2gtk3-2.48.1-1.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-devel-2.48.1-1.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-2.48.1-1.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-devel-2.48.1-1.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
