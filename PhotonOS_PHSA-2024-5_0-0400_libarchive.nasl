...
# extracted from VMware Security Advisory PHSA-2024-5.0-0400. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libarchive PHSA-2024-5.0-0400");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libarchive package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-400.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libarchive-3.7.1-4.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libarchive-devel-3.7.1-4.ph5')) flag++;
