...
# Rocky Linux Security Advisory RLSA-2024:9423.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:9423");

  script_name(english:"RockyLinux 9 : python-dns (RLSA-2024:9423)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:9423");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2274520");
  script_set_attribute(attribute:"solution", value:
"Update the affected python3-dns package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:python3-dns");
...
var pkgs = [
    {'reference':'python3-dns-2.6.1-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
