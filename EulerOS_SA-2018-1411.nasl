...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.1 : openssh (EulerOS-SA-2018-1411)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1411
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?439494c3");
...
pkgs = ["openssh-6.6.1p1-25.4.h7",
        "openssh-clients-6.6.1p1-25.4.h7",
        "openssh-keycat-6.6.1p1-25.4.h7",
        "openssh-server-6.6.1p1-25.4.h7"];
