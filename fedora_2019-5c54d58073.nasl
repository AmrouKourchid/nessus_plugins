...
# extracted from Fedora Security Advisory FEDORA-2019-5c54d58073.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-5c54d58073");

  script_name(english:"Fedora 28 : webkit2gtk3 (2019-5c54d58073)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Update to 2.22.6; CVE-2019-6212, CVE-2019-6215

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5c54d58073");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"webkit2gtk3-2.22.6-1.fc28")) flag++;
