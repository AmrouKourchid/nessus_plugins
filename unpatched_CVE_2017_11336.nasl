...
if (description)
{
  ...
  script_cve_id("CVE-2017-11336");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-11336");
...
patch available.
  ...
  - There is a heap-based buffer over-read in the Image::printIFDStructure function in image.cpp in Exiv2
    0.26. A Crafted input will lead to a remote denial of service attack. (CVE-2017-11336)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-11336");
