...
# extracted from Fedora Security Advisory FEDORA-2025-c858874183
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-c858874183");

  script_name(english:"Fedora 41 : qt6-qtwebengine (2025-c858874183)");
...
FEDORA-2025-c858874183 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-c858874183");
...
var pkgs = [
    {'reference':'qt6-qtwebengine-6.8.2-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
