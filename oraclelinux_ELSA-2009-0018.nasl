...
# Oracle Linux Security Advisory ELSA-2009-0018 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : xterm (ELSA-2009-0018)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0018.html");
