...
# extracted from Red Hat Security Advisory RHSA-2024:0208. The text
...
referenced in the RHSA-2024:0208 advisory.
    ...
    * openssl: Generating excessively long X9.42 DH keys or checking excessively long X9.42 DH keys or
    parameters may be very slow (JIRA:RHEL-16536)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0208.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b9dc7dc");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0208");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openssl package based on the guidance in RHSA-2024:0208.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssl-1.1.1k-12.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-devel-1.1.1k-12.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-libs-1.1.1k-12.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-perl-1.1.1k-12.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
