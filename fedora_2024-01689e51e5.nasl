...
# extracted from Fedora Security Advisory FEDORA-2024-01689e51e5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-01689e51e5");

  script_name(english:"Fedora 39 : freerdp (2024-01689e51e5)");
...
FEDORA-2024-01689e51e5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-01689e51e5");
...
var pkgs = [
    {'reference':'freerdp-2.11.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
