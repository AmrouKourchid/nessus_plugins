...
# extracted from Red Hat Security Advisory RHSA-2025:0823. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0823");

  script_name(english:"RHEL 8 : traceroute (RHSA-2025:0823)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for traceroute.");
...
the RHSA-2025:0823 advisory.

    The traceroute utility displays the route used by IP packets on their way to a specified network (or
    Internet) host.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0823.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a6c3063");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0823");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL traceroute package based on the guidance in RHSA-2025:0823.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:traceroute");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'traceroute-2.1.0-8.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
  }
];
