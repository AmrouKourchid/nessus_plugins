...
if (description)
{
  ...
  script_cve_id("CVE-2021-47484");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47484");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: octeontx2-af: Fix possible null
    pointer dereference. This patch fixes possible null pointer dereference in files rvu_debugfs.c and
    rvu_nix.c (CVE-2021-47484)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47484");
