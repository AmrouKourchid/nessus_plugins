...
# extracted from Fedora Security Advisory FEDORA-2023-d525cf5272
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d525cf5272");

  script_name(english:"Fedora 36 : kernel (2023-d525cf5272)");
...
FEDORA-2023-d525cf5272 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d525cf5272");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-d525cf5272');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.2.9-100.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
