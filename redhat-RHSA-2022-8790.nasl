...
# extracted from Red Hat Security Advisory RHSA-2022:8790. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8790");

  script_name(english:"RHEL 7 : Red Hat JBoss Enterprise Application Platform 7.4.8 Security update (Low) (RHSA-2022:8790)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8790.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67194415");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8790");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2117506");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/JBEAP-23833");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-undertow-2.2.20-1.SP1_redhat_00001.1.el7eap', 'release':'7', 'el_string':'el7eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  }
];
