...
if (description)
{
  ...
  script_cve_id("CVE-2019-2632");

  script_name(english:"Photon OS 2.0: Mysql PHSA-2019-2.0-0160");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'mysql-5.7.26-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'mysql-debuginfo-5.7.26-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'mysql-devel-5.7.26-1.ph2')) flag++;
