...
if (description)
{
  ...
  script_name(english:"SUSE Linux Enterprise SEoL (12.5.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of SUSE Linux Enterprise is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, SUSE Linux Enterprise is 12.5.x. It is, therefore, no longer maintained by its vendor or
provider.
