...
# openSUSE Security Update openSUSE-SU-2021:1169-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : tor (openSUSE-SU-2021:1169-1)");
...
openSUSE-SU-2021:1169-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?46adaf60");
...
var pkgs = [
    {'reference':'tor-0.4.6.7-lp152.2.15.1', 'cpu':'x86_64', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
