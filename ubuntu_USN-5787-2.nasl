...
# extracted from Ubuntu Security Notice USN-5787-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5787-2");
  script_xref(name:"IAVA", value:"2023-A-0072");

  script_name(english:"Ubuntu 16.04 ESM : Libksba vulnerability (USN-5787-2)");
...
USN-5787-2 advisory.
    ...
    USN-5787-1 fixed vulnerabilities in Libksba. This update provides the corresponding updates for Ubuntu
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5787-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libksba-dev', 'pkgver': '1.3.3-1ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libksba8', 'pkgver': '1.3.3-1ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE}
];
