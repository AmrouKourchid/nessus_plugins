...
"The version of Firefox installed on the remote Windows host is prior to 131.0.3. It is, therefore, affected by a
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'131.0.3', severity:SECURITY_WARNING);
