...
# extracted from Red Hat Security Advisory RHSA-2018:2290. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2290");

  script_name(english:"RHEL 7 : memcached (RHSA-2018:2290)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_2290.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?02ae3169");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1555064");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2290");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL memcached package based on the guidance in RHSA-2018:2290.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'memcached-1.4.39-2.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
