...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : curl (EulerOS-SA-2024-1524)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1524
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7d8624b");
...
var pkgs = [
  "curl-7.71.1-4.h31.eulerosv2r10",
  "libcurl-7.71.1-4.h31.eulerosv2r10"
];
