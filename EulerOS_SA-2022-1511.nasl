...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : openjpeg2 (EulerOS-SA-2022-1511)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1511
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2574cd1b");
...
var pkgs = [
  "openjpeg2-2.3.1-5.h5.eulerosv2r10"
];
