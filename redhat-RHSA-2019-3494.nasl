...
referenced in the RHSA-2019:3494 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3494.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?31d74368");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1700877");
...
"Update the RHEL container-tools:1.0 package based on the guidance in RHSA-2019:3494.");
  ...
  'container-tools:1.0': [
    {
      ...
      'pkgs': [
        {'reference':'buildah-1.5-5.gite94b4f9.module+el8.1.0+4241+a7060183', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'container-selinux-2.94-1.git1e99f1d.module+el8.1.0+3468+011f0ab0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'containernetworking-plugins-0.7.4-3.git9ebe139.module+el8.1.0+3468+011f0ab0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'containers-common-0.1.32-5.git1715c90.module+el8.1.0+4241+a7060183', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'fuse-overlayfs-0.3-5.module+el8.1.0+3468+011f0ab0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'oci-systemd-hook-0.1.15-2.git2d0b8a3.module+el8.1.0+3468+011f0ab0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'oci-umount-2.3.4-2.git87f9237.module+el8.1.0+3468+011f0ab0', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-1.0.0-3.git921f98f.module+el8.1.0+4241+a7060183', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-docker-1.0.0-3.git921f98f.module+el8.1.0+4241+a7060183', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'runc-1.0.0-55.rc5.dev.git2abd837.module+el8.1.0+3468+011f0ab0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'skopeo-0.1.32-5.git1715c90.module+el8.1.0+4241+a7060183', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'slirp4netns-0.1-3.dev.gitc4e1bc5.module+el8.1.0+4308+9d868e48', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
