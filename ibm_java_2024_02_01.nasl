...
if (description)
{
  ...
  script_cve_id("CVE-2023-33850");

  script_name(english:"IBM Java 8.0 < 8.0.8.20");

  script_set_attribute(attribute:"synopsis", value:
"IBM Java is affected a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of IBM Java installed on the remote host is prior to 8.0 < 8.0.8.20. It is, therefore, affected by a
vulnerability as referenced in the IBM Security Update February 2024 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg1IJ49187");
  # https://www.ibm.com/support/pages/java-sdk-security-vulnerabilities#IBM_Security_Update_February_2024
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f1a8f44");
  script_set_attribute(attribute:"solution", value:
"Apply the appropriate patch according to the IBM Security Update February 2024 advisory.");
