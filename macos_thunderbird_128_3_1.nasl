...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 128.3.1");

  script_set_attribute(attribute:"synopsis", value:
"A mail client installed on the remote macOS or Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 128.3.1. It is, therefore,
...
"Upgrade to Mozilla Thunderbird version 128.3.1 or later.");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'128.3.1', min:'128.0.0', severity:SECURITY_HOLE);
