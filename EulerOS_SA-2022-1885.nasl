...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : compat-openldap (EulerOS-SA-2022-1885)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the compat-openldap package installed, the EulerOS installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1885
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b5f9310");
...
var pkgs = [
  "compat-openldap-2.3.43-5.h3.eulerosv2r7"
];
