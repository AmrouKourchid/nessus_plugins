...
# extracted from Red Hat Security Advisory RHSA-2023:7016. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7016");

  script_name(english:"RHEL 8 : libpq (RHSA-2023:7016)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libpq.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:7016 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7016.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e41c7948");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2165722");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7016");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libpq package based on the guidance in RHSA-2023:7016.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libpq-13.11-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libpq-devel-13.11-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
