...
if (description)
{
  ...
  script_name(english:"Debian dla-3216 : libvlc-bin - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3216
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libvlc-bin', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'libvlc-dev', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'libvlc5', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'libvlccore-dev', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'libvlccore9', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-bin', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-data', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-l10n', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-plugin-access-extra', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-plugin-base', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-plugin-fluidsynth', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-plugin-jack', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-plugin-notify', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-plugin-qt', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-plugin-samba', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-plugin-skins2', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-plugin-svg', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-plugin-video-output', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-plugin-video-splitter', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-plugin-visualization', 'reference': '3.0.17.4-0+deb10u2'},
    {'release': '10.0', 'prefix': 'vlc-plugin-zvbi', 'reference': '3.0.17.4-0+deb10u2'}
];
