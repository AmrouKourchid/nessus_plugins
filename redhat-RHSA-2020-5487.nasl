...
# extracted from Red Hat Security Advisory RHSA-2020:5487. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5487");

  script_name(english:"RHEL 8 : pacemaker (RHSA-2020:5487)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for pacemaker.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:5487 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5487.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c836960a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5487");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1888191");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pacemaker package based on the guidance in RHSA-2020:5487.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pacemaker-2.0.4-6.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pacemaker-cli-2.0.4-6.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pacemaker-cluster-libs-2.0.4-6.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pacemaker-cts-2.0.4-6.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pacemaker-doc-2.0.4-6.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pacemaker-libs-2.0.4-6.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pacemaker-libs-devel-2.0.4-6.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pacemaker-nagios-plugins-metadata-2.0.4-6.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pacemaker-remote-2.0.4-6.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pacemaker-schemas-2.0.4-6.el8_3.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
