...
"The version of Firefox installed on the remote macOS or Mac OS X host is prior to 78.0. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2020-24 advisory. Note that Nessus has not tested for this issue but
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:FALSE, fix:'78.0', severity:SECURITY_HOLE);
