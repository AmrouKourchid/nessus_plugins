...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002639");
  script_xref(name:"MSFT", value:"MS23-5002639");
  script_xref(name:"IAVA", value:"2024-A-0561-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (September 2024)");
...
security updates. It is, therefore, affected by multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002639");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002639 to address this issue.");
