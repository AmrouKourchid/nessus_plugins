...
if (description)
{
  ...
  script_name(english:"AIX (IJ36816)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ36816. It is, therefore, affected by a vulnerability
as referenced in the IJ36816 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ36816");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6538952");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ36816.");
...
var constraints = [
    {'release': '7.3', 'ml': '00', 'sp': '01', 'patch': 'IJ36816s1a', 'package': 'bos.rte.security', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.0'}
];
