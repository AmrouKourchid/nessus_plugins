...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : dpdk (EulerOS-SA-2021-1241)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1241
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ee63f4d");
...
pkgs = ["dpdk-18.11-0.h19.eulerosv2r7",
        "dpdk-devel-18.11-0.h19.eulerosv2r7"];
