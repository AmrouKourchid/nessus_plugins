...
if (description)
{
  ...
  script_name(english:"CentOS 9 : wireshark-3.4.10-4.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for wireshark.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
wireshark-3.4.10-4.el9 build changelog.

  - f5ethtrailer Infinite loop in legacy style dissector (CVE-2022-3190)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=29671");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream wireshark package.");
