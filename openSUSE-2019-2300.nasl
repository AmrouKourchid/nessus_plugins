...
# extracted from openSUSE Security Update openSUSE-2019-2300.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : sqlite3 (openSUSE-2019-2300)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1150137");
...
if ( rpm_check(release:"SUSE15.1", reference:"libsqlite3-0-3.28.0-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libsqlite3-0-debuginfo-3.28.0-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"sqlite3-3.28.0-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"sqlite3-debuginfo-3.28.0-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"sqlite3-debugsource-3.28.0-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"sqlite3-devel-3.28.0-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libsqlite3-0-32bit-3.28.0-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libsqlite3-0-32bit-debuginfo-3.28.0-lp151.2.3.1") ) flag++;
