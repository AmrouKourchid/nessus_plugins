...
# extracted from Debian Security Advisory dla-3770. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3770 : libnet-cidr-lite-perl - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3770
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c295f038");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-47154");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/libnet-cidr-lite-perl");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libnet-cidr-lite-perl packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libnet-cidr-lite-perl");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libnet-cidr-lite-perl', 'reference': '0.21-2+debu10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libnet-cidr-lite-perl');
}
