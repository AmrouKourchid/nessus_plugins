...
# extracted from Red Hat Security Advisory RHSA-2021:0221 and
# CentOS Errata and Security Advisory 2021:0221 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : sudo (RHSA-2021:0221)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2021:0221 advisory.
...
var pkgs = [
    {'reference':'sudo-1.8.23-10.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.8.23-10.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.23-10.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.23-10.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
