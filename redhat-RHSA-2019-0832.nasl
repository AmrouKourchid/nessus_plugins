...
# extracted from Red Hat Security Advisory RHSA-2019:0832. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0832");

  script_name(english:"RHEL 6 : polkit (RHSA-2019:0832)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for polkit.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:0832 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0832.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf7b18be");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0832");
...
"Update the RHEL polkit package based on the guidance in RHSA-2019:0832.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'polkit-0.96-7.el6_6.1', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-0.96-7.el6_6.1', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-desktop-policy-0.96-7.el6_6.1', 'sp':'6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.96-7.el6_6.1', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-devel-0.96-7.el6_6.1', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-docs-0.96-7.el6_6.1', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
