...
# extracted from Red Hat Security Advisory RHSA-2025:0689. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0689");

  script_name(english:"RHEL 8 : redis:6 (RHSA-2025:0689)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for redis:6.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:0689 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0689.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c31b12f8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0689");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis:6 package based on the guidance in RHSA-2025:0689.");
  ...
  'redis:6': [
    {
      ...
      'pkgs': [
        {'reference':'redis-6.0.9-5.module+el8.6.0+22735+5bedcf81.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-6.0.9-5.module+el8.6.0+22735+5bedcf81.1', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-6.0.9-5.module+el8.6.0+22735+5bedcf81.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-6.0.9-5.module+el8.6.0+22735+5bedcf81.1', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-doc-6.0.9-5.module+el8.6.0+22735+5bedcf81.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
