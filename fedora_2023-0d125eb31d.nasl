...
# extracted from Fedora Security Advisory FEDORA-2023-0d125eb31d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0d125eb31d");

  script_name(english:"Fedora 40 : python3.9 (2023-0d125eb31d)");
...
FEDORA-2023-0d125eb31d advisory.

    Automatic update for python3.9-3.9.18-3.fc40.

    ##### **Changelog**

    ```
    * Mon Dec 18 2023 Lumr Balhar <lbalhar@redhat.com> - 3.9.18-3
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0d125eb31d");
...
var pkgs = [
    {'reference':'python3.9-3.9.18-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
