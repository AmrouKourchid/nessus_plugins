...
# extracted from Fedora Security Advisory FEDORA-2024-5f84678c08
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5f84678c08");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/06/03");

  script_name(english:"Fedora 40 : chromium (2024-5f84678c08)");
...
FEDORA-2024-5f84678c08 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5f84678c08");
...
var pkgs = [
    {'reference':'chromium-124.0.6367.201-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
