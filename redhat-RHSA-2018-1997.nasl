...
the RHSA-2018:1997 advisory.
    ...
    * Previously, the virtlogd service logged redundant AVC denial errors when a guest virtual machine was
    started. With this update, the virtlogd service no longer attempts to send shutdown inhibition calls to
    systemd, which prevents the described errors from occurring. (BZ#1573268)

    * Prior to this update, guest virtual machine actions that use a python library in some cases failed and
    Hash operation not allowed during iteration error messages were logged. Several redundant thread access
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1997.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2b165b3");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1573268");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1581364");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1582418");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libvirt package based on the guidance in RHSA-2018:1997.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvirt-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-admin-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-config-network-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-config-nwfilter-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-interface-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-lxc-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-network-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-nodedev-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-nwfilter-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-qemu-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-secret-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-core-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-disk-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-gluster-3.9.0-14.el7_5.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-iscsi-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-logical-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-mpath-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-rbd-3.9.0-14.el7_5.6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-driver-storage-scsi-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-kvm-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-daemon-lxc-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-docs-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-libs-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-lock-sanlock-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-login-shell-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-nss-3.9.0-14.el7_5.6', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
