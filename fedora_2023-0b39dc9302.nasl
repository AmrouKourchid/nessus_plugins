...
# extracted from Fedora Security Advisory FEDORA-2023-0b39dc9302
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0b39dc9302");

  script_name(english:"Fedora 39 : chromium (2023-0b39dc9302)");
...
FEDORA-2023-0b39dc9302 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0b39dc9302");
...
var pkgs = [
    {'reference':'chromium-118.0.5993.117-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
