...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : net-snmp (EulerOS-SA-2020-2370)");
...
vulnerabilities :
  ...
  - net-snmp before 5.8.1.pre1 has a double free in
    ...
    SNMPv3 GetBulk request.(CVE-2019-20892)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2370
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9877df60");
...
pkgs = ["net-snmp-5.7.2-24.1.h5",
        "net-snmp-agent-libs-5.7.2-24.1.h5",
        "net-snmp-devel-5.7.2-24.1.h5",
        "net-snmp-libs-5.7.2-24.1.h5",
        "net-snmp-utils-5.7.2-24.1.h5"];
