...
if (description)
{
  ...
  script_name(english:"Wireshark 3.4.x < 3.4.12 A Vulnerability (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote macOS / Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote macOS / Mac OS X host is prior to 3.4.12. It is, therefore, affected by
a vulnerability as referenced in the wireshark-3.4.12 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/docs/relnotes/wireshark-3.4.12.html");
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/security/wnpa-sec-2021-22");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Wireshark version 3.4.12 or later.");
...
var constraints = [
  { 'min_version' : '3.4.0', 'max_version' : '3.4.11', 'fixed_version' : '3.4.12' }
];
