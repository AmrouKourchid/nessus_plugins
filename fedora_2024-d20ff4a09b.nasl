...
# extracted from Fedora Security Advisory FEDORA-2024-d20ff4a09b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d20ff4a09b");

  script_name(english:"Fedora 40 : rust-routinator (2024-d20ff4a09b)");
...
FEDORA-2024-d20ff4a09b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d20ff4a09b");
...
var pkgs = [
    {'reference':'rust-routinator-0.13.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
