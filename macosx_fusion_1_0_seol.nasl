...
if (description)
{
  ...
  script_name(english:"VMware Fusion SEoL (1.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of VMware Fusion is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, VMware Fusion is 1.0.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of VMware Fusion that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2010/03/12");
