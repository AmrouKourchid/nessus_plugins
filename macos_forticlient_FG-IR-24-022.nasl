...
if (description)
{
  ...
  script_cve_id("CVE-2024-40592");

  script_name(english:"Fortinet FortiClient - Missing signature verification (FG-IR-24-022) (macOS)");
...
vulnerability as referenced in the FG-IR-24-022 advisory.

  - An improper verification of cryptographic signature vulnerability [CWE-347] in FortiClient MacOS version
    7.4.0, version 7.2.4 and below, version 7.0.10 and below, version 6.4.10 and below may allow a local
    authenticated attacker to swap the installer with a malicious package via a race condition during the
    installation process. (CVE-2024-40592)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-24-022");
  script_set_attribute(attribute:"solution", value:
"Upgrade to FortiClient version 6.4.999999 / 7.0.999999 / 7.2.5 / 7.4.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:H/PR:L/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-40592");
...
var constraints = [
  ...
  { 'min_version' : '7.0.0', 'max_version' : '7.0.10', 'fixed_version' : '7.0.999999', 'fixed_display' : 'See vendor advisory' },
