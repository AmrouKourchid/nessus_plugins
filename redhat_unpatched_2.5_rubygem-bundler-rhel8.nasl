...
# extracted from Red Hat Security Advisory 2.5_rubygem-bundler. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : 2.5_rubygem-bundler (Unpatched Vulnerability) (deprecated)");
