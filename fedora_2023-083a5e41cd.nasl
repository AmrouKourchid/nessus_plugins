...
# extracted from Fedora Security Advisory FEDORA-2023-083a5e41cd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-083a5e41cd");

  script_name(english:"Fedora 37 : firefox (2023-083a5e41cd)");
...
FEDORA-2023-083a5e41cd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-083a5e41cd");
...
var pkgs = [
    {'reference':'firefox-120.0.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
