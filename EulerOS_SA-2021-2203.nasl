...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : cups (EulerOS-SA-2021-2203)");
...
following vulnerability :
  ...
  - A Incorrect Default Permissions vulnerability in the
    ...
    2.2.7. SUSE OpenStack(CVE-2021-25317)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2203
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8fe60b1");
...
pkgs = ["cups-libs-2.2.13-3.h2.eulerosv2r9"];
