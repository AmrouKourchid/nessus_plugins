...
# extracted from Fedora Security Advisory FEDORA-2019-a6960910d8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : mingw-gdal (2019-a6960910d8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a6960910d8");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-gdal package.");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"mingw-gdal-2.3.2-7.fc30")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "mingw-gdal");
}
