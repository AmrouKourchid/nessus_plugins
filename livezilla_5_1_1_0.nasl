...
by multiple vulnerabilities :
  ...
  - The application is affected by a local file inclusion
    ...
    (CVE-2013-6225)");
  script_set_attribute(attribute:"see_also", value:"https://curesec.com/data/advisories/Curesec-2013-1006.pdf");
  script_set_attribute(attribute:"see_also", value:"https://curesec.com/data/advisories/Curesec-2013-1007.pdf");
  script_set_attribute(attribute:"see_also", value:"https://curesec.com/data/advisories/Curesec-2013-1008.pdf");
...
"Upgrade to LiveZilla version 5.1.1.0 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:ND");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-7002");
