...
# extracted from Fedora Security Advisory FEDORA-2020-7ab62c73bc.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : curl (2020-7ab62c73bc)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7ab62c73bc");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"curl-7.69.1-7.fc32")) flag++;
