...
# SUSE update advisory SUSE-SU-2022:4573-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4573-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (SUSE-SU-2022:4573-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 / SLES_SAP15 host has packages installed that are affected by multiple vulnerabilities as
referenced in the SUSE-SU-2022:4573-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013280.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?90119685");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-33981");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-4_12_14-150000_150_109-default");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-150000.150.109-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150000_150_109-default-1-150000.1.5.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15']},
          {'reference':'kernel-livepatch-4_12_14-150000_150_109-default-1-150000.1.5.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15', 'sle-module-live-patching-release-15', 'sles-release-15']}
        ]
      }
    }
  }
