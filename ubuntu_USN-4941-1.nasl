...
vulnerabilities as referenced in the USN-4941-1 advisory.

    It was discovered that Exiv2 incorrectly handled certain images. An attacker could possibly use this issue
    to execute arbitrary code or cause a crash. (CVE-2021-29457)

    It was discovered that Exiv2 incorrectly handled certain images. An attacker could possibly use this issue
    to cause a denial of service. (CVE-2021-29458, CVE-2021-29470)

    It was discovered that Exiv2 incorrectly handled certain images. An attacker could possibly use this issue
    to execute arbitrary code or cause a crash. (CVE-2021-3482)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'exiv2', 'pkgver': '0.25-2.1ubuntu16.04.7+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libexiv2-14', 'pkgver': '0.25-2.1ubuntu16.04.7+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libexiv2-dev', 'pkgver': '0.25-2.1ubuntu16.04.7+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'exiv2', 'pkgver': '0.25-3.1ubuntu0.18.04.7', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'libexiv2-14', 'pkgver': '0.25-3.1ubuntu0.18.04.7', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'libexiv2-dev', 'pkgver': '0.25-3.1ubuntu0.18.04.7', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'exiv2', 'pkgver': '0.27.2-8ubuntu2.2', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libexiv2-27', 'pkgver': '0.27.2-8ubuntu2.2', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libexiv2-dev', 'pkgver': '0.27.2-8ubuntu2.2', 'ubuntu_pro': FALSE}
];
