...
# @DEPRECATED@
#
# Disabled on 2024/10/24. Deprecated by macosx_google_chrome_87_0_4280_67.nasl.
##
...
if (description)
{
  ...
  script_name(english:"Google Chrome < 87.0.4280.66 Multiple Vulnerabilities (deprecated)");

  script_set_attribute(attribute:"synopsis", value:
"This plugin has been deprecated.");
  script_set_attribute(attribute:"description", value:
"This plugin has been deprecated as it references the fixed version of Chrome for Windows and Linux,
which differs from the version that fixes the vulnerability for MacOS.
It has been replaced by macosx_google_chrome_87_0_4280_67.nasl.");
...
exit(0, 'This plugin has been deprecated. Use macosx_google_chrome_87_0_4280_67.nasl (plugin ID 209562) instead.');
