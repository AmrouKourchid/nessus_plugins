...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Haproxy PHSA-2019-3.0-0010");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'haproxy-1.8.14-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'haproxy-debuginfo-1.8.14-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'haproxy-doc-1.8.14-3.ph3')) flag++;
