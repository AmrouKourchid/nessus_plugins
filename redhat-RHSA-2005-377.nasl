...
if (description)
{
  ...
  script_name(english:"RHEL 4 : sharutils (RHSA-2005:377)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for sharutils.");
...
referenced in the RHSA-2005:377 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_377.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e5b382a8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=152571");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=152573");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=154049");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:377");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sharutils package based on the guidance in RHSA-2005:377.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2004-1773");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2004-1772");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sharutils-4.2.1-22.2', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sharutils-4.2.1-22.2', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sharutils-4.2.1-22.2', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sharutils-4.2.1-22.2', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sharutils-4.2.1-22.2', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
