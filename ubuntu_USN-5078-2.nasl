...
# extracted from Ubuntu Security Notice USN-5078-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5078-2");

  script_name(english:"Ubuntu 16.04 ESM : Squashfs-Tools vulnerabilities (USN-5078-2)");
...
the USN-5078-2 advisory.

    USN-5078-1 fixed several vulnerabilities in Squashfs-Tools. This update provides the corresponding update
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5078-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'squashfs-tools', 'pkgver': '1:4.3-3ubuntu2.16.04.3+esm1', 'ubuntu_pro': TRUE}
];
