...
# extracted from Red Hat Security Advisory RHSA-2024:2033. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2033");

  script_name(english:"RHEL 9 : libreswan (RHSA-2024:2033)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2033.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?803f26a8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268952");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2033");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libreswan package based on the guidance in RHSA-2024:2033.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.12-1.el9_3.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
