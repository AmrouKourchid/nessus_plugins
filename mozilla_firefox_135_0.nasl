...
"The version of Firefox installed on the remote Windows host is prior to 135.0. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2025-07 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'135.0', severity:SECURITY_HOLE);
