...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-1008.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : patch (ALAS-2018-1008)");
...
time.(CVE-2018-1000156)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-1008.html");
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"patch-2.7.1-10.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"patch-debuginfo-2.7.1-10.amzn2")) flag++;
