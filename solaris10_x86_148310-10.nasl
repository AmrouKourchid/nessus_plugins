...
if (description)
{
  ...
  script_summary(english:"Check for patch 148310-10");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 148310-10"
  );
  script_set_attribute(
...
can result in takeover of Oracle Solaris."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/148310-10"
  );
  script_set_attribute(attribute:"solution", value:"Install patch 148310-10 or higher");
