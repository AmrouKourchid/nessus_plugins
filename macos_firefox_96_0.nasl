...
"The version of Firefox installed on the remote macOS or Mac OS X host is prior to 96.0. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2022-01 advisory.
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:FALSE, fix:'96.0', severity:SECURITY_HOLE);
