...
# AlmaLinux Security Advisory ALSA-2025:1372.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:1372");
  script_xref(name:"RHSA", value:"2025:1372");

  script_name(english:"AlmaLinux 8 : container-tools:rhel8 (ALSA-2025:1372)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2025:1372 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2025-1372.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1372");
...
var pkgs = [
    ...
    {'reference':'buildah-1.33.12-1.module_el8.10.0+3959+b8dc5e6a', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-1.33.12-1.module_el8.10.0+3959+b8dc5e6a', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-1.33.12-1.module_el8.10.0+3959+b8dc5e6a', 'cpu':'s390x', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-1.33.12-1.module_el8.10.0+3959+b8dc5e6a', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-tests-1.33.12-1.module_el8.10.0+3959+b8dc5e6a', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-tests-1.33.12-1.module_el8.10.0+3959+b8dc5e6a', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-tests-1.33.12-1.module_el8.10.0+3959+b8dc5e6a', 'cpu':'s390x', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'buildah-tests-1.33.12-1.module_el8.10.0+3959+b8dc5e6a', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    ...
    {'reference':'criu-3.18-5.module_el8.10.0+3876+e55593a8', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'criu-3.18-5.module_el8.10.0+3876+e55593a8', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'criu-3.18-5.module_el8.10.0+3876+e55593a8', 'cpu':'s390x', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'criu-3.18-5.module_el8.10.0+3876+e55593a8', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'criu-devel-3.18-5.module_el8.10.0+3858+6ad51f9f', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'criu-devel-3.18-5.module_el8.10.0+3858+6ad51f9f', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'criu-devel-3.18-5.module_el8.10.0+3858+6ad51f9f', 'cpu':'s390x', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'criu-devel-3.18-5.module_el8.10.0+3858+6ad51f9f', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    ...
    {'reference':'libslirp-devel-4.4.0-2.module_el8.10.0+3876+e55593a8', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libslirp-devel-4.4.0-2.module_el8.10.0+3876+e55593a8', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libslirp-devel-4.4.0-2.module_el8.10.0+3876+e55593a8', 'cpu':'s390x', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libslirp-devel-4.4.0-2.module_el8.10.0+3876+e55593a8', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    ...
    {'reference':'podman-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'s390x', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-catatonit-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-catatonit-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-catatonit-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'s390x', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-catatonit-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-docker-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-gvproxy-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-gvproxy-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-gvproxy-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'s390x', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-gvproxy-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-plugins-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-plugins-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-plugins-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'s390x', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-plugins-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-remote-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-remote-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-remote-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'s390x', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-remote-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-tests-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-tests-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-tests-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'s390x', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'podman-tests-4.9.4-19.module_el8.10.0+3959+b8dc5e6a', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    ...
    {'reference':'python3-podman-4.9.0-3.module_el8.10.0+3926+f12484f5', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'runc-1.1.12-6.module_el8.10.0+3959+b8dc5e6a', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'runc-1.1.12-6.module_el8.10.0+3959+b8dc5e6a', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'runc-1.1.12-6.module_el8.10.0+3959+b8dc5e6a', 'cpu':'s390x', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'runc-1.1.12-6.module_el8.10.0+3959+b8dc5e6a', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    ...
    {'reference':'udica-0.2.6-21.module_el8.10.0+3926+f12484f5', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
