...
# extracted from Fedora Security Advisory FEDORA-2023-0c354a3f9a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0c354a3f9a");

  script_name(english:"Fedora 36 : pack (2023-0c354a3f9a)");
...
FEDORA-2023-0c354a3f9a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0c354a3f9a");
...
var pkgs = [
    {'reference':'pack-0.29.0~rc1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
