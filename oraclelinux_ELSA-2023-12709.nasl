...
# extracted from Oracle Linux Security Advisory ELSA-2023-12709.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python-werkzeug (ELSA-2023-12709)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-12709.html");
...
"Update the affected python3-werkzeug package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python3-werkzeug");
...
var pkgs = [
    {'reference':'python3-werkzeug-0.12.2-4.0.1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
