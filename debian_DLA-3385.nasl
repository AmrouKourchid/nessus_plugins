...
if (description)
{
  ...
  script_name(english:"Debian dla-3385 : trafficserver - security update");
...
dla-3385 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3385-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Markus Koschany
    April 05, 2023                                https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : trafficserver
    Version        : 8.1.6+ds-1~deb10u1
    CVE ID         : CVE-2022-31778 CVE-2022-31779 CVE-2022-32749 CVE-2022-37392
