...
# extracted from Red Hat Security Advisory RHSA-2023:5837. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5837");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");
  script_xref(name:"IAVB", value:"2023-B-0083-S");

  script_name(english:"RHEL 8 : nghttp2 (RHSA-2023:5837)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for nghttp2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:5837 advisory.

    nghttp2 contains the Hypertext Transfer Protocol version 2 (HTTP/2) client, server, and proxy programs as
    well as a library implementing the HTTP/2 protocol in C.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5837.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ed027b1");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5837");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nghttp2 package based on the guidance in RHSA-2023:5837.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libnghttp2-1.33.0-5.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnghttp2-devel-1.33.0-5.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nghttp2-1.33.0-5.el8_8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libnghttp2-1.33.0-5.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnghttp2-devel-1.33.0-5.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nghttp2-1.33.0-5.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
