...
if (description)
{
  ...
  script_name(english:"CentOS 9 : nodejs-nodemon-2.0.19-1.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for nodejs-nodemon.");
...
nodejs-nodemon-2.0.19-1.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=24880");
...
var pkgs = [
    {'reference':'nodejs-nodemon-2.0.19-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
