...
# extracted from Gentoo Linux Security Advisory GLSA 201908-22.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201908-22");

  script_name(english:"GLSA-201908-22 : Patch: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201908-22
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201908-22");
...
if (qpkg_check(package:"sys-devel/patch", unaffected:make_list("ge 2.7.6-r4"), vulnerable:make_list("lt 2.7.6-r4"))) flag++;
