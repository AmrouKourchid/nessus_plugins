...
# extracted from Fedora Security Advisory FEDORA-2023-8aa264d5c5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8aa264d5c5");

  script_name(english:"Fedora 36 : mod_security (2023-8aa264d5c5)");
...
FEDORA-2023-8aa264d5c5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8aa264d5c5");
...
var pkgs = [
    {'reference':'mod_security-2.9.7-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
