...
if (description)
{
  ...
  script_cve_id("CVE-2022-49693");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49693");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/msm/mdp4: Fix refcount leak in
    mdp4_modeset_init_intf of_graph_get_remote_node() returns remote device node pointer with refcount
    incremented, we should use of_node_put() on it when not need anymore. Add missing of_node_put() to avoid
    refcount leak. Patchwork: https://patchwork.freedesktop.org/patch/488473/ (CVE-2022-49693)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49693");
