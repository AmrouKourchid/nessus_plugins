...
if (description)
{
  ...
  script_name(english:"Atlassian Jira Service Management Data Center and Server 5.12.x < 5.12.15 / 5.17.x < 5.17.5 / 10.3.x < 10.3.1 (JSDSERVER-15988)");
...
is affected by a vulnerability as referenced in the JSDSERVER-15988 advisory.

  - Schema parsing in the Java SDK of Apache Avro 1.11.3 and previous versions allows bad actors to execute
    arbitrary code. Users are recommended to upgrade to version 1.11.4 or 1.12.0, which fix this issue.
    (CVE-2024-47561)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/JSDSERVER-15988");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Atlassian Jira Service Management Data Center and Server version 5.12.15, 5.17.5, 10.3.1 or later.");
...
var constraints = [
  ...
  { 'min_version' : '5.17.0', 'fixed_version' : '5.17.5' },
