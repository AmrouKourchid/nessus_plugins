...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5058403");
  script_xref(name:"MSFT", value:"MS25-5058403");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/06/03");

  script_name(english:"KB5058403: Windows Server 2012 R2 Security Update (May 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5058403. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5058403");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5058403");
