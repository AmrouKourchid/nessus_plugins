...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : bind (EulerOS-SA-2020-2329)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2329
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?88401205");
...
pkgs = ["bind-9.9.4-61.1.h9",
        "bind-chroot-9.9.4-61.1.h9",
        "bind-libs-9.9.4-61.1.h9",
        "bind-libs-lite-9.9.4-61.1.h9",
        "bind-license-9.9.4-61.1.h9",
        "bind-pkcs11-9.9.4-61.1.h9",
        "bind-pkcs11-libs-9.9.4-61.1.h9",
        "bind-pkcs11-utils-9.9.4-61.1.h9",
        "bind-utils-9.9.4-61.1.h9"];
