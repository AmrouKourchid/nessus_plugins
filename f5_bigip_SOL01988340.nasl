...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : HTTP/2 Reset Flood vulnerability (K01988340)");
...
another system in the device group.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K01988340");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K01988340.");
