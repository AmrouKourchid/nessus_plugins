...
# extracted from Debian Security Advisory dsa-5665. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5665 : libtomcat10-embed-java - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-46589");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'libtomcat10-embed-java', 'reference': '10.1.6-1+deb12u2'},
    {'release': '12.0', 'prefix': 'libtomcat10-java', 'reference': '10.1.6-1+deb12u2'},
    {'release': '12.0', 'prefix': 'tomcat10', 'reference': '10.1.6-1+deb12u2'},
    {'release': '12.0', 'prefix': 'tomcat10-admin', 'reference': '10.1.6-1+deb12u2'},
    {'release': '12.0', 'prefix': 'tomcat10-common', 'reference': '10.1.6-1+deb12u2'},
    {'release': '12.0', 'prefix': 'tomcat10-docs', 'reference': '10.1.6-1+deb12u2'},
    {'release': '12.0', 'prefix': 'tomcat10-examples', 'reference': '10.1.6-1+deb12u2'},
    {'release': '12.0', 'prefix': 'tomcat10-user', 'reference': '10.1.6-1+deb12u2'}
];
