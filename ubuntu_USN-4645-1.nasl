...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Mutt vulnerability (USN-4645-1)");
...
referenced in the USN-4645-1 advisory.

    It was discovered that Mutt incorrectly handled certain connections. An attacker could possibly use this
