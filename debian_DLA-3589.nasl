...
# extracted from Debian Security Advisory dla-3589. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3589 : python-git - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3589
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'python-git', 'reference': '2.1.11-1+deb10u2'},
    {'release': '10.0', 'prefix': 'python-git-doc', 'reference': '2.1.11-1+deb10u2'},
    {'release': '10.0', 'prefix': 'python3-git', 'reference': '2.1.11-1+deb10u2'}
];
