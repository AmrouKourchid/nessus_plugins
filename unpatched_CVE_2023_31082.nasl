...
if (description)
{
  ...
  script_cve_id("CVE-2023-31082");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-31082");
...
patch available.
  ...
  - An issue was discovered in drivers/tty/n_gsm.c in the Linux kernel 6.2. There is a sleeping function
    called from an invalid context in gsmld_write, which will block the kernel. Note: This has been disputed
    by 3rd parties as not a valid vulnerability. (CVE-2023-31082)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-31082");
