...
if (description)
{
  ...
  script_name(english:"macOS and Mac OS X Multiple Vulnerabilities (Security Update 2018-006)");
  script_summary(english:"Checks for the presence of Security Update 2018-006.");
...
"Install Security Update 2018-006 or later for 10.12.x.");
