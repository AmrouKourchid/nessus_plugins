...
# extracted from Fedora Security Advisory FEDORA-2023-30c3ca07eb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-30c3ca07eb");
  script_xref(name:"IAVA", value:"2023-A-0434");

  script_name(english:"Fedora 38 : procps-ng (2023-30c3ca07eb)");
...
FEDORA-2023-30c3ca07eb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-30c3ca07eb");
...
"Update the affected procps-ng package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:procps-ng");
...
var pkgs = [
    {'reference':'procps-ng-3.3.17-11.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
