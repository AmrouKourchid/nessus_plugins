...
# extracted from Red Hat Security Advisory RHSA-2024:2119. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2119");

  script_name(english:"RHEL 9 : Image builder components (RHSA-2024:2119)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Image builder components.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2119.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3602137a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2119");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268513");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-1035");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Image builder components package based on the guidance in RHSA-2024:2119.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'osbuild-composer-101-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-core-101-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-worker-101-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
