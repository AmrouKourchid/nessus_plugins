...
# extracted from Fedora Security Advisory FEDORA-2024-8c218846ee
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8c218846ee");

  script_name(english:"Fedora 40 : golang-github-nvidia-container-toolkit (2024-8c218846ee)");
...
FEDORA-2024-8c218846ee advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8c218846ee");
...
var pkgs = [
    {'reference':'golang-github-nvidia-container-toolkit-1.16.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
