...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.0.0.RC1 < 8.0.52");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 8.0.52. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_8.0.52_security-8 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb2a802e");
  script_set_attribute(attribute:"see_also", value:"https://svn.apache.org/viewvc?view=rev&rev=1830375");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 8.0.52 or later.");
...
var constraints = [
  { 'min_version' : '8.0.0.RC1', 'max_version' : '8.0.51', 'fixed_version' : '8.0.52' }
];
