...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openwsman on SL7.x x86_64 (20190326)");
...
"Security Fix(es) :
  ...
  - openwsman: Disclosure of arbitrary files outside of the
    registered URIs (CVE-2019-3816)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1903&L=SCIENTIFIC-LINUX-ERRATA&P=13854
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6bcd2c01");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libwsman-devel-2.6.3-6.git4391e5c.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libwsman1-2.6.3-6.git4391e5c.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openwsman-client-2.6.3-6.git4391e5c.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openwsman-debuginfo-2.6.3-6.git4391e5c.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openwsman-perl-2.6.3-6.git4391e5c.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openwsman-python-2.6.3-6.git4391e5c.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openwsman-ruby-2.6.3-6.git4391e5c.el7_6")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openwsman-server-2.6.3-6.git4391e5c.el7_6")) flag++;
