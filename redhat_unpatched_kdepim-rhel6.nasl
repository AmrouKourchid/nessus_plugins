...
# extracted from Red Hat Security Advisory kdepim. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2014-8878", "CVE-2017-9604", "CVE-2017-17689");

  script_name(english:"RHEL 6 : kdepim (Unpatched Vulnerability) (deprecated)");
