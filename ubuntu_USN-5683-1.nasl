...
# extracted from Ubuntu Security Notice USN-5683-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5683-1");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (IBM) vulnerabilities (USN-5683-1)");
...
the USN-5683-1 advisory.
    ...
    Selim Enes Karaduman discovered that a race condition existed in the General notification queue
    implementation of the Linux kernel, leading to a use-after-free vulnerability. A local attacker could use
    this to cause a denial of service (system crash) or possibly execute arbitrary code. (CVE-2022-1882)
    ...
    Pawan Kumar Gupta, Alyssa Milburn, Amit Peled, Shani Rehana, Nir Shildan and Ariel Sabba discovered that
    some Intel processors with Enhanced Indirect Branch Restricted Speculation (eIBRS) did not properly handle
    RET instructions after a VM exits. A local attacker could potentially use this to expose sensitive
    information. (CVE-2022-26373)

    Eric Biggers discovered that a use-after-free vulnerability existed in the io_uring subsystem in the Linux
    kernel. A local attacker could possibly use this to cause a denial of service (system crash) or possibly
    execute arbitrary code. (CVE-2022-3176)
    ...
    Jann Horn discovered that the KVM subsystem in the Linux kernel did not properly handle TLB flush
    operations in some situations. A local attacker in a guest VM could use this to cause a denial of service
    (guest crash) or possibly execute arbitrary code in the guest kernel. (CVE-2022-39189)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5683-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1015-ibm");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5683-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-33655', 'CVE-2022-1882', 'CVE-2022-2318', 'CVE-2022-3176', 'CVE-2022-26365', 'CVE-2022-26373', 'CVE-2022-33740', 'CVE-2022-33741', 'CVE-2022-33742', 'CVE-2022-33743', 'CVE-2022-33744', 'CVE-2022-34494', 'CVE-2022-34495', 'CVE-2022-36879', 'CVE-2022-36946', 'CVE-2022-39189');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5683-1');
  }
  else
  {
