...
# extracted from Red Hat Security Advisory RHSA-2024:1800. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1800");

  script_name(english:"RHEL 9 : bind and bind-dyndb-ldap security updates (Important) (RHSA-2024:1800)");
...
referenced in the RHSA-2024:1800 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1800.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?07d61ca6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1800");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bind-9.16.23-1.el9_0.5', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-chroot-9.16.23-1.el9_0.5', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-devel-9.16.23-1.el9_0.5', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-dnssec-doc-9.16.23-1.el9_0.5', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-dnssec-utils-9.16.23-1.el9_0.5', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-libs-9.16.23-1.el9_0.5', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-license-9.16.23-1.el9_0.5', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'bind-utils-9.16.23-1.el9_0.5', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
      {'reference':'python3-bind-9.16.23-1.el9_0.5', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'bind-dyndb-ldap-11.9-7.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
