...
# extracted from Fedora Security Advisory FEDORA-2019-9f28451404.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : ghostscript (2019-9f28451404)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-9f28451404");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"ghostscript-9.26-4.fc28")) flag++;
