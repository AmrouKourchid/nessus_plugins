...
"The version of Adobe Bridge installed on the remote macOS or Mac OS X host is prior to 11.1.2. It is, therefore,
affected by multiple vulnerabilities as referenced in the apsb21-94 advisory.
...
"Upgrade to Adobe Bridge version 11.1.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-42721");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(125, 415, 416, 476, 787, 788);
