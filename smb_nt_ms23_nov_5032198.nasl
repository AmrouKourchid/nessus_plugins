...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5032198");
  script_xref(name:"MSKB", value:"5032304");
  script_xref(name:"MSFT", value:"MS23-5032198");
  script_xref(name:"MSFT", value:"MS23-5032304");
  ...
  script_name(english:"KB5032198: Windows Server 2022 / Azure Stack HCI 22H2 Security Update (November 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5032198. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5032198");
...
"Apply Security Update 5032198 or Azure HotPatch 5032304");
...
if (
  smb_check_rollup(os:'10',
                   ...
                   rollup_date:'11_2023',
                   bulletin:bulletin,
                   rollup_kb_list:[5032198,5032304])
)
{
