...
if (description)
{
  ...
  script_name(english:"Oracle Siebel Server (July 2023 CPU)");
...
2023 CPU advisory.
  ...
  - Vulnerability in the Siebel CRM product of Oracle Siebel CRM (component: Siebel Core (zlib)). Supported
    versions that are affected are 23.6 and prior. Easily exploitable vulnerability allows unauthenticated
