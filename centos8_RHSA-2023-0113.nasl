...
# Red Hat Security Advisory RHSA-2023:0113. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : postgresql:10 (CESA-2023:0113)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2023:0113 advisory.
...
var appstreams = {
    'postgresql:10': [
      {'reference':'postgresql-10.23-1.module_el8.7.0+1228+f13a78c7', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-10.23-1.module_el8.7.0+1228+f13a78c7', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-10.23-1.module_el8.7.0+1228+f13a78c7', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-10.23-1.module_el8.7.0+1228+f13a78c7', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-devel-10.23-1.module_el8.7.0+1228+f13a78c7', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-devel-10.23-1.module_el8.7.0+1228+f13a78c7', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-10.23-1.module_el8.7.0+1228+f13a78c7', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-10.23-1.module_el8.7.0+1228+f13a78c7', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'postgresql / postgresql-server / postgresql-server-devel / etc');
}
