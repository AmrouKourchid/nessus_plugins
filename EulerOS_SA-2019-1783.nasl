...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : expat (EulerOS-SA-2019-1783)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1783
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6c14d3d");
...
pkgs = ["expat-2.2.6-1.h1.eulerosv2r8",
        "expat-devel-2.2.6-1.h1.eulerosv2r8"];
