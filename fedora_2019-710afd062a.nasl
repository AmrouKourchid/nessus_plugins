...
# extracted from Fedora Security Advisory FEDORA-2019-710afd062a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : gsi-openssh (2019-710afd062a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-710afd062a");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"gsi-openssh-7.8p1-3.fc28")) flag++;
