...
ELSA-2016-0855 advisory.
    ...
    - [x86] kernel: espfix not working for 32-bit KVM paravirt guests (Jacob Tanenbaum) [1172767]
    {CVE-2014-8134}
    - [x86] nmi/64: Fix a paravirt stack-clobbering bug in the NMI code (Denys Vlasenko) [1259581]
    {CVE-2015-5157}
    - [x86] nmi/64: Switch stacks on userspace NMI entry (Denys Vlasenko) [1259581] {CVE-2015-5157}
    - [net] unix: correctly track in-flight fds in sending process user_struct (Hannes Frederic Sowa)
    [1313052] {CVE-2016-2550}
    - [net] sctp: Prevent soft lockup when sctp_accept() is called during a timeout event (Jacob Tanenbaum)
    [1297422] {CVE-2015-8767}
    - [virt] kvm: x86: Dont report guest userspace emulation error to userspace (Bandan Das) [1163764]
    {CVE-2010-5313 CVE-2014-7842}
    - [virt] kvm: inject #UD if instruction emulation fails and exit to userspace (Bandan Das) [1163764]
    {CVE-2010-5313 CVE-2014-7842}
    - [fs] pipe: fix offset and len mismatch on pipe_iov_copy_to_user failure (Seth Jennings) [1302223]
    {CVE-2016-0774}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-2.6.32-642.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-642.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
    ...
    {'reference':'kernel-abi-whitelists-2.6.32-642.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-642.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
