...
# Oracle Linux Security Advisory ELSA-2009-0345 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : ghostscript (ELSA-2009-0345)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0345.html");
...
"Update the affected ghostscript, ghostscript-devel and / or ghostscript-gtk packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0584");
...
var pkgs = [
    {'reference':'ghostscript-8.15.2-9.4.el5_3.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-devel-8.15.2-9.4.el5_3.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-gtk-8.15.2-9.4.el5_3.4', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-8.15.2-9.4.el5_3.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-devel-8.15.2-9.4.el5_3.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-gtk-8.15.2-9.4.el5_3.4', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
