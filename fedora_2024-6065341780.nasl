...
# extracted from Fedora Security Advisory FEDORA-2024-6065341780
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6065341780");

  script_name(english:"Fedora 39 : cockpit (2024-6065341780)");
...
FEDORA-2024-6065341780 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6065341780");
...
var pkgs = [
    {'reference':'cockpit-314-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
