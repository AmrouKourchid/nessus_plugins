...
# extracted from Fedora Security Advisory FEDORA-2023-7b78427a7d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7b78427a7d");

  script_name(english:"Fedora 40 : GitPython (2023-7b78427a7d)");
...
FEDORA-2023-7b78427a7d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7b78427a7d");
...
var pkgs = [
    {'reference':'GitPython-3.1.40-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
