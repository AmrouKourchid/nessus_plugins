...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-1585");
...
patch available.
  ...
  - In all versions of AppArmor mount rules are accidentally widened when compiled. (CVE-2016-1585)
