...
# extracted from Red Hat Security Advisory RHSA-2024:10965. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10965");

  script_name(english:"RHEL 8 : python3.11-cryptography (RHSA-2024:10965)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10965.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dcd4b5c8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10965");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11-cryptography package based on the guidance in RHSA-2024:10965.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-cryptography-37.0.2-5.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
