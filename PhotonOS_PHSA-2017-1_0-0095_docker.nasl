...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Docker PHSA-2017-1.0-0095");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-14992");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'docker-17.06.0-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'docker-doc-17.06.0-2.ph1')) flag++;
