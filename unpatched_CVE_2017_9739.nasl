...
if (description)
{
  ...
  script_cve_id("CVE-2017-9739");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-9739");
...
patch available.
  ...
  - The Ins_JMPR function in base/ttinterp.c in Artifex Ghostscript GhostXPS 9.21 allows remote attackers to
