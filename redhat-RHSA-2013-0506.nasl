...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2013/rhsa-2013_0506.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cd63a382");
  # https://access.redhat.com/knowledge/docs/en-US/Red_Hat_Enterprise_Linux/6/html/6.4_Release_Notes/index.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d7ca19d9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0506");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=766333");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=804093");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=861892");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=864889");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=867317");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=867854");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=868248");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=868419");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=877085");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=878564");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=882188");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=885089");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=886157");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=895718");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'samba4-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'samba4-client-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-client-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'samba4-common-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-common-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'samba4-dc-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-dc-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'samba4-dc-libs-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-dc-libs-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'samba4-devel-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-devel-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'samba4-libs-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-libs-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'samba4-pidl-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-pidl-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'samba4-python-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-python-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'samba4-swat-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-swat-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'samba4-test-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-test-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'samba4-winbind-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-winbind-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'samba4-winbind-clients-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-winbind-clients-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'samba4-winbind-krb5-locator-4.0.0-55.el6.rc4', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba4-winbind-krb5-locator-4.0.0-55.el6.rc4', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
