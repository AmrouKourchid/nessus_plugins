...
# extracted from Fedora Security Advisory FEDORA-2022-63b1344b6d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-63b1344b6d");

  script_name(english:"Fedora 35 : firefox (2022-63b1344b6d)");
...
FEDORA-2022-63b1344b6d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-63b1344b6d");
...
var pkgs = [
    {'reference':'firefox-100.0-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
