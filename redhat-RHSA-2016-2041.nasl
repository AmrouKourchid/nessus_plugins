...
# extracted from Red Hat Security Advisory RHSA-2016:2041. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:2041");

  script_name(english:"RHEL 7 : python-django (RHSA-2016:2041)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-django.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2016:2041 advisory.
    ...
    * A CSRF flaw was found in Django, where an interaction between Google Analytics and Django's cookie
    parsing could allow an attacker to set arbitrary cookies leading to a bypass of CSRF protection. In this
    update, the parser for ''request.COOKIES'' has been simplified to better match browser behavior and to
    mitigate this attack. ''request.COOKIES'' may now contain cookies that are invalid according to RFC 6265
    but are possible to set using ''document.cookie''. (CVE-2016-7401)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1377376");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_2041.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0989787c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:2041");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-django package based on the guidance in RHSA-2016:2041.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-7401");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-django-1.8.15-1.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-django-bash-completion-1.8.15-1.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-django-doc-1.8.15-1.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
