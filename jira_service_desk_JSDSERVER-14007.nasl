...
if (description)
{
  ...
  script_name(english:"Atlassian JIRA Service Desk < 4.20.25 / 5.3.x < 5.4.9 / 5.9.x < 5.9.2 / 5.10.x < 5.10.1 (JSDSERVER-14007)");
...
referenced in the JSDSERVER-14007 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/JSDSERVER-14007");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Atlassian JIRA Service Desk version 4.20.25, 5.4.9, 5.9.2, 5.10.1 or later.");
...
var constraints = [
  { 'min_version' : '4.20.0', 'fixed_version' : '4.20.25'},
  { 'min_version' : '5.3.0', 'fixed_version' : '5.4.9' },
