...
# extracted from Ubuntu Security Notice USN-6697-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6697-1");

  script_name(english:"Ubuntu 22.04 LTS : Bash vulnerability (USN-6697-1)");
...
USN-6697-1 advisory.
    ...
    It was discovered that Bash incorrectly handled certain memory operations when processing commands. If a
    user or automated system were tricked into running a specially crafted bash file, a remote attacker could
    use this issue to cause Bash to crash, resulting in a denial of service, or possibly execute arbitrary
    code.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6697-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'bash', 'pkgver': '5.1-6ubuntu1.1'},
    {'osver': '22.04', 'pkgname': 'bash-builtins', 'pkgver': '5.1-6ubuntu1.1'},
    {'osver': '22.04', 'pkgname': 'bash-static', 'pkgver': '5.1-6ubuntu1.1'}
];
