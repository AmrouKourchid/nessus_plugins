...
# AlmaLinux Security Advisory ALSA-2024:1134.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1134");
  script_xref(name:"IAVA", value:"2023-A-0661-S");

  script_name(english:"AlmaLinux 9 : tomcat (ALSA-2024:1134)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-1134.html");
