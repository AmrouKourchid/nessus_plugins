...
# extracted from Fedora Security Advisory FEDORA-2023-239bae4b57
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-239bae4b57");

  script_name(english:"Fedora 36 : xorg-x11-server-Xwayland (2023-239bae4b57)");
...
FEDORA-2023-239bae4b57 advisory.

    xwayland 22.1.9
    Security fx for CVE-2023-1393
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-239bae4b57");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-22.1.9-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
