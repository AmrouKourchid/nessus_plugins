...
# extracted from Fedora Security Advisory FEDORA-2023-469d0d1a18
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-469d0d1a18");

  script_name(english:"Fedora 38 : java-latest-openjdk (2023-469d0d1a18)");
...
FEDORA-2023-469d0d1a18 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-469d0d1a18");
...
var pkgs = [
    {'reference':'java-latest-openjdk-20.0.2.0.9-1.rolling.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
