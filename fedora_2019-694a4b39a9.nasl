...
# extracted from Fedora Security Advisory FEDORA-2019-694a4b39a9.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-694a4b39a9");

  script_name(english:"Fedora 31 : memcached (2019-694a4b39a9)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-694a4b39a9");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"memcached-1.5.17-1.fc31")) flag++;
