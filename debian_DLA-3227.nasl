...
if (description)
{
  ...
  script_name(english:"Debian dla-3227 : ruby-rails-html-sanitizer - security update");
...
advisory.
    ...
    - -----------------------------------------------------------------------
    Debian LTS Advisory DLA-3227-1              debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Utkarsh Gupta
    December 07, 2022                           https://wiki.debian.org/LTS
    - -----------------------------------------------------------------------

    Package        : ruby-rails-html-sanitizer
    Version        : 1.0.4-1+deb10u1
    CVE ID         : CVE-2022-32209
    Debian Bug     : 1013806

    A potential cross-site scripting (XSS) vulnerability was discovered
