...
if (description)
{
  ...
  script_name(english:"CentOS 9 : xorg-x11-server-Xwayland-21.1.3-6.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for xorg-x11-server-Xwayland.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
xorg-x11-server-Xwayland-21.1.3-6.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=27891");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream xorg-x11-server-Xwayland package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:xorg-x11-server-Xwayland-devel");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-21.1.3-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xwayland-devel-21.1.3-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
