...
# extracted from Oracle Linux Security Advisory ELSA-2021-14902.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : runc (ELSA-2021-14902)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-14902.html");
...
var pkgs = [
    {'reference':'runc-1.0.0-1.rc95.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
    {'reference':'runc-1.0.0-1.rc95.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
