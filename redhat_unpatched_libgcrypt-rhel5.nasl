...
# extracted from Red Hat Security Advisory libgcrypt. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-6313", "CVE-2017-7526", "CVE-2019-12904");

  script_name(english:"RHEL 5 : libgcrypt (Unpatched Vulnerability) (deprecated)");
