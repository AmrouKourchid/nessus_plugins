...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : bind (IJ29232)");
  script_summary(english:"Check for APAR IJ29232");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"00", patch:"IJ29232s1a", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"01", patch:"IJ29232s1a", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.1") < 0) flag++;
