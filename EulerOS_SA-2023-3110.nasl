...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : syslinux (EulerOS-SA-2023-3110)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the syslinux packages installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3110
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7113f5cb");
...
var pkgs = [
  "syslinux-6.04-5.h1.r2.eulerosv2r9",
  "syslinux-nonlinux-6.04-5.h1.r2.eulerosv2r9"
];
