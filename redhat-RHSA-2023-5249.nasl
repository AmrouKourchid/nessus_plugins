...
# extracted from Red Hat Security Advisory RHSA-2023:5249. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : ncurses (RHSA-2023:5249)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ncurses.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:5249 advisory.

    The ncurses (new curses) library routines are a terminal-independent method of updating character screens
    with reasonable optimization. The ncurses packages contain support utilities including a terminfo compiler
    tic, a decompiler infocmp, clear, tput, tset, and a termcap conversion tool captoinfo.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5249.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7968e459");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2191704");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5249");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ncurses package based on the guidance in RHSA-2023:5249.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ncurses");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ncurses-base");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ncurses-c++-libs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ncurses-compat-libs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ncurses-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ncurses-libs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ncurses-term");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ncurses-6.1-9.20180224.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-base-6.1-9.20180224.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-c++-libs-6.1-9.20180224.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-compat-libs-6.1-9.20180224.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-devel-6.1-9.20180224.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-libs-6.1-9.20180224.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-term-6.1-9.20180224.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ncurses-6.1-9.20180224.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-base-6.1-9.20180224.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-c++-libs-6.1-9.20180224.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-compat-libs-6.1-9.20180224.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-devel-6.1-9.20180224.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-libs-6.1-9.20180224.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ncurses-term-6.1-9.20180224.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
