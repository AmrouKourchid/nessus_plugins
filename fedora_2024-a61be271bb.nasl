...
# extracted from Fedora Security Advisory FEDORA-2024-a61be271bb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a61be271bb");

  script_name(english:"Fedora 39 : firefox (2024-a61be271bb)");
...
FEDORA-2024-a61be271bb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a61be271bb");
...
var pkgs = [
    {'reference':'firefox-127.0.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
