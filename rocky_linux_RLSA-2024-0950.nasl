...
# Rocky Linux Security Advisory RLSA-2024:0950.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:0950");

  script_name(english:"Rocky Linux 9 : postgresql:15 (RLSA-2024:0950)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:0950");
