...
# extracted from Gentoo Linux Security Advisory GLSA 202009-16.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202009-16");

  script_name(english:"GLSA-202009-16 : LinuxCIFS: Shell injection");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202009-16
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202009-16");
...
if (qpkg_check(package:"net-fs/cifs-utils", unaffected:make_list("ge 6.11"), vulnerable:make_list("lt 6.11"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "LinuxCIFS");
}
