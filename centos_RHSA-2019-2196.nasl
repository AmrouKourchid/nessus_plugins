...
# extracted from Red Hat Security Advisory RHSA-2019:2196 and 
# CentOS Errata and Security Advisory 2019:2196 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : zziplib (CESA-2019:2196)");
...
Enterprise Linux 7.7 Release Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2019-August/006196.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1250f6f6");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"zziplib-0.13.62-11.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"zziplib-devel-0.13.62-11.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"zziplib-utils-0.13.62-11.el7")) flag++;
