...
# extracted from Fedora Security Advisory FEDORA-2023-b87fd3a628
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b87fd3a628");

  script_name(english:"Fedora 38 : tigervnc (2023-b87fd3a628)");
...
FEDORA-2023-b87fd3a628 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b87fd3a628");
...
var pkgs = [
    {'reference':'tigervnc-1.13.1-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
