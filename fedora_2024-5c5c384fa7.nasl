...
# extracted from Fedora Security Advisory FEDORA-2024-5c5c384fa7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5c5c384fa7");

  script_name(english:"Fedora 40 : microcode_ctl (2024-5c5c384fa7)");
...
FEDORA-2024-5c5c384fa7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5c5c384fa7");
...
"Update the affected 2:microcode_ctl package.");
  ...
  script_set_attribute(attribute:"cvss4_vector", value:"CVSS:4.0/AV:L/AC:H/AT:P/PR:H/UI:N/VC:L/VI:H/VA:N/SC:L/SI:H/SA:N");
  script_set_attribute(attribute:"cvss4_threat_vector", value:"CVSS:4.0/E:U");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24853");
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2024-24980");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-61.2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
