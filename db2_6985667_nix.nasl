...
if (description)
{
  ...
  script_cve_id("CVE-2023-27559");
  script_xref(name:"IAVB", value:"2023-B-0028-S");

  script_name(english:"IBM DB2 10.5 < 10.5.0 FP 11 41270 / 11.1 < 11.1.4 FP 7 41268 / 11.5 < 11.5.7 FP 0 29113 / 11.5 < 11.5.8 FP 0 29133 DoS (Unix)");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a denial of service vulnerability.");
  script_set_attribute(attribute:"description", value:
"According to it self-reported version number, IBM Db2 is affected by a denial of service as the server may crash 
when using a specially crafted subquery.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6985667");
...
"Apply the appropriate IBM DB2 Fix Pack or Special Build based on the most recent fix pack level for your branch.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-27559");
...
var constraints = [
  ...
  {'equal':'11.5.7.0', 'fixed_build':'29113'},
  {'min_version':'11.5', 'fixed_version':'11.5.7.0', 'fixed_display':'11.5.7.0 + Special Build 29113'},
  {'equal':'11.5.8.0', 'fixed_build':'29133'},
  {'min_version':'11.5', 'fixed_version':'11.5.8.0', 'fixed_display':'11.5.8.0 + Special Build 29133'}
];
