...
# extracted from Red Hat Security Advisory RHSA-2024:0428. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0428.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e95f4969");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0428");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL curl package based on the guidance in RHSA-2024:0428.");
  ...
  script_cwe_id(201, 305, 416, 440, 1286);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'curl-7.61.1-22.el8_6.12', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-7.61.1-22.el8_6.12', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-devel-7.61.1-22.el8_6.12', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-minimal-7.61.1-22.el8_6.12', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
