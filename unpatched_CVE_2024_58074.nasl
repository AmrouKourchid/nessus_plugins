...
if (description)
{
  ...
  script_cve_id("CVE-2024-58074");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-58074");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/i915: Grab intel_display from the
    encoder to avoid potential oopsies Grab the intel_display from 'encoder' rather than 'state' in the
    encoder hooks to avoid the massive footgun that is intel_sanitize_encoder(), which passes NULL as the
    'state' argument to encoder .disable() and .post_disable(). TODO: figure out how to actually fix
    intel_sanitize_encoder()... (CVE-2024-58074)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-58074");
