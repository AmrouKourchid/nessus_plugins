...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Cairo PHSA-2019-1.0-0220");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"cairo-1.16.0-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"cairo-debuginfo-1.16.0-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"cairo-devel-1.16.0-1.ph1")) flag++;
