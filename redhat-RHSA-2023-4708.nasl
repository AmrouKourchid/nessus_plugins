...
# extracted from Red Hat Security Advisory RHSA-2023:4708. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4708");

  script_name(english:"RHEL 9 : subscription-manager (RHSA-2023:4708)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4708.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26288e5e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2225407");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4708");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL subscription-manager package based on the guidance in RHSA-2023:4708.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libdnf-plugin-subscription-manager");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libdnf-plugin-subscription-manager-1.29.33.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-cloud-what-1.29.33.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-subscription-manager-rhsm-1.29.33.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-1.29.33.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-plugin-ostree-1.29.33.1-2.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libdnf-plugin-subscription-manager-1.29.33.1-2.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-cloud-what-1.29.33.1-2.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-subscription-manager-rhsm-1.29.33.1-2.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-1.29.33.1-2.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'subscription-manager-plugin-ostree-1.29.33.1-2.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
