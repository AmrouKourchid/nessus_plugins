...
# extracted from Red Hat Security Advisory RHSA-2018:2692. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2692");

  script_name(english:"RHEL 7 : firefox (RHSA-2018:2692)");
...
referenced in the RHSA-2018:2692 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2692.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae334110");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2018-20/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2692");
...
"Update the RHEL firefox package based on the guidance in RHSA-2018:2692.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-60.2.0-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
