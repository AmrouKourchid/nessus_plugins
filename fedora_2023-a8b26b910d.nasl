...
# extracted from Fedora Security Advisory FEDORA-2023-a8b26b910d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a8b26b910d");

  script_name(english:"Fedora 38 : freeimage / mingw-freeimage (2023-a8b26b910d)");
...
FEDORA-2023-a8b26b910d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a8b26b910d");
...
var pkgs = [
    {'reference':'freeimage-3.19.0-0.19.svn1909.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mingw-freeimage-3.19.0-0.16.svn1909.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
