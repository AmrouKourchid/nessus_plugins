...
# extracted from Red Hat Security Advisory RHSA-2023:1068. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1068");

  script_name(english:"RHEL 9 : libjpeg-turbo (RHSA-2023:1068)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1068.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?62c89a7e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2100044");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1068");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libjpeg-turbo package based on the guidance in RHSA-2023:1068.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libjpeg-turbo-2.0.90-6.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libjpeg-turbo-devel-2.0.90-6.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libjpeg-turbo-utils-2.0.90-6.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'turbojpeg-2.0.90-6.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'turbojpeg-devel-2.0.90-6.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
