...
# extracted from Red Hat Security Advisory RHSA-2024:2145. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2145");

  script_name(english:"RHEL 9 : libX11 (RHSA-2024:2145)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libX11.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2145 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2145.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a0939df2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2145");
...
"Update the RHEL libX11 package based on the guidance in RHSA-2024:2145.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libX11-1.7.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-common-1.7.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-devel-1.7.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-xcb-1.7.0-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
