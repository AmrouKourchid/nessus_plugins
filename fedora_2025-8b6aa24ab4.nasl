...
# extracted from Fedora Security Advisory FEDORA-2025-8b6aa24ab4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-8b6aa24ab4");

  script_name(english:"Fedora 40 : python-jinja2 (2025-8b6aa24ab4)");
...
FEDORA-2025-8b6aa24ab4 advisory.

    ### Version 3.1.6 ###
    Released 2025-03-05

    The |attr filter does not bypass the environment's attribute lookup, allowing the sandbox to apply its
    checks.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-8b6aa24ab4");
...
var pkgs = [
    {'reference':'python-jinja2-3.1.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
