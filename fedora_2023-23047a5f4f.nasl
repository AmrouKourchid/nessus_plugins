...
# extracted from Fedora Security Advisory FEDORA-2023-23047a5f4f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-23047a5f4f");

  script_name(english:"Fedora 36 : binwalk (2023-23047a5f4f)");
...
FEDORA-2023-23047a5f4f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-23047a5f4f");
...
var pkgs = [
    {'reference':'binwalk-2.3.3-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
