...
# extracted from Red Hat Security Advisory RHSA-2019:0019. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2018-15727", "CVE-2018-18623");
  script_xref(name:"RHSA", value:"2019:0019");

  script_name(english:"RHEL 7 : grafana (RHSA-2019:0019)");
...
referenced in the RHSA-2019:0019 advisory.
    ...
    * Shrinking the cluster size no longer causes the Red Hat Ceph Storage Dashboard to display the error
    message Templating init failed (BZ#1653273)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0019.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b096c4cf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0019");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1624088");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1633825");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1647494");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1647496");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1652427");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1653273");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana package based on the guidance in RHSA-2019:0019.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-5.2.4-1.el7cp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7cp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ceph-mon-'}
    ]
  }
];
