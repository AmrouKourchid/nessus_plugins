...
USN-5537-2 advisory.
    ...
    USN-5537-1 fixed a vulnerability in MySQL. This update provides the corresponding update for Ubuntu 16.04
    ESM.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libmysqlclient-dev', 'pkgver': '5.7.39-0ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libmysqlclient20', 'pkgver': '5.7.39-0ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libmysqld-dev', 'pkgver': '5.7.39-0ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'mysql-client', 'pkgver': '5.7.39-0ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'mysql-client-5.7', 'pkgver': '5.7.39-0ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'mysql-client-core-5.7', 'pkgver': '5.7.39-0ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'mysql-common', 'pkgver': '5.7.39-0ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'mysql-server', 'pkgver': '5.7.39-0ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'mysql-server-5.7', 'pkgver': '5.7.39-0ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'mysql-server-core-5.7', 'pkgver': '5.7.39-0ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'mysql-source-5.7', 'pkgver': '5.7.39-0ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'mysql-testsuite', 'pkgver': '5.7.39-0ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'mysql-testsuite-5.7', 'pkgver': '5.7.39-0ubuntu0.16.04.1+esm2', 'ubuntu_pro': TRUE}
];
