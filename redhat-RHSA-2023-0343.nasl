...
# extracted from Red Hat Security Advisory RHSA-2023:0343. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0343");

  script_name(english:"RHEL 9 : libtasn1 (RHSA-2023:0343)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0343.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19296c40");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2140058");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0343");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libtasn1 package based on the guidance in RHSA-2023:0343.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libtasn1-4.16.0-8.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtasn1-devel-4.16.0-8.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtasn1-tools-4.16.0-8.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
