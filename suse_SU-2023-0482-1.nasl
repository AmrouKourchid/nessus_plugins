...
# SUSE update advisory SUSE-SU-2023:0482-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0482-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : openssl-1_1-livepatches (SUSE-SU-2023:0482-1)");
...
referenced in the SUSE-SU-2023:0482-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013880.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70176705");
...
var pkgs = [
    {'reference':'openssl-1_1-livepatches-0.1-150400.3.3.1', 'cpu':'x86_64', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'openssl-1_1-livepatches-0.1-150400.3.3.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
];
