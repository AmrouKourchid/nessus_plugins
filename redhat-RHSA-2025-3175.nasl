...
# extracted from Red Hat Security Advisory RHSA-2025:3175. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3175");

  script_name(english:"RHEL 8 : container-tools:rhel8 (RHSA-2025:3175)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for container-tools:rhel8.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:3175 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1eb121b1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3175");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL container-tools:rhel8 package based on the guidance in RHSA-2025:3175.");
  ...
  'container-tools:rhel8': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'podman-4.2.0-8.module+el8.6.0+22955+5cb62980.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-4.2.0-8.module+el8.6.0+22955+5cb62980.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-catatonit-4.2.0-8.module+el8.6.0+22955+5cb62980.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-catatonit-4.2.0-8.module+el8.6.0+22955+5cb62980.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-docker-4.2.0-8.module+el8.6.0+22955+5cb62980.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-gvproxy-4.2.0-8.module+el8.6.0+22955+5cb62980.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-gvproxy-4.2.0-8.module+el8.6.0+22955+5cb62980.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-plugins-4.2.0-8.module+el8.6.0+22955+5cb62980.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-plugins-4.2.0-8.module+el8.6.0+22955+5cb62980.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-remote-4.2.0-8.module+el8.6.0+22955+5cb62980.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-remote-4.2.0-8.module+el8.6.0+22955+5cb62980.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-tests-4.2.0-8.module+el8.6.0+22955+5cb62980.2', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-tests-4.2.0-8.module+el8.6.0+22955+5cb62980.2', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
