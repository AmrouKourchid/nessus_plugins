...
# extracted from Fedora Security Advisory FEDORA-2022-1f8312716f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1f8312716f");

  script_name(english:"Fedora 35 : firefox (2022-1f8312716f)");
...
FEDORA-2022-1f8312716f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1f8312716f");
...
var pkgs = [
    {'reference':'firefox-105.0.1-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
