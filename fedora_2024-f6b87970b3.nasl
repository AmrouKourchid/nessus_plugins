...
# extracted from Fedora Security Advisory FEDORA-2024-f6b87970b3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f6b87970b3");

  script_name(english:"Fedora 41 : tinyproxy (2024-f6b87970b3)");
...
FEDORA-2024-f6b87970b3 advisory.

    Automatic update for tinyproxy-1.11.2-1.fc41.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f6b87970b3");
...
"Update the affected tinyproxy package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:tinyproxy");
...
var pkgs = [
    {'reference':'tinyproxy-1.11.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
