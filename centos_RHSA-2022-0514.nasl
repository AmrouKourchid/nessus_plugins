...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2022:0514)");
...
var pkgs = [
    {'reference':'firefox-91.6.0-1.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
