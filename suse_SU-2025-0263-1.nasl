...
# SUSE update advisory SUSE-SU-2025:0263-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0263-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 0 for SLE 15 SP6) (SUSE-SU-2025:0263-1)");
...
the SUSE-SU-2025:0263-1 advisory.
    ...
    - CVE-2024-27029: drm/amdgpu: fix mmhub client id out-of-bounds access Properly handle cid 0x140
    (bsc#1226184).
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1226184");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-January/020208.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?898fc866");
...
var kernel_live_checks = [
  {
    'kernels': {
      '6.4.0-150600.21-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-6_4_0-150600_21-default-9-150600.4.19.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.6']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-6_4_0-150600_21-default');
}
