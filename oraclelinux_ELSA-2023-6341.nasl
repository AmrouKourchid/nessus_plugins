...
# extracted from Oracle Linux Security Advisory ELSA-2023-6341.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : xorg-x11-server-Xwayland (ELSA-2023-6341)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6341.html");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-22.1.9-2.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-Xwayland-22.1.9-2.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
