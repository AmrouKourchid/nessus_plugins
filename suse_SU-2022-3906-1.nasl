...
# SUSE update advisory SUSE-SU-2022:3906-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3906-1");

  script_name(english:"SUSE SLED12 / SLES12 Security Update : gstreamer-0_10-plugins-good (SUSE-SU-2022:3906-1)");
...
multiple vulnerabilities as referenced in the SUSE-SU-2022:3906-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-November/012844.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4bc30919");
  script_set_attribute(attribute:"solution", value:
"Update the affected gstreamer-0_10-plugins-good and / or gstreamer-0_10-plugins-good-lang packages.");
...
var pkgs = [
    {'reference':'gstreamer-0_10-plugins-good-0.10.31-17.7.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLED_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'gstreamer-0_10-plugins-good-0.10.31-17.7.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'gstreamer-0_10-plugins-good-lang-0.10.31-17.7.1', 'sp':'5', 'release':'SLED_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'gstreamer-0_10-plugins-good-lang-0.10.31-17.7.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'gstreamer-0_10-plugins-good-0.10.31-17.7.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLED12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-we-release-12.5', 'sled-release-12.5', 'sles-release-12.5']},
    {'reference':'gstreamer-0_10-plugins-good-0.10.31-17.7.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-we-release-12.5', 'sled-release-12.5', 'sles-release-12.5']},
    {'reference':'gstreamer-0_10-plugins-good-lang-0.10.31-17.7.1', 'sp':'5', 'release':'SLED12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-we-release-12.5', 'sled-release-12.5', 'sles-release-12.5']},
    {'reference':'gstreamer-0_10-plugins-good-lang-0.10.31-17.7.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-we-release-12.5', 'sled-release-12.5', 'sles-release-12.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gstreamer-0_10-plugins-good / gstreamer-0_10-plugins-good-lang');
}
