...
# extracted from Fedora Security Advisory FEDORA-2024-5c186175f2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5c186175f2");

  script_name(english:"Fedora 38 : postfix (2024-5c186175f2)");
...
FEDORA-2024-5c186175f2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5c186175f2");
...
var pkgs = [
    {'reference':'postfix-3.7.9-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
