...
# extracted from Red Hat Security Advisory RHSA-2024:4200. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4200");

  script_name(english:"RHEL 8 : libreswan (RHSA-2024:4200)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4200.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?484e6321");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2274448");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4200");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libreswan package based on the guidance in RHSA-2024:4200.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.9-3.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
