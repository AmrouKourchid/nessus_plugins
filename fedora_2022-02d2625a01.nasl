...
# extracted from Fedora Security Advisory FEDORA-2022-02d2625a01
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-02d2625a01");

  script_name(english:"Fedora 36 : firefox (2022-02d2625a01)");
...
FEDORA-2022-02d2625a01 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-02d2625a01");
...
var pkgs = [
    {'reference':'firefox-104.0-5.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
