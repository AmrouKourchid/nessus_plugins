...
# extracted from Fedora Security Advisory FEDORA-2023-ad944c2d34
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ad944c2d34");

  script_name(english:"Fedora 39 : libcap (2023-ad944c2d34)");
...
FEDORA-2023-ad944c2d34 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ad944c2d34");
...
"Update the affected libcap package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libcap");
...
var pkgs = [
    {'reference':'libcap-2.48-8.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
