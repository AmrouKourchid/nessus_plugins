...
if (description)
{
  ...
  script_cve_id("CVE-2023-4134");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-4134");
...
patch available.
  ...
  - A use-after-free vulnerability was found in the cyttsp4_core driver in the Linux kernel. This issue occurs
    in the device cleanup routine due to a possible rearming of the watchdog_timer from the workqueue. This
    could allow a local user to crash the system, causing a denial of service. (CVE-2023-4134)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-4134");
