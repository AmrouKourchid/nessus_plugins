...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5034167");
  script_xref(name:"MSKB", value:"5034169");
  script_xref(name:"MSFT", value:"MS24-5034167");
  script_xref(name:"MSFT", value:"MS24-5034169");
  script_xref(name:"IAVA", value:"2024-A-0015-S");
  script_xref(name:"IAVA", value:"2024-A-0016-S");

  script_name(english:"KB5034167: Windows Server 2008 R2 Security Update (January 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034167");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034169");
...
if (("windows server 2008 r2" >< tolower(os_name)) &&
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'01_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5034169, 5034167])
)
{
