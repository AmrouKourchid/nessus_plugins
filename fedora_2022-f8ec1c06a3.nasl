...
# extracted from Fedora Security Advisory FEDORA-2022-f8ec1c06a3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f8ec1c06a3");
  script_xref(name:"IAVB", value:"2022-B-0050-S");

  script_name(english:"Fedora 35 : poppler (2022-f8ec1c06a3)");
...
FEDORA-2022-f8ec1c06a3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f8ec1c06a3");
...
var pkgs = [
    {'reference':'poppler-21.08.0-3.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
