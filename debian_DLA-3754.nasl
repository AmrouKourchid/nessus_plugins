...
# extracted from Debian Security Advisory dla-3754. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3754 : fontforge - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-5395");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-5496");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/fontforge");
...
"Upgrade the fontforge packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libfontforge2");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libgdraw5");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'fontforge', 'reference': '1:20170731~dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'fontforge-common', 'reference': '1:20170731~dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'fontforge-dbg', 'reference': '1:20170731~dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'fontforge-doc', 'reference': '1:20170731~dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'fontforge-nox', 'reference': '1:20170731~dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libfontforge-dev', 'reference': '1:20170731~dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libfontforge2', 'reference': '1:20170731~dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libgdraw5', 'reference': '1:20170731~dfsg-1+deb10u1'},
    {'release': '10.0', 'prefix': 'python-fontforge', 'reference': '1:20170731~dfsg-1+deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'fontforge / fontforge-common / fontforge-dbg / fontforge-doc / etc');
}
