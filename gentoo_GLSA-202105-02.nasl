...
# extracted from Gentoo Linux Security Advisory GLSA 202105-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-02");

  script_name(english:"GLSA-202105-02 : stunnel: Improper certificate validation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-02
(stunnel: Improper certificate validation)

    It was discovered that stunnel did not correctly verified the client
      certificate when options &ldquo;redirect&rdquo; and &ldquo;verifyChain&rdquo; are used.
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-02"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-misc/stunnel", unaffected:make_list("ge 5.58"), vulnerable:make_list("lt 5.58"))) flag++;
