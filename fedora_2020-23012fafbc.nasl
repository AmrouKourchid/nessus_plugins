...
# extracted from Fedora Security Advisory FEDORA-2020-23012fafbc.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-23012fafbc");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Fedora 31 : snakeyaml (2020-23012fafbc)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-23012fafbc");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"snakeyaml-1.26-1.fc31")) flag++;
