...
# extracted from Ubuntu Security Notice USN-7161-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7161-1");

  script_name(english:"Ubuntu 18.04 LTS / 24.04 LTS : Docker vulnerabilities (USN-7161-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 18.04 LTS / 24.04 LTS host has a package installed that is affected by multiple vulnerabilities as
referenced in the USN-7161-1 advisory.

    Yair Zak discovered that Docker could unexpectedly forward DNS requests

    from internal networks in an unexpected manner. An attacker could possibly use this issue to exfiltrate
    data by encoding information in DNS queries
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7161-1");
...
if (! ('18.04' >< os_release || '24.04' >< os_release)) audit(AUDIT_OS_NOT, 'Ubuntu 18.04 / 24.04', 'Ubuntu ' + os_release);
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'docker.io', 'pkgver': '20.10.21-0ubuntu1~18.04.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '24.04', 'pkgname': 'docker.io', 'pkgver': '26.1.3-0ubuntu1~24.04.1+esm1', 'ubuntu_pro': TRUE}
];
