...
# extracted from Red Hat Security Advisory RHSA-2021:3576. The text
...
referenced in the RHSA-2021:3576 advisory.
    ...
    * krb5: Sending a request containing PA-ENCRYPTED-CHALLENGE padata element without using FAST could result
    in NULL dereference in KDC which leads to DoS (CVE-2021-36222)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3576.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d9af2129");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3576");
...
"Update the RHEL krb5 package based on the guidance in RHSA-2021:3576.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'krb5-devel-1.18.2-8.3.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-libs-1.18.2-8.3.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-pkinit-1.18.2-8.3.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-server-1.18.2-8.3.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-server-ldap-1.18.2-8.3.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-workstation-1.18.2-8.3.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libkadm5-1.18.2-8.3.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'krb5-devel-1.18.2-8.3.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-libs-1.18.2-8.3.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-pkinit-1.18.2-8.3.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-server-1.18.2-8.3.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-server-ldap-1.18.2-8.3.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'krb5-workstation-1.18.2-8.3.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libkadm5-1.18.2-8.3.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
