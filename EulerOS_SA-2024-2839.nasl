...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : syslinux (EulerOS-SA-2024-2839)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2839
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?965fbb6e");
...
var pkgs = [
  "syslinux-6.04-5.h1.r3.eulerosv2r9",
  "syslinux-nonlinux-6.04-5.h1.r3.eulerosv2r9"
];
