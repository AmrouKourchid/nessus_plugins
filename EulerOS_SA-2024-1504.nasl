...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : docker-runc (EulerOS-SA-2024-1504)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1504
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9ee10bd1");
...
var pkgs = [
  "docker-runc-1.0.0.rc3-108.h27.eulerosv2r9"
];
