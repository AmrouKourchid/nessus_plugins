...
# extracted from Fedora Security Advisory FEDORA-2022-23e6ee1fb9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-23e6ee1fb9");

  script_name(english:"Fedora 35 : squid (2022-23e6ee1fb9)");
...
FEDORA-2022-23e6ee1fb9 advisory.

    - version update to 5.7.
    - security fixes CVE-2022-41317

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-23e6ee1fb9");
...
var pkgs = [
    {'reference':'squid-5.7-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
