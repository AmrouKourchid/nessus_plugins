...
# extracted from Debian Security Advisory DLA-1965-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1965-1 : nfs-utils security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/10/msg00026.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/nfs-utils");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected nfs-common, and nfs-kernel-server packages.");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"nfs-common", reference:"1.2.8-9+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"nfs-kernel-server", reference:"1.2.8-9+deb8u1")) flag++;
