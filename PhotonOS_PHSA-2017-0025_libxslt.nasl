...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libxslt PHSA-2017-0025");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libxslt-1.1.29-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libxslt-debuginfo-1.1.29-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'libxslt-devel-1.1.29-4.ph1')) flag++;
