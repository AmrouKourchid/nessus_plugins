...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : python (EulerOS-SA-2021-1350)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1350
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9cf7ed6a");
...
pkgs = ["python-2.7.5-58.h24",
        "python-devel-2.7.5-58.h24",
        "python-libs-2.7.5-58.h24",
        "tkinter-2.7.5-58.h24"];
