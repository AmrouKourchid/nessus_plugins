...
# extracted from Ubuntu Security Notice USN-6522-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6522-2");

  script_name(english:"Ubuntu 18.04 ESM : FreeRDP vulnerabilities (USN-6522-2)");
...
the USN-6522-2 advisory.

    USN-6522-1 fixed several vulnerabilities in FreeRDP. This update provides the corresponding update for
    Ubuntu 18.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6522-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'freerdp2-dev', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'freerdp2-shadow-x11', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'freerdp2-wayland', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'freerdp2-x11', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libfreerdp-client2-2', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libfreerdp-server2-2', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libfreerdp-shadow-subsystem2-2', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libfreerdp-shadow2-2', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libfreerdp2-2', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libuwac0-0', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libuwac0-dev', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libwinpr-tools2-2', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libwinpr2-2', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libwinpr2-dev', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'winpr-utils', 'pkgver': '2.2.0+dfsg1-0ubuntu0.18.04.4+esm2', 'ubuntu_pro': TRUE}
];
