...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop 21.x < 21.2.9 / 22.x < 22.4.2 Vulnerability (APSB21-38)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop installed on the remote Windows host is prior to 21.2.9/22.4.2. It is, therefore,
affected by a vulnerability as referenced in the apsb21-38 advisory.
