...
# Oracle Linux Security Advisory ELSA-2012-0369 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : python-sqlalchemy (ELSA-2012-0369)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-0369.html");
...
"Update the affected python-sqlalchemy package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python-sqlalchemy");
...
var pkgs = [
    {'reference':'python-sqlalchemy-0.5.5-3.el6_2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
