...
# extracted from Debian Security Advisory dla-4137. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4137 : libbpf-dev - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/libbpf");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-3534");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-3606");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/libbpf");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libbpf-dev packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libbpf0");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libbpf-dev', 'reference': '0.3-2+deb11u1'},
    {'release': '11.0', 'prefix': 'libbpf0', 'reference': '0.3-2+deb11u1'}
];
