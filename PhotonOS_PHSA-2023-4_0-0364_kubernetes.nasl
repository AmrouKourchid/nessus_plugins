...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Kubernetes PHSA-2023-4.0-0364");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'kubernetes-1.23.9-10.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'kubernetes-kubeadm-1.23.9-10.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'kubernetes-pause-1.23.9-10.ph4')) flag++;
