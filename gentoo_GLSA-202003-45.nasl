...
# extracted from Gentoo Linux Security Advisory GLSA 202003-45.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-45");

  script_name(english:"GLSA-202003-45 : PyYAML: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202003-45
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202003-45");
...
if (qpkg_check(package:"dev-python/pyyaml", unaffected:make_list("ge 5.1"), vulnerable:make_list("lt 5.1"))) flag++;
