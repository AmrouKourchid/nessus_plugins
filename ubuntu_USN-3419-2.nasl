...
# extracted from Ubuntu Security Notice USN-3419-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Linux kernel (HWE) vulnerabilities (USN-3419-2)");
...
the USN-3419-2 advisory.

    USN-3419-1 fixed vulnerabilities in the Linux kernel for Ubuntu 17.04. This update provides the
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3419-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.10.0-35-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.10.0-35-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.10.0-35-lowlatency");
...
var kernel_mappings = {
  '16.04': {
    '4.10.0': {
      'generic': '4.10.0-35',
      'generic-lpae': '4.10.0-35',
      'lowlatency': '4.10.0-35'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3419-2');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2017-7541', 'CVE-2017-1000251');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-3419-2');
  }
  else
  {
