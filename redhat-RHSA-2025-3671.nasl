...
# extracted from Red Hat Security Advisory RHSA-2025:3671. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3671");

  script_name(english:"RHEL 8 : python-jinja2 (RHSA-2025:3671)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3671.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e46bc303");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3671");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-jinja2 package based on the guidance in RHSA-2025:3671.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-jinja2-2.10.1-2.el8_2.4', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
