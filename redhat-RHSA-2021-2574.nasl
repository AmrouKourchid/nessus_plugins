...
# extracted from Red Hat Security Advisory RHSA-2021:2574. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2574");

  script_name(english:"RHEL 8 : rpm (RHSA-2021:2574)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rpm.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:2574 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2574.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?861f4294");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2574");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1934125");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rpm package based on the guidance in RHSA-2021:2574.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rpm-plugin-fapolicyd");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rpm-plugin-ima");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rpm-plugin-prioreset");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rpm-plugin-selinux");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rpm-plugin-syslog");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-rpm-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-apidocs-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-build-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-build-libs-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-cron-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-devel-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-libs-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-fapolicyd-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-ima-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-prioreset-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-selinux-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-syslog-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-systemd-inhibit-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-sign-4.14.3-14.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-rpm-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-apidocs-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-build-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-build-libs-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-cron-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-devel-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-libs-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-fapolicyd-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-ima-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-prioreset-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-selinux-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-syslog-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-plugin-systemd-inhibit-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rpm-sign-4.14.3-14.el8_4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
