...
# Oracle Linux Security Advisory ELSA-2012-1434 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : icedtea-web (ELSA-2012-1434)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-1434.html");
