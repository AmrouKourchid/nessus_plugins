...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : dovecot (EulerOS-SA-2019-2138)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2138
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?49c42eb7");
...
pkgs = ["dovecot-2.2.10-8.h7.eulerosv2r7",
        "dovecot-mysql-2.2.10-8.h7.eulerosv2r7",
        "dovecot-pgsql-2.2.10-8.h7.eulerosv2r7",
        "dovecot-pigeonhole-2.2.10-8.h7.eulerosv2r7"];
