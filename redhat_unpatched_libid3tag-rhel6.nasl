...
# extracted from Red Hat Security Advisory libid3tag. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2004-2779", "CVE-2017-11550", "CVE-2017-11551");

  script_name(english:"RHEL 6 : libid3tag (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libid3tag");
