...
if (description)
{
  ...
  script_cve_id("CVE-2025-1756");
  script_xref(name:"IAVB", value:"2025-B-0037");

  script_name(english:"MongoDB Shell < 2.3.0 Control Character Injection (MONGOSH-2028)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of MongoDB Shell installed on the remote host is prior to 2.3.0. It is, therefore, affected by
 a vulnerability as referenced in the MONGOSH-2028 advisory.

  - mongosh may be susceptible to local privilege escalation under certain conditions potentially enabling 
    unauthorized actions on a user's system with elevated privilege, when a crafted file is stored in 
    C:\node_modules\. This issue affects mongosh prior to 2.3.0. (CVE-2025-1756)

  Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
  number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.mongodb.org/browse/MONGOSH-2028");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MongoDB Shell version 2.3.0 or later.");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:N/C:C/I:C/A:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:H/PR:L/UI:R/S:C/C:H/I:H/A:H");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-1756");
  ...
  'checks': [
    {
      ...
      'constraints' : [ {'fixed_version': '2.3.0'}
      ]
    }
  ]
};
