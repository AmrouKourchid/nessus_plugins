...
# SUSE update advisory SUSE-SU-2023:0456-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0456-1");

  script_name(english:"SUSE SLES12 Security Update : ucode-intel (SUSE-SU-2023:0456-1)");
...
referenced in the SUSE-SU-2023:0456-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013840.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b1d33b1");
...
var pkgs = [
    {'reference':'ucode-intel-20230214-3.49.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'ucode-intel-20230214-3.49.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
