...
# extracted from Red Hat Security Advisory RHSA-2020:2106. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2106");

  script_name(english:"RHEL 6 : Red Hat Single Sign-On 7.3.8 security update on RHEL 6 (Important) (RHSA-2020:2106)");
...
referenced in the RHSA-2020:2106 advisory.
    ...
    This release of Red Hat Single Sign-On 7.3.8 on RHEL 6 serves as a replacement for Red Hat Single Sign-On
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2106.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6160572a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2106");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/KEYCLOAK-13797");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Single Sign-On 7.3.8 package based on the guidance in RHSA-2020:2106.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-sso7-keycloak-4.8.20-1.Final_redhat_00001.1.el6sso', 'release':'6', 'el_string':'el6sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'},
      {'reference':'rh-sso7-keycloak-server-4.8.20-1.Final_redhat_00001.1.el6sso', 'release':'6', 'el_string':'el6sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'}
    ]
  }
];
