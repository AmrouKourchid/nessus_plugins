...
# extracted from Red Hat Security Advisory RHSA-2024:3066. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3066");

  script_name(english:"RHEL 8 : exempi (RHSA-2024:3066)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for exempi.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:3066 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3066.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0bdeb261");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3066");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL exempi package based on the guidance in RHSA-2024:3066.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'exempi-2.4.5-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'exempi-devel-2.4.5-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
