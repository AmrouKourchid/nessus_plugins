...
# extracted from Ubuntu Security Notice USN-6012-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6012-1");

  script_name(english:"Ubuntu 22.04 LTS : Smarty vulnerability (USN-6012-1)");
...
USN-6012-1 advisory.
    ...
    It was discovered that Smarty incorrectly parsed blocks' names and included files' names. A remote
    attacker with template writing permissions could use this issue to execute arbitrary PHP code.
    (CVE-2022-29221)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6012-1");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'smarty3', 'pkgver': '3.1.39-2ubuntu1.22.04.1'}
];
