...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0011.html");
...
"Update the affected lcms, lcms-devel and / or python-lcms packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-5317");
...
var pkgs = [
    {'reference':'lcms-1.15-1.2.2.el5_2.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lcms-devel-1.15-1.2.2.el5_2.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-lcms-1.15-1.2.2.el5_2.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lcms-1.15-1.2.2.el5_2.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lcms-devel-1.15-1.2.2.el5_2.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-lcms-1.15-1.2.2.el5_2.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
