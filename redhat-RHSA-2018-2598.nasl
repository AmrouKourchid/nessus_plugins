...
# extracted from Red Hat Security Advisory RHSA-2018:2598. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2598");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"RHEL 7 : opendaylight (RHSA-2018:2598)");
...
the RHSA-2018:2598 advisory.

    OpenDaylight (ODL) is a modular open platform for customizing and automating networks of any size and
    scale. The OpenDaylight Project arose out of the SDN movement, with a clear focus on network
    programmability.
    ...
    * Previously, when there are no DPNs associated with the controller, an Invalid dpnId, for example, zero,
    was selected as the NAPT Switch. Since the dpnId was zero, necessary flows for supporting external
    connectivity for VMs were missing in the pipeline. So VMs were unable to connect to internet.
    Now, the Invalid dpnId is not chosen as an NAPT Switch and as soon as a new DPN is associated with the
    OpenDaylight controller, it will schedule the NAPT Switches for all the routers, that did not have the
    NAPT switch scheduled.
    As a result, VMs are now able to reach internet. (BZ#1597304)

    * Some flows were missing from the ARP table and the flow programming generated an error due to a missing
    group. As a result, L2 failed and affected most of the traffic.
    The flow programming now waits for the group to be added. The group is always present and L2 traffic
    succeeds. (BZ#1598399)

    * In OVS2.9, conntrack adds extra headers that the OpenFlow plugin cannot parse. As a result, traffic from
    the VM to a PNF on external network failed.
    The extra headers are now explicit cleared. Traffic to PNF on external network does not fail. (BZ#1600608)

    * Some flows were missing from the SNAT table and the flow programming generated an error due to a missing
    group. As a result, SNAT traffic from compute, where the flow is missing,  failed and affected most of the
    traffic.
    As a result, the flow programming now waits for the group to be added.  The group is always present and
    SNAT works. (BZ#1602404)

    * Previously, the transaction did not close in netvirt.vpnmanager.VpnOpStatusListener. This resulted in
    memory leaks at scale and/or in longevity. This issue has been resolved and now OpenDaylight requires less
    memory to run. (BZ#1607965)

    * Previously, the transaction did not close in netvirt.fibmanager.VrfEntryListener. This resulted in
    memory leaks at scale and/or in longevity. This issue has been resolved and OpenDaylight now requires less
    memory to run. (BZ#1585227)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_2598.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1ce3242c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1573391");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1585227");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1597236");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1597304");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1598399");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1600608");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1602187");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1602188");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1602404");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1607965");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1609383");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1612057");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2598");
...
"Update the RHEL opendaylight package based on the guidance in RHSA-2018:2598.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-10237");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:opendaylight");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'opendaylight-8.3.0-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'opendaylight');
}
