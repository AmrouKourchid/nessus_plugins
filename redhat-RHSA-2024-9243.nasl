...
# extracted from Red Hat Security Advisory RHSA-2024:9243. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9243");

  script_name(english:"RHEL 9 : postfix (RHSA-2024:9243)");
...
the RHSA-2024:9243 advisory.

    The postfix packages provide a Mail Transport Agent (MTA), which supports protocols like LDAP, SMTP AUTH
    (SASL), and TLS.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9243.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56e109ee");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9243");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postfix package based on the guidance in RHSA-2024:9243.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:postfix-cdb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:postfix-ldap");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:postfix-lmdb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:postfix-mysql");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:postfix-pcre");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:postfix-perl-scripts");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:postfix-pgsql");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:postfix-sqlite");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postfix-3.5.25-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-cdb-3.5.25-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-ldap-3.5.25-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-lmdb-3.5.25-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-mysql-3.5.25-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-pcre-3.5.25-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-perl-scripts-3.5.25-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-pgsql-3.5.25-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-sqlite-3.5.25-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'postfix / postfix-cdb / postfix-ldap / postfix-lmdb / postfix-mysql / etc');
}
