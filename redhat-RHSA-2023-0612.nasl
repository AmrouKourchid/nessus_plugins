...
referenced in the RHSA-2023:0612 advisory.
    ...
    The following packages have been upgraded to a later upstream version: rh-nodejs14-nodejs (14.21.1), rh-
    nodejs14-nodejs-nodemon (2.0.20). (BZ#2129806, BZ#2135519, BZ#2135520, BZ#2141022)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0612.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0e213b2c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0612");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2009880");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2129806");
...
"Update the RHEL rh-nodejs14-nodejs / rh-nodejs14-nodejs-nodemon packages based on the guidance in RHSA-2023:0612.");
  ...
  script_cwe_id(350, 400, 601, 1321, 1333);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs14-nodejs-14.21.1-3.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-nodejs14-nodejs-devel-14.21.1-3.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-nodejs14-nodejs-full-i18n-14.21.1-3.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-nodejs14-npm-6.14.17-14.21.1.3.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
