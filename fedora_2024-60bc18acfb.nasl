...
# extracted from Fedora Security Advisory FEDORA-2024-60bc18acfb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-60bc18acfb");

  script_name(english:"Fedora 38 : dotnet6.0 (2024-60bc18acfb)");
...
FEDORA-2024-60bc18acfb advisory.

    This the January 2024 update for .NET 6. Release Notes: https://github.com/dotnet/core/blob/main/release-
    notes/6.0/6.0.26/6.0.26.md

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-60bc18acfb");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.126-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
