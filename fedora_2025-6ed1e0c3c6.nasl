...
# extracted from Fedora Security Advisory FEDORA-2025-6ed1e0c3c6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-6ed1e0c3c6");

  script_name(english:"Fedora 40 : python-jinja2 (2025-6ed1e0c3c6)");
...
FEDORA-2025-6ed1e0c3c6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-6ed1e0c3c6");
...
var pkgs = [
    {'reference':'python-jinja2-3.1.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
