...
if (description)
{
  ...
  script_cve_id("CVE-2017-6886");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-6886");
...
patch available.
  ...
  - An error within the parse_tiff_ifd() function (internal/dcraw_common.cpp) in LibRaw versions before
    0.18.2 can be exploited to corrupt memory. (CVE-2017-6886)
