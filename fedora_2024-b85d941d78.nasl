...
# extracted from Fedora Security Advisory FEDORA-2024-b85d941d78
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b85d941d78");

  script_name(english:"Fedora 41 : chromium (2024-b85d941d78)");
...
FEDORA-2024-b85d941d78 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b85d941d78");
...
var pkgs = [
    {'reference':'chromium-129.0.6668.58-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
