...
# extracted from Red Hat Security Advisory RHSA-2025:0168. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0168");

  script_name(english:"RHEL 8 : iperf3 (RHSA-2025:0168)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0168.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2c7fc1fa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0168");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL iperf3 package based on the guidance in RHSA-2025:0168.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'iperf3-3.5-11.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
