...
# extracted from Fedora Security Advisory FEDORA-2024-07b7b83a4f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-07b7b83a4f");

  script_name(english:"Fedora 39 : R (2024-07b7b83a4f)");
...
FEDORA-2024-07b7b83a4f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-07b7b83a4f");
...
var pkgs = [
    {'reference':'R-4.3.3-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
