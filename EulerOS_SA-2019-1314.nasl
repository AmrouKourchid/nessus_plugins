...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libvirt (EulerOS-SA-2019-1314)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1314
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d1fd8e9e");
...
pkgs = ["libvirt-daemon-config-network-2.0.0-10.10.h5",
        "libvirt-daemon-config-nwfilter-2.0.0-10.10.h5",
        "libvirt-daemon-driver-interface-2.0.0-10.10.h5",
        "libvirt-daemon-driver-lxc-2.0.0-10.10.h5",
        "libvirt-daemon-driver-network-2.0.0-10.10.h5",
        "libvirt-daemon-driver-nodedev-2.0.0-10.10.h5",
        "libvirt-daemon-driver-nwfilter-2.0.0-10.10.h5",
        "libvirt-daemon-driver-qemu-2.0.0-10.10.h5",
        "libvirt-daemon-driver-secret-2.0.0-10.10.h5",
        "libvirt-daemon-driver-storage-2.0.0-10.10.h5",
        "libvirt-daemon-kvm-2.0.0-10.10.h5"];
