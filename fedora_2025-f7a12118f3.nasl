...
# extracted from Fedora Security Advisory FEDORA-2025-f7a12118f3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-f7a12118f3");

  script_name(english:"Fedora 40 : mingw-libxslt (2025-f7a12118f3)");
...
FEDORA-2025-f7a12118f3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-f7a12118f3");
...
var pkgs = [
    {'reference':'mingw-libxslt-1.1.43-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
