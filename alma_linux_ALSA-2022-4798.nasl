...
# AlmaLinux Security Advisory ALSA-2022:4798.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:4798");

  script_name(english:"AlmaLinux 8 : maven:3.5 (ALSA-2022:4798)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2022:4798 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-4798.html");
...
var appstreams = {
    'maven:3.5': [
      {'reference':'jansi-1.17.1-1.module_el8.6.0+2752+f1f3449e', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jansi-native-1.7-7.module_el8.6.0+2752+f1f3449e', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'slf4j-1.7.25-4.module_el8.6.0+2752+f1f3449e', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'jansi-1.17.1-1.module_el8.0.0+6044+f3cbc35d', 'release':'8', 'el_string':'el8.0.0', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'maven-shared-utils-3.2.1-0.2.module_el8.6.0+2902+097a4293', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'slf4j-1.7.25-4.module_el8.5.0+2577+9e95fe00', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE}
    ]
};
