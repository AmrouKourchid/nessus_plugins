...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2023-A-0656-S");

  script_name(english:"Foxit PDF Editor < 2023.3 Multiple Vulnerabilities");
...
Windows host is prior to 2023.3. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor version 2023.3 or later");
...
var constraints = [
  { 'max_version' : '10.1.12.37872', 'fixed_version' : '2023.3' },
  { 'min_version' : '11.0', 'max_version' : '11.2.7.53812', 'fixed_version' : '2023.3' },
  { 'min_version' : '12.0', 'max_version' : '12.1.3.15356', 'fixed_version' : '2023.3' },
  {       'equal' : '13.0.0.21632', 'fixed_version' : '2023.3'},
  { 'min_version' : '2023.1.0.15510', 'fixed_version' : '2023.3' },
  { 'min_version' : '2023.2.0.21408', 'fixed_version' : '2023.3' }
];
