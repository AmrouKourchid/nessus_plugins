...
# extracted from Red Hat Security Advisory RHSA-2024:1498. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1498");

  script_name(english:"RHEL 7 : thunderbird (RHSA-2024:1498)");
...
referenced in the RHSA-2024:1498 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1498.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e3de501");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1498");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2024:1498.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-115.9.0-1.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-115.9.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
