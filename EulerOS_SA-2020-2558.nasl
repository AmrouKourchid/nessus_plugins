...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : perl-DBD-MySQL (EulerOS-SA-2020-2558)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2558
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc7bee6e");
...
"Update the affected perl-DBD-MySQL package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-1251");
...
pkgs = ["perl-DBD-MySQL-4.023-6.h1.eulerosv2r7"];
