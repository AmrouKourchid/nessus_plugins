...
the USN-5841-1 advisory.
    ...
    leading to a denial of service, or possibly execute arbitrary code with user privileges. This issue was
    only fixed in Ubuntu 14.04 ESM. (CVE-2019-14973, CVE-2019-17546, CVE-2020-35523, CVE-2020-35524,
    CVE-2022-3970)

    It was discovered that LibTIFF was incorrectly acessing a data structure when processing data with the
    tiffcrop tool, which could lead to a heap buffer overflow. An attacker could possibly use this issue to
    cause a denial of service or execute arbitrary code. (CVE-2022-48281)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libtiff-opengl', 'pkgver': '4.0.6-1ubuntu0.8+esm9', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiff-tools', 'pkgver': '4.0.6-1ubuntu0.8+esm9', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiff5', 'pkgver': '4.0.6-1ubuntu0.8+esm9', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiff5-dev', 'pkgver': '4.0.6-1ubuntu0.8+esm9', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libtiffxx5', 'pkgver': '4.0.6-1ubuntu0.8+esm9', 'ubuntu_pro': TRUE}
];
