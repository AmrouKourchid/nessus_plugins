...
# extracted from Fedora Security Advisory FEDORA-2023-83b529bd34
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-83b529bd34");

  script_name(english:"Fedora 38 : dcmtk (2023-83b529bd34)");
...
FEDORA-2023-83b529bd34 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-83b529bd34");
...
var pkgs = [
    {'reference':'dcmtk-3.6.7-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
