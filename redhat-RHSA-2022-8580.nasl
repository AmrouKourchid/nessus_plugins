...
# extracted from Red Hat Security Advisory RHSA-2022:8580. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8580");
  script_xref(name:"IAVA", value:"2022-A-0491-S");

  script_name(english:"RHEL 9 : firefox (RHSA-2022:8580)");
...
referenced in the RHSA-2022:8580 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8580.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?934ef9b1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8580");
...
"Update the RHEL firefox package based on the guidance in RHSA-2022:8580.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.5.0-1.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
