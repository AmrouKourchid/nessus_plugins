...
# extracted from Ubuntu Security Notice USN-2913-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : ca-certificates update (USN-2913-1)");
...
USN-2913-1 advisory.
    ...
    certificates to those contained in the 20160104 package, including the removal of the SPI CA and CA
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2913-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'ca-certificates', 'pkgver': '20160104ubuntu0.14.04.1'}
];
