...
# extracted from Oracle Linux Security Advisory ELSA-2020-5499.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2020-7774", "CVE-2020-8277", "CVE-2020-15366");
  script_xref(name:"IAVB", value:"2020-B-0070-S");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Oracle Linux 8 : nodejs:12 (ELSA-2020-5499)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2020-5499 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-5499.html");
...
var appstreams = {
    'nodejs:12': [
      {'reference':'nodejs-12.19.1-1.module+el8.3.0+7884+668e4ef8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-12.19.1-1.module+el8.3.0+7884+668e4ef8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-docs-12.19.1-1.module+el8.3.0+7884+668e4ef8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-12.19.1-1.module+el8.3.0+7884+668e4ef8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'npm-6.14.8-1.12.19.1.1.module+el8.3.0+7884+668e4ef8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-12.19.1-1.module+el8.3.0+7884+668e4ef8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-12.19.1-1.module+el8.3.0+7884+668e4ef8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-docs-12.19.1-1.module+el8.3.0+7884+668e4ef8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-12.19.1-1.module+el8.3.0+7884+668e4ef8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'npm-6.14.8-1.12.19.1.1.module+el8.3.0+7884+668e4ef8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
};
