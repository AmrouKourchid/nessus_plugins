...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 10.0.3 < 10.0.5");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 10.0.5. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_10.0.5_security-10 advisory.
...
var constraints = [
  { 'min_version' : '10.0.3', 'max_version' : '10.0.4', 'fixed_version' : '10.0.5' }
];
