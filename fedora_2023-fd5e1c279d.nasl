...
# extracted from Fedora Security Advisory FEDORA-2023-fd5e1c279d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fd5e1c279d");

  script_name(english:"Fedora 36 : firefox (2023-fd5e1c279d)");
...
FEDORA-2023-fd5e1c279d advisory.

    - Updated to latest upstream (111.0)

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fd5e1c279d");
...
var pkgs = [
    {'reference':'firefox-111.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
