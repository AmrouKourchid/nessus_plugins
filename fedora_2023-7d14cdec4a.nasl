...
# extracted from Fedora Security Advisory FEDORA-2023-7d14cdec4a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7d14cdec4a");
  script_xref(name:"IAVA", value:"2023-A-0124-S");

  script_name(english:"Fedora 38 : httpd (2023-7d14cdec4a)");
...
FEDORA-2023-7d14cdec4a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7d14cdec4a");
...
var pkgs = [
    {'reference':'httpd-2.4.56-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
