...
# extracted from Debian Security Advisory DSA-4808. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4808");

  script_name(english:"Debian DSA-4808-1 : apt - security update");
...
when processing malformed deb files.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/apt");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4808");
...
flag = 0;
if (deb_check(release:"10.0", prefix:"apt", reference:"1.8.2.2")) flag++;
if (deb_check(release:"10.0", prefix:"apt-doc", reference:"1.8.2.2")) flag++;
if (deb_check(release:"10.0", prefix:"apt-transport-https", reference:"1.8.2.2")) flag++;
if (deb_check(release:"10.0", prefix:"apt-utils", reference:"1.8.2.2")) flag++;
if (deb_check(release:"10.0", prefix:"libapt-inst2.0", reference:"1.8.2.2")) flag++;
if (deb_check(release:"10.0", prefix:"libapt-pkg-dev", reference:"1.8.2.2")) flag++;
if (deb_check(release:"10.0", prefix:"libapt-pkg-doc", reference:"1.8.2.2")) flag++;
if (deb_check(release:"10.0", prefix:"libapt-pkg5.0", reference:"1.8.2.2")) flag++;
