...
# extracted from Fedora Security Advisory FEDORA-2023-3661f028b8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3661f028b8");

  script_name(english:"Fedora 37 : kernel / kernel-headers / kernel-tools (2023-3661f028b8)");
...
FEDORA-2023-3661f028b8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3661f028b8");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-3661f028b8');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.4.4-100.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-headers-6.4.4-100.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-tools-6.4.4-100.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
