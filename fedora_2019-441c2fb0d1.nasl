...
# extracted from Fedora Security Advisory FEDORA-2019-441c2fb0d1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : jhead (2019-441c2fb0d1)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-441c2fb0d1");
...
"Update the affected jhead package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-1010302");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"jhead-3.03-4.fc29")) flag++;
