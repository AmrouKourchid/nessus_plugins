...
if (description)
{
  ...
  script_cve_id("CVE-2010-2936");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2010-2936");
...
patch available.
  ...
  - Integer overflow in simpress.bin in the Impress module in OpenOffice.org (OOo) 2.x and 3.x before 3.3
    allows remote attackers to cause a denial of service (application crash) or possibly execute arbitrary
    code via crafted polygons in a PowerPoint document that triggers a heap-based buffer overflow.
    (CVE-2010-2936)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-2936");
