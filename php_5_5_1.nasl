...
if (description)
{
  ...
  script_name(english:"PHP 5.5.x < 5.5.1 xml.c Buffer Overflow");
...
but instead relies only on PHP's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.php.net/ChangeLog-5.php#5.5.1");
