...
# extracted from Red Hat Security Advisory RHSA-2025:0837. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0837");

  script_name(english:"RHEL 8 : unbound (RHSA-2025:0837)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for unbound.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:0837 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0837.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?827034e0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0837");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL unbound package based on the guidance in RHSA-2025:0837.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-unbound-1.16.2-5.8.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unbound-1.16.2-5.8.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unbound-devel-1.16.2-5.8.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unbound-libs-1.16.2-5.8.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
