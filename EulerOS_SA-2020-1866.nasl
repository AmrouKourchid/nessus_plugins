...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libvncserver (EulerOS-SA-2020-1866)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1866
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a6722dfc");
...
pkgs = ["libvncserver-0.9.11-8.h3.eulerosv2r8"];
