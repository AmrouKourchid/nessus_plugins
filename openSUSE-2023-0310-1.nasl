...
# openSUSE Security Update openSUSE-SU-2023:0310-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-Django (openSUSE-SU-2023:0310-1)");
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/GDMEHEWSNLOLUUMODXKYDRGKFKV2UQ42/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ddc9f80d");
...
"Update the affected python3-Django package.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2023/10/21");
...
var pkgs = [
    {'reference':'python3-Django-2.2.28-bp154.2.15.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
