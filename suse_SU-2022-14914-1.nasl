...
# SUSE update advisory SUSE-SU-2022:14914-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:14914-1");
  script_xref(name:"IAVB", value:"2021-B-0021-S");

  script_name(english:"SUSE SLES11 Security Update : squid3 (SUSE-SU-2022:14914-1)");
...
the SUSE-SU-2022:14914-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-March/010444.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0c1175a");
...
var pkgs = [
    {'reference':'squid3-3.1.23-8.16.37.18.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
