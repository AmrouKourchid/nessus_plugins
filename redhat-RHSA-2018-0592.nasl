...
# extracted from Red Hat Security Advisory RHSA-2018:0592. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : slf4j (RHSA-2018:0592)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for slf4j.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:0592 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0592.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e6fc44ef");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0592");
...
"Update the RHEL slf4j package based on the guidance in RHSA-2018:0592.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:slf4j-javadoc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:slf4j-manual");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'slf4j-1.7.4-4.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'slf4j-javadoc-1.7.4-4.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'slf4j-manual-1.7.4-4.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
