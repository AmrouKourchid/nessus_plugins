...
# extracted from VMware Security Advisory PHSA-2025-5.0-0439. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libsoup PHSA-2025-5.0-0439");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libsoup package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-439.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libsoup-3.2.1-17.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libsoup-devel-3.2.1-17.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libsoup-lang-3.2.1-17.ph5')) flag++;
