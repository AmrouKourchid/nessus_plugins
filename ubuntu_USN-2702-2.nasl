...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Ubufox update (USN-2702-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2702-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'ubufox', 'pkgver': '3.1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'xul-ext-ubufox', 'pkgver': '3.1-0ubuntu0.14.04.1'}
];
