...
# extracted from F5 Networks BIG-IP Solution K000149915.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : zlib vulnerability (K000149915)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K000149915 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K000149915");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.5.0 17.1.0-17.1.2','16.1.0-16.1.6','15.1.0-15.1.10'
    ],
  },
  'APM': {
    'affected': [
