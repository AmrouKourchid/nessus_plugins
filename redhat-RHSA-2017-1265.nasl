...
referenced in the RHSA-2017:1265 advisory.
    ...
    * It was found that Samba always requested forwardable tickets when using Kerberos authentication. A
    service to which Samba authenticated using Kerberos could subsequently use the ticket to impersonate Samba
    to other services or domain users. (CVE-2016-2125)

    * A flaw was found in the way Samba handled PAC (Privilege Attribute Certificate) checksums. A remote,
    authenticated attacker could use this flaw to crash the winbindd process. (CVE-2016-2126)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_1265.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f5327b16");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:1265");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1403114");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1403115");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1429472");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL samba package based on the guidance in RHSA-2017:1265.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'libsmbclient-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsmbclient-devel-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwbclient-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwbclient-devel-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-client-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-client-libs-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-libs-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-common-tools-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-dc-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-dc-libs-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-devel-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-krb5-printing-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-libs-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-pidl-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-python-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-test-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-test-libs-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-vfs-glusterfs-4.4.4-13.el7_3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-clients-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-krb5-locator-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'samba-winbind-modules-4.4.4-13.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
