...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : gnupg2 (EulerOS-SA-2021-1435)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1435
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4fe0f96");
...
pkgs = ["gnupg2-2.0.22-5.h3.eulerosv2r7"];
