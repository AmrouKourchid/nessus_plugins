...
if (description)
{
  ...
  script_name(english:"CentOS 9 : wavpack-5.4.0-5.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for wavpack.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
wavpack-5.4.0-5.el9 build changelog.

  - heap Out-of-bounds Read (CVE-2021-44269)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=23143");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream wavpack package.");
