...
# extracted from Ubuntu Security Notice USN-7256-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7256-1");

  script_name(english:"Ubuntu 20.04 LTS : Ruby vulnerabilities (USN-7256-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 20.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-7256-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7256-1");
...
"Update the affected libruby2.7, ruby2.7 and / or ruby2.7-dev packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-43398");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libruby2.7', 'pkgver': '2.7.0-5ubuntu1.16'},
    {'osver': '20.04', 'pkgname': 'ruby2.7', 'pkgver': '2.7.0-5ubuntu1.16'},
    {'osver': '20.04', 'pkgname': 'ruby2.7-dev', 'pkgver': '2.7.0-5ubuntu1.16'}
];
