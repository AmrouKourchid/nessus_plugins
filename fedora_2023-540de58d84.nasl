...
# extracted from Fedora Security Advisory FEDORA-2023-540de58d84
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-540de58d84");

  script_name(english:"Fedora 38 : slurm (2023-540de58d84)");
...
FEDORA-2023-540de58d84 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-540de58d84");
...
var pkgs = [
    {'reference':'slurm-22.05.11-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
