...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Cyrus PHSA-2020-2.0-0216");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'cyrus-sasl-2.1.26-15.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'cyrus-sasl-debuginfo-2.1.26-15.ph2')) flag++;
