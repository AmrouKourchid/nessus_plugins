...
if (description)
{
  ...
  script_cve_id("CVE-2023-4785", "CVE-2023-33953");

  script_name(english:"EulerOS 2.0 SP9 : grpc (EulerOS-SA-2023-3332)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3332
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d3e0196");
