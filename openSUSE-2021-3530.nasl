...
# openSUSE Security Update openSUSE-SU-2021:3530-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : dnsmasq (openSUSE-SU-2021:3530-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the openSUSE-SU-2021:3530-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/2DP73HQCB6UNPUB54KPOZEMBUQDVN6M6/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?93e24926");
...
var pkgs = [
    {'reference':'dnsmasq-2.86-7.14.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-utils-2.86-7.14.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
