...
"The remote Red Hat host is missing a security update for swtpm.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8100.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30499438");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2090219");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL swtpm package based on the guidance in RHSA-2022:8100.");
