...
# extracted from Red Hat Security Advisory RHSA-2024:10090. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10090");

  script_name(english:"RHEL 9 : tigervnc (RHSA-2024:10090)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10090.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5303db3f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10090");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tigervnc package based on the guidance in RHSA-2024:10090.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tigervnc-1.14.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-icons-1.14.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-license-1.14.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-selinux-1.14.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-server-1.14.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-server-minimal-1.14.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-server-module-1.14.1-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
