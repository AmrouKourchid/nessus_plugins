...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : python-pip (EulerOS-SA-2024-1020)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?55a9a4f0");
...
var pkgs = [
  "python-pip-wheel-18.0-13.h9.eulerosv2r9",
  "python3-pip-18.0-13.h9.eulerosv2r9"
];
