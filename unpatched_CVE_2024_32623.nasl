...
if (description)
{
  ...
  script_cve_id("CVE-2024-32623");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-32623");
...
patch available.
  ...
  - HDF5 Library through 1.14.3 contains a heap-based buffer overflow in H5VM_array_fill in H5VM.c (called
    from H5S_select_elements in H5Spoint.c). (CVE-2024-32623)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32623");
