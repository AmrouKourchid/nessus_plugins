...
SSLv2 connections.");
  ...
  script_set_attribute(attribute: "cvss3_score_source", value: "CVE-2016-0800");
...
var vuln = FALSE;
var ssl_versions = get_kb_list_or_exit("SSL/Transport/" + port);
...
var supported_ciphers = get_kb_list_or_exit("SSL/Ciphers/" + port);
supported_ciphers = make_list(supported_ciphers);

if (!max_index(supported_ciphers)) exit(1, "No ciphers were found for port " + port + ".");

var c_report = cipher_report(supported_ciphers, name:vuln_cipher_suites_regex);
