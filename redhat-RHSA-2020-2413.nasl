...
if (description)
{
  ...
  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.5 (RHSA-2020:2413)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.5.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2413.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f04565e3");
...
"Update the RHEL OpenShift Container Platform 4.5 package based on the guidance in RHSA-2020:2413.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'machine-config-daemon-4.5.0-202007012112.p0.git.2527.d12c3da.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-8945']},
      {'reference':'openshift-hyperkube-4.5.0-202007012112.p0.git.0.582d7fc.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2019-11252', 'CVE-2019-11254', 'CVE-2020-8558', 'CVE-2020-9283']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.5.0-202007012112.p0.git.0.582d7fc.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2019-11252', 'CVE-2019-11254', 'CVE-2020-8558', 'CVE-2020-9283']}
    ]
  }
];
