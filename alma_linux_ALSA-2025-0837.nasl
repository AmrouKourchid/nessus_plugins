...
# AlmaLinux Security Advisory ALSA-2025:0837.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:0837");
  script_xref(name:"RHSA", value:"2025:0837");

  script_name(english:"AlmaLinux 8 : unbound (ALSA-2025:0837)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2025:0837 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2025-0837.html");
...
var pkgs = [
    {'reference':'python3-unbound-1.16.2-5.8.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'unbound-1.16.2-5.8.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'unbound-devel-1.16.2-5.8.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'unbound-libs-1.16.2-5.8.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
