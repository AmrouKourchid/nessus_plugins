...
if (description)
{
  ...
  script_name(english:"Adobe AIR for Mac <= 18.0.0.180 Multiple Vulnerabilities (APSB15-16)");
...
Mac OS X host is equal or prior to 18.0.0.180. It is, therefore,
affected by multiple vulnerabilities :

  - Multiple type confusion errors exist that allow an
    attacker to execute arbitrary code. (CVE-2015-5554, CVE-2015-5555,
...
fixed_version_for_report = '18.0.0.199';
