...
# extracted from Red Hat Security Advisory RHSA-2018:1278. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : java-1.7.0-openjdk (RHSA-2018:1278)");
...
referenced in the RHSA-2018:1278 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1278.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f4a0508");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1278");
...
"Update the RHEL java-1.7.0-openjdk package based on the guidance in RHSA-2018:1278.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.7.0-openjdk-1.7.0.181-2.6.14.5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-accessibility-1.7.0.181-2.6.14.5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-demo-1.7.0.181-2.6.14.5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-devel-1.7.0.181-2.6.14.5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-headless-1.7.0.181-2.6.14.5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-javadoc-1.7.0.181-2.6.14.5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-openjdk-src-1.7.0.181-2.6.14.5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
