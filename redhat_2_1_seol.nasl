...
if (description)
{
  ...
  script_name(english:"Red Hat Enterprise Linux SEoL (2.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Red Hat Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Red Hat Enterprise Linux is 2.1.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of Red Hat Enterprise Linux that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2009/05/31");
...
var constraints = [
  { max_branch : '2.1', min_branch : '2.1', seol : 20090531 }
];
