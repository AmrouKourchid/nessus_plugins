...
referenced in the RHSA-2019:3335 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3335.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f92dcb29");
...
"Update the RHEL python27:2.7 package based on the guidance in RHSA-2019:3335.");
  ...
  'python27:2.7': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'python2-2.7.16-12.module+el8.1.0+4148+33a50073', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-debug-2.7.16-12.module+el8.1.0+4148+33a50073', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-devel-2.7.16-12.module+el8.1.0+4148+33a50073', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-libs-2.7.16-12.module+el8.1.0+4148+33a50073', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-pip-9.0.3-14.module+el8.1.0+3446+c3d52da3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-pip-wheel-9.0.3-14.module+el8.1.0+3446+c3d52da3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-requests-2.20.0-2.module+el8.1.0+3111+de3f2d8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'python2-test-2.7.16-12.module+el8.1.0+4148+33a50073', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tkinter-2.7.16-12.module+el8.1.0+4148+33a50073', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tools-2.7.16-12.module+el8.1.0+4148+33a50073', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
