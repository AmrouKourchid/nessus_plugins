...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Git PHSA-2023-4.0-0327");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'git-2.35.6-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'git-lang-2.35.6-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'git-lfs-2.12.0-17.ph4')) flag++;
