...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Wireshark PHSA-2023-4.0-0488");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wireshark-4.0.10-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wireshark-devel-4.0.10-1.ph4')) flag++;
