...
# extracted from Red Hat Security Advisory RHSA-2019:0765. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0765");

  script_name(english:"RHEL 6 / 7 : rh-python36-python (RHSA-2019:0765)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-python36-python.");
...
in the RHSA-2019:0765 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0765.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4d0ce69");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0765");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-python36-python package based on the guidance in RHSA-2019:0765.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-python36-python-3.6.3-4.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python36-python-debug-3.6.3-4.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python36-python-devel-3.6.3-4.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python36-python-libs-3.6.3-4.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python36-python-test-3.6.3-4.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python36-python-tkinter-3.6.3-4.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python36-python-tools-3.6.3-4.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-python36-python-3.6.3-7.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python36-python-debug-3.6.3-7.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python36-python-devel-3.6.3-7.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python36-python-libs-3.6.3-7.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python36-python-test-3.6.3-7.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python36-python-tkinter-3.6.3-7.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-python36-python-tools-3.6.3-7.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
