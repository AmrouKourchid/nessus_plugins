...
# extracted from Fedora Security Advisory FEDORA-2023-1caffb88af
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1caffb88af");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 39 : trafficserver (2023-1caffb88af)");
...
FEDORA-2023-1caffb88af advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1caffb88af");
...
var pkgs = [
    {'reference':'trafficserver-9.2.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
