...
# extracted from Debian Security Advisory dsa-5588. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-36367", "CVE-2023-48795");

  script_name(english:"Debian DSA-5588-1 : putty - security update");
...
dsa-5588 advisory.
  ...
  - PuTTY through 0.75 proceeds with establishing an SSH session even if it has never sent a substantive
    authentication response. This makes it easier for an attacker-controlled SSH server to present a later
    spoofed authentication prompt (that the attacker can use to capture credential data, and use that data for
    purposes that are undesired by the client user). (CVE-2021-36367)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=990901");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/putty");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/putty");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/putty");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5588");
...
For the stable distribution (bookworm), these problems have been fixed in version 0.78-2+deb12u1.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2023/12/24");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'pterm', 'reference': '0.74-1+deb11u1'},
    {'release': '11.0', 'prefix': 'putty', 'reference': '0.74-1+deb11u1'},
    {'release': '11.0', 'prefix': 'putty-doc', 'reference': '0.74-1+deb11u1'},
    {'release': '11.0', 'prefix': 'putty-tools', 'reference': '0.74-1+deb11u1'},
    {'release': '12.0', 'prefix': 'pterm', 'reference': '0.78-2+deb12u1'},
    {'release': '12.0', 'prefix': 'putty', 'reference': '0.78-2+deb12u1'},
    {'release': '12.0', 'prefix': 'putty-doc', 'reference': '0.78-2+deb12u1'},
    {'release': '12.0', 'prefix': 'putty-tools', 'reference': '0.78-2+deb12u1'}
];
