...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : krb5 (EulerOS-SA-2024-2419)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2419
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d04f0895");
...
var pkgs = [
  "krb5-1.18.2-2.h14.eulerosv2r10",
  "krb5-client-1.18.2-2.h14.eulerosv2r10",
  "krb5-libs-1.18.2-2.h14.eulerosv2r10",
  "krb5-server-1.18.2-2.h14.eulerosv2r10"
];
