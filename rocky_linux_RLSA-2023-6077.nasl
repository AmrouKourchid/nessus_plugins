...
# Rocky Linux Security Advisory RLSA-2023:6077.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:6077");
  script_xref(name:"IAVB", value:"2023-B-0080-S");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Rocky Linux 9 : toolbox (RLSA-2023:6077)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:6077");
...
var pkgs = [
    {'reference':'toolbox-0.0.99.3-10.el9_2.rocky.0.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'toolbox-debuginfo-0.0.99.3-10.el9_2.rocky.0.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'toolbox-debugsource-0.0.99.3-10.el9_2.rocky.0.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'toolbox-tests-0.0.99.3-10.el9_2.rocky.0.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
