...
if (description)
{
  ...
  script_name(english:"RHEL 6 : rubygem-activesupport (RHSA-2013:0201)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rubygem-activesupport.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2013/rhsa-2013_0201.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?178a9d68");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0201");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=903440");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rubygem-activesupport package based on the guidance in RHSA-2013:0201.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rubygem-activesupport-3.0.10-7.el6cf', 'release':'6', 'el_string':'el6cf', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
