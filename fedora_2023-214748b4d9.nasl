...
# extracted from Fedora Security Advisory FEDORA-2023-214748b4d9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-214748b4d9");

  script_name(english:"Fedora 39 : libnbd (2023-214748b4d9)");
...
FEDORA-2023-214748b4d9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-214748b4d9");
...
var pkgs = [
    {'reference':'libnbd-1.18.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
