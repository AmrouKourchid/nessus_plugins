...
# extracted from Fedora Security Advisory FEDORA-2018-25525a9346.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-25525a9346");

  script_name(english:"Fedora 27 : thunderbird-enigmail (2018-25525a9346) (EFAIL)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-25525a9346");
  # https://enigmail.net/index.php/en/home/news/66-2018-05-16-efail-vulnerability-affects-encrypted-mails
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?21a16d26");
  script_set_attribute(attribute:"solution", value:
"Update the affected thunderbird-enigmail package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-17688");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"thunderbird-enigmail-2.0.4-1.fc27")) flag++;
