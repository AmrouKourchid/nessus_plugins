...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Openjdk11 PHSA-2020-3.0-0119");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openjdk11-11.0.8-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openjdk11-doc-11.0.8-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openjdk11-src-11.0.8-1.ph3')) flag++;
