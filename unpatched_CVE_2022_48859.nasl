...
if (description)
{
  ...
  script_cve_id("CVE-2022-48859");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-48859");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: net: marvell: prestera: Add missing
    of_node_put() in prestera_switch_set_base_mac_addr This node pointer is returned by
    of_find_compatible_node() with refcount incremented. Calling of_node_put() to aovid the refcount leak.
    (CVE-2022-48859)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-48859");
