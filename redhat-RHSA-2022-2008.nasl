...
# extracted from Red Hat Security Advisory RHSA-2022:2008. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:2008");

  script_name(english:"RHEL 8 : cockpit (RHSA-2022:2008)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:2008 advisory.
    ...
    The following packages have been upgraded to a later upstream version: cockpit (264.1). (BZ#1984902,
    BZ#1992620, BZ#2004041, BZ#2008208)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_2008.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a45681c8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:2008");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cockpit-264.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'cockpit-bridge-264.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      ...
      {'reference':'cockpit-ws-264.1-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
