...
# extracted from Amazon Linux 2 Security Advisory ALASHAPROXY2-2023-002.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2018-20102", "CVE-2023-0836");

  script_name(english:"Amazon Linux 2 : haproxy2 (ALASHAPROXY2-2023-002)");
...
vulnerabilities as referenced in the ALAS2HAPROXY2-2023-002 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASHAPROXY2-2023-002.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2018-20102.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2023-0836.html");
...
"Run 'yum update haproxy2' to update your system.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-0836");
...
var pkgs = [
    {'reference':'haproxy2-2.2.17-1.amzn2.0.6', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'haproxy2'},
    {'reference':'haproxy2-2.2.17-1.amzn2.0.6', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'haproxy2'},
    {'reference':'haproxy2-2.2.17-1.amzn2.0.6', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'haproxy2'},
    {'reference':'haproxy2-debuginfo-2.2.17-1.amzn2.0.6', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'haproxy2'},
    {'reference':'haproxy2-debuginfo-2.2.17-1.amzn2.0.6', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'haproxy2'},
    {'reference':'haproxy2-debuginfo-2.2.17-1.amzn2.0.6', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'haproxy2'}
];
