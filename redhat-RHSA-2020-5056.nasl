...
# extracted from Red Hat Security Advisory RHSA-2020:5056. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-14040", "CVE-2020-14370");
  script_xref(name:"RHSA", value:"2020:5056");

  script_name(english:"RHEL 7 : podman (RHSA-2020:5056)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for podman.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:5056 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5056.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67cf0dd6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5056");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1877699");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL podman package based on the guidance in RHSA-2020:5056.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-1.6.4-26.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-1.6.4-26.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-1.6.4-26.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'podman-docker-1.6.4-26.el7_9', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
