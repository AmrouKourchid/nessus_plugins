...
if (description)
{
  ...
  script_cve_id("CVE-2024-8193");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-8193");
...
patch available.
  ...
  - Heap buffer overflow in Skia in Google Chrome prior to 128.0.6613.113 allowed a remote attacker who had
    ...
    security severity: High) (CVE-2024-8193)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-8193");
