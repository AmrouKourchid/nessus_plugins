...
# extracted from Amazon Linux AMI Security Advisory ALAS-2019-1279.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : kernel (ALAS-2019-1279)");
...
Note: The Release Date is incorrect. This CVE was fixed Nov 2018");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2019-1279.html");
