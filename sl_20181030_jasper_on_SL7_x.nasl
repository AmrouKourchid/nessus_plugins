...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : jasper on SL7.x x86_64 (20181030)");
...
"Security Fix(es) :
  ...
  - jasper: NULL pointer exception in jp2_encode()
    (CVE-2017-1000050)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1811&L=scientific-linux-errata&F=&S=&P=12383
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?560f1378");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"jasper-1.900.1-33.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"jasper-debuginfo-1.900.1-33.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"jasper-devel-1.900.1-33.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"jasper-libs-1.900.1-33.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"jasper-utils-1.900.1-33.el7")) flag++;
