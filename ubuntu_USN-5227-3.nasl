...
# extracted from Ubuntu Security Notice USN-5227-3. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-22817");
  script_xref(name:"USN", value:"5227-3");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Pillow vulnerability (USN-5227-3)");
...
in the USN-5227-3 advisory.

    USN-5227-1 fixed vulnerabilities in Pillow. It was discovered that the fix for CVE-2022-22817 was
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5227-3");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'python-pil', 'pkgver': '5.1.0-1ubuntu0.8'},
    {'osver': '18.04', 'pkgname': 'python-pil.imagetk', 'pkgver': '5.1.0-1ubuntu0.8'},
    {'osver': '18.04', 'pkgname': 'python3-pil', 'pkgver': '5.1.0-1ubuntu0.8'},
    {'osver': '18.04', 'pkgname': 'python3-pil.imagetk', 'pkgver': '5.1.0-1ubuntu0.8'},
    {'osver': '20.04', 'pkgname': 'python3-pil', 'pkgver': '7.0.0-4ubuntu0.6'},
    {'osver': '20.04', 'pkgname': 'python3-pil.imagetk', 'pkgver': '7.0.0-4ubuntu0.6'}
];
