...
# extracted from Fedora Security Advisory FEDORA-2023-88c87f6191
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-88c87f6191");

  script_name(english:"Fedora 37 : mingw-LibRaw (2023-88c87f6191)");
...
FEDORA-2023-88c87f6191 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-88c87f6191");
...
var pkgs = [
    {'reference':'mingw-LibRaw-0.20.2-9.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
