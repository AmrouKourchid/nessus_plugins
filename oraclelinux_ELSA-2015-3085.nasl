...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-3085.html");
...
"Update the affected docker-engine package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-8179");
...
var pkgs = [
    {'reference':'docker-engine-1.8.3-1.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-engine-1.8.3-1.0.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
