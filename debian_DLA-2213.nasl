...
# extracted from Debian Security Advisory DLA-2213-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2213-1 : exim4 security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/05/msg00017.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/exim4");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"exim4", reference:"4.84.2-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"exim4-base", reference:"4.84.2-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"exim4-config", reference:"4.84.2-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"exim4-daemon-heavy", reference:"4.84.2-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"exim4-daemon-heavy-dbg", reference:"4.84.2-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"exim4-daemon-light", reference:"4.84.2-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"exim4-daemon-light-dbg", reference:"4.84.2-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"exim4-dbg", reference:"4.84.2-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"exim4-dev", reference:"4.84.2-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"eximon4", reference:"4.84.2-2+deb8u7")) flag++;
