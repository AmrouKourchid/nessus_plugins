...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : docker-engine (EulerOS-SA-2024-2411)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2411
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26eaf78e");
...
var pkgs = [
  "docker-engine-18.09.0-200.h88.42.30.eulerosv2r10",
  "docker-engine-selinux-18.09.0-200.h88.42.30.eulerosv2r10"
];
