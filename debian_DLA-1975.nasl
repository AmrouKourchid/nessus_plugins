...
# extracted from Debian Security Advisory DLA-1975-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1975-1 : spip security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/10/msg00038.html");
...
"Upgrade the affected spip package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-16391");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"spip", reference:"3.0.17-2+deb8u5")) flag++;
