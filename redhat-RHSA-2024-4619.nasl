...
# extracted from Red Hat Security Advisory RHSA-2024:4619. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4619");

  script_name(english:"RHEL 9 : libndp (RHSA-2024:4619)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4619.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3e160ad4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2284122");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4619");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libndp package based on the guidance in RHSA-2024:4619.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libndp-1.8-5.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
