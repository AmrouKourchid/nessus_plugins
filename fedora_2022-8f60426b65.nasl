...
# extracted from Fedora Security Advisory FEDORA-2022-8f60426b65
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8f60426b65");

  script_name(english:"Fedora 37 : grafana (2022-8f60426b65)");
...
FEDORA-2022-8f60426b65 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8f60426b65");
...
var pkgs = [
    {'reference':'grafana-9.0.2-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
