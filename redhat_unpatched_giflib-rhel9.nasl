...
# extracted from Red Hat Security Advisory giflib. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 9 : giflib (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  # https://security.access.redhat.com/data/csaf/v2/vex/2023/cve-2023-48161.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fddba716");
