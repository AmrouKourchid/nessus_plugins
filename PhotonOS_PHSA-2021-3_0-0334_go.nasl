...
# extracted from VMware Security Advisory PHSA-2021-3.0-0334. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Go PHSA-2021-3.0-0334");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the go package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-334.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2021/11/21");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-1.17.2-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-md2man-2.0.0-9.ph3')) flag++;
