...
if (description)
{
  ...
  script_cve_id("CVE-2024-56630");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-56630");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ocfs2: free inode when
    ocfs2_get_init_inode() fails syzbot is reporting busy inodes after unmount, for commit 9c89fe0af826
    (ocfs2: Handle error from dquot_initialize()) forgot to call iput() when new_inode() succeeded and
    dquot_initialize() failed. (CVE-2024-56630)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56630");
