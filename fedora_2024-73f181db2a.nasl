...
# extracted from Fedora Security Advisory FEDORA-2024-73f181db2a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-73f181db2a");

  script_name(english:"Fedora 39 : mingw-python-urllib3 (2024-73f181db2a)");
...
FEDORA-2024-73f181db2a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-73f181db2a");
...
var pkgs = [
    {'reference':'mingw-python-urllib3-1.26.19-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
