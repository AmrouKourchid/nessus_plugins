...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:7087");

  script_name(english:"Scientific Linux Security Update : 389-ds-base on SL7.x x86_64 (2022:7087)");
...
SLSA-2022:7087-1 advisory.

  - 389-ds-base: SIGSEGV in sync_repl (CVE-2022-2850)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20227087-1");
...
var pkgs = [
    {'reference':'389-ds-base-1.3.10.2-17.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-debuginfo-1.3.10.2-17.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-devel-1.3.10.2-17.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-libs-1.3.10.2-17.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'389-ds-base-snmp-1.3.10.2-17.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
