...
# extracted from Fedora Security Advisory FEDORA-2023-03422cb8de
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-03422cb8de");

  script_name(english:"Fedora 38 : redis (2023-03422cb8de)");
...
FEDORA-2023-03422cb8de advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-03422cb8de");
...
var pkgs = [
    {'reference':'redis-7.0.13-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
