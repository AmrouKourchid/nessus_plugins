...
if (description)
{
  ...
  script_name(english:"CentOS 9 : bcel-6.4.1-9.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for bcel.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
bcel-6.4.1-9.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=27542");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream bcel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:bcel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:bcel-javadoc");
...
var pkgs = [
    {'reference':'bcel-6.4.1-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'bcel-javadoc-6.4.1-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
