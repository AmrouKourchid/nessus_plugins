...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : expat (EulerOS-SA-2022-1679)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1679
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?75c2a8f5");
...
var pkgs = [
  "expat-2.1.0-10.h10",
  "expat-devel-2.1.0-10.h10",
  "expat-static-2.1.0-10.h10"
];
