...
# extracted from Fedora Security Advisory FEDORA-2023-af4cfc9c3c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-af4cfc9c3c");

  script_name(english:"Fedora 38 : firefox (2023-af4cfc9c3c)");
...
FEDORA-2023-af4cfc9c3c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-af4cfc9c3c");
...
var pkgs = [
    {'reference':'firefox-114.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
