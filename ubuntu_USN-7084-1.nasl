...
# extracted from Ubuntu Security Notice USN-7084-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7084-1");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS / 22.04 LTS / 24.04 LTS / 24.10 : urllib3 vulnerability (USN-7084-1)");
...
affected by a vulnerability as referenced in the USN-7084-1 advisory.

    It was discovered that urllib3 didn't strip HTTP Proxy-Authorization header on cross-origin redirects. A
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7084-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-urllib3', 'pkgver': '1.13.1-2ubuntu0.16.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-urllib3', 'pkgver': '1.13.1-2ubuntu0.16.04.4+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python-urllib3', 'pkgver': '1.22-1ubuntu0.18.04.2+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3-urllib3', 'pkgver': '1.22-1ubuntu0.18.04.2+esm2', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'python3-urllib3', 'pkgver': '1.25.8-2ubuntu0.4', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'python3-urllib3', 'pkgver': '1.26.5-1~exp1ubuntu0.2', 'ubuntu_pro': FALSE},
    {'osver': '24.04', 'pkgname': 'python3-urllib3', 'pkgver': '2.0.7-1ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '24.10', 'pkgname': 'python3-urllib3', 'pkgver': '2.0.7-2ubuntu0.1', 'ubuntu_pro': FALSE}
];
