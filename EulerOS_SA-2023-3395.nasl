...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : curl (EulerOS-SA-2023-3395)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3395
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37f988ad");
...
var pkgs = [
  "curl-7.29.0-46.h28.eulerosv2r7",
  "libcurl-7.29.0-46.h28.eulerosv2r7",
  "libcurl-devel-7.29.0-46.h28.eulerosv2r7"
];
