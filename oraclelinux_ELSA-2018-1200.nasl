...
# Oracle Linux Security Advisory ELSA-2018-1200 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : patch (ELSA-2018-1200)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-1200.html");
...
var pkgs = [
    {'reference':'patch-2.7.1-10.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'patch-2.7.1-10.el7_5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
