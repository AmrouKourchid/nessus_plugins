...
# extracted from Red Hat Security Advisory RHSA-2023:0407. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0407");

  script_name(english:"RHEL 7 / 8 : OpenShift Virtualization 4.12.0 RPMs (RHSA-2023:0407)");
...
referenced in the RHSA-2023:0407 advisory.

    OpenShift Virtualization is Red Hat's virtualization solution designed for Red Hat OpenShift Container
    Platform.This advisory contains OpenShift Virtualization 4.12.0 RPMs.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2089804");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2092793");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2100495");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d5b7f4f6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0407");
...
"Update the RHEL OpenShift Virtualization 4.12.0 RPMs package based on the guidance in RHSA-2023:0407.");
  ...
  script_cwe_id(125, 200, 331, 400, 444, 1325);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'kubevirt-virtctl-4.12.0-1057.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kubevirt-virtctl-redistributable-4.12.0-1057.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'kubevirt-virtctl-4.12.0-1057.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'kubevirt-virtctl-redistributable-4.12.0-1057.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
