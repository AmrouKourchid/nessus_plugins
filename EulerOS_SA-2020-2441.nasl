...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : unbound (EulerOS-SA-2020-2441)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2441
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a0d48c3b");
...
pkgs = ["python3-unbound-1.7.3-18.h2.eulerosv2r9",
        "unbound-1.7.3-18.h2.eulerosv2r9",
        "unbound-libs-1.7.3-18.h2.eulerosv2r9"];
