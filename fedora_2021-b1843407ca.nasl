...
# extracted from Fedora Security Advisory FEDORA-2021-b1843407ca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-b1843407ca");

  script_name(english:"Fedora 33 : python3.9 (2021-b1843407ca)");
...
FEDORA-2021-b1843407ca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-b1843407ca");
...
pkgs = [
    {'reference':'python3.9-3.9.2-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
