...
# extracted from VMware Security Advisory PHSA-2022-4.0-0182. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Util PHSA-2022-4.0-0182");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the util package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-182.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'util-linux-2.37.4-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'util-linux-devel-2.37.4-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'util-linux-lang-2.37.4-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'util-linux-libs-2.37.4-1.ph4')) flag++;
