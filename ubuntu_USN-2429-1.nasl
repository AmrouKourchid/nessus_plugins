...
# extracted from Ubuntu Security Notice USN-2429-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2429-1");

  script_name(english:"Ubuntu 14.04 LTS : ppp vulnerability (USN-2429-1)");
...
USN-2429-1 advisory.
    ...
    It was discovered that ppp incorrectly handled certain options files. A local attacker could possibly use
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2429-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'ppp', 'pkgver': '2.4.5-5.1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'ppp-dev', 'pkgver': '2.4.5-5.1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'ppp-udeb', 'pkgver': '2.4.5-5.1ubuntu2.1'}
];
