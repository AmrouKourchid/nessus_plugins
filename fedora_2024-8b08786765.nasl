...
# extracted from Fedora Security Advisory FEDORA-2024-8b08786765
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8b08786765");

  script_name(english:"Fedora 40 : suricata (2024-8b08786765)");
...
FEDORA-2024-8b08786765 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8b08786765");
...
var pkgs = [
    {'reference':'suricata-7.0.7-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
