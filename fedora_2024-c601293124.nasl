...
# extracted from Fedora Security Advisory FEDORA-2024-c601293124
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c601293124");
  script_xref(name:"IAVB", value:"2024-B-0070-S");

  script_name(english:"Fedora 39 : qemu (2024-c601293124)");
...
FEDORA-2024-c601293124 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c601293124");
...
var pkgs = [
    {'reference':'qemu-8.1.3-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
