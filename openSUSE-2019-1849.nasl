...
issues :
  ...
  - CVE-2019-5852: Object leak of utility functions
    (boo#1143492)");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1143492");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1144625");
...
if ( rpm_check(release:"SUSE15.1", reference:"chromium-76.0.3809.87-lp151.2.15.1", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-debuginfo-76.0.3809.87-lp151.2.15.1", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-debugsource-76.0.3809.87-lp151.2.15.1", allowmaj:TRUE) ) flag++;
