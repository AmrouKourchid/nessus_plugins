...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : postgresql (EulerOS-SA-2021-1348)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1348
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?61da00f2");
...
"Update the affected postgresql package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-25695");
...
pkgs = ["postgresql-9.2.24-1.h1",
        "postgresql-contrib-9.2.24-1.h1",
        "postgresql-devel-9.2.24-1.h1",
        "postgresql-docs-9.2.24-1.h1",
        "postgresql-libs-9.2.24-1.h1",
        "postgresql-plperl-9.2.24-1.h1",
        "postgresql-plpython-9.2.24-1.h1",
        "postgresql-pltcl-9.2.24-1.h1",
        "postgresql-server-9.2.24-1.h1",
        "postgresql-test-9.2.24-1.h1"];
