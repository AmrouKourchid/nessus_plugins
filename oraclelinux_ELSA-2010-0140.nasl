...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : pango (ELSA-2010-0140)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0140.html");
...
"Update the affected pango and / or pango-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-0421");
...
var pkgs = [
    {'reference':'pango-1.14.9-8.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pango-devel-1.14.9-8.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pango-1.14.9-8.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pango-devel-1.14.9-8.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
