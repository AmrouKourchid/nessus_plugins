...
if (description)
{
  ...
  script_cve_id("CVE-2021-35517");
  script_xref(name:"IAVA", value:"2024-A-0412");

  script_name(english:"Atlassian Confluence 7.19.23 < 7.19.25 / 8.5.x < 8.5.12 / 8.9.x < 8.9.4 (CONFSERVER-96102)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-96102");
...
"Upgrade to Atlassian Confluence version 7.19.25, 8.5.12, 8.9.4 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-35517");
...
var constraints = [
  { 'min_version' : '7.19.23', 'fixed_version' : '7.19.25' },
  { 'min_version' : '8.5.10', 'fixed_version' : '8.5.12' },
