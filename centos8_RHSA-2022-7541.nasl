...
# Red Hat Security Advisory RHSA-2022:7541. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : redis:6 (CESA-2022:7541)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2022:7541 advisory.
...
var appstreams = {
    'redis:6': [
      {'reference':'redis-6.2.7-1.module_el8.7.0+1144+ab2666e8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-6.2.7-1.module_el8.7.0+1144+ab2666e8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-6.2.7-1.module_el8.7.0+1144+ab2666e8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-6.2.7-1.module_el8.7.0+1144+ab2666e8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-doc-6.2.7-1.module_el8.7.0+1144+ab2666e8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-doc-6.2.7-1.module_el8.7.0+1144+ab2666e8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
