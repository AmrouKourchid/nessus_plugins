...
# extracted from Red Hat Security Advisory RHSA-2020:2486. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2486");

  script_name(english:"RHEL 7 : unzip (RHSA-2020:2486)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2486.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d0ef79fa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2486");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1727761");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL unzip package based on the guidance in RHSA-2020:2486.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'unzip-6.0-20.el7_7.1', 'sp':'7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unzip-6.0-20.el7_7.1', 'sp':'7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unzip-6.0-20.el7_7.1', 'sp':'7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unzip-6.0-20.el7_7.1', 'sp':'7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
