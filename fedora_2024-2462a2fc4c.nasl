...
# extracted from Fedora Security Advisory FEDORA-2024-2462a2fc4c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2462a2fc4c");

  script_name(english:"Fedora 40 : expat (2024-2462a2fc4c)");
...
FEDORA-2024-2462a2fc4c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2462a2fc4c");
...
var pkgs = [
    {'reference':'expat-2.6.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
