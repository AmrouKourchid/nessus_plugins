...
# extracted from Fedora Security Advisory FEDORA-2022-142872d895
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-142872d895");

  script_name(english:"Fedora 38 : mujs (2022-142872d895)");
...
FEDORA-2022-142872d895 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-142872d895");
  script_set_attribute(attribute:"solution", value:
"Update the affected mujs package.");
...
var pkgs = [
    {'reference':'mujs-1.3.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
