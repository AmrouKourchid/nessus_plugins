...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : binutils (EulerOS-SA-2023-2509)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2509
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f17f4c50");
...
"Update the affected binutils packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-25587");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-25588");
...
var pkgs = [
  "binutils-2.34-1.h30.eulerosv2r9"
];
