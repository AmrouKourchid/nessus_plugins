...
# AlmaLinux Security Advisory ALSA-2023:4412.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4412");
  script_xref(name:"IAVA", value:"2023-A-0377-S");

  script_name(english:"AlmaLinux 9 : openssh (ALSA-2023:4412)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-4412.html");
