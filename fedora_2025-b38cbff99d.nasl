...
# extracted from Fedora Security Advisory FEDORA-2025-b38cbff99d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-b38cbff99d");

  script_name(english:"Fedora 40 : php-phpseclib (2025-b38cbff99d)");
...
FEDORA-2025-b38cbff99d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b38cbff99d");
...
var pkgs = [
    {'reference':'php-phpseclib-2.0.48-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
