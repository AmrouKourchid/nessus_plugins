...
# extracted from Red Hat Security Advisory RHSA-2024:4620. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4620");

  script_name(english:"RHEL 8 : libndp (RHSA-2024:4620)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4620.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aee5f70c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4620");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libndp package based on the guidance in RHSA-2024:4620.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libndp-1.7-7.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
