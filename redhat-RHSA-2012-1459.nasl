...
"The remote Red Hat host is missing a security update for nspluginwrapper.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2012/rhsa-2012_1459.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a4429b9c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1459");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=715384");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nspluginwrapper package based on the guidance in RHSA-2012:1459.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nspluginwrapper-1.4.4-1.el6_3', 'cpu':'i686', 'release':'6', 'el_string':'el6_3', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nspluginwrapper-1.4.4-1.el6_3', 'cpu':'ppc', 'release':'6', 'el_string':'el6_3', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nspluginwrapper-1.4.4-1.el6_3', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_3', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
