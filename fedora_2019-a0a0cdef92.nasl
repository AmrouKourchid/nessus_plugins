...
# extracted from Fedora Security Advisory FEDORA-2019-a0a0cdef92.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-a0a0cdef92");

  script_name(english:"Fedora 31 : varnish (2019-a0a0cdef92)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a0a0cdef92");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"varnish-6.3.0-1.fc31")) flag++;
