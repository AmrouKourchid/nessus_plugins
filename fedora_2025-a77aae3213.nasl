...
# extracted from Fedora Security Advisory FEDORA-2025-a77aae3213
#
...
if (description)
{
  ...
  script_cve_id("CVE-2025-47256");
  script_xref(name:"FEDORA", value:"2025-a77aae3213");

  script_name(english:"Fedora 41 : libxmp (2025-a77aae3213)");
...
FEDORA-2025-a77aae3213 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-a77aae3213");
  script_set_attribute(attribute:"solution", value:
"Update the affected libxmp package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:H/PR:N/UI:N/S:C/C:L/I:L/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-47256");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libxmp");
...
var pkgs = [
    {'reference':'libxmp-4.6.2-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libxmp');
}
