...
if (description)
{
  ...
  script_name(english:"PHP 7.1.x < 7.1.22 Transfer-Encoding Parameter XSS Vulnerability");
...
server is 7.1.x prior to 7.1.22. It is, therefore, affected by a
...
security context of the affected site.");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.1.22");
  script_set_attribute(attribute:"see_also", value:"https://bugs.php.net/bug.php?id=76582");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 7.1.22 or later.");
