...
# extracted from Fedora Security Advisory FEDORA-2024-6ea93e629b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6ea93e629b");

  script_name(english:"Fedora 40 : galera / mariadb10.11 (2024-6ea93e629b)");
...
FEDORA-2024-6ea93e629b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6ea93e629b");
  script_set_attribute(attribute:"solution", value:
"Update the affected 3:mariadb10.11 and / or galera packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mariadb10.11");
...
var pkgs = [
    {'reference':'galera-26.4.18-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mariadb10.11-10.11.8-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'galera / mariadb10.11');
}
