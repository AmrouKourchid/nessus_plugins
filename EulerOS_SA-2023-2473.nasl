...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : apr-util (EulerOS-SA-2023-2473)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2473
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4f115c44");
...
var pkgs = [
  "apr-util-1.6.1-12.h2.eulerosv2r10"
];
