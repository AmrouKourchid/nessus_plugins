...
# extracted from Red Hat Security Advisory python-cryptography. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : python-cryptography (Unpatched Vulnerability) (deprecated)");
