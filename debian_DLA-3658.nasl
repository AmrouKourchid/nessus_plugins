...
if (description)
{
  ...
  script_name(english:"Debian dla-3658 : wordpress - security update");
...
dla-3658 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3658-1                debian-lts@lists.debian.org
    ...
    CVE ID         : CVE-2023-5561 CVE-2023-39999
