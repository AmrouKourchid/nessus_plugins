...
Update to 1.12.0
  ...
  - Change the Go build requirement to a more flexible
    'golang(API) >= 1.12'.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1184428");
  script_set_attribute(attribute:"see_also", value:"https://docs.syncthing.net/advanced/folder-caseSensitiveFS.html");
  script_set_attribute(attribute:"see_also", value:"https://docs.syncthing.net/advanced/folder-copyrangemethod.html");
  script_set_attribute(attribute:"see_also", value:"https://docs.syncthing.net/advanced/option-connection-limits.html");
  script_set_attribute(attribute:"see_also", value:"https://docs.syncthing.net/dev/rest.html#cluster-endpoints");
  # https://forum.syncthing.net/t/testing-untrusted-encrypted-devices/16470
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6c4e0223");
  script_set_attribute(attribute:"solution", value:
"Update the affected syncthing packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-21404");
