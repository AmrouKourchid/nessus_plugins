...
# extracted from Red Hat Security Advisory RHSA-2024:1486.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2024:1486)");
...
var pkgs = [
    {'reference':'firefox-115.9.1-1.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-115.9.1-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
