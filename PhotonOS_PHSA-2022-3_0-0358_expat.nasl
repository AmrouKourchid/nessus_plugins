...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Expat PHSA-2022-3.0-0358");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'expat-2.2.9-6.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'expat-devel-2.2.9-6.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'expat-libs-2.2.9-6.ph3')) flag++;
