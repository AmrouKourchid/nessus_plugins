...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird SEoL (102.x)");
...
"Upgrade to a version of Mozilla Thunderbird that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2023/10/01");
...
var constraints = [
{ max_branch : '102', min_branch : '102', seol : 20231001 }
];
