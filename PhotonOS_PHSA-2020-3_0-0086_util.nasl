...
if (description)
{
  ...
  script_bugtraq_id(96404);

  script_name(english:"Photon OS 3.0: Util PHSA-2020-3.0-0086");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the util package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-86.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'util-linux-2.32.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'util-linux-debuginfo-2.32.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'util-linux-devel-2.32.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'util-linux-lang-2.32.1-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'util-linux-libs-2.32.1-1.ph3')) flag++;
