...
# extracted from Fedora Security Advisory FEDORA-2024-9ab2666594
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9ab2666594");

  script_name(english:"Fedora 39 : freeipa (2024-9ab2666594)");
...
FEDORA-2024-9ab2666594 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9ab2666594");
...
var pkgs = [
    {'reference':'freeipa-4.11.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
