...
# extracted from Red Hat Security Advisory kmail. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-9604", "CVE-2021-38373");

  script_name(english:"RHEL 6 : kmail (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:kdepim3");
