...
# extracted from Fedora Security Advisory FEDORA-2019-4f978cacb4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-4f978cacb4");

  script_name(english:"Fedora 28 : python-jinja2 (2019-4f978cacb4)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-4f978cacb4");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"python-jinja2-2.10.1-1.fc28")) flag++;
