...
# extracted from Red Hat Security Advisory RHSA-2019:1200. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1200");
  script_xref(name:"CEA-ID", value:"CEA-2019-0324");
  script_xref(name:"CEA-ID", value:"CEA-2019-0547");

  script_name(english:"RHEL 7 : qemu-kvm-rhev (RHSA-2019:1200)");
...
referenced in the RHSA-2019:1200 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1200.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aee65301");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1200");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2019:1200.");
