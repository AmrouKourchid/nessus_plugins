...
# extracted from Fedora Security Advisory FEDORA-2022-b050ae8974
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-b050ae8974");

  script_name(english:"Fedora 35 : java-1.8.0-openjdk (2022-b050ae8974)");
...
FEDORA-2022-b050ae8974 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-b050ae8974");
...
var pkgs = [
    {'reference':'java-1.8.0-openjdk-1.8.0.352.b08-2.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
