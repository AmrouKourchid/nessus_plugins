...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1211.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1211");

  script_name(english:"Amazon Linux 2 : python-urllib3 (ALAS-2019-1211)");
...
transmitted in cleartext.(CVE-2018-20060)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1211.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"python-urllib3-1.24.3-1.amzn2.0.1")) flag++;
