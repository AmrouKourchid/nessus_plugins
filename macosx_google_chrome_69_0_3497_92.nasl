...
prior to 69.0.3497.92. It is, therefore, affected by a vulnerability
as noted in Google Chrome stable channel update release notes for
2018/09/11. Please refer to the release notes for additional
...
google_chrome_check_version(fix:'69.0.3497.92', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
