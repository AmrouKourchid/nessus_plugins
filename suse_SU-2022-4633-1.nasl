...
# SUSE update advisory SUSE-SU-2022:4633-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4633-1");
  script_xref(name:"IAVA", value:"2023-A-0008-S");

  script_name(english:"SUSE SLES15 Security Update : curl (SUSE-SU-2022:4633-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013355.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3cbff70b");
...
var pkgs = [
    {'reference':'curl-7.66.0-150200.4.45.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_RT-release-15.3']},
    {'reference':'libcurl-devel-7.66.0-150200.4.45.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_RT-release-15.3']},
    {'reference':'libcurl4-32bit-7.66.0-150200.4.45.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_RT-release-15.3']},
    {'reference':'libcurl4-7.66.0-150200.4.45.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_RT-release-15.3']}
];
