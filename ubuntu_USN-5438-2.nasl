...
# extracted from Ubuntu Security Notice USN-5438-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5438-2");

  script_name(english:"Ubuntu 16.04 ESM : HTMLDOC vulnerability (USN-5438-2)");
...
USN-5438-2 advisory.
    ...
    USN-5438-1 fixed a vulnerability in HTMLDOC. This update provides the corresponding update for Ubuntu
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5438-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'htmldoc', 'pkgver': '1.8.27-8ubuntu1.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'htmldoc-common', 'pkgver': '1.8.27-8ubuntu1.1+esm1', 'ubuntu_pro': TRUE}
];
