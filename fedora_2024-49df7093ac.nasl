...
# extracted from Fedora Security Advisory FEDORA-2024-49df7093ac
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-49df7093ac");

  script_name(english:"Fedora 41 : python-aiohttp (2024-49df7093ac)");
...
FEDORA-2024-49df7093ac advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-49df7093ac");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-aiohttp package.");
...
var pkgs = [
    {'reference':'python-aiohttp-3.10.5-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-aiohttp');
}
