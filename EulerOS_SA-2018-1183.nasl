...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : PackageKit (EulerOS-SA-2018-1183)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1183
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e1b8f5d");
...
pkgs = ["PackageKit-1.1.5-2",
        "PackageKit-command-not-found-1.1.5-2",
        "PackageKit-glib-1.1.5-2",
        "PackageKit-gstreamer-plugin-1.1.5-2",
        "PackageKit-gtk3-module-1.1.5-2",
        "PackageKit-yum-1.1.5-2"];
