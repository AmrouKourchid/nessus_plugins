...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-14560 (deprecated)");
...
"Plugin has been deprecated due to the specified CVE being rejected by NVD.");
  ...
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:M/C:N/I:C/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:H/PR:H/UI:N/S:C/C:N/I:H/A:L");
