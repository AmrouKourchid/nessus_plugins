...
# extracted from Fedora Security Advisory FEDORA-2024-54aa5fc4b2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-54aa5fc4b2");

  script_name(english:"Fedora 41 : python3.14 (2024-54aa5fc4b2)");
...
FEDORA-2024-54aa5fc4b2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-54aa5fc4b2");
...
var pkgs = [
    {'reference':'python3.14-3.14.0~a2-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
