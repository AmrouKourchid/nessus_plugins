...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate RADIUS Protocol CVE-2024-3596 (FG-IR-24-255)");
...
Fortigate version 7.4.6 or later. For 7.6.x, upgrade to Fortigate version 7.6.1 or later.");
