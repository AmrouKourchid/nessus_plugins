...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ovmf on (20190423)");
...
"Security Fix(es) :
  ...
  - edk2: Buffer Overflow in BlockIo service for RAM disk
    (CVE-2018-12180)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1904&L=SCIENTIFIC-LINUX-ERRATA&P=6630
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2ca4b44");
...
flag = 0;
if (rpm_check(release:"SL7", reference:"OVMF-20180508-3.gitee3198e672e2.el7_6.1")) flag++;
