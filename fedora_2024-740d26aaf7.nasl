...
# extracted from Fedora Security Advisory FEDORA-2024-740d26aaf7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-740d26aaf7");

  script_name(english:"Fedora 39 : tcpreplay (2024-740d26aaf7)");
...
FEDORA-2024-740d26aaf7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-740d26aaf7");
...
var pkgs = [
    {'reference':'tcpreplay-4.5.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
