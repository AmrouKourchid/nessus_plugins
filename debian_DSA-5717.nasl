...
# extracted from Debian Security Advisory dsa-5717. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5717 : libapache2-mod-php8.2 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5717
advisory.
...
var pkgs = [
    {'release': '12.0', 'prefix': 'libapache2-mod-php8.2', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'libphp8.2-embed', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-bcmath', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-bz2', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-cgi', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-cli', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-common', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-curl', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-dba', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-dev', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-enchant', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-fpm', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-gd', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-gmp', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-imap', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-interbase', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-intl', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-ldap', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-mbstring', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-mysql', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-odbc', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-opcache', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-pgsql', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-phpdbg', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-pspell', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-readline', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-snmp', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-soap', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-sqlite3', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-sybase', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-tidy', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-xml', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-xsl', 'reference': '8.2.20-1~deb12u1'},
    {'release': '12.0', 'prefix': 'php8.2-zip', 'reference': '8.2.20-1~deb12u1'}
];
