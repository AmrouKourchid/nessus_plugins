...
# extracted from Fedora Security Advisory FEDORA-2024-589ea34c42
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-589ea34c42");

  script_name(english:"Fedora 39 : trafficserver (2024-589ea34c42)");
...
FEDORA-2024-589ea34c42 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-589ea34c42");
...
var pkgs = [
    {'reference':'trafficserver-9.2.6-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
