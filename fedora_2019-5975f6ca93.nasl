...
# extracted from Fedora Security Advisory FEDORA-2019-5975f6ca93.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-5975f6ca93");

  script_name(english:"Fedora 31 : chromium (2019-5975f6ca93)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5975f6ca93");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"chromium-78.0.3904.70-1.fc31", allowmaj:TRUE)) flag++;
