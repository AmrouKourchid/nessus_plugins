...
# extracted from Red Hat Security Advisory RHSA-2023:1365. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1365");

  script_name(english:"RHEL 9 : nss (RHSA-2023:1365)");
...
the RHSA-2023:1365 advisory.
    ...
    * In FIPS mode, nss should reject RSASSA-PSS salt lengths larger than the output size of the hash function
    used, or provide an indicator. (BZ#2177435)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1365.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89ed43f5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2170377");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2177435");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2177876");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1365");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nss package based on the guidance in RHSA-2023:1365.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nspr-4.34.0-17.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nspr-devel-4.34.0-17.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-3.79.0-17.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-devel-3.79.0-17.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-3.79.0-17.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-devel-3.79.0-17.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-freebl-3.79.0-17.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-freebl-devel-3.79.0-17.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-sysinit-3.79.0-17.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-tools-3.79.0-17.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-util-3.79.0-17.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-util-devel-3.79.0-17.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
