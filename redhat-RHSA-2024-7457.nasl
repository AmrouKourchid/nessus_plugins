...
# extracted from Red Hat Security Advisory RHSA-2024:7457. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7457");
  script_xref(name:"IAVA", value:"2024-A-0629-S");

  script_name(english:"RHEL 9 : mod_jk  update (Moderate) (RHSA-2024:7457)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-58855");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7457.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?698f6d60");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7457");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_jk-1.2.50-1.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'mod_jk-1.2.50-1.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
