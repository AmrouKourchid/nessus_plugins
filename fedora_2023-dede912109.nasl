...
# extracted from Fedora Security Advisory FEDORA-2023-dede912109
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dede912109");

  script_name(english:"Fedora 37 : python-urllib3 (2023-dede912109)");
...
FEDORA-2023-dede912109 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dede912109");
...
var pkgs = [
    {'reference':'python-urllib3-1.26.18-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
