...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : grpc (EulerOS-SA-2024-2470)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the grpc package installed, the EulerOS installation on the remote host is affected by the
...
Tenable has extracted the preceding description block directly from the EulerOS grpc security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2470
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1079f32");
  script_set_attribute(attribute:"solution", value:
"Update the affected grpc packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-4785");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:grpc");
