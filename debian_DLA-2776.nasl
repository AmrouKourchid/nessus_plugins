...
# extracted from Debian Security Advisory dla-2776. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2776-1 : apache2 - LTS security update");
...
dla-2776 advisory.
    ...
    Several vulnerabilities were discovered in the Apache HTTP server. An attacker could send proxied requests
    to arbitrary servers, corrupt memory in some setups involving third-party modules, and cause the server to
    crash. CVE-2021-34798 Malformed requests may cause the server to dereference a NULL pointer.
    CVE-2021-39275 ap_escape_quotes() may write beyond the end of a buffer when given malicious input. No
    included modules pass untrusted data to these functions, but third-party / external modules may.
    CVE-2021-40438 A crafted request uri-path can cause mod_proxy to forward the request to an origin server
    choosen by the remote user. For Debian 9 stretch, these problems have been fixed in version
    2.4.25-3+deb9u11. We recommend that you upgrade your apache2 packages. For the detailed security status of
    apache2 please refer to its security tracker page at: https://security-tracker.debian.org/tracker/apache2
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2776");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'apache2', 'reference': '2.4.25-3+deb9u11'},
    {'release': '9.0', 'prefix': 'apache2-bin', 'reference': '2.4.25-3+deb9u11'},
    {'release': '9.0', 'prefix': 'apache2-data', 'reference': '2.4.25-3+deb9u11'},
    {'release': '9.0', 'prefix': 'apache2-dbg', 'reference': '2.4.25-3+deb9u11'},
    {'release': '9.0', 'prefix': 'apache2-dev', 'reference': '2.4.25-3+deb9u11'},
    {'release': '9.0', 'prefix': 'apache2-doc', 'reference': '2.4.25-3+deb9u11'},
    {'release': '9.0', 'prefix': 'apache2-ssl-dev', 'reference': '2.4.25-3+deb9u11'},
    {'release': '9.0', 'prefix': 'apache2-suexec-custom', 'reference': '2.4.25-3+deb9u11'},
    {'release': '9.0', 'prefix': 'apache2-suexec-pristine', 'reference': '2.4.25-3+deb9u11'},
    {'release': '9.0', 'prefix': 'apache2-utils', 'reference': '2.4.25-3+deb9u11'}
];
