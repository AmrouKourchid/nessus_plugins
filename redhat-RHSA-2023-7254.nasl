...
# extracted from Red Hat Security Advisory RHSA-2023:7254. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7254.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b038c55");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7254");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dotnet8.0 package based on the guidance in RHSA-2023:7254.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aspnetcore-runtime-8.0-8.0.0-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-8.0-8.0.0-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-8.0.100-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-apphost-pack-8.0-8.0.0-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-host-8.0.0-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-hostfxr-8.0-8.0.0-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-8.0-8.0.0-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-8.0.100-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-source-built-artifacts-8.0.100-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-targeting-pack-8.0-8.0.0-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-templates-8.0-8.0.100-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'netstandard-targeting-pack-2.1-8.0.100-2.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
