...
# extracted from F5 Networks BIG-IP Solution K44994972.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (K44994972)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to 17.1.0. It is, therefore, affected by a
vulnerability as referenced in the K44994972 advisory.
    ...
    service.(CVE-2020-25704)ImpactThis vulnerability may allow a locally authenticated user to exhaust system
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K44994972");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K44994972.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.0.0','16.1.0-16.1.4','15.1.0-15.1.10','14.1.0-14.1.5','13.1.0-13.1.5','12.1.0-12.1.6','11.6.1-11.6.5'
    ],
    'unaffected': [
      '17.1.0'
    ],
