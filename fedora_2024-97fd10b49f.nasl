...
# extracted from Fedora Security Advisory FEDORA-2024-97fd10b49f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-97fd10b49f");

  script_name(english:"Fedora 41 : golang-github-cloudflare-circl (2024-97fd10b49f)");
...
FEDORA-2024-97fd10b49f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-97fd10b49f");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-github-cloudflare-circl package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-1732");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-github-cloudflare-circl");
...
var pkgs = [
    {'reference':'golang-github-cloudflare-circl-1.3.7-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-cloudflare-circl');
}
