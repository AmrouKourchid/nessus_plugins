...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : curl (EulerOS-SA-2022-1003)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1003
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cbf79005");
...
var pkgs = [
  "curl-7.69.1-2.h11.eulerosv2r9",
  "libcurl-7.69.1-2.h11.eulerosv2r9"
];
