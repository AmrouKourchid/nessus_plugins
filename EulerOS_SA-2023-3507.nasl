...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : openssl (EulerOS-SA-2023-3507)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3507
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?355dfb44");
...
var pkgs = [
  "openssl-1.1.1f-8.h45.eulerosv2r10",
  "openssl-libs-1.1.1f-8.h45.eulerosv2r10",
  "openssl-perl-1.1.1f-8.h45.eulerosv2r10",
  "openssl-pkcs11-0.4.10-1.eulerosv2r10"
];
