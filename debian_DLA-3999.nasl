...
# extracted from Debian Security Advisory dla-3999. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3999 : gir1.2-gst-plugins-base-1.0 - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-47542");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'gir1.2-gst-plugins-base-1.0', 'reference': '1.18.4-2+deb11u3'},
    {'release': '11.0', 'prefix': 'gstreamer1.0-alsa', 'reference': '1.18.4-2+deb11u3'},
    {'release': '11.0', 'prefix': 'gstreamer1.0-gl', 'reference': '1.18.4-2+deb11u3'},
    {'release': '11.0', 'prefix': 'gstreamer1.0-plugins-base', 'reference': '1.18.4-2+deb11u3'},
    {'release': '11.0', 'prefix': 'gstreamer1.0-plugins-base-apps', 'reference': '1.18.4-2+deb11u3'},
    {'release': '11.0', 'prefix': 'gstreamer1.0-x', 'reference': '1.18.4-2+deb11u3'},
    {'release': '11.0', 'prefix': 'libgstreamer-gl1.0-0', 'reference': '1.18.4-2+deb11u3'},
    {'release': '11.0', 'prefix': 'libgstreamer-plugins-base1.0-0', 'reference': '1.18.4-2+deb11u3'},
    {'release': '11.0', 'prefix': 'libgstreamer-plugins-base1.0-dev', 'reference': '1.18.4-2+deb11u3'}
];
