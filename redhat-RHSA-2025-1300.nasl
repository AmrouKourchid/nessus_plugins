...
# extracted from Red Hat Security Advisory RHSA-2025:1300. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1300");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"RHEL 9 : gcc-toolset-14-gcc (RHSA-2025:1300)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1300.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1bbc3361");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1300");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gcc-toolset-14-gcc package based on the guidance in RHSA-2025:1300.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gcc-toolset-14-gcc-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-gcc-c++-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-gcc-gfortran-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-gcc-plugin-annobin-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-gcc-plugin-devel-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-libasan-devel-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-libatomic-devel-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-libgccjit-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-libgccjit-devel-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-libitm-devel-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-liblsan-devel-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-libquadmath-devel-14.2.1-1.3.el9_5', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-libquadmath-devel-14.2.1-1.3.el9_5', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-libquadmath-devel-14.2.1-1.3.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-libstdc++-devel-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-libstdc++-docs-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-libtsan-devel-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-libubsan-devel-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-offload-nvptx-14.2.1-1.3.el9_5', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-14-offload-nvptx-14.2.1-1.3.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libasan8-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'liblsan-14.2.1-1.3.el9_5', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtsan2-14.2.1-1.3.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
