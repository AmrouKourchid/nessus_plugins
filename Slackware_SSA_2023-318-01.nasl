...
# extracted from Slackware Security Advisory SSA:2023-318-01. The text
...
if (description)
{
  ...
  script_name(english:"Slackware Linux 15.0 / current mariadb  Vulnerability (SSA:2023-318-01)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Slackware Linux host is missing a security update to mariadb.");
  script_set_attribute(attribute:"description", value:
"The version of mariadb installed on the remote host is prior to 10.11.5 / 10.11.6 / 10.5.23. It is, therefore, affected
by a vulnerability as referenced in the SSA:2023-318-01 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3379013e");
...
var flag = 0;
var constraints = [
    { 'fixed_version' : '10.5.23', 'product' : 'mariadb', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'i586' },
    { 'fixed_version' : '10.5.23', 'product' : 'mariadb', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'x86_64' },
    { 'fixed_version' : '10.11.5', 'product' : 'mariadb', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'i586' },
    { 'fixed_version' : '10.11.6', 'product' : 'mariadb', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'x86_64' }
];
