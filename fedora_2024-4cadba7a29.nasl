...
# extracted from Fedora Security Advisory FEDORA-2024-4cadba7a29
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4cadba7a29");

  script_name(english:"Fedora 41 : matrix-synapse (2024-4cadba7a29)");
...
FEDORA-2024-4cadba7a29 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4cadba7a29");
...
"Update the affected matrix-synapse package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53867");
...
var pkgs = [
    {'reference':'matrix-synapse-1.118.0-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
