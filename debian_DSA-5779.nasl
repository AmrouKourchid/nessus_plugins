...
# extracted from Debian Security Advisory dsa-5779. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5779 : cups - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5779
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/cups");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'cups', 'reference': '2.4.2-3+deb12u8'},
    {'release': '12.0', 'prefix': 'cups-bsd', 'reference': '2.4.2-3+deb12u8'},
    {'release': '12.0', 'prefix': 'cups-client', 'reference': '2.4.2-3+deb12u8'},
    {'release': '12.0', 'prefix': 'cups-common', 'reference': '2.4.2-3+deb12u8'},
    {'release': '12.0', 'prefix': 'cups-core-drivers', 'reference': '2.4.2-3+deb12u8'},
    {'release': '12.0', 'prefix': 'cups-daemon', 'reference': '2.4.2-3+deb12u8'},
    {'release': '12.0', 'prefix': 'cups-ipp-utils', 'reference': '2.4.2-3+deb12u8'},
    {'release': '12.0', 'prefix': 'cups-ppdc', 'reference': '2.4.2-3+deb12u8'},
    {'release': '12.0', 'prefix': 'cups-server-common', 'reference': '2.4.2-3+deb12u8'},
    {'release': '12.0', 'prefix': 'libcups2', 'reference': '2.4.2-3+deb12u8'},
    {'release': '12.0', 'prefix': 'libcups2-dev', 'reference': '2.4.2-3+deb12u8'},
    {'release': '12.0', 'prefix': 'libcupsimage2', 'reference': '2.4.2-3+deb12u8'},
    {'release': '12.0', 'prefix': 'libcupsimage2-dev', 'reference': '2.4.2-3+deb12u8'}
];
