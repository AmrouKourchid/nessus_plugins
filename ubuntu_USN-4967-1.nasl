...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : nginx vulnerability (USN-4967-1)");
...
in the USN-4967-1 advisory.

    Luis Merino, Markus Vervier, and Eric Sesterhenn discovered that nginx incorrectly handled responses to
    the DNS resolver. A remote attacker could use this issue to cause nginx to crash, resulting in a denial of
