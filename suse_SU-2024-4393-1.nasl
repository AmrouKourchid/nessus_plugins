...
# SUSE update advisory SUSE-SU-2024:4393-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:4393-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : python-grpcio (SUSE-SU-2024:4393-1)");
...
vulnerabilities as referenced in the SUSE-SU-2024:4393-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-December/020035.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?017be264");
...
var pkgs = [
    {'reference':'python311-grpcio-1.60.1-150600.16.8.1', 'sp':'6', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.6']},
    {'reference':'python311-grpcio-1.60.1-150600.16.8.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.6', 'sle-module-public-cloud-release-15.6', 'sles-release-15.6']},
    {'reference':'python311-grpcio-1.60.1-150600.16.8.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']}
];
