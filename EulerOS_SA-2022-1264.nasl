...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : compat-libtiff3 (EulerOS-SA-2022-1264)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1264
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?65561b6b");
...
var pkgs = [
  "compat-libtiff3-3.9.4-11.h26.eulerosv2r7"
];
