...
# AlmaLinux Security Advisory ALSA-2024:1908.
##
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-1908.html");
...
"Update the affected firefox and / or firefox-x11 packages.");
  ...
  script_cwe_id(120, 125, 190, 356, 416, 843);
...
var pkgs = [
    {'reference':'firefox-115.10.0-1.el9_3.alma.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-115.10.0-1.el9_3.alma.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-x11-115.10.0-1.el9_3.alma.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-x11-115.10.0-1.el9_3.alma.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
