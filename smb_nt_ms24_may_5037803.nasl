...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5037780");
  script_xref(name:"MSKB", value:"5037803");
  script_xref(name:"MSFT", value:"MS24-5037780");
  script_xref(name:"MSFT", value:"MS24-5037803");
  script_xref(name:"IAVA", value:"2024-A-0282-S");

  script_name(english:"KB5037803: Windows Server 2008 R2 Security Update (May 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5037780");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5037803");
...
if (("windows server 2008 r2" >< tolower(os_name)) &&
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'05_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5037803, 5037780])
)
{
