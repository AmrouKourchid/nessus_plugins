...
# extracted from Red Hat Security Advisory RHSA-2024:10788. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 9 : postgresql:16 (RHSA-2024:10788)");
...
referenced in the RHSA-2024:10788 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10788.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85bba43b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10788");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:16 package based on the guidance in RHSA-2024:10788.");
  ...
  'postgresql:16': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'postgresql-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-16.6-1.module+el9.5.0+22557+8cb08ba5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
