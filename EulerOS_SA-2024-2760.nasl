...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.12.1 : python-pip (EulerOS-SA-2024-2760)");
...
Tenable has extracted the preceding description block directly from the EulerOS Virtualization python-pip security
advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2760
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0c70e91");
...
var pkgs = [
  "python-pip-wheel-21.3.1-2.h4.eulerosv2r12",
  "python3-pip-21.3.1-2.h4.eulerosv2r12"
];
