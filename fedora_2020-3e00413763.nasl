...
# extracted from Fedora Security Advisory FEDORA-2020-3e00413763.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : mingw-openjpeg2 / openjpeg2 (2020-3e00413763)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-3e00413763");
...
"Update the affected mingw-openjpeg2 and / or openjpeg2 packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-27845");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"mingw-openjpeg2-2.3.1-11.fc33")) flag++;
if (rpm_check(release:"FC33", reference:"openjpeg2-2.3.1-10.fc33")) flag++;
