...
# extracted from Ubuntu Security Notice USN-7352-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7352-1");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/05/27");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : FreeType vulnerability (USN-7352-1)");
...
in the USN-7352-1 advisory.

    It was discovered that FreeType incorrectly handled certain memory operations when parsing font subglyph
    structures. A remote attacker could use this issue to cause FreeType to crash, resulting in a denial of
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7352-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'freetype2-demos', 'pkgver': '2.10.1-2ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'libfreetype-dev', 'pkgver': '2.10.1-2ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'libfreetype6', 'pkgver': '2.10.1-2ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'libfreetype6-dev', 'pkgver': '2.10.1-2ubuntu0.4'},
    {'osver': '22.04', 'pkgname': 'freetype2-demos', 'pkgver': '2.11.1+dfsg-1ubuntu0.3'},
    {'osver': '22.04', 'pkgname': 'libfreetype-dev', 'pkgver': '2.11.1+dfsg-1ubuntu0.3'},
    {'osver': '22.04', 'pkgname': 'libfreetype6', 'pkgver': '2.11.1+dfsg-1ubuntu0.3'},
    {'osver': '22.04', 'pkgname': 'libfreetype6-dev', 'pkgver': '2.11.1+dfsg-1ubuntu0.3'}
];
