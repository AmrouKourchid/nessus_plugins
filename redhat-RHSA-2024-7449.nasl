...
# extracted from Red Hat Security Advisory RHSA-2024:7449. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7449");

  script_name(english:"RHEL 8 : git-lfs (RHSA-2024:7449)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7449.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eb32e6f6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7449");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL git-lfs package based on the guidance in RHSA-2024:7449.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-lfs-2.11.0-2.el8_4.3', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-lfs-2.11.0-2.el8_4.3', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
