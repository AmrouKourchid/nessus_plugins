...
# extracted from Red Hat Security Advisory RHSA-2019:3044. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3044");

  script_name(english:"RHEL 6 : Red Hat Single Sign-On 7.3.4 security update on RHEL 6 (Important) (RHSA-2019:3044)");
...
referenced in the RHSA-2019:3044 advisory.
    ...
    This release of Red Hat Single Sign-On 7.3.4 on RHEL 6 serves as a replacement for Red Hat Single Sign-On
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3044.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5c8f0377");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3044");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/KEYCLOAK-11454");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Single Sign-On 7.3.4 package based on the guidance in RHSA-2019:3044.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-sso7-keycloak-4.8.13-1.Final_redhat_00001.1.el6sso', 'release':'6', 'el_string':'el6sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'},
      {'reference':'rh-sso7-keycloak-server-4.8.13-1.Final_redhat_00001.1.el6sso', 'release':'6', 'el_string':'el6sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'}
    ]
  }
];
