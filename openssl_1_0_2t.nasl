...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.0.2 < 1.0.2t Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.0.2t. It is, therefore, affected by multiple
vulnerabilities as referenced in the 1.0.2t advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2c98b1de");
  # https://git.openssl.org/gitweb/?p=openssl.git;a=commitdiff;h=21c856b75d81eff61aa63b4f036bb64a85bf6d46
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?41db39fc");
  # https://git.openssl.org/gitweb/?p=openssl.git;a=commitdiff;h=d333ebaf9c77332754a9d5e111e2f53e1de54fdd
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd4abed7");
...
"Upgrade to OpenSSL version 1.0.2t or later.");
...
var constraints = [
  { 'min_version' : '1.0.2', 'fixed_version' : '1.0.2t' }
];
