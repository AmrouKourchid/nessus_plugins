...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : sqlite (EulerOS-SA-2023-3369)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3369
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e67c6d25");
...
var pkgs = [
  "sqlite-3.37.2-3.h2.eulerosv2r11"
];
