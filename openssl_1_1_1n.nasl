...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.1.1 < 1.1.1n Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.1.1n. It is, therefore, affected by a vulnerability as
referenced in the 1.1.1n advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.cve.org/CVERecord?id=CVE-2022-0778");
...
var constraints = [
  { 'min_version' : '1.1.1', 'fixed_version' : '1.1.1n' }
];
