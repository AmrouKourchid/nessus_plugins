...
# extracted from Fedora Security Advisory FEDORA-2024-364516d49a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-364516d49a");

  script_name(english:"Fedora 38 : chromium (2024-364516d49a)");
...
FEDORA-2024-364516d49a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-364516d49a");
...
var pkgs = [
    {'reference':'chromium-121.0.6167.160-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
