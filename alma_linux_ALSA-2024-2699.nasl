...
# AlmaLinux Security Advisory ALSA-2024:2699.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:2699");
  script_xref(name:"IAVB", value:"2024-B-0032-S");

  script_name(english:"AlmaLinux 8 : git-lfs (ALSA-2024:2699)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-2699.html");
