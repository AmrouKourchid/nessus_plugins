...
# extracted from Red Hat Security Advisory RHSA-2021:3296. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3296");

  script_name(english:"RHEL 7 : libX11 (RHSA-2021:3296)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libX11.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:3296 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3296.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?59ffb714");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3296");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1961822");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libX11 package based on the guidance in RHSA-2021:3296.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'libX11-1.6.7-4.el7_9', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-1.6.7-4.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-1.6.7-4.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-1.6.7-4.el7_9', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-1.6.7-4.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'libX11-devel-1.6.7-4.el7_9', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-devel-1.6.7-4.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-devel-1.6.7-4.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-devel-1.6.7-4.el7_9', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libX11-devel-1.6.7-4.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
