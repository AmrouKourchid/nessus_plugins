...
# extracted from Fedora Security Advisory FEDORA-2018-a24754252a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : xen (2018-a24754252a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a24754252a");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"xen-4.11.0-8.fc29")) flag++;
