...
"The version of microcode_ctl installed on the remote host is prior to 2.1-47.39. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS-2020-1396 advisory.
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-47.39.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'microcode_ctl-2.1-47.39.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'microcode_ctl-debuginfo-2.1-47.39.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'microcode_ctl-debuginfo-2.1-47.39.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
