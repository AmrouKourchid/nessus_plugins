...
# extracted from Fedora Security Advisory FEDORA-2024-8fd3285bd9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8fd3285bd9");

  script_name(english:"Fedora 38 : dotnet7.0 (2024-8fd3285bd9)");
...
FEDORA-2024-8fd3285bd9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8fd3285bd9");
...
var pkgs = [
    {'reference':'dotnet7.0-7.0.117-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
