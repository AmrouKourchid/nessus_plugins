...
referenced in the USN-4675-1 advisory.
    ...
    Pritam Singh discovered that OpenStack Horizon incorrectly validated certain parameters. An attacker could
    possibly use this issue to cause OpenStack Horizon to redirect to a malicious URL.
