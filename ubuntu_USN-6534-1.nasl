...
# extracted from Ubuntu Security Notice USN-6534-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6534-1");

  script_name(english:"Ubuntu 22.04 LTS / 23.04 : Linux kernel vulnerabilities (USN-6534-1)");
...
referenced in the USN-6534-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6534-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1010-starfive");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1017-aws");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1017-oracle");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1018-azure-fde");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1018-raspi");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-39-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-39-generic-64k");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-39-generic-lpae");
...
var kernel_mappings = {
  '22.04': {
    '6.2.0': {
      'aws': '6.2.0-1017',
      'azure-fde': '6.2.0-1018'
    }
  },
  '23.04': {
    '6.2.0': {
      'generic': '6.2.0-39',
      'generic-64k': '6.2.0-39',
      'generic-lpae': '6.2.0-39',
      'starfive': '6.2.0-1010',
      'oracle': '6.2.0-1017',
      'raspi': '6.2.0-1018'
    }
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6534-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-3773', 'CVE-2023-5158', 'CVE-2023-5178', 'CVE-2023-5717', 'CVE-2023-6039', 'CVE-2023-37453', 'CVE-2023-39189', 'CVE-2023-39192', 'CVE-2023-39193', 'CVE-2023-39194', 'CVE-2023-39198', 'CVE-2023-42754');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6534-1');
  }
  else
  {
