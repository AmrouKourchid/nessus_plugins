...
# extracted from Fedora Security Advisory FEDORA-2022-f321e2cec0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f321e2cec0");

  script_name(english:"Fedora 38 : python3.6 (2022-f321e2cec0)");
...
FEDORA-2022-f321e2cec0 advisory.

    Automatic update for python3.6-3.6.15-15.fc38.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f321e2cec0");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-15.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
