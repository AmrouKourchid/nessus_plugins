...
# extracted from Fedora Security Advisory FEDORA-2022-6beaa3bd0c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6beaa3bd0c");

  script_name(english:"Fedora 36 : mod_auth_openidc (2022-6beaa3bd0c)");
...
FEDORA-2022-6beaa3bd0c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6beaa3bd0c");
...
"Update the affected mod_auth_openidc package.");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2022/12/25");
...
var pkgs = [
    {'reference':'mod_auth_openidc-2.4.12.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
