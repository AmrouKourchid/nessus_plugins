...
# Rocky Linux Security Advisory RLSA-2022:8250.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:8250");
  script_xref(name:"IAVB", value:"2022-B-0025-S");

  script_name(english:"Rocky Linux 9 : grafana-pcp (RLSA-2022:8250)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:8250");
...
var pkgs = [
    ...
    {'reference':'grafana-pcp-3.2.0-3.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-pcp-3.2.0-3.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-pcp-debuginfo-3.2.0-3.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-pcp-debuginfo-3.2.0-3.el9', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-pcp-debuginfo-3.2.0-3.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
