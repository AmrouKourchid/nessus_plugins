...
# extracted from Fedora Security Advisory FEDORA-2024-826453ad39
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-826453ad39");

  script_name(english:"Fedora 39 : freeipa (2024-826453ad39)");
...
FEDORA-2024-826453ad39 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-826453ad39");
...
var pkgs = [
    {'reference':'freeipa-4.11.1-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
