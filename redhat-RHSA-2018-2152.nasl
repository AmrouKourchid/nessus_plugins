...
referenced in the RHSA-2018:2152 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_2152.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a92e36fa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2152");
...
"Update the RHEL ansible package based on the guidance in RHSA-2018:2152.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.4.6.0-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.4'},
      {'reference':'ansible-doc-2.4.6.0-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.4'}
    ]
  }
];
