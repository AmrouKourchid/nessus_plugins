...
# extracted from Fedora Security Advisory FEDORA-2024-32bc143584
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-32bc143584");

  script_name(english:"Fedora 41 : webkitgtk (2024-32bc143584)");
...
FEDORA-2024-32bc143584 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-32bc143584");
...
var pkgs = [
    {'reference':'webkitgtk-2.46.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
