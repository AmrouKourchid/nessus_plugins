...
# extracted from Debian Security Advisory dsa-5828. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5828 : python-aiohttp-doc - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/python-aiohttp");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'python-aiohttp-doc', 'reference': '3.8.4-1+deb12u1'},
    {'release': '12.0', 'prefix': 'python3-aiohttp', 'reference': '3.8.4-1+deb12u1'}
];
