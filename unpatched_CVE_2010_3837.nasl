...
if (description)
{
  ...
  script_cve_id("CVE-2010-3837");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2010-3837");
...
patch available.
  ...
  - MySQL 5.0 before 5.0.92, 5.1 before 5.1.51, and 5.5 before 5.5.6 allows remote authenticated users to
    ...
    also affects the original object. (CVE-2010-3837)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3837");
