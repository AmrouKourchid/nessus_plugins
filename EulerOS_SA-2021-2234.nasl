...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : xorg-x11-server (EulerOS-SA-2021-2234)");
...
following vulnerability :
  ...
  - A flaw was found in xorg-x11-server. An interger
    underflow can occur in xserver which can lead to a
    local privilege escalation. The highest threat from
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2234
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3341ff53");
...
pkgs = ["xorg-x11-server-Xephyr-1.19.5-5.h13.eulerosv2r7",
        "xorg-x11-server-Xorg-1.19.5-5.h13.eulerosv2r7",
        "xorg-x11-server-Xvfb-1.19.5-5.h13.eulerosv2r7",
        "xorg-x11-server-common-1.19.5-5.h13.eulerosv2r7"];
