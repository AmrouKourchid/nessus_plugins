...
# extracted from Red Hat Security Advisory RHSA-2023:0605. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0605");
  script_xref(name:"IAVA", value:"2023-A-0063-S");

  script_name(english:"RHEL 8 : thunderbird (RHSA-2023:0605)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0605.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d38204d2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2166591");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0605");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2023:0605.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-102.7.1-2.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
