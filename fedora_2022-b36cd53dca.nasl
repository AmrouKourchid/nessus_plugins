...
# extracted from Fedora Security Advisory FEDORA-2022-b36cd53dca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-b36cd53dca");

  script_name(english:"Fedora 35 : kernel (2022-b36cd53dca)");
...
FEDORA-2022-b36cd53dca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-b36cd53dca");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2022-b36cd53dca');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.0.11-100.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
