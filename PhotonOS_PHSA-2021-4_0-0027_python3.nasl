...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Python3 PHSA-2021-4.0-0027");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'python3-cryptography-3.3.2-1.ph4')) flag++;
