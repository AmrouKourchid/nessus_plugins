...
# extracted from Red Hat Security Advisory RHSA-2021:1343. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1343");

  script_name(english:"RHEL 7 / 8 : Ansible security update (2.9.20) (Moderate) (RHSA-2021:1343)");
...
in the RHSA-2021:1343 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1343.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2d030463");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1343");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1939349");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Ansible package based on the guidance in RHSA-2021:1343.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.9.20-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'},
      {'reference':'ansible-test-2.9.20-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-2.9.20-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'},
      {'reference':'ansible-test-2.9.20-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.9'}
    ]
  }
];
