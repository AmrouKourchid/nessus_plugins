...
"The remote Red Hat host is missing one or more security updates for mingw32-libxml2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2013:0217 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2013/rhsa-2013_0217.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8eafd299");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0217");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=787067");
...
"Update the RHEL mingw32-libxml2 package based on the guidance in RHSA-2013:0217.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-1944");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2012-5134");

  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");
  script_cwe_id(122, 125, 407, 476, 672, 787);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mingw32-libxml2-2.7.6-6.el6_3', 'release':'6', 'el_string':'el6_3', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-libxml2-static-2.7.6-6.el6_3', 'release':'6', 'el_string':'el6_3', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
