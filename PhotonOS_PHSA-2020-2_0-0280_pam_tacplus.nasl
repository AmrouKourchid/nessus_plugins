...
# extracted from VMware Security Advisory PHSA-2020-2.0-0280. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Pam_Tacplus PHSA-2020-2.0-0280");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the pam_tacplus package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-280.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'pam_tacplus-1.4.1-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'pam_tacplus-devel-1.4.1-2.ph2')) flag++;
