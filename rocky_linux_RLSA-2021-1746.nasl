...
# Rocky Linux Security Advisory RLSA-2021:1746.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2021:1746");

  script_name(english:"Rocky Linux 8 : go-toolset:rhel8 (RLSA-2021:1746)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2021:1746 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2021:1746");
...
var pkgs = [
    ...
    {'reference':'go-toolset-1.15.7-1.module+el8.4.0+396+d2d16ae3', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'go-toolset-1.15.7-1.module+el8.4.0+396+d2d16ae3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-1.15.7-1.module+el8.4.0+396+d2d16ae3', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-1.15.7-1.module+el8.4.0+396+d2d16ae3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-bin-1.15.7-1.module+el8.4.0+396+d2d16ae3', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-bin-1.15.7-1.module+el8.4.0+396+d2d16ae3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-docs-1.15.7-1.module+el8.4.0+396+d2d16ae3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-misc-1.15.7-1.module+el8.4.0+396+d2d16ae3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-race-1.15.7-1.module+el8.4.0+396+d2d16ae3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-src-1.15.7-1.module+el8.4.0+396+d2d16ae3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-tests-1.15.7-1.module+el8.4.0+396+d2d16ae3', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
