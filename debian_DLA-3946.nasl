...
# extracted from Debian Security Advisory dla-3946. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3946 : context - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-3946
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/context");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-32700");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/context");
  script_set_attribute(attribute:"solution", value:
"Upgrade the context packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:context");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'context', 'reference': '2020.03.10.20200331-1+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'context');
}
