...
# extracted from Fedora Security Advisory FEDORA-2023-d5ab1f0b44
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d5ab1f0b44");

  script_name(english:"Fedora 39 : composer (2023-d5ab1f0b44)");
...
FEDORA-2023-d5ab1f0b44 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d5ab1f0b44");
...
var pkgs = [
    {'reference':'composer-2.6.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
