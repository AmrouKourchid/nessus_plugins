...
if (description)
{
  ...
  script_bugtraq_id(57248);

  script_name(english:"LogAnalyzer userchange.php 'viewid' Parameter XSS");
...
sanitize user input to the 'viewid' parameter of the 'userchange.php'
...
security context of the affected site.");
  # https://loganalyzer.adiscon.com/news/loganalyzer-v3-6-2-v3-stable-released/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2319a239");
  script_set_attribute(attribute:"solution", value:
"Upgrade to version 3.6.2 or later.");
...
exploit = test_cgi_xss(
  ...
  dirs     : make_list(dir),
  cgi      : '/userchange.php',
  qs       : 'op=changeview&viewid=' + urlencode(str:xss_test),
  pass_str : xss_test,
  pass_re  : "DEBUG:"
);
