...
if (description)
{
  ...
  script_cve_id("CVE-2012-0877");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-0877");
...
patch available.
  ...
  - PyXML: Hash table collisions CPU usage Denial of Service (CVE-2012-0877)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-0877");
