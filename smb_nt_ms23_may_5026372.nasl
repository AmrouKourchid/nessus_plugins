...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5026372");
  script_xref(name:"MSFT", value:"MS23-5026372");
  script_xref(name:"IAVA", value:"2023-A-0248-S");
  script_xref(name:"IAVA", value:"2023-A-0249-S");

  script_name(english:"KB5026372: Windows 11 version 22H2 Security Update (May 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5026372. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5026372");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5026372");
