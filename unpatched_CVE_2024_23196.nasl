...
if (description)
{
  ...
  script_cve_id("CVE-2024-23196");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-23196");
...
patch available.
  ...
  - A race condition was found in the Linux kernel's sound/hda device driver in snd_hdac_regmap_sync()
    ...
    denial of service issue. (CVE-2024-23196)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-23196");
