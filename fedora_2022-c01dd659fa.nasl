...
# extracted from Fedora Security Advisory FEDORA-2022-c01dd659fa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c01dd659fa");

  script_name(english:"Fedora 37 : snakeyaml (2022-c01dd659fa)");
...
FEDORA-2022-c01dd659fa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c01dd659fa");
...
"Update the affected snakeyaml package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:snakeyaml");
...
var pkgs = [
    {'reference':'snakeyaml-1.32-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
