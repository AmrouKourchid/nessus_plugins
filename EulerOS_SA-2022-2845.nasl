...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : fribidi (EulerOS-SA-2022-2845)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2845
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?63bab9c2");
...
var pkgs = [
  "fribidi-1.0.10-1.h2.eulerosv2r10",
  "fribidi-devel-1.0.10-1.h2.eulerosv2r10"
];
