...
# extracted from Debian Security Advisory DLA-1805-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1805-1 : minissdpd security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/05/msg00037.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/minissdpd");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected minissdpd package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-12106");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"minissdpd", reference:"1.2.20130907-3+deb8u2")) flag++;
