...
# extracted from Red Hat Security Advisory networkmanager. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2012-2736", "CVE-2016-0764");

  script_name(english:"RHEL 6 : networkmanager (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-2736");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-0764");
