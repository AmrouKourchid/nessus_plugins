...
# extracted from Fedora Security Advisory FEDORA-2022-fff548cfab
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-fff548cfab");

  script_name(english:"Fedora 35 : vim (2022-fff548cfab)");
...
FEDORA-2022-fff548cfab advisory.

    The newest upstream commit

    Security fixes for CVE-2022-3256, CVE-2022-3324, CVE-2022-3352, CVE-2022-3235, CVE-2022-3234,
    CVE-2022-3296, CVE-2022-3297, CVE-2022-3278.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-fff548cfab");
...
"Update the affected 2:vim package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-3352");
...
var pkgs = [
    {'reference':'vim-9.0.720-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
