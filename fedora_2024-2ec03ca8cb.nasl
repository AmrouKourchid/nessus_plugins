...
# extracted from Fedora Security Advisory FEDORA-2024-2ec03ca8cb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2ec03ca8cb");

  script_name(english:"Fedora 39 : python-django (2024-2ec03ca8cb)");
...
FEDORA-2024-2ec03ca8cb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2ec03ca8cb");
...
var pkgs = [
    {'reference':'python-django-4.2.11-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
