...
# extracted from Gentoo Linux Security Advisory GLSA 202107-17.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-17");

  script_name(english:"GLSA-202107-17 : Mechanize: Command injection");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-17"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All Mechanize users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-21289");
  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:mechanize");
...
if (qpkg_check(package:"dev-ruby/mechanize", unaffected:make_list("ge 2.7.7"), vulnerable:make_list("lt 2.7.7"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Mechanize");
}
