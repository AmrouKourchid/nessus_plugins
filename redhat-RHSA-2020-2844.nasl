...
# extracted from Red Hat Security Advisory RHSA-2020:2844. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2844");

  script_name(english:"RHEL 7 : qemu-kvm (RHSA-2020:2844)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for qemu-kvm.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:2844 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2844.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2103531d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2844");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1798453");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qemu-kvm package based on the guidance in RHSA-2020:2844.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-1.5.3-160.el7_6.7', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-1.5.3-160.el7_6.7', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-common-1.5.3-160.el7_6.7', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
      {'reference':'qemu-kvm-tools-1.5.3-160.el7_6.7', 'sp':'6', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'}
    ]
  }
];
