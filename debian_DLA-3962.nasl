...
# extracted from Debian Security Advisory dla-3962. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3962 : libglib2.0-0 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-3962
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-52533");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libglib2.0-0', 'reference': '2.66.8-1+deb11u5'},
    {'release': '11.0', 'prefix': 'libglib2.0-bin', 'reference': '2.66.8-1+deb11u5'},
    {'release': '11.0', 'prefix': 'libglib2.0-data', 'reference': '2.66.8-1+deb11u5'},
    {'release': '11.0', 'prefix': 'libglib2.0-dev', 'reference': '2.66.8-1+deb11u5'},
    {'release': '11.0', 'prefix': 'libglib2.0-dev-bin', 'reference': '2.66.8-1+deb11u5'},
    {'release': '11.0', 'prefix': 'libglib2.0-doc', 'reference': '2.66.8-1+deb11u5'},
    {'release': '11.0', 'prefix': 'libglib2.0-tests', 'reference': '2.66.8-1+deb11u5'},
    {'release': '11.0', 'prefix': 'libglib2.0-udeb', 'reference': '2.66.8-1+deb11u5'}
];
