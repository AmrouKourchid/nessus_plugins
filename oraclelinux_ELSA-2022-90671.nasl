...
# extracted from Oracle Linux Security Advisory ELSA-2022-90671.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : ELSA-2022-9067-1: / firefox (ELSA-2022-90671)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9067-1.html");
...
var pkgs = [
    {'reference':'firefox-102.6.0-1.0.1.el8_7', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.6.0-1.0.1.el8_7', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
