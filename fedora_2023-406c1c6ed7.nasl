...
# extracted from Fedora Security Advisory FEDORA-2023-406c1c6ed7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-406c1c6ed7");
  script_xref(name:"IAVA", value:"2023-A-0118-S");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 37 : mingw-python3 (2023-406c1c6ed7)");
...
FEDORA-2023-406c1c6ed7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-406c1c6ed7");
...
var pkgs = [
    {'reference':'mingw-python3-3.10.10-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
