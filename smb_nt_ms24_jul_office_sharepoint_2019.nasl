...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002615");
  script_xref(name:"MSFT", value:"MS23-5002615");
  script_xref(name:"IAVA", value:"2024-A-0404-S");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/11/12");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (July 2024)");
...
affected by multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002615");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002615 to address this issue.");
