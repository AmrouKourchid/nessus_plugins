...
# extracted from Fedora Security Advisory FEDORA-2025-9e6b55e70b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-9e6b55e70b");
  script_xref(name:"IAVB", value:"2025-B-0056");

  script_name(english:"Fedora 41 : nextcloud (2025-9e6b55e70b)");
...
FEDORA-2025-9e6b55e70b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-9e6b55e70b");
...
var pkgs = [
    {'reference':'nextcloud-31.0.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
