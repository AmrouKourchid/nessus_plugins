...
# SUSE update advisory SUSE-SU-2021:2239-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2239-1");

  script_name(english:"SUSE SLES15 Security Update : crmsh (SUSE-SU-2021:2239-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-July/009111.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc20f9c3");
...
var pkgs = [
    {'reference':'crmsh-4.3.1+20210624.67223df2-3.74.1', 'sp':'0', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15']},
    {'reference':'crmsh-scripts-4.3.1+20210624.67223df2-3.74.1', 'sp':'0', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15']}
];
