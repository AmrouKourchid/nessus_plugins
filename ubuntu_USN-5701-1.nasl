...
# extracted from Ubuntu Security Notice USN-5701-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5701-1");

  script_name(english:"Ubuntu 16.04 ESM : Jinja2 vulnerability (USN-5701-1)");
...
USN-5701-1 advisory.
    ...
    Yeting Li discovered that Jinja2 incorrectly handled certain inputs. An attacker could possibly use this
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5701-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-jinja2', 'pkgver': '2.8-1ubuntu0.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-jinja2', 'pkgver': '2.8-1ubuntu0.1+esm1', 'ubuntu_pro': TRUE}
];
