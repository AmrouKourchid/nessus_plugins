...
# extracted from Fedora Security Advisory FEDORA-2023-0c1aaa76b6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0c1aaa76b6");

  script_name(english:"Fedora 37 : pdns-recursor (2023-0c1aaa76b6)");
...
FEDORA-2023-0c1aaa76b6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0c1aaa76b6");
...
var pkgs = [
    {'reference':'pdns-recursor-4.8.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
