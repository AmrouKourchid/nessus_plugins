...
# extracted from Fedora Security Advisory FEDORA-2024-d4d1e89e61
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d4d1e89e61");

  script_name(english:"Fedora 40 : iaito / radare2 (2024-d4d1e89e61)");
...
FEDORA-2024-d4d1e89e61 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d4d1e89e61");
...
var pkgs = [
    {'reference':'iaito-5.9.9-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'radare2-5.9.8-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
