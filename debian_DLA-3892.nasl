...
# extracted from Debian Security Advisory dla-3892. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3892 : tinyproxy - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-40468");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-49606");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/tinyproxy");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'tinyproxy', 'reference': '1.10.0-5+deb11u1'},
    {'release': '11.0', 'prefix': 'tinyproxy-bin', 'reference': '1.10.0-5+deb11u1'}
];
