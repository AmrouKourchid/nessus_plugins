...
# extracted from Fedora Security Advisory FEDORA-2023-76c06c8576
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-76c06c8576");
  script_xref(name:"IAVA", value:"2023-A-0376-S");

  script_name(english:"Fedora 38 : samba (2023-76c06c8576)");
...
FEDORA-2023-76c06c8576 advisory.

    Update to version 4.18.5, Security fixes for CVE-2022-2127, CVE-2023-3347, CVE-2023-34966, CVE-2023-34967
    and CVE-2023-34968
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-76c06c8576");
...
var pkgs = [
    {'reference':'samba-4.18.5-0.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
