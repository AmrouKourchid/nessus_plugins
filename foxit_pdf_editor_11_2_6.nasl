...
if (description)
{
  ...
  script_name(english:"Foxit PDF Editor < 11.2.6 Multiple Vulnerabilities");
...
Windows host is prior to 11.2.6. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PDF Editor version 11.2.6 or later");
...
var constraints = [
  { 'max_version' : '10.1.11.37866', 'fixed_version' : '11.2.6' },
