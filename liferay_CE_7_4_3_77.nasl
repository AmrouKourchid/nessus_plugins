...
if (description)
{
  ...
  script_name(english:"Liferay Portal CE  7.4.3.70 < x < 7.4.3.77 Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"An application running on a remote web server host is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The detected install of Liferay Portal CE is between 7.4.3.70 and 7.4.3.76. 
It is therefore affected by multiple vulnerabilities:

  - Cross-site request forgery (CSRF) vulnerability in the Layout module's SEO configuration 
  in Liferay Portal 7.4.3.70 through 7.4.3.76 allows remote attackers to execute arbitrary 
  ...
  7.4.3.70 through 7.4.3.76, to redirect users to arbitrary external URLs via the 
...
var constraints = [ {'min_version': '7.4.3.70' , 'fixed_version': '7.4.3.77'} ];
