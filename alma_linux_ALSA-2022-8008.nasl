...
# AlmaLinux Security Advisory ALSA-2022:8008.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:8008");

  script_name(english:"AlmaLinux 9 : buildah (ALSA-2022:8008)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2022:8008 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-8008.html");
...
"Update the affected buildah and / or buildah-tests packages.");
  ...
  script_cwe_id(20, 327, 400, 667, 842);
...
var pkgs = [
    {'reference':'buildah-1.27.0-2.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'buildah-1.27.0-2.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'buildah-tests-1.27.0-2.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'buildah-tests-1.27.0-2.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
