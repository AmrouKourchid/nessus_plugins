...
# Rocky Linux Security Advisory RLSA-2024:9281.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:9281");

  script_name(english:"RockyLinux 9 : python-jwcrypto (RLSA-2024:9281)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:9281");
...
var pkgs = [
    {'reference':'python3-jwcrypto-1.5.6-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
