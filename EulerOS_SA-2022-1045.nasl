...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : icu (EulerOS-SA-2022-1045)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the icu packages installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1045
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?566e1b4e");
...
var pkgs = [
  "icu-62.1-2.h3.eulerosv2r8",
  "libicu-62.1-2.h3.eulerosv2r8",
  "libicu-devel-62.1-2.h3.eulerosv2r8",
  "libicu-doc-62.1-2.h3.eulerosv2r8"
];
