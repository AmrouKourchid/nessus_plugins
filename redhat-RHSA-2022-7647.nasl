...
# extracted from Red Hat Security Advisory RHSA-2022:7647. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7647");

  script_name(english:"RHEL 8 : httpd:2.4 (RHSA-2022:7647)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for httpd:2.4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:7647 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7647.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e9fd8809");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7647");
...
"Update the RHEL httpd:2.4 package based on the guidance in RHSA-2022:7647.");
  ...
  script_cwe_id(125, 200, 348, 444, 770, 787, 789, 908);
  ...
  'httpd:2.4': [
    {
      ...
      'pkgs': [
        {'reference':'httpd-2.4.37-51.module+el8.7.0+16050+02173b8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-devel-2.4.37-51.module+el8.7.0+16050+02173b8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-filesystem-2.4.37-51.module+el8.7.0+16050+02173b8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-manual-2.4.37-51.module+el8.7.0+16050+02173b8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-tools-2.4.37-51.module+el8.7.0+16050+02173b8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_http2-1.15.7-5.module+el8.6.0+13996+01710940', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ldap-2.4.37-51.module+el8.7.0+16050+02173b8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_md-2.0.8-8.module+el8.3.0+6814+67d1e611', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_proxy_html-2.4.37-51.module+el8.7.0+16050+02173b8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_session-2.4.37-51.module+el8.7.0+16050+02173b8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ssl-2.4.37-51.module+el8.7.0+16050+02173b8e', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
