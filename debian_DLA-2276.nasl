...
# extracted from Debian Security Advisory DLA-2276-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2276-1 : mailman security update");
...
Cgi/private.py private archive login page.
...
For the detailed security status of mailman please refer to its
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/07/msg00007.html");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"mailman", reference:"1:2.1.23-1+deb9u6")) flag++;
