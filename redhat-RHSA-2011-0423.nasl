...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2011/rhsa-2011_0423.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?afd68cfa");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=674814");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:0423");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postfix package based on the guidance in RHSA-2011:0423.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postfix-2.6.6-2.1.el6_0', 'cpu':'i686', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-2.6.6-2.1.el6_0', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-2.6.6-2.1.el6_0', 'cpu':'s390x', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-2.6.6-2.1.el6_0', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-perl-scripts-2.6.6-2.1.el6_0', 'cpu':'i686', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-perl-scripts-2.6.6-2.1.el6_0', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-perl-scripts-2.6.6-2.1.el6_0', 'cpu':'s390x', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'postfix-perl-scripts-2.6.6-2.1.el6_0', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
