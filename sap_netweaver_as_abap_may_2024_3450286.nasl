...
if (description)
{
  ...
  script_name(english:"SAP NetWeaver AS ABAP XSS (May 2024) (3450286)");
...
scripting (XSS) vulnerability exists due to improper validation and encoding of untrusted data. An unauthenticated,
remote attacker can exploit this, by convincing a user to click a specially crafted URL, to access or modify sensitive
information within the user's browser session.
