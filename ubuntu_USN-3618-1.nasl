...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : LibVNCServer vulnerability (USN-3618-1)");
...
in the USN-3618-1 advisory.

    It was discovered that LibVNCServer incorrectly handled certain packet lengths. A remote attacker able to
    connect to a LibVNCServer could possibly use this issue to obtain sensitive information, cause a denial of
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3618-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libvncserver-config', 'pkgver': '0.9.9+dfsg-1ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'libvncserver-dev', 'pkgver': '0.9.9+dfsg-1ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'libvncserver0', 'pkgver': '0.9.9+dfsg-1ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'linuxvnc', 'pkgver': '0.9.9+dfsg-1ubuntu1.3'},
    {'osver': '16.04', 'pkgname': 'libvncclient1', 'pkgver': '0.9.10+dfsg-3ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'libvncserver-config', 'pkgver': '0.9.10+dfsg-3ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'libvncserver-dev', 'pkgver': '0.9.10+dfsg-3ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'libvncserver1', 'pkgver': '0.9.10+dfsg-3ubuntu0.16.04.2'}
];
