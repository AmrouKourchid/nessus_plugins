...
"The remote Red Hat host is missing a security update for Red Hat OpenShift Service Mesh 1.0 servicemesh-cni.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2870.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92a72db7");
...
"Update the RHEL Red Hat OpenShift Service Mesh 1.0 servicemesh-cni package based on the guidance in RHSA-2020:2870.");
