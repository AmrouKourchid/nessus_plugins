...
# openSUSE Security Update openSUSE-SU-2023:0259-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-GitPython (openSUSE-SU-2023:0259-1)");
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/ZWCDOX67N4DIYNYFBVRBOV5ED6DNNQIW/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b601505");
...
var pkgs = [
    {'reference':'python3-GitPython-3.1.12.1610074031.f653af66-bp155.3.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE}
];
