...
# Oracle Linux Security Advisory ELSA-2008-0239 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : poppler (ELSA-2008-0239)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0239.html");
...
var pkgs = [
    {'reference':'poppler-0.5.4-4.4.el5_1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-devel-0.5.4-4.4.el5_1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-utils-0.5.4-4.4.el5_1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-0.5.4-4.4.el5_1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-devel-0.5.4-4.4.el5_1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'poppler-utils-0.5.4-4.4.el5_1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
