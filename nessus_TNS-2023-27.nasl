...
if (description)
{
  ...
  script_name(english:"Tenable Nessus < 10.5.4 Multiple Vulnerabilities (TNS-2023-27)");

  script_set_attribute(attribute:"synopsis", value:
"An instance of Nessus installed on the remote system is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version, the Tenable Nessus application running on the remote host is prior to 10.5.4. It
...
number.");
  # https://docs.tenable.com/releasenotes/Content/nessus/nessus2023.htm#10.5.4
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b1d3eebd");
  script_set_attribute(attribute:"see_also", value:"https://www.tenable.com/security/TNS-2023-27");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Tenable Nessus 10.5.4 or later.");
...
var constraints = [
  { 'max_version' : '10.5.3', 'fixed_display' : '10.5.4' }
];
