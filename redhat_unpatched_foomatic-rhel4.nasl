...
# extracted from Red Hat Security Advisory foomatic. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2011-2923", "CVE-2011-2924");

  script_name(english:"RHEL 4 : foomatic (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  # https://security.access.redhat.com/data/csaf/v2/vex/2024/cve-2024-47177.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5946fd62");
