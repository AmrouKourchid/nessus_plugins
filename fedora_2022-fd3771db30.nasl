...
# extracted from Fedora Security Advisory FEDORA-2022-fd3771db30
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-fd3771db30");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"Fedora 36 : python3.9 (2022-fd3771db30)");
...
FEDORA-2022-fd3771db30 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-fd3771db30");
...
var pkgs = [
    {'reference':'python3.9-3.9.16-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
