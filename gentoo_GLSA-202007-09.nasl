...
# extracted from Gentoo Linux Security Advisory GLSA 202007-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-09");

  script_name(english:"GLSA-202007-09 : Mozilla Thunderbird: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-09
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-09");
...
if (qpkg_check(package:"mail-client/thunderbird", unaffected:make_list("ge 68.10.0"), vulnerable:make_list("lt 68.10.0"))) flag++;
if (qpkg_check(package:"mail-client/thunderbird-bin", unaffected:make_list("ge 68.10.0"), vulnerable:make_list("lt 68.10.0"))) flag++;
