...
# extracted from openSUSE Security Update openSUSE-2019-2668.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : clamav (openSUSE-2019-2668)");
...
"This update for clamav fixes the following issues :
  ...
  - CVE-2019-15961: Fixed a denial of service which might
    occur when scanning a specially crafted email file as
    (bsc#1157763).
...
if ( rpm_check(release:"SUSE15.1", reference:"clamav-0.100.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"clamav-debuginfo-0.100.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"clamav-debugsource-0.100.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"clamav-devel-0.100.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libclamav7-0.100.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libclamav7-debuginfo-0.100.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libclammspack0-0.100.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libclammspack0-debuginfo-0.100.3-lp151.2.6.1") ) flag++;
