...
# openSUSE Security Update openSUSE-SU-2021:3639-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : tinyxml (openSUSE-SU-2021:3639-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:3639-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aefff299");
...
var pkgs = [
    {'reference':'libtinyxml0-2.6.2-3.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tinyxml-devel-2.6.2-3.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
