...
# extracted from Debian Security Advisory DLA-1770-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1770-1 : gst-plugins-base1.0 security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/04/msg00031.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/gst-plugins-base1.0");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"gir1.2-gst-plugins-base-1.0", reference:"1.4.4-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"gstreamer1.0-alsa", reference:"1.4.4-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"gstreamer1.0-plugins-base", reference:"1.4.4-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"gstreamer1.0-plugins-base-apps", reference:"1.4.4-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"gstreamer1.0-plugins-base-dbg", reference:"1.4.4-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"gstreamer1.0-plugins-base-doc", reference:"1.4.4-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"gstreamer1.0-x", reference:"1.4.4-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libgstreamer-plugins-base1.0-0", reference:"1.4.4-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libgstreamer-plugins-base1.0-dev", reference:"1.4.4-2+deb8u2")) flag++;
