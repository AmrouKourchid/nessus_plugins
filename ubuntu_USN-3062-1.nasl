...
the USN-3062-1 advisory.
    ...
    sensitive data over the network, or possibly execute arbitrary code. (CVE-2016-3598, CVE-2016-3606,
    CVE-2016-3610)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3062-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'icedtea-7-jre-jamvm', 'pkgver': '7u111-2.6.7-0ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-demo', 'pkgver': '7u111-2.6.7-0ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jdk', 'pkgver': '7u111-2.6.7-0ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre', 'pkgver': '7u111-2.6.7-0ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-headless', 'pkgver': '7u111-2.6.7-0ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-lib', 'pkgver': '7u111-2.6.7-0ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-zero', 'pkgver': '7u111-2.6.7-0ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-source', 'pkgver': '7u111-2.6.7-0ubuntu0.14.04.3'}
];
