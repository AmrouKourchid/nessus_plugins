...
# extracted from Red Hat Security Advisory RHSA-2018:1707. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1707");
  script_xref(name:"IAVA", value:"2018-A-0202");

  script_name(english:"RHEL 7 : librelp (RHSA-2018:1707)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"An update for librelp is now available for Red Hat Enterprise Linux
...
and Kevin Backhouse (lgtm.com / Semmle) as the original reporters.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1707");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2018-1000140");
...
packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:librelp-debuginfo");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"3", reference:"librelp-1.2.0-4.el7_3")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", reference:"librelp-debuginfo-1.2.0-4.el7_3")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", reference:"librelp-devel-1.2.0-4.el7_3")) flag++;
