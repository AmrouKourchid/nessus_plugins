...
# extracted from Gentoo Linux Security Advisory GLSA 201805-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201805-02");

  script_name(english:"GLSA-201805-02 : Python: Buffer overflow");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201805-02
(Python: Buffer overflow)

    A buffer overflow was discovered in Python&rsquo;s PyString_DecodeEscape
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201805-02");
...
if (qpkg_check(package:"dev-lang/python", unaffected:make_list("ge 2.7.14"), vulnerable:make_list("lt 2.7.14"))) flag++;
