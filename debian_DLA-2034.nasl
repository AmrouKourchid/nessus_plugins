...
# extracted from Debian Security Advisory DLA-2034-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2034-1 : davical security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/12/msg00016.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/davical");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected davical, and davical-doc packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-18345");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:davical-doc");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"davical", reference:"1.1.3.1-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"davical-doc", reference:"1.1.3.1-1+deb8u1")) flag++;
