...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libsolv (EulerOS-SA-2021-2533)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2533
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?305ed982");
...
var pkgs = [
  "libsolv-0.7.7-2.h3.eulerosv2r9"
];
