...
# extracted from Fedora Security Advisory FEDORA-2022-30049cdcdb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-30049cdcdb");

  script_name(english:"Fedora 35 : cacti / cacti-spine (2022-30049cdcdb)");
...
FEDORA-2022-30049cdcdb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-30049cdcdb");
...
var pkgs = [
    {'reference':'cacti-1.2.22-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cacti-spine-1.2.22-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
