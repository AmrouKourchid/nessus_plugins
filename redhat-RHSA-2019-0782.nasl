...
# extracted from Red Hat Security Advisory RHSA-2019:0782. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0782");

  script_name(english:"RHEL 7 : rh-maven35-jackson-databind (RHSA-2019:0782)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rh-maven35-jackson-databind.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2019:0782 advisory.

    The jackson-databind package provides general data-binding functionality for Jackson, which works on top
    of Jackson core streaming API.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1666415");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1666418");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1666482");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1666484");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1666489");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0782.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ec88229");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0782");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-maven35-jackson-databind package based on the guidance in RHSA-2019:0782.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-maven35-jackson-databind-2.7.6-2.5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven35-jackson-databind-javadoc-2.7.6-2.5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
