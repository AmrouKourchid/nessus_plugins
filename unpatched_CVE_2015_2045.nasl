...
if (description)
{
  ...
  script_cve_id("CVE-2015-2045");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-2045");
...
patch available.
  ...
  - The HYPERVISOR_xen_version hypercall in Xen 3.2.x through 4.5.x does not properly initialize data
    structures, which allows local guest users to obtain sensitive information via unspecified vectors.
    (CVE-2015-2045)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-2045");
