...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : sysstat (EulerOS-SA-2023-2551)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2551
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?faed0022");
...
var pkgs = [
  "sysstat-12.2.1-1.h4.eulerosv2r10"
];
