...
# extracted from Red Hat Security Advisory RHSA-2020:4469. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4469");

  script_name(english:"RHEL 8 : cups (RHSA-2020:4469)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for cups.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:4469 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4469.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb7c2ab0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4469");
...
"Update the RHEL cups package based on the guidance in RHSA-2020:4469.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cups-2.2.6-38.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-client-2.2.6-38.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-devel-2.2.6-38.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-filesystem-2.2.6-38.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-ipptool-2.2.6-38.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-libs-2.2.6-38.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'cups-lpd-2.2.6-38.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
