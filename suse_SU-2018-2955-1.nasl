...
# extracted from SUSE update advisory SUSE-SU-2018:2955-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : libX11 (SUSE-SU-2018:2955-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20182955-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?53c4d422");
...
SUSE-SLE-Module-Basesystem-15-2018-2082=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", cpu:"x86_64", reference:"libX11-6-32bit-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"x86_64", reference:"libX11-6-32bit-debuginfo-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"x86_64", reference:"libX11-xcb1-32bit-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"x86_64", reference:"libX11-xcb1-32bit-debuginfo-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"libX11-6-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"libX11-6-debuginfo-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"libX11-debugsource-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"libX11-devel-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"libX11-xcb1-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"libX11-xcb1-debuginfo-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", cpu:"x86_64", reference:"libX11-6-32bit-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", cpu:"x86_64", reference:"libX11-6-32bit-debuginfo-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", cpu:"x86_64", reference:"libX11-xcb1-32bit-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", cpu:"x86_64", reference:"libX11-xcb1-32bit-debuginfo-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"libX11-6-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"libX11-6-debuginfo-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"libX11-debugsource-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"libX11-devel-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"libX11-xcb1-1.6.5-3.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"libX11-xcb1-debuginfo-1.6.5-3.3.1")) flag++;
