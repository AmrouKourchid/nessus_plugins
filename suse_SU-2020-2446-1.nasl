...
# extracted from SUSE update advisory SUSE-SU-2020:2446-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : curl (SUSE-SU-2020:2446-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?84889d07");
...
zypper in -t patch SUSE-SLE-Module-Basesystem-15-SP1-2020-2446=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"libcurl4-32bit-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"libcurl4-32bit-debuginfo-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"curl-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"curl-debuginfo-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"curl-debugsource-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libcurl-devel-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libcurl4-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libcurl4-debuginfo-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"libcurl4-32bit-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"libcurl4-32bit-debuginfo-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"curl-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"curl-debuginfo-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"curl-debugsource-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"libcurl-devel-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"libcurl4-7.60.0-3.32.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"libcurl4-debuginfo-7.60.0-3.32.1")) flag++;
