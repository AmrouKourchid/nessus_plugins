...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Git PHSA-2017-0038");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'git-2.14.2-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'git-debuginfo-2.14.2-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'git-lang-2.14.2-1.ph1')) flag++;
