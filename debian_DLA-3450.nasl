...
# extracted from Debian Security Advisory dla-3450. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3450 : libruby2.5 - security update");
...
dla-3450 advisory.
    ...
    - -----------------------------------------------------------------------
    Debian LTS Advisory DLA-3450-1              debian-lts@lists.debian.org
    ...
    CVE ID         : CVE-2021-33621 CVE-2022-28739
    Debian Bug     : 1009957 1024800 1037178

    A couple of security issues were discovered in ruby2.5, the Ruby
    interpreter, and are as follows -
    ...
    For Debian 10 buster, these problems have been fixed, along with the
    regressions caused by the last Ruby update, in version 2.5.5-3+deb10u6.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libruby2.5', 'reference': '2.5.5-3+deb10u6'},
    {'release': '10.0', 'prefix': 'ruby2.5', 'reference': '2.5.5-3+deb10u6'},
    {'release': '10.0', 'prefix': 'ruby2.5-dev', 'reference': '2.5.5-3+deb10u6'},
    {'release': '10.0', 'prefix': 'ruby2.5-doc', 'reference': '2.5.5-3+deb10u6'}
];
