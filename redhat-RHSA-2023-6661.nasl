...
# extracted from Red Hat Security Advisory RHSA-2023:6661. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6661");

  script_name(english:"RHEL 9 : gmp (RHSA-2023:6661)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6661.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?536315cc");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6661");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gmp package based on the guidance in RHSA-2023:6661.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gmp-6.2.0-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'gmp-c++-6.2.0-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'gmp-devel-6.2.0-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
