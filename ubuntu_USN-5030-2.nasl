...
# extracted from Ubuntu Security Notice USN-5030-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5030-2");

  script_name(english:"Ubuntu 16.04 ESM : Perl DBI module vulnerabilities (USN-5030-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5030-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libdbi-perl', 'pkgver': '1.634-1ubuntu0.2+esm1', 'ubuntu_pro': TRUE}
];
