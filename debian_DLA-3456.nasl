...
if (description)
{
  ...
  script_name(english:"Debian dla-3456 : python-requests - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3456
advisory.
...
"Upgrade the python-requests packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:python-requests");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:python3-requests");
