...
# extracted from Ubuntu Security Notice USN-5427-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5427-1");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : Apport vulnerabilities (USN-5427-1)");
...
vulnerabilities as referenced in the USN-5427-1 advisory.
    ...
    attacker could possibly use this issue to fill up the Apport log file, leading to denial of service.
    (CVE-2022-28654)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5427-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'apport', 'pkgver': '2.20.9-0ubuntu7.28'},
    {'osver': '18.04', 'pkgname': 'apport-gtk', 'pkgver': '2.20.9-0ubuntu7.28'},
    {'osver': '18.04', 'pkgname': 'apport-kde', 'pkgver': '2.20.9-0ubuntu7.28'},
    {'osver': '18.04', 'pkgname': 'apport-noui', 'pkgver': '2.20.9-0ubuntu7.28'},
    {'osver': '18.04', 'pkgname': 'apport-retrace', 'pkgver': '2.20.9-0ubuntu7.28'},
    {'osver': '18.04', 'pkgname': 'apport-valgrind', 'pkgver': '2.20.9-0ubuntu7.28'},
    {'osver': '18.04', 'pkgname': 'dh-apport', 'pkgver': '2.20.9-0ubuntu7.28'},
    {'osver': '18.04', 'pkgname': 'python-apport', 'pkgver': '2.20.9-0ubuntu7.28'},
    {'osver': '18.04', 'pkgname': 'python-problem-report', 'pkgver': '2.20.9-0ubuntu7.28'},
    {'osver': '18.04', 'pkgname': 'python3-apport', 'pkgver': '2.20.9-0ubuntu7.28'},
    {'osver': '18.04', 'pkgname': 'python3-problem-report', 'pkgver': '2.20.9-0ubuntu7.28'},
    {'osver': '20.04', 'pkgname': 'apport', 'pkgver': '2.20.11-0ubuntu27.24'},
    {'osver': '20.04', 'pkgname': 'apport-gtk', 'pkgver': '2.20.11-0ubuntu27.24'},
    {'osver': '20.04', 'pkgname': 'apport-kde', 'pkgver': '2.20.11-0ubuntu27.24'},
    {'osver': '20.04', 'pkgname': 'apport-noui', 'pkgver': '2.20.11-0ubuntu27.24'},
    {'osver': '20.04', 'pkgname': 'apport-retrace', 'pkgver': '2.20.11-0ubuntu27.24'},
    {'osver': '20.04', 'pkgname': 'apport-valgrind', 'pkgver': '2.20.11-0ubuntu27.24'},
    {'osver': '20.04', 'pkgname': 'dh-apport', 'pkgver': '2.20.11-0ubuntu27.24'},
    {'osver': '20.04', 'pkgname': 'python3-apport', 'pkgver': '2.20.11-0ubuntu27.24'},
    {'osver': '20.04', 'pkgname': 'python3-problem-report', 'pkgver': '2.20.11-0ubuntu27.24'},
    {'osver': '22.04', 'pkgname': 'apport', 'pkgver': '2.20.11-0ubuntu82.1'},
    {'osver': '22.04', 'pkgname': 'apport-gtk', 'pkgver': '2.20.11-0ubuntu82.1'},
    {'osver': '22.04', 'pkgname': 'apport-kde', 'pkgver': '2.20.11-0ubuntu82.1'},
    {'osver': '22.04', 'pkgname': 'apport-noui', 'pkgver': '2.20.11-0ubuntu82.1'},
    {'osver': '22.04', 'pkgname': 'apport-retrace', 'pkgver': '2.20.11-0ubuntu82.1'},
    {'osver': '22.04', 'pkgname': 'apport-valgrind', 'pkgver': '2.20.11-0ubuntu82.1'},
    {'osver': '22.04', 'pkgname': 'dh-apport', 'pkgver': '2.20.11-0ubuntu82.1'},
    {'osver': '22.04', 'pkgname': 'python3-apport', 'pkgver': '2.20.11-0ubuntu82.1'},
    {'osver': '22.04', 'pkgname': 'python3-problem-report', 'pkgver': '2.20.11-0ubuntu82.1'}
];
