...
# Oracle Linux Security Advisory ELSA-2018-1414 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : firefox (ELSA-2018-1414)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-1414.html");
...
var pkgs = [
    {'reference':'firefox-52.8.0-1.0.1.el6_9', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-52.8.0-1.0.1.el6_9', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
