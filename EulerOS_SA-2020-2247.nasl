...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : golang (EulerOS-SA-2020-2247)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2247
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?74364d9d");
...
pkgs = ["golang-1.13.3-8.eulerosv2r7",
        "golang-bin-1.13.3-8.eulerosv2r7",
        "golang-src-1.13.3-8.eulerosv2r7"];
