...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2546250");
...
code execution.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-061");
