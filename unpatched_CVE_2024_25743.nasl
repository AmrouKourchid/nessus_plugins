...
if (description)
{
  ...
  script_cve_id("CVE-2024-25743");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-25743");
...
patch available.
  ...
  - In the Linux kernel through 6.9, an untrusted hypervisor can inject virtual interrupts 0 and 14 at any
    point in time and can trigger the SIGFPE signal handler in userspace applications. This affects AMD SEV-
    SNP and AMD SEV-ES. (CVE-2024-25743)
