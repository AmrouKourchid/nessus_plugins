...
# extracted from Fedora Security Advisory FEDORA-2023-93aa6807da
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-93aa6807da");

  script_name(english:"Fedora 39 : tor (2023-93aa6807da)");
...
FEDORA-2023-93aa6807da advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-93aa6807da");
...
var pkgs = [
    {'reference':'tor-0.4.8.10-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
