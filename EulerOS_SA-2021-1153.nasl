...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libvncserver (EulerOS-SA-2021-1153)");
...
vulnerabilities :
  ...
  - An issue was discovered in LibVNCServer before 0.9.13.
    libvncserver/ws_decode.c can lead to a crash because of
    unaligned accesses in
    hybiReadAndDecode.(CVE-2019-20840)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1153
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1b17f665");
...
pkgs = ["libvncserver-0.9.11-8.h5.eulerosv2r8"];
