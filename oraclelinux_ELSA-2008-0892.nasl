...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0892.html");
...
"Update the affected xen, xen-devel and / or xen-libs packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-1945");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2008-1952");
...
var pkgs = [
    {'reference':'xen-3.0.3-64.el5_2.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-devel-3.0.3-64.el5_2.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-libs-3.0.3-64.el5_2.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-3.0.3-64.el5_2.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-devel-3.0.3-64.el5_2.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xen-libs-3.0.3-64.el5_2.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
