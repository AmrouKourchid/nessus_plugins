...
# extracted from Fedora Security Advisory FEDORA-2024-3fa713f2e0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3fa713f2e0");

  script_name(english:"Fedora 40 : iwd (2024-3fa713f2e0)");
...
FEDORA-2024-3fa713f2e0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3fa713f2e0");
...
var pkgs = [
    {'reference':'iwd-2.16-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
