...
if (description)
{
  ...
  script_name(english:"Adobe Digital Editions < 4.5.8 Multiple Information Disclosure (APSB18-13) (macOS)");
...
"The version of Adobe Digital Editions installed on the remote macOS host is prior to 4.5.8. It is, therefore, affected
by multiple vulnerabilities as referenced in the APSB18-13 advisory.

  - Adobe Digital Editions versions 4.5.7 and below have an exploitable Out-of-bounds read vulnerability.
    Successful exploitation could lead to information disclosure. (CVE-2018-4925)

  - Adobe Digital Editions versions 4.5.7 and below have an exploitable Stack Overflow vulnerability.
    Successful exploitation could lead to information disclosure. (CVE-2018-4926)
