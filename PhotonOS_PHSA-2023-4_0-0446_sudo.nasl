...
# extracted from VMware Security Advisory PHSA-2023-4.0-0446. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Sudo PHSA-2023-4.0-0446");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the sudo package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-446.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'sudo-1.9.14p3-1.ph4')) flag++;
