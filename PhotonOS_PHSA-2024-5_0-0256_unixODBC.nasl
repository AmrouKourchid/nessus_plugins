...
# extracted from VMware Security Advisory PHSA-2024-5.0-0256. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Unixodbc PHSA-2024-5.0-0256");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the unixODBC package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-256.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'unixODBC-2.3.12-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'unixODBC-devel-2.3.12-1.ph5')) flag++;
