...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : python-pillow (EulerOS-SA-2020-1966)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1966
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?722dd140");
...
pkgs = ["python-pillow-2.0.0-19.h7.gitd1c6db8"];
