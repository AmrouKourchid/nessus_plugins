...
# extracted from Amazon Linux 2 Security Advisory ALASNGINX1-2023-001.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : nginx (ALASNGINX1-2023-001)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of nginx installed on the remote host is prior to 1.22.1-1. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2NGINX1-2023-001 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASNGINX1-2023-001.html");
...
var pkgs = [
    {'reference':'nginx-1.22.1-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-1.22.1-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-all-modules-1.22.1-1.amzn2.0.2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-core-1.22.1-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-core-1.22.1-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-debuginfo-1.22.1-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-debuginfo-1.22.1-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-filesystem-1.22.1-1.amzn2.0.2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-devel-1.22.1-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-devel-1.22.1-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-http-geoip-1.22.1-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-http-geoip-1.22.1-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-http-image-filter-1.22.1-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-http-image-filter-1.22.1-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-http-perl-1.22.1-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-http-perl-1.22.1-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-http-xslt-filter-1.22.1-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-http-xslt-filter-1.22.1-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-mail-1.22.1-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-mail-1.22.1-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-stream-1.22.1-1.amzn2.0.2', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'},
    {'reference':'nginx-mod-stream-1.22.1-1.amzn2.0.2', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'nginx1'}
];
