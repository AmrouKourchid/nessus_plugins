...
# extracted from Fedora Security Advisory FEDORA-2025-ab7148736c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-ab7148736c");

  script_name(english:"Fedora 41 : exim (2025-ab7148736c)");
...
FEDORA-2025-ab7148736c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-ab7148736c");
  script_set_attribute(attribute:"solution", value:
"Update the affected exim package.");
...
var pkgs = [
    {'reference':'exim-4.98.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
