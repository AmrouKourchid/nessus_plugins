...
if (description)
{
  ...
  script_name(english:"Security Update for Microsoft .NET Core (July 2024)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-30105");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-35264");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-38081");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-38095");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5041081");
...
var constraints = [
  { 'min_version' : '8.0.0', 'fixed_version' : '8.0.7' }
];
