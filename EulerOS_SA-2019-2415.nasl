...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : perl-Archive-Tar (EulerOS-SA-2019-2415)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2415
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9450b677");
...
pkgs = ["perl-Archive-Tar-1.92-2.h1"];
