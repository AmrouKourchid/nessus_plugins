...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.10.61 (RHSA-2023:3362)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.10.61.");
...
referenced in the RHSA-2023:3362 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2023-1370");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3362");
  script_set_attribute(attribute:"solution", value:
"Update the RHCOS OpenShift Container Platform 4.10.61 packages based on the guidance in RHSA-2023:3362.");
...
var pkgs = [
    {'reference':'jenkins-2-plugins-4.10.1684982411-1.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
