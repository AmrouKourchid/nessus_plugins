...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : dhcp Vulnerability (NS-SA-2019-0129)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has dhcp packages installed that are affected by a
vulnerability:
...
pkgs = {
  "CGSL MAIN 4.05": [
    "dhclient-4.1.1-61.P1.el6.centos",
    "dhcp-4.1.1-61.P1.el6.centos",
    "dhcp-common-4.1.1-61.P1.el6.centos",
    "dhcp-debuginfo-4.1.1-61.P1.el6.centos",
    "dhcp-devel-4.1.1-61.P1.el6.centos"
  ]
};
