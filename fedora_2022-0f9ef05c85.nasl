...
# extracted from Fedora Security Advisory FEDORA-2022-0f9ef05c85
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-0f9ef05c85");

  script_name(english:"Fedora 37 : python3.6 (2022-0f9ef05c85)");
...
FEDORA-2022-0f9ef05c85 advisory.

    Automatic update for python3.6-3.6.15-9.fc37.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-0f9ef05c85");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-9.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
