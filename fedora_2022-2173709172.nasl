...
# extracted from Fedora Security Advisory FEDORA-2022-2173709172
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-2173709172");

  script_name(english:"Fedora 36 : pypy3.7 (2022-2173709172)");
...
FEDORA-2022-2173709172 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-2173709172");
...
var pkgs = [
    {'reference':'pypy3.7-7.3.9-4.3.7.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
