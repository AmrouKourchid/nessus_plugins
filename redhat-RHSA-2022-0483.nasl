...
# extracted from Red Hat Security Advisory RHSA-2022:0483. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0483");
  script_xref(name:"IAVA", value:"2022-A-0084-S");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.8.31 (RHSA-2022:0483)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.8.31.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:0483 advisory.

    Red Hat OpenShift Container Platform is Red Hat's cloud computing
    Kubernetes application platform solution designed for on-premise or private
    cloud deployments.

    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.8.31. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0483.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b23fb9ba");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0483");
...
"Update the RHEL OpenShift Container Platform 4.8.31 package based on the guidance in RHSA-2022:0483.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.8.1643649345-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-20617']},
      {'reference':'jenkins-2.319.2.1643648617-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-20612']}
    ]
  }
];
