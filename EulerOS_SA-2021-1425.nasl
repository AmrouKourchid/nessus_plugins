...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : trousers (EulerOS-SA-2021-1425)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the trousers package installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1425
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?053a783a");
  script_set_attribute(attribute:"solution", value:
"Update the affected trousers package.");
...
pkgs = ["trousers-0.3.14-2.h2.eulerosv2r7"];
