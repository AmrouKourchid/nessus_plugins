...
# extracted from Red Hat Security Advisory RHSA-2024:3660. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3660");

  script_name(english:"RHEL 9 : booth (RHSA-2024:3660)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3660.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?39d07eef");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2272082");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3660");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL booth package based on the guidance in RHSA-2024:3660.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'booth-1.0-283.1.9d4029a.git.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-arbitrator-1.0-283.1.9d4029a.git.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-core-1.0-283.1.9d4029a.git.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-site-1.0-283.1.9d4029a.git.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'booth-test-1.0-283.1.9d4029a.git.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
