...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : openssh (EulerOS-SA-2024-1533)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1533
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?41c6211e");
...
var pkgs = [
  "openssh-8.2p1-9.h55.eulerosv2r10",
  "openssh-clients-8.2p1-9.h55.eulerosv2r10",
  "openssh-server-8.2p1-9.h55.eulerosv2r10"
];
