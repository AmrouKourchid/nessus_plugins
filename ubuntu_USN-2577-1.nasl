...
# extracted from Ubuntu Security Notice USN-2577-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : wpa_supplicant vulnerability (USN-2577-1)");
...
USN-2577-1 advisory.
    ...
    It was discovered that wpa_supplicant incorrectly handled SSID information when creating or updating P2P
    peer entries. A remote attacker could use this issue to cause wpa_supplicant to crash, resulting in a
    denial of service, expose memory contents, or possibly execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2577-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'hostapd', 'pkgver': '1:2.1-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'wpagui', 'pkgver': '2.1-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'wpasupplicant', 'pkgver': '2.1-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'wpasupplicant-udeb', 'pkgver': '2.1-0ubuntu1.2'}
];
