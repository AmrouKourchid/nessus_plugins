...
# extracted from Red Hat Security Advisory exempi. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-18234", "CVE-2017-18236", "CVE-2018-7730");

  script_name(english:"RHEL 6 : exempi (Unpatched Vulnerability) (deprecated)");
