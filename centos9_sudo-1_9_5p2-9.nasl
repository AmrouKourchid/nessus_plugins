...
if (description)
{
  ...
  script_name(english:"CentOS 9 : sudo-1.9.5p2-9.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for sudo.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
sudo-1.9.5p2-9.el9 build changelog.

  - arbitrary file write with privileges of the RunAs user (CVE-2023-22809)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=29596");
...
var pkgs = [
    {'reference':'sudo-1.9.5p2-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.9.5p2-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-python-plugin-1.9.5p2-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
