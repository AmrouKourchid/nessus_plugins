...
# extracted from ZTE advisory NS-SA-2023-0075. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : rsyslog Vulnerability (NS-SA-2023-0075)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has rsyslog packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0075");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2022-24903");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    'rsyslog-8.2102.0-7.el8_6.1.cgslv6_2.1.g129a9e8',
    'rsyslog-mmjsonparse-8.2102.0-7.el8_6.1.cgslv6_2.1.g129a9e8'
  ]
};
