...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.1.0 : libarchive (EulerOS-SA-2019-1390)");
...
affected by the following vulnerabilities :
  ...
  - libarchive version commit
    ...
    parse_codes(), realloc(rar-i1/4zlzss.window, new_size)
    with new_size = 0 that can result in Crash/DoS. This
    attack appear to be exploitable via the victim must
    open a specially crafted RAR
    archive.i1/4^CVE-2018-1000877i1/4%0
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1390
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?29ad8452");
