...
# extracted from Red Hat Security Advisory libxfixes. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2013-1983", "CVE-2016-7944");

  script_name(english:"RHEL 5 : libxfixes (Unpatched Vulnerability) (deprecated)");
