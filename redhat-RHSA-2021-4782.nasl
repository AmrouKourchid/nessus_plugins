...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4782.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e991ff45");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4782");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1999263");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2008291");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openssh package based on the guidance in RHSA-2021:4782.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'pam_ssh_agent_auth-0.10.3-2.22.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pam_ssh_agent_auth-0.10.3-2.22.el7_9', 'cpu':'ppc', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pam_ssh_agent_auth-0.10.3-2.22.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pam_ssh_agent_auth-0.10.3-2.22.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pam_ssh_agent_auth-0.10.3-2.22.el7_9', 'cpu':'s390', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pam_ssh_agent_auth-0.10.3-2.22.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pam_ssh_agent_auth-0.10.3-2.22.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
