...
# extracted from SUSE update advisory SUSE-SU-2018:3987-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : kvm (SUSE-SU-2018:3987-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20183987-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01a8e589");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"3", reference:"kvm-1.4.2-53.26.2")) flag++;
