...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : curl (EulerOS-SA-2021-1063)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1063
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?254c4bd7");
...
pkgs = ["curl-7.29.0-35.h32",
        "libcurl-7.29.0-35.h32",
        "libcurl-devel-7.29.0-35.h32"];
