...
if (description)
{
  ...
  script_cve_id("CVE-2023-52757");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-52757");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: smb: client: fix potential deadlock
    ...
    kref_put(&mid->refcount, __release_mid) under @server->mid_lock spinlock. If they don't, then an use-
    after-free bug would have occurred anyways. By getting rid of such spinlock also fixes a potential
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52757");
