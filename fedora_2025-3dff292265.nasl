...
# extracted from Fedora Security Advisory FEDORA-2025-3dff292265
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3dff292265");

  script_name(english:"Fedora 40 : vaultwarden (2025-3dff292265)");
...
FEDORA-2025-3dff292265 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3dff292265");
...
"Update the affected vaultwarden package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56335");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-55225");
...
var pkgs = [
    {'reference':'vaultwarden-1.32.7-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
