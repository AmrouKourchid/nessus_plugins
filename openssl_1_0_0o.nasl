...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.0.0 < 1.0.0o Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.0.0o. It is, therefore, affected by multiple
vulnerabilities as referenced in the 1.0.0o advisory.
...
"Upgrade to OpenSSL version 1.0.0o or later.");
...
var constraints = [
  { 'min_version' : '1.0.0', 'fixed_version' : '1.0.0o' }
];
