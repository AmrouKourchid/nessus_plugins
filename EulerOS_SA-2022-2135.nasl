...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : libsndfile (EulerOS-SA-2022-2135)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2135
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d7a3321");
...
var pkgs = [
  "libsndfile-utils-help-1.0.28-18.h3.eulerosv2r10"
];
