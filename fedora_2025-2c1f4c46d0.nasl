...
# extracted from Fedora Security Advisory FEDORA-2025-2c1f4c46d0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-2c1f4c46d0");

  script_name(english:"Fedora 41 : nodejs22 (2025-2c1f4c46d0)");
...
FEDORA-2025-2c1f4c46d0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2c1f4c46d0");
...
var pkgs = [
    {'reference':'nodejs22-22.15.0-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
