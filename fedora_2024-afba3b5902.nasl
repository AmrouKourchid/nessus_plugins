...
# extracted from Fedora Security Advisory FEDORA-2024-afba3b5902
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-afba3b5902");

  script_name(english:"Fedora 40 : python3.12 (2024-afba3b5902)");
...
FEDORA-2024-afba3b5902 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-afba3b5902");
...
var pkgs = [
    {'reference':'python3.12-3.12.5-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
