...
# extracted from Gentoo Linux Security Advisory GLSA 202407-04.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202407-04 : Pixman: Heap Buffer Overflow");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202407-04 (Pixman: Heap Buffer Overflow)

    A vulnerability has been discovered in Pixman. Please review the CVE identifiers referenced below for
    details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202407-04");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=879207");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 0.42.2"),
    'vulnerable' : make_list("lt 0.42.2")
  }
];
