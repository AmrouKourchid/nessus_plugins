...
# extracted from Debian Security Advisory dla-3198. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3198 : php-phpseclib - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3198
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-30130");
...
"Upgrade the php-phpseclib packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-30130");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'php-phpseclib', 'reference': '2.0.30-2~deb10u1'}
];
