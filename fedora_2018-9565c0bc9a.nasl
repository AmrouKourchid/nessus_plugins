...
# extracted from Fedora Security Advisory FEDORA-2018-9565c0bc9a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : unixODBC (2018-9565c0bc9a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-9565c0bc9a");
...
"Update the affected unixODBC package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:unixODBC");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"unixODBC-2.3.7-1.fc28")) flag++;
