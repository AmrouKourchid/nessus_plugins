...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : dbus (EulerOS-SA-2019-1673)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1673
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?581f241f");
...
pkgs = ["dbus-1.10.24-7.h9.eulerosv2r7",
        "dbus-devel-1.10.24-7.h9.eulerosv2r7",
        "dbus-libs-1.10.24-7.h9.eulerosv2r7",
        "dbus-x11-1.10.24-7.h9.eulerosv2r7"];
