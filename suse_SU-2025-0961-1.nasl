...
# SUSE update advisory SUSE-SU-2025:0961-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-46818", "CVE-2024-50302");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/03/25");
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0961-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 49 for SLE 15 SP3) (SUSE-SU-2025:0961-1)");
...
the SUSE-SU-2025:0961-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-March/020562.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d11a36f");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150300.59.179-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_179-default-5-150300.2.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
