...
if (description)
{
  ...
  script_cve_id("CVE-2024-53117");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-53117");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: virtio/vsock: Improve MSG_ZEROCOPY
    error handling Add a missing kfree_skb() to prevent memory leaks. (CVE-2024-53117)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53117");
