...
# extracted from Fedora Security Advisory FEDORA-2025-cd51e0177b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-cd51e0177b");

  script_name(english:"Fedora 41 : yq (2025-cd51e0177b)");
...
FEDORA-2025-cd51e0177b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-cd51e0177b");
...
var pkgs = [
    {'reference':'yq-4.43.1-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
