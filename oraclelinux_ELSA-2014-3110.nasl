...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-3110.html");
...
"Update the affected docker, docker-devel and / or docker-pkg-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9357");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2014-9356");
...
var pkgs = [
    {'reference':'docker-1.3.3-1.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-devel-1.3.3-1.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-pkg-devel-1.3.3-1.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-1.3.3-1.0.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-devel-1.3.3-1.0.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-pkg-devel-1.3.3-1.0.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
