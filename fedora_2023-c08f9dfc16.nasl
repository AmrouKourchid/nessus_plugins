...
# extracted from Fedora Security Advisory FEDORA-2023-c08f9dfc16
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c08f9dfc16");

  script_name(english:"Fedora 37 : bzip3 (2023-c08f9dfc16)");
...
FEDORA-2023-c08f9dfc16 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c08f9dfc16");
...
var pkgs = [
    {'reference':'bzip3-1.3.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
