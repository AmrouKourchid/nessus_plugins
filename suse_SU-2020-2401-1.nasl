...
# extracted from SUSE update advisory SUSE-SU-2020:2401-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : xorg-x11-server (SUSE-SU-2020:2401-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4389da1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"xorg-x11-server-7.6_1.18.3-76.29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"xorg-x11-server-debuginfo-7.6_1.18.3-76.29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"xorg-x11-server-debugsource-7.6_1.18.3-76.29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"xorg-x11-server-extra-7.6_1.18.3-76.29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"xorg-x11-server-extra-debuginfo-7.6_1.18.3-76.29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"xorg-x11-server-7.6_1.18.3-76.29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"xorg-x11-server-debuginfo-7.6_1.18.3-76.29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"xorg-x11-server-debugsource-7.6_1.18.3-76.29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"xorg-x11-server-extra-7.6_1.18.3-76.29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"xorg-x11-server-extra-debuginfo-7.6_1.18.3-76.29.1")) flag++;
