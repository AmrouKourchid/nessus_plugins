...
# extracted from Red Hat Security Advisory RHSA-2024:3834. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3834");
  script_xref(name:"IAVA", value:"2024-A-0356");

  script_name(english:"RHEL 9 : gdk-pixbuf2 (RHSA-2024:3834)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3834.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0eacadde");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2260545");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3834");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gdk-pixbuf2 package based on the guidance in RHSA-2024:3834.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gdk-pixbuf2-2.42.6-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdk-pixbuf2-devel-2.42.6-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdk-pixbuf2-modules-2.42.6-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'gdk-pixbuf2-2.42.6-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdk-pixbuf2-devel-2.42.6-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gdk-pixbuf2-modules-2.42.6-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gdk-pixbuf2 / gdk-pixbuf2-devel / gdk-pixbuf2-modules');
}
