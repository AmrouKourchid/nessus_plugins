...
# extracted from Ubuntu Security Notice USN-2489-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2489-1");

  script_name(english:"Ubuntu 14.04 LTS : unzip vulnerability (USN-2489-1)");
...
USN-2489-1 advisory.
    ...
    Michal Zalewski discovered that unzip incorrectly handled certain malformed zip archives. If a user or
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2489-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'unzip', 'pkgver': '6.0-9ubuntu1.2'}
];
