...
# extracted from VMware Security Advisory PHSA-2024-3.0-0754. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Ruby PHSA-2024-3.0-0754");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the ruby package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-754.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'ruby-2.5.8-8.ph3')) flag++;
