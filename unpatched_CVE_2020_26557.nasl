...
if (description)
{
  ...
  script_cve_id("CVE-2020-26557");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2020-26557");
...
patch available.
  ...
  - Mesh Provisioning in the Bluetooth Mesh profile 1.0 and 1.0.1 may permit a nearby device (without
    possession of the AuthValue used in the provisioning protocol) to determine the AuthValue via a brute-
    force attack (unless the AuthValue is sufficiently random and changed each time). (CVE-2020-26557)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-26557");
