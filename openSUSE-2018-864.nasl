...
# extracted from openSUSE Security Update openSUSE-2018-864.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : cgit (openSUSE-2018-864)");
...
The following security vulnerability was addressed :
  ...
  - CVE-2018-14912: Fixed a directory traversal
    vulnerability, when enable-http-clone=1 is not turned
    off (boo#1103799)
...
The following other changes were made :
  ...
  - Add repo.homepage/gitweb.homepage setting and homepage
    tab.

  - Show reverse paths in title bar so that browser tab
    shows filename.

  - Allow redirects even when caching is turned on.

  - More gracefully deal with unparsable commits.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1103799");
...
"Update the affected cgit packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-14912");
...
if ( rpm_check(release:"SUSE42.3", reference:"cgit-1.2.1-13.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"cgit-debuginfo-1.2.1-13.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"cgit-debugsource-1.2.1-13.3.1") ) flag++;
