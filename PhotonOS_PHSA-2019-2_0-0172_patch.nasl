...
if (description)
{
  ...
  script_cve_id("CVE-2016-10713", "CVE-2019-13636", "CVE-2019-13638");

  script_name(english:"Photon OS 2.0: Patch PHSA-2019-2.0-0172");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'patch-2.7.5-8.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'patch-debuginfo-2.7.5-8.ph2')) flag++;
