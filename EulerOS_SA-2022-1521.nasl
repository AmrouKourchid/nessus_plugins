...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : udisks2 (EulerOS-SA-2022-1521)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1521
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?07c6ca79");
...
var pkgs = [
  "libudisks2-2.9.0-2.h3.eulerosv2r10",
  "udisks2-2.9.0-2.h3.eulerosv2r10"
];
