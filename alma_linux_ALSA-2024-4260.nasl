...
# AlmaLinux Security Advisory ALSA-2024:4260.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4260");

  script_name(english:"AlmaLinux 8 : python-idna (ALSA-2024:4260)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-4260.html");
