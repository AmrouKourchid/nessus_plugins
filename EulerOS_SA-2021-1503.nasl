...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : openldap (EulerOS-SA-2021-1503)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1503
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e73fae30");
...
pkgs = ["openldap-2.4.44-15.h11.eulerosv2r7",
        "openldap-clients-2.4.44-15.h11.eulerosv2r7",
        "openldap-devel-2.4.44-15.h11.eulerosv2r7",
        "openldap-servers-2.4.44-15.h11.eulerosv2r7"];
