...
# extracted from openSUSE Security Update openSUSE-2020-1262.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dovecot23 (openSUSE-2020-1262)");
...
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-backend-mysql-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-backend-mysql-debuginfo-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-backend-pgsql-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-backend-pgsql-debuginfo-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-backend-sqlite-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-backend-sqlite-debuginfo-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-debuginfo-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-debugsource-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-devel-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-fts-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-fts-debuginfo-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-fts-lucene-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-fts-lucene-debuginfo-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-fts-solr-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-fts-solr-debuginfo-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-fts-squat-2.3.10-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"dovecot23-fts-squat-debuginfo-2.3.10-lp152.2.3.1") ) flag++;
