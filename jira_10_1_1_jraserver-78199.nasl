...
if (description)
{
  ...
  script_name(english:"Atlassian Jira 9.4.x < 9.4.28 / 9.12.x < 9.12.15 / 9.17.x < 9.17.4 / 10.0.x < 10.1.1 XSS (JRASERVER-78199)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/JRASERVER-78199");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Atlassian Jira version 9.4.28, 9.12.15, 9.17.4, 10.1.1 or later.");
...
var constraints = [
  { 'min_version' : '9.4.0', 'fixed_version' : '9.4.28' },
  { 'min_version' : '9.12.0', 'fixed_version' : '9.12.15' },
