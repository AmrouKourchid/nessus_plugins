...
if (description)
{
  ...
  script_cve_id("CVE-2024-24697");

  script_name(english:"Zoom Client for Meetings < 5.17.0 Vulnerability (ZSB-24004)");
...
vulnerability as referenced in the ZSB-24004 advisory.

  - Untrusted search path in some Zoom 32 bit Windows clients may allow an authenticated user to conduct an
    escalation of privilege via local access. (CVE-2024-24697)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.zoom.com/en/trust/security-bulletin/ZSB-24004");
...
"Upgrade to Zoom Client for Meetings 5.17.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24697");
