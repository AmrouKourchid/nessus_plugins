...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libXpm (EulerOS-SA-2023-1615)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1615
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?efd6f9db");
...
var pkgs = [
  "libXpm-3.5.12-8.h1.eulerosv2r8",
  "libXpm-devel-3.5.12-8.h1.eulerosv2r8"
];
