...
if (description)
{
  ...
  script_cve_id("CVE-2015-7473");

  script_name(english:"IBM MQ 8.0 < 8.0.0.4 (281069)");
...
before 8.0.0.5 allows local users to bypass intended queue-manager command access restrictions by leveraging authority
for +connect and +dsp.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/281069");
...
"Upgrade to IBM MQ 8.0.0.5 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-7473");
