...
# extracted from VMware Security Advisory PHSA-2024-4.0-0713. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-38697");

  script_name(english:"Photon OS 4.0: Rubygem PHSA-2024-4.0-0713");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the rubygem package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-713.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-38697");
...
if (rpm_check(release:'PhotonOS-4.0', reference:'rubygem-protocol-http1-0.15.1-1.ph4')) flag++;
