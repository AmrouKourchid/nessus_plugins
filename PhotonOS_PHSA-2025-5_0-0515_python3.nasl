...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Python3 PHSA-2025-5.0-0515");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-56326");
...
if (rpm_check(release:'PhotonOS-5.0', reference:'python3-jinja2-3.1.6-1.ph5')) flag++;
