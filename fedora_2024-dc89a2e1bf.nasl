...
# extracted from Fedora Security Advisory FEDORA-2024-dc89a2e1bf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-dc89a2e1bf");

  script_name(english:"Fedora 40 : openssh (2024-dc89a2e1bf)");
...
FEDORA-2024-dc89a2e1bf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-dc89a2e1bf");
...
var pkgs = [
    {'reference':'openssh-9.6p1-1.fc40.4', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
