...
ELSA-2014-3034 advisory.
    ...
    - n_tty: Fix n_tty_write crash when echoing in raw mode (Peter Hurley) [Orabug: 18754908] {CVE-2014-0196}
    {CVE-2014-0196}
    - aacraid: missing capable() check in compat ioctl (Dan Carpenter) [Orabug: 18721960] {CVE-2013-6383}
    - vhost: fix total length when packets are too short (Michael S. Tsirkin) [Orabug: 18721975]
    {CVE-2014-0077}
    - ipv6: don't set DST_NOCOUNT for remotely added routes (Sabrina Dubroca) [Orabug: 18681501]
    {CVE-2014-2309}
    - kvm: x86: fix emulator buffer overflow (CVE-2014-0049) (Andrew Honig) [Orabug: 18681519] {CVE-2014-0049}
    - net: ipv4: current group_info should be put after using. (Wang, Xiaoming) [Orabug: 18603519]
    {CVE-2014-2851}
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2013-4587");
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-3.8.13-35.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-3.8.13'},
    {'reference':'kernel-uek-firmware-3.8.13-35.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-3.8.13'}
];
