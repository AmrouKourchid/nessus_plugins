...
# extracted from Debian Security Advisory dla-4028. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4028 : git-lfs - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4028
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-4028-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                       Andrej Shadura
    January 22, 2025                              https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-53263");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'git-lfs', 'reference': '2.13.2-1+deb11u1'},
    {'release': '11.0', 'prefix': 'golang-github-git-lfs-git-lfs-dev', 'reference': '2.13.2-1+deb11u1'}
];
