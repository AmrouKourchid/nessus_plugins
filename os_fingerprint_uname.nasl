...
var reject_unames = ["invalid", "please", "not supported", "help", "Syntax error", "is not allowed", "shell is currently disabled", "Unknown action 0"];
...
replace_kb_item(name:"Host/OS/uname/Fingerprint", value:uname);
...
if ( array[1] == "Linux" )
{
  ...
  # Microsoft CBL-Mariner uname -a
  # "Linux MarinerDetectionTest 5.15.26.1-4.cm2 #1 SMP Sun Apr 10 02:43:45 UTC 2022 x86_64 x86_64 x86_64 GNU/Linux"
  else if (array[3] =~ "\.cm[1-9]+$")
  {
...
replace_kb_item(name:"Host/OS/uname", value:os);
replace_kb_item(name:"Host/OS/uname/Confidence", value:confidence);
replace_kb_item(name:"Host/OS/uname/Type", value:type);
