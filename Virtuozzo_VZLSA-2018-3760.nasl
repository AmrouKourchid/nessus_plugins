...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : ghostscript / ghostscript-devel / ghostscript-doc / etc (VZLSA-2018-3760)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2018-3760.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05fb490d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3760");
...
pkgs = ["ghostscript-8.70-24.vl6.2",
        "ghostscript-devel-8.70-24.vl6.2",
        "ghostscript-doc-8.70-24.vl6.2",
        "ghostscript-gtk-8.70-24.vl6.2"];
