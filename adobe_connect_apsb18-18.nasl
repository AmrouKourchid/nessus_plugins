...
if (description)
{
  ...
  script_name(english:"Adobe Connect <= 9.7.4 Sensitive Information Disclosure Vulnerability (APSB18-18)");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server contains an application that is affected by
a sensitive information disclosure vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Connect installed on the remote host is prior to 9.7.5. It is, therefore, affected by a
vulnerability as referenced in the apsb18-18 advisory.
...
"Upgrade to Adobe Connect version 9.7.5 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-4994");
...
var constraints = [
  { 'min_version' : '9.0.0', 'max_version' : '9.7.4', 'fixed_version' : '9.7.5' }
];
