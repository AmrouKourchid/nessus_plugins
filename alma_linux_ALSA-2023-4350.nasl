...
# AlmaLinux Security Advisory ALSA-2023:4350.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4350");

  script_name(english:"AlmaLinux 9 : python-requests (ALSA-2023:4350)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-4350.html");
...
"Update the affected python3-requests, python3-requests+security and / or python3-requests+socks packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:python3-requests+security");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:python3-requests+socks");
