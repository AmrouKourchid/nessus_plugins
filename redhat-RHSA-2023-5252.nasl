...
# extracted from Red Hat Security Advisory RHSA-2023:5252. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5252");

  script_name(english:"RHEL 8 : dmidecode (RHSA-2023:5252)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5252.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c59b69b9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2186669");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5252");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dmidecode package based on the guidance in RHSA-2023:5252.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dmidecode-3.3-4.el8_8.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dmidecode-3.3-4.el8_8.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'dmidecode-3.3-4.el8_8.1', 'sp':'8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dmidecode-3.3-4.el8_8.1', 'sp':'8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
