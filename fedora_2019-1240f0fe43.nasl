...
# extracted from Fedora Security Advisory FEDORA-2019-1240f0fe43.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-1240f0fe43");

  script_name(english:"Fedora 31 : mbedtls (2019-1240f0fe43)");
...
Release notes:
https://tls.mbed.org/tech-updates/releases/mbedtls-2.16.3-and-2.7.12-r
eleased
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1240f0fe43");
  # https://tls.mbed.org/tech-updates/security-advisories/mbedtls-security-advisory-2019-10
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91a12f0c");
...
"Update the affected mbedtls package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-16910");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mbedtls-2.16.3-1.fc31")) flag++;
