...
# extracted from Fedora Security Advisory FEDORA-2024-671549e74c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-671549e74c");

  script_name(english:"Fedora 41 : expat (2024-671549e74c)");
...
FEDORA-2024-671549e74c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-671549e74c");
...
var pkgs = [
    {'reference':'expat-2.6.3-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
