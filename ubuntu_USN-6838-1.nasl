...
# extracted from Ubuntu Security Notice USN-6838-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6838-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.10 / 24.04 LTS : Ruby vulnerabilities (USN-6838-1)");
...
vulnerabilities as referenced in the USN-6838-1 advisory.

    It was discovered that Ruby RDoc incorrectly parsed certain YAML files. If a user or automated system were
    tricked into parsing a specially crafted .rdoc_options file, a remote attacker could possibly use this
    issue to execute arbitrary code. (CVE-2024-27281)

    It was discovered that the Ruby regex compiler incorrectly handled certain memory operations. A remote
    attacker could possibly use this issue to obtain sensitive memory contents. (CVE-2024-27282)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6838-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'libruby2.7', 'pkgver': '2.7.0-5ubuntu1.13'},
    {'osver': '20.04', 'pkgname': 'ruby2.7', 'pkgver': '2.7.0-5ubuntu1.13'},
    {'osver': '20.04', 'pkgname': 'ruby2.7-dev', 'pkgver': '2.7.0-5ubuntu1.13'},
    {'osver': '22.04', 'pkgname': 'libruby3.0', 'pkgver': '3.0.2-7ubuntu2.6'},
    {'osver': '22.04', 'pkgname': 'ruby3.0', 'pkgver': '3.0.2-7ubuntu2.6'},
    {'osver': '22.04', 'pkgname': 'ruby3.0-dev', 'pkgver': '3.0.2-7ubuntu2.6'},
    {'osver': '23.10', 'pkgname': 'libruby3.1', 'pkgver': '3.1.2-7ubuntu3.2'},
    {'osver': '23.10', 'pkgname': 'ruby3.1', 'pkgver': '3.1.2-7ubuntu3.2'},
    {'osver': '23.10', 'pkgname': 'ruby3.1-dev', 'pkgver': '3.1.2-7ubuntu3.2'},
    {'osver': '24.04', 'pkgname': 'libruby3.2', 'pkgver': '3.2.3-1ubuntu0.24.04.1'},
    {'osver': '24.04', 'pkgname': 'ruby3.2', 'pkgver': '3.2.3-1ubuntu0.24.04.1'},
    {'osver': '24.04', 'pkgname': 'ruby3.2-dev', 'pkgver': '3.2.3-1ubuntu0.24.04.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libruby2.7 / libruby3.0 / libruby3.1 / libruby3.2 / ruby2.7 / etc');
}
