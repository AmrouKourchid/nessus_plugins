...
# extracted from Debian Security Advisory DLA-2095-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2095-1 : storebackup security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"storeBackup.pl in storeBackup through 3.5 relies on the
/tmp/storeBackup.lock pathname, which allows symlink attacks that
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/02/msg00003.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/storebackup");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected storebackup package.");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"storebackup", reference:"3.2.1-1+deb8u1")) flag++;
