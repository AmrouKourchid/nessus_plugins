...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : ruby (EulerOS-SA-2020-2460)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2460
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf5ff99f");
...
pkgs = ["ruby-2.0.0.648-33.h26.eulerosv2r7",
        "ruby-irb-2.0.0.648-33.h26.eulerosv2r7",
        "ruby-libs-2.0.0.648-33.h26.eulerosv2r7"];
