...
if (description)
{
  ...
  script_cve_id("CVE-2023-46715");
  script_xref(name:"IAVA", value:"2025-A-0022");

  script_name(english:"Fortinet Fortigate IPsec dynamic assignation IP spoofing (FG-IR-23-407)");
...
vulnerability as referenced in the FG-IR-23-407 advisory.

  - An origin validation error [CWE-346] vulnerability in Fortinet FortiOS IPSec VPN version 7.4.0 through
    7.4.1 and version 7.2.6 and below allows an authenticated IPSec VPN user with dynamic IP addressing to
    send (but not receive) packets spoofing the IP of another user via crafted network packets.
    (CVE-2023-46715)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-23-407");
  script_set_attribute(attribute:"solution", value:
"For 6.2.x / 6.4.x / 7.0.x / 7.2.x, see vendor advisory. For 7.4.x, upgrade to Fortigate version 7.4.2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-46715");
