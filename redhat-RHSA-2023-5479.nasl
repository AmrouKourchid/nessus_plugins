...
# extracted from Red Hat Security Advisory RHSA-2023:5479. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-4853");
  script_xref(name:"RHSA", value:"2023:5479");

  script_name(english:"RHEL 8 : Release of OpenShift Serverless Client kn 1.30.1 (RHSA-2023:5479)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Release of OpenShift Serverless Client kn 1.30.1.");
...
the RHSA-2023:5479 advisory.

    Red Hat OpenShift Serverless Client kn 1.30.1 provides a CLI to interact with Red Hat OpenShift Serverless
    1.30.1. The kn CLI is delivered as an RPM package for installation on RHEL platforms, and as binaries for
    non-Linux platforms.
    ...
    * quarkus: HTTP security policy bypass (CVE-2023-4853)
    ...
    For further information about CVE-2023-4853, see the Red Hat Security Bulletin linked to in the References
    section.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/vulnerabilities/RHSB-2023-002");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5479.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4035807b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2238034");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5479");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Release of OpenShift Serverless Client kn 1.30.1 package based on the guidance in RHSA-2023:5479.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-4853");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-serverless-clients-1.9.2-3.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-1.9.2-3.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-1.9.2-3.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
