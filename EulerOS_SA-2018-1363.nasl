...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : spice-gtk (EulerOS-SA-2018-1363)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1363
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0e8ea9f");
...
pkgs = ["spice-glib-0.31-6.2.h2",
        "spice-gtk3-0.31-6.2.h2"];
