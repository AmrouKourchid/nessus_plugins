...
# extracted from Fedora Security Advisory FEDORA-2019-749d828945.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-749d828945");

  script_name(english:"Fedora 30 : libnbd (2019-749d828945)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-749d828945");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"libnbd-1.0.2-1.fc30")) flag++;
