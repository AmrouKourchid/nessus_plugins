...
# extracted from Fedora Security Advisory FEDORA-2025-3726ae12e9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3726ae12e9");

  script_name(english:"Fedora 40 : python3.14 (2025-3726ae12e9)");
...
FEDORA-2025-3726ae12e9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3726ae12e9");
...
var pkgs = [
    {'reference':'python3.14-3.14.0~a4-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
