...
# extracted from Fedora Security Advisory FEDORA-2018-9ef52861b5.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : 1:wireshark (2018-9ef52861b5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-9ef52861b5");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"wireshark-2.6.2-1.fc27", epoch:"1")) flag++;
