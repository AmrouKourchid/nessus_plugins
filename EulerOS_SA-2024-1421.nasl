...
if (description)
{
  ...
  script_cve_id("CVE-2023-5678", "CVE-2023-40546");

  script_name(english:"EulerOS Virtualization 2.11.1 : shim (EulerOS-SA-2024-1421)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1421
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b870ce1");
...
"Update the affected shim packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-40546");
...
var pkgs = [
  "shim-15.4-2.h23.eulerosv2r11",
  "shim-aa64-storage-15.4-2.h23.eulerosv2r11"
];
