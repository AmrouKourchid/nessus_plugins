...
# extracted from Fedora Security Advisory FEDORA-2024-bf29e92de4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bf29e92de4");

  script_name(english:"Fedora 40 : ovn (2024-bf29e92de4)");
...
FEDORA-2024-bf29e92de4 advisory.

    Security fix for CVE-2024-2182 ovn: insufficient validation of BFD packets may lead to denial of service
    [fedora-all]
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bf29e92de4");
...
"Update the affected ovn package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:ovn");
...
var pkgs = [
    {'reference':'ovn-23.09.0-139.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ovn');
}
