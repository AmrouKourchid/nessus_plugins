...
if (description)
{
  ...
  script_cve_id("CVE-2023-4458");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-4458");
...
patch available.
  ...
  - A flaw was found within the parsing of extended attributes in the kernel ksmbd module. The issue results
    ...
    installations of Linux. Only systems with ksmbd enabled are vulnerable to this CVE. (CVE-2023-4458)
...
"There is no known solution at this time.");
  ...
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:C/C:L/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-4458");
