...
if (description)
{
  ...
  script_cve_id("CVE-2021-47643");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47643");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: media: ir_toy: free before error
    exiting Fix leak in error path. (CVE-2021-47643)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47643");
