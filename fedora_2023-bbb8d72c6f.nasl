...
# extracted from Fedora Security Advisory FEDORA-2023-bbb8d72c6f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bbb8d72c6f");

  script_name(english:"Fedora 39 : firefox (2023-bbb8d72c6f)");
...
FEDORA-2023-bbb8d72c6f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bbb8d72c6f");
...
var pkgs = [
    {'reference':'firefox-118.0.1-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
