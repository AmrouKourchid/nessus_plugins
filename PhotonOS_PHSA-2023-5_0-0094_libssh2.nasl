...
# extracted from VMware Security Advisory PHSA-2023-5.0-0094. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libssh2 PHSA-2023-5.0-0094");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libssh2 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-94.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libssh2-1.11.0-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libssh2-devel-1.11.0-1.ph5')) flag++;
