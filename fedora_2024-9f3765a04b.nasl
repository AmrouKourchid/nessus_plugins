...
# extracted from Fedora Security Advisory FEDORA-2024-9f3765a04b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9f3765a04b");

  script_name(english:"Fedora 40 : libxml2 (2024-9f3765a04b)");
...
FEDORA-2024-9f3765a04b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9f3765a04b");
...
var pkgs = [
    {'reference':'libxml2-2.12.9-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
