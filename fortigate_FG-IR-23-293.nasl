...
if (description)
{
  ...
  script_cve_id("CVE-2023-42785", "CVE-2023-42786");
  script_xref(name:"IAVA", value:"2025-A-0022");

  script_name(english:"Fortinet Fortigate Null pointer dereference leading to sslvpn DOS (FG-IR-23-293)");
...
vulnerabilities as referenced in the FG-IR-23-293 advisory.

  - A null pointer dereference in FortiOS versions 7.4.0 through 7.4.1, 7.2.0 through 7.2.5, 7.0 all versions,
    6.4 all versions , 6.2 all versions and 6.0 all versions allows attacker to trigger a denial of service
    via a crafted http request. (CVE-2023-42785, CVE-2023-42786)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-23-293");
  script_set_attribute(attribute:"solution", value:
"For 6.0.x / 6.2.x / 6.4.x / 7.0.x, see vendor advisory. For 7.2.x, upgrade to Fortigate version 7.2.6 or later. For
7.4.x, upgrade to Fortigate version 7.4.2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-42786");
