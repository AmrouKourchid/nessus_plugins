...
if (description)
{
  ...
  script_bugtraq_id(75156);

  script_name(english:"EulerOS 2.0 SP3 : openssl098e (EulerOS-SA-2019-2271)");
...
vulnerabilities :
  ...
  - The X509_cmp_time function in crypto/x509/x509_vfy.c in
    ...
    read and application crash) via a crafted length field
    in ASN1_TIME data, as demonstrated by an attack against
    a server that supports client authentication with a
    custom verification callback.(CVE-2015-1789)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2271
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3758f8a1");
...
pkgs = ["openssl098e-0.9.8e-29.3.h4"];
