...
# extracted from Red Hat Security Advisory RHSA-2014:0762. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0762");

  script_name(english:"RHEL 6 : rubygem-openshift-origin-node (RHSA-2014:0762)");
...
issue.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0762");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-node-1.9.14.8-1.el6")) flag++;
