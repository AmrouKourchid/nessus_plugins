...
# extracted from Fedora Security Advisory FEDORA-2023-cb8c606fbb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cb8c606fbb");

  script_name(english:"Fedora 38 : podman-tui (2023-cb8c606fbb)");
...
FEDORA-2023-cb8c606fbb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cb8c606fbb");
...
var pkgs = [
    {'reference':'podman-tui-0.15.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
