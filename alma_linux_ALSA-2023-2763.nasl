...
# AlmaLinux Security Advisory ALSA-2023:2763.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2763");
  script_xref(name:"IAVA", value:"2022-A-0467-S");
  script_xref(name:"IAVA", value:"2023-A-0061-S");

  script_name(english:"AlmaLinux 8 : python38:3.8 and python38-devel:3.8 (ALSA-2023:2763)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2023:2763 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-2763.html");
...
var appstreams = {
    'python38-devel:3.8': [
      {'reference':'python38-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-debug-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debug-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debug-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debug-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-libs-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-libs-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-libs-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-libs-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-rpm-macros-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-test-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-test-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-test-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-test-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.16-1.module_el8.8.0+3482+d5d93a3e', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
