...
referenced in the RHSA-2009:0003 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2009/rhsa-2009_0003.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb8dd29a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2009:0003");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=464455");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=464817");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=470795");
...
"Update the RHEL xen package based on the guidance in RHSA-2009:0003.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-4405");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2008-4993");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xen-3.0.3-64.el5_2.9', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xen-3.0.3-64.el5_2.9', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xen-devel-3.0.3-64.el5_2.9', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xen-devel-3.0.3-64.el5_2.9', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xen-libs-3.0.3-64.el5_2.9', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xen-libs-3.0.3-64.el5_2.9', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
