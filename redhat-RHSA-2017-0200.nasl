...
# extracted from Red Hat Security Advisory RHSA-2017:0200. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:0200");

  script_name(english:"RHEL 7 : puppet-swift (RHSA-2017:0200)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for puppet-swift.");
...
the RHSA-2017:0200 advisory.

    puppet-swift is the Puppet module used by Red Hat OpenStack Platform director to install OpenStack Object
    Storage (swift).
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_0200.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a62fde39");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:0200");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL puppet-swift package based on the guidance in RHSA-2017:0200.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:puppet-swift");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'puppet-swift-9.4.3-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'puppet-swift');
}
