...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2396.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e099c1ea");
...
"Update the RHEL rh-postgresql13-postgresql package based on the guidance in RHSA-2021:2396.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-postgresql13-postgresql-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-postgresql13-postgresql-contrib-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-postgresql13-postgresql-contrib-syspaths-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-postgresql13-postgresql-devel-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-postgresql13-postgresql-docs-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-postgresql13-postgresql-libs-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-postgresql13-postgresql-plperl-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-postgresql13-postgresql-plpython3-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-postgresql13-postgresql-pltcl-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-postgresql13-postgresql-server-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-postgresql13-postgresql-server-syspaths-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-postgresql13-postgresql-static-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-postgresql13-postgresql-syspaths-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'rh-postgresql13-postgresql-test-13.3-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
