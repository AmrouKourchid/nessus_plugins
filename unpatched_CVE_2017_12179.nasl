...
if (description)
{
  ...
  script_cve_id("CVE-2017-12179");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-12179");
...
patch available.
  ...
  - xorg-x11-server before 1.19.5 was vulnerable to integer overflow in (S)ProcXIBarrierReleasePointer
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-12179");
