...
if (description)
{
  ...
  script_cve_id("CVE-2023-32725");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-32725");
...
patch available.
  ...
  - The website configured in the URL widget will receive a session cookie when testing or executing scheduled
    reports. The received session cookie can then be used to access the frontend as the particular user.
    (CVE-2023-32725)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-32725");
