...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-requests (EulerOS-SA-2023-2627)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2627
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5081c918");
...
var pkgs = [
  "python-requests-help-2.21.0-5.h3.eulerosv2r9"
];
