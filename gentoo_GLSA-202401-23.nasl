...
# extracted from Gentoo Linux Security Advisory GLSA 202401-23.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202401-23 : libuv: Buffer Overread");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202401-23 (libuv: Buffer Overread)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202401-23");
...
var packages = [
  {
    'name' : 'dev-libs/libuv',
    'unaffected' : make_list("ge 1.41.1"),
    'vulnerable' : make_list("lt 1.41.1")
  }
];
