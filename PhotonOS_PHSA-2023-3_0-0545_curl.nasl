...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Curl PHSA-2023-3.0-0545");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'curl-7.86.0-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'curl-devel-7.86.0-4.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'curl-libs-7.86.0-4.ph3')) flag++;
