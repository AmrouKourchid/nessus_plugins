...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : libyaml-libyaml-perl vulnerability (USN-2461-2)");
...
USN-2461-2 advisory.
    ...
    Stanisaw Pitucha and Jonathan Gray discovered that libyaml-libyaml-perl did not properly handle wrapped
    strings. An attacker could create specially crafted YAML data to trigger an assert, causing a denial of
    service.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2461-2");
  script_set_attribute(attribute:"solution", value:
"Update the affected libyaml-libyaml-perl package.");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libyaml-libyaml-perl', 'pkgver': '0.41-5ubuntu0.14.04.1'}
];
