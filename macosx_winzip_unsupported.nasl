...
# @DEPRECATED@
#
# Disabled on 2025/04/16. Deprecated by plugin feed for  Winzip for Mac SEoL.
##
...
exit(0, 'This plugin has been deprecated. For plugins which identify unsupported instances of this product, search the plugin feed for Winzip for Mac SEoL.');