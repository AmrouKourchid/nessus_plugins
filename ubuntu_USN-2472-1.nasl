...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : unzip vulnerabilities (USN-2472-1)");
...
the USN-2472-1 advisory.

    Wolfgang Ettlinger discovered that unzip incorrectly handled certain malformed zip archives. If a user or
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2472-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'unzip', 'pkgver': '6.0-9ubuntu1.1'}
];
