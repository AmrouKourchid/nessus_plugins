...
referenced in the RHSA-2021:0485 advisory.
    ...
    The following packages have been upgraded to a later upstream version: rh-nodejs12-nodejs (12.20.1), rh-
    nodejs12-nodejs-nodemon (2.0.3).
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0485.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?62f6a90f");
...
"Update the RHEL rh-nodejs12-nodejs package based on the guidance in RHSA-2021:0485.");
