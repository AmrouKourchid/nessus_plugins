...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libsoup (EulerOS-SA-2020-1748)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the libsoup package installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1748
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d8f29fc");
