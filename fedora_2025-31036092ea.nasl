...
# extracted from Fedora Security Advisory FEDORA-2025-31036092ea
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-31036092ea");

  script_name(english:"Fedora 40 : augeas (2025-31036092ea)");
...
FEDORA-2025-31036092ea advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-31036092ea");
...
"Update the affected augeas package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:augeas");
...
var pkgs = [
    {'reference':'augeas-1.14.2-0.4.20250324git4dffa3d.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
