...
# extracted from Oracle Linux Security Advisory ELSA-2024-3275.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python-dns (ELSA-2024-3275)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-3275.html");
...
"Update the affected python3-dns package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python3-dns");
...
var pkgs = [
    {'reference':'python3-dns-1.15.0-12.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
