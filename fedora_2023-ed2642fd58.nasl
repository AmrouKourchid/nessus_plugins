...
# extracted from Fedora Security Advisory FEDORA-2023-ed2642fd58
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ed2642fd58");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");
  script_xref(name:"IAVB", value:"2023-B-0083-S");

  script_name(english:"Fedora 38 : nghttp2 (2023-ed2642fd58)");
...
FEDORA-2023-ed2642fd58 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ed2642fd58");
...
var pkgs = [
    {'reference':'nghttp2-1.52.0-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
