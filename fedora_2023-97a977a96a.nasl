...
# extracted from Fedora Security Advisory FEDORA-2023-97a977a96a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-97a977a96a");

  script_name(english:"Fedora 37 : thunderbird (2023-97a977a96a)");
...
FEDORA-2023-97a977a96a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-97a977a96a");
...
var pkgs = [
    {'reference':'thunderbird-102.7.1-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
