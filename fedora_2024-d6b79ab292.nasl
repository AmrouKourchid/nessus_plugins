...
# extracted from Fedora Security Advisory FEDORA-2024-d6b79ab292
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-55566");
  script_xref(name:"FEDORA", value:"2024-d6b79ab292");

  script_name(english:"Fedora 41 : ColPack (2024-d6b79ab292)");
...
FEDORA-2024-d6b79ab292 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d6b79ab292");
  script_set_attribute(attribute:"solution", value:
"Update the affected ColPack package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-55566");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:ColPack");
...
var pkgs = [
    {'reference':'ColPack-1.0.10-25.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ColPack');
}
