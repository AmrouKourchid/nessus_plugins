...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0246.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc6dce1f");
...
"Update the RHEL libarchive package based on the guidance in RHSA-2020:0246.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bsdtar-3.3.2-4.el8_0', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bsdtar-3.3.2-4.el8_0', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libarchive-3.3.2-4.el8_0', 'sp':'0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libarchive-3.3.2-4.el8_0', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libarchive-3.3.2-4.el8_0', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bsdtar / libarchive');
}
