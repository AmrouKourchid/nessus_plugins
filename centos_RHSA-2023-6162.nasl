...
# extracted from Red Hat Security Advisory RHSA-2023:6162.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2023:6162)");
...
var pkgs = [
    {'reference':'firefox-115.4.0-1.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-115.4.0-1.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
