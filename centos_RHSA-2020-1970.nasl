...
# extracted from Red Hat Security Advisory RHSA-2020:1970.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : chromium-browser (RHSA-2020:1970)");
...
RHSA-2020:1970 advisory.

  - Out of bounds read and write in PDFium in Google Chrome prior to 81.0.4044.122 allowed a remote attacker
    to potentially exploit heap corruption via a crafted PDF file. (CVE-2020-6458)

  - Use after free in payments in Google Chrome prior to 81.0.4044.122 allowed a remote attacker to
    potentially exploit heap corruption via a crafted HTML page. (CVE-2020-6459)

  - Insufficient data validation in URL formatting in Google Chrome prior to 81.0.4044.122 allowed a remote
...
var pkgs = [
    {'reference':'chromium-browser-81.0.4044.122-1.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
