...
# AlmaLinux Security Advisory ALSA-2022:8057.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:8057");
  script_xref(name:"IAVB", value:"2022-B-0025-S");

  script_name(english:"AlmaLinux 9 : grafana (ALSA-2022:8057)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-8057.html");
...
"Update the affected grafana package.");
  ...
  script_cwe_id(79, 200, 201, 352, 400, 425, 863, 1325);
