...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : openjpeg2 (EulerOS-SA-2024-2561)");
...
the following vulnerabilities :
    ...
    A vulnerability was found in OpenJPEG similar to CVE-2019-6988. This flaw allows an attacker to bypass
    existing protections and cause an application crash through a maliciously crafted file.(CVE-2023-39328)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2561
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?985e4efa");
...
var pkgs = [
  "openjpeg2-2.4.0-4.h3.eulerosv2r11"
];
