...
# extracted from Amazon Linux AMI Security Advisory ALAS-2023-1881.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : docker (ALAS-2023-1881)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of docker installed on the remote host is prior to 20.10.13-3. It is, therefore, affected by a vulnerability
as referenced in the ALAS-2023-1881 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2023-1881.html");
...
var pkgs = [
    {'reference':'docker-20.10.13-3.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-debuginfo-20.10.13-3.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
