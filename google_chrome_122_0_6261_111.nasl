...
if (description)
{
  ...
  script_name(english:"Google Chrome < 122.0.6261.111 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 122.0.6261.111. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2024_03_stable-channel-update-for-desktop advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?173c8026");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/325893559");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/325866363");
  script_set_attribute(attribute:"see_also", value:"https://crbug.com/325936438");
...
google_chrome_check_version(installs:installs, fix:'122.0.6261.111', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
