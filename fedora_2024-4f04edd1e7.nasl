...
# extracted from Fedora Security Advisory FEDORA-2024-4f04edd1e7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4f04edd1e7");

  script_name(english:"Fedora 41 : cobbler (2024-4f04edd1e7)");
...
FEDORA-2024-4f04edd1e7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4f04edd1e7");
...
var pkgs = [
    {'reference':'cobbler-3.3.7-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
