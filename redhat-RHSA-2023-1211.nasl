...
# extracted from Red Hat Security Advisory RHSA-2023:1211. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1211");

  script_name(english:"RHEL 9 : lua (RHSA-2023:1211)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for lua.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:1211 advisory.

    The lua packages provide support for Lua, a powerful light-weight programming language designed for
    extending applications. Lua is also frequently used as a general-purpose, stand-alone language.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1211.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bcc1649c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1211");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL lua package based on the guidance in RHSA-2023:1211.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:lua");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:lua-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:lua-libs");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'lua-5.4.4-1.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lua-devel-5.4.4-1.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'lua-libs-5.4.4-1.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'lua / lua-devel / lua-libs');
}
