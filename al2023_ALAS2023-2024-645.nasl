...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-645.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : python3-jinja2 (ALAS2023-2024-645)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2024-645 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-645.html");
...
"Run 'dnf update python-jinja2 --releasever 2023.5.20240624' to update your system.");
...
var pkgs = [
    {'reference':'python3-jinja2-2.11.3-1.amzn2023.0.4', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
