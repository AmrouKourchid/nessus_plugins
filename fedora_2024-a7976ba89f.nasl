...
# extracted from Fedora Security Advisory FEDORA-2024-a7976ba89f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a7976ba89f");
  script_xref(name:"IAVA", value:"2024-A-0446-S");

  script_name(english:"Fedora 40 : curl (2024-a7976ba89f)");
...
FEDORA-2024-a7976ba89f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a7976ba89f");
...
var pkgs = [
    {'reference':'curl-8.6.0-9.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
