...
if (description)
{
  ...
  script_name(english:"Fortinet Fortigate Unauthenticated access to static files containing logging information (FG-IR-22-364)");
...
vulnerability as referenced in the FG-IR-22-364 advisory.

  - An exposure of sensitive information to an unauthorized actor vulnerability [CWE-200] in Fortinet
    FortiProxy version 7.2.0 through 7.2.1 and 7.0.0 through 7.0.7, FortiOS version 7.2.0 through 7.2.3 and
    7.0.0 through 7.0.9 allows an unauthenticated attackers to obtain sensitive logging informations on the
    device via crafted HTTP GET requests. (CVE-2022-41329)
...
var constraints = [
  { 'min_version' : '6.2.3', 'max_version' : '6.2.3', 'fixed_version' : '6.4.12' },
