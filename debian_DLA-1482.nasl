...
# extracted from Debian Security Advisory DLA-1482-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1482-1 : libx11 security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/08/msg00030.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/libx11");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libx11-6", reference:"2:1.6.2-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libx11-6-dbg", reference:"2:1.6.2-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libx11-6-udeb", reference:"2:1.6.2-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libx11-data", reference:"2:1.6.2-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libx11-dev", reference:"2:1.6.2-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libx11-doc", reference:"2:1.6.2-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libx11-xcb-dev", reference:"2:1.6.2-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libx11-xcb1", reference:"2:1.6.2-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libx11-xcb1-dbg", reference:"2:1.6.2-3+deb8u2")) flag++;
