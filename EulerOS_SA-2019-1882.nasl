...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libarchive (EulerOS-SA-2019-1882)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1882
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2812c957");
...
"Update the affected libarchive package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8918");
...
pkgs = ["libarchive-3.1.2-10.h3.eulerosv2r7"];
