...
# extracted from Red Hat Security Advisory spice-gtk. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-3066", "CVE-2017-12194");

  script_name(english:"RHEL 6 : spice-gtk (Unpatched Vulnerability) (deprecated)");
