...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Libksba vulnerability (USN-2427-1)");
...
USN-2427-1 advisory.
    ...
    Hanno Bck discovered that Libksba incorrectly handled certain S/MIME messages or ECC based OpenPGP data.
    An attacker could use this issue to cause Libksba to crash, resulting in a denial of service, or possibly
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2427-1");
...
"Update the affected libksba-dev and / or libksba8 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9087");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libksba-dev', 'pkgver': '1.3.0-3ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libksba8', 'pkgver': '1.3.0-3ubuntu0.14.04.1'}
];
