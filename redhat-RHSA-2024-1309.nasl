...
# extracted from Red Hat Security Advisory RHSA-2024:1309. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1309");
  script_xref(name:"IAVA", value:"2024-A-0151-S");

  script_name(english:"RHEL 9 : .NET 7.0 (RHSA-2024:1309)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1309.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?97f078e2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268266");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1309");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL .NET 7.0 package based on the guidance in RHSA-2024:1309.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aspnetcore-runtime-7.0-7.0.17-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-7.0-7.0.17-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-apphost-pack-7.0-7.0.17-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-hostfxr-7.0-7.0.17-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-7.0-7.0.17-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-7.0-7.0.117-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-7.0-source-built-artifacts-7.0.117-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-targeting-pack-7.0-7.0.17-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-templates-7.0-7.0.117-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
