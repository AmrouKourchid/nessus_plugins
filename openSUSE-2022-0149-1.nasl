...
# openSUSE Security Update openSUSE-SU-2022:0149-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : rust1.56 (openSUSE-SU-2022:0149-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2022:0149-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8da00b10");
...
"Update the affected cargo1.56 and / or rust1.56 packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:cargo1.56");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:rust1.56");
...
var pkgs = [
    {'reference':'cargo1.56-1.56.1-150300.7.6.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust1.56-1.56.1-150300.7.6.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
