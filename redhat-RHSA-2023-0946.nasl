...
referenced in the RHSA-2023:0946 advisory.
    ...
    * In FIPS mode, openssl should reject RSASSA-PSS salt lengths larger than the output size of the hash
    function used, or provide an indicator (BZ#2144012)
    ...
    * In FIPS mode, openssl should reject SHA-224, SHA-384, SHA-512-224, and SHA-512-256 as hashes for hash-
    based DRBGs, or provide an indicator after 2023-05-16 (BZ#2144017)
    ...
    * In FIPS mode, openssl should reject RSA keys < 2048 bits when using EVP_PKEY_decapsulate, or provide an
    indicator (BZ#2145170)

    * RHEL9.1 Nightly[0912] - error:03000093:digital envelope routines::command not supported when git clone
    is run with configured ibmca engine backed by libica.so.4 (OpenSSL 3.0) (BZ#2149010)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0946.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a6ade13d");
...
"Update the RHEL openssl package based on the guidance in RHSA-2023:0946.");
