...
# AlmaLinux Security Advisory ALSA-2022:1939.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:1939");

  script_name(english:"AlmaLinux 8 : squid:4 (ALSA-2022:1939)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2022:1939 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-1939.html");
...
var appstreams = {
    'squid:4': [
      ...
      {'reference':'squid-4.15-3.module_el8.6.0+2741+01592ae8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      ...
      {'reference':'squid-4.15-3.module_el8.6.0+2741+01592ae8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      ...
      {'reference':'squid-4.15-3.module_el8.6.0+2741+01592ae8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
};
