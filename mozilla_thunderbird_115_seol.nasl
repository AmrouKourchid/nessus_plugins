...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird SEoL (115.x)");
...
"Upgrade to a version of Mozilla Thunderbird that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2024/12/02");
...
var constraints = [
{ max_branch : '115', min_branch : '115', seol : 20241202 }
];
