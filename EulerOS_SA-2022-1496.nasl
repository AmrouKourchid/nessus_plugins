...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : ruby (EulerOS-SA-2022-1496)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1496
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3989fdbb");
...
var pkgs = [
  "ruby-2.5.8-112.h7.eulerosv2r10",
  "ruby-help-2.5.8-112.h7.eulerosv2r10",
  "ruby-irb-2.5.8-112.h7.eulerosv2r10"
];
