...
# extracted from SUSE update advisory SUSE-SU-2021:0990-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : zabbix (SUSE-SU-2021:0990-1)");
...
CVE-2021-27927: Fixed an improper CSRF protection mechanism
(bsc#1183014).

CVE-2013-7484: Fixed an issue where passwords in the users table were
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1158321");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1183014");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2013-7484/");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c7260e15");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"zabbix-agent-4.0.12-4.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"zabbix-agent-debuginfo-4.0.12-4.12.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"zabbix-debugsource-4.0.12-4.12.1")) flag++;
