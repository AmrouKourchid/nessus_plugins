...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libxml2 (EulerOS-SA-2023-2563)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2563
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e7abf5c8");
...
var pkgs = [
  "libxml2-2.9.10-11.h24.eulerosv2r10",
  "python3-libxml2-2.9.10-11.h24.eulerosv2r10"
];
