...
# AlmaLinux Security Advisory ALSA-2024:11345.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:11345");
  script_xref(name:"RHSA", value:"2024:11345");
  script_xref(name:"IAVA", value:"2024-A-0832-S");

  script_name(english:"AlmaLinux 8 : gstreamer1-plugins-base (ALSA-2024:11345)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:11345 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-11345.html");
...
var pkgs = [
    {'reference':'gstreamer1-plugins-base-1.16.1-5.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'gstreamer1-plugins-base-devel-1.16.1-5.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
