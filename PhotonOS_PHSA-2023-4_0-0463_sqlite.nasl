...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Sqlite PHSA-2023-4.0-0463");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-36191");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'sqlite-3.38.5-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'sqlite-devel-3.38.5-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'sqlite-libs-3.38.5-3.ph4')) flag++;
