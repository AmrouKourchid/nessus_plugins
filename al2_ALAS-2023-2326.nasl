...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2326.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : golist (ALAS-2023-2326)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of golist installed on the remote host is prior to 0.10.1-10. It is, therefore, affected by a vulnerability
as referenced in the ALAS2-2023-2326 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2326.html");
...
var pkgs = [
    {'reference':'golist-0.10.1-10.amzn2.0.4', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golist-0.10.1-10.amzn2.0.4', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golist-debuginfo-0.10.1-10.amzn2.0.4', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golist-debuginfo-0.10.1-10.amzn2.0.4', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
