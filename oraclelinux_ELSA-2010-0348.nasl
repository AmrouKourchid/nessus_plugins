...
# Oracle Linux Security Advisory ELSA-2010-0348 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : kdebase (ELSA-2010-0348)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0348.html");
...
"Update the affected kdebase and / or kdebase-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-0436");
...
var pkgs = [
    {'reference':'kdebase-3.5.4-21.0.1.el5_5.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdebase-devel-3.5.4-21.0.1.el5_5.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdebase-3.5.4-21.0.1.el5_5.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'},
    {'reference':'kdebase-devel-3.5.4-21.0.1.el5_5.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
];
