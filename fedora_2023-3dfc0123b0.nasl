...
# extracted from Fedora Security Advisory FEDORA-2023-3dfc0123b0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3dfc0123b0");

  script_name(english:"Fedora 38 : microcode_ctl (2023-3dfc0123b0)");
...
FEDORA-2023-3dfc0123b0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3dfc0123b0");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-55.2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
