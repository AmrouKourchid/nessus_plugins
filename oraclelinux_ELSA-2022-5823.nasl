...
ELSA-2022-5823 advisory.
    ...
    - Resolves: Bug 2081008 - CVE-2022-0996 389-ds:1.4/389-ds-base: expired password was still allowed to
    access the database
...
var appstreams = {
    '389-ds:1.4': [
      ...
      {'reference':'python3-lib389-1.4.3.28-7.module+el8.6.0+20716+53f13155', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python3-lib389-1.4.3.28-7.module+el8.6.0+20716+53f13155', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
