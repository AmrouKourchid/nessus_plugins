...
# extracted from Fedora Security Advisory FEDORA-2019-986622833f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : python3 (2019-986622833f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-986622833f");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"python3-3.7.5-1.fc29")) flag++;
