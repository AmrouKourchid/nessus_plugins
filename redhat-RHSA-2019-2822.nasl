...
# extracted from Red Hat Security Advisory RHSA-2019:2822. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2822.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?43ac4518");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2822");
...
"Update the RHEL dovecot package based on the guidance in RHSA-2019:2822.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dovecot-2.2.36-5.el8_0.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-devel-2.2.36-5.el8_0.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-mysql-2.2.36-5.el8_0.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-pgsql-2.2.36-5.el8_0.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'dovecot / dovecot-devel / dovecot-mysql / dovecot-pgsql');
}
