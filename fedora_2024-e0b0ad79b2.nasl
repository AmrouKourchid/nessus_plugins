...
# extracted from Fedora Security Advisory FEDORA-2024-e0b0ad79b2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e0b0ad79b2");

  script_name(english:"Fedora 39 : python-urllib3 (2024-e0b0ad79b2)");
...
FEDORA-2024-e0b0ad79b2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e0b0ad79b2");
...
var pkgs = [
    {'reference':'python-urllib3-1.26.19-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
