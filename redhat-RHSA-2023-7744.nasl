...
# extracted from Red Hat Security Advisory RHSA-2023:7744. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7744");

  script_name(english:"RHEL 9 : tracker-miners (RHSA-2023:7744)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7744.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a0c96265");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2243096");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7744");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tracker-miners package based on the guidance in RHSA-2023:7744.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tracker-miners-3.1.2-4.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
