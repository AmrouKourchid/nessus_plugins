...
# extracted from openSUSE Security Update openSUSE-2020-2032.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : chromium (openSUSE-2020-2032)");
...
if ( rpm_check(release:"SUSE15.1", reference:"chromedriver-87.0.4280.66-lp151.2.156.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromedriver-debuginfo-87.0.4280.66-lp151.2.156.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-87.0.4280.66-lp151.2.156.1", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-debuginfo-87.0.4280.66-lp151.2.156.1", allowmaj:TRUE) ) flag++;
