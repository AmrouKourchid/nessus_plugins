...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002391");
  script_xref(name:"MSKB", value:"5002462");
  script_xref(name:"MSFT", value:"MS23-5002391");
  script_xref(name:"MSFT", value:"MS23-5002462");

  script_name(english:"Defense-in-Depth Security Updates for Microsoft Publisher Products (August 2023)");
...
"The Microsoft Publisher Products are missing defense-in-depth security updates to help improve security-related features.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002391");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002462");
...
var constraints = [
  { 'kb':'5002391',  'fixed_version': '15.0.5579.1001', 'sp' : 1},
  { 'kb':'5002462', 'channel':'MSI', 'fixed_version': '16.0.5408.1001', 'sp' : 0}
];
