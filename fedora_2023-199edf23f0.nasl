...
# extracted from Fedora Security Advisory FEDORA-2023-199edf23f0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-199edf23f0");

  script_name(english:"Fedora 38 : php-Smarty (2023-199edf23f0)");
...
FEDORA-2023-199edf23f0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-199edf23f0");
...
var pkgs = [
    {'reference':'php-Smarty-3.1.48-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
