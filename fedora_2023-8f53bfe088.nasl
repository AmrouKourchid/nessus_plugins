...
# extracted from Fedora Security Advisory FEDORA-2023-8f53bfe088
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8f53bfe088");

  script_name(english:"Fedora 38 : python-urllib3 (2023-8f53bfe088)");
...
FEDORA-2023-8f53bfe088 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8f53bfe088");
...
var pkgs = [
    {'reference':'python-urllib3-1.26.17-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
