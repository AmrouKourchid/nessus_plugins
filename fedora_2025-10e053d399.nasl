...
# extracted from Fedora Security Advisory FEDORA-2025-10e053d399
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-10e053d399");

  script_name(english:"Fedora 40 : python3.10 (2025-10e053d399)");
...
FEDORA-2025-10e053d399 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-10e053d399");
...
var pkgs = [
    {'reference':'python3.10-3.10.16-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
