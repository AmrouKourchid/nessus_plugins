...
if (description)
{
  ...
  script_name(english:"Microsoft Windows HEVC Video Extension from Device Manufacturer RCE (August 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The Windows app installed on the remote host is affected by a remote code execution vulnerability.");
  script_set_attribute(attribute:"description", value:
"The Windows 'HEVC from Device Manufacturer' app installed on the remote host is affected by
...
#  Microsoft.HEVCVideoExtension  - app preinstalled from Device Manufacturer
var app = 'Microsoft.HEVCVideoExtension';
