...
ELSA-2013-0223 advisory.
    ...
    - [virt] kvm: invalid opcode oops on SET_SREGS with OSXSAVE bit set (Petr Matousek) [862903 862904]
    {CVE-2012-4461}
    ...
    - [kernel] usermodehelper: introduce umh_complete(sub_info) (Oleg Nesterov) [858755 819529]
    {CVE-2012-4398}
    - [kernel] call_usermodehelper: simplify/fix UMH_NO_WAIT case (Oleg Nesterov) [858755 819529]
    {CVE-2012-4398}
    - [kernel] wait_for_helper: SIGCHLD from user-space can lead to use-after-free (Oleg Nesterov) [858755
...
var pkgs = [
    ...
    {'reference':'kernel-firmware-2.6.32-279.22.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-279.22.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
