...
# extracted from Fedora Security Advisory FEDORA-2024-5ee2c7c696
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5ee2c7c696");

  script_name(english:"Fedora 39 : chromium (2024-5ee2c7c696)");
...
FEDORA-2024-5ee2c7c696 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5ee2c7c696");
...
var pkgs = [
    {'reference':'chromium-129.0.6668.100-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
