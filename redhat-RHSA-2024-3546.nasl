...
# extracted from Red Hat Security Advisory RHSA-2024:3546. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3546");
  script_xref(name:"IAVA", value:"2024-A-0328");

  script_name(english:"RHEL 8 : ruby:3.1 (RHSA-2024:3546)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:3546 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3546.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?199cbe29");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3546");
  ...
  'ruby:3.1': [
    {
      ...
      'pkgs': [
        {'reference':'ruby-3.1.5-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-bundled-gems-3.1.5-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-default-gems-3.1.5-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-devel-3.1.5-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-doc-3.1.5-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-libs-3.1.5-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-bigdecimal-3.1.1-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-bundler-2.3.27-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-io-console-0.5.11-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-irb-1.4.1-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-json-2.6.1-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-minitest-5.15.0-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-power_assert-2.0.1-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-psych-4.0.4-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rake-13.0.6-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rbs-2.7.0-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rdoc-6.4.1.1-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rexml-3.2.5-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rss-0.2.9-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-test-unit-3.5.3-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-typeprof-0.21.3-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-3.3.27-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-devel-3.3.27-143.module+el8.10.0+21792+e2f63d26', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
