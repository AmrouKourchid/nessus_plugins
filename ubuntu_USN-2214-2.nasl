...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : libxml2 regression (USN-2214-2)");
...
USN-2214-2 advisory.
    ...
    USN-2214-1 fixed vulnerabilities in libxml2. The upstream fix introduced a regression when using xmllint
    with the --postvalid option. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2214-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libxml2', 'pkgver': '2.9.1+dfsg1-3ubuntu4.2'},
    {'osver': '14.04', 'pkgname': 'libxml2-dev', 'pkgver': '2.9.1+dfsg1-3ubuntu4.2'},
    {'osver': '14.04', 'pkgname': 'libxml2-udeb', 'pkgver': '2.9.1+dfsg1-3ubuntu4.2'},
    {'osver': '14.04', 'pkgname': 'libxml2-utils', 'pkgver': '2.9.1+dfsg1-3ubuntu4.2'},
    {'osver': '14.04', 'pkgname': 'python-libxml2', 'pkgver': '2.9.1+dfsg1-3ubuntu4.2'}
];
