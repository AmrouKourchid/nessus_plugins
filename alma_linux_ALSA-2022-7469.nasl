...
# AlmaLinux Security Advisory ALSA-2022:7469.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7469");

  script_name(english:"AlmaLinux 8 : container-tools:4.0 (ALSA-2022:7469)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2022:7469 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-7469.html");
...
var appstreams = {
    'container-tools:4.0': [
      {'reference':'aardvark-dns-1.0.1-35.module_el8.6.0+3070+1510fbd1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'aardvark-dns-1.0.1-35.module_el8.6.0+3070+1510fbd1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'aardvark-dns-1.0.1-35.module_el8.6.0+3070+1510fbd1', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'aardvark-dns-1.0.1-35.module_el8.6.0+3070+1510fbd1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'container-selinux-2.189.0-1.module_el8.6.0+3336+00d107d5', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'containers-common-1-35.module_el8.6.0+3070+1510fbd1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'containers-common-1-35.module_el8.6.0+3070+1510fbd1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'containers-common-1-35.module_el8.6.0+3070+1510fbd1', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'containers-common-1-35.module_el8.6.0+3070+1510fbd1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      ...
      {'reference':'netavark-1.0.1-35.module_el8.6.0+3070+1510fbd1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'netavark-1.0.1-35.module_el8.6.0+3070+1510fbd1', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'netavark-1.0.1-35.module_el8.6.0+3070+1510fbd1', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'netavark-1.0.1-35.module_el8.6.0+3070+1510fbd1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'aardvark-dns / container-selinux / containers-common / crit / criu / etc');
}
