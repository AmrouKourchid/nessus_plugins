...
# extracted from Red Hat Security Advisory RHSA-2025:1755. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1755");

  script_name(english:"RHEL 9 : mysql (RHSA-2025:1755)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1755.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a054073c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1755");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mysql package based on the guidance in RHSA-2025:1755.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mysql-8.0.40-2.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-common-8.0.40-2.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-errmsg-8.0.40-2.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-server-8.0.40-2.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mysql / mysql-common / mysql-errmsg / mysql-server');
}
