...
# Oracle Linux Security Advisory ELSA-2008-0522 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : perl (ELSA-2008-0522)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0522.html");
...
"Update the affected perl and / or perl-suidperl packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-1927");
...
var pkgs = [
    {'reference':'perl-5.8.8-10.0.1.el5_2.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'perl-suidperl-5.8.8-10.0.1.el5_2.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'perl-5.8.8-10.0.1.el5_2.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'perl-suidperl-5.8.8-10.0.1.el5_2.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'}
];
