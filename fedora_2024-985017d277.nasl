...
# extracted from Fedora Security Advisory FEDORA-2024-985017d277
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-985017d277");

  script_name(english:"Fedora 40 : python3.11 (2024-985017d277)");
...
FEDORA-2024-985017d277 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-985017d277");
...
var pkgs = [
    {'reference':'python3.11-3.11.9-6.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
