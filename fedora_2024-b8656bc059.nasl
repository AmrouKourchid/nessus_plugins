...
# extracted from Fedora Security Advisory FEDORA-2024-b8656bc059
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b8656bc059");

  script_name(english:"Fedora 38 : mingw-expat (2024-b8656bc059)");
...
FEDORA-2024-b8656bc059 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b8656bc059");
...
var pkgs = [
    {'reference':'mingw-expat-2.6.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
