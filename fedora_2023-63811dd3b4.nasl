...
# extracted from Fedora Security Advisory FEDORA-2023-63811dd3b4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-63811dd3b4");

  script_name(english:"Fedora 37 : python3.9 (2023-63811dd3b4)");
...
FEDORA-2023-63811dd3b4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-63811dd3b4");
...
var pkgs = [
    {'reference':'python3.9-3.9.18-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
