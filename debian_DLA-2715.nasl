...
# extracted from Debian Security Advisory dla-2715. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2715-1 : systemd - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2715
advisory.
    ...
    service-systemd.txt For Debian 9 stretch, this problem has been fixed in version 232-25+deb9u13. We
    recommend that you upgrade your systemd packages. For the detailed security status of systemd please refer
    to its security tracker page at: https://security-tracker.debian.org/tracker/systemd Further information
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2715");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-33910");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/systemd");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libnss-myhostname', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'libnss-mymachines', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'libnss-resolve', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'libnss-systemd', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'libpam-systemd', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'libsystemd-dev', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'libsystemd0', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'libudev-dev', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'libudev1', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'systemd', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'systemd-container', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'systemd-coredump', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'systemd-journal-remote', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'systemd-sysv', 'reference': '232-25+deb9u13'},
    {'release': '9.0', 'prefix': 'udev', 'reference': '232-25+deb9u13'}
];
