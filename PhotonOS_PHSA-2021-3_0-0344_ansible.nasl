...
if (description)
{
  ...
  script_cve_id("CVE-2020-10744");

  script_name(english:"Photon OS 3.0: Ansible PHSA-2021-3.0-0344");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-10744");
...
if (rpm_check(release:'PhotonOS-3.0', reference:'ansible-2.10.16-1.ph3')) flag++;
