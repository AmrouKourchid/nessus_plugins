...
if (description)
{
  ...
  script_cve_id("CVE-2019-8523");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-8523");
...
patch available.
  ...
  - Multiple memory corruption issues were addressed with improved memory handling. This issue is fixed in iOS
    ...
    crafted web content may lead to arbitrary code execution. (CVE-2019-8523)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-8523");
