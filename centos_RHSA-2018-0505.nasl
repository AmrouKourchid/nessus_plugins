...
# CentOS Errata and Security Advisory 2018:0505 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : mailman (CESA-2018:0505)");
...
listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2018-March/022793.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8ff6fee");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"mailman-2.1.15-26.el7_4.1")) flag++;
