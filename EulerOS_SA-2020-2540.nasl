...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : cairo (EulerOS-SA-2020-2540)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2540
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3343bbba");
...
pkgs = ["cairo-1.14.8-2.h4.eulerosv2r7",
        "cairo-devel-1.14.8-2.h4.eulerosv2r7",
        "cairo-gobject-1.14.8-2.h4.eulerosv2r7",
        "cairo-gobject-devel-1.14.8-2.h4.eulerosv2r7"];
