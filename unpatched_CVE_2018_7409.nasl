...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-7409");
...
patch available.
  ...
  - In unixODBC before 2.3.5, there is a buffer overflow in the unicode_to_ansi_copy() function in
