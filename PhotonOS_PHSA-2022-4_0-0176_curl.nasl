...
# extracted from VMware Security Advisory PHSA-2022-4.0-0176. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-22576", "CVE-2022-27774");

  script_name(english:"Photon OS 4.0: Curl PHSA-2022-4.0-0176");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the curl package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-176.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-7.82.0-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-devel-7.82.0-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'curl-libs-7.82.0-3.ph4')) flag++;
