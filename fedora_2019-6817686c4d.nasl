...
# extracted from Fedora Security Advisory FEDORA-2019-6817686c4d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : kernel / kernel-headers (2019-6817686c4d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-6817686c4d");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2019-12817");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2019-6817686c4d");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC30", reference:"kernel-5.1.15-300.fc30")) flag++;
if (rpm_check(release:"FC30", reference:"kernel-headers-5.1.15-300.fc30")) flag++;
