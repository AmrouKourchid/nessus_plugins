...
# extracted from Fedora Security Advisory FEDORA-2024-53d986312e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-53d986312e");

  script_name(english:"Fedora 39 : grub2 (2024-53d986312e)");
...
FEDORA-2024-53d986312e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-53d986312e");
...
var pkgs = [
    {'reference':'grub2-2.06-116.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
