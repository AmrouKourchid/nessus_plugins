...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-1989");
...
patch available.
  ...
  - Multiple integer overflows in X.org libXv 1.0.7 and earlier allow X servers to trigger allocation of
    ...
    XvListImageFormats, and (3) XvCreateImage function. (CVE-2013-1989)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1989");
