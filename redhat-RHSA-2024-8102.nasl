...
# extracted from Red Hat Security Advisory RHSA-2024:8102. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8102");

  script_name(english:"RHEL 8 : python-gevent (RHSA-2024:8102)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8102.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9b53200");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8102");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-gevent package based on the guidance in RHSA-2024:8102.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-gevent-1.2.2-5.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
