...
# extracted from Gentoo Linux Security Advisory GLSA 202007-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-02");
  script_xref(name:"IAVB", value:"2020-B-0034-S");

  script_name(english:"GLSA-202007-02 : Xen: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-02
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-02");
...
if (qpkg_check(package:"app-emulation/xen", unaffected:make_list("ge 4.12.3-r2"), vulnerable:make_list("lt 4.12.3-r2"))) flag++;
if (qpkg_check(package:"app-emulation/xen-tools", unaffected:make_list("ge 4.12.3-r2"), vulnerable:make_list("lt 4.12.3-r2"))) flag++;
