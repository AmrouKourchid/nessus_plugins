...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Wireshark PHSA-2021-4.0-0055");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-22222");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wireshark-3.4.6-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wireshark-devel-3.4.6-1.ph4')) flag++;
