...
# extracted from Fedora Security Advisory FEDORA-2024-4c6304b6fa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4c6304b6fa");

  script_name(english:"Fedora 40 : webkitgtk (2024-4c6304b6fa)");
...
FEDORA-2024-4c6304b6fa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4c6304b6fa");
...
var pkgs = [
    {'reference':'webkitgtk-2.46.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
