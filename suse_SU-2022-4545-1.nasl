...
# SUSE update advisory SUSE-SU-2022:4545-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4545-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 35 for SLE 12 SP5) (SUSE-SU-2022:4545-1)");
...
referenced in the SUSE-SU-2022:4545-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013267.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f4ba07af");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.133-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_133-default-3-2.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
          {'reference':'kgraft-patch-4_12_14-122_133-default-3-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-12.5', 'sle-live-patching-release-12.5', 'sles-release-12.5']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-122_133-default');
}
