...
# extracted from Fedora Security Advisory FEDORA-2023-3d9f7ca27f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3d9f7ca27f");

  script_name(english:"Fedora 38 : chromium (2023-3d9f7ca27f)");
...
FEDORA-2023-3d9f7ca27f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3d9f7ca27f");
...
var pkgs = [
    {'reference':'chromium-120.0.6099.109-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
