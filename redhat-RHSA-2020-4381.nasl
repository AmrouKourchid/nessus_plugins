...
# extracted from Red Hat Security Advisory RHSA-2020:4381. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-1690");
  script_xref(name:"RHSA", value:"2020:4381");

  script_name(english:"RHEL 8 : openstack-selinux (RHSA-2020:4381)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openstack-selinux.");
...
the RHSA-2020:4381 advisory.

    The openstack-selinux package is a collection of SELinux policies for running OpenStack on Red Hat
    Enterprise Linux.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4381.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cbbb556c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4381");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1789640");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1872651");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-selinux package based on the guidance in RHSA-2020:4381.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:C/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-1690");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-selinux-0.8.24-1.20200914163011.26243bf.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openstack-selinux');
}
