...
# extracted from Fedora Security Advisory FEDORA-2019-d7f8995451.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : gd (2019-d7f8995451)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d7f8995451");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"gd-2.2.5-8.fc29")) flag++;
