...
referenced in the USN-4568-1 advisory.
    ...
    It was discovered that Brotli incorrectly handled certain inputs. An attacker could possibly use this
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'brotli / libbrotli-dev / libbrotli1 / python-brotli / etc');
}
