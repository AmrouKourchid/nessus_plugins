...
# extracted from Red Hat Security Advisory RHSA-2024:3275. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3275");

  script_name(english:"RHEL 8 : python-dns (RHSA-2024:3275)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3275.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?deedaa1c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3275");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-dns package based on the guidance in RHSA-2024:3275.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-dns-1.15.0-12.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
