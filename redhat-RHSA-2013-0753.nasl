...
referenced in the RHSA-2013:0753 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2013/rhsa-2013_0753.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?091fa684");
  # http://icedtea.classpath.org/hg/release/icedtea-web-1.2/file/icedtea-web-1.2.3/NEWS
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5448697a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0753");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=884705");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=916774");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL icedtea-web package based on the guidance in RHSA-2013:0753.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1927");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2013-1926");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'icedtea-web-1.2.3-2.el6_4', 'cpu':'i686', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'icedtea-web-1.2.3-2.el6_4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'icedtea-web-javadoc-1.2.3-2.el6_4', 'cpu':'i686', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'icedtea-web-javadoc-1.2.3-2.el6_4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
