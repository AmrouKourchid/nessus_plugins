...
# extracted from SUSE update advisory SUSE-SU-2021:1576-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : openvpn (SUSE-SU-2021:1576-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1085803");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1185279");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?989266db");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"openvpn-2.3.8-16.26.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"openvpn-auth-pam-plugin-2.3.8-16.26.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"openvpn-auth-pam-plugin-debuginfo-2.3.8-16.26.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"openvpn-debuginfo-2.3.8-16.26.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"openvpn-debugsource-2.3.8-16.26.1")) flag++;
