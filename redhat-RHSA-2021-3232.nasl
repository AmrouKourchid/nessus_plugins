...
# extracted from Red Hat Security Advisory RHSA-2021:3232. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3232");

  script_name(english:"RHEL 8 : exiv2 (RHSA-2021:3232)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for exiv2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:3232 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3232.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e01043bf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3232");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1990327");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL exiv2 package based on the guidance in RHSA-2021:3232.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'exiv2-0.26-11.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'exiv2-devel-0.26-11.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'exiv2-doc-0.26-11.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'exiv2-libs-0.26-11.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
