...
# extracted from Fedora Security Advisory FEDORA-2020-495c14a23f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : fastd (2020-495c14a23f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-495c14a23f");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"fastd-21-1.fc32")) flag++;
