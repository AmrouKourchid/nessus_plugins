...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.1.1 < 1.1.1za Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.1.1za. It is, therefore, affected by a vulnerability
as referenced in the 1.1.1za advisory.
...
var constraints = [
  { 'min_version' : '1.1.1', 'fixed_version' : '1.1.1za' }
];
