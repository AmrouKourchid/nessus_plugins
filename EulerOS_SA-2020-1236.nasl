...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : xorg-x11-server (EulerOS-SA-2020-1236)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1236
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c3af0f82");
...
pkgs = ["xorg-x11-server-Xorg-1.19.5-5.h7",
        "xorg-x11-server-common-1.19.5-5.h7"];
