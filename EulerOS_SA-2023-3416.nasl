...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : shim-signed (EulerOS-SA-2023-3416)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the shim-signed package installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3416
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9e31009");
