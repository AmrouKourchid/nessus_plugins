...
# extracted from WordPress Security Advisory wordpress-6-5-5.
...
if (description)
{
  ...
  script_name(english:"WordPress 6.0 < 6.5.5");

  script_set_attribute(attribute:"synopsis", value:
"A PHP application running on the remote web server is affected by one or more vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"WordPress versions 6.0 < 6.5.5 are affected by one or more vulnerabilities");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/download/releases/");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/news/2024/06/wordpress-6-5-5/");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/documentation/wordpress-version/version-6-5-5/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to WordPress version 6.5.5 or later.");
...
var constraints = [
  { 'min_version' : '6.0', 'fixed_version' : '6.5.5' }
];
