...
# extracted from Fedora Security Advisory FEDORA-2020-d5e74bf9a0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : ansible (2020-d5e74bf9a0)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-d5e74bf9a0");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"ansible-2.9.13-1.fc32")) flag++;
