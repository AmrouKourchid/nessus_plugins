...
# extracted from openSUSE Security Update openSUSE-2019-718.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : nodejs8 (openSUSE-2019-718)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1097748");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1105019");
