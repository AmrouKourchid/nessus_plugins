...
# extracted from Ubuntu Security Notice USN-7205-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7205-2");

  script_name(english:"Ubuntu 18.04 LTS : Django vulnerability (USN-7205-2)");
...
USN-7205-2 advisory.
    ...
    USN-7205-1 fixed a vulnerability in Django. This update provides the corresponding update for Ubuntu 18.04
    LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7205-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'python-django', 'pkgver': '1:1.11.11-1ubuntu1.21+esm9', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python-django-common', 'pkgver': '1:1.11.11-1ubuntu1.21+esm9', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3-django', 'pkgver': '1:1.11.11-1ubuntu1.21+esm9', 'ubuntu_pro': TRUE}
];
