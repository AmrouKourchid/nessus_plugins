...
# extracted from Red Hat Security Advisory RHSA-2020:4163.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (RHSA-2020:4163)");
...
var pkgs = [
    {'reference':'thunderbird-78.3.1-1.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-78.3.1-1.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
