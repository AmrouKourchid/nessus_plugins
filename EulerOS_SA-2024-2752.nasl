...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.12.1 : krb5 (EulerOS-SA-2024-2752)");
...
affected by the following vulnerabilities :
    ...
    In MIT Kerberos 5 (aka krb5) before 1.21.3, an attacker can modify the plaintext Extra Count field of a
    confidential GSS krb5 wrap token, causing the unwrapped token to appear truncated to the
    application.(CVE-2024-37370)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2752
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a48d4661");
...
var pkgs = [
  "krb5-1.19.2-6.h14.eulerosv2r12",
  "krb5-client-1.19.2-6.h14.eulerosv2r12",
  "krb5-libs-1.19.2-6.h14.eulerosv2r12",
  "krb5-server-1.19.2-6.h14.eulerosv2r12"
];
