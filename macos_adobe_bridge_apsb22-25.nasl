...
"The version of Adobe Bridge installed on the remote macOS or Mac OS X host is prior to 12.0.2. It is, therefore,
affected by multiple vulnerabilities as referenced in the apsb22-25 advisory.
...
"Upgrade to Adobe Bridge version 12.0.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-28845");
