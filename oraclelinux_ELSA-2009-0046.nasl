...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : ntp (ELSA-2009-0046)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0046.html");
...
"Update the affected ntp package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0021");
...
var pkgs = [
    {'reference':'ntp-4.2.2p1-9.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntp-4.2.2p1-9.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
