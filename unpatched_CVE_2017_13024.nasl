...
if (description)
{
  ...
  script_cve_id("CVE-2017-13024");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-13024");
...
patch available.
  ...
  - The IPv6 mobility parser in tcpdump before 4.9.2 has a buffer over-read in print-
    mobility.c:mobility_opt_print(). (CVE-2017-13024)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-13024");
