...
# extracted from Fedora Security Advisory FEDORA-2024-499b9be35f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-499b9be35f");

  script_name(english:"Fedora 39 : bind9-next (2024-499b9be35f)");
...
FEDORA-2024-499b9be35f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-499b9be35f");
...
var pkgs = [
    {'reference':'bind9-next-9.19.21-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
];
