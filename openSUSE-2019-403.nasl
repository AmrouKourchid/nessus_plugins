...
# extracted from openSUSE Security Update openSUSE-2019-403.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : pdns (openSUSE-2019-403)");
...
Security issues fixed :
  ...
  - CVE-2018-1046: Fix an issue with replaying a specially
    crafted PCAP file that can trigger a stack-based buffer
    overflow, leading to a crash and potentially arbitrary
    code execution (bsc#1092540).");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1092540");
...
if ( rpm_check(release:"SUSE15.0", reference:"pdns-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-geoip-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-geoip-debuginfo-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-godbc-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-godbc-debuginfo-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-ldap-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-ldap-debuginfo-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-lua-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-lua-debuginfo-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-mydns-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-mydns-debuginfo-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-mysql-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-mysql-debuginfo-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-postgresql-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-postgresql-debuginfo-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-remote-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-remote-debuginfo-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-sqlite3-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-backend-sqlite3-debuginfo-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-debuginfo-4.1.2-lp150.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pdns-debugsource-4.1.2-lp150.3.3.1") ) flag++;
