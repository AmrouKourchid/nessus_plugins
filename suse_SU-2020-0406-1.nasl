...
# extracted from SUSE update advisory SUSE-SU-2020:0406-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : sudo (SUSE-SU-2020:0406-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1471c298");
...
SUSE-OpenStack-Cloud-Crowbar-8-2020-406=1

SUSE OpenStack Cloud 8:zypper in -t patch
SUSE-OpenStack-Cloud-8-2020-406=1

SUSE Linux Enterprise Software Development Kit 12-SP4:zypper in -t
patch SUSE-SLE-SDK-12-SP4-2020-406=1

SUSE Linux Enterprise Server for SAP 12-SP3:zypper in -t patch
SUSE-SLE-SAP-12-SP3-2020-406=1

SUSE Linux Enterprise Server 12-SP4:zypper in -t patch
SUSE-SLE-SERVER-12-SP4-2020-406=1

SUSE Linux Enterprise Server 12-SP3-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP3-2020-406=1

SUSE Linux Enterprise Server 12-SP3-BCL:zypper in -t patch
SUSE-SLE-SERVER-12-SP3-BCL-2020-406=1

SUSE Linux Enterprise Desktop 12-SP4:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP4-2020-406=1

SUSE Enterprise Storage 5:zypper in -t patch SUSE-Storage-5-2020-406=1
...
HPE-Helion-OpenStack-8-2020-406=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"sudo-1.8.20p2-3.17.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"sudo-debuginfo-1.8.20p2-3.17.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"sudo-debugsource-1.8.20p2-3.17.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"sudo-1.8.20p2-3.17.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"sudo-debuginfo-1.8.20p2-3.17.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"sudo-debugsource-1.8.20p2-3.17.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"sudo-1.8.20p2-3.17.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"sudo-debuginfo-1.8.20p2-3.17.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"sudo-debugsource-1.8.20p2-3.17.1")) flag++;
