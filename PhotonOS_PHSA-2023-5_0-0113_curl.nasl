...
# extracted from VMware Security Advisory PHSA-2023-5.0-0113. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Curl PHSA-2023-5.0-0113");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the curl package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-113.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'curl-8.1.2-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'curl-devel-8.1.2-6.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'curl-libs-8.1.2-6.ph5')) flag++;
