...
# extracted from Fedora Security Advisory FEDORA-2019-3fc86a518b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-3fc86a518b");

  script_name(english:"Fedora 29 : 2:runc (2019-3fc86a518b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-3fc86a518b");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"runc-1.0.0-95.rc9.gitc1485a1.fc29", epoch:"2")) flag++;
