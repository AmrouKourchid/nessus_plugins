...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Kubernetes PHSA-2019-2.0-0120");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-18264");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'kubernetes-dashboard-1.10.1-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'kubernetes-dashboard-debuginfo-1.10.1-1.ph2')) flag++;
