...
# extracted from Red Hat Security Advisory RHSA-2024:3968. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3968");

  script_name(english:"RHEL 8 : container-tools:rhel8  update (Moderate) (RHSA-2024:3968)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:3968 advisory.
    ...
    * skopeo: jose-go: resource exhaustion (CVE-2024-28176)
    ...
    For detailed information on changes in this release, see the Red Hat Enterprise Linux 8 Release Notes
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3968.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3d8df451");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-39988");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3968");
  ...
  'container-tools:rhel8': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'buildah-1.33.7-2.module+el8.10.0+21962+8143777b', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'buildah-tests-1.33.7-2.module+el8.10.0+21962+8143777b', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        ...
        {'reference':'podman-4.9.4-3.module+el8.10.0+21974+acd2159c', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
        {'reference':'podman-catatonit-4.9.4-3.module+el8.10.0+21974+acd2159c', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
        {'reference':'podman-docker-4.9.4-3.module+el8.10.0+21974+acd2159c', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
        {'reference':'podman-gvproxy-4.9.4-3.module+el8.10.0+21974+acd2159c', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
        {'reference':'podman-plugins-4.9.4-3.module+el8.10.0+21974+acd2159c', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
        {'reference':'podman-remote-4.9.4-3.module+el8.10.0+21974+acd2159c', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
        {'reference':'podman-tests-4.9.4-3.module+el8.10.0+21974+acd2159c', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
        ...
        {'reference':'skopeo-1.14.3-2.module+el8.10.0+21962+8143777b', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'skopeo-tests-1.14.3-2.module+el8.10.0+21962+8143777b', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
