...
# extracted from Fedora Security Advisory FEDORA-2024-ed546e3543
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ed546e3543");
  script_xref(name:"IAVB", value:"2024-B-0095-S");

  script_name(english:"Fedora 39 : xen (2024-ed546e3543)");
...
FEDORA-2024-ed546e3543 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ed546e3543");
...
var pkgs = [
    {'reference':'xen-4.17.4-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
