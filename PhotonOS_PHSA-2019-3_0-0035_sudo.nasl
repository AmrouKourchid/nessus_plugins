...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Sudo PHSA-2019-3.0-0035");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'sudo-1.8.23-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'sudo-debuginfo-1.8.23-2.ph3')) flag++;
