...
if (description)
{
  ...
  script_cve_id("CVE-2016-8633");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-8633");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2016/11/06");
