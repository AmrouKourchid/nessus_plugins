...
# extracted from Oracle Linux Security Advisory ELSA-2024-3105.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python3.11-cryptography (ELSA-2024-3105)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-3105.html");
