...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Haproxy PHSA-2023-3.0-0637");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'haproxy-2.2.31-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'haproxy-doc-2.2.31-1.ph3')) flag++;
