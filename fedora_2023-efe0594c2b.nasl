...
# extracted from Fedora Security Advisory FEDORA-2023-efe0594c2b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-efe0594c2b");

  script_name(english:"Fedora 36 : webkit2gtk3 (2023-efe0594c2b)");
...
FEDORA-2023-efe0594c2b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-efe0594c2b");
...
var pkgs = [
    {'reference':'webkit2gtk3-2.38.5-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
