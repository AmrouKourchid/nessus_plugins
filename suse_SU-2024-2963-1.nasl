...
# SUSE update advisory SUSE-SU-2024:2963-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:2963-1");

  script_name(english:"SUSE SLES12 Security Update : osc (SUSE-SU-2024:2963-1)");
...
in the SUSE-SU-2024:2963-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2024-August/036631.html");
...
var pkgs = [
    {'reference':'osc-0.183.0-15.18.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'osc-0.183.0-15.18.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-sdk-release-12.5', 'sles-release-12.5']}
];
