...
# extracted from Red Hat Security Advisory RHSA-2020:2902 and 
# Oracle Linux Security Advisory ELSA-2020-2902 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : sane-backends (ELSA-2020-2902)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2020-2902 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-2902.html");
...
var pkgs = [
    ...
    {'reference':'sane-backends-devel-1.0.27-19.el8_2.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sane-backends-doc-1.0.27-19.el8_2.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sane-backends-drivers-cameras-1.0.27-19.el8_2.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sane-backends-drivers-scanners-1.0.27-19.el8_2.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sane-backends-libs-1.0.27-19.el8_2.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
