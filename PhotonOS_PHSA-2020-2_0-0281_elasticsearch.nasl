...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Elasticsearch PHSA-2020-2.0-0281");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'elasticsearch-6.8.12-1.ph2')) flag++;
