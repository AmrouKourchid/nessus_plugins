...
# extracted from Red Hat Security Advisory RHSA-2017:1581. The text 
...
the RHSA-2017:1581 advisory.
    ...
    * An authentication bypass flaw was found in the way the EAP module in FreeRADIUS handled TLS session
    resumption. A remote unauthenticated attacker could potentially use this flaw to bypass the inner
    authentication check in FreeRADIUS by resuming an older unauthenticated TLS session. (CVE-2017-9148)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_1581.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d83f8ce");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:1581");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1456697");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL freeradius package based on the guidance in RHSA-2017:1581.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freeradius-3.0.4-8.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-devel-3.0.4-8.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-doc-3.0.4-8.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-krb5-3.0.4-8.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-ldap-3.0.4-8.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-mysql-3.0.4-8.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-perl-3.0.4-8.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-postgresql-3.0.4-8.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-python-3.0.4-8.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-sqlite-3.0.4-8.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-unixODBC-3.0.4-8.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-utils-3.0.4-8.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
