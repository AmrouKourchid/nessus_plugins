...
if (description)
{
  ...
  script_name(english:"IBM WebSphere Application Server SEoL (6.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of IBM WebSphere Application Server is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, IBM WebSphere Application Server is 6.1.x. It is, therefore, no longer maintained by its
vendor or provider.
...
"Upgrade to a version of IBM WebSphere Application Server that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2013/09/30");
...
var constraints = [
  { max_branch : '6.1', min_branch : '6.1', seol : 20130930, eseol : 20160930 }
];
