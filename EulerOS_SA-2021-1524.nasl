...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : util-linux (EulerOS-SA-2021-1524)");
...
the following vulnerability :
  ...
  - runuser in util-linux allows local users to escape to
    the parent session via a crafted TIOCSTI ioctl call,
    which pushes characters to the terminal's input
    buffer.(CVE-2016-2779)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1524
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d5ce4a5");
...
pkgs = ["libblkid-2.23.2-52.1.h11.eulerosv2r7",
        "libblkid-devel-2.23.2-52.1.h11.eulerosv2r7",
        "libmount-2.23.2-52.1.h11.eulerosv2r7",
        "libuuid-2.23.2-52.1.h11.eulerosv2r7",
        "libuuid-devel-2.23.2-52.1.h11.eulerosv2r7",
        "util-linux-2.23.2-52.1.h11.eulerosv2r7",
        "uuidd-2.23.2-52.1.h11.eulerosv2r7"];
