...
# extracted from Fedora Security Advisory FEDORA-2023-58eac2b872
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-58eac2b872");

  script_name(english:"Fedora 36 : kernel (2023-58eac2b872)");
...
FEDORA-2023-58eac2b872 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-58eac2b872");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-58eac2b872');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.1.7-100.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
