...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / tar (ELSA-2007-0860)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0860.html");
...
"Update the affected tar package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-4131");
...
var pkgs = [
    {'reference':'tar-1.15.1-23.0.1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'tar-1.15.1-23.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
