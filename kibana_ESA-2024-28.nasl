...
if (description)
{
  ...
  script_cve_id("CVE-2024-37285");
  script_xref(name:"IAVB", value:"2024-B-0131-S");

  script_name(english:"Kibana 8.10.x < 8.15.1 (ESA-2024-28)");
...
"Upgrade to Kibana version 8.15.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-37285");
...
var constraints = [
  { 'min_version' : '8.10.0', 'fixed_version' : '8.15.1' }
];
