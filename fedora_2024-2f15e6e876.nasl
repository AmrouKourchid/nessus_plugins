...
# extracted from Fedora Security Advisory FEDORA-2024-2f15e6e876
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2f15e6e876");

  script_name(english:"Fedora 40 : llhttp / python-aiohttp (2024-2f15e6e876)");
...
FEDORA-2024-2f15e6e876 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2f15e6e876");
...
var pkgs = [
    {'reference':'llhttp-9.2.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-aiohttp-3.9.3-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
