...
# SUSE update advisory SUSE-SU-2023:4065-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4065-1");

  script_name(english:"SUSE SLES12 Security Update : opensc (SUSE-SU-2023:4065-1)");
...
referenced in the SUSE-SU-2023:4065-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-October/016643.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0db310b5");
...
"Update the affected opensc package.");
  ...
  script_set_cvss3_base_vector("CVSS:3.0/AV:P/AC:L/PR:L/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-42782");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-40661");
...
var pkgs = [
    {'reference':'opensc-0.13.0-3.25.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'opensc-0.13.0-3.25.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
