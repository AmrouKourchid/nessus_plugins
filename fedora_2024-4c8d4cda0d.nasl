...
# extracted from Fedora Security Advisory FEDORA-2024-4c8d4cda0d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4c8d4cda0d");

  script_name(english:"Fedora 39 : stb (2024-4c8d4cda0d)");
...
FEDORA-2024-4c8d4cda0d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4c8d4cda0d");
...
var pkgs = [
    {'reference':'stb-0^20240213gitae721c5-6.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
