...
# extracted from openSUSE Security Update openSUSE-2020-624.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : LibVNCServer (openSUSE-2020-624)");
...
"This update for LibVNCServer fixes the following issues :
  ...
  - CVE-2019-15690: Fixed a heap buffer overflow
    (bsc#1160471).
  ...
  - CVE-2019-20788: Fixed a integer overflow and heap-based
    buffer overflow via a large height or width value
    (bsc#1170441).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1155419");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1160471");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1170441");
...
if ( rpm_check(release:"SUSE15.1", reference:"LibVNCServer-debugsource-0.9.10-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"LibVNCServer-devel-0.9.10-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libvncclient0-0.9.10-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libvncclient0-debuginfo-0.9.10-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libvncserver0-0.9.10-lp151.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libvncserver0-debuginfo-0.9.10-lp151.7.3.1") ) flag++;
