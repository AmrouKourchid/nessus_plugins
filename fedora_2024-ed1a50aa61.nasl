...
# extracted from Fedora Security Advisory FEDORA-2024-ed1a50aa61
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ed1a50aa61");

  script_name(english:"Fedora 40 : wolfssl (2024-ed1a50aa61)");
...
FEDORA-2024-ed1a50aa61 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ed1a50aa61");
  script_set_attribute(attribute:"solution", value:
"Update the affected wolfssl package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-1545");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:wolfssl");
...
var pkgs = [
    {'reference':'wolfssl-5.7.2-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'wolfssl');
}
