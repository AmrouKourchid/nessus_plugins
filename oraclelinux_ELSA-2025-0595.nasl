...
# extracted from Oracle Linux Security Advisory ELSA-2025-0595.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : redis:6 (ELSA-2025-0595)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2025-0595 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-0595.html");
...
var appstreams = {
    'redis:6': [
      {'reference':'redis-6.2.17-1.0.1.module+el8.10.0+90491+f9002f77', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-6.2.17-1.0.1.module+el8.10.0+90491+f9002f77', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-doc-6.2.17-1.0.1.module+el8.10.0+90491+f9002f77', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-6.2.17-1.0.1.module+el8.10.0+90491+f9002f77', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-devel-6.2.17-1.0.1.module+el8.10.0+90491+f9002f77', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'redis-doc-6.2.17-1.0.1.module+el8.10.0+90491+f9002f77', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
