...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_4361.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5a5e7154");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:4361");
...
"Update the RHEL fribidi package based on the guidance in RHSA-2019:4361.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'fribidi-1.0.4-7.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fribidi-devel-1.0.4-7.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'fribidi-1.0.4-7.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'fribidi-devel-1.0.4-7.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
