...
if (description)
{
  ...
  script_cve_id("CVE-2023-1775");
  script_xref(name:"IAVA", value:"2023-A-0250-S");

  script_name(english:"Mattermost Server < 7.1.6 / 7.2.x < 7.7.2 Information Disclosure (MMSA-2023-00138)");

  script_set_attribute(attribute:"synopsis", value:
"A web application running on the remote server is affected by an information disclosure vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Mattermost Server running on the remote host is prior to 7.1.6 or 7.2.x prior to 7.7.2. It is,
therefore, affected by an information disclosure vulnerability. When running in a High Availability configuration, 
Mattermost fails to sanitize some of the user_updated and post_deleted events broadcast to all users, leading to
disclosure of sensitive information to some of the users with currently connected Websocket clients.
...
"Upgrade to Mattermost Server version 7.1.6, 7.7.2, 7.8.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-1775");
