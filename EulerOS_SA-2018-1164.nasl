...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libevent (EulerOS-SA-2018-1164)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the libevent package installed, the
...
vulnerability :
  ...
  - Multiple integer overflows in the evbuffer API in
    ...
    buffer overflow or an infinite loop.(CVE-2014-6272)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1164
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?17e39be2");
  script_set_attribute(attribute:"solution", value:
"Update the affected libevent package.");
