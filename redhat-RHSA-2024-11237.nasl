...
# extracted from Red Hat Security Advisory RHSA-2024:11237. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:11237");

  script_name(english:"RHEL 9 : libsndfile:1.0.31 (RHSA-2024:11237)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libsndfile:1.0.31.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_11237.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d159eb8c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11237");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsndfile:1.0.31 package based on the guidance in RHSA-2024:11237.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsndfile-1.0.31-8.el9_5.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsndfile-devel-1.0.31-8.el9_5.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsndfile-utils-1.0.31-8.el9_5.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
