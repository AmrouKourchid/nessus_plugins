...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1122675");
...
"Update the affected osc package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-3681");
