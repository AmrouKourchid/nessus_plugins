...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : openssl (EulerOS-SA-2024-2145)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2145
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bea36654");
...
var pkgs = [
  "openssl-1.1.1f-8.h47.r2.eulerosv2r10",
  "openssl-libs-1.1.1f-8.h47.r2.eulerosv2r10",
  "openssl-perl-1.1.1f-8.h47.r2.eulerosv2r10"
];
