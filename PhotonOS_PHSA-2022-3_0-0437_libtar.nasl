...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libtar PHSA-2022-3.0-0437");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtar-1.2.20-6.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libtar-devel-1.2.20-6.ph3')) flag++;
