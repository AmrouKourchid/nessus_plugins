...
if (description)
{
  ...
  script_cve_id("CVE-2016-7979");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-7979");
...
patch available.
  ...
  - Ghostscript before 9.21 might allow remote attackers to bypass the SAFER mode protection mechanism and
    consequently execute arbitrary code by leveraging type confusion in .initialize_dsc_parser.
    (CVE-2016-7979)
