...
# extracted from Red Hat Security Advisory RHSA-2021:0489. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0489");
  ...
  script_name(english:"RHEL 7 : Red Hat JBoss Web Server 3.1 Service Pack 11 (RHSA-2021:0489)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat JBoss Web Server 3.1 Service Pack 11.");
...
the RHSA-2021:0489 advisory.
    ...
    This release of Red Hat JBoss Web Server 3.1 Service Pack 11 serves as a replacement for Red Hat JBoss Web
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0489.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b2a65032");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0489");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1903409");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/JWS-1938");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat JBoss Web Server 3.1 Service Pack 11 package based on the guidance in RHSA-2021:0489.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tomcat-native-1.2.23-23.redhat_23.ep7.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-3'}
    ]
  }
];
