...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : gstreamer-plugins-good (EulerOS-SA-2021-2331)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the gstreamer-plugins-good package
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2331
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8866c2f6");
...
pkgs = ["gstreamer-plugins-good-0.10.31-13.h3.eulerosv2r7"];
