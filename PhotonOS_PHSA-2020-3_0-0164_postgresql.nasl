...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Postgresql PHSA-2020-3.0-0164");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the postgresql package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-164.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'postgresql-10.15-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'postgresql-devel-10.15-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'postgresql-libs-10.15-1.ph3')) flag++;
