...
# SUSE update advisory SUSE-SU-2024:2115-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-46955", "CVE-2023-6931", "CVE-2024-26852");
  script_xref(name:"SuSE", value:"SUSE-SU-2024:2115-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 43 for SLE 15 SP2) (SUSE-SU-2024:2115-1)");
...
the SUSE-SU-2024:2115-1 advisory.
    ...
    (bsc#1220537).
    - CVE-2023-6931: Fixed an out of bounds write in the Performance Events subsystem when adding a new event
    (bsc#1218259).
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-June/018778.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e9ed3a13");
...
"Update the affected kernel-livepatch-5_3_18-150200_24_172-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150200.24.172-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150200_24_172-default-8-150200.2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150200_24_172-default');
}
