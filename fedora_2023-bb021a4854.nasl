...
# extracted from Fedora Security Advisory FEDORA-2023-bb021a4854
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bb021a4854");

  script_name(english:"Fedora 38 : thunderbird (2023-bb021a4854)");
...
FEDORA-2023-bb021a4854 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bb021a4854");
...
var pkgs = [
    {'reference':'thunderbird-115.5.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
