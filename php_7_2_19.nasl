...
if (description)
{
  ...
  script_name(english:"PHP 7.2.x < 7.2.19 Multiple Vulnerabilities.");
...
It is, therefore, affected by the following vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.2.19");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 7.2.19 or later.");
