...
# extracted from Red Hat Security Advisory ovirt-engine-backend. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2013-2144", "CVE-2014-3706", "CVE-2015-1780");

  script_name(english:"RHEL 7 : ovirt-engine-backend (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3706");
