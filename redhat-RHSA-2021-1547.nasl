...
the RHSA-2021:1547 advisory.
    ...
    are .NET Core SDK 3.1.115 and .NET Core Runtime 3.1.15.

    Security Fix(es):

    * dotnet: .NET Core single-file application privilege escalation (CVE-2021-31204)

    In order for the update to be complete, self-contained applications deployed using previous versions need
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1547.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dec17d7a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1547");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1956815");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet31-aspnetcore-runtime-3.1-3.1.15-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-aspnetcore-targeting-pack-3.1-3.1.15-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-3.1.115-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-apphost-pack-3.1-3.1.15-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-host-3.1.15-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-hostfxr-3.1-3.1.15-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-runtime-3.1-3.1.15-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-sdk-3.1-3.1.115-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-targeting-pack-3.1-3.1.15-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-templates-3.1-3.1.115-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-netstandard-targeting-pack-2.1-3.1.115-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'}
    ]
  }
];
