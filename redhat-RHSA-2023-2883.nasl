...
# extracted from Red Hat Security Advisory RHSA-2023:2883. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2883");

  script_name(english:"RHEL 8 : libtiff (RHSA-2023:2883)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libtiff.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:2883 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2883.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad9ba21b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2883");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libtiff package based on the guidance in RHSA-2023:2883.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libtiff-4.0.9-27.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-4.0.9-27.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-tools-4.0.9-27.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
