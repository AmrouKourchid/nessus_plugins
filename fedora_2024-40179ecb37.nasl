...
# extracted from Fedora Security Advisory FEDORA-2024-40179ecb37
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-40179ecb37");

  script_name(english:"Fedora 39 : suricata (2024-40179ecb37)");
...
FEDORA-2024-40179ecb37 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-40179ecb37");
...
var pkgs = [
    {'reference':'suricata-6.0.20-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
