...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5055521");
  script_xref(name:"MSFT", value:"MS25-5055521");
  script_xref(name:"IAVA", value:"2025-A-0255");
  script_xref(name:"IAVA", value:"2025-A-0256");

  script_name(english:"KB5055521: Windows 10 Version 1607 / Windows Server 2016 Security Update (April 2025)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5055521");
