...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : squirrelmail (RHSA-2009:0010)");
...
referenced in the RHSA-2009:0010 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2009/rhsa-2009_0010.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ee621f4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=464183");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=473877");
  script_set_attribute(attribute:"see_also", value:"http://www.squirrelmail.org/security/issue/2008-09-28");
  script_set_attribute(attribute:"see_also", value:"http://www.squirrelmail.org/security/issue/2008-12-04");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2009:0010");
...
"Update the RHEL squirrelmail package based on the guidance in RHSA-2009:0010.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-3663");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2008-2379");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squirrelmail-1.4.8-5.el4_7.2', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'squirrelmail-1.4.8-5.el5_2.2', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
