...
# extracted from Ubuntu Security Notice USN-3177-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Tomcat vulnerabilities (USN-3177-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS / 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as
referenced in the USN-3177-1 advisory.

    It was discovered that the Tomcat realm implementations incorrectly handled passwords when a username
    didn't exist. A remote attacker could possibly use this issue to enumerate usernames. This issue only
    applied to Ubuntu 12.04 LTS, Ubuntu 14.04 LTS and Ubuntu 16.04 LTS. (CVE-2016-0762)

    Alvaro Munoz and Alexander Mirosh discovered that Tomcat incorrectly limited use of a certain utility
    method. A malicious application could possibly use this to bypass Security Manager restrictions. This
    issue only applied to Ubuntu 12.04 LTS, Ubuntu 14.04 LTS and Ubuntu 16.04 LTS. (CVE-2016-5018)

    It was discovered that Tomcat did not protect applications from untrusted data in the HTTP_PROXY
    environment variable. A remote attacker could possibly use this issue to redirect outbound traffic to an
    arbitrary proxy server. This issue only applied to Ubuntu 12.04 LTS, Ubuntu 14.04 LTS and Ubuntu 16.04
    LTS. (CVE-2016-5388)

    It was discovered that Tomcat incorrectly controlled reading system properties. A malicious application
    could possibly use this to bypass Security Manager restrictions. This issue only applied to Ubuntu 12.04
    ...
    application could possibly use this to bypass Security Manager restrictions. This issue only applied to
    Ubuntu 12.04 LTS, Ubuntu 14.04 LTS and Ubuntu 16.04 LTS. (CVE-2016-6796)

    It was discovered that Tomcat incorrectly limited access to global JNDI resources. A malicious application
    could use this to access any global JNDI resource without an explicit ResourceLink. This issue only
    applied to Ubuntu 12.04 LTS, Ubuntu 14.04 LTS and Ubuntu 16.04 LTS. (CVE-2016-6797)
    ...
    It was discovered that Tomcat incorrectly handled error handling in the send file code. A remote attacker
    could possibly use this issue to access information from other requests. (CVE-2016-8745)

    Paul Szabo discovered that the Tomcat package incorrectly handled upgrades and removals. A local attacker
    could possibly use this issue to obtain root privileges. (CVE-2016-9774, CVE-2016-9775)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3177-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libservlet3.0-java', 'pkgver': '7.0.52-1ubuntu0.8'},
    {'osver': '14.04', 'pkgname': 'libtomcat7-java', 'pkgver': '7.0.52-1ubuntu0.8'},
    {'osver': '14.04', 'pkgname': 'tomcat7', 'pkgver': '7.0.52-1ubuntu0.8'},
    {'osver': '14.04', 'pkgname': 'tomcat7-admin', 'pkgver': '7.0.52-1ubuntu0.8'},
    {'osver': '14.04', 'pkgname': 'tomcat7-common', 'pkgver': '7.0.52-1ubuntu0.8'},
    {'osver': '14.04', 'pkgname': 'tomcat7-examples', 'pkgver': '7.0.52-1ubuntu0.8'},
    {'osver': '14.04', 'pkgname': 'tomcat7-user', 'pkgver': '7.0.52-1ubuntu0.8'},
    {'osver': '16.04', 'pkgname': 'libservlet3.1-java', 'pkgver': '8.0.32-1ubuntu1.3'},
    {'osver': '16.04', 'pkgname': 'libtomcat8-java', 'pkgver': '8.0.32-1ubuntu1.3'},
    {'osver': '16.04', 'pkgname': 'tomcat8', 'pkgver': '8.0.32-1ubuntu1.3'},
    {'osver': '16.04', 'pkgname': 'tomcat8-admin', 'pkgver': '8.0.32-1ubuntu1.3'},
    {'osver': '16.04', 'pkgname': 'tomcat8-common', 'pkgver': '8.0.32-1ubuntu1.3'},
    {'osver': '16.04', 'pkgname': 'tomcat8-examples', 'pkgver': '8.0.32-1ubuntu1.3'},
    {'osver': '16.04', 'pkgname': 'tomcat8-user', 'pkgver': '8.0.32-1ubuntu1.3'}
];
