...
# extracted from Fedora Security Advisory FEDORA-2025-7d661758bd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-7d661758bd");

  script_name(english:"Fedora 41 : mod_auth_openidc (2025-7d661758bd)");
...
FEDORA-2025-7d661758bd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-7d661758bd");
...
var pkgs = [
    {'reference':'mod_auth_openidc-2.4.16.11-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
