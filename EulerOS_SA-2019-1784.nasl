...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : exiv2 (EulerOS-SA-2019-1784)");
...
vulnerabilities :
  ...
  - There is an infinite loop in the
    Exiv2::Image::printIFDStructure function of image.cpp
    in Exiv2 0.27-RC1. A crafted input will lead to a
    remote denial of service attack.(CVE-2018-18915)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1784
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37610f0d");
...
"Update the affected exiv2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-19607");
...
pkgs = ["exiv2-0.26-12.h2.eulerosv2r8",
        "exiv2-libs-0.26-12.h2.eulerosv2r8"];
