...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : libtiff (EulerOS-SA-2023-3380)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3380
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6831245d");
...
var pkgs = [
  "libtiff-4.3.0-9.h22.eulerosv2r11"
];
