...
if (description)
{
  ...
  script_cve_id("CVE-2023-50176");
  script_xref(name:"IAVA", value:"2024-A-0745");

  script_name(english:"Fortinet Fortigate - SSLVPN session hijacking using SAML authentication (FG-IR-23-475)");
...
vulnerability as referenced in the FG-IR-23-475 advisory.

  - A session fixation in Fortinet FortiOS version 7.4.0 through 7.4.3 and 7.2.0 through 7.2.7 and 7.0.0
    through 7.0.13 allows attacker to execute unauthorized code or commands via phishing SAML authentication
    link. (CVE-2023-50176)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-23-475");
...
"Upgrade to Fortigate version 7.0.14 / 7.2.8 / 7.4.4 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-50176");
