...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Open vSwitch vulnerabilities (USN-3450-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-3450-1 advisory.

    Bhargava Shastry discovered that Open vSwitch incorrectly handled certain OFP messages. A remote attacker
    could possibly use this issue to cause Open vSwitch to crash, resulting in a denial of service.
    (CVE-2017-9214)

    It was discovered that Open vSwitch incorrectly handled certain OpenFlow role messages. A remote attacker
    could possibly use this issue to cause Open vSwitch to crash, resulting in a denial of service.
    (CVE-2017-9263)

    It was discovered that Open vSwitch incorrectly handled certain malformed packets. A remote attacker could
    ...
    It was discovered that Open vSwitch incorrectly handled group mod OpenFlow messages. A remote attacker
    could possibly use this issue to cause Open vSwitch to crash, resulting in a denial of service.
    (CVE-2017-9265)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3450-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'openvswitch-common', 'pkgver': '2.5.2-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openvswitch-ipsec', 'pkgver': '2.5.2-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openvswitch-pki', 'pkgver': '2.5.2-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openvswitch-switch', 'pkgver': '2.5.2-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openvswitch-switch-dpdk', 'pkgver': '2.5.2-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openvswitch-test', 'pkgver': '2.5.2-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openvswitch-testcontroller', 'pkgver': '2.5.2-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openvswitch-vtep', 'pkgver': '2.5.2-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'ovn-central', 'pkgver': '2.5.2-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'ovn-common', 'pkgver': '2.5.2-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'ovn-host', 'pkgver': '2.5.2-0ubuntu0.16.04.2'},
    {'osver': '16.04', 'pkgname': 'python-openvswitch', 'pkgver': '2.5.2-0ubuntu0.16.04.2'}
];
