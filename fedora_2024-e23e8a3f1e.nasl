...
# extracted from Fedora Security Advisory FEDORA-2024-e23e8a3f1e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e23e8a3f1e");

  script_name(english:"Fedora 40 : dovecot (2024-e23e8a3f1e)");
...
FEDORA-2024-e23e8a3f1e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e23e8a3f1e");
...
var pkgs = [
    {'reference':'dovecot-2.3.21.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
