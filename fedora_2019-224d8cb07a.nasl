...
# extracted from Fedora Security Advisory FEDORA-2019-224d8cb07a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-224d8cb07a");

  script_name(english:"Fedora 31 : 1:xpdf (2019-224d8cb07a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-224d8cb07a");
...
"Update the affected 1:xpdf package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-17064");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"xpdf-4.02-2.fc31", epoch:"1")) flag++;
