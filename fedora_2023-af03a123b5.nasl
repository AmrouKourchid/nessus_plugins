...
# extracted from Fedora Security Advisory FEDORA-2023-af03a123b5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-af03a123b5");

  script_name(english:"Fedora 37 : community-mysql (2023-af03a123b5)");
...
FEDORA-2023-af03a123b5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-af03a123b5");
...
var pkgs = [
    {'reference':'community-mysql-8.0.33-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
