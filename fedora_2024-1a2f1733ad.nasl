...
# extracted from Fedora Security Advisory FEDORA-2024-1a2f1733ad
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1a2f1733ad");

  script_name(english:"Fedora 41 : python-sql (2024-1a2f1733ad)");
...
FEDORA-2024-1a2f1733ad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1a2f1733ad");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-sql package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-sql");
...
var pkgs = [
    {'reference':'python-sql-1.5.2-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-sql');
}
