...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : expat (EulerOS-SA-2019-1758)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1758
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d245ee94");
...
pkgs = ["expat-2.1.0-10.h5.eulerosv2r7",
        "expat-devel-2.1.0-10.h5.eulerosv2r7"];
