...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : golang (EulerOS-SA-2021-1792)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1792
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8ae2c965");
...
pkgs = ["golang-1.13.3-9.h5",
        "golang-bin-1.13.3-9.h5",
        "golang-src-1.13.3-9.h5"];
