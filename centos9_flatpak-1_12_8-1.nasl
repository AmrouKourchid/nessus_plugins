...
if (description)
{
  ...
  script_name(english:"CentOS 9 : flatpak-1.12.8-1.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for flatpak.");
...
flatpak-1.12.8-1.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=34405");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream flatpak package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:flatpak-tests");
...
var pkgs = [
    ...
    {'reference':'flatpak-tests-1.12.8-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
