...
# extracted from Ubuntu Security Notice USN-4062-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : WavPack vulnerabilities (USN-4062-1)");
...
the USN-4062-1 advisory.

    Rohan Padhye discovered that WavPack incorrectly handled certain WAV files. An attacker could possibly use
    this issue to cause a denial of service. (CVE-2019-1010315, CVE-2019-1010317, CVE-2019-1010318,
    CVE-2019-1010319)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4062-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libwavpack-dev', 'pkgver': '5.1.0-2ubuntu1.4'},
    {'osver': '18.04', 'pkgname': 'libwavpack1', 'pkgver': '5.1.0-2ubuntu1.4'},
    {'osver': '18.04', 'pkgname': 'wavpack', 'pkgver': '5.1.0-2ubuntu1.4'}
];
