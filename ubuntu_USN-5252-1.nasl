...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : PolicyKit vulnerability (USN-5252-1)");
...
in the USN-5252-1 advisory.

    It was discovered that the PolicyKit pkexec tool incorrectly handled command-line arguments. A local
    attacker could use this issue to escalate privileges to an administrator.
