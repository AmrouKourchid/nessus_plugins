...
# extracted from Red Hat Security Advisory RHSA-2023:5721. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5721");
  script_xref(name:"IAVB", value:"2023-B-0080-S");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");
  script_xref(name:"IAVB", value:"2023-B-0083-S");

  script_name(english:"RHEL 8 : go-toolset:rhel8 (RHSA-2023:5721)");
...
referenced in the RHSA-2023:5721 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5721.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8c4437b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5721");
...
"Update the RHEL go-toolset:rhel8 package based on the guidance in RHSA-2023:5721.");
  ...
  'go-toolset:rhel8': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'go-toolset-1.19.13-1.module+el8.8.0+20380+7171fefb', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-bin-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-docs-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-misc-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-race-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-src-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-tests-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        ...
        {'reference':'go-toolset-1.19.13-1.module+el8.8.0+20380+7171fefb', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-bin-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-docs-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-misc-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-race-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'sp':'8', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-src-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-tests-1.19.13-1.module+el8.8.0+20373+d9cd605c', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
