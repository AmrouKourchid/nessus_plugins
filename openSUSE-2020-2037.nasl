...
# extracted from openSUSE Security Update openSUSE-2020-2037.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : krb5 (openSUSE-2020-2037)");
...
if ( rpm_check(release:"SUSE15.1", reference:"krb5-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-client-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-client-debuginfo-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-debuginfo-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-debugsource-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-devel-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-mini-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-mini-debuginfo-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-mini-debugsource-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-mini-devel-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-plugin-kdb-ldap-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-plugin-kdb-ldap-debuginfo-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-plugin-preauth-otp-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-plugin-preauth-otp-debuginfo-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-plugin-preauth-pkinit-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-plugin-preauth-pkinit-debuginfo-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-server-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"krb5-server-debuginfo-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"krb5-32bit-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"krb5-32bit-debuginfo-1.16.3-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"krb5-devel-32bit-1.16.3-lp151.2.15.1") ) flag++;
