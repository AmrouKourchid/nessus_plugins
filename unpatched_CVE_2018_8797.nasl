...
if (description)
{
  ...
  script_cve_id("CVE-2018-8797");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-8797");
...
patch available.
  ...
  - rdesktop versions up to and including v1.8.3 contain a Heap-Based Buffer Overflow in function
    process_plane() that results in a memory corruption and probably even a remote code execution.
    (CVE-2018-8797)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-8797");
