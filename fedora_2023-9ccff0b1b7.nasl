...
# extracted from Fedora Security Advisory FEDORA-2023-9ccff0b1b7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9ccff0b1b7");

  script_name(english:"Fedora 39 : community-mysql (2023-9ccff0b1b7)");
...
FEDORA-2023-9ccff0b1b7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9ccff0b1b7");
...
var pkgs = [
    {'reference':'community-mysql-8.0.34-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
