...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : tomcat (EulerOS-SA-2021-1856)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1856
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89a90759");
...
pkgs = ["tomcat-7.0.76-8.h12",
        "tomcat-admin-webapps-7.0.76-8.h12",
        "tomcat-el-2.2-api-7.0.76-8.h12",
        "tomcat-jsp-2.2-api-7.0.76-8.h12",
        "tomcat-lib-7.0.76-8.h12",
        "tomcat-servlet-3.0-api-7.0.76-8.h12",
        "tomcat-webapps-7.0.76-8.h12"];
