...
# extracted from Red Hat Security Advisory RHSA-2021:0165. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0165.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ca1d453c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0165");
...
"Update the RHEL libpq package based on the guidance in RHSA-2021:0165.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libpq-12.5-2.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libpq-devel-12.5-2.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
