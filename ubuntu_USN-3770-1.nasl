...
vulnerabilities as referenced in the USN-3770-1 advisory.
    ...
    Quang Nguyen discovered that Little CMS incorrectly handled certain files. An attacker could possibly use
    this issue to execute arbitrary code. (CVE-2018-16435)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3770-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected liblcms2-2, liblcms2-dev and / or liblcms2-utils packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:liblcms2-dev");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'liblcms2-2', 'pkgver': '2.5-0ubuntu4.2'},
    {'osver': '14.04', 'pkgname': 'liblcms2-dev', 'pkgver': '2.5-0ubuntu4.2'},
    {'osver': '14.04', 'pkgname': 'liblcms2-utils', 'pkgver': '2.5-0ubuntu4.2'},
    {'osver': '16.04', 'pkgname': 'liblcms2-2', 'pkgver': '2.6-3ubuntu2.1'},
    {'osver': '16.04', 'pkgname': 'liblcms2-dev', 'pkgver': '2.6-3ubuntu2.1'},
    {'osver': '16.04', 'pkgname': 'liblcms2-utils', 'pkgver': '2.6-3ubuntu2.1'},
    {'osver': '18.04', 'pkgname': 'liblcms2-2', 'pkgver': '2.9-1ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'liblcms2-dev', 'pkgver': '2.9-1ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'liblcms2-utils', 'pkgver': '2.9-1ubuntu0.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'liblcms2-2 / liblcms2-dev / liblcms2-utils');
}
