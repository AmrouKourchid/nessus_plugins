...
USN-5638-1 advisory.
    ...
    Rhodri James discovered that Expat incorrectly handled memory when processing certain malformed XML files.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'expat', 'pkgver': '2.1.0-7ubuntu0.16.04.5+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'lib64expat1', 'pkgver': '2.1.0-7ubuntu0.16.04.5+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'lib64expat1-dev', 'pkgver': '2.1.0-7ubuntu0.16.04.5+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libexpat1', 'pkgver': '2.1.0-7ubuntu0.16.04.5+esm6', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libexpat1-dev', 'pkgver': '2.1.0-7ubuntu0.16.04.5+esm6', 'ubuntu_pro': TRUE}
];
