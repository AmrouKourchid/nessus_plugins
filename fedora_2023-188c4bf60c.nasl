...
# extracted from Fedora Security Advisory FEDORA-2023-188c4bf60c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-188c4bf60c");

  script_name(english:"Fedora 36 : openbgpd (2023-188c4bf60c)");
...
FEDORA-2023-188c4bf60c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-188c4bf60c");
...
var pkgs = [
    {'reference':'openbgpd-7.9-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
