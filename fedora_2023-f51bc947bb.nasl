...
# extracted from Fedora Security Advisory FEDORA-2023-f51bc947bb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f51bc947bb");
  script_xref(name:"IAVB", value:"2023-B-0023-S");

  script_name(english:"Fedora 37 : ghostscript (2023-f51bc947bb)");
...
FEDORA-2023-f51bc947bb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f51bc947bb");
...
var pkgs = [
    {'reference':'ghostscript-9.56.1-7.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
