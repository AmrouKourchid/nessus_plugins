...
# SUSE update advisory SUSE-SU-2021:4059-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:4059-1");

  script_name(english:"SUSE SLES12 Security Update : runc (SUSE-SU-2021:4059-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1193436");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2021-43784");
  # https://lists.suse.com/pipermail/sle-security-updates/2021-December/009902.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ff29a36");
...
var pkgs = [
    {'reference':'runc-1.0.3-16.18.1', 'sp':'0', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-containers-release-12-0']},
    {'reference':'runc-1.0.3-16.18.1', 'sp':'3', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-containers-release-12-0']},
    {'reference':'runc-1.0.3-16.18.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-containers-release-12-0']},
    {'reference':'runc-1.0.3-16.18.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-containers-release-12-0']}
];
