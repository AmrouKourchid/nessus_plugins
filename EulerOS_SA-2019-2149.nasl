...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : gd (EulerOS-SA-2019-2149)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2149
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4163b0ef");
...
pkgs = ["gd-2.0.35-26.h7.eulerosv2r7"];
