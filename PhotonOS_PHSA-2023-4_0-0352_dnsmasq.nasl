...
# extracted from VMware Security Advisory PHSA-2023-4.0-0352. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Dnsmasq PHSA-2023-4.0-0352");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the dnsmasq package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-352.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'dnsmasq-2.85-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'dnsmasq-utils-2.85-3.ph4')) flag++;
