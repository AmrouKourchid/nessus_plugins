...
"The remote Red Hat host is missing one or more security updates for dotnet3.1.");
...
referenced in the RHSA-2020:2250 advisory.
    ...
    are .NET Core SDK 3.1.104 and .NET Core Runtime 3.1.4.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2250.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b1691283");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1827645");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dotnet3.1 package based on the guidance in RHSA-2020:2250.");
