...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : busybox (EulerOS-SA-2024-2431)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2431
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c5c36f8b");
...
var pkgs = [
  "busybox-help-1.31.1-6.h12.eulerosv2r10"
];
