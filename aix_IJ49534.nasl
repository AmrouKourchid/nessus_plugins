...
if (description)
{
  ...
  script_name(english:"AIX 3.1 TL 3 : kernel (IJ49534)");
  script_summary(english:"Check for APAR IJ49534");
...
if (aix_check_ifix(release:"3.1", ml:"03", sp:"21", patch:"IJ49534s3a", package:"bos.mp64", minfilesetver:"7.3.1.0", maxfilesetver:"7.3.1.3") < 0) flag++;
if (aix_check_ifix(release:"3.1", ml:"03", sp:"30", patch:"IJ49534s3a", package:"bos.mp64", minfilesetver:"7.3.1.0", maxfilesetver:"7.3.1.3") < 0) flag++;
if (aix_check_ifix(release:"3.1", ml:"03", sp:"40", patch:"IJ49534s4a", package:"bos.mp64", minfilesetver:"7.3.1.0", maxfilesetver:"7.3.1.3") < 0) flag++;
