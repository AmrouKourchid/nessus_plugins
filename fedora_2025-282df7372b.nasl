...
# extracted from Fedora Security Advisory FEDORA-2025-282df7372b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-282df7372b");

  script_name(english:"Fedora 40 : redict (2025-282df7372b)");
...
FEDORA-2025-282df7372b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-282df7372b");
...
var pkgs = [
    {'reference':'redict-7.3.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
