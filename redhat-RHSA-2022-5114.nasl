...
# extracted from Red Hat Security Advisory RHSA-2022:5114. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5114");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (openstack-barbican) (RHSA-2022:5114)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 16.2 (openstack-
barbican).");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:5114 advisory.
    ...
    * Barbican allows authenticated users to add/modify/delete arbitrary metadata on any secret
    (CVE-2022-23451)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5114.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?378813f5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5114");
...
"Update the RHEL Red Hat OpenStack Platform 16.2 (openstack-barbican) package based on the guidance in RHSA-2022:5114.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-barbican-9.0.2-2.20220122185348.c718783.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-', 'cves':['CVE-2022-23451', 'CVE-2022-23452']},
      {'reference':'openstack-barbican-api-9.0.2-2.20220122185348.c718783.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-', 'cves':['CVE-2022-23452']},
      {'reference':'openstack-barbican-common-9.0.2-2.20220122185348.c718783.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-', 'cves':['CVE-2022-23452']},
      {'reference':'openstack-barbican-keystone-listener-9.0.2-2.20220122185348.c718783.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-', 'cves':['CVE-2022-23452']},
      {'reference':'openstack-barbican-worker-9.0.2-2.20220122185348.c718783.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-', 'cves':['CVE-2022-23452']},
      {'reference':'python3-barbican-9.0.2-2.20220122185348.c718783.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-', 'cves':['CVE-2022-23452']}
    ]
  }
];
