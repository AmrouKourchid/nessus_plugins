...
# SUSE update advisory SUSE-SU-2023:0857-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0857-1");

  script_name(english:"SUSE SLES12 Security Update : drbd (SUSE-SU-2023:0857-1)");
...
SU-2023:0857-1 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1209188");
  # https://lists.suse.com/pipermail/sle-security-updates/2023-March/014120.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad97020e");
...
var pkgs = [
    {'reference':'drbd-9.0.14+git.62f906cf-4.24.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-12.4']},
    {'reference':'drbd-kmp-default-9.0.14+git.62f906cf_k4.12.14_95.117-4.24.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-12.4']}
];
