...
if (description)
{
  ...
  script_cve_id("CVE-2023-48235");
  script_xref(name:"IAVA", value:"2023-A-0650-S");

  script_name(english:"Vim < 9.0.2110");
...
overflow. Ironically this happens in the existing overflow check, because the line number becomes negative and 
LONG_MAX - lnum will cause the overflow. Impact is low, user interaction is required and a crash may not even happen 
in all situations. This issue has been addressed in release version 9.0.2110. 

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://github.com/vim/vim/security/advisories/GHSA-6g74-hr6q-pr8g
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?722fe4c1");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Vim version 9.0.2110 or later");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-48235");
