...
# extracted from Red Hat Security Advisory RHSA-2022:7188. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7188");

  script_name(english:"RHEL 8 : device-mapper-multipath (RHSA-2022:7188)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7188.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?206d022a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2133988");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7188");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL device-mapper-multipath package based on the guidance in RHSA-2022:7188.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'device-mapper-multipath-0.8.3-3.el8_2.7', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
