...
# extracted from Red Hat Security Advisory RHSA-2024:0200. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0200");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.12.47 (RHSA-2024:0200)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.12.47.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0200.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ec7ece87");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2231370");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0200");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.12.47 package based on the guidance in RHSA-2024:0200.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy22-2.2.24-4.rhaos4.12.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
