...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : mod_http2 (EulerOS-SA-2024-2480)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2480
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f034de8");
...
var pkgs = [
  "mod_http2-1.10.20-2.h2.eulerosv2r8"
];
