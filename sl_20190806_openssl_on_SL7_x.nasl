...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openssl on SL7.x x86_64 (20190806)");
...
"Security Fix(es) :
  ...
  - openssl: timing side channel attack in the DSA signature
    algorithm (CVE-2018-0734)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1908&L=SCIENTIFIC-LINUX-ERRATA&P=28154
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e198486");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssl-1.0.2k-19.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssl-debuginfo-1.0.2k-19.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssl-devel-1.0.2k-19.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssl-libs-1.0.2k-19.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssl-perl-1.0.2k-19.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssl-static-1.0.2k-19.el7")) flag++;
