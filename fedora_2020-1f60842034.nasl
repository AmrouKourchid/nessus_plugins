...
# extracted from Fedora Security Advisory FEDORA-2020-1f60842034.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : claws-mail (2020-1f60842034)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-1f60842034");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"claws-mail-3.17.7-1.fc33")) flag++;
