...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : systemd on SL7.x x86_64 (20201001)");
...
"Security Fix(es) :
  ...
  - systemd: memory leak in button_open() in
    login/logind-button.c when udev events are received
    (CVE-2019-20386)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=11760
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4f0dc13d");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libgudev1-219-78.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libgudev1-devel-219-78.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-219-78.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-debuginfo-219-78.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-devel-219-78.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-journal-gateway-219-78.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-libs-219-78.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-networkd-219-78.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-python-219-78.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-resolved-219-78.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-sysv-219-78.el7")) flag++;
