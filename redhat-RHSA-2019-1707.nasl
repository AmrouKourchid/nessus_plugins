...
the RHSA-2019:1707 advisory.
    ...
    * ansible: unsafe template evaluation of returned module data can lead to information disclosure
    ...
    See: https://github.com/ansible/ansible/blob/v2.6.18/changelogs/CHANGELOG-v2.6.rst for details on bug
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1707.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bddd93ca");
  # https://github.com/ansible/ansible/blob/v2.6.18/changelogs/CHANGELOG-v2.6.rst
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f80ca301");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1707");
...
"Update the RHEL ansible package based on the guidance in RHSA-2019:1707.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.6.18-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.6'}
    ]
  }
];
