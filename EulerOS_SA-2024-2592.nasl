...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : python-setuptools (EulerOS-SA-2024-2592)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2592
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5aaa9a77");
...
var pkgs = [
  "python-setuptools-59.4.0-3.h2.eulerosv2r11",
  "python3-setuptools-59.4.0-3.h2.eulerosv2r11"
];
