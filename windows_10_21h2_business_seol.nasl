...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 21H2 Business SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 21H2 Business is no longer maintained by its vendor or provider.
...
"Upgrade to a version of Microsoft Windows that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2023/06/13");
...
var constraints = [
  { seol : 20230613, cpe_attributes : [{'edition': 'business*'}] }
];
