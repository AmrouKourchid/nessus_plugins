...
# extracted from Fedora Security Advisory FEDORA-2022-19538a3732
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-19538a3732");

  script_name(english:"Fedora 36 : mingw-binutils (2022-19538a3732)");
...
FEDORA-2022-19538a3732 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-19538a3732");
...
var pkgs = [
    {'reference':'mingw-binutils-2.37-5.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
