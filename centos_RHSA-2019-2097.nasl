...
# extracted from Red Hat Security Advisory RHSA-2019:2097 and 
# CentOS Errata and Security Advisory 2019:2097 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : perl-Archive-Tar (CESA-2019:2097)");
...
Enterprise Linux 7.7 Release Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2019-August/006044.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1526a0ae");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"perl-Archive-Tar-1.92-3.el7")) flag++;
