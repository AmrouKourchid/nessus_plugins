...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2024-A-0216-S");

  script_name(english:"Adobe Media Encoder < 23.6.5 / 24.0.0 < 24.3.0 Arbitrary code execution (APSB24-23) (macOS)");
...
"The version of Adobe Media Encoder installed on the remote macOS host is prior to 23.6.5, 24.3.0. It is, therefore,
affected by a vulnerability as referenced in the APSB24-23 advisory.

  - Media Encoder versions 24.2.1, 23.6.4 and earlier are affected by a Stack-based Buffer Overflow
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/media-encoder/apsb24-23.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe Media Encoder version 23.6.5, 24.3.0 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-20772");
...
var constraints = [
  ...
  { 'min_version' : '24.0.0', 'fixed_version' : '24.3.0' }
];
