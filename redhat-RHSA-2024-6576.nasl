...
# extracted from Red Hat Security Advisory RHSA-2024:6576. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-3657", "CVE-2024-5953");
  script_xref(name:"IAVA", value:"2024-A-0356");
  script_xref(name:"RHSA", value:"2024:6576");

  script_name(english:"RHEL 8 : redhat-ds:11 (RHSA-2024:6576)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for redhat-ds:11.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:6576 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6576.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c52ee5cd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6576");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redhat-ds:11 package based on the guidance in RHSA-2024:6576.");
  ...
  'redhat-ds:11': [
    {
      ...
      'pkgs': [
        {'reference':'389-ds-base-1.4.3.34-4.module+el8dsrv+22274+a8abd89c', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-devel-1.4.3.34-4.module+el8dsrv+22274+a8abd89c', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-legacy-tools-1.4.3.34-4.module+el8dsrv+22274+a8abd89c', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-libs-1.4.3.34-4.module+el8dsrv+22274+a8abd89c', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-snmp-1.4.3.34-4.module+el8dsrv+22274+a8abd89c', 'cpu':'x86_64', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'cockpit-389-ds-1.4.3.34-4.module+el8dsrv+22274+a8abd89c', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'python3-lib389-1.4.3.34-4.module+el8dsrv+22274+a8abd89c', 'release':'8', 'el_string':'el8dsrv', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
