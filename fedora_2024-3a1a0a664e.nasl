...
# extracted from Fedora Security Advisory FEDORA-2024-3a1a0a664e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-3a1a0a664e");

  script_name(english:"Fedora 40 : chromium (2024-3a1a0a664e)");
...
FEDORA-2024-3a1a0a664e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3a1a0a664e");
...
var pkgs = [
    {'reference':'chromium-127.0.6533.88-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
