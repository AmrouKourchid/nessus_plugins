...
dla-2826 advisory.
    ...
    Several vulnerabilities were discovered in mbed TLS, a lightweight crypto and SSL/TLS library, which could
    result in denial of service, information disclosure or side-channel attacks. For Debian 9 stretch, these
    problems have been fixed in version 2.4.2-1+deb9u4. We recommend that you upgrade your mbedtls packages.
    For the detailed security status of mbedtls please refer to its security tracker page at:
    https://security-tracker.debian.org/tracker/mbedtls Further information about Debian LTS security
...
var pkgs = [
    ...
    {'release': '9.0', 'prefix': 'libmbedtls-doc', 'reference': '2.4.2-1+deb9u4'},
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libmbedcrypto0 / libmbedtls-dev / libmbedtls-doc / libmbedtls10 / etc');
}
