...
# extracted from Oracle Linux Security Advisory ELSA-2022-2191.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : gzip (ELSA-2022-2191)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-2191.html");
...
var pkgs = [
    {'reference':'gzip-1.5-11.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
