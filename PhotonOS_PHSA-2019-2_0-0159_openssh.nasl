...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Openssh PHSA-2019-2.0-0159");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssh-7.5p1-13.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssh-clients-7.5p1-13.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssh-debuginfo-7.5p1-13.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssh-server-7.5p1-13.ph2')) flag++;
