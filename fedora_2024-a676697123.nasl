...
# extracted from Fedora Security Advisory FEDORA-2024-a676697123
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a676697123");
  script_xref(name:"IAVB", value:"2024-B-0200");

  script_name(english:"Fedora 38 : xen (2024-a676697123)");
...
FEDORA-2024-a676697123 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a676697123");
...
var pkgs = [
    {'reference':'xen-4.17.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
