...
# SUSE update advisory SUSE-SU-2022:4533-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4533-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 29 for SLE 12 SP4) (SUSE-SU-2022:4533-1)");
...
multiple vulnerabilities as referenced in the SUSE-SU-2022:4533-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013262.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc321eaf");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-4_12_14-150100_197_120-default, kgraft-patch-4_12_14-122_121-default and / or
kgraft-patch-4_12_14-95_105-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.121-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_121-default-8-2.2', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
          {'reference':'kgraft-patch-4_12_14-122_121-default-8-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-12.5', 'sle-live-patching-release-12.5', 'sles-release-12.5']}
        ]
      },
      '4.12.14-150100.197.120-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150100_197_120-default-5-150100.2.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
          {'reference':'kernel-livepatch-4_12_14-150100_197_120-default-5-150100.2.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.1', 'sle-module-live-patching-release-15.1', 'sles-release-15.1']}
        ]
      },
      '4.12.14-95.105-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_105-default-5-2.1', 'sp':'4', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
          {'reference':'kgraft-patch-4_12_14-95_105-default-5-2.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-12.4', 'sle-live-patching-release-12.4', 'sles-release-12.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-4_12_14-150100_197_120-default / etc');
}
