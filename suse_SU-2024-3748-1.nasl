...
# SUSE update advisory SUSE-SU-2024:3748-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:3748-1");

  script_name(english:"openSUSE 15 Security Update : cargo-c (SUSE-SU-2024:3748-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1230683");
  # https://lists.suse.com/pipermail/sle-security-updates/2024-October/019669.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb0721a1");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2024-45405");
  script_set_attribute(attribute:"solution", value:
"Update the affected cargo-c package.");
...
var pkgs = [
    {'reference':'cargo-c-0.10.3~git0.ee7d7ef-150600.3.3.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cargo-c');
}
