...
# extracted from Fedora Security Advisory FEDORA-2022-3dcb5a3785
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-3dcb5a3785");
  script_xref(name:"IAVA", value:"2022-A-0447-S");

  script_name(english:"Fedora 36 : samba (2022-3dcb5a3785)");
...
FEDORA-2022-3dcb5a3785 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3dcb5a3785");
...
var pkgs = [
    {'reference':'samba-4.16.6-0.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
