...
# extracted from Red Hat Security Advisory RHSA-2022:7730. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7730");

  script_name(english:"RHEL 8 : libldb (RHSA-2022:7730)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:7730 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7730.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a941278");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.7_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?790bc9ea");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7730");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python-ldb-devel-common");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-ldb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-ldb-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ldb-tools-2.5.2-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libldb-2.5.2-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libldb-devel-2.5.2-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-ldb-devel-common-2.5.2-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-ldb-2.5.2-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-ldb-devel-2.5.2-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ldb-tools / libldb / libldb-devel / python-ldb-devel-common / etc');
}
