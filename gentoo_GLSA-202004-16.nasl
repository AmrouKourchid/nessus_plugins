...
# extracted from Gentoo Linux Security Advisory GLSA 202004-16.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202004-16");

  script_name(english:"GLSA-202004-16 : Cacti: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202004-16
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?277bf893");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202004-16");
...
if (qpkg_check(package:"net-analyzer/cacti", unaffected:make_list("ge 1.2.11"), vulnerable:make_list("lt 1.2.11"))) flag++;
