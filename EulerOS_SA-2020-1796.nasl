...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : curl (EulerOS-SA-2020-1796)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1796
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d3960e9f");
...
pkgs = ["curl-7.61.1-2.h9.eulerosv2r8",
        ...
        "libcurl-devel-7.61.1-2.h9.eulerosv2r8"];
