...
# extracted from Fedora Security Advisory FEDORA-2024-8f4d69d2ec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8f4d69d2ec");

  script_name(english:"Fedora 40 : stb (2024-8f4d69d2ec)");
...
FEDORA-2024-8f4d69d2ec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8f4d69d2ec");
...
var pkgs = [
    {'reference':'stb-0^20240213gitae721c5-6.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
