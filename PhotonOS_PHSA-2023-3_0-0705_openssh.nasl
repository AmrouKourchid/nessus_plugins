...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Openssh PHSA-2023-3.0-0705");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssh-7.8p1-18.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssh-clients-7.8p1-18.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'openssh-server-7.8p1-18.ph3')) flag++;
