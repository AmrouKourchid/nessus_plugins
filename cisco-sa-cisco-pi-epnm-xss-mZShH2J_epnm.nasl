...
if (description)
{
  ...
  script_xref(name:"CISCO-BUG-ID", value:"CSCwd62509");
  script_xref(name:"CISCO-SA", value:"cisco-sa-cisco-pi-epnm-xss-mZShH2J");
  script_xref(name:"IAVA", value:"2023-A-0219-S");

  script_name(english:"Cisco Evolved Programmable Network Manager Stored XSS (cisco-sa-cisco-pi-epnm-xss-mZShH2J)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of Cisco Evolved Programmable Network Manager installed on the remote host is prior to 7.0. It is,
therefore, affected by a cross-site scripting (XSS)vulnerability as referenced in the cisco-sa-cisco-pi-epnm-xss-mZShH2J
advisory. This vulnerability is due to insufficient validation of user-supplied input. An authenticated, remote attacker
could exploit this vulnerability by persuading a user of an affected interface to click a crafted link. A successful
exploit could allow the attacker to execute arbitrary script code in the context of the affected interface or access
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwd62509");
  script_set_attribute(attribute:"solution", value:
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCwd62509");
