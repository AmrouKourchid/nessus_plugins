...
# extracted from Red Hat Security Advisory RHSA-2020:4820. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4820");

  script_name(english:"RHEL 8 : file-roller (RHSA-2020:4820)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for file-roller.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2020:4820 advisory.

    File Roller is an application for creating and viewing archives files, such as tar or zip files.

    Security Fix(es):

    * file-roller: path traversal vulnerability via a specially crafted filename contained in malicious
    archive (CVE-2019-16680)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4820.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f8ea062");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.3_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7e37d18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4820");
...
"Update the RHEL file-roller package based on the guidance in RHSA-2020:4820.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'file-roller-3.28.1-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
