...
"The version of Thunderbird installed on the remote Windows host is prior to 102.15.1. It is, therefore, affected by a
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'102.15.1', min:'102.0.0', severity:SECURITY_HOLE);
