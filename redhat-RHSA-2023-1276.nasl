...
# extracted from Red Hat Security Advisory RHSA-2023:1276. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1276");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform (collectd-libpod-stats) (RHSA-2023:1276)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform (collectd-libpod-stats).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1276.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2bc65d17");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2161274");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1276");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform (collectd-libpod-stats) package based on the guidance in RHSA-2023:1276.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'collectd-libpod-stats-1.0.4-3.el8ost', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'collectd-libpod-stats-1.0.4-3.el8ost', 'cpu':'x86_64', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
