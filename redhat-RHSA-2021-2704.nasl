...
# extracted from Red Hat Security Advisory RHSA-2021:2704. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-27918", "CVE-2021-31525", "CVE-2021-33196");
  script_xref(name:"RHSA", value:"2021:2704");

  script_name(english:"RHEL 8 : Release of OpenShift Serverless Client kn 1.16.0 (Moderate) (RHSA-2021:2704)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2021:2704 advisory.

    Red Hat OpenShift Serverless Client kn 1.16.0 provides a CLI to interact with Red Hat OpenShift Serverless
    1.16.0. The kn CLI is delivered as an RPM package for installation on RHEL platforms, and as binaries for
    non-Linux platforms.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2704.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8ba62348");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1971449");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2704");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-serverless-clients-0.22.0-3.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-0.22.0-3.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openshift-serverless-clients-0.22.0-3.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
