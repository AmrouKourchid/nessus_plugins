...
# extracted from Red Hat Security Advisory RHSA-2021:4593. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4593");

  script_name(english:"RHEL 8 : annobin (RHSA-2021:4593)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for annobin.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4593 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4593.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?542730b6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4593");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2005819");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL annobin package based on the guidance in RHSA-2021:4593.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'annobin-9.72-1.el8_5.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'annobin-annocheck-9.72-1.el8_5.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
