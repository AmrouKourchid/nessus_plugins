...
# extracted from Fedora Security Advisory FEDORA-2024-c967c7d287
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c967c7d287");

  script_name(english:"Fedora 38 : unbound (2024-c967c7d287)");
...
FEDORA-2024-c967c7d287 advisory.

    - Fix CVE-2023-50387, DNSSEC verification complexity can be exploited to exhaust CPU resources and stall
    DNS resolvers.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c967c7d287");
...
var pkgs = [
    {'reference':'unbound-1.19.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
