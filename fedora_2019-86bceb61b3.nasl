...
# extracted from Fedora Security Advisory FEDORA-2019-86bceb61b3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : openslp (2019-86bceb61b3)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-86bceb61b3");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"openslp-2.0.0-22.fc30")) flag++;
