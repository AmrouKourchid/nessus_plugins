...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Curl PHSA-2023-5.0-0049");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'curl-8.1.2-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'curl-devel-8.1.2-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'curl-libs-8.1.2-1.ph5')) flag++;
