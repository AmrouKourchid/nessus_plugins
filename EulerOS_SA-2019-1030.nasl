...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libsndfile (EulerOS-SA-2019-1030)");
...
vulnerability :
  ...
  - A stack-based buffer overflow in psf_memset in common.c
    in libsndfile 1.0.28 allows remote attackers to cause a
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1030
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8ddb1bc");
...
pkgs = ["libsndfile-1.0.25-10.h4.eulerosv2r7"];
