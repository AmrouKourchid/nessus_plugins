...
# extracted from Fedora Security Advisory FEDORA-2018-390001d1c7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-390001d1c7");

  script_name(english:"Fedora 28 : libvncserver (2018-390001d1c7)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-390001d1c7");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"libvncserver-0.9.11-6.fc28")) flag++;
