...
# extracted from Fedora Security Advisory FEDORA-2023-587d6a00c3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-587d6a00c3");

  script_name(english:"Fedora 36 : dino (2023-587d6a00c3)");
...
FEDORA-2023-587d6a00c3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-587d6a00c3");
...
var pkgs = [
    {'reference':'dino-0.3.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
