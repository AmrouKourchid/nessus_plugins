...
# extracted from Red Hat Security Advisory RHSA-2024:8700. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8700");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.14.40 (RHSA-2024:8700)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.14.40.");
...
referenced in the RHSA-2024:8700 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.14.40. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18a0a63b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8700");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.14.40 packages based on the guidance in RHSA-2024:8700.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-9676");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(22, 674, 1325);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'containernetworking-plugins-1.4.0-4.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']},
      {'reference':'cri-o-1.27.8-12.rhaos4.14.git7597c43.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9676']},
      {'reference':'podman-4.4.1-21.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9675', 'CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-catatonit-4.4.1-21.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9675', 'CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-docker-4.4.1-21.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9675', 'CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-gvproxy-4.4.1-21.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9675', 'CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-plugins-4.4.1-21.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9675', 'CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-remote-4.4.1-21.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9675', 'CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-tests-4.4.1-21.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9675', 'CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'skopeo-1.11.3-4.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']},
      {'reference':'skopeo-tests-1.11.3-4.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.27.8-12.rhaos4.14.git7597c43.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9676']},
      {'reference':'podman-4.4.1-21.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9675', 'CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-docker-4.4.1-21.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9675', 'CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-gvproxy-4.4.1-21.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9675', 'CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-plugins-4.4.1-21.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9675', 'CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-remote-4.4.1-21.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9675', 'CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'podman-tests-4.4.1-21.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-9675', 'CVE-2024-34155', 'CVE-2024-34156', 'CVE-2024-34158']},
      {'reference':'skopeo-1.11.3-4.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']},
      {'reference':'skopeo-tests-1.11.3-4.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-34156']}
    ]
  }
];
