...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : spice-gtk (EulerOS-SA-2021-2099)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2099
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aa379f16");
...
pkgs = ["spice-glib-0.34-3.2.h3",
        "spice-gtk3-0.34-3.2.h3"];
