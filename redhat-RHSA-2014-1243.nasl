...
# extracted from Red Hat Security Advisory RHSA-2014:1243. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : automake (RHSA-2014:1243)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for automake.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2014/rhsa-2014_1243.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3b259320");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=838286");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1243");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL automake package based on the guidance in RHSA-2014:1243.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'automake-1.9.6-3.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
