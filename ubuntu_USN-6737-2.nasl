...
# extracted from Ubuntu Security Notice USN-6737-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6737-2");

  script_name(english:"Ubuntu 24.04 LTS. : GNU C Library vulnerability (USN-6737-2)");
...
USN-6737-2 advisory.
    ...
    USN-6737-1 fixed a vulnerability in the GNU C Library. This update provides the corresponding update for
    Ubuntu 24.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6737-2");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'glibc-source', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'libc-bin', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'libc-dev-bin', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'libc-devtools', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'libc6', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'libc6-amd64', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'libc6-dev', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'libc6-dev-amd64', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'libc6-dev-i386', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'libc6-dev-s390', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'libc6-dev-x32', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'libc6-i386', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'libc6-s390', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'libc6-x32', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'locales', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'locales-all', 'pkgver': '2.39-0ubuntu8.1'},
    {'osver': '24.04', 'pkgname': 'nscd', 'pkgver': '2.39-0ubuntu8.1'}
];
