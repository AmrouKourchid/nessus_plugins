...
# extracted from Fedora Security Advisory FEDORA-2021-17668e344a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-17668e344a");

  script_name(english:"Fedora 32 : python27 (2021-17668e344a)");
...
FEDORA-2021-17668e344a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-17668e344a");
  script_set_attribute(attribute:"solution", value:
"Update the affected python27 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python27");
...
pkgs = [
    {'reference':'python27-2.7.18-8.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python27');
}
