...
# extracted from Red Hat Security Advisory gedit. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2009-0314", "CVE-2017-14108");

  script_name(english:"RHEL 5 : gedit (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2017-14108");
