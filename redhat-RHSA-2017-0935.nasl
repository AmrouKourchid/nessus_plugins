...
referenced in the RHSA-2017:0935 advisory.
    ...
    * It was discovered that the code that parsed the HTTP request line permitted invalid characters. This
    ...
    Note: This fix causes Tomcat to respond with an HTTP 400 Bad Request error when request contains
    characters that are not permitted by the HTTP specification to appear not encoded, even though they were
    previously accepted. The newly introduced system property
    tomcat.util.http.parser.HttpParser.requestTargetAllow can be used to configure Tomcat to accept curly
    braces ({ and }) and the pipe symbol (|) in not encoded form, as these are often used in URLs without
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_0935.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?871c0dee");
...
"Update the RHEL tomcat package based on the guidance in RHSA-2017:0935.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-6816");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-8745");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tomcat-7.0.69-11.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-admin-webapps-7.0.69-11.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-docs-webapp-7.0.69-11.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-el-2.2-api-7.0.69-11.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-javadoc-7.0.69-11.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-jsp-2.2-api-7.0.69-11.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-jsvc-7.0.69-11.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-lib-7.0.69-11.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-servlet-3.0-api-7.0.69-11.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-webapps-7.0.69-11.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
