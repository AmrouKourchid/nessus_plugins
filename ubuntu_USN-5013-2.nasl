...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : systemd vulnerabilities (USN-5013-2)");
...
the USN-5013-2 advisory.
    ...
    USN-5013-1 fixed several vulnerabilities in systemd. This update provides the corresponding update for
    Ubuntu 16.04 ESM.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libnss-myhostname', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss-mymachines', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libnss-resolve', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libpam-systemd', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsystemd-dev', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsystemd0', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libudev-dev', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libudev1', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libudev1-udeb', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'systemd', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'systemd-container', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'systemd-coredump', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'systemd-journal-remote', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'systemd-sysv', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'udev', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'udev-udeb', 'pkgver': '229-4ubuntu21.31+esm1', 'ubuntu_pro': TRUE}
];
