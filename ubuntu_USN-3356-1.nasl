...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Expat vulnerability (USN-3356-1)");
...
in the USN-3356-1 advisory.

    It was discovered that Expat incorrectly handled certain external entities. A remote attacker could
    possibly use this issue to cause Expat to hang, resulting in a denial of service.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3356-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'expat', 'pkgver': '2.1.0-4ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'lib64expat1', 'pkgver': '2.1.0-4ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'lib64expat1-dev', 'pkgver': '2.1.0-4ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'libexpat1', 'pkgver': '2.1.0-4ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'libexpat1-dev', 'pkgver': '2.1.0-4ubuntu1.4'},
    {'osver': '14.04', 'pkgname': 'libexpat1-udeb', 'pkgver': '2.1.0-4ubuntu1.4'},
    {'osver': '16.04', 'pkgname': 'expat', 'pkgver': '2.1.0-7ubuntu0.16.04.3'},
    {'osver': '16.04', 'pkgname': 'lib64expat1', 'pkgver': '2.1.0-7ubuntu0.16.04.3'},
    {'osver': '16.04', 'pkgname': 'lib64expat1-dev', 'pkgver': '2.1.0-7ubuntu0.16.04.3'},
    {'osver': '16.04', 'pkgname': 'libexpat1', 'pkgver': '2.1.0-7ubuntu0.16.04.3'},
    {'osver': '16.04', 'pkgname': 'libexpat1-dev', 'pkgver': '2.1.0-7ubuntu0.16.04.3'},
    {'osver': '16.04', 'pkgname': 'libexpat1-udeb', 'pkgver': '2.1.0-7ubuntu0.16.04.3'}
];
