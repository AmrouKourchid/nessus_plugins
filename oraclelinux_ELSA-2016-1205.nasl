...
# extracted from Red Hat Security Advisory RHSA-2016:1205 and 
# Oracle Linux Security Advisory ELSA-2016-1205 respectively.
#
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:1205");

  script_name(english:"Oracle Linux 7 : spice (ELSA-2016-1205)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2016-1205 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-1205.html");
...
var pkgs = [
    {'reference':'spice-server-0.12.4-15.el7_2.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spice-server-devel-0.12.4-15.el7_2.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
