...
# extracted from Fedora Security Advisory FEDORA-2024-ce7649d28e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ce7649d28e");

  script_name(english:"Fedora 39 : python-jinja2 (2024-ce7649d28e)");
...
FEDORA-2024-ce7649d28e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ce7649d28e");
...
var pkgs = [
    {'reference':'python-jinja2-3.1.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
