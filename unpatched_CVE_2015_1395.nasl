...
if (description)
{
  ...
  script_cve_id("CVE-2015-1395");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-1395");
...
patch available.
  ...
  - Directory traversal vulnerability in GNU patch versions which support Git-style patching before 2.7.3
    allows remote attackers to write to arbitrary files with the permissions of the target user via a .. (dot
    dot) in a diff file name. (CVE-2015-1395)
