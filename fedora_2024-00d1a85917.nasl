...
# extracted from Fedora Security Advisory FEDORA-2024-00d1a85917
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-00d1a85917");

  script_name(english:"Fedora 39 : chromium (2024-00d1a85917)");
...
FEDORA-2024-00d1a85917 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-00d1a85917");
...
var pkgs = [
    {'reference':'chromium-130.0.6723.91-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
