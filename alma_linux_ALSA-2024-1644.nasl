...
# AlmaLinux Security Advisory ALSA-2024:1644.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1644");

  script_name(english:"AlmaLinux 8 : grafana-pcp (ALSA-2024:1644)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-1644.html");
...
var pkgs = [
    {'reference':'grafana-pcp-5.1.1-2.el8_9.alma.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-pcp-5.1.1-2.el8_9.alma.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
