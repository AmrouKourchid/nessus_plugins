...
# extracted from Fedora Security Advisory FEDORA-2023-0f2f9bc779
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0f2f9bc779");

  script_name(english:"Fedora 37 : subscription-manager (2023-0f2f9bc779)");
...
FEDORA-2023-0f2f9bc779 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0f2f9bc779");
...
var pkgs = [
    {'reference':'subscription-manager-1.29.37-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
