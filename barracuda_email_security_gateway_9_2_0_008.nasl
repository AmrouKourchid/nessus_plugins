...
if (description)
{
  ...
  script_xref(name:"CEA-ID", value:"CEA-2023-0041");
...
Barracuda released guidance on May 31, 2023 on the continued exploitation of this vulnerability on small number of 
already compromised ESG appliances. It urges to discontinue the use of the compromised ESG appliances and to contact 
Barracuda support to obtain a new ESG virtual or hardware appliance.

The FBI has independently verified that all exploited ESG appliances, even those with patches pushed out by Barracuda, 
remain at risk for continued computer network compromise from suspected PRC cyber actors exploiting this vulnerability.
It issued a flash alert on Aug 24, 2023 reinforcing Barracuda's warning where it strongly advises all affected ESG 
appliances to be isolated and replaced immediately, and all networks scanned for connections to the provided list of 
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?731e407f");
  # https://www.cisa.gov/news-events/alerts/2023/07/28/cisa-releases-malware-analysis-reports-barracuda-backdoors
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28018ade");
