...
# extracted from Ubuntu Security Notice USN-3043-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : OpenJDK 8 vulnerabilities (USN-3043-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-3043-1 advisory.
    ...
    sensitive data over the network, or possibly execute arbitrary code. (CVE-2016-3587, CVE-2016-3598,
    ...
    this to expose sensitive data over the network or possibly execute arbitrary code. (CVE-2016-3458)

    Multiple vulnerabilities were discovered in the OpenJDK JRE related to availability. An attacker could
    exploit these to cause a denial of service. (CVE-2016-3500, CVE-2016-3508)

    A vulnerability was discovered in the OpenJDK JRE related to information disclosure. An attacker could
    exploit this to expose sensitive data over the network. (CVE-2016-3550)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3043-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'openjdk-8-demo', 'pkgver': '8u91-b14-3ubuntu1~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk', 'pkgver': '8u91-b14-3ubuntu1~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk-headless', 'pkgver': '8u91-b14-3ubuntu1~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre', 'pkgver': '8u91-b14-3ubuntu1~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-headless', 'pkgver': '8u91-b14-3ubuntu1~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-jamvm', 'pkgver': '8u91-b14-3ubuntu1~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-zero', 'pkgver': '8u91-b14-3ubuntu1~16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-source', 'pkgver': '8u91-b14-3ubuntu1~16.04.1'}
];
