...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : curl (EulerOS-SA-2024-1031)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1031
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0cb5fa0f");
...
var pkgs = [
  "curl-7.69.1-2.h24.eulerosv2r9",
  "libcurl-7.69.1-2.h24.eulerosv2r9"
];
