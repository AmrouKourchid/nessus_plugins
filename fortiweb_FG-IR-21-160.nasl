...
if (description)
{
  ...
  script_name(english:"Fortinet FortiWeb - Heap-based buffer overflows in API controller (FG-IR-21-160)");
...
vulnerability as referenced in the FG-IR-21-160 advisory.

  - Multiple heap-based buffer overflow vulnerabilities in some web API controllers of FortiWeb 6.4.1, 6.4.0,
    and 6.3.0 through 6.3.15 may allow a remote authenticated attacker to execute arbitrary code or commands
    via specifically crafted HTTP requests. (CVE-2021-41017)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-21-160");
