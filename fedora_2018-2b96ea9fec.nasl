...
# extracted from Fedora Security Advisory FEDORA-2018-2b96ea9fec.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : podman (2018-2b96ea9fec)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-2b96ea9fec");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"podman-0.6.4-1.gitd5beb2f.fc28")) flag++;
