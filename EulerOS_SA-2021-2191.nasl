...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : cifs-utils (EulerOS-SA-2021-2191)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2191
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?844b5917");
...
pkgs = ["cifs-utils-6.10-0.h2.eulerosv2r9"];
