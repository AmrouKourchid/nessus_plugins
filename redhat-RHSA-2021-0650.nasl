...
# extracted from Red Hat Security Advisory RHSA-2021:0650. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0650");

  script_name(english:"RHEL 8 : xterm (RHSA-2021:0650)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for xterm.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:0650 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0650.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?23b8b2c6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0650");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1927559");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xterm package based on the guidance in RHSA-2021:0650.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xterm-331-1.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xterm-resize-331-1.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
