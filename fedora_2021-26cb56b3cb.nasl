...
# extracted from Fedora Security Advisory FEDORA-2021-26cb56b3cb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-26cb56b3cb");

  script_name(english:"Fedora 32 : jasper (2021-26cb56b3cb)");
...
FEDORA-2021-26cb56b3cb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-26cb56b3cb");
...
"Update the affected jasper package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-3443");
...
pkgs = [
    {'reference':'jasper-2.0.26-2.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
