...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6999.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?655b2924");
...
"Update the RHEL java-17-openjdk package based on the guidance in RHSA-2022:6999.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'java-17-openjdk-demo-fastdebug-17.0.5.0.8-2.el9_0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'java-17-openjdk-devel-fastdebug-17.0.5.0.8-2.el9_0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'java-17-openjdk-fastdebug-17.0.5.0.8-2.el9_0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'java-17-openjdk-headless-fastdebug-17.0.5.0.8-2.el9_0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'java-17-openjdk-jmods-fastdebug-17.0.5.0.8-2.el9_0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'java-17-openjdk-src-fastdebug-17.0.5.0.8-2.el9_0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'java-17-openjdk-static-libs-fastdebug-17.0.5.0.8-2.el9_0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
  ...
  },
  {
    ...
    'pkgs': [
      ...
      {'reference':'java-17-openjdk-demo-fastdebug-17.0.5.0.8-2.el9_0', 'sp':'0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'java-17-openjdk-devel-fastdebug-17.0.5.0.8-2.el9_0', 'sp':'0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'java-17-openjdk-fastdebug-17.0.5.0.8-2.el9_0', 'sp':'0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'java-17-openjdk-headless-fastdebug-17.0.5.0.8-2.el9_0', 'sp':'0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'java-17-openjdk-jmods-fastdebug-17.0.5.0.8-2.el9_0', 'sp':'0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'java-17-openjdk-src-fastdebug-17.0.5.0.8-2.el9_0', 'sp':'0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'java-17-openjdk-static-libs-fastdebug-17.0.5.0.8-2.el9_0', 'sp':'0', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
