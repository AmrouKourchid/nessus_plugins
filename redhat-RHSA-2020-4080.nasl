...
# extracted from Red Hat Security Advisory RHSA-2020:4080. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : firefox (RHSA-2020:4080)");
...
referenced in the RHSA-2020:4080 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4080.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01fca0a6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1868842");
...
"Update the RHEL firefox package based on the guidance in RHSA-2020:4080.");
  ...
  script_cwe_id(79, 120, 125, 138, 190, 276, 416, 451, 601, 843);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-78.3.0-1.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-78.3.0-1.el7_9', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-78.3.0-1.el7_9', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-78.3.0-1.el7_9', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-78.3.0-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
