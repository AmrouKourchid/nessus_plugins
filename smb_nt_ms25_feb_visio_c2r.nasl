...
if (description)
{
  ...
  script_cve_id("CVE-2025-21345", "CVE-2025-21356");

  script_name(english:"Security Updates for Microsoft Visio Products C2R (February 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Visio Products are missing a security update.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Visio Products are missing a security update. It is, therefore, affected by the following vulnerabilities:

  - Microsoft Office is affected by a remote code execution vulnerability. (CVE-2025-21345, CVE-2025-21356)
...
manually perform an update.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21356");
