...
# extracted from Fedora Security Advisory FEDORA-2023-c908110b8a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c908110b8a");
  script_xref(name:"IAVA", value:"2023-A-0654-S");

  script_name(english:"Fedora 38 : firefox (2023-c908110b8a)");
...
FEDORA-2023-c908110b8a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c908110b8a");
...
var pkgs = [
    {'reference':'firefox-120.0-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
