...
referenced in the USN-6281-1 advisory.
    ...
    Alvaro Munoz discovered that Velocity Engine incorrectly handled certain inputs. If a user or an automated
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'velocity', 'pkgver': '1.7-4ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'velocity', 'pkgver': '1.7-5ubuntu0.18.04.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'velocity', 'pkgver': '1.7-5+deb9u1build0.20.04.1', 'ubuntu_pro': FALSE}
];
