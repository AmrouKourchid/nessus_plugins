...
# extracted from Red Hat Security Advisory xsa217_xen. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-10912");

  script_name(english:"RHEL 5 : xsa217_xen (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-10912");
