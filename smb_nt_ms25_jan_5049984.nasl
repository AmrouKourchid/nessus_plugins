...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5049984");
  script_xref(name:"MSFT", value:"MS25-5049984");
  ...
  script_name(english:"KB5049984: Windows 11 version 22H2 / Windows Server version 23H2 Security Update (January 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5049984. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5049984");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5049984");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21417");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2025-21311");
