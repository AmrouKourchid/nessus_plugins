...
# extracted from Ubuntu Security Notice USN-4049-3. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : GLib regression (USN-4049-3)");
...
USN-4049-3 advisory.
    ...
    USN-4049-1 fixed a vulnerability in GLib. The update introduced a regression in Ubuntu 16.04 LTS causing a
    possibly memory leak. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4049-3");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libglib2.0-0', 'pkgver': '2.48.2-0ubuntu4.4'},
    {'osver': '16.04', 'pkgname': 'libglib2.0-0-refdbg', 'pkgver': '2.48.2-0ubuntu4.4'},
    {'osver': '16.04', 'pkgname': 'libglib2.0-bin', 'pkgver': '2.48.2-0ubuntu4.4'},
    {'osver': '16.04', 'pkgname': 'libglib2.0-data', 'pkgver': '2.48.2-0ubuntu4.4'},
    {'osver': '16.04', 'pkgname': 'libglib2.0-dev', 'pkgver': '2.48.2-0ubuntu4.4'},
    {'osver': '16.04', 'pkgname': 'libglib2.0-tests', 'pkgver': '2.48.2-0ubuntu4.4'},
    {'osver': '16.04', 'pkgname': 'libglib2.0-udeb', 'pkgver': '2.48.2-0ubuntu4.4'}
];
