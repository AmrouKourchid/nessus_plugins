...
if (description)
{
  ...
  script_cve_id("CVE-2021-30639", "CVE-2021-33037", "CVE-2024-23672");

  script_name(english:"Photon OS 4.0: Apache PHSA-2021-4.0-0066");
...
if (rpm_check(release:'PhotonOS-4.0', reference:'apache-tomcat-8.5.68-1.ph4')) flag++;
