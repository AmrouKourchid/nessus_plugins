...
# extracted from Fedora Security Advisory FEDORA-2024-23085d548c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-23085d548c");

  script_name(english:"Fedora 39 : engrampa (2024-23085d548c)");
...
FEDORA-2024-23085d548c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-23085d548c");
...
var pkgs = [
    {'reference':'engrampa-1.26.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
