...
if (description)
{
  ...
  script_name(english:"OpenSSL SEoL (1.0.1.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of OpenSSL is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, OpenSSL is 1.0.1.x. It is, therefore, no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://www.openssl.org/news/vulnerabilities-1.0.1.html");
...
"Upgrade to a version of OpenSSL that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2017/01/01");
...
var constraints = [
  { max_branch : '1.0.1', min_branch : '1.0.1', seol : 20170101 }
];
