...
# extracted from Ubuntu Security Notice USN-6429-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6429-3");
  script_xref(name:"CEA-ID", value:"CEA-2023-0052");
  script_xref(name:"IAVA", value:"2023-A-0531-S");

  script_name(english:"Ubuntu 23.10 : curl vulnerabilities (USN-6429-3)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6429-3");
...
var pkgs = [
    {'osver': '23.10', 'pkgname': 'curl', 'pkgver': '8.2.1-1ubuntu3.1'},
    {'osver': '23.10', 'pkgname': 'libcurl3-gnutls', 'pkgver': '8.2.1-1ubuntu3.1'},
    {'osver': '23.10', 'pkgname': 'libcurl3-nss', 'pkgver': '8.2.1-1ubuntu3.1'},
    {'osver': '23.10', 'pkgname': 'libcurl4', 'pkgver': '8.2.1-1ubuntu3.1'},
    {'osver': '23.10', 'pkgname': 'libcurl4-gnutls-dev', 'pkgver': '8.2.1-1ubuntu3.1'},
    {'osver': '23.10', 'pkgname': 'libcurl4-nss-dev', 'pkgver': '8.2.1-1ubuntu3.1'},
    {'osver': '23.10', 'pkgname': 'libcurl4-openssl-dev', 'pkgver': '8.2.1-1ubuntu3.1'}
];
