...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Wpa_Supplicant PHSA-2021-4.0-0007");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'wpa_supplicant-2.9-3.ph4')) flag++;
