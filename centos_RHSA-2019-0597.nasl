...
# CentOS Errata and Security Advisory 2019:0597 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : cloud-init (CESA-2019:0597)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2019-March/023222.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2aea3467");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"cloud-init-18.2-1.el7.centos.2")) flag++;
