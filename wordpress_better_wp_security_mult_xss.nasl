...
relied only on the application's self-reported version number.");
  # https://packetstormsecurity.com/files/112617/WordPress-Better-WP-Security-Cross-Site-Scripting.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7161ccc7");
  script_set_attribute(attribute:"see_also", value:"https://wordpress.org/plugins/better-wp-security/#changelog");
  script_set_attribute(attribute:"solution", value:
"Upgrade to version 3.2.5 or later.");
