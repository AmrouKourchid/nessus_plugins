...
# extracted from Fedora Security Advisory FEDORA-2021-7547ad987f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-7547ad987f");

  script_name(english:"Fedora 33 : python3.6 (2021-7547ad987f)");
...
FEDORA-2021-7547ad987f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-7547ad987f");
...
pkgs = [
    {'reference':'python3.6-3.6.13-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
