...
if (description)
{
  ...
  script_name(english:"Adobe Premiere Pro < 14.2 Information Disclosure (APSB20-27) (macOS)");
...
"The version of Adobe Premiere Pro installed on the remote macOS host is prior to 14.2. It is, therefore, affected by a
