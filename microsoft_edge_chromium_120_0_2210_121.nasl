...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2024-A-0009-S");

  script_name(english:"Microsoft Edge (Chromium) < 120.0.2210.121 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an web browser installed that is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft Edge installed on the remote Windows host is prior to 120.0.2210.121. It is, therefore,
affected by multiple vulnerabilities as referenced in the January 5, 2024 advisory.
...
number.");
  # https://docs.microsoft.com/en-us/DeployEdge/microsoft-edge-relnotes-security#january-5-2024
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4aae3ac8");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-0222");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-0223");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-0224");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-0225");
