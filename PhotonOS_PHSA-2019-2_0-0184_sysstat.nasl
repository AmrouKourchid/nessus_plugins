...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Sysstat PHSA-2019-2.0-0184");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'sysstat-12.1.6-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'sysstat-debuginfo-12.1.6-1.ph2')) flag++;
