...
# extracted from Ubuntu Security Notice USN-6585-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6585-1");

  script_name(english:"Ubuntu 23.10 : libssh2 vulnerability (USN-6585-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 23.10 host has packages installed that are affected by a vulnerability as referenced in the USN-6585-1
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6585-1");
...
var pkgs = [
    {'osver': '23.10', 'pkgname': 'libssh2-1', 'pkgver': '1.11.0-2ubuntu0.1'},
    {'osver': '23.10', 'pkgname': 'libssh2-1-dev', 'pkgver': '1.11.0-2ubuntu0.1'}
];
