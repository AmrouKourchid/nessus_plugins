...
referenced in the RHSA-2021:3801 advisory.
    ...
    * RHEL 7.9.z [qedf driver] Racing condition between qedf_cleanup_fcport and releasing command after
    timeout (BZ#1982702)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3801.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc06d4d3");
