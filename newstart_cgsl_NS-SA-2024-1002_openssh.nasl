...
# extracted from ZTE advisory NS-SA-2024-1002. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : openssh Vulnerability (NS-SA-2024-1002)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has openssh packages installed that are affected
by a vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2024-1002");
...
for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:openssh");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:openssh-askpass");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:openssh-clients");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:openssh-server");
...
var pkgs = {
  'CGSL CORE 5.05': [
    'openssh-8.5p1-2.el7.cgslv5_5.0.10.10.g2018421',
    'openssh-askpass-8.5p1-2.el7.cgslv5_5.0.10.10.g2018421',
    'openssh-clients-8.5p1-2.el7.cgslv5_5.0.10.10.g2018421',
    'openssh-server-8.5p1-2.el7.cgslv5_5.0.10.10.g2018421'
  ],
  'CGSL MAIN 5.05': [
    'openssh-8.5p1-2.el7.cgslv5_5.0.10.10.g2018421',
    'openssh-askpass-8.5p1-2.el7.cgslv5_5.0.10.10.g2018421',
