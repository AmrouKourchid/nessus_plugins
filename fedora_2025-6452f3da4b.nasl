...
# extracted from Fedora Security Advisory FEDORA-2025-6452f3da4b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-6452f3da4b");

  script_name(english:"Fedora 40 : vim (2025-6452f3da4b)");
...
FEDORA-2025-6452f3da4b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-6452f3da4b");
...
var pkgs = [
    {'reference':'vim-9.1.1169-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
