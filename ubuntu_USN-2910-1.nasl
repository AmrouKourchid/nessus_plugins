...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Linux kernel (Vivid HWE) vulnerabilities (USN-2910-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2910-1");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-2910-1');
}
