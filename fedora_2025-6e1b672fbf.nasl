...
# extracted from Fedora Security Advisory FEDORA-2025-6e1b672fbf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-6e1b672fbf");

  script_name(english:"Fedora 41 : giflib (2025-6e1b672fbf)");
...
FEDORA-2025-6e1b672fbf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-6e1b672fbf");
...
"Update the affected giflib package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:giflib");
...
var pkgs = [
    {'reference':'giflib-5.2.2-6.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
