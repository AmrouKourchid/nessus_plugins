...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5044306");
  script_xref(name:"MSKB", value:"5044320");
  script_xref(name:"MSFT", value:"MS24-5044306");
  script_xref(name:"MSFT", value:"MS24-5044320");
  ...
  script_name(english:"KB5044306: Windows Server 2008 Security Update (October 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5044306. It is, therefore, affected by multiple vulnerabilities
  ...
  - Remote Registry Service Elevation of Privilege Vulnerability (CVE-2024-43532)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5044306");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5044320");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5044306 or Cumulative Update 5044320");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'10_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5044320, 5044306])
)
{
