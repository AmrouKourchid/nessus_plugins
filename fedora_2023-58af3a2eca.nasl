...
# extracted from Fedora Security Advisory FEDORA-2023-58af3a2eca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-58af3a2eca");

  script_name(english:"Fedora 40 : stb / usd (2023-58af3a2eca)");
...
FEDORA-2023-58af3a2eca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-58af3a2eca");
...
var pkgs = [
    {'reference':'stb-0^20231011gitbeebb24-12.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'usd-23.08-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
