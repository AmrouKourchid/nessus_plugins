...
# extracted from Red Hat Security Advisory RHSA-2024:2731. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2731");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (python-django) (RHSA-2024:2731)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2731.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2282c1f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2731");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-django-2.2.24-8.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
