...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS : RabbitMQ vulnerabilities (USN-5004-1)");
...
vulnerabilities as referenced in the USN-5004-1 advisory.

    It was discovered that RabbitMQ incorrectly handled certain inputs. An attacker could possibly use this
    issue to cause a denial of service. This issue only affected Ubuntu 16.04 ESM and Ubuntu 18.04 LTS.
    (CVE-2019-11287)

    Jonathan Knudsen discovered RabbitMQ incorrectly handled certain inputs. An attacker could possibly use
    this issue to cause a denial of service. (CVE-2021-22116)
...
"Update the affected rabbitmq-server package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-22116");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'rabbitmq-server', 'pkgver': '3.5.7-1ubuntu0.16.04.4+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'rabbitmq-server', 'pkgver': '3.6.10-1ubuntu0.5', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'rabbitmq-server', 'pkgver': '3.8.2-0ubuntu1.3', 'ubuntu_pro': FALSE}
];
