...
# extracted from Oracle Linux Security Advisory ELSA-2024-8727.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : firefox (ELSA-2024-8727)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-8727.html");
...
var pkgs = [
    {'reference':'firefox-128.4.0-1.0.1.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-128.4.0-1.0.1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
