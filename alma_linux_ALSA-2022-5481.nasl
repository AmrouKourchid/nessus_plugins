...
# AlmaLinux Security Advisory ALSA-2022:5481.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:5481");

  script_name(english:"AlmaLinux 9 : firefox (ALSA-2022:5481)");
...
ALSA-2022:5481 advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-5481.html");
...
var pkgs = [
    {'reference':'firefox-91.11.0-2.el9_0.alma', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-91.11.0-2.el9_0.alma', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
