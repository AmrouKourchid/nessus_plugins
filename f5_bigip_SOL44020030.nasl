...
more rapidly than other BIG-IP platforms.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K44020030");
...
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K44020030.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-5936");
...
var vmatrix = {
  'LTM': {
    'affected': [
      '15.0.0-15.1.0','14.1.0-14.1.2','13.1.0-13.1.4','12.1.0-12.1.5'
    ],
    'unaffected': [
      '16.0.0','15.1.1','14.1.2.8','13.1.5','12.1.5.2'
    ],
  }
};
