...
# extracted from Red Hat Security Advisory RHSA-2013:0629. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:0629");

  script_name(english:"RHEL 6 : jbossweb (RHSA-2013:0629)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for jbossweb.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2013:0629 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2013/rhsa-2013_0629.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3913cffe");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0629");
...
"Update the RHEL jbossweb package based on the guidance in RHSA-2013:0629.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jbossweb-2.1.13-4_patch_02.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossweb-el-1.0-api-2.1.13-4_patch_02.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossweb-jsp-2.1-api-2.1.13-4_patch_02.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossweb-lib-2.1.13-4_patch_02.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossweb-servlet-2.5-api-2.1.13-4_patch_02.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'}
    ]
  }
];
