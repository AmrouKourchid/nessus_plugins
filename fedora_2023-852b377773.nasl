...
# extracted from Fedora Security Advisory FEDORA-2023-852b377773
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-852b377773");

  script_name(english:"Fedora 37 : yajl (2023-852b377773)");
...
FEDORA-2023-852b377773 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-852b377773");
...
var pkgs = [
    {'reference':'yajl-2.1.0-21.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
