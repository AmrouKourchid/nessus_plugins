...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : docker-engine (EulerOS-SA-2022-1644)");
...
issues.");
  # https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2022-1644#:~:text=EulerOS%2DSA%2D2022%2D1644
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e847ef71");
...
var pkgs = [
  "docker-engine-18.09.0.200-200.h44.25.14.eulerosv2r10.src.rpm",
  "docker-engine-18.09.0.200-200.h44.25.14.eulerosv2r10.aarch64.rpm",
  "docker-engine-selinux-18.09.0.200-200.h44.25.14.eulerosv2r10.noarch.rpm"
];
