...
# SUSE update advisory SUSE-SU-2022:4169-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4169-1");

  script_name(english:"SUSE SLES15 Security Update : redis (SUSE-SU-2022:4169-1)");
...
in the SUSE-SU-2022:4169-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1204633");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2022-3647");
  # https://lists.suse.com/pipermail/sle-security-updates/2022-November/013070.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?97e15de8");
...
var pkgs = [
    {'reference':'redis-6.0.14-150200.6.14.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'redis-6.0.14-150200.6.14.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-server-applications-release-15.3', 'sles-release-15.3']}
];
