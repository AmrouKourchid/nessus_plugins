...
# extracted from Red Hat Security Advisory RHSA-2025:0692. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0692.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?250721e0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0692");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis:7 package based on the guidance in RHSA-2025:0692.");
  ...
  'redis:7': [
    {
      ...
      'pkgs': [
        {'reference':'redis-7.2.7-1.module+el9.5.0+22705+3d861c1c', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-devel-7.2.7-1.module+el9.5.0+22705+3d861c1c', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'redis-doc-7.2.7-1.module+el9.5.0+22705+3d861c1c', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
