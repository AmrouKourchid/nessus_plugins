...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : qemu (EulerOS-SA-2024-2380)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2380
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2333e81");
...
var pkgs = [
  "qemu-img-4.1.0-16.h31.eulerosv2r9"
];
