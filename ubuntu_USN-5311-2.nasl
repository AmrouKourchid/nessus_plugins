...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : containerd regression (USN-5311-2)");
...
USN-5311-2 advisory.
    ...
    USN-5311-1 released updates for contained. Unfortunately, a subsequent update reverted the fix for this
    CVE by mistake. This update corrects the problem.
