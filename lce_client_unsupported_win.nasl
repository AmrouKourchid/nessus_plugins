...
if (description)
{
  ...
  script_name(english:"Tenable Log Correlation Engine Client for Windows SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Log Correlation Engine Client for Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, the installation of the Tenable Log Correlation Engine (LCE) Client for Windows on the remote
host is is no longer maintained by its vendor or provider.
...
"Log Correlation Engine Client for Windows has been discontinued. Please refer to the vendor for support.");
...
var app = 'Log Correlation Engine Windows Client';
