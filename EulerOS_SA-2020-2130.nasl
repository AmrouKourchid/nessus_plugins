...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openldap (EulerOS-SA-2020-2130)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2130
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?adf6c97b");
...
pkgs = ["openldap-2.4.44-5.h7",
        "openldap-clients-2.4.44-5.h7",
        "openldap-devel-2.4.44-5.h7",
        "openldap-servers-2.4.44-5.h7"];
