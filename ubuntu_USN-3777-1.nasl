...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : Linux kernel vulnerabilities (USN-3777-1)");
...
the USN-3777-1 advisory.
    ...
    Andy Lutomirski and Mika Penttil discovered that the KVM implementation in the Linux kernel did not
    properly check privilege levels when emulating some instructions. An unprivileged attacker in a guest VM
    could use this to escalate privileges within the guest. (CVE-2018-10853)
    ...
    USN 3652-1 added a mitigation for Speculative Store Bypass a.k.a. Spectre Variant 4 (CVE-2018-3639). This
    update provides the corresponding mitigation for ARM64 processors. Please note that for this mitigation to
    be effective, an updated firmware for the processor may be required.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3777-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1021-oem");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1023-aws");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1023-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1024-raspi2");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-36-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-36-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-36-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-36-snapdragon");
...
var kernel_mappings = {
  '18.04': {
    '4.15.0': {
      'generic': '4.15.0-36',
      'generic-lpae': '4.15.0-36',
      'lowlatency': '4.15.0-36',
      'snapdragon': '4.15.0-36',
      'oem': '4.15.0-1021',
      'aws': '4.15.0-1023',
      'kvm': '4.15.0-1023',
      'raspi2': '4.15.0-1024'
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-3777-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2018-6554', 'CVE-2018-6555', 'CVE-2018-10853', 'CVE-2018-14633', 'CVE-2018-15572', 'CVE-2018-15594', 'CVE-2018-17182');
