...
# extracted from Amazon Linux AMI Security Advisory ALAS-2018-1076.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : pcre (ALAS-2018-1076)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The compile_branch function in pcre_compile.c in PCRE 8.x and
pcre2_compile.c in PCRE2 mishandles patterns containing an (*ACCEPT)
...
aka ZDI-CAN-3542.(CVE-2016-3191)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2018-1076.html");
...
"Run 'yum update pcre' to update your system.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-3191");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"pcre-8.21-7.8.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"pcre-debuginfo-8.21-7.8.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"pcre-devel-8.21-7.8.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"pcre-static-8.21-7.8.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"pcre-tools-8.21-7.8.amzn1")) flag++;
