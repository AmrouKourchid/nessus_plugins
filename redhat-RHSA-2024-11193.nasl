...
# extracted from Red Hat Security Advisory RHSA-2024:11193. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:11193");

  script_name(english:"RHEL 8 : mpg123 (RHSA-2024:11193)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mpg123.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:11193 advisory.

    The mpg123 packages contain real time MPEG 1.0/2.0/2.5 audio player/decoder for layers 1, 2, and 3 (most
    commonly MPEG 1.0 layer 3 also known as MP3), as well as re-usable decoding and output libraries.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_11193.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?592dfede");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:11193");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mpg123 package based on the guidance in RHSA-2024:11193.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mpg123");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mpg123-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mpg123-libs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mpg123-plugins-pulseaudio");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mpg123-1.32.9-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mpg123-devel-1.32.9-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mpg123-libs-1.32.9-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mpg123-plugins-pulseaudio-1.32.9-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
