...
# extracted from Red Hat Security Advisory RHSA-2025:3613. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3613");

  script_name(english:"RHEL 9 : libxslt (RHSA-2025:3613)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3613.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e75c438d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3613");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxslt-1.1.34-13.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxslt-devel-1.1.34-13.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
