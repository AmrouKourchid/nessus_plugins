...
if (description)
{
  ...
  script_cve_id("CVE-2023-48090");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-48090");
...
patch available.
  ...
  - GPAC 2.3-DEV-rev617-g671976fcc-master is vulnerable to memory leaks in extract_attributes
    media_tools/m3u8.c:329. (CVE-2023-48090)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-48090");
