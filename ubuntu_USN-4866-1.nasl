...
# extracted from Ubuntu Security Notice USN-4866-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4866-1");
  script_xref(name:"CEA-ID", value:"CEA-2019-0643");

  script_name(english:"Ubuntu 18.04 ESM : Netty vulnerabilities (USN-4866-1)");
...
the USN-4866-1 advisory.

    It was discovered that Netty incorrectly implements HTTP/2. An attacker could possibly use this issue to
    cause a denial of service. (CVE-2019-9512, CVE-2019-9514, CVE-2019-9515, CVE-2019-9518)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4866-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libnetty-java', 'pkgver': '1:4.1.7-4ubuntu0.1+esm1', 'ubuntu_pro': TRUE}
];
