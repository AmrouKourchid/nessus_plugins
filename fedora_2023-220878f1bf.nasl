...
# extracted from Fedora Security Advisory FEDORA-2023-220878f1bf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-220878f1bf");

  script_name(english:"Fedora 36 : mingw-LibRaw (2023-220878f1bf)");
...
FEDORA-2023-220878f1bf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-220878f1bf");
...
var pkgs = [
    {'reference':'mingw-LibRaw-0.20.2-8.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
