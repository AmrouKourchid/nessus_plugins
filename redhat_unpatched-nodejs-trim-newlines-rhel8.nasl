...
# extracted from Red Hat Security Advisory nodejs-trim-newlines. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : nodejs-trim-newlines (Unpatched Vulnerability) (deprecated)");
