...
# extracted from Fedora Security Advisory FEDORA-2023-b854908745
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b854908745");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 38 : python3.9 (2023-b854908745)");
...
FEDORA-2023-b854908745 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b854908745");
...
var pkgs = [
    {'reference':'python3.9-3.9.16-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
