...
# extracted from Fedora Security Advisory FEDORA-2021-00ada7e667
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-00ada7e667");
  script_xref(name:"IAVA", value:"2021-A-0524-S");

  script_name(english:"Fedora 34 : salt (2021-00ada7e667)");
...
FEDORA-2021-00ada7e667 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-00ada7e667");
...
var pkgs = [
    {'reference':'salt-3003.3-1.fc34', 'release':'FC34', 'rpm_spec_vers_cmp':TRUE}
];
