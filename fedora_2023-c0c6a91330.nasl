...
# extracted from Fedora Security Advisory FEDORA-2023-c0c6a91330
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c0c6a91330");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 37 : mod_http2 (2023-c0c6a91330)");
...
FEDORA-2023-c0c6a91330 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c0c6a91330");
...
var pkgs = [
    {'reference':'mod_http2-2.0.25-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
