...
# extracted from Debian Security Advisory dla-3519. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3519 : ghostscript - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3519
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3519-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-38559");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ghostscript', 'reference': '9.27~dfsg-2+deb10u8'},
    {'release': '10.0', 'prefix': 'ghostscript-dbg', 'reference': '9.27~dfsg-2+deb10u8'},
    {'release': '10.0', 'prefix': 'ghostscript-doc', 'reference': '9.27~dfsg-2+deb10u8'},
    {'release': '10.0', 'prefix': 'ghostscript-x', 'reference': '9.27~dfsg-2+deb10u8'},
    {'release': '10.0', 'prefix': 'libgs-dev', 'reference': '9.27~dfsg-2+deb10u8'},
    {'release': '10.0', 'prefix': 'libgs9', 'reference': '9.27~dfsg-2+deb10u8'},
    {'release': '10.0', 'prefix': 'libgs9-common', 'reference': '9.27~dfsg-2+deb10u8'}
];
