...
if (description)
{
  ...
  script_name(english:"Foxit PDF Reader < 12.0 Multiple Vulnerabilities");
...
"Upgrade to Foxit PDF Reader version 12.0 or later");
...
var constraints = [
  { 'max_version' : '11.2.2.53575', 'fixed_version' : '12.0' }
];
