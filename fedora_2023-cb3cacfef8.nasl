...
# extracted from Fedora Security Advisory FEDORA-2023-cb3cacfef8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cb3cacfef8");
  script_xref(name:"IAVA", value:"2023-A-0645");

  script_name(english:"Fedora 37 : webkitgtk (2023-cb3cacfef8)");
...
FEDORA-2023-cb3cacfef8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cb3cacfef8");
...
var pkgs = [
    {'reference':'webkitgtk-2.42.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
