...
if (description)
{
  ...
  script_name(english:"CentOS 9 : net-snmp-5.9.1-9.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for net-snmp.");
...
net-snmp-5.9.1-9.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=30471");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream net-snmp package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:python3-net-snmp");
...
var pkgs = [
    ...
    {'reference':'net-snmp-gui-5.9.1-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
