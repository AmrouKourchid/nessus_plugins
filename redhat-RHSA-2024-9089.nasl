...
# extracted from Red Hat Security Advisory RHSA-2024:9089. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-24788", "CVE-2024-24791");
  script_xref(name:"RHSA", value:"2024:9089");

  script_name(english:"RHEL 9 : containernetworking-plugins (RHSA-2024:9089)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for containernetworking-plugins.");
...
referenced in the RHSA-2024:9089 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-28855");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9089.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c64170c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9089");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL containernetworking-plugins package based on the guidance in RHSA-2024:9089.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24788");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-24791");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'containernetworking-plugins-1.5.1-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
