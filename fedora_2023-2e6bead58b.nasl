...
# extracted from Fedora Security Advisory FEDORA-2023-2e6bead58b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2e6bead58b");

  script_name(english:"Fedora 38 : trafficserver (2023-2e6bead58b)");
...
FEDORA-2023-2e6bead58b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2e6bead58b");
...
var pkgs = [
    {'reference':'trafficserver-9.2.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
