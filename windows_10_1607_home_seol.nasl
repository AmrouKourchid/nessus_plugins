...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 1607 Home SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 1607 Home is no longer maintained by its vendor or provider.
...
"Upgrade to a version of Microsoft Windows that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2018/04/10");
...
var constraints = [
  { seol : 20180410, cpe_attributes : [{'edition': 'home*'}] }
];
