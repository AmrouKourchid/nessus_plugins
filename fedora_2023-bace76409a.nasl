...
# extracted from Fedora Security Advisory FEDORA-2023-bace76409a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bace76409a");

  script_name(english:"Fedora 38 : freeimage / mingw-freeimage (2023-bace76409a)");
...
FEDORA-2023-bace76409a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bace76409a");
...
var pkgs = [
    {'reference':'freeimage-3.19.0-0.16.svn1889.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mingw-freeimage-3.19.0-0.14.svn1889.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
