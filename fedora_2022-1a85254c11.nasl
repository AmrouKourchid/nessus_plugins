...
# extracted from Fedora Security Advisory FEDORA-2022-1a85254c11
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1a85254c11");

  script_name(english:"Fedora 36 : cacti / cacti-spine (2022-1a85254c11)");
...
FEDORA-2022-1a85254c11 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1a85254c11");
...
var pkgs = [
    {'reference':'cacti-1.2.22-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cacti-spine-1.2.22-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
