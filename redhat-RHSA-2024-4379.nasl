...
# extracted from Red Hat Security Advisory RHSA-2024:4379. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4379");

  script_name(english:"RHEL 9 : gvisor-tap-vsock (RHSA-2024:4379)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4379.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?22214034");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2262921");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4379");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gvisor-tap-vsock package based on the guidance in RHSA-2024:4379.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gvisor-tap-vsock-0.7.3-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'gvisor-tap-vsock-0.7.3-4.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'6'}
    ]
  }
];
