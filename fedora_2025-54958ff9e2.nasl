...
# extracted from Fedora Security Advisory FEDORA-2025-54958ff9e2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-54958ff9e2");

  script_name(english:"Fedora 40 : nodejs20 (2025-54958ff9e2)");
...
FEDORA-2025-54958ff9e2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-54958ff9e2");
...
var pkgs = [
    {'reference':'nodejs20-20.18.2-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
