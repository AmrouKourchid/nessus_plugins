...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : gd (EulerOS-SA-2020-1901)");
...
by the following vulnerabilities :
  ...
  - ** RESERVED ** This candidate has been reserved by an
    ...
    will be provided.(CVE-2018-14553)

  - ** RESERVED ** This candidate has been reserved by an
    organization or individual that will use it when
    announcing a new security problem. When the candidate
    has been publicized, the details for this candidate
    will be provided.(CVE-2017-6363)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1901
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30f0da75");
