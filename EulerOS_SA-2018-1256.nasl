...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.1 : kernel (EulerOS-SA-2018-1256)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1256
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?daf1f2be");
...
pkgs = ["kernel-3.10.0-514.41.4.28_48",
        "kernel-devel-3.10.0-514.41.4.28_48",
        "kernel-headers-3.10.0-514.41.4.28_48",
        "kernel-tools-3.10.0-514.41.4.28_48",
        "kernel-tools-libs-3.10.0-514.41.4.28_48",
        "kernel-tools-libs-devel-3.10.0-514.41.4.28_48"];
