...
if (description)
{
  ...
  script_cve_id("CVE-2024-33870");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-33870");
...
patch available.
  ...
  - An issue was discovered in Artifex Ghostscript before 10.03.1. There is path traversal (via a crafted
    ...
    there can be a transformation of ../../foo to ./../../foo and this will grant access if ./ is permitted.
    (CVE-2024-33870)
