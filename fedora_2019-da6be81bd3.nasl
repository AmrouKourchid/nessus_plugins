...
# extracted from Fedora Security Advisory FEDORA-2019-da6be81bd3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : libmspack (2019-da6be81bd3)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-da6be81bd3");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libmspack-0.10.1-0.1.alpha.fc29")) flag++;
