...
# extracted from Red Hat Security Advisory containernetworking-cni. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : containernetworking-cni (Unpatched Vulnerability) (deprecated)");
