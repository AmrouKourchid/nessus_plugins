...
# extracted from Fedora Security Advisory FEDORA-2024-dd14eefb0e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-dd14eefb0e");
  script_xref(name:"IAVA", value:"2024-A-0365-S");

  script_name(english:"Fedora 39 : chromium (2024-dd14eefb0e)");
...
FEDORA-2024-dd14eefb0e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-dd14eefb0e");
...
"Update the affected chromium package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-5171");
...
var pkgs = [
    {'reference':'chromium-126.0.6478.114-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
