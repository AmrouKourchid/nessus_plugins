...
# extracted from Red Hat Security Advisory RHSA-2021:0054. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0054");
  script_xref(name:"IAVA", value:"2021-A-0040-S");
  script_xref(name:"IAVA", value:"2021-A-0005-S");

  script_name(english:"RHEL 8 : firefox (RHSA-2021:0054)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0054.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d7d54b3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0054");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1913503");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2021:0054.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-78.6.1-1.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
