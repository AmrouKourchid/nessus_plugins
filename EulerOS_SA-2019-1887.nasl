...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : binutils (EulerOS-SA-2019-1887)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1887
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e29f6b47");
...
pkgs = ["binutils-2.27-28.base.1.h23.eulerosv2r7",
        "binutils-devel-2.27-28.base.1.h23.eulerosv2r7"];
