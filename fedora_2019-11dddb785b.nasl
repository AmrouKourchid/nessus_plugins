...
# extracted from Fedora Security Advisory FEDORA-2019-11dddb785b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-11dddb785b");

  script_name(english:"Fedora 30 : 2:samba (2019-11dddb785b)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Update to Samba 4.10.11, Security fixes for CVE-2019-14861 and
CVE-2019-14870
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-11dddb785b");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"samba-4.10.11-0.fc30", epoch:"2")) flag++;
