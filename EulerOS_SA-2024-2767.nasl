...
if (description)
{
  ...
  script_cve_id("CVE-2024-30203", "CVE-2024-39331");

  script_name(english:"EulerOS Virtualization 2.12.0 : emacs (EulerOS-SA-2024-2767)");
...
affected by the following vulnerabilities :
    ...
    specifies an unsafe function, such as shell-command-to-string. This affects Org Mode before
    9.7.5.(CVE-2024-39331)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2767
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf0f235b");
...
var pkgs = [
  "emacs-filesystem-27.2-8.h6.eulerosv2r12"
];
