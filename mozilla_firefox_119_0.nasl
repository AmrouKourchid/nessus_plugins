...
"The version of Firefox installed on the remote Windows host is prior to 119.0. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2023-45 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'119.0', severity:SECURITY_HOLE);
