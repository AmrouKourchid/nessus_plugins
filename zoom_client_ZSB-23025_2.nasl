...
if (description)
{
  ...
  script_name(english:"Zoom Client for Meetings 5.15.0 < 5.15.2 Vulnerability (ZSB-23025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an application installed that is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Zoom Client for Meetings installed on the remote host is between 5.15.0 and 5.15.2. It is, therefore,
affected by a vulnerability as referenced in the ZSB-23025 advisory.
...
var constraints = [
  { 'min_version' : '5.15.0', 'fixed_version' : '5.15.2' }
];
