...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5033429");
  script_xref(name:"MSFT", value:"MS23-5033429");
  script_xref(name:"IAVA", value:"2023-A-0689-S");
  script_xref(name:"IAVA", value:"2023-A-0690-S");

  script_name(english:"KB5033429: Windows Server 2012 Security Update (December 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5033429. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5033429");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5033429");
