...
# extracted from Red Hat Security Advisory RHSA-2022:4999. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:4999");

  script_name(english:"RHEL 7 : OpenShift Container Platform 3.11.715 (RHSA-2022:4999)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 3.11.715.");
...
the RHSA-2022:4999 advisory.

    Red Hat OpenShift Container Platform is Red Hat's cloud computing
    Kubernetes application platform solution designed for on-premise or private
    cloud deployments.

    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 3.11.715. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4999.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1463a38");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4999");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2085361");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2089734");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 3.11.715 packages based on the guidance in RHSA-2022:4999.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.11.16-0.17.rhaos3.11.git4c0a8ad.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'cri-o-1.11.16-0.17.rhaos3.11.git4c0a8ad.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
