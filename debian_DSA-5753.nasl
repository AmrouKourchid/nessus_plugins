...
# extracted from Debian Security Advisory dsa-5753. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5753 : aom-tools - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5753
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-5171");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/aom");
...
"Upgrade the aom-tools packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libaom3");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'aom-tools', 'reference': '3.6.0-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libaom-dev', 'reference': '3.6.0-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libaom-doc', 'reference': '3.6.0-1+deb12u1'},
    {'release': '12.0', 'prefix': 'libaom3', 'reference': '3.6.0-1+deb12u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'aom-tools / libaom-dev / libaom-doc / libaom3');
}
