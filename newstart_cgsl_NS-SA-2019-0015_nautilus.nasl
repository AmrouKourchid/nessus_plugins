...
# extracted from ZTE advisory NS-SA-2019-0015. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 5.04 : nautilus Vulnerability (NS-SA-2019-0015)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 5.04, has nautilus packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2019-0015");
  script_set_attribute(attribute:"solution", value:
"Upgrade the vulnerable CGSL nautilus packages. Note that updated packages may not be available yet. Please contact ZTE
