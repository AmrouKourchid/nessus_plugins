...
if (description)
{
  ...
  script_name(english:"RHEL 7 : qemu-kvm-rhev (RHSA-2019:1968)");
...
referenced in the RHSA-2019:1968 advisory.
    ...
    * 1705364  RHV VM pauses when 'dd' issued inside guest to a direct lun configured as virtio-scsi with
    scsi-passthrough

    Users of qemu-kvm are advised to upgrade to these updated packages. After installing this update, shut
    down all running virtual machines. Once all virtual machines have shut down, start them again for this
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1968.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6decc760");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1968");
...
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2019:1968.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-rhev-2.12.0-18.el7_6.7', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-img-rhev-2.12.0-18.el7_6.7', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-common-rhev-2.12.0-18.el7_6.7', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-common-rhev-2.12.0-18.el7_6.7', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-rhev-2.12.0-18.el7_6.7', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-rhev-2.12.0-18.el7_6.7', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-tools-rhev-2.12.0-18.el7_6.7', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'},
      {'reference':'qemu-kvm-tools-rhev-2.12.0-18.el7_6.7', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'ovirt-'}
    ]
  }
];
