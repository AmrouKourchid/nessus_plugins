...
# extracted from Ubuntu Security Notice USN-2322-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2322-1");

  script_name(english:"Ubuntu 14.04 LTS : OpenStack Glance vulnerability (USN-2322-1)");
...
USN-2322-1 advisory.
    ...
    Thomas Leaman and Stuart McLaren discovered that OpenStack Glance did not properly honor the
    image_size_cap configuration option. A remote authenticated attacker could exploit this to cause a denial
    of service via disk consumption.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2322-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'glance', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'glance-api', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'glance-common', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'glance-registry', 'pkgver': '1:2014.1.2-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'python-glance', 'pkgver': '1:2014.1.2-0ubuntu1.1'}
];
