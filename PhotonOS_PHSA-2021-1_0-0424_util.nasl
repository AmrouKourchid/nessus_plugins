...
# extracted from VMware Security Advisory PHSA-2021-1.0-0424. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Util PHSA-2021-1.0-0424");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the util package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-424.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'util-linux-2.27.1-7.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'util-linux-devel-2.27.1-7.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'util-linux-lang-2.27.1-7.ph1')) flag++;
