...
# extracted from Fedora Security Advisory FEDORA-2025-a7a06a72c8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-a7a06a72c8");

  script_name(english:"Fedora 41 : zabbix (2025-a7a06a72c8)");
...
FEDORA-2025-a7a06a72c8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-a7a06a72c8");
...
"Update the affected 1:zabbix package.");
  ...
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2024-36465");
...
var pkgs = [
    {'reference':'zabbix-7.0.11-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
