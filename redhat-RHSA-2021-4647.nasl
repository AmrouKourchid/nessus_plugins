...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4647.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?466cde3c");
...
"Update the RHEL kernel package based on the guidance in RHSA-2021:4647.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'kernel-tools-libs-4.18.0-348.2.1.el8_5', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'kernel-tools-libs-devel-4.18.0-348.2.1.el8_5', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
