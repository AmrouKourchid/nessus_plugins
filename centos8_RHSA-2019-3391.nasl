...
# Red Hat Security Advisory RHSA-2019:3391. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : libreswan (CESA-2019:3391)");
...
pkgs = [
    {'reference':'libreswan-3.29-6.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libreswan-3.29-6.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
