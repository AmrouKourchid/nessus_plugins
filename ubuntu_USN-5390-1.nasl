...
the USN-5390-1 advisory.
    ...
    David Bouman discovered that the netfilter subsystem in the Linux kernel did not properly validate passed
    user register indices. A local attacker could use this to cause a denial of service or possibly execute
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1003-oracle");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1004-gcp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1005-aws");
...
var kernel_mappings = {
  '22.04': {
    '5.15.0': {
      'generic': '5.15.0-27',
      'generic-64k': '5.15.0-27',
      'generic-lpae': '5.15.0-27',
      'lowlatency': '5.15.0-27',
      'lowlatency-64k': '5.15.0-27',
      'oracle': '5.15.0-1003',
      'gcp': '5.15.0-1004',
      'aws': '5.15.0-1005'
    }
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5390-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-1015', 'CVE-2022-1016', 'CVE-2022-26490');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5390-1');
  }
  else
  {
