...
# extracted from Ubuntu Security Notice USN-5060-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5060-2");

  script_name(english:"Ubuntu 16.04 ESM : NTFS-3G vulnerabilities (USN-5060-2)");
...
USN-5060-2 advisory.
    ...
    USN-5060-1 fixed a vulnerability in NTFS-3G. This update provides the corresponding update for Ubuntu
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5060-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ntfs-3g', 'pkgver': '1:2015.3.14AR.1-1ubuntu0.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ntfs-3g-dev', 'pkgver': '1:2015.3.14AR.1-1ubuntu0.3+esm1', 'ubuntu_pro': TRUE}
];
