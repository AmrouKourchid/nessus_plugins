...
# extracted from VMware Security Advisory PHSA-2023-4.0-0449. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Xinetd PHSA-2023-4.0-0449");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the xinetd package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-449.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:xinetd");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'xinetd-2.3.15-10.ph4')) flag++;
