...
# extracted from Oracle Linux Security Advisory ELSA-2022-8100.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : swtpm (ELSA-2022-8100)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-8100.html");
