...
if (description)
{
  ...
  script_name(english:"RHEL 6 : rdesktop (RHSA-2011:0506)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rdesktop.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2011/rhsa-2011_0506.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a048cfa1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=676252");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:0506");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rdesktop package based on the guidance in RHSA-2011:0506.");
  script_set_cvss_base_vector("CVSS2#AV:A/AC:H/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-1595");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rdesktop-1.6.0-8.el6_0.1', 'cpu':'i686', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rdesktop-1.6.0-8.el6_0.1', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rdesktop-1.6.0-8.el6_0.1', 'cpu':'s390x', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rdesktop-1.6.0-8.el6_0.1', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_0', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
