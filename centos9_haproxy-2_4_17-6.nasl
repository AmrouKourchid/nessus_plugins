...
if (description)
{
  ...
  script_name(english:"CentOS 9 : haproxy-2.4.17-6.el9");
...
haproxy-2.4.17-6.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=30791");
...
var pkgs = [
    {'reference':'haproxy-2.4.17-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
