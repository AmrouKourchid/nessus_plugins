...
if (description)
{
  ...
  script_cve_id("CVE-2012-5089");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-5089");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment (JRE) component in Oracle Java SE 7 Update 7 and
    ...
    confidentiality, integrity, and availability, related to JMX, a different vulnerability than
    CVE-2012-3143. (CVE-2012-5089)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-5089");
