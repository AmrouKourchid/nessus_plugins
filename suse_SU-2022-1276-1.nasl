...
# SUSE update advisory SUSE-SU-2022:1276-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:1276-1");

  script_name(english:"openSUSE 15 Security Update : nbd (SUSE-SU-2022:1276-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1196827");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1196828");
  # https://lists.suse.com/pipermail/sle-security-updates/2022-April/010767.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?13f39f02");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2022-26495");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2022-26496");
  script_set_attribute(attribute:"solution", value:
"Update the affected nbd package.");
...
var pkgs = [
    {'reference':'nbd-3.24-150000.3.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.3']}
];
