...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (RHSA-2020:0521)");
...
var pkgs = [
    {'reference':'firefox-68.5.0-2.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
