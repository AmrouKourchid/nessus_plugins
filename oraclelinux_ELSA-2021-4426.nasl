...
# extracted from Oracle Linux Security Advisory ELSA-2021-4426.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : ncurses (ELSA-2021-4426)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2021-4426 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-4426.html");
...
var pkgs = [
    ...
    {'reference':'ncurses-term-6.1-9.20180224.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
