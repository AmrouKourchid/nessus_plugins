...
if (description)
{
  ...
  script_cve_id("CVE-2016-2785");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-2785");
...
patch available.
  ...
  - Puppet Server before 2.3.2 and Ruby puppetmaster in Puppet 4.x before 4.4.2 and in Puppet Agent before
    1.4.2 might allow remote attackers to bypass intended auth.conf access restrictions by leveraging
    incorrect URL decoding. (CVE-2016-2785)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-2785");
