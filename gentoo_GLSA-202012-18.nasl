...
# extracted from Gentoo Linux Security Advisory GLSA 202012-18.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202012-18");

  script_name(english:"GLSA-202012-18 : PowerDNS: information disclosure");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202012-18
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8474d3f8");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202012-18");
...
if (qpkg_check(package:"net-dns/pdns", unaffected:make_list("ge 4.3.1"), vulnerable:make_list("lt 4.3.1"))) flag++;
