...
# extracted from Fedora Security Advisory FEDORA-2023-b3a3df39dd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b3a3df39dd");
  script_xref(name:"IAVA", value:"2023-A-0118-S");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 36 : mingw-python3 (2023-b3a3df39dd)");
...
FEDORA-2023-b3a3df39dd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b3a3df39dd");
...
var pkgs = [
    {'reference':'mingw-python3-3.10.10-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
