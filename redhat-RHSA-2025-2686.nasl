...
# extracted from Red Hat Security Advisory RHSA-2025:2686. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:2686");

  script_name(english:"RHEL 8 : libxml2 (RHSA-2025:2686)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libxml2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:2686 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_2686.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb0bff55");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:2686");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libxml2 package based on the guidance in RHSA-2025:2686.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxml2-2.9.7-19.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.9.7-19.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libxml2-2.9.7-19.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
