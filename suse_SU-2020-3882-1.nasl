...
# extracted from SUSE update advisory SUSE-SU-2020:3882-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : openssh (SUSE-SU-2020:3882-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9993480d");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"openssh-7.6p1-9.38.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"openssh-debuginfo-7.6p1-9.38.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"openssh-debugsource-7.6p1-9.38.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"openssh-fips-7.6p1-9.38.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"openssh-helpers-7.6p1-9.38.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"openssh-helpers-debuginfo-7.6p1-9.38.1")) flag++;
