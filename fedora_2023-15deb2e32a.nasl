...
# extracted from Fedora Security Advisory FEDORA-2023-15deb2e32a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-15deb2e32a");

  script_name(english:"Fedora 38 : kernel / kernel-headers / kernel-tools (2023-15deb2e32a)");
...
FEDORA-2023-15deb2e32a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-15deb2e32a");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-15deb2e32a');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.6.3-100.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-headers-6.6.3-100.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-tools-6.6.3-100.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
