...
# extracted from Fedora Security Advisory FEDORA-2019-9ab7ee6309.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-9ab7ee6309");

  script_name(english:"Fedora 31 : 1:openssl (2019-9ab7ee6309)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-9ab7ee6309");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"openssl-1.1.1d-1.fc31", epoch:"1")) flag++;
