...
# extracted from Fedora Security Advisory FEDORA-2023-1bbea3700b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1bbea3700b");

  script_name(english:"Fedora 40 : rubygem-loofah (2023-1bbea3700b)");
...
FEDORA-2023-1bbea3700b advisory.

    Automatic update for rubygem-loofah-2.22.0-1.fc40.

    ##### **Changelog**

    ```
    * Thu Nov 23 2023 Vt Ondruch <vondruch@redhat.com> - 2.22.0-1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1bbea3700b");
  script_set_attribute(attribute:"solution", value:
"Update the affected rubygem-loofah package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:rubygem-loofah");
...
var pkgs = [
    {'reference':'rubygem-loofah-2.22.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
