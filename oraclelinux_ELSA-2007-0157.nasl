...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / xorg-x11-apps/libX11 (ELSA-2007-0157)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0157.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected libX11, libX11-devel and / or xorg-x11-apps packages.");
...
var pkgs = [
    {'reference':'libX11-1.0.3-8.0.1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-devel-1.0.3-8.0.1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-apps-7.1-4.0.1.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-1.0.3-8.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libX11-devel-1.0.3-8.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-apps-7.1-4.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
