...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : gdb (EulerOS-SA-2024-1104)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1104
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ecc3fee");
...
var pkgs = [
  "gdb-11.1-1.h6.eulerosv2r11",
  "gdb-headless-11.1-1.h6.eulerosv2r11",
  "gdb-help-11.1-1.h6.eulerosv2r11"
];
