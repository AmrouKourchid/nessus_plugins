...
# extracted from Red Hat Security Advisory RHSA-2019:1669. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1669");

  script_name(english:"RHEL 7 : openstack-ironic-inspector (RHSA-2019:1669)");
...
the RHSA-2019:1669 advisory.

    Nodes managed by Ironic may use the ironic-inspector auxiliary service to discover hardware properties.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1669.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01e8b351");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1711722");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1712027");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1669");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-ironic-inspector package based on the guidance in RHSA-2019:1669.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-ironic-inspector-8.0.3-0.20190420013817.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
