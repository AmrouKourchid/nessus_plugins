...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : ruby (EulerOS-SA-2019-1895)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1895
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?472a6f52");
...
pkgs = ["ruby-2.0.0.648-33.h14.eulerosv2r7",
        "ruby-irb-2.0.0.648-33.h14.eulerosv2r7",
        "ruby-libs-2.0.0.648-33.h14.eulerosv2r7"];
