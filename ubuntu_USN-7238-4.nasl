...
# extracted from Ubuntu Security Notice USN-7238-4. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7238-4");

  script_name(english:"Ubuntu 24.10 : Linux kernel (AWS) vulnerabilities (USN-7238-4)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7238-4");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.11.0-1008-aws");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-7238-4');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-7238-4');
  }
  else
  {
