...
# extracted from Red Hat Security Advisory RHSA-2014:0763. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0763");

  script_name(english:"RHEL 6 : rubygem-openshift-origin-node (RHSA-2014:0763)");
...
issue.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0763");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2014-3496");
  script_set_attribute(attribute:"solution", value:
"Update the affected rubygem-openshift-origin-node package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3496");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-node-1.17.5.17-1.el6")) flag++;
