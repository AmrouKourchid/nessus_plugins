...
# extracted from Fedora Security Advisory FEDORA-2018-791c3cfe21.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-791c3cfe21");

  script_name(english:"Fedora 29 : php (2018-791c3cfe21)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-791c3cfe21");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"php-7.2.10-1.fc29")) flag++;
