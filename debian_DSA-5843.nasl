...
# extracted from Debian Security Advisory dsa-5843. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5843 : rsync - security update");
...
dsa-5843 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5843-2                   security@debian.org
    Debian Security Advisory DSA-5843-1                   security@debian.org
    https://www.debian.org/security/                     Salvatore Bonaccorso
    January 16, 2025                      https://www.debian.org/security/faq
    - -------------------------------------------------------------------------

    Package        : rsync
    Debian Bug     : 1093052 1093089
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/rsync");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-12084");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-12085");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-12086");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-12087");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-12088");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-12747");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/rsync");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'rsync', 'reference': '3.2.7-1+deb12u2'}
];
