...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2023-A-0312-S");

  script_name(english:"Liferay Portal CE 7.4.3.70 < 7.4.3.74 XSS");

  script_set_attribute(attribute:"synopsis", value:
"An application running on a remote web server host is affected by a cross site scripting vulnerability");
  script_set_attribute(attribute:"description", value:
"The detected install of Liferay Portal CE is between 7.4.3.70 and 7.4.3.73. It is therefore affected by a
Cross-site scripting (XSS) vulnerability in the Layout module's SEO configuration in Liferay Portal 7.4.3.70 through 
7.4.3.73, which allows remote attackers to inject arbitrary web script or HTML via the 
...
"Upgrade to Liferay Portal 7.4.3.74 or later.");
...
var constraints = [ {'min_version': '7.4.3.70' , 'fixed_version': '7.4.3.74'} ];
