...
# extracted from Red Hat Security Advisory RHSA-2024:9818. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9818");

  script_name(english:"RHEL 8 : tigervnc (RHSA-2024:9818)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for tigervnc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:9818 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9818.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?235b20d6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9818");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tigervnc package based on the guidance in RHSA-2024:9818.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tigervnc-1.9.0-15.el8_2.12', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-icons-1.9.0-15.el8_2.12', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-license-1.9.0-15.el8_2.12', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-server-1.9.0-15.el8_2.12', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-server-applet-1.9.0-15.el8_2.12', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-server-minimal-1.9.0-15.el8_2.12', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-server-module-1.9.0-15.el8_2.12', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
