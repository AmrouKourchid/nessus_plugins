...
# extracted from openSUSE Security Update openSUSE-2021-471.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ruby2.5 (openSUSE-2021-471)");
...
"This update for ruby2.5 fixes the following issues :
  ...
  - CVE-2020-25613: Fixed a potential HTTP Request Smuggling
    in WEBrick (bsc#1177125).

  - Enable optimizations also on ARM64 (bsc#1177222)

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1177125");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1177222");
...
if ( rpm_check(release:"SUSE15.2", reference:"libruby2_5-2_5-2.5.8-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libruby2_5-2_5-debuginfo-2.5.8-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ruby2.5-2.5.8-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ruby2.5-debuginfo-2.5.8-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ruby2.5-debugsource-2.5.8-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ruby2.5-devel-2.5.8-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ruby2.5-devel-extra-2.5.8-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ruby2.5-doc-ri-2.5.8-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ruby2.5-stdlib-2.5.8-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ruby2.5-stdlib-debuginfo-2.5.8-lp152.2.3.1") ) flag++;
