...
# extracted from Red Hat Security Advisory kdebase-runtime. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : kdebase-runtime (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-7252");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:kdebase-runtime");
