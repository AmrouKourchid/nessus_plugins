...
# extracted from Fedora Security Advisory FEDORA-2022-88cefef88c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-88cefef88c");

  script_name(english:"Fedora 35 : krb5 (2022-88cefef88c)");
...
FEDORA-2022-88cefef88c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-88cefef88c");
...
var pkgs = [
    {'reference':'krb5-1.19.2-9.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
