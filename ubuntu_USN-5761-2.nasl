...
# extracted from Ubuntu Security Notice USN-5761-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5761-2");

  script_name(english:"Ubuntu 16.04 ESM : ca-certificates update (USN-5761-2)");
...
USN-5761-2 advisory.
    ...
    USN-5761-1 updated ca-certificates. This update provides the corresponding update for Ubuntu 14.04 ESM and
    Ubuntu 16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5761-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ca-certificates', 'pkgver': '20211016~16.04.1~esm2', 'ubuntu_pro': TRUE}
];
