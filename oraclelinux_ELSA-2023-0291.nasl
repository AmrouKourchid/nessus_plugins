...
# extracted from Oracle Linux Security Advisory ELSA-2023-0291.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : sudo (ELSA-2023-0291)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2023-0291 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-0291.html");
...
var pkgs = [
    {'reference':'sudo-1.8.23-10.el7_9.3', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-devel-1.8.23-10.el7_9.3', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
