...
# extracted from Fedora Security Advisory FEDORA-2020-98ebbd1397.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : glib-networking (2020-98ebbd1397)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-98ebbd1397");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"glib-networking-2.62.4-1.fc31")) flag++;
