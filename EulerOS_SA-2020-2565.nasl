...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : sox (EulerOS-SA-2020-2565)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2565
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3486960e");
...
pkgs = ["sox-14.4.1-6.h3.eulerosv2r7"];
