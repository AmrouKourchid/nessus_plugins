...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : mariadb (EulerOS-SA-2020-2008)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2008
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?11d1d87e");
...
pkgs = ["mariadb-10.3.9-2.h2.eulerosv2r8",
        "mariadb-common-10.3.9-2.h2.eulerosv2r8",
        "mariadb-devel-10.3.9-2.h2.eulerosv2r8"];
