...
# extracted from Ubuntu Security Notice USN-5348-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5348-2");

  script_name(english:"Ubuntu 16.04 ESM : Smarty vulnerabilities (USN-5348-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5348-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'smarty3', 'pkgver': '3.1.21-1ubuntu1+esm1', 'ubuntu_pro': TRUE}
];
