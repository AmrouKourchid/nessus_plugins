...
# extracted from SUSE update advisory SUSE-SU-2020:0390-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : sudo (SUSE-SU-2020:0390-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56da4fc0");
...
SUSE-SLE-SAP-12-SP1-2020-390=1

SUSE Linux Enterprise Server 12-SP1-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP1-2020-390=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"1", reference:"sudo-1.8.10p3-2.32.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"sudo-debuginfo-1.8.10p3-2.32.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"sudo-debugsource-1.8.10p3-2.32.1")) flag++;
