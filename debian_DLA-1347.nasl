...
# extracted from Debian Security Advisory DLA-1347-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1347-1 : tiff3 security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/04/msg00011.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/wheezy/tiff3");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libtiff4", reference:"3.9.6-11+deb7u10")) flag++;
if (deb_check(release:"7.0", prefix:"libtiff4-dev", reference:"3.9.6-11+deb7u10")) flag++;
if (deb_check(release:"7.0", prefix:"libtiffxx0c2", reference:"3.9.6-11+deb7u10")) flag++;
