...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : vim (EulerOS-SA-2018-1171)");
...
vulnerability :
  ...
  - An integer overflow flaw was found in the way vim
    handled undo files. This bug could result in vim
    crashing when trying to process corrupted undo
    files.(CVE-2017-6349)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1171
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dbf48725");
...
"Update the affected vim package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-6349");
...
pkgs = ["vim-X11-7.4.160-2.h4",
        "vim-common-7.4.160-2.h4",
        "vim-enhanced-7.4.160-2.h4",
        "vim-filesystem-7.4.160-2.h4",
        "vim-minimal-7.4.160-2.h4"];
