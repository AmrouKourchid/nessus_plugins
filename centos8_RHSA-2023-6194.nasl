...
# Red Hat Security Advisory RHSA-2023:6194. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : thunderbird (CESA-2023:6194)");
...
var pkgs = [
    {'reference':'thunderbird-115.4.1-1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.4.1-1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
