...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : bind (EulerOS-SA-2021-1766)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1766
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?23c76d64");
...
pkgs = ["bind-9.9.4-61.1.h11",
        "bind-chroot-9.9.4-61.1.h11",
        "bind-libs-9.9.4-61.1.h11",
        "bind-libs-lite-9.9.4-61.1.h11",
        "bind-license-9.9.4-61.1.h11",
        "bind-pkcs11-9.9.4-61.1.h11",
        "bind-pkcs11-libs-9.9.4-61.1.h11",
        "bind-pkcs11-utils-9.9.4-61.1.h11",
