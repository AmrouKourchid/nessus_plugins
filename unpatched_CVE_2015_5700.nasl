...
if (description)
{
  ...
  script_cve_id("CVE-2015-5700");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-5700");
...
patch available.
  ...
  - mktexlsr revision 22855 through revision 36625 as packaged in texlive allows local users to write to
    arbitrary files via a symlink attack. (CVE-2015-5700)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-5700");
