...
# extracted from Ubuntu Security Notice USN-5431-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5431-1");

  script_name(english:"Ubuntu 18.04 LTS : GnuPG vulnerability (USN-5431-1)");
...
USN-5431-1 advisory.
    ...
    It was discovered that GnuPG was not properly processing keys with large amounts of signatures. An
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5431-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'dirmngr', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gnupg', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gnupg-agent', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gnupg-l10n', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gnupg-utils', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gnupg2', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gpg', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gpg-agent', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gpg-wks-client', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gpg-wks-server', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gpgconf', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gpgsm', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gpgv', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gpgv-static', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gpgv-win32', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'gpgv2', 'pkgver': '2.2.4-1ubuntu1.5'},
    {'osver': '18.04', 'pkgname': 'scdaemon', 'pkgver': '2.2.4-1ubuntu1.5'}
];
