...
# extracted from Fedora Security Advisory FEDORA-2024-c83208238d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c83208238d");

  script_name(english:"Fedora 40 : opentofu (2024-c83208238d)");
...
FEDORA-2024-c83208238d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c83208238d");
...
var pkgs = [
    {'reference':'opentofu-1.8.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
