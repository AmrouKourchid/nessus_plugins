...
# extracted from Red Hat Security Advisory RHSA-2024:2981. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2981");

  script_name(english:"RHEL 8 : frr (RHSA-2024:2981)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for frr.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2981 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2981.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d1539ab");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-12039");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-22303");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-2263");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-6583");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2981");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'frr-7.5.1-22.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'frr-selinux-7.5.1-22.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
