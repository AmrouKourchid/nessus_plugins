...
# extracted from Fedora Security Advisory FEDORA-2023-e1482687dd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e1482687dd");

  script_name(english:"Fedora 38 : microcode_ctl (2023-e1482687dd)");
...
FEDORA-2023-e1482687dd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e1482687dd");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-55.1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
