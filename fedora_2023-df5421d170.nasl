...
# extracted from Fedora Security Advisory FEDORA-2023-df5421d170
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-df5421d170");

  script_name(english:"Fedora 36 : java-17-openjdk (2023-df5421d170)");
...
FEDORA-2023-df5421d170 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-df5421d170");
...
var pkgs = [
    {'reference':'java-17-openjdk-17.0.6.0.10-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
