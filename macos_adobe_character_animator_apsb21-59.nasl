...
if (description)
{
  ...
  script_name(english:"Adobe Character Animator 4.0 < 4.4 Multiple Vulnerabilities (APSB21-59) (macOS)");
...
"The version of Adobe Character Animator installed on the remote macOS host is prior to 4.4. It is, therefore, affected
