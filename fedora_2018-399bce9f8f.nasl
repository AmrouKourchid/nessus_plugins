...
# extracted from Fedora Security Advisory FEDORA-2018-399bce9f8f.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-18557", "CVE-2018-18661");
  script_xref(name:"FEDORA", value:"2018-399bce9f8f");

  script_name(english:"Fedora 27 : libtiff (2018-399bce9f8f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"http://www.simplesystems.org/libtiff/v4.0.10.html");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-399bce9f8f");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libtiff-4.0.10-1.fc27")) flag++;
