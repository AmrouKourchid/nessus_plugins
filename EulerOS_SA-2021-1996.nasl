...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : cups (EulerOS-SA-2021-1996)");
...
by the following vulnerability :
  ...
  - access to uninitialized buffer in ipp.c(CVE-2020-10001)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1996
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52fea8a1");
