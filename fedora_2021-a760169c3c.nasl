...
# extracted from Fedora Security Advisory FEDORA-2021-a760169c3c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-a760169c3c");
  script_xref(name:"IAVB", value:"2021-B-0012-S");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Fedora 33 : 1:nodejs (2021-a760169c3c)");
...
FEDORA-2021-a760169c3c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-a760169c3c");
...
pkgs = [
    {'reference':'nodejs-14.16.0-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
