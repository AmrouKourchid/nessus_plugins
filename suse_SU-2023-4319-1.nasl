...
# SUSE update advisory SUSE-SU-2023:4319-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-1281", "CVE-2023-1829");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4319-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 49 for SLE 12 SP5) (SUSE-SU-2023:4319-1)");
...
the SUSE-SU-2023:4319-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-October/016960.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1aac7106");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.179-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_179-default-2-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      }
    }
  }
