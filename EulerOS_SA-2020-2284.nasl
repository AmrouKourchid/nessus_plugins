...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : graphviz (EulerOS-SA-2020-2284)");
...
vulnerability :
  ...
  - NULL pointer dereference vulnerability in the
    rebuild_vlists function in lib/dotgen/conc.c in the
    dotgen library in Graphviz 2.40.1 allows remote
    attackers to cause a denial of service (application
    crash) via a crafted file.(CVE-2018-10196)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2284
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f4db3b4");
...
pkgs = ["graphviz-2.30.1-21.h6.eulerosv2r7",
        "graphviz-tcl-2.30.1-21.h6.eulerosv2r7"];
