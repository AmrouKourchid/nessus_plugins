...
# extracted from Fedora Security Advisory FEDORA-2023-26116901d9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-26116901d9");

  script_name(english:"Fedora 37 : GitPython (2023-26116901d9)");
...
FEDORA-2023-26116901d9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-26116901d9");
...
var pkgs = [
    {'reference':'GitPython-3.1.32-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
