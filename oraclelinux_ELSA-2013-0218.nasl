...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-0218.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected xorg-x11-drv-qxl package.");
...
var pkgs = [
    {'reference':'xorg-x11-drv-qxl-0.0.14-14.el6_3', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-drv-qxl-0.0.14-14.el6_3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
