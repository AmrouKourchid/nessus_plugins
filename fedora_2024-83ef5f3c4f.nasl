...
# extracted from Fedora Security Advisory FEDORA-2024-83ef5f3c4f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-83ef5f3c4f");

  script_name(english:"Fedora 39 : mingw-python-idna (2024-83ef5f3c4f)");
...
FEDORA-2024-83ef5f3c4f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-83ef5f3c4f");
...
var pkgs = [
    {'reference':'mingw-python-idna-3.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
