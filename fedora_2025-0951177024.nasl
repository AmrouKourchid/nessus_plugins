...
# extracted from Fedora Security Advisory FEDORA-2025-0951177024
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-4068");
  script_xref(name:"FEDORA", value:"2025-0951177024");

  script_name(english:"Fedora 41 : nodejs-nodemon (2025-0951177024)");
...
FEDORA-2025-0951177024 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-0951177024");
...
"Update the affected nodejs-nodemon package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:nodejs-nodemon");
...
var pkgs = [
    {'reference':'nodejs-nodemon-3.1.9-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
