...
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.7.7.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1150.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2597480");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1948423");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.7.7 package based on the guidance in RHSA-2021:1150.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.20.2-6.rhaos4.7.gitf1d5201.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      ...
      {'reference':'openshift-hyperkube-4.7.0-202104090228.p0.git.97111.77863f8.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
