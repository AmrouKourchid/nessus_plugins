...
# extracted from Ubuntu Security Notice USN-6716-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6716-1");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/06/20");

  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Linux kernel (Azure) vulnerabilities (USN-6716-1)");
...
referenced in the USN-6716-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6716-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1126-azure");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6716-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-44879', 'CVE-2023-4244', 'CVE-2023-6121', 'CVE-2023-22995', 'CVE-2023-23000', 'CVE-2023-23004', 'CVE-2023-51779', 'CVE-2023-51780', 'CVE-2023-51782', 'CVE-2024-0340', 'CVE-2024-1086', 'CVE-2024-24855');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6716-1');
  }
  else
  {
