...
# extracted from Fedora Security Advisory FEDORA-2025-6baf694c75
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-6baf694c75");

  script_name(english:"Fedora 40 : freeipa (2025-6baf694c75)");
...
FEDORA-2025-6baf694c75 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-6baf694c75");
  script_set_attribute(attribute:"solution", value:
"Update the affected freeipa package.");
...
var pkgs = [
    {'reference':'freeipa-4.12.2-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
