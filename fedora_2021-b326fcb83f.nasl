...
# extracted from Fedora Security Advisory FEDORA-2021-b326fcb83f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-b326fcb83f");

  script_name(english:"Fedora 33 : python3.10 (2021-b326fcb83f)");
...
FEDORA-2021-b326fcb83f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-b326fcb83f");
...
pkgs = [
    {'reference':'python3.10-3.10.0~a6-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
