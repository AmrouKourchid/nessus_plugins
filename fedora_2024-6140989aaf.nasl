...
# extracted from Fedora Security Advisory FEDORA-2024-6140989aaf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6140989aaf");

  script_name(english:"Fedora 41 : python3.9 (2024-6140989aaf)");
...
FEDORA-2024-6140989aaf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6140989aaf");
...
var pkgs = [
    {'reference':'python3.9-3.9.19-6.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
