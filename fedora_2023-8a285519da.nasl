...
# extracted from Fedora Security Advisory FEDORA-2023-8a285519da
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8a285519da");

  script_name(english:"Fedora 37 : dotnet7.0 (2023-8a285519da)");
...
FEDORA-2023-8a285519da advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8a285519da");
...
var pkgs = [
    {'reference':'dotnet7.0-7.0.112-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
