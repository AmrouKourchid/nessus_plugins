...
# extracted from Fedora Security Advisory FEDORA-2024-0a0b1533f7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0a0b1533f7");

  script_name(english:"Fedora 40 : liblas (2024-0a0b1533f7)");
...
FEDORA-2024-0a0b1533f7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0a0b1533f7");
...
"Update the affected liblas package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-27507");
...
var pkgs = [
    {'reference':'liblas-1.8.2-0.12.gitf1da555.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
