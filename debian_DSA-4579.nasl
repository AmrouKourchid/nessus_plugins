...
# extracted from Debian Security Advisory DSA-4579. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4579");

  script_name(english:"Debian DSA-4579-1 : nss - security update");
...
execution of arbitrary code.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2019/dsa-4579");
  script_set_attribute(attribute:"solution", value:
"Upgrade the nss packages.

For the stable distribution (buster), these problems have been fixed
in version 2:3.42.1-1+deb10u2.");
...
flag = 0;
if (deb_check(release:"10.0", prefix:"libnss3", reference:"2:3.42.1-1+deb10u2")) flag++;
if (deb_check(release:"10.0", prefix:"libnss3-dev", reference:"2:3.42.1-1+deb10u2")) flag++;
if (deb_check(release:"10.0", prefix:"libnss3-tools", reference:"2:3.42.1-1+deb10u2")) flag++;
