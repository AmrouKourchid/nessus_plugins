...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : exempi (EulerOS-SA-2018-1124)");
...
vulnerabilities :
  ...
  -
    MPFiles/source/FormatSupport/TIFF_Support.hpp.(CVE-2017
    -18234)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1124
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2da6d3b");
