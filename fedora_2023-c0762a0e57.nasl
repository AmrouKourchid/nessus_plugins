...
# extracted from Fedora Security Advisory FEDORA-2023-c0762a0e57
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c0762a0e57");

  script_name(english:"Fedora 37 : ntp-refclock (2023-c0762a0e57)");
...
FEDORA-2023-c0762a0e57 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c0762a0e57");
...
var pkgs = [
    {'reference':'ntp-refclock-0.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
