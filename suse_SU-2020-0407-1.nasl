...
# extracted from SUSE update advisory SUSE-SU-2020:0407-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : sudo (SUSE-SU-2020:0407-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?deb98c12");
...
SUSE-OpenStack-Cloud-7-2020-407=1

SUSE Linux Enterprise Server for SAP 12-SP2:zypper in -t patch
SUSE-SLE-SAP-12-SP2-2020-407=1

SUSE Linux Enterprise Server 12-SP2-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP2-2020-407=1

SUSE Linux Enterprise Server 12-SP2-BCL:zypper in -t patch
SUSE-SLE-SERVER-12-SP2-BCL-2020-407=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", reference:"sudo-1.8.10p3-10.26.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"sudo-debuginfo-1.8.10p3-10.26.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"sudo-debugsource-1.8.10p3-10.26.1")) flag++;
