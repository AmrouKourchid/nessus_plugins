...
# extracted from openSUSE Security Update openSUSE-2019-988.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : pdns-recursor (openSUSE-2019-988)");
...
Security issues fixed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1114169");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1114170");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1116592");
...
"Update the affected pdns-recursor packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-16855");
