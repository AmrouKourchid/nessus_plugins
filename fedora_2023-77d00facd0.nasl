...
# extracted from Fedora Security Advisory FEDORA-2023-77d00facd0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-77d00facd0");

  script_name(english:"Fedora 38 : frr (2023-77d00facd0)");
...
FEDORA-2023-77d00facd0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-77d00facd0");
...
var pkgs = [
    {'reference':'frr-8.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
