...
# extracted from Red Hat Security Advisory RHSA-2019:2506. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:2506");

  script_name(english:"RHEL 7 : redis (RHSA-2019:2506)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2506.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be50810f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2506");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL redis package based on the guidance in RHSA-2019:2506.");
...
var constraints = [
  {
    'repo_relative_urls': [
      'content/dist/rhel/server/7/7Server/x86_64/openstack-optools/9/debug',
      'content/dist/rhel/server/7/7Server/x86_64/openstack-optools/9/os',
      'content/dist/rhel/server/7/7Server/x86_64/openstack-optools/9/source/SRPMS'
    ],
    'pkgs': [
      {'reference':'redis-3.0.6-5.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
