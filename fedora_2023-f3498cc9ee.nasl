...
# extracted from Fedora Security Advisory FEDORA-2023-f3498cc9ee
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f3498cc9ee");

  script_name(english:"Fedora 40 : python3.12 (2023-f3498cc9ee)");
...
FEDORA-2023-f3498cc9ee advisory.

    Automatic update for python3.12-3.12.1-2.fc40.

    ##### **Changelog**

    ```
    * Mon Dec 18 2023 Lumr Balhar <lbalhar@redhat.com> - 3.12.1-2
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f3498cc9ee");
...
var pkgs = [
    {'reference':'python3.12-3.12.1-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
