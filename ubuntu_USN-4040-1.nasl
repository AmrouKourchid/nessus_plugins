...
# extracted from Ubuntu Security Notice USN-4040-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4040-1");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : Expat vulnerability (USN-4040-1)");
...
in the USN-4040-1 advisory.

    It was discovered that Expat incorrectly handled certain XML files. An attacker could possibly use this
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4040-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'expat', 'pkgver': '2.1.0-7ubuntu0.16.04.4'},
    {'osver': '16.04', 'pkgname': 'lib64expat1', 'pkgver': '2.1.0-7ubuntu0.16.04.4'},
    {'osver': '16.04', 'pkgname': 'lib64expat1-dev', 'pkgver': '2.1.0-7ubuntu0.16.04.4'},
    {'osver': '16.04', 'pkgname': 'libexpat1', 'pkgver': '2.1.0-7ubuntu0.16.04.4'},
    {'osver': '16.04', 'pkgname': 'libexpat1-dev', 'pkgver': '2.1.0-7ubuntu0.16.04.4'},
    {'osver': '16.04', 'pkgname': 'libexpat1-udeb', 'pkgver': '2.1.0-7ubuntu0.16.04.4'},
    {'osver': '18.04', 'pkgname': 'expat', 'pkgver': '2.2.5-3ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'libexpat1', 'pkgver': '2.2.5-3ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'libexpat1-dev', 'pkgver': '2.2.5-3ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'libexpat1-udeb', 'pkgver': '2.2.5-3ubuntu0.1'}
];
