...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : python-jinja2 (EulerOS-SA-2020-1570)");
...
affected by the following vulnerability :
  ...
  - flattenSubquery in select.c in SQLite 3.30.1 mishandles
    ...
    results).(CVE-2019-10906)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1570
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?929dc9be");
