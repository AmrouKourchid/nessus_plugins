...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop 21.x < 21.2.7 / 22.x < 22.3.1 Multiple Vulnerabilities (APSB21-28)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop installed on the remote Windows host is prior to 21.2.7/22.3.1. It is, therefore,
affected by multiple vulnerabilities as referenced in the apsb21-28 advisory.
