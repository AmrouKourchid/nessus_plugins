...
# extracted from Fedora Security Advisory FEDORA-2025-15a818859e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-15a818859e");

  script_name(english:"Fedora 40 : java-17-openjdk (2025-15a818859e)");
...
FEDORA-2025-15a818859e advisory.

    This is major rework of alternatives usage. We are (finally!) dropping the parallel installs support, and
    moving back to good, old java-xyz-openjdk major alternatives target
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-15a818859e");
...
var pkgs = [
    {'reference':'java-17-openjdk-17.0.14.0.7-6.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
