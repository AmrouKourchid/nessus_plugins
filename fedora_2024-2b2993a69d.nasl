...
# extracted from Fedora Security Advisory FEDORA-2024-2b2993a69d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2b2993a69d");
  script_xref(name:"IAVA", value:"2024-A-0695-S");

  script_name(english:"Fedora 41 : thunderbird (2024-2b2993a69d)");
...
FEDORA-2024-2b2993a69d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2b2993a69d");
...
var pkgs = [
    {'reference':'thunderbird-128.4.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
