...
# extracted from Red Hat Security Advisory RHSA-2024:1487. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1487");
  script_xref(name:"IAVA", value:"2024-A-0174-S");

  script_name(english:"RHEL 9 : firefox (RHSA-2024:1487)");
...
referenced in the RHSA-2024:1487 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1487.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b21b81b4");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1487");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2024:1487.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-115.9.1-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
