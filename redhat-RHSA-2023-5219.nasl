...
# extracted from Red Hat Security Advisory RHSA-2023:5219. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5219");

  script_name(english:"RHEL 8 : frr (RHSA-2023:5219)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for frr.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:5219 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5219.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?771c7e62");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2230983");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2231829");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5219");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL frr package based on the guidance in RHSA-2023:5219.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'frr-7.5.1-7.el8_8.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'frr-selinux-7.5.1-7.el8_8.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'frr-7.5.1-7.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'frr-selinux-7.5.1-7.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
