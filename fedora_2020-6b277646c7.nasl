...
# extracted from Fedora Security Advisory FEDORA-2020-6b277646c7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : asterisk (2020-6b277646c7)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-6b277646c7");
...
"Update the affected asterisk package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-28242");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"asterisk-17.9.0-1.fc33")) flag++;
