...
if (description)
{
  ...
  script_cve_id("CVE-2015-0848");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-0848");
...
patch available.
  ...
  - Heap-based buffer overflow in libwmf 0.2.8.4 allows remote attackers to cause a denial of service (crash)
    or possibly execute arbitrary code via a crafted BMP image. (CVE-2015-0848)
