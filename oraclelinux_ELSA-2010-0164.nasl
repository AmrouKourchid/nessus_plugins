...
# Oracle Linux Security Advisory ELSA-2010-0164 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : openssl097a (ELSA-2010-0164)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0164.html");
...
var pkgs = [
    {'reference':'openssl097a-0.9.7a-9.el5_4.2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openssl097a-0.9.7a-9.el5_4.2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
