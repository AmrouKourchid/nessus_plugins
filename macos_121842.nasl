...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"121842");
  script_xref(name:"IAVA", value:"2024-A-0793-S");

  script_name(english:"macOS 13.x < 13.7.2 Multiple Vulnerabilities (121842)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 13.x prior to 13.7.2. It is, therefore, affected by
multiple vulnerabilities:
  ...
  - A logic issue was addressed with improved checks. This issue is fixed in iPadOS 17.7.3, watchOS 11.2, tvOS
    18.2, macOS Sequoia 15.2, iOS 18.2 and iPadOS 18.2, macOS Ventura 13.7.2, macOS Sonoma 14.7.2. An app may
    be able to gain elevated privileges. (CVE-2024-44225)

Note that Nessus has not tested for these issues but has instead relied only on the operating system's self-reported
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/121842");
  script_set_attribute(attribute:"solution", value:
"Upgrade to macOS 13.7.2 or later.");
...
var constraints = [
  { 'fixed_version' : '13.7.2', 'min_version' : '13.0', 'fixed_display' : 'macOS Ventura 13.7.2' }
];
