...
if (description)
{
  ...
  script_name(english:"Apache Struts SEoL (1.0.x <= x <= 1.3.10.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Apache Struts is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Apache Struts is between 1.0.x and 1.3.10.x. It is, therefore, no longer maintained by its
vendor or provider.
...
contain security vulnerabilities.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://struts.apache.org/struts1eol-press");
...
"Upgrade to a version of Apache Struts that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2013/04/05");
...
var constraints = [
  { max_branch : '1.3.10', min_branch : '1.0', seol : 20130405 }
];
