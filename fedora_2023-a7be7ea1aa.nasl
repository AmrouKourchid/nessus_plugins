...
# extracted from Fedora Security Advisory FEDORA-2023-a7be7ea1aa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a7be7ea1aa");

  script_name(english:"Fedora 36 : ruby (2023-a7be7ea1aa)");
...
FEDORA-2023-a7be7ea1aa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a7be7ea1aa");
...
var pkgs = [
    {'reference':'ruby-3.1.4-175.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
