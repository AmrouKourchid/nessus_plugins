...
if (description)
{
  ...
  script_name(english:"Adobe Acrobat < 11.0.15 / 15.006.30121 / 15.010.20060 Multiple Vulnerabilities (APSB16-09) (macOS)");
...
"The version of Adobe Acrobat installed on the remote macOS host is a version prior to 11.0.15, 15.006.30121, or
15.010.20060. It is, therefore, affected by multiple vulnerabilities.
...
var constraints = [
  { 'max_version' : '11.0.14', 'fixed_version' : '11.0.15', 'track' : 'DC Continuous' },
