...
"The remote Red Hat host is missing a security update for python-psutil.");
...
the RHSA-2021:4324 advisory.
    ...
    psutil is a module providing an interface for retrieving information on all running processes and system
    utilization (CPU, memory, disks, network, users) in a portable way by using Python.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4324.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0333f216");
...
"Update the RHEL python-psutil package based on the guidance in RHSA-2021:4324.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-psutil-5.4.3-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
