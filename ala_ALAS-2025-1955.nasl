...
# extracted from Amazon Linux AMI Security Advisory ALAS-2025-1955.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : rsync (ALAS-2025-1955)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of rsync installed on the remote host is prior to 3.0.6-12.17. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS-2025-1955 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2025-1955.html");
...
var pkgs = [
    {'reference':'rsync-3.0.6-12.17.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rsync-3.0.6-12.17.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rsync-debuginfo-3.0.6-12.17.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rsync-debuginfo-3.0.6-12.17.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
