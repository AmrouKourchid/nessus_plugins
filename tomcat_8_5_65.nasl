...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.5.0 < 8.5.65");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 8.5.65. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_8.5.65_security-8 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12322635");
  script_set_attribute(attribute:"see_also", value:"https://bz.apache.org/bugzilla/show_bug.cgi?id=65203");
  # https://tomcat.apache.org/security-8.html#Fixed_in_Apache_Tomcat_8.5.65
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?07c55563");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 8.5.65 or later.");
...
var constraints = [
  { 'fixed_version' : '8.5.65', 'equal' : '8.5.64' }
];
