...
# extracted from VMware Security Advisory PHSA-2018-2.0-0052. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Unzip PHSA-2018-2.0-0052");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the unzip package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-52.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'unzip-6.0-11.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'unzip-debuginfo-6.0-11.ph2')) flag++;
