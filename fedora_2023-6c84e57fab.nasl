...
# extracted from Fedora Security Advisory FEDORA-2023-6c84e57fab
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6c84e57fab");
  script_xref(name:"IAVB", value:"2023-B-0084-S");
  script_xref(name:"IAVA", value:"2023-A-0579-S");

  script_name(english:"Fedora 38 : vim (2023-6c84e57fab)");
...
FEDORA-2023-6c84e57fab advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6c84e57fab");
...
var pkgs = [
    {'reference':'vim-9.0.2048-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
