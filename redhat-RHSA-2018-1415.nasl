...
# extracted from Red Hat Security Advisory RHSA-2018:1415. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1415");

  script_name(english:"RHEL 7 : firefox (RHSA-2018:1415)");
...
referenced in the RHSA-2018:1415 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1415.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?993fa7f5");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2018-12/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1415");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-52.8.0-1.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
