...
# Rocky Linux Security Advisory RLSA-2022:6313.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:6313");

  script_name(english:"Rocky Linux 9 : pcs (RLSA-2022:6313)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:6313");
...
var pkgs = [
    {'reference':'pcs-0.11.1-10.el9_0.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pcs-0.11.1-10.el9_0.2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pcs-snmp-0.11.1-10.el9_0.2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pcs-snmp-0.11.1-10.el9_0.2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
