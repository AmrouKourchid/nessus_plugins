...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : ghostscript (EulerOS-SA-2022-1723)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1723
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f3df8b5");
...
var pkgs = [
  "ghostscript-9.07-31.6.h24",
  "ghostscript-cups-9.07-31.6.h24"
];
