...
if (description)
{
  ...
  script_name(english:"Adobe Animate 21.x < 21.0.3 A Vulnerability (APSB21-11)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Animate installed on remote macOS or Mac OS X host is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Animate installed on the remote macOS or Mac OS X host is prior to 21.0.3. It is, therefore,
affected by a vulnerability as referenced in the apsb21-11 advisory.

  - Adobe Animate version 21.0.2 (and earlier) is affected by an Out-of-bounds Write vulnerability. An
    ...
    open a malicious file. (CVE-2021-21052)
...
var constraints = [
  { 'min_version' : '21.0.0', 'fixed_version' : '21.0.3' }
];
