...
if (description)
{
  ...
  script_name(english:"Wireshark 3.2.x < 3.2.15 A Vulnerability (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote macOS / Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote macOS / Mac OS X host is prior to 3.2.15. It is, therefore, affected by
a vulnerability as referenced in the wireshark-3.2.15 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/docs/relnotes/wireshark-3.2.15.html");
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/security/wnpa-sec-2021-06");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Wireshark version 3.2.15 or later.");
...
constraints = [
  { 'min_version' : '3.2.0', 'max_version' : '3.2.14', 'fixed_version' : '3.2.15' }
];
