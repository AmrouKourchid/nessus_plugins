...
# extracted from Fedora Security Advisory FEDORA-2024-b0e165ded6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b0e165ded6");

  script_name(english:"Fedora 38 : dotnet6.0 (2024-b0e165ded6)");
...
FEDORA-2024-b0e165ded6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b0e165ded6");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.127-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
