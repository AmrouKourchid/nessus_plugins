...
# extracted from Fedora Security Advisory FEDORA-2019-d15aac6c4e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-d15aac6c4e");

  script_name(english:"Fedora 30 : 1:openssl (2019-d15aac6c4e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d15aac6c4e");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"openssl-1.1.1d-1.fc30", epoch:"1")) flag++;
