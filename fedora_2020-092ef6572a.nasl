...
# extracted from Fedora Security Advisory FEDORA-2020-092ef6572a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-092ef6572a");

  script_name(english:"Fedora 30 : glib2 (2020-092ef6572a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-092ef6572a");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"glib2-2.60.7-3.fc30")) flag++;
