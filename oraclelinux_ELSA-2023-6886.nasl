...
# extracted from Oracle Linux Security Advisory ELSA-2023-6886.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : plexus-archiver (ELSA-2023-6886)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2023-6886 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-6886.html");
...
var pkgs = [
    {'reference':'plexus-archiver-2.4.2-6.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'plexus-archiver-javadoc-2.4.2-6.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
