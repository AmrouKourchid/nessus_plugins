...
if (description)
{
  ...
  script_name(english:"SolarWinds Serv-U 15.3.1");
...
vulnerability as referenced in the serv-u_15_3_hf_1 advisory.

  - A researcher reported a Directory Transversal Vulnerability in Serv-U 15.3. This may allow access to files
    relating to the Serv-U installation and server files. This issue has been resolved in Serv-U 15.3 Hotfix
    1. (CVE-2021-35250)
...
var constraints = [
  { 'fixed_version' : '15.3.1', 'equal' : '15.3', 'fixed_display' : '15.3 HF1' }
];
