...
if (description)
{
  ...
  script_cve_id("CVE-2024-10394");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-10394");
...
patch available.
  ...
  - A local user can bypass the OpenAFS PAG (Process Authentication Group) throttling mechanism in Unix
    clients, allowing the user to create a PAG using an existing id number, effectively joining the PAG and
    letting the user steal the credentials in that PAG. (CVE-2024-10394)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-10394");
