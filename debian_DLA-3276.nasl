...
# extracted from Debian Security Advisory dla-3276. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3276 : lava - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3276
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'lava', 'reference': '2019.01-5+deb10u2'},
    {'release': '10.0', 'prefix': 'lava-common', 'reference': '2019.01-5+deb10u2'},
    {'release': '10.0', 'prefix': 'lava-dev', 'reference': '2019.01-5+deb10u2'},
    {'release': '10.0', 'prefix': 'lava-dispatcher', 'reference': '2019.01-5+deb10u2'},
    {'release': '10.0', 'prefix': 'lava-lxc-mocker', 'reference': '2019.01-5+deb10u2'},
    {'release': '10.0', 'prefix': 'lava-server', 'reference': '2019.01-5+deb10u2'},
    {'release': '10.0', 'prefix': 'lava-server-doc', 'reference': '2019.01-5+deb10u2'}
];
