...
# extracted from Fedora Security Advisory FEDORA-2024-c0e7a4f5ef
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c0e7a4f5ef");

  script_name(english:"Fedora 40 : less (2024-c0e7a4f5ef)");
...
FEDORA-2024-c0e7a4f5ef advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c0e7a4f5ef");
...
"Update the affected less package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:less");
...
var pkgs = [
    {'reference':'less-643-6.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
