...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Redis PHSA-2018-2.0-0070");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'redis-4.0.10-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'redis-debuginfo-4.0.10-1.ph2')) flag++;
