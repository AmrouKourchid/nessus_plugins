...
if (description)
{
  ...
  script_cve_id("CVE-2024-11596");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-11596");
...
patch available.
  ...
  - Buffer Over-read in Wireshark [fedora-40] (CVE-2024-11596)
