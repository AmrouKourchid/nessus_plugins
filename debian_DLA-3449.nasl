...
# extracted from Debian Security Advisory dla-3449. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3449 : libssl-dev - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libssl-dev', 'reference': '1.1.1n-0+deb10u5'},
    {'release': '10.0', 'prefix': 'libssl-doc', 'reference': '1.1.1n-0+deb10u5'},
    {'release': '10.0', 'prefix': 'libssl1.1', 'reference': '1.1.1n-0+deb10u5'},
    {'release': '10.0', 'prefix': 'openssl', 'reference': '1.1.1n-0+deb10u5'}
];
