...
# extracted from Ubuntu Security Notice USN-7154-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7154-2");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (HWE) vulnerabilities (USN-7154-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7154-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.8.0-50-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.8.0-50-generic-64k");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-7154-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-7154-2');
  }
  else
  {
