...
# extracted from Fedora Security Advisory FEDORA-2024-88ad2bee84
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-88ad2bee84");

  script_name(english:"Fedora 41 : sympa (2024-88ad2bee84)");
...
FEDORA-2024-88ad2bee84 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-88ad2bee84");
...
var pkgs = [
    {'reference':'sympa-6.2.74-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
