...
# extracted from Red Hat Security Advisory RHSA-2025:7049. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:7049");

  script_name(english:"RHEL 9 : python-requests (RHSA-2025:7049)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-requests.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7049.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4c59ebd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7049");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-requests package based on the guidance in RHSA-2025:7049.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:M/C:C/I:C/A:N");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-requests+security");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-requests+socks");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-requests+security-2.25.1-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-requests+socks-2.25.1-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-requests-2.25.1-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-requests / python3-requests+security / etc');
}
