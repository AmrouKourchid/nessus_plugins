...
# extracted from Fedora Security Advisory FEDORA-2020-eadda524a8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : phpMyAdmin (2020-eadda524a8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-eadda524a8");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"phpMyAdmin-5.0.3-1.fc31")) flag++;
