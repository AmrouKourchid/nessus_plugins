...
# extracted from Fedora Security Advisory FEDORA-2023-f66fc0f62a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f66fc0f62a");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Fedora 37 : nodejs20 (2023-f66fc0f62a)");
...
FEDORA-2023-f66fc0f62a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f66fc0f62a");
...
var pkgs = [
    {'reference':'nodejs20-20.8.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
