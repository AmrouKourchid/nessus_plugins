...
# extracted from Red Hat Security Advisory RHSA-2020:1787. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1787");

  script_name(english:"RHEL 8 : unzip (RHSA-2020:1787)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1787.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0221f53c");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd7b3f20");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1787");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1727761");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL unzip package based on the guidance in RHSA-2020:1787.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'unzip-6.0-43.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
