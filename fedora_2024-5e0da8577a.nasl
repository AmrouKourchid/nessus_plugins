...
# extracted from Fedora Security Advisory FEDORA-2024-5e0da8577a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5e0da8577a");

  script_name(english:"Fedora 41 : rapidjson (2024-5e0da8577a)");
...
FEDORA-2024-5e0da8577a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5e0da8577a");
...
var pkgs = [
    {'reference':'rapidjson-1.1.0-41.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
