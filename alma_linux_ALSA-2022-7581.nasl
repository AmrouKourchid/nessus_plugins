...
# AlmaLinux Security Advisory ALSA-2022:7581.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7581");

  script_name(english:"AlmaLinux 8 : python38:3.8 and python38-devel:3.8 (ALSA-2022:7581)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2022:7581 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-7581.html");
...
var appstreams = {
    'python38-devel:3.8': [
      {'reference':'python38-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-debug-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debug-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debug-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-debug-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-devel-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-idle-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-libs-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-libs-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-libs-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-libs-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-mod_wsgi-4.6.8-4.module_el8.7.0+3344+99a6a656', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-mod_wsgi-4.6.8-4.module_el8.7.0+3344+99a6a656', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-rpm-macros-3.8.13-1.module_el8.7.0+3344+99a6a656', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python38-test-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-test-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-test-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-test-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python38-tkinter-3.8.13-1.module_el8.7.0+3344+99a6a656', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
