...
# extracted from Fedora Security Advisory FEDORA-2022-b2f06fbb62
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-b2f06fbb62");

  script_name(english:"Fedora 37 : python3.10 (2022-b2f06fbb62)");
...
FEDORA-2022-b2f06fbb62 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-b2f06fbb62");
...
var pkgs = [
    {'reference':'python3.10-3.10.9-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
