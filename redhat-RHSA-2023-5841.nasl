...
# extracted from Red Hat Security Advisory RHSA-2023:5841. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5841");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");
  script_xref(name:"IAVB", value:"2023-B-0083-S");

  script_name(english:"RHEL 7 : httpd24-nghttp2 (RHSA-2023:5841)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for httpd24-nghttp2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:5841 advisory.

    httpd24-nghttp2 is a library implementing the Hypertext Transfer Protocol version 2 (HTTP/2) protocol in
    C.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5841.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?966ffe1f");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5841");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL httpd24-nghttp2 package based on the guidance in RHSA-2023:5841.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'httpd24-libnghttp2-1.7.1-11.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd24-libnghttp2-1.7.1-11.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd24-libnghttp2-1.7.1-11.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd24-libnghttp2-devel-1.7.1-11.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd24-libnghttp2-devel-1.7.1-11.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd24-libnghttp2-devel-1.7.1-11.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd24-nghttp2-1.7.1-11.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd24-nghttp2-1.7.1-11.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd24-nghttp2-1.7.1-11.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
