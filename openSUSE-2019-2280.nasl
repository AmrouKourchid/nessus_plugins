...
# extracted from openSUSE Security Update openSUSE-2019-2280.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libseccomp (openSUSE-2019-2280)");
...
if ( rpm_check(release:"SUSE15.0", reference:"libseccomp-debugsource-2.4.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libseccomp-devel-2.4.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libseccomp-tools-2.4.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libseccomp-tools-debuginfo-2.4.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libseccomp2-2.4.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libseccomp2-debuginfo-2.4.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libseccomp2-32bit-2.4.1-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libseccomp2-32bit-debuginfo-2.4.1-lp150.2.3.1") ) flag++;
