...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : libcroco (EulerOS-SA-2020-1909)");
...
affected by the following vulnerability :
  ...
  - libcroco through 0.6.13 has excessive recursion in
    cr_parser_parse_any_core in cr-parser.c, leading to
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1909
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bff09b52");
...
pkgs = ["libcroco-0.6.12-5.h3.eulerosv2r8"];
