...
# extracted from Red Hat Security Advisory RHSA-2015:1676. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:1676");

  script_name(english:"RHEL 7 : redis security advisory (Moderate) (RHSA-2015:1676)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1228327");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2015/rhsa-2015_1676.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?75ceea45");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1676");
...
"Update the affected redis package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-4335");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redis-2.8.21-1.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
