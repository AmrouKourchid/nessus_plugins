...
# extracted from Fedora Security Advisory FEDORA-2018-76c82b393e.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-15090", "CVE-2017-15120", "CVE-2018-1000003");
  script_xref(name:"FEDORA", value:"2018-76c82b393e");

  script_name(english:"Fedora 27 : pdns-recursor (2018-76c82b393e)");
...
"- Upstream released new version
  ...
  - Fix a bunch of CVE's

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-76c82b393e");
...
"Update the affected pdns-recursor package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-15090");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"pdns-recursor-4.1.3-2.fc27")) flag++;
