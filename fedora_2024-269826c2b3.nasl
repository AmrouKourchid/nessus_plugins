...
# extracted from Fedora Security Advisory FEDORA-2024-269826c2b3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-269826c2b3");

  script_name(english:"Fedora 39 : expat (2024-269826c2b3)");
...
FEDORA-2024-269826c2b3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-269826c2b3");
...
var pkgs = [
    {'reference':'expat-2.6.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
