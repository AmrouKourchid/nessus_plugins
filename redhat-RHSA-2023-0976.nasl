...
# extracted from Red Hat Security Advisory RHSA-2023:0976. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0976");

  script_name(english:"RHEL 7 : zlib (RHSA-2023:0976)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for zlib.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:0976 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0976.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8df4b22a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0976");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2067945");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL zlib package based on the guidance in RHSA-2023:0976.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'minizip-1.2.7-17.el7_4.1', 'sp':'4', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'minizip-1.2.7-17.el7_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'minizip-devel-1.2.7-17.el7_4.1', 'sp':'4', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'minizip-devel-1.2.7-17.el7_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-1.2.7-17.el7_4.1', 'sp':'4', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-1.2.7-17.el7_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-devel-1.2.7-17.el7_4.1', 'sp':'4', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-devel-1.2.7-17.el7_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-static-1.2.7-17.el7_4.1', 'sp':'4', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-static-1.2.7-17.el7_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
