...
# Oracle Linux Security Advisory ELSA-2018-2251 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : thunderbird (ELSA-2018-2251)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-2251.html");
...
var pkgs = [
    {'reference':'thunderbird-52.9.1-1.0.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-52.9.1-1.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
