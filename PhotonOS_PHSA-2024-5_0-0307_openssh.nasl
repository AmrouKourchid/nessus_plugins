...
# extracted from VMware Security Advisory PHSA-2024-5.0-0307. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Openssh PHSA-2024-5.0-0307");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openssh package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-307.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssh-9.3p2-9.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssh-clients-9.3p2-9.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssh-server-9.3p2-9.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'openssh-socket-9.3p2-9.ph5')) flag++;
