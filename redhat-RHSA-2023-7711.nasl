...
# extracted from Red Hat Security Advisory RHSA-2023:7711. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7711");

  script_name(english:"RHEL 9 : apr (RHSA-2023:7711)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7711.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?857b7b36");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2169465");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7711");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL apr package based on the guidance in RHSA-2023:7711.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'apr-1.7.0-12.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'apr-devel-1.7.0-12.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
