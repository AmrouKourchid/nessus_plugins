...
if (description)
{
  ...
  script_cve_id("CVE-2024-46812");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46812");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Skip inactive planes
    within ModeSupportAndSystemConfiguration [Why] Coverity reports Memory - illegal accesses. [How] Skip
    inactive planes. (CVE-2024-46812)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46812");
