...
# extracted from Fedora Security Advisory FEDORA-2023-79e2b35ba6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-79e2b35ba6");

  script_name(english:"Fedora 37 : yt-dlp (2023-79e2b35ba6)");
...
FEDORA-2023-79e2b35ba6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-79e2b35ba6");
...
var pkgs = [
    {'reference':'yt-dlp-2023.07.06-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
