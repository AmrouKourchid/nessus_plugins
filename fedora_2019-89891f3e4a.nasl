...
# extracted from Fedora Security Advisory FEDORA-2019-89891f3e4a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : mbedtls (2019-89891f3e4a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-89891f3e4a");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"mbedtls-2.16.3-1.fc29")) flag++;
