...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : gssproxy (EulerOS-SA-2021-1145)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1145
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?869f932f");
...
pkgs = ["gssproxy-0.8.0-6.h1.eulerosv2r8"];
