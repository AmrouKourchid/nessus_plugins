...
if (description)
{
  ...
  script_cve_id("CVE-2023-32342");
  script_xref(name:"IAVB", value:"2023-B-0085-S");

  script_name(english:"IBM HTTP Server 8.5.0.0 < 8.5.5.24 / 9.0.0.0 < 9.0.5.16 Information Disclosure (6998037)");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server is affected by a information disclosure vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of IBM HTTP Server running on the remote host is affected by an information disclosure vulnerability due to
IBM GSKit which is used for SSL connections. An unauthenticated, remote attacker could exploit a timing-based side 
channel in the RSA Decryption implementation, by sending an overly large number of trial messages for decryption, to
obtain sensitive information.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6998037");
...
"Upgrade to IBM HTTP Server version 8.5.5.24, 9.0.5.16, or later. Alternatively, upgrade to the minimal fix pack levels
 required by the interim fix and then apply Interim Fix PH52546.");
  script_set_attribute(attribute:"agent", value:"unix");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-32342");
...
var fix = 'Interim Fix PH52546';

var app_info = vcf::get_app_info(app:app);
vcf::check_granularity(app_info:app_info, sig_segments:4);

if ('PH52546' >< app_info['Fixes'])
