...
# extracted from Fedora Security Advisory FEDORA-2020-0e036c907e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : tcpreplay (2020-0e036c907e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-0e036c907e");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"tcpreplay-4.3.3-3.fc32")) flag++;
