...
# SUSE update advisory SUSE-SU-2022:0502-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:0502-1");
  script_xref(name:"IAVA", value:"2022-A-0092");

  script_name(english:"SUSE SLES15 Security Update : ucode-intel (SUSE-SU-2022:0502-1)");
...
referenced in the SUSE-SU-2022:0502-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-February/010264.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6a2cd1d6");
...
var pkgs = [
    {'reference':'ucode-intel-20220207-3.70.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15']},
    {'reference':'ucode-intel-20220207-3.70.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-ESPOS-release-15', 'SLE_HPC-LTSS-release-15']},
    {'reference':'ucode-intel-20220207-3.70.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-ESPOS-release-15', 'SLE_HPC-LTSS-release-15']}
];
