...
# extracted from Fedora Security Advisory FEDORA-2024-9fc8015fa9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9fc8015fa9");

  script_name(english:"Fedora 40 : freeipa (2024-9fc8015fa9)");
...
FEDORA-2024-9fc8015fa9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9fc8015fa9");
...
var pkgs = [
    {'reference':'freeipa-4.11.1-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
