...
# extracted from Fedora Security Advisory FEDORA-2023-9c901b8c2d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9c901b8c2d");

  script_name(english:"Fedora 38 : dotnet6.0 (2023-9c901b8c2d)");
...
FEDORA-2023-9c901b8c2d advisory.

    This is the November 2023 update for .NET 6. It includes fixes for multiple CVEs.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9c901b8c2d");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.125-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
