...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : python3 (EulerOS-SA-2022-2119)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2119
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f81a673");
...
var pkgs = [
  "python3-3.7.9-9.h21.eulerosv2r10",
  "python3-devel-3.7.9-9.h21.eulerosv2r10",
  "python3-help-3.7.9-9.h21.eulerosv2r10",
  "python3-unversioned-command-3.7.9-9.h21.eulerosv2r10"
];
