...
# extracted from Red Hat Security Advisory RHSA-2025:1350. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1350");

  script_name(english:"RHEL 9 : libxml2 (RHSA-2025:1350)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1350.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5be2a4de");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1350");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libxml2 package based on the guidance in RHSA-2025:1350.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxml2-2.9.13-6.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.9.13-6.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libxml2-2.9.13-6.el9_5.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
