...
# extracted from Fedora Security Advisory FEDORA-2021-7c71cda8da
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-7c71cda8da");

  script_name(english:"Fedora 33 : mingw-glib2 (2021-7c71cda8da)");
...
FEDORA-2021-7c71cda8da advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-7c71cda8da");
...
pkgs = [
    {'reference':'mingw-glib2-2.66.7-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
