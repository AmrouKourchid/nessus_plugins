...
if (description)
{
  ...
  script_cve_id("CVE-2013-5661");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-5661");
...
patch available.
  ...
  - Cache Poisoning issue exists in DNS Response Rate Limiting. (CVE-2013-5661)
