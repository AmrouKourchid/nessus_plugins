...
# extracted from Fedora Security Advisory FEDORA-2023-45cf2b4014
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-45cf2b4014");
  script_xref(name:"IAVA", value:"2023-A-0650-S");

  script_name(english:"Fedora 39 : vim (2023-45cf2b4014)");
...
FEDORA-2023-45cf2b4014 advisory.

    The newest upstream commit

    Security fixes for CVE-2023-48233, CVE-2023-48231, CVE-2023-48232, CVE-2023-48234, CVE-2023-48235,
    CVE-2023-48236, CVE-2023-48237.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-45cf2b4014");
...
var pkgs = [
    {'reference':'vim-9.0.2120-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
