...
# extracted from Ubuntu Security Notice USN-2809-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 15.10 : lxd vulnerability (USN-2809-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security-related patch.");
  script_set_attribute(attribute:"description", value:
"Jeroen Simonetti discovered that LXD incorrectly set socket
permissions. A local attacker could use this issue to escalate
privileges.
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/2809-1/");
...
if (ubuntu_check(osver:"15.10", pkgname:"lxd", pkgver:"0.20-0ubuntu4.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "lxd");
}
