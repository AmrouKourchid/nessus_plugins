...
# extracted from Red Hat Security Advisory RHSA-2024:7135. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7135");

  script_name(english:"RHEL 8 : git-lfs (RHSA-2024:7135)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7135.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fbfa8371");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7135");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL git-lfs package based on the guidance in RHSA-2024:7135.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-lfs-3.4.1-3.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
