...
if (description)
{
  ...
  script_cve_id("CVE-2024-29133");
  script_xref(name:"IAVA", value:"2024-A-0366");

  script_name(english:"Atlassian Confluence 1.0.1 < 7.19.23 / 7.20.x < 8.5.9 / 8.6.x < 8.9.1 (CONFSERVER-95975)");
...
the CONFSERVER-95975 advisory.
  ...
  - Out-of-bounds Write vulnerability in Apache Commons Configuration.This issue affects Apache Commons
    ...
    issue. (CVE-2024-29133)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://jira.atlassian.com/browse/CONFSERVER-95975");
