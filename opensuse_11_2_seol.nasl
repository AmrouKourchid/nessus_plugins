...
if (description)
{
  ...
  script_name(english:"openSUSE SEoL (11.2.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of openSUSE is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, openSUSE is 11.2.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of openSUSE that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2011/05/12");
...
var constraints = [
  { max_branch : '11.2', min_branch : '11.2', seol : 20110512 }
];
