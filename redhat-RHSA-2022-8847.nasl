...
# extracted from Red Hat Security Advisory RHSA-2022:8847. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8847");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2.4 (protobuf) (RHSA-2022:8847)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.2.4 (protobuf).");
...
the RHSA-2022:8847 advisory.
    ...
    breaking deployed programs that are compiled against the old format. This package contains Protocol
    Buffers compiler for all programming
    languages and C++ headers and Static libraries for Protocol Buffers built with optimize_for =
    LITE_RUNTIME.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8847.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d9f91dcd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8847");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2049429");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2.4 (protobuf) package based on the guidance in RHSA-2022:8847.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-protobuf-3.6.1-6.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-protobuf');
}
