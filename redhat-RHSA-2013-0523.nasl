...
"The remote Red Hat host is missing a security update for ccid.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2013/rhsa-2013_0523.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c37024f6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0523");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=664986");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ccid package based on the guidance in RHSA-2013:0523.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ccid-1.3.9-6.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ccid-1.3.9-6.el6', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ccid-1.3.9-6.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
