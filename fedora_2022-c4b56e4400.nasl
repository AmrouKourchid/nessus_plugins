...
# extracted from Fedora Security Advisory FEDORA-2022-c4b56e4400
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c4b56e4400");

  script_name(english:"Fedora 37 : mujs (2022-c4b56e4400)");
...
FEDORA-2022-c4b56e4400 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c4b56e4400");
...
var pkgs = [
    {'reference':'mujs-1.3.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
