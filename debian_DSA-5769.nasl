...
# extracted from Debian Security Advisory dsa-5769. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5769 : git - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-32020");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/git");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'git', 'reference': '1:2.39.5-0+deb12u1'},
    {'release': '12.0', 'prefix': 'git-all', 'reference': '1:2.39.5-0+deb12u1'},
    {'release': '12.0', 'prefix': 'git-cvs', 'reference': '1:2.39.5-0+deb12u1'},
    {'release': '12.0', 'prefix': 'git-daemon-run', 'reference': '1:2.39.5-0+deb12u1'},
    {'release': '12.0', 'prefix': 'git-daemon-sysvinit', 'reference': '1:2.39.5-0+deb12u1'},
    {'release': '12.0', 'prefix': 'git-doc', 'reference': '1:2.39.5-0+deb12u1'},
    {'release': '12.0', 'prefix': 'git-email', 'reference': '1:2.39.5-0+deb12u1'},
    {'release': '12.0', 'prefix': 'git-gui', 'reference': '1:2.39.5-0+deb12u1'},
    {'release': '12.0', 'prefix': 'git-man', 'reference': '1:2.39.5-0+deb12u1'},
    {'release': '12.0', 'prefix': 'git-mediawiki', 'reference': '1:2.39.5-0+deb12u1'},
    {'release': '12.0', 'prefix': 'git-svn', 'reference': '1:2.39.5-0+deb12u1'},
    {'release': '12.0', 'prefix': 'gitk', 'reference': '1:2.39.5-0+deb12u1'},
    {'release': '12.0', 'prefix': 'gitweb', 'reference': '1:2.39.5-0+deb12u1'}
];
