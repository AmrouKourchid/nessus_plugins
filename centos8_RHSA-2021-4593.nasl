...
# Red Hat Security Advisory RHSA-2021:4593. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : annobin (CESA-2021:4593)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2021:4593 advisory.
...
"Update the affected annobin and / or annobin-annocheck packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:annobin");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:annobin-annocheck");
