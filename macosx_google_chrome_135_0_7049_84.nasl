...
"The version of Google Chrome installed on the remote macOS host is prior to 135.0.7049.84. It is, therefore, affected by
a vulnerability as referenced in the 2025_04_stable-channel-update-for-desktop_8 advisory.
...
google_chrome_check_version(fix:'135.0.7049.84', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
