...
# Rocky Linux Security Advisory RLSA-2021:3027.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2021:3027");

  script_name(english:"Rocky Linux 8 : microcode_ctl (RLSA-2021:3027)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2021:3027");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1972325");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1972328");
