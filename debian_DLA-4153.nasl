...
# extracted from Debian Security Advisory dla-4153. The text
...
if (description)
{
  script_id(235113);
  script_version("1.1");
  script_set_attribute(attribute:"plugin_modification_date", value:"2025/05/04");

  script_cve_id("CVE-2024-40635");
  script_xref(name:"IAVA", value:"2025-A-0300");

  script_name(english:"Debian dla-4153 : containerd - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4153
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-40635");
...
"Upgrade the containerd packages.");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2025/05/04");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'containerd', 'reference': '1.4.13~ds1-1~deb11u5'},
    {'release': '11.0', 'prefix': 'golang-github-containerd-containerd-dev', 'reference': '1.4.13~ds1-1~deb11u5'}
];
