...
referenced in the RHSA-2019:2399 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2399.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e180c5b1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2399");
...
"Update the RHEL libssh2 package based on the guidance in RHSA-2019:2399.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libssh2-1.4.3-11.el7_3.1', 'sp':'3', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_3.1', 'sp':'3', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-1.4.3-11.el7_3.1', 'sp':'3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_3.1', 'sp':'3', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_3.1', 'sp':'3', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-devel-1.4.3-11.el7_3.1', 'sp':'3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh2-docs-1.4.3-11.el7_3.1', 'sp':'3', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
