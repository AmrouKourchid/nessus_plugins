...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : ImageMagick (EulerOS-SA-2019-1114)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1114
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d598b7e0");
...
pkgs = ["ImageMagick-6.7.8.9-15.h18",
        "ImageMagick-c++-6.7.8.9-15.h18",
        "ImageMagick-perl-6.7.8.9-15.h18"];
