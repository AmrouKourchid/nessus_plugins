...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Unbound PHSA-2024-5.0-0389");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'unbound-1.21.0-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'unbound-devel-1.21.0-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'unbound-docs-1.21.0-2.ph5')) flag++;
