...
# extracted from Gentoo Linux Security Advisory GLSA 202310-18.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202310-18 : Rack: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202310-18 (Rack: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202310-18");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=884795");
...
var packages = [
  {
    'name' : 'dev-ruby/rack',
    'unaffected' : make_list("ge 2.2.3.1"),
    'vulnerable' : make_list("lt 2.2.3.1")
  }
];
