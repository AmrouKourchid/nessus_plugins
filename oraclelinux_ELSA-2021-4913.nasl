...
# extracted from Oracle Linux Security Advisory ELSA-2021-4913.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : mailman (ELSA-2021-4913)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-4913.html");
...
var pkgs = [
    {'reference':'mailman-2.1.15-30.el7_9.2', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
