...
if (description)
{
  ...
  script_cve_id("CVE-2025-21366", "CVE-2025-21186", "CVE-2025-21395");

  script_name(english:"Security Updates for Microsoft Access Products C2R (January 2025)");
...
"The Microsoft Access Products are missing a security update. It is, therefore, affected by the following vulnerabilities:
  ...
  - Microsoft Office is affected by a remote code execution vulnerability. (CVE-2025-21366, CVE-2025-21186, CVE-2025-21395)
