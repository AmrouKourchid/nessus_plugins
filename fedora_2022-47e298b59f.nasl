...
# extracted from Fedora Security Advisory FEDORA-2022-47e298b59f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-47e298b59f");

  script_name(english:"Fedora 37 : admesh (2022-47e298b59f)");
...
FEDORA-2022-47e298b59f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-47e298b59f");
...
var pkgs = [
    {'reference':'admesh-0.98.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
