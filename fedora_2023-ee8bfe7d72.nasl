...
# extracted from Fedora Security Advisory FEDORA-2023-ee8bfe7d72
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ee8bfe7d72");

  script_name(english:"Fedora 37 : firefox (2023-ee8bfe7d72)");
...
FEDORA-2023-ee8bfe7d72 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ee8bfe7d72");
...
var pkgs = [
    {'reference':'firefox-109.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
