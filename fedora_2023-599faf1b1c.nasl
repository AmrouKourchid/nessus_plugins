...
# extracted from Fedora Security Advisory FEDORA-2023-599faf1b1c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-599faf1b1c");

  script_name(english:"Fedora 38 : netatalk (2023-599faf1b1c)");
...
FEDORA-2023-599faf1b1c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-599faf1b1c");
  script_set_attribute(attribute:"solution", value:
"Update the affected 5:netatalk package.");
...
var pkgs = [
    {'reference':'netatalk-3.1.14-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
