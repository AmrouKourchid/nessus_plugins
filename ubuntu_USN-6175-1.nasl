...
# extracted from Ubuntu Security Notice USN-6175-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6175-1");

  script_name(english:"Ubuntu 23.04 : Linux kernel vulnerabilities (USN-6175-1)");
...
USN-6175-1 advisory.
    ...
    It was discovered that the io_uring subsystem in the Linux kernel did not properly perform file table
    updates in some situations, leading to a null pointer dereference vulnerability. A local attacker could
    use this to cause a denial of service (system crash). (CVE-2023-1583)
    ...
    It was discovered that a race condition existed in the Bluetooth HCI SDIO driver, leading to a use-after-
    free vulnerability. A local attacker could use this to cause a denial of service (system crash).
    (CVE-2023-1989)
    ...
    It was discovered that the Bluetooth subsystem in the Linux kernel did not properly initialize some data
    structures, leading to an out-of-bounds access vulnerability in certain situations. An attacker could use
    this to expose sensitive information (kernel memory). (CVE-2023-28866)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6175-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1005-aws");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1005-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1005-lowlatency-64k");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1006-raspi");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-1006-raspi-nolpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-23-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-23-generic-64k");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.2.0-23-generic-lpae");
...
var kernel_mappings = {
  '23.04': {
    '6.2.0': {
      'generic': '6.2.0-23',
      'generic-64k': '6.2.0-23',
      'generic-lpae': '6.2.0-23',
      'aws': '6.2.0-1005',
      'lowlatency': '6.2.0-1005',
      'lowlatency-64k': '6.2.0-1005',
      'raspi': '6.2.0-1006',
      'raspi-nolpae': '6.2.0-1006'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6175-1');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6175-1');
  }
  else
  {
