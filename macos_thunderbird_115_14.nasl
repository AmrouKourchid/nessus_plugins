...
# extracted from Mozilla Foundation Security Advisory mfsa2024-38.
...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 115.14");

  script_set_attribute(attribute:"synopsis", value:
"A mail client installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 115.14. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2024-38 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2024-38/");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'115.14', severity:SECURITY_HOLE);
