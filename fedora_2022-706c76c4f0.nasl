...
# extracted from Fedora Security Advisory FEDORA-2022-706c76c4f0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-706c76c4f0");

  script_name(english:"Fedora 36 : woff (2022-706c76c4f0)");
...
FEDORA-2022-706c76c4f0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-706c76c4f0");
...
var pkgs = [
    {'reference':'woff-0.20091126-34.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
