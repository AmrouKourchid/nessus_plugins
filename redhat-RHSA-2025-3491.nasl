...
# extracted from Red Hat Security Advisory RHSA-2025:3491. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-56201", "CVE-2025-27407", "CVE-2025-27610");
  script_xref(name:"RHSA", value:"2025:3491");
  script_xref(name:"IAVB", value:"2025-B-0065");

  script_name(english:"RHEL 8 : Satellite 6.15.5.2 Async Update (Important) (RHSA-2025:3491)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:3491 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3491.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3dbc61a5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3491");
  script_set_attribute(attribute:"solution", value:
"Update the affected python3.11-jinja2, rubygem-graphql and / or rubygem-rack packages.");
  ...
  script_set_attribute(attribute:"cvss4_score_source", value:"CVE-2024-56201");

  script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"false");
  script_cwe_id(23, 94, 150);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-jinja2-3.1.5-1.el8pc', 'release':'8', 'el_string':'el8pc', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'satellite-6', 'cves':['CVE-2024-56201']},
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3.11-jinja2 / rubygem-graphql / rubygem-rack');
}
