...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : NLTK vulnerability (USN-4106-1)");
...
in the USN-4106-1 advisory.

    Mike Salvatore discovered that NLTK mishandled crafted ZIP archives during extraction. A remote attacker
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4106-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-nltk', 'pkgver': '3.1-1ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'python3-nltk', 'pkgver': '3.1-1ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'python-nltk', 'pkgver': '3.2.5-1ubuntu0.1'},
    {'osver': '18.04', 'pkgname': 'python3-nltk', 'pkgver': '3.2.5-1ubuntu0.1'}
];
