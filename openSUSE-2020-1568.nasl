...
# extracted from openSUSE Security Update openSUSE-2020-1568.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libqt5-qtbase (openSUSE-2020-1568)");
...
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Bootstrap-devel-static-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Concurrent-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Concurrent5-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Concurrent5-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Core-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Core-private-headers-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Core5-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Core5-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5DBus-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5DBus-devel-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5DBus-private-headers-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5DBus5-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5DBus5-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Gui-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Gui-private-headers-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Gui5-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Gui5-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5KmsSupport-devel-static-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5KmsSupport-private-headers-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Network-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Network-private-headers-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Network5-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Network5-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5OpenGL-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5OpenGL-private-headers-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5OpenGL5-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5OpenGL5-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5OpenGLExtensions-devel-static-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5PlatformHeaders-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5PlatformSupport-devel-static-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5PlatformSupport-private-headers-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5PrintSupport-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5PrintSupport-private-headers-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5PrintSupport5-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5PrintSupport5-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Sql-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Sql-private-headers-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Sql5-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Sql5-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Sql5-mysql-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Sql5-mysql-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Sql5-postgresql-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Sql5-postgresql-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Sql5-sqlite-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Sql5-sqlite-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Sql5-unixODBC-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Sql5-unixODBC-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Test-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Test-private-headers-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Test5-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Test5-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Widgets-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Widgets-private-headers-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Widgets5-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Widgets5-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Xml-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Xml5-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libQt5Xml5-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libqt5-qtbase-common-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libqt5-qtbase-common-devel-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libqt5-qtbase-debugsource-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libqt5-qtbase-devel-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libqt5-qtbase-examples-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libqt5-qtbase-examples-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libqt5-qtbase-platformtheme-gtk3-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libqt5-qtbase-platformtheme-gtk3-debuginfo-5.9.7-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libqt5-qtbase-private-headers-devel-5.9.7-lp151.4.6.1") ) flag++;
