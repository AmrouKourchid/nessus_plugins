...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Rsync PHSA-2018-2.0-0009");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rsync-3.1.2-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rsync-debuginfo-3.1.2-5.ph2')) flag++;
