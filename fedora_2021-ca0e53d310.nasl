...
# extracted from Fedora Security Advisory FEDORA-2021-ca0e53d310
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : php (2021-ca0e53d310)");
...
FEDORA-2021-ca0e53d310 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-ca0e53d310");
...
pkgs = [
    {'reference':'php-7.4.14-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
