...
# extracted from Red Hat Security Advisory RHSA-2023:3095. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3095");

  script_name(english:"RHEL 8 : libreswan (RHSA-2023:3095)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libreswan.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3095.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85622724");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2173610");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2187647");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3095");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libreswan package based on the guidance in RHSA-2023:3095.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.9-2.el8_8.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libreswan-4.9-2.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
