...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-1795.html");
...
"Update the affected cups-filters, cups-filters-devel and / or cups-filters-libs packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-4338");
...
var pkgs = [
    {'reference':'cups-filters-devel-1.0.35-15.el7_0.1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-libs-1.0.35-15.el7_0.1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-1.0.35-15.el7_0.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-devel-1.0.35-15.el7_0.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cups-filters-libs-1.0.35-15.el7_0.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
