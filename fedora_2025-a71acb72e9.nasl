...
# extracted from Fedora Security Advisory FEDORA-2025-a71acb72e9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-a71acb72e9");
  script_xref(name:"IAVA", value:"2025-A-0128-S");

  script_name(english:"Fedora 41 : vim (2025-a71acb72e9)");
...
FEDORA-2025-a71acb72e9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-a71acb72e9");
...
"Update the affected 2:vim package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-26603");
...
var pkgs = [
    {'reference':'vim-9.1.1122-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
