...
# extracted from VMware Security Advisory PHSA-2024-5.0-0289. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Cups PHSA-2024-5.0-0289");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the cups package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-289.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'cups-2.4.7-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'cups-devel-2.4.7-3.ph5')) flag++;
