...
# extracted from Red Hat Security Advisory RHSA-2020:1962 and 
# CentOS Errata and Security Advisory 2020:1962 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : python-twisted-web (RHSA-2020:1962)");
...
var pkgs = [
    {'reference':'python-twisted-web-8.2.0-6.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE}
];
