...
# extracted from Debian Security Advisory dsa-5543. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5543-1 : open-vm-tools - security update");
...
dsa-5543 advisory.
    ...
    escalation. For the oldstable distribution (bullseye), these problems have been fixed in version
    2:11.2.5-2+deb11u3. For the stable distribution (bookworm), these problems have been fixed in version
    2:12.2.0-1+deb12u2. We recommend that you upgrade your open-vm-tools packages. For the detailed security
    status of open-vm-tools please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/open-vm-tools
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5543");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-34058");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-34059");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'open-vm-tools', 'reference': '2:11.2.5-2+deb11u3'},
    {'release': '11.0', 'prefix': 'open-vm-tools-desktop', 'reference': '2:11.2.5-2+deb11u3'},
    {'release': '11.0', 'prefix': 'open-vm-tools-dev', 'reference': '2:11.2.5-2+deb11u3'},
    {'release': '11.0', 'prefix': 'open-vm-tools-sdmp', 'reference': '2:11.2.5-2+deb11u3'},
    {'release': '12.0', 'prefix': 'open-vm-tools', 'reference': '2:12.2.0-1+deb12u2'},
    {'release': '12.0', 'prefix': 'open-vm-tools-containerinfo', 'reference': '2:12.2.0-1+deb12u2'},
    {'release': '12.0', 'prefix': 'open-vm-tools-desktop', 'reference': '2:12.2.0-1+deb12u2'},
    {'release': '12.0', 'prefix': 'open-vm-tools-dev', 'reference': '2:12.2.0-1+deb12u2'},
    {'release': '12.0', 'prefix': 'open-vm-tools-salt-minion', 'reference': '2:12.2.0-1+deb12u2'},
    {'release': '12.0', 'prefix': 'open-vm-tools-sdmp', 'reference': '2:12.2.0-1+deb12u2'}
];
