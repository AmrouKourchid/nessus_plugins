...
# extracted from Fedora Security Advisory FEDORA-2024-18d9a6ba14
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-18d9a6ba14");

  script_name(english:"Fedora 39 : osc (2024-18d9a6ba14)");
...
FEDORA-2024-18d9a6ba14 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-18d9a6ba14");
...
var pkgs = [
    {'reference':'osc-1.9.1-420.1.1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
