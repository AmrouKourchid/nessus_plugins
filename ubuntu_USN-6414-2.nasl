...
# extracted from Ubuntu Security Notice USN-6414-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6414-2");

  script_name(english:"Ubuntu 18.04 ESM : Django vulnerabilities (USN-6414-2)");
...
the USN-6414-2 advisory.

    USN-6414-1 and USN-6378-1 fixed CVE-2023-43665 and CVE-2023-41164 in Django, respectively. This update
    provides the corresponding update for Ubuntu 18.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6414-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'python-django', 'pkgver': '1:1.11.11-1ubuntu1.21+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python-django-common', 'pkgver': '1:1.11.11-1ubuntu1.21+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3-django', 'pkgver': '1:1.11.11-1ubuntu1.21+esm2', 'ubuntu_pro': TRUE}
];
