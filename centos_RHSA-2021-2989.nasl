...
# extracted from Red Hat Security Advisory RHSA-2021:2989.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : lasso (RHSA-2021:2989)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2021:2989 advisory.
...
"Update the affected lasso, lasso-devel and / or lasso-python packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:lasso-python");
...
var pkgs = [
    {'reference':'lasso-2.5.1-8.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lasso-2.5.1-8.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lasso-devel-2.5.1-8.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lasso-devel-2.5.1-8.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lasso-python-2.5.1-8.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lasso-python-2.5.1-8.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
