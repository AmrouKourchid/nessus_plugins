...
if (description)
{
  ...
  script_name(english:"Google Chrome < 120.0.6099.110 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 120.0.6099.110. It is, therefore, affected
...
"Upgrade to Google Chrome version 120.0.6099.110 or later.");
...
google_chrome_check_version(installs:installs, fix:'120.0.6099.110', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
