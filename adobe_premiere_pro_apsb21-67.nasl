...
if (description)
{
  ...
  script_name(english:"Adobe Premiere Pro < 15.4.1 Arbitrary Code Execution (APSB21-67)");
...
"The version of Adobe Premiere Pro installed on the remote Windows host is prior to 15.4.1. It is, therefore, affected by
a vulnerability as referenced in the APSB21-67 advisory.
