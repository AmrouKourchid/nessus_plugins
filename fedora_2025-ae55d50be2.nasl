...
# extracted from Fedora Security Advisory FEDORA-2025-ae55d50be2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-ae55d50be2");

  script_name(english:"Fedora 41 : OpenIPMI (2025-ae55d50be2)");
...
FEDORA-2025-ae55d50be2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-ae55d50be2");
  script_set_attribute(attribute:"solution", value:
"Update the affected OpenIPMI package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:OpenIPMI");
...
var pkgs = [
    {'reference':'OpenIPMI-2.0.36-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
