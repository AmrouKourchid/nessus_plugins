...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : zlib (EulerOS-SA-2022-2543)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2543
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3f0f61a7");
...
var pkgs = [
  "zlib-1.2.7-17.h2.eulerosv2r7",
  "zlib-devel-1.2.7-17.h2.eulerosv2r7"
];
