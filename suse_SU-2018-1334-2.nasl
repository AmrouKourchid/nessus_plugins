...
# extracted from SUSE update advisory SUSE-SU-2018:1334-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : MozillaFirefox (SUSE-SU-2018:1334-2)");
...
MFSA 2018-12/CVE-2018-5159: Integer overflow and out-of-bounds write
in Skia

MFSA 2018-12/CVE-2018-5158: Malicious PDF can inject JavaScript into
PDF Viewer

MFSA 2018-12/CVE-2018-5168: Lightweight themes can be installed
without user interaction

MFSA 2018-12/CVE-2018-5150: Memory safety bugs fixed in Firefox 60 and
Firefox ESR 52.8

MFSA 2018-12/CVE-2018-5155: Use-after-free with SVG animations and
text paths
...
MFSA 2018-12/CVE-2018-5154: Use-after-free with SVG animations and
clip paths
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20181334-2/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?53325e74");
...
SUSE-SLE-SERVER-12-SP2-BCL-2018-943=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"MozillaFirefox-52.8.0esr-109.31.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"MozillaFirefox-debuginfo-52.8.0esr-109.31.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"MozillaFirefox-debugsource-52.8.0esr-109.31.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"MozillaFirefox-devel-52.8.0esr-109.31.2")) flag++;
