...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-0594.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected graphite2 and / or graphite2-devel packages.");
...
var pkgs = [
    {'reference':'graphite2-1.3.6-1.el7_2', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'graphite2-devel-1.3.6-1.el7_2', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'graphite2-1.3.6-1.el7_2', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'graphite2-devel-1.3.6-1.el7_2', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'graphite2-1.3.6-1.el7_2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'graphite2-devel-1.3.6-1.el7_2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
