...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : binutils (EulerOS-SA-2021-1919)");
...
vulnerability :
  ...
  - Binutils is a collection of binary utilities, including
    ...
    addresses to file and line).Security Fix(es):Load value
    injection in some Intel(R) Processors utilizing
    speculative execution may allow an authenticated user
    to potentially enable information disclosure via a side
    channel with local access.(CVE-2020-0551)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1919
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c910ddbb");
...
"Update the affected binutils package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-0551");
...
pkgs = ["binutils-2.34-1.h16.eulerosv2r9"];
