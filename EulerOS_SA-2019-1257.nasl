...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : glibc (EulerOS-SA-2019-1257)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1257
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0027ab94");
...
pkgs = ["glibc-2.17-196.h32",
        "glibc-common-2.17-196.h32",
        "glibc-devel-2.17-196.h32",
        "glibc-headers-2.17-196.h32",
        "nscd-2.17-196.h32"];
