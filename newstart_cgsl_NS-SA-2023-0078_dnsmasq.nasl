...
# extracted from ZTE advisory NS-SA-2023-0078. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : dnsmasq Multiple Vulnerabilities (NS-SA-2023-0078)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.06, has dnsmasq packages installed that are affected by multiple
vulnerabilities:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0078");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2020-25681");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2020-25682");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2020-25683");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2020-25687");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2021-3448");
...
var pkgs = {
  'CGSL MAIN 6.06': [
    'dnsmasq-2.79-21.0.2.zncgsl6_6.1',
    'dnsmasq-utils-2.79-21.0.2.zncgsl6_6.1'
  ]
};
