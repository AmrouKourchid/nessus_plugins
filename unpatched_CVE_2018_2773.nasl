...
if (description)
{
  ...
  script_cve_id("CVE-2018-2773");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-2773");
...
patch available.
  ...
  - Vulnerability in the MySQL Server component of Oracle MySQL (subcomponent: Client programs). Supported
    ...
    ability to cause a hang or frequently repeatable crash (complete DOS) of MySQL Server. (CVE-2018-2773)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-2773");
