...
# extracted from Red Hat Security Advisory RHSA-2025:4043. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-27349", "CVE-2023-51589");
  script_xref(name:"RHSA", value:"2025:4043");

  script_name(english:"RHEL 8 : bluez (RHSA-2025:4043)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for bluez.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:4043 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4043.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?705abd11");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4043");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bluez package based on the guidance in RHSA-2025:4043.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bluez-5.63-5.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-cups-5.63-5.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-hid2hci-5.63-5.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-libs-5.63-5.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-libs-devel-5.63-5.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-obexd-5.63-5.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bluez / bluez-cups / bluez-hid2hci / bluez-libs / bluez-libs-devel / etc');
}
