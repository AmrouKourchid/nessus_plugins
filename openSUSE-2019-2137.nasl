...
# extracted from openSUSE Security Update openSUSE-2019-2137.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : buildah (openSUSE-2019-2137)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1144065");
...
if ( rpm_check(release:"SUSE15.1", reference:"buildah-1.7.1-lp151.2.3.1") ) flag++;
