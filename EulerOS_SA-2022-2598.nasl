...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : zlib (EulerOS-SA-2022-2598)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2598
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?214f6876");
...
var pkgs = [
  "zlib-1.2.11-14.h2.eulerosv2r8",
  "zlib-devel-1.2.11-14.h2.eulerosv2r8"
];
