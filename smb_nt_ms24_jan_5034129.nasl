...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5034129");
  script_xref(name:"MSFT", value:"MS24-5034129");
  script_xref(name:"IAVA", value:"2024-A-0015-S");
  script_xref(name:"IAVA", value:"2024-A-0016-S");

  script_name(english:"KB5034129: Windows Server 2022 / Azure Stack HCI 22H2 Security Update (January 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034129");
