...
# SUSE update advisory SUSE-SU-2022:3382-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3382-1");

  script_name(english:"SUSE SLES12 Security Update : permissions (SUSE-SU-2022:3382-1)");
...
in the SUSE-SU-2022:3382-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1191194");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-September/012372.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f5c6f63");
...
var pkgs = [
    {'reference':'permissions-20170707-6.10.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'permissions-20170707-6.10.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
