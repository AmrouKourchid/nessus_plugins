...
# extracted from Fedora Security Advisory FEDORA-2023-222495c87a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-222495c87a");

  script_name(english:"Fedora 37 : thunderbird (2023-222495c87a)");
...
FEDORA-2023-222495c87a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-222495c87a");
...
var pkgs = [
    {'reference':'thunderbird-102.9.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
