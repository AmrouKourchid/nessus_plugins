...
# extracted from openSUSE Security Update openSUSE-2020-1278.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gettext-runtime (openSUSE-2020-1278)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1106843");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1113719");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=941629");
  script_set_attribute(attribute:"solution", value:
"Update the affected gettext-runtime packages.");
...
if ( rpm_check(release:"SUSE15.2", reference:"gettext-runtime-0.19.8.1-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"gettext-runtime-debuginfo-0.19.8.1-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"gettext-runtime-debugsource-0.19.8.1-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"gettext-runtime-mini-0.19.8.1-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"gettext-runtime-mini-debuginfo-0.19.8.1-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"gettext-runtime-mini-debugsource-0.19.8.1-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"gettext-tools-0.19.8.1-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"gettext-tools-debuginfo-0.19.8.1-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"gettext-tools-mini-0.19.8.1-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"gettext-tools-mini-debuginfo-0.19.8.1-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"gettext-csharp-0.19.8.1-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"gettext-java-0.19.8.1-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"gettext-runtime-32bit-0.19.8.1-lp152.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"gettext-runtime-32bit-debuginfo-0.19.8.1-lp152.6.3.1") ) flag++;
