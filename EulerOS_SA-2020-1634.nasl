...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : elfutils (EulerOS-SA-2020-1634)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1634
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a986caf");
...
"Update the affected elfutils package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-16403");
...
pkgs = ["elfutils-0.163-3.h7",
        "elfutils-devel-0.163-3.h7",
        "elfutils-libelf-0.163-3.h7",
        "elfutils-libelf-devel-0.163-3.h7",
        "elfutils-libs-0.163-3.h7"];
