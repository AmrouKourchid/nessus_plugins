...
# extracted from VMware Security Advisory PHSA-2017-0012. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Apache PHSA-2017-0012");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the apache package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-36.md");
...
if (rpm_check(release:'PhotonOS-1.0', reference:'apache-tomcat-8.5.13-1.ph1')) flag++;
