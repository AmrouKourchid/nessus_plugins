...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : python3 (EulerOS-SA-2022-2362)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2362
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0a71d15");
...
var pkgs = [
  "python3-3.7.4-7.h46.eulerosv2r9",
  "python3-unversioned-command-3.7.4-7.h46.eulerosv2r9"
];
