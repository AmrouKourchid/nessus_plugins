...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openldap (EulerOS-SA-2022-2628)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2628
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc22a706");
...
var pkgs = [
  "openldap-2.4.44-5.h13",
  "openldap-clients-2.4.44-5.h13",
  "openldap-devel-2.4.44-5.h13",
  "openldap-servers-2.4.44-5.h13"
];
