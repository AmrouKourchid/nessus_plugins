...
# extracted from Fedora Security Advisory FEDORA-2023-1068309389
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1068309389");

  script_name(english:"Fedora 36 : libgit2 (2023-1068309389)");
...
FEDORA-2023-1068309389 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1068309389");
...
var pkgs = [
    {'reference':'libgit2-1.3.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
