...
# extracted from Red Hat Security Advisory RHSA-2017:2912. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-1000232", "CVE-2017-15010");
  script_xref(name:"RHSA", value:"2017:2912");

  script_name(english:"RHEL 6 / 7 : rh-nodejs4-nodejs-tough-cookie (RHSA-2017:2912)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rh-nodejs4-nodejs-tough-cookie.");
...
referenced in the RHSA-2017:2912 advisory.

    Tough-Cookie is a Node.js module that offers RFC6265 Cookies and Cookie Jar.

    The following packages have been upgraded to a later upstream version: rh-nodejs4-nodejs-tough-cookie
    (2.3.3). (BZ#1497695)

    Security Fix(es):

    * Regular expression denial of service flaws were found in Tough-Cookie. An attacker able to make an
    application using Touch-Cookie to parse a sufficiently large HTTP request Cookie header could cause the
    application to consume an excessive amount of CPU. (CVE-2016-1000232, CVE-2017-15010)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2912.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?abc7afc8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1359818");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1493989");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2912");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-nodejs4-nodejs-tough-cookie package based on the guidance in RHSA-2017:2912.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-15010");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-nodejs4-nodejs-tough-cookie");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs4-nodejs-tough-cookie-2.3.3-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-nodejs4-nodejs-tough-cookie-2.3.3-2.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-nodejs4-nodejs-tough-cookie');
}
