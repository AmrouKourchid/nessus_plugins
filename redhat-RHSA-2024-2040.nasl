...
# extracted from Red Hat Security Advisory RHSA-2024:2040. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2040");

  script_name(english:"RHEL 9 : tigervnc (RHSA-2024:2040)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for tigervnc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2040 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2040.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?34ad89e0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2040");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tigervnc package based on the guidance in RHSA-2024:2040.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tigervnc-1.12.0-14.el9_2.8', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-icons-1.12.0-14.el9_2.8', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-license-1.12.0-14.el9_2.8', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-selinux-1.12.0-14.el9_2.8', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-server-1.12.0-14.el9_2.8', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-server-minimal-1.12.0-14.el9_2.8', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tigervnc-server-module-1.12.0-14.el9_2.8', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
