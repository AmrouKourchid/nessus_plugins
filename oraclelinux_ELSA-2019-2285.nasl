...
# extracted from Oracle Linux Security Advisory ELSA-2019-2285.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : keepalived (ELSA-2019-2285)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-2285.html");
...
var pkgs = [
    {'reference':'keepalived-1.3.5-16.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'keepalived-1.3.5-16.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
