...
# extracted from Red Hat Security Advisory eclipse. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2008-7271", "CVE-2010-4647");

  script_name(english:"RHEL 5 : eclipse (Unpatched Vulnerability) (deprecated)");
