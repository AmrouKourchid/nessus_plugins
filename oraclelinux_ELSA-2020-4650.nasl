...
ELSA-2020-4650 advisory.
    ...
    - Resolves: bz#1812171
      (CVE-2020-8632 cloud-init: Too short random password length in cc_set_password in
    config/cc_set_passwords.py [rhel-8])
    - Resolves: bz#1812174
...
var pkgs = [
    {'reference':'cloud-init-19.4-11.0.1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
