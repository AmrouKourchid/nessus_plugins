...
# extracted from Fedora Security Advisory FEDORA-2024-4e36df9dfd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4e36df9dfd");

  script_name(english:"Fedora 38 : pdns-recursor (2024-4e36df9dfd)");
...
FEDORA-2024-4e36df9dfd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4e36df9dfd");
...
var pkgs = [
    {'reference':'pdns-recursor-4.8.6-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
