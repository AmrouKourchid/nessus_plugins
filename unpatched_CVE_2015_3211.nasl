...
if (description)
{
  ...
  script_cve_id("CVE-2015-3211");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-3211");
...
patch available.
  ...
  - php-fpm allows local users to write to or create arbitrary files via a symlink attack. (CVE-2015-3211)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-3211");
