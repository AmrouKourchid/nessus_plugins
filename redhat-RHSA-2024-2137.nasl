...
# extracted from Red Hat Security Advisory RHSA-2024:2137. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2137");

  script_name(english:"RHEL 9 : LibRaw (RHSA-2024:2137)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2137.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0155e599");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2137");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2188240");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-768");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL LibRaw package based on the guidance in RHSA-2024:2137.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'LibRaw-0.21.1-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'LibRaw-devel-0.21.1-1.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'LibRaw-devel-0.21.1-1.el9', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'LibRaw-devel-0.21.1-1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
