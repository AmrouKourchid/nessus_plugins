...
# extracted from Red Hat Security Advisory RHSA-2024:2184. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2184");

  script_name(english:"RHEL 9 : libsndfile (RHSA-2024:2184)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2184.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c527aa90");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2184");
...
"Update the RHEL libsndfile package based on the guidance in RHSA-2024:2184.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsndfile-1.0.31-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsndfile-devel-1.0.31-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsndfile-utils-1.0.31-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
