...
# extracted from Fedora Security Advisory FEDORA-2023-c40519168b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c40519168b");

  script_name(english:"Fedora 37 : podman (2023-c40519168b)");
...
FEDORA-2023-c40519168b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c40519168b");
...
var pkgs = [
    {'reference':'podman-4.4.4-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
