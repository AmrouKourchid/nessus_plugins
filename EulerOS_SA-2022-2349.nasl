...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : libarchive (EulerOS-SA-2022-2349)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2349
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85c54b42");
...
var pkgs = [
  "libarchive-3.4.1-4.h4.eulerosv2r9"
];
