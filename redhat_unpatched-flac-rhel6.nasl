...
# extracted from Red Hat Security Advisory flac. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-0499", "CVE-2020-22219", "CVE-2021-0561");

  script_name(english:"RHEL 6 : flac (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-22219");
