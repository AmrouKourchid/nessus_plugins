...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 115.3.1");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox ESR installed on the remote Windows host is prior to 115.3.1. It is, therefore, affected by a
vulnerability as referenced in the mfsa2023-44 advisory.
...
"Upgrade to Mozilla Firefox ESR version 115.3.1 or later.");
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'115.3.1', min:'115.0.0', severity:SECURITY_HOLE);
