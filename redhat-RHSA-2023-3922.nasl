...
# extracted from Red Hat Security Advisory RHSA-2023:3922. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3922");
  script_xref(name:"IAVB", value:"2023-B-0040-S");
  script_xref(name:"IAVB", value:"2023-B-0080-S");

  script_name(english:"RHEL 8 : go-toolset:rhel8 (RHSA-2023:3922)");
...
referenced in the RHSA-2023:3922 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3922.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a0c30d7");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3922");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL go-toolset:rhel8 package based on the guidance in RHSA-2023:3922.");
  ...
  'go-toolset:rhel8': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'go-toolset-1.19.10-1.module+el8.8.0+19203+782922b7', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-1.19.10-1.module+el8.8.0+19203+782922b7', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-bin-1.19.10-1.module+el8.8.0+19203+782922b7', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-docs-1.19.10-1.module+el8.8.0+19203+782922b7', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-misc-1.19.10-1.module+el8.8.0+19203+782922b7', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-race-1.19.10-1.module+el8.8.0+19203+782922b7', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-src-1.19.10-1.module+el8.8.0+19203+782922b7', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-tests-1.19.10-1.module+el8.8.0+19203+782922b7', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        ...
        {'reference':'go-toolset-1.19.10-1.module+el8.8.0+19203+782922b7', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-1.19.10-1.module+el8.8.0+19203+782922b7', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-bin-1.19.10-1.module+el8.8.0+19203+782922b7', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-docs-1.19.10-1.module+el8.8.0+19203+782922b7', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-misc-1.19.10-1.module+el8.8.0+19203+782922b7', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-race-1.19.10-1.module+el8.8.0+19203+782922b7', 'sp':'8', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-src-1.19.10-1.module+el8.8.0+19203+782922b7', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'golang-tests-1.19.10-1.module+el8.8.0+19203+782922b7', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
