...
# extracted from Fedora Security Advisory FEDORA-2024-a6c2300bca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a6c2300bca");

  script_name(english:"Fedora 38 : chromium (2024-a6c2300bca)");
...
FEDORA-2024-a6c2300bca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a6c2300bca");
...
var pkgs = [
    {'reference':'chromium-120.0.6099.199-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
