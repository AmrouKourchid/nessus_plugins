...
if (description)
{
  ...
  script_name(english:"PHP 5.5.x < 5.5.34 Multiple Vulnerabilities");
...
server is 5.5.x prior to 5.5.34. It is, therefore, affected by
multiple vulnerabilities :
  ...
  - An invalid memory write error exists when handling
    ...
    to have an unspecified impact. (CVE-2016-4072)
...
relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-5.php#5.5.34");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 5.5.34 or later.");
...
if (version !~ "^5\.5\.([0-9]|1[0-9]|2[0-9]|3[0-3])($|[^0-9])")
