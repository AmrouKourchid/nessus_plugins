...
if (description)
{
  ...
  script_cve_id("CVE-2022-49681");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49681");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: xtensa: xtfpga: Fix refcount leak bug
    in setup In machine_setup(), of_find_compatible_node() will return a node pointer with refcount
    incremented. We should use of_node_put() when it is not used anymore. (CVE-2022-49681)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49681");
