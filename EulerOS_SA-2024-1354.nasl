...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : binutils (EulerOS-SA-2024-1354)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1354
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91e87c67");
...
var pkgs = [
  "binutils-2.34-4.h24.eulerosv2r10"
];
