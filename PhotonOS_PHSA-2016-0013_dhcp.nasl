...
if (description)
{
  ...
  script_cve_id("CVE-2015-8605", "CVE-2016-2774");

  script_name(english:"Photon OS 1.0: Dhcp PHSA-2016-0013");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2015-8605");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dhcp-client-4.3.5-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dhcp-debuginfo-4.3.5-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dhcp-devel-4.3.5-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dhcp-libs-4.3.5-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dhcp-server-4.3.5-1.ph1')) flag++;
