...
# extracted from Red Hat Security Advisory RHSA-2021:0818. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:0818");

  script_name(english:"RHEL 8 : wpa_supplicant (RHSA-2021:0818)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0818.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?54f5eee5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:0818");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1933361");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL wpa_supplicant package based on the guidance in RHSA-2021:0818.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wpa_supplicant-2.7-2.el8_1.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
