...
# extracted from Fedora Security Advisory FEDORA-2018-bca1c1ab49.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : libssh (2018-bca1c1ab49)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-bca1c1ab49");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libssh-0.7.6-1.fc27")) flag++;
