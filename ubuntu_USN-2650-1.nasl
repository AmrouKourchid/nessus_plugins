...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : wpa_supplicant and hostapd vulnerabilities (USN-2650-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2650-1 advisory.

    Kostya Kortchinsky discovered multiple flaws in wpa_supplicant and hostapd. A remote attacker could use
    these issues to cause wpa_supplicant or hostapd to crash, resulting in a denial of service.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2650-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-4146");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'hostapd', 'pkgver': '1:2.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'wpagui', 'pkgver': '2.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'wpasupplicant', 'pkgver': '2.1-0ubuntu1.3'},
    {'osver': '14.04', 'pkgname': 'wpasupplicant-udeb', 'pkgver': '2.1-0ubuntu1.3'}
];
