...
# extracted from Red Hat Security Advisory RHSA-2022:7970. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7970");

  script_name(english:"RHEL 9 : protobuf (RHSA-2022:7970)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7970.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66fb70d8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7970");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2049429");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL protobuf package based on the guidance in RHSA-2022:7970.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'protobuf-3.14.0-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-compiler-3.14.0-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-devel-3.14.0-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-lite-3.14.0-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'protobuf-lite-devel-3.14.0-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
