...
# extracted from Red Hat Security Advisory RHSA-2019:2157 and 
# CentOS Errata and Security Advisory 2019:2157 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : freerdp / vinagre (CESA-2019:2157)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"An update for freerdp and vinagre is now available for Red Hat
Enterprise Linux 7.
...
Enterprise Linux 7.7 Release Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2019-August/005873.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52f933b7");
  # https://lists.centos.org/pipermail/centos-cr-announce/2019-August/006176.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae85e746");
  script_set_attribute(attribute:"solution", value:
"Update the affected freerdp and / or vinagre packages.");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"freerdp-2.0.0-1.rc4.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"freerdp-devel-2.0.0-1.rc4.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"freerdp-libs-2.0.0-1.rc4.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libwinpr-2.0.0-1.rc4.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libwinpr-devel-2.0.0-1.rc4.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"vinagre-3.22.0-12.el7")) flag++;
