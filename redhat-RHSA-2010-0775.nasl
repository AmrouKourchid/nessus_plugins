...
if (description)
{
  ...
  script_cve_id("CVE-2010-2235");
  script_xref(name:"RHSA", value:"2010:0775");

  script_name(english:"RHEL 5 : cobbler (RHSA-2010:0775)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2010/rhsa-2010_0775.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ec8776f");
  script_set_attribute(attribute:"see_also", value:"http://www.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2010:0775");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=607662");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cobbler package based on the guidance in RHSA-2010:0775.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-2235");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cobbler-1.6.6-15.el5sat', 'cpu':'i386', 'release':'5', 'el_string':'el5sat', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cobbler-1.6.6-15.el5sat', 'cpu':'s390x', 'release':'5', 'el_string':'el5sat', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'cobbler-1.6.6-15.el5sat', 'cpu':'x86_64', 'release':'5', 'el_string':'el5sat', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
