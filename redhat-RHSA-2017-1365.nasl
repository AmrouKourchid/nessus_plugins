...
the RHSA-2017:1365 advisory.
    ...
    * The Network Security Services (NSS) code and Certificate Authority (CA) list have been updated to meet
    ...
    CA list on June 12, 2017. (BZ#1451421)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_1365.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?706cabd6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:1365");
...
"Update the RHEL nss package based on the guidance in RHSA-2017:1365.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nss-3.28.4-1.2.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-devel-3.28.4-1.2.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-pkcs11-devel-3.28.4-1.2.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-sysinit-3.28.4-1.2.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-tools-3.28.4-1.2.el7_3', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
