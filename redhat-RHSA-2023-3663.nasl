...
# extracted from Red Hat Security Advisory RHSA-2023:3663. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3663");

  script_name(english:"RHEL 8 : jenkins and jenkins-2-plugins (RHSA-2023:3663)");
...
referenced in the RHSA-2023:3663 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3663.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16cc86d4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2087214");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3663");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL jenkins / jenkins-2-plugins packages based on the guidance in RHSA-2023:3663.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-22976");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-27898");

  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");
  script_cwe_id(79, 155, 190, 200, 266, 378, 400, 410, 502, 674, 787);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.11.1686831822-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-40149', 'CVE-2022-40150', 'CVE-2022-42003', 'CVE-2022-42004', 'CVE-2023-1370', 'CVE-2023-1436', 'CVE-2023-26464', 'CVE-2023-32977', 'CVE-2023-32981']},
      {'reference':'jenkins-2.401.1.1686831596-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-2048', 'CVE-2022-22976', 'CVE-2022-41966', 'CVE-2023-20860', 'CVE-2023-27898', 'CVE-2023-27899', 'CVE-2023-27903', 'CVE-2023-27904']}
    ]
  }
];
