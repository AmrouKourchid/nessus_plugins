...
# extracted from Red Hat Security Advisory RHSA-2024:3214. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3214");

  script_name(english:"RHEL 8 : gmp (RHSA-2024:3214)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gmp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3214 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3214.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a0bf8c6d");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2024904");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3214");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gmp package based on the guidance in RHSA-2024:3214.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gmp-6.1.2-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'gmp-c++-6.1.2-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'gmp-devel-6.1.2-11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
