...
# extracted from Amazon Linux 2022 Security Advisory ALAS2022-2021-003.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2022 : log4j, log4j-jcl, log4j-slf4j (ALAS2022-2021-003)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2022 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2022-2021-003 advisory.

    A flaw was found in the Java logging library Apache Log4j 2 in versions from 2.0-beta9 and before and
    including 2.14.1. This could allow a remote attacker to execute code on the server if the system logs an
    attacker-controlled string value with the attacker's JNDI LDAP server lookup. (CVE-2021-44228)

Tenable has extracted the preceding description block directly from the tested product security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2022/ALAS-2021-003.html");
...
var pkgs = [
    {'reference':'log4j-2.15.0-1.amzn2022.0.1', 'release':'AL-2022', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'log4j-jcl-2.15.0-1.amzn2022.0.1', 'release':'AL-2022', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'log4j-slf4j-2.15.0-1.amzn2022.0.1', 'release':'AL-2022', 'rpm_spec_vers_cmp':TRUE}
];
