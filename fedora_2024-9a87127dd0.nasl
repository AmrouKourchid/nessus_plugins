...
# extracted from Fedora Security Advisory FEDORA-2024-9a87127dd0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9a87127dd0");

  script_name(english:"Fedora 41 : mbedtls3.6 (2024-9a87127dd0)");
...
FEDORA-2024-9a87127dd0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9a87127dd0");
  script_set_attribute(attribute:"solution", value:
"Update the affected mbedtls3.6 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mbedtls3.6");
...
var pkgs = [
    {'reference':'mbedtls3.6-3.6.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mbedtls3.6');
}
