...
# extracted from Red Hat Security Advisory RHSA-2018:1701. The text 
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1701.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9354516b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1701");
...
"Update the RHEL librelp package based on the guidance in RHSA-2018:1701.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'librelp-1.2.7-3.el6_6.1', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-1.2.7-3.el6_6.1', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-devel-1.2.7-3.el6_6.1', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'librelp-devel-1.2.7-3.el6_6.1', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
