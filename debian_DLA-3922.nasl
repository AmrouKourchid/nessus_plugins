...
# extracted from Debian Security Advisory dla-3922. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3922 : python-cryptography-doc - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-49083");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/python-cryptography");
  script_set_attribute(attribute:"solution", value:
"Upgrade the python-cryptography-doc packages.");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'python-cryptography-doc', 'reference': '3.3.2-1+deb11u1'},
    {'release': '11.0', 'prefix': 'python3-cryptography', 'reference': '3.3.2-1+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-cryptography-doc / python3-cryptography');
}
