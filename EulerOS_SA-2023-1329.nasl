...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : NetworkManager (EulerOS-SA-2023-1329)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1329
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?565cb9d2");
...
"Update the affected NetworkManager packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:NetworkManager-config-connectivity-redhat");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:NetworkManager-config-server");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:NetworkManager-dispatcher-routing-rules");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:NetworkManager-libnm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:NetworkManager-ppp");
...
var pkgs = [
  "NetworkManager-1.12.4-1.h14.eulerosv2r8",
  "NetworkManager-adsl-1.12.4-1.h14.eulerosv2r8",
  "NetworkManager-config-connectivity-redhat-1.12.4-1.h14.eulerosv2r8",
  "NetworkManager-config-server-1.12.4-1.h14.eulerosv2r8",
  "NetworkManager-dispatcher-routing-rules-1.12.4-1.h14.eulerosv2r8",
  "NetworkManager-libnm-1.12.4-1.h14.eulerosv2r8",
  "NetworkManager-ppp-1.12.4-1.h14.eulerosv2r8",
  "NetworkManager-team-1.12.4-1.h14.eulerosv2r8",
  "NetworkManager-tui-1.12.4-1.h14.eulerosv2r8",
  "NetworkManager-wifi-1.12.4-1.h14.eulerosv2r8",
  "NetworkManager-wwan-1.12.4-1.h14.eulerosv2r8"
];
