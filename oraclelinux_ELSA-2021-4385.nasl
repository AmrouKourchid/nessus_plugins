...
# extracted from Oracle Linux Security Advisory ELSA-2021-4385.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : glib2 (ELSA-2021-4385)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2021-4385 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-4385.html");
...
var pkgs = [
    ...
    {'reference':'glib2-fam-2.56.4-156.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glib2-static-2.56.4-156.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'glib2-tests-2.56.4-156.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
