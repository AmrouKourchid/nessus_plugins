...
# extracted from Debian Security Advisory DLA-2027-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2027-1 : jruby security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/12/msg00009.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/jruby");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"jruby", reference:"1.5.6-9+deb8u2")) flag++;
