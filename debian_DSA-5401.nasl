...
# extracted from Debian Security Advisory dsa-5401. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5401-1 : postgresql-13 - security update");
...
dsa-5401 advisory.
    ...
    Two security issues were found in PostgreSQL, which may result in privilege escalation or incorrect policy
    enforcement. For the stable distribution (bullseye), these problems have been fixed in version
    13.11-0+deb11u1. We recommend that you upgrade your postgresql-13 packages. For the detailed security
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5401");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libecpg-compat3', 'reference': '13.11-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libecpg-dev', 'reference': '13.11-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libecpg6', 'reference': '13.11-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libpgtypes3', 'reference': '13.11-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libpq-dev', 'reference': '13.11-0+deb11u1'},
    {'release': '11.0', 'prefix': 'libpq5', 'reference': '13.11-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-13', 'reference': '13.11-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-client-13', 'reference': '13.11-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-doc-13', 'reference': '13.11-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-plperl-13', 'reference': '13.11-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-plpython3-13', 'reference': '13.11-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-pltcl-13', 'reference': '13.11-0+deb11u1'},
    {'release': '11.0', 'prefix': 'postgresql-server-dev-13', 'reference': '13.11-0+deb11u1'}
];
