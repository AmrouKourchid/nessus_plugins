...
# extracted from Fedora Security Advisory FEDORA-2025-2d5726abb8
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-2142");
  script_xref(name:"FEDORA", value:"2025-2d5726abb8");

  script_name(english:"Fedora 40 : workrave (2025-2d5726abb8)");
...
FEDORA-2025-2d5726abb8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2d5726abb8");
  script_set_attribute(attribute:"solution", value:
"Update the affected workrave package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-2142");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:workrave");
...
var pkgs = [
    {'reference':'workrave-1.11.0~rc.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'workrave');
}
