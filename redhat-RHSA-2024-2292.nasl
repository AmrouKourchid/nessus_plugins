...
# extracted from Red Hat Security Advisory RHSA-2024:2292. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2292");

  script_name(english:"RHEL 9 : python3.11 (RHSA-2024:2292)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2292.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc342a4b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2292");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2196183");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-20233");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11 package based on the guidance in RHSA-2024:2292.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-3.11.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-debug-3.11.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-devel-3.11.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-idle-3.11.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-libs-3.11.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-test-3.11.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-tkinter-3.11.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
