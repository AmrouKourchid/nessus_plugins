...
# extracted from Fedora Security Advisory FEDORA-2023-16a1a6ec81
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-16a1a6ec81");

  script_name(english:"Fedora 38 : avahi (2023-16a1a6ec81)");
...
FEDORA-2023-16a1a6ec81 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-16a1a6ec81");
...
var pkgs = [
    {'reference':'avahi-0.8-22.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
