...
# extracted from Red Hat Security Advisory RHSA-2023:6796. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6796");

  script_name(english:"RHEL 9 : insights-client (RHSA-2023:6796)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6796.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e65d6e51");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2227027");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6796");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL insights-client package based on the guidance in RHSA-2023:6796.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'insights-client-3.2.2-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
