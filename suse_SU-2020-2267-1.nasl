...
# extracted from SUSE update advisory SUSE-SU-2020:2267-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : dovecot23 (SUSE-SU-2020:2267-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c5b10d5");
...
zypper in -t patch
SUSE-SLE-Module-Server-Applications-15-SP1-2020-2267=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-backend-mysql-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-backend-mysql-debuginfo-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-backend-pgsql-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-backend-pgsql-debuginfo-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-backend-sqlite-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-backend-sqlite-debuginfo-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-debuginfo-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-debugsource-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-devel-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-fts-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-fts-debuginfo-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-fts-lucene-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-fts-lucene-debuginfo-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-fts-solr-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-fts-solr-debuginfo-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-fts-squat-2.3.10-16.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"dovecot23-fts-squat-debuginfo-2.3.10-16.1")) flag++;
