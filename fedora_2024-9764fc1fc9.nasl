...
# extracted from Fedora Security Advisory FEDORA-2024-9764fc1fc9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9764fc1fc9");

  script_name(english:"Fedora 41 : mingw-libgcrypt (2024-9764fc1fc9)");
...
FEDORA-2024-9764fc1fc9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9764fc1fc9");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-libgcrypt package.");
...
var pkgs = [
    {'reference':'mingw-libgcrypt-1.10.3-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
