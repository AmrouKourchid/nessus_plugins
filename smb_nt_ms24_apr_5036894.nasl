...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5036894");
  script_xref(name:"MSFT", value:"MS24-5036894");
  ...
  script_name(english:"KB5036894: Windows 11 version 21H2 Security Update (April 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5036894");
