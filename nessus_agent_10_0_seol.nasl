...
if (description)
{
  ...
  script_name(english:"Tenable Nessus Agent SEoL (10.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus Agent is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus Agent is 10.0.x. It is, therefore, no longer maintained by its vendor or
provider.
...
var constraints = [
  { max_branch : '10.0', min_branch : '10.0', seol : 20230531, eseol : 20231130 }
];
