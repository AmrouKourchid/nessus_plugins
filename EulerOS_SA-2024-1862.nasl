...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : shim (EulerOS-SA-2024-1862)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1862
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5dba983b");
...
var pkgs = [
  "shim-15.6-7.h14.eulerosv2r12",
  "shim-aa64-storage-15.6-7.h14.eulerosv2r12"
];
