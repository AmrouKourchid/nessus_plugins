...
# extracted from Oracle Linux Security Advisory ELSA-2022-6602.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : gnupg2 (ELSA-2022-6602)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-6602.html");
