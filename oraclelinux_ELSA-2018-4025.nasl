...
the ELSA-2018-4025 advisory.
    ...
    - ALSA: pcm: prevent UAF in snd_pcm_info (Robb Glasser)  [Orabug: 27344841]  {CVE-2017-0861}
    {CVE-2017-0861}
    - assoc_array: Fix a buggy node-splitting case (David Howells)  [Orabug: 27364592]  {CVE-2017-12193}
    {CVE-2017-12193}
    ...
    - sctp: do not peel off an assoc from one netns to another one (Xin Long)  [Orabug: 27386999]
    {CVE-2017-15115}
    - net: ipv4: fix for a race condition in raw_sendmsg (Mohamed Ghannam)  [Orabug: 27390682]
    {CVE-2017-17712}
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-4.1.12-112.14.14.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-112.14.14.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'},
    ...
    {'reference':'kernel-uek-doc-4.1.12-112.14.14.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-112.14.14.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'}
];
