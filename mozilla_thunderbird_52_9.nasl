...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 52.9 Multiple Vulnerabilities");
...
mozilla_check_version(installs:installs, product:'thunderbird', fix:'52.9', severity:SECURITY_HOLE);
