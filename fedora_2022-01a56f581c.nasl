...
# extracted from Fedora Security Advisory FEDORA-2022-01a56f581c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-01a56f581c");

  script_name(english:"Fedora 37 : bcel (2022-01a56f581c)");
...
FEDORA-2022-01a56f581c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-01a56f581c");
...
var pkgs = [
    {'reference':'bcel-6.5.0-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
