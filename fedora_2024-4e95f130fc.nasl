...
# extracted from Fedora Security Advisory FEDORA-2024-4e95f130fc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4e95f130fc");

  script_name(english:"Fedora 40 : cockpit (2024-4e95f130fc)");
...
FEDORA-2024-4e95f130fc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4e95f130fc");
...
var pkgs = [
    {'reference':'cockpit-314-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
