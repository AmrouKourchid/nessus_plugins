...
# extracted from Red Hat Security Advisory RHSA-2025:1673. The text
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-40866");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1673.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b43d14f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1673");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mysql:8.0 package based on the guidance in RHSA-2025:1673.");
  ...
  'mysql:8.0': [
    {
      ...
      'pkgs': [
        {'reference':'mecab-0.996-2.module+el8.10.0+22857+7f331edd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mecab-devel-0.996-2.module+el8.10.0+22857+7f331edd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mecab-ipadic-2.7.0.20070801-17.module+el8.10.0+22857+7f331edd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mecab-ipadic-EUCJP-2.7.0.20070801-17.module+el8.10.0+22857+7f331edd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-8.0.41-1.module+el8.10.0+22857+7f331edd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-common-8.0.41-1.module+el8.10.0+22857+7f331edd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-devel-8.0.41-1.module+el8.10.0+22857+7f331edd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-errmsg-8.0.41-1.module+el8.10.0+22857+7f331edd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-libs-8.0.41-1.module+el8.10.0+22857+7f331edd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-server-8.0.41-1.module+el8.10.0+22857+7f331edd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mysql-test-8.0.41-1.module+el8.10.0+22857+7f331edd', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
