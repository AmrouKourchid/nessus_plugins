...
# extracted from Red Hat Security Advisory RHSA-2024:4054. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4054");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (python-gunicorn) (RHSA-2024:4054)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.2 (python-gunicorn).");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4054.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a0ba59b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2275280");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4054");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2 (python-gunicorn) package based on the guidance in RHSA-2024:4054.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-gunicorn-19.9.0-11.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
