...
# extracted from Fedora Security Advisory FEDORA-2024-2c9be9d949
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2c9be9d949");

  script_name(english:"Fedora 38 : chromium (2024-2c9be9d949)");
...
FEDORA-2024-2c9be9d949 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2c9be9d949");
...
var pkgs = [
    {'reference':'chromium-124.0.6367.78-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
