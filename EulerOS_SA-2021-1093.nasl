...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libxml2 (EulerOS-SA-2021-1093)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1093
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?82928f18");
...
pkgs = ["libxml2-2.9.1-6.3.h20",
        "libxml2-devel-2.9.1-6.3.h20",
        "libxml2-python-2.9.1-6.3.h20"];
