...
# extracted from Debian Security Advisory dla-3881. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3881 : aom-tools - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-3881
advisory.
...
var pkgs = [
    {'release': '11.0', 'prefix': 'aom-tools', 'reference': '1.0.0.errata1-3+deb11u2'},
    {'release': '11.0', 'prefix': 'libaom-dev', 'reference': '1.0.0.errata1-3+deb11u2'},
    {'release': '11.0', 'prefix': 'libaom-doc', 'reference': '1.0.0.errata1-3+deb11u2'},
    {'release': '11.0', 'prefix': 'libaom0', 'reference': '1.0.0.errata1-3+deb11u2'}
];
