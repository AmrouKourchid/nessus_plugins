...
"The version of zsh installed on the remote host is prior to 5.7.1-6. It is, therefore, affected by a vulnerability as
referenced in the ALAS2-2020-1439 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1439.html");
...
var pkgs = [
    {'reference':'zsh-5.7.1-6.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'zsh-5.7.1-6.amzn2.0.1', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'zsh-5.7.1-6.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'zsh-debuginfo-5.7.1-6.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'zsh-debuginfo-5.7.1-6.amzn2.0.1', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'zsh-debuginfo-5.7.1-6.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'zsh-html-5.7.1-6.amzn2.0.1', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
