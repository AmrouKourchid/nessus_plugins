...
# extracted from Red Hat Security Advisory RHSA-2024:2733. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2733");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (openstack-ansible-core) (RHSA-2024:2733)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2733.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?691c6f46");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2733");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-ansible-core-2.14.2-4.3.el9ost', 'cpu':'x86_64', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
