...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5048654");
  script_xref(name:"MSKB", value:"5048800");
  script_xref(name:"MSFT", value:"MS24-5048654");
  script_xref(name:"MSFT", value:"MS24-5048800");
  ...
  script_name(english:"KB5048654: Windows Server 2022 / Azure Stack HCI 22H2 Security Update (December 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5048654 or hotpatch 5048800. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5048654");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5048800");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5048654 or hotpatch 5048800");
...
if (
  smb_check_rollup(os:'10',
                   ...
                   rollup_date:'12_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5048654,5048800])
)
{
