...
# extracted from Fedora Security Advisory FEDORA-2019-672ae0f060.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-672ae0f060");

  script_name(english:"Fedora 29 : expat (2019-672ae0f060)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-672ae0f060");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"expat-2.2.8-1.fc29")) flag++;
