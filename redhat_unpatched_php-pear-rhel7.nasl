...
# extracted from Red Hat Security Advisory php-pear. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-5630", "CVE-2018-1000888");

  script_name(english:"RHEL 7 : php-pear (Unpatched Vulnerability) (deprecated)");
