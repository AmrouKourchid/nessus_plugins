...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Polkit PHSA-2019-1.0-0227");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"polkit-0.113-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"polkit-debuginfo-0.113-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"polkit-devel-0.113-2.ph1")) flag++;
