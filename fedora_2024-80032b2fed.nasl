...
# extracted from Fedora Security Advisory FEDORA-2024-80032b2fed
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-80032b2fed");

  script_name(english:"Fedora 39 : chromium (2024-80032b2fed)");
...
FEDORA-2024-80032b2fed advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-80032b2fed");
...
var pkgs = [
    {'reference':'chromium-122.0.6261.111-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
