...
# extracted from Fedora Security Advisory FEDORA-2024-f4a65623e7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f4a65623e7");

  script_name(english:"Fedora 39 : apptainer (2024-f4a65623e7)");
...
FEDORA-2024-f4a65623e7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f4a65623e7");
...
var pkgs = [
    {'reference':'apptainer-1.3.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
