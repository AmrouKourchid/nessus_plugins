...
# extracted from Ubuntu Security Notice USN-5034-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5034-2");

  script_name(english:"Ubuntu 16.04 ESM : c-ares vulnerability (USN-5034-2)");
...
USN-5034-2 advisory.
    ...
    USN-5034-1 fixed a vulnerability in c-ares. This update provides the corresponding update for Ubuntu 16.04
    ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5034-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.10.0-3ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc-ares2', 'pkgver': '1.10.0-3ubuntu0.2+esm1', 'ubuntu_pro': TRUE}
];
