...
# AlmaLinux Security Advisory ALSA-2024:0609.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:0609");
  script_xref(name:"IAVA", value:"2024-A-0053-S");

  script_name(english:"AlmaLinux 8 : thunderbird (ALSA-2024:0609)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-0609.html");
...
var pkgs = [
    {'reference':'thunderbird-115.7.0-1.el8_9.alma.plus', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.7.0-1.el8_9.alma.plus', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
