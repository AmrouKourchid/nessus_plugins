...
# extracted from Oracle Linux Security Advisory ELSA-2019-4540.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : runc (ELSA-2019-4540)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-4540.html");
...
var pkgs = [
    {'reference':'runc-1.0.0-19.rc5.git4bb1fe4.0.3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
