...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Mysql PHSA-2021-3.0-0281");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'mysql-8.0.26-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'mysql-devel-8.0.26-1.ph3')) flag++;
