...
if (description)
{
  ...
  script_name(english:"CentOS 9 : nghttp2-1.43.0-5.el9.1");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for libnghttp2.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
nghttp2-1.43.0-5.el9.1 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=39709");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream libnghttp2 package.");
...
var pkgs = [
    {'reference':'libnghttp2-1.43.0-5.el9.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libnghttp2-devel-1.43.0-5.el9.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nghttp2-1.43.0-5.el9.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
