...
# extracted from Red Hat Security Advisory RHSA-2024:2126. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2126.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f66cb485");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2126");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-3960");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL webkit2gtk3 package based on the guidance in RHSA-2024:2126.");
  ...
  script_cwe_id(20, 119, 400, 416, 787, 942);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'webkit2gtk3-2.42.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-devel-2.42.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-2.42.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-devel-2.42.5-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
