...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : gnutls (EulerOS-SA-2019-1676)");
...
vulnerability :
  ...
  - A cache-based side channel attack was found in the way
    ...
    and Lucky-13 attacks to recover plain text in a
    cross-VM attack scenario.(CVE-2018-10846)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1676
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?59cb9f91");
...
"Update the affected gnutls package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-10846");
...
pkgs = ["gnutls-3.3.26-9.h4.eulerosv2r7",
        "gnutls-c++-3.3.26-9.h4.eulerosv2r7",
        "gnutls-dane-3.3.26-9.h4.eulerosv2r7",
        "gnutls-devel-3.3.26-9.h4.eulerosv2r7",
        "gnutls-utils-3.3.26-9.h4.eulerosv2r7"];
