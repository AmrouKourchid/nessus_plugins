...
if (description)
{
  ...
  script_name(english:"RHEL 6 : openswan (RHSA-2011:1422)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openswan.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2011:1422 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2011/rhsa-2011_1422.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?475dc6b8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=748961");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:1422");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openswan package based on the guidance in RHSA-2011:1422.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openswan-2.6.32-4.el6_1.4', 'cpu':'i686', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-2.6.32-4.el6_1.4', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-2.6.32-4.el6_1.4', 'cpu':'s390x', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-2.6.32-4.el6_1.4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-doc-2.6.32-4.el6_1.4', 'cpu':'i686', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-doc-2.6.32-4.el6_1.4', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-doc-2.6.32-4.el6_1.4', 'cpu':'s390x', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openswan-doc-2.6.32-4.el6_1.4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
