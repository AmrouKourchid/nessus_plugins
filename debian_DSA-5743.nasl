...
# extracted from Debian Security Advisory dsa-5743. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5743 : roundcube - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-42008");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-42009");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-42010");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'roundcube', 'reference': '1.6.5+dfsg-1+deb12u3'},
    {'release': '12.0', 'prefix': 'roundcube-core', 'reference': '1.6.5+dfsg-1+deb12u3'},
    {'release': '12.0', 'prefix': 'roundcube-mysql', 'reference': '1.6.5+dfsg-1+deb12u3'},
    {'release': '12.0', 'prefix': 'roundcube-pgsql', 'reference': '1.6.5+dfsg-1+deb12u3'},
    {'release': '12.0', 'prefix': 'roundcube-plugins', 'reference': '1.6.5+dfsg-1+deb12u3'},
    {'release': '12.0', 'prefix': 'roundcube-sqlite3', 'reference': '1.6.5+dfsg-1+deb12u3'}
];
