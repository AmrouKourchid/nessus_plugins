...
# extracted from Fedora Security Advisory FEDORA-2025-2e627d0672
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-2e627d0672");
  script_xref(name:"IAVA", value:"2025-A-0079-S");

  script_name(english:"Fedora 40 : firefox (2025-2e627d0672)");
...
FEDORA-2025-2e627d0672 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2e627d0672");
...
var pkgs = [
    {'reference':'firefox-135.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
