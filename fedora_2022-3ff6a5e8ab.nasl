...
# extracted from Fedora Security Advisory FEDORA-2022-3ff6a5e8ab
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-3ff6a5e8ab");

  script_name(english:"Fedora 38 : python-lxml (2022-3ff6a5e8ab)");
...
FEDORA-2022-3ff6a5e8ab advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3ff6a5e8ab");
...
var pkgs = [
    {'reference':'python-lxml-4.9.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
