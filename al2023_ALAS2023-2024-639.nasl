...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-639.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-26605", "CVE-2024-26939", "CVE-2024-35995");

  script_name(english:"Amazon Linux 2023 : bpftool, kernel, kernel-devel (ALAS2023-2024-639)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2024-639 advisory.

    2024-07-03: CVE-2024-26605 was added to this advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-639.html");
...
"Run 'dnf update kernel --releasever 2023.4.20240611' to update your system.");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2024-26605", "CVE-2024-26939", "CVE-2024-35995");
  if (hotfix_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "kpatch hotfix for ALAS2023-2024-639");
  }
  else
  {
