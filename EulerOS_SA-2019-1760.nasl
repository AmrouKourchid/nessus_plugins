...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : graphviz (EulerOS-SA-2019-1760)");
...
vulnerability :
  ...
  - The agroot() function in cgraph\obj.c in libcgraph.a in
    Graphviz 2.39.20160612.1140 has a NULL pointer
    dereference, as demonstrated by
    graphml2gv.(CVE-2019-11023)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1760
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7ff2e73");
...
pkgs = ["graphviz-2.40.1-36.h2.eulerosv2r8",
        "graphviz-tcl-2.40.1-36.h2.eulerosv2r8"];
