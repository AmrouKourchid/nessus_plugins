...
# extracted from openSUSE Security Update openSUSE-2020-1272.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : inn (openSUSE-2020-1272)");
...
"This update for inn fixes the following issues :
  ...
  - change file owners in /usr/lib/news to root
    [boo#1172573] [CVE-2020-8026]");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1172573");
...
"Update the affected inn packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-8026");
...
if ( rpm_check(release:"SUSE15.2", reference:"inn-2.6.2-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"inn-debuginfo-2.6.2-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"inn-debugsource-2.6.2-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"inn-devel-2.6.2-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mininews-2.6.2-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mininews-debuginfo-2.6.2-lp152.2.3.1") ) flag++;
