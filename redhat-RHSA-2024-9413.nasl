...
# extracted from Red Hat Security Advisory RHSA-2024:9413. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9413");

  script_name(english:"RHEL 9 : bluez (RHSA-2024:9413)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for bluez.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:9413 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9413.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c34760e1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9413");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bluez package based on the guidance in RHSA-2024:9413.");
  ...
  script_cwe_id(121, 122, 125, 129, 285);
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bluez-obexd");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bluez-5.72-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-cups-5.72-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-libs-5.72-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-libs-devel-5.72-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-obexd-5.72-2.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-obexd-5.72-2.el9', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'bluez-obexd-5.72-2.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bluez / bluez-cups / bluez-libs / bluez-libs-devel / bluez-obexd');
}
