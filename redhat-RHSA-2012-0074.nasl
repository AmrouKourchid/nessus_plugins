...
referenced in the RHSA-2012:0074 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_0074.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?582f7a88");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:0074");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=767871");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=783359");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL jbossweb package based on the guidance in RHSA-2012:0074.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jbossweb-2.1.12-3_patch_03.2.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossweb-el-1.0-api-2.1.12-3_patch_03.2.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossweb-jsp-2.1-api-2.1.12-3_patch_03.2.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossweb-lib-2.1.12-3_patch_03.2.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossweb-servlet-2.5-api-2.1.12-3_patch_03.2.ep5.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jbossweb-2.1.12-3_patch_03.2.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossweb-el-1.0-api-2.1.12-3_patch_03.2.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossweb-jsp-2.1-api-2.1.12-3_patch_03.2.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossweb-lib-2.1.12-3_patch_03.2.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'},
      {'reference':'jbossweb-servlet-2.5-api-2.1.12-3_patch_03.2.ep5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap5'}
    ]
  }
];
