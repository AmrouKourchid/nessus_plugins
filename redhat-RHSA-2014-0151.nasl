...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_0151.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2e8e4725");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0151");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=602797");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=833831");
...
"Update the RHEL wget package based on the guidance in RHSA-2014:0151.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-2252");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wget-1.12-1.11.el6_5', 'cpu':'i686', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.12-1.11.el6_5', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.12-1.11.el6_5', 'cpu':'s390x', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.12-1.11.el6_5', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
