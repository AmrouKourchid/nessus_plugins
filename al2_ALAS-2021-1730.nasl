...
# extracted from Amazon Linux 2 Security Advisory ALAS-2021-1730.
##
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2021-1730");
  ...
  script_name(english:"Amazon Linux 2 : aws-kinesis-agent (ALAS-2021-1730)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of aws-kinesis-agent installed on the remote host is prior to 2.0.4-1. It is, therefore, affected by
multiple vulnerabilities as referenced in the ALAS2-2021-1730 advisory.

    Amazon Kinesis Agent versions within Amazon Linux 2 (AL2) prior to aws-kinesis-agent-2.0.4-1 included a
    version of Apache Log4j affected by CVE-2021-44228 and CVE-2021-45046. The Amazon Kinesis Agent has been
    updated to aws-kinesis-agent-2.0.4-1 within Amazon Linux 2 that mitigates CVE-2021-44228 and
    CVE-2021-45046. For additional detail see https://github.com/awslabs/amazon-kinesis-agent.

Tenable has extracted the preceding description block directly from the tested product security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2021-1730.html");
...
var pkgs = [
    {'reference':'aws-kinesis-agent-2.0.4-1.amzn2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
