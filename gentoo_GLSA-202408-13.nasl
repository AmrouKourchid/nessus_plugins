...
# extracted from Gentoo Linux Security Advisory GLSA 202408-13.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202408-13 : Nokogiri: Denial of Service");
...
"The remote host is affected by the vulnerability described in GLSA-202408-13 (Nokogiri: Denial of Service)
    ...
    A denial of service vulnerability has been discovered in Nokogiri. Please review the CVE identifier
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202408-13");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=884863");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.13.10"),
    'vulnerable' : make_list("lt 1.13.10")
  }
];
