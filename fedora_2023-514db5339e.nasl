...
# extracted from Fedora Security Advisory FEDORA-2023-514db5339e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-514db5339e");

  script_name(english:"Fedora 39 : frr (2023-514db5339e)");
...
FEDORA-2023-514db5339e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-514db5339e");
...
var pkgs = [
    {'reference':'frr-8.5.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
