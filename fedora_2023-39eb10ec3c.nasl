...
# extracted from Fedora Security Advisory FEDORA-2023-39eb10ec3c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-39eb10ec3c");

  script_name(english:"Fedora 38 : syncthing (2023-39eb10ec3c)");
...
FEDORA-2023-39eb10ec3c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-39eb10ec3c");
...
var pkgs = [
    {'reference':'syncthing-1.23.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
