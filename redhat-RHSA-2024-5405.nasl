...
# extracted from Red Hat Security Advisory RHSA-2024:5405. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:5405");

  script_name(english:"RHEL 8 : Red Hat Product OCP Tools 4.15 OpenShift Jenkins (RHSA-2024:5405)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat Product OCP Tools 4.15 OpenShift Jenkins.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:5405 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_5405.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?df2708f5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:5405");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Product OCP Tools 4.15 OpenShift Jenkins package based on the guidance in RHSA-2024:5405.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.15.1723440333-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jenkins-2.462.1.1723440104-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
