...
# extracted from Fedora Security Advisory FEDORA-2023-f844a8fa64
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f844a8fa64");

  script_name(english:"Fedora 39 : webkitgtk (2023-f844a8fa64)");
...
FEDORA-2023-f844a8fa64 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f844a8fa64");
...
var pkgs = [
    {'reference':'webkitgtk-2.42.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
