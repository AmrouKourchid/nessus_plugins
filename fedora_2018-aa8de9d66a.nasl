...
# extracted from Fedora Security Advisory FEDORA-2018-aa8de9d66a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : python-pip / python3 / python3-docs (2018-aa8de9d66a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-aa8de9d66a");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"python-pip-9.0.3-1.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"python3-3.6.5-1.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"python3-docs-3.6.5-1.fc26")) flag++;
