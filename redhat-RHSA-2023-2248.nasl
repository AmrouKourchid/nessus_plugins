...
# extracted from Red Hat Security Advisory RHSA-2023:2248. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2248");

  script_name(english:"RHEL 9 : xorg-x11-server (RHSA-2023:2248)");
...
referenced in the RHSA-2023:2248 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2248.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92e3c2d2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2148292");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2172116");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2248");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xorg-x11-server package based on the guidance in RHSA-2023:2248.");
  ...
  script_cwe_id(120, 121, 125, 404, 416);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-common-1.20.11-17.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-devel-1.20.11-17.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-source-1.20.11-17.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xdmx-1.20.11-17.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xephyr-1.20.11-17.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xnest-1.20.11-17.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xorg-1.20.11-17.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xorg-x11-server-Xvfb-1.20.11-17.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
