...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 23.04 : runC vulnerabilities (USN-6088-1)");
...
vulnerabilities as referenced in the USN-6088-1 advisory.
    ...
    It was discovered that runC incorrectly made /sys/fs/cgroup writable when in rootless mode. An attacker
    could possibly use this issue to escalate privileges. (CVE-2023-25809)

    It was discovered that runC incorrectly performed access control when mounting /proc to non-directories.
    An attacker could possibly use this issue to escalate privileges. (CVE-2023-27561)

    It was discovered that runC incorrectly handled /proc and

    /sys mounts inside a container. An attacker could possibly use this issue to bypass AppArmor, and
    potentially SELinux. (CVE-2023-28642)
