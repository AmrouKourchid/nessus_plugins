...
# Oracle Linux Security Advisory ELSA-2015-1510 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : clutter (ELSA-2015-1510)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2015-1510 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-1510.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected clutter, clutter-devel and / or clutter-doc packages.");
...
var pkgs = [
    {'reference':'clutter-1.14.4-12.el7_1.1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'clutter-devel-1.14.4-12.el7_1.1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'clutter-doc-1.14.4-12.el7_1.1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'clutter-1.14.4-12.el7_1.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'clutter-devel-1.14.4-12.el7_1.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'clutter-doc-1.14.4-12.el7_1.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
