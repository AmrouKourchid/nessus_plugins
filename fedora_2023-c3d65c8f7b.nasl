...
# extracted from Fedora Security Advisory FEDORA-2023-c3d65c8f7b
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-22845", "CVE-2023-24472", "CVE-2023-24473");
  script_xref(name:"FEDORA", value:"2023-c3d65c8f7b");

  script_name(english:"Fedora 37 : OpenImageIO (2023-c3d65c8f7b)");
...
FEDORA-2023-c3d65c8f7b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c3d65c8f7b");
...
"Update the affected OpenImageIO package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-24473");
...
var pkgs = [
    {'reference':'OpenImageIO-2.4.8.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
