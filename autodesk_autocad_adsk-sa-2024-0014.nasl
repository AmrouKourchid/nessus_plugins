...
if (description)
{
  ...
  script_name(english:"Autodesk AutoCAD 25.0.x < 25.0.101.0 (2025.1) (adsk-sa-2024-0014)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of Autodesk AutoCAD installed on the remote host is prior to 25.0.101.0 (2025.1). It is, therefore, affected
by a vulnerability as referenced in the adsk-sa-2024-0014 advisory.
...
"Upgrade to Autodesk AutoCAD version 25.0.101.0 (2025.1) or later.");
