...
# extracted from Fedora Security Advisory FEDORA-2022-e4460c41bc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e4460c41bc");

  script_name(english:"Fedora 37 : kernel (2022-e4460c41bc)");
...
FEDORA-2022-e4460c41bc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e4460c41bc");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2022-e4460c41bc');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.0.11-300.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
