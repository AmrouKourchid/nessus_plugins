...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : curl (EulerOS-SA-2023-3121)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3121
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?faf28760");
...
var pkgs = [
  "curl-7.61.1-2.h30.eulerosv2r8",
  "libcurl-7.61.1-2.h30.eulerosv2r8",
  "libcurl-devel-7.61.1-2.h30.eulerosv2r8"
];
