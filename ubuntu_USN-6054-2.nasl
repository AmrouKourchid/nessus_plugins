...
# extracted from Ubuntu Security Notice USN-6054-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6054-2");

  script_name(english:"Ubuntu 16.04 ESM : Django vulnerability (USN-6054-2)");
...
USN-6054-2 advisory.
    ...
    USN-6054-1 fixed a vulnerability in Django. This update provides the corresponding update for Ubuntu 14.04
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6054-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-django', 'pkgver': '1.8.7-1ubuntu5.15+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-django-common', 'pkgver': '1.8.7-1ubuntu5.15+esm7', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-django', 'pkgver': '1.8.7-1ubuntu5.15+esm7', 'ubuntu_pro': TRUE}
];
