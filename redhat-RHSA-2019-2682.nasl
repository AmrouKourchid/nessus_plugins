...
if (description)
{
  ...
  script_name(english:"RHEL 7 : go-toolset-1.11 and go-toolset-1.11-golang (RHSA-2019:2682)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for go-toolset-1.11 / go-toolset-1.11-golang.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2019:2682 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2682.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d98fbae");
...
"Update the RHEL go-toolset-1.11 / go-toolset-1.11-golang packages based on the guidance in RHSA-2019:2682.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'go-toolset-1.11-1.11.13-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-build-1.11.13-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-1.11.13-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-bin-1.11.13-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-docs-1.11.13-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-misc-1.11.13-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-race-1.11.13-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-src-1.11.13-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-golang-tests-1.11.13-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-runtime-1.11.13-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'go-toolset-1.11-scldevel-1.11.13-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
