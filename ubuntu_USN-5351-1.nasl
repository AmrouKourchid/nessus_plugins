...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Paramiko vulnerability (USN-5351-1)");
...
in the USN-5351-1 advisory.

    Jan Schejbal discovered that Paramiko incorrectly handled permissions when writing private key files. A
    local attacker could possibly use this issue to gain access to private keys.
