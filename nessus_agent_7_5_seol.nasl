...
if (description)
{
  ...
  script_name(english:"Tenable Nessus Agent SEoL (7.5.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus Agent is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus Agent is 7.5.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of Tenable Nessus Agent that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2021/06/30");
...
var constraints = [
  { max_branch : '7.5', min_branch : '7.5', seol : 20210630, eseol : 20211231 }
];
