...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5033371");
  script_xref(name:"MSFT", value:"MS23-5033371");
  script_xref(name:"IAVA", value:"2023-A-0689-S");
  script_xref(name:"IAVA", value:"2023-A-0690-S");

  script_name(english:"KB5033371: Windows 10 version 1809 / Windows Server 2019 Security Update (December 2023)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5033371");
