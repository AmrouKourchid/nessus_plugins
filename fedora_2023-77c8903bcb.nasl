...
# extracted from Fedora Security Advisory FEDORA-2023-77c8903bcb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-77c8903bcb");

  script_name(english:"Fedora 38 : xorg-x11-server-Xwayland (2023-77c8903bcb)");
...
FEDORA-2023-77c8903bcb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-77c8903bcb");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-22.1.9-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
