...
# Rocky Linux Security Advisory RLSA-2023:5838.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:5838");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"Rocky Linux 9 : nghttp2 (RLSA-2023:5838)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:5838");
...
var pkgs = [
    ...
    {'reference':'libnghttp2-debuginfo-1.43.0-5.el9_2.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'nghttp2-debuginfo-1.43.0-5.el9_2.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nghttp2-debugsource-1.43.0-5.el9_2.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
