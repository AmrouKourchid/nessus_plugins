...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Freetype2 PHSA-2017-0041");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-8105");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'freetype2-2.7.1-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'freetype2-debuginfo-2.7.1-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'freetype2-devel-2.7.1-4.ph1')) flag++;
