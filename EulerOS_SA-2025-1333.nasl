...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP13 : golang (EulerOS-SA-2025-1333)");
...
the following vulnerabilities :
    ...
    Due to the usage of a variable time instruction in the assembly implementation of an internal function, a
    small number of bits of secret scalars are leaked on the ppc64le architecture. Due to the way this
    function is used, we do not believe this leakage is enough to allow recovery of the private key when P-256
    is used in any well known protocols.(CVE-2025-22866)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1333
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e7337573");
...
var pkgs = [
  "golang-1.21.4-8.h110.eulerosv2r13",
  "golang-devel-1.21.4-8.h110.eulerosv2r13",
  "golang-help-1.21.4-8.h110.eulerosv2r13"
];
