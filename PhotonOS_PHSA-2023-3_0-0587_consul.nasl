...
if (description)
{
  ...
  script_cve_id("CVE-2021-41803", "CVE-2022-29153", "CVE-2022-40716");

  script_name(english:"Photon OS 3.0: Consul PHSA-2023-3.0-0587");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'consul-1.11.9-1.ph3')) flag++;
