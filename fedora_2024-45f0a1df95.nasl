...
# extracted from Fedora Security Advisory FEDORA-2024-45f0a1df95
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-45f0a1df95");

  script_name(english:"Fedora 38 : prometheus-podman-exporter (2024-45f0a1df95)");
...
FEDORA-2024-45f0a1df95 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-45f0a1df95");
...
var pkgs = [
    {'reference':'prometheus-podman-exporter-1.11.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
