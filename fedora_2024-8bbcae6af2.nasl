...
# extracted from Fedora Security Advisory FEDORA-2024-8bbcae6af2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8bbcae6af2");

  script_name(english:"Fedora 40 : amavis (2024-8bbcae6af2)");
...
FEDORA-2024-8bbcae6af2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8bbcae6af2");
...
var pkgs = [
    {'reference':'amavis-2.13.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
