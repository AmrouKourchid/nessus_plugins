...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : ruby (EulerOS-SA-2024-2226)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2226
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2dbe6f1");
...
var pkgs = [
  "ruby-3.0.3-128.h8.eulerosv2r12",
  "ruby-help-3.0.3-128.h8.eulerosv2r12",
  "ruby-irb-3.0.3-128.h8.eulerosv2r12"
];
