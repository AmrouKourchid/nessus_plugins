...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : kernel (EulerOS-SA-2024-2002)");
...
is affected by the following vulnerabilities :
    ...
    __skb_gso_segment+0x339/0x710 net/core/gso.c:124 skb_gso_segment include
    et/gso.h:83 [inline] validate_xmit_skb+0x36c/0xeb0 net/core/dev.c:3626 __dev_queue_xmit+0x6f3/0x3d60
    net/core/dev.c:4338 dev_queue_xmit include/linux
    etdevice.h:3134 [inline] packet_xmit+0x257/0x380 net/packet/af_packet.c:276 packet_snd
    net/packet/af_packet.c:3087 [inline] packet_sendmsg+0x24c6/0x5220 net/packet/af_packet.c:3119
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2002
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?becfc4ab");
