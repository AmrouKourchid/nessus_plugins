...
# extracted from F5 Networks BIG-IP Solution K20850144.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-41964");
  script_xref(name:"IAVA", value:"2023-A-0537-S");

  script_name(english:"F5 Networks BIG-IP : BIG-IP and BIG-IQ DB Variable Vulnerability (K20850144)");
...
It is, therefore, affected by a vulnerability as referenced in the K20850144 advisory.
...
self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K20850144");
...
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K20850144.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-41964");
