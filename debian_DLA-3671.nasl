...
# extracted from Debian Security Advisory dla-3671. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3671 : mediawiki - security update");
...
"Upgrade the mediawiki packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-45362");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'mediawiki', 'reference': '1:1.31.16-1+deb10u7'},
    {'release': '10.0', 'prefix': 'mediawiki-classes', 'reference': '1:1.31.16-1+deb10u7'}
];
