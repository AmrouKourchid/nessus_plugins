...
# extracted from Red Hat Security Advisory RHSA-2024:2735. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2735");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.1 (python-paramiko) (RHSA-2024:2735)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2735.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f1351b4a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2735");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.1 (python-paramiko) package based on the guidance in RHSA-2024:2735.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-paramiko-2.11.0-2.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
