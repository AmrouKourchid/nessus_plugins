...
# extracted from Red Hat Security Advisory RHSA-2023:2283. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2283");

  script_name(english:"RHEL 9 : skopeo (RHSA-2023:2283)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for skopeo.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:2283 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2283.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06d6941e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2182318");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2283");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL skopeo package based on the guidance in RHSA-2023:2283.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'skopeo-1.11.2-0.1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'skopeo-tests-1.11.2-0.1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
