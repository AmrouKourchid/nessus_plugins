...
# extracted from Fedora Security Advisory FEDORA-2018-cdccabb23d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : glpi (2018-cdccabb23d)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"add upstream patch to fix SQL injection

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-cdccabb23d");
...
"Update the affected glpi package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-13049");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"glpi-9.1.7.1-3.fc27")) flag++;
