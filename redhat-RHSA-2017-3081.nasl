...
referenced in the RHSA-2017:3081 advisory.
    ...
    * A vulnerability was discovered in Tomcat where the CORS Filter did not send a Vary: Origin HTTP
    header. This potentially allowed sensitive data to be leaked to other visitors through both client-side
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_3081.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0ac7ce77");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1480618");
...
"Update the RHEL tomcat package based on the guidance in RHSA-2017:3081.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'tomcat-7.0.76-3.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-admin-webapps-7.0.76-3.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-docs-webapp-7.0.76-3.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-el-2.2-api-7.0.76-3.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-javadoc-7.0.76-3.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-jsp-2.2-api-7.0.76-3.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-jsvc-7.0.76-3.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-lib-7.0.76-3.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-servlet-3.0-api-7.0.76-3.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tomcat-webapps-7.0.76-3.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
