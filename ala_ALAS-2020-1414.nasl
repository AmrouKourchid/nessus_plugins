...
"The version of keepalived installed on the remote host is prior to 1.2.13-8.5. It is, therefore, affected by a
vulnerability as referenced in the ALAS-2020-1414 advisory.

    keepalived 2.0.8 didn't check for pathnames with symlinks when writing data to a temporary file upon a
    call to PrintData or PrintStats. This allowed local users to overwrite arbitrary files if
    fs.protected_symlinks is set to 0, as demonstrated by a symlink from /tmp/keepalived.data or
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2018-19044");
...
var pkgs = [
    {'reference':'keepalived-1.2.13-8.5.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'keepalived-1.2.13-8.5.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'keepalived-debuginfo-1.2.13-8.5.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'keepalived-debuginfo-1.2.13-8.5.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
