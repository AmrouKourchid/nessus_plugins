...
# extracted from Fedora Security Advisory FEDORA-2023-e359fd31d2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e359fd31d2");

  script_name(english:"Fedora 38 : podman-tui (2023-e359fd31d2)");
...
FEDORA-2023-e359fd31d2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e359fd31d2");
...
var pkgs = [
    {'reference':'podman-tui-0.12.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
