...
# extracted from F5 Networks BIG-IP Solution K21350967.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenSSH vulnerability (K21350967)");
...
affected by a vulnerability as referenced in the K21350967 advisory.
    ...
    well (for example, to overwrite the .ssh/authorized_keys file).(CVE-2019-6111)ImpactImproper validation of
    object names allows a malicious server to overwrite files through the OpenSSH SCPclient.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K21350967");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K21350967.");
