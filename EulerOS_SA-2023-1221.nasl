...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : gcc (EulerOS-SA-2023-1221)");
...
affected by the following vulnerabilities :
  ...
  - Rejected reason: DO NOT USE THIS CANDIDATE NUMBER. ConsultIDs: none. Reason: This candidate was withdrawn
    by its CNA. Further investigation showed that it was not a security issue. Notes: none. (CVE-2020-35536,
    CVE-2020-35537)

Note that Tenable Network Security has extracted the preceding description block directly from the EulerOS security
advisory. Tenable has attempted to automatically clean and format it as much as possible without introducing additional
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1221
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7af1ca95");
...
var pkgs = [
  "gcc-7.3.0-20210605.41.h45.eulerosv2r9",
  "gcc-c++-7.3.0-20210605.41.h45.eulerosv2r9",
  "gcc-gfortran-7.3.0-20210605.41.h45.eulerosv2r9",
  "gcc-objc++-7.3.0-20210605.41.h45.eulerosv2r9",
  "gcc-objc-7.3.0-20210605.41.h45.eulerosv2r9",
  "libgcc-7.3.0-20210605.41.h45.eulerosv2r9"
];
