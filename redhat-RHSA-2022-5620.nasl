...
# extracted from Red Hat Security Advisory RHSA-2022:5620. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5620");

  script_name(english:"RHEL 8 : 389-ds:1.4 (RHSA-2022:5620)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for 389-ds:1.4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:5620 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5620.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?561b8dd0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5620");
...
"Update the RHEL 389-ds:1.4 package based on the guidance in RHSA-2022:5620.");
  ...
  '389-ds:1.4': [
    {
      ...
      'pkgs': [
        {'reference':'389-ds-base-1.4.3.16-21.module+el8.4.0+15657+e1585ac1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-devel-1.4.3.16-21.module+el8.4.0+15657+e1585ac1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-legacy-tools-1.4.3.16-21.module+el8.4.0+15657+e1585ac1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-libs-1.4.3.16-21.module+el8.4.0+15657+e1585ac1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'389-ds-base-snmp-1.4.3.16-21.module+el8.4.0+15657+e1585ac1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-lib389-1.4.3.16-21.module+el8.4.0+15657+e1585ac1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
