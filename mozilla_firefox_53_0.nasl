...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox < 53 Multiple Vulnerabilities");
...
prior to 53. It is, therefore, affected by the following
vulnerabilities :
...
mozilla_check_version(installs:installs, product:'firefox', fix:'53', severity:SECURITY_HOLE);
