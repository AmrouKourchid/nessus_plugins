...
# extracted from Debian Security Advisory dla-3175. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3175 : idle-python3.7 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3175
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'idle-python3.7', 'reference': '3.7.3-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libpython3.7', 'reference': '3.7.3-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libpython3.7-dbg', 'reference': '3.7.3-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libpython3.7-dev', 'reference': '3.7.3-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libpython3.7-minimal', 'reference': '3.7.3-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libpython3.7-stdlib', 'reference': '3.7.3-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libpython3.7-testsuite', 'reference': '3.7.3-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python3.7', 'reference': '3.7.3-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python3.7-dbg', 'reference': '3.7.3-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python3.7-dev', 'reference': '3.7.3-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python3.7-doc', 'reference': '3.7.3-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python3.7-examples', 'reference': '3.7.3-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python3.7-minimal', 'reference': '3.7.3-2+deb10u4'},
    {'release': '10.0', 'prefix': 'python3.7-venv', 'reference': '3.7.3-2+deb10u4'}
];
