...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Python PHSA-2023-3.0-0681");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'python-cryptography-3.1.1-2.ph3')) flag++;
