...
# extracted from Ubuntu Security Notice USN-5333-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5333-2");
  script_xref(name:"IAVA", value:"2022-A-0124-S");

  script_name(english:"Ubuntu 16.04 ESM : Apache HTTP Server vulnerabilities (USN-5333-2)");
...
the USN-5333-2 advisory.

    USN-5333-1 fixed several vulnerabilities in Apache. This update provides the corresponding update for
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5333-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'apache2', 'pkgver': '2.4.18-2ubuntu3.17+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-bin', 'pkgver': '2.4.18-2ubuntu3.17+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-data', 'pkgver': '2.4.18-2ubuntu3.17+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-dev', 'pkgver': '2.4.18-2ubuntu3.17+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-suexec-custom', 'pkgver': '2.4.18-2ubuntu3.17+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-suexec-pristine', 'pkgver': '2.4.18-2ubuntu3.17+esm5', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'apache2-utils', 'pkgver': '2.4.18-2ubuntu3.17+esm5', 'ubuntu_pro': TRUE}
];
