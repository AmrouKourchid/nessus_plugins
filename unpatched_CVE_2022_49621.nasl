...
if (description)
{
  ...
  script_cve_id("CVE-2022-49621");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49621");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: cpufreq: pmac32-cpufreq: Fix refcount
    leak bug In pmac_cpufreq_init_MacRISC3(), we need to add corresponding of_node_put() for the three node
    pointers whose refcount have been incremented by of_find_node_by_name(). (CVE-2022-49621)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49621");
