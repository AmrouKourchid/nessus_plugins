...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : ghostscript (EulerOS-SA-2020-1100)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1100
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7b1b54e7");
...
pkgs = ["ghostscript-9.07-31.6.h13.eulerosv2r7",
        "ghostscript-cups-9.07-31.6.h13.eulerosv2r7"];
