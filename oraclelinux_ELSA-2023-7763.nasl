...
# extracted from Oracle Linux Security Advisory ELSA-2023-7763.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : runc (ELSA-2023-7763)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-7763.html");
