...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Samba regression (USN-5142-3)");
...
USN-5142-3 advisory.
    ...
    USN-5142-1 fixed vulnerabilities in Samba. Some of the upstream changes introduced a regression in
    Kerberos authentication in certain environments.
