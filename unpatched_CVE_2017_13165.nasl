...
if (description)
{
  ...
  script_cve_id("CVE-2017-13165");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-13165");
...
patch available.
  ...
  - An elevation of privilege vulnerability in the kernel file system. Product: Android. Versions: Android
    kernel. Android ID A-31269937. (CVE-2017-13165)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-13165");
