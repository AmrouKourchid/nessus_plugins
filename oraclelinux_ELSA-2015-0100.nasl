...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-0100.html");
...
var pkgs = [
    ...
    {'reference':'libyaml-0.1.4-11.el7_0', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libyaml-devel-0.1.4-11.el7_0', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
