...
USN-4560-1 advisory.
    ...
    It was discovered that Gon gem did not properly escape certain input. An attacker could use this
    vulnerability to execute a cross-site scripting (XSS) attack.
