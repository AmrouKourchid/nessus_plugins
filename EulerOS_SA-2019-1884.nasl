...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libx11 (EulerOS-SA-2019-1884)");
...
vulnerabilities :
  ...
  - libX11: Off-by-one error in XListExtensions in
    ListExt.c (CVE-2018-14599)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1884
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f890ae2");
...
pkgs = ["libX11-1.6.5-1.h2.eulerosv2r7",
        "libX11-common-1.6.5-1.h2.eulerosv2r7",
        "libX11-devel-1.6.5-1.h2.eulerosv2r7"];
