...
# extracted from VMware Security Advisory PHSA-2024-4.0-0598. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Kubernetes PHSA-2024-4.0-0598");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the kubernetes package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-598.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'kubernetes-1.27.13-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'kubernetes-kubeadm-1.27.13-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'kubernetes-pause-1.27.13-1.ph4')) flag++;
