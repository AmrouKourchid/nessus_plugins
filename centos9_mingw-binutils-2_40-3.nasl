...
if (description)
{
  ...
  script_cve_id("CVE-2022-4285", "CVE-2023-1972", "CVE-2023-25587");

  script_name(english:"CentOS 9 : mingw-binutils-2.40-3.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for mingw-binutils-generic.");
...
mingw-binutils-2.40-3.el9 build changelog.
  ...
  - Rejected reason: DO NOT USE THIS CANDIDATE NUMBER. ConsultIDs: none. Reason: This candidate was withdrawn
    by its CNA. Further investigation showed that it was not a security issue. Notes: none. (CVE-2023-25587)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=34780");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream mingw-binutils-generic package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:ucrt64-binutils");
...
var pkgs = [
    {'reference':'mingw-binutils-generic-2.40-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mingw32-binutils-2.40-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mingw64-binutils-2.40-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ucrt64-binutils-2.40-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw-binutils-generic / mingw32-binutils / mingw64-binutils / etc');
}
