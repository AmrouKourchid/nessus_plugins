...
# extracted from Fedora Security Advisory FEDORA-2018-a675aa39fc.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-a675aa39fc");

  script_name(english:"Fedora 28 : subscription-manager (2018-a675aa39fc)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a675aa39fc");
  script_set_attribute(attribute:"solution", value:
"Update the affected subscription-manager package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-2663");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"subscription-manager-1.24.2-1.fc28")) flag++;
