...
# extracted from Red Hat Security Advisory RHSA-2021:1620. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : linux-firmware (RHSA-2021:1620)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:1620 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1620.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f07633e");
