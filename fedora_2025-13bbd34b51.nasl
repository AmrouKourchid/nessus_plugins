...
# extracted from Fedora Security Advisory FEDORA-2025-13bbd34b51
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-13bbd34b51");
  script_xref(name:"IAVA", value:"2025-A-0079-S");

  script_name(english:"Fedora 41 : firefox (2025-13bbd34b51)");
...
FEDORA-2025-13bbd34b51 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-13bbd34b51");
...
var pkgs = [
    {'reference':'firefox-135.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
