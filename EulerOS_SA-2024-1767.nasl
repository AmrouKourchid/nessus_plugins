...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : libxml2 (EulerOS-SA-2024-1767)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1767
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b31fd088");
...
var pkgs = [
  "libxml2-2.9.14-4.h16.eulerosv2r12",
  "python3-libxml2-2.9.14-4.h16.eulerosv2r12"
];
