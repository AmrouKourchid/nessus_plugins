...
# extracted from Fedora Security Advisory FEDORA-2024-a56a47ef1b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a56a47ef1b");

  script_name(english:"Fedora 38 : kernel (2024-a56a47ef1b)");
...
FEDORA-2024-a56a47ef1b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a56a47ef1b");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2024-a56a47ef1b');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.8.5-101.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
