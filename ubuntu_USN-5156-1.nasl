...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : ICU vulnerability (USN-5156-1)");
...
USN-5156-1 advisory.
    ...
    It was discovered that ICU contains a double free issue. An attacker could use this issue to cause a
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'icu-devtools / libicu-dev / libicu66');
}
