...
# extracted from Red Hat Security Advisory autotrace. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : autotrace (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-19005");
