...
# extracted from Red Hat Security Advisory RHSA-2023:0852. The text
...
referenced in the RHSA-2023:0852 advisory.
    ...
    * httpd-init fails to create localhost.crt, localhost.key due to sscg default now creates a
    /dhparams.pem and is not idempotent if the file /dhparams.pem already exists. (BZ#2165967)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0852.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8277b2a8");
...
"Update the RHEL httpd:2.4 package based on the guidance in RHSA-2023:0852.");
  ...
  'httpd:2.4': [
    {
      ...
      'pkgs': [
        {'reference':'httpd-2.4.37-51.module+el8.7.0+18026+7b169787.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-devel-2.4.37-51.module+el8.7.0+18026+7b169787.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-filesystem-2.4.37-51.module+el8.7.0+18026+7b169787.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-manual-2.4.37-51.module+el8.7.0+18026+7b169787.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'httpd-tools-2.4.37-51.module+el8.7.0+18026+7b169787.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_http2-1.15.7-5.module+el8.6.0+13996+01710940', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ldap-2.4.37-51.module+el8.7.0+18026+7b169787.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_md-2.0.8-8.module+el8.3.0+6814+67d1e611', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_proxy_html-2.4.37-51.module+el8.7.0+18026+7b169787.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'mod_session-2.4.37-51.module+el8.7.0+18026+7b169787.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_ssl-2.4.37-51.module+el8.7.0+18026+7b169787.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
