...
# extracted from Fedora Security Advisory FEDORA-2023-1e5af38524
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1e5af38524");

  script_name(english:"Fedora 37 : perl-CPAN (2023-1e5af38524)");
...
FEDORA-2023-1e5af38524 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1e5af38524");
...
var pkgs = [
    {'reference':'perl-CPAN-2.36-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
