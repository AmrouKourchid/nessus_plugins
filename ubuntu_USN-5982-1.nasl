...
# extracted from Ubuntu Security Notice USN-5982-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5982-1");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/04/20");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : Linux kernel vulnerabilities (USN-5982-1)");
...
referenced in the USN-5982-1 advisory.

    It was discovered that the KVM VMX implementation in the Linux kernel did not properly handle indirect
    branch prediction isolation between L1 and L2 VMs. An attacker in a guest VM could use this to expose
    sensitive information from the host OS or other guest VMs. (CVE-2022-2196)
    ...
    attributes in certain situations, leading to an out-of-bounds write vulnerability. A local attacker could
    use this to cause a denial of service (system crash). (CVE-2022-48423)

    It was discovered that the NTFS file system implementation in the Linux kernel did not properly validate
    attributes in certain situations, leading to an out-of-bounds read vulnerability. A local attacker could
    possibly use this to expose sensitive information (kernel memory). (CVE-2022-48424)
    ...
    It was discovered that the KSMBD implementation in the Linux kernel did not properly validate buffer
    lengths, leading to a heap-based buffer overflow. A remote attacker could possibly use this to cause a
    denial of service (system crash). (CVE-2023-0210)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5982-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1017-gkeop");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1026-raspi");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1026-raspi-nolpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1031-gcp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1032-oracle");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1033-aws");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1035-azure");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1035-azure-fde");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-69-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-69-generic-64k");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-69-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-69-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-69-lowlatency-64k");
...
var kernel_mappings = {
  '20.04': {
    '5.15.0': {
      'generic': '5.15.0-69',
      'generic-64k': '5.15.0-69',
      'generic-lpae': '5.15.0-69',
      'lowlatency': '5.15.0-69',
      'lowlatency-64k': '5.15.0-69',
      'gcp': '5.15.0-1031',
      'oracle': '5.15.0-1032',
      'aws': '5.15.0-1033',
      'azure': '5.15.0-1035'
  ...
  '22.04': {
    '5.15.0': {
      ...
      'gkeop': '5.15.0-1017',
      'raspi': '5.15.0-1026',
      'raspi-nolpae': '5.15.0-1026',
      'gcp': '5.15.0-1031',
      'oracle': '5.15.0-1032',
      'aws': '5.15.0-1033',
      'azure-fde': '5.15.0-1035'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5982-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2022-2196', 'CVE-2022-3424', 'CVE-2022-4382', 'CVE-2022-36280', 'CVE-2022-41218', 'CVE-2022-48423', 'CVE-2022-48424', 'CVE-2023-0045', 'CVE-2023-0210', 'CVE-2023-0266', 'CVE-2023-23454', 'CVE-2023-23455', 'CVE-2023-23559', 'CVE-2023-26606', 'CVE-2023-28328');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5982-1');
  }
  else
  {
