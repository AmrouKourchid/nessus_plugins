...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : libldb (EulerOS-SA-2024-2421)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libldb package installed, the EulerOS installation on the remote host is affected by
the following vulnerabilities :

    MaxQueryDuration not honoured in Samba AD DC LDAP(CVE-2021-3670)

Tenable has extracted the preceding description block directly from the EulerOS libldb security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2421
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0bfad9f");
...
var pkgs = [
  "libldb-2.0.12-1.h5.eulerosv2r10"
];
