...
if (description)
{
  ...
  script_name(english:"Security Update for Microsoft .NET Core (April 2025)");
...
vulnerability as referenced in the vendor advisory.
  ...
  - Allocation of resources without limits or throttling in ASP.NET Core allows an unauthorized attacker to
    deny service over a network. (CVE-2025-26682)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://dotnet.microsoft.com/download/dotnet/8.0");
  script_set_attribute(attribute:"see_also", value:"https://dotnet.microsoft.com/download/dotnet/9.0");
  script_set_attribute(attribute:"see_also", value:"https://github.com/dotnet/announcements/issues/353");
  # https://github.com/dotnet/core/blob/main/release-notes/8.0/8.0.15/8.0.15.md
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f84a2dd2");
  # https://github.com/dotnet/core/blob/main/release-notes/9.0/9.0.4/9.0.4.md
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a63b5dd1");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-26682");
...
var constraints = [
  { 'min_version' : '8.0.0', 'fixed_version' : '8.0.15' },
