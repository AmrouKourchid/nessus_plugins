...
# extracted from Fedora Security Advisory FEDORA-2023-3a821e6e73
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3a821e6e73");

  script_name(english:"Fedora 36 : bzip3 (2023-3a821e6e73)");
...
FEDORA-2023-3a821e6e73 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3a821e6e73");
...
var pkgs = [
    {'reference':'bzip3-1.3.0-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
