...
if (description)
{
  ...
  script_cve_id("CVE-2013-3006");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-3006");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment (JRE) in IBM Java 7 before 7 SR5 allows remote
    ...
    vulnerability than CVE-2013-3008. (CVE-2013-3006)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-3006");
