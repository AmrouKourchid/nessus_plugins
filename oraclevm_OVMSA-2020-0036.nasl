...
# Security Advisory OVMSA-2020-0036.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.4 : python (OVMSA-2020-0036)");
...
critical security updates :
  ...
  - Prefix dot in domain for proper subdomain validation");
  # https://oss.oracle.com/pipermail/oraclevm-errata/2020-September/000997.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba1412e9");
...
flag = 0;
if (rpm_check(release:"OVS3.4", reference:"python-2.6.6-68.0.2.el6_10")) flag++;
if (rpm_check(release:"OVS3.4", reference:"python-libs-2.6.6-68.0.2.el6_10")) flag++;
