...
if (description)
{
  ...
  script_cve_id("CVE-2024-9780", "CVE-2024-9781");
  script_xref(name:"IAVB", value:"2024-B-0153-S");

  script_name(english:"Wireshark 4.4.x < 4.4.1 Multiple Vulnerabilities (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote macOS / Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote macOS / Mac OS X host is prior to 4.4.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the wireshark-4.4.1 advisory.

  - ITS dissector crash in Wireshark 4.4.0 allows denial of service via packet injection or crafted capture
    file (CVE-2024-9780)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/docs/relnotes/wireshark-4.4.1.html");
  script_set_attribute(attribute:"see_also", value:"https://gitlab.com/wireshark/wireshark/-/issues/20026");
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/security/wnpa-sec-2024-12");
...
"Upgrade to Wireshark version 4.4.1 or later.");
