...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : openldap (EulerOS-SA-2022-2096)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2096
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?65224219");
...
"Update the affected openldap packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:openldap-help");
...
var pkgs = [
  "openldap-2.4.50-3.h12.eulerosv2r10",
  "openldap-clients-2.4.50-3.h12.eulerosv2r10",
  "openldap-devel-2.4.50-3.h12.eulerosv2r10",
  "openldap-help-2.4.50-3.h12.eulerosv2r10",
  "openldap-servers-2.4.50-3.h12.eulerosv2r10"
];
