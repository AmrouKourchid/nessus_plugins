...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Binutils PHSA-2017-2.0-0008");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-17125");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'binutils-2.29.1-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'binutils-debuginfo-2.29.1-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'binutils-devel-2.29.1-4.ph2')) flag++;
