...
if (description)
{
  ...
  script_cve_id("CVE-2024-26934");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-26934");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: USB: core: Fix deadlock in
    ...
    sysfs_break_active_protection() function, which tells sysfs not to wait for the attribute callback.
