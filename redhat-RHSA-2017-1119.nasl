...
# extracted from Red Hat Security Advisory RHSA-2017:1119. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:1119");

  script_name(english:"RHEL 7 : java-1.6.0-sun (RHSA-2017:1119)");
...
referenced in the RHSA-2017:1119 advisory.
    ...
    * This update fixes multiple vulnerabilities in the Oracle Java Runtime Environment and the Oracle Java
    ...
    Critical Patch Update Advisory page, listed in the References section. (CVE-2017-3509, CVE-2017-3526,
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?923274e8");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_1119.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6dbc575");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:1119");
...
"Update the RHEL java-1.6.0-sun package based on the guidance in RHSA-2017:1119.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.6.0-sun-1.6.0.151-1jpp.1.el7_3', 'cpu':'i686', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-1.6.0.151-1jpp.1.el7_3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-demo-1.6.0.151-1jpp.1.el7_3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-devel-1.6.0.151-1jpp.1.el7_3', 'cpu':'i686', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-devel-1.6.0.151-1jpp.1.el7_3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-jdbc-1.6.0.151-1jpp.1.el7_3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-plugin-1.6.0.151-1jpp.1.el7_3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.6.0-sun-src-1.6.0.151-1jpp.1.el7_3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_3', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
