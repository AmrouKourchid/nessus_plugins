...
# extracted from Fedora Security Advisory FEDORA-2023-5f5bea627b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5f5bea627b");

  script_name(english:"Fedora 37 : gerbv (2023-5f5bea627b)");
...
FEDORA-2023-5f5bea627b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5f5bea627b");
...
"Update the affected gerbv package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-40393");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:gerbv");
...
var pkgs = [
    {'reference':'gerbv-2.9.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
