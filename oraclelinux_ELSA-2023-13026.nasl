...
# extracted from Oracle Linux Security Advisory ELSA-2023-13026.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : edk2 (ELSA-2023-13026)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-13026.html");
...
var pkgs = [
    {'reference':'OVMF-1.6.6-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
