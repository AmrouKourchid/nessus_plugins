...
# extracted from Fedora Security Advisory FEDORA-2023-54dae7b78a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-54dae7b78a");
  script_xref(name:"IAVA", value:"2023-A-0124-S");

  script_name(english:"Fedora 37 : httpd (2023-54dae7b78a)");
...
FEDORA-2023-54dae7b78a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-54dae7b78a");
...
var pkgs = [
    {'reference':'httpd-2.4.56-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
