...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL6.x i386/x86_64 (20190919)");
...
Security Fix(es) :
  ...
  - Mozilla: Cross-origin access to unload event attributes
    (CVE-2019-11743)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1909&L=SCIENTIFIC-LINUX-ERRATA&P=13208
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5800317a");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"thunderbird-60.9.0-1.el6_10", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"thunderbird-debuginfo-60.9.0-1.el6_10", allowmaj:TRUE)) flag++;
