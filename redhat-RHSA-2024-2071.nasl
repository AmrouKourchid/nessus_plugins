...
# extracted from Red Hat Security Advisory RHSA-2024:2071. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2071");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.15.11 (RHSA-2024:2071)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.15.11.");
...
in the RHSA-2024:2071 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.15.11. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2071.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8942f6ba");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268854");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2071");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.15.11 packages based on the guidance in RHSA-2024:2071.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'skopeo-1.11.3-0.1.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube'},
      {'reference':'skopeo-tests-1.11.3-0.1.rhaos4.15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'skopeo-1.11.3-0.1.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube'},
      {'reference':'skopeo-tests-1.11.3-0.1.rhaos4.15.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openshift-hyperkube'}
    ]
  }
];
