...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Curl PHSA-2020-2.0-0304");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'curl-7.59.0-12.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'curl-devel-7.59.0-12.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'curl-libs-7.59.0-12.ph2')) flag++;
