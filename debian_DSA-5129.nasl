...
dsa-5129 advisory.
    ...
    distribution (buster), these problems have been fixed in version 91.9.0esr-1~deb10u1. For the stable
    distribution (bullseye), these problems have been fixed in version 91.9.0esr-1~deb11u1. We recommend that
