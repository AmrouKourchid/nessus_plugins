...
# extracted from Red Hat Security Advisory RHSA-2025:1726. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1726");
  script_xref(name:"IAVB", value:"2025-B-0028");

  script_name(english:"RHEL 9 : postgresql (RHSA-2025:1726)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1726.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7fa85d1a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1726");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql package based on the guidance in RHSA-2025:1726.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postgresql-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-contrib-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-docs-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plperl-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plpython3-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-pltcl-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-private-devel-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-private-libs-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-devel-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-static-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-devel-13.20-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
