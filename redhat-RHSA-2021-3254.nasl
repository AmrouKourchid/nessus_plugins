...
referenced in the RHSA-2021:3254 advisory.
  ...
  - python-babel: Relative path traversal allows attacker to load arbitrary locale files and execute arbitrary
    code (CVE-2021-20095, CVE-2021-42771)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?814bf75b");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2021/rhsa-2021_3254.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad5577f2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/articles/5860431");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1969523");
...
"Update the affected packages.");
  ...
  script_cwe_id(20, 22, 252, 74, 79, 95, 119, 120, 200, 385, 400, 444, 835);
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-python38-babel");
