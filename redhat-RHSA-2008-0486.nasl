...
# extracted from Red Hat Security Advisory RHSA-2008:0486. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : nfs-utils (RHSA-2008:0486)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2008/rhsa-2008_0486.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5acb564e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=440114");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2008:0486");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nfs-utils package based on the guidance in RHSA-2008:0486.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nfs-utils-1.0.9-35z.el5_2', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nfs-utils-1.0.9-35z.el5_2', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nfs-utils-1.0.9-35z.el5_2', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nfs-utils-1.0.9-35z.el5_2', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
