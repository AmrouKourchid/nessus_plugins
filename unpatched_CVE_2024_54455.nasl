...
if (description)
{
  ...
  script_cve_id("CVE-2024-54455");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-54455");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: accel/ivpu: Fix general protection
    fault in ivpu_bo_list() Check if ctx is not NULL before accessing its fields. (CVE-2024-54455)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-54455");
