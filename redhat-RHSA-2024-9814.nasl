...
# extracted from Red Hat Security Advisory RHSA-2024:9814. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9814");

  script_name(english:"RHEL 8 : squid:4 (RHSA-2024:9814)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for squid:4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:9814 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9814.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b885d4f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9814");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid:4 package based on the guidance in RHSA-2024:9814.");
  ...
  'squid:4': [
    {
      ...
      'pkgs': [
        {'reference':'libecap-1.0.1-2.module+el8.1.0+4044+36416a77', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libecap-1.0.1-2.module+el8.1.0+4044+36416a77', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libecap-devel-1.0.1-2.module+el8.1.0+4044+36416a77', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libecap-devel-1.0.1-2.module+el8.1.0+4044+36416a77', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'squid-4.15-3.module+el8.6.0+22491+132fca59.7', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
        {'reference':'squid-4.15-3.module+el8.6.0+22491+132fca59.7', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
      ]
    }
  ]
};
