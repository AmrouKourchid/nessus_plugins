...
# extracted from Fedora Security Advisory FEDORA-2020-7f91f10f2b.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : 1:wireshark (2020-7f91f10f2b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7f91f10f2b");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"wireshark-3.2.6-1.fc32", epoch:"1")) flag++;
