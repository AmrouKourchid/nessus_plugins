...
referenced in the RHSA-2017:2258 advisory.

    The gtk-vnc packages provide a VNC viewer widget for GTK. The gtk-vnc widget is built by using co-
    routines, which allows the widget to be completely asynchronous while remaining single-threaded.

    The following packages have been upgraded to a later upstream version: gtk-vnc (0.7.0). (BZ#1416783)

    Security Fix(es):

    * It was found that gtk-vnc lacked proper bounds checking while processing messages using RRE, hextile, or
    copyrect encodings. A remote malicious VNC server could use this flaw to crash VNC viewers which are based
    on the gtk-vnc library. (CVE-2017-5884)

    * An integer overflow flaw was found in gtk-vnc. A remote malicious VNC server could use this flaw to
    crash VNC viewers which are based on the gtk-vnc library. (CVE-2017-5885)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_2258.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f79fd3a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2258");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1126825");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1416783");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1418944");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1418952");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1441120");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=921008");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=921330");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gtk-vnc-0.7.0-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk-vnc-devel-0.7.0-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk-vnc-python-0.7.0-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk-vnc2-0.7.0-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gtk-vnc2-devel-0.7.0-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gvnc-0.7.0-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gvnc-devel-0.7.0-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gvnc-tools-0.7.0-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gvncpulse-0.7.0-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gvncpulse-devel-0.7.0-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
