...
local user may acquire elevated privileges.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K20934447");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K20934447.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '14.0.0-14.1.0','13.0.0-13.1.1','12.1.0-12.1.4','11.2.1-11.6.3'
    ],
    'unaffected': [
      '15.0.0','14.1.0.6','14.0.1.1','13.1.1.5','12.1.5','11.6.4'
    ],
  },
  'AM': {
    'affected': [
