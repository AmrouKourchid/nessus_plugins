...
"The remote Red Hat host is missing a security update for polkit-qt.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2014:1359 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_1359.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8de98628");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1359");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1094890");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL polkit-qt package based on the guidance in RHSA-2014:1359.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'polkit-qt-0.103.0-10.el7_0', 'cpu':'i686', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-qt-0.103.0-10.el7_0', 'cpu':'ppc', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-qt-0.103.0-10.el7_0', 'cpu':'ppc64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-qt-0.103.0-10.el7_0', 'cpu':'s390', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-qt-0.103.0-10.el7_0', 'cpu':'s390x', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-qt-0.103.0-10.el7_0', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-qt-devel-0.103.0-10.el7_0', 'cpu':'i686', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-qt-devel-0.103.0-10.el7_0', 'cpu':'ppc', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-qt-devel-0.103.0-10.el7_0', 'cpu':'ppc64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-qt-devel-0.103.0-10.el7_0', 'cpu':'s390', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-qt-devel-0.103.0-10.el7_0', 'cpu':'s390x', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-qt-devel-0.103.0-10.el7_0', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'polkit-qt-doc-0.103.0-10.el7_0', 'release':'7', 'el_string':'el7_0', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
