...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 102.13. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2023-24 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'102.13', severity:SECURITY_HOLE);
