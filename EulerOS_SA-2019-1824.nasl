...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : postgresql (EulerOS-SA-2019-1824)");
...
vulnerability :
  ...
  - PostgreSQL versions 10.x before 10.9 and versions 11.x
    before 11.4 are vulnerable to a stack-based buffer
    overflow. Any authenticated user can overflow a
    stack-based buffer by changing the user's own password
    to a purpose-crafted value. This often suffices to
    execute arbitrary code as the PostgreSQL operating
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1824
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2bd9ebba");
...
pkgs = ["postgresql-10.5-3.h2.eulerosv2r8",
        "postgresql-contrib-10.5-3.h2.eulerosv2r8",
        "postgresql-devel-10.5-3.h2.eulerosv2r8",
        "postgresql-docs-10.5-3.h2.eulerosv2r8",
        "postgresql-libs-10.5-3.h2.eulerosv2r8",
        "postgresql-plperl-10.5-3.h2.eulerosv2r8",
        "postgresql-plpython-10.5-3.h2.eulerosv2r8",
        "postgresql-pltcl-10.5-3.h2.eulerosv2r8",
        "postgresql-server-10.5-3.h2.eulerosv2r8",
        "postgresql-test-10.5-3.h2.eulerosv2r8"];
