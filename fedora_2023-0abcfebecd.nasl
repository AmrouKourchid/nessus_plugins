...
# extracted from Fedora Security Advisory FEDORA-2023-0abcfebecd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0abcfebecd");

  script_name(english:"Fedora 40 : exim (2023-0abcfebecd)");
...
FEDORA-2023-0abcfebecd advisory.

    Automatic update for exim-4.96.1-1.fc40.

    ##### **Changelog**

    ```
    * Mon Oct  2 2023 Jaroslav karvada <jskarvad@redhat.com> - 4.96.1-1
    - New version
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0abcfebecd");
...
var pkgs = [
    {'reference':'exim-4.96.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
