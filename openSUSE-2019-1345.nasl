...
# extracted from openSUSE Security Update openSUSE-2019-1345.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : wpa_supplicant (openSUSE-2019-1345)");
...
This non-security issue was fixed :
  ...
  - Enabled PWD as EAP method. This allows for
    password-based authentication, which is easier to setup
    than most of the other methods, and is used by the
    Eduroam network (bsc#1109209).

This update was imported from the SUSE:SLE-12:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1104205");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1109209");
...
if ( rpm_check(release:"SUSE42.3", reference:"wpa_supplicant-2.6-16.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"wpa_supplicant-debuginfo-2.6-16.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"wpa_supplicant-debugsource-2.6-16.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"wpa_supplicant-gui-2.6-16.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"wpa_supplicant-gui-debuginfo-2.6-16.1") ) flag++;
