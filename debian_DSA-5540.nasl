...
# extracted from Debian Security Advisory dsa-5540. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5540-1 : jetty9 - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-36478");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'jetty9', 'reference': '9.4.50-4+deb11u1'},
    {'release': '11.0', 'prefix': 'libjetty9-extra-java', 'reference': '9.4.50-4+deb11u1'},
    {'release': '11.0', 'prefix': 'libjetty9-java', 'reference': '9.4.50-4+deb11u1'},
    {'release': '12.0', 'prefix': 'jetty9', 'reference': '9.4.50-4+deb12u2'},
    {'release': '12.0', 'prefix': 'libjetty9-extra-java', 'reference': '9.4.50-4+deb12u2'},
    {'release': '12.0', 'prefix': 'libjetty9-java', 'reference': '9.4.50-4+deb12u2'}
];
