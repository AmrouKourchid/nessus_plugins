...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.11.52 (RHSA-2023:5717)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing one or more security updates for OpenShift Container Platform 4.11.52.");
...
as referenced in the RHSA-2023:5717 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.11.52 packages based on the guidance in RHSA-2023:5717.");
...
var pkgs = [
    {'reference':'openshift-hyperkube-4.11.0-202310140343.p0.gec2a592.assembly.stream.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
