...
# extracted from Fedora Security Advisory FEDORA-2025-8445f115f6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-8445f115f6");

  script_name(english:"Fedora 40 : perl / perl-Devel-Cover / perl-PAR-Packer (2025-8445f115f6)");
...
FEDORA-2025-8445f115f6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-8445f115f6");
...
var pkgs = [
    {'reference':'perl-5.38.4-508.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
    {'reference':'perl-Devel-Cover-1.40-9.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'perl-PAR-Packer-1.063-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
