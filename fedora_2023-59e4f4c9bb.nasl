...
# extracted from Fedora Security Advisory FEDORA-2023-59e4f4c9bb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-59e4f4c9bb");

  script_name(english:"Fedora 38 : godot (2023-59e4f4c9bb)");
...
FEDORA-2023-59e4f4c9bb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-59e4f4c9bb");
...
var pkgs = [
    {'reference':'godot-4.1.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
