...
# SUSE update advisory SUSE-SU-2022:4534-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4534-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 19 for SLE 15 SP3) (SUSE-SU-2022:4534-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 / SLES_SAP15 host has packages installed that are affected by multiple vulnerabilities as
referenced in the SUSE-SU-2022:4534-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013265.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8ec9564");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-5_3_18-150200_24_129-default and / or kernel-livepatch-5_3_18-150300_59_71-default
packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150200.24.129-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150200_24_129-default-3-150200.2.1', 'sp':'2', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
          {'reference':'kernel-livepatch-5_3_18-150200_24_129-default-3-150200.2.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.2', 'sle-module-live-patching-release-15.2', 'sles-release-15.2']}
        ]
      },
      '5.3.18-150300.59.71-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_71-default-9-150300.2.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
          {'reference':'kernel-livepatch-5_3_18-150300_59_71-default-9-150300.2.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-live-patching-release-15.3', 'sles-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150200_24_129-default / etc');
}
