...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : libX11 (EulerOS-SA-2020-1191)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1191
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?afb5660c");
...
pkgs = ["libX11-1.6.5-1.h3",
        "libX11-common-1.6.5-1.h3"];
