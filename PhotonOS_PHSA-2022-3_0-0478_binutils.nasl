...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Binutils PHSA-2022-3.0-0478");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'binutils-2.32-7.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'binutils-devel-2.32-7.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'binutils-libs-2.32-7.ph3')) flag++;
