...
if (description)
{
  ...
  script_cve_id("CVE-2017-3526");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-3526");
...
patch available.
  ...
  - Vulnerability in the Java SE, Java SE Embedded, JRockit component of Oracle Java SE (subcomponent: JAXP).
    ...
    JRockit: R28.3.13. Difficult to exploit vulnerability allows unauthenticated attacker with network access
    ...
    Web Start applications or sandboxed Java applets, such as through a web service. (CVE-2017-3526)
