...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : xmlrpc-c (EulerOS-SA-2024-2961)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the xmlrpc-c package installed, the EulerOS installation on the remote host is affected by
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2961
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d4c81136");
  script_set_attribute(attribute:"solution", value:
"Update the affected xmlrpc-c packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:xmlrpc-c-help");
...
var pkgs = [
  "xmlrpc-c-help-1.51.08-2.h1.eulerosv2r12"
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "xmlrpc-c");
}
