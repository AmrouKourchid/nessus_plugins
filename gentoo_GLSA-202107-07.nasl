...
# extracted from Gentoo Linux Security Advisory GLSA 202107-07.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2019-25013", "CVE-2020-27618", "CVE-2021-27645", "CVE-2021-3326", "CVE-2021-33574");
  script_xref(name:"GLSA", value:"202107-07");

  script_name(english:"GLSA-202107-07 : glibc: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-07
...
if (qpkg_check(package:"sys-libs/glibc", unaffected:make_list("ge 2.33-r1"), vulnerable:make_list("lt 2.33-r1"))) flag++;
