...
file is processed.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=987505");
  # https://security-tracker.debian.org/tracker/source-package/libimage-exiftool-perl
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?df5f9b2e");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/libimage-exiftool-perl");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2021/dsa-4910");
