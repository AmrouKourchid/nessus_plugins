...
if (description)
{
  ...
  script_cve_id("CVE-2024-26822");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-26822");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: smb: client: set correct id, uid and
    cruid for multiuser automounts When uid, gid and cruid are not specified, we need to dynamically set them
    into the filesystem context used for automounting otherwise they'll end up reusing the values from the
    parent mount. (CVE-2024-26822)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-26822");
