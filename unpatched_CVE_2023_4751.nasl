...
if (description)
{
  ...
  script_cve_id("CVE-2023-4751");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-4751");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2023/09/03");
