...
if (description)
{
  ...
  script_cve_id("CVE-2025-30179");
  script_xref(name:"IAVA", value:"2025-A-0195-S");

  script_name(english:"Mattermost Server 9.11.x < 9.11.9 / 10.3.x < 10.3.4 / 10.4.x < 10.4.3 (MMSA-2025-00422)");
...
affected by a vulnerability as referenced in the MMSA-2025-00422 advisory.

  - Mattermost versions 10.4.x <= 10.4.2, 10.3.x <= 10.3.3, 9.11.x <= 9.11.8 fail to enforce MFA on certain
    search APIs, which allows authenticated attackers to bypass MFA protections via user search, channel
    search, or team search queries. (CVE-2025-30179)
...
"Upgrade to Mattermost Server version 9.11.9 / 10.3.4 / 10.4.3 / 10.5.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-30179");
