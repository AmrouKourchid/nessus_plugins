...
if (description)
{
  ...
  script_name(english:"Fortinet FortiWeb ] Restricted user can execute arbitrary commands with root privileges (OS command Injection). (FG-IR-20-120)");
...
vulnerability as referenced in the FG-IR-20-120 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-20-120");
  script_set_attribute(attribute:"solution", value:
"Please upgrade to FortiWeb version 6.3.8 or later.");
...
var constraints = [
  { 'min_version' : '5.9.0', 'max_version' : '5.9.0', 'fixed_version' : '6.3.8' },
  { 'min_version' : '6.0.0', 'max_version' : '6.0.0', 'fixed_version' : '6.3.8' },
  { 'min_version' : '6.1.0', 'max_version' : '6.1.0', 'fixed_version' : '6.3.8' },
  { 'min_version' : '6.2.0', 'max_version' : '6.2.3', 'fixed_version' : '6.3.8' },
