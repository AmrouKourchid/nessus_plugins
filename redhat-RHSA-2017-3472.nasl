...
# extracted from Red Hat Security Advisory RHSA-2017:3472. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:3472");

  script_name(english:"RHEL 7 : qemu-kvm-rhev (RHSA-2017:3472)");
...
referenced in the RHSA-2017:3472 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_3472.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1bd0e93");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:3472");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2017:3472.");
