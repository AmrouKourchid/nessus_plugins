...
# extracted from Gentoo Linux Security Advisory GLSA 202007-38.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2020-12267");
  script_xref(name:"GLSA", value:"202007-38");

  script_name(english:"GLSA-202007-38 : QtGui: Arbitrary code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-38
(QtGui: Arbitrary code execution)

    QtGui&rsquo;s setMarkdown has a use-after-free related to
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-38");
...
"All QtGui users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-12267");
...
if (qpkg_check(package:"dev-qt/qtgui", unaffected:make_list("ge 5.14.2"), vulnerable:make_list("lt 5.14.2"))) flag++;
