...
# extracted from Fedora Security Advisory FEDORA-2025-cddcfd6518
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-cddcfd6518");

  script_name(english:"Fedora 41 : matrix-synapse (2025-cddcfd6518)");
...
FEDORA-2025-cddcfd6518 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-cddcfd6518");
...
var pkgs = [
    {'reference':'matrix-synapse-1.118.0-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
