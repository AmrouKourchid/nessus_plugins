...
"The remote Red Hat host is missing a security update for devtoolset-9-gcc.");
...
the RHSA-2020:2274 advisory.
    ...
    languages, including C, C++, and Fortran. The devtoolset-9-gcc packages provide the Red Hat Developer
    ...
    * Update gcc for DTS 9.1 from upstream GCC 9.3 (BZ#1812147)
    ...
    For detailed changes in this release, see the Red Hat Developer Toolset 9.1 User Guide linked from the
    References section.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2274.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b2aeba51");
  # https://access.redhat.com/documentation/en-us/red_hat_developer_toolset/9/html/user_guide/appe-changes_in_version_9.1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c83975b8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2274");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1755523");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1769410");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1783475");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1802608");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1812147");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL devtoolset-9-gcc package based on the guidance in RHSA-2020:2274.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'devtoolset-9-gcc-9.3.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-9-gcc-c++-9.3.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-9-gcc-gdb-plugin-9.3.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-9-gcc-gfortran-9.3.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-9-gcc-plugin-devel-9.3.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'devtoolset-9-libgccjit-docs-9.3.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-9-libitm-devel-9.3.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-9-liblsan-devel-9.3.1-2.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'devtoolset-9-libstdc++-docs-9.3.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-9-libtsan-devel-9.3.1-2.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'liblsan-9.3.1-2.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'libtsan-9.3.1-2.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'devtoolset-9-gcc / devtoolset-9-gcc-c++ / etc');
}
