...
# extracted from Fedora Security Advisory FEDORA-2024-9283a3b879
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9283a3b879");

  script_name(english:"Fedora 41 : python-urllib3 (2024-9283a3b879)");
...
FEDORA-2024-9283a3b879 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9283a3b879");
...
var pkgs = [
    {'reference':'python-urllib3-1.26.19-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
