...
# extracted from Fedora Security Advisory FEDORA-2022-74a9c8e95f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-74a9c8e95f");

  script_name(english:"Fedora 37 : moodle (2022-74a9c8e95f)");
...
FEDORA-2022-74a9c8e95f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-74a9c8e95f");
...
var pkgs = [
    {'reference':'moodle-4.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
