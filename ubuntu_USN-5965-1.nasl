...
USN-5965-1 advisory.
    ...
    It was discovered that TigerVNC mishandled TLS certificate exceptions. An attacker could use this
    vulnerability to impersonate any server after a client had added an exception and obtain sensitive
    information.
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'tigervnc-common', 'pkgver': '1.10.1+dfsg-3ubuntu0.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'tigervnc-scraping-server', 'pkgver': '1.10.1+dfsg-3ubuntu0.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'tigervnc-standalone-server', 'pkgver': '1.10.1+dfsg-3ubuntu0.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'tigervnc-viewer', 'pkgver': '1.10.1+dfsg-3ubuntu0.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'tigervnc-xorg-extension', 'pkgver': '1.10.1+dfsg-3ubuntu0.1+esm2', 'ubuntu_pro': TRUE}
];
