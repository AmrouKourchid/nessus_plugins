...
# extracted from Fedora Security Advisory FEDORA-2023-d9c91f39a5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d9c91f39a5");

  script_name(english:"Fedora 37 : jpegoptim (2023-d9c91f39a5)");
...
FEDORA-2023-d9c91f39a5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d9c91f39a5");
...
"Update the affected jpegoptim package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-32325");
...
var pkgs = [
    {'reference':'jpegoptim-1.5.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
