...
# CentOS Errata and Security Advisory 2020:0199 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : openslp (RHSA-2020:0199)");
...
var pkgs = [
    {'reference':'openslp-2.0.0-4.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openslp-devel-2.0.0-4.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openslp-server-2.0.0-4.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
