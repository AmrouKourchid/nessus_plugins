...
# extracted from Oracle Linux Security Advisory ELSA-2024-9456.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : osbuild-composer (ELSA-2024-9456)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9456.html");
...
var pkgs = [
    {'reference':'osbuild-composer-118-2.0.1.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'osbuild-composer-core-118-2.0.1.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'osbuild-composer-worker-118-2.0.1.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'osbuild-composer-118-2.0.1.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'osbuild-composer-core-118-2.0.1.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'osbuild-composer-worker-118-2.0.1.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
