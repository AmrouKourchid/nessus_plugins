...
# extracted from Fedora Security Advisory FEDORA-2024-4afd3d38ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4afd3d38ae");
  script_xref(name:"IAVB", value:"2024-B-0038");

  script_name(english:"Fedora 39 : rpm-ostree (2024-4afd3d38ae)");
...
FEDORA-2024-4afd3d38ae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4afd3d38ae");
...
var pkgs = [
    {'reference':'rpm-ostree-2024.4-6.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
