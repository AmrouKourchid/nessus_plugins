...
# extracted from Fedora Security Advisory FEDORA-2023-00b3e9d551
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-00b3e9d551");

  script_name(english:"Fedora 38 : grafana-pcp (2023-00b3e9d551)");
...
FEDORA-2023-00b3e9d551 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-00b3e9d551");
...
var pkgs = [
    {'reference':'grafana-pcp-5.1.1-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
