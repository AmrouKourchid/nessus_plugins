...
# extracted from Oracle Linux Security Advisory ELSA-2020-3970.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : mod_auth_openidc (ELSA-2020-3970)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-3970.html");
...
var pkgs = [
    {'reference':'mod_auth_openidc-1.8.8-7.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
