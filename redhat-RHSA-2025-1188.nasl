...
# extracted from Red Hat Security Advisory RHSA-2025:1188. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1188");

  script_name(english:"RHEL 9 : buildah (RHSA-2025:1188)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1188.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00955760");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1188");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL buildah package based on the guidance in RHSA-2025:1188.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.33.12-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'buildah-tests-1.33.12-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
