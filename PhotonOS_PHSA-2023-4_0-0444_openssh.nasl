...
# extracted from VMware Security Advisory PHSA-2023-4.0-0444. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Openssh PHSA-2023-4.0-0444");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openssh package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-444.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-8.9p1-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-clients-8.9p1-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'openssh-server-8.9p1-2.ph4')) flag++;
