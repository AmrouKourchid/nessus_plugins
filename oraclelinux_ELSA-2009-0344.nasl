...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : libsoup (ELSA-2009-0344)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0344.html");
...
"Update the affected libsoup and / or libsoup-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0585");
...
var pkgs = [
    {'reference':'libsoup-2.2.98-2.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libsoup-devel-2.2.98-2.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libsoup-2.2.98-2.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libsoup-devel-2.2.98-2.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
