...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-2416.html");
...
var pkgs = [
    ...
    {'reference':'unbound-devel-1.7.3-11.el8_2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'unbound-libs-1.7.3-11.el8_2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
