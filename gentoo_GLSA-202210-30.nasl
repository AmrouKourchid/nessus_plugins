...
# extracted from Gentoo Linux Security Advisory GLSA 202210-30.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202210-30 : X.Org X server, XWayland: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202210-30 (X.Org X server, XWayland: Multiple
Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202210-30");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=857780");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 21.1.4", "lt 21.0.0"),
    'vulnerable' : make_list("lt 21.1.4")
  },
  {
    'name' : 'x11-base/xwayland',
    'unaffected' : make_list("ge 22.1.3", "lt 22.0.0"),
    'vulnerable' : make_list("lt 22.1.3")
  }
];
