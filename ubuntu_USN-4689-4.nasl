...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Linux kernel update (USN-4689-4)");
...
referenced in the USN-4689-4 advisory.

    USN-4689-3 fixed vulnerabilities in the NVIDIA server graphics drivers. This update provides the
    corresponding updates for the NVIDIA Linux DKMS kernel modules.
...
var kernel_mappings = {
  '18.04': {
    '4.15.0': {
      'generic': '4.15.0-134',
      'generic-lpae': '4.15.0-134',
      'lowlatency': '4.15.0-134'
    },
    '5.4.0': {
      'generic': '5.4.0-64',
      'generic-lpae': '5.4.0-64',
      'lowlatency': '5.4.0-64'
    }
  },
  '20.04': {
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4689-4');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2021-1052', 'CVE-2021-1053');
