...
# extracted from Fedora Security Advisory FEDORA-2023-be842ba7fb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-be842ba7fb");

  script_name(english:"Fedora 37 : mingw-LibRaw (2023-be842ba7fb)");
...
FEDORA-2023-be842ba7fb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-be842ba7fb");
...
var pkgs = [
    {'reference':'mingw-LibRaw-0.20.2-8.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
