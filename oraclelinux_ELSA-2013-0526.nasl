...
# Oracle Linux Security Advisory ELSA-2013-0526 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : automake (ELSA-2013-0526)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-0526.html");
...
var pkgs = [
    {'reference':'automake-1.11.1-4.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
