...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2023:0817");
  script_xref(name:"IAVA", value:"2023-A-0106-S");

  script_name(english:"Scientific Linux Security Update : thunderbird on SL7.x x86_64 (2023:0817)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20230817-1");
...
var pkgs = [
    {'reference':'thunderbird-102.8.0-2.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-102.8.0-2.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
