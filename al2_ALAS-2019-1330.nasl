...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1330.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1330");

  script_name(english:"Amazon Linux 2 : perl-Archive-Tar (ALAS-2019-1330)");
...
interpreter.(CVE-2018-12015)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1330.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"perl-Archive-Tar-1.92-3.amzn2")) flag++;
