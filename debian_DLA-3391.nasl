...
if (description)
{
  ...
  script_name(english:"Debian dla-3391 : firefox-esr - security update");
...
var pkgs = [
    ...
    {'release': '10.0', 'prefix': 'firefox-esr-l10n-fur', 'reference': '102.10.0esr-1~deb10u1'},
    ...
    {'release': '10.0', 'prefix': 'firefox-esr-l10n-sc', 'reference': '102.10.0esr-1~deb10u1'},
    ...
    {'release': '10.0', 'prefix': 'firefox-esr-l10n-tg', 'reference': '102.10.0esr-1~deb10u1'},
    ...
    {'release': '10.0', 'prefix': 'iceweasel-l10n-fur', 'reference': '102.10.0esr-1~deb10u1'},
    ...
    {'release': '10.0', 'prefix': 'iceweasel-l10n-sc', 'reference': '102.10.0esr-1~deb10u1'},
    ...
    {'release': '10.0', 'prefix': 'iceweasel-l10n-tg', 'reference': '102.10.0esr-1~deb10u1'},
