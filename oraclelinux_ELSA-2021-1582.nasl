...
# extracted from Oracle Linux Security Advisory ELSA-2021-1582.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : cpio (ELSA-2021-1582)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-1582.html");
