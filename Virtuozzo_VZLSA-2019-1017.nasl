...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : ghostscript / ghostscript-cups / ghostscript-devel / etc (VZLSA-2019-1017)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2019-1017.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a2bfa94");
...
pkgs = ["ghostscript-9.07-31.vl7.11",
        "ghostscript-cups-9.07-31.vl7.11",
        "ghostscript-devel-9.07-31.vl7.11",
        "ghostscript-doc-9.07-31.vl7.11",
        "ghostscript-gtk-9.07-31.vl7.11"];
