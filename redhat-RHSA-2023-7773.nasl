...
# extracted from Red Hat Security Advisory RHSA-2023:7773. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-5189", "CVE-2023-5764");
  script_xref(name:"IAVA", value:"2024-A-0126");
  script_xref(name:"RHSA", value:"2023:7773");

  script_name(english:"RHEL 8 / 9 : Red Hat Ansible Automation Platform 2.4 Product Security and Bug Fix Update (Moderate) (RHSA-2023:7773)");
...
referenced in the RHSA-2023:7773 advisory.
    ...
    * ansible-core: Template Injection (CVE-2023-5764)

    * python3-galaxy-importer/python39-galaxy-importer: insecure galaxy-importer tarfile extraction
    (CVE-2023-5189)
    ...
    Additional changes:
    * ansible-core has been updated to 2.15.8
    * python3-galaxy-importer/python39-galaxy-importer has been updated to 0.4.18

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7773.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e8bf6c1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2234387");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2247629");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7773");
  script_set_attribute(attribute:"solution", value:
"Update the affected ansible-core, python3-galaxy-importer and / or python39-galaxy-importer packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:C/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-5189");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-5764");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3x-galaxy-importer");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-core-2.15.8-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-5764']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python39-galaxy-importer-0.4.18-1.el8ap', 'release':'8', 'el_string':'el8ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-5189']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-core-2.15.8-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-5764']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-galaxy-importer-0.4.18-1.el9ap', 'release':'9', 'el_string':'el9ap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'automation-hub-2.4', 'cves':['CVE-2023-5189']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ansible-core / python3-galaxy-importer / python39-galaxy-importer');
}
