...
# extracted from Red Hat Security Advisory RHSA-2024:10966. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10966");

  script_name(english:"RHEL 8 : ruby:3.1 (RHSA-2024:10966)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ruby:3.1.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:10966 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10966.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1ee9182");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10966");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ruby:3.1 package based on the guidance in RHSA-2024:10966.");
  ...
  'ruby:3.1': [
    {
      ...
      'pkgs': [
        {'reference':'ruby-3.1.2-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-bundled-gems-3.1.2-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-default-gems-3.1.2-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-devel-3.1.2-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-doc-3.1.2-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-libs-3.1.2-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-abrt-0.4.0-1.module+el8.7.0+15051+29b42f0c', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-abrt-doc-0.4.0-1.module+el8.7.0+15051+29b42f0c', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-bigdecimal-3.1.1-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-bundler-2.3.7-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-io-console-0.5.11-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-irb-1.4.1-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-json-2.6.1-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-minitest-5.15.0-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-mysql2-0.5.3-2.module+el8.7.0+15051+29b42f0c', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-mysql2-doc-0.5.3-2.module+el8.7.0+15051+29b42f0c', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-pg-1.3.2-1.module+el8.7.0+15125+b11ff321', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-pg-doc-1.3.2-1.module+el8.7.0+15125+b11ff321', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-power_assert-2.0.1-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-psych-4.0.3-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rake-13.0.6-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rbs-2.1.0-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rdoc-6.4.0-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rexml-3.2.5-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rss-0.2.9-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-test-unit-3.5.3-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-typeprof-0.21.2-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-3.3.7-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-devel-3.3.7-142.module+el8.8.0+22637+76cde83a', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
