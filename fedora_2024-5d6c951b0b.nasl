...
# extracted from Fedora Security Advisory FEDORA-2024-5d6c951b0b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5d6c951b0b");

  script_name(english:"Fedora 41 : iwd (2024-5d6c951b0b)");
...
FEDORA-2024-5d6c951b0b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5d6c951b0b");
...
var pkgs = [
    {'reference':'iwd-2.22-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
