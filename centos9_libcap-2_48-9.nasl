...
if (description)
{
  ...
  script_name(english:"CentOS 9 : libcap-2.48-9.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates for libcap.");
...
libcap-2.48-9.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=34463");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream libcap package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:libcap-static");
...
var pkgs = [
    {'reference':'libcap-2.48-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libcap-devel-2.48-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libcap-static-2.48-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libcap / libcap-devel / libcap-static');
}
