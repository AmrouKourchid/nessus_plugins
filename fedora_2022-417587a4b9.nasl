...
# extracted from Fedora Security Advisory FEDORA-2022-417587a4b9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-417587a4b9");

  script_name(english:"Fedora 37 : slurm (2022-417587a4b9)");
...
FEDORA-2022-417587a4b9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-417587a4b9");
...
var pkgs = [
    {'reference':'slurm-21.08.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
