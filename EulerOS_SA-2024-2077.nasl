...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : tigervnc (EulerOS-SA-2024-2077)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2077
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9cf702d1");
...
var pkgs = [
  "tigervnc-1.8.0-5.h7.eulerosv2r7",
  "tigervnc-icons-1.8.0-5.h7.eulerosv2r7",
  "tigervnc-license-1.8.0-5.h7.eulerosv2r7",
  "tigervnc-server-1.8.0-5.h7.eulerosv2r7",
  "tigervnc-server-minimal-1.8.0-5.h7.eulerosv2r7"
];
