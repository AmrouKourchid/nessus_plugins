...
# extracted from Red Hat Security Advisory RHSA-2024:3701. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3701");

  script_name(english:"RHEL 8 : nghttp2 (RHSA-2024:3701)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for nghttp2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3701 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3701.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?27457c02");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268639");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3701");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nghttp2 package based on the guidance in RHSA-2024:3701.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libnghttp2-1.33.0-5.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnghttp2-devel-1.33.0-5.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nghttp2-1.33.0-5.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
