...
the USN-2388-1 advisory.

    A vulnerability was discovered in the OpenJDK JRE related to information disclosure and data integrity. An
    attacker could exploit this to expose sensitive data over the network. (CVE-2014-6457)

    Several vulnerabilities were discovered in the OpenJDK JRE related to data integrity. (CVE-2014-6502,
    CVE-2014-6512, CVE-2014-6519, CVE-2014-6527, CVE-2014-6558)

    Several vulnerabilities were discovered in the OpenJDK JRE related to information disclosure. An attacker
    could exploit these to expose sensitive data over the network. (CVE-2014-6504, CVE-2014-6511,
    CVE-2014-6517, CVE-2014-6531)

    Two vulnerabilities were discovered in the OpenJDK JRE related to information disclosure, data integrity
    and availability. An attacker could exploit these to cause a denial of service or expose sensitive data
    over the network. (CVE-2014-6506, CVE-2014-6513)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2388-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'icedtea-7-jre-jamvm', 'pkgver': '7u71-2.5.3-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-demo', 'pkgver': '7u71-2.5.3-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jdk', 'pkgver': '7u71-2.5.3-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre', 'pkgver': '7u71-2.5.3-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-headless', 'pkgver': '7u71-2.5.3-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-lib', 'pkgver': '7u71-2.5.3-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-zero', 'pkgver': '7u71-2.5.3-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-source', 'pkgver': '7u71-2.5.3-0ubuntu0.14.04.1'}
];
