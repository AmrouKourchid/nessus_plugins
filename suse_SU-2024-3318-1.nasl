...
# SUSE update advisory SUSE-SU-2024:3318-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:3318-1");

  script_name(english:"SUSE SLES15 Security Update : kernel RT (Live Patch 11 for SLE 15 SP5) (SUSE-SU-2024:3318-1)");
...
the SUSE-SU-2024:3318-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-updates/2024-September/036961.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8be842bb");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150500.13.38-rt-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150500_13_38-rt-6-150500.11.6.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.5']}
        ]
      }
    }
  }
