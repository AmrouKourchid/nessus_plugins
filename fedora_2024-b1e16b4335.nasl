...
# extracted from Fedora Security Advisory FEDORA-2024-b1e16b4335
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b1e16b4335");

  script_name(english:"Fedora 39 : trafficserver (2024-b1e16b4335)");
...
FEDORA-2024-b1e16b4335 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b1e16b4335");
...
var pkgs = [
    {'reference':'trafficserver-9.2.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
