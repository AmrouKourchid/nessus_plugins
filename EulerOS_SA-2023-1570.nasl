...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : containerd (EulerOS-SA-2023-1570)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1570
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f1cc81a");
...
var pkgs = [
  "docker-engine-18.09.0-300.h26.34.27.eulerosv2r11"
];
