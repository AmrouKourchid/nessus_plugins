...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0271.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38c41fa2");
...
"Update the RHEL polkit package based on the guidance in RHSA-2022:0271.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'polkit-0.112-18.el7_6.3', 'sp':'6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'polkit-devel-0.112-18.el7_6.3', 'sp':'6', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
