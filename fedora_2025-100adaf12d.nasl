...
# extracted from Fedora Security Advisory FEDORA-2025-100adaf12d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-100adaf12d");
  script_xref(name:"IAVA", value:"2025-A-0146-S");

  script_name(english:"Fedora 40 : firefox (2025-100adaf12d)");
...
FEDORA-2025-100adaf12d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-100adaf12d");
...
var pkgs = [
    {'reference':'firefox-136.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
