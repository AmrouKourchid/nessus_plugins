...
# extracted from Slackware Security Advisory 2018-325-01. The text 
...
if (description)
{
  ...
  script_xref(name:"SSA", value:"2018-325-01");

  script_name(english:"Slackware 14.0 / 14.1 / 14.2 / current : openssl (SSA:2018-325-01)");
...
fix security issues.");
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2018&m=slackware-security.576913
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?11f85267");
...
if (slackware_check(osver:"14.2", pkgname:"openssl", pkgver:"1.0.2q", pkgarch:"i586", pkgnum:"1_slack14.2")) flag++;
if (slackware_check(osver:"14.2", pkgname:"openssl-solibs", pkgver:"1.0.2q", pkgarch:"i586", pkgnum:"1_slack14.2")) flag++;
if (slackware_check(osver:"14.2", arch:"x86_64", pkgname:"openssl", pkgver:"1.0.2q", pkgarch:"x86_64", pkgnum:"1_slack14.2")) flag++;
if (slackware_check(osver:"14.2", arch:"x86_64", pkgname:"openssl-solibs", pkgver:"1.0.2q", pkgarch:"x86_64", pkgnum:"1_slack14.2")) flag++;

if (slackware_check(osver:"current", pkgname:"openssl", pkgver:"1.1.1a", pkgarch:"i586", pkgnum:"1")) flag++;
if (slackware_check(osver:"current", pkgname:"openssl-solibs", pkgver:"1.1.1a", pkgarch:"i586", pkgnum:"1")) flag++;
if (slackware_check(osver:"current", arch:"x86_64", pkgname:"openssl", pkgver:"1.1.1a", pkgarch:"x86_64", pkgnum:"1")) flag++;
if (slackware_check(osver:"current", arch:"x86_64", pkgname:"openssl-solibs", pkgver:"1.1.1a", pkgarch:"x86_64", pkgnum:"1")) flag++;
