...
USN-4530-1 advisory.
    ...
    Wolfgang Schweer discovered that Debian-LAN did not properly handle ACLs for the Kerberos admin server. A
    local attacker could possibly use this issue to change the passwords of other users, leading to root
    privilege escalation. (CVE-2019-3467)
