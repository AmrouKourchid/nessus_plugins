...
if (description)
{
  ...
  script_name(english:"F5 BIG-IP Edge Client Windows Component Installer 7.2.x < 7.2.3.1 DLL Hijacking (K76964818)");
...
in the BIG-IP Edge Client for Windows. (CVE-2023-22358)");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K76964818");
