...
in the USN-3429-1 advisory.

    Wang Junjie discovered that Libplist incorrectly handled certain files. If a user were tricked into
    opening a crafted file, an attacker could possibly use this to cause a crash or denial or service.
