...
# extracted from Ubuntu Security Notice USN-5409-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5409-1");

  script_name(english:"Ubuntu 16.04 ESM : libsndfile vulnerability (USN-5409-1)");
...
USN-5409-1 advisory.
    ...
    It was discovered that libsndfile was incorrectly performing memory management operations and incorrectly
    using buffers when executing its FLAC codec. If a user or automated system were tricked into processing a
    specially crafted sound file, an attacker could possibly use this issue to cause a denial of service or
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5409-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libsndfile1', 'pkgver': '1.0.25-10ubuntu0.16.04.3+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsndfile1-dev', 'pkgver': '1.0.25-10ubuntu0.16.04.3+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'sndfile-programs', 'pkgver': '1.0.25-10ubuntu0.16.04.3+esm2', 'ubuntu_pro': TRUE}
];
