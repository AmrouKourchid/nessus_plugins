...
# SUSE update advisory SUSE-SU-2022:0171-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:0171-1");

  script_name(english:"SUSE SLED15 / SLES15 Security Update : rust1.55 (SUSE-SU-2022:0171-1)");
...
the SUSE-SU-2022:0171-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-January/010068.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c4a8467a");
  script_set_attribute(attribute:"solution", value:
"Update the affected cargo1.55 and / or rust1.55 packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:cargo1.55");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:rust1.55");
...
var pkgs = [
    {'reference':'cargo1.55-1.55.0-150300.7.6.1', 'sp':'3', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-development-tools-release-15.3']},
    {'reference':'cargo1.55-1.55.0-150300.7.6.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-development-tools-release-15.3']},
    {'reference':'rust1.55-1.55.0-150300.7.6.1', 'sp':'3', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-development-tools-release-15.3']},
    {'reference':'rust1.55-1.55.0-150300.7.6.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-development-tools-release-15.3']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cargo1.55 / rust1.55');
}
