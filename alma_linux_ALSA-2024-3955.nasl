...
# AlmaLinux Security Advisory ALSA-2024:3955.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:3955");
  script_xref(name:"IAVA", value:"2024-A-0335-S");

  script_name(english:"AlmaLinux 9 : firefox (ALSA-2024:3955)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:3955 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-3955.html");
...
"Update the affected firefox and / or firefox-x11 packages.");
  ...
  script_cwe_id(120, 1287, 284, 385, 416, 829);
...
var pkgs = [
    {'reference':'firefox-115.12.0-1.el9_4.alma.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-115.12.0-1.el9_4.alma.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-x11-115.12.0-1.el9_4.alma.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-x11-115.12.0-1.el9_4.alma.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
