...
# extracted from Red Hat Security Advisory RHSA-2021:2391. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2391");
  script_xref(name:"IAVB", value:"2021-B-0036-S");

  script_name(english:"RHEL 8 : postgresql:9.6 (RHSA-2021:2391)");
...
referenced in the RHSA-2021:2391 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2391.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dbe5e6f4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2391");
...
"Update the RHEL postgresql:9.6 package based on the guidance in RHSA-2021:2391.");
  ...
  'postgresql:9.6': [
    {
      ...
      'pkgs': [
        {'reference':'postgresql-9.6.22-1.module+el8.2.0+11238+a7309cb6', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-9.6.22-1.module+el8.2.0+11238+a7309cb6', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-9.6.22-1.module+el8.2.0+11238+a7309cb6', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-9.6.22-1.module+el8.2.0+11238+a7309cb6', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-9.6.22-1.module+el8.2.0+11238+a7309cb6', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-9.6.22-1.module+el8.2.0+11238+a7309cb6', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-9.6.22-1.module+el8.2.0+11238+a7309cb6', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-9.6.22-1.module+el8.2.0+11238+a7309cb6', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-9.6.22-1.module+el8.2.0+11238+a7309cb6', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-9.6.22-1.module+el8.2.0+11238+a7309cb6', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-9.6.22-1.module+el8.2.0+11238+a7309cb6', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
