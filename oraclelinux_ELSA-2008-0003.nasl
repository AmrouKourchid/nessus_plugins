...
# Oracle Linux Security Advisory ELSA-2008-0003 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / e2fsprogs (ELSA-2008-0003)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0003.html");
...
var pkgs = [
    {'reference':'e2fsprogs-1.39-10.el5_1.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'e2fsprogs-devel-1.39-10.el5_1.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'e2fsprogs-libs-1.39-10.el5_1.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'e2fsprogs-1.39-10.el5_1.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'e2fsprogs-devel-1.39-10.el5_1.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'e2fsprogs-libs-1.39-10.el5_1.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
