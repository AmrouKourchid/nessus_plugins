...
the RHSA-2012:0310 advisory.

  - nfs-utils: mount.nfs fails to anticipate RLIMIT_FSIZE (CVE-2011-1749)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_0310.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7ded218");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:0310");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=697975");
...
"Update the affected nfs-utils package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-1749");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nfs-utils-1.0.9-60.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nfs-utils-1.0.9-60.el5', 'cpu':'ppc', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nfs-utils-1.0.9-60.el5', 'cpu':'s390x', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nfs-utils-1.0.9-60.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
