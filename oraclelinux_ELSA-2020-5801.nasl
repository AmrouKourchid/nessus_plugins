...
the ELSA-2020-5801 advisory.
    ...
    - media: rc: prevent memory leak in cx23888_ir_probe (Navid Emamdoost)  [Orabug: 31351672]
    {CVE-2019-19054}
    - vfio/pci: Fix SR-IOV VF handling with MMIO blocking (Alex Williamson)  [Orabug: 31439671]
    {CVE-2020-12888}
    ...
    31439671]  {CVE-2020-12888} {CVE-2020-12888}
    - vfio/pci: Pull BAR mapping setup from read-write path (Alex Williamson)  [Orabug: 31439671]
    {CVE-2020-12888}
    - vfio_pci: Enable memory accesses before calling pci_map_rom (Eric Auger)  [Orabug: 31439671]
    {CVE-2020-12888}
    ...
    - mm: bring in additional flag for fixup_user_fault to signal unlock (Dominik Dingel)  [Orabug: 31439671]
    {CVE-2020-12888}
    - vfio/type1: Fix VA->PA translation for PFNMAP VMAs in vaddr_get_pfn() (Sean Christopherson)  [Orabug:
    31439671]  {CVE-2020-12888}
    - can, slip: Protect tty->disc_data in write_wakeup and close with RCU (Richard Palethorpe)  [Orabug:
    31516085]  {CVE-2020-14416}
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-4.1.12-124.41.4.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-124.41.4.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'},
    ...
    {'reference':'kernel-uek-doc-4.1.12-124.41.4.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-124.41.4.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'}
];
