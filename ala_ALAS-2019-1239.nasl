...
# extracted from Amazon Linux AMI Security Advisory ALAS-2019-1239.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : vim (ALAS-2019-1239)");
...
(CVE-2019-12735)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2019-1239.html");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"vim-common-8.0.0503-1.46.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"vim-debuginfo-8.0.0503-1.46.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"vim-enhanced-8.0.0503-1.46.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"vim-filesystem-8.0.0503-1.46.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"vim-minimal-8.0.0503-1.46.amzn1")) flag++;
