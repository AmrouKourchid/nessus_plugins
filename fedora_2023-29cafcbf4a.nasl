...
# extracted from Fedora Security Advisory FEDORA-2023-29cafcbf4a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-29cafcbf4a");

  script_name(english:"Fedora 38 : tor (2023-29cafcbf4a)");
...
FEDORA-2023-29cafcbf4a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-29cafcbf4a");
...
var pkgs = [
    {'reference':'tor-0.4.8.9-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
