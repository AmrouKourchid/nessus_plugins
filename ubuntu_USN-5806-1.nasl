...
# extracted from Ubuntu Security Notice USN-5806-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5806-1");

  script_name(english:"Ubuntu 16.04 ESM : Ruby vulnerability (USN-5806-1)");
...
USN-5806-1 advisory.
    ...
    Hiroshi Tokumaru discovered that Ruby did not properly handle certain user input for applications which
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5806-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libruby2.3', 'pkgver': '2.3.1-2~ubuntu16.04.16+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ruby2.3', 'pkgver': '2.3.1-2~ubuntu16.04.16+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ruby2.3-dev', 'pkgver': '2.3.1-2~ubuntu16.04.16+esm4', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ruby2.3-tcltk', 'pkgver': '2.3.1-2~ubuntu16.04.16+esm4', 'ubuntu_pro': TRUE}
];
