...
# extracted from Red Hat Security Advisory RHSA-2024:9625. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9625");

  script_name(english:"RHEL 9 : squid (RHSA-2024:9625)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9625.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd7d3201");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9625");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid package based on the guidance in RHSA-2024:9625.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squid-5.5-14.el9_5.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
  }
];
