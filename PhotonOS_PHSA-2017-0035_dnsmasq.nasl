...
# extracted from VMware Security Advisory PHSA-2017-0035. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Dnsmasq PHSA-2017-0035");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the dnsmasq package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-74.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dnsmasq-2.76-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'dnsmasq-debuginfo-2.76-2.ph1')) flag++;
