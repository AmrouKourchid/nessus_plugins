...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : glibc (EulerOS-SA-2023-1064)");
...
affected by the following vulnerabilities :
  ...
  - In iconvdata/iso-2022-jp-3.c in the GNU C Library (aka glibc) 2.34, remote attackers can force iconv() to
    emit a spurious '\0' character via crafted ISO-2022-JP-3 data that is accompanied by an internal state
    reset. This may affect data integrity in certain iconv() use cases. NOTE: the vendor states 'the bug
    cannot be invoked through user input and requires iconv to be invoked with a NULL inbuf, which ought to
    require a separate application bug to do so unintentionally. Hence there's no security impact to the bug.
    (CVE-2021-43396)

Note that Tenable Network Security has extracted the preceding description block directly from the EulerOS security
advisory. Tenable has attempted to automatically clean and format it as much as possible without introducing additional
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1064
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3504bfb4");
...
var pkgs = [
  "glibc-2.17-222.h51.eulerosv2r7",
  "glibc-common-2.17-222.h51.eulerosv2r7",
  "glibc-devel-2.17-222.h51.eulerosv2r7",
  "glibc-headers-2.17-222.h51.eulerosv2r7",
  "nscd-2.17-222.h51.eulerosv2r7"
];
