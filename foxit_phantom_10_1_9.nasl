...
if (description)
{
  ...
  script_name(english:"Foxit PhantomPDF < 10.1.9 Multiple Vulnerabilities");
...
host is prior to 10.1.9. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PhantomPDF version 10.1.9 or later");
...
var constraints = [
  { 'max_version' : '10.1.8.37795', 'fixed_version' : '10.1.9' }
];
