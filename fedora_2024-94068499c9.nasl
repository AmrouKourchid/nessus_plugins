...
# extracted from Fedora Security Advisory FEDORA-2024-94068499c9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-94068499c9");
  script_xref(name:"IAVB", value:"2024-B-0085-S");

  script_name(english:"Fedora 40 : mingw-poppler (2024-94068499c9)");
...
FEDORA-2024-94068499c9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-94068499c9");
...
var pkgs = [
    {'reference':'mingw-poppler-24.02.0-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
