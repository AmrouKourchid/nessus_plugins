...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.0.2 < 1.0.2x Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.0.2x. It is, therefore, affected by a vulnerability as
referenced in the 1.0.2x advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?db9e764c");
...
var constraints = [
  { 'min_version' : '1.0.2', 'fixed_version' : '1.0.2x' }
];
