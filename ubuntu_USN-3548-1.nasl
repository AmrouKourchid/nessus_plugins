...
# extracted from Ubuntu Security Notice USN-3548-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3548-1");

  script_name(english:"Ubuntu 17.10 : linux vulnerability (USN-3548-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/3548-1/");
...
if (ubuntu_check(osver:"17.10", pkgname:"linux-image-4.13.0-32-generic", pkgver:"4.13.0-32.35")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"linux-image-4.13.0-32-lowlatency", pkgver:"4.13.0-32.35")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"linux-image-generic", pkgver:"4.13.0.32.34")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"linux-image-lowlatency", pkgver:"4.13.0.32.34")) flag++;
