...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Net PHSA-2020-1.0-0308");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"net-snmp-5.7.3-10.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"net-snmp-devel-5.7.3-10.ph1")) flag++;
