...
# extracted from Fedora Security Advisory FEDORA-2023-ab86bdbce6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ab86bdbce6");

  script_name(english:"Fedora 37 : python-cairosvg (2023-ab86bdbce6)");
...
FEDORA-2023-ab86bdbce6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ab86bdbce6");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-cairosvg package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-cairosvg");
...
var pkgs = [
    {'reference':'python-cairosvg-2.7.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-cairosvg');
}
