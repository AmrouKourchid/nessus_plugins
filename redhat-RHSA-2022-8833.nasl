...
# extracted from Red Hat Security Advisory RHSA-2022:8833. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8833");

  script_name(english:"RHEL 8 : nodejs:18 (RHSA-2022:8833)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:8833 advisory.

    Node.js is a software development platform for building fast and scalable network applications in the
    JavaScript programming language.

    The following packages have been upgraded to a later upstream version: nodejs (18.12.1), nodejs-nodemon
    (2.0.20). (BZ#2142818)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8833.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98a8d8db");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8833");
  ...
  'nodejs:18': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-18.12.1-2.module+el8.7.0+17306+fc023f99', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-18.12.1-2.module+el8.7.0+17306+fc023f99', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-18.12.1-2.module+el8.7.0+17306+fc023f99', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-18.12.1-2.module+el8.7.0+17306+fc023f99', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-nodemon-2.0.20-1.module+el8.7.0+17282+f47dd33b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'npm-8.19.2-1.18.12.1.2.module+el8.7.0+17306+fc023f99', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
