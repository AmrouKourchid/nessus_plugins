...
if (description)
{
  ...
  script_name(english:"Google Chrome < 87.0.4280.67 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote macOS host is prior to 87.0.4280.67. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2020_11_stable-channel-update-for-desktop_17 advisory.
...
"Upgrade to Google Chrome version 87.0.4280.67 or later.");
...
google_chrome_check_version(fix:'87.0.4280.67', severity:SECURITY_WARNING, xss:TRUE, xsrf:FALSE);
