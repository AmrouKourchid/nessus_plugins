...
# extracted from Fedora Security Advisory FEDORA-2024-60cefb07e8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-60cefb07e8");

  script_name(english:"Fedora 38 : hugin (2024-60cefb07e8)");
...
FEDORA-2024-60cefb07e8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-60cefb07e8");
...
var pkgs = [
    {'reference':'hugin-2023.0.0-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
