...
# extracted from Fedora Security Advisory FEDORA-2019-4d33c62860.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : jss (2019-4d33c62860)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-4d33c62860");
  script_set_attribute(attribute:"solution", value:
"Update the affected jss package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:jss");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"jss-4.6.2-1.fc29")) flag++;
