...
# extracted from Red Hat Security Advisory RHSA-2022:4584. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:4584");

  script_name(english:"RHEL 9 : zlib (RHSA-2022:4584)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4584.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d101d328");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2067945");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4584");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL zlib package based on the guidance in RHSA-2022:4584.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'zlib-1.2.11-31.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-devel-1.2.11-31.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-static-1.2.11-31.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'zlib-1.2.11-31.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-devel-1.2.11-31.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zlib-static-1.2.11-31.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
