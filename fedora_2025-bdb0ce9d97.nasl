...
# extracted from Fedora Security Advisory FEDORA-2025-bdb0ce9d97
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-bdb0ce9d97");

  script_name(english:"Fedora 41 : bootc (2025-bdb0ce9d97)");
...
FEDORA-2025-bdb0ce9d97 advisory.

    Automatic update for bootc-1.1.5-1.fc41.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-bdb0ce9d97");
  script_set_attribute(attribute:"solution", value:
"Update the affected bootc package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:bootc");
...
var pkgs = [
    {'reference':'bootc-1.1.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'bootc');
}
