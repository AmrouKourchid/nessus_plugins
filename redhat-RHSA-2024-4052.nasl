...
# extracted from Red Hat Security Advisory RHSA-2024:4052. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4052");

  script_name(english:"RHEL 9 : dnsmasq (RHSA-2024:4052)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4052.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a009d6b0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4052");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dnsmasq package based on the guidance in RHSA-2024:4052.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dnsmasq-2.85-6.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dnsmasq-utils-2.85-6.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
