...
# extracted from Fedora Security Advisory FEDORA-2023-788d505ddc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-788d505ddc");

  script_name(english:"Fedora 37 : cacti / cacti-spine (2023-788d505ddc)");
...
FEDORA-2023-788d505ddc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-788d505ddc");
...
var pkgs = [
    {'reference':'cacti-1.2.23-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cacti-spine-1.2.23-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
