...
# extracted from Debian Security Advisory dsa-5854. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5854 : bind9 - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-12705");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'bind9', 'reference': '1:9.18.33-1~deb12u2'},
    {'release': '12.0', 'prefix': 'bind9-dev', 'reference': '1:9.18.33-1~deb12u2'},
    {'release': '12.0', 'prefix': 'bind9-dnsutils', 'reference': '1:9.18.33-1~deb12u2'},
    {'release': '12.0', 'prefix': 'bind9-doc', 'reference': '1:9.18.33-1~deb12u2'},
    {'release': '12.0', 'prefix': 'bind9-host', 'reference': '1:9.18.33-1~deb12u2'},
    {'release': '12.0', 'prefix': 'bind9-libs', 'reference': '1:9.18.33-1~deb12u2'},
    {'release': '12.0', 'prefix': 'bind9-utils', 'reference': '1:9.18.33-1~deb12u2'},
    {'release': '12.0', 'prefix': 'bind9utils', 'reference': '1:9.18.33-1~deb12u2'},
    {'release': '12.0', 'prefix': 'dnsutils', 'reference': '1:9.18.33-1~deb12u2'}
];
