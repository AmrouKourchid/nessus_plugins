...
if (description)
{
  ...
  script_cve_id("CVE-2022-31620");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-31620");
...
patch available.
  ...
  - In libjpeg before 1.64, BitStream<false>::Get in bitstream.hpp has an assertion failure that may cause
    ...
    or arithmetically coded sequential scan. (CVE-2022-31620)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-31620");
