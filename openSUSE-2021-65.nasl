...
# extracted from openSUSE Security Update openSUSE-2021-65.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : nodejs10 (openSUSE-2021-65)");
...
if ( rpm_check(release:"SUSE15.2", reference:"nodejs10-10.23.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nodejs10-debuginfo-10.23.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nodejs10-debugsource-10.23.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nodejs10-devel-10.23.1-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"npm10-10.23.1-lp152.2.9.1") ) flag++;
