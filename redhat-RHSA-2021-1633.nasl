...
# extracted from Red Hat Security Advisory RHSA-2021:1633. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1633.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9d55abc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1633");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1868003");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1917691");
...
"Update the RHEL python3 package based on the guidance in RHSA-2021:1633.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'platform-python-3.6.8-37.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'platform-python-debug-3.6.8-37.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'platform-python-devel-3.6.8-37.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-idle-3.6.8-37.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libs-3.6.8-37.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-test-3.6.8-37.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-tkinter-3.6.8-37.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
