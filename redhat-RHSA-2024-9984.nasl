...
# extracted from Red Hat Security Advisory RHSA-2024:9984. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9984");

  script_name(english:"RHEL 9 : RHOSP 17.1.4 (python-sqlparse) (RHSA-2024:9984)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9984.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?50384383");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9984");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL RHOSP 17.1.4 (python-sqlparse) package based on the guidance in RHSA-2024:9984.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-sqlparse-0.4.1-2.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
