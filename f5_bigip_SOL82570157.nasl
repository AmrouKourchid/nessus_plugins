...
# extracted from F5 Networks BIG-IP Solution K82570157.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (K82570157)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K82570157 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K82570157");
...
Refer to the vendor for remediation guidance.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-7170");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '13.1.0','13.0.0','12.1.0-12.1.3','11.6.3','11.5.1-11.5.5','11.2.1'
    ],
  },
  'AM': {
    'affected': [
