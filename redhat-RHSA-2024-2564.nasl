...
# extracted from Red Hat Security Advisory RHSA-2024:2564. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2564");

  script_name(english:"RHEL 9 : mod_http2 (RHSA-2024:2564)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f11776d4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2564");
...
"Update the RHEL mod_http2 package based on the guidance in RHSA-2024:2564.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_http2-2.0.26-2.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'mod_http2-2.0.26-2.el9_4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
