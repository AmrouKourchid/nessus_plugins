...
# extracted from Debian Security Advisory dla-3567. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3567 : libc-ares-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3567
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3567-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                         Anton Gladky
    September 15, 2023                            https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-22217");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libc-ares-dev', 'reference': '1.14.0-1+deb10u4'},
    {'release': '10.0', 'prefix': 'libc-ares2', 'reference': '1.14.0-1+deb10u4'}
];
