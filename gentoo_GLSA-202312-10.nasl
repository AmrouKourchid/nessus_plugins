...
# extracted from Gentoo Linux Security Advisory GLSA 202312-10.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202312-10 : Ceph: Root Privilege Escalation");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202312-10 (Ceph: Root Privilege Escalation)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202312-10");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=878277");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 17.2.6"),
    'vulnerable' : make_list("lt 17.2.6")
  }
];
