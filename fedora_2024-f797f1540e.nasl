...
# extracted from Fedora Security Advisory FEDORA-2024-f797f1540e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f797f1540e");

  script_name(english:"Fedora 39 : kernel (2024-f797f1540e)");
...
FEDORA-2024-f797f1540e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f797f1540e");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2024-22099', 'CVE-2024-26622');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2024-f797f1540e');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.7.9-200.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
