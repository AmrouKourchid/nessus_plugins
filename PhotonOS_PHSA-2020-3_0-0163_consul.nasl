...
if (description)
{
  ...
  script_cve_id("CVE-2020-25201");

  script_name(english:"Photon OS 3.0: Consul PHSA-2020-3.0-0163");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-25201");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'consul-1.7.9-1.ph3')) flag++;
