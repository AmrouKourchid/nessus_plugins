...
# extracted from Fedora Security Advisory FEDORA-2023-1f4f1b8365
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1f4f1b8365");

  script_name(english:"Fedora 38 : xorg-x11-server (2023-1f4f1b8365)");
...
FEDORA-2023-1f4f1b8365 advisory.

    Security fix for CVE-2023-5367, CVE-2023-5380

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1f4f1b8365");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-26.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
