...
# extracted from Debian Security Advisory dla-3673. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3673 : gir1.2-gst-plugins-bad-1.0 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3673
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3673-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'gir1.2-gst-plugins-bad-1.0', 'reference': '1.14.4-1+deb10u5'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-opencv', 'reference': '1.14.4-1+deb10u5'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-plugins-bad', 'reference': '1.14.4-1+deb10u5'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-plugins-bad-dbg', 'reference': '1.14.4-1+deb10u5'},
    {'release': '10.0', 'prefix': 'gstreamer1.0-plugins-bad-doc', 'reference': '1.14.4-1+deb10u5'},
    {'release': '10.0', 'prefix': 'libgstreamer-opencv1.0-0', 'reference': '1.14.4-1+deb10u5'},
    {'release': '10.0', 'prefix': 'libgstreamer-plugins-bad1.0-0', 'reference': '1.14.4-1+deb10u5'},
    {'release': '10.0', 'prefix': 'libgstreamer-plugins-bad1.0-dev', 'reference': '1.14.4-1+deb10u5'}
];
