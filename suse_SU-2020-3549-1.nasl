...
# extracted from SUSE update advisory SUSE-SU-2020:3549-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : nodejs12 (SUSE-SU-2020:3549-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d9bc6895");
...
zypper in -t patch SUSE-SLE-Module-Web-Scripting-12-2020-3549=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs12-12.19.1-1.23.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs12-debuginfo-12.19.1-1.23.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs12-debugsource-12.19.1-1.23.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"nodejs12-devel-12.19.1-1.23.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"npm12-12.19.1-1.23.1")) flag++;
