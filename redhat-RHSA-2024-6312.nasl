...
# extracted from Red Hat Security Advisory RHSA-2024:6312. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6312");

  script_name(english:"RHEL 9 : python3.11-setuptools (RHSA-2024:6312)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6312.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?458641ca");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2297771");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6312");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.11-setuptools package based on the guidance in RHSA-2024:6312.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-setuptools-65.5.1-2.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3.11-setuptools-wheel-65.5.1-2.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
