...
# extracted from Fedora Security Advisory FEDORA-2024-70cf80279f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-70cf80279f");

  script_name(english:"Fedora 40 : dotnet9.0 (2024-70cf80279f)");
...
FEDORA-2024-70cf80279f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-70cf80279f");
...
var pkgs = [
    {'reference':'dotnet9.0-9.0.100-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
