...
# extracted from Red Hat Security Advisory RHSA-2025:0146. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0146");

  script_name(english:"RHEL 9 : webkit2gtk3 (RHSA-2025:0146)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for webkit2gtk3.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:0146 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0146.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc75fc3a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0146");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL webkit2gtk3 package based on the guidance in RHSA-2025:0146.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'webkit2gtk3-2.46.5-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-devel-2.46.5-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-2.46.5-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-devel-2.46.5-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
