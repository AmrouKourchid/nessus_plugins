...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL6.x i386/x86_64 (20200707)");
...
"Security Fix(es) :
  ...
  - Mozilla: Add-On updates did not respect the same
    ...
    (CVE-2020-12421)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2007&L=SCIENTIFIC-LINUX-ERRATA&P=2340
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be93fe2e");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"firefox-68.10.0-1.el6_10", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-68.10.0-1.el6_10", allowmaj:TRUE)) flag++;
