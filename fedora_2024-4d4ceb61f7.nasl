...
# extracted from Fedora Security Advisory FEDORA-2024-4d4ceb61f7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4d4ceb61f7");

  script_name(english:"Fedora 40 : pgadmin4 / python-libgravatar (2024-4d4ceb61f7)");
...
FEDORA-2024-4d4ceb61f7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4d4ceb61f7");
  script_set_attribute(attribute:"solution", value:
"Update the affected pgadmin4 and / or python-libgravatar packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-libgravatar");
...
var pkgs = [
    {'reference':'pgadmin4-8.6-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-libgravatar-1.0.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'pgadmin4 / python-libgravatar');
}
