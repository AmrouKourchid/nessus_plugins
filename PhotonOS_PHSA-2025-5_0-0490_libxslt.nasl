...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Libxslt PHSA-2025-5.0-0490");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libxslt-1.1.39-2.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libxslt-devel-1.1.39-2.ph5')) flag++;
