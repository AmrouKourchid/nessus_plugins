...
# SUSE update advisory SUSE-SU-2023:4465-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4465-1");

  script_name(english:"openSUSE 15 Security Update : python-Pillow (SUSE-SU-2023:4465-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-November/017054.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?420da45f");
...
var pkgs = [
    {'reference':'python3-Pillow-7.2.0-150300.3.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'python3-Pillow-tk-7.2.0-150300.3.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'python3-Pillow-7.2.0-150300.3.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'python3-Pillow-tk-7.2.0-150300.3.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
