...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2022 : ImageMagick, ImageMagick-c++, ImageMagick-c++-devel (ALAS2022-2022-164)");
...
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2022-2022-164 advisory.
    ...
    A divide-by-zero flaw was found in ImageMagick in gem.c. This flaw allows an attacker who submits a
    crafted file that is processed by ImageMagick to trigger undefined behavior through a division by zero.
    The highest threat from this vulnerability is to system availability. (CVE-2021-20176)
