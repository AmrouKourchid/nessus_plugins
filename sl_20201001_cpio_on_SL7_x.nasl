...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : cpio on SL7.x x86_64 (20201001)");
...
"Security Fix(es) :
  ...
  - cpio: improper input validation when writing tar header
    fields leads to unexpect tar generation (CVE-2019-14866)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2010&L=SCIENTIFIC-LINUX-ERRATA&P=8075
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?344f7e98");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"cpio-2.11-28.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"cpio-debuginfo-2.11-28.el7")) flag++;
