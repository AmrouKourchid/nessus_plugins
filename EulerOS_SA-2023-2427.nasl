...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libarchive (EulerOS-SA-2023-2427)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2427
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4b1717bb");
...
var pkgs = [
  "libarchive-3.1.2-10.h13.eulerosv2r7"
];
