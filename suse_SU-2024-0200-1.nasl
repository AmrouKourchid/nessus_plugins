...
# SUSE update advisory SUSE-SU-2024:0200-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0200-1");

  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : redis7 (SUSE-SU-2024:0200-1)");
...
as referenced in the SUSE-SU-2024:0200-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1212119");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1216376");
  # https://lists.suse.com/pipermail/sle-security-updates/2024-January/017742.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cbe63147");
...
var pkgs = [
    {'reference':'redis7-7.0.8-150500.3.9.1', 'sp':'5', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.5']},
    {'reference':'redis7-7.0.8-150500.3.9.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.5', 'sle-module-server-applications-release-15.5', 'sles-release-15.5']},
    {'reference':'redis7-7.0.8-150500.3.9.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']}
];
