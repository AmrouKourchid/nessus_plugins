...
# extracted from Fedora Security Advisory FEDORA-2023-b19f236bc7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b19f236bc7");

  script_name(english:"Fedora 38 : mingw-LibRaw (2023-b19f236bc7)");
...
FEDORA-2023-b19f236bc7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b19f236bc7");
...
var pkgs = [
    {'reference':'mingw-LibRaw-0.21.1-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
