...
if (description)
{
  ...
  script_cve_id("CVE-2025-21727");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21727");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: padata: fix UAF in padata_reorder A
    ...
    calls to finish. [1] https://lore.kernel.org/all/20221028160401.cccypv4euxikusiq@parnassus.localdomain/
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21727");
