...
the RHSA-2019:0109 advisory.
    ...
    * perl: Integer overflow leading to buffer overflow in Perl_my_setenv() (CVE-2018-18311)
    ...
    Red Hat would like to thank the Perl project for reporting this issue. Upstream acknowledges Jayakrishna
    Menon as the original reporter.

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0109.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1026a655");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0109");
...
"Update the RHEL perl package based on the guidance in RHSA-2019:0109.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'perl-5.16.3-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'perl-core-5.16.3-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-CPAN-1.9800-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-devel-5.16.3-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'perl-ExtUtils-CBuilder-0.28.2.6-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'perl-ExtUtils-Embed-1.30-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-ExtUtils-Install-1.58-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-IO-Zlib-1.10-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'perl-libs-5.16.3-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'perl-Locale-Maketext-Simple-0.21-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'perl-macros-5.16.3-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'perl-Module-CoreList-2.76.02-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'perl-Module-Loaded-0.08-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'perl-Object-Accessor-0.42-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'perl-Package-Constants-0.02-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'perl-Pod-Escapes-1.04-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'perl-tests-5.16.3-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'4'},
      {'reference':'perl-Time-Piece-1.20.1-294.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
