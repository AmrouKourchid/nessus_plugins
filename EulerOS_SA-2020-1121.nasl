...
if (description)
{
  ...
  script_bugtraq_id(67901);

  script_name(english:"EulerOS 2.0 SP5 : openssl098e (EulerOS-SA-2020-1121)");
...
vulnerability :
  ...
  - The dtls1_get_message_fragment function in d1_both.c in
    ...
    handshake.(CVE-2014-0221)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1121
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?586d5b9e");
  script_set_attribute(attribute:"solution", value:
"Update the affected openssl098e package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0221");
