...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : evince (EulerOS-SA-2021-1291)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1291
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a194df22");
...
pkgs = ["evince-3.14.2-5.h3",
        "evince-dvi-3.14.2-5.h3",
        "evince-libs-3.14.2-5.h3",
        "evince-nautilus-3.14.2-5.h3"];
