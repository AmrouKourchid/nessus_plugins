...
# extracted from SUSE update advisory SUSE-SU-2020:0405-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : ipmitool (SUSE-SU-2020:0405-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85be3d60");
...
-t patch SUSE-SLE-Module-Server-Applications-15-SP1-2020-405=1

SUSE Linux Enterprise Module for Basesystem 15-SP1:zypper in -t patch
SUSE-SLE-Module-Basesystem-15-SP1-2020-405=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"ipmitool-1.8.18-7.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"ipmitool-debuginfo-1.8.18-7.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"ipmitool-debugsource-1.8.18-7.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"ipmitool-1.8.18-7.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"ipmitool-debuginfo-1.8.18-7.3.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"ipmitool-debugsource-1.8.18-7.3.1")) flag++;
