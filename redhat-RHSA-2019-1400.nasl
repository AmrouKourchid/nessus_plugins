...
# extracted from Red Hat Security Advisory RHSA-2019:1400. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1400");

  script_name(english:"RHEL 7 : qpid-proton (RHSA-2019:1400)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for qpid-proton.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:1400 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1400.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f037794");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1702439");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1704978");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1717133");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1400");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qpid-proton package based on the guidance in RHSA-2019:1400.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:jsoncpp");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jsoncpp-1.7.7-1.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'jsoncpp-1.7.7-1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-qpid-proton-0.27.0-3.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python-qpid-proton-0.27.0-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'qpid-proton-c-0.27.0-3.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'qpid-proton-c-0.27.0-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'qpid-proton-cpp-0.27.0-3.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'qpid-proton-cpp-0.27.0-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'jsoncpp / python-qpid-proton / qpid-proton-c / qpid-proton-cpp');
}
