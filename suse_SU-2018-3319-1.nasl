...
# extracted from SUSE update advisory SUSE-SU-2018:3319-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : net-snmp (SUSE-SU-2018:3319-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1111122");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2018-18065/");
  # https://www.suse.com/support/update/announcement/2018/suse-su-20183319-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?44d69eed");
...
SUSE-SLE-SERVER-12-2018-2390=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"libsnmp30-32bit-5.7.2.1-4.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"libsnmp30-5.7.2.1-4.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"libsnmp30-debuginfo-32bit-5.7.2.1-4.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"libsnmp30-debuginfo-5.7.2.1-4.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"net-snmp-5.7.2.1-4.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"net-snmp-debuginfo-5.7.2.1-4.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"net-snmp-debugsource-5.7.2.1-4.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"perl-SNMP-5.7.2.1-4.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"perl-SNMP-debuginfo-5.7.2.1-4.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"snmp-mibs-5.7.2.1-4.9.1")) flag++;
