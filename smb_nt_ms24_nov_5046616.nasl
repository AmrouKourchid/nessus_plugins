...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5046616");
  script_xref(name:"MSKB", value:"5046616");
  script_xref(name:"MSFT", value:"MS24-5046698");
  script_xref(name:"MSFT", value:"MS24-5046698");
  ...
  script_name(english:"KB5046616: Windows Server 2022 / Azure Stack HCI 22H2 Security Update (November 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5046616 and hotpatch 5046698. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5046616");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5046698");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5046616 or HotPatch 5046698");
...
if (
  smb_check_rollup(os:'10',
                   ...
                   rollup_date:'11_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5046616, 5046698])
)
{
