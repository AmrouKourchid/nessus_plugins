...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : glibc (EulerOS-SA-2021-1299)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1299
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2443da40");
...
pkgs = ["glibc-2.17-111.h50",
        "glibc-common-2.17-111.h50",
        "glibc-devel-2.17-111.h50",
        "glibc-headers-2.17-111.h50",
        "glibc-static-2.17-111.h50",
        "glibc-utils-2.17-111.h50",
        "nscd-2.17-111.h50"];
