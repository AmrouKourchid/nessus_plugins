...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : ipa (EulerOS-SA-2020-1679)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1679
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2e59978");
...
pkgs = ["ipa-admintools-4.2.0-15.0.1.19.h5",
        "ipa-client-4.2.0-15.0.1.19.h5",
        "ipa-python-4.2.0-15.0.1.19.h5",
        "ipa-server-4.2.0-15.0.1.19.h5",
        "ipa-server-dns-4.2.0-15.0.1.19.h5",
        "ipa-server-trust-ad-4.2.0-15.0.1.19.h5"];
