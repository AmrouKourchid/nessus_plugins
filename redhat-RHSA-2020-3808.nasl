...
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.3.38 jenkins /
openshift.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3808.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9ac4cee9");
...
"Update the RHEL OpenShift Container Platform 4.3.38 jenkins / openshift packages based on the guidance in
RHSA-2020:3808.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-hyperkube-4.3.37-202009120213.p0.git.0.dffefe4.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-8557']},
      {'reference':'openshift-hyperkube-4.3.37-202009120213.p0.git.0.dffefe4.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-8557']},
      {'reference':'openshift-hyperkube-4.3.37-202009120213.p0.git.0.dffefe4.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2020-8557']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jenkins-2.235.5.1600415514-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2019-17638', 'CVE-2020-2220', 'CVE-2020-2221', 'CVE-2020-2222', 'CVE-2020-2223', 'CVE-2020-2229', 'CVE-2020-2230', 'CVE-2020-2231']}
    ]
  }
];
