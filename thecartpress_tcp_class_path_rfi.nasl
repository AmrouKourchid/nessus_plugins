...
taken from third-party hosts.");
  # https://spareclockcycles.org/2011/09/18/exploitring-the-wordpress-extension-repos/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00aa0aec");
  # https://plugins.trac.wordpress.org/changeset/438950/thecartpress/trunk/checkout/CheckoutEditor.php?old=438924&old_path=thecartpress%2Ftrunk%2Fcheckout%2FCheckoutEditor.php
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?64ab87f7");
  script_set_attribute(attribute:"solution", value:
"Upgrade to TheCartPress version 1.1.2 or later.");
