...
# extracted from Red Hat Security Advisory RHSA-2025:3383. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3383");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2025/05/27");

  script_name(english:"RHEL 9 : freetype (RHSA-2025:3383)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3383.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?78d038f1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3383");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL freetype package based on the guidance in RHSA-2025:3383.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freetype-2.10.4-10.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freetype-devel-2.10.4-10.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
