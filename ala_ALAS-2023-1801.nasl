...
# extracted from Amazon Linux AMI Security Advisory ALAS-2023-1801.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : ghostscript (ALAS-2023-1801)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of ghostscript installed on the remote host is prior to 8.70-24.29. It is, therefore, affected by a
vulnerability as referenced in the ALAS-2023-1801 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2023-1801.html");
...
var pkgs = [
    {'reference':'ghostscript-8.70-24.29.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-8.70-24.29.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-debuginfo-8.70-24.29.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-debuginfo-8.70-24.29.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-devel-8.70-24.29.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-devel-8.70-24.29.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-doc-8.70-24.29.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ghostscript-doc-8.70-24.29.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
