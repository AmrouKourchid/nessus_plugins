...
if (description)
{
  ...
  script_cve_id("CVE-2021-47645");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47645");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: media: staging: media: zoran:
    calculate the right buffer number for zoran_reap_stat_com On the case tmp_dcim=1, the index of buffer is
    miscalculated. This generate a NULL pointer dereference later. So let's fix the calcul and add a check to
    prevent this to reappear. (CVE-2021-47645)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47645");
