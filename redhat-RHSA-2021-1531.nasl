...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1531.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?654e37a9");
...
"Update the RHEL kernel package based on the guidance in RHSA-2021:1531.");
  ...
  script_cwe_id(20, 119, 122, 125, 200, 330);
