...
# extracted from openSUSE Security Update openSUSE-2020-1420.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gimp (openSUSE-2020-1420)");
...
"This update for gimp fixes the following issue :
  ...
  - CVE-2017-17789: Fix heap buffer overflow in PSP importer
    (bsc#1073627).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1073627");
...
if ( rpm_check(release:"SUSE15.1", reference:"gimp-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gimp-debuginfo-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gimp-debugsource-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gimp-devel-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gimp-devel-debuginfo-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gimp-lang-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gimp-plugin-aa-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gimp-plugin-aa-debuginfo-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gimp-plugins-python-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gimp-plugins-python-debuginfo-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libgimp-2_0-0-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libgimp-2_0-0-debuginfo-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libgimpui-2_0-0-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libgimpui-2_0-0-debuginfo-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libgimp-2_0-0-32bit-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libgimp-2_0-0-32bit-debuginfo-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libgimpui-2_0-0-32bit-2.8.22-lp151.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libgimpui-2_0-0-32bit-debuginfo-2.8.22-lp151.5.3.1") ) flag++;
