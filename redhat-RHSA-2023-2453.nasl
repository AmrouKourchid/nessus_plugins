...
# extracted from Red Hat Security Advisory RHSA-2023:2453. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2453");

  script_name(english:"RHEL 9 : libtpms (RHSA-2023:2453)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libtpms.");
...
referenced in the RHSA-2023:2453 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2453.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?261a5d93");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2453");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libtpms package based on the guidance in RHSA-2023:2453.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libtpms-0.9.1-3.20211126git1ff6fe1f43.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtpms-0.9.1-3.20211126git1ff6fe1f43.el9_2', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtpms-0.9.1-3.20211126git1ff6fe1f43.el9_2', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtpms-0.9.1-3.20211126git1ff6fe1f43.el9_2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libtpms');
}
