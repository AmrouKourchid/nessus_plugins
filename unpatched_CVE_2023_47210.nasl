...
if (description)
{
  ...
  script_cve_id("CVE-2023-47210");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-47210");
...
patch available.
  ...
  - Improper input validation for some Intel(R) PROSet/Wireless WiFi software for linux before version 23.20
    may allow an unauthenticated user to potentially enable denial of service via adjacent access.
    (CVE-2023-47210)
