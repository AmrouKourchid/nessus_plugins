...
# extracted from Red Hat Security Advisory RHSA-2018:2892. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2892");

  script_name(english:"RHEL 6 : glusterfs (RHSA-2018:2892)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:2892 advisory.
    ...
    The glusterfs packages have been upgraded to upstream version 3.12.2, which provides a number of bug fixes
    over the previous version. (BZ#1594203)
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2892.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?613d44a3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2892");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1594203");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'glusterfs-3.12.2-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glusterfs-api-3.12.2-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glusterfs-api-devel-3.12.2-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glusterfs-cli-3.12.2-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glusterfs-client-xlators-3.12.2-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glusterfs-devel-3.12.2-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glusterfs-fuse-3.12.2-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glusterfs-libs-3.12.2-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'glusterfs-rdma-3.12.2-18.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
