...
# extracted from Fedora Security Advisory FEDORA-2025-bd8f5a599b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-bd8f5a599b");

  script_name(english:"Fedora 41 : dotnet8.0 (2025-bd8f5a599b)");
...
FEDORA-2025-bd8f5a599b advisory.

    This is the January 2025 security and bugfix release for .NET 8.0. It updates the SDK to version 8.0.112
    and Runtime to version 8.0.12.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-bd8f5a599b");
...
var pkgs = [
    {'reference':'dotnet8.0-8.0.112-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
