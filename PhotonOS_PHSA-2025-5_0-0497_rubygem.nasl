...
# extracted from VMware Security Advisory PHSA-2025-5.0-0497. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Rubygem PHSA-2025-5.0-0497");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the rubygem package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-497.md");
...
if (rpm_check(release:'PhotonOS-5.0', reference:'rubygem-fluentd-1.15.2-4.ph5')) flag++;
