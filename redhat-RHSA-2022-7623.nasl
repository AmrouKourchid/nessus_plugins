...
# extracted from Red Hat Security Advisory RHSA-2022:7623. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7623");

  script_name(english:"RHEL 8 : dovecot (RHSA-2022:7623)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for dovecot.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:7623 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7623.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c927d525");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7623");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2105070");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dovecot package based on the guidance in RHSA-2022:7623.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dovecot-2.3.16-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-devel-2.3.16-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-mysql-2.3.16-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-pgsql-2.3.16-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'dovecot-pigeonhole-2.3.16-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
