...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : httpd (EulerOS-SA-2018-1212)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1212
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d993205");
...
pkgs = ["httpd-2.4.6-45.0.1.4.h9",
        "httpd-devel-2.4.6-45.0.1.4.h9",
        "httpd-manual-2.4.6-45.0.1.4.h9",
        "httpd-tools-2.4.6-45.0.1.4.h9",
        "mod_ssl-2.4.6-45.0.1.4.h9"];
