...
# extracted from Fedora Security Advisory FEDORA-2024-f19c79e713
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f19c79e713");

  script_name(english:"Fedora 41 : libtiff (2024-f19c79e713)");
...
FEDORA-2024-f19c79e713 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f19c79e713");
...
var pkgs = [
    {'reference':'libtiff-4.6.0-6.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
