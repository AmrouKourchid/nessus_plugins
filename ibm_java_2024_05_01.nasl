...
if (description)
{
  ...
  script_cve_id("CVE-2023-38264", "CVE-2024-3933");
...
affected by multiple vulnerabilities as referenced in the IBM Security Update May 2024 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg1IJ51327");
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg1IX90196");
  # https://www.ibm.com/support/pages/java-sdk-security-vulnerabilities#IBM_Security_Update_May_2024
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6a4b81f");
  script_set_attribute(attribute:"solution", value:
"Apply the appropriate patch according to the IBM Security Update May 2024 advisory.");
