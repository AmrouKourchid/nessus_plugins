...
# extracted from Fedora Security Advisory FEDORA-2024-523badd730
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-523badd730");

  script_name(english:"Fedora 39 : dotnet6.0 (2024-523badd730)");
...
FEDORA-2024-523badd730 advisory.

    This is the July 2024 security update for .NET 6.

    ## Release Notes

    - SDK: https://github.com/dotnet/core/blob/main/release-notes/6.0/6.0.32/6.0.132.md
    - Runtime: https://github.com/dotnet/core/blob/main/release-notes/6.0/6.0.32/6.0.32.md

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-523badd730");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.132-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
