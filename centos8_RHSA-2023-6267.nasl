...
# Red Hat Security Advisory RHSA-2023:6267. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : squid:4 (CESA-2023:6267)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2023:6267 advisory.
...
var appstreams = {
    'squid:4': [
      ...
      {'reference':'squid-4.15-6.module_el8.8.0+1236+bbc41960', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-4.15-6.module_el8.8.0+1236+bbc41960', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
};
