...
# extracted from Red Hat Security Advisory RHSA-2025:2223. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:2223");

  script_name(english:"RHEL 8 : Red Hat Product OCP Tools 4.12 Openshift Jenkins (RHSA-2025:2223)");
...
referenced in the RHSA-2025:2223 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25b76f96");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:2223");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Product OCP Tools 4.12 Openshift Jenkins package based on the guidance in RHSA-2025:2223.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.12.1740464689-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jenkins-2.479.3.1740464431-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
