...
if (description)
{
  ...
  script_cve_id("CVE-2024-32856");
  script_xref(name:"IAVA", value:"2024-A-0360");

  script_name(english:"Dell Client BIOS Improper Input Validation (DSA-2024-167)");
...
A high privileged attacker with local access could potentially exploit this vulnerability, leading to Information
disclosure.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://www.dell.com/support/kbdoc/en-us/000221745/dsa-2024-067-security-update-for-dell-client-platform-bios-for-an-improper-input-validation-vulnerability
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?470aeaa2");
...
"Apply the security patch in accordance with the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32856");
