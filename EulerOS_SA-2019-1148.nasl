...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : poppler (EulerOS-SA-2019-1148)");
...
vulnerability :
  ...
  - A heap-based buffer underwrite exists in
    ...
    attacker to cause Denial of Service (Segmentation
    fault) or possibly have unspecified other
    impact.(CVE-2019-9200)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1148
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a5c328b");
...
pkgs = ["poppler-0.26.5-17.h16.eulerosv2r7",
        "poppler-glib-0.26.5-17.h16.eulerosv2r7",
        "poppler-qt-0.26.5-17.h16.eulerosv2r7",
        "poppler-utils-0.26.5-17.h16.eulerosv2r7"];
