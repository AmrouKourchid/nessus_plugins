...
# extracted from Fedora Security Advisory FEDORA-2023-43eb573065
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-43eb573065");

  script_name(english:"Fedora 36 : syslog-ng (2023-43eb573065)");
...
FEDORA-2023-43eb573065 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-43eb573065");
...
var pkgs = [
    {'reference':'syslog-ng-3.35.1-4.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
