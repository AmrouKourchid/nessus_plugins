...
# Rocky Linux Security Advisory RLSA-2023:0446.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:0446");
  script_xref(name:"IAVB", value:"2023-B-0080-S");

  script_name(english:"Rocky Linux 8 : go-toolset:rhel8 (RLSA-2023:0446)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2023:0446 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:0446");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2139718");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2149313");
...
var pkgs = [
    {'reference':'delve-1.8.3-1.module+el8.7.0+1073+99e3b3cd', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'delve-debuginfo-1.8.3-1.module+el8.7.0+1073+99e3b3cd', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'delve-debugsource-1.8.3-1.module+el8.7.0+1073+99e3b3cd', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'go-toolset-1.18.9-1.module+el8.7.0+1133+56289a01', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'go-toolset-1.18.9-1.module+el8.7.0+1133+56289a01', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-1.18.9-1.module+el8.7.0+1133+56289a01', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-1.18.9-1.module+el8.7.0+1133+56289a01', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-bin-1.18.9-1.module+el8.7.0+1133+56289a01', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-bin-1.18.9-1.module+el8.7.0+1133+56289a01', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-docs-1.18.9-1.module+el8.7.0+1133+56289a01', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-misc-1.18.9-1.module+el8.7.0+1133+56289a01', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-race-1.18.9-1.module+el8.7.0+1133+56289a01', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-src-1.18.9-1.module+el8.7.0+1133+56289a01', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-tests-1.18.9-1.module+el8.7.0+1133+56289a01', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
