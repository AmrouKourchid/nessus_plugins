...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : gmp (EulerOS-SA-2023-1069)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1069
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05a7a61b");
...
var pkgs = [
  "gmp-6.0.0-15.h1.eulerosv2r7",
  "gmp-devel-6.0.0-15.h1.eulerosv2r7"
];
