...
# extracted from Gentoo Linux Security Advisory GLSA 202105-26.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-26");

  script_name(english:"GLSA-202105-26 : SpamAssassin: Arbitrary command execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-26
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-26"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"mail-filter/spamassassin", unaffected:make_list("ge 3.4.5"), vulnerable:make_list("lt 3.4.5"))) flag++;
