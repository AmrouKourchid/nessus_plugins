...
# extracted from openSUSE Security Update openSUSE-2021-303.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : jasper (openSUSE-2021-303)");
...
"This update for jasper fixes the following issues :
  ...
  - bsc#1179748 CVE-2020-27828: Fix heap overflow by
    checking maxrlvls

  - bsc#1181483 CVE-2021-3272: Fix buffer over-read in
    jp2_decode

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1179748");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1181483");
...
if ( rpm_check(release:"SUSE15.2", reference:"jasper-2.0.14-lp152.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"jasper-debuginfo-2.0.14-lp152.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"jasper-debugsource-2.0.14-lp152.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libjasper-devel-2.0.14-lp152.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libjasper4-2.0.14-lp152.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libjasper4-debuginfo-2.0.14-lp152.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libjasper4-32bit-2.0.14-lp152.7.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libjasper4-32bit-debuginfo-2.0.14-lp152.7.6.1") ) flag++;
