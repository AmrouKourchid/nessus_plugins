...
# extracted from openSUSE Security Update openSUSE-2019-1077.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaFirefox (openSUSE-2019-1077)");
...
Mozilla Firefox 60.5.2esr also had one change :
  ...
  - Fix a frequent crash when reading various Reuters news
    articles.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1129821");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1130262");
...
if ( rpm_check(release:"SUSE15.0", reference:"MozillaFirefox-60.6.1-lp150.3.45.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"MozillaFirefox-branding-upstream-60.6.1-lp150.3.45.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"MozillaFirefox-buildsymbols-60.6.1-lp150.3.45.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"MozillaFirefox-debuginfo-60.6.1-lp150.3.45.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"MozillaFirefox-debugsource-60.6.1-lp150.3.45.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"MozillaFirefox-devel-60.6.1-lp150.3.45.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"MozillaFirefox-translations-common-60.6.1-lp150.3.45.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"MozillaFirefox-translations-other-60.6.1-lp150.3.45.1") ) flag++;
