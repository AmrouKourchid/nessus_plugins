...
# extracted from Fedora Security Advisory FEDORA-2019-a8ffcff7ee.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-0495", "CVE-2018-0734", "CVE-2018-0735");
  script_xref(name:"FEDORA", value:"2019-a8ffcff7ee");

  script_name(english:"Fedora 29 : 1:openssl (2019-a8ffcff7ee)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Minor update to version 1.1.1a with bug fixes and low impact security
fixes.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a8ffcff7ee");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"openssl-1.1.1a-1.fc29", epoch:"1")) flag++;
