...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Linux kernel vulnerabilities (USN-5468-1)");
...
var kernel_mappings = {
  '20.04': {
    '5.13.0': {
      'generic': '5.13.0-48',
      'generic-64k': '5.13.0-48',
      'generic-lpae': '5.13.0-48',
      'lowlatency': '5.13.0-48',
      'intel': '5.13.0-1014',
      'azure': '5.13.0-1028',
      'gcp': '5.13.0-1030',
      'oracle': '5.13.0-1033'
...
{
  var cve_list = make_list('CVE-2022-1158', 'CVE-2022-21499', 'CVE-2022-24958', 'CVE-2022-28390');
