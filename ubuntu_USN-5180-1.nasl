...
# extracted from Ubuntu Security Notice USN-5180-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5180-1");

  script_name(english:"Ubuntu 18.04 LTS : Mailman vulnerability (USN-5180-1)");
...
USN-5180-1 advisory.
    ...
    It was discovered that Mailman incorrectly handled CSRF tokens. A remote list member or moderator could
    possibly use their own token to craft an admin request CSRF attack and set a new admin password or make
    other changes.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5180-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'mailman', 'pkgver': '1:2.1.26-1ubuntu0.6'}
];
