...
# extracted from Debian Security Advisory dsa-5517. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5517-1 : libx11 - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5517");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-43785");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-43786");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-43787");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libx11-6', 'reference': '2:1.7.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libx11-6-udeb', 'reference': '2:1.7.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libx11-data', 'reference': '2:1.7.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libx11-dev', 'reference': '2:1.7.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libx11-doc', 'reference': '2:1.7.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libx11-xcb-dev', 'reference': '2:1.7.2-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libx11-xcb1', 'reference': '2:1.7.2-1+deb11u2'},
    {'release': '12.0', 'prefix': 'libx11-6', 'reference': '2:1.8.4-2+deb12u2'},
    {'release': '12.0', 'prefix': 'libx11-6-udeb', 'reference': '2:1.8.4-2+deb12u2'},
    {'release': '12.0', 'prefix': 'libx11-data', 'reference': '2:1.8.4-2+deb12u2'},
    {'release': '12.0', 'prefix': 'libx11-dev', 'reference': '2:1.8.4-2+deb12u2'},
    {'release': '12.0', 'prefix': 'libx11-doc', 'reference': '2:1.8.4-2+deb12u2'},
    {'release': '12.0', 'prefix': 'libx11-xcb-dev', 'reference': '2:1.8.4-2+deb12u2'},
    {'release': '12.0', 'prefix': 'libx11-xcb1', 'reference': '2:1.8.4-2+deb12u2'}
];
