...
# extracted from Ubuntu Security Notice USN-145-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.04 : wget bug fix (USN-145-2)");
...
if (ubuntu_check(osver:"5.04", pkgname:"wget", pkgver:"1.9.1-10ubuntu2.2")) flag++;
