...
# extracted from VMware Security Advisory PHSA-2025-5.0-0514. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Perl PHSA-2025-5.0-0514");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the perl package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-514.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'perl-5.36.0-8.ph5')) flag++;
