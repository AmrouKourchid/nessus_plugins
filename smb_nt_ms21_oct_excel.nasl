...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002030");
  script_xref(name:"MSKB", value:"5002043");
  script_xref(name:"MSFT", value:"MS21-5002030");
  script_xref(name:"MSFT", value:"MS21-5002043");
  script_xref(name:"IAVA", value:"2021-A-0468-S");
  script_xref(name:"IAVA", value:"2021-A-0465-S");

  script_name(english:"Security Updates for Microsoft Excel Products (October 2021)");
...
It is, therefore, affected by multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002030");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002043");
...
var checks = make_array(
  '15.0', make_array('sp', 1, 'version', '15.0.5389.1000', 'kb', '5002043'),
  '16.0', make_nested_list(
    make_array('sp', 0, 'version', '16.0.5227.1000', 'channel', 'MSI', 'kb', '5002030')
  )
);
