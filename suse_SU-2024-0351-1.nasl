...
# SUSE update advisory SUSE-SU-2024:0351-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0351-1");

  script_name(english:"SUSE SLES15 Security Update : kernel RT (Live Patch 15 for SLE 15 SP4) (SUSE-SU-2024:0351-1)");
...
the SUSE-SU-2024:0351-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-February/017869.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?53f8830c");
...
"Update the affected kernel-livepatch-5_14_21-150400_15_59-rt package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.15.59-rt-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_15_59-rt-2-150400.2.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_15_59-rt');
}
