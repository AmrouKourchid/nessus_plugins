...
if (description)
{
  ...
  script_name(english:"NuGet Package 'Forge.OpenAI' Detection");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.nuget.org/packages/Forge.OpenAI/");
  script_set_attribute(attribute:"solution", value:
"The Forge.OpenAI package is installed on the remote host.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:jzo:forge.openai");
...
var app_info = vcf::nuget_package::get_app_info(pkg_name:"Forge.OpenAI");
app_info.vendor = "JZO";
app_info.cpe = "cpe:/a:jzo:forge.openai";
