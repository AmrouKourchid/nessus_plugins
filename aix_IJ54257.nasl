...
if (description)
{
  ...
  script_name(english:"AIX (IJ54257)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ54257. It is, therefore, affected by a vulnerability
as referenced in the IJ54257 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ54257");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ54257.");
...
var constraints = [
    {'release': '7.3', 'ml': '01', 'sp': '02', 'patch': 'IJ54257m3a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.3'},
    {'release': '7.3', 'ml': '01', 'sp': '03', 'patch': 'IJ54257m3a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.3'},
    {'release': '7.3', 'ml': '01', 'sp': '04', 'patch': 'IJ54257s4a', 'package': 'bos.rte.control', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.3'}
];
