...
# extracted from Fedora Security Advisory FEDORA-2023-478aa17fa2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-478aa17fa2");

  script_name(english:"Fedora 37 : pgadmin4 (2023-478aa17fa2)");
...
FEDORA-2023-478aa17fa2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-478aa17fa2");
...
"Update the affected pgadmin4 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-5002");
...
var pkgs = [
    {'reference':'pgadmin4-6.19-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
