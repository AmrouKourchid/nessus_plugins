...
# extracted from Fedora Security Advisory FEDORA-2023-5230b1a68a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5230b1a68a");

  script_name(english:"Fedora 37 : suricata (2023-5230b1a68a)");
...
FEDORA-2023-5230b1a68a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5230b1a68a");
...
var pkgs = [
    {'reference':'suricata-6.0.13-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
