...
# extracted from Fedora Security Advisory FEDORA-2023-0cd03c3746
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0cd03c3746");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/10/23");

  script_name(english:"Fedora 37 : chromium (2023-0cd03c3746)");
...
FEDORA-2023-0cd03c3746 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0cd03c3746");
...
var pkgs = [
    {'reference':'chromium-117.0.5938.132-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
