...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : dnsmasq (EulerOS-SA-2024-1261)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1261
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?caa8f0c6");
...
var pkgs = [
  "dnsmasq-2.79-7.h9.eulerosv2r8",
  "dnsmasq-utils-2.79-7.h9.eulerosv2r8"
];
