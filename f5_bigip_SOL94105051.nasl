...
# extracted from F5 Networks BIG-IP Solution K94105051.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-5537");

  script_name(english:"F5 Networks BIG-IP : TMM vulnerability (K94105051)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"A remote attacker may be able to disrupt services on the BIG-IP if the
...
to a peer system.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K94105051");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K94105051.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:N/UI:R/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-5537");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '13.0.0-13.1.0','12.1.0-12.1.3','11.6.1-11.6.3','11.2.1-11.5.6'
    ],
    'unaffected': [
      '14.0.0','13.1.0.6','12.1.3.6','11.6.3.2','11.5.7'
    ],
  },
  'AM': {
    'affected': [
