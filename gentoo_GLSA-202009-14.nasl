...
# extracted from Gentoo Linux Security Advisory GLSA 202009-14.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202009-14");

  script_name(english:"GLSA-202009-14 : Xen: Buffer overflow");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202009-14
(Xen: Buffer overflow)
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://xenbits.xen.org/xsa/advisory-335.html");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202009-14");
...
if (qpkg_check(package:"app-emulation/xen", unaffected:make_list("ge 4.13.1-r3"), vulnerable:make_list("lt 4.13.1-r3"))) flag++;
if (qpkg_check(package:"app-emulation/xen-tools", unaffected:make_list("ge 4.13.1-r3"), vulnerable:make_list("lt 4.13.1-r3"))) flag++;
