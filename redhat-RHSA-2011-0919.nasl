...
referenced in the RHSA-2011:0919 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2011/rhsa-2011_0919.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9960e4dd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=713589");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=717399");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2011:0919");
...
"Update the RHEL qemu-kvm package based on the guidance in RHSA-2011:0919.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-2212");
  script_cwe_id(119);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-0.12.1.2-2.160.el6_1.2', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-kvm-0.12.1.2-2.160.el6_1.2', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'qemu-kvm-tools-0.12.1.2-2.160.el6_1.2', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_1', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
