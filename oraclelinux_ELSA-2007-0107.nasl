...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Important: / gnupg (ELSA-2007-0107)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0107.html");
