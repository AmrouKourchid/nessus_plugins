...
# extracted from Fedora Security Advisory FEDORA-2024-96a7a68962
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-96a7a68962");

  script_name(english:"Fedora 40 : golang (2024-96a7a68962)");
...
FEDORA-2024-96a7a68962 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-96a7a68962");
...
var pkgs = [
    {'reference':'golang-1.22.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
