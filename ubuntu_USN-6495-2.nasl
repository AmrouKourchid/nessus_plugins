...
# extracted from Ubuntu Security Notice USN-6495-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6495-2");

  script_name(english:"Ubuntu 18.04 ESM / 20.04 LTS : Linux kernel vulnerabilities (USN-6495-2)");
...
referenced in the USN-6495-2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6495-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1081-gkeop");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1118-gcp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.4.0-1120-azure");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6495-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6495-2');
  }
  else
  {
