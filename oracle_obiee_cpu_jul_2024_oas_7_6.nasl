...
if (description)
{
  ...
  script_cve_id("CVE-2024-0727", "CVE-2024-21139");

  script_name(english:"Oracle Business Intelligence Enterprise Edition (OAS 7.6) (July 2024 CPU)");
...
"Apply the appropriate patch according to the July 2024 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21139");
...
var constraints = [
  {'min_version': '7.6.0.0.0', 'fixed_version': '7.6.0.0.240708', 'fixed_display': '7.6.0.0.240708 patch: 36814917'}
];
