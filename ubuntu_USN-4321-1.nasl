...
# extracted from Ubuntu Security Notice USN-4321-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : HAProxy vulnerability (USN-4321-1)");
...
USN-4321-1 advisory.
    ...
    Felix Wilhelm discovered that HAProxy incorrectly handled certain HTTP/2 requests. An attacker could
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4321-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'haproxy', 'pkgver': '1.8.8-1ubuntu0.10'},
    {'osver': '18.04', 'pkgname': 'vim-haproxy', 'pkgver': '1.8.8-1ubuntu0.10'}
];
