...
# extracted from Fedora Security Advisory FEDORA-2023-fbf86d8916
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fbf86d8916");

  script_name(english:"Fedora 38 : ghostscript (2023-fbf86d8916)");
...
FEDORA-2023-fbf86d8916 advisory.

    Security fix for CVE-2023-28879
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fbf86d8916");
...
var pkgs = [
    {'reference':'ghostscript-10.01.0-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
