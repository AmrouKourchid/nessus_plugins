...
"The version of Google Chrome installed on the remote Windows host is prior to 126.0.6478.126. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'126.0.6478.126', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
