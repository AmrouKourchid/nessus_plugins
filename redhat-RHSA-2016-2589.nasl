...
the RHSA-2016:2589 advisory.
    ...
    * Multiple use-after-free vulnerabilities were found in GIMP in the channel and layer properties parsing
    process when loading XCF files. An attacker could create a specially crafted XCF file which could cause
    GIMP to crash. (CVE-2016-4994)
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2016/rhsa-2016_2589.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?69d9c712");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:2589");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1298226");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1348617");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1370595");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gimp-2.8.16-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'gimp-devel-2.8.16-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'gimp-devel-tools-2.8.16-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'gimp-help-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-ca-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-da-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-de-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-el-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-en_GB-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-es-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-fr-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-it-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-ja-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-ko-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-nl-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-nn-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-pt_BR-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-ru-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-sl-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-sv-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-help-zh_CN-2.8.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gimp-libs-2.8.16-3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
