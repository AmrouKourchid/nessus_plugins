...
# extracted from Red Hat Security Advisory RHSA-2020:0903. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0903");

  script_name(english:"RHEL 8 : zsh (RHSA-2020:0903)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for zsh.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:0903 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0903.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f3efc545");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0903");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1804859");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL zsh package based on the guidance in RHSA-2020:0903.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'zsh-5.5.1-6.el8_1.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
  ...
  },
  {
    ...
    'pkgs': [
      {'reference':'zsh-5.5.1-6.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'zsh-html-5.5.1-6.el8_1.2', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
