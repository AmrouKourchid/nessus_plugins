...
# extracted from Red Hat Security Advisory RHSA-2021:5235. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:5235");
  script_xref(name:"IAVB", value:"2021-B-0067-S");

  script_name(english:"RHEL 8 : postgresql:12 (RHSA-2021:5235)");
...
referenced in the RHSA-2021:5235 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_5235.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?703badbc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:5235");
...
"Update the RHEL postgresql:12 package based on the guidance in RHSA-2021:5235.");
  ...
  'postgresql:12': [
    {
      ...
      'pkgs': [
        {'reference':'pg_repack-1.4.6-3.module+el8.5.0+11354+78b3c9c5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pgaudit-1.4.0-5.module+el8.5.0+11354+78b3c9c5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgres-decoderbufs-0.10.0-2.module+el8.5.0+11354+78b3c9c5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-12.9-1.module+el8.5.0+13373+4554acc4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-12.9-1.module+el8.5.0+13373+4554acc4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-12.9-1.module+el8.5.0+13373+4554acc4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-12.9-1.module+el8.5.0+13373+4554acc4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-12.9-1.module+el8.5.0+13373+4554acc4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-12.9-1.module+el8.5.0+13373+4554acc4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-12.9-1.module+el8.5.0+13373+4554acc4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-12.9-1.module+el8.5.0+13373+4554acc4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-12.9-1.module+el8.5.0+13373+4554acc4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-12.9-1.module+el8.5.0+13373+4554acc4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-12.9-1.module+el8.5.0+13373+4554acc4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-12.9-1.module+el8.5.0+13373+4554acc4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-12.9-1.module+el8.5.0+13373+4554acc4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
