...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.5.0 < 8.5.83");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 8.5.83. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_8.5.83_security-8 advisory.
...
var constraints = [
  { 'min_version' : '8.5.0', 'max_version' : '8.5.82', 'fixed_version' : '8.5.83' }
];
