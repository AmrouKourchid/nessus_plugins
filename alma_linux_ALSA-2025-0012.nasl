...
# AlmaLinux Security Advisory ALSA-2025:0012.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:0012");
  script_xref(name:"RHSA", value:"2025:0012");

  script_name(english:"AlmaLinux 8 : python-requests (ALSA-2025:0012)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2025-0012.html");
