...
# extracted from Red Hat Security Advisory RHSA-2024:8859. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8859");

  script_name(english:"RHEL 8 : xmlrpc-c (RHSA-2024:8859)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for xmlrpc-c.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:8859 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?025d4f02");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8859");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xmlrpc-c package based on the guidance in RHSA-2024:8859.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xmlrpc-c-1.51.0-10.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-c++-1.51.0-10.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-client++-1.51.0-10.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-client-1.51.0-10.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-devel-1.51.0-10.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
