...
# extracted from Red Hat Security Advisory RHSA-2022:8226. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8226");

  script_name(english:"RHEL 9 : python-lxml (RHSA-2022:8226)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-lxml.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8226.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38cfade1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8226");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2107571");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-lxml package based on the guidance in RHSA-2022:8226.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-lxml");
