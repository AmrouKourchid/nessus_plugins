...
vulnerabilities as referenced in the ALAS2-2021-1719 advisory.
    ...
    highest threat from this vulnerability is system availability. (CVE-2021-20317)
    ...
    A flaw was found in the Linux kernel. The cBPF JIT compiler may produce machine code with incorrect
    branches. This flaw allows an unprivileged user to craft anomalous machine code, where the control flow is
    hijacked to execute arbitrary kernel code. The highest threat from this vulnerability is to
    confidentiality, integrity, as well as system availability. (CVE-2021-38300)
...
"Run 'yum update kernel' to update your system.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-47404");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2021-3744", "CVE-2021-3764", "CVE-2021-20317", "CVE-2021-20321", "CVE-2021-37159", "CVE-2021-38300", "CVE-2021-41864", "CVE-2021-47373", "CVE-2021-47375", "CVE-2021-47383", "CVE-2021-47387", "CVE-2021-47404", "CVE-2021-47497");
