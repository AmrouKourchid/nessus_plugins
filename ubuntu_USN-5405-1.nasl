...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : jbig2dec vulnerabilities (USN-5405-1)");
...
the USN-5405-1 advisory.
    ...
    It was discovered that jbig2dec incorrectly handled memory when parsing invalid files. An attacker could
    use this issue to cause jbig2dec to crash, leading to a denial of service. (CVE-2017-9216)

    It was discovered that jbig2dec incorrectly handled memory when processing untrusted input. An attacker
    could use this issue to cause a denial of service, or possibly execute arbitrary code. (CVE-2020-12268)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'jbig2dec', 'pkgver': '0.12+20150918-1ubuntu0.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libjbig2dec0', 'pkgver': '0.12+20150918-1ubuntu0.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libjbig2dec0-dev', 'pkgver': '0.12+20150918-1ubuntu0.1+esm2', 'ubuntu_pro': TRUE}
];
