...
# extracted from Fedora Security Advisory FEDORA-2023-a479289864
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a479289864");

  script_name(english:"Fedora 38 : webkitgtk (2023-a479289864)");
...
FEDORA-2023-a479289864 advisory.

    Fix several crashes and rendering issues

    Security fixes: CVE-2023-38133, CVE-2023-38572, CVE-2023-38592, CVE-2023-38594, CVE-2023-38595,
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a479289864");
...
var pkgs = [
    {'reference':'webkitgtk-2.40.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
