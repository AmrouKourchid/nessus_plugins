...
# extracted from Oracle Linux Security Advisory ELSA-2023-0318.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : postgresql-jdbc (ELSA-2023-0318)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-0318.html");
...
var pkgs = [
    {'reference':'postgresql-jdbc-42.2.18-6.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
