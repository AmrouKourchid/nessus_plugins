...
# extracted from Fedora Security Advisory FEDORA-2022-3a000dac3a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-3a000dac3a");

  script_name(english:"Fedora 36 : firefox (2022-3a000dac3a)");
...
FEDORA-2022-3a000dac3a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3a000dac3a");
...
var pkgs = [
    {'reference':'firefox-108.0.1-3.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
