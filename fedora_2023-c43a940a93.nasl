...
# extracted from Fedora Security Advisory FEDORA-2023-c43a940a93
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c43a940a93");

  script_name(english:"Fedora 38 : pypy (2023-c43a940a93)");
...
FEDORA-2023-c43a940a93 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c43a940a93");
  script_set_attribute(attribute:"solution", value:
"Update the affected pypy package.");
...
var pkgs = [
    {'reference':'pypy-7.3.12-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
