...
# extracted from Red Hat Security Advisory RHSA-2022:1407. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1407");

  script_name(english:"RHEL 8 : container-tools:2.0 (RHSA-2022:1407)");
...
referenced in the RHSA-2022:1407 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fdfc404d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1407");
...
"Update the RHEL container-tools:2.0 package based on the guidance in RHSA-2022:1407.");
  ...
  'container-tools:2.0': [
    {
      ...
      'pkgs': [
        {'reference':'buildah-1.11.6-9.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'buildah-tests-1.11.6-9.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'cockpit-podman-11-1.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'conmon-2.0.15-1.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'container-selinux-2.130.0-1.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'containernetworking-plugins-0.8.3-4.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'containers-common-0.1.41-4.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'crit-3.12-9.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'criu-3.12-9.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'fuse-overlayfs-0.7.8-1.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-1.6.4-28.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-docker-1.6.4-28.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-remote-1.6.4-28.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-tests-1.6.4-28.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-podman-api-1.2.0-0.2.gitd0a45fe.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-criu-3.12-9.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'runc-1.0.0-65.rc10.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'skopeo-0.1.41-4.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'skopeo-tests-0.1.41-4.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'slirp4netns-0.4.2-3.git21fdece.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'toolbox-0.0.7-1.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'udica-0.2.1-2.module+el8.4.0+14792+f44be4c2', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
