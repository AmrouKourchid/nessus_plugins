...
# extracted from Fedora Security Advisory FEDORA-2025-2edd9dc83b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-2edd9dc83b");

  script_name(english:"Fedora 41 : dotnet9.0 (2025-2edd9dc83b)");
...
FEDORA-2025-2edd9dc83b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2edd9dc83b");
...
var pkgs = [
    {'reference':'dotnet9.0-9.0.104-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
