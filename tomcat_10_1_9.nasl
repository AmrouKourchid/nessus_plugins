...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 10.1.0 < 10.1.9");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 10.1.9. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_10.1.9_security-10 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8445fb1c");
  # https://tomcat.apache.org/security-10.html#Fixed_in_Apache_Tomcat_10.1.9
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?198163af");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 10.1.9 or later.");
...
var constraints = [
  { 'fixed_version' : '10.1.9', 'equal' : '10.1.8' }
];
