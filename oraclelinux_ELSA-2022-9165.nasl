...
# extracted from Oracle Linux Security Advisory ELSA-2022-9165.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : aide (ELSA-2022-9165)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-9165.html");
...
var pkgs = [
    {'reference':'aide-0.14-11.0.1.el6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'aide-0.14-11.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
