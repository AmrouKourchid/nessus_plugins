...
# extracted from Fedora Security Advisory FEDORA-2024-9176fdb518
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9176fdb518");

  script_name(english:"Fedora 39 : python-idna (2024-9176fdb518)");
...
FEDORA-2024-9176fdb518 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9176fdb518");
...
var pkgs = [
    {'reference':'python-idna-3.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
