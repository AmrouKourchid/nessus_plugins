...
# extracted from Fedora Security Advisory FEDORA-2025-a13867ecbc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-a13867ecbc");

  script_name(english:"Fedora 41 : rust-openssl / rust-openssl-sys (2025-a13867ecbc)");
...
FEDORA-2025-a13867ecbc advisory.

    - Update the openssl crate to version 0.10.72.
    - Update the openssl-sys crate to version 0.9.107.

    This update addresses [CVE-2025-3416](https://nvd.nist.gov/vuln/detail/CVE-2025-3416) /
    [RUSTSEC-2025-0022](https://rustsec.org/advisories/RUSTSEC-2025-0022.html) (a possible use-after-free
    issue in two public functions). A survey of dependent packages in Fedora shows that none of them use the
    affected API, or do not use them in a way that triggers this issue.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-a13867ecbc");
  script_set_attribute(attribute:"solution", value:
"Update the affected rust-openssl and / or rust-openssl-sys packages.");
...
var pkgs = [
    {'reference':'rust-openssl-0.10.72-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rust-openssl-sys-0.9.107-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rust-openssl / rust-openssl-sys');
}
