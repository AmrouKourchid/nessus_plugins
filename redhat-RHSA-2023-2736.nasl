...
# extracted from Red Hat Security Advisory RHSA-2023:2736. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2736");

  script_name(english:"RHEL 8 : kernel-rt (RHSA-2023:2736)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:2736 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2736");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2023:2736');
  }
  else
  {
