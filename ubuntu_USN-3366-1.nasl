...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : OpenJDK 8 vulnerabilities (USN-3366-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-3366-1 advisory.
    ...
    It was discovered that the JavaScript Scripting component of OpenJDK incorrectly allowed access to Java
    APIs. An attacker could use this to specially craft JavaScript code to bypass access restrictions.
    (CVE-2017-10078)
    ...
    Jackson Davis discovered that the LambdaFormEditor class in the Libraries component of OpenJDK did not
    correctly perform bounds checks in the permuteArgumentsForm() function. An attacker could use this to
    specially construct an untrusted Java application or applet that could escape sandbox restrictions and
    possibly execute arbitrary code. (CVE-2017-10111)
    ...
    It was discovered that OpenJDK did not properly restrict weak key sizes in some situations. An attacker
    could use this to specially construct an untrusted Java application or applet that could escape sandbox
    restrictions. (CVE-2017-10193)

    It was discovered that OpenJDK did not properly enforce disabled algorithm restrictions on X.509
    certificate chains. An attacker could use this to expose sensitive information or escape sandbox
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3366-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'openjdk-8-demo', 'pkgver': '8u131-b11-2ubuntu1.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk', 'pkgver': '8u131-b11-2ubuntu1.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk-headless', 'pkgver': '8u131-b11-2ubuntu1.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre', 'pkgver': '8u131-b11-2ubuntu1.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-headless', 'pkgver': '8u131-b11-2ubuntu1.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-jamvm', 'pkgver': '8u131-b11-2ubuntu1.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-zero', 'pkgver': '8u131-b11-2ubuntu1.16.04.2'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-source', 'pkgver': '8u131-b11-2ubuntu1.16.04.2'}
];
