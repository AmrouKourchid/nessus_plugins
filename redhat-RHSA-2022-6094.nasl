...
# extracted from Red Hat Security Advisory RHSA-2022:6094. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6094");

  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.10.28 (RHSA-2022:6094)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.10.28.");
...
referenced in the RHSA-2022:6094 advisory.

    Red Hat OpenShift Container Platform is Red Hat's cloud computing
    Kubernetes application platform solution designed for on-premise or private
    cloud deployments.

    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.10.28. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6094.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd8592ba");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6094");
...
"Update the RHEL OpenShift Container Platform 4.10.28 packages based on the guidance in RHSA-2022:6094.");
  ...
  script_cwe_id(120, 190, 252, 1220);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.23.3-14.rhaos4.10.git6af791c.1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.23.3-13.rhaos4.10.git6af791c.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
