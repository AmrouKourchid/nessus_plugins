...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 1703 Home SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 1703 Home is no longer maintained by its vendor or provider.
...
"Upgrade to a version of Microsoft Windows that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2018/10/09");
...
var constraints = [
  { seol : 20181009, cpe_attributes : [{'edition': 'home*'}] }
];
