...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : perl (EulerOS-SA-2018-1307)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1307
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1fe86417");
...
pkgs = ["perl-5.16.3-285.h2",
        "perl-core-5.16.3-285.h2",
        "perl-devel-5.16.3-285.h2",
        "perl-libs-5.16.3-285.h2",
        "perl-macros-5.16.3-285.h2"];
