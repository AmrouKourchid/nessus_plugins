...
# extracted from Fedora Security Advisory FEDORA-2023-5d980e6aaf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5d980e6aaf");

  script_name(english:"Fedora 37 : matrix-synapse (2023-5d980e6aaf)");
...
FEDORA-2023-5d980e6aaf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5d980e6aaf");
...
var pkgs = [
    {'reference':'matrix-synapse-1.80.0-6.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
