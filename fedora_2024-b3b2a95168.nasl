...
# extracted from Fedora Security Advisory FEDORA-2024-b3b2a95168
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b3b2a95168");

  script_name(english:"Fedora 38 : tcpreplay (2024-b3b2a95168)");
...
FEDORA-2024-b3b2a95168 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b3b2a95168");
...
var pkgs = [
    {'reference':'tcpreplay-4.4.4-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
