...
# extracted from Fedora Security Advisory FEDORA-2023-a93d7639cd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a93d7639cd");

  script_name(english:"Fedora 38 : thunderbird (2023-a93d7639cd)");
...
FEDORA-2023-a93d7639cd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a93d7639cd");
...
var pkgs = [
    {'reference':'thunderbird-102.13.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
