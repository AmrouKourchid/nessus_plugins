...
if (description)
{
  ...
  script_cve_id("CVE-2024-30203", "CVE-2024-30205");

  script_name(english:"EulerOS 2.0 SP9 : emacs (EulerOS-SA-2024-2387)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2387
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?232686aa");
...
var pkgs = [
  "emacs-filesystem-26.1-13.h9.eulerosv2r9"
];
