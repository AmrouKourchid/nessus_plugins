...
# extracted from Fedora Security Advisory FEDORA-2024-fbe1f0c1aa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fbe1f0c1aa");

  script_name(english:"Fedora 39 : mingw-expat (2024-fbe1f0c1aa)");
...
FEDORA-2024-fbe1f0c1aa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fbe1f0c1aa");
...
var pkgs = [
    {'reference':'mingw-expat-2.6.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
