...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.0.1 < 1.0.1q Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.0.1q. It is, therefore, affected by multiple
vulnerabilities as referenced in the 1.0.1q advisory.
...
var constraints = [
  { 'min_version' : '1.0.1', 'fixed_version' : '1.0.1q' }
];
