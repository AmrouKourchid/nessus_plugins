...
# extracted from Debian Security Advisory dsa-5676. The text
...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2024-A-0267-S");

  script_name(english:"Debian dsa-5676 : chromium - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-4331");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-4368");
...
"Upgrade the chromium packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-4368");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'chromium', 'reference': '124.0.6367.118-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-common', 'reference': '124.0.6367.118-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-driver', 'reference': '124.0.6367.118-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-l10n', 'reference': '124.0.6367.118-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-sandbox', 'reference': '124.0.6367.118-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-shell', 'reference': '124.0.6367.118-1~deb12u1'}
];
