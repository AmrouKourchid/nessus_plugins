...
# extracted from Fedora Security Advisory FEDORA-2024-de10068888
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-de10068888");

  script_name(english:"Fedora 39 : emacs (2024-de10068888)");
...
FEDORA-2024-de10068888 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-de10068888");
...
var pkgs = [
    {'reference':'emacs-29.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
