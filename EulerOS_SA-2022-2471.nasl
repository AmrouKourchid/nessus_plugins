...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libxml2 (EulerOS-SA-2022-2471)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2471
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a49473e");
...
var pkgs = [
  "libxml2-2.9.8-4.h19.eulerosv2r8",
  "libxml2-devel-2.9.8-4.h19.eulerosv2r8",
  "python2-libxml2-2.9.8-4.h19.eulerosv2r8",
  "python3-libxml2-2.9.8-4.h19.eulerosv2r8"
];
