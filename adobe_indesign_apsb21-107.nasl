...
if (description)
{
  ...
  script_name(english:"Adobe InDesign 16.0 < 17.0.0 Multiple Vulnerabilities (APSB21-107)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe InDesign instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe InDesign installed on the remote Windows host is prior to 17.0.0. It is, therefore, affected by
