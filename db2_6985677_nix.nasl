...
if (description)
{
  ...
  script_cve_id("CVE-2023-25930");
  script_xref(name:"IAVB", value:"2023-B-0028-S");

  script_name(english:"IBM DB2 < v10.5 Special Build 41270 / < 11.1 Special Build 41268 / < 11.5 Special Build 29133 DoS (Unix)");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a denial of service vulnerability.");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version number, IBM Db2 is vulnerable to a denial of service. Under rare conditions, 
setting a special register may cause the Db2 server to terminate abnormally.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6985677");
...
"Apply the appropriate IBM DB2 Fix Pack or Special Build based on the most recent fix pack level for your branch.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-25930");
...
var constraints = [
  ...
  {'min_version':'10.5.0.0', 'fixed_version':'10.5.0.11', 'fixed_display':'10.5.0.11 + Special Build 41270'},
  {'equal':'11.1.4.7', 'fixed_build':'41268'},
  {'min_version':'11.1.0.0', 'fixed_version':'11.1.4.7', 'fixed_display':'11.1.4.7 + Special Build 41268'},
  {'equal':'11.5.7.0', 'fixed_build':'29133'},
  {'min_version':'11.5.7', 'fixed_version':'11.5.7.0', 'fixed_display':'11.5.7.0 + Special Build 29133'},
  {'equal':'11.5.8.0', 'fixed_build':'29133'},
  {'min_version':'11.5.8', 'fixed_version':'11.5.8.0', 'fixed_display':'11.5.8.0 + Special Build 29133'}
];
