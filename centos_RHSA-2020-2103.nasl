...
# extracted from Red Hat Security Advisory RHSA-2020:2103 and 
# CentOS Errata and Security Advisory 2020:2103 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : kernel (RHSA-2020:2103)");
...
var pkgs = [
    {'reference':'kernel-2.6.32-754.29.2.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-abi-whitelists-2.6.32-754.29.2.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-bootwrapper-2.6.32-754.29.2.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-debug-2.6.32-754.29.2.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-debug-devel-2.6.32-754.29.2.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-devel-2.6.32-754.29.2.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-firmware-2.6.32-754.29.2.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-headers-2.6.32-754.29.2.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-kdump-2.6.32-754.29.2.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-kdump-devel-2.6.32-754.29.2.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'perf-2.6.32-754.29.2.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-perf-2.6.32-754.29.2.el6', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE}
];
