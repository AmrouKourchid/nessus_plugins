...
# extracted from Fedora Security Advisory FEDORA-2024-9231308a4f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9231308a4f");

  script_name(english:"Fedora 40 : prometheus-podman-exporter (2024-9231308a4f)");
...
FEDORA-2024-9231308a4f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9231308a4f");
...
var pkgs = [
    {'reference':'prometheus-podman-exporter-1.11.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
