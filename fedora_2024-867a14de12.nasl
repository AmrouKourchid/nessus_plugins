...
# extracted from Fedora Security Advisory FEDORA-2024-867a14de12
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-867a14de12");

  script_name(english:"Fedora 41 : libxml2 (2024-867a14de12)");
...
FEDORA-2024-867a14de12 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-867a14de12");
...
var pkgs = [
    {'reference':'libxml2-2.12.9-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
