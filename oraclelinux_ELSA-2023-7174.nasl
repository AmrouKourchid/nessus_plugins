...
# extracted from Oracle Linux Security Advisory ELSA-2023-7174.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : perl-HTTP-Tiny (ELSA-2023-7174)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-7174.html");
...
var pkgs = [
    {'reference':'perl-HTTP-Tiny-0.074-2.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
