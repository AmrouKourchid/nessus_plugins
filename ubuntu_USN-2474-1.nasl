...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : curl vulnerability (USN-2474-1)");
...
USN-2474-1 advisory.
    ...
    Andrey Labunets discovered that curl incorrectly handled certain URLs when using a proxy server. If a user
    or automated system were tricked into using a specially crafted URL, an attacker could possibly use this
    issue to inject arbitrary HTTP requests.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2474-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-8150");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'curl', 'pkgver': '7.35.0-1ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'curl-udeb', 'pkgver': '7.35.0-1ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'libcurl3', 'pkgver': '7.35.0-1ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'libcurl3-gnutls', 'pkgver': '7.35.0-1ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'libcurl3-nss', 'pkgver': '7.35.0-1ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'libcurl3-udeb', 'pkgver': '7.35.0-1ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'libcurl4-gnutls-dev', 'pkgver': '7.35.0-1ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'libcurl4-nss-dev', 'pkgver': '7.35.0-1ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'libcurl4-openssl-dev', 'pkgver': '7.35.0-1ubuntu2.3'}
];
