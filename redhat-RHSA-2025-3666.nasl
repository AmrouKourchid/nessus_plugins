...
# extracted from Red Hat Security Advisory RHSA-2025:3666. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3666");

  script_name(english:"RHEL 9 : openssl (RHSA-2025:3666)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3666.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6de792ad");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3666");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openssl package based on the guidance in RHSA-2025:3666.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssl-3.0.7-29.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-devel-3.0.7-29.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-libs-3.0.7-29.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-perl-3.0.7-29.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
