...
referenced in the RHSA-2019:0633 advisory.
    ...
    * ghostscript: Regression: double comment chars '%%' in gs_init.ps leading to missing metadata
    (BZ#1673915)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0633.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?07e3a012");
...
"Update the RHEL ghostscript package based on the guidance in RHSA-2019:0633.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ghostscript-9.07-31.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-cups-9.07-31.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-devel-9.07-31.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-doc-9.07-31.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-gtk-9.07-31.el7_6.10', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
