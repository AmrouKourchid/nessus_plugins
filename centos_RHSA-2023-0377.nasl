...
# extracted from Red Hat Security Advisory RHSA-2023:0377 and
# CentOS Errata and Security Advisory 2023:0377 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libXpm (RHSA-2023:0377)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
RHSA-2023:0377 advisory.
...
var pkgs = [
    {'reference':'libXpm-3.5.12-2.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libXpm-3.5.12-2.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libXpm-devel-3.5.12-2.el7_9', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libXpm-devel-3.5.12-2.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
