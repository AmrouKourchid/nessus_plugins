...
# extracted from Red Hat Security Advisory RHSA-2024:10851. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10851");

  script_name(english:"RHEL 8 : postgresql:15 (RHSA-2024:10851)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for postgresql:15.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:10851 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10851.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?412ce7ae");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10851");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:15 package based on the guidance in RHSA-2024:10851.");
  ...
  'postgresql:15': [
    {
      ...
      'pkgs': [
        {'reference':'pg_repack-1.4.8-1.module+el8.8.0+17071+aaaceaa4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pgaudit-1.7.0-1.module+el8.8.0+17071+aaaceaa4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgres-decoderbufs-1.9.7-1.Final.module+el8.8.0+17071+aaaceaa4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-devel-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-private-libs-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-15.10-1.module+el8.8.0+22585+211737dc.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
