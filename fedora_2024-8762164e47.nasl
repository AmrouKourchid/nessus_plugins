...
# extracted from Fedora Security Advisory FEDORA-2024-8762164e47
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8762164e47");

  script_name(english:"Fedora 39 : qpdf (2024-8762164e47)");
...
FEDORA-2024-8762164e47 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8762164e47");
...
var pkgs = [
    {'reference':'qpdf-11.6.4-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
