...
ELSA-2022-0825 advisory.
    ...
    - selftests: kvm: Check whether SIDA memop fails for normal guests (Thomas Huth) [2050806 2050807]
    {CVE-2022-0516}
    ...
    - drm/vmwgfx: Fix stale file descriptors on failed usercopy (Dave Airlie) [2047601 2047602]
    {CVE-2022-22942}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-stablelists-4.18.0-348.20.1.el8_5', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-stablelists-4.18.0'},
