...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002649");
  script_xref(name:"MSFT", value:"MS23-5002649");
  script_xref(name:"IAVA", value:"2024-A-0634-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server Subscription Edition (October 2024)");
...
security updates. It is, therefore, affected by a privilage elevation vulnerability.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002649");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002649 to address this issue.");
