...
# extracted from Debian Security Advisory dla-3952. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3952 : libunbound-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-3952
advisory.
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libunbound-dev', 'reference': '1.13.1-1+deb11u4'},
    {'release': '11.0', 'prefix': 'libunbound8', 'reference': '1.13.1-1+deb11u4'},
    {'release': '11.0', 'prefix': 'python3-unbound', 'reference': '1.13.1-1+deb11u4'},
    {'release': '11.0', 'prefix': 'unbound', 'reference': '1.13.1-1+deb11u4'},
    {'release': '11.0', 'prefix': 'unbound-anchor', 'reference': '1.13.1-1+deb11u4'},
    {'release': '11.0', 'prefix': 'unbound-host', 'reference': '1.13.1-1+deb11u4'}
];
