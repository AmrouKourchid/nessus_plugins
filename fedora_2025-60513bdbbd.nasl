...
# extracted from Fedora Security Advisory FEDORA-2025-60513bdbbd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-60513bdbbd");

  script_name(english:"Fedora 41 : ruby (2025-60513bdbbd)");
...
FEDORA-2025-60513bdbbd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-60513bdbbd");
...
var pkgs = [
    {'reference':'ruby-3.3.8-19.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
