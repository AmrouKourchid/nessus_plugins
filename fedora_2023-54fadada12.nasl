...
# extracted from Fedora Security Advisory FEDORA-2023-54fadada12
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-54fadada12");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");
  script_xref(name:"IAVB", value:"2023-B-0083-S");

  script_name(english:"Fedora 37 : trafficserver (2023-54fadada12)");
...
FEDORA-2023-54fadada12 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-54fadada12");
...
var pkgs = [
    {'reference':'trafficserver-9.2.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
