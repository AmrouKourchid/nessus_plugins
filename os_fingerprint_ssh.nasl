...
var ports, port, banner, confidence, sshtext;
var os, product, match, proteus_version, kernel_version, pat, v;
...
# OS detected from SSH banner
#  - Add protocol and port
if (get_one_kb_item('Host/OS/SSH'))
{
  replace_kb_item(name:'Host/OS/SSH/Protocol', value:'tcp');
  replace_kb_item(name:'Host/OS/SSH/Port', value:port);
}