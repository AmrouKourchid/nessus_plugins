...
# extracted from Red Hat Security Advisory libjpeg-turbo. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-13960", "CVE-2020-35538");

  script_name(english:"RHEL 8 : libjpeg-turbo (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-35538");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mingw-libjpeg-turbo");
