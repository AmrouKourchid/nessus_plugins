...
# extracted from Fedora Security Advisory FEDORA-2019-355f6e10c1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-355f6e10c1");

  script_name(english:"Fedora 29 : libmodbus (2019-355f6e10c1)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-355f6e10c1");
  script_set_attribute(attribute:"solution", value:
"Update the affected libmodbus package.");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libmodbus-3.0.8-1.fc29")) flag++;
