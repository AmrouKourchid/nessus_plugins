...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5043138");
  script_xref(name:"MSFT", value:"MS24-5043138");
  ...
  script_name(english:"KB5043138: Windows Server 2012 R2 Security Update (September 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5043138. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5043138");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5043138");
