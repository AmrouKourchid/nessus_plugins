...
if (description)
{
  ...
  script_cve_id("CVE-2022-37050", "CVE-2022-37052");

  script_name(english:"RHEL 9 : poppler (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libreoffice-flatpak-container");
