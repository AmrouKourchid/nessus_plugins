...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : kernel (IJ43869)");
  script_summary(english:"Check for APAR IJ43869");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ43869m3c", package:"bos.mp64", minfilesetver:"7.2.5.102", maxfilesetver:"7.2.5.105") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ43869m3c", package:"bos.mp64", minfilesetver:"7.2.5.200", maxfilesetver:"7.2.5.201") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ43869m3d", package:"bos.mp64", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.5") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ43869m3d", package:"bos.mp64", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.101") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ43869m4b", package:"bos.mp64", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.5") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ43869m4b", package:"bos.mp64", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.105") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ43869m4b", package:"bos.mp64", minfilesetver:"7.2.5.200", maxfilesetver:"7.2.5.201") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"05", patch:"(IJ43869m5b|IJ48608m5b)", package:"bos.mp64", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.5") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"05", patch:"(IJ43869m5b|IJ48608m5b)", package:"bos.mp64", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.105") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"05", patch:"(IJ43869m5b|IJ48608m5b)", package:"bos.mp64", minfilesetver:"7.2.5.200", maxfilesetver:"7.2.5.201") < 0) flag++;

if (flag)
  security_report_v4(severity:SECURITY_WARNING, port:0, extra:aix_report_get());
else 
