...
# extracted from Fedora Security Advisory FEDORA-2023-5c979c4971
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5c979c4971");

  script_name(english:"Fedora 37 : firefox (2023-5c979c4971)");
...
FEDORA-2023-5c979c4971 advisory.

    - New upstream update (115.0)
    - Built with PGO
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5c979c4971");
...
var pkgs = [
    {'reference':'firefox-115.0-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
