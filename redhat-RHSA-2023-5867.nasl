...
# extracted from Red Hat Security Advisory RHSA-2023:5867. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5867");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");
  script_xref(name:"IAVB", value:"2023-B-0083-S");

  script_name(english:"RHEL 9 : grafana (RHSA-2023:5867)");
...
referenced in the RHSA-2023:5867 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5867.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?99108965");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5867");
...
"Update the RHEL grafana package based on the guidance in RHSA-2023:5867.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-9.0.9-4.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'grafana-9.0.9-4.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
