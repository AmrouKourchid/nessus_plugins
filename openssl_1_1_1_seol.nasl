...
if (description)
{
  ...
  script_name(english:"OpenSSL SEoL (1.1.1.x)");
...
contain security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://www.openssl.org/blog/blog/2023/09/11/eol-111/");
  script_set_attribute(attribute:"see_also", value:"https://www.openssl.org/policies/releasestrat.html");
  script_set_attribute(attribute:"see_also", value:"https://www.openssl.org/news/vulnerabilities-1.1.1.html");
...
"Upgrade to a version of OpenSSL that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2023/09/11");
...
# Versions after the last stable release of 1.1.1w are extended support
# https://openssl-library.org/news/vulnerabilities-1.1.1/
# This will catch all versions past 1.1.1w such as : 
# 1.1.1x, 1.1.1y , 1.1.1z*
if (pgrep(pattern:"1\.1\.1[x-z]" , string:app_info['version']))
{
  ::audit(AUDIT_HOST_NOT, "affected due to Extended Support");
}

var constraints = [
  { max_branch : '1.1.1', min_branch : '1.1.1', seol : 20230911 }
];
