...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : gvfs (EulerOS-SA-2019-1749)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1749
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1bbf12dd");
...
pkgs = ["gvfs-1.22.4-6.h1",
        "gvfs-afc-1.22.4-6.h1",
        "gvfs-afp-1.22.4-6.h1",
        "gvfs-archive-1.22.4-6.h1",
        "gvfs-devel-1.22.4-6.h1",
        "gvfs-fuse-1.22.4-6.h1",
        "gvfs-goa-1.22.4-6.h1",
        "gvfs-gphoto2-1.22.4-6.h1",
        "gvfs-mtp-1.22.4-6.h1",
        "gvfs-smb-1.22.4-6.h1"];
