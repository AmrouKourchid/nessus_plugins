...
# extracted from Fedora Security Advisory FEDORA-2025-9c1d536035
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-9c1d536035");

  script_name(english:"Fedora 41 : chromium (2025-9c1d536035)");
...
FEDORA-2025-9c1d536035 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-9c1d536035");
...
var pkgs = [
    {'reference':'chromium-135.0.7049.95-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
