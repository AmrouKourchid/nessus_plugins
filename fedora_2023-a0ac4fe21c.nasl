...
# extracted from Fedora Security Advisory FEDORA-2023-a0ac4fe21c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a0ac4fe21c");

  script_name(english:"Fedora 39 : firefox (2023-a0ac4fe21c)");
...
FEDORA-2023-a0ac4fe21c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a0ac4fe21c");
...
var pkgs = [
    {'reference':'firefox-118.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
