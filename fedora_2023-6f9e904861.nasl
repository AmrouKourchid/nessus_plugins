...
# extracted from Fedora Security Advisory FEDORA-2023-6f9e904861
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6f9e904861");

  script_name(english:"Fedora 38 : tacacs (2023-6f9e904861)");
...
FEDORA-2023-6f9e904861 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6f9e904861");
...
var pkgs = [
    {'reference':'tacacs-F4.0.4.28.7fb~20231005g4fdf178-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
