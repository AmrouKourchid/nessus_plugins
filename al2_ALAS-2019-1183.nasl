...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1183.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1183");

  script_name(english:"Amazon Linux 2 : flatpak (ALAS-2019-1183)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Earlier versions of flatpak exposes /proc in the apply_extra script
sandbox, which allows attackers to modify a host-side executable
file.(CVE-2019-8308)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1183.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"flatpak-1.0.2-4.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"flatpak-builder-1.0.0-4.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"flatpak-debuginfo-1.0.2-4.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"flatpak-devel-1.0.2-4.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"flatpak-libs-1.0.2-4.amzn2.0.1")) flag++;
