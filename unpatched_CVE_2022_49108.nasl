...
if (description)
{
  ...
  script_cve_id("CVE-2022-49108");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49108");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: clk: mediatek: Fix memory leaks on
    probe Handle the error branches to free memory where required. Addresses-Coverity-ID: 1491825 (Resource
    leak) (CVE-2022-49108)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49108");
