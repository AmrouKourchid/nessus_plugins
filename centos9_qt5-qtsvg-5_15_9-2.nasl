...
if (description)
{
  ...
  script_name(english:"CentOS 9 : qt5-qtsvg-5.15.9-2.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for qt5-qtsvg.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
qt5-qtsvg-5.15.9-2.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=32977");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream qt5-qtsvg package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:qt5-qtsvg-tests");
...
var pkgs = [
    {'reference':'qt5-qtsvg-5.15.9-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtsvg-devel-5.15.9-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtsvg-examples-5.15.9-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtsvg-tests-5.15.9-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'qt5-qtsvg / qt5-qtsvg-devel / qt5-qtsvg-examples / qt5-qtsvg-tests');
}
