...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : ClamAV vulnerability (USN-2488-1)");
...
USN-2488-1 advisory.
    ...
    Sebastian Andrzej Siewior discovered that ClamAV incorrectly handled certain upack packer files. An
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2488-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9328");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'clamav', 'pkgver': '0.98.6+dfsg-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'clamav-base', 'pkgver': '0.98.6+dfsg-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'clamav-daemon', 'pkgver': '0.98.6+dfsg-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'clamav-freshclam', 'pkgver': '0.98.6+dfsg-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'clamav-milter', 'pkgver': '0.98.6+dfsg-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'clamav-testfiles', 'pkgver': '0.98.6+dfsg-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libclamav-dev', 'pkgver': '0.98.6+dfsg-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'libclamav6', 'pkgver': '0.98.6+dfsg-0ubuntu0.14.04.1'}
];
