...
# extracted from Fedora Security Advisory FEDORA-2024-69af78a508
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-69af78a508");
  script_xref(name:"IAVB", value:"2024-B-0170-S");

  script_name(english:"Fedora 41 : ghostscript (2024-69af78a508)");
...
FEDORA-2024-69af78a508 advisory.

    CVE-2024-46951 ghostscript: Arbitrary Code Execution in Artifex Ghostscript Pattern Color Space
    (fedora#2325238)

    2325241 - CVE-2024-46952 CVE-2024-46953 CVE-2024-46954 CVE-2024-46955 CVE-2024-46956 ghostscript: various
    flaws [fedora-41]
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-69af78a508");
...
var pkgs = [
    {'reference':'ghostscript-10.03.1-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
