...
# extracted from Fedora Security Advisory FEDORA-2023-c896cf87db
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c896cf87db");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/10/23");

  script_name(english:"Fedora 38 : libvpx (2023-c896cf87db)");
...
FEDORA-2023-c896cf87db advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c896cf87db");
...
var pkgs = [
    {'reference':'libvpx-1.13.0-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
