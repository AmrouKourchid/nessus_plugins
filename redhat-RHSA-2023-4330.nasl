...
# extracted from Red Hat Security Advisory RHSA-2023:4330. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4330");

  script_name(english:"RHEL 9 : nodejs:18 (RHSA-2023:4330)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:4330 advisory.

    Node.js is a software development platform for building fast and scalable network applications in the
    JavaScript programming language.

    The package has been upgraded to a later upstream version: nodejs (18). (BZ#2223314, BZ#2223316,
    BZ#2223318, BZ#2223319, BZ#2223320, BZ#2223354)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4330.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf4f8e88");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2223320");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4330");
  ...
  'nodejs:18': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-18.16.1-1.module+el9.2.0.z+19424+78951f07', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-18.16.1-1.module+el9.2.0.z+19424+78951f07', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-18.16.1-1.module+el9.2.0.z+19424+78951f07', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-18.16.1-1.module+el9.2.0.z+19424+78951f07', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-9.5.1-1.18.16.1.1.module+el9.2.0.z+19424+78951f07', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'nodejs-18.16.1-1.module+el9.2.0.z+19424+78951f07', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-18.16.1-1.module+el9.2.0.z+19424+78951f07', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-18.16.1-1.module+el9.2.0.z+19424+78951f07', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-18.16.1-1.module+el9.2.0.z+19424+78951f07', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-9.5.1-1.18.16.1.1.module+el9.2.0.z+19424+78951f07', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
