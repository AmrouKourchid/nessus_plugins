...
# extracted from Red Hat Security Advisory pywbem. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2013-6418", "CVE-2013-6444");

  script_name(english:"RHEL 6 : pywbem (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pywbem");
