...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : glibc (EulerOS-SA-2020-1229)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1229
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b984c8cf");
...
pkgs = ["glibc-2.28-9.h26",
        "glibc-all-langpacks-2.28-9.h26",
        "glibc-common-2.28-9.h26",
        "glibc-devel-2.28-9.h26",
        "glibc-headers-2.28-9.h26",
        "libnsl-2.28-9.h26",
        "nscd-2.28-9.h26"];
