...
# extracted from Ubuntu Security Notice USN-3702-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3702-1");

  script_name(english:"Ubuntu 18.04 LTS : PHP vulnerability (USN-3702-1)");
...
USN-3702-1 advisory.
    ...
    It was discovered that PHP incorrectly handled exif tags in certain images. A remote attacker could use
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3702-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2018/07/04");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'libapache2-mod-php7.2', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'libphp7.2-embed', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-bcmath', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-bz2', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-cgi', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-cli', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-common', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-curl', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-dba', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-dev', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-enchant', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-fpm', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-gd', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-gmp', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-imap', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-interbase', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-intl', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-json', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-ldap', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-mbstring', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-mysql', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-odbc', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-opcache', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-pgsql', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-phpdbg', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-pspell', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-readline', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-recode', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-snmp', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-soap', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-sqlite3', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-sybase', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-tidy', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-xml', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-xmlrpc', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-xsl', 'pkgver': '7.2.7-0ubuntu0.18.04.1'},
    {'osver': '18.04', 'pkgname': 'php7.2-zip', 'pkgver': '7.2.7-0ubuntu0.18.04.1'}
];
