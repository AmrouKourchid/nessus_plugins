...
# extracted from Red Hat Security Advisory RHSA-2024:1112. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1112");

  script_name(english:"RHEL 8 : linux-firmware (RHSA-2024:1112)");
...
referenced in the RHSA-2024:1112 advisory.
    ...
    * linux-firmware: hw: intel: Protection mechanism failure for some Intel(R) PROSet/Wireless WiFi
    (RHEL-14257)

    * linux-firmware: hw: amd: INVD instruction may lead to a loss of SEV-ES guest machine memory integrity
    problem (RHEL-13978)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1112.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d981c1c1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2238961");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2244590");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1112");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'iwl100-firmware-39.31.5.1-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl1000-firmware-39.31.5.1-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'iwl105-firmware-18.168.6.1-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl135-firmware-18.168.6.1-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl2000-firmware-18.168.6.1-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl2030-firmware-18.168.6.1-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl3160-firmware-25.30.13.0-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'iwl3945-firmware-15.32.2.9-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl4965-firmware-228.61.2.24-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl5000-firmware-8.83.5.1_1-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl5150-firmware-8.24.2.2-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6000-firmware-9.221.4.1-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6000g2a-firmware-18.168.6.1-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6000g2b-firmware-18.168.6.1-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl6050-firmware-41.28.5.1-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'iwl7260-firmware-25.30.13.0-114.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'libertas-sd8686-firmware-20220210-114.git6342082c.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libertas-sd8787-firmware-20220210-114.git6342082c.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libertas-usb8388-firmware-20220210-114.git6342082c.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'libertas-usb8388-olpc-firmware-20220210-114.git6342082c.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'linux-firmware-20220210-114.git6342082c.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
