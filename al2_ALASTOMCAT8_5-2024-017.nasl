...
# extracted from Amazon Linux 2 Security Advisory ALASTOMCAT8.5-2024-017.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-30640", "CVE-2021-33037", "CVE-2024-21733");
  script_xref(name:"IAVA", value:"2023-A-0661-S");

  script_name(english:"Amazon Linux 2 : tomcat (ALASTOMCAT8.5-2024-017)");
...
vulnerabilities as referenced in the ALAS2TOMCAT8.5-2024-017 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASTOMCAT8.5-2024-017.html");
