...
# extracted from Ubuntu Security Notice USN-5628-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5628-2");

  script_name(english:"Ubuntu 18.04 ESM : etcd vulnerabilities (USN-5628-2)");
...
the USN-5628-2 advisory.

    USN-5628-1 fixed vulnerabilities in etcd. This update provides the corresponding updates for Ubuntu 18.04
    ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5628-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'etcd', 'pkgver': '3.2.17+dfsg-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'etcd-client', 'pkgver': '3.2.17+dfsg-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'etcd-server', 'pkgver': '3.2.17+dfsg-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'golang-etcd-server-dev', 'pkgver': '3.2.17+dfsg-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
