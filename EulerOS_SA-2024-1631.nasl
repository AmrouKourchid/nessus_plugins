...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : openssh (EulerOS-SA-2024-1631)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1631
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e3fe59f4");
...
var pkgs = [
  "openssh-8.8p1-2.h32.eulerosv2r11",
  "openssh-clients-8.8p1-2.h32.eulerosv2r11",
  "openssh-server-8.8p1-2.h32.eulerosv2r11"
];
