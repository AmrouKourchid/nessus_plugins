...
# Red Hat Security Advisory RHSA-2024:0606. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0606");
  script_xref(name:"IAVA", value:"2023-A-0701-S");

  script_name(english:"CentOS 8 : openssh (CESA-2024:0606)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2024:0606 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0606");
