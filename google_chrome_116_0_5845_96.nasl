...
"The version of Google Chrome installed on the remote Windows host is prior to 116.0.5845.96. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2023_08_stable-channel-update-for-desktop_15 advisory.
...
google_chrome_check_version(installs:installs, fix:'116.0.5845.96', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
