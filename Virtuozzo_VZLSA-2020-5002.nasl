...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : curl / libcurl / libcurl-devel (VZLSA-2020-5002)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Virtuozzo host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in the RHSA-2020:5002 advisory.
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2020-5002.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b0961c13");
...
pkgs = ["curl-7.29.0-59.vl7.1",
        "libcurl-7.29.0-59.vl7.1",
        "libcurl-devel-7.29.0-59.vl7.1"];
