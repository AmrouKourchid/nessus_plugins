...
# extracted from Red Hat Security Advisory RHSA-2019:0054. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0054");

  script_name(english:"RHEL 7 : ansible (RHSA-2019:0054)");
...
referenced in the RHSA-2019:0054 advisory.
    ...
    * ansible: ansible.cfg is being read from current working directory allowing possible code execution
    ...
    Red Hat would like to thank Tobias Henkel (BMW Car IT GmbH) for reporting CVE-2018-10855 and Michael
    Scherer (OSAS) for reporting CVE-2018-10874. The CVE-2018-10875 issue was discovered by Brian Coca (Red
    Hat).
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0054.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?65534532");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0054");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ansible package based on the guidance in RHSA-2019:0054.");
