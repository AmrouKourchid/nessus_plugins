...
"The remote Red Hat host is missing one or more security updates for Red Hat JBoss Enterprise Application Platform 7.4.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0436.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ba6823c");
...
"Update the RHEL Red Hat JBoss Enterprise Application Platform 7.4 package based on the guidance in RHSA-2022:0436.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-log4j-jboss-logmanager-1.2.2-1.Final_redhat_00002.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'eap7-log4j-jboss-logmanager-1.2.2-1.Final_redhat_00002.1.el7eap', 'release':'7', 'el_string':'el7eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  }
];
