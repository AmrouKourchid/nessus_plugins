...
# extracted from Ubuntu Security Notice USN-5712-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5712-1");
  script_xref(name:"IAVA", value:"2022-A-0382-S");

  script_name(english:"Ubuntu 16.04 ESM : SQLite vulnerability (USN-5712-1)");
...
USN-5712-1 advisory.
    ...
    It was discovered that SQLite did not properly handle large string inputs in certain circumstances. An
    attacker could possibly use this issue to cause a denial of service or arbitrary code execution.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5712-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'lemon', 'pkgver': '3.11.0-1ubuntu1.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsqlite3-0', 'pkgver': '3.11.0-1ubuntu1.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsqlite3-dev', 'pkgver': '3.11.0-1ubuntu1.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libsqlite3-tcl', 'pkgver': '3.11.0-1ubuntu1.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'sqlite3', 'pkgver': '3.11.0-1ubuntu1.5+esm2', 'ubuntu_pro': TRUE}
];
