...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Go PHSA-2022-4.0-0214");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'go-1.18.1-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'go-md2man-2.0.0-11.ph4')) flag++;
