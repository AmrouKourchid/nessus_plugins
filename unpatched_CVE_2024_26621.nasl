...
if (description)
{
  ...
  script_cve_id("CVE-2024-26621");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-26621");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: mm: huge_memory: don't force huge page
    ...
    https://lore.kernel.org/linux-mm/d0a136a0-4a31-46bc-adf4-2db109a61672@kernel.org/ [2]
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-26621");
