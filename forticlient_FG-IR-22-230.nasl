...
if (description)
{
  ...
  script_name(english:"Fortinet FortiClient (All) - Lack of client-side certificate validation using SAML SSO (FG-IR-22-230)");
...
"Upgrade to FortiClient version 6.4.999999 / 7.0.8 or later.");
