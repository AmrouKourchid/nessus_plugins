...
# extracted from Red Hat Security Advisory libxt. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : libxt (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-2005");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2013-2002");
