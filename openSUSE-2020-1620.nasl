...
# extracted from openSUSE Security Update openSUSE-2020-1620.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : perl-DBI (openSUSE-2020-1620)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176764");
...
if ( rpm_check(release:"SUSE15.1", reference:"perl-DBI-1.639-lp151.3.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"perl-DBI-debuginfo-1.639-lp151.3.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"perl-DBI-debugsource-1.639-lp151.3.13.1") ) flag++;
