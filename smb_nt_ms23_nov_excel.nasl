...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002518");
  script_xref(name:"MSFT", value:"MS23-5002518");
  script_xref(name:"IAVA", value:"2023-A-0620-S");

  script_name(english:"Security Updates for Microsoft Excel Products (November 2023)");
...
"The Microsoft Excel Products are missing security updates. It is, therefore, affected by multiple vulnerabilities:
  ...
  - A remote code execution vulnerability. An attacker can exploit this to bypass authentication and execute
    unauthorized arbitrary commands. (CVE-2023-36041)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002518");
...
var constraints = [
  { 'kb':'5002518', 'channel':'MSI', 'fixed_version': '16.0.5422.1000', 'sp' : 0}
];
