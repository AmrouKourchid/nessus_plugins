...
# extracted from Red Hat Security Advisory RHSA-2021:4909. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4909");

  script_name(english:"RHEL 8 : nss (RHSA-2021:4909)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for nss.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4909 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4909.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c5a4e28a");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4909");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2024370");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nss package based on the guidance in RHSA-2021:4909.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nss-3.67.0-7.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-devel-3.67.0-7.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-3.67.0-7.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-devel-3.67.0-7.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-freebl-3.67.0-7.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-softokn-freebl-devel-3.67.0-7.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-sysinit-3.67.0-7.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-tools-3.67.0-7.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-util-3.67.0-7.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nss-util-devel-3.67.0-7.el8_4', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
