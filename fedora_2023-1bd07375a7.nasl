...
# extracted from Fedora Security Advisory FEDORA-2023-1bd07375a7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1bd07375a7");

  script_name(english:"Fedora 37 : libXpm (2023-1bd07375a7)");
...
FEDORA-2023-1bd07375a7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1bd07375a7");
...
var pkgs = [
    {'reference':'libXpm-3.5.15-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
