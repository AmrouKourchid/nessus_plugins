...
# extracted from Debian Security Advisory dla-3918. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3918 : docker-doc - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-3918
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-41110");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/docker.io");
  script_set_attribute(attribute:"solution", value:
"Upgrade the docker-doc packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:docker-doc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:docker.io");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:golang-github-docker-docker-dev");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'docker-doc', 'reference': '20.10.5+dfsg1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'docker.io', 'reference': '20.10.5+dfsg1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'golang-github-docker-docker-dev', 'reference': '20.10.5+dfsg1-1+deb11u3'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'docker-doc / docker.io / golang-github-docker-docker-dev');
}
