...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : qemu (EulerOS-SA-2021-1169)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1169
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8ec04a4");
...
pkgs = ["qemu-img-3.0.1-3.h10.eulerosv2r8"];
