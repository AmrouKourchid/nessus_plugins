...
if (description)
{
  ...
  script_name(english:"RHEL 4 : Evolution (RHSA-2005:267)");
...
referenced in the RHSA-2005:267 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_267.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?793bb9b5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=165235");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=165236");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:267");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Evolution package based on the guidance in RHSA-2005:267.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-2550");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2005-2549");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'evolution-2.0.2-16.3', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-2.0.2-16.3', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-2.0.2-16.3', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-2.0.2-16.3', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-2.0.2-16.3', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-devel-2.0.2-16.3', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-devel-2.0.2-16.3', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-devel-2.0.2-16.3', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-devel-2.0.2-16.3', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-devel-2.0.2-16.3', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
