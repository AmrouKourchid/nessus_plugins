...
# extracted from Red Hat Security Advisory RHSA-2024:2245. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2245");

  script_name(english:"RHEL 9 : buildah (RHSA-2024:2245)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for buildah.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2245 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2245.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a2c1348");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2245");
...
"Update the RHEL buildah package based on the guidance in RHSA-2024:2245.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.33.6-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'buildah-tests-1.33.6-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
