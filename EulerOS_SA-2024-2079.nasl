...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : xorg-x11-server (EulerOS-SA-2024-2079)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2079
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c360fe7");
...
var pkgs = [
  "xorg-x11-server-Xephyr-1.19.5-5.h24.eulerosv2r7",
  "xorg-x11-server-Xorg-1.19.5-5.h24.eulerosv2r7",
  "xorg-x11-server-Xvfb-1.19.5-5.h24.eulerosv2r7",
  "xorg-x11-server-common-1.19.5-5.h24.eulerosv2r7"
];
