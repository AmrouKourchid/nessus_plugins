...
# extracted from Ubuntu Security Notice USN-6342-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6342-2");

  script_name(english:"Ubuntu 16.04 ESM / 18.04 ESM : Linux kernel (Azure) vulnerabilities (USN-6342-2)");
...
referenced in the USN-6342-2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6342-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1169-azure");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6342-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6342-2');
  }
  else
  {
