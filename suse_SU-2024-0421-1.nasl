...
# SUSE update advisory SUSE-SU-2024:0421-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0421-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 1 for SLE 15 SP5) (SUSE-SU-2024:0421-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2024:0421-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1216044");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-February/017887.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0904ed2b");
...
"Update the affected kernel-livepatch-5_14_21-150400_24_88-default and / or kernel-livepatch-5_14_21-150500_55_7-default
packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.24.88-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_88-default-4-150400.2.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      },
      '5.14.21-150500.55.7-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150500_55_7-default-6-150500.2.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.5']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_24_88-default / etc');
}
