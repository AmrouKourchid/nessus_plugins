...
# extracted from Debian Security Advisory dla-3043. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-3043-1 : pidgin - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-3043
advisory.
    ...
    over control over the XMPP connection and to obtain user credentials and all communication content. For
    Debian 9 stretch, this problem has been fixed in version 2.12.0-1+deb9u1. We recommend that you upgrade
    your pidgin packages. For the detailed security status of pidgin please refer to its security tracker page
    at: https://security-tracker.debian.org/tracker/pidgin Further information about Debian LTS security
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/pidgin");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3043");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-26491");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/pidgin");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'finch', 'reference': '2.12.0-1+deb9u1'},
    {'release': '9.0', 'prefix': 'finch-dev', 'reference': '2.12.0-1+deb9u1'},
    {'release': '9.0', 'prefix': 'libpurple-bin', 'reference': '2.12.0-1+deb9u1'},
    {'release': '9.0', 'prefix': 'libpurple-dev', 'reference': '2.12.0-1+deb9u1'},
    {'release': '9.0', 'prefix': 'libpurple0', 'reference': '2.12.0-1+deb9u1'},
    {'release': '9.0', 'prefix': 'pidgin', 'reference': '2.12.0-1+deb9u1'},
    {'release': '9.0', 'prefix': 'pidgin-data', 'reference': '2.12.0-1+deb9u1'},
    {'release': '9.0', 'prefix': 'pidgin-dbg', 'reference': '2.12.0-1+deb9u1'},
    {'release': '9.0', 'prefix': 'pidgin-dev', 'reference': '2.12.0-1+deb9u1'}
];
