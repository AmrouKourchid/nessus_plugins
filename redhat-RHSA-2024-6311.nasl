...
# extracted from Red Hat Security Advisory RHSA-2024:6311. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6311");

  script_name(english:"RHEL 8 : resource-agents (RHSA-2024:6311)");
...
referenced in the RHSA-2024:6311 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-50041");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6311.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e907b7fb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6311");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL resource-agents package based on the guidance in RHSA-2024:6311.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'resource-agents-4.9.0-54.el8_10.4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resource-agents-aliyun-4.9.0-54.el8_10.4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resource-agents-gcp-4.9.0-54.el8_10.4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'resource-agents-paf-4.9.0-54.el8_10.4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
