...
if (description)
{
  ...
  script_cve_id("CVE-2022-49643");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49643");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ima: Fix a potential integer overflow
    in ima_appraise_measurement When the ima-modsig is enabled, the rc passed to evm_verifyxattr() may be
    negative, which may cause the integer overflow problem. (CVE-2022-49643)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49643");
