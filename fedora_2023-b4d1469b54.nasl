...
# extracted from Fedora Security Advisory FEDORA-2023-b4d1469b54
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b4d1469b54");

  script_name(english:"Fedora 37 : insight (2023-b4d1469b54)");
...
FEDORA-2023-b4d1469b54 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b4d1469b54");
...
var pkgs = [
    {'reference':'insight-13.0.50.20220502-9.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
