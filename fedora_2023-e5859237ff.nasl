...
# extracted from Fedora Security Advisory FEDORA-2023-e5859237ff
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e5859237ff");

  script_name(english:"Fedora 37 : firefox (2023-e5859237ff)");
...
FEDORA-2023-e5859237ff advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e5859237ff");
...
var pkgs = [
    {'reference':'firefox-114.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
