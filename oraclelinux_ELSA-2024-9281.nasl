...
# extracted from Oracle Linux Security Advisory ELSA-2024-9281.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : python-jwcrypto (ELSA-2024-9281)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9281.html");
...
var pkgs = [
    {'reference':'python3-jwcrypto-1.5.6-2.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
