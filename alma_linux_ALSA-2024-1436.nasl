...
# AlmaLinux Security Advisory ALSA-2024:1436.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1436");

  script_name(english:"AlmaLinux 9 : postgresql-jdbc (ALSA-2024:1436)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-1436.html");
