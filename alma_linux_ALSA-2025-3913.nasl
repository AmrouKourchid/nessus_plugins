...
# AlmaLinux Security Advisory ALSA-2025:3913.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:3913");
  script_xref(name:"RHSA", value:"2025:3913");

  script_name(english:"AlmaLinux 8 : expat (ALSA-2025:3913)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2025:3913 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2025-3913.html");
...
var pkgs = [
    {'reference':'expat-2.2.5-17.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'expat-devel-2.2.5-17.el8_10', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
