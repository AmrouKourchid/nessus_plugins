...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2208.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : cni-plugins (ALAS-2023-2208)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of cni-plugins installed on the remote host is prior to 1.2.0-1. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2-2023-2208 advisory.

    2023-08-31: CVE-2023-29406 was added to this advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2208.html");
...
var pkgs = [
    {'reference':'cni-plugins-1.2.0-1.amzn2.0.3', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cni-plugins-1.2.0-1.amzn2.0.3', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cni-plugins-debuginfo-1.2.0-1.amzn2.0.3', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cni-plugins-debuginfo-1.2.0-1.amzn2.0.3', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
