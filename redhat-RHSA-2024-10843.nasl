...
# extracted from Red Hat Security Advisory RHSA-2024:10843. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10843");

  script_name(english:"RHEL 9 : python-tornado (RHSA-2024:10843)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-tornado.");
...
the RHSA-2024:10843 advisory.

    Tornado is a Python web framework and asynchronous networking library that provides an open source version
    of scalable, non-blocking web server and tools.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10843.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9934158f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10843");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-tornado package based on the guidance in RHSA-2024:10843.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-tornado-6.4.2-1.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
