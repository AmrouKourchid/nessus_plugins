...
# extracted from Gentoo Linux Security Advisory GLSA 202209-18.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202209-18 : Mozilla Thunderbird: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202209-18 (Mozilla Thunderbird: Multiple
Vulnerabilities)
  ...
  - When saving or opening an email attachment on macOS, Thunderbird did not set attribute
    ...
    to open it, then the application was started immediately without asking the user to confirm.
    (CVE-2022-3155)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202209-18");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=872572");
