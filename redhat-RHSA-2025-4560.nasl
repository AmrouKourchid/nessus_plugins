...
# extracted from Red Hat Security Advisory RHSA-2025:4560. The text
...
referenced in the RHSA-2025:4560 advisory.
    ...
    * libsoup: Heap buffer overflows in sniff_feed_or_html() and skip_insignificant_space() [rhel-8.10.z]
    (CVE-2025-32053)

    * libsoup: Out of bounds reads in soup_headers_parse_request() [rhel-8.10.z] (CVE-2025-32906)

    * libsoup: Double free on  soup_message_headers_get_content_disposition() through  soup-message-
    headers.c via params GHashTable value [rhel-8.10.z] (CVE-2025-32911)

    * libsoup: NULL pointer dereference in  soup_message_headers_get_content_disposition when filename
    parameter  is present, but has no value in Content-Disposition header [rhel-8.10.z] (CVE-2025-32913)

    * libsoup: Memory leak on soup_header_parse_quality_list() via soup-headers.c [rhel-8.10.z]
    (CVE-2025-46420)

    * libsoup: Information disclosure may leads libsoup client sends Authorization header to a different host
    when being redirected by a server [rhel-8.10.z] (CVE-2025-46421)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4560.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?46cd7ae0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4560");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsoup package based on the guidance in RHSA-2025:4560.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsoup-2.62.3-8.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.62.3-8.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
