...
# extracted from Debian Security Advisory dla-3806. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3806 : distro-info-data - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3806
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3806-1                debian-lts@lists.debian.org
    ...
    Ubuntu. The version of distro-info in buster is not able to display the
    data from these columns, but they are present in the CSV.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'distro-info-data', 'reference': '0.41+deb10u9'}
];
