...
# extracted from Fedora Security Advisory FEDORA-2020-83f513fd7e.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-11769", "CVE-2018-17188", "CVE-2018-8007");
  script_xref(name:"FEDORA", value:"2020-83f513fd7e");

  script_name(english:"Fedora 31 : couchdb (2020-83f513fd7e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-83f513fd7e");
  script_set_attribute(attribute:"solution", value:
"Update the affected couchdb package.");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"couchdb-3.0.0-1.fc31")) flag++;
