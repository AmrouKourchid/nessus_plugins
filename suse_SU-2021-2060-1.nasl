...
# SUSE update advisory SUSE-SU-2021:2060-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2060-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 23 for SLE 15) (SUSE-SU-2021:2060-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES12 / SLES15 / SLES_SAP12 host has packages installed that are affected by multiple
vulnerabilities as referenced in the SUSE-SU-2021:2060-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-June/009049.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad0275dc");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-4_12_14-150_69-default and / or kgraft-patch-4_4_180-94_135-default packages.");
...
os_ver = os_ver[1];
if (! preg(pattern:"^(SLES12|SLES15|SLES_SAP12)$", string:os_ver)) audit(AUDIT_OS_NOT, 'SUSE SLES12 / SLES15 / SLES_SAP12', 'SUSE (' + os_ver + ')');
...
var pkgs = [
    {'reference':'kgraft-patch-4_4_180-94_135-default-8-2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
    {'reference':'kgraft-patch-4_4_180-94_135-default-8-2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
    {'reference':'kernel-livepatch-4_12_14-150_69-default-5-2', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15']},
    {'reference':'kgraft-patch-4_4_180-94_135-default-8-2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
];
