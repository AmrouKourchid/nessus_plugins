...
if (description)
{
  ...
  script_name(english:"Oracle Siebel Server (April 2021 CPU)");
...
the April 2021 CPU advisory.
  ...
  - Vulnerability in the Siebel UI Framework product of Oracle Siebel CRM (component: EAI (jackson-databind)).
    Supported versions that are affected are 21.2 and prior. Difficult to exploit vulnerability allows
    unauthenticated attacker with network access via HTTP to compromise Siebel UI Framework. Successful
    attacks of this vulnerability can result in takeover of Siebel UI Framework. (CVE-2020-14195)

  - Vulnerability in the Siebel UI Framework product of Oracle Siebel CRM (component: EAI (Jersey)). Supported
    versions that are affected are 21.2 and prior. Easily exploitable vulnerability allows low privileged
    ...
    Framework accessible data. (CVE-2019-10080)

  - Vulnerability in the Siebel UI Framework product of Oracle Siebel CRM (component: UIF Open UI (jQuery)).
    Supported versions that are affected are 21.2 and prior. Easily exploitable vulnerability allows
    unauthenticated attacker with network access via HTTP to compromise Siebel UI Framework. Successful
  ...
  - Vulnerability in the Siebel UI Framework product of Oracle Siebel CRM (component: UIF Open UI (jQuery
    UI)). Supported versions that are affected are 21.2 and prior. Easily exploitable vulnerability allows
    unauthenticated attacker with network access via HTTP to compromise Siebel UI Framework. Successful
    attacks require human interaction from a person other than the attacker and while the vulnerability is in
    Siebel UI Framework, attacks may significantly impact additional products. Successful attacks of this
    vulnerability can result in unauthorized update, insert or delete access to some of Siebel UI Framework
  ...
  - Vulnerability in the Siebel UI Framework product of Oracle Siebel CRM (component: EAI (Apache Log4j)).
    Supported versions that are affected are 21.2 and prior. Difficult to exploit vulnerability allows
    unauthenticated attacker with network access via HTTP to compromise Siebel UI Framework. Successful
    attacks of this vulnerability can result in unauthorized read access to a subset of Siebel UI Framework
    accessible data. (CVE-2020-9488)
...
"Apply the appropriate patch according to the April 2021 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-14195");
