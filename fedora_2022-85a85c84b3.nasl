...
# extracted from Fedora Security Advisory FEDORA-2022-85a85c84b3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-85a85c84b3");

  script_name(english:"Fedora 35 : mod_security / mod_security_crs (2022-85a85c84b3)");
...
FEDORA-2022-85a85c84b3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-85a85c84b3");
...
var pkgs = [
    {'reference':'mod_security-2.9.6-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_security_crs-3.3.4-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
