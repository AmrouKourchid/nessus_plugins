...
# extracted from VMware Security Advisory PHSA-2020-2.0-0201. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Dnsmasq PHSA-2020-2.0-0201");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the dnsmasq package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-201.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'dnsmasq-2.79-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'dnsmasq-utils-2.79-1.ph2')) flag++;
