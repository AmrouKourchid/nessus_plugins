...
# extracted from Fedora Security Advisory FEDORA-2024-55247f3a4f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-55247f3a4f");

  script_name(english:"Fedora 40 : openexr (2024-55247f3a4f)");
...
FEDORA-2024-55247f3a4f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-55247f3a4f");
...
var pkgs = [
    {'reference':'openexr-3.1.10-5.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
