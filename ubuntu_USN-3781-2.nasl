...
USN-3781-2 advisory.
    ...
    USN-3781-1 fixed vulnerabilities in WebKitGTK+. The updated package was missing some header files,
    preventing certain applications from building. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3781-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'gir1.2-javascriptcoregtk-4.0', 'pkgver': '2.22.2-0ubuntu0.18.04.2'},
    {'osver': '18.04', 'pkgname': 'gir1.2-webkit2-4.0', 'pkgver': '2.22.2-0ubuntu0.18.04.2'},
    {'osver': '18.04', 'pkgname': 'libjavascriptcoregtk-4.0-18', 'pkgver': '2.22.2-0ubuntu0.18.04.2'},
    {'osver': '18.04', 'pkgname': 'libjavascriptcoregtk-4.0-bin', 'pkgver': '2.22.2-0ubuntu0.18.04.2'},
    {'osver': '18.04', 'pkgname': 'libjavascriptcoregtk-4.0-dev', 'pkgver': '2.22.2-0ubuntu0.18.04.2'},
    {'osver': '18.04', 'pkgname': 'libwebkit2gtk-4.0-37', 'pkgver': '2.22.2-0ubuntu0.18.04.2'},
    {'osver': '18.04', 'pkgname': 'libwebkit2gtk-4.0-37-gtk2', 'pkgver': '2.22.2-0ubuntu0.18.04.2'},
    {'osver': '18.04', 'pkgname': 'libwebkit2gtk-4.0-dev', 'pkgver': '2.22.2-0ubuntu0.18.04.2'},
    {'osver': '18.04', 'pkgname': 'webkit2gtk-driver', 'pkgver': '2.22.2-0ubuntu0.18.04.2'}
];
