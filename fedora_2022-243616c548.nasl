...
# extracted from Fedora Security Advisory FEDORA-2022-243616c548
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-243616c548");

  script_name(english:"Fedora 37 : ntfs-3g (2022-243616c548)");
...
FEDORA-2022-243616c548 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-243616c548");
  script_set_attribute(attribute:"solution", value:
"Update the affected 2:ntfs-3g package.");
...
var pkgs = [
    {'reference':'ntfs-3g-2022.10.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
