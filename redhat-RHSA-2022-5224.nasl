...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2022/rhsa-2022_5224.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e6fd2d3");
...
"Update the RHEL kernel-rt package based on the guidance in RHSA-2022:5224.");
  ...
  script_cwe_id(122, 200, 362, 366, 416);
