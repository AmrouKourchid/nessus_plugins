...
# extracted from Fedora Security Advisory FEDORA-2023-c890266d3f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c890266d3f");

  script_name(english:"Fedora 39 : chromium (2023-c890266d3f)");
...
FEDORA-2023-c890266d3f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c890266d3f");
...
var pkgs = [
    {'reference':'chromium-117.0.5938.132-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
