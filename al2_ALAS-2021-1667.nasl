...
# extracted from Amazon Linux 2 Security Advisory ALAS-2021-1667.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python-pip (ALAS-2021-1667)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2021-1667.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2021-28363");
...
"Run 'yum update python-pip' to update your system.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-28363");
...
var pkgs = [
    {'reference':'python-pip-wheel-20.2.2-1.amzn2.0.3', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python2-pip-20.2.2-1.amzn2.0.3', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-pip-20.2.2-1.amzn2.0.3', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
