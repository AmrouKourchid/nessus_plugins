...
# extracted from Oracle Linux Security Advisory ELSA-2024-1902.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : shim (ELSA-2024-1902)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2024-1902 advisory.
    ...
    - fix CVE-2023-40546, CVE-2023-40547, CVE-2023-40548, CVE-2023-40549, CVE-2023-40550, CVE-2023-40551
    [Orabug: 36072863]
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-1902.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected shim-aa64, shim-ia32 and / or shim-x64 packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:shim-aa64");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:shim-ia32");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:shim-x64");
...
var pkgs = [
    {'reference':'shim-aa64-15.8-4.0.1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'shim-ia32-15.8-4.0.1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'shim-x64-15.8-4.0.1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
