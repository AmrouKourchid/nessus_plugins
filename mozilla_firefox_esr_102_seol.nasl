...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR SEoL (102.x)");
...
"Upgrade to a version of Mozilla Firefox that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2023/09/26");
...
var constraints = [
{ max_branch : '102', min_branch : '102', seol : 20230926 }
];
