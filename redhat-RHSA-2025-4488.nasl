...
# extracted from Red Hat Security Advisory RHSA-2025:4488. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4488.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86c2be64");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4488");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ruby:3.1 package based on the guidance in RHSA-2025:4488.");
  ...
  'ruby:3.1': [
    {
      ...
      'pkgs': [
        {'reference':'ruby-3.1.7-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-bundled-gems-3.1.7-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-default-gems-3.1.7-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-devel-3.1.7-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-doc-3.1.7-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'ruby-libs-3.1.7-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-bigdecimal-3.1.1-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-bundler-2.3.27-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-io-console-0.5.11-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-irb-1.4.1-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-json-2.6.1-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-minitest-5.15.0-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'rubygem-power_assert-2.0.1-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-psych-4.0.4-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rake-13.0.6-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rbs-2.7.0-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rdoc-6.4.1.1-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rexml-3.3.9-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-rss-0.3.1-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-test-unit-3.5.3-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygem-typeprof-0.21.3-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-3.3.27-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'rubygems-devel-3.3.27-146.module+el9.5.0+23003+a4c328ce', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
