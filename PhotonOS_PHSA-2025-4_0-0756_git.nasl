...
# extracted from VMware Security Advisory PHSA-2025-4.0-0756. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-50349");

  script_name(english:"Photon OS 4.0: Git PHSA-2025-4.0-0756");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the git package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-756.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss4_vector", value:"CVSS:4.0/AV:N/AC:H/AT:P/PR:N/UI:A/VC:N/VI:L/VA:N/SC:L/SI:L/SA:N");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'git-2.40.4-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'git-extras-2.40.4-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'git-lang-2.40.4-1.ph4')) flag++;
