...
# extracted from Gentoo Linux Security Advisory GLSA 202011-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202011-04");

  script_name(english:"GLSA-202011-04 : Fossil: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202011-04
(Fossil: Multiple vulnerabilities)

    Multiple vulnerabilities have been discovered in Fossil. Please review
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202011-04");
...
if (qpkg_check(package:"dev-vcs/fossil", unaffected:make_list("ge 2.12.1"), vulnerable:make_list("lt 2.12.1"))) flag++;
