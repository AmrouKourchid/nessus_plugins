...
vulnerabilities as referenced in the ALAS2SQUID4-2023-006 advisory.
    ...
    A flaw was found in squid. A denial of service attack is possible due to an improper input validation. The
    highest threat from this vulnerability is to system availability. (CVE-2020-24606)
