...
# Rocky Linux Security Advisory RLSA-2024:5297.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:5297");

  script_name(english:"RockyLinux 8 : edk2 (RLSA-2024:5297)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:5297");
...
var pkgs = [
    {'reference':'edk2-aarch64-20220126gitbb1bba3d77-13.el8_10.2', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'edk2-ovmf-20220126gitbb1bba3d77-13.el8_10.2', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
