...
# extracted from Red Hat Security Advisory RHSA-2023:6587. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6587");

  script_name(english:"RHEL 9 : opensc (RHSA-2023:6587)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6587.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?74c64938");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2211088");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6587");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL opensc package based on the guidance in RHSA-2023:6587.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'opensc-0.23.0-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
