...
# extracted from Red Hat Security Advisory RHSA-2025:1657. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1657");

  script_name(english:"RHEL 8 : kpatch-patch-4_18_0-553, kpatch-patch-4_18_0-553_16_1, and kpatch-patch-4_18_0-553_30_1 (RHSA-2025:1657)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1657.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a6f3d0e0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1657");
...
the guidance in RHSA-2025:1657.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2025:1657');
  }
  else
  {
...
var kernel_live_checks = [
  {
    ...
    'kernels': {
      '4.18.0-553.el8_10.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-4_18_0-553-1-4.el8_10', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '4.18.0-553.el8_10.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-4_18_0-553-1-4.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '4.18.0-553.16.1.el8_10.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-4_18_0-553_16_1-1-3.el8_10', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '4.18.0-553.16.1.el8_10.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-4_18_0-553_16_1-1-3.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '4.18.0-553.30.1.el8_10.ppc64le': {
        'pkgs': [
          {'reference':'kpatch-patch-4_18_0-553_30_1-1-2.el8_10', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ]
      },
      '4.18.0-553.30.1.el8_10.x86_64': {
        'pkgs': [
          {'reference':'kpatch-patch-4_18_0-553_30_1-1-2.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
        ]
      }
    }
  }
