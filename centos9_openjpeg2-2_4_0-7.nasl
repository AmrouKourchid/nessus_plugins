...
if (description)
{
  ...
  script_name(english:"CentOS 9 : openjpeg2-2.4.0-7.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for openjpeg2.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
openjpeg2-2.4.0-7.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=23715");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream openjpeg2 package.");
...
var pkgs = [
    ...
    {'reference':'openjpeg2-devel-docs-2.4.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
