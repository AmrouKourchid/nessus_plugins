...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : gnutls (EulerOS-SA-2024-1545)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1545
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7776c37");
...
var pkgs = [
  "gnutls-3.6.14-6.h14.eulerosv2r10",
  "gnutls-utils-3.6.14-6.h14.eulerosv2r10"
];
