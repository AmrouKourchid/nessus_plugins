...
# extracted from Fedora Security Advisory FEDORA-2023-b88929bc79
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b88929bc79");

  script_name(english:"Fedora 39 : xorg-x11-server (2023-b88929bc79)");
...
FEDORA-2023-b88929bc79 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b88929bc79");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-26.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
