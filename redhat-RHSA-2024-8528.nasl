...
# extracted from Red Hat Security Advisory RHSA-2024:8528. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8528");

  script_name(english:"RHEL 9 : pki-servlet-engine (RHSA-2024:8528)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33938438");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8528");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pki-servlet-engine package based on the guidance in RHSA-2024:8528.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pki-servlet-4.0-api-9.0.43-4.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'pki-servlet-engine-9.0.43-4.el9_0.1', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
