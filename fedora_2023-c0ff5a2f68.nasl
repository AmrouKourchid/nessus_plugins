...
# extracted from Fedora Security Advisory FEDORA-2023-c0ff5a2f68
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c0ff5a2f68");
  script_xref(name:"IAVA", value:"2023-A-0500-S");

  script_name(english:"Fedora 39 : bind / bind-dyndb-ldap (2023-c0ff5a2f68)");
...
FEDORA-2023-c0ff5a2f68 advisory.

    # Update to BIND 9.18.16

    Selected parts from [upstream release
    notes](https://downloads.isc.org/isc/bind9/9.18.16/doc/arm/html/notes.html#notes-for-bind-9-18-16). Visit
    that for details of bug fixes.

    ## Security Fixes

    -    The overmem cleaning process has been improved, to prevent the cache from significantly exceeding the
    configured max-cache-size limit. (CVE-2023-2828)
    ...
    If the fetch is aborted for exceeding the recursion quota, it was possible for named to enter an infinite
    callback loop and crash due to stack overflow. This has been fixed. (CVE-2023-2911) [GL #4089]

    ## New Features

    -    The system test suite can now be executed with pytest (along with pytest-xdist for parallel
    execution). [GL #3978]

    ## Removed Features

    -    TKEY mode 2 (Diffie-Hellman Exchanged Keying) is now deprecated, and will be removed in a future
    release. A warning will be logged when the tkey-dhkey option is used in named.conf. [GL #3905]
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c0ff5a2f68");
...
var pkgs = [
    {'reference':'bind-9.18.16-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-dyndb-ldap-11.10-17.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
