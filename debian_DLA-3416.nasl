...
if (description)
{
  ...
  script_name(english:"Debian dla-3416 : emacs - security update");
...
dla-3416 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3416-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Markus Koschany
    May 10, 2023                                  https://wiki.debian.org/LTS
    -------------------------------------------------------------------------
