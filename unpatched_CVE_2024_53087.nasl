...
if (description)
{
  ...
  script_cve_id("CVE-2024-53087");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-53087");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/xe: Fix possible exec queue leak
    in exec IOCTL In a couple of places after an exec queue is looked up the exec IOCTL returns on input
    errors without dropping the exec queue ref. Fix this ensuring the exec queue ref is dropped on input
    error. (cherry picked from commit 07064a200b40ac2195cb6b7b779897d9377e5e6f) (CVE-2024-53087)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-53087");
