...
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.9.9.");
...
referenced in the RHSA-2021:4833 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.9.9. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4833.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8ebf64c5");
...
"Update the RHEL OpenShift Container Platform 4.9.9 package based on the guidance in RHSA-2021:4833.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.9.1637598812-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-21698']},
      {'reference':'jenkins-2.303.3.1637595827-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2021-21685', 'CVE-2021-21686', 'CVE-2021-21687', 'CVE-2021-21688', 'CVE-2021-21689', 'CVE-2021-21690', 'CVE-2021-21691', 'CVE-2021-21692', 'CVE-2021-21693', 'CVE-2021-21694', 'CVE-2021-21695', 'CVE-2021-21696', 'CVE-2021-21697']}
    ]
  }
];
