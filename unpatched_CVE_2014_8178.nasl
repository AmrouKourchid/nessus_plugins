...
if (description)
{
  ...
  script_cve_id("CVE-2014-8178");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-8178");
...
patch available.
  ...
  - Docker Engine before 1.8.3 and CS Docker Engine before 1.6.2-CS7 do not use a globally unique identifier
    to store image layers, which makes it easier for attackers to poison the image cache via a crafted image
    in pull or push commands. (CVE-2014-8178)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-8178");
