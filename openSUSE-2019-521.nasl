...
# extracted from openSUSE Security Update openSUSE-2019-521.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : slurm (openSUSE-2019-521)");
...
The following tracked packaging changes are included :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1095508");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1100850");
