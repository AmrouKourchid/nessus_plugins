...
"The version of Google Chrome installed on the remote macOS host is prior to 120.0.6099.216. It is, therefore, affected
...
google_chrome_check_version(fix:'120.0.6099.216', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
