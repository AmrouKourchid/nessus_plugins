...
"The version of Firefox ESR installed on the remote Windows host is prior to 128.3.1. It is, therefore, affected by a
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'128.3.1', min:'128.0.0', severity:SECURITY_HOLE);
