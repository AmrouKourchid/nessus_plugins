...
# SUSE update advisory SUSE-SU-2023:3435-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3435-1");
  script_xref(name:"IAVB", value:"2023-B-0062-S");

  script_name(english:"SUSE SLES12 Security Update : clamav (SUSE-SU-2023:3435-1)");
...
in the SUSE-SU-2023:3435-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-August/016023.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd7196f9");
...
var pkgs = [
    {'reference':'clamav-0.103.9-3.27.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'clamav-0.103.9-3.27.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
