...
# AlmaLinux Security Advisory ALSA-2024:0533.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:0533");

  script_name(english:"AlmaLinux 9 : gnutls (ALSA-2024:0533)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:0533 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-0533.html");
...
var pkgs = [
    {'reference':'gnutls-3.7.6-23.el9_3.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-c++-3.7.6-23.el9_3.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-dane-3.7.6-23.el9_3.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-devel-3.7.6-23.el9_3.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gnutls-utils-3.7.6-23.el9_3.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
