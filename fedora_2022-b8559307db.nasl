...
# extracted from Fedora Security Advisory FEDORA-2022-b8559307db
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-b8559307db");

  script_name(english:"Fedora 37 : python2.7 (2022-b8559307db)");
...
FEDORA-2022-b8559307db advisory.

    Automatic update for python2.7-2.7.18-20.fc37.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-b8559307db");
...
var pkgs = [
    {'reference':'python2.7-2.7.18-20.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
