...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-lxml (EulerOS-SA-2022-2303)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2303
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e55ac875");
...
var pkgs = [
  "python-lxml-help-4.2.3-4.h7.eulerosv2r9"
];
