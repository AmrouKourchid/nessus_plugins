...
if (description)
{
  ...
  script_cve_id("CVE-2024-10229");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-10229");
...
patch available.
  ...
  - Inappropriate implementation in Extensions in Google Chrome prior to 130.0.6723.69 allowed a remote
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-10229");
