...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate:libexif (ELSA-2007-1165)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-1165.html");
...
var pkgs = [
    {'reference':'libexif-0.6.13-4.0.2.el5_1.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libexif-devel-0.6.13-4.0.2.el5_1.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libexif-0.6.13-4.0.2.el5_1.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libexif-devel-0.6.13-4.0.2.el5_1.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
