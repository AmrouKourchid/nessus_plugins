...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : qemu-kvm on SL7.x x86_64 (20180515)");
...
"Security Fix(es) :
  ...
  - QEMU: cirrus: OOB access when updating VGA display
    (CVE-2018-7858)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1805&L=scientific-linux-errata&F=&S=&P=17734
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d5582df");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-img-1.5.3-156.el7_5.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-1.5.3-156.el7_5.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-common-1.5.3-156.el7_5.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-debuginfo-1.5.3-156.el7_5.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-tools-1.5.3-156.el7_5.1")) flag++;
