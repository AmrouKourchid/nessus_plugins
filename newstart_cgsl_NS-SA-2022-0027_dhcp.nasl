...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : dhcp Vulnerability (NS-SA-2022-0027)");
...
var pkgs = {
  'CGSL CORE 5.05': [
    ...
    'dhcp-4.2.5-83.el7.centos.1',
    'dhcp-common-4.2.5-83.el7.centos.1',
    'dhcp-debuginfo-4.2.5-83.el7.centos.1',
    'dhcp-devel-4.2.5-83.el7.centos.1',
