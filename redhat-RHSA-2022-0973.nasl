...
# extracted from Red Hat Security Advisory RHSA-2022:0973. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0973");

  script_name(english:"RHEL 8 : virt:av and virt-devel:av qemu-kvm (RHSA-2022:0973)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for virt:av / virt-devel:av qemu-kvm.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:0973 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0973.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?55442ce2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0973");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2044863");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL virt:av / virt-devel:av qemu-kvm packages based on the guidance in RHSA-2022:0973.");
  ...
  'virt:8.2': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'qemu-guest-agent-4.2.0-29.module+el8.2.1+14195+13a89360.11', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-img-4.2.0-29.module+el8.2.1+14195+13a89360.11', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-4.2.0-29.module+el8.2.1+14195+13a89360.11', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-curl-4.2.0-29.module+el8.2.1+14195+13a89360.11', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-gluster-4.2.0-29.module+el8.2.1+14195+13a89360.11', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-iscsi-4.2.0-29.module+el8.2.1+14195+13a89360.11', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-rbd-4.2.0-29.module+el8.2.1+14195+13a89360.11', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-ssh-4.2.0-29.module+el8.2.1+14195+13a89360.11', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-common-4.2.0-29.module+el8.2.1+14195+13a89360.11', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-core-4.2.0-29.module+el8.2.1+14195+13a89360.11', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
  ...
  'virt-devel:8.2': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'qemu-kvm-tests-4.2.0-29.module+el8.2.1+14195+13a89360.11', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
