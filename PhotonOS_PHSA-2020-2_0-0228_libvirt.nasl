...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libvirt PHSA-2020-2.0-0228");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libvirt-3.2.0-8.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libvirt-debuginfo-3.2.0-8.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libvirt-devel-3.2.0-8.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libvirt-docs-3.2.0-8.ph2')) flag++;
