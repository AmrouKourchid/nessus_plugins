...
"The version of expat installed on the remote host is prior to 2.1.0-11.22. It is, therefore, affected by a vulnerability
as referenced in the ALAS-2020-1364 advisory.
    ...
    compressed XML data, a related issue toCVE-2015-1283. (CVE-2015-2716)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2020-1364.html");
...
var pkgs = [
    {'reference':'expat-2.1.0-11.22.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-2.1.0-11.22.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-debuginfo-2.1.0-11.22.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-debuginfo-2.1.0-11.22.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.1.0-11.22.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.1.0-11.22.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
