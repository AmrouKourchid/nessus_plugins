...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : ipa (EulerOS-SA-2020-2073)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2073
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af0c9401");
...
pkgs = ["ipa-admintools-4.4.0-14.4.h6",
        "ipa-client-4.4.0-14.4.h6",
        "ipa-client-common-4.4.0-14.4.h6",
        "ipa-common-4.4.0-14.4.h6",
        "ipa-server-4.4.0-14.4.h6",
        "ipa-server-common-4.4.0-14.4.h6",
        "ipa-server-dns-4.4.0-14.4.h6",
        "ipa-server-trust-ad-4.4.0-14.4.h6",
        "python2-ipaclient-4.4.0-14.4.h6",
        "python2-ipalib-4.4.0-14.4.h6",
        "python2-ipaserver-4.4.0-14.4.h6"];
