...
# extracted from Fedora Security Advisory FEDORA-2024-34aa24af35
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-34aa24af35");

  script_name(english:"Fedora 39 : micropython (2024-34aa24af35)");
...
FEDORA-2024-34aa24af35 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-34aa24af35");
...
var pkgs = [
    {'reference':'micropython-1.22.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
