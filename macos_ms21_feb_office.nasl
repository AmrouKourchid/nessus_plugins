...
if (description)
{
  ...
  script_cve_id("CVE-2021-24067", "CVE-2021-24069");
  script_xref(name:"IAVA", value:"2021-A-0067-S");

  script_name(english:"Security Updates for Microsoft Office (February 2021) (macOS)");
...
number.");
  ...
  # https://docs.microsoft.com/en-us/officeupdates/release-notes-office-for-mac#february-16-2021
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?20edf462");
...
"Microsoft has released a set of patches for Microsoft Office for Mac.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-24069");
