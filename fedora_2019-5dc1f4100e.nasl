...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5dc1f4100e");
  script_set_attribute(attribute:"solution", value:
"Update the affected php-pecl-imagick package.");
