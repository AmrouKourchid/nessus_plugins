...
referenced in the RHSA-2019:1142 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1142.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a161836");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1142");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1695748");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1695783");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL freeradius:3.0 package based on the guidance in RHSA-2019:1142.");
  ...
  'freeradius:3.0': [
    {
      ...
      'pkgs': [
        {'reference':'freeradius-3.0.17-4.module+el8.0.0+3108+851cb559', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-devel-3.0.17-4.module+el8.0.0+3108+851cb559', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-doc-3.0.17-4.module+el8.0.0+3108+851cb559', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-krb5-3.0.17-4.module+el8.0.0+3108+851cb559', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-ldap-3.0.17-4.module+el8.0.0+3108+851cb559', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-mysql-3.0.17-4.module+el8.0.0+3108+851cb559', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-perl-3.0.17-4.module+el8.0.0+3108+851cb559', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-postgresql-3.0.17-4.module+el8.0.0+3108+851cb559', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-rest-3.0.17-4.module+el8.0.0+3108+851cb559', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-sqlite-3.0.17-4.module+el8.0.0+3108+851cb559', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-unixODBC-3.0.17-4.module+el8.0.0+3108+851cb559', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-utils-3.0.17-4.module+el8.0.0+3108+851cb559', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
