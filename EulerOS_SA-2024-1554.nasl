...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : python-jinja2 (EulerOS-SA-2024-1554)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1554
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a895d88");
...
var pkgs = [
  "python3-jinja2-2.11.2-1.h4.eulerosv2r10"
];
