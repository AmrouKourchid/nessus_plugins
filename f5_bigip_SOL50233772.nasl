...
# extracted from F5 Networks BIG-IP Solution K50233772.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : HTTP/2 Settings Flood vulnerability (K50233772)");
...
memory, or both. (CVE-2019-9515)

Impact

The BIG-IP system may exhaust available resources and fail over to
another system in the device group.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K50233772");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K50233772.");
...
var vmatrix = {
  'LTM': {
    'affected': [
      '15.0.0-15.0.1','14.0.0-14.1.2','13.1.0-13.1.3','12.1.0-12.1.5','11.6.1-11.6.5'
    ],
    'unaffected': [
