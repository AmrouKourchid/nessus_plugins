...
if (description)
{
  ...
  script_cve_id("CVE-2016-9636");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-9636");
...
patch available.
  ...
  - Heap-based buffer overflow in the flx_decode_delta_fli function in gst/flx/gstflxdec.c in the FLIC decoder
    ...
    (application crash) by providing a 'write count' that goes beyond the initialized buffer. (CVE-2016-9636)
