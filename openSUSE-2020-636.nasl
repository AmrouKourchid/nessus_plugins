...
# extracted from openSUSE Security Update openSUSE-2020-636.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : slirp4netns (openSUSE-2020-636)");
...
Security issue fixed :
  ...
  - CVE-2020-1983: Fixed a use-after-free in ip_reass
    (bsc#1170940).

This update was imported from the SUSE:SLE-15-SP1:Update update
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1170940");
  script_set_attribute(attribute:"solution", value:
"Update the affected slirp4netns packages.");
...
if ( rpm_check(release:"SUSE15.1", reference:"slirp4netns-0.4.5-lp151.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"slirp4netns-debuginfo-0.4.5-lp151.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"slirp4netns-debugsource-0.4.5-lp151.2.9.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "slirp4netns / slirp4netns-debuginfo / slirp4netns-debugsource");
}
