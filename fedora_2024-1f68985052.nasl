...
# extracted from Fedora Security Advisory FEDORA-2024-1f68985052
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1f68985052");

  script_name(english:"Fedora 40 : krb5 (2024-1f68985052)");
...
FEDORA-2024-1f68985052 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1f68985052");
...
var pkgs = [
    {'reference':'krb5-1.21.3-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
