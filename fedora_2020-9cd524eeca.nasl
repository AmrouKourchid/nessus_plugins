...
# extracted from Fedora Security Advisory FEDORA-2020-9cd524eeca.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : mingw-openjpeg2 / openjpeg2 (2020-9cd524eeca)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-9cd524eeca");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"mingw-openjpeg2-2.3.1-9.fc33")) flag++;
if (rpm_check(release:"FC33", reference:"openjpeg2-2.3.1-8.fc33")) flag++;
