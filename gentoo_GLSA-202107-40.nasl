...
# extracted from Gentoo Linux Security Advisory GLSA 202107-40.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-30152", "CVE-2021-30154", "CVE-2021-30155", "CVE-2021-30157", "CVE-2021-30158", "CVE-2021-30159", "CVE-2021-30458", "CVE-2021-35197");
  script_xref(name:"GLSA", value:"202107-40");

  script_name(english:"GLSA-202107-40 : MediaWiki: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-40
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-40"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"www-apps/mediawiki", unaffected:make_list("ge 1.36.1"), vulnerable:make_list("lt 1.36.1"))) flag++;
