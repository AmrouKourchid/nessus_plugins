...
# extracted from Fedora Security Advisory FEDORA-2023-d1cdb80702
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d1cdb80702");

  script_name(english:"Fedora 39 : python3.10 (2023-d1cdb80702)");
...
FEDORA-2023-d1cdb80702 advisory.

    Automatic update for python3.10-3.10.11-2.fc39.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d1cdb80702");
...
var pkgs = [
    {'reference':'python3.10-3.10.11-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
