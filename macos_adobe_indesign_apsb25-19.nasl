...
if (description)
{
  ...
  script_name(english:"Adobe InDesign < 19.5.3 / 20.0 < 20.2.0 Multiple Vulnerabilities (APSB25-19) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe InDesign instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe InDesign installed on the remote macOS host is prior to 19.5.3, 20.2.0. It is, therefore, affected
by multiple vulnerabilities as referenced in the APSB25-19 advisory.
...
var constraints = [
  ...
  { 'min_version' : '20.0', 'max_version' : '20.1', 'fixed_version' : '20.2.0', 'fixed_display' : 'ID20.2' }
];
