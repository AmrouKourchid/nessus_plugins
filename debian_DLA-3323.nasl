...
# extracted from Debian Security Advisory dla-3323. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3323 : libc-ares-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3323
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3323-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-4904");
...
"Upgrade the libc-ares-dev packages.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2023/02/18");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libc-ares-dev', 'reference': '1.14.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'libc-ares2', 'reference': '1.14.0-1+deb10u2'}
];
