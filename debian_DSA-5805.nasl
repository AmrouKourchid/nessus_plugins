...
# extracted from Debian Security Advisory dsa-5805. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5805 : guix - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has a package installed that is affected by a vulnerability as referenced in the dsa-5805
advisory.
...
var pkgs = [
    {'release': '12.0', 'prefix': 'guix', 'reference': '1.4.0-3+deb12u2'}
];
