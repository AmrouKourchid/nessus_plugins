...
if (description)
{
  ...
  script_cve_id("CVE-2023-1193");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-1193");
...
patch available.
  ...
  - A use-after-free flaw was found in setup_async_work in the KSMBD implementation of the in-kernel samba
    server and CIFS in the Linux kernel. This issue could allow an attacker to crash the system by accessing
    freed work. (CVE-2023-1193)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-1193");
