...
# extracted from Red Hat Security Advisory nodejs-glob-parent. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-28469");

  script_name(english:"RHEL 8 : nodejs-glob-parent (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-28469");
