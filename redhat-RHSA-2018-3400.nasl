...
# extracted from Red Hat Security Advisory RHSA-2018:3400. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3400");

  script_name(english:"RHEL 6 : libvirt (RHSA-2018:3400)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libvirt.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:3400 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3400.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3603001");
...
"Update the RHEL libvirt package based on the guidance in RHSA-2018:3400.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libvirt-0.10.2-46.el6_6.9', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-0.10.2-46.el6_6.9', 'sp':'6', 'cpu':'i686', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-client-0.10.2-46.el6_6.9', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-0.10.2-46.el6_6.9', 'sp':'6', 'cpu':'i686', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-devel-0.10.2-46.el6_6.9', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-lock-sanlock-0.10.2-46.el6_6.9', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libvirt-python-0.10.2-46.el6_6.9', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
