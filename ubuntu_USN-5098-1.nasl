...
# extracted from Ubuntu Security Notice USN-5098-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5098-1");

  script_name(english:"Ubuntu 18.04 LTS : bl vulnerability (USN-5098-1)");
...
USN-5098-1 advisory.
    ...
    It was discovered that bl didn't properly sanitize the inputs. An attacker could use this to leak
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5098-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'node-bl', 'pkgver': '1.1.2-1ubuntu1.1'}
];
