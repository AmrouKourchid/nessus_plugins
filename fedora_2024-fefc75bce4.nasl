...
# extracted from Fedora Security Advisory FEDORA-2024-fefc75bce4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fefc75bce4");

  script_name(english:"Fedora 39 : mingw-python3 (2024-fefc75bce4)");
...
FEDORA-2024-fefc75bce4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fefc75bce4");
...
var pkgs = [
    {'reference':'mingw-python3-3.11.8-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
