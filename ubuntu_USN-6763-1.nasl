...
USN-6763-1 advisory.
    ...
    Martin irokov discovered that libvirt incorrectly handled certain memory operations. A local attacker
    could possibly use this issue to access virtproxyd without authorization.
