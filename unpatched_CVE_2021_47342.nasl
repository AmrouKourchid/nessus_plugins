...
if (description)
{
  ...
  script_cve_id("CVE-2021-47342");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47342");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: ext4: fix possible UAF when remounting
    ...
    sbi->s_mmp_tsk to point at freed memory, which the call to ext4_stop_mmpd() can trip over. Fix this by
    only allowing kmmpd() to exit when it is stopped via ext4_stop_mmpd(). Bug-Report-Link:
    <20210629143603.2166962-1-yebin10@huawei.com> (CVE-2021-47342)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47342");
