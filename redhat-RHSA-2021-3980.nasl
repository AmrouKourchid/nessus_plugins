...
# extracted from Red Hat Security Advisory RHSA-2021:3980. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3980");

  script_name(english:"RHEL 7 : Red Hat OpenStack Platform 13.0 (redis) (RHSA-2021:3980)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for Red Hat OpenStack Platform 13.0 (redis).");
...
referenced in the RHSA-2021:3980 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3980.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?df2ca46e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3980");
...
"Update the RHEL Red Hat OpenStack Platform 13.0 (redis) package based on the guidance in RHSA-2021:3980.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redis-3.2.8-5.el7ost', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'redis-3.2.8-5.el7ost', 'cpu':'x86_64', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
