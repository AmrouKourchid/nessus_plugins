...
in a stack-based buffer overflow.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2019-16159");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/bird");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/bird");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2019/dsa-4528");
...
which is not affected by CVE-2019-16159 ).");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-16159");
