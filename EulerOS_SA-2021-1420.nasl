...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : python-lxml (EulerOS-SA-2021-1420)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1420
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?34c6979c");
...
pkgs = ["python-lxml-3.2.1-4.h3.eulerosv2r7"];
