...
var appstreams = {
    'nodejs:16': [
      {'reference':'nodejs-16.14.0-4.module_el8.6.0+2904+f21ad6f4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-16.14.0-4.module_el8.6.0+2904+f21ad6f4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-16.14.0-4.module_el8.6.0+2904+f21ad6f4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'npm-8.3.1-1.16.14.0.4.module_el8.6.0+2904+f21ad6f4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
