...
# extracted from Red Hat Security Advisory ttembed. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-10921", "CVE-2018-10922");

  script_name(english:"RHEL 7 : ttembed (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:ttembed");
