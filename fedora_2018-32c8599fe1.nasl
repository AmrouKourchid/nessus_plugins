...
# extracted from Fedora Security Advisory FEDORA-2018-32c8599fe1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-32c8599fe1");

  script_name(english:"Fedora 29 : elfutils (2018-32c8599fe1)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-32c8599fe1");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"elfutils-0.174-1.fc29")) flag++;
