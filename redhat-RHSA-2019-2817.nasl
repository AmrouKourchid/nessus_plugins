...
if (description)
{
  ...
  script_name(english:"RHEL 7 : OpenShift Container Platform 3.11 (RHSA-2019:2817)");
...
referenced in the RHSA-2019:2817 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2817.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7684749f");
...
"Update the RHEL OpenShift Container Platform 3.11 package based on the guidance in RHSA-2019:2817.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.11.16-0.2.dev.rhaos3.11.git3f89eba.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'cri-o-1.11.16-0.2.dev.rhaos3.11.git3f89eba.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
