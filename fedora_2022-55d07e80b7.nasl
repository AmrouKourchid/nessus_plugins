...
# extracted from Fedora Security Advisory FEDORA-2022-55d07e80b7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-55d07e80b7");

  script_name(english:"Fedora 37 : fapolicyd (2022-55d07e80b7)");
...
FEDORA-2022-55d07e80b7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-55d07e80b7");
  script_set_attribute(attribute:"solution", value:
"Update the affected fapolicyd package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:fapolicyd");
...
var pkgs = [
    {'reference':'fapolicyd-1.1.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'fapolicyd');
}
