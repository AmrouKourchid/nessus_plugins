...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libtasn1 PHSA-2025-4.0-0758");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtasn1-4.14-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libtasn1-devel-4.14-3.ph4')) flag++;
