...
# extracted from Gentoo Linux Security Advisory GLSA 202101-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202101-03");

  script_name(english:"GLSA-202101-03 : ipmitool: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202101-03
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202101-03");
...
"All ipmitool users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:ipmitool");
...
if (qpkg_check(package:"sys-apps/ipmitool", unaffected:make_list("ge 1.8.18_p20201004-r1"), vulnerable:make_list("lt 1.8.18_p20201004-r1"))) flag++;
