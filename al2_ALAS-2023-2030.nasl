...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2030.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-21342");

  script_name(english:"Amazon Linux 2 : xstream (ALAS-2023-2030)");
...
as referenced in the ALAS2-2023-2030 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2030.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2021-21342.html");
...
"Run 'yum update xstream' to update your system.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-21342");
...
var pkgs = [
    {'reference':'xstream-1.3.1-16.amzn2.0.2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xstream-javadoc-1.3.1-16.amzn2.0.2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
