...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : cairo (EulerOS-SA-2021-1181)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1181
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a98c3d4");
...
"Update the affected cairo package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-7475");
...
pkgs = ["cairo-1.14.8-2.h5.eulerosv2r7",
        "cairo-devel-1.14.8-2.h5.eulerosv2r7",
        "cairo-gobject-1.14.8-2.h5.eulerosv2r7",
        "cairo-gobject-devel-1.14.8-2.h5.eulerosv2r7"];
