...
# AlmaLinux Security Advisory ALSA-2023:4569.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4569");

  script_name(english:"AlmaLinux 9 : dbus (ALSA-2023:4569)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-4569.html");
