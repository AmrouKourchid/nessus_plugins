...
# extracted from VMware Security Advisory PHSA-2023-4.0-0397. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libvirt PHSA-2023-4.0-0397");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libvirt package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-397.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libvirt-7.10.0-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libvirt-devel-7.10.0-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libvirt-docs-7.10.0-3.ph4')) flag++;
