...
# extracted from Red Hat Security Advisory av_libtpms. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-3505", "CVE-2023-1017");

  script_name(english:"RHEL 8 : av_libtpms (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-3505");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-1017");
