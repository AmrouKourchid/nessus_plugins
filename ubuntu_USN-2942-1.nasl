...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : OpenJDK 7 vulnerability (USN-2942-1)");
...
USN-2942-1 advisory.
    ...
    A vulnerability was discovered in the JRE related to information disclosure, data integrity, and
    availability. An attacker could exploit these to cause a denial of service, expose sensitive data over the
    network, or possibly execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2942-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'icedtea-7-jre-jamvm', 'pkgver': '7u95-2.6.4-0ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-demo', 'pkgver': '7u95-2.6.4-0ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jdk', 'pkgver': '7u95-2.6.4-0ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre', 'pkgver': '7u95-2.6.4-0ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-headless', 'pkgver': '7u95-2.6.4-0ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-lib', 'pkgver': '7u95-2.6.4-0ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-jre-zero', 'pkgver': '7u95-2.6.4-0ubuntu0.14.04.2'},
    {'osver': '14.04', 'pkgname': 'openjdk-7-source', 'pkgver': '7u95-2.6.4-0ubuntu0.14.04.2'}
];
