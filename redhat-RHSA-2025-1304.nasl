...
# extracted from Red Hat Security Advisory RHSA-2025:1304. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1304");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"RHEL 9 : gcc (RHSA-2025:1304)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1304.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c0871fd8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1304");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gcc package based on the guidance in RHSA-2025:1304.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cpp-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-c++-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-gfortran-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-offload-nvptx-11.4.1-4.el9_4', 'sp':'4', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-offload-nvptx-11.4.1-4.el9_4', 'sp':'4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-plugin-annobin-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-plugin-devel-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libasan-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libatomic-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgcc-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgccjit-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgccjit-devel-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgfortran-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgomp-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgomp-offload-nvptx-11.4.1-4.el9_4', 'sp':'4', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgomp-offload-nvptx-11.4.1-4.el9_4', 'sp':'4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libitm-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libitm-devel-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'liblsan-11.4.1-4.el9_4', 'sp':'4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'liblsan-11.4.1-4.el9_4', 'sp':'4', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'liblsan-11.4.1-4.el9_4', 'sp':'4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libquadmath-11.4.1-4.el9_4', 'sp':'4', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libquadmath-11.4.1-4.el9_4', 'sp':'4', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libquadmath-11.4.1-4.el9_4', 'sp':'4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libquadmath-devel-11.4.1-4.el9_4', 'sp':'4', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libquadmath-devel-11.4.1-4.el9_4', 'sp':'4', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libquadmath-devel-11.4.1-4.el9_4', 'sp':'4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libstdc++-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libstdc++-devel-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libstdc++-docs-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libstdc++-static-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtsan-11.4.1-4.el9_4', 'sp':'4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtsan-11.4.1-4.el9_4', 'sp':'4', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtsan-11.4.1-4.el9_4', 'sp':'4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libubsan-11.4.1-4.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
