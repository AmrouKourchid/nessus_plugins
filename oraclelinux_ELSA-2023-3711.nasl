...
# extracted from Oracle Linux Security Advisory ELSA-2023-3711.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : libtiff (ELSA-2023-3711)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2023-3711 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-3711.html");
...
var pkgs = [
    ...
    {'reference':'libtiff-tools-4.4.0-8.el9_2', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
