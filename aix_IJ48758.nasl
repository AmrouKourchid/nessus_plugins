...
if (description)
{
  ...
  script_name(english:"AIX (IJ48758)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ48758. It is, therefore, affected by a vulnerability
as referenced in the IJ48758 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ48758");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7099314");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ48758.");
...
var constraints = [
    {'release': '7.3', 'ml': '00', 'sp': '02', 'patch': 'IJ48758s4a', 'package': 'X11.base.smt', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.0'},
    {'release': '7.3', 'ml': '00', 'sp': '03', 'patch': 'IJ48758s4a', 'package': 'X11.base.smt', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.0'},
    {'release': '7.3', 'ml': '00', 'sp': '04', 'patch': 'IJ48758s4a', 'package': 'X11.base.smt', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.0'}
];
