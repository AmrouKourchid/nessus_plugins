...
# extracted from Red Hat Security Advisory RHSA-2024:3417. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3417");

  script_name(english:"RHEL 9 : mod_http2 (RHSA-2024:3417)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85107589");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268277");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3417");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_http2 package based on the guidance in RHSA-2024:3417.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_http2-1.15.19-3.el9_0.6', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
