...
Sprockets server is used in production.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=901913");
  # https://security-tracker.debian.org/tracker/source-package/ruby-sprockets
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0c4015a");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/ruby-sprockets");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4242");
