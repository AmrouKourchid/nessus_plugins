...
# extracted from F5 Networks BIG-IP Solution K49921213.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : glibc vulnerability (K49921213)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K49921213 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K49921213");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '16.0.0-16.1.2','15.0.0-15.1.4','14.1.0-14.1.4','13.1.0-13.1.4'
    ],
  },
  'AM': {
    'affected': [
