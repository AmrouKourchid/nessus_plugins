...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 115.10. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2024-20 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'115.10', severity:SECURITY_HOLE);
