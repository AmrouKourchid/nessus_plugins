...
# SUSE update advisory SUSE-SU-2023:2666-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2666-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 34 for SLE 12 SP4) (SUSE-SU-2023:2666-1)");
...
the SUSE-SU-2023:2666-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-June/015345.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc52a1d2");
  script_set_attribute(attribute:"solution", value:
"Update the affected kgraft-patch-4_12_14-95_120-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-95.120-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_120-default-4-2.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-95_120-default');
}
