...
if (description)
{
  ...
  script_name(english:"Foxit Reader < 9.7.1 Multiple Vulnerabilities");
...
"Upgrade to Foxit Reader version 9.7.1 or later");
...
var constraints = [
  { 'max_version' : '9.7.0.29478', 'fixed_version' : '9.7.1' }
];
