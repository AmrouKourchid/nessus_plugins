...
# extracted from Fedora Security Advisory FEDORA-2024-049f068a8c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-049f068a8c");
  script_xref(name:"IAVA", value:"2024-A-0042-S");

  script_name(english:"Fedora 38 : chromium (2024-049f068a8c)");
...
FEDORA-2024-049f068a8c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-049f068a8c");
...
var pkgs = [
    {'reference':'chromium-120.0.6099.224-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
