...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : python-jinja2 (EulerOS-SA-2025-1306)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1306
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5e7a2b63");
