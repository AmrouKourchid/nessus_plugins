...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.5.0 : xorg-x11-server (EulerOS-SA-2020-1062)");
...
is affected by the following vulnerabilities :
  ...
  - An incorrect permission check for -modulepath and
    -logfile options when starting Xorg X server allows
  ...
  - systemd 242 changes the VT1 mode upon a logout, which
    ...
    mishandled.(CVE-2018-20839)(CVE-2019-1547)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1062
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1ac7ca3f");
...
pkgs = ["xorg-x11-server-Xorg-1.20.1-4.h4.eulerosv2r8",
