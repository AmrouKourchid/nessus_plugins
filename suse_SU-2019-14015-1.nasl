...
# extracted from SUSE update advisory SUSE-SU-2019:14015-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : clamav (SUSE-SU-2019:14015-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2019/suse-su-201914015-1.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c8570fd1");
...
slessp4-clamav-14015=1

SUSE Linux Enterprise Point of Sale 11-SP3:zypper in -t patch
sleposp3-clamav-14015=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-clamav-14015=1

SUSE Linux Enterprise Debuginfo 11-SP3:zypper in -t patch
dbgsp3-clamav-14015=1");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"clamav-0.100.3-0.20.21.1")) flag++;
