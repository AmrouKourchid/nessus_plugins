...
if (description)
{
  ...
  script_cve_id("CVE-2017-9743");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-9743");
...
patch available.
  ...
  - The print_insn_score32 function in opcodes/score7-dis.c:552 in GNU Binutils 2.28 allows remote attackers
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-9743");
