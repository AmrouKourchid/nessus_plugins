...
USN-5666-1 advisory.
    ...
    It was discovered that OpenSSH incorrectly handled certain helper programs. An attacker could possibly use
    this issue to arbitrary code execution.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'openssh-client', 'pkgver': '1:7.2p2-4ubuntu2.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openssh-client-ssh1', 'pkgver': '1:7.2p2-4ubuntu2.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openssh-server', 'pkgver': '1:7.2p2-4ubuntu2.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openssh-sftp-server', 'pkgver': '1:7.2p2-4ubuntu2.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ssh', 'pkgver': '1:7.2p2-4ubuntu2.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ssh-askpass-gnome', 'pkgver': '1:7.2p2-4ubuntu2.10+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ssh-krb5', 'pkgver': '1:7.2p2-4ubuntu2.10+esm2', 'ubuntu_pro': TRUE}
];
