...
# extracted from Fedora Security Advisory FEDORA-2024-930af3332f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-930af3332f");

  script_name(english:"Fedora 40 : python-dns (2024-930af3332f)");
...
FEDORA-2024-930af3332f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-930af3332f");
...
var pkgs = [
    {'reference':'python-dns-2.6.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
