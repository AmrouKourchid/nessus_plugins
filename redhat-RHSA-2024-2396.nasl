...
# extracted from Red Hat Security Advisory RHSA-2024:2396. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2396");

  script_name(english:"RHEL 9 : squashfs-tools (RHSA-2024:2396)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for squashfs-tools.");
...
referenced in the RHSA-2024:2396 advisory.

    SquashFS is a highly compressed read-only file system for Linux. These packages contain the utilities for
    manipulating squashfs file systems.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2396.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28965a9d");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2396");
...
"Update the RHEL squashfs-tools package based on the guidance in RHSA-2024:2396.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:squashfs-tools");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squashfs-tools-4.4-10.git1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
