...
# SUSE update advisory SUSE-SU-2025:1445-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-8805", "CVE-2024-50205", "CVE-2024-56650");
  script_xref(name:"SuSE", value:"SUSE-SU-2025:1445-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 26 for SLE 15 SP4) (SUSE-SU-2025:1445-1)");
...
the SUSE-SU-2025:1445-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2025-May/039139.html");
...
"Update the affected kernel-livepatch-5_14_21-150400_24_119-default package.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2025/05/04");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.24.119-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_119-default-16-150400.2.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_24_119-default');
}
