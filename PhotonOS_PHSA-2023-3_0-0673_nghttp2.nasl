...
# extracted from VMware Security Advisory PHSA-2023-3.0-0673. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Nghttp2 PHSA-2023-3.0-0673");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the nghttp2 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-673.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nghttp2-1.57.0-1.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'nghttp2-devel-1.57.0-1.ph3')) flag++;
