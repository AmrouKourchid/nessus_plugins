...
if (description)
{
  ...
  script_cve_id("CVE-2025-29482");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-29482");
...
patch available.
  ...
  - Buffer Overflow vulnerability in libheif 1.19.7 allows a local attacker to execute arbitrary code via the
    SAO (Sample Adaptive Offset) processing of libde265. (CVE-2025-29482)

Note that Nessus relies on the presence of the package as reported by the vendor.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-29482");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-29482");
