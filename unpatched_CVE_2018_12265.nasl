...
if (description)
{
  ...
  script_cve_id("CVE-2018-12265");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-12265");
...
patch available.
  ...
  - Exiv2 0.26 has an integer overflow in the LoaderExifJpeg class in preview.cpp, leading to an out-of-bounds
    read in Exiv2::MemIo::read in basicio.cpp. (CVE-2018-12265)
