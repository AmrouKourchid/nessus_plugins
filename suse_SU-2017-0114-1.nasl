...
# extracted from SUSE update advisory SUSE-SU-2017:0114-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : python-Twisted (SUSE-SU-2017:0114-1)");
...
"This update for python-Twisted fixes the following issues :
  ...
  - CVE-2016-1000111: sets environmental variable HTTP_PROXY
    based on user supplied Proxy request header (bsc#989997)

Note that Tenable Network Security has extracted the preceding
description block directly from the SUSE security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=989997");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2016-1000111/");
  # https://www.suse.com/support/update/announcement/2017/suse-su-20170114-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2e190cd5");
  script_set_attribute(attribute:"solution", value:
"To install this SUSE Security Update use YaST online_update.
Alternatively you can run the command listed for your product :

SUSE Linux Enterprise Module for Web Scripting 12:zypper in -t patch
SUSE-SLE-Module-Web-Scripting-12-2017-56=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"python-Twisted-15.2.1-8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"python-Twisted-debuginfo-15.2.1-8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"python-Twisted-debugsource-15.2.1-8.1")) flag++;
