...
# extracted from Fedora Security Advisory FEDORA-2025-256a86d7c8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-256a86d7c8");

  script_name(english:"Fedora 40 : webkitgtk (2025-256a86d7c8)");
...
FEDORA-2025-256a86d7c8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-256a86d7c8");
...
var pkgs = [
    {'reference':'webkitgtk-2.48.1-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
