...
# extracted from Fedora Security Advisory FEDORA-2025-942a0d7e5d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-942a0d7e5d");

  script_name(english:"Fedora 40 : c-ares (2025-942a0d7e5d)");
...
FEDORA-2025-942a0d7e5d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-942a0d7e5d");
...
var pkgs = [
    {'reference':'c-ares-1.34.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
