...
the RHSA-2017:2966 advisory.
    ...
    The ansible packages have been upgraded to upstream version 2.4.0, which provides a number of bug fixes
    and enhancements over the previous version. For more information, please see the Ansible 2.4 Porting Guide
    linked in the References section. (BZ#1492477)

    Security Fix(es):

    * A flaw was found in the way Ansible passed certain parameters to the jenkins_plugin module. A remote
    attacker could use this flaw to expose sensitive information from a remote host's logs. This flaw was
    fixed by not allowing passwords to be specified in the params argument, and noting this in the module
    documentation. (CVE-2017-7550)

    Red Hat would like to thank Stefano Mazzucco (Kirontech) for reporting this issue.

    Bug Fix(es):

    * A bug in the SELinux module, which caused a corruption of the SELinux configuration file, has been
    fixed.

    * Previously, some of the functionality of Ansible (the json_query filter) was unavailable, because the
    dependency on the python2-jmespath package was missing. Now, the missing dependency has been added.
    (BZ#1484910)
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2017/rhsa-2017_2966.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecabfccd");
  script_set_attribute(attribute:"see_also", value:"https://docs.ansible.com/ansible/2.4/porting_guide_2.4.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:2966");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1473645");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1484910");
...
"Update the affected ansible and / or ansible-doc packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-7550");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.4.0.0-5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ansible-doc-2.4.0.0-5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
