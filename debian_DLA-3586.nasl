...
# extracted from Debian Security Advisory dla-3586. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3586 : lib32ncurses-dev - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3586
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3586-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                         Sean Whitton
    September 28, 2023                            https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : ncurses
    Version        : 6.1+20181013-2+deb10u4
    CVE ID         : CVE-2020-19189

    An out-of-bounds read problem was found in the postprocess_terminfo
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-19189");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'lib32ncurses-dev', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'lib32ncurses6', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'lib32ncursesw6', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'lib32tinfo6', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'lib64ncurses-dev', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'lib64ncurses6', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'lib64ncursesw6', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'lib64tinfo6', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libncurses-dev', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libncurses5', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libncurses5-dev', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libncurses6', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libncurses6-dbg', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libncursesw5', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libncursesw5-dev', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libncursesw6', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libncursesw6-dbg', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libtinfo-dev', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libtinfo5', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libtinfo6', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'libtinfo6-dbg', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'ncurses-base', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'ncurses-bin', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'ncurses-doc', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'ncurses-examples', 'reference': '6.1+20181013-2+deb10u4'},
    {'release': '10.0', 'prefix': 'ncurses-term', 'reference': '6.1+20181013-2+deb10u4'}
];
