...
# extracted from Fedora Security Advisory FEDORA-2022-61ec901852
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-61ec901852");

  script_name(english:"Fedora 36 : jhead (2022-61ec901852)");
...
FEDORA-2022-61ec901852 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-61ec901852");
...
var pkgs = [
    {'reference':'jhead-3.06.0.1-5.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
