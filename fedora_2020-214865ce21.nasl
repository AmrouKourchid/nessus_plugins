...
# extracted from Fedora Security Advisory FEDORA-2020-214865ce21.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : chromium (2020-214865ce21)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-214865ce21");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"chromium-85.0.4183.121-1.fc32", allowmaj:TRUE)) flag++;
