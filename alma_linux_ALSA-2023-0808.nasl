...
# AlmaLinux Security Advisory ALSA-2023:0808.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:0808");
  script_xref(name:"IAVA", value:"2023-A-0081-S");

  script_name(english:"AlmaLinux 8 : firefox (ALSA-2023:0808)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-0808.html");
...
var pkgs = [
    {'reference':'firefox-102.8.0-2.el8_7.alma', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.8.0-2.el8_7.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
