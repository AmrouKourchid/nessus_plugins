...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : systemd on SL7.x x86_64 (20190129)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1901&L=SCIENTIFIC-LINUX-ERRATA&P=10101
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2040b4f3");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-16864");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libgudev1-219-62.el7_6.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libgudev1-devel-219-62.el7_6.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-219-62.el7_6.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-debuginfo-219-62.el7_6.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-devel-219-62.el7_6.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-journal-gateway-219-62.el7_6.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-libs-219-62.el7_6.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-networkd-219-62.el7_6.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-python-219-62.el7_6.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-resolved-219-62.el7_6.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-sysv-219-62.el7_6.3")) flag++;
