...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : elfutils (EulerOS-SA-2025-1504)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1504
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9acfc3cd");
...
var pkgs = [
  "elfutils-0.180-1.h7.eulerosv2r10"
];
