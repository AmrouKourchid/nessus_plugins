...
if (description)
{
  ...
  script_name(english:"CentOS 9 : vim-8.2.2637-13.el9");
...
vim-8.2.2637-13.el9 build changelog.

  - heap overflow in ex_retab() may lead to crash (CVE-2022-0572)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=17101");
...
"Update the CentOS 9 Stream vim-X11 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-0572");
...
var pkgs = [
    {'reference':'vim-X11-8.2.2637-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'vim-common-8.2.2637-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'vim-enhanced-8.2.2637-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'vim-filesystem-8.2.2637-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'vim-minimal-8.2.2637-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
