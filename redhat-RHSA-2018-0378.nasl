...
referenced in the RHSA-2018:0378 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0378.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c33ad6b9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0378");
...
"Update the RHEL ruby package based on the guidance in RHSA-2018:0378.");
  ...
  script_cwe_id(117, 119, 122, 138, 20, 200, 77);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ruby-2.0.0.648-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-devel-2.0.0.648-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-doc-2.0.0.648-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-irb-2.0.0.648-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-libs-2.0.0.648-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ruby-tcltk-2.0.0.648-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-bigdecimal-1.2.0-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-io-console-0.4.2-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-json-1.7.7-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-minitest-4.3.2-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-psych-2.0.0-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-rake-0.9.6-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygem-rdoc-4.0.0-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygems-2.0.14.1-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rubygems-devel-2.0.14.1-33.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
