...
# extracted from Red Hat Security Advisory RHSA-2024:0195. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-6476");
  script_xref(name:"RHSA", value:"2024:0195");

  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.13.29 (RHSA-2024:0195)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.13.29.");
...
in the RHSA-2024:0195 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.13.29. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0195.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bdef36b2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2253994");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0195");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.13.29 packages based on the guidance in RHSA-2024:0195.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.26.4-6.1.rhaos4.13.git9eb9cf3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.26.4-6.1.rhaos4.13.git9eb9cf3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
