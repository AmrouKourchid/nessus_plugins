...
# extracted from Fedora Security Advisory FEDORA-2022-d832fd2f45
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d832fd2f45");

  script_name(english:"Fedora 37 : ceph (2022-d832fd2f45)");
...
FEDORA-2022-d832fd2f45 advisory.
    ...
    Security fix for CVE-2021-3979

    Note: fix was actually included in ceph-17.2.3
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d832fd2f45");
  script_set_attribute(attribute:"solution", value:
"Update the affected 2:ceph package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:ceph");
...
var pkgs = [
    {'reference':'ceph-17.2.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
