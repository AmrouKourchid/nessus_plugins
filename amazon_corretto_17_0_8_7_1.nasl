...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 17.x < 17.0.8.7.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 17 < 17.0.8.7.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-17-2023-Jul-18 advisory.

  - core-libs/java.net (CVE-2023-22006)

  - core-libs/java.util (CVE-2023-22036)

  - hotspot/compiler (CVE-2023-22041, CVE-2023-22044, CVE-2023-22045)

  - core-libs/java.io (CVE-2023-22049)

  - client-libs/2d (CVE-2023-25193)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"solution", value:
"Update to Amazon Corretto Java 17.0.8.7.1 or later");
...
var constraints = [
  { 'min_version' : '17.0', 'fixed_version' : '17.0.8.7.1' }
]; 
