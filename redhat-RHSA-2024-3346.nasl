...
# extracted from Red Hat Security Advisory RHSA-2024:3346. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3346");

  script_name(english:"RHEL 8 : git-lfs (RHSA-2024:3346)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for git-lfs.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2024:3346 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3346.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4b35005b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3346");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL git-lfs package based on the guidance in RHSA-2024:3346.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-lfs-3.4.1-2.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
