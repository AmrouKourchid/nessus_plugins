...
# extracted from Ubuntu Security Notice USN-2821-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2821-1");

  script_name(english:"Ubuntu 14.04 LTS : GnuTLS vulnerability (USN-2821-1)");
...
USN-2821-1 advisory.
    ...
    It was discovered that GnuTLS incorrectly validated the first byte of padding in CBC modes. A remote
    attacker could possibly use this issue to perform a padding oracle attack.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2821-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'gnutls-bin', 'pkgver': '3.0.11+really2.12.23-12ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'libgnutls-dev', 'pkgver': '2.12.23-12ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'libgnutls-openssl27', 'pkgver': '2.12.23-12ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'libgnutls26', 'pkgver': '2.12.23-12ubuntu2.3'},
    {'osver': '14.04', 'pkgname': 'libgnutlsxx27', 'pkgver': '2.12.23-12ubuntu2.3'}
];
