...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : sqlite (EulerOS-SA-2024-1498)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1498
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7e38830d");
...
var pkgs = [
  "sqlite-3.31.1-1.h12.eulerosv2r9"
];
