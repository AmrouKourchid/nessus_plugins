...
# extracted from Fedora Security Advisory FEDORA-2024-08eb67ed86
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-08eb67ed86");

  script_name(english:"Fedora 41 : python-werkzeug (2024-08eb67ed86)");
...
FEDORA-2024-08eb67ed86 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-08eb67ed86");
...
var pkgs = [
    {'reference':'python-werkzeug-3.0.6-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
