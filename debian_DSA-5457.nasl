...
# extracted from Debian Security Advisory dsa-5457. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5457-1 : webkit2gtk - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 / 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5457
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5457");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-37450");
...
For the stable distribution (bookworm), this problem has been fixed in version 2.40.3-2~deb12u2.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2023/07/22");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'gir1.2-javascriptcoregtk-4.0', 'reference': '2.40.3-2~deb11u2'},
    {'release': '11.0', 'prefix': 'gir1.2-webkit2-4.0', 'reference': '2.40.3-2~deb11u2'},
    {'release': '11.0', 'prefix': 'libjavascriptcoregtk-4.0-18', 'reference': '2.40.3-2~deb11u2'},
    {'release': '11.0', 'prefix': 'libjavascriptcoregtk-4.0-bin', 'reference': '2.40.3-2~deb11u2'},
    {'release': '11.0', 'prefix': 'libjavascriptcoregtk-4.0-dev', 'reference': '2.40.3-2~deb11u2'},
    {'release': '11.0', 'prefix': 'libwebkit2gtk-4.0-37', 'reference': '2.40.3-2~deb11u2'},
    {'release': '11.0', 'prefix': 'libwebkit2gtk-4.0-37-gtk2', 'reference': '2.40.3-2~deb11u2'},
    {'release': '11.0', 'prefix': 'libwebkit2gtk-4.0-dev', 'reference': '2.40.3-2~deb11u2'},
    {'release': '11.0', 'prefix': 'libwebkit2gtk-4.0-doc', 'reference': '2.40.3-2~deb11u2'},
    {'release': '11.0', 'prefix': 'webkit2gtk-driver', 'reference': '2.40.3-2~deb11u2'},
    {'release': '12.0', 'prefix': 'gir1.2-javascriptcoregtk-4.0', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'gir1.2-javascriptcoregtk-4.1', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'gir1.2-javascriptcoregtk-6.0', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'gir1.2-webkit-6.0', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'gir1.2-webkit2-4.0', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'gir1.2-webkit2-4.1', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libjavascriptcoregtk-4.0-18', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libjavascriptcoregtk-4.0-bin', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libjavascriptcoregtk-4.0-dev', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libjavascriptcoregtk-4.1-0', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libjavascriptcoregtk-4.1-dev', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libjavascriptcoregtk-6.0-1', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libjavascriptcoregtk-6.0-dev', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libwebkit2gtk-4.0-37', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libwebkit2gtk-4.0-dev', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libwebkit2gtk-4.0-doc', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libwebkit2gtk-4.1-0', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libwebkit2gtk-4.1-dev', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libwebkitgtk-6.0-4', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'libwebkitgtk-6.0-dev', 'reference': '2.40.3-2~deb12u2'},
    {'release': '12.0', 'prefix': 'webkit2gtk-driver', 'reference': '2.40.3-2~deb12u2'}
];
