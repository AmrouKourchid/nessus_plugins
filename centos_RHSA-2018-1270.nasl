...
# CentOS Errata and Security Advisory 2018:1270 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : java-1.7.0-openjdk (CESA-2018:1270)");
...
listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2018-May/022816.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1eadc73");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-1.7.0.181-2.6.14.1.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-demo-1.7.0.181-2.6.14.1.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-devel-1.7.0.181-2.6.14.1.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-javadoc-1.7.0.181-2.6.14.1.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-src-1.7.0.181-2.6.14.1.el6_9")) flag++;
