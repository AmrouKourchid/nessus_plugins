...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-3065.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected libkdcraw and / or libkdcraw-devel packages.");
