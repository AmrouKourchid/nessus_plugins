...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : compat-openssl10 (EulerOS-SA-2024-1675)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1675
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f368e46e");
...
var pkgs = [
  "compat-openssl10-1.0.2o-3.h22.eulerosv2r8"
];
