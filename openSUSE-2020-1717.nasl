...
# extracted from openSUSE Security Update openSUSE-2020-1717.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : hunspell (openSUSE-2020-1717)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1151867");
  script_set_attribute(attribute:"solution", value:
"Update the affected hunspell packages.");
...
if ( rpm_check(release:"SUSE15.1", reference:"hunspell-1.6.2-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"hunspell-debuginfo-1.6.2-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"hunspell-debugsource-1.6.2-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"hunspell-devel-1.6.2-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"hunspell-tools-1.6.2-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"hunspell-tools-debuginfo-1.6.2-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libhunspell-1_6-0-1.6.2-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libhunspell-1_6-0-debuginfo-1.6.2-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"hunspell-devel-32bit-1.6.2-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libhunspell-1_6-0-32bit-1.6.2-lp151.3.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libhunspell-1_6-0-32bit-debuginfo-1.6.2-lp151.3.3.1") ) flag++;
