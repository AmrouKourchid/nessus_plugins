...
if (description)
{
  ...
  script_name(english:"Apache Subversion Client SEoL (1.2.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Apache Subversion Client is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Apache Subversion Client is 1.2.x. It is, therefore, no longer maintained by its vendor or
provider.
...
"Upgrade to a version of Apache Subversion Client that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2009/05/21");
...
var constraints = [
  { max_branch : '1.2', min_branch : '1.2', seol : 20090521 }
];
