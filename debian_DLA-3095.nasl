...
# extracted from Debian Security Advisory dla-3095. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3095 : ruby-rack - security update");
...
dla-3095 advisory.
    ...
    - -----------------------------------------------------------------------
    Debian LTS Advisory DLA-3095-1              debian-lts@lists.debian.org
...
"Upgrade the ruby-rack packages.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2022/09/04");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'ruby-rack', 'reference': '2.0.6-3+deb10u1'}
];
