...
"The remote Red Hat host is missing one or more security updates for rh-mariadb103-mariadb.");
...
referenced in the RHSA-2022:1010 advisory.
    ...
    The following packages have been upgraded to a later upstream version: rh-mariadb103-mariadb (10.3.32),
    rh-mariadb103-galera (25.3.34). (BZ#2050544)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1010.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f7cf4ef");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2050509");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2050516");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2050520");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2050538");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2050544");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2050549");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-mariadb103-mariadb package based on the guidance in RHSA-2022:1010.");
