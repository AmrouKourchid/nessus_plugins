...
# extracted from Fedora Security Advisory FEDORA-2024-e3caf31c98
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e3caf31c98");

  script_name(english:"Fedora 40 : mingw-python-jinja2 (2024-e3caf31c98)");
...
FEDORA-2024-e3caf31c98 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e3caf31c98");
...
var pkgs = [
    {'reference':'mingw-python-jinja2-3.1.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
