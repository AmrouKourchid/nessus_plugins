...
if (description)
{
  ...
  script_cve_id("CVE-2024-0150");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-0150");
...
patch available.
  ...
  - NVIDIA GPU display driver for Windows and Linux contains a vulnerability where data is written past the
    end or before the beginning of a buffer. A successful exploit of this vulnerability might lead to
    information disclosure, denial of service, or data tampering. (CVE-2024-0150)
