...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libtiff (EulerOS-SA-2019-1807)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1807
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b5d7d8e9");
...
pkgs = ["libtiff-4.0.3-27.h10.eulerosv2r7",
        "libtiff-devel-4.0.3-27.h10.eulerosv2r7"];
