...
# extracted from Fedora Security Advisory FEDORA-2023-e77300e4b5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e77300e4b5");

  script_name(english:"Fedora 39 : python-asyncssh (2023-e77300e4b5)");
...
FEDORA-2023-e77300e4b5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e77300e4b5");
...
var pkgs = [
    {'reference':'python-asyncssh-2.14.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
