...
of the web server user id.");
  # https://packetstormsecurity.com/files/119219/WordPress-Uploader-1.0.4-Shell-Upload.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d052c6cc");
