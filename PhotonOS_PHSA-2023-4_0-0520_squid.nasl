...
if (description)
{
  ...
  script_cve_id("CVE-2023-46728", "CVE-2023-46846", "CVE-2023-5824");

  script_name(english:"Photon OS 4.0: Squid PHSA-2023-4.0-0520");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'squid-6.5-1.ph4')) flag++;
