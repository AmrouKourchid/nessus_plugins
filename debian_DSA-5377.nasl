...
# extracted from Debian Security Advisory dsa-5377. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5377-1 : chromium - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1015367");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/chromium");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5377");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-1528");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-1529");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-1530");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-1531");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-1532");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-1533");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-1534");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'chromium', 'reference': '111.0.5563.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-common', 'reference': '111.0.5563.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-driver', 'reference': '111.0.5563.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-l10n', 'reference': '111.0.5563.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-sandbox', 'reference': '111.0.5563.110-1~deb11u1'},
    {'release': '11.0', 'prefix': 'chromium-shell', 'reference': '111.0.5563.110-1~deb11u1'}
];
