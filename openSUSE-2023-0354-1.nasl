...
# openSUSE Security Update openSUSE-SU-2023:0354-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : opera (openSUSE-SU-2023:0354-1)");
...
number.");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/2Y5GV5TH6NRTLTHJ4VYCUYSWH6XUX5TQ/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30e7c14b");
...
var pkgs = [
    {'reference':'opera-104.0.4944.36-lp155.3.18.1', 'cpu':'x86_64', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE}
];
