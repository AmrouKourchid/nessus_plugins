...
# extracted from Ubuntu Security Notice USN-7000-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7000-2");
  script_xref(name:"IAVA", value:"2024-A-0543-S");

  script_name(english:"Ubuntu 22.04 LTS : Expat vulnerabilities (USN-7000-2)");
...
the USN-7000-2 advisory.

    USN-7000-1 fixed vulnerabilities in Expat. This update provides the corresponding updates for Ubuntu 22.04
    LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7000-2");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'expat', 'pkgver': '2.4.7-1ubuntu0.4'},
    {'osver': '22.04', 'pkgname': 'libexpat1', 'pkgver': '2.4.7-1ubuntu0.4'},
    {'osver': '22.04', 'pkgname': 'libexpat1-dev', 'pkgver': '2.4.7-1ubuntu0.4'}
];
