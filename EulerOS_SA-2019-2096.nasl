...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : bind (EulerOS-SA-2019-2096)");
...
vulnerability :
  ...
  - A race condition which may occur when discarding
    malformed packets can result in BIND exiting due to a
    REQUIRE assertion failure in dispatch.c. Versions
    affected: BIND 9.11.0 -> 9.11.7, 9.12.0 -> 9.12.4-P1,
    9.14.0 -> 9.14.2. Also all releases of the BIND 9.13
    development branch and version 9.15.0 of the BIND 9.15
    development branch and BIND Supported Preview Edition
    versions 9.11.3-S1 -> 9.11.7-S1.(CVE-2019-6471)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2096
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8fb078e1");
...
pkgs = ["bind-9.11.4-10.P2.h13.eulerosv2r8",
        "bind-chroot-9.11.4-10.P2.h13.eulerosv2r8",
        "bind-export-devel-9.11.4-10.P2.h13.eulerosv2r8",
        "bind-export-libs-9.11.4-10.P2.h13.eulerosv2r8",
        "bind-libs-9.11.4-10.P2.h13.eulerosv2r8",
        "bind-libs-lite-9.11.4-10.P2.h13.eulerosv2r8",
        "bind-license-9.11.4-10.P2.h13.eulerosv2r8",
        "bind-pkcs11-9.11.4-10.P2.h13.eulerosv2r8",
        "bind-pkcs11-libs-9.11.4-10.P2.h13.eulerosv2r8",
        "bind-pkcs11-utils-9.11.4-10.P2.h13.eulerosv2r8",
        "bind-utils-9.11.4-10.P2.h13.eulerosv2r8",
        "python3-bind-9.11.4-10.P2.h13.eulerosv2r8"];
