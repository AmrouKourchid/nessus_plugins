...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : yajl (EulerOS-SA-2023-1210)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1210
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f983ba36");
...
var pkgs = [
  "yajl-2.1.0-12.h1.r3.eulerosv2r9"
];
