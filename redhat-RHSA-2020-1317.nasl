...
# extracted from Red Hat Security Advisory RHSA-2020:1317. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1317");

  script_name(english:"RHEL 8 : nodejs:10 (RHSA-2020:1317)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for nodejs:10.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:1317 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1317.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0b95d68f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1317");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1807349");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nodejs:10 package based on the guidance in RHSA-2020:1317.");
  ...
  'nodejs:10': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-10.19.0-2.module+el8.1.0+6118+5aaa808b', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-10.19.0-2.module+el8.1.0+6118+5aaa808b', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-10.19.0-2.module+el8.1.0+6118+5aaa808b', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-6.13.4-1.10.19.0.2.module+el8.1.0+6118+5aaa808b', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'nodejs-10.19.0-2.module+el8.1.0+6118+5aaa808b', 'sp':'1', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-10.19.0-2.module+el8.1.0+6118+5aaa808b', 'sp':'1', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-10.19.0-2.module+el8.1.0+6118+5aaa808b', 'sp':'1', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-6.13.4-1.10.19.0.2.module+el8.1.0+6118+5aaa808b', 'sp':'1', 'release':'8', 'el_string':'el8.1.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
