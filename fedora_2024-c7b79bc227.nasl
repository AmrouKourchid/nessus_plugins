...
# extracted from Fedora Security Advisory FEDORA-2024-c7b79bc227
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c7b79bc227");

  script_name(english:"Fedora 39 : kitty (2024-c7b79bc227)");
...
FEDORA-2024-c7b79bc227 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c7b79bc227");
...
var pkgs = [
    {'reference':'kitty-0.31.0-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
