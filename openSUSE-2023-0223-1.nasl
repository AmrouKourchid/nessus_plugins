...
# openSUSE Security Update openSUSE-SU-2023:0223-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : perl-HTTP-Tiny (openSUSE-SU-2023:0223-1)");
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/E3ZS64YN6IDP4X4L3RSPD77DZ3YJT32J/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25a21568");
...
var pkgs = [
    {'reference':'perl-HTTP-Tiny-0.086-bp155.3.3.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE}
];
