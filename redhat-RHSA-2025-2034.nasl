...
# extracted from Red Hat Security Advisory RHSA-2025:2034. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:2034");

  script_name(english:"RHEL 8 : webkit2gtk3 (RHSA-2025:2034)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for webkit2gtk3.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:2034 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2344621");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2344622");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2344623");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2344624");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_2034.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fcf1776b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:2034");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL webkit2gtk3 package based on the guidance in RHSA-2025:2034.");
  ...
  script_cwe_id(77, 119, 770, 787, 862);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'webkit2gtk3-2.46.6-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-devel-2.46.6-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-2.46.6-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-devel-2.46.6-1.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
