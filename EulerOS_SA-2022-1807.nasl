...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : httpd (EulerOS-SA-2022-1807)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1807
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e56e655e");
...
var pkgs = [
  ...
  "mod_ssl-2.4.43-4.h14.eulerosv2r10"
];
