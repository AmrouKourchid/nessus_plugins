...
# openSUSE Security Update openSUSE-SU-2024:0397-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : radare2 (openSUSE-SU-2024:0397-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1234065");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/3TFFYH6UBBCXZJVULIKEERWLXPLONYTN/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3e569ad7");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2024-29645");
...
"Update the affected radare2, radare2-devel and / or radare2-zsh-completion packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-29645");
...
var pkgs = [
    {'reference':'radare2-5.9.8-bp156.4.3.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'radare2-devel-5.9.8-bp156.4.3.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'radare2-zsh-completion-5.9.8-bp156.4.3.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE}
];
