...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : squid (EulerOS-SA-2022-1190)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1190
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4ae03f5");
...
"Update the affected squid packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-28652");
...
var pkgs = [
  "squid-3.5.20-2.2.h15",
  "squid-migration-script-3.5.20-2.2.h15"
];
