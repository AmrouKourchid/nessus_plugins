...
# extracted from Fedora Security Advisory FEDORA-2023-a4de0fb2bb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a4de0fb2bb");

  script_name(english:"Fedora 39 : suricata (2023-a4de0fb2bb)");
...
FEDORA-2023-a4de0fb2bb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a4de0fb2bb");
...
var pkgs = [
    {'reference':'suricata-6.0.15-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
