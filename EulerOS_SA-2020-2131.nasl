...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : glibc (EulerOS-SA-2020-2131)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2131
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d292ea7f");
...
pkgs = ["glibc-2.17-196.h35",
        "glibc-common-2.17-196.h35",
        "glibc-devel-2.17-196.h35",
        "glibc-headers-2.17-196.h35",
        "glibc-static-2.17-196.h35",
        "glibc-utils-2.17-196.h35",
        "nscd-2.17-196.h35"];
