...
# extracted from Fedora Security Advisory FEDORA-2023-e8c27ba884
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e8c27ba884");

  script_name(english:"Fedora 36 : containernetworking-plugins (2023-e8c27ba884)");
...
FEDORA-2023-e8c27ba884 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e8c27ba884");
...
var pkgs = [
    {'reference':'containernetworking-plugins-1.1.1-16.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
