...
# extracted from Red Hat Security Advisory RHSA-2022:7020. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7020");
  script_xref(name:"IAVA", value:"2022-A-0491-S");

  script_name(english:"RHEL 9 : firefox (RHSA-2022:7020)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7020.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c68760dd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2130769");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7020");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2022:7020.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-102.3.0-7.el9_0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'firefox-102.3.0-7.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
