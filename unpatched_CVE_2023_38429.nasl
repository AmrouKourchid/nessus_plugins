...
if (description)
{
  ...
  script_cve_id("CVE-2023-38429");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-38429 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-38429");
