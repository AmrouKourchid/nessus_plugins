...
# extracted from Red Hat Security Advisory RHSA-2024:7456. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:7456");

  script_name(english:"RHEL 8 : git-lfs (RHSA-2024:7456)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_7456.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4169662");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:7456");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL git-lfs package based on the guidance in RHSA-2024:7456.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-lfs-3.2.0-2.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
