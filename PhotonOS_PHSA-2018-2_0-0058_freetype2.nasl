...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'freetype2-2.7.1-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'freetype2-debuginfo-2.7.1-5.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'freetype2-devel-2.7.1-5.ph2')) flag++;
