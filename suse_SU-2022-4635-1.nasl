...
# SUSE update advisory SUSE-SU-2022:4635-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4635-1");

  script_name(english:"SUSE SLES15 Security Update : conmon (SUSE-SU-2022:4635-1)");
...
in the SUSE-SU-2022:4635-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-December/013379.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b049fb5b");
...
var pkgs = [
    {'reference':'conmon-2.1.5-150400.3.3.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'conmon-2.1.5-150400.3.3.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-containers-release-15.4', 'sles-release-15.4']}
];
