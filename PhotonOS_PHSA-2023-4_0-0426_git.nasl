...
if (description)
{
  ...
  script_cve_id("CVE-2020-27955");

  script_name(english:"Photon OS 4.0: Git PHSA-2023-4.0-0426");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-27955");

  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");
  script_set_attribute(attribute:"metasploit_name", value:'Git Remote Code Execution via git-lfs (CVE-2020-27955)');
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'git-lfs-3.2.0-1.ph4')) flag++;
