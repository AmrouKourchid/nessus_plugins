...
# extracted from Fedora Security Advisory FEDORA-2025-bd6664e83b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-bd6664e83b");
  script_xref(name:"IAVA", value:"2025-A-0146-S");

  script_name(english:"Fedora 41 : thunderbird (2025-bd6664e83b)");
...
FEDORA-2025-bd6664e83b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-bd6664e83b");
...
var pkgs = [
    {'reference':'thunderbird-128.8.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
