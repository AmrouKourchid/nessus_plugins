...
# extracted from Fedora Security Advisory FEDORA-2019-554c3c691f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-554c3c691f");

  script_name(english:"Fedora 31 : file (2019-554c3c691f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-554c3c691f");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"file-5.37-8.fc31")) flag++;
