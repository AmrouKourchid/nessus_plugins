...
# extracted from Fedora Security Advisory FEDORA-2023-e77628f240
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-e77628f240");

  script_name(english:"Fedora 37 : pesign (2023-e77628f240)");
...
FEDORA-2023-e77628f240 advisory.

    - New upstream release (116)
    - Fix CVE-2022-3560
      - This is a privilege escalation in the pesign-authorize script, which is now deprecated.  There is no
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-e77628f240");
...
"Update the affected pesign package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:pesign");
...
var pkgs = [
    {'reference':'pesign-116-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
