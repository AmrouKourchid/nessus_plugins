...
# Oracle Linux Security Advisory ELSA-2017-3071 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : ntp (ELSA-2017-3071)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 6 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2017-3071 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2017-3071.html");
...
var pkgs = [
    {'reference':'ntp-4.2.6p5-12.0.1.el6_9.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntp-doc-4.2.6p5-12.0.1.el6_9.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntp-perl-4.2.6p5-12.0.1.el6_9.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntpdate-4.2.6p5-12.0.1.el6_9.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntp-4.2.6p5-12.0.1.el6_9.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntp-doc-4.2.6p5-12.0.1.el6_9.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntp-perl-4.2.6p5-12.0.1.el6_9.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntpdate-4.2.6p5-12.0.1.el6_9.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
