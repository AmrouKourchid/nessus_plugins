...
if (description)
{
  ...
  script_name(english:"SUSE Enterprise Linux SEoL (12.4.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of SUSE Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, SUSE Enterprise Linux is 12.4.x. It is, therefore, no longer maintained by its vendor or
provider.
...
var constraints = [
  { max_branch : '12.4', min_branch : '12.4', seol : 20200630, eseol : 20230630 }
];
