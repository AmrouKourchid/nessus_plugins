...
# Rocky Linux Security Advisory RLSA-2025:0711.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2025:0711");

  script_name(english:"RockyLinux 8 : python-jinja2 (RLSA-2025:0711)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2025:0711");
