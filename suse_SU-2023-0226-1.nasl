...
# SUSE update advisory SUSE-SU-2023:0226-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0226-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 29 for SLE 12 SP4) (SUSE-SU-2023:0226-1)");
...
the SUSE-SU-2023:0226-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013615.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86ae83a9");
  script_set_attribute(attribute:"solution", value:
"Update the affected kgraft-patch-4_12_14-95_105-default package.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-95.105-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_105-default-6-2.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-95_105-default');
}
