...
# extracted from Fedora Security Advisory FEDORA-2022-2d5a6f48e1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-2d5a6f48e1");

  script_name(english:"Fedora 37 : pgadmin4 (2022-2d5a6f48e1)");
...
FEDORA-2022-2d5a6f48e1 advisory.

    Fix compatibility with newer python-azure-mgmt-rdbms.

    ----

    Update to pgadmin4-6.17, see https://www.pgadmin.org/docs/pgadmin4/development/release_notes_6_17.html for
    details.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-2d5a6f48e1");
...
"Update the affected pgadmin4 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-4223");
...
var pkgs = [
    {'reference':'pgadmin4-6.17-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
