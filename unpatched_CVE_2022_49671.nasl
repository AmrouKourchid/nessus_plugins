...
if (description)
{
  ...
  script_cve_id("CVE-2022-49671");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49671");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: RDMA/cm: Fix memory leak in
    ib_cm_insert_listen cm_alloc_id_priv() allocates resource for the cm_id_priv. When cm_init_listen() fails
    it doesn't free it, leading to memory leak. Add the missing error unwind. (CVE-2022-49671)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49671");
