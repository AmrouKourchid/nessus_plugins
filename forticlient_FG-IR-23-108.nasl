...
if (description)
{
  ...
  script_cve_id("CVE-2023-33304");
  script_xref(name:"IAVA", value:"2024-A-0260-S");

  script_name(english:"Fortinet FortiClient Hardcoded credentials in vcm2.exe (FG-IR-23-108)");
...
vulnerability as referenced in the FG-IR-23-108 advisory.

  - A use of hard-coded credentials vulnerability in Fortinet FortiClient Windows 7.0.0 - 7.0.9 and 7.2.0 -
    7.2.1 allows an attacker to bypass system protections via the use of static credentials. (CVE-2023-33304)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-23-108");
...
"Upgrade to FortiClient version 7.0.10 / 7.2.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-33304");
