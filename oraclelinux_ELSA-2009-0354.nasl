...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : evolution-data-server (ELSA-2009-0354)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0354.html");
...
"Update the affected evolution-data-server, evolution-data-server-devel and / or evolution-data-server-doc packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2009-0582");
...
var pkgs = [
    {'reference':'evolution-data-server-1.12.3-10.el5_3.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'evolution-data-server-devel-1.12.3-10.el5_3.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'evolution-data-server-doc-1.12.3-10.el5_3.3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'evolution-data-server-1.12.3-10.el5_3.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'evolution-data-server-devel-1.12.3-10.el5_3.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'evolution-data-server-doc-1.12.3-10.el5_3.3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'evolution-data-server / evolution-data-server-devel / evolution-data-server-doc');
}
