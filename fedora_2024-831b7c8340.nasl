...
# extracted from Fedora Security Advisory FEDORA-2024-831b7c8340
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-831b7c8340");

  script_name(english:"Fedora 38 : mingw-python-idna (2024-831b7c8340)");
...
FEDORA-2024-831b7c8340 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-831b7c8340");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-python-idna package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mingw-python-idna");
...
var pkgs = [
    {'reference':'mingw-python-idna-3.7-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mingw-python-idna');
}
