...
# extracted from Fedora Security Advisory FEDORA-2020-ccd9bdb2eb.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : 2:samba / libldb (2020-ccd9bdb2eb)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-ccd9bdb2eb");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"samba-4.12.5-0.fc32", epoch:"2")) flag++;
if (rpm_check(release:"FC32", reference:"libldb-2.1.4-1.fc32")) flag++;
