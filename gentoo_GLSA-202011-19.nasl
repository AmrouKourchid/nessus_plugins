...
# extracted from Gentoo Linux Security Advisory GLSA 202011-19.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202011-19");

  script_name(english:"GLSA-202011-19 : libexif: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202011-19
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202011-19");
...
if (qpkg_check(package:"media-libs/libexif", unaffected:make_list("ge 0.6.22_p20201105"), vulnerable:make_list("lt 0.6.22_p20201105"))) flag++;
