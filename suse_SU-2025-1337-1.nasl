...
# SUSE update advisory SUSE-SU-2025:1337-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:1337-1");
  script_xref(name:"IAVB", value:"2025-B-0058");

  script_name(english:"SUSE SLES12 Security Update : apache2-mod_auth_openidc (SUSE-SU-2025:1337-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2025-April/039057.html");
...
var pkgs = [
    {'reference':'apache2-mod_auth_openidc-2.4.0-7.15.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-extended-security-release-12.5']},
    {'reference':'apache2-mod_auth_openidc-2.4.0-7.15.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
