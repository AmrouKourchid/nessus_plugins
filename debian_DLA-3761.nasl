...
# extracted from Debian Security Advisory dla-3761. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3761 : spip - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3761
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-52322");
...
"Upgrade the spip packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-52322");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'spip', 'reference': '3.2.4-1+deb10u13'}
];
