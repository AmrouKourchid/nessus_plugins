...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.3.0 : elfutils (EulerOS-SA-2019-2313)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2313
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5107b40c");
...
pkgs = ["elfutils-0.174-1.h1.eulerosv2r8",
        "elfutils-default-yama-scope-0.174-1.h1.eulerosv2r8",
        "elfutils-libelf-0.174-1.h1.eulerosv2r8",
        "elfutils-libs-0.174-1.h1.eulerosv2r8"];
