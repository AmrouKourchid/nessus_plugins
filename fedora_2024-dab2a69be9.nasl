...
# extracted from Fedora Security Advisory FEDORA-2024-dab2a69be9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-dab2a69be9");

  script_name(english:"Fedora 39 : python3.11 (2024-dab2a69be9)");
...
FEDORA-2024-dab2a69be9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-dab2a69be9");
...
var pkgs = [
    {'reference':'python3.11-3.11.9-6.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
