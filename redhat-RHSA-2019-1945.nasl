...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1945.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?21c58735");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1945");
...
"Update the RHEL keepalived package based on the guidance in RHSA-2019:1945.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'keepalived-1.3.5-1.el7_4.1', 'sp':'4', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keepalived-1.3.5-1.el7_4.1', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
