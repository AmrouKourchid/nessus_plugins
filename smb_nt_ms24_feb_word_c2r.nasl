...
if (description)
{
  ...
  script_cve_id("CVE-2024-21379");
  script_xref(name:"IAVA", value:"2024-A-0094-S");
  script_xref(name:"IAVA", value:"2024-A-0097-S");

  script_name(english:"Security Updates for Microsoft Word Products C2R (February 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Word Products are missing a security update.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Word application installed on the remote host is missing a security update. It is, therefore,
...
manually perform an update.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21379");
