...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : python-urllib3 (EulerOS-SA-2024-1390)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1390
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38003e60");
...
var pkgs = [
  "python3-urllib3-1.25.9-1.h9.eulerosv2r10"
];
