...
# extracted from Fedora Security Advisory FEDORA-2024-584e1133e4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-584e1133e4");

  script_name(english:"Fedora 40 : seamonkey (2024-584e1133e4)");
...
FEDORA-2024-584e1133e4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-584e1133e4");
...
var pkgs = [
    {'reference':'seamonkey-2.53.19-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
