...
# extracted from Red Hat Security Advisory RHSA-2022:6985. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6985");

  script_name(english:"RHEL 8 : nodejs:14 (RHSA-2022:6985)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for nodejs:14.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:6985 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6985.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d53536e3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6985");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2106368");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nodejs:14 package based on the guidance in RHSA-2022:6985.");
  ...
  'nodejs:14': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-14.20.0-2.module+el8.4.0+16234+70f4adc8', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-14.20.0-2.module+el8.4.0+16234+70f4adc8', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-14.20.0-2.module+el8.4.0+16234+70f4adc8', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-14.20.0-2.module+el8.4.0+16234+70f4adc8', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-nodemon-2.0.19-2.module+el8.4.0+16234+70f4adc8', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'nodejs-packaging-23-3.module+el8.3.0+6519+9f98ed83', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
        {'reference':'npm-6.14.17-1.14.20.0.2.module+el8.4.0+16234+70f4adc8', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
