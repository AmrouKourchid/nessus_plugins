...
# extracted from Gentoo Linux Security Advisory GLSA 202105-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-09");

  script_name(english:"GLSA-202105-09 : BusyBox: Denial of service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-09
...
if (qpkg_check(package:"sys-apps/busybox", unaffected:make_list("ge 1.32.1"), vulnerable:make_list("lt 1.32.1"))) flag++;
