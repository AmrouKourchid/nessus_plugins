...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : dovecot (EulerOS-SA-2020-2340)");
...
vulnerabilities :
  ...
  - In Dovecot before 2.3.11.3, sending a specially
    formatted NTLM request will crash the auth service
    because of an out-of-bounds read.(CVE-2020-12673)

  - In Dovecot before 2.3.11.3, sending a specially
    formatted RPA request will crash the auth service
    because a length of zero is mishandled.(CVE-2020-12674)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2340
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0bb9d7a4");
...
pkgs = ["dovecot-2.2.10-5.h8",
        "dovecot-mysql-2.2.10-5.h8",
        "dovecot-pgsql-2.2.10-5.h8",
        "dovecot-pigeonhole-2.2.10-5.h8"];
