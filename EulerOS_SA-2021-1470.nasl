...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : exiv2 (EulerOS-SA-2021-1470)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the exiv2 package installed, the EulerOS
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1470
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc39d5a6");
...
pkgs = ["exiv2-libs-0.26-3.h12.eulerosv2r7"];
