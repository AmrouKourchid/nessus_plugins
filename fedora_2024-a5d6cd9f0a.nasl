...
# extracted from Fedora Security Advisory FEDORA-2024-a5d6cd9f0a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a5d6cd9f0a");

  script_name(english:"Fedora 41 : unbound (2024-a5d6cd9f0a)");
...
FEDORA-2024-a5d6cd9f0a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a5d6cd9f0a");
...
var pkgs = [
    {'reference':'unbound-1.21.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
