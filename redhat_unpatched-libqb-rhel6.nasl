...
# extracted from Red Hat Security Advisory libqb. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-12779", "CVE-2023-39976");

  script_name(english:"RHEL 6 : libqb (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-39976");
