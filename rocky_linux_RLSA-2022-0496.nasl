...
# Rocky Linux Security Advisory RLSA-2022:0496.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2022:0496");

  script_name(english:"Rocky Linux 8 : .NET 6.0 (RLSA-2022:0496)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2022:0496 advisory.

  - .NET Denial of Service Vulnerability (CVE-2022-21986)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2022:0496");
