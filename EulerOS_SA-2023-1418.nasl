...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : sysstat (EulerOS-SA-2023-1418)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1418
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?81945f8a");
...
var pkgs = [
  "sysstat-12.5.4-1.h4.eulerosv2r11"
];
