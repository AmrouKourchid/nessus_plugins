...
# extracted from Debian Security Advisory dla-3148. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3148 : mediawiki - security update");
...
dla-3148 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3148-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Markus Koschany
    October 12, 2022                              https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : mediawiki
    Version        : 1:1.31.16-1+deb10u4
    CVE ID         : CVE-2022-41765 CVE-2022-41767
...
var pkgs = [
    {'release': '10.0', 'prefix': 'mediawiki', 'reference': '1:1.31.16-1+deb10u4'},
    {'release': '10.0', 'prefix': 'mediawiki-classes', 'reference': '1:1.31.16-1+deb10u4'}
];
