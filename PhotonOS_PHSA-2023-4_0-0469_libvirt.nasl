...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libvirt PHSA-2023-4.0-0469");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libvirt-7.10.0-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libvirt-devel-7.10.0-6.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libvirt-docs-7.10.0-6.ph4')) flag++;
