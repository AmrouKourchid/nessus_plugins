...
# extracted from Fedora Security Advisory FEDORA-2023-f25098f499
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f25098f499");

  script_name(english:"Fedora 38 : netconsd (2023-f25098f499)");
...
FEDORA-2023-f25098f499 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f25098f499");
...
var pkgs = [
    {'reference':'netconsd-0.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
