...
# extracted from Fedora Security Advisory FEDORA-2024-bd8c6c6926
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-bd8c6c6926");

  script_name(english:"Fedora 39 : squid (2024-bd8c6c6926)");
...
FEDORA-2024-bd8c6c6926 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-bd8c6c6926");
...
var pkgs = [
    {'reference':'squid-6.9-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
