...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : harfbuzz (EulerOS-SA-2022-2290)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2290
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc11ce03");
...
var pkgs = [
  "harfbuzz-2.6.1-2.h3.eulerosv2r9",
  "harfbuzz-devel-2.6.1-2.h3.eulerosv2r9",
  "harfbuzz-help-2.6.1-2.h3.eulerosv2r9"
];
