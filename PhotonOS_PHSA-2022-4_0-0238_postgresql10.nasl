...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Postgresql10 PHSA-2022-4.0-0238");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'postgresql10-10.22-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'postgresql10-devel-10.22-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'postgresql10-libs-10.22-1.ph4')) flag++;
