...
# extracted from Fedora Security Advisory FEDORA-2023-dfd4a6e8f2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dfd4a6e8f2");

  script_name(english:"Fedora 37 : kernel (2023-dfd4a6e8f2)");
...
FEDORA-2023-dfd4a6e8f2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dfd4a6e8f2");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2023-2124', 'CVE-2023-2269');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-dfd4a6e8f2');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.2.15-200.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
