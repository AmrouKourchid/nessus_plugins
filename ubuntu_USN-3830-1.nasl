...
in the USN-3830-1 advisory.

    USN-3804-1 fixed vulnerabilities in OpenJDK. Unfortunately, that update introduced a regression when
    validating JAR files that prevented Java applications from finding classes in some situations. This update
    fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3830-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'openjdk-8-demo', 'pkgver': '8u191-b12-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk', 'pkgver': '8u191-b12-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk-headless', 'pkgver': '8u191-b12-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre', 'pkgver': '8u191-b12-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-headless', 'pkgver': '8u191-b12-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-jamvm', 'pkgver': '8u191-b12-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-zero', 'pkgver': '8u191-b12-0ubuntu0.16.04.1'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-source', 'pkgver': '8u191-b12-0ubuntu0.16.04.1'},
    {'osver': '18.04', 'pkgname': 'openjdk-11-demo', 'pkgver': '10.0.2+13-1ubuntu0.18.04.4'},
    {'osver': '18.04', 'pkgname': 'openjdk-11-jdk', 'pkgver': '10.0.2+13-1ubuntu0.18.04.4'},
    {'osver': '18.04', 'pkgname': 'openjdk-11-jdk-headless', 'pkgver': '10.0.2+13-1ubuntu0.18.04.4'},
    {'osver': '18.04', 'pkgname': 'openjdk-11-jre', 'pkgver': '10.0.2+13-1ubuntu0.18.04.4'},
    {'osver': '18.04', 'pkgname': 'openjdk-11-jre-headless', 'pkgver': '10.0.2+13-1ubuntu0.18.04.4'},
    {'osver': '18.04', 'pkgname': 'openjdk-11-jre-zero', 'pkgver': '10.0.2+13-1ubuntu0.18.04.4'},
    {'osver': '18.04', 'pkgname': 'openjdk-11-source', 'pkgver': '10.0.2+13-1ubuntu0.18.04.4'}
];
