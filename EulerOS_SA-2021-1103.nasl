...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openldap (EulerOS-SA-2021-1103)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1103
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a012e194");
...
pkgs = ["openldap-2.4.44-5.h8",
        "openldap-clients-2.4.44-5.h8",
        "openldap-devel-2.4.44-5.h8",
        "openldap-servers-2.4.44-5.h8"];
