...
# extracted from Red Hat Security Advisory RHSA-2024:6661. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6661");

  script_name(english:"RHEL 7 : python3-setuptools (RHSA-2024:6661)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python3-setuptools.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6661.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2612c35f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2297771");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6661");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3-setuptools package based on the guidance in RHSA-2024:6661.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-setuptools-39.2.0-10.el7_9.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-setuptools');
}
