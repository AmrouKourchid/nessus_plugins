...
# extracted from Fedora Security Advisory FEDORA-2024-5d080305ab
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5d080305ab");
  script_xref(name:"IAVA", value:"2024-A-0174-S");

  script_name(english:"Fedora 38 : thunderbird (2024-5d080305ab)");
...
FEDORA-2024-5d080305ab advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5d080305ab");
...
var pkgs = [
    {'reference':'thunderbird-115.9.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
