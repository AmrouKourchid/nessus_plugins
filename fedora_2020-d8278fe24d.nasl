...
# extracted from Fedora Security Advisory FEDORA-2020-d8278fe24d.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2019-20509", "CVE-2020-9308");
  script_xref(name:"FEDORA", value:"2020-d8278fe24d");

  script_name(english:"Fedora 31 : libarchive (2020-d8278fe24d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-d8278fe24d");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"libarchive-3.4.3-1.fc31")) flag++;
