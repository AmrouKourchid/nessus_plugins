...
# extracted from Fedora Security Advisory FEDORA-2022-c8c2e402fb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c8c2e402fb");

  script_name(english:"Fedora 37 : expat (2022-c8c2e402fb)");
...
FEDORA-2022-c8c2e402fb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c8c2e402fb");
...
var pkgs = [
    {'reference':'expat-2.5.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
