...
# extracted from VMware Security Advisory PHSA-2024-4.0-0594. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Glibc PHSA-2024-4.0-0594");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the glibc package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-594.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'glibc-2.32-17.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'glibc-devel-2.32-17.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'glibc-i18n-2.32-17.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'glibc-iconv-2.32-17.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'glibc-lang-2.32-17.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'glibc-nscd-2.32-17.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'glibc-tools-2.32-17.ph4')) flag++;
