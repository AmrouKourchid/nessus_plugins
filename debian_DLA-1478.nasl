...
# extracted from Debian Security Advisory DLA-1478-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1478-1 : libextractor security update");
...
a library to obtain metadata from files of arbitrary type.
  ...
  - A stack-based buffer overflow in unzip.c.
    (CVE-2018-14346)

  - An infinite loop vulnerability in mpeg_extractor.c.
    (CVE-2018-14347)
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/08/msg00025.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/libextractor");
...
"Upgrade the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-14346");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"extract", reference:"1:1.3-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libextractor-dbg", reference:"1:1.3-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libextractor-dev", reference:"1:1.3-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libextractor3", reference:"1:1.3-2+deb8u2")) flag++;
