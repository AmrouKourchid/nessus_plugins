...
# extracted from Fedora Security Advisory FEDORA-2024-56fb9c0762
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-56fb9c0762");

  script_name(english:"Fedora 40 : dotnet8.0 (2024-56fb9c0762)");
...
FEDORA-2024-56fb9c0762 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-56fb9c0762");
...
var pkgs = [
    {'reference':'dotnet8.0-8.0.105-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
