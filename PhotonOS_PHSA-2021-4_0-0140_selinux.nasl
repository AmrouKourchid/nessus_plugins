...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Selinux PHSA-2021-4.0-0140");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the selinux package has been released.");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:selinux");
...
if (rpm_check(release:'PhotonOS-4.0', reference:'selinux-policy-3.14.8-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', reference:'selinux-policy-devel-3.14.8-1.ph4')) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'selinux');
}
