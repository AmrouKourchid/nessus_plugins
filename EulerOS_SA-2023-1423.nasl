...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : httpd (EulerOS-SA-2023-1423)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1423
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05bd73d6");
...
var pkgs = [
  "httpd-2.4.51-5.h11.eulerosv2r11",
  "httpd-filesystem-2.4.51-5.h11.eulerosv2r11",
  "httpd-tools-2.4.51-5.h11.eulerosv2r11",
  "mod_ssl-2.4.51-5.h11.eulerosv2r11"
];
