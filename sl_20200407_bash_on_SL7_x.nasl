...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : bash on SL7.x x86_64 (20200407)");
...
"* bash: BASH_CMD is writable in restricted bash shells");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2004&L=SCIENTIFIC-LINUX-ERRATA&P=17378
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f3a5b39b");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"bash-4.2.46-34.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"bash-debuginfo-4.2.46-34.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"bash-doc-4.2.46-34.el7")) flag++;
