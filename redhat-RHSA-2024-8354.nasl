...
# extracted from Red Hat Security Advisory RHSA-2024:8354. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8354");

  script_name(english:"RHEL 8 : NetworkManager-libreswan (RHSA-2024:8354)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8354.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd5d9fc4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8354");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL NetworkManager-libreswan package based on the guidance in RHSA-2024:8354.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'NetworkManager-libreswan-1.2.10-6.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'NetworkManager-libreswan-gnome-1.2.10-6.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
