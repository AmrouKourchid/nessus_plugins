...
referenced in the RHSA-2005:271 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_271.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5df17c60");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=150098");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=150103");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:271");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL HelixPlayer package based on the guidance in RHSA-2005:271.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-0611");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2005-0455");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'HelixPlayer-1.0.3-1', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'HelixPlayer-1.0.3-1', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
