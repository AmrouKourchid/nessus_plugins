...
# extracted from Fedora Security Advisory FEDORA-2023-a74513bda8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a74513bda8");

  script_name(english:"Fedora 38 : python-django3 (2023-a74513bda8)");
...
FEDORA-2023-a74513bda8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a74513bda8");
...
var pkgs = [
    {'reference':'python-django3-3.2.18-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
