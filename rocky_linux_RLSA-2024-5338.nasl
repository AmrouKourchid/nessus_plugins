...
# Rocky Linux Security Advisory RLSA-2024:5338.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:5338");

  script_name(english:"RockyLinux 8 : pcs (RLSA-2024:5338)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:5338");
...
var pkgs = [
    {'reference':'pcs-0.10.18-2.el8_10.1', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'pcs-0.10.18-2.el8_10.1', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'pcs-snmp-0.10.18-2.el8_10.1', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'pcs-snmp-0.10.18-2.el8_10.1', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
