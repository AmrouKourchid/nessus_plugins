...
# extracted from Ubuntu Security Notice USN-5900-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5900-2");

  script_name(english:"Ubuntu 23.04 : tar vulnerability (USN-5900-2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 23.04 host has packages installed that are affected by a vulnerability as referenced in the USN-5900-2
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5900-2");
...
var pkgs = [
    {'osver': '23.04', 'pkgname': 'tar', 'pkgver': '1.34+dfsg-1.2ubuntu0.1'},
    {'osver': '23.04', 'pkgname': 'tar-scripts', 'pkgver': '1.34+dfsg-1.2ubuntu0.1'}
];
