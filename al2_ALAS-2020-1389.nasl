...
# extracted from Amazon Linux 2 Security Advisory ALAS-2020-1389.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : python-pip (ALAS-2020-1389)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2-2020-1389 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1389.html");
...
var pkgs = [
    {'reference':'python2-pip-9.0.3-1.amzn2.0.2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-pip-9.0.3-1.amzn2.0.2', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
