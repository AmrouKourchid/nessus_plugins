...
# extracted from Fedora Security Advisory FEDORA-2023-fa739b5753
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fa739b5753");

  script_name(english:"Fedora 36 : chromium (2023-fa739b5753)");
...
FEDORA-2023-fa739b5753 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fa739b5753");
...
var pkgs = [
    {'reference':'chromium-112.0.5615.165-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
