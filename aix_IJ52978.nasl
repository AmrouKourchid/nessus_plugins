...
if (description)
{
  ...
  script_name(english:"AIX : Multiple Vulnerabilities (IJ52978)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ52978. It is, therefore, affected by multiple
vulnerabilities as referenced in the IJ52978 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ52978");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ52978.");
...
var constraints = [
    {'release': '7.3', 'ml': '01', 'sp': '02', 'patch': 'IJ52978m4a', 'package': 'bos.net.tcp.client_core', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.5'},
    {'release': '7.3', 'ml': '01', 'sp': '02', 'patch': 'IJ52978m4a', 'package': 'bos.perf.perfstat', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.1'},
    {'release': '7.3', 'ml': '01', 'sp': '03', 'patch': 'IJ52978m4a', 'package': 'bos.net.tcp.client_core', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.5'},
    {'release': '7.3', 'ml': '01', 'sp': '03', 'patch': 'IJ52978m4a', 'package': 'bos.perf.perfstat', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.1'},
    {'release': '7.3', 'ml': '01', 'sp': '04', 'patch': 'IJ52978m4a', 'package': 'bos.net.tcp.client_core', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.5'},
    {'release': '7.3', 'ml': '01', 'sp': '04', 'patch': 'IJ52978m4a', 'package': 'bos.perf.perfstat', 'minfilesetver': '7.3.1.0', 'maxfilesetver': '7.3.1.1'}
];
