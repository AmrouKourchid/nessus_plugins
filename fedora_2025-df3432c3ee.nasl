...
# extracted from Fedora Security Advisory FEDORA-2025-df3432c3ee
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-df3432c3ee");

  script_name(english:"Fedora 40 : buku (2025-df3432c3ee)");
...
FEDORA-2025-df3432c3ee advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-df3432c3ee");
...
var pkgs = [
    {'reference':'buku-4.9-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
