...
# extracted from Oracle Linux Security Advisory ELSA-2023-7876.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : opensc (ELSA-2023-7876)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-7876.html");
...
var pkgs = [
    {'reference':'opensc-0.20.0-7.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'opensc-0.20.0-7.el8_9', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'opensc-0.20.0-7.el8_9', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
