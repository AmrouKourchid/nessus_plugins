...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : unbound (EulerOS-SA-2020-1618)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1618
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b505fa73");
...
pkgs = ["unbound-1.6.6-1.h2.eulerosv2r7",
        "unbound-libs-1.6.6-1.h2.eulerosv2r7"];
