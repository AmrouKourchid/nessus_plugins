...
if (description)
{
  ...
  script_name(english:"CentOS 9 : libwebp-1.2.0-8.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for libwebp.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
libwebp-1.2.0-8.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=37257");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream libwebp package.");
...
var pkgs = [
    {'reference':'libwebp-1.2.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libwebp-devel-1.2.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libwebp-java-1.2.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libwebp-tools-1.2.0-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
