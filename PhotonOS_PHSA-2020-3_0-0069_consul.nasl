...
if (description)
{
  ...
  script_cve_id("CVE-2020-7219", "CVE-2020-7955");

  script_name(english:"Photon OS 3.0: Consul PHSA-2020-3.0-0069");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the consul package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-69.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-7955");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'consul-1.7.1-1.ph3')) flag++;
