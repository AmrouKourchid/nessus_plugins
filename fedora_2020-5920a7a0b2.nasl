...
# extracted from Fedora Security Advisory FEDORA-2020-5920a7a0b2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : kernel (2020-5920a7a0b2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-5920a7a0b2");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2020-5920a7a0b2");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC31", reference:"kernel-5.8.9-101.fc31")) flag++;
