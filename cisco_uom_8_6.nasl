...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2011-A-0132-S");
...
vulnerabilities :
  ...
  # https://www.cisco.com/en/US/products/products_security_advisory09186a0080b9351e.shtml
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73d9c279");
