...
# extracted from Ubuntu Security Notice USN-7431-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7431-1");

  script_name(english:"Ubuntu 22.04 LTS / 24.04 LTS / 24.10 : HAProxy vulnerability (USN-7431-1)");
...
referenced in the USN-7431-1 advisory.

    Aleandro Prudenzano and Edoardo Geraci discovered that HAProxy incorrectly handled certain uncommon
    configurations that replace multiple short patterns with a longer one. A remote attacker could use this
    issue to cause HAProxy to crash, resulting in a denial of service, or possibly execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7431-1");
...
"Update the affected haproxy and / or vim-haproxy packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-32464");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'haproxy', 'pkgver': '2.4.24-0ubuntu0.22.04.2'},
    {'osver': '22.04', 'pkgname': 'vim-haproxy', 'pkgver': '2.4.24-0ubuntu0.22.04.2'},
    {'osver': '24.04', 'pkgname': 'haproxy', 'pkgver': '2.8.5-1ubuntu3.3'},
    {'osver': '24.04', 'pkgname': 'vim-haproxy', 'pkgver': '2.8.5-1ubuntu3.3'},
    {'osver': '24.10', 'pkgname': 'haproxy', 'pkgver': '2.9.10-1ubuntu1.2'},
    {'osver': '24.10', 'pkgname': 'vim-haproxy', 'pkgver': '2.9.10-1ubuntu1.2'}
];
