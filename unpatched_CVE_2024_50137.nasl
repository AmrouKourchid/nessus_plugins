...
if (description)
{
  ...
  script_cve_id("CVE-2024-50137");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-50137");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: reset: starfive: jh71x0: Fix accessing
    the empty member on JH7110 SoC data->asserted will be NULL on JH7110 SoC since commit 82327b127d41
    (reset: starfive: Add StarFive JH7110 reset driver) was added. Add the judgment condition to avoid
    errors when calling reset_control_status on JH7110 SoC. (CVE-2024-50137)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-50137");
