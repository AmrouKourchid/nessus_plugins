...
# extracted from Fedora Security Advisory FEDORA-2023-3fd7349f60
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3fd7349f60");

  script_name(english:"Fedora 36 : kernel / kernel-headers / kernel-tools (2023-3fd7349f60)");
...
FEDORA-2023-3fd7349f60 advisory.

    The 6.1.5 stable kernel rebase contains new features, enhanced hardware support, and a number of important
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3fd7349f60");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2022-2196', 'CVE-2022-4379');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-3fd7349f60');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.1.5-100.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-headers-6.1.5-100.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-tools-6.1.5-100.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
