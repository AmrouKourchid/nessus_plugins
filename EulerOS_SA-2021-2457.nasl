...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : curl (EulerOS-SA-2021-2457)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2457
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?44ed623e");
...
var pkgs = [
  "curl-7.61.1-2.h15.eulerosv2r8",
  "libcurl-7.61.1-2.h15.eulerosv2r8",
  "libcurl-devel-7.61.1-2.h15.eulerosv2r8"
];
