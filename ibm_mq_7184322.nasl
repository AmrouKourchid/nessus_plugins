...
if (description)
{
  ...
  script_cve_id("CVE-2024-54175");
  script_xref(name:"IAVA", value:"2025-A-0144");

  script_name(english:"IBM MQ DoS (7184322)");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of IBM MQ Server running on the remote host is affected by a vulnerability as referenced in the 7184322
advisory.

  - IBM MQ 9.3 LTS, 9.3 CD, 9.4 LTS, and 9.4 CD could allow a local user to cause a denial of service due to 
    an improper check for unusual or exceptional conditions. (CVE-2024-54175)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7184322");
  script_set_attribute(attribute:"solution", value:
"Upgrade to IBM MQ 9.2.0.31 LTS, 9.3.0.27 LTS, 9.4.0.10 LTS, 9.4.2 CD or later.");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:S/C:N/I:N/A:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-54175");
