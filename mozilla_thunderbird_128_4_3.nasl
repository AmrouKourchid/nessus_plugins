...
"The version of Thunderbird installed on the remote Windows host is prior to 128.4.3. It is, therefore, affected by a
vulnerability as referenced in the mfsa2024-61 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'128.4.3', severity:SECURITY_WARNING);
