...
# extracted from Fedora Security Advisory FEDORA-2024-92bac3b909
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-92bac3b909");

  script_name(english:"Fedora 39 : libgit2 (2024-92bac3b909)");
...
FEDORA-2024-92bac3b909 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-92bac3b909");
...
var pkgs = [
    {'reference':'libgit2-1.7.2-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
