...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : xerces-c (EulerOS-SA-2020-1640)");
...
vulnerability :
  ...
  - The Apache Xerces-C 3.0.0 to 3.2.2 XML parser contains
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1640
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d3bdd971");
