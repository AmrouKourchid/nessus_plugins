...
# extracted from Red Hat Security Advisory RHSA-2024:1688. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1688");

  script_name(english:"RHEL 9 : nodejs:20 (RHSA-2024:1688)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for nodejs:20.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:1688 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1688.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b21120c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1688");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nodejs:20 package based on the guidance in RHSA-2024:1688.");
  ...
  script_cwe_id(22, 94, 208, 269, 400, 1059);
  ...
  'nodejs:20': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-20.11.1-1.module+el9.3.0+21385+bac43d5a', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-20.11.1-1.module+el9.3.0+21385+bac43d5a', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-20.11.1-1.module+el9.3.0+21385+bac43d5a', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-20.11.1-1.module+el9.3.0+21385+bac43d5a', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-10.2.4-1.20.11.1.1.module+el9.3.0+21385+bac43d5a', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
