...
# extracted from Red Hat Security Advisory RHSA-2025:2222. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:2222");

  script_name(english:"RHEL 8 : Red Hat Product OCP Tools 4.13 Openshift Jenkins (RHSA-2025:2222)");
...
referenced in the RHSA-2025:2222 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_2222.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e5f2e4f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:2222");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Product OCP Tools 4.13 Openshift Jenkins package based on the guidance in RHSA-2025:2222.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.13.1740464698-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jenkins-2.479.3.1740464433-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
