...
if (description)
{
  ...
  script_name(english:"RHEL 8 : OpenShift Container Platform 4.10.52 (RHSA-2023:0697)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.10.52.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:0697 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.10.52. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0697.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?35082652");
...
"Update the RHEL OpenShift Container Platform 4.10.52 package based on the guidance in RHSA-2023:0697.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.10.1675407676-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-1471']},
      {'reference':'jenkins-2.361.1.1675406172-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-34174']}
    ]
  }
];
