...
var kernel_mappings = {
  '18.04': {
    '5.4.0': {
      'generic': '5.4.0-110',
      'generic-lpae': '5.4.0-110',
      'lowlatency': '5.4.0-110',
      'ibm': '5.4.0-1021',
      'gkeop': '5.4.0-1040',
      'raspi': '5.4.0-1060',
      'oracle': '5.4.0-1071',
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5415-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2020-27820', 'CVE-2021-26401', 'CVE-2022-1016', 'CVE-2022-20008', 'CVE-2022-25258', 'CVE-2022-25375', 'CVE-2022-26490', 'CVE-2022-27223');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-5415-1');
  }
  else
  {
