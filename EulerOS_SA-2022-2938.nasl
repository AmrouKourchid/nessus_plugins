...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : net-snmp (EulerOS-SA-2022-2938)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2938
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a16a2759");
...
var pkgs = [
  "net-snmp-5.9-3.h6.eulerosv2r10",
  "net-snmp-libs-5.9-3.h6.eulerosv2r10",
  "python3-net-snmp-5.9-3.h6.eulerosv2r10"
];
