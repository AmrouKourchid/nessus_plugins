...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : libxml2 (EulerOS-SA-2024-1718)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1718
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?21289217");
...
var pkgs = [
  "libxml2-2.9.12-5.h27.eulerosv2r11",
  "python3-libxml2-2.9.12-5.h27.eulerosv2r11"
];
