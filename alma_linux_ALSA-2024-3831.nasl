...
# AlmaLinux Security Advisory ALSA-2024:3831.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:3831");
  script_xref(name:"IAVB", value:"2024-B-0020-S");

  script_name(english:"AlmaLinux 9 : containernetworking-plugins (ALSA-2024:3831)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-3831.html");
...
var pkgs = [
    {'reference':'containernetworking-plugins-1.4.0-3.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'containernetworking-plugins-1.4.0-3.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
