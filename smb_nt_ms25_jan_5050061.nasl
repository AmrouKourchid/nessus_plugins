...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5050061");
  script_xref(name:"MSKB", value:"5050063");
  script_xref(name:"MSFT", value:"MS25-5050061");
  script_xref(name:"MSFT", value:"MS25-5050063");
  script_xref(name:"IAVA", value:"2025-A-0034-S");
  script_xref(name:"IAVA", value:"2025-A-0033-S");

  script_name(english:"KB5050061: Windows Server 2008 Security Update (January 2025)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5050061");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5050063");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5050061 or Cumulative Update 5050063");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'01_2025',
                   bulletin:bulletin,
                   rollup_kb_list:[5050063, 5050061])
)
{
