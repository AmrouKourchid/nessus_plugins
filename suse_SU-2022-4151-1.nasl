...
# SUSE update advisory SUSE-SU-2022:4151-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4151-1");

  script_name(english:"SUSE SLES15 Security Update : cni-plugins (SUSE-SU-2022:4151-1)");
...
referenced in the SUSE-SU-2022:4151-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1172410");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-November/013051.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e5e9f609");
...
var pkgs = [
    {'reference':'cni-plugins-0.8.6-150000.1.7.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15']},
    {'reference':'cni-plugins-0.8.6-150000.1.7.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15', 'sle-module-public-cloud-release-15', 'sles-release-15']}
];
