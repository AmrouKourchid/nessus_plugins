...
# extracted from Fedora Security Advisory FEDORA-2025-16778d3c88
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-16778d3c88");

  script_name(english:"Fedora 40 : dotnet8.0 (2025-16778d3c88)");
...
FEDORA-2025-16778d3c88 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-16778d3c88");
...
var pkgs = [
    {'reference':'dotnet8.0-8.0.112-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
