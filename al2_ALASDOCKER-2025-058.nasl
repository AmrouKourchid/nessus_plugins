...
# extracted from Amazon Linux 2 Security Advisory ALASDOCKER-2025-058.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : docker (ALASDOCKER-2025-058)");
...
as referenced in the ALAS2DOCKER-2025-058 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASDOCKER-2025-058.html");
