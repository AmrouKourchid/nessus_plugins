...
# extracted from Fedora Security Advisory FEDORA-2023-f4954af225
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f4954af225");

  script_name(english:"Fedora 37 : chromium (2023-f4954af225)");
...
FEDORA-2023-f4954af225 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f4954af225");
...
var pkgs = [
    {'reference':'chromium-114.0.5735.106-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
