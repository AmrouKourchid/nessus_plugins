...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : mutt (EulerOS-SA-2021-1690)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1690
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0f9d22ff");
...
pkgs = ["mutt-1.5.21-28.h5.eulerosv2r7"];
