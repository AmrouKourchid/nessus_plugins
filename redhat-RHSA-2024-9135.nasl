...
# extracted from Red Hat Security Advisory RHSA-2024:9135. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9135");

  script_name(english:"RHEL 9 : toolbox (RHSA-2024:9135)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for toolbox.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:9135 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9135.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1abb0dec");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9135");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL toolbox package based on the guidance in RHSA-2024:9135.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'toolbox-0.0.99.5-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'toolbox-tests-0.0.99.5-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
