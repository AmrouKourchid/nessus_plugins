...
# extracted from Fedora Security Advisory FEDORA-2023-6b4d3ca766
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6b4d3ca766");

  script_name(english:"Fedora 38 : netconsd (2023-6b4d3ca766)");
...
FEDORA-2023-6b4d3ca766 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6b4d3ca766");
...
var pkgs = [
    {'reference':'netconsd-0.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
