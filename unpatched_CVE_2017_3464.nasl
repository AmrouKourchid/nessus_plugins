...
if (description)
{
  ...
  script_cve_id("CVE-2017-3464");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-3464");
...
patch available.
  ...
  - Vulnerability in the MySQL Server component of Oracle MySQL (subcomponent: Server: DDL). Supported
    ...
    insert or delete access to some of MySQL Server accessible data. (CVE-2017-3464)
