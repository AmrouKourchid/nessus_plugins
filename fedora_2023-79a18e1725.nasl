...
# extracted from Fedora Security Advisory FEDORA-2023-79a18e1725
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-79a18e1725");
  script_xref(name:"IAVA", value:"2023-A-0377-S");

  script_name(english:"Fedora 37 : openssh (2023-79a18e1725)");
...
FEDORA-2023-79a18e1725 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-79a18e1725");
...
var pkgs = [
    {'reference':'openssh-8.8p1-11.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
