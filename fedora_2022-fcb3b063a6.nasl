...
# extracted from Fedora Security Advisory FEDORA-2022-fcb3b063a6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-fcb3b063a6");
  script_xref(name:"IAVB", value:"2022-B-0033-S");

  script_name(english:"Fedora 37 : poppler (2022-fcb3b063a6)");
...
FEDORA-2022-fcb3b063a6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-fcb3b063a6");
...
var pkgs = [
    {'reference':'poppler-22.08.0-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
