...
if (description)
{
  ...
  script_cve_id("CVE-2018-6198");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2018-6198");
...
patch available.
  ...
  - w3m through 0.5.3 does not properly handle temporary files when the ~/.w3m directory is unwritable, which
    allows a local attacker to craft a symlink attack to overwrite arbitrary files. (CVE-2018-6198)
