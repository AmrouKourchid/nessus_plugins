...
# extracted from Debian Security Advisory dla-3919. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3919 : libapache-mod-jk-doc - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-3919
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-46544");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/libapache-mod-jk");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libapache-mod-jk-doc', 'reference': '1:1.2.48-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libapache2-mod-jk', 'reference': '1:1.2.48-1+deb11u2'}
];
