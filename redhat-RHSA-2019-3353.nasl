...
# extracted from Red Hat Security Advisory RHSA-2019:3353. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3353");

  script_name(english:"RHEL 8 : freeradius:3.0 (RHSA-2019:3353)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for freeradius:3.0.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:3353 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3353.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?90bc24d5");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.1_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8d3b26b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3353");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1685546");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1705340");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL freeradius:3.0 package based on the guidance in RHSA-2019:3353.");
  ...
  'freeradius:3.0': [
    {
      ...
      'pkgs': [
        {'reference':'freeradius-3.0.17-6.module+el8.1.0+3392+9bd8939b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-devel-3.0.17-6.module+el8.1.0+3392+9bd8939b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-doc-3.0.17-6.module+el8.1.0+3392+9bd8939b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-krb5-3.0.17-6.module+el8.1.0+3392+9bd8939b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-ldap-3.0.17-6.module+el8.1.0+3392+9bd8939b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-mysql-3.0.17-6.module+el8.1.0+3392+9bd8939b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-perl-3.0.17-6.module+el8.1.0+3392+9bd8939b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-postgresql-3.0.17-6.module+el8.1.0+3392+9bd8939b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-rest-3.0.17-6.module+el8.1.0+3392+9bd8939b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-sqlite-3.0.17-6.module+el8.1.0+3392+9bd8939b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-unixODBC-3.0.17-6.module+el8.1.0+3392+9bd8939b', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'freeradius-utils-3.0.17-6.module+el8.1.0+3392+9bd8939b', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
