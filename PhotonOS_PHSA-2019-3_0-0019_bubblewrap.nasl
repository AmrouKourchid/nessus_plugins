...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'bubblewrap-0.3.0-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'bubblewrap-debuginfo-0.3.0-2.ph3')) flag++;
