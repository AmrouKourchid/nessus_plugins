...
# extracted from Debian Security Advisory DLA-2634-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2634-1 : openjdk-8 security update");
...
runtime, resulting in bypass of sandbox restrictions.
...
For the detailed security status of openjdk-8 please refer to its
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/04/msg00021.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"openjdk-8-dbg", reference:"8u292-b10-0+deb8u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-demo", reference:"8u292-b10-0+deb8u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-doc", reference:"8u292-b10-0+deb8u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-jdk", reference:"8u292-b10-0+deb8u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-jdk-headless", reference:"8u292-b10-0+deb8u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-jre", reference:"8u292-b10-0+deb8u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-jre-headless", reference:"8u292-b10-0+deb8u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-jre-zero", reference:"8u292-b10-0+deb8u1")) flag++;
if (deb_check(release:"9.0", prefix:"openjdk-8-source", reference:"8u292-b10-0+deb8u1")) flag++;
