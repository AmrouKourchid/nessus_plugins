...
# extracted from Debian Security Advisory dla-3780. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3780 : jetty9 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3780
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3780-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'jetty9', 'reference': '9.4.50-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libjetty9-extra-java', 'reference': '9.4.50-4+deb10u2'},
    {'release': '10.0', 'prefix': 'libjetty9-java', 'reference': '9.4.50-4+deb10u2'}
];
