...
# AlmaLinux Security Advisory ALSA-2023:6265.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:6265");
  script_xref(name:"IAVB", value:"2023-B-0070-S");

  script_name(english:"AlmaLinux 9 : ghostscript (ALSA-2023:6265)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-6265.html");
