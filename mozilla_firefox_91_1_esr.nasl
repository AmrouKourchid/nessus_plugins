...
"The version of Firefox ESR installed on the remote Windows host is prior to 91.1. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2021-41 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'91.1', min:'91.0.0', severity:SECURITY_WARNING);
