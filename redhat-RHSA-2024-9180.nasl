...
# extracted from Red Hat Security Advisory RHSA-2024:9180. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9180");

  script_name(english:"RHEL 9 : mod_auth_openidc (RHSA-2024:9180)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mod_auth_openidc.");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-32450");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9180.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?487ffbc8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9180");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_auth_openidc package based on the guidance in RHSA-2024:9180.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_auth_openidc-2.4.10-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
