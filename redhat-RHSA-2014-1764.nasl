...
in the RHSA-2014:1764 advisory.

  - wget: FTP symlink arbitrary filesystem access (CVE-2014-4877)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2014/rhsa-2014_1764.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4f718607");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1764");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1139181");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL wget package based on the guidance in RHSA-2014:1764.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wget-1.14-10.el7_0.1', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.14-10.el7_0.1', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.14-10.el7_0.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'wget-1.12-5.el6_6.1', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.12-5.el6_6.1', 'cpu':'ppc64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.12-5.el6_6.1', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wget-1.12-5.el6_6.1', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
