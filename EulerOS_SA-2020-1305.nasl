...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : flatpak (EulerOS-SA-2020-1305)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1305
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ce7d5da0");
...
pkgs = ["flatpak-0.8.8-3.h3.eulerosv2r7",
        "flatpak-libs-0.8.8-3.h3.eulerosv2r7"];
