...
# extracted from Ubuntu Security Notice USN-6699-1. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-4921", "CVE-2023-30456", "CVE-2024-24855");
  script_xref(name:"USN", value:"6699-1");

  script_name(english:"Ubuntu 14.04 LTS : Linux kernel vulnerabilities (USN-6699-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6699-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-197-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-197-lowlatency");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6699-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-4921', 'CVE-2023-30456', 'CVE-2024-24855');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6699-1');
  }
  else
  {
