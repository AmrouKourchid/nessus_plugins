...
# extracted from Fedora Security Advisory FEDORA-2018-a120d509ab.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : knot-resolver (2018-a120d509ab)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a120d509ab");
...
"Update the affected knot-resolver package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1110");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"knot-resolver-2.3.0-1.fc27")) flag++;
