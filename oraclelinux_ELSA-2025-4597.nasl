...
# extracted from Oracle Linux Security Advisory ELSA-2025-4597.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : mod_auth_openidc:2.3 (ELSA-2025-4597)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2025-4597 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-4597.html");
...
var appstreams = {
    'mod_auth_openidc:2.3': [
      ...
      {'reference':'mod_auth_openidc-2.4.9.4-8.module+el8.10.0+90568+7a187228', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'mod_auth_openidc-2.4.9.4-8.module+el8.10.0+90568+7a187228', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
