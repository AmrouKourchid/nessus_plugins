...
# extracted from Fedora Security Advisory FEDORA-2025-7b6e208ef2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-7b6e208ef2");

  script_name(english:"Fedora 41 : python-jinja2 (2025-7b6e208ef2)");
...
FEDORA-2025-7b6e208ef2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-7b6e208ef2");
...
var pkgs = [
    {'reference':'python-jinja2-3.1.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
