...
# extracted from Fedora Security Advisory FEDORA-2018-def329f680.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-def329f680");

  script_name(english:"Fedora 28 : 1:libvorbis (2018-def329f680)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-def329f680");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:libvorbis package.");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"libvorbis-1.3.6-1.fc28", epoch:"1")) flag++;
