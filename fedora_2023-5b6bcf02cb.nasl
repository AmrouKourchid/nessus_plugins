...
# extracted from Fedora Security Advisory FEDORA-2023-5b6bcf02cb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5b6bcf02cb");

  script_name(english:"Fedora 38 : openbgpd (2023-5b6bcf02cb)");
...
FEDORA-2023-5b6bcf02cb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5b6bcf02cb");
...
var pkgs = [
    {'reference':'openbgpd-7.9-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
