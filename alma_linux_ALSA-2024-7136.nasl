...
# AlmaLinux Security Advisory ALSA-2024:7136.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:7136");
  script_xref(name:"IAVB", value:"2024-B-0132-S");

  script_name(english:"AlmaLinux 9 : git-lfs (ALSA-2024:7136)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-7136.html");
