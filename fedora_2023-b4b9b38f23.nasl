...
# extracted from Fedora Security Advisory FEDORA-2023-b4b9b38f23
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b4b9b38f23");

  script_name(english:"Fedora 38 : perl-CryptX (2023-b4b9b38f23)");
...
FEDORA-2023-b4b9b38f23 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b4b9b38f23");
...
"Update the affected perl-CryptX package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:perl-CryptX");
...
var pkgs = [
    {'reference':'perl-CryptX-0.080-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
