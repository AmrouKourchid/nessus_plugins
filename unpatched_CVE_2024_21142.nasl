...
if (description)
{
  ...
  script_cve_id("CVE-2024-21142");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-21142");
...
patch available.
  ...
  - Vulnerability in the MySQL Server product of Oracle MySQL (component: Server: Security: Privileges).
    ...
    or frequently repeatable crash (complete DOS) of MySQL Server. (CVE-2024-21142)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-21142");
