...
# extracted from Fedora Security Advisory FEDORA-2024-86d287b270
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-86d287b270");

  script_name(english:"Fedora 40 : editorconfig (2024-86d287b270)");
...
FEDORA-2024-86d287b270 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-86d287b270");
  script_set_attribute(attribute:"solution", value:
"Update the affected editorconfig package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:editorconfig");
...
var pkgs = [
    {'reference':'editorconfig-0.12.7-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'editorconfig');
}
