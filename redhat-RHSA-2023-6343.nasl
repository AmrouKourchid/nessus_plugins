...
# extracted from Red Hat Security Advisory RHSA-2023:6343. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6343");

  script_name(english:"RHEL 9 : LibRaw (RHSA-2023:6343)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6343.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3b22694b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6343");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL LibRaw package based on the guidance in RHSA-2023:6343.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'LibRaw-0.20.2-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'LibRaw-devel-0.20.2-6.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'LibRaw-devel-0.20.2-6.el9', 'cpu':'ppc64le', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'LibRaw-devel-0.20.2-6.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
