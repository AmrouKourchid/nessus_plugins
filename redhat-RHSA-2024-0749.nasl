...
# extracted from Red Hat Security Advisory RHSA-2024:0749. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-25033");
  script_xref(name:"RHSA", value:"2024:0749");

  script_name(english:"RHEL 8 : unbound (RHSA-2024:0749)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for unbound.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:0749 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0749.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c42054ac");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1954775");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0749");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL unbound package based on the guidance in RHSA-2024:0749.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-unbound-1.7.3-17.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unbound-1.7.3-17.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unbound-devel-1.7.3-17.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unbound-libs-1.7.3-17.el8_6.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
