...
# extracted from Red Hat Security Advisory RHSA-2022:8361. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8361");

  script_name(english:"RHEL 9 : e2fsprogs (RHSA-2022:8361)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8361.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?462499a2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8361");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2069726");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL e2fsprogs package based on the guidance in RHSA-2022:8361.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'e2fsprogs-1.46.5-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'e2fsprogs-devel-1.46.5-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'e2fsprogs-libs-1.46.5-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcom_err-1.46.5-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcom_err-devel-1.46.5-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libss-1.46.5-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
