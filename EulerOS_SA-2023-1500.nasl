...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : exiv2 (EulerOS-SA-2023-1500)");
...
following vulnerabilities :
  ...
  - Rejected reason: DO NOT USE THIS CANDIDATE NUMBER. ConsultIDs: none. Reason: This candidate was withdrawn
    by its CNA. Further investigation showed that it was not a security issue. Notes: none. (CVE-2022-3718,
    CVE-2022-3719)

Note that Tenable Network Security has extracted the preceding description block directly from the EulerOS security
advisory. Tenable has attempted to automatically clean and format it as much as possible without introducing additional
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1500
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?57d5df4a");
...
"Update the affected exiv2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-3719");
...
var pkgs = [
  "exiv2-libs-0.26-3.h19.eulerosv2r7"
];
