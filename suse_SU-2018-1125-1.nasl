...
# extracted from SUSE update advisory SUSE-SU-2018:1125-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : dovecot22 (SUSE-SU-2018:1125-1)");
...
"This update for dovecot22 fixes the following issues :
  ...
  - CVE-2017-14461: dovecot22: rfc822_parse_domain
    (bsc#1082826) Information Leak Vulnerability

Note that Tenable Network Security has extracted the preceding
description block directly from the SUSE security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1082826");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2017-14461/");
  # https://www.suse.com/support/update/announcement/2018/suse-su-20181125-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?74df8998");
...
patch SUSE-SLE-SDK-12-SP3-2018-773=1

SUSE Linux Enterprise Server 12-SP3:zypper in -t patch
SUSE-SLE-SERVER-12-SP3-2018-773=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"dovecot22-2.2.31-19.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"dovecot22-backend-mysql-2.2.31-19.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"dovecot22-backend-mysql-debuginfo-2.2.31-19.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"dovecot22-backend-pgsql-2.2.31-19.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"dovecot22-backend-pgsql-debuginfo-2.2.31-19.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"dovecot22-backend-sqlite-2.2.31-19.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"dovecot22-backend-sqlite-debuginfo-2.2.31-19.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"dovecot22-debuginfo-2.2.31-19.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"dovecot22-debugsource-2.2.31-19.8.1")) flag++;
