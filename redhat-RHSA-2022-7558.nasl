...
# extracted from Red Hat Security Advisory RHSA-2022:7558. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7558");

  script_name(english:"RHEL 8 : wavpack (RHSA-2022:7558)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for wavpack.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:7558 advisory.

    WavPack is a completely open audio compression format providing lossless, high-quality lossy and a unique
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7558.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b68ce8af");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7558");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2064457");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL wavpack package based on the guidance in RHSA-2022:7558.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:wavpack");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:wavpack-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wavpack-5.1.0-16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wavpack-devel-5.1.0-16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
