...
# extracted from Fedora Security Advisory FEDORA-2023-91e69ea326
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-91e69ea326");

  script_name(english:"Fedora 40 : rubygem-rails-html-sanitizer (2023-91e69ea326)");
...
FEDORA-2023-91e69ea326 advisory.

    Automatic update for rubygem-rails-html-sanitizer-1.6.0-1.fc40.

    ##### **Changelog**

    ```
    * Thu Nov 23 2023 Vt Ondruch <vondruch@redhat.com> - 1.6.0-1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-91e69ea326");
  script_set_attribute(attribute:"solution", value:
"Update the affected rubygem-rails-html-sanitizer package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:rubygem-rails-html-sanitizer");
...
var pkgs = [
    {'reference':'rubygem-rails-html-sanitizer-1.6.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rubygem-rails-html-sanitizer');
}
