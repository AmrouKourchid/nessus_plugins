...
vulnerability as referenced in the USN-6037-1 advisory.
    ...
    ZeddYu Lu discovered that the FTP client from Apache Commons Net trusted the host from PASV responses by
    default. A remote attacker with a malicious FTP server could redirect the client to another server, which
    could possibly result in leaked information about services running on the private network of the client.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libcommons-net-java', 'pkgver': '3.4-2ubuntu2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libcommons-net-java', 'pkgver': '3.6-1+deb11u1build0.18.04.1', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libcommons-net-java', 'pkgver': '3.6-1+deb11u1build0.20.04.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'libcommons-net-java', 'pkgver': '3.6-1+deb11u1build0.22.04.1', 'ubuntu_pro': FALSE}
];
