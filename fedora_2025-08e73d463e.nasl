...
# extracted from Fedora Security Advisory FEDORA-2025-08e73d463e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-08e73d463e");

  script_name(english:"Fedora 41 : wireshark (2025-08e73d463e)");
...
FEDORA-2025-08e73d463e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-08e73d463e");
...
var pkgs = [
    {'reference':'wireshark-4.4.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
