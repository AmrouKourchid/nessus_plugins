...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : unbound (EulerOS-SA-2024-2494)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2494
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6c674d08");
...
var pkgs = [
  "python2-unbound-1.7.3-9.h10.eulerosv2r8",
  "python3-unbound-1.7.3-9.h10.eulerosv2r8",
  "unbound-1.7.3-9.h10.eulerosv2r8",
  "unbound-libs-1.7.3-9.h10.eulerosv2r8"
];
