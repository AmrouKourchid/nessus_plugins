...
# extracted from Fedora Security Advisory FEDORA-2022-fc361cc7b6
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-41981", "CVE-2022-43603");
  script_xref(name:"FEDORA", value:"2022-fc361cc7b6");

  script_name(english:"Fedora 37 : OpenImageIO (2022-fc361cc7b6)");
...
FEDORA-2022-fc361cc7b6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-fc361cc7b6");
...
"Update the affected OpenImageIO package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-41981");
...
var pkgs = [
    {'reference':'OpenImageIO-2.4.6.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
