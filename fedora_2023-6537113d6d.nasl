...
# extracted from Fedora Security Advisory FEDORA-2023-6537113d6d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6537113d6d");
  script_xref(name:"IAVB", value:"2023-B-0006-S");

  script_name(english:"Fedora 37 : ImageMagick (2023-6537113d6d)");
...
FEDORA-2023-6537113d6d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6537113d6d");
...
var pkgs = [
    {'reference':'ImageMagick-6.9.12.77-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
