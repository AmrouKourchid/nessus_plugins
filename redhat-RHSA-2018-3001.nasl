...
# extracted from Red Hat Security Advisory RHSA-2018:3001. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3001");

  script_name(english:"RHEL 7 : java-1.7.0-oracle (RHSA-2018:3001)");
...
referenced in the RHSA-2018:3001 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3001.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?731d0a4b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3001");
...
"Update the RHEL java-1.7.0-oracle package based on the guidance in RHSA-2018:3001.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.7.0-oracle-1.7.0.201-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-oracle-devel-1.7.0.201-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-oracle-javafx-1.7.0.201-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-oracle-jdbc-1.7.0.201-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-oracle-plugin-1.7.0.201-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.7.0-oracle-src-1.7.0.201-1jpp.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
