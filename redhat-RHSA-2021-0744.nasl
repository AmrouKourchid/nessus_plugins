...
# extracted from Red Hat Security Advisory RHSA-2021:0744. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_0744.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9aa172ce");
...
"Update the RHEL nodejs:14 package based on the guidance in RHSA-2021:0744.");
  ...
  'nodejs:14': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-14.16.0-2.module+el8.3.0+10180+b92e1eb6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-14.16.0-2.module+el8.3.0+10180+b92e1eb6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-14.16.0-2.module+el8.3.0+10180+b92e1eb6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-14.16.0-2.module+el8.3.0+10180+b92e1eb6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-6.14.11-1.14.16.0.2.module+el8.3.0+10180+b92e1eb6', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
