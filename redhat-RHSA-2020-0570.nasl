...
# extracted from Red Hat Security Advisory RHSA-2020:0570. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0570");

  script_name(english:"RHEL 8 : openjpeg2 (RHSA-2020:0570)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openjpeg2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:0570 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0570.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?88b7ad2d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0570");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1800535");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openjpeg2 package based on the guidance in RHSA-2020:0570.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openjpeg2-2.3.1-3.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openjpeg2-devel-2.3.1-3.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openjpeg2-devel-docs-2.3.1-3.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openjpeg2-tools-2.3.1-3.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openjpeg2-2.3.1-3.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openjpeg2-devel-2.3.1-3.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openjpeg2-devel-docs-2.3.1-3.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openjpeg2-tools-2.3.1-3.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
