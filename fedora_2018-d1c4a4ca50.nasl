...
# extracted from Fedora Security Advisory FEDORA-2018-d1c4a4ca50.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : 3:mariadb (2018-d1c4a4ca50)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d1c4a4ca50");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"mariadb-10.2.17-1.fc27", epoch:"3")) flag++;
