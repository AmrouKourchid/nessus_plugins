...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : GIMP vulnerability (USN-3025-1)");
...
USN-3025-1 advisory.
    ...
    It was discovered that GIMP incorrectly handled malformed XCF files. If a user were tricked into opening a
    specially crafted XCF file, an attacker could cause GIMP to crash, or possibly execute arbitrary code with
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3025-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'gimp', 'pkgver': '2.8.10-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'gimp-data', 'pkgver': '2.8.10-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'libgimp2.0', 'pkgver': '2.8.10-0ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'libgimp2.0-dev', 'pkgver': '2.8.10-0ubuntu1.1'}
];
