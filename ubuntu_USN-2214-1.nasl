...
# extracted from Ubuntu Security Notice USN-2214-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : libxml2 vulnerability (USN-2214-1)");
...
USN-2214-1 advisory.
    ...
    Daniel Berrange discovered that libxml2 would incorrectly perform entity substitution even when requested
    not to. If a user or automated system were tricked into opening a specially crafted document, an attacker
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2214-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libxml2', 'pkgver': '2.9.1+dfsg1-3ubuntu4.1'},
    {'osver': '14.04', 'pkgname': 'libxml2-dev', 'pkgver': '2.9.1+dfsg1-3ubuntu4.1'},
    {'osver': '14.04', 'pkgname': 'libxml2-udeb', 'pkgver': '2.9.1+dfsg1-3ubuntu4.1'},
    {'osver': '14.04', 'pkgname': 'libxml2-utils', 'pkgver': '2.9.1+dfsg1-3ubuntu4.1'},
    {'osver': '14.04', 'pkgname': 'python-libxml2', 'pkgver': '2.9.1+dfsg1-3ubuntu4.1'}
];
