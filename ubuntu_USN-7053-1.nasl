...
# extracted from Ubuntu Security Notice USN-7053-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7053-1");

  script_name(english:"Ubuntu 14.04 LTS : ImageMagick vulnerabilities (USN-7053-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-7053-1 advisory.
    ...
    exploit this to cause a denial of service or potentially leak sensitive information.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7053-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2019/01/17");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'imagemagick', 'pkgver': '8:6.7.7.10-6ubuntu3.13+esm10', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'imagemagick-common', 'pkgver': '8:6.7.7.10-6ubuntu3.13+esm10', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libmagick++-dev', 'pkgver': '8:6.7.7.10-6ubuntu3.13+esm10', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libmagick++5', 'pkgver': '8:6.7.7.10-6ubuntu3.13+esm10', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libmagickcore-dev', 'pkgver': '8:6.7.7.10-6ubuntu3.13+esm10', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libmagickcore5', 'pkgver': '8:6.7.7.10-6ubuntu3.13+esm10', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libmagickcore5-extra', 'pkgver': '8:6.7.7.10-6ubuntu3.13+esm10', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libmagickwand-dev', 'pkgver': '8:6.7.7.10-6ubuntu3.13+esm10', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libmagickwand5', 'pkgver': '8:6.7.7.10-6ubuntu3.13+esm10', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'perlmagick', 'pkgver': '8:6.7.7.10-6ubuntu3.13+esm10', 'ubuntu_pro': TRUE}
];
