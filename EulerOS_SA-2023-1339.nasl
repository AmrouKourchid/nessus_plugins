...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : systemd (EulerOS-SA-2023-1339)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1339
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?993b2037");
...
var pkgs = [
  "systemd-239-3.h130.eulerosv2r8",
  "systemd-container-239-3.h130.eulerosv2r8",
  "systemd-devel-239-3.h130.eulerosv2r8",
  "systemd-journal-remote-239-3.h130.eulerosv2r8",
  "systemd-libs-239-3.h130.eulerosv2r8",
  "systemd-pam-239-3.h130.eulerosv2r8",
  "systemd-udev-239-3.h130.eulerosv2r8",
  "systemd-udev-compat-239-3.h130.eulerosv2r8"
];
