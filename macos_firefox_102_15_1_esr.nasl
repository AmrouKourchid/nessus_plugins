...
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 102.15.1. It is, therefore,
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'102.15.1', min:'102.0.0', severity:SECURITY_HOLE);
