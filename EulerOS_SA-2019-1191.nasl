...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : libXcursor (EulerOS-SA-2019-1191)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1191
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ac10e62f");
...
pkgs = ["libXcursor-1.1.14-8.h2.eulerosv2r7"];
