...
# extracted from Red Hat Security Advisory RHSA-2024:9552. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 9 : thunderbird (RHSA-2024:9552)");
...
referenced in the RHSA-2024:9552 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9552.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9ae4270");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9552");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2024:9552.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-128.4.0-1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
