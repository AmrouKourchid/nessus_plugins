...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : vim (EulerOS-SA-2023-1238)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1238
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66566e9e");
...
var pkgs = [
  "vim-common-8.2-1.h5.r41.eulerosv2r9",
  "vim-enhanced-8.2-1.h5.r41.eulerosv2r9",
  "vim-filesystem-8.2-1.h5.r41.eulerosv2r9",
  "vim-minimal-8.2-1.h5.r41.eulerosv2r9"
];
