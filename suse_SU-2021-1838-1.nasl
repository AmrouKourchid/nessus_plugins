...
# extracted from SUSE update advisory SUSE-SU-2021:1838-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : squid (SUSE-SU-2021:1838-1)");
...
fix previous change to reinstante permissions macros, because the
wrong path has been used (bsc#1171569).

use libexecdir instead of libdir to conform to recent changes in
Factory (bsc#1171164).

Reinstate permissions macros for pinger binary, because the
permissions package is also responsible for setting up the cap_net_raw
capability, currently a fresh squid install doesn't get a capability
bit at all (bsc#1171569).
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1171164");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1171569");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1183436");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1185916");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1185918");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1185919");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1185921");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1185923");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4f065be");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"squid-4.15-4.18.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"squid-debuginfo-4.15-4.18.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"squid-debugsource-4.15-4.18.1")) flag++;
