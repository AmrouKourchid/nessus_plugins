...
# extracted from Fedora Security Advisory FEDORA-2023-f83b5e84d3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f83b5e84d3");

  script_name(english:"Fedora 39 : chromium (2023-f83b5e84d3)");
...
FEDORA-2023-f83b5e84d3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f83b5e84d3");
...
var pkgs = [
    {'reference':'chromium-119.0.6045.123-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
