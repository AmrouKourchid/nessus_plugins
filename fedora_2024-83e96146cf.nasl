...
# extracted from Fedora Security Advisory FEDORA-2024-83e96146cf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-83e96146cf");

  script_name(english:"Fedora 39 : valkey (2024-83e96146cf)");
...
FEDORA-2024-83e96146cf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-83e96146cf");
...
var pkgs = [
    {'reference':'valkey-8.0.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
