...
# SUSE update advisory SUSE-SU-2022:4057-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4057-1");

  script_name(english:"SUSE SLED15 / SLES15 Security Update : python-Twisted (SUSE-SU-2022:4057-1)");
...
vulnerability as referenced in the SUSE-SU-2022:4057-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-November/012969.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1e1afd6");
...
var pkgs = [
    {'reference':'python3-Twisted-19.10.0-150200.3.18.1', 'sp':'3', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'python3-Twisted-19.10.0-150200.3.18.1', 'sp':'3', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'python3-Twisted-19.10.0-150200.3.18.1', 'sp':'3', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-packagehub-subpackages-release-15.3', 'sled-release-15.3', 'sles-release-15.3']},
    {'reference':'python3-Twisted-19.10.0-150200.3.18.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.3', 'sle-module-packagehub-subpackages-release-15.3', 'sle-module-server-applications-release-15.3', 'sled-release-15.3', 'sles-release-15.3']}
];
