...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002397");
  script_xref(name:"MSFT", value:"MS23-5002397");
  ...
  script_name(english:"Security Updates for Microsoft SharePoint Server 2016 (May 2023)");
...
missing security updates. It is, therefore, affected by multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002397");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002397 to address this issue.");
