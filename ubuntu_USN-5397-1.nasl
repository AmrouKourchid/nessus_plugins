...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : curl vulnerabilities (USN-5397-1)");
...
vulnerabilities as referenced in the USN-5397-1 advisory.
    ...
    Patrick Monnerat discovered that curl incorrectly handled certain OAUTH2. An attacker could possibly use
    this issue to access sensitive information. (CVE-2022-22576)

    Harry Sintonen discovered that curl incorrectly handled certain requests. An attacker could possibly use
    this issue to expose sensitive information. (CVE-2022-27774, CVE-2022-27775, CVE-2022-27776)
