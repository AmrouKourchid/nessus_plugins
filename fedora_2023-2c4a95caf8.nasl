...
# extracted from Fedora Security Advisory FEDORA-2023-2c4a95caf8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2c4a95caf8");

  script_name(english:"Fedora 37 : chromium (2023-2c4a95caf8)");
...
FEDORA-2023-2c4a95caf8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2c4a95caf8");
...
var pkgs = [
    {'reference':'chromium-113.0.5672.63-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
