...
# extracted from ZTE advisory NS-SA-2021-0002. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.06 : libX11 Vulnerability (NS-SA-2021-0002)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.06, has libX11 packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0002");
...
pkgs = {
  'CGSL MAIN 4.06': [
    'libX11-1.6.4-4.el6_10',
    'libX11-common-1.6.4-4.el6_10',
    'libX11-devel-1.6.4-4.el6_10'
  ]
};
