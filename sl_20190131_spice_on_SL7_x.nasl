...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : spice on SL7.x x86_64 (20190131)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1901&L=SCIENTIFIC-LINUX-ERRATA&P=11134
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?44fcdc6d");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"spice-debuginfo-0.14.0-6.el7_6.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"spice-server-0.14.0-6.el7_6.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"spice-server-devel-0.14.0-6.el7_6.1")) flag++;
