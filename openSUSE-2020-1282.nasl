...
# extracted from openSUSE Security Update openSUSE-2020-1282.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : grub2 (openSUSE-2020-1282)");
...
"Update the affected grub2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-15705");
...
if ( rpm_check(release:"SUSE15.2", reference:"grub2-2.04-lp152.7.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"grub2-branding-upstream-2.04-lp152.7.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"grub2-debuginfo-2.04-lp152.7.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"grub2-debugsource-2.04-lp152.7.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"grub2-i386-efi-2.04-lp152.7.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"grub2-i386-efi-debug-2.04-lp152.7.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"grub2-i386-pc-2.04-lp152.7.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"grub2-i386-pc-debug-2.04-lp152.7.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"grub2-i386-xen-2.04-lp152.7.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"grub2-snapper-plugin-2.04-lp152.7.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"grub2-systemd-sleep-plugin-2.04-lp152.7.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"grub2-x86_64-efi-2.04-lp152.7.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"grub2-x86_64-efi-debug-2.04-lp152.7.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"grub2-x86_64-xen-2.04-lp152.7.9.1") ) flag++;
