...
# extracted from Fedora Security Advisory FEDORA-2022-cb47d98a05
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-cb47d98a05");

  script_name(english:"Fedora 37 : python3.8 (2022-cb47d98a05)");
...
FEDORA-2022-cb47d98a05 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-cb47d98a05");
...
var pkgs = [
    {'reference':'python3.8-3.8.15-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
