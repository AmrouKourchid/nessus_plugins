...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : keepalived Vulnerability (NS-SA-2019-0240)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has keepalived packages installed that are
...
pkgs = {
  "CGSL CORE 5.05": [
    ...
    "keepalived-debuginfo-1.3.5-16.el7"
  ],
  "CGSL MAIN 5.05": [
    "keepalived-1.3.5-16.el7",
    "keepalived-debuginfo-1.3.5-16.el7"
