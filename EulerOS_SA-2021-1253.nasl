...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-paramiko (EulerOS-SA-2021-1253)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1253
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3b2c1dd");
...
pkgs = ["python-paramiko-2.4.1-7.h2.eulerosv2r9",
        "python3-paramiko-2.4.1-7.h2.eulerosv2r9"];
