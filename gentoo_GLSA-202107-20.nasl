...
# extracted from Gentoo Linux Security Advisory GLSA 202107-20.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-20");

  script_name(english:"GLSA-202107-20 : Redis: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202107-20
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202107-20");
...
if (qpkg_check(package:"dev-db/redis", unaffected:make_list("ge 6.0.13", "ge 6.2.3"), vulnerable:make_list("lt 6.0.13"))) flag++;
