...
# extracted from Fedora Security Advisory FEDORA-2022-60c0d28bbd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-60c0d28bbd");

  script_name(english:"Fedora 37 : apptainer (2022-60c0d28bbd)");
...
FEDORA-2022-60c0d28bbd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-60c0d28bbd");
...
var pkgs = [
    {'reference':'apptainer-1.1.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
