...
# extracted from Amazon Linux AMI Security Advisory ALAS-2018-977.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-977");

  script_name(english:"Amazon Linux AMI : python-crypto (ALAS-2018-977)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Weak ElGamal key parameters in PublicKey/ElGamal.py allow attackers to
obtain sensitive information by reading ciphertext :
...
PyCrypto's ElGamal implementation. (CVE-2018-6594)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2018-977.html");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"python-crypto-debuginfo-2.6.1-1.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python26-crypto-2.6.1-1.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python27-crypto-2.6.1-1.15.amzn1")) flag++;
