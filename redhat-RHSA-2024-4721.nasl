...
# extracted from Red Hat Security Advisory RHSA-2024:4721. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-22025", "CVE-2024-25629", "CVE-2024-28182");
  script_xref(name:"RHSA", value:"2024:4721");

  script_name(english:"RHEL 9 : nodejs (RHSA-2024:4721)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for nodejs.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:4721 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4721.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f278ff73");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4721");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nodejs package based on the guidance in RHSA-2024:4721.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nodejs-16.20.2-9.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-docs-16.20.2-9.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-16.20.2-9.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-libs-16.20.2-9.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'npm-8.19.4-1.16.20.2.9.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
