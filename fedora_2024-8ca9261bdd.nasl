...
# extracted from Fedora Security Advisory FEDORA-2024-8ca9261bdd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8ca9261bdd");
  script_xref(name:"IAVB", value:"2024-B-0087-S");

  script_name(english:"Fedora 39 : squid (2024-8ca9261bdd)");
...
FEDORA-2024-8ca9261bdd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8ca9261bdd");
...
var pkgs = [
    {'reference':'squid-6.10-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
