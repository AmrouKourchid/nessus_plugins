...
if (description)
{
  ...
  script_name(english:"Adobe Character Animator 3.0 < 3.3 Arbitrary code execution (APSB20-25) (macOS)");
...
"The version of Adobe Character Animator installed on the remote macOS host is prior to 3.3. It is, therefore, affected
by a vulnerability as referenced in the APSB20-25 advisory.

  - Adobe Character Animator versions 3.2 and earlier have a buffer overflow vulnerability. Successful
    exploitation could lead to arbitrary code execution. (CVE-2020-9586)
...
var constraints = [
  { 'min_version' : '3.0', 'fixed_version' : '3.3' }
];
