...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : PHP vulnerabilities (USN-5902-1)");
...
vulnerabilities as referenced in the USN-5902-1 advisory.
    ...
    It was discovered that PHP incorrectly handled a large number of parts in HTTP form uploads. A remote
    attacker could possibly use this issue to cause PHP to consume resources, leading to a denial of service.
    (CVE-2023-0662)
