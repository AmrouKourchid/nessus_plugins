...
ELSA-2017-1430 advisory.

    [1.5.3-126.el7_3.9]
    - kvm-spice-fix-spice_chr_add_watch-pre-condition.patch [bz#1452332]
    - Resolves: bz#1452332
      (RHEL 7.2 based VM (Virtual Machine) hung for several hours apparently waiting for lock held by
    main_loop)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2017-1430.html");
...
var pkgs = [
    {'reference':'qemu-img-1.5.3-126.el7_3.9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'qemu-kvm-1.5.3-126.el7_3.9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'qemu-kvm-common-1.5.3-126.el7_3.9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'},
    {'reference':'qemu-kvm-tools-1.5.3-126.el7_3.9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'}
];
