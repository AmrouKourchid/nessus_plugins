...
# extracted from Red Hat Security Advisory RHSA-2020:4056 and
# CentOS Errata and Security Advisory 2020:4056 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : qemu-kvm (RHSA-2020:4056)");
...
var pkgs = [
    {'reference':'qemu-guest-agent-0.12.1.2-2.506.el6_10.8', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'qemu-img-0.12.1.2-2.506.el6_10.8', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'qemu-kvm-0.12.1.2-2.506.el6_10.8', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'qemu-kvm-tools-0.12.1.2-2.506.el6_10.8', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
