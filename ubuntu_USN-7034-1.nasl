...
# extracted from Ubuntu Security Notice USN-7034-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7034-1");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : ca-certificates update (USN-7034-1)");
...
in the USN-7034-1 advisory.

    The ca-certificates package contained outdated CA certificates. This update refreshes the included
    certificates to those contained in the 2.64 version of the Mozilla certificate authority bundle.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7034-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'ca-certificates', 'pkgver': '20240203~20.04.1'},
    {'osver': '22.04', 'pkgname': 'ca-certificates', 'pkgver': '20240203~22.04.1'}
];
