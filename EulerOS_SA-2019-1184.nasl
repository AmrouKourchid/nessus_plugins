...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : krb5 (EulerOS-SA-2019-1184)");
...
following vulnerabilities :
  ...
  - MIT krb5 1.6 or later allows an authenticated kadmin
    ...
    module.i1/4^CVE-2018-5729i1/4%0
  ...
  - MIT krb5 1.6 or later allows an authenticated kadmin
    ...
    DN.i1/4^CVE-2018-5730i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1184
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?620e9fd8");
