...
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.3.35
jenkins-2-plugins.");
...
referenced in the RHSA-2020:3616 advisory.
    ...
    * jenkins-script-security-plugin: sandbox protection bypass led to arbitrary code execution in sandboxed
    ...
    * jenkins-script-security-plugin: sandbox protection bypass during script compilation phase by applying
    AST transforming annotations (CVE-2020-2110)
    ...
    * jenkins-script-security-plugin: sandbox protection bypass led to arbitrary code execution
    (CVE-2020-2135)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3616.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a7b0c8b");
...
"Update the RHEL OpenShift Container Platform 4.3.35 jenkins-2-plugins package based on the guidance in RHSA-2020:3616.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.3.1597915133-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
