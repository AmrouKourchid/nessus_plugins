...
# extracted from Fedora Security Advisory FEDORA-2023-322314ad50
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-322314ad50");

  script_name(english:"Fedora 37 : caddy (2023-322314ad50)");
...
FEDORA-2023-322314ad50 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-322314ad50");
...
var pkgs = [
    {'reference':'caddy-2.5.2-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
