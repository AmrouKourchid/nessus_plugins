...
# extracted from Fedora Security Advisory FEDORA-2024-d6a850992f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d6a850992f");

  script_name(english:"Fedora 39 : libuev (2024-d6a850992f)");
...
FEDORA-2024-d6a850992f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d6a850992f");
  script_set_attribute(attribute:"solution", value:
"Update the affected libuev package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libuev");
...
var pkgs = [
    {'reference':'libuev-2.4.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libuev');
}
