...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIG-IP AAM security vulnerability (K25359902)");
...
ways when targeting the BIG-IP AAM module.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K25359902");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K25359902.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-6601");
...
var vmatrix = {
  'AM': {
    'affected': [
      '13.0.0','12.1.0-12.1.3','11.6.1-11.6.3','11.2.1-11.5.8'
    ],
    'unaffected': [
      '13.1.0','13.0.1','13.0.0 HF1','12.1.4','11.6.3.3','11.5.9'
    ],
  }
};
