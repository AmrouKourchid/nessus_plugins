...
# AlmaLinux Security Advisory ALSA-2024:4256.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4256");

  script_name(english:"AlmaLinux 8 : less (ALSA-2024:4256)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-4256.html");
...
var pkgs = [
    {'reference':'less-530-3.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'less-530-3.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
