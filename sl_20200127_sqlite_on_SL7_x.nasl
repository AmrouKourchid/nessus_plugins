...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : sqlite on SL7.x x86_64 (20200127)");
...
"Security Fix(es) :
  ...
  - sqlite: fts3: improve shadow table corruption detection
    (CVE-2019-13734)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2001&L=SCIENTIFIC-LINUX-ERRATA&P=7403
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?39d9a502");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"lemon-3.7.17-8.el7_7.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"sqlite-3.7.17-8.el7_7.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"sqlite-debuginfo-3.7.17-8.el7_7.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"sqlite-devel-3.7.17-8.el7_7.1")) flag++;
if (rpm_check(release:"SL7", reference:"sqlite-doc-3.7.17-8.el7_7.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"sqlite-tcl-3.7.17-8.el7_7.1")) flag++;
