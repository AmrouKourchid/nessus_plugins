...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : ncurses (EulerOS-SA-2024-1551)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1551
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6f387b9");
...
var pkgs = [
  "ncurses-6.2-1.h6.eulerosv2r10",
  "ncurses-base-6.2-1.h6.eulerosv2r10",
  "ncurses-libs-6.2-1.h6.eulerosv2r10"
];
