...
# extracted from Fedora Security Advisory FEDORA-2024-87a7b3f47a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-87a7b3f47a");
  script_xref(name:"IAVA", value:"2024-A-0416-S");

  script_name(english:"Fedora 39 : exim (2024-87a7b3f47a)");
...
FEDORA-2024-87a7b3f47a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-87a7b3f47a");
...
var pkgs = [
    {'reference':'exim-4.98-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
