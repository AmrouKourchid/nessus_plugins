...
# Rocky Linux Security Advisory RLSA-2025:1611.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2025:1611");

  script_name(english:"RockyLinux 8 : nodejs:22 (RLSA-2025:1611)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2025:1611");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2339176");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2339392");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:rocky:linux:v8-12.4-devel");
...
var appstreams = {
    'nodejs:22': [
      {'reference':'nodejs-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debuginfo-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debuginfo-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debugsource-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-debugsource-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-devel-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-docs-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-libs-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-libs-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-libs-debuginfo-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-libs-debuginfo-22.13.1-1.module+el8.10.0+1935+d3cbe60f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'npm-10.9.2-1.22.13.1.1.module+el8.10.0+1935+d3cbe60f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'npm-10.9.2-1.22.13.1.1.module+el8.10.0+1935+d3cbe60f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'v8-12.4-devel-12.4.254.21-1.22.13.1.1.module+el8.10.0+1935+d3cbe60f', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'v8-12.4-devel-12.4.254.21-1.22.13.1.1.module+el8.10.0+1935+d3cbe60f', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
};
