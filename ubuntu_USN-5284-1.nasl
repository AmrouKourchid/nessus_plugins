...
referenced in the USN-5284-1 advisory.
    ...
    restrictions, obtain sensitive information, or execute arbitrary code. (CVE-2022-0511, CVE-2022-22755,
    ...
    It was discovered that Remote Agent, used in WebDriver, did not validate Host or Origin headers. If a user
    were tricked into opening a specially crafted website with WebDriver enabled, an attacker could
    potentially exploit this to connect back to the user's browser in order to control it. (CVE-2022-22757)
