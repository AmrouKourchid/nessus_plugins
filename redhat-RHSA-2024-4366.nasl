...
# extracted from Red Hat Security Advisory RHSA-2024:4366. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4366");

  script_name(english:"RHEL 8 : less (RHSA-2024:4366)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4366.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f864bb52");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4366");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL less package based on the guidance in RHSA-2024:4366.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'less-530-2.el8_2', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
