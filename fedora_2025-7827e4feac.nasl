...
# extracted from Fedora Security Advisory FEDORA-2025-7827e4feac
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-7827e4feac");

  script_name(english:"Fedora 40 : chromium (2025-7827e4feac)");
...
FEDORA-2025-7827e4feac advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-7827e4feac");
...
var pkgs = [
    {'reference':'chromium-135.0.7049.95-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
