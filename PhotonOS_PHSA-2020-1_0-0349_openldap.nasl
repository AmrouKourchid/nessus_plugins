...
# extracted from VMware Security Advisory PHSA-2020-1.0-0349. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Openldap PHSA-2020-1.0-0349");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openldap package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-349.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openldap-2.4.43-5.ph1')) flag++;
