...
# extracted from Red Hat Security Advisory RHSA-2024:3139. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3139");

  script_name(english:"RHEL 8 : squashfs-tools (RHSA-2024:3139)");
...
referenced in the RHSA-2024:3139 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3139.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66588820");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3139");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squashfs-tools package based on the guidance in RHSA-2024:3139.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'squashfs-tools-4.3-21.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
