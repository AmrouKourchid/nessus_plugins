...
# extracted from Fedora Security Advisory FEDORA-2023-54a88e1ae4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-54a88e1ae4");

  script_name(english:"Fedora 36 : qt5-qtbase (2023-54a88e1ae4)");
...
FEDORA-2023-54a88e1ae4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-54a88e1ae4");
...
var pkgs = [
    {'reference':'qt5-qtbase-5.15.8-5.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
