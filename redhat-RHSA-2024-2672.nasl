...
if (description)
{
  ...
  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.14.24 (RHSA-2024:2672)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.14.24.");
...
referenced in the RHSA-2024:2672 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.14.24. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2672.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05210c53");
...
"Update the RHEL OpenShift Container Platform 4.14.24 packages based on the guidance in RHSA-2024:2672.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.27.6-2.rhaos4.14.gitb3bd0bf.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-3154', 'CVE-2024-28180']},
      {'reference':'openshift-hyperkube-4.14.0-202404301807.p0.gfd36fb9.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-45288']},
      {'reference':'podman-4.4.1-13.4.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753', 'CVE-2024-28180']},
      {'reference':'podman-catatonit-4.4.1-13.4.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753', 'CVE-2024-28180']},
      {'reference':'podman-docker-4.4.1-13.4.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753', 'CVE-2024-28180']},
      {'reference':'podman-gvproxy-4.4.1-13.4.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753', 'CVE-2024-28180']},
      {'reference':'podman-plugins-4.4.1-13.4.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753', 'CVE-2024-28180']},
      {'reference':'podman-remote-4.4.1-13.4.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753', 'CVE-2024-28180']},
      {'reference':'podman-tests-4.4.1-13.4.rhaos4.14.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753', 'CVE-2024-28180']}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.27.6-2.rhaos4.14.gitb3bd0bf.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-3154', 'CVE-2024-28180']},
      {'reference':'openshift-hyperkube-4.14.0-202404301807.p0.gfd36fb9.assembly.stream.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2023-45288']},
      {'reference':'podman-4.4.1-13.4.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753', 'CVE-2024-28180']},
      {'reference':'podman-docker-4.4.1-13.4.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753', 'CVE-2024-28180']},
      {'reference':'podman-gvproxy-4.4.1-13.4.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753', 'CVE-2024-28180']},
      {'reference':'podman-plugins-4.4.1-13.4.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753', 'CVE-2024-28180']},
      {'reference':'podman-remote-4.4.1-13.4.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753', 'CVE-2024-28180']},
      {'reference':'podman-tests-4.4.1-13.4.rhaos4.14.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3', 'exists_check':'openshift-hyperkube', 'cves':['CVE-2024-1753', 'CVE-2024-28180']}
    ]
  }
];
