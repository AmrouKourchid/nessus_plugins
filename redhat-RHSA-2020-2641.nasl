...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2641.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b20bc091");
...
"Update the RHEL grafana package based on the guidance in RHSA-2020:2641.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-6.3.6-2.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-azure-monitor-6.3.6-2.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-cloudwatch-6.3.6-2.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-elasticsearch-6.3.6-2.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-graphite-6.3.6-2.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-influxdb-6.3.6-2.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-loki-6.3.6-2.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-mssql-6.3.6-2.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-mysql-6.3.6-2.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-opentsdb-6.3.6-2.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-postgres-6.3.6-2.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-prometheus-6.3.6-2.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-stackdriver-6.3.6-2.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'grafana-6.3.6-2.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-azure-monitor-6.3.6-2.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-cloudwatch-6.3.6-2.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-elasticsearch-6.3.6-2.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-graphite-6.3.6-2.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-influxdb-6.3.6-2.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-loki-6.3.6-2.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-mssql-6.3.6-2.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-mysql-6.3.6-2.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-opentsdb-6.3.6-2.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-postgres-6.3.6-2.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-prometheus-6.3.6-2.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'grafana-stackdriver-6.3.6-2.el8_2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
