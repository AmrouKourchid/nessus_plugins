...
load on the system, causing it to become unresponsive.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K15840535");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K15840535.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '15.0.1-15.1.0','14.1.1-14.1.2','13.1.2-13.1.3','12.1.5','11.6.5','11.5.10'
    ],
    'unaffected': [
      '16.0.0','15.1.0.5','14.1.2.5','13.1.3.4','12.1.5.1','11.6.5.2'
    ],
  },
  'AM': {
    'affected': [
