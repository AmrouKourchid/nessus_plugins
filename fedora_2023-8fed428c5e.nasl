...
# extracted from Fedora Security Advisory FEDORA-2023-8fed428c5e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8fed428c5e");

  script_name(english:"Fedora 37 : python-django (2023-8fed428c5e)");
...
FEDORA-2023-8fed428c5e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8fed428c5e");
...
var pkgs = [
    {'reference':'python-django-4.0.10-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
