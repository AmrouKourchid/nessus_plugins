...
if (description)
{
  ...
  script_cve_id("CVE-2015-7974");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-7974");
...
patch available.
  ...
  - NTP 4.x before 4.2.8p6 and 4.3.x before 4.3.90 do not verify peer associations of symmetric keys when
    authenticating packets, which might allow remote attackers to conduct impersonation attacks via an
    arbitrary trusted key, aka a skeleton key. (CVE-2015-7974)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-7974");
