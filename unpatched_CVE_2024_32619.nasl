...
if (description)
{
  ...
  script_cve_id("CVE-2024-32619");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-32619");
...
patch available.
  ...
  - HDF5 Library through 1.14.3 contains a heap-based buffer overflow in H5T_copy_reopen in H5T.c, resulting
    in the corruption of the instruction pointer. (CVE-2024-32619)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-32619");
