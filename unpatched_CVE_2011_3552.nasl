...
if (description)
{
  ...
  script_cve_id("CVE-2011-3552");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2011-3552");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment component in Oracle Java SE JDK and JRE 7, 6
    Update 27 and earlier, 5.0 Update 31 and earlier, and 1.4.2_33 and earlier allows remote attackers to
    affect integrity via unknown vectors related to Networking. (CVE-2011-3552)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-3552");
