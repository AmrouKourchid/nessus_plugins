...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30f4e31c");
  # https://github.com/apache/tomcat/commit/7f748eb6bfaba5207c89dbd7d5adf50fae847145
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3581a2b1");
  # https://github.com/apache/tomcat/commit/ada725a50a60867af3422c8e612aecaeea856a9a
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5dc1885d");
...
var constraints = [
  { 'min_version' : '9.0.0.M1', 'max_version' : '9.0.19', 'fixed_version' : '9.0.20' }
];
