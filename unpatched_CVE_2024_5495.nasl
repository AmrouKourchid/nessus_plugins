...
if (description)
{
  ...
  script_cve_id("CVE-2024-5495");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-5495");
...
patch available.
  ...
  - Use after free in Dawn in Google Chrome prior to 125.0.6422.141 allowed a remote attacker to potentially
    exploit heap corruption via a crafted HTML page. (Chromium security severity: High) (CVE-2024-5495)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-5495");
