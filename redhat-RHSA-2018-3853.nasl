...
# extracted from Red Hat Security Advisory RHSA-2018:3853. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3853");

  script_name(english:"RHEL 6 : ntp (RHSA-2018:3853)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ntp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:3853 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_3853.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?262fc6f8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3853");
...
"Update the RHEL ntp package based on the guidance in RHSA-2018:3853.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ntp-4.2.6p5-5.el6_7.6', 'sp':'7', 'cpu':'i686', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-5.el6_7.6', 'sp':'7', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-5.el6_7.6', 'sp':'7', 'cpu':'s390x', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-4.2.6p5-5.el6_7.6', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-doc-4.2.6p5-5.el6_7.6', 'sp':'7', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-5.el6_7.6', 'sp':'7', 'cpu':'i686', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-5.el6_7.6', 'sp':'7', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-5.el6_7.6', 'sp':'7', 'cpu':'s390x', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntp-perl-4.2.6p5-5.el6_7.6', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-5.el6_7.6', 'sp':'7', 'cpu':'i686', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-5.el6_7.6', 'sp':'7', 'cpu':'ppc64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-5.el6_7.6', 'sp':'7', 'cpu':'s390x', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ntpdate-4.2.6p5-5.el6_7.6', 'sp':'7', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
