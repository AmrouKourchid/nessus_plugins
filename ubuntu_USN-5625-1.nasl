...
vulnerability as referenced in the USN-5625-1 advisory.
    ...
    It was discovered that Mako incorrectly handled certain regular expressions. An attacker could possibly
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-mako', 'pkgver': '1.0.3+ds1-1ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-mako', 'pkgver': '1.0.3+ds1-1ubuntu1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python-mako', 'pkgver': '1.0.7+ds1-1ubuntu0.2', 'ubuntu_pro': FALSE},
    {'osver': '18.04', 'pkgname': 'python3-mako', 'pkgver': '1.0.7+ds1-1ubuntu0.2', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'python-mako', 'pkgver': '1.1.0+ds1-1ubuntu2.1', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'python3-mako', 'pkgver': '1.1.0+ds1-1ubuntu2.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'python3-mako', 'pkgver': '1.1.3+ds1-2ubuntu0.1', 'ubuntu_pro': FALSE}
];
