...
# extracted from Fedora Security Advisory FEDORA-2022-cf9ae8e4ff
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-cf9ae8e4ff");

  script_name(english:"Fedora 37 : wireshark (2022-cf9ae8e4ff)");
...
FEDORA-2022-cf9ae8e4ff advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-cf9ae8e4ff");
...
var pkgs = [
    {'reference':'wireshark-4.0.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
