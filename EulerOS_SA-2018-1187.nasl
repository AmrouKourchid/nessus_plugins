...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : mariadb (EulerOS-SA-2018-1187)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1187
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1979434");
...
pkgs = ["mariadb-5.5.56-2.h2",
        "mariadb-bench-5.5.56-2.h2",
        "mariadb-devel-5.5.56-2.h2",
        "mariadb-libs-5.5.56-2.h2",
        "mariadb-server-5.5.56-2.h2",
        "mariadb-test-5.5.56-2.h2"];
