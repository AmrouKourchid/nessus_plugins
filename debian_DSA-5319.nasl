...
# extracted from Debian Security Advisory dsa-5319. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5319-1 : openvswitch - security update");
...
dsa-5319 advisory.
    ...
    Two vulnerabilities were discovered in the LLPD implementation of Open vSwitch, software-based Ethernet
    virtual switch, which could result in denial of service. For the stable distribution (bullseye), these
    problems have been fixed in version 2.15.0+ds1-2+deb11u2. We recommend that you upgrade your openvswitch
    packages. For the detailed security status of openvswitch please refer to its security tracker page at:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1027273");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/openvswitch");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5319");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'openvswitch-common', 'reference': '2.15.0+ds1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'openvswitch-dbg', 'reference': '2.15.0+ds1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'openvswitch-dev', 'reference': '2.15.0+ds1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'openvswitch-ipsec', 'reference': '2.15.0+ds1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'openvswitch-pki', 'reference': '2.15.0+ds1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'openvswitch-switch', 'reference': '2.15.0+ds1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'openvswitch-switch-dpdk', 'reference': '2.15.0+ds1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'openvswitch-testcontroller', 'reference': '2.15.0+ds1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'openvswitch-vtep', 'reference': '2.15.0+ds1-2+deb11u2'},
    {'release': '11.0', 'prefix': 'python3-openvswitch', 'reference': '2.15.0+ds1-2+deb11u2'}
];
