...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : git (EulerOS-SA-2022-1043)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1043
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb04eed3");
...
var pkgs = [
  "git-2.19.1-1.h10.eulerosv2r8",
  "git-core-2.19.1-1.h10.eulerosv2r8",
  "git-core-doc-2.19.1-1.h10.eulerosv2r8",
  "perl-Git-2.19.1-1.h10.eulerosv2r8"
];
