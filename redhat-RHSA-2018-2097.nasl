...
# extracted from Red Hat Security Advisory RHSA-2018:2097. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2097");

  script_name(english:"RHEL 6 : patch (RHSA-2018:2097)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_2097.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7eb82650");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2097");
...
"Update the RHEL patch package based on the guidance in RHSA-2018:2097.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'patch-2.6-8.el6_4', 'sp':'4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
