...
# extracted from Fedora Security Advisory FEDORA-2023-c33188f575
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c33188f575");

  script_name(english:"Fedora 38 : nats-server (2023-c33188f575)");
...
FEDORA-2023-c33188f575 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c33188f575");
...
var pkgs = [
    {'reference':'nats-server-2.10.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
