...
# SUSE update advisory SUSE-SU-2022:2877-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:2877-1");

  script_name(english:"SUSE SLED15 / SLES15 Security Update : cosign (SUSE-SU-2022:2877-1)");
...
vulnerability as referenced in the SUSE-SU-2022:2877-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1202157");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2022-35929");
  # https://lists.suse.com/pipermail/sle-security-updates/2022-August/011974.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0518a903");
...
"Update the affected cosign package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-35929");
...
var pkgs = [
    {'reference':'cosign-1.10.1-150400.3.3.1', 'sp':'4', 'release':'SLED_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'cosign-1.10.1-150400.3.3.1', 'sp':'4', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4']},
    {'reference':'cosign-1.10.1-150400.3.3.1', 'sp':'4', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-basesystem-release-15.4', 'sled-release-15.4', 'sles-release-15.4']},
    {'reference':'cosign-1.10.1-150400.3.3.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.4', 'sle-module-basesystem-release-15.4', 'sled-release-15.4', 'sles-release-15.4']}
];
