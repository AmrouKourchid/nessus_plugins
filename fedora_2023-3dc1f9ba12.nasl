...
# extracted from Fedora Security Advisory FEDORA-2023-3dc1f9ba12
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3dc1f9ba12");

  script_name(english:"Fedora 38 : cutter-re / rizin (2023-3dc1f9ba12)");
...
FEDORA-2023-3dc1f9ba12 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3dc1f9ba12");
...
"Update the affected cutter-re and / or rizin packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-27590");
...
var pkgs = [
    {'reference':'cutter-re-2.2.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rizin-0.5.2-1.fc38.2', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
