...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Rsync PHSA-2017-0052");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'rsync-3.1.2-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'rsync-debuginfo-3.1.2-3.ph1')) flag++;
