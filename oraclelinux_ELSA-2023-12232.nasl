...
the ELSA-2023-12232 advisory.
    ...
    - netfilter: nf_tables: fix null deref due to zeroed list head (Florian Westphal)  [Orabug: 35181628]
    {CVE-2023-1095}
    - sctp: fail if no bound addresses can be used for a given scope (Marcelo Ricardo Leitner)  [Orabug:
    35181461]  {CVE-2023-1074}
    - HID: check empty report_list in hid_validate_values() (Pietro Borrello)  [Orabug: 35181168]
    {CVE-2023-1073}
    - media: uvcvideo: Avoid cyclic entity chains due to malformed USB descriptors (Will Deacon)  [Orabug:
    35180270]  {CVE-2020-0404}
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-4.1.12-124.73.2.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-124.73.2.el6uek', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'},
    ...
    {'reference':'kernel-uek-doc-4.1.12-124.73.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-124.73.2.el7uek', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'}
];
