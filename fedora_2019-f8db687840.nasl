...
# extracted from Fedora Security Advisory FEDORA-2019-f8db687840.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-f8db687840");

  script_name(english:"Fedora 29 : php-symfony (2019-f8db687840)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-f8db687840");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"php-symfony-2.8.51-1.fc29")) flag++;
