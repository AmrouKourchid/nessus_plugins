...
# extracted from Fedora Security Advisory FEDORA-2023-4a48637c3f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4a48637c3f");

  script_name(english:"Fedora 37 : dotnet6.0 (2023-4a48637c3f)");
...
FEDORA-2023-4a48637c3f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4a48637c3f");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.120-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
