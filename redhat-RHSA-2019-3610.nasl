...
# extracted from Red Hat Security Advisory RHSA-2019:3610. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3610");

  script_name(english:"RHEL 8 : libqb (RHSA-2019:3610)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libqb.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:3610 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3610.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d654468");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.1_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8d3b26b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3610");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1695948");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1718773");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libqb package based on the guidance in RHSA-2019:3610.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libqb-1.0.3-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libqb-devel-1.0.3-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
