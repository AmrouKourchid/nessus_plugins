...
# extracted from Fedora Security Advisory FEDORA-2023-1c069009b8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-1c069009b8");

  script_name(english:"Fedora 39 : bind9-next (2023-1c069009b8)");
...
FEDORA-2023-1c069009b8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-1c069009b8");
...
var pkgs = [
    {'reference':'bind9-next-9.19.17-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
];
