...
# extracted from Fedora Security Advisory FEDORA-2024-b02e95ce83
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b02e95ce83");

  script_name(english:"Fedora 39 : dotnet6.0 (2024-b02e95ce83)");
...
FEDORA-2024-b02e95ce83 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b02e95ce83");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.127-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
