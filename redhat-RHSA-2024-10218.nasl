...
# extracted from Red Hat Security Advisory RHSA-2024:10218. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10218");

  script_name(english:"RHEL 9 : perl-App-cpanminus (RHSA-2024:10218)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for perl-App-cpanminus.");
...
the RHSA-2024:10218 advisory.

    Why? It's dependency free, requires zero configuration, and stands alone but it's maintainable and
    extensible with plug-ins and friendly to shell scripting. When running, it requires only 10 MB of RAM.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10218.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c9d1b420");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10218");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL perl-App-cpanminus package based on the guidance in RHSA-2024:10218.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'perl-App-cpanminus-1.7044-14.1.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'perl-App-cpanminus');
}
