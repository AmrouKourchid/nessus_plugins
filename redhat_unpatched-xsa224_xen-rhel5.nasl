...
# extracted from Red Hat Security Advisory xsa224_xen. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-10920", "CVE-2017-10921", "CVE-2017-10922");

  script_name(english:"RHEL 5 : xsa224_xen (Unpatched Vulnerability) (deprecated)");
