...
vulnerability.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K55812535");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K55812535.");
...
var vmatrix = {
  'LTM': {
    ...
    'unaffected': [
      '15.1.0','15.0.1.4','14.1.2.1','14.0.1.1','13.1.3.2'
    ],
  }
};
