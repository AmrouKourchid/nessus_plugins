...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : openjpeg2 (EulerOS-SA-2022-1048)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1048
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a46670e");
...
var pkgs = [
  "openjpeg2-2.3.0-9.h10.eulerosv2r8"
];
