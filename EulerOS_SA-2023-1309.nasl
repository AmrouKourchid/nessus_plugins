...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : curl (EulerOS-SA-2023-1309)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1309
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?defb4968");
...
var pkgs = [
  "curl-7.61.1-2.h27.eulerosv2r8",
  "libcurl-7.61.1-2.h27.eulerosv2r8",
  "libcurl-devel-7.61.1-2.h27.eulerosv2r8"
];
