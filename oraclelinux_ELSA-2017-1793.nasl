...
# Oracle Linux Security Advisory ELSA-2017-1793 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : graphite2 (ELSA-2017-1793)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2017:1793 :
...
original reporters of these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2017-July/007061.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"graphite2-1.3.10-1.el7_3")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"graphite2-devel-1.3.10-1.el7_3")) flag++;
