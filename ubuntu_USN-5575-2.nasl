...
the USN-5575-2 advisory.
    ...
    USN-5575-1 fixed vulnerabilities in Libxslt. This update provides the corresponding updates for Ubuntu
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libxslt1-dev', 'pkgver': '1.1.28-2.1ubuntu0.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libxslt1.1', 'pkgver': '1.1.28-2.1ubuntu0.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-libxslt1', 'pkgver': '1.1.28-2.1ubuntu0.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'xsltproc', 'pkgver': '1.1.28-2.1ubuntu0.3+esm1', 'ubuntu_pro': TRUE}
];
