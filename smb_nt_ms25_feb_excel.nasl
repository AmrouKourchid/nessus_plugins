...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002687");
  script_xref(name:"MSFT", value:"MS25-5002687");
  script_xref(name:"IAVA", value:"2025-A-0105");
  script_xref(name:"IAVA", value:"2025-A-0104-S");

  script_name(english:"Security Updates for Microsoft Excel Products (February 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Excel Products are missing a security update.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Excel Products are missing a security update. It is, therefore, affected by multiple remote code
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002687");
...
var constraints = [
  { 'kb':'5002687', 'channel':'MSI', 'fixed_version': '16.0.5487.1000', 'sp' : 0}
];
