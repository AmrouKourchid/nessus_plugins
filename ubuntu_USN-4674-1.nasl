...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Dovecot vulnerabilities (USN-4674-1)");
...
vulnerabilities as referenced in the USN-4674-1 advisory.
    ...
    It was discovered that Dovecot incorrectly handled certain imap hibernation commands. A remote
    authenticated attacker could possibly use this issue to access other users' email. This issue only
    affected Ubuntu 18.04 LTS, Ubuntu 20.04 LTS, and Ubuntu 20.10. (CVE-2020-24386)

    Innokentii Sennovskiy discovered that Dovecot incorrectly handled MIME parsing. A remote attacker could
    possibly use this issue to cause Dovecot to crash, resulting in a denial of service. (CVE-2020-25275)
