...
# extracted from Fedora Security Advisory FEDORA-2024-4d68c5928c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4d68c5928c");

  script_name(english:"Fedora 39 : dnsdist (2024-4d68c5928c)");
...
FEDORA-2024-4d68c5928c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4d68c5928c");
...
var pkgs = [
    {'reference':'dnsdist-1.9.7-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
