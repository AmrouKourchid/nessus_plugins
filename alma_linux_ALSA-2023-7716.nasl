...
# AlmaLinux Security Advisory ALSA-2023:7716.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:7716");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/12/25");

  script_name(english:"AlmaLinux 8 : webkit2gtk3 (ALSA-2023:7716)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2023:7716 advisory.

  - A memory corruption vulnerability was addressed with improved locking. (CVE-2023-42917)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-7716.html");
...
var pkgs = [
    {'reference':'webkit2gtk3-2.40.5-1.el8_9.1.alma.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'webkit2gtk3-devel-2.40.5-1.el8_9.1.alma.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'webkit2gtk3-jsc-2.40.5-1.el8_9.1.alma.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'webkit2gtk3-jsc-devel-2.40.5-1.el8_9.1.alma.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
