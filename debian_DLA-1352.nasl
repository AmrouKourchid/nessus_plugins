...
# extracted from Debian Security Advisory DLA-1352-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1352-1 : jruby security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/04/msg00017.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/wheezy/jruby");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"jruby", reference:"1.5.6-5+deb7u2")) flag++;
