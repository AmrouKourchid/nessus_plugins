...
# extracted from Fedora Security Advisory FEDORA-2023-6d4055d482
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6d4055d482");

  script_name(english:"Fedora 36 : httpd (2023-6d4055d482)");
...
FEDORA-2023-6d4055d482 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6d4055d482");
...
var pkgs = [
    {'reference':'httpd-2.4.55-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
