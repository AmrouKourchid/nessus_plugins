...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Iniparser PHSA-2025-5.0-0480");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the iniparser package has been released.");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:iniparser");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'iniparser-4.1-3.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'iniparser-devel-4.1-3.ph5')) flag++;
