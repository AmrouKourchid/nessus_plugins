...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-0840");
...
patch available.
  ...
  - tables/apr_hash.c in the Apache Portable Runtime (APR) library through 1.4.5 computes hash values without
    ...
    to cause a denial of service (CPU consumption) via crafted input to an application that maintains a hash
    table. (CVE-2012-0840)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-0840");
