...
# extracted from Amazon Linux 2 Security Advisory ALASDOCKER-2024-046.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : amazon-ecr-credential-helper (ALASDOCKER-2024-046)");
...
by a vulnerability as referenced in the ALAS2DOCKER-2024-046 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASDOCKER-2024-046.html");
