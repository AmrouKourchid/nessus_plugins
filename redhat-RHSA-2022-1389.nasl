...
referenced in the RHSA-2022:1389 advisory.
    ...
    This release adds the new Apache HTTP Server 2.4.37 Service Pack 11 packages that are part of the JBoss
    ...
    Pack 10 and includes bug fixes and enhancements. Refer to the Release Notes for information on the most
    significant bug fixes and enhancements included in this release.

    Security Fix(es):

    * jbcs-httpd24-httpd: httpd: HTTP request smuggling vulnerability in Apache HTTP Server 2.4.52 and earlier
    (CVE-2022-22720)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1389.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3239cd74");
...
"Update the RHEL Red Hat JBoss Core Services Apache HTTP Server 2.4.37 SP11 package based on the guidance in
RHSA-2022:1389.");
