...
if (description)
{
  ...
  script_cve_id("CVE-2019-19080");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-19080 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-19080");
