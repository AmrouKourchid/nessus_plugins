...
# extracted from Fedora Security Advisory FEDORA-2023-7cdf31bb36
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7cdf31bb36");
  script_xref(name:"IAVA", value:"2023-A-0585-S");

  script_name(english:"Fedora 38 : firefox (2023-7cdf31bb36)");
...
FEDORA-2023-7cdf31bb36 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7cdf31bb36");
...
var pkgs = [
    {'reference':'firefox-119.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
