...
# extracted from Red Hat Security Advisory RHSA-2023:5046. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5046");

  script_name(english:"RHEL 8 : flac (RHSA-2023:5046)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for flac.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:5046 advisory.

    FLAC stands for Free Lossless Audio Codec. FLAC is similar to Ogg Vorbis, but lossless. The FLAC project
    consists of the stream format, reference encoders and decoders in library form, a command-line program to
    encode and decode FLAC files, and a command-line metadata editor for FLAC files.

    Security Fix(es):

    * flac: Remote Code Execution (RCE) via the bitwriter_grow_ function, by supplying crafted input to the
    encoder (CVE-2020-22219)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5046.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f4f5c0cb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2235489");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5046");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL flac package based on the guidance in RHSA-2023:5046.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'flac-1.3.2-9.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flac-devel-1.3.2-9.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flac-libs-1.3.2-9.el8_8.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'flac-1.3.2-9.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flac-devel-1.3.2-9.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'flac-libs-1.3.2-9.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
