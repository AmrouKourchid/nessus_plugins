...
# extracted from Red Hat Security Advisory java-1.7.0-oracle. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-3511");

  script_name(english:"RHEL 5 : java-1.7.0-oracle (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-3511");
