...
# extracted from ZTE advisory NS-SA-2020-0037. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.01 : unbound Multiple Vulnerabilities (NS-SA-2020-0037)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.01, has unbound packages installed that are affected by multiple
vulnerabilities:
  ...
  - Unbound 1.6.4 through 1.9.4 contain a vulnerability in
    ...
    `--enable-ipsecmod` support, and ipsecmod is enabled and
    used in the configuration. (CVE-2019-18934)

  - Unbound before 1.10.1 has an infinite loop via malformed
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2020-0037");
...
pkgs = {
  "CGSL MAIN 6.01": [
    ...
    "python3-unbound-debuginfo-1.7.3-11.el8_2",
    "unbound-1.7.3-11.el8_2",
    "unbound-debuginfo-1.7.3-11.el8_2",
    "unbound-debugsource-1.7.3-11.el8_2",
    "unbound-devel-1.7.3-11.el8_2",
    "unbound-libs-1.7.3-11.el8_2",
    "unbound-libs-debuginfo-1.7.3-11.el8_2"
  ]
};
