...
if (description)
{
  ...
  script_name(english:"Debian dla-3675 : libbarcode-zbar-perl - security update");
...
dla-3675 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3675-1                debian-lts@lists.debian.org
...
"Upgrade the libbarcode-zbar-perl packages.");
