...
# extracted from Fedora Security Advisory FEDORA-2025-3f77ed652b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3f77ed652b");

  script_name(english:"Fedora 40 : upx (2025-3f77ed652b)");
...
FEDORA-2025-3f77ed652b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3f77ed652b");
...
var pkgs = [
    {'reference':'upx-5.0.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
