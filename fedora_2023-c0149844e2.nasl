...
# extracted from Fedora Security Advisory FEDORA-2023-c0149844e2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c0149844e2");

  script_name(english:"Fedora 37 : containernetworking-plugins (2023-c0149844e2)");
...
FEDORA-2023-c0149844e2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c0149844e2");
...
var pkgs = [
    {'reference':'containernetworking-plugins-1.1.1-16.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
