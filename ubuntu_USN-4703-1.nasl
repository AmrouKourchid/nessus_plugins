...
# extracted from Ubuntu Security Notice USN-4703-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4703-1");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : Mutt vulnerability (USN-4703-1)");
...
referenced in the USN-4703-1 advisory.

    It was discovered that Mutt incorrectly handled certain email messages. An attacker could possibly use
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4703-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'mutt', 'pkgver': '1.5.24-1ubuntu0.6'},
    {'osver': '16.04', 'pkgname': 'mutt-patched', 'pkgver': '1.5.24-1ubuntu0.6'},
    {'osver': '18.04', 'pkgname': 'mutt', 'pkgver': '1.9.4-3ubuntu0.5'},
    {'osver': '20.04', 'pkgname': 'mutt', 'pkgver': '1.13.2-1ubuntu0.4'}
];
