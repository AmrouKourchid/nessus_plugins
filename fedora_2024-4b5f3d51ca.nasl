...
# extracted from Fedora Security Advisory FEDORA-2024-4b5f3d51ca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4b5f3d51ca");

  script_name(english:"Fedora 41 : jupyterlab / python-notebook (2024-4b5f3d51ca)");
...
FEDORA-2024-4b5f3d51ca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4b5f3d51ca");
...
var pkgs = [
    {'reference':'jupyterlab-4.2.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-notebook-7.2.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
