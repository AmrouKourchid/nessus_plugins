...
# extracted from Red Hat Security Advisory RHSA-2019:4358. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:4358");

  script_name(english:"RHEL 8 : openstack-keystone (RHSA-2019:4358)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openstack-keystone.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:4358 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1781470");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_4358.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8a2246a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:4358");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-keystone package based on the guidance in RHSA-2019:4358.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-19687");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-keystone-15.0.1-0.20190720060412.5f27c4b.1.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python3-keystone-15.0.1-0.20190720060412.5f27c4b.1.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
