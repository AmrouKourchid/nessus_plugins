...
# SUSE update advisory SUSE-SU-2023:2838-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2018-21009", "CVE-2019-12293", "CVE-2022-27337");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2838-1");

  script_name(english:"openSUSE 15 Security Update : poppler (SUSE-SU-2023:2838-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote openSUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote openSUSE 15 host has packages installed that are affected by multiple vulnerabilities as referenced in the
SUSE-SU-2023:2838-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-July/015498.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb525a46");
...
var pkgs = [
    {'reference':'libpoppler73-0.62.0-150000.4.15.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'libpoppler73-32bit-0.62.0-150000.4.15.1', 'cpu':'x86_64', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']}
];
