...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1289.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c319c24a");
...
"Update the RHEL haproxy package based on the guidance in RHSA-2020:1289.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy-1.8.15-5.el8_0.1', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'haproxy-1.8.15-5.el8_0.1', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
