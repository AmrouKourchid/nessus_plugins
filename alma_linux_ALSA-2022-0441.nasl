...
# AlmaLinux Security Advisory ALSA-2022:0441.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:0441");

  script_name(english:"AlmaLinux 8 : aide (ALSA-2022:0441)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-0441.html");
...
"Update the affected aide package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:aide");
