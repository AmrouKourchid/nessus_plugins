...
# extracted from Fedora Security Advisory FEDORA-2019-68d7f68507.
#
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-68d7f68507");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2019-68d7f68507");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC31", reference:"microcode_ctl-2.1-33.fc31", epoch:"2")) flag++;
if (rpm_check(release:"FC31", reference:"kernel-5.3.11-300.fc31")) flag++;
if (rpm_check(release:"FC31", reference:"kernel-headers-5.3.11-300.fc31")) flag++;
if (rpm_check(release:"FC31", reference:"kernel-tools-5.3.11-300.fc31")) flag++;
