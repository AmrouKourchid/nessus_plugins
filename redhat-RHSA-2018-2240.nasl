...
# extracted from Red Hat Security Advisory RHSA-2018:2240. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2240");

  script_name(english:"RHEL 7 : openslp (RHSA-2018:2240)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openslp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:2240 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2240.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?721766fd");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1572166");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2240");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2017-17833");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openslp package based on the guidance in RHSA-2018:2240.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openslp-2.0.0-7.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openslp-devel-2.0.0-7.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openslp-server-2.0.0-7.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
