...
if (description)
{
  ...
  script_cve_id("CVE-2014-9844", "CVE-2014-9913", "CVE-2016-9844");

  script_name(english:"Photon OS 1.0: Unzip PHSA-2017-0040");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'unzip-6.0-8.ph1')) flag++;
