...
if (description)
{
  ...
  script_bugtraq_id(108875, 108452);
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3669.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?853b216f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:3669");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1707109");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1857228");
...
"Update the RHEL postgresql:10 package based on the guidance in RHSA-2020:3669.");
  ...
  'postgresql:10': [
    {
      ...
      'pkgs': [
        {'reference':'postgresql-10.14-1.module+el8.2.0+7801+be0fed80', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-10.14-1.module+el8.2.0+7801+be0fed80', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-10.14-1.module+el8.2.0+7801+be0fed80', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-10.14-1.module+el8.2.0+7801+be0fed80', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-10.14-1.module+el8.2.0+7801+be0fed80', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-10.14-1.module+el8.2.0+7801+be0fed80', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-10.14-1.module+el8.2.0+7801+be0fed80', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-10.14-1.module+el8.2.0+7801+be0fed80', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-10.14-1.module+el8.2.0+7801+be0fed80', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-10.14-1.module+el8.2.0+7801+be0fed80', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-10.14-1.module+el8.2.0+7801+be0fed80', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-10.14-1.module+el8.2.0+7801+be0fed80', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-10.14-1.module+el8.2.0+7801+be0fed80', 'sp':'2', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'postgresql-10.14-1.module+el8.2.0+7801+be0fed80', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-10.14-1.module+el8.2.0+7801+be0fed80', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-10.14-1.module+el8.2.0+7801+be0fed80', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-10.14-1.module+el8.2.0+7801+be0fed80', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-10.14-1.module+el8.2.0+7801+be0fed80', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-10.14-1.module+el8.2.0+7801+be0fed80', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-10.14-1.module+el8.2.0+7801+be0fed80', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-10.14-1.module+el8.2.0+7801+be0fed80', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-10.14-1.module+el8.2.0+7801+be0fed80', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-10.14-1.module+el8.2.0+7801+be0fed80', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-10.14-1.module+el8.2.0+7801+be0fed80', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-10.14-1.module+el8.2.0+7801+be0fed80', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-10.14-1.module+el8.2.0+7801+be0fed80', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
