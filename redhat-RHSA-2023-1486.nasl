...
# extracted from Red Hat Security Advisory RHSA-2023:1486. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1486");

  script_name(english:"RHEL 7 : Red Hat Gluster Storage web-admin-build (RHSA-2023:1486)");
...
referenced in the RHSA-2023:1486 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1486.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2c8dcf36");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1486");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2099524");
...
"Update the RHEL Red Hat Gluster Storage web-admin-build package based on the guidance in RHSA-2023:1486.");
  ...
  script_cwe_id(23, 179, 400, 444, 770);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-5.2.4-6.el7rhgs', 'cpu':'x86_64', 'release':'7', 'el_string':'el7rhgs', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'glusterfs', 'cves':['CVE-2022-31129']},
      {'reference':'rubygem-puma-4.3.12-1.el7rhgs', 'cpu':'x86_64', 'release':'7', 'el_string':'el7rhgs', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'glusterfs', 'cves':['CVE-2022-24790']},
      {'reference':'rubygem-puma-doc-4.3.12-1.el7rhgs', 'release':'7', 'el_string':'el7rhgs', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'glusterfs', 'cves':['CVE-2022-24790']},
      {'reference':'rubygem-rack-2.2.4-1.el7rhgs', 'release':'7', 'el_string':'el7rhgs', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'glusterfs', 'cves':['CVE-2022-30122', 'CVE-2022-30123']},
      {'reference':'rubygem-rack-doc-2.2.4-1.el7rhgs', 'release':'7', 'el_string':'el7rhgs', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'glusterfs', 'cves':['CVE-2022-30122', 'CVE-2022-30123']},
      {'reference':'rubygem-tzinfo-1.2.10-1.el7rhgs', 'release':'7', 'el_string':'el7rhgs', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'glusterfs', 'cves':['CVE-2022-31163']},
      {'reference':'rubygem-tzinfo-doc-1.2.10-1.el7rhgs', 'release':'7', 'el_string':'el7rhgs', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'glusterfs', 'cves':['CVE-2022-31163']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'grafana / rubygem-puma / rubygem-puma-doc / rubygem-rack / etc');
}
