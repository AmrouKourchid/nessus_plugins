...
# extracted from Debian Security Advisory dsa-5761. The text
...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2024-A-0531-S");

  script_name(english:"Debian dsa-5761 : chromium - security update");
...
dsa-5761 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5761-1                   security@debian.org
    https://www.debian.org/security/                           Andres Salomon
    August 29, 2024                       https://www.debian.org/security/faq
    - -------------------------------------------------------------------------

    Package        : chromium
    CVE ID         : CVE-2024-7969 CVE-2024-8193 CVE-2024-8194 CVE-2024-8198
    ...
    version 128.0.6613.113-1~deb12u1.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-8193");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-8194");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-8198");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'chromium', 'reference': '128.0.6613.113-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-common', 'reference': '128.0.6613.113-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-driver', 'reference': '128.0.6613.113-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-l10n', 'reference': '128.0.6613.113-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-sandbox', 'reference': '128.0.6613.113-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-shell', 'reference': '128.0.6613.113-1~deb12u1'}
];
