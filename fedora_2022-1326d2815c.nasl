...
# extracted from Fedora Security Advisory FEDORA-2022-1326d2815c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-1326d2815c");

  script_name(english:"Fedora 37 : unbound (2022-1326d2815c)");
...
FEDORA-2022-1326d2815c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-1326d2815c");
...
var pkgs = [
    {'reference':'unbound-1.16.3-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
