...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?996028c6");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1587.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b0593446");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1587");
...
"Update the RHEL python package based on the guidance in RHSA-2019:1587.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-2.7.5-80.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-debug-2.7.5-80.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-devel-2.7.5-80.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-libs-2.7.5-80.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-test-2.7.5-80.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-tools-2.7.5-80.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tkinter-2.7.5-80.el7_6', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
