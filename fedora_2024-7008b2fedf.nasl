...
# extracted from Fedora Security Advisory FEDORA-2024-7008b2fedf
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-0397", "CVE-2024-6923", "CVE-2024-8088");
  script_xref(name:"FEDORA", value:"2024-7008b2fedf");

  script_name(english:"Fedora 39 : mingw-python3 (2024-7008b2fedf)");
...
FEDORA-2024-7008b2fedf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7008b2fedf");
...
"Update the affected mingw-python3 package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-0397");
...
var pkgs = [
    {'reference':'mingw-python3-3.11.9-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
