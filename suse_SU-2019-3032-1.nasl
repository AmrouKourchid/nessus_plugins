...
# extracted from SUSE update advisory SUSE-SU-2019:3032-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : dpdk (SUSE-SU-2019:3032-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2019/suse-su-20193032-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3d585dd1");
...
patch SUSE-SLE-SDK-12-SP4-2019-3032=1

SUSE Linux Enterprise Server 12-SP4:zypper in -t patch
SUSE-SLE-SERVER-12-SP4-2019-3032=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"dpdk-17.11.7-5.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"dpdk-debuginfo-17.11.7-5.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"dpdk-debugsource-17.11.7-5.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"dpdk-kmp-default-17.11.7_k4.12.14_95.37-5.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"dpdk-kmp-default-debuginfo-17.11.7_k4.12.14_95.37-5.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"dpdk-tools-17.11.7-5.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"dpdk-tools-debuginfo-17.11.7-5.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"libdpdk-17_11-17.11.7-5.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"4", cpu:"x86_64", reference:"libdpdk-17_11-debuginfo-17.11.7-5.3.2")) flag++;
