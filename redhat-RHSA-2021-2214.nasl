...
# extracted from Red Hat Security Advisory RHSA-2021:2214. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:2214");

  script_name(english:"RHEL 8 : firefox (RHSA-2021:2214)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2214.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ccf6f7e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2214");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1966831");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2021:2214.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-78.11.0-3.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
