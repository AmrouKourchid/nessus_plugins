...
# extracted from Ubuntu Security Notice USN-6513-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6513-2");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.04 : Python vulnerability (USN-6513-2)");
...
referenced in the USN-6513-2 advisory.

    USN-6513-1 fixed vulnerabilities in Python. This update provides the corresponding updates for Ubuntu
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6513-2");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'idle-python3.8', 'pkgver': '3.8.10-0ubuntu1~20.04.9'},
    {'osver': '20.04', 'pkgname': 'libpython3.8', 'pkgver': '3.8.10-0ubuntu1~20.04.9'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-dev', 'pkgver': '3.8.10-0ubuntu1~20.04.9'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-minimal', 'pkgver': '3.8.10-0ubuntu1~20.04.9'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-stdlib', 'pkgver': '3.8.10-0ubuntu1~20.04.9'},
    {'osver': '20.04', 'pkgname': 'libpython3.8-testsuite', 'pkgver': '3.8.10-0ubuntu1~20.04.9'},
    {'osver': '20.04', 'pkgname': 'python3.8', 'pkgver': '3.8.10-0ubuntu1~20.04.9'},
    {'osver': '20.04', 'pkgname': 'python3.8-dev', 'pkgver': '3.8.10-0ubuntu1~20.04.9'},
    {'osver': '20.04', 'pkgname': 'python3.8-examples', 'pkgver': '3.8.10-0ubuntu1~20.04.9'},
    {'osver': '20.04', 'pkgname': 'python3.8-full', 'pkgver': '3.8.10-0ubuntu1~20.04.9'},
    {'osver': '20.04', 'pkgname': 'python3.8-minimal', 'pkgver': '3.8.10-0ubuntu1~20.04.9'},
    {'osver': '20.04', 'pkgname': 'python3.8-venv', 'pkgver': '3.8.10-0ubuntu1~20.04.9'},
    {'osver': '22.04', 'pkgname': 'idle-python3.10', 'pkgver': '3.10.12-1~22.04.3'},
    {'osver': '22.04', 'pkgname': 'libpython3.10', 'pkgver': '3.10.12-1~22.04.3'},
    {'osver': '22.04', 'pkgname': 'libpython3.10-dev', 'pkgver': '3.10.12-1~22.04.3'},
    {'osver': '22.04', 'pkgname': 'libpython3.10-minimal', 'pkgver': '3.10.12-1~22.04.3'},
    {'osver': '22.04', 'pkgname': 'libpython3.10-stdlib', 'pkgver': '3.10.12-1~22.04.3'},
    {'osver': '22.04', 'pkgname': 'libpython3.10-testsuite', 'pkgver': '3.10.12-1~22.04.3'},
    {'osver': '22.04', 'pkgname': 'python3.10', 'pkgver': '3.10.12-1~22.04.3'},
    {'osver': '22.04', 'pkgname': 'python3.10-dev', 'pkgver': '3.10.12-1~22.04.3'},
    {'osver': '22.04', 'pkgname': 'python3.10-examples', 'pkgver': '3.10.12-1~22.04.3'},
    {'osver': '22.04', 'pkgname': 'python3.10-full', 'pkgver': '3.10.12-1~22.04.3'},
    {'osver': '22.04', 'pkgname': 'python3.10-minimal', 'pkgver': '3.10.12-1~22.04.3'},
    {'osver': '22.04', 'pkgname': 'python3.10-nopie', 'pkgver': '3.10.12-1~22.04.3'},
    {'osver': '22.04', 'pkgname': 'python3.10-venv', 'pkgver': '3.10.12-1~22.04.3'},
    {'osver': '23.04', 'pkgname': 'idle-python3.11', 'pkgver': '3.11.4-1~23.04.1'},
    {'osver': '23.04', 'pkgname': 'libpython3.11', 'pkgver': '3.11.4-1~23.04.1'},
    {'osver': '23.04', 'pkgname': 'libpython3.11-dev', 'pkgver': '3.11.4-1~23.04.1'},
    {'osver': '23.04', 'pkgname': 'libpython3.11-minimal', 'pkgver': '3.11.4-1~23.04.1'},
    {'osver': '23.04', 'pkgname': 'libpython3.11-stdlib', 'pkgver': '3.11.4-1~23.04.1'},
    {'osver': '23.04', 'pkgname': 'libpython3.11-testsuite', 'pkgver': '3.11.4-1~23.04.1'},
    {'osver': '23.04', 'pkgname': 'python3.11', 'pkgver': '3.11.4-1~23.04.1'},
    {'osver': '23.04', 'pkgname': 'python3.11-dev', 'pkgver': '3.11.4-1~23.04.1'},
    {'osver': '23.04', 'pkgname': 'python3.11-examples', 'pkgver': '3.11.4-1~23.04.1'},
    {'osver': '23.04', 'pkgname': 'python3.11-full', 'pkgver': '3.11.4-1~23.04.1'},
    {'osver': '23.04', 'pkgname': 'python3.11-minimal', 'pkgver': '3.11.4-1~23.04.1'},
    {'osver': '23.04', 'pkgname': 'python3.11-nopie', 'pkgver': '3.11.4-1~23.04.1'},
    {'osver': '23.04', 'pkgname': 'python3.11-venv', 'pkgver': '3.11.4-1~23.04.1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'idle-python3.10 / idle-python3.11 / idle-python3.8 / libpython3.10 / etc');
}
