...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : procps-ng (EulerOS-SA-2023-3106)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3106
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?14976936");
...
var pkgs = [
  "procps-ng-3.3.16-15.h8.eulerosv2r9",
  "procps-ng-i18n-3.3.16-15.h8.eulerosv2r9"
];
