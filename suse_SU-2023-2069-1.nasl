...
in the SUSE-SU-2023:2069-1 advisory.
...
var pkgs = [
    {'reference':'shadow-4.2.1-27.22.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
    ...
    {'reference':'shadow-4.2.1-27.22.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-4']}
];
