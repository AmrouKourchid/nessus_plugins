...
# extracted from Red Hat Security Advisory RHSA-2024:6849. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6849");

  script_name(english:"RHEL 8 : edk2 (RHSA-2024:6849)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6849.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4b771177");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2258700");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6849");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL edk2 package based on the guidance in RHSA-2024:6849.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'edk2-ovmf-20190829git37eef91017ad-9.el8_2.5', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
