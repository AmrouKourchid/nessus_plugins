...
# AlmaLinux Security Advisory ALSA-2020:4483.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2020:4483");

  script_name(english:"AlmaLinux 8 : opensc (ALSA-2020:4483)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2020-4483.html");
...
var pkgs = [
    {'reference':'opensc-0.20.0-2.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'opensc-0.20.0-2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
