...
a vulnerability as referenced in the K32469285 advisory.
    ...
    and - Tomcat did not ensure that, if present, the chunked encoding was the final
    encoding.(CVE-2021-33037)ImpactA remote attacker may be able to bypass security controls and gain access
    to restricted content, such as a site administration page.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K32469285");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.0.0-17.1.2','16.0.0-16.1.5','15.1.0-15.1.10','14.1.0-14.1.5','13.1.0-13.1.5','12.1.0-12.1.6','11.6.1-11.6.5'
    ],
  },
  'APM': {
    'affected': [
