...
# AlmaLinux Security Advisory ALSA-2023:5200.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:5200");
  ...
  script_name(english:"AlmaLinux 9 : firefox (ALSA-2023:5200)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-5200.html");
...
var pkgs = [
    {'reference':'firefox-102.15.1-1.el9_2.alma.plus', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.15.1-1.el9_2.alma.plus', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-x11-102.15.1-1.el9_2.alma.plus', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-x11-102.15.1-1.el9_2.alma.plus', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
