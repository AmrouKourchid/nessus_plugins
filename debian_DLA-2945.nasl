...
# extracted from Debian Security Advisory dla-2945. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2945-1 : tryton-server - LTS security update");
...
dla-2945 advisory.
    ...
    Jeremy Mousset discovered two XML parsing vulnerabilities in the Tryton application platform, which may
    result in information disclosure or denial of service. For Debian 9 stretch, these problems have been
    fixed in version 4.2.1-2+deb9u2. We recommend that you upgrade your tryton-server packages. For the
    detailed security status of tryton-server please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/tryton-server Further information about Debian LTS security advisories, how to
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2945");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/tryton-server");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'tryton-server', 'reference': '4.2.1-2+deb9u2'},
    {'release': '9.0', 'prefix': 'tryton-server-doc', 'reference': '4.2.1-2+deb9u2'}
];
