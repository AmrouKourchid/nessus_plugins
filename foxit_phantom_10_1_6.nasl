...
if (description)
{
  ...
  script_name(english:"Foxit PhantomPDF < 10.1.6 Multiple Vulnerabilities");
...
host is prior to 10.1.6. It is, therefore affected by multiple vulnerabilities:
...
"Upgrade to Foxit PhantomPDF version 10.1.6 or later");
...
var constraints = [
  { 'max_version' : '10.1.5.37672', 'fixed_version' : '10.1.6' }
];
