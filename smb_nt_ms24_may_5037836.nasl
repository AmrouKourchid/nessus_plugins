...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5037800");
  script_xref(name:"MSKB", value:"5037836");
  script_xref(name:"MSFT", value:"MS24-5037800");
  script_xref(name:"MSFT", value:"MS24-5037836");
  script_xref(name:"IAVA", value:"2024-A-0282-S");

  script_name(english:"KB5037836: Windows Server 2008 Security Update (May 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5037836. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5037800");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5037836");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5037836 or Cumulative Update 5037800");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-30009");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-30030");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'05_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5037836, 5037800])
)
{
