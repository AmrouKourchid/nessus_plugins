...
# extracted from Fedora Security Advisory FEDORA-2022-8e5d214237
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8e5d214237");

  script_name(english:"Fedora 38 : grafana (2022-8e5d214237)");
...
FEDORA-2022-8e5d214237 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8e5d214237");
...
var pkgs = [
    {'reference':'grafana-9.0.9-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
