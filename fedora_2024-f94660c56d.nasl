...
# extracted from Fedora Security Advisory FEDORA-2024-f94660c56d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f94660c56d");

  script_name(english:"Fedora 38 : chromium (2024-f94660c56d)");
...
FEDORA-2024-f94660c56d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f94660c56d");
...
var pkgs = [
    {'reference':'chromium-123.0.6312.122-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
