...
# extracted from Fedora Security Advisory FEDORA-2023-7490239652
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7490239652");

  script_name(english:"Fedora 36 : php-Smarty (2023-7490239652)");
...
FEDORA-2023-7490239652 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7490239652");
...
var pkgs = [
    {'reference':'php-Smarty-3.1.48-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
