...
# extracted from Gentoo Linux Security Advisory GLSA 202409-05.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202409-05 : PJSIP: Heap Buffer Overflow");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202409-05 (PJSIP: Heap Buffer Overflow)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202409-05");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=917463");
...
"All PJSIP users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-27585");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 2.13.1"),
    'vulnerable' : make_list("lt 2.13.1")
  }
];
