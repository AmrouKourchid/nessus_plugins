...
# extracted from Debian Security Advisory DSA-4811. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4811");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Debian DSA-4811-1 : libxstream-java - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"It was discovered that the default blacklist of XStream, a Java
library to serialise objects to XML and back again, was vulnerable to
the execution of arbitrary shell commands by manipulating the
...
https://github.com/x-stream/xstream/security/advisories/GHSA-mw36-7c6c
-q4q2");
  # https://github.com/x-stream/xstream/security/advisories/GHSA-mw36-7c6c-q4q2
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d346353f");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2020/dsa-4811");
...
flag = 0;
if (deb_check(release:"10.0", prefix:"libxstream-java", reference:"1.4.11.1-1+deb10u1")) flag++;
