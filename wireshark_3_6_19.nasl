...
if (description)
{
  ...
  script_name(english:"Wireshark 3.6.x < 3.6.19 A Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote Windows host is prior to 3.6.19. It is, therefore, affected by a
vulnerability as referenced in the wireshark-3.6.19 advisory.
