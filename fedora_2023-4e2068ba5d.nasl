...
# extracted from Fedora Security Advisory FEDORA-2023-4e2068ba5d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-4e2068ba5d");

  script_name(english:"Fedora 38 : golang-github-need-being-tree / golang-helm-3 / golang-oras / etc (2023-4e2068ba5d)");
...
FEDORA-2023-4e2068ba5d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-4e2068ba5d");
...
var pkgs = [
    {'reference':'golang-github-need-being-tree-0.1.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-helm-3-3.11.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-oras-0.15.1-1.20221105git690716b.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-oras-1-1.2.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-oras-2-2.0.0~rc.4-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
