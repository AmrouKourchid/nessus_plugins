...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : uboot-tools (EulerOS-SA-2022-2745)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2745
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e00ffc29");
...
var pkgs = [
  "uboot-tools-2018.09-8.h7.eulerosv2r9",
  "uboot-tools-help-2018.09-8.h7.eulerosv2r9"
];
