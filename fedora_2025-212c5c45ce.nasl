...
# extracted from Fedora Security Advisory FEDORA-2025-212c5c45ce
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-212c5c45ce");
  script_xref(name:"IAVA", value:"2025-A-0010-S");

  script_name(english:"Fedora 41 : chromium (2025-212c5c45ce)");
...
FEDORA-2025-212c5c45ce advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-212c5c45ce");
...
var pkgs = [
    {'reference':'chromium-131.0.6778.264-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
