...
# SUSE update advisory SUSE-SU-2024:0585-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:0585-1");

  script_name(english:"SUSE SLES15 Security Update : python-pycryptodome (SUSE-SU-2024:0585-1)");
...
in the SUSE-SU-2024:0585-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?359a775d");
...
var pkgs = [
    {'reference':'python3-pycryptodome-3.9.0-150100.3.6.1', 'sp':'2', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
    {'reference':'python3-pycryptodome-3.9.0-150100.3.6.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.2', 'SUSE-Manager-Proxy-release-4.1', 'SUSE-Manager-Server-release-4.1', 'sle-module-public-cloud-release-15.2', 'sles-release-15.2', 'suse-manager-server-release-4.1']}
];
