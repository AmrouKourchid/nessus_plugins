...
# extracted from Gentoo Linux Security Advisory GLSA 202009-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202009-06");

  script_name(english:"GLSA-202009-06 : GNOME File Roller: Directory traversal");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202009-06
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202009-06");
...
"All GNOME File Roller users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:file-roller");
...
if (qpkg_check(package:"app-arch/file-roller", unaffected:make_list("ge 3.36.3"), vulnerable:make_list("lt 3.36.3"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "GNOME File Roller");
}
