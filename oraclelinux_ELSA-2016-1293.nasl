...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : setroubleshoot / and / setroubleshoot-plugins (ELSA-2016-1293)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2016-1293 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-1293.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected setroubleshoot, setroubleshoot-plugins and / or setroubleshoot-server packages.");
...
var pkgs = [
    {'reference':'setroubleshoot-3.2.24-4.0.1.el7_2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'setroubleshoot-plugins-3.0.59-2.0.1.el7_2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'setroubleshoot-server-3.2.24-4.0.1.el7_2', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
