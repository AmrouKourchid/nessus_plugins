...
# Rocky Linux Security Advisory RLSA-2023:7836.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:7836");

  script_name(english:"Rocky Linux 8 : avahi (RLSA-2023:7836)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2023:7836 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:7836");
...
var pkgs = [
    ...
    {'reference':'avahi-autoipd-debuginfo-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-compat-howl-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-compat-howl-debuginfo-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'avahi-compat-libdns_sd-debuginfo-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-compat-libdns_sd-devel-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-debuginfo-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-debugsource-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'avahi-glib-debuginfo-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'avahi-gobject-debuginfo-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'avahi-libs-debuginfo-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-tools-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-tools-debuginfo-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-ui-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'avahi-ui-debuginfo-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'avahi-ui-gtk3-debuginfo-0.7-21.el8_9.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
