...
# extracted from Fedora Security Advisory FEDORA-2022-760d1eac9b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-760d1eac9b");

  script_name(english:"Fedora 35 : python3.7 (2022-760d1eac9b)");
...
FEDORA-2022-760d1eac9b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-760d1eac9b");
...
var pkgs = [
    {'reference':'python3.7-3.7.15-2.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
