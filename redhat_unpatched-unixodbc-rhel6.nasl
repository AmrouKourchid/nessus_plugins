...
# extracted from Red Hat Security Advisory unixodbc. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-7409", "CVE-2018-7485", "CVE-2024-1013");

  script_name(english:"RHEL 6 : unixodbc (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:compat-unixODBC234");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:unixODBC");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:unixODBC64");
