...
if (description)
{
  ...
  script_cve_id("CVE-2023-42363");

  script_name(english:"EulerOS 2.0 SP11 : busybox (EulerOS-SA-2024-2572)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2572
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?36f22290");
...
var pkgs = [
  "busybox-help-1.34.1-13.h13.eulerosv2r11"
];
