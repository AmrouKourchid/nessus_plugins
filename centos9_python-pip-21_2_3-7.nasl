...
if (description)
{
  ...
  script_name(english:"CentOS 9 : python-pip-21.2.3-7.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for python3-pip.");
...
pip-21.2.3-7.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=36200");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream python3-pip package.");
