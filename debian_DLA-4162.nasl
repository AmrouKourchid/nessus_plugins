...
# extracted from Debian Security Advisory dla-4162. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4162 : redis - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4162
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-4162-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-21605");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'redis', 'reference': '5:6.0.16-1+deb11u6'},
    {'release': '11.0', 'prefix': 'redis-sentinel', 'reference': '5:6.0.16-1+deb11u6'},
    {'release': '11.0', 'prefix': 'redis-server', 'reference': '5:6.0.16-1+deb11u6'},
    {'release': '11.0', 'prefix': 'redis-tools', 'reference': '5:6.0.16-1+deb11u6'}
];
