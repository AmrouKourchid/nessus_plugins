...
# extracted from Fedora Security Advisory FEDORA-2023-dd3ebcea25
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-dd3ebcea25");

  script_name(english:"Fedora 39 : linux-firmware (2023-dd3ebcea25)");
...
FEDORA-2023-dd3ebcea25 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-dd3ebcea25");
...
var pkgs = [
    {'reference':'linux-firmware-20230919-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
