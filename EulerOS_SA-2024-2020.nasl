...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : c-ares (EulerOS-SA-2024-2020)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd5de288");
...
var pkgs = [
  "c-ares-1.13.0-5.h3.eulerosv2r8",
  "c-ares-devel-1.13.0-5.h3.eulerosv2r8"
];
