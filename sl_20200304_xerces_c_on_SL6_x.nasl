...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : xerces-c on SL6.x i386/x86_64 (20200304)");
...
"Security Fix(es) :
  ...
  - xerces-c: XML parser contains a use-after-free error
    ...
    (CVE-2018-1311)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2003&L=SCIENTIFIC-LINUX-ERRATA&P=731
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e15a43fb");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"xerces-c-3.0.1-21.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"xerces-c-debuginfo-3.0.1-21.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"xerces-c-devel-3.0.1-21.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"xerces-c-doc-3.0.1-21.el6_10")) flag++;
