...
# extracted from Red Hat Security Advisory RHSA-2023:7581. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7581");
  script_xref(name:"IAVB", value:"2023-B-0088-S");

  script_name(english:"RHEL 8 : postgresql:13 (RHSA-2023:7581)");
...
referenced in the RHSA-2023:7581 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7581.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?056fb105");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7581");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:13 package based on the guidance in RHSA-2023:7581.");
  ...
  'postgresql:13': [
    {
      ...
      'pkgs': [
        {'reference':'pg_repack-1.4.6-3.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pgaudit-1.5.0-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgres-decoderbufs-0.10.0-2.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-13.13-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-13.13-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-13.13-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-13.13-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-13.13-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-13.13-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-13.13-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-13.13-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-13.13-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-13.13-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-13.13-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-13.13-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-13.13-1.module+el8.9.0+20664+9c30cf7f', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
