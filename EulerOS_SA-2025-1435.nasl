...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : python3 (EulerOS-SA-2025-1435)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1435
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a289db9");
...
var pkgs = [
  "python3-3.9.9-21.h17.eulerosv2r12",
  "python3-fgo-3.9.9-21.h17.eulerosv2r12",
  "python3-unversioned-command-3.9.9-21.h17.eulerosv2r12"
];
