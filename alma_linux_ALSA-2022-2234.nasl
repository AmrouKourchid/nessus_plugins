...
var appstreams = {
    'subversion:1.14': [
      ...
      {'reference':'libserf-1.3.9-9.module_el8.5.0+73+aa7e29ed', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'utf8proc-2.1.1-5.module_el8.5.0+73+aa7e29ed', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.5.0', 'rpm_spec_vers_cmp':TRUE}
    ]
};
