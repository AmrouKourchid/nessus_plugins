...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : policycoreutils (EulerOS-SA-2019-2400)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2400
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6797cea3");
...
pkgs = ["policycoreutils-2.2.5-15.h2",
        "policycoreutils-devel-2.2.5-15.h2",
        "policycoreutils-gui-2.2.5-15.h2",
        "policycoreutils-newrole-2.2.5-15.h2",
        "policycoreutils-python-2.2.5-15.h2",
        "policycoreutils-sandbox-2.2.5-15.h2"];
