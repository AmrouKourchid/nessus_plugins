...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2023:1791)");
...
var pkgs = [
    {'reference':'firefox-102.10.0-1.el7.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
