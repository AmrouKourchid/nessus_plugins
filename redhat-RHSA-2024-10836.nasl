...
# extracted from Red Hat Security Advisory RHSA-2024:10836. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10836");

  script_name(english:"RHEL 9 : python-tornado (RHSA-2024:10836)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10836.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?053767b0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10836");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-tornado package based on the guidance in RHSA-2024:10836.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-tornado-6.4.2-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
