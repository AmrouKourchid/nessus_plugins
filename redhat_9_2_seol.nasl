...
if (description)
{
  ...
  script_name(english:"Red Hat Enterprise Linux SEoL (9.2.x, 9.3.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Red Hat Enterprise Linux is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Red Hat Enterprise Linux is 9.2.x or 9.3.x. It is, therefore, no longer maintained by its 
vendor or provider.
...
var constraints = [
  { min_branch : '9.2', max_branch : '9.3', seol : 20250531, eseol : 20270531 }
];
