...
ELSA-2016-2098 advisory.
    ...
    [3.10.0-327.36.3]
    - [mm] remove gup_flags FOLL_WRITE games from __get_user_pages() (Alexander Gordeev) [1385123 1385124]
    {CVE-2016-5195}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-327.36.3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
