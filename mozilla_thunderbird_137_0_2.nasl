...
"The version of Thunderbird installed on the remote Windows host is prior to 137.0.2. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2025-26 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'137.0.2', severity:SECURITY_WARNING);
