...
# extracted from ZTE advisory NS-SA-2021-0102. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : pki-core Multiple Vulnerabilities (NS-SA-2021-0102)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0102");
