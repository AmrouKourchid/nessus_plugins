...
# extracted from Red Hat Security Advisory RHSA-2022:7692. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : xmlrpc-c (RHSA-2022:7692)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for xmlrpc-c.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:7692 advisory.

    XML-RPC is a remote procedure call (RPC) protocol that uses XML to encode its calls and HTTP as a
    transport mechanism. The xmlrpc-c packages provide a network protocol to allow a client program to make a
    simple RPC (remote procedure call) over the Internet. It converts an RPC into an XML document, sends it to
    a remote server using HTTP, and gets back the response in XML.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7692.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?88c2ef8b");
...
"Update the RHEL xmlrpc-c package based on the guidance in RHSA-2022:7692.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xmlrpc-c");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xmlrpc-c-c++");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xmlrpc-c-client");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xmlrpc-c-client++");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xmlrpc-c-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xmlrpc-c-1.51.0-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-c++-1.51.0-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-client++-1.51.0-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-client-1.51.0-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-devel-1.51.0-8.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
