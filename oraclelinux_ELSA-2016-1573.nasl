...
# Oracle Linux Security Advisory ELSA-2016-1573 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : squid (ELSA-2016-1573)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2016-1573.html");
...
"Update the affected squid package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-5408");
...
var pkgs = [
    {'reference':'squid-3.1.23-16.el6_8.6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
    {'reference':'squid-3.1.23-16.el6_8.6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
