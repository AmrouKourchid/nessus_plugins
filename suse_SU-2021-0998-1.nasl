...
# extracted from SUSE update advisory SUSE-SU-2021:0998-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : opensc (SUSE-SU-2021:0998-1)");
...
CVE-2019-19479: incorrect read operation during parsing of a SETCOS
file attribute (bsc#1158256)
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed15db6a");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"opensc-0.13.0-3.11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"opensc-debuginfo-0.13.0-3.11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"opensc-debugsource-0.13.0-3.11.1")) flag++;
