...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Pygments vulnerability (USN-2862-1)");
...
USN-2862-1 advisory.
    ...
    It was discovered that Pygments incorrectly sanitized strings used to search system fonts. An attacker
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2862-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-pygments', 'pkgver': '1.6+dfsg-1ubuntu1.1'},
    {'osver': '14.04', 'pkgname': 'python3-pygments', 'pkgver': '1.6+dfsg-1ubuntu1.1'}
];
