...
# extracted from Red Hat Security Advisory RHSA-2020:0870. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0870");

  script_name(english:"RHEL 7 : python-flask (RHSA-2020:0870)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-flask.");
...
the RHSA-2020:0870 advisory.

    Flask is a lightweight but extensible web development framework for Python based on the Werkzeug WSGI
    toolkit, and the Jinja 2 template engine.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0870.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?93a95e23");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0870");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1623131");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-flask package based on the guidance in RHSA-2020:0870.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-flask-0.10.1-5.el7_7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-flask');
}
