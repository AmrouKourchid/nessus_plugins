...
# extracted from Gentoo Linux Security Advisory GLSA 201904-21.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201904-21");

  script_name(english:"GLSA-201904-21 : SQLite: Remote code execution");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201904-21
(SQLite: Remote code execution)

    An integer overflow was discovered in SQLite&rsquo;s FTS3 extension.
  
Impact :

    A remote attacker could, by executing arbitrary SQL statements against a
      vulnerable host, execute arbitrary code.
  
Workaround :

    There is no known workaround at this time.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201904-21");
...
if (qpkg_check(package:"dev-db/sqlite", unaffected:make_list("ge 3.25.3"), vulnerable:make_list("lt 3.25.3"))) flag++;
