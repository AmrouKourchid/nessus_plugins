...
# extracted from Fedora Security Advisory FEDORA-2023-a990c93ed0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a990c93ed0");

  script_name(english:"Fedora 37 : python2.7 (2023-a990c93ed0)");
...
FEDORA-2023-a990c93ed0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a990c93ed0");
...
var pkgs = [
    {'reference':'python2.7-2.7.18-26.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
