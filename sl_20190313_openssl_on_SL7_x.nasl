...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openssl on SL7.x x86_64 (20190313)");
...
Bug Fix(es) :
  ...
  - Perform the RSA signature self-tests with SHA-256");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1903&L=SCIENTIFIC-LINUX-ERRATA&P=5409
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?63530bb6");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssl-1.0.2k-16.el7_6.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssl-debuginfo-1.0.2k-16.el7_6.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssl-devel-1.0.2k-16.el7_6.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssl-libs-1.0.2k-16.el7_6.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssl-perl-1.0.2k-16.el7_6.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"openssl-static-1.0.2k-16.el7_6.1")) flag++;
