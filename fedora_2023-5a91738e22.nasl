...
# extracted from Fedora Security Advisory FEDORA-2023-5a91738e22
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5a91738e22");

  script_name(english:"Fedora 38 : liferea (2023-5a91738e22)");
...
FEDORA-2023-5a91738e22 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5a91738e22");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:liferea package.");
...
var pkgs = [
    {'reference':'liferea-1.14.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
