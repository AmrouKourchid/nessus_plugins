...
# extracted from Debian Security Advisory DLA-1649-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1649-1 : spice security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/01/msg00026.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/spice");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libspice-server-dev", reference:"0.12.5-1+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"libspice-server1", reference:"0.12.5-1+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"libspice-server1-dbg", reference:"0.12.5-1+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"spice-client", reference:"0.12.5-1+deb8u7")) flag++;
