...
# extracted from Fedora Security Advisory FEDORA-2023-f3dedfef46
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f3dedfef46");

  script_name(english:"Fedora 38 : composer (2023-f3dedfef46)");
...
FEDORA-2023-f3dedfef46 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f3dedfef46");
...
var pkgs = [
    {'reference':'composer-2.6.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
