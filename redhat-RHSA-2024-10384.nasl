...
# extracted from Red Hat Security Advisory RHSA-2024:10384. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:10384");

  script_name(english:"RHEL 9 : tuned (RHSA-2024:10384)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for tuned.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:10384 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2324540");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2324541");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10384.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?96ddfcc7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10384");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL tuned package based on the guidance in RHSA-2024:10384.");
...
var constraints = [
  {
    'repo_relative_urls': [
      ...
      'content/dist/rhel9/9.4/ppc64le/sap-solutions/debug',
      'content/dist/rhel9/9.4/ppc64le/sap-solutions/os',
      'content/dist/rhel9/9.4/ppc64le/sap-solutions/source/SRPMS',
      'content/dist/rhel9/9.4/ppc64le/sap/debug',
      'content/dist/rhel9/9.4/ppc64le/sap/os',
      'content/dist/rhel9/9.4/ppc64le/sap/source/SRPMS',
      ...
      'content/dist/rhel9/9.4/s390x/sap/debug',
      'content/dist/rhel9/9.4/s390x/sap/os',
      'content/dist/rhel9/9.4/s390x/sap/source/SRPMS',
      ...
      'content/dist/rhel9/9.4/x86_64/sap-solutions/debug',
      'content/dist/rhel9/9.4/x86_64/sap-solutions/os',
      'content/dist/rhel9/9.4/x86_64/sap-solutions/source/SRPMS',
      'content/dist/rhel9/9.4/x86_64/sap/debug',
      'content/dist/rhel9/9.4/x86_64/sap/os',
      'content/dist/rhel9/9.4/x86_64/sap/source/SRPMS',
      ...
      'content/dist/rhel9/9.5/ppc64le/sap-solutions/debug',
      'content/dist/rhel9/9.5/ppc64le/sap-solutions/os',
      'content/dist/rhel9/9.5/ppc64le/sap-solutions/source/SRPMS',
      'content/dist/rhel9/9.5/ppc64le/sap/debug',
      'content/dist/rhel9/9.5/ppc64le/sap/os',
      'content/dist/rhel9/9.5/ppc64le/sap/source/SRPMS',
      ...
      'content/dist/rhel9/9.5/s390x/sap/debug',
      'content/dist/rhel9/9.5/s390x/sap/os',
      'content/dist/rhel9/9.5/s390x/sap/source/SRPMS',
      ...
      'content/dist/rhel9/9.5/x86_64/sap-solutions/debug',
      'content/dist/rhel9/9.5/x86_64/sap-solutions/os',
      'content/dist/rhel9/9.5/x86_64/sap-solutions/source/SRPMS',
      'content/dist/rhel9/9.5/x86_64/sap/debug',
      'content/dist/rhel9/9.5/x86_64/sap/os',
      'content/dist/rhel9/9.5/x86_64/sap/source/SRPMS',
    ...
    'pkgs': [
      {'reference':'tuned-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-gtk-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-ppd-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-atomic-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-cpu-partitioning-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-mssql-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-nfv-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-nfv-guest-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-nfv-host-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-oracle-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-postgresql-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-realtime-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-sap-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-sap-hana-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-profiles-spectrumscale-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'tuned-utils-2.24.0-2.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
