...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : python-httplib2 (ALAS-2020-1420)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS-2020-1420 advisory.
...
var pkgs = [
    {'reference':'python26-httplib2-0.18.1-1.13.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python27-httplib2-0.18.1-1.13.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
