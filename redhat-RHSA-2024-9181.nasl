...
# extracted from Red Hat Security Advisory RHSA-2024:9181. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9181");

  script_name(english:"RHEL 9 : jose (RHSA-2024:9181)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for jose.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:9181 advisory.

    Jose is a C-language implementation of the Javascript Object Signing and Encryption standards. The jose
    package is a dependency of the clevis and tang packages, together providing Network Bound Disk Encryption
    (NBDE) in Red Hat Enterprise Linux.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-38079");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9181.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ccec1f49");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9181");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL jose package based on the guidance in RHSA-2024:9181.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:jose");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libjose");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libjose-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jose-14-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libjose-14-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libjose-devel-14-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
