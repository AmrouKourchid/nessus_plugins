...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-375.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2022-38752", "CVE-2022-41854");

  script_name(english:"Amazon Linux 2023 : snakeyaml, snakeyaml-javadoc (ALAS2023-2023-375)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-375.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2022-38752.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2022-41854.html");
...
"Run 'dnf update snakeyaml --releasever 2023.2.20231002' to update your system.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-41854");
...
var pkgs = [
    {'reference':'snakeyaml-1.27-6.amzn2023.0.3', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'snakeyaml-javadoc-1.27-6.amzn2023.0.3', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
