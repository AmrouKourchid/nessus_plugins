...
# extracted from Oracle Linux Security Advisory ELSA-2024-10218.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : perl-App-cpanminus (ELSA-2024-10218)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-10218.html");
...
var pkgs = [
    {'reference':'perl-App-cpanminus-1.7044-14.1.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
