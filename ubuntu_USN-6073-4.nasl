...
# extracted from Ubuntu Security Notice USN-6073-4. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6073-4");

  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.04 : os-brick vulnerability (USN-6073-4)");
...
referenced in the USN-6073-4 advisory.

    Jan Wasilewski and Gorka Eguileor discovered that os-brick incorrectly handled deleted volume attachments.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6073-4");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'os-brick-common', 'pkgver': '3.0.8-0ubuntu1.1'},
    {'osver': '20.04', 'pkgname': 'python3-os-brick', 'pkgver': '3.0.8-0ubuntu1.1'},
    {'osver': '22.04', 'pkgname': 'os-brick-common', 'pkgver': '5.2.2-0ubuntu1'},
    {'osver': '22.04', 'pkgname': 'python3-os-brick', 'pkgver': '5.2.2-0ubuntu1'},
    {'osver': '23.04', 'pkgname': 'os-brick-common', 'pkgver': '6.2.0-0ubuntu2.1'},
    {'osver': '23.04', 'pkgname': 'python3-os-brick', 'pkgver': '6.2.0-0ubuntu2.1'}
];
