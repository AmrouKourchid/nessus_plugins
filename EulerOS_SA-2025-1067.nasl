...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : xmlrpc-c (EulerOS-SA-2025-1067)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1067
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b1c4dd44");
...
var pkgs = [
  "xmlrpc-c-help-1.51.03-4.h2.eulerosv2r9"
];
