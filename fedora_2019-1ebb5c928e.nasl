...
# extracted from Fedora Security Advisory FEDORA-2019-1ebb5c928e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-1ebb5c928e");

  script_name(english:"Fedora 31 : mingw-libidn2 (2019-1ebb5c928e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1ebb5c928e");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-libidn2 package.");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mingw-libidn2-2.3.0-1.fc31")) flag++;
