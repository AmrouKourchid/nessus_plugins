...
# extracted from Amazon Linux 2 Security Advisory ALAS-2022-1799.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2022-0562");

  script_name(english:"Amazon Linux 2 : libtiff (ALAS-2022-1799)");
...
as referenced in the ALAS2-2022-1799 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2022-1799.html");
