...
# extracted from Fedora Security Advisory FEDORA-2024-a66f05d20f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a66f05d20f");

  script_name(english:"Fedora 39 : dotnet7.0 (2024-a66f05d20f)");
...
FEDORA-2024-a66f05d20f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a66f05d20f");
...
var pkgs = [
    {'reference':'dotnet7.0-7.0.116-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
