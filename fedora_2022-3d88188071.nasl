...
# extracted from Fedora Security Advisory FEDORA-2022-3d88188071
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-3d88188071");

  script_name(english:"Fedora 37 : xorg-x11-server (2022-3d88188071)");
...
FEDORA-2022-3d88188071 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-3d88188071");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-12.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
