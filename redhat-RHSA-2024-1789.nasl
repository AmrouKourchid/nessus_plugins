...
# extracted from Red Hat Security Advisory RHSA-2024:1789. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1789");

  script_name(english:"RHEL 9 : bind (RHSA-2024:1789)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for bind.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:1789 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1789.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ea5a19e4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1789");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL bind package based on the guidance in RHSA-2024:1789.");
...
var constraints = [
  ...
  },
  {
    ...
    'pkgs': [
      {'reference':'bind-dyndb-ldap-11.9-8.el9_3.3', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
