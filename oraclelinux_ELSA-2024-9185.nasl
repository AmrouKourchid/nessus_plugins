...
# extracted from Oracle Linux Security Advisory ELSA-2024-9185.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : iperf3 (ELSA-2024-9185)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9185.html");
...
var pkgs = [
    {'reference':'iperf3-3.9-13.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iperf3-3.9-13.el9', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'iperf3-3.9-13.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
