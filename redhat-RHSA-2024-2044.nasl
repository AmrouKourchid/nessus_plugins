...
# extracted from Red Hat Security Advisory RHSA-2024:2044. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2044");

  script_name(english:"RHEL 8 : gnutls (RHSA-2024:2044)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for gnutls.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:2044 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2044.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c7acc017");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2044");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gnutls package based on the guidance in RHSA-2024:2044.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnutls-3.6.16-5.el8_6.4', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-c++-3.6.16-5.el8_6.4', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-dane-3.6.16-5.el8_6.4', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-devel-3.6.16-5.el8_6.4', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gnutls-utils-3.6.16-5.el8_6.4', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
