...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : mariadb (EulerOS-SA-2019-1859)");
...
vulnerability :
  ...
  - Vulnerability in the MySQL Client component of Oracle
    ...
    protocols to compromise MySQL Client. Successful
    attacks of this vulnerability can result in
    unauthorized ability to cause a hang or frequently
    repeatable crash (complete DOS) of MySQL Client as well
    as unauthorized update, insert or delete access to some
    of MySQL Client accessible data. (CVE-2018-3081)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1859
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7d1a9d3");
...
pkgs = ["mariadb-5.5.60-1.h1",
        "mariadb-bench-5.5.60-1.h1",
        "mariadb-devel-5.5.60-1.h1",
        "mariadb-libs-5.5.60-1.h1",
        "mariadb-server-5.5.60-1.h1",
        "mariadb-test-5.5.60-1.h1"];
