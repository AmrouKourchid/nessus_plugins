...
# extracted from VMware Security Advisory PHSA-2021-2.0-0323. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Openvswitch PHSA-2021-2.0-0323");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openvswitch package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-323.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openvswitch-2.12.0-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openvswitch-devel-2.12.0-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openvswitch-devel-static-2.12.0-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openvswitch-doc-2.12.0-2.ph2')) flag++;
