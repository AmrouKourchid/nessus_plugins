...
# extracted from openSUSE Security Update openSUSE-2019-1275.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : lxc / lxcfs (openSUSE-2019-1275)");
...
Non-security issues fixed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1122185");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1131762");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=988348");
  script_set_attribute(attribute:"see_also", value:"https://linuxcontainers.org/.");
  script_set_attribute(attribute:"solution", value:
"Update the affected lxc / lxcfs packages.");
...
if ( rpm_check(release:"SUSE15.0", reference:"liblxc-devel-3.1.0-lp150.2.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"liblxc1-3.1.0-lp150.2.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"liblxc1-debuginfo-3.1.0-lp150.2.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"lxc-3.1.0-lp150.2.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"lxc-bash-completion-3.1.0-lp150.2.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"lxc-debuginfo-3.1.0-lp150.2.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"lxc-debugsource-3.1.0-lp150.2.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"lxcfs-3.0.3-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"lxcfs-debuginfo-3.0.3-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"lxcfs-debugsource-3.0.3-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"lxcfs-hooks-lxc-3.0.3-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pam_cgfs-3.1.0-lp150.2.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pam_cgfs-debuginfo-3.1.0-lp150.2.10.1") ) flag++;
