...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : python-pillow (EulerOS-SA-2022-1583)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1583
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba1e74d9");
...
var pkgs = [
  "python2-pillow-5.3.0-1.h14.eulerosv2r8",
  "python3-pillow-5.3.0-1.h14.eulerosv2r8"
];
