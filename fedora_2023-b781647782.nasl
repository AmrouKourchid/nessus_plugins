...
# extracted from Fedora Security Advisory FEDORA-2023-b781647782
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b781647782");

  script_name(english:"Fedora 39 : xrdp (2023-b781647782)");
...
FEDORA-2023-b781647782 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b781647782");
...
var pkgs = [
    {'reference':'xrdp-0.9.23.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
