...
# extracted from Red Hat Security Advisory RHSA-2020:0851 and 
# Oracle Linux Security Advisory ELSA-2020-0851 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : python-virtualenv (ELSA-2020-0851)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-0851.html");
...
"Update the affected python-virtualenv package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python-virtualenv");
...
var pkgs = [
    {'reference':'python-virtualenv-15.1.0-4.el7_7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
