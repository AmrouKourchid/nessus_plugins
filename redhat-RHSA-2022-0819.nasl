...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05f7509f");
...
"Update the RHEL kernel-rt package based on the guidance in RHSA-2022:0819.");
  ...
  script_cwe_id(281, 416, 787, 862, 909);
