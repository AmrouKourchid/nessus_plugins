...
advisory.
  ...
  - A Missing Release of File Descriptor or Handle after Effective Lifetime vulnerability in plugable
    ...
    authenticated attacker with low privileges to cause a Denial of Service (DoS). (CVE-2022-22215)
...
var vuln_ranges = [
  {'min_ver':'0.0', 'fixed_ver':'19.1R3-S8'},
  {'min_ver':'0.0-EVO', 'fixed_ver':'20.4R3-EVO'},
  ...
  {'min_ver':'21.1-EVO', 'fixed_ver':'21.1R3-S1-EVO'},
  {'min_ver':'21.2', 'fixed_ver':'21.2R2'},
  {'min_ver':'21.2-EVO', 'fixed_ver':'21.2R1-S1-EVO', 'fixed_display':'21.2R1-S1-EVO, 21.2R2-EVO'}
];
