...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4486708");
  script_xref(name:"MSKB", value:"4484531");
  script_xref(name:"MSFT", value:"MS20-4462175");
  script_xref(name:"MSFT", value:"MS20-4486708");
  script_xref(name:"MSFT", value:"MS20-4484531");
  script_xref(name:"IAVA", value:"2020-A-0460-S");
  script_xref(name:"CEA-ID", value:"CEA-2020-0126");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2010 (October 2020)");
...
affected by multiple vulnerabilities :
  ...
  - A cross-site-scripting (XSS) vulnerability exists when
    ...
    Server properly sanitizes web requests. (CVE-2020-16946)
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/4486708");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/4484531");
