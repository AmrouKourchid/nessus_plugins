...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : libsolv (EulerOS-SA-2021-2790)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2790
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f7138dd");
...
var pkgs = [
  "libsolv-0.7.7-2.h4.eulerosv2r9"
];
