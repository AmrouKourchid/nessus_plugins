...
if (description)
{
  ...
  script_name(english:"OpenSSL 3.3.0 < 3.3.3 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 3.3.3. It is, therefore, affected by a vulnerability as
referenced in the 3.3.3 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e069aba1");
...
"Upgrade to OpenSSL version 3.3.3 or later.");
...
var constraints = [
  { 'min_version' : '3.3.0', 'fixed_version' : '3.3.3' }
];
