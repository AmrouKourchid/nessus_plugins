...
if (description)
{
  ...
  script_name(english:"Wireshark 4.0.x < 4.0.9 A Vulnerability (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote macOS / Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote macOS / Mac OS X host is prior to 4.0.9. It is, therefore, affected by
a vulnerability as referenced in the wireshark-4.0.9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/docs/relnotes/wireshark-4.0.9.html");
...
"Upgrade to Wireshark version 4.0.9 or later.");
...
var constraints = [
  { 'min_version' : '4.0.0', 'max_version' : '4.0.8', 'fixed_version' : '4.0.9' }
];
