...
# extracted from Red Hat Security Advisory RHSA-2018:1643. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-3639", "CVE-2018-7550", "CVE-2018-7858");
  script_xref(name:"IAVA", value:"2018-A-0170");
  script_xref(name:"RHSA", value:"2018:1643");

  script_name(english:"RHEL 7 : qemu-kvm-rhev (RHSA-2018:1643)");
...
referenced in the RHSA-2018:1643 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1643.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ddcb2fc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1643");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2018:1643.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-rhev-2.10.0-21.el7_5.3', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
      {'reference':'qemu-img-rhev-2.10.0-21.el7_5.3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-common-rhev-2.10.0-21.el7_5.3', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-common-rhev-2.10.0-21.el7_5.3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-rhev-2.10.0-21.el7_5.3', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-rhev-2.10.0-21.el7_5.3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-tools-rhev-2.10.0-21.el7_5.3', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-tools-rhev-2.10.0-21.el7_5.3', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'openstack-'}
    ]
  }
];
