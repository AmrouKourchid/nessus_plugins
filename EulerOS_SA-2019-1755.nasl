...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : openssl (EulerOS-SA-2019-1755)");
...
vulnerability :
  ...
  - The OpenSSL DSA signature algorithm has been shown to
    ...
    to recover the private key. (CVE-2018-0734)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1755
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?148be7ba");
...
pkgs = ["openssl-1.0.2k-16.h6.eulerosv2r7",
        "openssl-devel-1.0.2k-16.h6.eulerosv2r7",
        "openssl-libs-1.0.2k-16.h6.eulerosv2r7"];
