...
# extracted from Red Hat Security Advisory RHSA-2018:1711. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1711");
  script_xref(name:"IAVA", value:"2018-A-0170");

  script_name(english:"RHEL 6 / 7 : rhev-hypervisor7 (RHSA-2018:1711)");
...
referenced in the RHSA-2018:1711 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1711.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae4b28d7");
...
"Update the RHEL rhev-hypervisor7 package based on the guidance in RHSA-2018:1711.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhev-hypervisor7-7.3-20180521.1.el7ev', 'release':'7', 'el_string':'el7ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rhev-hypervisor7-7.3-20180521.1.el6ev', 'release':'6', 'el_string':'el6ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ovirt-'}
    ]
  }
];
