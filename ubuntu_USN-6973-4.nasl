...
# extracted from Ubuntu Security Notice USN-6973-4. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6973-4");

  script_name(english:"Ubuntu 18.04 LTS : Linux kernel (Raspberry Pi) vulnerabilities (USN-6973-4)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6973-4");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6973-4');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6973-4');
  }
  else
  {
