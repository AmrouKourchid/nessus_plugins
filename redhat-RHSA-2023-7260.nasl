...
# extracted from Red Hat Security Advisory RHSA-2023:7260. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7260");

  script_name(english:"RHEL 8 : open-vm-tools (RHSA-2023:7260)");
...
referenced in the RHSA-2023:7260 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7260.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d07c1d35");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7260");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL open-vm-tools package based on the guidance in RHSA-2023:7260.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'open-vm-tools-10.3.10-3.el8_1.5', 'sp':'1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'open-vm-tools-desktop-10.3.10-3.el8_1.5', 'sp':'1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
