...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 152363-01");
  script_summary(english:"Check for patch 152363-01");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 152363-01"
  );
  script_set_attribute(
...
repeatable crash (complete DOS) of Solaris."
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 152363-01 or higher");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:N/C:N/I:N/A:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0676");
  script_set_attribute(attribute: "cvss3_score_source", value: "manual");
  script_set_attribute(attribute:"cvss3_score_rationale", value:"Scoring adjustsed to align with CVSS 3.1 attack complexity guidance.");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:152363");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"152363-01", obsoleted_by:"", package:"SUNWckr", version:"11.10.0,REV=2005.01.21.15.53") < 0) flag++;
