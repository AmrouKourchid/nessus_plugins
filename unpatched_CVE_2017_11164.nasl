...
if (description)
{
  ...
  script_cve_id("CVE-2017-11164");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-11164");
...
patch available.
  ...
  - In PCRE 8.41, the OP_KETRMAX feature in the match function in pcre_exec.c allows stack exhaustion
    (uncontrolled recursion) when processing a crafted regular expression. (CVE-2017-11164)
