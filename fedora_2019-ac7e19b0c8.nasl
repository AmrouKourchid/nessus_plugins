...
# extracted from Fedora Security Advisory FEDORA-2019-ac7e19b0c8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : krb5 (2019-ac7e19b0c8)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Improve memset hygiene in one location.

----

Fix low-severity CVE-2018-20217 (an authenticated user who can obtain
a TGT using an older encryption type (DES, DES3, or RC4) can cause an
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-ac7e19b0c8");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"krb5-1.16.1-24.fc28")) flag++;
