...
if (description)
{
  ...
  script_cve_id("CVE-2022-43927");
  script_xref(name:"IAVB", value:"2023-B-0007-S");

  script_name(english:"IBM DB2 10.5 < 10.5.0 FP11 41247 / 11.1 < 11.1.4 FP6 41246 / 11.5 < 11.5.8  FP0 26513 Information Disclosure (Unix)");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by an information disclosure vulnerability.");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version number, IBM Db2 is affected by an information disclosure due to improper
privilege management when a specially crafted table access is used.
...
"Apply the appropriate IBM DB2 Fix Pack or Special Build based on the most recent fix pack level for your branch.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-43927");
...
var constraints = [
  {'equal':'10.5.0.11', 'fixed_build':'41247'},
  {'min_version':'10.5', 'fixed_version':'10.5.0.11', 'fixed_display':'10.5.0.11 + Special Build 41247'},
  {'equal':'11.1.4.7', 'fixed_build':'41246'},
  {'min_version':'11.1', 'fixed_version':'11.1.4.7', 'fixed_display':'11.1.4.7 + Special Build 41246'},
  {'equal':'11.5.8.0', 'fixed_build':'26513'},
  {'min_version':'11.5', 'fixed_version':'11.5.8.0', 'fixed_display':'11.5.8.0 + Special Build 26513'}
];
