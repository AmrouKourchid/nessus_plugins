...
# extracted from Debian Security Advisory dla-3628. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3628 : dbus - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3628
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3628-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-34969");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'dbus', 'reference': '1.12.28-0+deb10u1'},
    {'release': '10.0', 'prefix': 'dbus-1-doc', 'reference': '1.12.28-0+deb10u1'},
    {'release': '10.0', 'prefix': 'dbus-tests', 'reference': '1.12.28-0+deb10u1'},
    {'release': '10.0', 'prefix': 'dbus-user-session', 'reference': '1.12.28-0+deb10u1'},
    {'release': '10.0', 'prefix': 'dbus-x11', 'reference': '1.12.28-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libdbus-1-3', 'reference': '1.12.28-0+deb10u1'},
    {'release': '10.0', 'prefix': 'libdbus-1-dev', 'reference': '1.12.28-0+deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'dbus / dbus-1-doc / dbus-tests / dbus-user-session / dbus-x11 / etc');
}
