...
# extracted from Red Hat Security Advisory RHSA-2018:2585. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2018-10855", "CVE-2018-10874", "CVE-2018-10875");
  script_xref(name:"RHSA", value:"2018:2585");

  script_name(english:"RHEL 7 : ansible (RHSA-2018:2585)");
...
referenced in the RHSA-2018:2585 advisory.
    ...
    * ansible: ansible.cfg is being read from current working directory allowing possible code execution
    ...
    Red Hat would like to thank Tobias Henkel (BMW Car IT GmbH), Brian Coca (Red Hat), and Michael Scherer
    (OSAS) for reporting this issue.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2585.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72b22850");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2585");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ansible package based on the guidance in RHSA-2018:2585.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.4.6.0-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
