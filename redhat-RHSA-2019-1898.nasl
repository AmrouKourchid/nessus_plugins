...
# extracted from Red Hat Security Advisory RHSA-2019:1898. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1898.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f6c5663");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1898");
...
"Update the RHEL httpd package based on the guidance in RHSA-2019:1898.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'httpd-2.4.6-89.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-devel-2.4.6-89.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-manual-2.4.6-89.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpd-tools-2.4.6-89.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ldap-2.4.6-89.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_proxy_html-2.4.6-89.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'mod_session-2.4.6-89.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_ssl-2.4.6-89.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
