...
# extracted from Red Hat Security Advisory RHSA-2020:5183. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5183");

  script_name(english:"RHEL 7 : microcode_ctl (RHSA-2020:5183)");
...
referenced in the RHSA-2020:5183 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5183.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?119c293f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5183");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'microcode_ctl-2.1-16.37.el7_3', 'sp':'3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
