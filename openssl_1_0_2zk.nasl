...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.0.2 < 1.0.2zk Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.0.2zk. It is, therefore, affected by a vulnerability
as referenced in the 1.0.2zk advisory.
...
var constraints = [
  { 'min_version' : '1.0.2', 'fixed_version' : '1.0.2zk' }
];
