...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Go PHSA-2019-3.0-0019");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the go package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-3.0-19.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-1.9.7-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'go-debuginfo-1.9.7-3.ph3')) flag++;
