...
# extracted from Red Hat Security Advisory RHSA-2025:4128. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:4128");

  script_name(english:"RHEL 8 : mod_auth_openidc:2.3 (RHSA-2025:4128)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mod_auth_openidc:2.3.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:4128 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85ff7a78");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4128");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_auth_openidc:2.3 package based on the guidance in RHSA-2025:4128.");
  ...
  'mod_auth_openidc:2.3': [
    {
      ...
      'pkgs': [
        {'reference':'cjose-0.6.1-3.module+el8.8.0+19464+578f4546', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'cjose-devel-0.6.1-3.module+el8.8.0+19464+578f4546', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'mod_auth_openidc-2.4.9.4-1.module+el8.8.0+23028+2aae5ce6.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
