...
# extracted from ZTE advisory NS-SA-2020-0104. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : gettext Vulnerability (NS-SA-2020-0104)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has gettext packages installed that are affected
by a vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2020-0104");
...
pkgs = {
  'CGSL CORE 5.05': [
    'emacs-gettext-0.19.8.1-3.el7',
    'gettext-0.19.8.1-3.el7',
    'gettext-common-devel-0.19.8.1-3.el7',
    'gettext-debuginfo-0.19.8.1-3.el7',
    'gettext-devel-0.19.8.1-3.el7',
    'gettext-libs-0.19.8.1-3.el7'
  ],
  'CGSL MAIN 5.05': [
    'emacs-gettext-0.19.8.1-3.el7',
    'gettext-0.19.8.1-3.el7',
