...
# extracted from Fedora Security Advisory FEDORA-2023-3d1bf0ee44
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3d1bf0ee44");

  script_name(english:"Fedora 37 : httpd (2023-3d1bf0ee44)");
...
FEDORA-2023-3d1bf0ee44 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3d1bf0ee44");
...
var pkgs = [
    {'reference':'httpd-2.4.58-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
