...
# extracted from Fedora Security Advisory FEDORA-2024-055adf8e6f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-055adf8e6f");
  script_xref(name:"IAVA", value:"2024-A-0536-S");

  script_name(english:"Fedora 39 : vim (2024-055adf8e6f)");
...
FEDORA-2024-055adf8e6f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-055adf8e6f");
...
var pkgs = [
    {'reference':'vim-9.1.719-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
