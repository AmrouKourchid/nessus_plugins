...
# extracted from Red Hat Security Advisory RHSA-2020:0002. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0002");

  script_name(english:"RHEL 7 : rh-git218-git (RHSA-2020:0002)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rh-git218-git.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:0002 advisory.
    ...
    The following packages have been upgraded to a later upstream version: rh-git218-git (2.18.2).
    (BZ#1784060, BZ#1784368, BZ#1784528)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0002.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86d3365b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0002");
...
"Update the RHEL rh-git218-git package based on the guidance in RHSA-2020:0002.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-git218-git-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-all-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-core-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-core-doc-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-cvs-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-daemon-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-email-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-gui-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-instaweb-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-p4-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-subtree-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-git-svn-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-gitk-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-gitweb-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-perl-Git-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-git218-perl-Git-SVN-2.18.2-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
