...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : openjpeg2 (EulerOS-SA-2019-1775)");
...
vulnerabilities :
  ...
  - In OpenJPEG 2.3.0, a stack-based buffer overflow was
    discovered in the pgxtovolume function in
    ...
    execution.(CVE-2017-17480)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1775
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?700a69d8");
...
pkgs = ["openjpeg2-2.3.0-9.h1.eulerosv2r8"];
