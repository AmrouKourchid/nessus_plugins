...
# extracted from Red Hat Security Advisory RHSA-2018:2244. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2244");

  script_name(english:"RHEL 6 / 7 : rh-ror42-rubygem-sprockets (RHSA-2018:2244)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for rh-ror42-rubygem-sprockets.");
...
in the RHSA-2018:2244 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2244.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73603b3a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2244");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-ror42-rubygem-sprockets package based on the guidance in RHSA-2018:2244.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-ror42-rubygem-sprockets");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-ror42-rubygem-sprockets-doc");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-ror42-rubygem-sprockets-3.2.0-5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-ror42-rubygem-sprockets-doc-3.2.0-5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-ror42-rubygem-sprockets-3.2.0-5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-ror42-rubygem-sprockets-doc-3.2.0-5.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-ror42-rubygem-sprockets / rh-ror42-rubygem-sprockets-doc');
}
