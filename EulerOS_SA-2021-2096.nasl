...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : python (EulerOS-SA-2021-2096)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2096
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4f231fc6");
...
pkgs = ["python-2.7.5-69.h34",
        "python-devel-2.7.5-69.h34",
        "python-libs-2.7.5-69.h34",
        "python-tools-2.7.5-69.h34"];
