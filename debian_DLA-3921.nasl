...
# extracted from Debian Security Advisory dla-3921. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3921 : apache2 - security update");
...
dla-3921 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3921-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '11.0', 'prefix': 'apache2', 'reference': '2.4.62-1~deb11u2'},
    {'release': '11.0', 'prefix': 'apache2-bin', 'reference': '2.4.62-1~deb11u2'},
    {'release': '11.0', 'prefix': 'apache2-data', 'reference': '2.4.62-1~deb11u2'},
    {'release': '11.0', 'prefix': 'apache2-dev', 'reference': '2.4.62-1~deb11u2'},
    {'release': '11.0', 'prefix': 'apache2-doc', 'reference': '2.4.62-1~deb11u2'},
    {'release': '11.0', 'prefix': 'apache2-ssl-dev', 'reference': '2.4.62-1~deb11u2'},
    {'release': '11.0', 'prefix': 'apache2-suexec-custom', 'reference': '2.4.62-1~deb11u2'},
    {'release': '11.0', 'prefix': 'apache2-suexec-pristine', 'reference': '2.4.62-1~deb11u2'},
    {'release': '11.0', 'prefix': 'apache2-utils', 'reference': '2.4.62-1~deb11u2'},
    {'release': '11.0', 'prefix': 'libapache2-mod-md', 'reference': '2.4.62-1~deb11u2'},
    {'release': '11.0', 'prefix': 'libapache2-mod-proxy-uwsgi', 'reference': '2.4.62-1~deb11u2'}
];
