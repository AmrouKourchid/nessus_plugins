...
# extracted from VMware Security Advisory PHSA-2021-4.0-0024. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Binutils PHSA-2021-4.0-0024");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the binutils package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-24.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'binutils-2.35-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'binutils-devel-2.35-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'binutils-libs-2.35-3.ph4')) flag++;
