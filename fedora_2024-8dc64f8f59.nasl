...
# extracted from Fedora Security Advisory FEDORA-2024-8dc64f8f59
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8dc64f8f59");

  script_name(english:"Fedora 38 : engrampa (2024-8dc64f8f59)");
...
FEDORA-2024-8dc64f8f59 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8dc64f8f59");
  script_set_attribute(attribute:"solution", value:
"Update the affected engrampa package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:engrampa");
...
var pkgs = [
    {'reference':'engrampa-1.26.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'engrampa');
}
