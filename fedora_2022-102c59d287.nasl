...
# extracted from Fedora Security Advisory FEDORA-2022-102c59d287
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-102c59d287");

  script_name(english:"Fedora 37 : squid (2022-102c59d287)");
...
FEDORA-2022-102c59d287 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-102c59d287");
...
var pkgs = [
    {'reference':'squid-5.7-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
