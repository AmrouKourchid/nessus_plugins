...
if (description)
{
  ...
  script_cve_id("CVE-2016-0640");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-0640");
...
patch available.
  ...
  - Unspecified vulnerability in Oracle MySQL 5.5.47 and earlier, 5.6.28 and earlier, and 5.7.10 and earlier
    ...
    integrity and availability via vectors related to DML. (CVE-2016-0640)
