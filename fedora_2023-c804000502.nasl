...
# extracted from Fedora Security Advisory FEDORA-2023-c804000502
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c804000502");

  script_name(english:"Fedora 37 : openbgpd (2023-c804000502)");
...
FEDORA-2023-c804000502 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c804000502");
...
var pkgs = [
    {'reference':'openbgpd-7.9-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
