...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : KDE-Libs vulnerability (USN-2304-1)");
...
USN-2304-1 advisory.
    ...
    It was discovered that kauth was using polkit in an unsafe manner. A local attacker could possibly use
    this issue to bypass intended polkit authorizations.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2304-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'kdelibs-bin', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'kdelibs5-data', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'kdelibs5-dev', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'kdelibs5-plugins', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'kdoctools', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkcmutils4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkde3support4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkdeclarative5', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkdecore5', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkdesu5', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkdeui5', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkdewebkit5', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkdnssd4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkemoticons4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkfile4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkhtml5', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkidletime4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkimproxy4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkio5', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkjsapi4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkjsembed4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkmediaplayer4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libknewstuff2-4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libknewstuff3-4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libknotifyconfig4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkntlm4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkparts4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkprintutils4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkpty4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkrosscore4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkrossui4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libktexteditor4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkunitconversion4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libkutils4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libnepomuk4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libnepomukquery4a', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libnepomukutils4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libplasma3', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libsolid4', 'pkgver': '4:4.13.2a-0ubuntu0.3'},
    {'osver': '14.04', 'pkgname': 'libthreadweaver4', 'pkgver': '4:4.13.2a-0ubuntu0.3'}
];
