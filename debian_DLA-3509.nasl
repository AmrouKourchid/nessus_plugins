...
# extracted from Debian Security Advisory dla-3509. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3509 : libmail-dkim-perl - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3509
advisory.
...
number.");
  # https://security-tracker.debian.org/tracker/source-package/libmail-dkim-perl
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67ab35c6");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/libmail-dkim-perl");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libmail-dkim-perl packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libmail-dkim-perl");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libmail-dkim-perl', 'reference': '0.54-1+deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libmail-dkim-perl');
}
