...
# extracted from Gentoo Linux Security Advisory GLSA 202405-27.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202405-27 : Epiphany: Buffer Overflow");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202405-27 (Epiphany: Buffer Overflow)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202405-27");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=839786");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 42.4"),
    'vulnerable' : make_list("lt 42.4")
  }
];
