...
# extracted from Fedora Security Advisory FEDORA-2019-a034423db8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-a034423db8");

  script_name(english:"Fedora 29 : 2:docker (2019-a034423db8)");
...
"- Resolves: #1666565, #1666566 - CVE-2018-20699
  ...
  - Resolves: #1663068, #1667622 - umount all procfs and
    sysfs with --no-pivot
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a034423db8");
  script_set_attribute(attribute:"solution", value:
"Update the affected 2:docker package.");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"docker-1.13.1-63.git1185cfd.fc29", epoch:"2")) flag++;
