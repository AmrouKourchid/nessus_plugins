...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : gstreamer1-plugins-good (EulerOS-SA-2021-1796)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1796
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?332c9c83");
...
pkgs = ["gstreamer1-plugins-good-1.4.5-3.h1"];
