...
# extracted from Fedora Security Advisory FEDORA-2025-66b73d6c72
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-66b73d6c72");

  script_name(english:"Fedora 40 : ntpd-rs (2025-66b73d6c72)");
...
FEDORA-2025-66b73d6c72 advisory.

    Update to version 1.5.0 (for now, without PPS feature enabled due to potential correctness issues in the
    code).
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-66b73d6c72");
  script_set_attribute(attribute:"solution", value:
"Update the affected ntpd-rs package.");
...
var pkgs = [
    {'reference':'ntpd-rs-1.5.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ntpd-rs');
}
