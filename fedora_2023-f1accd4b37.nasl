...
# extracted from Fedora Security Advisory FEDORA-2023-f1accd4b37
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f1accd4b37");

  script_name(english:"Fedora 38 : bind / bind-dyndb-ldap (2023-f1accd4b37)");
...
FEDORA-2023-f1accd4b37 advisory.

    - [Release notes](https://downloads.isc.org/isc/bind9/9.18.11/RELEASE-NOTES-bind-9.18.11.html)

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f1accd4b37");
...
var pkgs = [
    {'reference':'bind-9.18.11-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'},
    {'reference':'bind-dyndb-ldap-11.10-11.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
