...
# extracted from Fedora Security Advisory FEDORA-2018-45d8b8ae21.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : puppet (2018-45d8b8ae21)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-45d8b8ae21");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"puppet-4.10.10-1.fc27")) flag++;
