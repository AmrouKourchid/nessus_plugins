...
# extracted from Red Hat Security Advisory RHSA-2023:2177. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2177");

  script_name(english:"RHEL 9 : grafana-pcp (RHSA-2023:2177)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f53aa6f3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2124669");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2127038");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2177");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL grafana-pcp package based on the guidance in RHSA-2023:2177.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-pcp-5.1.1-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
