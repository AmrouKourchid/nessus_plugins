...
# extracted from Red Hat Security Advisory RHSA-2024:4000. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4000");

  script_name(english:"RHEL 8 : ghostscript (RHSA-2024:4000)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ghostscript.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:4000 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4000.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1197fa5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4000");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ghostscript package based on the guidance in RHSA-2024:4000.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ghostscript-9.27-13.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-doc-9.27-13.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-tools-dvipdf-9.27-13.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-tools-fonts-9.27-13.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-tools-printing-9.27-13.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ghostscript-x11-9.27-13.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgs-9.27-13.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgs-devel-9.27-13.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
