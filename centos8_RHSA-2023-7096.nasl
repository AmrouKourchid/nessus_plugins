...
# Red Hat Security Advisory RHSA-2023:7096. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : python-cryptography (CESA-2023:7096)");
...
var pkgs = [
    {'reference':'python3-cryptography-3.2.1-6.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-cryptography-3.2.1-6.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
