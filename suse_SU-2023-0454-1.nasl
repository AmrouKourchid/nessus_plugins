...
# SUSE update advisory SUSE-SU-2023:0454-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:0454-1");

  script_name(english:"SUSE SLES15 Security Update : ucode-intel (SUSE-SU-2023:0454-1)");
...
referenced in the SUSE-SU-2023:0454-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-February/013842.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?321e8100");
...
var pkgs = [
    {'reference':'ucode-intel-20230214-150100.3.217.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
    {'reference':'ucode-intel-20230214-150100.3.217.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.1', 'sles-ltss-release-15.1']}
];
