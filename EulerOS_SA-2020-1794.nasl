...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : ant (EulerOS-SA-2020-1794)");
...
vulnerability :
  ...
  - Apache Ant 1.1 to 1.9.14 and 1.10.0 to 1.10.7 uses the
    ...
    process.(CVE-2020-1945)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1794
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b01ca78e");
...
pkgs = ["ant-1.10.5-2.h1.eulerosv2r8",
        "ant-lib-1.10.5-2.h1.eulerosv2r8"];
