...
# extracted from Fedora Security Advisory FEDORA-2024-7fe5206574
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7fe5206574");
  script_xref(name:"IAVA", value:"2024-A-0465-S");

  script_name(english:"Fedora 39 : thunderbird (2024-7fe5206574)");
...
FEDORA-2024-7fe5206574 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7fe5206574");
...
var pkgs = [
    {'reference':'thunderbird-115.14.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
