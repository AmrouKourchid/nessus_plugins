...
# extracted from Amazon Linux 2 Security Advisory ALAS-2024-2464.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2022-40151");

  script_name(english:"Amazon Linux 2 : xstream (ALAS-2024-2464)");
...
as referenced in the ALAS2-2024-2464 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2024-2464.html");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/cve/html/CVE-2022-40151.html");
...
"Run 'yum update xstream' to update your system.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-40151");
...
var pkgs = [
    {'reference':'xstream-1.3.1-16.amzn2.0.3', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xstream-javadoc-1.3.1-16.amzn2.0.3', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
