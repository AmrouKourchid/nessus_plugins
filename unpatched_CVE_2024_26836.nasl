...
if (description)
{
  ...
  script_cve_id("CVE-2024-26836");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-26836");
...
"There is no known solution at this time.");
  ...
  script_set_cvss3_base_vector("CVSS:3.0/AV:P/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-26836");
