...
if (description)
{
  ...
  script_bugtraq_id(73066);

  script_name(english:"EulerOS 2.0 SP5 : libgcrypt (EulerOS-SA-2019-2695)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2695
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?178d90cf");
...
"Update the affected libgcrypt package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3591");
...
pkgs = ["libgcrypt-1.5.3-14.h3.eulerosv2r7",
        "libgcrypt-devel-1.5.3-14.h3.eulerosv2r7"];
