...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : ruby (EulerOS-SA-2019-2230)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2230
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?36156eda");
...
pkgs = ["ruby-2.0.0.648-33.h18.eulerosv2r7",
        "ruby-irb-2.0.0.648-33.h18.eulerosv2r7",
        "ruby-libs-2.0.0.648-33.h18.eulerosv2r7"];
