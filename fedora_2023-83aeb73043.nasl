...
# extracted from Fedora Security Advisory FEDORA-2023-83aeb73043
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-83aeb73043");

  script_name(english:"Fedora 37 : drupal7 (2023-83aeb73043)");
...
FEDORA-2023-83aeb73043 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-83aeb73043");
...
var pkgs = [
    {'reference':'drupal7-7.98-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
