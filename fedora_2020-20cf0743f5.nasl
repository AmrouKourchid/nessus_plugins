...
# extracted from Fedora Security Advisory FEDORA-2020-20cf0743f5.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : upx (2020-20cf0743f5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-20cf0743f5");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"upx-3.96-1.fc30")) flag++;
