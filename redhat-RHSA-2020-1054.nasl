...
# extracted from Red Hat Security Advisory RHSA-2020:1054. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:1054");

  script_name(english:"RHEL 7 : mailman (RHSA-2020:1054)");
...
referenced in the RHSA-2020:1054 advisory.

    Mailman is a program used to help manage e-mail discussion lists.

    Security Fix(es):

    * mailman: Cross-site scripting vulnerability allows malicious listowners to inject scripts into listinfo
    pages (CVE-2018-0618)

    * mailman: Mishandled URLs in Utils.py:GetPathPieces() allows attackers to display arbitrary text on
    trusted sites (CVE-2018-13796)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1054.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8e51e5d9");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html/7.8_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?afba0e17");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1054");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1596458");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1609090");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mailman package based on the guidance in RHSA-2020:1054.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mailman-2.1.15-30.el7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.15-30.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.15-30.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.15-30.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
  }
];
