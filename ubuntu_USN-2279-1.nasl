...
# extracted from Ubuntu Security Notice USN-2279-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Transmission vulnerability (USN-2279-1)");
...
USN-2279-1 advisory.
    ...
    Ben Hawkes discovered that Transmission incorrectly handled certain peer messages. A remote attacker could
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2279-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-4909");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'transmission', 'pkgver': '2.82-1.1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'transmission-cli', 'pkgver': '2.82-1.1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'transmission-common', 'pkgver': '2.82-1.1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'transmission-daemon', 'pkgver': '2.82-1.1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'transmission-gtk', 'pkgver': '2.82-1.1ubuntu3.1'},
    {'osver': '14.04', 'pkgname': 'transmission-qt', 'pkgver': '2.82-1.1ubuntu3.1'}
];
