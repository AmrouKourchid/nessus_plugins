...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1332.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d1369af6");
...
"Update the RHEL ksh package based on the guidance in RHSA-2020:1332.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ksh-20120801-138.el7_5', 'sp':'5', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ksh-20120801-138.el7_5', 'sp':'5', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ksh-20120801-138.el7_5', 'sp':'5', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ksh-20120801-138.el7_5', 'sp':'5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
