...
# extracted from Fedora Security Advisory FEDORA-2023-43bce108c7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-43bce108c7");

  script_name(english:"Fedora 36 : java-latest-openjdk (2023-43bce108c7)");
...
FEDORA-2023-43bce108c7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-43bce108c7");
...
var pkgs = [
    {'reference':'java-latest-openjdk-19.0.2.0.7-1.rolling.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
