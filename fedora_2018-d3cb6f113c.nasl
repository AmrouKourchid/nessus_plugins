...
# extracted from Fedora Security Advisory FEDORA-2018-d3cb6f113c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : xen (2018-d3cb6f113c)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d3cb6f113c");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"xen-4.10.1-4.fc28")) flag++;
