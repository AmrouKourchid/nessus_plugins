...
# extracted from Fedora Security Advisory FEDORA-2025-dcf429359c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-dcf429359c");

  script_name(english:"Fedora 40 : podman-tui (2025-dcf429359c)");
...
FEDORA-2025-dcf429359c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-dcf429359c");
...
var pkgs = [
    {'reference':'podman-tui-1.4.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
