...
# extracted from Debian Security Advisory dla-3853. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3853 : tryton-server - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3853
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'tryton-server', 'reference': '5.0.4-2+deb10u3'},
    {'release': '10.0', 'prefix': 'tryton-server-doc', 'reference': '5.0.4-2+deb10u3'}
];
