...
if (description)
{
  ...
  script_cve_id("CVE-2025-0146");
  script_xref(name:"IAVA", value:"2025-A-0025-S");

  script_name(english:"Zoom Workplace Desktop App < 6.2.10 DoS (ZSB-25005)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an application installed that is affected by an denial of service vulnerability.");
...
a vulnerability as referenced in the ZSB-25005 advisory.

  - Symlink following in the installer for Zoom Workplace app for macOS before 6.2.10 may allow an 
    authenticated user to conduct a denial of service via local access. (CVE-2025-0146)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.zoom.com/en/trust/security-bulletin/ZSB-25005/");
...
"Upgrade to Zoom Client for Meetings 6.2.10 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-0146");
