...
# extracted from Red Hat Security Advisory RHSA-2019:3203. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3203");

  script_name(english:"RHEL 7 / 8 : Ansible (RHSA-2019:3203)");
...
referenced in the RHSA-2019:3203 advisory.
...
number.");
  # https://github.com/ansible/ansible/blob/v2.8.6/changelogs/CHANGELOG-v2.8.rst
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?404559f6");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3203.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3019e64");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3203");
...
"Update the RHEL Ansible package based on the guidance in RHSA-2019:3203.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.8.6-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.8'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'ansible-2.8.6-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.8'}
    ]
  }
];
