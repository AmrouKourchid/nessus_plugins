...
# AlmaLinux Security Advisory ALSA-2024:6682.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:6682");

  script_name(english:"AlmaLinux 8 : firefox (ALSA-2024:6682)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-6682.html");
...
var pkgs = [
    {'reference':'firefox-128.2.0-1.el8_10.alma.1', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'firefox-128.2.0-1.el8_10.alma.1', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'firefox-128.2.0-1.el8_10.alma.1', 'cpu':'s390x', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE},
    {'reference':'firefox-128.2.0-1.el8_10.alma.1', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0', 'allowmaj':TRUE}
];
