...
the RHSA-2017:1260 advisory.
    ...
    Enterprise Application Platform 6.4.15.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_1260.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?220e22a1");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:1260");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jboss-ec2-eap-7.5.15-3.Final_redhat_3.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'jboss-ec2-eap-samples-7.5.15-3.Final_redhat_3.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  }
];
