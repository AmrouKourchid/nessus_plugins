...
in the RHSA-2012:1060 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_1060.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?790e0488");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1060");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=824460");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL cobbler package based on the guidance in RHSA-2012:1060.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cobbler-2.0.7-14.6.el5sat', 'release':'5', 'el_string':'el5sat', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cobbler-2.0.7-14.6.el6sat', 'release':'6', 'el_string':'el6sat', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
