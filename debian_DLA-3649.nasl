...
# extracted from Debian Security Advisory dla-3649. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-43803");

  script_name(english:"Debian dla-3649 : python-urllib3 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3649
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3649-1                debian-lts@lists.debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-43803");
...
"Upgrade the python-urllib3 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-43803");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'python-urllib3', 'reference': '1.24.1-1+deb10u2'},
    {'release': '10.0', 'prefix': 'python3-urllib3', 'reference': '1.24.1-1+deb10u2'}
];
