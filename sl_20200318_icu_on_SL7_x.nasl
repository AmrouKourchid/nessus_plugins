...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : icu on SL7.x x86_64 (20200318)");
...
"Security Fix(es) :
  ...
  - ICU: Integer overflow in UnicodeString::doAppend()
    (CVE-2020-10531)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2003&L=SCIENTIFIC-LINUX-ERRATA&P=11667
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66d1e344");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"icu-50.2-4.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"icu-debuginfo-50.2-4.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libicu-50.2-4.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libicu-devel-50.2-4.el7_7")) flag++;
if (rpm_check(release:"SL7", reference:"libicu-doc-50.2-4.el7_7")) flag++;
