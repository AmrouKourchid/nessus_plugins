...
# extracted from F5 Networks BIG-IP Solution K32760744.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : libxml2 vulnerability (K32760744)");
...
affected by a vulnerability as referenced in the K32760744 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K32760744");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K32760744.");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '17.0.0','16.1.0-16.1.3','15.1.0-15.1.7','14.1.0-14.1.5','13.1.0-13.1.5','12.1.0-12.1.6'
    ],
    'unaffected': [
