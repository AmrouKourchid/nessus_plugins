...
# extracted from Fedora Security Advisory FEDORA-2019-d778bd4137.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : exim (2019-d778bd4137)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d778bd4137");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"exim-4.92.3-1.fc29")) flag++;
