...
# Red Hat Security Advisory RHSA-2022:0545. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : ruby:2.5 (CESA-2022:0545)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2022:0545 advisory.
...
"Update the affected rubygem-bundler and / or rubygem-bundler-doc packages.");
...
var pkgs = [
    {'reference':'rubygem-bundler-1.16.1-4.module_el8.5.0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rubygem-bundler-doc-1.16.1-4.module_el8.5.0', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
