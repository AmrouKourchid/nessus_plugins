...
# extracted from Fedora Security Advisory FEDORA-2024-b595c68c09
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b595c68c09");

  script_name(english:"Fedora 41 : python-jinja2 (2024-b595c68c09)");
...
FEDORA-2024-b595c68c09 advisory.
    ...
    ```
    * Tue May  7 2024 Lumr Balhar <lbalhar@redhat.com> - 3.1.4-1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b595c68c09");
...
var pkgs = [
    {'reference':'python-jinja2-3.1.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
