...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 131.0.1");

  script_set_attribute(attribute:"synopsis", value:
"A mail client installed on the remote macOS or Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 131.0.1. It is, therefore,
affected by a vulnerability as referenced in the mfsa2024-52 advisory.
...
"Upgrade to Mozilla Thunderbird version 131.0.1 or later.");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'131.0.1', min:'131.0.0', severity:SECURITY_HOLE);
