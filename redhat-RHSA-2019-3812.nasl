...
"The remote Red Hat host is missing a security update for OpenShift Container Platform 3.9 cri-o.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3812.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3f70c732");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3812");
...
"Update the RHEL OpenShift Container Platform 3.9 cri-o package based on the guidance in RHSA-2019:3812.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.9.16-5.git858756d.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
