...
# extracted from Red Hat Security Advisory RHSA-2024:3005. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3005.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aba257d2");
...
"Update the RHEL python-pillow package based on the guidance in RHSA-2024:3005.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-pillow-5.1.1-20.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pillow-devel-5.1.1-20.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pillow-doc-5.1.1-20.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pillow-tk-5.1.1-20.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
