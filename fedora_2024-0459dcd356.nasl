...
# extracted from Fedora Security Advisory FEDORA-2024-0459dcd356
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-0459dcd356");

  script_name(english:"Fedora 39 : gnutls (2024-0459dcd356)");
...
FEDORA-2024-0459dcd356 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-0459dcd356");
...
var pkgs = [
    {'reference':'gnutls-3.8.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
