...
# extracted from Oracle Linux Security Advisory ELSA-2020-1181.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : unzip (ELSA-2020-1181)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1181.html");
...
var pkgs = [
    {'reference':'unzip-6.0-21.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
