...
if (description)
{
  ...
  script_name(english:"SuSE 11.3 Security Update : KVM (SAT Patch Number 10672)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SuSE 11 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"KVM was updated to fix a buffer overflow in the floppy drive
...
also known as VENOM. (CVE-2015-3456)");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.novell.com/show_bug.cgi?id=929339");
  script_set_attribute(attribute:"see_also", value:"http://support.novell.com/security/cve/CVE-2015-3456.html");
  script_set_attribute(attribute:"solution", value:
"Apply SAT patch number 10672.");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:3, cpu:"i586", reference:"kvm-1.4.2-0.22.27.1")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"x86_64", reference:"kvm-1.4.2-0.22.27.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, reference:"kvm-1.4.2-0.22.27.1")) flag++;
