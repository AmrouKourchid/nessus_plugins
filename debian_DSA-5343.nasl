...
# extracted from Debian Security Advisory dsa-5343. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5343-1 : openssl - security update");
...
dsa-5343 advisory.
    ...
    Multiple vulnerabilities have been discovered in OpenSSL, a Secure Sockets Layer toolkit, which may result
    in incomplete encryption, side channel attacks, denial of service or information disclosure. Additional
    details can be found in the upstream advisories at https://www.openssl.org/news/secadv/20220705.txt and
    https://www.openssl.org/news/secadv/20230207.txt For the stable distribution (bullseye), these problems
    have been fixed in version 1.1.1n-0+deb11u4. We recommend that you upgrade your openssl packages. For the
    detailed security status of openssl please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/openssl

Tenable has extracted the preceding description block directly from the Debian security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1023424");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/openssl");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5343");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libcrypto1.1-udeb', 'reference': '1.1.1n-0+deb11u4'},
    {'release': '11.0', 'prefix': 'libssl-dev', 'reference': '1.1.1n-0+deb11u4'},
    {'release': '11.0', 'prefix': 'libssl-doc', 'reference': '1.1.1n-0+deb11u4'},
    {'release': '11.0', 'prefix': 'libssl1.1', 'reference': '1.1.1n-0+deb11u4'},
    {'release': '11.0', 'prefix': 'libssl1.1-udeb', 'reference': '1.1.1n-0+deb11u4'},
    {'release': '11.0', 'prefix': 'openssl', 'reference': '1.1.1n-0+deb11u4'}
];
