...
if (description)
{
  ...
  script_name(english:"Macrium Reflect 7.2.x/7.3.x < 7.3.5281 Privilege Escalation");
...
It is, therefore, affected by a privilege escalation vulnerability related to the OpenSSL component. An
unprivileged Windows user can exploit this, by creating the appropriate path to a specially-crafted
openssl.cnf in order to execute arbitrary code with SYSTEM privileges.
...
constraints = [
  { 'min_version' : '7.2', 'fixed_version' : '7.3.5281' }
];
