...
if (description)
{
  ...
  script_name(english:"Adobe After Effects < 23.6.5 / 24.0 < 24.2 Memory leak (APSB24-09)");
...
"The version of Adobe After Effects installed on the remote Windows host is prior to 23.6.5, 24.2. It is, therefore,
