...
# extracted from Ubuntu Security Notice USN-4940-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4940-1");
  script_xref(name:"IAVA", value:"2021-A-0463");

  script_name(english:"Ubuntu 20.04 LTS : PyYAML vulnerability (USN-4940-1)");
...
USN-4940-1 advisory.
    ...
    It was discovered that PyYAML incorrectly handled untrusted YAML files with the FullLoader loader. A
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4940-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'python-yaml', 'pkgver': '5.3.1-1ubuntu0.1'},
    {'osver': '20.04', 'pkgname': 'python3-yaml', 'pkgver': '5.3.1-1ubuntu0.1'}
];
