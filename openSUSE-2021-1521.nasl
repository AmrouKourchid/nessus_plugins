...
# openSUSE Security Update openSUSE-SU-2021:1521-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-Pygments (openSUSE-SU-2021:1521-1)");
...
openSUSE-SU-2021:1521-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/Q2O2K274EQSHKSL5YSPYVHDKM5IDGONQ/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?48bc10ac");
...
"Update the affected python3-Pygments package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:python3-Pygments");
...
var pkgs = [
    {'reference':'python3-Pygments-2.6.1-lp152.5.12.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
