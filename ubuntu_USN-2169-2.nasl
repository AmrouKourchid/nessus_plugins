...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Django regression (USN-2169-2)");
...
USN-2169-2 advisory.
    ...
    USN-2169-1 fixed vulnerabilities in Django. The upstream security patch for CVE-2014-0472 introduced a
    regression for certain applications. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2169-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'python-django', 'pkgver': '1.6.1-2ubuntu0.2'}
];
