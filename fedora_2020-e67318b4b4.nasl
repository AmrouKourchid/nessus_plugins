...
# extracted from Fedora Security Advisory FEDORA-2020-e67318b4b4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : transmission (2020-e67318b4b4)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-e67318b4b4");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"transmission-2.94-9.fc32")) flag++;
