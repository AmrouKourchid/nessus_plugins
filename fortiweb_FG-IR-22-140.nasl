...
if (description)
{
  ...
  script_name(english:"Fortinet FortiWeb sqli (FG-IR-22-140)");
...
vulnerability as referenced in the FG-IR-22-140 advisory.

  - An improper neutralization of special elements used in an SQL command ('SQL Injection') vulnerability
    [CWE-89] in FortiWeb delete log filter component may allow a privileged attacker to execute SQL commands
    over the log database via specifically crafted strings parameters. (CVE-2022-29059)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-22-140");
...
var constraints = [
  { 'min_version' : '6.2.3', 'max_version' : '6.2.7', 'fixed_version' : '7.0.2' },
  { 'min_version' : '6.3.0', 'max_version' : '6.3.18', 'fixed_version' : '7.0.2' },
