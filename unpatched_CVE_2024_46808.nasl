...
if (description)
{
  ...
  script_cve_id("CVE-2024-46808");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46808");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Add missing NULL
    pointer check within dpcd_extend_address_range [Why & How] ASSERT if return NULL from kcalloc.
    (CVE-2024-46808)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46808");
