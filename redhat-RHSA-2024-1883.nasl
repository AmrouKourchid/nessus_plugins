...
# extracted from Red Hat Security Advisory RHSA-2024:1883. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1883");

  script_name(english:"RHEL 8 : shim (RHSA-2024:1883)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for shim.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:1883 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1883.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19182562");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1883");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL shim package based on the guidance in RHSA-2024:1883.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'shim-aa64-15.8-2.el8', 'sp':'8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'shim-ia32-15.8-2.el8', 'sp':'8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'shim-x64-15.8-2.el8', 'sp':'8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'shim-unsigned-x64-15.8-2.el8', 'sp':'8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'shim-aa64 / shim-ia32 / shim-unsigned-x64 / shim-x64');
}
