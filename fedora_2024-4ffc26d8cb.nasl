...
# extracted from Fedora Security Advisory FEDORA-2024-4ffc26d8cb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4ffc26d8cb");

  script_name(english:"Fedora 40 : dnsdist (2024-4ffc26d8cb)");
...
FEDORA-2024-4ffc26d8cb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4ffc26d8cb");
...
var pkgs = [
    {'reference':'dnsdist-1.9.7-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
