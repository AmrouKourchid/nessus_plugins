...
# extracted from Ubuntu Security Notice USN-5178-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5178-1");

  script_name(english:"Ubuntu 20.04 LTS : Django vulnerability (USN-5178-1)");
...
USN-5178-1 advisory.
    ...
    Sjoerd Job Postmus and TengMA discovered that Django incorrectly handled URLs with trailing newlines. A
    remote attacker could possibly use this issue to bypass certain access controls.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5178-1");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'python3-django', 'pkgver': '2:2.2.12-1ubuntu0.8'}
];
