...
# extracted from Fedora Security Advisory FEDORA-2023-a2348480cb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a2348480cb");

  script_name(english:"Fedora 38 : libreswan (2023-a2348480cb)");
...
FEDORA-2023-a2348480cb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a2348480cb");
...
var pkgs = [
    {'reference':'libreswan-4.10-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
