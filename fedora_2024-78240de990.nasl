...
# extracted from Fedora Security Advisory FEDORA-2024-78240de990
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-78240de990");

  script_name(english:"Fedora 39 : sssd (2024-78240de990)");
...
FEDORA-2024-78240de990 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-78240de990");
...
var pkgs = [
    {'reference':'sssd-2.9.4-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
