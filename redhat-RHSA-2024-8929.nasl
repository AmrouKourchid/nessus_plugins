...
# extracted from Red Hat Security Advisory RHSA-2024:8929. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8929");

  script_name(english:"RHEL 9 : mod_jk (RHSA-2024:8929)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for mod_jk.");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-65739");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8929.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?75ffea63");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8929");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mod_jk package based on the guidance in RHSA-2024:8929.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mod_jk-1.2.50-1.el9_2.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mod_jk');
}
