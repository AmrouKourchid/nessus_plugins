...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-0750.html");
...
var pkgs = [
    ...
    {'reference':'postgresql-contrib-9.2.10-2.el7_1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-devel-9.2.10-2.el7_1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-docs-9.2.10-2.el7_1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-libs-9.2.10-2.el7_1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-plperl-9.2.10-2.el7_1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-plpython-9.2.10-2.el7_1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-pltcl-9.2.10-2.el7_1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-server-9.2.10-2.el7_1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-test-9.2.10-2.el7_1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'postgresql-upgrade-9.2.10-2.el7_1', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
