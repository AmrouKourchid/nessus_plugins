...
# extracted from Fedora Security Advisory FEDORA-2022-64ab9153c0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-64ab9153c0");

  script_name(english:"Fedora 36 : kernel (2022-64ab9153c0)");
...
FEDORA-2022-64ab9153c0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-64ab9153c0");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2022-64ab9153c0');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.0.8-200.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
