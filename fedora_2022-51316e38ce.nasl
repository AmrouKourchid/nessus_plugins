...
# extracted from Fedora Security Advisory FEDORA-2022-51316e38ce
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-51316e38ce");

  script_name(english:"Fedora 37 : suricata (2022-51316e38ce)");
...
FEDORA-2022-51316e38ce advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-51316e38ce");
...
var pkgs = [
    {'reference':'suricata-6.0.9-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
