...
# extracted from Fedora Security Advisory FEDORA-2023-604a7d56b0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-604a7d56b0");

  script_name(english:"Fedora 38 : freeimage / mingw-freeimage (2023-604a7d56b0)");
...
FEDORA-2023-604a7d56b0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-604a7d56b0");
...
"Update the affected freeimage and / or mingw-freeimage packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-40263");
...
var pkgs = [
    {'reference':'freeimage-3.19.0-0.20.svn1909.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mingw-freeimage-3.19.0-0.17.svn1909.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
