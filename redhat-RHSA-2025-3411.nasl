...
# extracted from Red Hat Security Advisory RHSA-2025:3411. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:3411");

  script_name(english:"RHEL 9 : opentelemetry-collector (RHSA-2025:3411)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_3411.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ce08aa69");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:3411");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL opentelemetry-collector package based on the guidance in RHSA-2025:3411.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'opentelemetry-collector-0.107.0-10.el9_5', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
