...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Openjdk11 PHSA-2020-2.0-0265");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openjdk11-11.0.8-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openjdk11-doc-11.0.8-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openjdk11-src-11.0.8-1.ph2')) flag++;
