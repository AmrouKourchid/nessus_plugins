...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 1607 Enterprise 2016 LTSB SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 1607 Enterprise 2016 LTSB is no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # https://learn.microsoft.com/en-us/lifecycle/products/windows-10-2016-ltsb
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d1357c57");
...
"Upgrade to a version of Microsoft Windows that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2026/10/13");
...
var os = ucf::get_os_cpe(vendor:'microsoft', product:'windows_10_1607', type:'local');

var constraints = [
  { seol : 20261013, cpe_attributes : [{'edition': 'enterprise_2016_ltsb'}] }
];
