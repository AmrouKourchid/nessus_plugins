...
if (description)
{
  ...
  script_cve_id("CVE-2024-47683");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-47683");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Skip Recompute DSC
    ...
    new request. If detected, keep checking whether the stream is already on current state or not.
    (CVE-2024-47683)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-47683");
