...
# extracted from VMware Security Advisory PHSA-2022-4.0-0243. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Rpm PHSA-2022-4.0-0243");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the rpm package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-243.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'rpm-4.16.1.3-12.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'rpm-build-4.16.1.3-12.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'rpm-devel-4.16.1.3-12.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'rpm-lang-4.16.1.3-12.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'rpm-libs-4.16.1.3-12.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'rpm-plugin-systemd-inhibit-4.16.1.3-12.ph4')) flag++;
