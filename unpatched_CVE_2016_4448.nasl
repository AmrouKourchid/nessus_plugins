...
if (description)
{
  ...
  script_cve_id("CVE-2016-4448");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-4448");
...
patch available.
  ...
  - Format string vulnerability in libxml2 before 2.9.4 allows attackers to have unspecified impact via format
    string specifiers in unknown vectors. (CVE-2016-4448)
