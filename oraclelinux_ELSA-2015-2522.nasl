...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-2522.html");
...
var pkgs = [
    {'reference':'apache-commons-collections-3.2.1-22.el7_2', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'apache-commons-collections-javadoc-3.2.1-22.el7_2', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'apache-commons-collections-testframework-3.2.1-22.el7_2', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'apache-commons-collections-testframework-javadoc-3.2.1-22.el7_2', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'apache-commons-collections / apache-commons-collections-javadoc / apache-commons-collections-testframework / etc');
}
