...
# extracted from Ubuntu Security Notice USN-4229-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4229-2");

  script_name(english:"Ubuntu 18.04 ESM : NTP vulnerability (USN-4229-2)");
...
USN-4229-2 advisory.
    ...
    USN-4229-1 fixed a vulnerability in NTP. This update provides the corresponding update for Ubuntu 18.04
    ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4229-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'ntp', 'pkgver': '1:4.2.8p10+dfsg-5ubuntu7.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'ntpdate', 'pkgver': '1:4.2.8p10+dfsg-5ubuntu7.3+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'sntp', 'pkgver': '1:4.2.8p10+dfsg-5ubuntu7.3+esm1', 'ubuntu_pro': TRUE}
];
