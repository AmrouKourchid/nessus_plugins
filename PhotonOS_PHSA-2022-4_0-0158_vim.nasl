...
if (description)
{
  ...
  script_cve_id("CVE-2022-0128", "CVE-2022-0554");

  script_name(english:"Photon OS 4.0: Vim PHSA-2022-4.0-0158");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-8.2.3428-10.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'vim-extra-8.2.3428-10.ph4')) flag++;
