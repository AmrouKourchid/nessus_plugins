...
# extracted from Fedora Security Advisory FEDORA-2024-f9eb1130c8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f9eb1130c8");

  script_name(english:"Fedora 40 : chromium (2024-f9eb1130c8)");
...
FEDORA-2024-f9eb1130c8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f9eb1130c8");
...
var pkgs = [
    {'reference':'chromium-123.0.6312.58-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
