...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : util-linux (EulerOS-SA-2023-1302)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1302
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1155f4b0");
...
var pkgs = [
  "util-linux-2.23.2-52.1.h13.eulerosv2r7"
];
