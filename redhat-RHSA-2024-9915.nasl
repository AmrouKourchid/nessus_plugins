...
# extracted from Red Hat Security Advisory RHSA-2024:9915. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9915");

  script_name(english:"RHEL 9 : gnome-shell (RHSA-2024:9915)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9915.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ce6ea8a4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9915");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gnome-shell package based on the guidance in RHSA-2024:9915.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gnome-shell-40.10-19.el9_4', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
