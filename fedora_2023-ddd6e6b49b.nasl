...
# extracted from Fedora Security Advisory FEDORA-2023-ddd6e6b49b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ddd6e6b49b");

  script_name(english:"Fedora 38 : libreswan (2023-ddd6e6b49b)");
...
FEDORA-2023-ddd6e6b49b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ddd6e6b49b");
...
var pkgs = [
    {'reference':'libreswan-4.12-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
