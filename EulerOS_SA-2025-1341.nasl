...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP13 : python-jinja2 (EulerOS-SA-2025-1341)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1341
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71b366e6");
...
var pkgs = [
  "python3-jinja2-3.0.3-2.h4.eulerosv2r13"
];
