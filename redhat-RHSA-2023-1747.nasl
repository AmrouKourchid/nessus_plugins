...
# extracted from Red Hat Security Advisory RHSA-2023:1747. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1747");

  script_name(english:"RHEL 8 : pki-core:10.6 (RHSA-2023:1747)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for pki-core:10.6.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:1747 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1747.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9829598b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2104676");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1747");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pki-core:10.6 package based on the guidance in RHSA-2023:1747.");
  ...
  'pki-core:10.6': [
    {
      ...
      'pkgs': [
        {'reference':'jss-4.6.2-12.module+el8.2.0+10554+cf83aa72', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jss-4.6.2-12.module+el8.2.0+10554+cf83aa72', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jss-javadoc-4.6.2-12.module+el8.2.0+10554+cf83aa72', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'jss-javadoc-4.6.2-12.module+el8.2.0+10554+cf83aa72', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        ...
        {'reference':'pki-base-10.8.4-1.module+el8.2.0+17305+ef598dea', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-base-java-10.8.4-1.module+el8.2.0+17305+ef598dea', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-ca-10.8.4-1.module+el8.2.0+17305+ef598dea', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-kra-10.8.4-1.module+el8.2.0+17305+ef598dea', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-server-10.8.4-1.module+el8.2.0+17305+ef598dea', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-symkey-10.8.4-1.module+el8.2.0+17305+ef598dea', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-symkey-10.8.4-1.module+el8.2.0+17305+ef598dea', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-tools-10.8.4-1.module+el8.2.0+17305+ef598dea', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'pki-tools-10.8.4-1.module+el8.2.0+17305+ef598dea', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-pki-10.8.4-1.module+el8.2.0+17305+ef598dea', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
