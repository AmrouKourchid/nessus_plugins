...
# extracted from Fedora Security Advisory FEDORA-2018-c7a234c440.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-c7a234c440");

  script_name(english:"Fedora 28 : libtiff (2018-c7a234c440)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Added fix for **CVE-2018-7456**.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-c7a234c440");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"libtiff-4.0.9-8.fc28")) flag++;
