...
# Red Hat Security Advisory RHSA-2021:1751. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : mailman:2.1 (CESA-2021:1751)");
...
pkgs = [
    {'reference':'mailman-2.1.29-11.module_el8.4.0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
    {'reference':'mailman-2.1.29-11.module_el8.4.0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
