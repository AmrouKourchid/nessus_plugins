...
# extracted from VMware Security Advisory PHSA-2024-4.0-0638. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Libssh2 PHSA-2024-4.0-0638");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the libssh2 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-638.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libssh2-1.11.0-2.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'libssh2-devel-1.11.0-2.ph4')) flag++;
