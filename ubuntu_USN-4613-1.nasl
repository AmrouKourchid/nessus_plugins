...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : python-cryptography vulnerability (USN-4613-1)");
...
referenced in the USN-4613-1 advisory.

    Hubert Kario discovered that python-cryptography incorrectly handled certain decryption. An attacker could
