...
# Rocky Linux Security Advisory RLSA-2024:1962.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:1962");
  script_xref(name:"IAVB", value:"2024-B-0032-S");

  script_name(english:"Rocky Linux 8 : go-toolset:rhel8 (RLSA-2024:1962)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2024:1962 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:1962");
...
var pkgs = [
    ...
    {'reference':'golang-1.20.12-8.module+el8.9.0+1787+5672f315', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-1.20.12-8.module+el8.9.0+1787+5672f315', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-bin-1.20.12-8.module+el8.9.0+1787+5672f315', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-bin-1.20.12-8.module+el8.9.0+1787+5672f315', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-docs-1.20.12-8.module+el8.9.0+1787+5672f315', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-misc-1.20.12-8.module+el8.9.0+1787+5672f315', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-src-1.20.12-8.module+el8.9.0+1787+5672f315', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'golang-tests-1.20.12-8.module+el8.9.0+1787+5672f315', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
