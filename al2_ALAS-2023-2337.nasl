...
# extracted from Amazon Linux 2 Security Advisory ALAS-2023-2337.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : qt5-qtimageformats (ALAS-2023-2337)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of qt5-qtimageformats installed on the remote host is prior to 5.9.2-1. It is, therefore, affected by a
vulnerability as referenced in the ALAS2-2023-2337 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2023-2337.html");
...
var pkgs = [
    {'reference':'qt5-qtimageformats-5.9.2-1.amzn2.0.3', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtimageformats-5.9.2-1.amzn2.0.3', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtimageformats-5.9.2-1.amzn2.0.3', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtimageformats-debuginfo-5.9.2-1.amzn2.0.3', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtimageformats-debuginfo-5.9.2-1.amzn2.0.3', 'cpu':'i686', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtimageformats-debuginfo-5.9.2-1.amzn2.0.3', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtimageformats-doc-5.9.2-1.amzn2.0.3', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
