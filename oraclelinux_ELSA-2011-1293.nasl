...
# extracted from Red Hat Security Advisory RHSA-2011:1293 and 
# Oracle Linux Security Advisory ELSA-2011-1293 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : squid (ELSA-2011-1293)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2011-1293.html");
