...
# Oracle Linux Security Advisory ELSA-2018-2737 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : mod_perl (ELSA-2018-2737)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-2737.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected mod_perl and / or mod_perl-devel packages.");
