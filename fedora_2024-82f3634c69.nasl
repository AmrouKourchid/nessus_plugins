...
# extracted from Fedora Security Advisory FEDORA-2024-82f3634c69
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-82f3634c69");

  script_name(english:"Fedora 41 : cjson (2024-82f3634c69)");
...
FEDORA-2024-82f3634c69 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-82f3634c69");
...
var pkgs = [
    {'reference':'cjson-1.7.18-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
