...
# extracted from Fedora Security Advisory FEDORA-2018-f29459149a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : wget (2018-f29459149a)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-f29459149a");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"wget-1.19.5-1.fc26")) flag++;
