...
# extracted from Debian Security Advisory dla-3125. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3125 : libvncclient1 - security update");
...
dla-3125 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3125-1                debian-lts@lists.debian.org
    ...
    CVE ID         : CVE-2020-25708 CVE-2020-29260
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b930abb4");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-25708");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-29260");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/libvncserver");
  script_set_attribute(attribute:"solution", value:
"Upgrade the libvncclient1 packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-25708");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-29260");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libvncclient1', 'reference': '0.9.11+dfsg-1.3+deb10u5'},
    {'release': '10.0', 'prefix': 'libvncclient1-dbg', 'reference': '0.9.11+dfsg-1.3+deb10u5'},
    {'release': '10.0', 'prefix': 'libvncserver-config', 'reference': '0.9.11+dfsg-1.3+deb10u5'},
    {'release': '10.0', 'prefix': 'libvncserver-dev', 'reference': '0.9.11+dfsg-1.3+deb10u5'},
    {'release': '10.0', 'prefix': 'libvncserver1', 'reference': '0.9.11+dfsg-1.3+deb10u5'},
    {'release': '10.0', 'prefix': 'libvncserver1-dbg', 'reference': '0.9.11+dfsg-1.3+deb10u5'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libvncclient1 / libvncclient1-dbg / libvncserver-config / etc');
}
