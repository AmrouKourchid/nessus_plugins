...
# extracted from Red Hat Security Advisory RHSA-2023:6496. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6496");

  script_name(english:"RHEL 9 : haproxy (RHSA-2023:6496)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for haproxy.");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6496.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8ad9c80d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2180746");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2196530");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2212246");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6496");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL haproxy package based on the guidance in RHSA-2023:6496.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy-2.4.22-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
