...
Other issue addressed :
  ...
  - Restore process name after sv_setpv_mg() call.
    (bsc#1091625)&#9;");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1091625");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1156944");
  script_set_attribute(attribute:"solution", value:
"Update the affected apache2-mod_perl packages.");
