...
# extracted from Fedora Security Advisory FEDORA-2023-6b20b7807a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6b20b7807a");
  script_xref(name:"IAVB", value:"2023-B-0075-S");

  script_name(english:"Fedora 38 : poppler (2023-6b20b7807a)");
...
FEDORA-2023-6b20b7807a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6b20b7807a");
...
var pkgs = [
    {'reference':'poppler-23.02.0-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
