...
# extracted from Fedora Security Advisory FEDORA-2023-eeca11a4df
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-eeca11a4df");

  script_name(english:"Fedora 38 : dnsmasq (2023-eeca11a4df)");
...
FEDORA-2023-eeca11a4df advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-eeca11a4df");
...
var pkgs = [
    {'reference':'dnsmasq-2.89-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
