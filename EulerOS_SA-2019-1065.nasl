...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : ghostscript (EulerOS-SA-2019-1065)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1065
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e7a1c467");
...
pkgs = ["ghostscript-9.07-31.6.h4.eulerosv2r7",
        "ghostscript-cups-9.07-31.6.h4.eulerosv2r7"];
