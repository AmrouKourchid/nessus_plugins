...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.06 : dovecot Vulnerability (NS-SA-2019-0211)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.06, has dovecot packages installed that are affected by a
vulnerability:
