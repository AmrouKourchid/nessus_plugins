...
# extracted from Debian Security Advisory dla-2944. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2944-1 : nbd - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2944
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2944");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-26495");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/nbd");
...
For Debian 9 Stretch, these problems have been fixed in version 1");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-26495");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'nbd-client', 'reference': '1:3.15.2-3+deb9u1'},
    {'release': '9.0', 'prefix': 'nbd-server', 'reference': '1:3.15.2-3+deb9u1'}
];
