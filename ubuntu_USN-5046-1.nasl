...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS : Linux kernel vulnerabilities (USN-5046-1)");
...
var kernel_mappings = {
  '20.04': {
    '5.11.0': {
      'generic': '5.11.0-27',
      'generic-64k': '5.11.0-27',
      'generic-lpae': '5.11.0-27',
      'lowlatency': '5.11.0-27'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5046-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2020-26558', 'CVE-2021-0129', 'CVE-2021-3564', 'CVE-2021-3573', 'CVE-2021-28691');
