...
# extracted from Oracle Linux Security Advisory ELSA-2024-3017.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : edk2 (ELSA-2024-3017)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2024-3017 advisory.

    - Resolves: RHEL-21158
      (CVE-2022-36765 edk2: integer overflow in CreateHob() could lead to HOB OOB R/W [rhel-8])
    - edk2-NetworkPkg-Ip6Dxe-SECURITY-PATCH-CVE-2023-45231-Patc.patch [RHEL-21840 RHEL-21844 RHEL-21846
    RHEL-21848 RHEL-21850 RHEL-21852]
    - edk2-NetworkPkg-Ip6Dxe-SECURITY-PATCH-CVE-2023-45231-Unit.patch [RHEL-21840 RHEL-21844 RHEL-21846
    RHEL-21848 RHEL-21850 RHEL-21852]
    - edk2-NetworkPkg-Ip6Dxe-SECURITY-PATCH-CVE-2023-45232-Patc.patch [RHEL-21840 RHEL-21844 RHEL-21846
    RHEL-21848 RHEL-21850 RHEL-21852]
    - edk2-NetworkPkg-Ip6Dxe-SECURITY-PATCH-CVE-2023-45232-Unit.patch [RHEL-21840 RHEL-21844 RHEL-21846
    RHEL-21848 RHEL-21850 RHEL-21852]
    - edk2-NetworkPkg-UefiPxeBcDxe-SECURITY-PATCH-CVE-2023-4523.patch [RHEL-21840 RHEL-21844 RHEL-21846
    RHEL-21848 RHEL-21850 RHEL-21852]
    - edk2-NetworkPkg-UefiPxeBcDxe-SECURITY-PATCH-CVE-2023-4523p2.patch [RHEL-21840 RHEL-21844 RHEL-21846
    RHEL-21848 RHEL-21850 RHEL-21852]
    - edk2-NetworkPkg-UefiPxeBcDxe-SECURITY-PATCH-CVE-2023-4523p3.patch [RHEL-21840 RHEL-21844 RHEL-21846
    RHEL-21848 RHEL-21850 RHEL-21852]
    - edk2-NetworkPkg-UefiPxeBcDxe-SECURITY-PATCH-CVE-2023-4523p4.patch [RHEL-21840 RHEL-21844 RHEL-21846
    RHEL-21848 RHEL-21850 RHEL-21852]
    - edk2-NetworkPkg-Dhcp6Dxe-SECURITY-PATCH-CVE-2023-45229-Re.patch [RHEL-21840 RHEL-21844 RHEL-21846
    RHEL-21848 RHEL-21850 RHEL-21852]
    - Resolves: RHEL-21840
    ...
    [rhel-8])
    - Resolves: RHEL-21848
      (CVE-2023-45233 edk2: Infinite loop when parsing a PadN option in the Destination Options header
    [rhel-8])
    - Resolves: RHEL-21850
      (CVE-2023-45234 edk2: Buffer overflow when processing DNS Servers option in a DHCPv6 Advertise message
    [rhel-8])
    - Resolves: RHEL-21852
      (CVE-2023-45235 edk2: Buffer overflow when handling Server ID option from a DHCPv6 proxy Advertise
    message [rhel-8])
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-3017.html");
...
var pkgs = [
    {'reference':'edk2-aarch64-20220126gitbb1bba3d77-13.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'edk2-ovmf-20220126gitbb1bba3d77-13.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
