...
# extracted from Fedora Security Advisory FEDORA-2024-d7b9fbb2a5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d7b9fbb2a5");

  script_name(english:"Fedora 41 : freeipa (2024-d7b9fbb2a5)");
...
FEDORA-2024-d7b9fbb2a5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d7b9fbb2a5");
...
var pkgs = [
    {'reference':'freeipa-4.11.1-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
