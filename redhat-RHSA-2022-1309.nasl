...
# extracted from Red Hat Security Advisory RHSA-2022:1309. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1309");

  script_name(english:"RHEL 6 : expat (RHSA-2022:1309)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for expat.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:1309 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1309.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b5fccaef");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1309");
...
"Update the RHEL expat package based on the guidance in RHSA-2022:1309.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'expat-2.0.1-14.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-2.0.1-14.el6_10', 'cpu':'s390', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-2.0.1-14.el6_10', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-2.0.1-14.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-devel-2.0.1-14.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-devel-2.0.1-14.el6_10', 'cpu':'s390', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-devel-2.0.1-14.el6_10', 'cpu':'s390x', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'expat-devel-2.0.1-14.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
