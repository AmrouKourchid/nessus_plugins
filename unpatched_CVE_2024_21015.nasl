...
if (description)
{
  ...
  script_cve_id("CVE-2024-21015");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-21015");
...
patch available.
  ...
  - Vulnerability in the MySQL Server product of Oracle MySQL (component: Server: DML). Supported versions
    that are affected are 8.0.34 and prior and 8.3.0 and prior. Easily exploitable vulnerability allows high
    ...
    MySQL Server accessible data. (CVE-2024-21015)
