...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002520");
  script_xref(name:"MSFT", value:"MS23-5002520");
  script_xref(name:"IAVA", value:"2023-A-0686-S");

  script_name(english:"Security Updates for Microsoft Word Products (December 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Word Products are affected by an information disclosure vulnerability.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Word Products are missing security updates. It is, therefore, affected by an information disclosure
vulnerability. An attacker can exploit this to disclose potentially sensitive information.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002520");
...
"Microsoft has released KB5002520 to address this issue.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-36009");
...
var constraints = [
  { 'kb':'5002520', 'channel':'MSI', 'fixed_version': '16.0.5426.1000', 'sp' : 0}
];
