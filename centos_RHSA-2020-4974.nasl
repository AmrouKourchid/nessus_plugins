...
# extracted from Red Hat Security Advisory RHSA-2020:4974.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : chromium-browser (RHSA-2020:4974)");
...
var pkgs = [
    {'reference':'chromium-browser-86.0.4240.183-1.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
