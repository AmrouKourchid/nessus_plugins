...
if (description)
{
  ...
  script_name(english:"CentOS 9 : curl-7.76.1-23.el9");
...
curl-7.76.1-23.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=30555");
