...
# extracted from Fedora Security Advisory FEDORA-2020-8d3ea0fe8d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : mbedtls (2020-8d3ea0fe8d)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-8d3ea0fe8d");
  # https://tls.mbed.org/tech-updates/security-advisories/mbedtls-security-advisory-2019-12
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b9ed5b3f");
...
"Update the affected mbedtls package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-18222");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"mbedtls-2.16.4-1.fc30")) flag++;
