...
# extracted from Fedora Security Advisory FEDORA-2023-921f6975c2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-921f6975c2");

  script_name(english:"Fedora 39 : perl-Spreadsheet-ParseExcel (2023-921f6975c2)");
...
FEDORA-2023-921f6975c2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-921f6975c2");
...
"Update the affected perl-Spreadsheet-ParseExcel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:perl-Spreadsheet-ParseExcel");
...
var pkgs = [
    {'reference':'perl-Spreadsheet-ParseExcel-0.6600-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
