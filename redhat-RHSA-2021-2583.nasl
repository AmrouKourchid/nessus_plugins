...
# extracted from Red Hat Security Advisory RHSA-2021:2583. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : python38:3.8 and python38-devel:3.8 (RHSA-2021:2583)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2583.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?afa39d2e");
...
"Update the RHEL python38:3.8 / python38-devel:3.8 packages based on the guidance in RHSA-2021:2583.");
...
var appstreams = {
  'python38:3.8': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'python38-pyyaml-5.4.1-1.module+el8.4.0+10706+5c295a3e', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
    ...
    },
    {
      ...
      'pkgs': [
        ...
        {'reference':'python38-pyyaml-5.4.1-1.module+el8.4.0+10706+5c295a3e', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
  ...
  'python38-devel:3.8': [
    ...
    },
    {
      ...
      'pkgs': [
        {'reference':'python38-atomicwrites-1.3.0-8.module+el8.4.0+8888+89bc7e79', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python38-attrs-19.3.0-3.module+el8.4.0+8888+89bc7e79', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python38-more-itertools-7.2.0-5.module+el8.4.0+8888+89bc7e79', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python38-packaging-19.2-3.module+el8.4.0+8888+89bc7e79', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python38-pluggy-0.13.0-3.module+el8.4.0+8888+89bc7e79', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python38-py-1.8.0-8.module+el8.4.0+8888+89bc7e79', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python38-pyparsing-2.4.5-3.module+el8.4.0+8888+89bc7e79', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python38-pytest-4.6.6-3.module+el8.4.0+8888+89bc7e79', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python38-wcwidth-0.1.7-16.module+el8.4.0+8888+89bc7e79', 'sp':'4', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
