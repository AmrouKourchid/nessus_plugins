...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5040490");
  script_xref(name:"MSKB", value:"5040499");
  script_xref(name:"MSFT", value:"MS24-5040490");
  script_xref(name:"MSFT", value:"MS24-5040499");
  ...
  script_name(english:"KB5040490: Windows Server 2008 Security Update (July 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5040490. It is, therefore, affected by multiple vulnerabilities
  ...
  - A remote code execution vulnerability. An attacker can exploit this to bypass authentication and execute 
    unauthorized arbitrary commands. (CVE-2024-38104)


Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5040490");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5040499");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5040490 or Cumulative Update 5040499");
...
if (
  smb_check_rollup(os:'6.0',
                   ...
                   rollup_date:'07_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5040499, 5040490])
)
{
