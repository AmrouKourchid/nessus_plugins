...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1345.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1345");

  script_name(english:"Amazon Linux 2 : compat-libtiff3 (ALAS-2019-1345)");
...
CVE-2017-18013 patch.)(CVE-2018-7456)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1345.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"compat-libtiff3-3.9.4-12.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"compat-libtiff3-debuginfo-3.9.4-12.amzn2")) flag++;
