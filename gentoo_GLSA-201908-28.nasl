...
# extracted from Gentoo Linux Security Advisory GLSA 201908-28.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201908-28");

  script_name(english:"GLSA-201908-28 : GNOME desktop library: Security bypass");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201908-28
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201908-28");
...
"All GNOME desktop library users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:gnome-desktop");
...
if (qpkg_check(package:"gnome-base/gnome-desktop", unaffected:make_list("ge 3.30.2.3"), vulnerable:make_list("lt 3.30.2.3"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "GNOME desktop library");
}
