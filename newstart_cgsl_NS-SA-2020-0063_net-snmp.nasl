...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : net-snmp Vulnerability (NS-SA-2020-0063)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has net-snmp packages installed that are affected
by a vulnerability:
...
pkgs = {
  'CGSL CORE 5.04': [
    'net-snmp-5.7.2-47.el7.cgslv5',
    'net-snmp-agent-libs-5.7.2-47.el7.cgslv5',
    'net-snmp-debuginfo-5.7.2-47.el7.cgslv5',
    'net-snmp-devel-5.7.2-47.el7.cgslv5',
    'net-snmp-gui-5.7.2-47.el7.cgslv5',
    'net-snmp-libs-5.7.2-47.el7.cgslv5',
    'net-snmp-perl-5.7.2-47.el7.cgslv5',
    'net-snmp-python-5.7.2-47.el7.cgslv5',
    'net-snmp-sysvinit-5.7.2-47.el7.cgslv5',
    'net-snmp-utils-5.7.2-47.el7.cgslv5'
  ],
  'CGSL MAIN 5.04': [
    'net-snmp-5.7.2-47.el7.cgslv5',
    'net-snmp-agent-libs-5.7.2-47.el7.cgslv5',
