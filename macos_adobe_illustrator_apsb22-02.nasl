...
if (description)
{
  ...
  script_name(english:"Adobe Illustrator < 25.4.3 / 26.0.0 < 26.0.2 Multiple Privilege escalation (APSB22-02) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Illustrator instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Illustrator installed on the remote macOS host is prior to 25.4.3, 26.0.2. It is, therefore,
affected by multiple vulnerabilities as referenced in the APSB22-02 advisory.

  - Adobe Illustrator versions 25.4.2 (and earlier) and 26.0.1 (and earlier) are affected by an out-of-bounds
    ...
    that a victim must open a malicious file. (CVE-2021-43752, CVE-2021-44700)
...
"Upgrade to Adobe Illustrator version 25.4.3, 26.0.2 or later.");
...
var constraints = [
  { 'fixed_version' : '25.4.3' },
  { 'min_version' : '26.0.0', 'fixed_version' : '26.0.2' }
];
