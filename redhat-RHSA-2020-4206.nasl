...
# extracted from Red Hat Security Advisory RHSA-2020:4206. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4206");
  script_xref(name:"IAVA", value:"2020-A-0436-S");

  script_name(english:"RHEL 6 : chromium-browser (RHSA-2020:4206)");
...
referenced in the RHSA-2020:4206 advisory.
    ...
    * chromium-browser: Insufficient policy enforcement in extensions (CVE-2020-15961)

    * chromium-browser: Insufficient policy enforcement in serial (CVE-2020-15962)

    * chromium-browser: Insufficient policy enforcement in extensions (CVE-2020-15963)
    ...
    * chromium-browser: Insufficient policy enforcement in extensions (CVE-2020-15966)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4206.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1233c8e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4206");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1881593");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1881595");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1881596");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1881597");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1881598");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1881599");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1881600");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL chromium-browser package based on the guidance in RHSA-2020:4206.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'chromium-browser-85.0.4183.121-1.el6_10', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'chromium-browser-85.0.4183.121-1.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
