...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : xorg-x11-server (EulerOS-SA-2024-1210)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1210
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?35c9fff3");
...
var pkgs = [
  "xorg-x11-server-help-1.20.6-5.h10.eulerosv2r9"
];
