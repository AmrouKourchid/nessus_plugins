...
# extracted from Red Hat Security Advisory RHSA-2021:2420. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_2420.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2185c96");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2420");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1963258");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL dhcp package based on the guidance in RHSA-2021:2420.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dhcp-client-4.3.6-40.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-common-4.3.6-40.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-libs-4.3.6-40.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-relay-4.3.6-40.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-server-4.3.6-40.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'}
    ]
  }
];
