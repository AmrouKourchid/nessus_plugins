...
# SUSE update advisory SUSE-SU-2023:4093-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4093-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (SUSE-SU-2023:4093-1)");
...
the SUSE-SU-2023:4093-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-October/016702.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dbee4990");
...
"Update the affected kernel-livepatch-5_14_21-150400_15_56-rt package.");
...
var pkgs = [
    {'reference':'kernel-livepatch-5_14_21-150400_15_56-rt-1-150400.1.3.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_15_56-rt');
}
