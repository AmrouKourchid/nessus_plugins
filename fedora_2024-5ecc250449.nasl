...
# extracted from Fedora Security Advisory FEDORA-2024-5ecc250449
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5ecc250449");

  script_name(english:"Fedora 38 : yarnpkg (2024-5ecc250449)");
...
FEDORA-2024-5ecc250449 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5ecc250449");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.21-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
