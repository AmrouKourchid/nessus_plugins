...
# SUSE update advisory SUSE-SU-2024:2267-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:2267-1");
  script_xref(name:"IAVB", value:"2024-B-0087-S");

  script_name(english:"openSUSE 15 Security Update : libxml2 (SUSE-SU-2024:2267-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-July/018843.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?31283ffb");
...
var pkgs = [
    {'reference':'python3-libxml2-python-2.9.7-150000.3.70.1', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.5']},
    {'reference':'python3-libxml2-python-2.9.7-150000.3.70.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']}
];
