...
if (description)
{
  ...
  script_cve_id("CVE-2017-1000116");

  script_name(english:"Photon OS 1.0: Mercurial PHSA-2017-0038");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'mercurial-4.3.3-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'mercurial-debuginfo-4.3.3-1.ph1')) flag++;
