...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : sysstat (EulerOS-SA-2023-1138)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1138
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d71766ba");
...
var pkgs = [
  "sysstat-12.1.6-2.h4.eulerosv2r9"
];
