...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Linux kernel vulnerabilities (USN-2965-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2965-1");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-2965-1');
}
