...
# extracted from Red Hat Security Advisory RHSA-2019:0231. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : spice (RHSA-2019:0231)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for spice.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:0231 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0231.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0f7421ff");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0231");
...
"Update the RHEL spice package based on the guidance in RHSA-2019:0231.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'spice-server-0.14.0-6.el7_6.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-server-devel-0.14.0-6.el7_6.1', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
