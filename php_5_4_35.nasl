...
if (description)
{
  ...
  script_name(english:"PHP 5.4.x < 5.4.35 'donote' DoS");
...
remote host is prior to 5.4.35. It is, therefore, affected by an
...
instead relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-5.php#5.4.35");
...
if (version =~ "^5\.4\.([0-9]|[12][0-9]|3[0-4])($|[^0-9])")
{
