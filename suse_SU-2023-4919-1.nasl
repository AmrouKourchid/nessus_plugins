...
# SUSE update advisory SUSE-SU-2023:4919-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:4919-1");
  script_xref(name:"IAVA", value:"2024-A-0121-S");

  script_name(english:"SUSE SLES15 Security Update : openssl-1_1-livepatches (SUSE-SU-2023:4919-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1208755");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1217151");
  # https://lists.suse.com/pipermail/sle-security-updates/2023-December/017499.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92110945");
...
var pkgs = [
    {'reference':'openssl-1_1-livepatches-0.2-150400.3.6.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
];
