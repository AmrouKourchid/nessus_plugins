...
if (description)
{
  ...
  script_cve_id("CVE-2004-2771");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2004-2771");
...
patch available.
  ...
  - The expand function in fio.c in Heirloom mailx 12.5 and earlier and BSD mailx 8.1.2 and earlier allows
    remote attackers to execute arbitrary commands via shell metacharacters in an email address.
    (CVE-2004-2771)
