...
if (description)
{
  ...
  script_cve_id("CVE-2021-32280");

  script_name(english:"CentOS 9 : transfig-3.2.7b-9.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for transfig.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has a package installed that is affected by a vulnerability as referenced in the
transfig-3.2.7b-9.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=14424");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream transfig package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:transfig");
...
var pkgs = [
    {'reference':'transfig-3.2.7b-9.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
