...
if (description)
{
  ...
  script_name(english:"Adobe Premiere Pro < 15.4.3 / 22.0.0 < 22.1.1 Multiple Vulnerabilities (APSB21-117) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Premiere Pro instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Premiere Pro installed on the remote macOS host is prior to 15.4.3, 22.1.1. It is, therefore,
