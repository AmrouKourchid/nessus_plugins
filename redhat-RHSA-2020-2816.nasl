...
# extracted from Red Hat Security Advisory RHSA-2020:2816. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:2816");

  script_name(english:"RHEL 6 / 7 : RH-SSO 7.4.1 adapters for Red Hat JBoss Enterprise Application Platform 6 (Important) (RHSA-2020:2816)");
...
in the RHSA-2020:2816 advisory.

    Packages: Red Hat Single Sign-On 7.4.1 adapters for Red Hat JBoss Enterprise Application Platform 6
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2816.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fefe3d48");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2816");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1705975");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/KEYCLOAK-13949");
  script_set_attribute(attribute:"solution", value:
"Update the affected keycloak-adapter-sso7_4-eap6 and / or keycloak-saml-adapter-sso7_4-eap6 packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:keycloak-adapter-sso7_4-eap6");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:keycloak-saml-adapter-sso7_4-eap6");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'keycloak-adapter-sso7_4-eap6-9.0.4-1.redhat_00001.1.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'keycloak-saml-adapter-sso7_4-eap6-9.0.4-1.redhat_00001.1.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'keycloak-adapter-sso7_4-eap6-9.0.4-1.redhat_00001.1.ep6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'keycloak-saml-adapter-sso7_4-eap6-9.0.4-1.redhat_00001.1.ep6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'keycloak-adapter-sso7_4-eap6 / keycloak-saml-adapter-sso7_4-eap6');
}
