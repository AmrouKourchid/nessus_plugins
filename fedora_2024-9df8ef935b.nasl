...
# extracted from Fedora Security Advisory FEDORA-2024-9df8ef935b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9df8ef935b");

  script_name(english:"Fedora 39 : moodle (2024-9df8ef935b)");
...
FEDORA-2024-9df8ef935b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9df8ef935b");
...
"Update the affected moodle package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-38276");
...
var pkgs = [
    {'reference':'moodle-4.3.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
