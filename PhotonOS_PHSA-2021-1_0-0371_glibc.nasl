...
# extracted from VMware Security Advisory PHSA-2021-1.0-0371. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Glibc PHSA-2021-1.0-0371");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the glibc package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-371.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'glibc-2.22-34.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'glibc-devel-2.22-34.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'glibc-lang-2.22-34.ph1')) flag++;
