...
if (description)
{
  ...
  script_cve_id("CVE-2024-20750");
  script_xref(name:"IAVB", value:"2024-B-0048-S");

  script_name(english:"Adobe Substance 3D Designer < 13.1.1 RCE (APSB24-13) (macOS)");
...
"The version of Adobe Substance 3D Designer installed on the remote macOS host is prior to 13.1.1. It is, therefore,
affected by a Remote Code Execution vulnerability as referenced in the APSB24-13 advisory.  Successful exploitation of these 
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c45935f");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe Substance 3D Designer 13.1.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-20750");
...
var constraints = [
  { 'max_version': '13.1.0', 'fixed_version' : '13.1.1' }
];
