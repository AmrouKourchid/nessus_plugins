...
# extracted from Debian Security Advisory DLA-1746-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1746-1 : drupal7 security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/04/msg00003.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"drupal7", reference:"7.32-1+deb8u16")) flag++;
