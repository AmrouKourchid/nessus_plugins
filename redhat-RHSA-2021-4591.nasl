...
"The remote Red Hat host is missing a security update for gcc-toolset-11-annobin.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4591.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c811671");
...
"Update the RHEL gcc-toolset-11-annobin package based on the guidance in RHSA-2021:4591.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gcc-toolset-11-annobin");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gcc-toolset-11-annobin-annocheck-9.85-1.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-11-annobin-docs-9.85-1.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gcc-toolset-11-annobin-plugin-gcc-9.85-1.el8_5.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
