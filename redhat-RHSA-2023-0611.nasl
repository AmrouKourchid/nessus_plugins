...
# extracted from Red Hat Security Advisory RHSA-2023:0611. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0611");

  script_name(english:"RHEL 9 : git (RHSA-2023:0611)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for git.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:0611 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0611.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56c008d3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0611");
...
"Update the RHEL git package based on the guidance in RHSA-2023:0611.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'git-2.31.1-3.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-all-2.31.1-3.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-core-2.31.1-3.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-core-doc-2.31.1-3.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-credential-libsecret-2.31.1-3.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-daemon-2.31.1-3.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'git-subtree-2.31.1-3.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
