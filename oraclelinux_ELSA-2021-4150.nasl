...
var appstreams = {
    'python36:3.6': [
      {'reference':'python-nose-docs-1.3.7-31.module+el8.5.0+20329+5c5719bc', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-pymongo-doc-3.7.0-1.module+el8.4.0+20103+1849b5f9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-sqlalchemy-doc-1.3.2-2.module+el8.3.0+7694+550a8252', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python-virtualenv-doc-15.1.0-21.module+el8.5.0+20329+5c5719bc', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-PyMySQL-0.10.1-2.module+el8.4.0+20103+1849b5f9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python3-nose-1.3.7-31.module+el8.5.0+20329+5c5719bc', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pygments-2.2.0-22.module+el8.5.0+20329+5c5719bc', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python3-virtualenv-15.1.0-21.module+el8.5.0+20329+5c5719bc', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-wheel-0.31.1-3.module+el8.5.0+20329+5c5719bc', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'python3-wheel-wheel-0.31.1-3.module+el8.5.0+20329+5c5719bc', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'python36-rpm-macros-3.6.8-38.module+el8.5.0+20329+5c5719bc', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python3-nose-1.3.7-31.module+el8.5.0+20329+5c5719bc', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pygments-2.2.0-22.module+el8.5.0+20329+5c5719bc', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python3-virtualenv-15.1.0-21.module+el8.5.0+20329+5c5719bc', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-wheel-0.31.1-3.module+el8.5.0+20329+5c5719bc', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'python3-wheel-wheel-0.31.1-3.module+el8.5.0+20329+5c5719bc', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'python36-rpm-macros-3.6.8-38.module+el8.5.0+20329+5c5719bc', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
