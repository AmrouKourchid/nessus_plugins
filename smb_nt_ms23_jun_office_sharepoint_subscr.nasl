...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002416");
  script_xref(name:"MSFT", value:"MS23-5002416");
  script_xref(name:"IAVA", value:"2023-A-0297-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server Subscription Edition (June 2023)");
...
missing security updates. It is, therefore, affected by multiple vulnerabilities:
  ...
  - A Sharepoint Server elevation of privilege vulnerabilty. (CVE-2023-33142)
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002416");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002416 to address this issue.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:R/S:U/C:H/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-33130");
