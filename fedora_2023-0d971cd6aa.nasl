...
# extracted from Fedora Security Advisory FEDORA-2023-0d971cd6aa
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0d971cd6aa");
  script_xref(name:"IAVB", value:"2023-B-0098-S");

  script_name(english:"Fedora 38 : libcmis / libreoffice (2023-0d971cd6aa)");
...
FEDORA-2023-0d971cd6aa advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0d971cd6aa");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:libreoffice and / or libcmis packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:libcmis");
...
var pkgs = [
    {'reference':'libcmis-0.6.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libreoffice-7.5.9.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libcmis / libreoffice');
}
