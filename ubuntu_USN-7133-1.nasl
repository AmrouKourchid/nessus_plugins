...
# extracted from Ubuntu Security Notice USN-7133-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7133-1");
  script_xref(name:"IAVB", value:"2024-B-0190");

  script_name(english:"Ubuntu 24.04 LTS : HAProxy vulnerability (USN-7133-1)");
...
USN-7133-1 advisory.
    ...
    Yuki Mogi discovered that HAProxy incorrectly handled the interpretation of certain HTTP requests. A
    remote attacker could possibly use this issue to perform a request smuggling attack and obtain sensitive
    information.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7133-1");
...
var pkgs = [
    {'osver': '24.04', 'pkgname': 'haproxy', 'pkgver': '2.8.5-1ubuntu3.2'},
    {'osver': '24.04', 'pkgname': 'vim-haproxy', 'pkgver': '2.8.5-1ubuntu3.2'}
];
