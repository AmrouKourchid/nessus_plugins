...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : avahi (EulerOS-SA-2023-2346)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2346
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf15d0bf");
...
var pkgs = [
  "avahi-libs-0.8-1.h11.eulerosv2r10"
];
