...
# extracted from VMware Security Advisory PHSA-2020-3.0-0179. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Cassandra PHSA-2020-3.0-0179");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the cassandra package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-3.0-179.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'cassandra-3.11.8-1.ph3')) flag++;
