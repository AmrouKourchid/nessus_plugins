...
# extracted from Ubuntu Security Notice USN-4967-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4967-2");

  script_name(english:"Ubuntu 16.04 ESM : nginx vulnerability (USN-4967-2)");
...
USN-4967-2 advisory.
    ...
    USN-4967-1 fixed a vulnerability in nginx. This update provides the corresponding update for Ubuntu 14.04
    ESM and 16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4967-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'nginx', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-common', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-core', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-extras', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-full', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-light', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm1', 'ubuntu_pro': TRUE}
];
