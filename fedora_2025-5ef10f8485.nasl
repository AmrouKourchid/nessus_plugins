...
# extracted from Fedora Security Advisory FEDORA-2025-5ef10f8485
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-5ef10f8485");

  script_name(english:"Fedora 40 : SDL2_sound (2025-5ef10f8485)");
...
FEDORA-2025-5ef10f8485 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-5ef10f8485");
...
var pkgs = [
    {'reference':'SDL2_sound-2.0.4-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
