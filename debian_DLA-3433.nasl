...
# extracted from Debian Security Advisory dla-3433. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3433 : libraw-bin - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-32142");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-1729");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libraw-bin', 'reference': '0.19.2-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libraw-dev', 'reference': '0.19.2-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libraw-doc', 'reference': '0.19.2-2+deb10u3'},
    {'release': '10.0', 'prefix': 'libraw19', 'reference': '0.19.2-2+deb10u3'}
];
