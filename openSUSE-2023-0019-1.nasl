...
# openSUSE Security Update openSUSE-SU-2023:0019-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : libheimdal (openSUSE-SU-2023:0019-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the openSUSE-SU-2023:0019-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70a17881");
...
var pkgs = [
    {'reference':'libasn1-8-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libgssapi3-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libhcrypto4-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libhdb9-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libheimbase1-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libheimdal-devel-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libheimedit0-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libheimntlm0-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libhx509-5-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libkadm5clnt7-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libkadm5srv8-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libkafs0-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libkdc2-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libkrb5-26-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libotp0-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libroken18-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libsl0-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libwind0-7.8.0-bp154.2.4.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
