...
# extracted from Ubuntu Security Notice USN-4067-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Evince vulnerability (USN-4067-1)");
...
USN-4067-1 advisory.
    ...
    It was discovered that Evince incorrectly handled certain PDF files. An attacker could possibly use this
    issue to cause a denial of service or to execute arbitrary code.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4067-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'evince', 'pkgver': '3.18.2-1ubuntu4.6'},
    {'osver': '16.04', 'pkgname': 'evince-common', 'pkgver': '3.18.2-1ubuntu4.6'},
    {'osver': '16.04', 'pkgname': 'evince-gtk', 'pkgver': '3.18.2-1ubuntu4.6'},
    {'osver': '16.04', 'pkgname': 'gir1.2-evince-3.0', 'pkgver': '3.18.2-1ubuntu4.6'},
    {'osver': '16.04', 'pkgname': 'libevdocument3-4', 'pkgver': '3.18.2-1ubuntu4.6'},
    {'osver': '16.04', 'pkgname': 'libevince-dev', 'pkgver': '3.18.2-1ubuntu4.6'},
    {'osver': '16.04', 'pkgname': 'libevview3-3', 'pkgver': '3.18.2-1ubuntu4.6'}
];
