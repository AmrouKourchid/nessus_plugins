...
# extracted from Red Hat Security Advisory RHSA-2024:2302. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2302");

  script_name(english:"RHEL 9 : gstreamer1-plugins-base (RHSA-2024:2302)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2302.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ee2db24f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2302");
...
"Update the RHEL gstreamer1-plugins-base package based on the guidance in RHSA-2024:2302.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gstreamer1-plugins-base-1.22.1-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-base-devel-1.22.1-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gstreamer1-plugins-base-tools-1.22.1-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
