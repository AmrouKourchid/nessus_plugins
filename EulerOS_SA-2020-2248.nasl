...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : ImageMagick (EulerOS-SA-2020-2248)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2248
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cadb35b0");
...
pkgs = ["ImageMagick-6.9.10.67-1.h2.eulerosv2r7",
        "ImageMagick-c++-6.9.10.67-1.h2.eulerosv2r7",
        "ImageMagick-libs-6.9.10.67-1.h2.eulerosv2r7",
        "ImageMagick-perl-6.9.10.67-1.h2.eulerosv2r7"];
