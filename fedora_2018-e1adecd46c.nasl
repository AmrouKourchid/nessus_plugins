...
# extracted from Fedora Security Advisory FEDORA-2018-e1adecd46c.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-14679", "CVE-2018-14681");
  script_xref(name:"FEDORA", value:"2018-e1adecd46c");

  script_name(english:"Fedora 27 : libmspack (2018-e1adecd46c)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"New upstream version 0.7alpha. Fixes CVE-2018-14679 libmspack:
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-e1adecd46c");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libmspack-0.7-0.1.alpha.fc27")) flag++;
