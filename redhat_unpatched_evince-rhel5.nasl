...
# extracted from Red Hat Security Advisory evince. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2013-3718", "CVE-2017-9083");

  script_name(english:"RHEL 5 : evince (Unpatched Vulnerability) (deprecated)");
