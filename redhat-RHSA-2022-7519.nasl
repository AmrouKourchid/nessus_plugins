...
# extracted from Red Hat Security Advisory RHSA-2022:7519. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:7519");

  script_name(english:"RHEL 8 : grafana (RHSA-2022:7519)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2022:7519 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_7519.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86248b0e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7519");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2055348");
...
"Update the affected grafana package.");
  ...
  script_cwe_id(79, 200, 201, 352, 425, 444, 772, 1325);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-7.5.15-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
