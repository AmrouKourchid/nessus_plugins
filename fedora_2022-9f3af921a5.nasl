...
# extracted from Fedora Security Advisory FEDORA-2022-9f3af921a5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-9f3af921a5");

  script_name(english:"Fedora 37 : sysstat (2022-9f3af921a5)");
...
FEDORA-2022-9f3af921a5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-9f3af921a5");
...
var pkgs = [
    {'reference':'sysstat-12.6.0-4.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
