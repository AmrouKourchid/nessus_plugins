...
# extracted from Fedora Security Advisory FEDORA-2023-3e8a21cd5b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3e8a21cd5b");

  script_name(english:"Fedora 37 : haproxy (2023-3e8a21cd5b)");
...
FEDORA-2023-3e8a21cd5b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3e8a21cd5b");
...
var pkgs = [
    {'reference':'haproxy-2.6.9-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
