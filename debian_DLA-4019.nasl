...
# extracted from Debian Security Advisory dla-4019. The text
...
if (description)
{
  script_id(214387);
  script_version("1.1");
  script_set_attribute(attribute:"plugin_modification_date", value:"2025/01/19");
  ...
  script_name(english:"Debian dla-4019 : busybox - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/busybox");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-28831");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-42374");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-42378");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-42379");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-42380");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-42381");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-42382");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-42384");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-42385");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-42386");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-48174");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-42364");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2023-42365");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/busybox");
  script_set_attribute(attribute:"solution", value:
"Upgrade the busybox packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-48174");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'busybox', 'reference': '1:1.30.1-6+deb11u1'},
    {'release': '11.0', 'prefix': 'busybox-static', 'reference': '1:1.30.1-6+deb11u1'},
    {'release': '11.0', 'prefix': 'busybox-syslogd', 'reference': '1:1.30.1-6+deb11u1'},
    {'release': '11.0', 'prefix': 'busybox-udeb', 'reference': '1:1.30.1-6+deb11u1'},
    {'release': '11.0', 'prefix': 'udhcpc', 'reference': '1:1.30.1-6+deb11u1'},
    {'release': '11.0', 'prefix': 'udhcpd', 'reference': '1:1.30.1-6+deb11u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'busybox / busybox-static / busybox-syslogd / busybox-udeb / udhcpc / etc');
}
