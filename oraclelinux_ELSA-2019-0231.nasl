...
# Oracle Linux Security Advisory ELSA-2019-0231 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : spice (ELSA-2019-0231)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2019-0231 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-0231.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected spice-server and / or spice-server-devel packages.");
...
var pkgs = [
    {'reference':'spice-server-0.14.0-6.0.2.el7_6.1', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spice-server-devel-0.14.0-6.0.2.el7_6.1', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
