...
# extracted from Red Hat Security Advisory RHSA-2020:1506. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : java-1.8.0-openjdk (RHSA-2020:1506)");
...
referenced in the RHSA-2020:1506 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1506.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2c3e39b6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1506");
...
"Update the RHEL java-1.8.0-openjdk package based on the guidance in RHSA-2020:1506.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'java-1.8.0-openjdk-javadoc-1.8.0.252.b09-2.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'java-1.8.0-openjdk-javadoc-debug-1.8.0.252.b09-2.el6_10', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
