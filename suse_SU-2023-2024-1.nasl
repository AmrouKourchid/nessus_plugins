...
# SUSE update advisory SUSE-SU-2023:2024-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-0590", "CVE-2023-1118");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2024-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 29 for SLE 15 SP3) (SUSE-SU-2023:2024-1)");
...
referenced in the SUSE-SU-2023:2024-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-April/028994.html");
...
"Update the affected kernel-livepatch-4_12_14-150100_197_123-default, kernel-livepatch-5_3_18-150300_59_112-default and /
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-150100.197.123-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150100_197_123-default-6-150100.2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      },
      '4.12.14-95.108-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_108-default-7-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      },
      '5.3.18-150300.59.112-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_112-default-3-150300.2.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-4_12_14-150100_197_123-default / etc');
}
