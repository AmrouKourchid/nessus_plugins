...
# AlmaLinux Security Advisory ALSA-2024:0108.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:0108");

  script_name(english:"AlmaLinux 9 : nss (ALSA-2024:0108)");
...
ALSA-2024:0108 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-0108.html");
