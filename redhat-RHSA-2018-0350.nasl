...
"The remote Red Hat host is missing a security update for gcab.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:0350 advisory.

    The gcab package contains a utility for managing the Cabinet archives. It can list, extract, and create
    Microsoft cabinet (.cab) files.

    Security Fix(es):

    * gcab: Extracting malformed .cab files causes stack smashing potentially leading to arbitrary code
    execution (CVE-2018-5345)
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0350.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b44822f3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0350");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1527296");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL gcab package based on the guidance in RHSA-2018:0350.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'gcab-0.7-4.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgcab1-0.7-4.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgcab1-devel-0.7-4.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
