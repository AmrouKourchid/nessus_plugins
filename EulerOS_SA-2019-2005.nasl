...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openssl1.1.0f (EulerOS-SA-2019-2005)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the openssl1.1.0f packages installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2005
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7883f66a");
  script_set_attribute(attribute:"solution", value:
"Update the affected openssl1.1.0f package.");
...
pkgs = ["openssl110f-1.1.0f-5.h8",
        "openssl110f-devel-1.1.0f-5.h8",
        "openssl110f-libs-1.1.0f-5.h8",
        "openssl110f-static-1.1.0f-5.h8"];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "openssl1.1.0f");
}
