...
# extracted from Red Hat Security Advisory RHSA-2023:7096. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7096");

  script_name(english:"RHEL 8 : python-cryptography (RHSA-2023:7096)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7096.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7ff3b57");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2171817");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2172404");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7096");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-cryptography package based on the guidance in RHSA-2023:7096.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-cryptography-3.2.1-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
