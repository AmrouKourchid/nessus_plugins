...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Kubernetes PHSA-2023-5.0-0043");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'kubernetes-dashboard-2.7.0-6.ph5')) flag++;
