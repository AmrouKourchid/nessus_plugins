...
# extracted from Fedora Security Advisory FEDORA-2023-5460cf6dfb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5460cf6dfb");

  script_name(english:"Fedora 39 : pypy (2023-5460cf6dfb)");
...
FEDORA-2023-5460cf6dfb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5460cf6dfb");
...
var pkgs = [
    {'reference':'pypy-7.3.12-3.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
