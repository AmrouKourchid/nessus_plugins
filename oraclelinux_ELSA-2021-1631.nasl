...
# extracted from Oracle Linux Security Advisory ELSA-2021-1631.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python-urllib3 (ELSA-2021-1631)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-1631.html");
...
var pkgs = [
    {'reference':'python3-urllib3-1.24.2-5.0.1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
