...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-1122.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-1122");

  script_name(english:"Amazon Linux 2 : wpa_supplicant (ALAS-2018-1122)");
...
vulnerability to recover sensitive information.(CVE-2018-14526)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-1122.html");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"wpa_supplicant-2.6-12.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"wpa_supplicant-debuginfo-2.6-12.amzn2")) flag++;
