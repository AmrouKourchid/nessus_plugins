...
# extracted from Fedora Security Advisory FEDORA-2024-e109b67926
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-e109b67926");

  script_name(english:"Fedora 41 : chromium (2024-e109b67926)");
...
FEDORA-2024-e109b67926 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e109b67926");
...
var pkgs = [
    {'reference':'chromium-128.0.6613.119-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
