...
# extracted from Red Hat Security Advisory RHSA-2023:2166. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2166");

  script_name(english:"RHEL 9 : freeradius (RHSA-2023:2166)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for freeradius.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:2166 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2166.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?97fa99b5");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2126380");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2166");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL freeradius package based on the guidance in RHSA-2023:2166.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freeradius-3.0.21-37.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-devel-3.0.21-37.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-doc-3.0.21-37.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-krb5-3.0.21-37.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-ldap-3.0.21-37.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-mysql-3.0.21-37.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-perl-3.0.21-37.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-postgresql-3.0.21-37.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-rest-3.0.21-37.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-sqlite-3.0.21-37.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-unixODBC-3.0.21-37.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'freeradius-utils-3.0.21-37.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-freeradius-3.0.21-37.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
