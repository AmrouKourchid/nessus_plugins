...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : php (EulerOS-SA-2019-1249)");
...
following vulnerability :
  ...
  - An infinite loop vulnerability was found in
    ...
    process and consume resources.i1/4^CVE-2018-10546i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1249
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a801e853");
...
"Update the affected php package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-10546");
...
pkgs = ["php-5.4.16-45.h3",
        "php-cli-5.4.16-45.h3",
        "php-common-5.4.16-45.h3"];
