...
# extracted from Red Hat Security Advisory RHSA-2019:3193. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : firefox (RHSA-2019:3193)");
...
referenced in the RHSA-2019:3193 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3193.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ff7f683");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3193");
...
"Update the RHEL firefox package based on the guidance in RHSA-2019:3193.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-68.2.0-1.el7_7', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.2.0-1.el7_7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.2.0-1.el7_7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.2.0-1.el7_7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-68.2.0-1.el7_7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
