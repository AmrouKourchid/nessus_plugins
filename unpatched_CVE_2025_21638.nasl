...
if (description)
{
  ...
  script_cve_id("CVE-2025-21638");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21638");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: sctp: sysctl: auth_enable: avoid using
    ...
    used directly, but that would increase the size of this fix, while 'sctp.ctl_sock' still needs to be
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21638");
