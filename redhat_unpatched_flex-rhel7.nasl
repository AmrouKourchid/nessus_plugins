...
# extracted from Red Hat Security Advisory flex. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-6354", "CVE-2019-6293");

  script_name(english:"RHEL 7 : flex (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:flex");
