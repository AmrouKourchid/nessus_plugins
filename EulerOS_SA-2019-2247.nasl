...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libpng (EulerOS-SA-2019-2247)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2247
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?abbe8150");
...
pkgs = ["libpng-1.5.13-7.h4",
        "libpng-devel-1.5.13-7.h4"];
