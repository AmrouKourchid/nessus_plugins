...
# extracted from Debian Security Advisory dla-3683. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3683 : roundcube - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3683
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3683-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                       Guilhem Moulin
    December 05, 2023                             https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : roundcube
    Version        : 1.3.17+dfsg.1-1~deb10u5
    CVE ID         : CVE-2023-47272
    Debian Bug     : 1055421

    Rene Rehme discovered a cross-site scripting (XSS) vulnerability in
    ...
    from attachment preview/download via crafted Content-Type and/or
...
var pkgs = [
    {'release': '10.0', 'prefix': 'roundcube', 'reference': '1.3.17+dfsg.1-1~deb10u5'},
    {'release': '10.0', 'prefix': 'roundcube-core', 'reference': '1.3.17+dfsg.1-1~deb10u5'},
    {'release': '10.0', 'prefix': 'roundcube-mysql', 'reference': '1.3.17+dfsg.1-1~deb10u5'},
    {'release': '10.0', 'prefix': 'roundcube-pgsql', 'reference': '1.3.17+dfsg.1-1~deb10u5'},
    {'release': '10.0', 'prefix': 'roundcube-plugins', 'reference': '1.3.17+dfsg.1-1~deb10u5'},
    {'release': '10.0', 'prefix': 'roundcube-sqlite3', 'reference': '1.3.17+dfsg.1-1~deb10u5'}
];
