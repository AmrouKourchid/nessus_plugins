...
# extracted from Fedora Security Advisory FEDORA-2023-b9c1d0e4c5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b9c1d0e4c5");

  script_name(english:"Fedora 39 : moby-engine (2023-b9c1d0e4c5)");
...
FEDORA-2023-b9c1d0e4c5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b9c1d0e4c5");
...
var pkgs = [
    {'reference':'moby-engine-24.0.5-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
