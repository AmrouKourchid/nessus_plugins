...
FEDORA-2021-5c83efb61c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-5c83efb61c");
...
pkgs = [
    {'reference':'wavpack-5.4.0-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
