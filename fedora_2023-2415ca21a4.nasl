...
# extracted from Fedora Security Advisory FEDORA-2023-2415ca21a4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2415ca21a4");

  script_name(english:"Fedora 39 : python3.6 (2023-2415ca21a4)");
...
FEDORA-2023-2415ca21a4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2415ca21a4");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-18.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
