...
# extracted from Ubuntu Security Notice USN-6818-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6818-2");

  script_name(english:"Ubuntu 23.10 : Linux kernel (ARM laptop) vulnerabilities (USN-6818-2)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6818-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-6.5.0-1017-laptop");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6818-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6818-2');
  }
  else
  {
