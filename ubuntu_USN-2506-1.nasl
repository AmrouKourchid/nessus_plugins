...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Thunderbird vulnerabilities (USN-2506-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2506-1 advisory.
    ...
    message with scripting enabled, an attacker could potentially exploit this to obtain sensitive
    ...
    crafted message with scripting enabled, an attacker could potentially exploit this to cause a denial of
    service via application crash, or execute arbitrary code with the privileges of the user invoking
    Thunderbird. (CVE-2015-0831)

    Carsten Book, Christoph Diehl, Gary Kwong, Jan de Mooij, Liz Henry, Byron Campen, Tom Schuster, and Ryan
    VanderMeulen discovered multiple memory safety issues in Thunderbird. If a user were tricked in to opening
    a specially crafted message with scripting enabled, an attacker could potentially exploit these to cause a
    denial of service via application crash, or execute arbitrary code with the privileges of the user
    invoking Thunderbird. (CVE-2015-0836)

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2506-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2015-0822");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'thunderbird', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-dev', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-globalmenu', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-gnome-support', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-af', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-ar', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-ast', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-be', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-bg', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-bn', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-bn-bd', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-br', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-ca', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-cs', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-da', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-de', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-el', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-en', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-en-gb', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-en-us', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-es', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-es-ar', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-es-es', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-et', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-eu', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-fi', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-fr', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-fy', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-fy-nl', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-ga', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-ga-ie', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-gd', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-gl', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-he', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-hr', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-hu', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-hy', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-id', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-is', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-it', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-ja', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-ka', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-ko', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-lt', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-mk', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-nb', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-nb-no', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-nl', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-nn', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-nn-no', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-pa', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-pa-in', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-pl', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-pt', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-pt-br', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-pt-pt', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-rm', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-ro', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-ru', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-si', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-sk', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-sl', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-sq', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-sr', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-sv', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-sv-se', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-ta', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-ta-lk', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-tr', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-uk', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-vi', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-zh-cn', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-zh-hans', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-zh-hant', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-locale-zh-tw', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-mozsymbols', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'thunderbird-testsuite', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'xul-ext-calendar-timezones', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'xul-ext-gdata-provider', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'},
    {'osver': '14.04', 'pkgname': 'xul-ext-lightning', 'pkgver': '1:31.5.0+build1-0ubuntu0.14.04.1'}
];
