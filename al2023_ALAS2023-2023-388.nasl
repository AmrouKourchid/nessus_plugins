...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-388.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-43565", "CVE-2022-41723", "CVE-2023-24538");
  script_xref(name:"IAVB", value:"2023-B-0012-S");
  script_xref(name:"IAVB", value:"2023-B-0022-S");

  script_name(english:"Amazon Linux 2023 : amazon-ssm-agent (ALAS2023-2023-388)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2023-388 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-388.html");
...
var pkgs = [
    {'reference':'amazon-ssm-agent-3.2.1705.0-1.amzn2023', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ssm-agent-3.2.1705.0-1.amzn2023', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ssm-agent-debuginfo-3.2.1705.0-1.amzn2023', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ssm-agent-debuginfo-3.2.1705.0-1.amzn2023', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ssm-agent-debugsource-3.2.1705.0-1.amzn2023', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'amazon-ssm-agent-debugsource-3.2.1705.0-1.amzn2023', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
