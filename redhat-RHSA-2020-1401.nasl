...
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.2.28.");
...
the RHSA-2020:1401 advisory.
    ...
    * buildah: crafted input tar file may lead to local file overwriting during image build process
    (CVE-2020-10696)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9682ad7e");
...
"Update the RHEL OpenShift Container Platform 4.2.28 package based on the guidance in RHSA-2020:1401.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'podman-1.4.2-6.rhaos4.2.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-1.4.2-6.rhaos4.2.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-docker-1.4.2-6.rhaos4.2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'podman-manpages-1.4.2-6.rhaos4.2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
