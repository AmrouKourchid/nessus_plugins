...
# extracted from Red Hat Security Advisory RHSA-2018:2096. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:2096");

  script_name(english:"RHEL 6 : patch (RHSA-2018:2096)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2096.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?11f27149");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2096");
...
"Update the RHEL patch package based on the guidance in RHSA-2018:2096.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'patch-2.6-8.el6_5', 'sp':'5', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
