...
# extracted from Red Hat Security Advisory RHSA-2024:1989. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1989");

  script_name(english:"RHEL 8 : less (RHSA-2024:1989)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1989.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d33e2f8a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1989");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL less package based on the guidance in RHSA-2024:1989.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'less-530-2.el8_6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
