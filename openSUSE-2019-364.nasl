...
# extracted from openSUSE Security Update openSUSE-2019-364.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : Mozilla Thunderbird (openSUSE-2019-364)");
...
Security issues fixed (MFSA 2018-13, boo#1092548) :
  ...
  - CVE-2018-5185: Leaking plaintext through HTML forms
    (bsc#1093973)");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1092548");
