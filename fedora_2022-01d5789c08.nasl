...
# extracted from Fedora Security Advisory FEDORA-2022-01d5789c08
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-01d5789c08");

  script_name(english:"Fedora 35 : pypy3.7 (2022-01d5789c08)");
...
FEDORA-2022-01d5789c08 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-01d5789c08");
...
var pkgs = [
    {'reference':'pypy3.7-7.3.9-4.3.7.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
