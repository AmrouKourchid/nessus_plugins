...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : bind (EulerOS-SA-2020-2494)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2494
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba3bb702");
...
pkgs = ["bind-9.11.4-17.h5.eulerosv2r9",
        "bind-chroot-9.11.4-17.h5.eulerosv2r9",
        "bind-export-libs-9.11.4-17.h5.eulerosv2r9",
        "bind-libs-9.11.4-17.h5.eulerosv2r9",
        "bind-libs-lite-9.11.4-17.h5.eulerosv2r9",
        "bind-pkcs11-9.11.4-17.h5.eulerosv2r9",
        "bind-utils-9.11.4-17.h5.eulerosv2r9",
        "python3-bind-9.11.4-17.h5.eulerosv2r9"];
