...
# Oracle Linux Security Advisory ELSA-2015-1889 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : spice-server (ELSA-2015-1889)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 6 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2015-1889 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2015-1889.html");
...
var pkgs = [
    {'reference':'spice-server-0.12.4-12.el6_7.3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'spice-server-devel-0.12.4-12.el6_7.3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
