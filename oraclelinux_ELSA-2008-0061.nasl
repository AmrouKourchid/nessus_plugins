...
# extracted from Oracle Linux Security Advisory ELSA-2008-0061.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : setroubleshoot (ELSA-2008-0061)");
...
ELSA-2008-0061 advisory.
    ...
    - move all plugins and their translations to independent package
            ...
            - Resolves Bug #251545: Review Request: setroubleshoot-plugins - analysis plugins for
    setroubleshoot
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0061.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected setroubleshoot and / or setroubleshoot-server packages.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-5495");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2007-5496");
...
var pkgs = [
    {'reference':'setroubleshoot-2.0.5-3.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'setroubleshoot-server-2.0.5-3.0.1.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'setroubleshoot / setroubleshoot-server');
}
