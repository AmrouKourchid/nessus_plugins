...
# extracted from Fedora Security Advisory FEDORA-2025-0245d352e6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-0245d352e6");

  script_name(english:"Fedora 41 : golang-github-nvidia-container-toolkit (2025-0245d352e6)");
...
FEDORA-2025-0245d352e6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-0245d352e6");
...
var pkgs = [
    {'reference':'golang-github-nvidia-container-toolkit-1.17.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
