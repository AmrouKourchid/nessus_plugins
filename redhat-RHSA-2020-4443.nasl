...
# extracted from Red Hat Security Advisory RHSA-2020:4443. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4443");

  script_name(english:"RHEL 8 : libarchive (RHSA-2020:4443)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libarchive.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:4443 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4443.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0b6c5fb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4443");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1801635");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libarchive package based on the guidance in RHSA-2020:4443.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bsdtar-3.3.2-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libarchive-3.3.2-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libarchive-devel-3.3.2-9.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
