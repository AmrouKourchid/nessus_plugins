...
# extracted from Fedora Security Advisory FEDORA-2022-01ffde372c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-01ffde372c");

  script_name(english:"Fedora 36 : curl (2022-01ffde372c)");
...
FEDORA-2022-01ffde372c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-01ffde372c");
...
var pkgs = [
    {'reference':'curl-7.82.0-9.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
