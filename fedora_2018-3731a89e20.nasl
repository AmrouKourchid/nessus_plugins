...
# extracted from Fedora Security Advisory FEDORA-2018-3731a89e20.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-3731a89e20");

  script_name(english:"Fedora 28 : strongswan (2018-3731a89e20)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-3731a89e20");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"strongswan-5.6.2-6.fc28")) flag++;
