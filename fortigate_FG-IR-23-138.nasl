...
if (description)
{
  ...
  script_cve_id("CVE-2023-36639");
  script_xref(name:"IAVA", value:"2024-A-0019-S");

  script_name(english:"Fortinet Fortigate Format String Bug in HTTPSd (FG-IR-23-138)");
...
vulnerability as referenced in the FG-IR-23-138 advisory.

  - A use of externally-controlled format string in Fortinet FortiProxy versions 7.2.0 through 7.2.4, 7.0.0
    through 7.0.10, FortiOS versions 7.4.0, 7.2.0 through 7.2.4, 7.0.0 through 7.0.11, 6.4.0 through 6.4.12,
    6.2.0 through 6.2.15, 6.0.0 through 6.0.17, FortiPAM versions 1.0.0 through 1.0.3 allows attacker to
    execute unauthorized code or commands via specially crafted API requests. (CVE-2023-36639)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.fortiguard.com/psirt/FG-IR-23-138");
...
version 6.4.13 or later. For 7.0.x, upgrade to Fortigate version 7.0.12 or later. For 7.2.x, upgrade to Fortigate
version 7.2.5 or later. For 7.4.x, upgrade to Fortigate version 7.4.1 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-36639");
