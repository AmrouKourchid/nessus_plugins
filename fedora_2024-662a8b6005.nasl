...
# extracted from Fedora Security Advisory FEDORA-2024-662a8b6005
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-662a8b6005");

  script_name(english:"Fedora 39 : kubernetes (2024-662a8b6005)");
...
FEDORA-2024-662a8b6005 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-662a8b6005");
...
var pkgs = [
    {'reference':'kubernetes-1.27.13-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
