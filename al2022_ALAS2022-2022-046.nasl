...
# extracted from Amazon Linux 2022 Security Advisory ALAS2022-2022-046.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2022 : python3-twisted, python3-twisted+tls (ALAS2022-2022-046)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2022 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2022-2022-046 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2022/ALAS-2022-046.html");
...
var pkgs = [
    {'reference':'python3-twisted+tls-22.2.0-117.amzn2022.0.1', 'release':'AL-2022', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-twisted-22.2.0-117.amzn2022.0.1', 'release':'AL-2022', 'rpm_spec_vers_cmp':TRUE}
];
