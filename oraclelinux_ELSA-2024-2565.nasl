...
# extracted from Oracle Linux Security Advisory ELSA-2024-2565.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : libreswan (ELSA-2024-2565)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2565.html");
...
var pkgs = [
    {'reference':'libreswan-4.12-2.0.1.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libreswan-4.12-2.0.1.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
