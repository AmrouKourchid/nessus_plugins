...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : curl (EulerOS-SA-2019-1269)");
...
following vulnerability :
  ...
  - Curl versions 7.14.1 through 7.61.1 are vulnerable to a
    ...
    denial of service.i1/4^CVE-2018-16842i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1269
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c7f11c81");
