...
# extracted from Fedora Security Advisory FEDORA-2024-7c800c4df7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7c800c4df7");
  script_xref(name:"IAVA", value:"2024-A-0609-S");

  script_name(english:"Fedora 39 : php (2024-7c800c4df7)");
...
FEDORA-2024-7c800c4df7 advisory.
    ...
    * Fixed bug php#73182 (PHP SOAPClient does not support stream context HTTP headers in array form).
    (nielsdos)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7c800c4df7");
...
var pkgs = [
    {'reference':'php-8.2.24-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
