...
# extracted from openSUSE Security Update openSUSE-2020-654.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : cacti / cacti-spine (openSUSE-2020-654)");
...
cacti fixes :
  ...
  - CVE-2020-7106: Lack of escaping of color items can lead
    to XSS exposure (boo#1163749)

  - Fix multiple graphing bugs and web UI issues

  - Fix multiple warnings, PHP Exceptions and errors

  - Content-Security-Policy prevents External Links from
    being opened
...
"Update the affected cacti / cacti-spine packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-7106");
...
if ( rpm_check(release:"SUSE15.1", reference:"cacti-1.2.12-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"cacti-spine-1.2.12-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"cacti-spine-debuginfo-1.2.12-lp151.3.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"cacti-spine-debugsource-1.2.12-lp151.3.9.1") ) flag++;
