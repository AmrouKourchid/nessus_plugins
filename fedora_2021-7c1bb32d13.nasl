...
# extracted from Fedora Security Advisory FEDORA-2021-7c1bb32d13
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-7c1bb32d13");

  script_name(english:"Fedora 32 : python39 (2021-7c1bb32d13)");
...
FEDORA-2021-7c1bb32d13 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-7c1bb32d13");
...
pkgs = [
    {'reference':'python39-3.9.2-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
