...
# extracted from Gentoo Linux Security Advisory GLSA 202312-17.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202312-17 : OpenSSH: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202312-17 (OpenSSH: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202312-17");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=920292");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=920722");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 9.6_p1"),
    'vulnerable' : make_list("lt 9.6_p1")
  }
];
