...
# extracted from Red Hat Security Advisory RHSA-2024:2779. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2779");

  script_name(english:"RHEL 9 : nodejs:18 (RHSA-2024:2779)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for nodejs:18.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2779 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2779.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?07c652ae");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2779");
...
"Update the RHEL nodejs:18 package based on the guidance in RHSA-2024:2779.");
  ...
  'nodejs:18': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-18.20.2-2.module+el9.4.0+21742+692df1ea', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-18.20.2-2.module+el9.4.0+21742+692df1ea', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-18.20.2-2.module+el9.4.0+21742+692df1ea', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-18.20.2-2.module+el9.4.0+21742+692df1ea', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-10.5.0-1.18.20.2.2.module+el9.4.0+21742+692df1ea', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'nodejs-18.20.2-2.module+el9.4.0+21742+692df1ea', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-18.20.2-2.module+el9.4.0+21742+692df1ea', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-18.20.2-2.module+el9.4.0+21742+692df1ea', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-18.20.2-2.module+el9.4.0+21742+692df1ea', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-10.5.0-1.18.20.2.2.module+el9.4.0+21742+692df1ea', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
