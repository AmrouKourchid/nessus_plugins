...
# extracted from Fedora Security Advisory FEDORA-2023-deb5cf6515
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-deb5cf6515");

  script_name(english:"Fedora 38 : seamonkey (2023-deb5cf6515)");
...
FEDORA-2023-deb5cf6515 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-deb5cf6515");
...
var pkgs = [
    {'reference':'seamonkey-2.53.18-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
