...
# extracted from Red Hat Security Advisory RHSA-2025:0318. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:0318");

  script_name(english:"RHEL 8 : raptor2 (RHSA-2025:0318)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for raptor2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:0318 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_0318.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?59e179df");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:0318");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL raptor2 package based on the guidance in RHSA-2025:0318.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'raptor2-2.0.15-17.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'raptor2-devel-2.0.15-17.el8_8', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
