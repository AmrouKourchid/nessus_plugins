...
# extracted from Fedora Security Advisory FEDORA-2024-2b163f9201
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-2b163f9201");

  script_name(english:"Fedora 41 : python3.10 (2024-2b163f9201)");
...
FEDORA-2024-2b163f9201 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2b163f9201");
...
var pkgs = [
    {'reference':'python3.10-3.10.15-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
