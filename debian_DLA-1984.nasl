...
# extracted from Debian Security Advisory DLA-1984-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1984-1 : gdal security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"GDAL through 3.0.1 had a poolDestroy double free in OGRExpatRealloc in
ogr/ogr_expat.cpp when the 10MB threshold was exceeded.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/11/msg00005.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"gdal-bin", reference:"1.10.1+dfsg-8+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libgdal-dev", reference:"1.10.1+dfsg-8+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libgdal-doc", reference:"1.10.1+dfsg-8+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libgdal-java", reference:"1.10.1+dfsg-8+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libgdal-perl", reference:"1.10.1+dfsg-8+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libgdal1-dev", reference:"1.10.1+dfsg-8+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libgdal1h", reference:"1.10.1+dfsg-8+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"python-gdal", reference:"1.10.1+dfsg-8+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"python3-gdal", reference:"1.10.1+dfsg-8+deb8u1")) flag++;
