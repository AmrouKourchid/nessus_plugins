...
# extracted from Red Hat Security Advisory libical. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-5825", "CVE-2016-5826", "CVE-2016-5827");

  script_name(english:"RHEL 5 : libical (Unpatched Vulnerability) (deprecated)");
