...
# extracted from Red Hat Security Advisory RHSA-2023:6167. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6167");

  script_name(english:"RHEL 9 : libguestfs-winsupport (RHSA-2023:6167)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libguestfs-winsupport.");
...
the RHSA-2023:6167 advisory.

    The libguestfs-winsupport package adds support for Windows guests to libguestfs, a set of tools and
    libraries allowing users to access and modify virtual machine (VM) disk images.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6167.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ab7d15c3");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2236130");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6167");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libguestfs-winsupport package based on the guidance in RHSA-2023:6167.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libguestfs-winsupport-9.2-2.el9_2', 'sp':'2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libguestfs-winsupport-9.2-2.el9_2', 'sp':'2', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libguestfs-winsupport-9.2-2.el9_2', 'sp':'2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libguestfs-winsupport-9.2-2.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libguestfs-winsupport-9.2-2.el9_2', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libguestfs-winsupport-9.2-2.el9_2', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
