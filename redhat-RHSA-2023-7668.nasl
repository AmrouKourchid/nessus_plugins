...
# extracted from Red Hat Security Advisory RHSA-2023:7668. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7668");

  script_name(english:"RHEL 8 : squid:4 (RHSA-2023:7668)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for squid:4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:7668 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7668.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?699e032d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2245914");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7668");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL squid:4 package based on the guidance in RHSA-2023:7668.");
  ...
  'squid:4': [
    {
      ...
      'pkgs': [
        {'reference':'libecap-1.0.1-2.module+el8.9.0+19703+a1da7223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'libecap-devel-1.0.1-2.module+el8.9.0+19703+a1da7223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'squid-4.15-7.module+el8.9.0+20806+014d88aa.3', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
      ]
    }
  ]
};
