...
# extracted from Ubuntu Security Notice USN-3728-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : ClamAV vulnerabilities (USN-3728-2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-3728-2 advisory.

    USN-3728-1 fixed several vulnerabilities in libmspack. In Ubuntu 14.04 libmspack is included into ClamAV.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3728-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'clamav', 'pkgver': '0.100.1+dfsg-1ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'clamav-base', 'pkgver': '0.100.1+dfsg-1ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'clamav-daemon', 'pkgver': '0.100.1+dfsg-1ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'clamav-freshclam', 'pkgver': '0.100.1+dfsg-1ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'clamav-milter', 'pkgver': '0.100.1+dfsg-1ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'clamav-testfiles', 'pkgver': '0.100.1+dfsg-1ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'libclamav-dev', 'pkgver': '0.100.1+dfsg-1ubuntu0.14.04.3'},
    {'osver': '14.04', 'pkgname': 'libclamav7', 'pkgver': '0.100.1+dfsg-1ubuntu0.14.04.3'}
];
