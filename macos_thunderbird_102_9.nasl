...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 102.9. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2023-11 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'102.9', severity:SECURITY_HOLE);
