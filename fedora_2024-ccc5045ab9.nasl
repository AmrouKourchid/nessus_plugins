...
# extracted from Fedora Security Advisory FEDORA-2024-ccc5045ab9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ccc5045ab9");

  script_name(english:"Fedora 41 : expat (2024-ccc5045ab9)");
...
FEDORA-2024-ccc5045ab9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ccc5045ab9");
...
var pkgs = [
    {'reference':'expat-2.6.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
