...
# extracted from Ubuntu Security Notice USN-6164-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6164-2");

  script_name(english:"Ubuntu 16.04 ESM / 18.04 ESM : c-ares vulnerabilities (USN-6164-2)");
...
referenced in the USN-6164-2 advisory.

    USN-6164-1 fixed several vulnerabilities in c-ares. This update provides the corresponding update for
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6164-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.10.0-3ubuntu0.2+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc-ares2', 'pkgver': '1.10.0-3ubuntu0.2+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.14.0-1ubuntu0.2+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libc-ares2', 'pkgver': '1.14.0-1ubuntu0.2+esm1', 'ubuntu_pro': TRUE}
];
