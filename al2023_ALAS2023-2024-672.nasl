...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-672.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : ecs-init (ALAS2023-2024-672)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2024-672 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-672.html");
...
var pkgs = [
    {'reference':'ecs-init-1.84.0-1.amzn2023', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ecs-init-1.84.0-1.amzn2023', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
