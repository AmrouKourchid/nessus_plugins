...
# extracted from Red Hat Security Advisory RHSA-2005:232. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2005:232");

  script_name(english:"RHEL 4 : ipsec-tools (RHSA-2005:232)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ipsec-tools.");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2005/rhsa-2005_232.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7836d5c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=145531");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=145535");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=148950");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=150179");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2005:232");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ipsec-tools package based on the guidance in RHSA-2005:232.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-0398");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ipsec-tools-0.3.3-6', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsec-tools-0.3.3-6', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsec-tools-0.3.3-6', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsec-tools-0.3.3-6', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipsec-tools-0.3.3-6', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
