...
# extracted from Fedora Security Advisory FEDORA-2025-8eb387668b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-8eb387668b");

  script_name(english:"Fedora 41 : yarnpkg (2025-8eb387668b)");
...
FEDORA-2025-8eb387668b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-8eb387668b");
...
var pkgs = [
    {'reference':'yarnpkg-1.22.22-7.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
