...
# extracted from VMware Security Advisory PHSA-2024-5.0-0356. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Python3 PHSA-2024-5.0-0356");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the python3 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-356.md");
...
if (rpm_check(release:'PhotonOS-5.0', reference:'python3-certifi-2023.11.17-2.ph5')) flag++;
