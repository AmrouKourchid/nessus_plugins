...
if (description)
{
  ...
  script_name(english:"Google Chrome < 134.0.6998.44 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote macOS host is prior to 134.0.6998.44. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2025_03_stable-channel-update-for-desktop advisory.
...
"Upgrade to Google Chrome version 134.0.6998.44 or later.");
...
google_chrome_check_version(fix:'134.0.6998.44', fixed_display:'134.0.6998.44 / 134.0.6998.45', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
