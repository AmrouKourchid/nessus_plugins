...
# extracted from Slackware Security Advisory SSA:2024-084-01. The text
...
if (description)
{
  ...
  script_name(english:"Slackware Linux 15.0 / current emacs  Vulnerability (SSA:2024-084-01)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Slackware Linux host is missing a security update to emacs.");
  script_set_attribute(attribute:"description", value:
"The version of emacs installed on the remote host is prior to 29.3. It is, therefore, affected by a vulnerability as
referenced in the SSA:2024-084-01 advisory.
...
number.");
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2024&m=slackware-security.367764
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b5cd220");
...
var flag = 0;
var constraints = [
    { 'fixed_version' : '29.3', 'product' : 'emacs', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'i586' },
    { 'fixed_version' : '29.3', 'product' : 'emacs', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'x86_64' },
    { 'fixed_version' : '29.3', 'product' : 'emacs', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'i586' },
    { 'fixed_version' : '29.3', 'product' : 'emacs', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'x86_64' }
];
