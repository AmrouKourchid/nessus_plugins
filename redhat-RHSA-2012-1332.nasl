...
if (description)
{
  ...
  script_name(english:"RHEL 5 : java-1.4.2-ibm-sap (RHSA-2012:1332)");
...
referenced in the RHSA-2012:1332 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_1332.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?974665bc");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/developerworks/java/jdk/alerts/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1332");
...
"Update the RHEL java-1.4.2-ibm-sap package based on the guidance in RHSA-2012:1332.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-1713");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'java-1.4.2-ibm-sap-1.4.2.13.13.sap-1jpp.2.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'java-1.4.2-ibm-sap-demo-1.4.2.13.13.sap-1jpp.2.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'java-1.4.2-ibm-sap-devel-1.4.2.13.13.sap-1jpp.2.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'java-1.4.2-ibm-sap-javacomm-1.4.2.13.13.sap-1jpp.2.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'java-1.4.2-ibm-sap-src-1.4.2.13.13.sap-1jpp.2.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
