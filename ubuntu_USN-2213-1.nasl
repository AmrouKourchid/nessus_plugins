...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : Dovecot vulnerability (USN-2213-1)");
...
USN-2213-1 advisory.
    ...
    It was discovered that Dovecot incorrectly handled closing inactive SSL/TLS connections. A remote attacker
    could use this issue to cause Dovecot to stop responding to new connections, resulting in a denial of
    service.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2213-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'dovecot-core', 'pkgver': '1:2.2.9-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'dovecot-dev', 'pkgver': '1:2.2.9-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'dovecot-gssapi', 'pkgver': '1:2.2.9-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'dovecot-imapd', 'pkgver': '1:2.2.9-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'dovecot-ldap', 'pkgver': '1:2.2.9-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'dovecot-lmtpd', 'pkgver': '1:2.2.9-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'dovecot-managesieved', 'pkgver': '1:2.2.9-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'dovecot-mysql', 'pkgver': '1:2.2.9-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'dovecot-pgsql', 'pkgver': '1:2.2.9-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'dovecot-pop3d', 'pkgver': '1:2.2.9-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'dovecot-sieve', 'pkgver': '1:2.2.9-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'dovecot-solr', 'pkgver': '1:2.2.9-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'dovecot-sqlite', 'pkgver': '1:2.2.9-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'mail-stack-delivery', 'pkgver': '1:2.2.9-1ubuntu2.1'}
];
