...
# extracted from SUSE update advisory SUSE-SU-2021:0028-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : dovecot23 (SUSE-SU-2021:0028-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?49a0b289");
...
zypper in -t patch
SUSE-SLE-Module-Server-Applications-15-SP2-2021-28=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-backend-mysql-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-backend-mysql-debuginfo-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-backend-pgsql-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-backend-pgsql-debuginfo-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-backend-sqlite-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-backend-sqlite-debuginfo-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-debuginfo-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-debugsource-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-devel-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-fts-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-fts-debuginfo-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-fts-lucene-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-fts-lucene-debuginfo-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-fts-solr-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-fts-solr-debuginfo-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-fts-squat-2.3.11.3-17.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"dovecot23-fts-squat-debuginfo-2.3.11.3-17.5.1")) flag++;
