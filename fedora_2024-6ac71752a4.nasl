...
# extracted from Fedora Security Advisory FEDORA-2024-6ac71752a4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6ac71752a4");

  script_name(english:"Fedora 41 : mingw-libxml2 (2024-6ac71752a4)");
...
FEDORA-2024-6ac71752a4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6ac71752a4");
...
var pkgs = [
    {'reference':'mingw-libxml2-2.12.7-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
