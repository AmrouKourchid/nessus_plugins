...
# SUSE update advisory SUSE-SU-2022:2444-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:2444-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 23 for SLE 12 SP4) (SUSE-SU-2022:2444-1)");
...
the SUSE-SU-2022:2444-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-July/011598.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf21e9bf");
  script_set_attribute(attribute:"solution", value:
"Update the affected kgraft-patch-4_12_14-95_83-default package.");
...
var pkgs = [
    {'reference':'kgraft-patch-4_12_14-95_83-default-11-2.3', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-95_83-default');
}
