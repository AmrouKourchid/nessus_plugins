...
# extracted from Fedora Security Advisory FEDORA-2020-7eb7eac270.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-7eb7eac270");

  script_name(english:"Fedora 31 : json-c (2020-7eb7eac270)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7eb7eac270");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"json-c-0.13.1-12.fc31")) flag++;
