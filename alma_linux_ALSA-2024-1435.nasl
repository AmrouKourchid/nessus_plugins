...
# AlmaLinux Security Advisory ALSA-2024:1435.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1435");

  script_name(english:"AlmaLinux 8 : postgresql-jdbc (ALSA-2024:1435)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2024:1435 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-1435.html");
...
"Update the affected postgresql-jdbc and / or postgresql-jdbc-javadoc packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:postgresql-jdbc-javadoc");
