...
# extracted from Red Hat Security Advisory RHSA-2024:2577. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2577");

  script_name(english:"RHEL 8 : shadow-utils (RHSA-2024:2577)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for shadow-utils.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:2577 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2577.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?54323a2a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2577");
...
"Update the RHEL shadow-utils package based on the guidance in RHSA-2024:2577.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'shadow-utils-4.6-17.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'shadow-utils-subid-4.6-17.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'shadow-utils-subid-devel-4.6-17.el8_8.2', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
