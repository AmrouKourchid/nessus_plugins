...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : mariadb (EulerOS-SA-2021-1391)");
...
affected by the following vulnerability :
  ...
  - Vulnerability in the MySQL Client product of Oracle
    ...
    affected are 5.7.32 and prior and 8.0.22 and prior.
    ...
    3.1 Base Score 5.9 (Availability impacts). CVSS Vector:
    (CVE-2021-2011)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1391
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7846805");
...
pkgs = ["mariadb-5.5.66-1.h1",
        "mariadb-libs-5.5.66-1.h1",
        "mariadb-server-5.5.66-1.h1"];
