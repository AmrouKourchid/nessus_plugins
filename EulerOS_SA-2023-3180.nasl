...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : haproxy (EulerOS-SA-2023-3180)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3180
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b2a24ac");
...
var pkgs = [
  "haproxy-2.0.14-2.h9.eulerosv2r10"
];
