...
# extracted from Fedora Security Advisory FEDORA-2022-6f630b1ba7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6f630b1ba7");

  script_name(english:"Fedora 36 : containerd (2022-6f630b1ba7)");
...
FEDORA-2022-6f630b1ba7 advisory.

    Automatic update for containerd-1.5.9-1.fc36.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6f630b1ba7");
...
var pkgs = [
    {'reference':'containerd-1.5.9-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
