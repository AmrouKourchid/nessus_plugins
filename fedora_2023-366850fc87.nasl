...
# extracted from Fedora Security Advisory FEDORA-2023-366850fc87
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-366850fc87");

  script_name(english:"Fedora 36 : ghostscript (2023-366850fc87)");
...
FEDORA-2023-366850fc87 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-366850fc87");
...
var pkgs = [
    {'reference':'ghostscript-9.56.1-7.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
