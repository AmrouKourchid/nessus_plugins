...
# extracted from Red Hat Security Advisory RHSA-2024:6337. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6337");
  script_xref(name:"IAVA", value:"2024-A-0546");

  script_name(english:"RHEL 8 : Satellite 6.13.7.2 Security Update (Important) (RHSA-2024:6337)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:6337 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6337.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2c11179");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6337");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'foreman-installer-3.5.2.8-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'satellite-6'},
      {'reference':'foreman-installer-katello-3.5.2.8-1.el8sat', 'release':'8', 'el_string':'el8sat', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'satellite-6'}
    ]
  }
];
