...
# extracted from Fedora Security Advisory FEDORA-2023-88629e9585
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-88629e9585");

  script_name(english:"Fedora 37 : netconsd (2023-88629e9585)");
...
FEDORA-2023-88629e9585 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-88629e9585");
...
var pkgs = [
    {'reference':'netconsd-0.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
