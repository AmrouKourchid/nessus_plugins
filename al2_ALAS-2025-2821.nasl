...
# extracted from Amazon Linux 2 Security Advisory ALAS-2025-2821.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : nerdctl (ALAS-2025-2821)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of nerdctl installed on the remote host is prior to 2.0.4-1. It is, therefore, affected by a vulnerability
as referenced in the ALAS2-2025-2821 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2025-2821.html");
...
var pkgs = [
    {'reference':'nerdctl-2.0.4-1.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nerdctl-2.0.4-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nerdctl-debuginfo-2.0.4-1.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nerdctl-debuginfo-2.0.4-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE}
];
