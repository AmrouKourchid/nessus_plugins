...
# extracted from Red Hat Security Advisory RHSA-2023:3264. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3264");

  script_name(english:"RHEL 7 : sudo (RHSA-2023:3264)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for sudo.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:3264 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3264.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fcfef189");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2161142");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3264");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sudo package based on the guidance in RHSA-2023:3264.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.8.19p2-12.el7_4.3', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.19p2-12.el7_4.3', 'sp':'4', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.19p2-12.el7_4.3', 'sp':'4', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
