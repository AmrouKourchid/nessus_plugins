...
# extracted from Red Hat Security Advisory RHSA-2022:1939. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:1939");

  script_name(english:"RHEL 8 : squid:4 (RHSA-2022:1939)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for squid:4.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:1939 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1939.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1a1d43a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1939");
...
"Update the RHEL squid:4 package based on the guidance in RHSA-2022:1939.");
  ...
  'squid:4': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'squid-4.15-3.module+el8.6.0+14176+9782b8ab', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
      ]
    }
  ]
};
