...
# extracted from Red Hat Security Advisory RHSA-2024:9097. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-3727", "CVE-2024-24791");
  script_xref(name:"RHSA", value:"2024:9097");

  script_name(english:"RHEL 9 : buildah (RHSA-2024:9097)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for buildah.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:9097 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-29278");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-40808");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9097.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?496042c0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9097");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL buildah package based on the guidance in RHSA-2024:9097.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.37.2-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'buildah-tests-1.37.2-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
