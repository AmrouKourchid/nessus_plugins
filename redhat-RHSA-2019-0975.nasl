...
the RHSA-2019:0975 advisory.
    ...
    * [stream rhel8] unable to mount disk at `/var/lib/containers` via `systemd` unit when `container-selinux`
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0975.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8de759ea");
...
"Update the RHEL container-tools:rhel8 package based on the guidance in RHSA-2019:0975.");
  ...
  'container-tools:rhel8': [
    {
      ...
      'pkgs': [
        {'reference':'buildah-1.5-3.gite94b4f9.module+el8.0.0+2958+4e823551', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'container-selinux-2.94-1.git1e99f1d.module+el8.0.0+2958+4e823551', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'containernetworking-plugins-0.7.4-3.git9ebe139.module+el8.0.0+2958+4e823551', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'containers-common-0.1.32-3.git1715c90.module+el8.0.0+2958+4e823551', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'fuse-overlayfs-0.3-2.module+el8.0.0+2958+4e823551', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'oci-systemd-hook-0.1.15-2.git2d0b8a3.module+el8.0.0+2958+4e823551', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'oci-umount-2.3.4-2.git87f9237.module+el8.0.0+2958+4e823551', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
        {'reference':'podman-1.0.0-2.git921f98f.module+el8.0.0+2958+4e823551', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'podman-docker-1.0.0-2.git921f98f.module+el8.0.0+2958+4e823551', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'runc-1.0.0-55.rc5.dev.git2abd837.module+el8.0.0+3049+59fd2bba', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'skopeo-0.1.32-3.git1715c90.module+el8.0.0+2958+4e823551', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'slirp4netns-0.1-2.dev.gitc4e1bc5.module+el8.0.0+2958+4e823551', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
