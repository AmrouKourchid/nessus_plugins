...
# extracted from Red Hat Security Advisory RHSA-2023:5204. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5204");

  script_name(english:"RHEL 9 : libwebp (RHSA-2023:5204)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libwebp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:5204 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5204.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb3e8ef2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5204");
...
"Update the RHEL libwebp package based on the guidance in RHSA-2023:5204.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libwebp-1.2.0-6.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libwebp-devel-1.2.0-6.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
