...
# extracted from Fedora Security Advisory FEDORA-2025-2210d27149
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-2210d27149");
  script_xref(name:"IAVA", value:"2025-A-0135");

  script_name(english:"Fedora 41 : xorg-x11-server-Xwayland (2025-2210d27149)");
...
FEDORA-2025-2210d27149 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2210d27149");
...
var pkgs = [
    {'reference':'xorg-x11-server-Xwayland-24.1.6-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
