...
# SUSE update advisory SUSE-SU-2025:1285-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:1285-1");

  script_name(english:"openSUSE 15 Security Update : etcd (SUSE-SU-2025:1285-1)");
...
SU-2025:1285-1 advisory.

    - Update to version 3.5.21:
    - CVE-2025-30204: Fixed a bug that could allow excessive memory allocation during header parsing in jwt-
    go. (bsc#1240515)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1240515");
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2025-April/039010.html");
...
var pkgs = [
    {'reference':'etcd-3.5.21-150000.7.12.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']},
    {'reference':'etcdctl-3.5.21-150000.7.12.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.6']}
];
