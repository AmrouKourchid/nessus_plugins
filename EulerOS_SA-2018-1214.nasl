...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openssl110f (EulerOS-SA-2018-1214)");
...
vulnerabilities :
  ...
  - During key agreement in a TLS handshake using a DH(E)
    ...
    in a Denial Of Service attack.(CVE-2017-0732)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1214
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d69d8f94");
...
pkgs = ["openssl110f-1.1.0f-5.h5",
        "openssl110f-devel-1.1.0f-5.h5",
        "openssl110f-libs-1.1.0f-5.h5",
        "openssl110f-static-1.1.0f-5.h5"];
