...
# extracted from Fedora Security Advisory FEDORA-2025-e911f71d99
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e911f71d99");

  script_name(english:"Fedora 41 : python3-docs / python3.13 (2025-e911f71d99)");
...
FEDORA-2025-e911f71d99 advisory.

    Update to 3.13.2

    ----

    Statically build the `_datetime` module into libpython. This fixes a segfault when importing it from
    Python 3.13.0 updated to 3.13.1+ while running.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e911f71d99");
...
var pkgs = [
    {'reference':'python3-docs-3.13.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.13-3.13.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
