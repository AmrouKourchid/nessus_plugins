...
# extracted from Red Hat Security Advisory wget. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-6508", "CVE-2018-20483", "CVE-2021-31879");

  script_name(english:"RHEL 7 : wget (Unpatched Vulnerability) (deprecated)");
...
"This plugin has been deprecated as it does not adhere to established standards for this style of check.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-20483");
