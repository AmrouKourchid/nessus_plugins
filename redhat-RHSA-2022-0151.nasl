...
# extracted from Red Hat Security Advisory RHSA-2022:0151. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0151");
  script_xref(name:"IAVA", value:"2021-A-0556-S");

  script_name(english:"RHEL 7 : Red Hat Single Sign-On 7.5.1 security update on RHEL 7 (Important) (RHSA-2022:0151)");
...
referenced in the RHSA-2022:0151 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0151.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cbc35001");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0151");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/CIAM-1616");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Single Sign-On 7.5.1 package based on the guidance in RHSA-2022:0151.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-sso7-keycloak-15.0.4-1.redhat_00001.1.el7sso', 'release':'7', 'el_string':'el7sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'},
      {'reference':'rh-sso7-keycloak-server-15.0.4-1.redhat_00001.1.el7sso', 'release':'7', 'el_string':'el7sso', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-sso'}
    ]
  }
];
