...
path in quotes.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0759");
...
var slist = get_kb_list_or_exit('SMB/svc/*/startuptype');
var services = make_list();
...
# plugins
var items = get_kb_list('SMB/Unquoted/*');
var unquoted = make_array();
var key;
if (!isnull(items))
{
