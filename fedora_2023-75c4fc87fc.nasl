...
# extracted from Fedora Security Advisory FEDORA-2023-75c4fc87fc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-75c4fc87fc");

  script_name(english:"Fedora 39 : python3.7 (2023-75c4fc87fc)");
...
FEDORA-2023-75c4fc87fc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-75c4fc87fc");
...
var pkgs = [
    {'reference':'python3.7-3.7.16-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
