...
# extracted from Fedora Security Advisory FEDORA-2024-aeb75f8b5b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-aeb75f8b5b");

  script_name(english:"Fedora 40 : w3m (2024-aeb75f8b5b)");
...
FEDORA-2024-aeb75f8b5b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-aeb75f8b5b");
...
var pkgs = [
    {'reference':'w3m-0.5.3-63.git20230121.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
