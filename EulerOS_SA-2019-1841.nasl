...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : expat (EulerOS-SA-2019-1841)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1841
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?605bef80");
...
pkgs = ["expat-2.1.0-10.h2",
        "expat-devel-2.1.0-10.h2"];
