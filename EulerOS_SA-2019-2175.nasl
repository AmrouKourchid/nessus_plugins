...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : nss-softokn (EulerOS-SA-2019-2175)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2175
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f273ee3a");
...
pkgs = ["nss-softokn-3.36.0-5.h7.eulerosv2r7",
        "nss-softokn-devel-3.36.0-5.h7.eulerosv2r7",
        "nss-softokn-freebl-3.36.0-5.h7.eulerosv2r7",
        "nss-softokn-freebl-devel-3.36.0-5.h7.eulerosv2r7"];
