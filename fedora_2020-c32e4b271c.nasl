...
# extracted from Fedora Security Advisory FEDORA-2020-c32e4b271c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-c32e4b271c");

  script_name(english:"Fedora 30 : glibc (2020-c32e4b271c)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"This update incorporates fixes from the upstream glibc 2.29 stable
release branch, including a fix for a minor security vulnerability
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-c32e4b271c");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"glibc-2.29-28.fc30")) flag++;
