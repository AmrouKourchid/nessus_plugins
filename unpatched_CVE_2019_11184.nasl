...
if (description)
{
  ...
  script_cve_id("CVE-2019-11184");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2019-11184");
...
patch available.
  ...
  - A race condition in specific microprocessors using Intel (R) DDIO cache allocation and RDMA may allow an
    authenticated user to potentially enable partial information disclosure via adjacent access.
    (CVE-2019-11184)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-11184");
