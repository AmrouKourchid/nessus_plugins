...
if (description)
{
  ...
  script_cve_id("CVE-2022-22784");

  script_name(english:"Zoom Client for Meetings < 5.10.0 Vulnerability (ZSB-22006)");
...
vulnerability as referenced in the ZSB-22006 advisory.

  - The Zoom Client for Meetings (for Android, iOS, Linux, macOS, and Windows) before version 5.10.0 fails to
    properly parse XML stanzas in XMPP messages. This can allow a malicious user to break out of the current
    XMPP message context and create a new message context to have the receiving user's client perform a
    variety of actions. This issue could be used in a more sophisticated attack to forge XMPP messages from
    the server. Users can help keep themselves secure by applying current updates or downloading the latest
    Zoom software with all current security updates from https://zoom.us/download. (CVE-2022-22784)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://explore.zoom.us/en/trust/security/security-bulletin/?filter-cve=&filter=&keywords=ZSB-%2022006
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?13dcc305");
...
"Upgrade to Zoom Client for Meetings 5.10.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-22784");
