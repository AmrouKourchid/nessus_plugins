...
# extracted from Fedora Security Advisory FEDORA-2023-cbc688b8ca
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cbc688b8ca");

  script_name(english:"Fedora 38 : dotnet6.0 / dotnet7.0 (2023-cbc688b8ca)");
...
FEDORA-2023-cbc688b8ca advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cbc688b8ca");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.121-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dotnet7.0-7.0.110-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
