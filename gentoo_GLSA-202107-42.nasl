...
# extracted from Gentoo Linux Security Advisory GLSA 202107-42.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-42");

  script_name(english:"GLSA-202107-42 : PJSIP: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-42
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-42"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-libs/pjproject", unaffected:make_list("ge 2.10-r1"), vulnerable:make_list("lt 2.10-r1"))) flag++;
