...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 21H2 IoT Enterprise LTSC SEoL");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Microsoft Windows is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 21H2 IoT Enterprise LTSC is no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # https://learn.microsoft.com/en-us/lifecycle/products/windows-10-iot-enterprise-ltsc-2021
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?29e07396");
...
"Upgrade to a version of Microsoft Windows that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2032/01/13");
...
var constraints = [
  { seol : 20320113, cpe_attributes : [{'edition': 'iot_enterprise_ltsc*'}] }
];
