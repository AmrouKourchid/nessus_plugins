...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : libtiff (EulerOS-SA-2023-1427)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1427
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6c409702");
...
var pkgs = [
  "libtiff-4.3.0-9.h10.eulerosv2r11"
];
