...
if (description)
{
  ...
  script_cve_id("CVE-2017-14735");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-14735");
...
patch available.
  ...
  - OWASP AntiSamy before 1.5.7 allows XSS via HTML5 entities, as demonstrated by use of : to construct
    a javascript: URL. (CVE-2017-14735)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-14735");
