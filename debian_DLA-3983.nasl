...
# extracted from Debian Security Advisory dla-3983. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3983 : clamav - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-20505");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-20506");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/clamav");
...
"Upgrade the clamav packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libclamav11");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'clamav', 'reference': '1.0.7+dfsg-1~deb11u1'},
    {'release': '11.0', 'prefix': 'clamav-base', 'reference': '1.0.7+dfsg-1~deb11u1'},
    {'release': '11.0', 'prefix': 'clamav-daemon', 'reference': '1.0.7+dfsg-1~deb11u1'},
    {'release': '11.0', 'prefix': 'clamav-docs', 'reference': '1.0.7+dfsg-1~deb11u1'},
    {'release': '11.0', 'prefix': 'clamav-freshclam', 'reference': '1.0.7+dfsg-1~deb11u1'},
    {'release': '11.0', 'prefix': 'clamav-milter', 'reference': '1.0.7+dfsg-1~deb11u1'},
    {'release': '11.0', 'prefix': 'clamav-testfiles', 'reference': '1.0.7+dfsg-1~deb11u1'},
    {'release': '11.0', 'prefix': 'clamdscan', 'reference': '1.0.7+dfsg-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libclamav-dev', 'reference': '1.0.7+dfsg-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libclamav11', 'reference': '1.0.7+dfsg-1~deb11u1'}
];
