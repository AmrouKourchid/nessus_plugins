...
# extracted from Fedora Security Advisory FEDORA-2023-254c1f3b69
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-254c1f3b69");

  script_name(english:"Fedora 40 : python3.10 (2023-254c1f3b69)");
...
FEDORA-2023-254c1f3b69 advisory.

    Automatic update for python3.10-3.10.13-2.fc40.

    ##### **Changelog**

    ```
    * Mon Dec 18 2023 Lumr Balhar <lbalhar@redhat.com> - 3.10.13-2
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-254c1f3b69");
...
var pkgs = [
    {'reference':'python3.10-3.10.13-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
