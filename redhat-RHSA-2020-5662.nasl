...
# extracted from Red Hat Security Advisory RHSA-2020:5662. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5662");
  ...
  script_name(english:"RHEL 8 : mariadb-connector-c (RHSA-2020:5662)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:5662 advisory.

    The MariaDB Native Client library (C driver) is used to connect applications developed in C/C++ to MariaDB
    and MySQL databases.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5662.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58acbc66");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5662");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1898997");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1899004");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1899102");
...
"Update the affected mariadb-connector-c, mariadb-connector-c-config and / or mariadb-connector-c-devel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mariadb-connector-c");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mariadb-connector-c-config");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mariadb-connector-c-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mariadb-connector-c-3.1.11-2.el8_0', 'sp':'0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb-connector-c-3.1.11-2.el8_0', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb-connector-c-3.1.11-2.el8_0', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb-connector-c-config-3.1.11-2.el8_0', 'sp':'0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb-connector-c-devel-3.1.11-2.el8_0', 'sp':'0', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb-connector-c-devel-3.1.11-2.el8_0', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb-connector-c-devel-3.1.11-2.el8_0', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
