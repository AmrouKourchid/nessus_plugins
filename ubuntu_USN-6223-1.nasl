...
# extracted from Ubuntu Security Notice USN-6223-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6223-1");

  script_name(english:"Ubuntu 22.04 LTS : Linux kernel (Azure CVM) vulnerabilities (USN-6223-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6223-1");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6223-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-1076', 'CVE-2023-1077', 'CVE-2023-1079', 'CVE-2023-1670', 'CVE-2023-1859', 'CVE-2023-1998', 'CVE-2023-2985', 'CVE-2023-25012', 'CVE-2023-35788');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6223-1');
  }
  else
  {
