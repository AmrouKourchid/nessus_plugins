...
# extracted from Red Hat Security Advisory RHSA-2025:7326. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-45336", "CVE-2025-22866");
  script_xref(name:"RHSA", value:"2025:7326");

  script_name(english:"RHEL 9 : rhc (RHSA-2025:7326)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rhc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2025:7326 advisory.

    rhc is a client tool and daemon that connects the system to Red Hat hosted services enabling system and
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2344219");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-53958");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-59506");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_7326.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?508c2253");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:7326");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rhc package based on the guidance in RHSA-2025:7326.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rhc-0.2.6-3.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'rhc-devel-0.2.6-3.el9_6', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rhc / rhc-devel');
}
