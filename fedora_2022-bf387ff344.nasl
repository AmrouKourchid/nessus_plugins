...
# extracted from Fedora Security Advisory FEDORA-2022-bf387ff344
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-bf387ff344");

  script_name(english:"Fedora 37 : bash (2022-bf387ff344)");
...
FEDORA-2022-bf387ff344 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-bf387ff344");
...
var pkgs = [
    {'reference':'bash-5.1.16-4.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
