...
# extracted from Fedora Security Advisory FEDORA-2023-fc79ee273d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fc79ee273d");

  script_name(english:"Fedora 38 : librsvg2 (2023-fc79ee273d)");
...
FEDORA-2023-fc79ee273d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fc79ee273d");
...
var pkgs = [
    {'reference':'librsvg2-2.56.3-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
