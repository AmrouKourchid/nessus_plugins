...
# extracted from Fedora Security Advisory FEDORA-2023-d8a1c3e5e2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d8a1c3e5e2");
  script_xref(name:"IAVB", value:"2023-B-0041-S");

  script_name(english:"Fedora 38 : ghostscript (2023-d8a1c3e5e2)");
...
FEDORA-2023-d8a1c3e5e2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d8a1c3e5e2");
...
var pkgs = [
    {'reference':'ghostscript-10.01.2-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
