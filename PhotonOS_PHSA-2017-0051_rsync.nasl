...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Rsync PHSA-2017-0051");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rsync-3.1.2-4.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'rsync-debuginfo-3.1.2-4.ph2')) flag++;
