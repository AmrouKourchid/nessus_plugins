...
if (description)
{
  ...
  script_name(english:"OpenSSL 0.9.6c < 0.9.6m Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 0.9.6m. It is, therefore, affected by a vulnerability as
referenced in the 0.9.6m advisory.
...
"Upgrade to OpenSSL version 0.9.6m or later.");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2004-0079");
...
var constraints = [
  { 'min_version' : '0.9.6c', 'fixed_version' : '0.9.6m' }
];
