...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : numpy (EulerOS-SA-2020-2375)");
...
vulnerability :
  ...
  - An issue was discovered in NumPy 1.16.0 and earlier. It
    ...
    numpy.load call.(CVE-2019-6446)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2375
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1b1953bb");
