...
# extracted from Red Hat Security Advisory RHSA-2025:4048. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:4048");

  script_name(english:"RHEL 8 : xmlrpc-c (RHSA-2025:4048)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for xmlrpc-c.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:4048 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_4048.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56e43d29");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:4048");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL xmlrpc-c package based on the guidance in RHSA-2025:4048.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xmlrpc-c-1.51.0-11.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-c++-1.51.0-11.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-client++-1.51.0-11.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-client-1.51.0-11.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'xmlrpc-c-devel-1.51.0-11.el8_10', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
