...
if (description)
{
  ...
  script_cve_id("CVE-2011-3323");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2011-3323");
...
patch available.
  ...
  - The OSPFv3 implementation in ospf6d in Quagga before 0.99.19 allows remote attackers to cause a denial of
    ...
    IPv6 prefix length. (CVE-2011-3323)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-3323");
