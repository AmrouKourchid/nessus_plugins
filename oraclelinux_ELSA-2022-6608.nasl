...
# extracted from Oracle Linux Security Advisory ELSA-2022-6608.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : dbus-broker (ELSA-2022-6608)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-6608.html");
...
"Update the affected dbus-broker package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:dbus-broker");
...
var pkgs = [
    {'reference':'dbus-broker-28-5.1.el9_0', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dbus-broker-28-5.1.el9_0', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
