...
# extracted from Fedora Security Advisory FEDORA-2025-9bef972bb9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-9bef972bb9");

  script_name(english:"Fedora 40 : ruby (2025-9bef972bb9)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-9bef972bb9");
...
var pkgs = [
    {'reference':'ruby-3.3.8-19.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
