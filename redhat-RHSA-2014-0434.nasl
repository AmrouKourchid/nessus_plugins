...
# extracted from Red Hat Security Advisory RHSA-2014:0434. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0434");

  script_name(english:"RHEL 6 : qemu-kvm-rhev (RHSA-2014:0434)");
...
referenced in the RHSA-2014:0434 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1078201");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1078212");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1078232");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1078846");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1078848");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1078885");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1079140");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1079240");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2014/rhsa-2014_0434.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?57b188e6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0434");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2014:0434.");
  ...
  script_cwe_id(20, 119, 190, 369, 476);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-rhev-0.12.1.2-2.415.el6_5.8', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-rhev-0.12.1.2-2.415.el6_5.8', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openstack-'},
      {'reference':'qemu-kvm-rhev-tools-0.12.1.2-2.415.el6_5.8', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'openstack-'}
    ]
  }
];
