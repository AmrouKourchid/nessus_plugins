...
# extracted from Red Hat Security Advisory RHSA-2024:4645. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4645");

  script_name(english:"RHEL 9 : qt5-qtbase (RHSA-2024:4645)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4645.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0bfd7642");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2295867");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4645");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qt5-qtbase package based on the guidance in RHSA-2024:4645.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qt5-qtbase-5.15.2-30.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-common-5.15.2-30.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-devel-5.15.2-30.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-examples-5.15.2-30.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-gui-5.15.2-30.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-mysql-5.15.2-30.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-odbc-5.15.2-30.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-postgresql-5.15.2-30.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'qt5-qtbase-private-devel-5.15.2-30.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
