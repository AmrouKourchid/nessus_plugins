...
# extracted from Red Hat Security Advisory RHSA-2024:2504. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2504");

  script_name(english:"RHEL 9 : libssh (RHSA-2024:2504)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libssh.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:2504 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2504.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9aa0521e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2504");
...
"Update the RHEL libssh package based on the guidance in RHSA-2024:2504.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libssh-0.10.4-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-config-0.10.4-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libssh-devel-0.10.4-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
