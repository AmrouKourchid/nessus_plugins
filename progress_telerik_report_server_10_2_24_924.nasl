...
if (description)
{
  ...
  script_cve_id("CVE-2024-8015");
  script_xref(name:"IAVB", value:"2024-B-0152-S");

  script_name(english:"Progress Telerik Report Server <= 10.2.24.806 Insecure Type Resolution (CVE-2024-8015)");

  script_set_attribute(attribute:"synopsis", value:
"The version of Progress Telerik Report Server installed on the remote host is affected by an insecure type resolution vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Progress Telerik Report Server installed on the remote host is affected by an insecure type resolution
vulnerability:
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b850d71b");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Progress Telerik Report Server 2024 Q3 (10.2.24.924) or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:M/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:H/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-8015");
...
var constraints = [
  { 'max_version':'10.2.24.806', 'fixed_version':'10.2.24.924'}
];
