...
# extracted from Red Hat Security Advisory RHSA-2022:5062. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:5062");
  script_xref(name:"IAVA", value:"2022-A-0235-S");

  script_name(english:"RHEL 7 : .NET Core 3.1 on RHEL 7 (RHSA-2022:5062)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2022:5062 advisory.
    ...
    .NET SDK 3.1.420 and .NET Runtime 3.1.26.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_5062.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aa96feb8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5062");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet31-aspnetcore-runtime-3.1-3.1.26-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-aspnetcore-targeting-pack-3.1-3.1.26-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-3.1.420-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-apphost-pack-3.1-3.1.26-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-host-3.1.26-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-hostfxr-3.1-3.1.26-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-runtime-3.1-3.1.26-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-sdk-3.1-3.1.420-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-sdk-3.1-source-built-artifacts-3.1.420-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-targeting-pack-3.1-3.1.26-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-dotnet-templates-3.1-3.1.420-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'},
      {'reference':'rh-dotnet31-netstandard-targeting-pack-2.1-3.1.420-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet31'}
    ]
  }
];
