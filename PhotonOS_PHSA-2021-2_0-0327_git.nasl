...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Git PHSA-2021-2.0-0327");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'git-2.23.3-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'git-lang-2.23.3-2.ph2')) flag++;
