...
if (description)
{
  ...
  script_name(english:"H2OGPT Detection");

  script_set_attribute(attribute:"synopsis", value:
"A H2OGPT Python library is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"A H2OGPT Python library is installed on the remote host. 

Note that Nessus has relied upon on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/h2oai/h2ogpt");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:h2o:h2ogpt");
