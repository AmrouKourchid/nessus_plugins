...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libsolv PHSA-2019-1.0-0212");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"libsolv-0.6.19-6.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libsolv-debuginfo-0.6.19-6.ph1")) flag++;
