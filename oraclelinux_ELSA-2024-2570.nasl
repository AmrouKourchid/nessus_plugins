...
# extracted from Oracle Linux Security Advisory ELSA-2024-2570.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : gnutls (ELSA-2024-2570)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2024-2570 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-2570.html");
...
var pkgs = [
    ...
    {'reference':'gnutls-utils-3.8.3-4.el9_4', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
