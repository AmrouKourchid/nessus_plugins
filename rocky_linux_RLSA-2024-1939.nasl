...
# Rocky Linux Security Advisory RLSA-2024:1939.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-3302");
  script_xref(name:"RLSA", value:"2024:1939");
  script_xref(name:"IAVA", value:"2024-A-0257-S");

  script_name(english:"Rocky Linux 8 : thunderbird (RLSA-2024:1939)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2024:1939 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:1939");
...
"Update the affected thunderbird, thunderbird-debuginfo and / or thunderbird-debugsource packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-3302");
...
var pkgs = [
    {'reference':'thunderbird-115.10.0-2.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-115.10.0-2.el8_9', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-115.10.0-2.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-115.10.0-2.el8_9', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debugsource-115.10.0-2.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debugsource-115.10.0-2.el8_9', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
