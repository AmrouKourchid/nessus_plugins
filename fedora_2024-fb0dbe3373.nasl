...
# extracted from Fedora Security Advisory FEDORA-2024-fb0dbe3373
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-fb0dbe3373");

  script_name(english:"Fedora 39 : upx (2024-fb0dbe3373)");
...
FEDORA-2024-fb0dbe3373 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-fb0dbe3373");
...
var pkgs = [
    {'reference':'upx-4.2.3-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
