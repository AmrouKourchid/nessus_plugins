...
# extracted from Fedora Security Advisory FEDORA-2024-ddb5f7c0a3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-ddb5f7c0a3");

  script_name(english:"Fedora 41 : moodle (2024-ddb5f7c0a3)");
...
FEDORA-2024-ddb5f7c0a3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ddb5f7c0a3");
...
var pkgs = [
    {'reference':'moodle-4.4.5-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
