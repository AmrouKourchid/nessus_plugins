...
# extracted from Fedora Security Advisory FEDORA-2023-19bcafe341
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-19bcafe341");

  script_name(english:"Fedora 37 : rust (2023-19bcafe341)");
...
FEDORA-2023-19bcafe341 advisory.

    Security fix for CVE-2022-46176: Cargo did not perform SSH host key verification when cloning indexes and
    dependencies via SSH. For more details, see the upstream [security advisory](https://blog.rust-
    lang.org/2023/01/10/cve-2022-46176.html).
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-19bcafe341");
  script_set_attribute(attribute:"solution", value:
"Update the affected rust package.");
...
var pkgs = [
    {'reference':'rust-1.66.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
