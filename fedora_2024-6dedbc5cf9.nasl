...
# extracted from Fedora Security Advisory FEDORA-2024-6dedbc5cf9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-6dedbc5cf9");

  script_name(english:"Fedora 40 : python3.8 (2024-6dedbc5cf9)");
...
FEDORA-2024-6dedbc5cf9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6dedbc5cf9");
...
var pkgs = [
    {'reference':'python3.8-3.8.20-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
