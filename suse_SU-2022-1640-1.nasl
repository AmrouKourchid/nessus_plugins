...
# SUSE update advisory SUSE-SU-2022:1640-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:1640-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 39 for SLE 12 SP3) (SUSE-SU-2022:1640-1)");
...
in the SUSE-SU-2022:1640-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-May/010991.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fa21123c");
...
var pkgs = [
    {'reference':'kgraft-patch-4_4_180-94_144-default-15-2.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
    {'reference':'kgraft-patch-4_4_180-94_144-default-15-2.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
];
