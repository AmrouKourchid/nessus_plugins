...
ELSA-2015-2152 advisory.
    ...
    - [kernel] Initialize msg/shm IPC objects before doing ipc_addid() (Lennert Buytenhek) [1271507]
    {CVE-2015-7613}
    - [fs] vfs: Test for and handle paths that are unreachable from their mnt_root ('Eric W. Biederman')
    [1209371] {CVE-2015-2925}
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2015-7837");
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-327.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
