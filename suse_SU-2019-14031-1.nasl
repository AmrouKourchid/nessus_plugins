...
# extracted from SUSE update advisory SUSE-SU-2019:14031-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : libssh2_org (SUSE-SU-2019:14031-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1091236");
  ...
  # https://www.suse.com/support/update/announcement/2019/suse-su-201914031-1.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?afd1954d");
...
slessp4-libssh2_org-14031=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-libssh2_org-14031=1");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"libssh2-1-1.4.3-17.6.1")) flag++;
