...
# extracted from Fedora Security Advisory FEDORA-2023-7da03dc2ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7da03dc2ae");

  script_name(english:"Fedora 38 : openvswitch (2023-7da03dc2ae)");
...
FEDORA-2023-7da03dc2ae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7da03dc2ae");
  script_set_attribute(attribute:"solution", value:
"Update the affected openvswitch package.");
...
var pkgs = [
    {'reference':'openvswitch-3.1.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
