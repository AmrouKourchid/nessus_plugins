...
if (description)
{
  ...
  script_name(english:"CentOS 9 : pam-1.5.1-19.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for pam.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
pam-1.5.1-19.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=51963");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream pam package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:pam-docs");
