...
# extracted from Fedora Security Advisory FEDORA-2024-121f5cec9f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-121f5cec9f");
  script_xref(name:"IAVA", value:"2024-A-0245-S");

  script_name(english:"Fedora 39 : firefox (2024-121f5cec9f)");
...
FEDORA-2024-121f5cec9f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-121f5cec9f");
...
var pkgs = [
    {'reference':'firefox-125.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
