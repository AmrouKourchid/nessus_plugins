...
# extracted from Red Hat Security Advisory RHSA-2024:0150. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0150.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f907218f");
...
"Update the RHEL .NET 8.0 package based on the guidance in RHSA-2024:0150.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'aspnetcore-runtime-8.0-8.0.1-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'aspnetcore-targeting-pack-8.0-8.0.1-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-8.0.101-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-apphost-pack-8.0-8.0.1-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-host-8.0.1-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-hostfxr-8.0-8.0.1-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-runtime-8.0-8.0.1-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-8.0.101-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-sdk-8.0-source-built-artifacts-8.0.101-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-targeting-pack-8.0-8.0.1-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'dotnet-templates-8.0-8.0.101-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'netstandard-targeting-pack-2.1-8.0.101-1.el8_9', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
