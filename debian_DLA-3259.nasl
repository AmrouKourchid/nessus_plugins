...
# extracted from Debian Security Advisory dla-3259. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3259 : libjettison-java - security update");
...
dla-3259 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3259-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libjettison-java', 'reference': '1.5.3-1~deb10u1'}
];
