...
# extracted from SUSE update advisory SUSE-SU-2020:2475-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : libX11 (SUSE-SU-2020:2475-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ab257524");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"libX11-6-1.6.2-12.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libX11-6-32bit-1.6.2-12.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libX11-6-debuginfo-1.6.2-12.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libX11-6-debuginfo-32bit-1.6.2-12.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libX11-debugsource-1.6.2-12.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libX11-xcb1-1.6.2-12.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libX11-xcb1-32bit-1.6.2-12.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libX11-xcb1-debuginfo-1.6.2-12.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libX11-xcb1-debuginfo-32bit-1.6.2-12.15.1")) flag++;
