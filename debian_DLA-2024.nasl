...
# extracted from Debian Security Advisory DLA-2024-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2024-1 : phpmyadmin security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"phpMyAdmin before 4.9.2 does not escape certain Git information,
related to libraries/display_git_revision.lib.php and
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2019/12/msg00006.html");
...
"Upgrade the affected phpmyadmin package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-19617");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"phpmyadmin", reference:"4:4.2.12-2+deb8u7")) flag++;
