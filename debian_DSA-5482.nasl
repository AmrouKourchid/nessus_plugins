...
# extracted from Debian Security Advisory dsa-5482. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5482-1 : tryton-server - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 / 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5482
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5482");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'tryton-server', 'reference': '5.0.33-2+deb11u2'},
    {'release': '11.0', 'prefix': 'tryton-server-doc', 'reference': '5.0.33-2+deb11u2'},
    {'release': '12.0', 'prefix': 'tryton-server', 'reference': '6.0.29-2+deb12u1'},
    {'release': '12.0', 'prefix': 'tryton-server-all-in-one', 'reference': '6.0.29-2+deb12u1'},
    {'release': '12.0', 'prefix': 'tryton-server-doc', 'reference': '6.0.29-2+deb12u1'},
    {'release': '12.0', 'prefix': 'tryton-server-nginx', 'reference': '6.0.29-2+deb12u1'},
    {'release': '12.0', 'prefix': 'tryton-server-postgresql', 'reference': '6.0.29-2+deb12u1'},
    {'release': '12.0', 'prefix': 'tryton-server-uwsgi', 'reference': '6.0.29-2+deb12u1'}
];
