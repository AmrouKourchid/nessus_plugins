...
# extracted from Debian Security Advisory dla-3430. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3430 : cups-browsed - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3430
advisory.

    - ------------------------------------------------------------------------
    Debian LTS Advisory DLA-3430-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                    Thorsten Alteholz
    May 22, 2023                                  https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------

    Package        : cups-filters
    Version        : 1.21.6-5+deb10u1
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/cups-filters");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'cups-browsed', 'reference': '1.21.6-5+deb10u1'},
    {'release': '10.0', 'prefix': 'cups-filters', 'reference': '1.21.6-5+deb10u1'},
    {'release': '10.0', 'prefix': 'cups-filters-core-drivers', 'reference': '1.21.6-5+deb10u1'},
    {'release': '10.0', 'prefix': 'libcupsfilters-dev', 'reference': '1.21.6-5+deb10u1'},
    {'release': '10.0', 'prefix': 'libcupsfilters1', 'reference': '1.21.6-5+deb10u1'},
    {'release': '10.0', 'prefix': 'libfontembed-dev', 'reference': '1.21.6-5+deb10u1'},
    {'release': '10.0', 'prefix': 'libfontembed1', 'reference': '1.21.6-5+deb10u1'}
];
