...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : icu (EulerOS-SA-2021-1801)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1801
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9061834");
...
pkgs = ["libicu-50.1.2-15.h8",
        "libicu-devel-50.1.2-15.h8"];
