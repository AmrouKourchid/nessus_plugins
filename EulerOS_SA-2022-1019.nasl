...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : squashfs-tools (EulerOS-SA-2022-1019)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1019
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c66fb3f0");
...
var pkgs = [
  "squashfs-tools-4.4-1.h1.r3.eulerosv2r9"
];
