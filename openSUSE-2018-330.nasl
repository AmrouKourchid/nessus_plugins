...
# extracted from openSUSE Security Update openSUSE-2018-330.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : links (openSUSE-2018-330)");
...
"This update for links to version 2.15 fixes the following issues :
  ...
  - CVE-2017-11114: Buffer over-read vulnerability in case
    of corrupted UTF-8 data (boo#1051448)

This update also contains a number of upstream improvements :

  - Rewrite google docs URLs to the download link, so that
    the file can be viewed in external viewer

  - Improved handling of compressed connections and content

  - various other bug fixes and improvements");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1051448");
  script_set_attribute(attribute:"solution", value:
"Update the affected links packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-11114");
...
if ( rpm_check(release:"SUSE42.3", reference:"links-2.15-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"links-debuginfo-2.15-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"links-debugsource-2.15-7.3.1") ) flag++;
