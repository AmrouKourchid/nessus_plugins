...
# CentOS Errata and Security Advisory 2018:2283 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : java-1.7.0-openjdk (CESA-2018:2283)");
...
listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2018-August/022977.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc148b7d");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-1.7.0.191-2.6.15.4.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-demo-1.7.0.191-2.6.15.4.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-devel-1.7.0.191-2.6.15.4.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-javadoc-1.7.0.191-2.6.15.4.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-src-1.7.0.191-2.6.15.4.el6_10")) flag++;
