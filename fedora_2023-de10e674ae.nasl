...
# extracted from Fedora Security Advisory FEDORA-2023-de10e674ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-de10e674ae");

  script_name(english:"Fedora 36 : libpcap / tcpdump (2023-de10e674ae)");
...
FEDORA-2023-de10e674ae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-de10e674ae");
...
var pkgs = [
    {'reference':'libpcap-1.10.4-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'},
    {'reference':'tcpdump-4.99.4-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'14'}
];
