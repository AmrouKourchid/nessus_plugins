...
referenced in the RHSA-2012:0016 advisory.
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2012/rhsa-2012_0016.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f6e4efad");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:0016");
...
"Update the RHEL libxml2 package based on the guidance in RHSA-2012:0016.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxml2-2.6.16-12.9', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-2.6.16-12.9', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-2.6.16-12.9', 'cpu':'ppc64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-2.6.16-12.9', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-2.6.16-12.9', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-2.6.16-12.9', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.6.16-12.9', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.6.16-12.9', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.6.16-12.9', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.6.16-12.9', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.6.16-12.9', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-python-2.6.16-12.9', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-python-2.6.16-12.9', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-python-2.6.16-12.9', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-python-2.6.16-12.9', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-python-2.6.16-12.9', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
