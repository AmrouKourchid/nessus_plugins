...
# extracted from VMware Security Advisory PHSA-2019-2.0-0139. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Openssh PHSA-2019-2.0-0139");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the openssh package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-139.md");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssh-7.5p1-12.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssh-clients-7.5p1-12.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssh-debuginfo-7.5p1-12.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'openssh-server-7.5p1-12.ph2')) flag++;
