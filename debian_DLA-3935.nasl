...
# extracted from Debian Security Advisory dla-3935. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3935 : distro-info-data - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-3935
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3935-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                       Stefano Rivera
    October 24, 2024                              https://wiki.debian.org/LTS
    -------------------------------------------------------------------------
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/distro-info-data");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'distro-info-data', 'reference': '0.51+deb11u7'}
];
