...
# extracted from Red Hat Security Advisory RHSA-2024:2512. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2512");

  script_name(english:"RHEL 9 : file (RHSA-2024:2512)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2512.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb2575b5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2512");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2235714");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-5734");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL file package based on the guidance in RHSA-2024:2512.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-file-magic");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'file-5.39-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'file-devel-5.39-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'file-libs-5.39-16.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'file / file-devel / file-libs / python3-file-magic');
}
