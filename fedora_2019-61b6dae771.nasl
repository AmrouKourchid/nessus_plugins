...
# extracted from Fedora Security Advisory FEDORA-2019-61b6dae771.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-61b6dae771");

  script_name(english:"Fedora 29 : sleuthkit (2019-61b6dae771)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-61b6dae771");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"sleuthkit-4.6.6-1.fc29")) flag++;
