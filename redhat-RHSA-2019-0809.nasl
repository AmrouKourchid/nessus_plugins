...
# extracted from Red Hat Security Advisory RHSA-2019:0809. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : ovmf (RHSA-2019:0809)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ovmf.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:0809 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0809.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77079b3a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0809");
...
"Update the RHEL ovmf package based on the guidance in RHSA-2019:0809.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:AAVMF");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'AAVMF-20180508-3.gitee3198e672e2.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'OVMF-20180508-3.gitee3198e672e2.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
