...
if (description)
{
  ...
  script_cve_id("CVE-2016-4971", "CVE-2017-6508", "CVE-2018-0494");

  script_name(english:"RHEL 6 : wget (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2016-4971");
