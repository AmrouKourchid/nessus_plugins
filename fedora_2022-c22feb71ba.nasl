...
# extracted from Fedora Security Advisory FEDORA-2022-c22feb71ba
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-c22feb71ba");

  script_name(english:"Fedora 35 : mingw-expat (2022-c22feb71ba)");
...
FEDORA-2022-c22feb71ba advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-c22feb71ba");
...
var pkgs = [
    {'reference':'mingw-expat-2.4.9-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
