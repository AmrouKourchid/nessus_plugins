...
# extracted from Red Hat Security Advisory RHSA-2024:6782. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:6782");

  script_name(english:"RHEL 9 : firefox  update (Important) (RHSA-2024:6782)");
...
referenced in the RHSA-2024:6782 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6782.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f707b3c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6782");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-128.2.0-1.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
