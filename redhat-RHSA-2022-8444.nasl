...
# extracted from Red Hat Security Advisory RHSA-2022:8444. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8444");

  script_name(english:"RHEL 9 : keylime (RHSA-2022:8444)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8444.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c24d78f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8444");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2135343");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL keylime package based on the guidance in RHSA-2022:8444.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'keylime-6.5.1-1.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-base-6.5.1-1.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-registrar-6.5.1-1.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-selinux-6.5.1-1.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-tenant-6.5.1-1.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'keylime-verifier-6.5.1-1.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-keylime-6.5.1-1.el9_1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
