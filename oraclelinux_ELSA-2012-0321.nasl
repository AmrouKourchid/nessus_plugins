...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-0321.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected cvs and / or cvs-inetd packages.");
