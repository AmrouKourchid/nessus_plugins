...
denial-of-service or execute arbitrary code.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=865504");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=865505");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=876400");
  # https://security-tracker.debian.org/tracker/source-package/php-horde-image
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e6ad62e8");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/php-horde-image");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4276");
...
in version 2.3.6-1+deb9u1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-14650");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2017-9774");
