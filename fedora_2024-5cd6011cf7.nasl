...
# extracted from Fedora Security Advisory FEDORA-2024-5cd6011cf7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5cd6011cf7");
  script_xref(name:"IAVA", value:"2024-A-0541-S");

  script_name(english:"Fedora 39 : openssl (2024-5cd6011cf7)");
...
FEDORA-2024-5cd6011cf7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5cd6011cf7");
...
var pkgs = [
    {'reference':'openssl-3.1.4-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
