...
# Rocky Linux Security Advisory RLSA-2024:0975.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:0975");
  script_xref(name:"IAVB", value:"2024-B-0009-S");

  script_name(english:"Rocky Linux 8 : postgresql:13 (RLSA-2024:0975)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
RLSA-2024:0975 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:0975");
...
var appstreams = {
    'postgresql:13': [
      ...
      {'reference':'pgaudit-1.5.0-1.module+el8.8.0+1443+0e26d3b2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pgaudit-debuginfo-1.5.0-1.module+el8.8.0+1443+0e26d3b2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pgaudit-debugsource-1.5.0-1.module+el8.8.0+1443+0e26d3b2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'postgresql-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-contrib-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-contrib-debuginfo-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-debuginfo-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-debugsource-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-docs-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-docs-debuginfo-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plperl-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plperl-debuginfo-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plpython3-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-plpython3-debuginfo-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-pltcl-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-pltcl-debuginfo-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-debuginfo-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-devel-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-server-devel-debuginfo-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-static-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-debuginfo-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-test-rpm-macros-13.14-1.module+el8.9.0+1736+ef8fa13a', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-debuginfo-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-devel-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-upgrade-devel-debuginfo-13.14-1.module+el8.9.0+1736+ef8fa13a', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
