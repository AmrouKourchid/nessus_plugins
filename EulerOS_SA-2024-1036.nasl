...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : httpd (EulerOS-SA-2024-1036)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1036
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?171865ef");
...
var pkgs = [
  "httpd-2.4.34-24.h19.eulerosv2r9",
  "httpd-filesystem-2.4.34-24.h19.eulerosv2r9",
  "httpd-tools-2.4.34-24.h19.eulerosv2r9",
  "mod_ssl-2.4.34-24.h19.eulerosv2r9"
];
