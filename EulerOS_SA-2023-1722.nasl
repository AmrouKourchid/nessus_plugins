...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : grub2 (EulerOS-SA-2023-1722)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1722
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?160bd0a0");
...
var pkgs = [
  "grub2-common-2.02-0.65.2.h12",
  "grub2-efi-aa64-2.02-0.65.2.h12",
  "grub2-efi-aa64-modules-2.02-0.65.2.h12",
  "grub2-tools-2.02-0.65.2.h12",
  "grub2-tools-extra-2.02-0.65.2.h12",
  "grub2-tools-minimal-2.02-0.65.2.h12"
];
