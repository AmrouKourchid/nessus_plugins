...
# extracted from Red Hat Security Advisory RHSA-2024:3303. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3303");

  script_name(english:"RHEL 8 : libxml2 (RHSA-2024:3303)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libxml2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3303 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3303.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a0d1031");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3303");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libxml2 package based on the guidance in RHSA-2024:3303.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libxml2-2.9.7-16.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libxml2-devel-2.9.7-16.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libxml2-2.9.7-16.el8_8.4', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
