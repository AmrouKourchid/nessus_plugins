...
# CentOS Errata and Security Advisory 2018:3050 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : gnutls (CESA-2018:3050)");
...
* gnutls: HMAC-SHA-384 vulnerable to Lucky thirteen attack due to use
of wrong constant (CVE-2018-10845)

* gnutls: 'Just in Time' PRIME + PROBE cache-based side channel attack
can lead to plaintext recovery (CVE-2018-10846)
...
Enterprise Linux 7.6 Release Notes linked from the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2018-December/005773.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ceed0eb");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"gnutls-3.3.29-8.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"gnutls-c++-3.3.29-8.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"gnutls-dane-3.3.29-8.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"gnutls-devel-3.3.29-8.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"gnutls-utils-3.3.29-8.el7")) flag++;
