...
# extracted from Fedora Security Advisory FEDORA-2019-0ef4149687.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-0ef4149687");

  script_name(english:"Fedora 30 : php-symfony (2019-0ef4149687)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-0ef4149687");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"php-symfony-2.8.51-1.fc30")) flag++;
