...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : ruby (EulerOS-SA-2023-2851)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2851
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c360e70e");
...
var pkgs = [
  "ruby-3.0.3-122.h9.eulerosv2r11",
  "ruby-help-3.0.3-122.h9.eulerosv2r11",
  "ruby-irb-3.0.3-122.h9.eulerosv2r11"
];
