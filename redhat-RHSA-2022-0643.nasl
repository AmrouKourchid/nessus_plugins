...
# extracted from Red Hat Security Advisory RHSA-2022:0643. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:0643");

  script_name(english:"RHEL 8 : python-pillow (RHSA-2022:0643)");
...
referenced in the RHSA-2022:0643 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0643.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a3e234e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0643");
...
"Update the RHEL python-pillow package based on the guidance in RHSA-2022:0643.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-pillow-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-pillow-doc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:python3-pillow-tk");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-pillow-5.1.1-18.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pillow-devel-5.1.1-18.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pillow-doc-5.1.1-18.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-pillow-tk-5.1.1-18.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
