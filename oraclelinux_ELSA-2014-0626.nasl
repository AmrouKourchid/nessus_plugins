...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 / 6 : openssl097a / and / openssl098e (ELSA-2014-0626)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-0626.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected openssl097a and / or openssl098e packages.");
...
var pkgs = [
    {'reference':'openssl097a-0.9.7a-12.el5_10.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openssl097a-0.9.7a-12.el5_10.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openssl098e-0.9.8e-18.0.1.el6_5.2', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openssl098e-0.9.8e-18.0.1.el6_5.2', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
