...
# extracted from Fedora Security Advisory FEDORA-2021-ced31f3f0c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-ced31f3f0c");

  script_name(english:"Fedora 33 : mingw-python3 (2021-ced31f3f0c)");
...
FEDORA-2021-ced31f3f0c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-ced31f3f0c");
...
pkgs = [
    {'reference':'mingw-python3-3.9.1-2.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
