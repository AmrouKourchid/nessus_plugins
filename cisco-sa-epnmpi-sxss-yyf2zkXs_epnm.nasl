...
if (description)
{
  ...
  script_xref(name:"CISCO-BUG-ID", value:"CSCwk84368");
  script_xref(name:"CISCO-SA", value:"cisco-sa-epnmpi-sxss-yyf2zkXs");
  script_xref(name:"IAVA", value:"2024-A-0709-S");

  script_name(english:"Cisco Evolved Programmable Network Manager XSS (cisco-sa-epnmpi-sxss-yyf2zkXs)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of Cisco Evolved Programmable Network Manager installed on the remote host is prior to 8.0.0. It is, 
therefore, affected by the following:

  - A vulnerability in the web-based management interface of Cisco Evolved Programmable Network Manager (EPNM) 
    could allow an authenticated, low-privileged, remote attacker to conduct a stored cross-site scripting (XSS) 
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwk84368");
