...
# extracted from Fedora Security Advisory FEDORA-2019-96946c39dd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-96946c39dd");

  script_name(english:"Fedora 30 : 2:runc (2019-96946c39dd)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-96946c39dd");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"runc-1.0.0-95.rc9.gitc1485a1.fc30", epoch:"2")) flag++;
