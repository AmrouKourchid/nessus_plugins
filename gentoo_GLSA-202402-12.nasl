...
# extracted from Gentoo Linux Security Advisory GLSA 202402-12.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202402-12 : GNU Tar: Out of Bounds Read");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202402-12 (GNU Tar: Out of Bounds Read)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202402-12");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=898176");
...
var packages = [
  {
    'name' : 'app-arch/tar',
    'unaffected' : make_list("ge 1.34-r3"),
    'vulnerable' : make_list("lt 1.34-r3")
  }
];
