...
# extracted from F5 Networks BIG-IP Solution K73008537.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Apache Tomcat vulnerability (K73008537)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to 14.0.1.1 / 14.1.0. It is, therefore, affected
by a vulnerability as referenced in the K73008537 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K73008537");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K73008537.");
