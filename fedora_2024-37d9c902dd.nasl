...
# extracted from Fedora Security Advisory FEDORA-2024-37d9c902dd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-37d9c902dd");

  script_name(english:"Fedora 39 : python3.11 (2024-37d9c902dd)");
...
FEDORA-2024-37d9c902dd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-37d9c902dd");
...
var pkgs = [
    {'reference':'python3.11-3.11.10-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
