...
# extracted from Red Hat Security Advisory RHSA-2019:4089. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:4089");

  script_name(english:"RHEL 7 : OpenShift Container Platform 4.1 jenkins-2-plugins (RHSA-2019:4089)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.1 jenkins-2-plugins.");
...
referenced in the RHSA-2019:4089 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_4089.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?30668304");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:4089");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1764387");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1764390");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.1 jenkins-2-plugins package based on the guidance in RHSA-2019:4089.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.1.1574872364-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
