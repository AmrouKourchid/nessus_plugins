...
# extracted from Red Hat Security Advisory RHSA-2024:0750. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0750");

  script_name(english:"RHEL 8 : libmaxminddb (RHSA-2024:0750)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libmaxminddb.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:0750 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0750.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7afc521b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1895379");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0750");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libmaxminddb package based on the guidance in RHSA-2024:0750.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libmaxminddb");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libmaxminddb-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libmaxminddb-1.2.0-10.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libmaxminddb-devel-1.2.0-10.el8_8.1', 'sp':'8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libmaxminddb / libmaxminddb-devel');
}
