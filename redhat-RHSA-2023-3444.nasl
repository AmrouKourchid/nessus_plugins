...
# extracted from Red Hat Security Advisory RHSA-2023:3444. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3444");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (python-flask) (RHSA-2023:3444)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 16.2 (python-flask).");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3444.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc8a5f40");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3444");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 16.2 (python-flask) package based on the guidance in RHSA-2023:3444.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-flask-1.0.2-8.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
