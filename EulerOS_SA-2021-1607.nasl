...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : librepo (EulerOS-SA-2021-1607)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the librepo package installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1607
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?da4b1fd6");
...
pkgs = ["librepo-1.11.0-2.h3.eulerosv2r9"];
