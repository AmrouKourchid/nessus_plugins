...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : glib2 (EulerOS-SA-2025-1189)");
...
following vulnerabilities :
    ...
    gio/gsocks4aproxy.c in GNOME GLib before 2.82.1 has an off-by-one error and resultant buffer overflow
    because SOCKS4_CONN_MSG_LEN is not sufficient for a trailing '\0' character.(CVE-2024-52533)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1189
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5e4e2c55");
...
var pkgs = [
  "glib2-2.72.2-5.h19.eulerosv2r12"
];
