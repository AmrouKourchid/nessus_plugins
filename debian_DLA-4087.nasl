...
# extracted from Debian Security Advisory dla-4087. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-0391", "CVE-2025-0938", "CVE-2025-1795");

  script_name(english:"Debian dla-4087 : idle-python3.9 - security update");
...
dla-4087 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-4087-1                debian-lts@lists.debian.org
    ...
    Multiple vulnerabilities were discovered in modules shipped with
    cpython 3.9, the primary interpreter for the Python programming
    language.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-0938");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-1795");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'idle-python3.9', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libpython3.9', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libpython3.9-dbg', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libpython3.9-dev', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libpython3.9-minimal', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libpython3.9-stdlib', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libpython3.9-testsuite', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'python3.9', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'python3.9-dbg', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'python3.9-dev', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'python3.9-doc', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'python3.9-examples', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'python3.9-full', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'python3.9-minimal', 'reference': '3.9.2-1+deb11u3'},
    {'release': '11.0', 'prefix': 'python3.9-venv', 'reference': '3.9.2-1+deb11u3'}
];
