...
# extracted from Fedora Security Advisory FEDORA-2024-d61bffd77f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d61bffd77f");

  script_name(english:"Fedora 39 : galera / mariadb (2024-d61bffd77f)");
...
FEDORA-2024-d61bffd77f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d61bffd77f");
...
var pkgs = [
    {'reference':'galera-26.4.18-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mariadb-10.5.25-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'galera / mariadb');
}
