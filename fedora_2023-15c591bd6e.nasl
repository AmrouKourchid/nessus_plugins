...
# extracted from Fedora Security Advisory FEDORA-2023-15c591bd6e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-15c591bd6e");

  script_name(english:"Fedora 37 : vim (2023-15c591bd6e)");
...
FEDORA-2023-15c591bd6e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-15c591bd6e");
...
var pkgs = [
    {'reference':'vim-9.0.1649-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
