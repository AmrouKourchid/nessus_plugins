...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : c-ares (EulerOS-SA-2023-3421)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3421
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25e0b4c7");
...
var pkgs = [
  "c-ares-1.13.0-5.h2.eulerosv2r8",
  "c-ares-devel-1.13.0-5.h2.eulerosv2r8"
];
