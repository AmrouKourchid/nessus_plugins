...
# extracted from Red Hat Security Advisory RHSA-2024:2055. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2055");

  script_name(english:"RHEL 9 : buildah (RHSA-2024:2055)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f9bbc6b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2055");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL buildah package based on the guidance in RHSA-2024:2055.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'buildah-1.31.5-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'buildah-tests-1.31.5-1.el9_3', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
