...
# extracted from Fedora Security Advisory FEDORA-2022-22b1f8dae2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-22b1f8dae2");

  script_name(english:"Fedora 37 : qemu (2022-22b1f8dae2)");
...
FEDORA-2022-22b1f8dae2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-22b1f8dae2");
...
var pkgs = [
    {'reference':'qemu-7.0.0-12.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
