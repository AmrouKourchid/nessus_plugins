...
# extracted from Red Hat Security Advisory RHSA-2024:3760. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3760");

  script_name(english:"RHEL 7 : ipa (RHSA-2024:3760)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for ipa.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:3760 advisory.
    ...
    * ipa: user can obtain a hash of the passwords of all domain users and perform offline brute force
    (CVE-2024-3183)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_3760.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb619178");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3760");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ipa package based on the guidance in RHSA-2024:3760.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ipa-client-4.6.8-5.el7_9.17', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-4.6.8-5.el7_9.17', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-4.6.8-5.el7_9.17', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-4.6.8-5.el7_9.17', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-client-common-4.6.8-5.el7_9.17', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-common-4.6.8-5.el7_9.17', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-python-compat-4.6.8-5.el7_9.17', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-4.6.8-5.el7_9.17', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-common-4.6.8-5.el7_9.17', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-dns-4.6.8-5.el7_9.17', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-trust-ad-4.6.8-5.el7_9.17', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-ipaclient-4.6.8-5.el7_9.17', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-ipalib-4.6.8-5.el7_9.17', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-ipaserver-4.6.8-5.el7_9.17', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
