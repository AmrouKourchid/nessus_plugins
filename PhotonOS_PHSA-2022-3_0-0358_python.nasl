...
if (description)
{
  ...
  script_cve_id("CVE-2021-41496", "CVE-2021-43818");

  script_name(english:"Photon OS 3.0: Python PHSA-2022-3.0-0358");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'python-lxml-4.2.4-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'python-numpy-1.15.1-4.ph3')) flag++;
