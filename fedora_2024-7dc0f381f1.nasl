...
# extracted from Fedora Security Advisory FEDORA-2024-7dc0f381f1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7dc0f381f1");

  script_name(english:"Fedora 39 : python3.6 (2024-7dc0f381f1)");
...
FEDORA-2024-7dc0f381f1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7dc0f381f1");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-36.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
