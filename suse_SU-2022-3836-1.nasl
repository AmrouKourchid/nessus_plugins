...
# SUSE update advisory SUSE-SU-2022:3836-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2020-27783", "CVE-2021-28957");
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3836-1");

  script_name(english:"openSUSE 15 Security Update : python-lxml (SUSE-SU-2022:3836-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote openSUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote openSUSE 15 host has packages installed that are affected by multiple vulnerabilities as referenced in the
SUSE-SU-2022:3836-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-November/012792.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eecd300f");
...
"Update the affected python2-lxml-doc and / or python3-lxml-doc packages.");
...
var pkgs = [
    {'reference':'python2-lxml-doc-4.0.0-150000.4.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.3']},
    {'reference':'python3-lxml-doc-4.0.0-150000.4.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.3']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python2-lxml-doc / python3-lxml-doc');
}
