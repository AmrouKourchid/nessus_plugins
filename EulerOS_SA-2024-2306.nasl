...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.12.1 : gnutls (EulerOS-SA-2024-2306)");
...
Tenable has extracted the preceding description block directly from the EulerOS Virtualization gnutls security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2306
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6775acc2");
...
var pkgs = [
  "gnutls-3.7.2-6.h11.eulerosv2r12",
  "gnutls-utils-3.7.2-6.h11.eulerosv2r12"
];
