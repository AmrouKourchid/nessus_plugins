...
# extracted from Red Hat Security Advisory RHSA-2024:4937. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:4937");

  script_name(english:"RHEL 8 : varnish:6 (RHSA-2024:4937)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for varnish:6.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2024:4937 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_4937.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e59e76fb");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:4937");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL varnish:6 package based on the guidance in RHSA-2024:4937.");
  ...
  'varnish:6': [
    {
      ...
      'pkgs': [
        {'reference':'varnish-6.0.6-1.module+el8.2.0+22154+6b906702', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-devel-6.0.6-1.module+el8.2.0+22154+6b906702', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-docs-6.0.6-1.module+el8.2.0+22154+6b906702', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
