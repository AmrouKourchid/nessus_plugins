...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2023-061.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2023 : ca-certificates (ALAS2023-2023-061)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by a vulnerability as referenced in the ALAS2023-2023-061 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2023-061.html");
...
"Run 'dnf update ca-certificates --releasever=2023.0.20230222 ' to update your system.");
...
var pkgs = [
    {'reference':'ca-certificates-2021.2.50-1.0.amzn2023.0.6', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
