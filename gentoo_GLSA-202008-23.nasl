...
# extracted from Gentoo Linux Security Advisory GLSA 202008-23.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202008-23");

  script_name(english:"GLSA-202008-23 : chrony: Symlink vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202008-23
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?274f0ff2");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202008-23");
...
if (qpkg_check(package:"net-misc/chrony", unaffected:make_list("ge 3.5.1"), vulnerable:make_list("lt 3.5.1"))) flag++;
