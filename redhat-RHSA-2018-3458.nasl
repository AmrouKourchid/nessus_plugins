...
# extracted from Red Hat Security Advisory RHSA-2018:3458. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : thunderbird (RHSA-2018:3458)");
...
referenced in the RHSA-2018:3458 advisory.
  ...
  - Mozilla: Same-origin policy violation using meta refresh and performance.getEntries to steal cross-origin
    URLs (CVE-2018-18499)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3458.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d296a2e2");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2018-25/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3458");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1625531");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1632062");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL thunderbird package based on the guidance in RHSA-2018:3458.");
  ...
  script_cwe_id(119, 120, 212, 416, 787, 829);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-60.2.1-4.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-60.2.1-4.el7_5', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-60.2.1-4.el7_5', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
