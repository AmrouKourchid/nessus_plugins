...
# extracted from Fedora Security Advisory FEDORA-2018-4ac3c68ee4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : polkit (2018-4ac3c68ee4)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-4ac3c68ee4");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"polkit-0.115-2.fc28")) flag++;
