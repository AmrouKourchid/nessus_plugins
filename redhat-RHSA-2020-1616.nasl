...
# extracted from Red Hat Security Advisory RHSA-2020:1616. The text
...
if (description)
{
  ...
  script_bugtraq_id(108998);
  script_xref(name:"RHSA", value:"2020:1616");

  script_name(english:"RHEL 8 : irssi (RHSA-2020:1616)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for irssi.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:1616 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_1616.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc0e3a40");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.2_release_notes/index
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd7b3f20");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1616");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1727683");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL irssi package based on the guidance in RHSA-2020:1616.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:irssi-devel");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'irssi-1.1.1-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'irssi-devel-1.1.1-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
