...
# extracted from Debian Security Advisory DLA-2583-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2583-1 : activemq security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Multiple security issues were discovered in activemq, a message broker
built around Java Message Service.

CVE-2017-15709

When using the OpenWire protocol in activemq, it was found that
certain system details (such as the OS and kernel version) are exposed
as plain text.

CVE-2018-11775

TLS hostname verification when using the Apache ActiveMQ Client was
missing which could make the client vulnerable to a MITM attack
between a Java application using the ActiveMQ client and the ActiveMQ
server. This is now enabled by default.
...
anonymous access to the LDAP server. The anonymous context is used to
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2021/03/msg00005.html");
...
"Upgrade the affected packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-26117");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"activemq", reference:"5.14.3-3+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libactivemq-java", reference:"5.14.3-3+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libactivemq-java-doc", reference:"5.14.3-3+deb9u2")) flag++;
