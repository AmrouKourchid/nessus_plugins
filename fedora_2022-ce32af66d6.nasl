...
# extracted from Fedora Security Advisory FEDORA-2022-ce32af66d6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ce32af66d6");

  script_name(english:"Fedora 36 : webkit2gtk3 (2022-ce32af66d6)");
...
FEDORA-2022-ce32af66d6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ce32af66d6");
...
var pkgs = [
    {'reference':'webkit2gtk3-2.38.2-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
