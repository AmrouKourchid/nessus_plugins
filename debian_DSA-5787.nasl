...
# extracted from Debian Security Advisory dsa-5787. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5787 : chromium - security update");
...
dsa-5787 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5787-1                   security@debian.org
    https://www.debian.org/security/                           Andres Salomon
    October 09, 2024                      https://www.debian.org/security/faq
    - -------------------------------------------------------------------------
    ...
    version 129.0.6668.100-1~deb12u1.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-9602");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-9603");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'chromium', 'reference': '129.0.6668.100-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-common', 'reference': '129.0.6668.100-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-driver', 'reference': '129.0.6668.100-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-l10n', 'reference': '129.0.6668.100-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-sandbox', 'reference': '129.0.6668.100-1~deb12u1'},
    {'release': '12.0', 'prefix': 'chromium-shell', 'reference': '129.0.6668.100-1~deb12u1'}
];
