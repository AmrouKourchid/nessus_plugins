...
if (description)
{
  ...
  script_cve_id("CVE-2024-7965");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2024/09/18");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-7965");
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-7965");
