...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : binutils (EulerOS-SA-2024-1003)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1003
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf276c07");
...
var pkgs = [
  "binutils-2.34-1.h38.eulerosv2r9"
];
