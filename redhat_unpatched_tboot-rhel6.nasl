...
# extracted from Red Hat Security Advisory tboot. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2014-5118", "CVE-2017-16837");

  script_name(english:"RHEL 6 : tboot (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:tboot");
