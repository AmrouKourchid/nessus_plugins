...
FEDORA-2021-79926272ce advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-79926272ce");
...
pkgs = [
    {'reference':'chromium-87.0.4280.141-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
