...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libgcrypt (EulerOS-SA-2019-2205)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2205
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4867e9d");
...
pkgs = ["libgcrypt-1.5.3-14.h2.eulerosv2r7",
        "libgcrypt-devel-1.5.3-14.h2.eulerosv2r7"];
