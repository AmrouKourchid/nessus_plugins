...
if (description)
{
  ...
  script_name(english:"AIX : Multiple Vulnerabilities (IJ36596)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ36596. It is, therefore, affected by multiple
vulnerabilities as referenced in the IJ36596 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ36596");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6560390");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ36596.");
...
var constraints = [
    {'release': '7.3', 'ml': '00', 'sp': '01', 'patch': 'IJ36596s1a', 'package': 'bos.cluster.rte', 'minfilesetver': '7.3.0.0', 'maxfilesetver': '7.3.0.0'}
];
