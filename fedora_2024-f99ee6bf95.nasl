...
# extracted from Fedora Security Advisory FEDORA-2024-f99ee6bf95
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f99ee6bf95");

  script_name(english:"Fedora 40 : rust-h2 (2024-f99ee6bf95)");
...
FEDORA-2024-f99ee6bf95 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f99ee6bf95");
...
var pkgs = [
    {'reference':'rust-h2-0.3.26-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
