...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5043064");
  script_xref(name:"MSFT", value:"MS24-5043064");
  ...
  script_name(english:"KB5043064: Windows 10 Version 21H2 / Windows 10 Version 22H2 Security Update (September 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5043064. It is, therefore, affected by multiple vulnerabilities
  ...
  - Windows TCP/IP Remote Code Execution Vulnerability (CVE-2024-21416, CVE-2024-38045)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5043064");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5043064");
