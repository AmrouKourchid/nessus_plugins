...
# extracted from Gentoo Linux Security Advisory GLSA 202107-19.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-19");

  script_name(english:"GLSA-202107-19 : Jinja: Denial of service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-19
(Jinja: Denial of service)

    The &lsquo;urlize&rsquo; filter in Jinja utilized an inefficient regular
...
Impact :
    ...
    An attacker could cause a Denial of Service condition via crafted input
      to the &lsquo;urlize&rsquo; Jinja filter.
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-19"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"dev-python/jinja", unaffected:make_list("ge 2.11.3"), vulnerable:make_list("lt 2.11.3"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Jinja");
}
