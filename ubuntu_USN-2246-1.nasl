...
# extracted from Ubuntu Security Notice USN-2246-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(68034);
  script_xref(name:"USN", value:"2246-1");

  script_name(english:"Ubuntu 14.04 LTS : APT vulnerability (USN-2246-1)");
...
USN-2246-1 advisory.
    ...
    Jakub Wilk discovered that APT did not correctly validate signatures when downloading source packages. If
    a remote attacker were able to perform a machine-in-the-middle attack, this flaw could potentially be used
    to install altered source packages.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2246-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0478");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'apt', 'pkgver': '1.0.1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'apt-transport-https', 'pkgver': '1.0.1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'apt-utils', 'pkgver': '1.0.1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'libapt-inst1.5', 'pkgver': '1.0.1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'libapt-pkg-dev', 'pkgver': '1.0.1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'libapt-pkg4.12', 'pkgver': '1.0.1ubuntu2.1'}
];
