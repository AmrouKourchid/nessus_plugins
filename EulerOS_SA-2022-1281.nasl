...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : postgresql (EulerOS-SA-2022-1281)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1281
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2785b568");
...
"Update the affected postgresql packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-23214");
...
var pkgs = [
  "postgresql-9.2.24-1.h4.eulerosv2r7",
  "postgresql-contrib-9.2.24-1.h4.eulerosv2r7",
  "postgresql-devel-9.2.24-1.h4.eulerosv2r7",
  "postgresql-docs-9.2.24-1.h4.eulerosv2r7",
  "postgresql-libs-9.2.24-1.h4.eulerosv2r7",
  "postgresql-plperl-9.2.24-1.h4.eulerosv2r7",
  "postgresql-plpython-9.2.24-1.h4.eulerosv2r7",
  "postgresql-pltcl-9.2.24-1.h4.eulerosv2r7",
  "postgresql-server-9.2.24-1.h4.eulerosv2r7",
  "postgresql-test-9.2.24-1.h4.eulerosv2r7"
];
