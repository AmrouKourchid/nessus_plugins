...
# extracted from Fedora Security Advisory FEDORA-2023-86068d1187
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-86068d1187");

  script_name(english:"Fedora 37 : redis (2023-86068d1187)");
...
FEDORA-2023-86068d1187 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-86068d1187");
...
"Update the affected redis package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-28425");
...
var pkgs = [
    {'reference':'redis-7.0.10-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
