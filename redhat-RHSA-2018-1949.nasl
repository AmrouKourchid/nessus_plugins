...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2018/rhsa-2018_1949.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?722b683d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1949");
...
"Update the RHEL ansible package based on the guidance in RHSA-2018:1949.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.5.5-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.5'},
      {'reference':'ansible-doc-2.5.5-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.5'}
    ]
  }
];
