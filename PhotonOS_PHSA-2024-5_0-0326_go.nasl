...
if (description)
{
  ...
  script_cve_id("CVE-2024-24787", "CVE-2024-24791");
  script_xref(name:"IAVB", value:"2024-B-0052-S");

  script_name(english:"Photon OS 5.0: Go PHSA-2024-5.0-0326");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'go-1.21.12-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'go-md2man-2.0.2-11.ph5')) flag++;
