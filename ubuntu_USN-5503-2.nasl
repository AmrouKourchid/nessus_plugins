...
# extracted from Ubuntu Security Notice USN-5503-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5503-2");

  script_name(english:"Ubuntu 16.04 ESM : GnuPG vulnerability (USN-5503-2)");
...
USN-5503-2 advisory.
    ...
    USN-5503-1 fixed a vulnerability in GnuPG. This update provides the corresponding update for Ubuntu 14.04
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5503-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'dirmngr', 'pkgver': '2.1.11-6ubuntu2.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'gnupg', 'pkgver': '1.4.20-1ubuntu3.3+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'gnupg-agent', 'pkgver': '2.1.11-6ubuntu2.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'gnupg-curl', 'pkgver': '1.4.20-1ubuntu3.3+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'gnupg2', 'pkgver': '2.1.11-6ubuntu2.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'gpgsm', 'pkgver': '2.1.11-6ubuntu2.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'gpgv', 'pkgver': '1.4.20-1ubuntu3.3+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'gpgv2', 'pkgver': '2.1.11-6ubuntu2.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'scdaemon', 'pkgver': '2.1.11-6ubuntu2.1+esm1', 'ubuntu_pro': TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'dirmngr / gnupg / gnupg-agent / gnupg-curl / gnupg2 / gpgsm / gpgv / etc');
}
