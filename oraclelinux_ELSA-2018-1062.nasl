...
ELSA-2018-1062 advisory.
    ...
    - [media] v4l2-compat-ioctl32.c: refactor compat ioctl32 logic fixup (Jarod Wilson) [1548430]
    {CVE-2017-13166}
    ...
    - [sound] alsa: seq: Fix use-after-free at creating a port (CVE-2017-15265) (Jaroslav Kysela) [1503381]
    {CVE-2017-15265}
    - [x86] kvm: fix singlestepping over syscall (Paolo Bonzini) [1464481] {CVE-2017-7518}
    - [net] netfilter: xt_TCPMSS: add more sanity tests on tcph->doff (Florian Westphal) [1543088]
    {CVE-2017-18017}
    - [sound] alsa: seq: Make ioctls race-free (CVE-2018-1000004) (Jaroslav Kysela) [1537203]
    {CVE-2018-1000004}
    ...
    - [net] netfilter: nfnetlink_cthelper: Add missing permission checks (Florian Westphal) [1539230]
    {CVE-2017-17448}
    - [powerpc] kvm: book3s: Provide information about hardware/firmware CVE workarounds (Serhii Popovych)
    [1532077] {CVE-2017-5754}
    - [net] Fix double free and memory corruption in get_net_ns_by_id() (Aristeu Rozanski) [1531551]
    {CVE-2017-15129}
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-862.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
