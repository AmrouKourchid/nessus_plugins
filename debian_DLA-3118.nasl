...
# extracted from Debian Security Advisory dla-3118. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3118 : unzip - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/unzip");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'unzip', 'reference': '6.0-23+deb10u3'}
];
