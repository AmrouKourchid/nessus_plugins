...
the RHSA-2020:5599 advisory.
    ...
    * Previously, tendrl-node-agent service was unable to import the cluster in a VMware environment as tendrl
    was looking for the serial number of the devices. With the current update, tendrl-node-agent service is
    able to import the cluster in a VMware environment without failure as the hardware_id and parent_id of the
    devices are used after proper validation instead of the serial number. (BZ#1809920)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5599.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1eb11d4b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5599");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1809920");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1843640");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL web-admin-build package based on the guidance in RHSA-2020:5599.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'grafana-5.2.4-3.el7rhgs', 'cpu':'x86_64', 'release':'7', 'el_string':'el7rhgs', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'glusterfs'}
    ]
  }
];
