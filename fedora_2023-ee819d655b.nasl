...
# extracted from Fedora Security Advisory FEDORA-2023-ee819d655b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-ee819d655b");

  script_name(english:"Fedora 38 : dotnet7.0 (2023-ee819d655b)");
...
FEDORA-2023-ee819d655b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ee819d655b");
...
var pkgs = [
    {'reference':'dotnet7.0-7.0.107-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
