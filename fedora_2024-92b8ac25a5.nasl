...
# extracted from Fedora Security Advisory FEDORA-2024-92b8ac25a5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-92b8ac25a5");

  script_name(english:"Fedora 38 : clamav (2024-92b8ac25a5)");
...
FEDORA-2024-92b8ac25a5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-92b8ac25a5");
...
var pkgs = [
    {'reference':'clamav-1.0.6-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
