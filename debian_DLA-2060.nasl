...
# extracted from Debian Security Advisory DLA-2060-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2060-1 : phpmyadmin security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/01/msg00011.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"phpmyadmin", reference:"4:4.2.12-2+deb8u8")) flag++;
