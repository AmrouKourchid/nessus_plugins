...
# extracted from Oracle Linux Security Advisory ELSA-2021-0808.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : wpa_supplicant (ELSA-2021-0808)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-0808.html");
...
var pkgs = [
    {'reference':'wpa_supplicant-2.6-12.0.2.el7_9.2', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
