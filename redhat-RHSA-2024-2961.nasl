...
# extracted from Red Hat Security Advisory RHSA-2024:2961. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : Image builder components (RHSA-2024:2961)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2961.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d1576c8");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2268513");
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-1770");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2961");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Image builder components package based on the guidance in RHSA-2024:2961.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'osbuild-composer-101-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-core-101-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'osbuild-composer-worker-101-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
