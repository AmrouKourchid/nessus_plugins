...
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 3.11 jenkins-2-plugins.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_2478.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc175206");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1819704");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 3.11 jenkins-2-plugins package based on the guidance in RHSA-2020:2478.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-3.11.1591354111-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
