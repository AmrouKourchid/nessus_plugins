...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : NetworkManager (EulerOS-SA-2020-2499)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2499
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58aec314");
...
pkgs = ["NetworkManager-1.16.0-14.h6.eulerosv2r9",
        "NetworkManager-config-server-1.16.0-14.h6.eulerosv2r9",
        "NetworkManager-libnm-1.16.0-14.h6.eulerosv2r9"];
