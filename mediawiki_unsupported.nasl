...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0551");
...
security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://www.mediawiki.org/wiki/Version_lifecycle");
...
foreach ver_regex (keys(unsupported_versions))
{
  if (version =~ ver_regex)
  {
    ...
    eol_url = "https://www.mediawiki.org/wiki/Version_lifecycle";
