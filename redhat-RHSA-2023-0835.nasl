...
# extracted from Red Hat Security Advisory RHSA-2023:0835. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0835");

  script_name(english:"RHEL 8 : python-setuptools (RHSA-2023:0835)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-setuptools.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:0835 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0835.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?936f6ff0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2158559");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0835");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-setuptools package based on the guidance in RHSA-2023:0835.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'platform-python-setuptools-39.2.0-6.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-setuptools-39.2.0-6.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-setuptools-wheel-39.2.0-6.el8_7.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
