...
# extracted from Gentoo Linux Security Advisory GLSA 202407-19.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202407-19 : Mozilla Thunderbird: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202407-19 (Mozilla Thunderbird: Multiple
Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202407-19");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=932375");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 115.11.0"),
    'vulnerable' : make_list("lt 115.11.0")
  },
  {
