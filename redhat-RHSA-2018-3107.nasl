...
# extracted from Red Hat Security Advisory RHSA-2018:3107. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : wpa_supplicant (RHSA-2018:3107)");
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_3107.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a80aa2b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3107");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1434434");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1490885");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1614520");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL wpa_supplicant package based on the guidance in RHSA-2018:3107.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wpa_supplicant-2.6-12.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
