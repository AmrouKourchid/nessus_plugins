...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL6.x i386/x86_64 (20200113)");
...
Security Fix(es) :
  ...
  - Mozilla: CSS sanitization does not escape HTML tags
    (CVE-2019-17022)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2001&L=SCIENTIFIC-LINUX-ERRATA&P=2306
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9034cea8");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"firefox-68.4.1-1.el6_10", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-68.4.1-1.el6_10", allowmaj:TRUE)) flag++;
