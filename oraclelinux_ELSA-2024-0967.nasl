...
# extracted from Oracle Linux Security Advisory ELSA-2024-0967.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : opensc (ELSA-2024-0967)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-0967.html");
...
var pkgs = [
    {'reference':'opensc-0.20.0-8.el8_9', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'opensc-0.20.0-8.el8_9', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'opensc-0.20.0-8.el8_9', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
