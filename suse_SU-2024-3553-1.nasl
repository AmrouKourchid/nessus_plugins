...
# SUSE update advisory SUSE-SU-2024:3553-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:3553-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (SUSE-SU-2024:3553-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2024:3553-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1229748");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1230542");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2024-October/037161.html");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2024-43886");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2024-46711");
...
var pkgs = [
    {'reference':'kernel-coco-6.4.0-15061.6.coco15sp6.1', 'sp':'6', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-confidential-computing-release--15.6']},
    {'reference':'kernel-coco-devel-6.4.0-15061.6.coco15sp6.1', 'sp':'6', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-confidential-computing-release--15.6']},
    {'reference':'kernel-coco_debug-6.4.0-15061.6.coco15sp6.1', 'sp':'6', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-confidential-computing-release--15.6']},
    {'reference':'kernel-coco_debug-devel-6.4.0-15061.6.coco15sp6.1', 'sp':'6', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-confidential-computing-release--15.6']},
    {'reference':'kernel-devel-coco-6.4.0-15061.6.coco15sp6.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-confidential-computing-release--15.6']},
    {'reference':'kernel-source-coco-6.4.0-15061.6.coco15sp6.1', 'sp':'6', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-confidential-computing-release--15.6']},
    {'reference':'kernel-syms-coco-6.4.0-15061.6.coco15sp6.1', 'sp':'6', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-confidential-computing-release--15.6']},
    {'reference':'reiserfs-kmp-coco-6.4.0-15061.6.coco15sp6.1', 'sp':'6', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-confidential-computing-release--15.6']}
];
