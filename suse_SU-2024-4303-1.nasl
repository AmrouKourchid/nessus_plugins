...
# SUSE update advisory SUSE-SU-2024:4303-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2024:4303-1");
  script_xref(name:"IAVA", value:"2024-A-0672-S");

  script_name(english:"SUSE SLES15 Security Update : buildah (SUSE-SU-2024:4303-1)");
...
referenced in the SUSE-SU-2024:4303-1 advisory.

    Security issues fixed:

    - CVE-2024-9675: cache arbitrary directory mount (bsc#1231499)
    - CVE-2024-9407: Improper Input Validation in bind-propagation Option of Dockerfile RUN --mount
    Instruction (bsc#1231208)
    - CVE-2024-9676: symlink traversal vulnerability in the containers/storage library can cause denial of
    service (bsc#1231698)
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2024-December/019996.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f416de91");
...
var pkgs = [
    {'reference':'buildah-1.35.4-150300.8.28.3', 'sp':'3', 'cpu':'x86_64', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3']},
    {'reference':'buildah-1.35.4-150300.8.28.3', 'sp':'3', 'cpu':'aarch64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.3']},
    {'reference':'buildah-1.35.4-150300.8.28.3', 'sp':'3', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-LTSS-release-15.3']},
    {'reference':'buildah-1.35.4-150300.8.28.3', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-release-15.3']}
];
