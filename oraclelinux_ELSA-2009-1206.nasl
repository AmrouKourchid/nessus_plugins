...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : libxml / and / libxml2 (ELSA-2009-1206)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1206.html");
...
"Update the affected libxml2, libxml2-devel and / or libxml2-python packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-2416");
...
var pkgs = [
    {'reference':'libxml2-2.6.26-2.1.2.8.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-devel-2.6.26-2.1.2.8.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-python-2.6.26-2.1.2.8.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-2.6.26-2.1.2.8.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-devel-2.6.26-2.1.2.8.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-python-2.6.26-2.1.2.8.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
