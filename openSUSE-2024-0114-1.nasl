...
# openSUSE Security Update openSUSE-SU-2024:0114-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : pdns-recursor (openSUSE-SU-2024:0114-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1223262");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/ZZH2ONXJKWNVDG6IH66D5CLFDU6CHDXI/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f7d461c");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2024-25583");
...
var pkgs = [
    {'reference':'pdns-recursor-4.8.8-bp155.2.6.1', 'cpu':'aarch64', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pdns-recursor-4.8.8-bp155.2.6.1', 'cpu':'x86_64', 'release':'SUSE15.5', 'rpm_spec_vers_cmp':TRUE}
];
