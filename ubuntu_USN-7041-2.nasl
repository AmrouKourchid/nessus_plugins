...
# extracted from Ubuntu Security Notice USN-7041-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7041-2");

  script_name(english:"Ubuntu 18.04 LTS : CUPS vulnerability (USN-7041-2)");
...
USN-7041-2 advisory.
    ...
    USN-7041-1 fixed a vulnerability in CUPS. This update provides the corresponding update for Ubuntu 18.04
    LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7041-2");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'cups', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'cups-bsd', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'cups-client', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'cups-common', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'cups-core-drivers', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'cups-daemon', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'cups-ipp-utils', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'cups-ppdc', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'cups-server-common', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libcups2', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libcups2-dev', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libcupscgi1', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libcupsimage2', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libcupsimage2-dev', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libcupsmime1', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libcupsppdc1', 'pkgver': '2.2.7-1ubuntu2.10+esm6', 'ubuntu_pro': TRUE}
];
