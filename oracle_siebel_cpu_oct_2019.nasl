...
if (description)
{
  ...
  script_name(english:"Oracle Siebel Server (October 2019 CPU)");
...
October 2019 CPU advisory.

  - Vulnerability in the Siebel UI Framework product of Oracle Siebel CRM (component: Customizable
    Prod/Configurator (Apache Tomcat)). Supported versions that are affected are 19.7 and prior. Difficult to
    exploit vulnerability allows unauthenticated attacker with network access via HTTP to compromise Siebel UI
    Framework. Successful attacks of this vulnerability can result in unauthorized access to critical data or
    complete access to all Siebel UI Framework accessible data. (CVE-2018-8037)
