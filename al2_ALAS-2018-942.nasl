...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-942.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : qemu-kvm (ALAS-2018-942) (Spectre)");
...
conducting targeted cache side-channel attacks. (CVE-2017-5715)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-942.html");
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"qemu-img-1.5.3-141.amzn2.5.3")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"qemu-kvm-1.5.3-141.amzn2.5.3")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"qemu-kvm-common-1.5.3-141.amzn2.5.3")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"qemu-kvm-debuginfo-1.5.3-141.amzn2.5.3")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"qemu-kvm-tools-1.5.3-141.amzn2.5.3")) flag++;
