...
# extracted from Oracle Linux Security Advisory ELSA-2019-2308.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : libguestfs-winsupport (ELSA-2019-2308)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-2308.html");
...
var pkgs = [
    {'reference':'libguestfs-winsupport-7.2-3.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
