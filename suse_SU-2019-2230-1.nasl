...
# extracted from SUSE update advisory SUSE-SU-2019:2230-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (SUSE-SU-2019:2230-1)");
...
CVE-2018-5390: Fixed expensive calls to tcp_collapse_ofo_queue() and
tcp_prune_ofo_queue() for every incoming packet which could have led
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2019/suse-su-20192230-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b549c720");
...
SUSE-SLE-SAP-12-SP2-2019-2230=1

SUSE Linux Enterprise Server 12-SP2-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP2-2019-2230=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"kgraft-patch-4_4_121-92_117-default-2-2.1")) flag++;
