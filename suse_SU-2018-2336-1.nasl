...
# extracted from SUSE update advisory SUSE-SU-2018:2336-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : apache2 (SUSE-SU-2018:2336-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"This update for apache2 fixes the following issues: The following
security vulnerability were fixed :
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1101689");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2018-1333/");
  # https://www.suse.com/support/update/announcement/2018/suse-su-20182336-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?22d74494");
...
patch SUSE-SLE-SDK-12-SP3-2018-1575=1

SUSE Linux Enterprise Server 12-SP3:zypper in -t patch
SUSE-SLE-SERVER-12-SP3-2018-1575=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"apache2-2.4.23-29.21.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"apache2-debuginfo-2.4.23-29.21.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"apache2-debugsource-2.4.23-29.21.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"apache2-example-pages-2.4.23-29.21.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"apache2-prefork-2.4.23-29.21.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"apache2-prefork-debuginfo-2.4.23-29.21.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"apache2-utils-2.4.23-29.21.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"apache2-utils-debuginfo-2.4.23-29.21.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"apache2-worker-2.4.23-29.21.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"apache2-worker-debuginfo-2.4.23-29.21.1")) flag++;
