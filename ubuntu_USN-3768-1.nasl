...
vulnerabilities as referenced in the USN-3768-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3768-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-16802");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'ghostscript', 'pkgver': '9.10~dfsg-0ubuntu10.13'},
    {'osver': '14.04', 'pkgname': 'ghostscript-x', 'pkgver': '9.10~dfsg-0ubuntu10.13'},
    {'osver': '14.04', 'pkgname': 'libgs-dev', 'pkgver': '9.10~dfsg-0ubuntu10.13'},
    {'osver': '14.04', 'pkgname': 'libgs9', 'pkgver': '9.10~dfsg-0ubuntu10.13'},
    {'osver': '14.04', 'pkgname': 'libgs9-common', 'pkgver': '9.10~dfsg-0ubuntu10.13'},
    {'osver': '16.04', 'pkgname': 'ghostscript', 'pkgver': '9.18~dfsg~0-0ubuntu2.9'},
    {'osver': '16.04', 'pkgname': 'ghostscript-x', 'pkgver': '9.18~dfsg~0-0ubuntu2.9'},
    {'osver': '16.04', 'pkgname': 'libgs-dev', 'pkgver': '9.18~dfsg~0-0ubuntu2.9'},
    {'osver': '16.04', 'pkgname': 'libgs9', 'pkgver': '9.18~dfsg~0-0ubuntu2.9'},
    {'osver': '16.04', 'pkgname': 'libgs9-common', 'pkgver': '9.18~dfsg~0-0ubuntu2.9'},
    {'osver': '18.04', 'pkgname': 'ghostscript', 'pkgver': '9.22~dfsg+1-0ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'ghostscript-x', 'pkgver': '9.22~dfsg+1-0ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'libgs-dev', 'pkgver': '9.22~dfsg+1-0ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'libgs9', 'pkgver': '9.22~dfsg+1-0ubuntu1.2'},
    {'osver': '18.04', 'pkgname': 'libgs9-common', 'pkgver': '9.22~dfsg+1-0ubuntu1.2'}
];
