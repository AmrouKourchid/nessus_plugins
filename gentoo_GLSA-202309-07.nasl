...
# extracted from Gentoo Linux Security Advisory GLSA 202309-07.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202309-07 : Binwalk: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202309-07 (Binwalk: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202309-07");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=820614");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=903652");
...
"All Binwalk users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:binwalk");
...
var packages = [
  {
    'name' : 'app-misc/binwalk',
    'unaffected' : make_list("ge 2.3.4"),
    'vulnerable' : make_list("lt 2.3.4")
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'Binwalk');
}
