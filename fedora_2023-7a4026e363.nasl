...
# extracted from Fedora Security Advisory FEDORA-2023-7a4026e363
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-7a4026e363");
  script_xref(name:"IAVA", value:"2023-A-0507-S");

  script_name(english:"Fedora 37 : firefox (2023-7a4026e363)");
...
FEDORA-2023-7a4026e363 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-7a4026e363");
...
var pkgs = [
    {'reference':'firefox-118.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
