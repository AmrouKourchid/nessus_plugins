...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : httpd (EulerOS-SA-2019-2157)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2157
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4f7f5150");
...
pkgs = ["httpd-2.4.6-80.1.h7.eulerosv2r7",
        "httpd-devel-2.4.6-80.1.h7.eulerosv2r7",
        "httpd-manual-2.4.6-80.1.h7.eulerosv2r7",
        "httpd-tools-2.4.6-80.1.h7.eulerosv2r7",
        "mod_session-2.4.6-80.1.h7.eulerosv2r7",
        "mod_ssl-2.4.6-80.1.h7.eulerosv2r7"];
