...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Low: / mod_perl (ELSA-2007-0395)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0395.html");
...
var pkgs = [
    {'reference':'mod_perl-2.0.2-6.3.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_perl-devel-2.0.2-6.3.el5', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_perl-2.0.2-6.3.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_perl-devel-2.0.2-6.3.el5', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
