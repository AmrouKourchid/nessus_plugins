...
if (description)
{
  ...
  script_cve_id("CVE-2014-0182");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-0182");
...
patch available.
  ...
  - Heap-based buffer overflow in the virtio_load function in hw/virtio/virtio.c in QEMU before 1.7.2 might
    allow remote attackers to execute arbitrary code via a crafted config length in a savevm image.
    (CVE-2014-0182)
