...
# extracted from Fedora Security Advisory FEDORA-2023-38094d905c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-38094d905c");

  script_name(english:"Fedora 38 : texlive-base (2023-38094d905c)");
...
FEDORA-2023-38094d905c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-38094d905c");
  script_set_attribute(attribute:"solution", value:
"Update the affected 10:texlive-base package.");
...
var pkgs = [
    {'reference':'texlive-base-20220321-72.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10'}
];
