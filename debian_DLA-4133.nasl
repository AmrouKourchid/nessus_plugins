...
# extracted from Debian Security Advisory dla-4133. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4133 : wget - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-4133
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/wget");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-38428");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/wget");
...
"Upgrade the wget packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:wget-udeb");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'wget', 'reference': '1.21-1+deb11u2'},
    {'release': '11.0', 'prefix': 'wget-udeb', 'reference': '1.21-1+deb11u2'}
];
