...
if (description)
{
  ...
  script_cve_id("CVE-2021-42530");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-42530");
...
patch available.
  ...
  - XMP Toolkit SDK version 2021.07 (and earlier) is affected by a stack-based buffer overflow vulnerability
    ...
    requires user interaction in that a victim must open a crafted file. (CVE-2021-42530)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-42530");
