...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Shadow PHSA-2023-4.0-0415");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'shadow-4.13-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'shadow-devel-4.13-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'shadow-lang-4.13-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'shadow-libs-4.13-1.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'shadow-tools-4.13-1.ph4')) flag++;
