...
if (description)
{
  ...
  script_cve_id("CVE-2022-49310");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49310");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: char: xillybus: fix a refcount leak in
    cleanup_dev() usb_get_dev is called in xillyusb_probe. So it is better to call usb_put_dev before xdev is
    released. (CVE-2022-49310)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49310");
