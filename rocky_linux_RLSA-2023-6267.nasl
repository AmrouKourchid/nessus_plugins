...
# Rocky Linux Security Advisory RLSA-2023:6267.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:6267");

  script_name(english:"Rocky Linux 8 : squid:4 (RLSA-2023:6267)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2023:6267 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:6267");
...
var appstreams = {
    'squid:4': [
      ...
      {'reference':'squid-4.15-6.module+el8.8.0+1273+55f5b063', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-4.15-6.module+el8.8.0+1273+55f5b063', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-debuginfo-4.15-6.module+el8.8.0+1273+55f5b063', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-debuginfo-4.15-6.module+el8.8.0+1273+55f5b063', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-debugsource-4.15-6.module+el8.8.0+1273+55f5b063', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
      {'reference':'squid-debugsource-4.15-6.module+el8.8.0+1273+55f5b063', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
    ]
};
