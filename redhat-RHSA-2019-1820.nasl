...
# extracted from Red Hat Security Advisory RHSA-2019:1820. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1820");

  script_name(english:"RHEL 7 : rh-maven35-jackson-databind (RHSA-2019:1820)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1820.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?832dc84c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1725807");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1820");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-maven35-jackson-databind package based on the guidance in RHSA-2019:1820.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-maven35-jackson-databind-2.7.6-2.6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-maven35-jackson-databind-javadoc-2.7.6-2.6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
