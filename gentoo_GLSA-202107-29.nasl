...
# extracted from Gentoo Linux Security Advisory GLSA 202107-29.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-26675", "CVE-2021-26676", "CVE-2021-33833");
  script_xref(name:"GLSA", value:"202107-29");

  script_name(english:"GLSA-202107-29 : ConnMan: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-29
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-29"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-misc/connman", unaffected:make_list("ge 1.40"), vulnerable:make_list("lt 1.40"))) flag++;
