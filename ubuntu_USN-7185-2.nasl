...
# extracted from Ubuntu Security Notice USN-7185-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7185-2");

  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS : Linux kernel (Azure) vulnerabilities (USN-7185-2)");
...
vulnerabilities as referenced in the USN-7185-2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7185-2");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1184-azure");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-7185-2');
}
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-7185-2');
  }
  else
  {
