...
# extracted from Red Hat Security Advisory RHSA-2019:3951. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3951");

  script_name(english:"RHEL 8 : SDL (RHSA-2019:3951)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for SDL.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:3951 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3951.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?382e71a6");
  script_set_attribute(attribute:"see_also", value:"https://hg.libsdl.org/SDL/rev/e7ba650a643a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3951");
...
"Update the RHEL SDL package based on the guidance in RHSA-2019:3951.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'SDL-1.2.15-36.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'SDL-devel-1.2.15-36.el8_1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'SDL-1.2.15-36.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'SDL-devel-1.2.15-36.el8_1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
