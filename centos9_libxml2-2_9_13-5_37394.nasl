...
if (description)
{
  ...
  script_name(english:"CentOS 9 : libxml2-2.9.13-5.el9");
...
libxml2-2.9.13-5.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=37394");
...
var pkgs = [
    {'reference':'libxml2-2.9.13-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-devel-2.9.13-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxml2-static-2.9.13-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-libxml2-2.9.13-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
