...
# extracted from Ubuntu Security Notice USN-3589-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3589-1");

  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : PostgreSQL vulnerability (USN-3589-1)");
...
in the USN-3589-1 advisory.

    It was discovered that PostgreSQL incorrectly handled certain settings. An attacker could possibly use
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3589-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libecpg-compat3', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libecpg-dev', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libecpg6', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libpgtypes3', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libpq-dev', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'libpq5', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-9.3', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-client-9.3', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-contrib-9.3', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-plperl-9.3', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-plpython-9.3', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-plpython3-9.3', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-pltcl-9.3', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '14.04', 'pkgname': 'postgresql-server-dev-9.3', 'pkgver': '9.3.22-0ubuntu0.14.04'},
    {'osver': '16.04', 'pkgname': 'libecpg-compat3', 'pkgver': '9.5.12-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libecpg-dev', 'pkgver': '9.5.12-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libecpg6', 'pkgver': '9.5.12-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libpgtypes3', 'pkgver': '9.5.12-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libpq-dev', 'pkgver': '9.5.12-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'libpq5', 'pkgver': '9.5.12-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-9.5', 'pkgver': '9.5.12-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-client-9.5', 'pkgver': '9.5.12-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-contrib-9.5', 'pkgver': '9.5.12-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-plperl-9.5', 'pkgver': '9.5.12-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-plpython-9.5', 'pkgver': '9.5.12-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-plpython3-9.5', 'pkgver': '9.5.12-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-pltcl-9.5', 'pkgver': '9.5.12-0ubuntu0.16.04'},
    {'osver': '16.04', 'pkgname': 'postgresql-server-dev-9.5', 'pkgver': '9.5.12-0ubuntu0.16.04'}
];
