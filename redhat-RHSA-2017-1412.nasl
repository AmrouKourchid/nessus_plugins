...
referenced in the RHSA-2017:1412 advisory.
    ...
    JBoss Enterprise Application Platform 7.0.6.

    Refer to the JBoss Enterprise Application Platform 7.0.6 Release Notes, linked to in the References
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2017/rhsa-2017_1412.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a2e8dbe");
  # https://access.redhat.com/documentation/en/jboss-enterprise-application-platform/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e41b214b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017:1412");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/JBEAP-8077");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-jboss-ec2-eap-7.0.6-1.GA_redhat_1.ep7.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'},
      {'reference':'eap7-jboss-ec2-eap-samples-7.0.6-1.GA_redhat_1.ep7.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'eap7-jboss-ec2-eap-7.0.6-1.GA_redhat_1.ep7.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'},
      {'reference':'eap7-jboss-ec2-eap-samples-7.0.6-1.GA_redhat_1.ep7.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  }
];
