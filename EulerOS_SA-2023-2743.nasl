...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : shim (EulerOS-SA-2023-2743)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2743
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?929c1844");
...
var pkgs = [
  "shim-15.4-2.h19.eulerosv2r11",
  "shim-aa64-storage-15.4-2.h19.eulerosv2r11"
];
