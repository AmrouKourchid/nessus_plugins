...
# extracted from Fedora Security Advisory FEDORA-2023-381f23a0ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-381f23a0ae");

  script_name(english:"Fedora 38 : mariadb (2023-381f23a0ae)");
...
FEDORA-2023-381f23a0ae advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-381f23a0ae");
...
var pkgs = [
    {'reference':'mariadb-10.5.20-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
];
