...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Sysstat PHSA-2019-1.0-0263");
...
if (rpm_exists(rpm:"sysstat-12.2", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"sysstat-12.2.0-1.ph1")) flag++;
if (rpm_exists(rpm:"sysstat-12.2", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"src", reference:"sysstat-12.2.0-1.ph1.src")) flag++;
