...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5044321");
  script_xref(name:"MSKB", value:"5044356");
  script_xref(name:"MSFT", value:"MS24-5044321");
  script_xref(name:"MSFT", value:"MS24-5044356");
  ...
  script_name(english:"KB5044321: Windows Server 2008 R2 Security Update (October 2024)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5044321");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5044356");
...
if (("windows server 2008 r2" >< tolower(os_name)) &&
  smb_check_rollup(os:'6.1',
                   ...
                   rollup_date:'10_2024',
                   bulletin:bulletin,
                   rollup_kb_list:[5044356, 5044321])
)
{
