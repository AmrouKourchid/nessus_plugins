...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : unzip (EulerOS-SA-2019-1880)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1880
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2da6807");
...
pkgs = ["unzip-6.0-19.h5.eulerosv2r7"];
