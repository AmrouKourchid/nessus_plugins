...
# AlmaLinux Security Advisory ALSA-2023:4541.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:4541");

  script_name(english:"AlmaLinux 8 : kernel-rt (ALSA-2023:4541)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2023:4541 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-4541.html");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for ALSA-2023:4541');
  }
  else
  {
