...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : curl (EulerOS-SA-2025-1350)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1350
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?482e7b1f");
...
"Update the affected curl packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2025-0725");
...
var pkgs = [
  "curl-7.79.1-2.h34.eulerosv2r11",
  "libcurl-7.79.1-2.h34.eulerosv2r11"
];
