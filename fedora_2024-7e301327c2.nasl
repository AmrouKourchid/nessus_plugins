...
# extracted from Fedora Security Advisory FEDORA-2024-7e301327c2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-7e301327c2");

  script_name(english:"Fedora 39 : openssh (2024-7e301327c2)");
...
FEDORA-2024-7e301327c2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7e301327c2");
...
var pkgs = [
    {'reference':'openssh-9.3p1-10.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
