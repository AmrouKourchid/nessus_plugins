...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-1009.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : ntp (ALAS-2018-1009)");
...
array.(CVE-2018-7183)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-1009.html");
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"ntp-4.2.6p5-28.amzn2.2.1")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"ntp-debuginfo-4.2.6p5-28.amzn2.2.1")) flag++;
if (rpm_check(release:"AL2", reference:"ntp-doc-4.2.6p5-28.amzn2.2.1")) flag++;
if (rpm_check(release:"AL2", reference:"ntp-perl-4.2.6p5-28.amzn2.2.1")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"ntpdate-4.2.6p5-28.amzn2.2.1")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"sntp-4.2.6p5-28.amzn2.2.1")) flag++;
