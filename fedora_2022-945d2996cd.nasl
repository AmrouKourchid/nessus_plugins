...
# extracted from Fedora Security Advisory FEDORA-2022-945d2996cd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-945d2996cd");

  script_name(english:"Fedora 37 : java-11-openjdk (2022-945d2996cd)");
...
FEDORA-2022-945d2996cd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-945d2996cd");
...
var pkgs = [
    {'reference':'java-11-openjdk-11.0.17.0.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
