...
# extracted from Fedora Security Advisory FEDORA-2019-2f47af13f6.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-2f47af13f6");

  script_name(english:"Fedora 28 : tor (2019-2f47af13f6)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-2f47af13f6");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"tor-0.3.4.11-1.fc28")) flag++;
