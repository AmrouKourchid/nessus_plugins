...
# extracted from Fedora Security Advisory FEDORA-2023-d33a0f8471
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d33a0f8471");

  script_name(english:"Fedora 37 : xorg-x11-server (2023-d33a0f8471)");
...
FEDORA-2023-d33a0f8471 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d33a0f8471");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-18.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
