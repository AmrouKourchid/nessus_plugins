...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4577053");
  script_xref(name:"MSFT", value:"MS20-4577051");
  script_xref(name:"MSFT", value:"MS20-4577053");
  ...
  script_name(english:"KB4577053: Windows 7 and Windows Server 2008 R2 September 2020 Security Update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 4577053
or cumulative update 4577051. It is, therefore, affected by
multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/4577053/windows-7-update");
...
if (
  smb_check_rollup(os:'6.1', 
                   ...
                   rollup_date:'09_2020',
                   bulletin:bulletin,
                   rollup_kb_list:[4577051, 4577053])
)
{
