...
if (description)
{
  ...
  script_cve_id("CVE-2024-46807");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46807");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/amdgpu: Check tbo resource
    pointer Validate tbo resource pointer, skip if NULL (CVE-2024-46807)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46807");
