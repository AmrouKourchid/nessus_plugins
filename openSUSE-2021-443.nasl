...
Update to version 3.0.32 :
  ...
  - Add a 'Third-party licenses and copyrights' section to
    the user manual.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1183129");
  script_set_attribute(attribute:"see_also", value:"https://bulk.fefe.de/scalability/.");
...
"Update the affected privoxy packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-20276");
