...
# extracted from Fedora Security Advisory FEDORA-2023-5b61346bbe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5b61346bbe");

  script_name(english:"Fedora 38 : webkitgtk (2023-5b61346bbe)");
...
FEDORA-2023-5b61346bbe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5b61346bbe");
...
var pkgs = [
    {'reference':'webkitgtk-2.40.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
