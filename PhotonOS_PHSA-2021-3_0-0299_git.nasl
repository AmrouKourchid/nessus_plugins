...
# extracted from VMware Security Advisory PHSA-2021-3.0-0299. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Git PHSA-2021-3.0-0299");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the git package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-3.0-299.md");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'git-2.23.3-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'git-lang-2.23.3-3.ph3')) flag++;
