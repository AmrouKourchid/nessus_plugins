...
# extracted from Fedora Security Advisory FEDORA-2019-3ba38e1cdb.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-3ba38e1cdb");

  script_name(english:"Fedora 31 : mediawiki (2019-3ba38e1cdb)");
...
"== Security fixes ==
  ...
  - (T230402, CVE-2019-16738) SECURITY: Add permission check
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-3ba38e1cdb");
  script_set_attribute(attribute:"see_also", value:"https://phabricator.wikimedia.org/T227662");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mediawiki-1.32.4-1.fc31")) flag++;
