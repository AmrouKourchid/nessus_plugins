...
# extracted from Fedora Security Advisory FEDORA-2020-92195be0e2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : pdfresurrect (2020-92195be0e2)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-92195be0e2");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"pdfresurrect-0.21-1.fc32")) flag++;
