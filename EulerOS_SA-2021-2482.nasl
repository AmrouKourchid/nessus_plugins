...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : python-jinja2 (EulerOS-SA-2021-2482)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-jinja2 packages installed, the EulerOS installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2482
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?228427df");
...
var pkgs = [
  "python2-jinja2-2.10-6.h5.eulerosv2r8",
  "python3-jinja2-2.10-6.h5.eulerosv2r8"
];
