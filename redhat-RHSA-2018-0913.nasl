...
# extracted from Red Hat Security Advisory RHSA-2018:0913. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : policycoreutils (RHSA-2018:0913)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2018:0913 advisory.

    The policycoreutils packages contain the core policy utilities required to manage a SELinux environment.

    Security Fix(es):

    * policycoreutils: Relabelling of symbolic links in /tmp and /var/tmp change the context of their target
    instead (CVE-2018-1063)
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0913.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2802e9bb");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0913");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1260238");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1337192");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1376770");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1409813");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1458831");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1471809");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1481191");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1499259");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1550122");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=974163");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'policycoreutils-2.5-22.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'policycoreutils-devel-2.5-22.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'policycoreutils-gui-2.5-22.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'policycoreutils-newrole-2.5-22.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'policycoreutils-python-2.5-22.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'policycoreutils-restorecond-2.5-22.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'policycoreutils-sandbox-2.5-22.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
