...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : cups (EulerOS-SA-2024-2574)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2574
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c29ee7de");
...
var pkgs = [
  "cups-libs-2.4.0-3.h6.eulerosv2r11"
];
