...
# extracted from Amazon Linux AMI Security Advisory ALAS-2018-1111.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : java-1.7.0-openjdk (ALAS-2018-1111)");
...
(Confidentiality, Integrity and Availability impacts). CVSS Vector:
(CVSS:3.0/AV:N/AC:H/PR:N/UI:R/S:C/C:H/I:H/A:H).(CVE-2018-3136)Codebase
restriction (JNDI, 8199177");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2018-1111.html");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-1.7.0.201-2.6.16.0.77.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-debuginfo-1.7.0.201-2.6.16.0.77.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-demo-1.7.0.201-2.6.16.0.77.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-devel-1.7.0.201-2.6.16.0.77.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-javadoc-1.7.0.201-2.6.16.0.77.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-src-1.7.0.201-2.6.16.0.77.amzn1")) flag++;
