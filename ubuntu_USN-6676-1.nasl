...
# extracted from Ubuntu Security Notice USN-6676-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6676-1");

  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS / 22.04 LTS / 23.10 : c-ares vulnerability (USN-6676-1)");
...
a vulnerability as referenced in the USN-6676-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6676-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.10.0-3ubuntu0.2+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'libc-ares2', 'pkgver': '1.10.0-3ubuntu0.2+esm3', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.14.0-1ubuntu0.2+esm2', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libc-ares2', 'pkgver': '1.14.0-1ubuntu0.2+esm2', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.15.0-1ubuntu0.5', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libc-ares2', 'pkgver': '1.15.0-1ubuntu0.5', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.18.1-1ubuntu0.22.04.3', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'libc-ares2', 'pkgver': '1.18.1-1ubuntu0.22.04.3', 'ubuntu_pro': FALSE},
    {'osver': '23.10', 'pkgname': 'libc-ares-dev', 'pkgver': '1.19.1-3ubuntu0.1', 'ubuntu_pro': FALSE},
    {'osver': '23.10', 'pkgname': 'libc-ares2', 'pkgver': '1.19.1-3ubuntu0.1', 'ubuntu_pro': FALSE}
];
