...
# extracted from Red Hat Security Advisory RHSA-2019:1237. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:1237");

  script_name(english:"RHEL 6 / 7 : rh-python35-python-jinja2 (RHSA-2019:1237)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for rh-python35-python-jinja2.");
...
referenced in the RHSA-2019:1237 advisory.

    The rh-python35-python-jinja2 package contains Jinja2, a template engine written in pure Python. Jinja2
    provides a Django inspired non-XML syntax but supports inline expressions and an optional sandboxed
    environment.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_1237.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af462ad5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1237");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-python35-python-jinja2 package based on the guidance in RHSA-2019:1237.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rh-python35-python-jinja2");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-python35-python-jinja2-2.8.1-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'rh-python35-python-jinja2-2.8.1-2.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-python35-python-jinja2');
}
