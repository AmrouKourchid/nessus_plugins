...
# SUSE update advisory SUSE-SU-2025:0180-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0180-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 48 for SLE 15 SP3) (SUSE-SU-2025:0180-1)");
...
referenced in the SUSE-SU-2025:0180-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-January/020174.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?491b0c7c");
...
"Update the affected kernel-livepatch-5_3_18-150300_59_174-default and / or kgraft-patch-4_12_14-122_231-default
packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.231-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_231-default-2-8.6.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '5.3.18-150300.59.174-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_174-default-2-150300.7.6.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-150300_59_174-default / etc');
}
