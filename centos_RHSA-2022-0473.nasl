...
# extracted from Red Hat Security Advisory RHSA-2022:0473 and
# CentOS Errata and Security Advisory 2022:0473 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : aide (RHSA-2022:0473)");
...
var pkgs = [
    {'reference':'aide-0.15.1-13.el7', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'aide-0.15.1-13.el7', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
