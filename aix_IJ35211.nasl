...
if (description)
{
  ...
  script_name(english:"AIX (IJ35211)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ35211. It is, therefore, affected by a vulnerability
as referenced in the IJ35211 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ35211");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/6516786");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ35211.");
...
var constraints = [
    {'release': '3.1', 'ml': '02', 'sp': '10', 'patch': 'IJ35211m1a', 'package': 'bos.rte.security', 'minfilesetver': '7.2.5.0', 'maxfilesetver': '7.2.5.100'},
    {'release': '3.1', 'ml': '02', 'sp': '21', 'patch': 'IJ35211m2a', 'package': 'bos.rte.security', 'minfilesetver': '7.2.5.0', 'maxfilesetver': '7.2.5.100'},
    {'release': '7.2', 'ml': '05', 'sp': '01', 'patch': 'IJ35211m1a', 'package': 'bos.rte.security', 'minfilesetver': '7.2.5.0', 'maxfilesetver': '7.2.5.100'},
    {'release': '7.2', 'ml': '05', 'sp': '02', 'patch': 'IJ35211m2a', 'package': 'bos.rte.security', 'minfilesetver': '7.2.5.0', 'maxfilesetver': '7.2.5.100'}
];
