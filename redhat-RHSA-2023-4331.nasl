...
# extracted from Red Hat Security Advisory RHSA-2023:4331. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:4331");

  script_name(english:"RHEL 9 : nodejs (RHSA-2023:4331)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:4331 advisory.

    Node.js is a software development platform for building fast and scalable network applications in the
    JavaScript programming language.

    The package has been upgraded to a later upstream version: nodejs (16.20.1). (BZ#2223334, BZ#2223336,
    BZ#2223338, BZ#2223340, BZ#2223342, BZ#2223344)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_4331.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0c6663ae");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2223334");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2223344");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:4331");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'nodejs-16.20.1-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-docs-16.20.1-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-full-i18n-16.20.1-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nodejs-libs-16.20.1-1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'npm-8.19.4-1.16.20.1.1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      ...
      {'reference':'npm-8.19.4-1.16.20.1.1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
