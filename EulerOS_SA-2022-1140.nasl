...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : python-jinja2 (EulerOS-SA-2022-1140)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-jinja2 package installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1140
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?742eadb5");
...
var pkgs = [
  "python-jinja2-2.7.2-2.h3.eulerosv2r7"
];
