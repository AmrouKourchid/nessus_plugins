...
# extracted from Debian Security Advisory dsa-4991. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-4991-1 : mailman - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2021/dsa-4991");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-12108");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-15011");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/mailman");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'mailman', 'reference': '1:2.1.29-1+deb10u2'}
];
