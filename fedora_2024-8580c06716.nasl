...
# extracted from Fedora Security Advisory FEDORA-2024-8580c06716
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8580c06716");

  script_name(english:"Fedora 41 : golang-github-prometheus-alertmanager (2024-8580c06716)");
...
FEDORA-2024-8580c06716 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8580c06716");
...
"Update the affected golang-github-prometheus-alertmanager package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-github-prometheus-alertmanager");
...
var pkgs = [
    {'reference':'golang-github-prometheus-alertmanager-0.27.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
