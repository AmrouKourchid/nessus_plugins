...
# SUSE update advisory SUSE-SU-2025:0713-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2025:0713-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 34 for SLE 15 SP4) (SUSE-SU-2025:0713-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2025-February/020435.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6a23e210");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2024-53104");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-5_14_21-150400_24_144-default and / or kernel-
livepatch-5_3_18-150300_59_185-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150400.24.144-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150400_24_144-default-2-150400.2.1', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.4']}
        ]
      },
      '5.3.18-150300.59.185-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_185-default-2-150300.2.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_14_21-150400_24_144-default / etc');
}
