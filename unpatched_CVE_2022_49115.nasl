...
if (description)
{
  ...
  script_cve_id("CVE-2022-49115");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49115");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: PCI: endpoint: Fix misused goto label
    Fix a misused goto label jump since that can result in a memory leak. (CVE-2022-49115)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49115");
