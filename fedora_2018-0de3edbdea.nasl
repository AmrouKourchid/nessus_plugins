...
# extracted from Fedora Security Advisory FEDORA-2018-0de3edbdea.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-10811");
  script_xref(name:"FEDORA", value:"2018-0de3edbdea");

  script_name(english:"Fedora 28 : strongswan (2018-0de3edbdea)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-0de3edbdea");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"strongswan-5.6.3-1.fc28")) flag++;
