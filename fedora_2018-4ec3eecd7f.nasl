...
# extracted from Fedora Security Advisory FEDORA-2018-4ec3eecd7f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-4ec3eecd7f");

  script_name(english:"Fedora 27 : moodle (2018-4ec3eecd7f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-4ec3eecd7f");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"moodle-3.3.9-1.fc27")) flag++;
