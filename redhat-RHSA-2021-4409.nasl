...
# extracted from Red Hat Security Advisory RHSA-2021:4409. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4409");

  script_name(english:"RHEL 8 : libgcrypt (RHSA-2021:4409)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libgcrypt.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:4409 advisory.

    The libgcrypt library provides general-purpose implementations of various cryptographic algorithms.

    Security Fix(es):

    * libgcrypt: mishandles ElGamal encryption because it lacks exponent blinding to address a side-channel
    attack against mpi_powm (CVE-2021-33560)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4409.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d8da1f18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4409");
...
"Update the RHEL libgcrypt package based on the guidance in RHSA-2021:4409.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libgcrypt-1.8.5-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libgcrypt-devel-1.8.5-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
