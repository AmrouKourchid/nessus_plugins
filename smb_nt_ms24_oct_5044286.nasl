...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5044286");
  script_xref(name:"MSFT", value:"MS24-5044286");
  ...
  script_name(english:"KB5044286: Windows 10 LTS 1507 Security Update (October 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5044286. It is, therefore, affected by multiple vulnerabilities
  ...
  - Microsoft WDAC OLE DB provider for SQL Server Remote Code Execution Vulnerability (CVE-2024-43519)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5044286");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5044286");
