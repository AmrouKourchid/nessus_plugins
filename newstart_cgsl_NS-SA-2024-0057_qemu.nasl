...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : qemu Vulnerability (NS-SA-2024-0057)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2023-3180");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    'qemu-4.1.0-2.el8.cgslv6_2.318.gebefdecd0',
    'qemu-block-rbd-4.1.0-2.el8.cgslv6_2.318.gebefdecd0',
    'qemu-common-4.1.0-2.el8.cgslv6_2.318.gebefdecd0',
    'qemu-img-4.1.0-2.el8.cgslv6_2.318.gebefdecd0',
    'qemu-kvm-4.1.0-2.el8.cgslv6_2.318.gebefdecd0',
    'qemu-tools-4.1.0-2.el8.cgslv6_2.318.gebefdecd0'
  ]
};
