...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : binutils (EulerOS-SA-2022-1301)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1301
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?75467e5a");
...
var pkgs = [
  "binutils-2.34-1.h23.eulerosv2r9"
];
