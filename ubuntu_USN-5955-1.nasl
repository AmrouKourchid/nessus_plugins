...
USN-5955-1 advisory.
    ...
    It was discovered that Emacs did not properly manage certain files when using htmlfontify functionality. A
    local attacker could possibly use this issue to cause a denial of service, or possibly execute arbitrary
    commands.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'emacs24', 'pkgver': '24.5+1-6ubuntu1.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-bin-common', 'pkgver': '24.5+1-6ubuntu1.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-common', 'pkgver': '24.5+1-6ubuntu1.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-el', 'pkgver': '24.5+1-6ubuntu1.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-lucid', 'pkgver': '24.5+1-6ubuntu1.1+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'emacs24-nox', 'pkgver': '24.5+1-6ubuntu1.1+esm2', 'ubuntu_pro': TRUE}
];
