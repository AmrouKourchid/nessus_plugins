...
# extracted from Fedora Security Advisory FEDORA-2022-7d2f942be2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-7d2f942be2");

  script_name(english:"Fedora 37 : w3m (2022-7d2f942be2)");
...
FEDORA-2022-7d2f942be2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-7d2f942be2");
...
var pkgs = [
    {'reference':'w3m-0.5.3-58.git20220429.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
