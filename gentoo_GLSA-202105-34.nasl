...
# extracted from Gentoo Linux Security Advisory GLSA 202105-34.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-34");

  script_name(english:"GLSA-202105-34 : Bash: Privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-34
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-34"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"app-shells/bash", unaffected:make_list("ge 5.0_p11-r1"), vulnerable:make_list("lt 5.0_p11-r1"))) flag++;
