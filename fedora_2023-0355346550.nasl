...
# extracted from Fedora Security Advisory FEDORA-2023-0355346550
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0355346550");

  script_name(english:"Fedora 40 : doctl (2023-0355346550)");
...
FEDORA-2023-0355346550 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0355346550");
...
var pkgs = [
    {'reference':'doctl-1.102.0-3.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
