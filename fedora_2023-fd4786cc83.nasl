...
# extracted from Fedora Security Advisory FEDORA-2023-fd4786cc83
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-fd4786cc83");

  script_name(english:"Fedora 37 : chromium (2023-fd4786cc83)");
...
FEDORA-2023-fd4786cc83 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-fd4786cc83");
...
var pkgs = [
    {'reference':'chromium-109.0.5414.119-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
