...
if (description)
{
  ...
  script_name(english:"RHEL 6 : node.js (RHSA-2015:1546)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2015/rhsa-2015_1546.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a4d075ee");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1546");
...
"Update the RHEL node.js package based on the guidance in RHSA-2015:1546.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-origin-node-proxy-1.16.4.2-1.el6op', 'release':'6', 'el_string':'el6op', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
