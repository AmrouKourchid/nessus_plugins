...
# AlmaLinux Security Advisory ALSA-2024:4620.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:4620");

  script_name(english:"AlmaLinux 8 : libndp (ALSA-2024:4620)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-4620.html");
...
"Update the affected libndp package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:libndp");
...
var pkgs = [
    {'reference':'libndp-1.7-7.el8_10.alma.1', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
