...
# extracted from Fedora Security Advisory FEDORA-2024-8a9a692906
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8a9a692906");

  script_name(english:"Fedora 40 : valkey (2024-8a9a692906)");
...
FEDORA-2024-8a9a692906 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8a9a692906");
...
var pkgs = [
    {'reference':'valkey-8.0.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
