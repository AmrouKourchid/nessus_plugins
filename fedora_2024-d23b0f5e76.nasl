...
# extracted from Fedora Security Advisory FEDORA-2024-d23b0f5e76
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-d23b0f5e76");

  script_name(english:"Fedora 38 : ImageMagick (2024-d23b0f5e76)");
...
FEDORA-2024-d23b0f5e76 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d23b0f5e76");
...
var pkgs = [
    {'reference':'ImageMagick-7.1.1.26-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
