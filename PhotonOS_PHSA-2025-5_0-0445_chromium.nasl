...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Chromium PHSA-2025-5.0-0445");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'chromium-131.0.6778.268-1.ph5')) flag++;
