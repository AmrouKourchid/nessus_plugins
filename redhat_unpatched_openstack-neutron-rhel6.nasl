...
# extracted from Red Hat Security Advisory openstack-neutron. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2015-8914", "CVE-2016-5362", "CVE-2016-5363");

  script_name(english:"RHEL 6 : openstack-neutron (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2015-8914");
