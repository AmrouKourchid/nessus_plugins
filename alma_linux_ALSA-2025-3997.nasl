...
# AlmaLinux Security Advisory ALSA-2025:3997.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2025:3997");
  script_xref(name:"RHSA", value:"2025:3997");

  script_name(english:"AlmaLinux 8 : mod_auth_openidc:2.3 (ALSA-2025:3997)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2025:3997 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2025-3997.html");
...
var appstreams = {
    'mod_auth_openidc:2.3': [
      ...
      {'reference':'mod_auth_openidc-2.4.9.4-7.module_el8.10.0+3978+e883c40d', 'cpu':'aarch64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
      {'reference':'mod_auth_openidc-2.4.9.4-7.module_el8.10.0+3978+e883c40d', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
      {'reference':'mod_auth_openidc-2.4.9.4-7.module_el8.10.0+3978+e883c40d', 'cpu':'s390x', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
      {'reference':'mod_auth_openidc-2.4.9.4-7.module_el8.10.0+3978+e883c40d', 'cpu':'x86_64', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
    ]
};
