...
# extracted from Gentoo Linux Security Advisory GLSA 201806-01.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201806-01");

  script_name(english:"GLSA-201806-01 : GNU Wget: Cookie injection");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201806-01
(GNU Wget: Cookie injection)

    A vulnerability was discovered in GNU Wget&rsquo;s resp_new function which
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201806-01");
...
if (qpkg_check(package:"net-misc/wget", unaffected:make_list("ge 1.19.5"), vulnerable:make_list("lt 1.19.5"))) flag++;
