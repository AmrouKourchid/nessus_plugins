...
# extracted from Oracle Linux Security Advisory ELSA-2023-12989.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : microcode_ctl (ELSA-2023-12989)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-12989.html");
...
var pkgs = [
    {'reference':'microcode_ctl-2.1-73.19.0.3.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
