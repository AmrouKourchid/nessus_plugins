...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.15.0-1082-raspi2");
...
var kernel_mappings = {
  '16.04': {
    '4.15.0': {
      'generic': '4.15.0-140',
      'generic-lpae': '4.15.0-140',
      'lowlatency': '4.15.0-140',
      'oracle': '4.15.0-1068',
      'gcp': '4.15.0-1096',
      'aws': '4.15.0-1097',
      'azure': '4.15.0-1111'
  ...
  '18.04': {
    '4.15.0': {
      ...
      'generic-lpae': '4.15.0-140',
      'lowlatency': '4.15.0-140',
      'dell300x': '4.15.0-1015',
      'oracle': '4.15.0-1068',
      'raspi2': '4.15.0-1082',
      'kvm': '4.15.0-1088',
      'gcp': '4.15.0-1096',
      'aws': '4.15.0-1097',
      'snapdragon': '4.15.0-1099',
      'azure': '4.15.0-1111'
    }
  }
};
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-4890-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2020-27170', 'CVE-2020-27171');
