...
# extracted from Fedora Security Advisory FEDORA-2024-87bb7ffab1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-87bb7ffab1");

  script_name(english:"Fedora 39 : chromium (2024-87bb7ffab1)");
...
FEDORA-2024-87bb7ffab1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-87bb7ffab1");
...
var pkgs = [
    {'reference':'chromium-125.0.6422.76-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
