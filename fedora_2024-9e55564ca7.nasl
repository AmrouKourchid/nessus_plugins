...
# extracted from Fedora Security Advisory FEDORA-2024-9e55564ca7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9e55564ca7");

  script_name(english:"Fedora 41 : python-gcsfs (2024-9e55564ca7)");
...
FEDORA-2024-9e55564ca7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9e55564ca7");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-gcsfs package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-gcsfs");
...
var pkgs = [
    {'reference':'python-gcsfs-2024.9.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-gcsfs');
}
