...
# extracted from Red Hat Security Advisory RHSA-2018:1646. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:1646");

  script_name(english:"RHEL 7 : qemu-kvm-rhev (RHSA-2018:1646)");
...
referenced in the RHSA-2018:1646 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1646.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3e20e962");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1646");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL qemu-kvm-rhev package based on the guidance in RHSA-2018:1646.");
