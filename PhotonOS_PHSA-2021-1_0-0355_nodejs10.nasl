...
# extracted from VMware Security Advisory PHSA-2021-1.0-0355. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-8265");
  script_xref(name:"IAVB", value:"2021-B-0004-S");

  script_name(english:"Photon OS 1.0: Nodejs10 PHSA-2021-1.0-0355");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the nodejs10 package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-355.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'nodejs10-10.22.1-2.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'nodejs10-devel-10.22.1-2.ph1')) flag++;
