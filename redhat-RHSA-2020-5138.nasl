...
# extracted from Red Hat Security Advisory RHSA-2020:5138. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5138");
  script_xref(name:"IAVA", value:"2020-A-0531-S");

  script_name(english:"RHEL 8 : firefox (RHSA-2020:5138)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5138.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f3509878");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5138");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1896306");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL firefox package based on the guidance in RHSA-2020:5138.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'firefox-78.4.1-1.el8_0', 'sp':'0', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'firefox-78.4.1-1.el8_0', 'sp':'0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
