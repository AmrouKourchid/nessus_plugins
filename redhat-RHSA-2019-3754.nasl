...
# extracted from Red Hat Security Advisory RHSA-2019:3754. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:3754");

  script_name(english:"RHEL 6 : sudo (RHSA-2019:3754)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for sudo.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 6 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2019:3754 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_3754.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?90e8b43a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:3754");
...
"Update the RHEL sudo package based on the guidance in RHSA-2019:3754.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.8.6p3-15.el6_6.2', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.6p3-15.el6_6.2', 'sp':'6', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.6p3-15.el6_6.2', 'sp':'6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
