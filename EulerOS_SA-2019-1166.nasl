...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : glibc (EulerOS-SA-2019-1166)");
...
following vulnerability :
  ...
  - stdlib/canonicalize.c in the GNU C Library (aka glibc
    ...
    execution.i1/4^CVE-2018-11236i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1166
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a6dc2ac");
...
pkgs = ["glibc-2.17-196.h25",
        "glibc-common-2.17-196.h25",
        "glibc-devel-2.17-196.h25",
        "glibc-headers-2.17-196.h25",
        "nscd-2.17-196.h25"];
