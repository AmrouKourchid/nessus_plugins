...
"The remote Debian 11 host has a package installed that is affected by a vulnerability as referenced in the dla-3695
advisory.
...
var pkgs = [
    {'release': '11.0', 'prefix': 'ansible', 'reference': '2.10.7+merged+base+2.10.17+dfsg-0+deb11u3'}
];
