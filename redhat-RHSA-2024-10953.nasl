...
# extracted from Red Hat Security Advisory RHSA-2024:10953. The text
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_10953.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4baf5a6");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:10953");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python36:3.6 package based on the guidance in RHSA-2024:10953.");
  ...
  'python36:3.6': [
    {
      ...
      'pkgs': [
        {'reference':'python-nose-docs-1.3.7-31.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-pymongo-doc-3.7.0-1.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-sqlalchemy-doc-1.3.2-3.module+el8.10.0+20981+3704b446', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-virtualenv-doc-15.1.0-23.module+el8.10.0+22619+61b70790', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-bson-3.7.0-1.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-distro-1.4.0-2.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-docs-3.6.7-2.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-docutils-0.14-12.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-nose-1.3.7-31.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-pygments-2.2.0-22.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-pymongo-3.7.0-1.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-pymongo-gridfs-3.7.0-1.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-PyMySQL-0.10.1-2.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-scipy-1.0.0-21.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-sqlalchemy-1.3.2-3.module+el8.10.0+20981+3704b446', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-virtualenv-15.1.0-23.module+el8.10.0+22619+61b70790', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python3-wheel-0.31.1-3.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'python3-wheel-wheel-0.31.1-3.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'python36-3.6.8-39.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python36-debug-3.6.8-39.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python36-devel-3.6.8-39.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python36-rpm-macros-3.6.8-39.module+el8.10.0+20784+edafcd43', 'release':'8', 'el_string':'el8.10.0', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
