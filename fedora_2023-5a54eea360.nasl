...
# extracted from Fedora Security Advisory FEDORA-2023-5a54eea360
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-48340", "CVE-2023-26253");
  script_xref(name:"FEDORA", value:"2023-5a54eea360");

  script_name(english:"Fedora 37 : glusterfs (2023-5a54eea360)");
...
FEDORA-2023-5a54eea360 advisory.

    GlusterFS 10.4 GA
    Security fix for CVE-2023-26253, CVE-2022-48340
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5a54eea360");
...
var pkgs = [
    {'reference':'glusterfs-10.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
