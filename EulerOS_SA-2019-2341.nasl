...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.3.0 : unbound (EulerOS-SA-2019-2341)");
...
affected by the following vulnerability :
  ...
  - A flaw was found in the way unbound validated
    wildcard-synthesized NSEC records. An improperly
    validated wildcard NSEC record could be used to prove
    the non-existence (NXDOMAIN answer) of an existing
    wildcard record, or trick unbound into accepting a
    NODATA proof.(CVE-2017-15105)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2341
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4b2420a");
...
pkgs = ["unbound-libs-1.7.3-9.h1.eulerosv2r8"];
