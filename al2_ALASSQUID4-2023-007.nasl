...
# extracted from Amazon Linux 2 Security Advisory ALASSQUID4-2023-007.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : squid (ALASSQUID4-2023-007)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of squid installed on the remote host is prior to 4.10-3. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS2SQUID4-2023-007 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASSQUID4-2023-007.html");
...
var pkgs = [
    {'reference':'squid-4.10-3.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'squid4'},
    {'reference':'squid-4.10-3.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'squid4'},
    {'reference':'squid-debuginfo-4.10-3.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'squid4'},
    {'reference':'squid-debuginfo-4.10-3.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'squid4'}
];
