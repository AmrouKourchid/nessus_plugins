...
# extracted from Red Hat Security Advisory RHSA-2023:6120. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6120");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"RHEL 9 : nginx:1.22 (RHSA-2023:6120)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for nginx:1.22.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6120.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71b563f6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6120");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nginx:1.22 package based on the guidance in RHSA-2023:6120.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:nginx-core");
  ...
  'nginx:1.22': [
    {
      ...
      'pkgs': [
        {'reference':'nginx-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-all-modules-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-core-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-filesystem-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-devel-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-image-filter-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-perl-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-xslt-filter-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-mail-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-stream-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'nginx-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-all-modules-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-core-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-filesystem-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-devel-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-image-filter-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-perl-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-xslt-filter-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-mail-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-stream-1.22.1-3.module+el9.2.0.z+20353+5a828d50.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
