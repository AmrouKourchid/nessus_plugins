...
# extracted from Fedora Security Advisory FEDORA-2023-5effef25a3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5effef25a3");

  script_name(english:"Fedora 39 : caddy (2023-5effef25a3)");
...
FEDORA-2023-5effef25a3 advisory.

    Automatic update for caddy-2.7.4-1.fc39.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5effef25a3");
...
var pkgs = [
    {'reference':'caddy-2.7.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
