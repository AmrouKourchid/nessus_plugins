...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-700.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-45288", "CVE-2024-24786", "CVE-2024-28180");
  script_xref(name:"IAVB", value:"2024-B-0032-S");

  script_name(english:"Amazon Linux 2023 : nerdctl (ALAS2023-2024-700)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2023 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"It is, therefore, affected by multiple vulnerabilities as referenced in the ALAS2023-2024-700 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-700.html");
...
var pkgs = [
    {'reference':'nerdctl-1.7.6-1.amzn2023.0.1', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nerdctl-1.7.6-1.amzn2023.0.1', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
