...
# extracted from Fedora Security Advisory FEDORA-2018-fac5420dd1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : obs-build / osc (2018-fac5420dd1)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-fac5420dd1");
  script_set_attribute(attribute:"solution", value:
"Update the affected obs-build and / or osc packages.");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"obs-build-20180816-291.1.1.fc27")) flag++;
if (rpm_check(release:"FC27", reference:"osc-0.163.0-237.1.1.fc27")) flag++;
