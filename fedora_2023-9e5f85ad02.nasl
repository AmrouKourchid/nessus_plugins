...
# extracted from Fedora Security Advisory FEDORA-2023-9e5f85ad02
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-9e5f85ad02");

  script_name(english:"Fedora 38 : dokuwiki (2023-9e5f85ad02)");
...
FEDORA-2023-9e5f85ad02 advisory.

    Update to hotfix release 2023-04-04a (fixes an XSS vulnerability).
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-9e5f85ad02");
...
var pkgs = [
    {'reference':'dokuwiki-20230404a-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
