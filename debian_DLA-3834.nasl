...
# extracted from Debian Security Advisory dla-3834. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3834 : libnetty-java - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3834
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-29025");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libnetty-java', 'reference': '1:4.1.33-1+deb10u5'}
];
