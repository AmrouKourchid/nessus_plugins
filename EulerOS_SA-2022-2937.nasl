...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : mariadb-connector-c (EulerOS-SA-2022-2937)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the mariadb-connector-c package installed, the EulerOS Virtualization installation on the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2937
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c0dbd32f");
  script_set_attribute(attribute:"solution", value:
"Update the affected mariadb-connector-c packages.");
...
var pkgs = [
  "mariadb-connector-c-3.0.6-7.h5.eulerosv2r10"
];
