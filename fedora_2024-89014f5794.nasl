...
# extracted from Fedora Security Advisory FEDORA-2024-89014f5794
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-89014f5794");

  script_name(english:"Fedora 41 : python-virtualenv (2024-89014f5794)");
...
FEDORA-2024-89014f5794 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-89014f5794");
...
var pkgs = [
    {'reference':'python-virtualenv-20.21.1-25.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
