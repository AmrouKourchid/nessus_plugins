...
if (description)
{
  ...
  script_cve_id("CVE-2022-49294");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49294");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amd/display: Check if modulo is 0
    before dividing. [How & Why] If a value of 0 is read, then this will cause a divide-by-0 panic.
    (CVE-2022-49294)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49294");
