...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : mesa (EulerOS-SA-2021-1542)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1542
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?46a6e23d");
...
pkgs = ["mesa-dri-drivers-18.2.2-1.h1.eulerosv2r8",
