...
# extracted from Ubuntu Security Notice USN-5546-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5546-2");

  script_name(english:"Ubuntu 16.04 ESM : OpenJDK 8 vulnerabilities (USN-5546-2)");
...
the USN-5546-2 advisory.

    USN-5546-1 fixed vulnerabilities in OpenJDK. This update provides the corresponding updates for Ubuntu
    16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5546-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'openjdk-8-demo', 'pkgver': '8u342-b07-0ubuntu1~16.04', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk', 'pkgver': '8u342-b07-0ubuntu1~16.04', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk-headless', 'pkgver': '8u342-b07-0ubuntu1~16.04', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre', 'pkgver': '8u342-b07-0ubuntu1~16.04', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-headless', 'pkgver': '8u342-b07-0ubuntu1~16.04', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-jamvm', 'pkgver': '8u342-b07-0ubuntu1~16.04', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-zero', 'pkgver': '8u342-b07-0ubuntu1~16.04', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'openjdk-8-source', 'pkgver': '8u342-b07-0ubuntu1~16.04', 'ubuntu_pro': TRUE}
];
