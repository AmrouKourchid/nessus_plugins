...
# AlmaLinux Security Advisory ALSA-2024:1075.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:1075");

  script_name(english:"AlmaLinux 9 : edk2 (ALSA-2024:1075)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 9 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2024:1075 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-1075.html");
...
var pkgs = [
    {'reference':'edk2-aarch64-20230524-4.el9_3.2.alma', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'edk2-ovmf-20230524-4.el9_3.2.alma', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'edk2-tools-20230524-4.el9_3.2.alma', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'edk2-tools-20230524-4.el9_3.2.alma', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'edk2-tools-doc-20230524-4.el9_3.2.alma', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
