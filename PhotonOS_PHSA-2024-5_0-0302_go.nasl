...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Go PHSA-2024-5.0-0302");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'go-1.21.11-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'go-md2man-2.0.2-10.ph5')) flag++;
