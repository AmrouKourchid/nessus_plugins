...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM : snapd vulnerabilities (USN-5292-3)");
...
the USN-5292-3 advisory.
    ...
    USN-5292-1 fixed several vulnerabilities in snapd. This update provides the corresponding update for
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'golang-github-snapcore-snapd-dev', 'pkgver': '2.54.3+16.04~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'golang-github-ubuntu-core-snappy-dev', 'pkgver': '2.54.3+16.04~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'snap-confine', 'pkgver': '2.54.3+16.04~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'snapd', 'pkgver': '2.54.3+16.04~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'snapd-xdg-open', 'pkgver': '2.54.3+16.04~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ubuntu-core-launcher', 'pkgver': '2.54.3+16.04~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ubuntu-core-snapd-units', 'pkgver': '2.54.3+16.04~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ubuntu-snappy', 'pkgver': '2.54.3+16.04~esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'ubuntu-snappy-cli', 'pkgver': '2.54.3+16.04~esm2', 'ubuntu_pro': TRUE}
];
