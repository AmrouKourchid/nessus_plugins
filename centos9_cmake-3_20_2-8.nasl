...
if (description)
{
  ...
  script_name(english:"CentOS 9 : cmake-3.20.2-8.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for cmake.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
cmake-3.20.2-8.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=29910");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream cmake package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:cmake");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:cmake-data");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:cmake-doc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:cmake-filesystem");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:cmake-gui");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:cmake-rpm-macros");
...
var pkgs = [
    {'reference':'cmake-3.20.2-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cmake-data-3.20.2-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cmake-doc-3.20.2-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cmake-filesystem-3.20.2-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cmake-gui-3.20.2-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'cmake-rpm-macros-3.20.2-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cmake / cmake-data / cmake-doc / cmake-filesystem / cmake-gui / etc');
}
