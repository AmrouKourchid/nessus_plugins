...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : Erlang vulnerability (USN-6059-1)");
...
in the USN-6059-1 advisory.

    It was discovered that Erlang did not properly implement TLS client certificate validation during the TLS
    handshake. A remote attacker could use this issue to bypass client authentication.
