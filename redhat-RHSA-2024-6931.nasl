...
# extracted from Red Hat Security Advisory RHSA-2024:6931. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-45235");
  script_xref(name:"RHSA", value:"2024:6931");

  script_name(english:"RHEL 9 : edk2 (RHSA-2024:6931)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_6931.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d3bf665");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:6931");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL edk2 package based on the guidance in RHSA-2024:6931.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'edk2-aarch64-20220126gitbb1bba3d77-3.el9_0.5', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'edk2-ovmf-20220126gitbb1bba3d77-3.el9_0.5', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
