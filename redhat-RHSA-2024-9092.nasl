...
# extracted from Red Hat Security Advisory RHSA-2024:9092. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9092");

  script_name(english:"RHEL 9 : freerdp (RHSA-2024:9092)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for freerdp.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2024:9092 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-33988");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9092.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?41534556");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9092");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL freerdp package based on the guidance in RHSA-2024:9092.");
  ...
  script_cwe_id(125, 190, 191, 476, 770, 787);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'freerdp-2.11.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'freerdp-devel-2.11.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'freerdp-libs-2.11.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'libwinpr-2.11.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'libwinpr-devel-2.11.7-1.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
