...
# extracted from Ubuntu Security Notice USN-4493-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4493-1");

  script_name(english:"Ubuntu 20.04 LTS : cryptsetup vulnerability (USN-4493-1)");
...
USN-4493-1 advisory.
    ...
    It was discovered that cryptsetup incorrectly handled certain inputs. An attacker could possibly use this
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4493-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:cryptsetup-udeb");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:libcryptsetup12-udeb");
...
var pkgs = [
    {'osver': '20.04', 'pkgname': 'cryptsetup', 'pkgver': '2:2.2.2-3ubuntu2.2'},
    {'osver': '20.04', 'pkgname': 'cryptsetup-bin', 'pkgver': '2:2.2.2-3ubuntu2.2'},
    {'osver': '20.04', 'pkgname': 'cryptsetup-initramfs', 'pkgver': '2:2.2.2-3ubuntu2.2'},
    {'osver': '20.04', 'pkgname': 'cryptsetup-run', 'pkgver': '2:2.2.2-3ubuntu2.2'},
    {'osver': '20.04', 'pkgname': 'cryptsetup-udeb', 'pkgver': '2:2.2.2-3ubuntu2.2'},
    {'osver': '20.04', 'pkgname': 'libcryptsetup-dev', 'pkgver': '2:2.2.2-3ubuntu2.2'},
    {'osver': '20.04', 'pkgname': 'libcryptsetup12', 'pkgver': '2:2.2.2-3ubuntu2.2'},
    {'osver': '20.04', 'pkgname': 'libcryptsetup12-udeb', 'pkgver': '2:2.2.2-3ubuntu2.2'}
];
