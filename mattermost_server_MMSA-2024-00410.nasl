...
if (description)
{
  ...
  script_cve_id("CVE-2025-24839");
  script_xref(name:"IAVA", value:"2025-A-0289");

  script_name(english:"Mattermost Server 9.11.x < 9.11.10 / 10.4.x < 10.4.4 / 10.5.x < 10.5.2 / 10.6.0 (MMSA-2024-00410)");
...
therefore, affected by a vulnerability as referenced in the MMSA-2024-00410 advisory.

  - Mattermost versions 10.5.x <= 10.5.1, 10.4.x <= 10.4.3, 9.11.x <= 9.11.9 fail to prevent Wrangler posts
    from triggering AI responses. This vulnerability allows users without access to the AI bot to activate it
    by attaching the activate_ai override property to a post via the Wrangler plugin, provided both the AI and
    Wrangler plugins are enabled. (CVE-2025-24839)
...
"Upgrade to Mattermost Server version 9.11.10 / 10.4.4 / 10.5.2 / 10.6.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-24839");
