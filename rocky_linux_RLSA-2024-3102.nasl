...
# Rocky Linux Security Advisory RLSA-2024:3102.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:3102");

  script_name(english:"Rocky Linux 8 : python-jinja2 (RLSA-2024:3102)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:3102");
