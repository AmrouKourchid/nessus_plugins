...
# extracted from Fedora Security Advisory FEDORA-2024-f69ecb0511
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f69ecb0511");

  script_name(english:"Fedora 40 : gnutls (2024-f69ecb0511)");
...
FEDORA-2024-f69ecb0511 advisory.

    Rebase gnutls to version 3.8.5
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f69ecb0511");
...
var pkgs = [
    {'reference':'gnutls-3.8.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
