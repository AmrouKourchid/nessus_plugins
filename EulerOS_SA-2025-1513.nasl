...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : git (EulerOS-SA-2025-1513)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1513
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d71a06e7");
...
var pkgs = [
  "git-2.27.0-2.h15.r4.eulerosv2r10",
  "git-help-2.27.0-2.h15.r4.eulerosv2r10"
];
