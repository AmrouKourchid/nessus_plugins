...
# extracted from Fedora Security Advisory FEDORA-2023-f3c4404efd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f3c4404efd");

  script_name(english:"Fedora 38 : CuraEngine (2023-f3c4404efd)");
...
FEDORA-2023-f3c4404efd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f3c4404efd");
...
var pkgs = [
    {'reference':'CuraEngine-5.3.0-5.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
