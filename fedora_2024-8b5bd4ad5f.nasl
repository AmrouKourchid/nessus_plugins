...
# extracted from Fedora Security Advisory FEDORA-2024-8b5bd4ad5f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-8b5bd4ad5f");

  script_name(english:"Fedora 40 : firefox (2024-8b5bd4ad5f)");
...
FEDORA-2024-8b5bd4ad5f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8b5bd4ad5f");
...
var pkgs = [
    {'reference':'firefox-124.0.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
