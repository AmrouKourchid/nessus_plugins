...
# openSUSE Security Update openSUSE-SU-2023:0069-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2022-37704", "CVE-2022-37705");

  script_name(english:"openSUSE 15 Security Update : amanda (openSUSE-SU-2023:0069-1)");
...
openSUSE-SU-2023:0069-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1208032");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1208033");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/45FBXK7GXP7SESEIZZ6JOEP7VN2T37AM/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb49c223");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2022-37704");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2022-37705");
  script_set_attribute(attribute:"solution", value:
"Update the affected amanda package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:amanda");
...
var pkgs = [
    {'reference':'amanda-3.5.1-bp154.3.3.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'amanda');
}
