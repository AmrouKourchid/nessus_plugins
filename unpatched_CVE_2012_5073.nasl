...
if (description)
{
  ...
  script_cve_id("CVE-2012-5073");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2012-5073");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment (JRE) component in Oracle Java SE 7 Update 7 and
    ...
    attackers to affect integrity via unknown vectors related to Libraries, a different vulnerability than
    CVE-2012-5079. (CVE-2012-5073)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-5073");
