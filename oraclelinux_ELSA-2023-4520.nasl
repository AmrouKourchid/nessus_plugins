...
# extracted from Oracle Linux Security Advisory ELSA-2023-4520.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : python-requests (ELSA-2023-4520)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-4520.html");
...
var pkgs = [
    {'reference':'python3-requests-2.20.0-3.el8_8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
