...
# extracted from Ubuntu Security Notice USN-4058-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Bash vulnerability (USN-4058-1)");
...
USN-4058-1 advisory.
    ...
    It was discovered that Bash incorrectly handled the restricted shell. An attacker could possibly use this
    issue to escape restrictions and execute any command.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4058-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'bash', 'pkgver': '4.3-14ubuntu1.4'},
    {'osver': '16.04', 'pkgname': 'bash-builtins', 'pkgver': '4.3-14ubuntu1.4'},
    {'osver': '16.04', 'pkgname': 'bash-static', 'pkgver': '4.3-14ubuntu1.4'}
];
