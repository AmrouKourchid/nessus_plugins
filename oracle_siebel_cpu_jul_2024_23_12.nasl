...
if (description)
{
  ...
  script_name(english:"Oracle Siebel Server <= 23.12 (July 2024 CPU)");
...
2024 CPU advisory.
  ...
  - Vulnerability in the Siebel CRM Integration product of Oracle Siebel CRM (component: EAI (JSON-java)).
    Supported versions that are affected are 23.12 and prior. Easily exploitable vulnerability allows
    unauthenticated attacker with network access via HTTP to compromise Siebel CRM Integration. Successful
    attacks of this vulnerability can result in unauthorized ability to cause a hang or frequently repeatable
    crash (complete DOS) of Siebel CRM Integration. (CVE-2023-5072)
...
var constraints = [
  { 'max_version' : '23.12.999', 'fixed_version' : '24.7' }
];
