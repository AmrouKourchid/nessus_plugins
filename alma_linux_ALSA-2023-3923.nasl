...
# AlmaLinux Security Advisory ALSA-2023:3923.
##
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-3923.html");
...
var pkgs = [
    ...
    {'reference':'golang-race-1.19.10-1.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
