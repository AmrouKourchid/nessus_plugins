...
# extracted from Red Hat Security Advisory RHSA-2022:8420. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8420");

  script_name(english:"RHEL 9 : mingw-zlib (RHSA-2022:8420)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8420.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ed2a7ee8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2067945");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8420");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL mingw-zlib package based on the guidance in RHSA-2022:8420.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mingw32-zlib-1.2.12-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-zlib-static-1.2.12-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-zlib-1.2.12-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-zlib-static-1.2.12-2.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
