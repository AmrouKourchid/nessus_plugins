...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2023-A-0143-S");

  script_name(english:"Adobe Photoshop 23.x < 23.5.4 / 24.x < 24.2.1 Vulnerability (macOS APSB23-23)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote macOS or Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop installed on the remote macOS or Mac OS X host is prior to 23.5.4/24.2.1. It is,
therefore, affected by a vulnerability as referenced in the apsb23-23 advisory.
