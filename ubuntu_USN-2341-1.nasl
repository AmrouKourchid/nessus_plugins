...
# extracted from Ubuntu Security Notice USN-2341-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(68842, 68846, 68847);
  script_xref(name:"USN", value:"2341-1");

  script_name(english:"Ubuntu 14.04 LTS : CUPS vulnerabilities (USN-2341-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 14.04 LTS host has packages installed that are affected by multiple vulnerabilities as referenced in
the USN-2341-1 advisory.

    Salvatore Bonaccorso discovered that the CUPS web interface incorrectly validated permissions and
    incorrectly handled symlinks. An attacker could possibly use this issue to bypass file permissions and
    read arbitrary files, possibly leading to a privilege escalation.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2341-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'cups', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'cups-bsd', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'cups-client', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'cups-common', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'cups-core-drivers', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'cups-daemon', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'cups-ppdc', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'cups-server-common', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'libcups2', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'libcups2-dev', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'libcupscgi1', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'libcupscgi1-dev', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'libcupsimage2', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'libcupsimage2-dev', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'libcupsmime1', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'libcupsmime1-dev', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'libcupsppdc1', 'pkgver': '1.7.2-0ubuntu1.2'},
    {'osver': '14.04', 'pkgname': 'libcupsppdc1-dev', 'pkgver': '1.7.2-0ubuntu1.2'}
];
