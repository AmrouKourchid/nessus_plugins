...
# extracted from Red Hat Security Advisory libxrender. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2013-1987", "CVE-2016-7949", "CVE-2016-7950");

  script_name(english:"RHEL 5 : libxrender (Unpatched Vulnerability) (deprecated)");
