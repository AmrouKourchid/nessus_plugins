...
dsa-4948 advisory.
    ...
    A buffer overflow was discovered in the Aspell spell checker, which could result in the execution of
    arbitrary code. For the stable distribution (buster), these problems have been fixed in version
    0.60.7~20110707-6+deb10u1. We recommend that you upgrade your aspell packages. For the detailed security
    status of aspell please refer to its security tracker page at: https://security-
    tracker.debian.org/tracker/aspell
