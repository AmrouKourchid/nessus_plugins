...
# extracted from Fedora Security Advisory FEDORA-2023-8d0913f986
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-8d0913f986");

  script_name(english:"Fedora 37 : gdb (2023-8d0913f986)");
...
FEDORA-2023-8d0913f986 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-8d0913f986");
...
var pkgs = [
    {'reference':'gdb-13.2-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
