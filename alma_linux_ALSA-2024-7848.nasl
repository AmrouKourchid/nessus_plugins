...
# AlmaLinux Security Advisory ALSA-2024:7848.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:7848");

  script_name(english:"AlmaLinux 8 : openssl (ALSA-2024:7848)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2024:7848 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2024-7848.html");
...
var pkgs = [
    {'reference':'openssl-1.1.1k-14.el8_6', 'release':'8', 'el_string':'el8_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-devel-1.1.1k-14.el8_6', 'release':'8', 'el_string':'el8_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-libs-1.1.1k-14.el8_6', 'release':'8', 'el_string':'el8_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-perl-1.1.1k-14.el8_6', 'release':'8', 'el_string':'el8_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
