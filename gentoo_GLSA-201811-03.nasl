...
# extracted from Gentoo Linux Security Advisory GLSA 201811-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201811-03");

  script_name(english:"GLSA-201811-03 : OpenSSL: Denial of service");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201811-03
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201811-03");
...
if (qpkg_check(package:"dev-libs/openssl", unaffected:make_list("ge 1.0.2o-r6"), vulnerable:make_list("lt 1.0.2o-r6"))) flag++;
