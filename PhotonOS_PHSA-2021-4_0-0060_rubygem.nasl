...
if (description)
{
  ...
  script_cve_id("CVE-2019-3881", "CVE-2020-36327");

  script_name(english:"Photon OS 4.0: Rubygem PHSA-2021-4.0-0060");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'rubygem-bundler-2.2.21-1.ph4')) flag++;
