...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 19.x < 19.1.8 / CC 20.x < 20.0.4 Vulnerability (macOS APSB19-15)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote macOS or Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop CC installed on the remote macOS or Mac OS X host is prior to 19.1.8/20.0.4. It is,
therefore, affected by a vulnerability as referenced in the apsb19-15 advisory.

  - Adobe Photoshop CC 19.1.7 and earlier, and 20.0.2 and earlier have a heap corruption vulnerability.
    Successful exploitation could lead to arbitrary code execution. (CVE-2019-7094)
...
"Upgrade to Adobe Photoshop version 19.1.8/20.0.4 or later.");
...
var constraints = [
  { 'min_version' : '19.0.0', 'fixed_version' : '19.1.8' },
  { 'min_version' : '20.0.0', 'fixed_version' : '20.0.4' }
];
