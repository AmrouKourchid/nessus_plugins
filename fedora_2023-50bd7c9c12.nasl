...
# extracted from Fedora Security Advisory FEDORA-2023-50bd7c9c12
#
...
if (description)
{
  ...
  script_cve_id("CVE-2023-5345", "CVE-2023-42754", "CVE-2023-42756");
  script_xref(name:"FEDORA", value:"2023-50bd7c9c12");

  script_name(english:"Fedora 37 : kernel (2023-50bd7c9c12)");
...
FEDORA-2023-50bd7c9c12 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-50bd7c9c12");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2023-5345', 'CVE-2023-42754', 'CVE-2023-42756');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-50bd7c9c12');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.5.6-100.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
