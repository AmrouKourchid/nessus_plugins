...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Net PHSA-2024-4.0-0542");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'net-snmp-5.8-12.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'net-snmp-devel-5.8-12.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'net-snmp-perl-5.8-12.ph4')) flag++;
