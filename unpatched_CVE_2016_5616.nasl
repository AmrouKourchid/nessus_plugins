...
if (description)
{
  ...
  script_cve_id("CVE-2016-5616");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2016-5616 (deprecated)");
...
"Plugin has been deprecated due to the specified CVE being rejected by NVD.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-5616");
