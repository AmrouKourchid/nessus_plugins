...
# SUSE update advisory SUSE-SU-2022:3864-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3864-1");

  script_name(english:"SUSE SLES12 Security Update : hsqldb (SUSE-SU-2022:3864-1)");
...
in the SUSE-SU-2022:3864-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1204521");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2022-41853");
  # https://lists.suse.com/pipermail/sle-security-updates/2022-November/012804.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e498cb65");
  script_set_attribute(attribute:"solution", value:
"Update the affected hsqldb package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:hsqldb");
...
var pkgs = [
    {'reference':'hsqldb-2.2.9-5.3.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'hsqldb-2.2.9-5.3.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-sdk-release-12.5', 'sles-release-12.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'hsqldb');
}
