...
# extracted from openSUSE Security Update openSUSE-2021-638.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : cups (openSUSE-2021-638)");
...
"This update for cups fixes the following issues :
  ...
  - CVE-2021-25317: ownership of /var/log/cups could allow
    privilege escalation from lp user to root via symlink
    attacks (bsc#1184161)

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1184161");
...
if ( rpm_check(release:"SUSE15.2", reference:"cups-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"cups-client-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"cups-client-debuginfo-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"cups-config-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"cups-ddk-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"cups-ddk-debuginfo-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"cups-debuginfo-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"cups-debugsource-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"cups-devel-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcups2-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcups2-debuginfo-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcupscgi1-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcupscgi1-debuginfo-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcupsimage2-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcupsimage2-debuginfo-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcupsmime1-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcupsmime1-debuginfo-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcupsppdc1-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libcupsppdc1-debuginfo-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"cups-devel-32bit-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libcups2-32bit-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libcups2-32bit-debuginfo-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libcupscgi1-32bit-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libcupscgi1-32bit-debuginfo-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libcupsimage2-32bit-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libcupsimage2-32bit-debuginfo-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libcupsmime1-32bit-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libcupsmime1-32bit-debuginfo-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libcupsppdc1-32bit-2.2.7-lp152.9.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libcupsppdc1-32bit-debuginfo-2.2.7-lp152.9.9.1") ) flag++;
