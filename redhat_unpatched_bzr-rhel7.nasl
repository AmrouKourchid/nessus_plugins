...
# extracted from Red Hat Security Advisory bzr. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2013-2099", "CVE-2013-7440", "CVE-2017-14176");

  script_name(english:"RHEL 7 : bzr (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bzr");
