...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : sqlite (EulerOS-SA-2024-1536)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1536
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3396af9f");
...
var pkgs = [
  "sqlite-3.32.3-2.h8.eulerosv2r10"
];
