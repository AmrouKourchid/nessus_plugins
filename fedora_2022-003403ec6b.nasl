...
# extracted from Fedora Security Advisory FEDORA-2022-003403ec6b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-003403ec6b");

  script_name(english:"Fedora 35 : samba (2022-003403ec6b)");
...
FEDORA-2022-003403ec6b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-003403ec6b");
...
var pkgs = [
    {'reference':'samba-4.15.12-0.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
