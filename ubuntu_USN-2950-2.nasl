...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : libsoup update (USN-2950-2)");
...
in the USN-2950-2 advisory.

    USN-2950-1 fixed vulnerabilities in Samba. The updated Samba packages introduced a compatibility issue
    with NTLM authentication in libsoup. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2950-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'gir1.2-soup-2.4', 'pkgver': '2.44.2-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'libsoup-gnome2.4-1', 'pkgver': '2.44.2-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'libsoup-gnome2.4-dev', 'pkgver': '2.44.2-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'libsoup2.4-1', 'pkgver': '2.44.2-1ubuntu2.1'},
    {'osver': '14.04', 'pkgname': 'libsoup2.4-dev', 'pkgver': '2.44.2-1ubuntu2.1'},
    {'osver': '16.04', 'pkgname': 'gir1.2-soup-2.4', 'pkgver': '2.52.2-1ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'libsoup-gnome2.4-1', 'pkgver': '2.52.2-1ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'libsoup-gnome2.4-dev', 'pkgver': '2.52.2-1ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'libsoup2.4-1', 'pkgver': '2.52.2-1ubuntu0.1'},
    {'osver': '16.04', 'pkgname': 'libsoup2.4-dev', 'pkgver': '2.52.2-1ubuntu0.1'}
];
