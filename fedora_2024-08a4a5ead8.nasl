...
# extracted from Fedora Security Advisory FEDORA-2024-08a4a5ead8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-08a4a5ead8");

  script_name(english:"Fedora 38 : putty (2024-08a4a5ead8)");
...
FEDORA-2024-08a4a5ead8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-08a4a5ead8");
...
var pkgs = [
    {'reference':'putty-0.81-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
