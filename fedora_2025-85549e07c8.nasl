...
# extracted from Fedora Security Advisory FEDORA-2025-85549e07c8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-85549e07c8");

  script_name(english:"Fedora 41 : php-tcpdf (2025-85549e07c8)");
...
FEDORA-2025-85549e07c8 advisory.
    ...
    - Removed tcpdf_import.php and tcpdf_parser.php files (for a parser check the tc-lib-pdf-parser project
    instead).
    - Fix composer.json.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-85549e07c8");
...
var pkgs = [
    {'reference':'php-tcpdf-6.9.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
