...
# extracted from Red Hat Security Advisory RHSA-2024:3846. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:3846");
  script_xref(name:"IAVA", value:"2024-A-0356");

  script_name(english:"RHEL 9 : python-idna (RHSA-2024:3846)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-idna.");
...
the RHSA-2024:3846 advisory.

    The hsakmt packages include a thunk library for AMD's Heterogeneous System Architecture (HSA) Linux kernel
    driver (amdkfd).
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?93195ddc");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:3846");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-idna package based on the guidance in RHSA-2024:3846.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-idna-2.10-7.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-idna-2.10-7.el9_4.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
