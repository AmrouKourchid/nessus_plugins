...
# Oracle Linux Security Advisory ELSA-2012-1130 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : xen (ELSA-2012-1130)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2012-1130.html");
