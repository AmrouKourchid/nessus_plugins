...
# extracted from Fedora Security Advisory FEDORA-2021-dff7e97510
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-dff7e97510");

  script_name(english:"Fedora 32 : upx (2021-dff7e97510)");
...
FEDORA-2021-dff7e97510 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-dff7e97510");
...
pkgs = [
    {'reference':'upx-3.96-8.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
