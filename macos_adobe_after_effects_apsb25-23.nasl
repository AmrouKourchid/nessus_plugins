...
if (description)
{
  ...
  script_name(english:"Adobe After Effects < 24.6.5 / 25.0 < 25.2 Multiple Vulnerabilities (APSB25-23) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe After Effects instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe After Effects installed on the remote macOS host is prior to 24.6.5, 25.2. It is, therefore,
