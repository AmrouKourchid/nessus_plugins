...
if (description)
{
  ...
  script_cve_id("CVE-2025-21789");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21789");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: LoongArch: csum: Fix OoB access in IP
    checksum code for negative lengths Commit 69e3a6aa6be2 (LoongArch: Add checksum optimization for 64-bit
    system) would cause an undefined shift and an out-of-bounds read. Commit 8bd795fedb84 (arm64: csum: Fix
    OoB access in IP checksum code for negative lengths) fixes the same issue on ARM64. (CVE-2025-21789)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21789");
