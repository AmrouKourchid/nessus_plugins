...
if (description)
{
  ...
  script_cve_id("CVE-2022-36320");

  script_name(english:"Photon OS 4.0: Nss PHSA-2023-4.0-0391");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nss-3.72-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nss-devel-3.72-3.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'nss-libs-3.72-3.ph4')) flag++;
