...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2014-0131");
...
patch available.
  ...
  - Use-after-free vulnerability in the skb_segment function in net/core/skbuff.c in the Linux kernel through
    3.13.6 allows attackers to obtain sensitive information from kernel memory by leveraging the absence of a
    certain orphaning operation. (CVE-2014-0131)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0131");
