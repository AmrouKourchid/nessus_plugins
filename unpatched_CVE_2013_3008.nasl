...
if (description)
{
  ...
  script_cve_id("CVE-2013-3008");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2013-3008");
...
patch available.
  ...
  - Unspecified vulnerability in the Java Runtime Environment (JRE) in IBM Java 7 before 7 SR5 allows remote
    attackers to affect confidentiality, availability, and integrity via unknown vectors, a different
    vulnerability than CVE-2013-3006. (CVE-2013-3008)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-3008");
