...
# extracted from Fedora Security Advisory FEDORA-2024-9cce1f4b49
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9cce1f4b49");

  script_name(english:"Fedora 40 : suricata (2024-9cce1f4b49)");
...
FEDORA-2024-9cce1f4b49 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9cce1f4b49");
...
var pkgs = [
    {'reference':'suricata-7.0.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
