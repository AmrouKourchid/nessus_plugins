...
# SUSE update advisory SUSE-SU-2025:1092-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2022-48791");
  script_xref(name:"SuSE", value:"SUSE-SU-2025:1092-1");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 60 for SLE 12 SP5) (SUSE-SU-2025:1092-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?658c1dfe");
...
"Update the affected kgraft-patch-4_12_14-122_228-default package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-48791");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.228-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_228-default-6-2.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      }
    }
  }
