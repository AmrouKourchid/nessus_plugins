...
# extracted from Oracle Linux Security Advisory ELSA-2022-4795.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : rsyslog (ELSA-2022-4795)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-4795.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:rsyslog-logrotate");
...
var pkgs = [
    ...
    {'reference':'rsyslog-doc-8.2102.0-101.el9_0.1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'rsyslog-doc-8.2102.0-101.el9_0.1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
