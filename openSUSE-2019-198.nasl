...
# extracted from openSUSE Security Update openSUSE-2019-198.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : pspp / spread-sheet-widget (openSUSE-2019-198)");
...
dependency.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1120061");
  script_set_attribute(attribute:"solution", value:
"Update the affected pspp / spread-sheet-widget packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-20230");
...
if ( rpm_check(release:"SUSE15.0", reference:"libspread-sheet-widget0-0.3-lp150.2.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libspread-sheet-widget0-debuginfo-0.3-lp150.2.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pspp-1.2.0-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pspp-debuginfo-1.2.0-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pspp-debugsource-1.2.0-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"pspp-devel-1.2.0-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"spread-sheet-widget-debugsource-0.3-lp150.2.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"spread-sheet-widget-devel-0.3-lp150.2.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "pspp / pspp-debuginfo / pspp-debugsource / pspp-devel / etc");
}
