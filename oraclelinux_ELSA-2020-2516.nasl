...
# extracted from Red Hat Security Advisory RHSA-2020:2516 and 
# Oracle Linux Security Advisory ELSA-2020-2516 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : libexif (ELSA-2020-2516)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-2516.html");
