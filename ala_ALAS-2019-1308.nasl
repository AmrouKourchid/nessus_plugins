...
# extracted from Amazon Linux AMI Security Advisory ALAS-2019-1308.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1308");

  script_name(english:"Amazon Linux AMI : libarchive (ALAS-2019-1308)");
...
onwards (release v3.0.2 onwards) contains a CWE-125 Out-of-bounds Read
...
specially crafted ISO9660 file.(CVE-2019-1000020)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2019-1308.html");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"bsdcpio-3.1.2-12.12.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bsdtar-3.1.2-12.12.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libarchive-3.1.2-12.12.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libarchive-debuginfo-3.1.2-12.12.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libarchive-devel-3.1.2-12.12.amzn1")) flag++;
