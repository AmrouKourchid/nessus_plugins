...
# extracted from VMware Security Advisory PHSA-2024-5.0-0423. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Wireshark PHSA-2024-5.0-0423");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the wireshark package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-423.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'wireshark-4.2.9-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'wireshark-devel-4.2.9-1.ph5')) flag++;
