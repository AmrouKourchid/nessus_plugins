...
# extracted from Red Hat Security Advisory RHSA-2022:0237. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-29923", "CVE-2021-34558", "CVE-2021-44716");
  script_xref(name:"RHSA", value:"2022:0237");
  script_xref(name:"IAVB", value:"2021-B-0047-S");

  script_name(english:"RHEL 8 : Red Hat OpenStack Platform 16.2 (etcd) (RHSA-2022:0237)");
...
referenced in the RHSA-2022:0237 advisory.
    ...
    * net: incorrect parsing of extraneous zero characters at the beginning of an IP address octet
    (CVE-2021-29923)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0237.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7829418b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0237");
...
"Update the RHEL Red Hat OpenStack Platform 16.2 (etcd) package based on the guidance in RHSA-2022:0237.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'etcd-3.3.23-7.el8ost', 'cpu':'ppc64le', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'etcd-3.3.23-7.el8ost', 'cpu':'x86_64', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
