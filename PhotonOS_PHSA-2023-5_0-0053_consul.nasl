...
# extracted from VMware Security Advisory PHSA-2023-5.0-0053. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-0845", "CVE-2023-1297");

  script_name(english:"Photon OS 5.0: Consul PHSA-2023-5.0-0053");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the consul package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-53.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-1297");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'consul-1.14.8-1.ph5')) flag++;
