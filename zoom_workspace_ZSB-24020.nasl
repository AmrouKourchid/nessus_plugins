...
if (description)
{
  ...
  script_cve_id("CVE-2024-27241");
  script_xref(name:"IAVA", value:"2024-A-0436-S");

  script_name(english:"Zoom Workplace Desktop App < 6.0.0 Improper Input Validation (ZSB-24020)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an application installed that is affected by a mproper input validation vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Zoom Workplace Desktop App installed on the remote host is prior to 6.0.0. It is, therefore, 
affected by a improper input validation vulnerability that allow a local authenticated attacker to conduct a 
denial of service via network access.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.zoom.com/en/trust/security-bulletin/ZSB-24020/");
...
"Upgrade to Zoom Workplace Desktop App 6.0.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-27241");
