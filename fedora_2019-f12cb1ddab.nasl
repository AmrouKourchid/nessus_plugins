...
# extracted from Fedora Security Advisory FEDORA-2019-f12cb1ddab.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-f12cb1ddab");

  script_name(english:"Fedora 30 : GraphicsMagick (2019-f12cb1ddab)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"http://www.graphicsmagick.org/NEWS.html#december-24-2019");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-f12cb1ddab");
...
"Update the affected GraphicsMagick package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-15139");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"GraphicsMagick-1.3.34-1.fc30")) flag++;
