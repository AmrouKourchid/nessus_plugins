...
# extracted from Red Hat Security Advisory RHSA-2024:9572. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:9572");

  script_name(english:"RHEL 9 : libsoup (RHSA-2024:9572)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_9572.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a5fdd3c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:9572");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libsoup package based on the guidance in RHSA-2024:9572.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libsoup-2.72.0-8.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsoup-devel-2.72.0-8.el9_4.1', 'sp':'4', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
