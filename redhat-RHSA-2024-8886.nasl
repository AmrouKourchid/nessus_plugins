...
# extracted from Red Hat Security Advisory RHSA-2024:8886. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8886");

  script_name(english:"RHEL 8 : Red Hat Product OCP Tools 4.12 Openshift Jenkins (RHSA-2024:8886)");
...
referenced in the RHSA-2024:8886 advisory.
    ...
    * jenkins: Denial of service when processing a specially crafted Spring Expression Language expression
    (CVE-2024-38808)
    * jenkins-2-plugins: jenkins-plugin/script-security: sandbox bypass via crafted constructor bodies
    (CVE-2024-34144)
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8886.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4230b2e2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8886");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat Product OCP Tools 4.12 Openshift Jenkins package based on the guidance in RHSA-2024:8886.");
  ...
  script_cwe_id(209, 295, 400, 693, 1220);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.12.1730119231-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'jenkins-2.462.3.1730119132-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
