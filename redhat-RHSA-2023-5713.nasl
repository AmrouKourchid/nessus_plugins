...
# extracted from Red Hat Security Advisory RHSA-2023:5713. The text
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5713.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8d8ab66");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5713");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL nginx:1.22 package based on the guidance in RHSA-2023:5713.");
  ...
  'nginx:1.22': [
    {
      ...
      'pkgs': [
        {'reference':'nginx-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-all-modules-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-filesystem-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-devel-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-image-filter-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-perl-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-xslt-filter-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-mail-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-stream-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        {'reference':'nginx-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-all-modules-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-filesystem-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-devel-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-image-filter-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-perl-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-http-xslt-filter-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-mail-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nginx-mod-stream-1.22.1-1.module+el8.8.0+20355+6d9c8a63.1', 'sp':'8', 'release':'8', 'el_string':'el8.8.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
