...
# extracted from Fedora Security Advisory FEDORA-2023-af2e3d1c18
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-af2e3d1c18");

  script_name(english:"Fedora 37 : exercism (2023-af2e3d1c18)");
...
FEDORA-2023-af2e3d1c18 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-af2e3d1c18");
...
var pkgs = [
    {'reference':'exercism-3.2.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
