...
# Oracle Linux Security Advisory ELSA-2010-0124 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : systemtap (ELSA-2010-0124)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2010-0124.html");
