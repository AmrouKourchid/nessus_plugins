...
if (description)
{
  ...
  script_cve_id("CVE-2015-4882");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-4882");
...
patch available.
  ...
  - Unspecified vulnerability in Oracle Java SE 6u101, 7u85, and 8u60, and Java SE Embedded 8u51, allows
    remote attackers to affect availability via vectors related to CORBA. (CVE-2015-4882)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-4882");
