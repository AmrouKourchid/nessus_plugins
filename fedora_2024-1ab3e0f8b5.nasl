...
# extracted from Fedora Security Advisory FEDORA-2024-1ab3e0f8b5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1ab3e0f8b5");
  script_xref(name:"IAVA", value:"2025-A-0135");

  script_name(english:"Fedora 40 : xorg-x11-server (2024-1ab3e0f8b5)");
...
FEDORA-2024-1ab3e0f8b5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1ab3e0f8b5");
...
var pkgs = [
    {'reference':'xorg-x11-server-1.20.14-36.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
