...
# extracted from Ubuntu Security Notice USN-5227-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5227-2");

  script_name(english:"Ubuntu 16.04 ESM : Pillow vulnerabilities (USN-5227-2)");
...
the USN-5227-2 advisory.

    USN-5227-1 fixed several vulnerabilities in Pillow. This update provides the corresponding update for
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5227-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-imaging', 'pkgver': '3.1.2-0ubuntu1.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-pil', 'pkgver': '3.1.2-0ubuntu1.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-pil.imagetk', 'pkgver': '3.1.2-0ubuntu1.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-pil', 'pkgver': '3.1.2-0ubuntu1.6+esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-pil.imagetk', 'pkgver': '3.1.2-0ubuntu1.6+esm1', 'ubuntu_pro': TRUE}
];
