...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : glusterfs (EulerOS-SA-2020-2347)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2347
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9c08adf");
...
pkgs = ["glusterfs-3.7.1-16.0.1.h2",
        "glusterfs-api-3.7.1-16.0.1.h2",
        "glusterfs-client-xlators-3.7.1-16.0.1.h2",
        "glusterfs-fuse-3.7.1-16.0.1.h2",
        "glusterfs-libs-3.7.1-16.0.1.h2",
        "glusterfs-rdma-3.7.1-16.0.1.h2"];
