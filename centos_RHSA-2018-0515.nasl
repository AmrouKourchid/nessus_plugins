...
# extracted from Red Hat Security Advisory RHSA-2018:0515 and 
# CentOS Errata and Security Advisory 2018:0515 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : 389-ds-base (CESA-2018:0515)");
...
The CVE-2017-15135 issue was discovered by Martin Poole (Red Hat).");
  # https://lists.centos.org/pipermail/centos-announce/2018-March/022797.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cb3f37d5");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"389-ds-base-1.2.11.15-94.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"389-ds-base-devel-1.2.11.15-94.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"389-ds-base-libs-1.2.11.15-94.el6_9")) flag++;
