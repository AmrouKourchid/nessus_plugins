...
# extracted from Debian Security Advisory dla-3108. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3108 : pcs - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3108
advisory.

    - -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3108-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                       Valentin Vidic
    September 14, 2022                            https://wiki.debian.org/LTS
    - -------------------------------------------------------------------------
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/pcs");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-1049");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/pcs");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'pcs', 'reference': '0.10.1-2+deb10u1'},
    {'release': '10.0', 'prefix': 'pcs-snmp', 'reference': '0.10.1-2+deb10u1'}
];
