...
# extracted from Red Hat Security Advisory RHSA-2023:6371. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:6371");

  script_name(english:"RHEL 9 : cloud-init (RHSA-2023:6371)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_6371.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4737a7fc");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2179017");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2182948");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2188388");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2190079");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:6371");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cloud-init-23.1.1-11.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  }
];
