...
# extracted from Red Hat Security Advisory RHSA-2015:1681. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:1681");

  script_name(english:"RHEL 7 : openstack-swift (RHSA-2015:1681)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for openstack-swift.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2015:1681 advisory.
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2015/rhsa-2015_1681.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0749bf40");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1681");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openstack-swift package based on the guidance in RHSA-2015:1681.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-swift-2.2.0-4.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-swift-account-2.2.0-4.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-swift-container-2.2.0-4.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-swift-doc-2.2.0-4.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-swift-object-2.2.0-4.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-swift-proxy-2.2.0-4.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
