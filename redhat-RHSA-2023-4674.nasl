...
if (description)
{
  ...
  script_name(english:"RHEL 8 / 9 : OpenShift Container Platform 4.12.30 (RHSA-2023:4674)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.12.30.");
...
in the RHSA-2023:4674 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.30. See the
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?40bab0f0");
...
"Update the RHEL OpenShift Container Platform 4.12.30 packages based on the guidance in RHSA-2023:4674.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openshift-clients-4.12.0-202308151125.p0.gf61957e.assembly.stream.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-clients-redistributable-4.12.0-202308151125.p0.gf61957e.assembly.stream.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'openshift-clients-4.12.0-202308151125.p0.gf61957e.assembly.stream.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'openshift-clients-redistributable-4.12.0-202308151125.p0.gf61957e.assembly.stream.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
