...
# extracted from F5 Networks BIG-IP Solution K23153696.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2020-1927");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"F5 Networks BIG-IP : Apache HTTPD vulnerability (K23153696)");
...
part of a client-side attack on browsers.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K23153696");
  script_set_attribute(attribute:"solution", value:
"Upgrade to one of the non-vulnerable versions listed in the F5 Solution K23153696.");
