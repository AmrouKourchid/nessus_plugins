...
# extracted from Red Hat Security Advisory RHSA-2023:5840. The text
...
the RHSA-2023:5840 advisory.
    ...
    * rh-nodejs14-nodejs: HTTP/2: Multiple HTTP/2 enabled web servers are vulnerable to a DDoS attack (Rapid
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5840.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9af955d6");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5840");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL rh-nodejs14 package based on the guidance in RHSA-2023:5840.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-nodejs14-nodejs-14.21.3-5.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-14.21.3-5.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-14.21.3-5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-devel-14.21.3-5.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-devel-14.21.3-5.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-devel-14.21.3-5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-docs-14.21.3-5.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-full-i18n-14.21.3-5.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-full-i18n-14.21.3-5.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-nodejs-full-i18n-14.21.3-5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-npm-6.14.18-14.21.3.5.el7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-npm-6.14.18-14.21.3.5.el7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-nodejs14-npm-6.14.18-14.21.3.5.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
