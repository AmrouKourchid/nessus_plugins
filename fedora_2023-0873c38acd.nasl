...
# extracted from Fedora Security Advisory FEDORA-2023-0873c38acd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0873c38acd");

  script_name(english:"Fedora 37 : librsvg2 (2023-0873c38acd)");
...
FEDORA-2023-0873c38acd advisory.

    librsvg 2.54.6 release, fixing CVE-2023-38633:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0873c38acd");
...
var pkgs = [
    {'reference':'librsvg2-2.54.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
