...
if (description)
{
  ...
  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-25763");
...
patch available.
  ...
  - openNDS 10.2.0 is vulnerable to Use-After-Free via /openNDS/src/auth.c. (CVE-2024-25763)
