...
# extracted from Fedora Security Advisory FEDORA-2025-23fe8c5b7e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-23fe8c5b7e");

  script_name(english:"Fedora 41 : thunderbird (2025-23fe8c5b7e)");
...
FEDORA-2025-23fe8c5b7e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-23fe8c5b7e");
...
var pkgs = [
    {'reference':'thunderbird-128.10.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
