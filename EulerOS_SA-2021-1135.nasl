...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : binutils (EulerOS-SA-2021-1135)");
...
vulnerabilities :
  ...
  - Null Pointer Dereference in debug_get_real_type could
    result in DoS(CVE-2020-16598)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1135
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8f7bf905");
...
pkgs = ["binutils-2.31.1-13.h21.eulerosv2r8",
        "binutils-devel-2.31.1-13.h21.eulerosv2r8"];
