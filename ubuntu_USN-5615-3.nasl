...
# extracted from Ubuntu Security Notice USN-5615-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5615-3");

  script_name(english:"Ubuntu 14.04 LTS : SQLite vulnerability (USN-5615-3)");
...
USN-5615-3 advisory.
    ...
    CVE-2020-35525 for Ubuntu 14.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5615-3");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'lemon', 'pkgver': '3.8.2-1ubuntu2.2+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libsqlite3-0', 'pkgver': '3.8.2-1ubuntu2.2+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libsqlite3-dev', 'pkgver': '3.8.2-1ubuntu2.2+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libsqlite3-tcl', 'pkgver': '3.8.2-1ubuntu2.2+esm4', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'sqlite3', 'pkgver': '3.8.2-1ubuntu2.2+esm4', 'ubuntu_pro': TRUE}
];
