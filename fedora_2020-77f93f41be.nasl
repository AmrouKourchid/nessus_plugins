...
# extracted from Fedora Security Advisory FEDORA-2020-77f93f41be.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : libslirp (2020-77f93f41be)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Fix CVE-2020-29129 CVE-2020-29130 out-of-bounds access while
processing ARP/NCSI packets

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-77f93f41be");
  script_set_attribute(attribute:"solution", value:
"Update the affected libslirp package.");
...
flag = 0;
if (rpm_check(release:"FC33", reference:"libslirp-4.3.1-3.fc33")) flag++;
