...
# extracted from Amazon Linux AMI Security Advisory ALAS-2023-1793.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : nghttp2 (ALAS-2023-1793)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of nghttp2 installed on the remote host is prior to 1.33.0-1.1.7. It is, therefore, affected by a
vulnerability as referenced in the ALAS-2023-1793 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2023-1793.html");
...
var pkgs = [
    {'reference':'libnghttp2-1.33.0-1.1.7.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libnghttp2-1.33.0-1.1.7.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libnghttp2-devel-1.33.0-1.1.7.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libnghttp2-devel-1.33.0-1.1.7.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nghttp2-1.33.0-1.1.7.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nghttp2-1.33.0-1.1.7.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nghttp2-debuginfo-1.33.0-1.1.7.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nghttp2-debuginfo-1.33.0-1.1.7.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
