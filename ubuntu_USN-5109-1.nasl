...
# extracted from Ubuntu Security Notice USN-5109-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5109-1");

  script_name(english:"Ubuntu 16.04 ESM : nginx vulnerability (USN-5109-1)");
...
USN-5109-1 advisory.
    ...
    It was discovered that nginx incorrectly handled files with certain modification dates. A remote attacker
    could possibly use this issue to cause a denial of service or other unspecified impact.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5109-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'nginx', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-common', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-core', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-extras', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-full', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm2', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'nginx-light', 'pkgver': '1.10.3-0ubuntu0.16.04.5+esm2', 'ubuntu_pro': TRUE}
];
