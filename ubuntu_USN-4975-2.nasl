...
# extracted from Ubuntu Security Notice USN-4975-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"4975-2");

  script_name(english:"Ubuntu 16.04 ESM : Django vulnerability (USN-4975-2)");
...
USN-4975-2 advisory.
    ...
    USN-4975-1 fixed a vulnerability in Django. This update provides the corresponding update for Ubuntu 16.04
    ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-4975-2");
...
"Update the affected python-django, python-django-common and / or python3-django packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-33203");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-django', 'pkgver': '1.8.7-1ubuntu5.15+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python-django-common', 'pkgver': '1.8.7-1ubuntu5.15+esm3', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-django', 'pkgver': '1.8.7-1ubuntu5.15+esm3', 'ubuntu_pro': TRUE}
];
