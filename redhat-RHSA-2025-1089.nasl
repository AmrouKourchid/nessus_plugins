...
# extracted from Red Hat Security Advisory RHSA-2025:1089. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:1089");

  script_name(english:"RHEL 9 : ovn22.03 (RHSA-2025:1089)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_1089.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2b473a2");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:1089");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ovn22.03-22.03.7-11.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'ovn22.03-central-22.03.7-11.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'ovn22.03-host-22.03.7-11.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'},
      {'reference':'ovn22.03-vtep-22.03.7-11.el9fdp', 'release':'9', 'el_string':'el9fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'}
    ]
  }
];
