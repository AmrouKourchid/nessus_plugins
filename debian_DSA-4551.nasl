...
# extracted from Debian Security Advisory DSA-4551. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4551");
  script_xref(name:"IAVB", value:"2019-B-0085-S");

  script_name(english:"Debian DSA-4551-1 : golang-1.11 - security update");
...
panic in dsa.Verify(), resulting in denial of service.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2019/dsa-4551");
...
flag = 0;
if (deb_check(release:"10.0", prefix:"golang-1.11", reference:"1.11.6-1+deb10u3")) flag++;
if (deb_check(release:"10.0", prefix:"golang-1.11-doc", reference:"1.11.6-1+deb10u3")) flag++;
if (deb_check(release:"10.0", prefix:"golang-1.11-go", reference:"1.11.6-1+deb10u3")) flag++;
if (deb_check(release:"10.0", prefix:"golang-1.11-src", reference:"1.11.6-1+deb10u3")) flag++;
