...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"285985");
...
file.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2001/ms01-004");
...
from Microsoft (MS01-004).");
  ...
  script_copyright(english:"This script is Copyright (C) 2001-2024 Pedro Antonio Nieto Feijoo");
