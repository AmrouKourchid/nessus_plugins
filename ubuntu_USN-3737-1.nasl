...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : GDM vulnerability (USN-3737-1)");
...
USN-3737-1 advisory.
    ...
    A use-after-free was discovered in GDM. A local user could exploit this to cause a denial of service, or
    potentially execute arbitrary code as the administrator.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3737-1");
...
var pkgs = [
    {'osver': '18.04', 'pkgname': 'gdm3', 'pkgver': '3.28.2-0ubuntu1.4'},
    {'osver': '18.04', 'pkgname': 'gir1.2-gdm-1.0', 'pkgver': '3.28.2-0ubuntu1.4'},
    {'osver': '18.04', 'pkgname': 'libgdm-dev', 'pkgver': '3.28.2-0ubuntu1.4'},
    {'osver': '18.04', 'pkgname': 'libgdm1', 'pkgver': '3.28.2-0ubuntu1.4'}
];
