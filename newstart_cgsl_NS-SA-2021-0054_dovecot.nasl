...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : dovecot Multiple Vulnerabilities (NS-SA-2021-0054)");
...
pkgs = {
  'CGSL MAIN 6.02': [
    'dovecot-2.3.8-2.el8_2.2',
    'dovecot-debuginfo-2.3.8-2.el8_2.2',
    'dovecot-debugsource-2.3.8-2.el8_2.2',
    'dovecot-devel-2.3.8-2.el8_2.2',
    'dovecot-mysql-2.3.8-2.el8_2.2',
    'dovecot-mysql-debuginfo-2.3.8-2.el8_2.2',
    'dovecot-pgsql-2.3.8-2.el8_2.2',
    'dovecot-pgsql-debuginfo-2.3.8-2.el8_2.2',
    'dovecot-pigeonhole-2.3.8-2.el8_2.2',
    'dovecot-pigeonhole-debuginfo-2.3.8-2.el8_2.2'
  ]
};
