...
# extracted from VMware Security Advisory PHSA-2025-5.0-0447. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Rsync PHSA-2025-5.0-0447");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the rsync package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-447.md");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'rsync-3.2.7-5.ph5')) flag++;
