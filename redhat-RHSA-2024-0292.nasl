...
# extracted from Red Hat Security Advisory RHSA-2024:0292. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0292");

  script_name(english:"RHEL 9 : OpenShift Container Platform 4.14.10 (RHSA-2024:0292)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.14.10.");
...
the RHSA-2024:0292 advisory.
    ...
    This advisory contains the RPM packages for Red Hat build of MicroShift 4.14.10. See the following
    ...
    * golang: crypto/tls: slow verification of certificate chains containing
    ...
    other related information, refer to the CVE page(s) listed in the References section. All of the bug fixes
    may not be documented in this advisory. See the following release notes documentation for details about
    these changes:
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0292.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6be93ef8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2228743");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0292");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.14.10 package based on the guidance in RHSA-2024:0292.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'microshift-4.14.10-202401181720.p0.gd25a4c5.assembly.4.14.10.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-4.14.10-202401181720.p0.gd25a4c5.assembly.4.14.10.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-greenboot-4.14.10-202401181720.p0.gd25a4c5.assembly.4.14.10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-networking-4.14.10-202401181720.p0.gd25a4c5.assembly.4.14.10.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-networking-4.14.10-202401181720.p0.gd25a4c5.assembly.4.14.10.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-release-info-4.14.10-202401181720.p0.gd25a4c5.assembly.4.14.10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'microshift-selinux-4.14.10-202401181720.p0.gd25a4c5.assembly.4.14.10.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
