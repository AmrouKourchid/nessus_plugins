...
USN-3661-1 advisory.
    ...
    It was discovered that Batik incorrectly handled certain XML. An attacker could possibly use this to
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3661-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libbatik-java', 'pkgver': '1.7.ubuntu-8ubuntu2.14.04.3'}
];
