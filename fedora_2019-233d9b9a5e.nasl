...
# extracted from Fedora Security Advisory FEDORA-2019-233d9b9a5e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : znc (2019-233d9b9a5e)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-233d9b9a5e");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"znc-1.7.5-1.fc31")) flag++;
