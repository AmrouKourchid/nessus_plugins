...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Libarchive PHSA-2020-3.0-0055");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libarchive-3.3.3-5.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libarchive-debuginfo-3.3.3-5.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'libarchive-devel-3.3.3-5.ph3')) flag++;
