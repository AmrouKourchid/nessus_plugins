...
"The version of Google Chrome installed on the remote Windows host is prior to 136.0.7103.48. It is, therefore, affected
by multiple vulnerabilities as referenced in the 2025_04_stable-channel-update-for-desktop_29 advisory.
...
google_chrome_check_version(installs:installs, fix:'136.0.7103.48', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
