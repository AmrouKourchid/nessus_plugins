...
# extracted from Fedora Security Advisory FEDORA-2023-3cccbc4c95
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3cccbc4c95");

  script_name(english:"Fedora 38 : runc (2023-3cccbc4c95)");
...
FEDORA-2023-3cccbc4c95 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3cccbc4c95");
...
"Update the affected 2:runc package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:runc");
...
var pkgs = [
    {'reference':'runc-1.1.6-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
