...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : python-urllib3 (EulerOS-SA-2019-2362)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2362
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d5d36642");
...
pkgs = ["python-urllib3-1.15.1-2.h4"];
