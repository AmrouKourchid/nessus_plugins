...
# extracted from VMware Security Advisory PHSA-2020-1.0-0321. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Postgresql PHSA-2020-1.0-0321");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the postgresql package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-321.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'postgresql-9.6.19-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'postgresql-devel-9.6.19-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'postgresql-libs-9.6.19-1.ph1')) flag++;
