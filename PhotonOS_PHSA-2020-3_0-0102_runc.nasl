...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Runc PHSA-2020-3.0-0102");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'runc-1.0.0.rc9-3.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'runc-doc-1.0.0.rc9-3.ph3')) flag++;
