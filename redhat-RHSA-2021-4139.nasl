...
# extracted from Red Hat Security Advisory RHSA-2021:4139. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4139");

  script_name(english:"RHEL 8 : resource-agents (RHSA-2021:4139)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2021:4139 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4139.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0e3c32a8");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.5_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7240878e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4139");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'resource-agents-4.1.1-98.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'resource-agents-paf-4.1.1-98.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
