...
# Red Hat Security Advisory RHSA-2024:3105. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : python3.11-cryptography (CESA-2024:3105)");
...
var pkgs = [
    {'reference':'python3.11-cryptography-37.0.2-6.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.11-cryptography-37.0.2-6.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
