...
# extracted from VMware Security Advisory PHSA-2023-4.0-0398. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Etcd PHSA-2023-4.0-0398");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the etcd package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-398.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'etcd-3.5.1-14.ph4')) flag++;
