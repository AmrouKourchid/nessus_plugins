...
# extracted from Fedora Security Advisory FEDORA-2024-87e0baecb6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-87e0baecb6");
  script_xref(name:"IAVA", value:"2024-A-0064-S");

  script_name(english:"Fedora 39 : chromium (2024-87e0baecb6)");
...
FEDORA-2024-87e0baecb6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-87e0baecb6");
...
var pkgs = [
    {'reference':'chromium-121.0.6167.139-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
