...
# extracted from Red Hat Security Advisory RHSA-2020:1420.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (RHSA-2020:1420)");
...
var pkgs = [
    {'reference':'firefox-68.7.0-2.el6.centos', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-68.7.0-2.el6.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
