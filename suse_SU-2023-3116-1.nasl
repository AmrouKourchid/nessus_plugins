...
# SUSE update advisory SUSE-SU-2023:3116-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3116-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 0 for SLE 15 SP5) (SUSE-SU-2023:3116-1)");
...
the SUSE-SU-2023:3116-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1210987");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1212348");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1212509");
  # https://lists.suse.com/pipermail/sle-security-updates/2023-August/015733.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?973367f0");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.14.21-150500.53-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_14_21-150500_53-default-2-150500.3.1', 'sp':'5', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.5']}
        ]
      }
    }
  }
