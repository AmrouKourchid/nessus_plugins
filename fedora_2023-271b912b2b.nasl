...
# extracted from Fedora Security Advisory FEDORA-2023-271b912b2b
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-4243", "CVE-2021-32850");
  script_xref(name:"FEDORA", value:"2023-271b912b2b");

  script_name(english:"Fedora 38 : sympa (2023-271b912b2b)");
...
FEDORA-2023-271b912b2b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-271b912b2b");
...
"Update the affected sympa package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-32850");
...
var pkgs = [
    {'reference':'sympa-6.2.72-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
