...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : libpng (EulerOS-SA-2019-1855)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1855
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ac863f2");
...
pkgs = ["libpng-1.5.13-7.h6",
        "libpng-devel-1.5.13-7.h6"];
