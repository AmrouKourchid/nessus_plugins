...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Elasticsearch PHSA-2018-2.0-0116");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-3831");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'elasticsearch-6.4.1-1.ph2')) flag++;
