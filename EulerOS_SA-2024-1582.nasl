...
if (description)
{
  ...
  script_cve_id("CVE-2023-1393", "CVE-2023-5367", "CVE-2023-5380");

  script_name(english:"EulerOS 2.0 SP10 : xorg-x11-server (EulerOS-SA-2024-1582)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1582
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d245553");
...
var pkgs = [
  "xorg-x11-server-help-1.20.8-4.h13.eulerosv2r10"
];
