...
# extracted from Fedora Security Advisory FEDORA-2023-5d1b8507b8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-5d1b8507b8");
  script_xref(name:"IAVA", value:"2023-A-0669-S");

  script_name(english:"Fedora 39 : chromium (2023-5d1b8507b8)");
...
FEDORA-2023-5d1b8507b8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-5d1b8507b8");
...
var pkgs = [
    {'reference':'chromium-120.0.6099.62-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
