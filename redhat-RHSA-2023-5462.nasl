...
# extracted from Red Hat Security Advisory RHSA-2023:5462. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:5462");
  script_xref(name:"IAVA", value:"2023-A-0442-S");

  script_name(english:"RHEL 9 : python3.9 (RHSA-2023:5462)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_5462.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16089a9e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2235789");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:5462");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python3.9 package based on the guidance in RHSA-2023:5462.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-unversioned-command-3.9.16-1.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-3.9.16-1.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-debug-3.9.16-1.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-devel-3.9.16-1.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-idle-3.9.16-1.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libs-3.9.16-1.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-test-3.9.16-1.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-tkinter-3.9.16-1.el9_2.2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python-unversioned-command-3.9.16-1.el9_2.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-3.9.16-1.el9_2.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-debug-3.9.16-1.el9_2.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-devel-3.9.16-1.el9_2.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-idle-3.9.16-1.el9_2.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libs-3.9.16-1.el9_2.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-test-3.9.16-1.el9_2.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-tkinter-3.9.16-1.el9_2.2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
