...
# extracted from Fedora Security Advisory FEDORA-2025-3ec637e6e9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-3ec637e6e9");

  script_name(english:"Fedora 41 : rsync (2025-3ec637e6e9)");
...
FEDORA-2025-3ec637e6e9 advisory.

    New version 3.4.1, a couple of fixes for the 3.4.0 release.

    ----

    New version 3.4.0. Contains fixes for CVE-2024-12084, CVE-2024-12085, CVE-2024-12086, CVE-2024-12087,
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3ec637e6e9");
...
var pkgs = [
    {'reference':'rsync-3.4.1-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
