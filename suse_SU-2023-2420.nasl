...
# SUSE update advisory SUSE-SU-2023:2420. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:2420");

  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 30 for SLE 12 SP4) (SUSE-SU-2023:2420)");
...
the SUSE-SU-2023:2420 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/029745.html");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-95.108-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_108-default-8-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      }
    }
  }
