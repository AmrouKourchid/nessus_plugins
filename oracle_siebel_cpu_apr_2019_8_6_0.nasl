...
if (description)
{
  ...
  script_cve_id("CVE-2016-0635");

  script_name(english:"Oracle Siebel Server 8.5.1.x <= 8.5.1.7 / 8.6.0 (April 2019 CPU)");
...
April 2019 CPU advisory
  ...
  - Vulnerability in the Oracle Knowledge component of Oracle Siebel CRM (subcomponent: AnswerFlow (Spring
    Framework)). Supported versions that are affected are 8.5.1.0 - 8.5.1.7 and 8.6.0. Easily exploitable
    vulnerability allows low privileged attacker with network access via HTTP to compromise Oracle Knowledge.
    Successful attacks of this vulnerability can result in takeover of Oracle Knowledge. (CVE-2016-0635)
...
var constraints = [
  ...
  { 'min_version' : '8.6.0', 'max_version' : '8.6.0.999', 'fixed_display' : 'See vendor advisory' }
];
