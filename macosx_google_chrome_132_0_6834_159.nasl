...
if (description)
{
  ...
  script_name(english:"Google Chrome < 132.0.6834.159 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote macOS host is prior to 132.0.6834.159. It is, therefore, affected
...
"Upgrade to Google Chrome version 132.0.6834.159 or later.");
...
google_chrome_check_version(fix:'132.0.6834.159', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
