...
# extracted from Fedora Security Advisory FEDORA-2025-e0e44b1b98
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-e0e44b1b98");
  script_xref(name:"IAVA", value:"2025-A-0127");

  script_name(english:"Fedora 41 : openssl (2025-e0e44b1b98)");
...
FEDORA-2025-e0e44b1b98 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e0e44b1b98");
...
var pkgs = [
    {'reference':'openssl-3.2.4-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
