...
# extracted from Red Hat Security Advisory RHSA-2019:3694 and 
# Oracle Linux Security Advisory ELSA-2019-3694 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : sudo (ELSA-2019-3694)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-3694.html");
...
var pkgs = [
    {'reference':'sudo-1.8.25p1-8.el8_1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sudo-1.8.25p1-8.el8_1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
