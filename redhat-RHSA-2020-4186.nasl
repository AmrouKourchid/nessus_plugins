...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4186.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b2a06207");
...
"Update the RHEL spice / spice-gtk packages based on the guidance in RHSA-2020:4186.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'spice-server-0.14.2-1.el8_2.1', 'sp':'2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-server-0.14.2-1.el8_2.1', 'sp':'2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-server-0.14.2-1.el8_2.1', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-server-devel-0.14.2-1.el8_2.1', 'sp':'2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-server-devel-0.14.2-1.el8_2.1', 'sp':'2', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-server-devel-0.14.2-1.el8_2.1', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'spice-glib-0.37-1.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-glib-devel-0.37-1.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-gtk-0.37-1.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-gtk-tools-0.37-1.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-gtk3-0.37-1.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-gtk3-devel-0.37-1.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-gtk3-vala-0.37-1.el8_2.2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'spice-server-0.14.2-1.el8_2.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-server-0.14.2-1.el8_2.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-server-0.14.2-1.el8_2.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-server-devel-0.14.2-1.el8_2.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-server-devel-0.14.2-1.el8_2.1', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-server-devel-0.14.2-1.el8_2.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'spice-glib-0.37-1.el8_2.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-glib-devel-0.37-1.el8_2.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-gtk-0.37-1.el8_2.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-gtk-tools-0.37-1.el8_2.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-gtk3-0.37-1.el8_2.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-gtk3-devel-0.37-1.el8_2.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'spice-gtk3-vala-0.37-1.el8_2.2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'spice-glib / spice-glib-devel / spice-gtk / spice-gtk-tools / etc');
}
