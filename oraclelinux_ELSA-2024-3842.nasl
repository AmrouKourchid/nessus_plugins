...
# extracted from Oracle Linux Security Advisory ELSA-2024-3842.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : c-ares (ELSA-2024-3842)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-3842.html");
...
var pkgs = [
    {'reference':'c-ares-1.19.1-2.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-devel-1.19.1-2.el9_4', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-1.19.1-2.el9_4', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-devel-1.19.1-2.el9_4', 'cpu':'i686', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-1.19.1-2.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'c-ares-devel-1.19.1-2.el9_4', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
