...
USN-5135-1 advisory.
    ...
    objects. A local attacker could use this to cause a denial of service (memory exhaustion).
...
var kernel_mappings = {
  '20.04': {
    '5.11.0': {
      'generic': '5.11.0-40',
      'generic-64k': '5.11.0-40',
      'generic-lpae': '5.11.0-40',
      'lowlatency': '5.11.0-40',
      'aws': '5.11.0-1021',
      'gcp': '5.11.0-1022'
    },
    '5.13.0': {
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-5135-1');
}
