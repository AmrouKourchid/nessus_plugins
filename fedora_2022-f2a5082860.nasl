...
# extracted from Fedora Security Advisory FEDORA-2022-f2a5082860
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f2a5082860");

  script_name(english:"Fedora 35 : php (2022-f2a5082860)");
...
FEDORA-2022-f2a5082860 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f2a5082860");
...
var pkgs = [
    {'reference':'php-8.0.25-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
