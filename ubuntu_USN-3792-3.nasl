...
# extracted from Ubuntu Security Notice USN-3792-3. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.10 : Net-SNMP vulnerability (USN-3792-3)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/3792-3/");
  script_set_attribute(attribute:"solution", value:
"Update the affected libsnmp30 package.");
...
if (ubuntu_check(osver:"18.10", pkgname:"libsnmp30", pkgver:"5.7.3+dfsg-1.8ubuntu3.18.10.1")) flag++;
