...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop 22.x < 22.5.6 / 23.x < 23.2 Vulnerability (APSB22-14)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop installed on the remote Windows host is prior to 22.5.6/23.2. It is, therefore, affected
by a vulnerability as referenced in the apsb22-14 advisory.
