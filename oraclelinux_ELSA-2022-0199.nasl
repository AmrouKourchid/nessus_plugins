...
# extracted from Oracle Linux Security Advisory ELSA-2022-0199.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : libreswan (ELSA-2022-0199)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2022-0199.html");
...
var pkgs = [
    {'reference':'libreswan-4.4-4.0.1.el8_5', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libreswan-4.4-4.0.1.el8_5', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
