...
# extracted from Red Hat Security Advisory RHSA-2022:8207. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8207");

  script_name(english:"RHEL 9 : openjpeg2 (RHSA-2022:8207)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8207.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66302120");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8207");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2067052");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openjpeg2 package based on the guidance in RHSA-2022:8207.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openjpeg2-2.4.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openjpeg2-devel-2.4.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'openjpeg2-tools-2.4.0-7.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
