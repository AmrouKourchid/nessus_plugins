...
multiple vulnerabilities as referenced in the USN-5946-1 advisory.
    ...
    Lai Han discovered that XStream incorrectly handled certain inputs. If a user or an automated system were
    ...
    It was discovered that XStream incorrectly handled certain inputs. If a user or an automated system were
    tricked into opening a specially crafted input file, a remote attacker could possibly use this issue to
    execute arbitrary code. This issue only affected Ubuntu 18.04 LTS and Ubuntu 20.04 LTS. (CVE-2021-39139,
    CVE-2021-39141, CVE-2021-39144, CVE-2021-39145, CVE-2021-39146, CVE-2021-39147, CVE-2021-39148,
    CVE-2021-39149, CVE-2021-39151, CVE-2021-39153, CVE-2021-39154)
    ...
    Lai Han discovered that XStream incorrectly handled certain inputs. If a user or an automated system were
    tricked into opening a specially crafted input file, a remote attacker could possibly use this issue to
    cause a denial of service. (CVE-2022-41966)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libxstream-java', 'pkgver': '1.4.8-1ubuntu0.1+esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'libxstream-java', 'pkgver': '1.4.11.1-1+deb10u4build0.18.04.1', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'libxstream-java', 'pkgver': '1.4.11.1-1ubuntu0.3', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'libxstream-java', 'pkgver': '1.4.18-2ubuntu0.1', 'ubuntu_pro': FALSE}
];
