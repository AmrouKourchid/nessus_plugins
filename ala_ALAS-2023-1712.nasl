...
# extracted from Amazon Linux AMI Security Advisory ALAS-2023-1712.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : emacs (ALAS-2023-1712)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux AMI host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of emacs installed on the remote host is prior to 24.3-20.25. It is, therefore, affected by multiple
vulnerabilities as referenced in the ALAS-2023-1712 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2023-1712.html");
...
var pkgs = [
    {'reference':'emacs-24.3-20.25.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'emacs-24.3-20.25.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'emacs-common-24.3-20.25.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'emacs-common-24.3-20.25.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'emacs-debuginfo-24.3-20.25.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'emacs-debuginfo-24.3-20.25.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'emacs-el-24.3-20.25.amzn1', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
