...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : dpkg vulnerability (USN-2566-1)");
...
USN-2566-1 advisory.
    ...
    Jann Horn discovered that dpkg incorrectly validated signatures when extracting local source packages. If
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2566-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-0840");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'dpkg', 'pkgver': '1.17.5ubuntu5.4'},
    {'osver': '14.04', 'pkgname': 'dpkg-dev', 'pkgver': '1.17.5ubuntu5.4'},
    {'osver': '14.04', 'pkgname': 'dselect', 'pkgver': '1.17.5ubuntu5.4'},
    {'osver': '14.04', 'pkgname': 'libdpkg-dev', 'pkgver': '1.17.5ubuntu5.4'},
    {'osver': '14.04', 'pkgname': 'libdpkg-perl', 'pkgver': '1.17.5ubuntu5.4'}
];
