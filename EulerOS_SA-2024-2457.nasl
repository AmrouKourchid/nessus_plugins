...
if (description)
{
  ...
  script_cve_id("CVE-2022-44840", "CVE-2022-47673", "CVE-2023-25584");

  script_name(english:"EulerOS 2.0 SP8 : binutils (EulerOS-SA-2024-2457)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2457
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?82bef43d");
...
"Update the affected binutils packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-47673");
...
var pkgs = [
  "binutils-2.31.1-13.h37.eulerosv2r8",
  "binutils-devel-2.31.1-13.h37.eulerosv2r8"
];
