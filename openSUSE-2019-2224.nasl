...
# extracted from openSUSE Security Update openSUSE-2019-2224.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : SDL2 (openSUSE-2019-2224)");
...
Security issues fixed :
  ...
  - CVE-2019-13616: Fixed heap-based buffer over-read in
    BlitNtoN in video/SDL_blit_N.c (bsc#1141844).

  - CVE-2019-13626: Fixed integer overflow in
    IMA_ADPCM_decode() in audio/SDL_wave.c (bsc#1142031).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1141844");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1142031");
  script_set_attribute(attribute:"solution", value:
"Update the affected SDL2 packages.");
...
if ( rpm_check(release:"SUSE15.0", reference:"SDL2-debugsource-2.0.8-lp150.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libSDL2-2_0-0-2.0.8-lp150.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libSDL2-2_0-0-debuginfo-2.0.8-lp150.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libSDL2-devel-2.0.8-lp150.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libSDL2-2_0-0-32bit-2.0.8-lp150.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libSDL2-2_0-0-32bit-debuginfo-2.0.8-lp150.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"libSDL2-devel-32bit-2.0.8-lp150.2.9.1") ) flag++;
