...
# extracted from Fedora Security Advisory FEDORA-2020-982b2950db.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : python35 (2020-982b2950db)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-982b2950db");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"python35-3.5.9-9.fc32")) flag++;
