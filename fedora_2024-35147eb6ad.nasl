...
# extracted from Fedora Security Advisory FEDORA-2024-35147eb6ad
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-35147eb6ad");

  script_name(english:"Fedora 39 : opentofu (2024-35147eb6ad)");
...
FEDORA-2024-35147eb6ad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-35147eb6ad");
...
var pkgs = [
    {'reference':'opentofu-1.8.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
