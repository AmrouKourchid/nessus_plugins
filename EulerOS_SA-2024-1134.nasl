...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : compact-libtiff3 (EulerOS-SA-2024-1134)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the compact-libtiff3 package installed, the EulerOS installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1134
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6510cedb");
  script_set_attribute(attribute:"solution", value:
"Update the affected compact-libtiff3 packages.");
...
var pkgs = [
  "compat-libtiff3-3.9.4-11.h34.eulerosv2r7"
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "compact-libtiff3");
}
