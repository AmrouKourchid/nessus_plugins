...
# extracted from VMware Security Advisory PHSA-2025-4.0-0789. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-34088", "CVE-2024-44070");

  script_name(english:"Photon OS 4.0: Frr PHSA-2025-4.0-0789");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the frr package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-789.md");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:vmware:photonos:frr");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'frr-10.2.1-1.ph4')) flag++;
