...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : libtasn1 (EulerOS-SA-2025-1425)");
...
the following vulnerabilities :
    ...
    number of elements in a certificate, libtasn1 takes much longer than expected, which can slow down or even
    crash the system. This flaw allows an attacker to send a specially crafted certificate, causing a denial
    of service attack.(CVE-2024-12133)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1425
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ec6d83e1");
...
var pkgs = [
  "libtasn1-4.17.0-3.h1.eulerosv2r12"
];
