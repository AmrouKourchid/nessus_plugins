...
# extracted from Red Hat Security Advisory RHSA-2020:5351. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:5351");

  script_name(english:"RHEL 7 : ksh (RHSA-2020:5351)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5351.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0d51fe57");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:5351");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1757324");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ksh package based on the guidance in RHSA-2020:5351.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ksh-20120801-27.el7_3', 'sp':'3', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
