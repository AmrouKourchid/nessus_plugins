...
# extracted from Fedora Security Advisory FEDORA-2025-2eb86c0cbf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-2eb86c0cbf");

  script_name(english:"Fedora 41 : dotnet9.0 (2025-2eb86c0cbf)");
...
FEDORA-2025-2eb86c0cbf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2eb86c0cbf");
...
var pkgs = [
    {'reference':'dotnet9.0-9.0.102-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
