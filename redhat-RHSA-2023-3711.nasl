...
# extracted from Red Hat Security Advisory RHSA-2023:3711. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3711");

  script_name(english:"RHEL 9 : libtiff (RHSA-2023:3711)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for libtiff.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:3711 advisory.
    ...
    * libtiff: out-of-bounds read in _TIFFmemcpy() in libtiff/tif_unix.c when called by functions in
    tools/tiffcrop.c (CVE-2023-0797)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3711.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?abffce8e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3711");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libtiff-4.4.0-8.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-devel-4.4.0-8.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libtiff-tools-4.4.0-8.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
