...
# extracted from Fedora Security Advisory FEDORA-2023-66d60c3df7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-66d60c3df7");
  script_xref(name:"IAVB", value:"2023-B-0070-S");

  script_name(english:"Fedora 38 : ghostscript (2023-66d60c3df7)");
...
FEDORA-2023-66d60c3df7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-66d60c3df7");
...
var pkgs = [
    {'reference':'ghostscript-10.01.2-4.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
