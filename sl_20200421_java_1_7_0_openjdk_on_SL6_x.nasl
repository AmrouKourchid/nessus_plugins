...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-1.7.0-openjdk on SL6.x i386/x86_64 (20200421)");
...
"Security Fix(es) :
  ...
  - OpenJDK: Uncaught InstantiationError exception in
    ...
    (CVE-2020-2757)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2004&L=SCIENTIFIC-LINUX-ERRATA&P=22018
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5091e581");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"java-1.7.0-openjdk-1.7.0.261-2.6.22.1.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.7.0-openjdk-debuginfo-1.7.0.261-2.6.22.1.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.7.0-openjdk-demo-1.7.0.261-2.6.22.1.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.7.0-openjdk-devel-1.7.0.261-2.6.22.1.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.7.0-openjdk-javadoc-1.7.0.261-2.6.22.1.el6_10")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.7.0-openjdk-src-1.7.0.261-2.6.22.1.el6_10")) flag++;
