...
# extracted from Fedora Security Advisory FEDORA-2024-52192927d8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-52192927d8");
  script_xref(name:"IAVB", value:"2024-B-0074-S");

  script_name(english:"Fedora 39 : ghostscript (2024-52192927d8)");
...
FEDORA-2024-52192927d8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-52192927d8");
...
var pkgs = [
    {'reference':'ghostscript-10.02.1-7.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
