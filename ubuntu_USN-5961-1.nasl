...
multiple vulnerabilities as referenced in the USN-5961-1 advisory.
    ...
    It was discovered that abcm2ps incorrectly handled memory when parsing specially crafted ABC files. An
    attacker could use this issue to cause abcm2ps to crash, leading to a denial of service, or possibly
    execute arbitrary code. This issue only affected Ubuntu 16.04 ESM and Ubuntu 18.04 LTS.

    (CVE-2018-10753, CVE-2018-10771, CVE-2019-1010069)

    Chiba of Topsec Alpha Lab discovered that abcm2ps incorrectly handled memory when parsing specially
    crafted ABC files. An attacker could use this issue to cause abcm2ps to crash, leading to a denial of
    service. (CVE-2021-32434, CVE-2021-32435, CVE-2021-32436)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'abcm2ps', 'pkgver': '7.8.9-1ubuntu0.16.04.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'abcm2ps', 'pkgver': '7.8.9-1+deb9u1build0.18.04.1', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'abcm2ps', 'pkgver': '8.14.6-0.1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '22.04', 'pkgname': 'abcm2ps', 'pkgver': '8.14.11-0.1ubuntu0.1~esm1', 'ubuntu_pro': TRUE}
];
