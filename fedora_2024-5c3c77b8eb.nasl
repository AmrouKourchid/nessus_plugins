...
# extracted from Fedora Security Advisory FEDORA-2024-5c3c77b8eb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-5c3c77b8eb");

  script_name(english:"Fedora 39 : vips (2024-5c3c77b8eb)");
...
FEDORA-2024-5c3c77b8eb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5c3c77b8eb");
...
var pkgs = [
    {'reference':'vips-8.15.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
