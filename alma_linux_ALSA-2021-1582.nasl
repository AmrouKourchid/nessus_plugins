...
# AlmaLinux Security Advisory ALSA-2021:1582.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:1582");

  script_name(english:"AlmaLinux 8 : cpio (ALSA-2021:1582)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-1582.html");
