...
if (description)
{
  ...
  script_name(english:"IBM DB2 SEoL (7.2.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of IBM DB2 is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, IBM DB2 is 7.2.x. It is, therefore, no longer maintained by its vendor or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.");
  # http://www-01.ibm.com/common/ssi/cgi-bin/ssialias?subtype=ca&infotype=an&appname=iSource&supplier=897&letternum=ENUS903-185
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f7f090a");
...
"Upgrade to a version of IBM DB2 that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2005/04/30");
...
var constraints = [
  { max_branch : '7.2', min_branch : '7.2', seol : 20050430 }
];
