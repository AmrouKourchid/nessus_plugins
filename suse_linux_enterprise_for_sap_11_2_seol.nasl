...
# @DEPRECATED@
#
# Disabled on 2024/10/08. Deprecated by suse_linux_enterprise_server_for_sap_11_2_seol.nasl.
##
...
if (description)
{
  ...
  script_name(english:"SUSE Linux Enterprise For SAP SEoL (11.2.x) (deprecated)");

  script_set_attribute(attribute:"synopsis", value:
"This plugin has been deprecated.");
  script_set_attribute(attribute:"description", value:
"According to its version, SUSE Linux Enterprise For SAP is 11.2.x. It is, therefore, no longer maintained by its vendor
or provider.

Lack of support implies that no new security patches for the product will be released by the vendor. As a result, it may
contain security vulnerabilities.

This plugin has been deprecated as it is a duplicate of suse_linux_enterprise_server_for_sap_11_2_seol.nasl.");
...
exit(0, 'This plugin has been deprecated. Use suse_linux_enterprise_server_for_sap_11_2_seol.nasl instead.');
