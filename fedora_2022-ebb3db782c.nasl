...
# extracted from Fedora Security Advisory FEDORA-2022-ebb3db782c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-ebb3db782c");
  script_xref(name:"IAVA", value:"2022-A-0338-S");

  script_name(english:"Fedora 35 : exim (2022-ebb3db782c)");
...
FEDORA-2022-ebb3db782c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-ebb3db782c");
...
var pkgs = [
    {'reference':'exim-4.96-4.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
