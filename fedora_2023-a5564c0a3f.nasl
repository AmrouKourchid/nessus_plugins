...
# extracted from Fedora Security Advisory FEDORA-2023-a5564c0a3f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a5564c0a3f");

  script_name(english:"Fedora 36 : openssl (2023-a5564c0a3f)");
...
FEDORA-2023-a5564c0a3f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a5564c0a3f");
...
var pkgs = [
    {'reference':'openssl-3.0.8-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
