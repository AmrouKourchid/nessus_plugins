...
# extracted from Debian Security Advisory dsa-5760. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5760 : ghostscript - security update");
...
dsa-5760 advisory.
    ...
    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5760-1                   security@debian.org
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-29506");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-29507");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-29508");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2024-29509");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'ghostscript', 'reference': '10.0.0~dfsg-11+deb12u5'},
    {'release': '12.0', 'prefix': 'ghostscript-doc', 'reference': '10.0.0~dfsg-11+deb12u5'},
    {'release': '12.0', 'prefix': 'ghostscript-x', 'reference': '10.0.0~dfsg-11+deb12u5'},
    {'release': '12.0', 'prefix': 'libgs-common', 'reference': '10.0.0~dfsg-11+deb12u5'},
    {'release': '12.0', 'prefix': 'libgs-dev', 'reference': '10.0.0~dfsg-11+deb12u5'},
    {'release': '12.0', 'prefix': 'libgs10', 'reference': '10.0.0~dfsg-11+deb12u5'},
    {'release': '12.0', 'prefix': 'libgs10-common', 'reference': '10.0.0~dfsg-11+deb12u5'},
    {'release': '12.0', 'prefix': 'libgs9-common', 'reference': '10.0.0~dfsg-11+deb12u5'}
];
