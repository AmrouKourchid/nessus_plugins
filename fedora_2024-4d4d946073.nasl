...
# extracted from Fedora Security Advisory FEDORA-2024-4d4d946073
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4d4d946073");

  script_name(english:"Fedora 41 : pam (2024-4d4d946073)");
...
FEDORA-2024-4d4d946073 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4d4d946073");
...
var pkgs = [
    {'reference':'pam-1.6.1-7.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
