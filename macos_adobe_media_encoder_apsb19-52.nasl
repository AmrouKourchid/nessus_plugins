...
if (description)
{
  ...
  script_name(english:"Adobe Media Encoder < 14.0 Multiple Vulnerabilities (APSB19-52) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Media Encoder instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Media Encoder installed on the remote macOS host is prior to 14.0. It is, therefore, affected by
