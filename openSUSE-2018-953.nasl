...
notes.txt).");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1065363");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1086778");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1097779");
  # https://ftp.openbsd.org/pub/OpenBSD/LibreSSL/libressl-2.8.0-relnotes.txt
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5af67e40");
...
"Update the affected libressl packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-8970");
