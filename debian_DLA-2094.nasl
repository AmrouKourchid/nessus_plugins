...
# extracted from Debian Security Advisory DLA-2094-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2094-1 : sudo security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"A stack-based buffer overflow vulnerability in sudo, a program
designed to provide limited super user privileges to specific users,
triggerable when configured with the pwfeedback option enabled. An
unprivileged user can take advantage of this flaw to obtain full root
privileges.
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/02/msg00002.html");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"sudo", reference:"1.8.10p3-1+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"sudo-ldap", reference:"1.8.10p3-1+deb8u7")) flag++;
