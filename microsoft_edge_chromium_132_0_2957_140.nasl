...
if (description)
{
  ...
  script_name(english:"Microsoft Edge (Chromium) < 132.0.2957.140 (CVE-2025-0762)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an web browser installed that is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft Edge installed on the remote Windows host is prior to 132.0.2957.140. It is, therefore,
affected by a vulnerability as referenced in the January 30, 2025 advisory.

  - Use after free in DevTools in Google Chrome prior to 132.0.6834.159 allowed a remote attacker to
    potentially exploit heap corruption via a crafted Chrome Extension. (Chromium security severity: Medium)
    (CVE-2025-0762)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://docs.microsoft.com/en-us/DeployEdge/microsoft-edge-relnotes-security#january-30-2025
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?031a09a7");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-0762");
