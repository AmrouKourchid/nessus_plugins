...
# SUSE update advisory SUSE-SU-2022:4252-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:4252-1");

  script_name(english:"SUSE SLES12 Security Update : exiv2 (SUSE-SU-2022:4252-1)");
...
referenced in the SUSE-SU-2022:4252-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1142681");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2019-13112");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-November/013131.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d83830e7");
  script_set_attribute(attribute:"solution", value:
"Update the affected libexiv2-12 package.");
...
var pkgs = [
    {'reference':'libexiv2-12-0.23-12.18.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
    {'reference':'libexiv2-12-0.23-12.18.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'libexiv2-12-0.23-12.18.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libexiv2-12');
}
