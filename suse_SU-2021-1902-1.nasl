...
# SUSE update advisory SUSE-SU-2021:1902-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:1902-1");

  script_name(english:"SUSE SLES12 Security Update : spice (SUSE-SU-2021:1902-1)");
...
referenced in the SUSE-SU-2021:1902-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.suse.com/pipermail/sle-updates/2021-June/019243.html");
...
var pkgs = [
    {'reference':'libspice-server1-0.12.7-10.12', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.2']},
    {'reference':'libspice-server1-0.12.7-10.12', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.2']}
];
