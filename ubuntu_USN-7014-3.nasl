...
# extracted from Ubuntu Security Notice USN-7014-3. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"7014-3");

  script_name(english:"Ubuntu 14.04 LTS : nginx vulnerability (USN-7014-3)");
...
USN-7014-3 advisory.
    ...
    USN-7014-1 fixed a vulnerability in nginx. This update provides the corresponding update for Ubuntu 14.04
    LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-7014-3");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'nginx', 'pkgver': '1.4.6-1ubuntu3.9+esm5', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'nginx-common', 'pkgver': '1.4.6-1ubuntu3.9+esm5', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'nginx-core', 'pkgver': '1.4.6-1ubuntu3.9+esm5', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'nginx-extras', 'pkgver': '1.4.6-1ubuntu3.9+esm5', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'nginx-full', 'pkgver': '1.4.6-1ubuntu3.9+esm5', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'nginx-light', 'pkgver': '1.4.6-1ubuntu3.9+esm5', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'nginx-naxsi', 'pkgver': '1.4.6-1ubuntu3.9+esm5', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'nginx-naxsi-ui', 'pkgver': '1.4.6-1ubuntu3.9+esm5', 'ubuntu_pro': TRUE}
];
