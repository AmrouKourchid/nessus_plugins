...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : libtiff (EulerOS-SA-2024-2801)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2801
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b473855a");
...
var pkgs = [
  "libtiff-4.3.0-24.h18.eulerosv2r12"
];
