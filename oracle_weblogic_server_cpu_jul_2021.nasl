...
"Apply the appropriate patch according to the July 2021 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-2397");
  ...
  script_require_ports("installed_sw/Oracle WebLogic Server", "installed_sw/JDeveloper's Integrated WebLogic Server", "installed_sw/Oracle Data Integrator Embedded Weblogic Server");
