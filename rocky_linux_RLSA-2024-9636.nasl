...
# Rocky Linux Security Advisory RLSA-2024:9636.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2024:9636");

  script_name(english:"RockyLinux 8 : webkit2gtk3 (RLSA-2024:9636)");
...
RLSA-2024:9636 advisory.
    ...
    * webkitgtk: webkit2gtk: Processing maliciously crafted web content may lead to an unexpected process
    crash (CVE-2024-44244)

    * webkitgtk: webkit2gtk: Processing maliciously crafted web content may prevent Content Security Policy
    from being enforced (CVE-2024-44296)

Tenable has extracted the preceding description block directly from the RockyLinux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2024:9636");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2323278");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2323289");
...
var pkgs = [
    {'reference':'webkit2gtk3-2.46.3-1.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-2.46.3-1.el8_10', 'cpu':'i686', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-2.46.3-1.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-debuginfo-2.46.3-1.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-debuginfo-2.46.3-1.el8_10', 'cpu':'i686', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-debuginfo-2.46.3-1.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-debugsource-2.46.3-1.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-debugsource-2.46.3-1.el8_10', 'cpu':'i686', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-debugsource-2.46.3-1.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-devel-2.46.3-1.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-devel-2.46.3-1.el8_10', 'cpu':'i686', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-devel-2.46.3-1.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-devel-debuginfo-2.46.3-1.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-devel-debuginfo-2.46.3-1.el8_10', 'cpu':'i686', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-devel-debuginfo-2.46.3-1.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-2.46.3-1.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-2.46.3-1.el8_10', 'cpu':'i686', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-2.46.3-1.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-debuginfo-2.46.3-1.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-debuginfo-2.46.3-1.el8_10', 'cpu':'i686', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-debuginfo-2.46.3-1.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-devel-2.46.3-1.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-devel-2.46.3-1.el8_10', 'cpu':'i686', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-devel-2.46.3-1.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-devel-debuginfo-2.46.3-1.el8_10', 'cpu':'aarch64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-devel-debuginfo-2.46.3-1.el8_10', 'cpu':'i686', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'webkit2gtk3-jsc-devel-debuginfo-2.46.3-1.el8_10', 'cpu':'x86_64', 'release':'8', 'el_string':'el8_10', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
