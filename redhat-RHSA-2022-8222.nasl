...
# extracted from Red Hat Security Advisory RHSA-2022:8222. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8222");

  script_name(english:"RHEL 9 : xorg-x11-server-Xwayland (RHSA-2022:8222)");
...
referenced in the RHSA-2022:8222 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8222.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a5c6bb9d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8222");
...
"Update the RHEL xorg-x11-server-Xwayland packages based on the guidance in RHSA-2022:8222.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'xorg-x11-server-Xwayland-21.1.3-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
