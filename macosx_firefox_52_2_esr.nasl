...
if (description)
{
  ...
  script_bugtraq_id(99040, 99041, 99057);
  script_xref(name:"MFSA", value:"2017-16");

  script_name(english:"Mozilla Firefox ESR < 52.2 Multiple Vulnerabilities (macOS)");
...
vulnerabilities :
  ...
  - A flaw exists in the Graphite component in the
    ...
    (CVE-2017-7777)");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2017-16/");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'52.2', min:'52', severity:SECURITY_HOLE);
