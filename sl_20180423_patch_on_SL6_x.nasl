...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : patch on SL6.x i386/x86_64 (20180423)");
...
Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1804&L=scientific-linux-errata&F=&S=&P=2415
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?445ddfd6");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"patch-2.6-8.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"patch-debuginfo-2.6-8.el6_9")) flag++;
