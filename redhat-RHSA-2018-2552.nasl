...
referenced in the RHSA-2018:2552 advisory.
    ...
    This release of RHOAR Node.js 8.11.4 serves as a replacement for RHOAR Node.js 8.11.3, and includes bug
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_2552.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d48f3927");
  # https://nodejs.org/en/blog/vulnerability/august-2018-security-releases/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f738f917");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:2552");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/NODE-160");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenShift Application Runtimes Node.js 8.11.4 package based on the guidance in RHSA-2018:2552.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'npm-5.6.0-1.8.11.4.2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'rhoar-nodejs'},
      {'reference':'rhoar-nodejs-8.11.4-2.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'rhoar-nodejs'},
      {'reference':'rhoar-nodejs-docs-8.11.4-2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'rhoar-nodejs'}
    ]
  }
];
