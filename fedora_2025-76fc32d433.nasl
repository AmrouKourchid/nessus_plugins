...
# extracted from Fedora Security Advisory FEDORA-2025-76fc32d433
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-76fc32d433");

  script_name(english:"Fedora 41 : nodejs20 (2025-76fc32d433)");
...
FEDORA-2025-76fc32d433 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-76fc32d433");
...
var pkgs = [
    {'reference':'nodejs20-20.18.2-2.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
