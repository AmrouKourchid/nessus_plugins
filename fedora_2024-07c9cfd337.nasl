...
# extracted from Fedora Security Advisory FEDORA-2024-07c9cfd337
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-07c9cfd337");

  script_name(english:"Fedora 39 : libreswan (2024-07c9cfd337)");
...
FEDORA-2024-07c9cfd337 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-07c9cfd337");
...
var pkgs = [
    {'reference':'libreswan-4.15-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
