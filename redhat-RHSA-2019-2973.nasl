...
# extracted from Red Hat Security Advisory RHSA-2019:2973. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2019-14843");
  script_xref(name:"RHSA", value:"2019:2973");

  script_name(english:"RHEL 6 / 7 / 8 : Red Hat JBoss Enterprise Application Platform 7.2 (RHSA-2019:2973)");
...
referenced in the RHSA-2019:2973 advisory.

    Red Hat JBoss Enterprise Application Platform 7 is a platform for Java applications based on Wildfly.

    This asynchronous patch is a security update for wildfly-security-manager package in Red Hat JBoss
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_2973.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?399f7eb5");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:2973");
...
"Update the RHEL Red Hat JBoss Enterprise Application Platform 7.2 package based on the guidance in RHSA-2019:2973.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-wildfly-elytron-1.6.4-3.Final_redhat_00002.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'eap7-wildfly-elytron-1.6.4-3.Final_redhat_00002.1.el6eap', 'release':'6', 'el_string':'el6eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'eap7-wildfly-elytron-1.6.4-3.Final_redhat_00002.1.el7eap', 'release':'7', 'el_string':'el7eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'eap7-wildfly-elytron');
}
