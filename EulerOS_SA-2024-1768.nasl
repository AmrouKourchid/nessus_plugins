...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : ncurses (EulerOS-SA-2024-1768)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1768
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?10bfe0d0");
...
var pkgs = [
  "ncurses-6.3-5.h7.eulerosv2r12",
  "ncurses-base-6.3-5.h7.eulerosv2r12",
  "ncurses-libs-6.3-5.h7.eulerosv2r12"
];
