...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : glibc (EulerOS-SA-2023-1254)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1254
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8282b052");
...
var pkgs = [
  "glibc-2.17-222.h55.eulerosv2r7",
  "glibc-common-2.17-222.h55.eulerosv2r7",
  "glibc-devel-2.17-222.h55.eulerosv2r7",
  "glibc-headers-2.17-222.h55.eulerosv2r7"
];
