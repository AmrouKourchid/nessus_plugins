...
# extracted from Debian Security Advisory DLA-2327-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2327-1 : lucene-solr security update");
...
debugging / development of a DIH config. Since a DIH config can
contain scripts, this parameter is a security risk. Starting from now
on, use of this parameter requires setting the Java System property
...
For the detailed security status of lucene-solr please refer to its
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00025.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/lucene-solr");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/lucene-solr");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"liblucene3-contrib-java", reference:"3.6.2+dfsg-10+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"liblucene3-java", reference:"3.6.2+dfsg-10+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"liblucene3-java-doc", reference:"3.6.2+dfsg-10+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"libsolr-java", reference:"3.6.2+dfsg-10+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"solr-common", reference:"3.6.2+dfsg-10+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"solr-jetty", reference:"3.6.2+dfsg-10+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"solr-tomcat", reference:"3.6.2+dfsg-10+deb9u3")) flag++;
