...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : rsyslog (EulerOS-SA-2019-1245)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1245
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?251aea67");
...
pkgs = ["rsyslog-8.24.0-17.h12",
        "rsyslog-mmjsonparse-8.24.0-17.h12"];
