...
if (description)
{
  ...
  script_cve_id("CVE-2023-44431");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2023-44431");
...
patch available.
  ...
  - BlueZ Audio Profile AVRCP Stack-based Buffer Overflow Remote Code Execution Vulnerability. This
    ...
    to a fixed-length stack-based buffer. An attacker can leverage this vulnerability to execute code in the
    context of root. Was ZDI-CAN-19909. (CVE-2023-44431)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-44431");
