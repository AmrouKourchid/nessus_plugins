...
# extracted from Fedora Security Advisory FEDORA-2024-c1fabee30e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c1fabee30e");

  script_name(english:"Fedora 38 : grub2 (2024-c1fabee30e)");
...
FEDORA-2024-c1fabee30e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c1fabee30e");
...
var pkgs = [
    {'reference':'grub2-2.06-116.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
