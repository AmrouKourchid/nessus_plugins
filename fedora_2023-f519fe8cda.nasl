...
# extracted from Fedora Security Advisory FEDORA-2023-f519fe8cda
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f519fe8cda");

  script_name(english:"Fedora 36 : mingw-glib2 (2023-f519fe8cda)");
...
FEDORA-2023-f519fe8cda advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f519fe8cda");
...
"Update the affected mingw-glib2 package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-24593");
...
var pkgs = [
    {'reference':'mingw-glib2-2.72.1-2.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
