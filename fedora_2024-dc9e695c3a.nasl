...
# extracted from Fedora Security Advisory FEDORA-2024-dc9e695c3a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-dc9e695c3a");

  script_name(english:"Fedora 41 : strongswan (2024-dc9e695c3a)");
...
FEDORA-2024-dc9e695c3a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-dc9e695c3a");
...
var pkgs = [
    {'reference':'strongswan-5.9.14-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
