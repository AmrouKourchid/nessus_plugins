...
"The version of Google Chrome installed on the remote Windows host is prior to 116.0.5845.110. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'116.0.5845.110', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
