...
if (description)
{
  ...
  script_name(english:"Photon OS 3.0: Cifs PHSA-2020-3.0-0142");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'cifs-utils-6.8-2.ph3')) flag++;
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'cifs-utils-devel-6.8-2.ph3')) flag++;
