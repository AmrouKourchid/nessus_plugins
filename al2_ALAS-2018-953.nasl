...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-953.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-953");
  script_xref(name:"IAVA", value:"2018-A-0020");

  script_name(english:"Amazon Linux 2 : microcode_ctl (ALAS-2018-953) (Spectre)");
...
conducting targeted cache side-channel attacks. (CVE-2017-5715)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALAS-2018-953.html");
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"microcode_ctl-2.1-22.5.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"microcode_ctl-debuginfo-2.1-22.5.amzn2")) flag++;
