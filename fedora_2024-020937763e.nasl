...
# extracted from Fedora Security Advisory FEDORA-2024-020937763e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-020937763e");

  script_name(english:"Fedora 40 : moodle (2024-020937763e)");
...
FEDORA-2024-020937763e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-020937763e");
...
var pkgs = [
    {'reference':'moodle-4.3.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
