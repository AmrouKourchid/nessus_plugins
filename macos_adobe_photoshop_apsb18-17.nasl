...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 18.x < 18.1.4 / CC 19.x < 19.1.4 Vulnerability (macOS APSB18-17)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote macOS or Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop CC installed on the remote macOS or Mac OS X host is prior to 18.1.4/19.1.4. It is,
therefore, affected by a vulnerability as referenced in the apsb18-17 advisory.
