...
# extracted from openSUSE Security Update openSUSE-2018-862.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : sddm (openSUSE-2018-862)");
...
The following other bugs were addressed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1099908");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1101450");
  script_set_attribute(attribute:"solution", value:
"Update the affected sddm packages.");
