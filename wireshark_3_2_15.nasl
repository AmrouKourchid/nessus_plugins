...
if (description)
{
  ...
  script_name(english:"Wireshark 3.2.x < 3.2.15 A Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote Windows host is prior to 3.2.15. It is, therefore, affected by a
vulnerability as referenced in the wireshark-3.2.15 advisory.
