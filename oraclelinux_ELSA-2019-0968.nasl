...
# extracted from Red Hat Security Advisory RHSA-2019:0968 and 
# Oracle Linux Security Advisory ELSA-2019-0968 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : edk2 (ELSA-2019-0968)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
ELSA-2019-0968 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-0968.html");
...
var pkgs = [
    {'reference':'edk2-aarch64-20180508gitee3198e672e2-9.el8_0.1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'edk2-ovmf-20180508gitee3198e672e2-9.el8_0.1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
