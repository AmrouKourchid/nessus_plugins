...
# extracted from Red Hat Security Advisory RHSA-2024:2199. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2199");

  script_name(english:"RHEL 9 : pmix (RHSA-2024:2199)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for pmix.");
...
the RHSA-2024:2199 advisory.

    The Process Management Interface (PMI) provides process management functions for MPI implementations. PMI
    Exascale (PMIx) provides an extended version of the PMI standard specifically designed to support clusters
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2199.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb483700");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2199");
...
"Update the RHEL pmix package based on the guidance in RHSA-2024:2199.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pmix");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pmix-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pmix-pmi");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pmix-pmi-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:pmix-tools");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pmix-3.2.3-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pmix-devel-3.2.3-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pmix-pmi-3.2.3-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pmix-pmi-devel-3.2.3-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pmix-tools-3.2.3-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'pmix / pmix-devel / pmix-pmi / pmix-pmi-devel / pmix-tools');
}
