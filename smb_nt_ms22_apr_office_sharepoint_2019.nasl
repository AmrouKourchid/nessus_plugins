...
if (description)
{
  ...
  script_cve_id("CVE-2022-24472");
  script_xref(name:"MSKB", value:"5002180");
  script_xref(name:"MSFT", value:"MS22-5002180");
  script_xref(name:"IAVA", value:"2022-A-0141-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2019 (April 2022)");
...
another user.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002180");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002180 to address this issue.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:R/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:F/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-24472");
