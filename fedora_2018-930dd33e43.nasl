...
# extracted from Fedora Security Advisory FEDORA-2018-930dd33e43.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : libjpeg-turbo (2018-930dd33e43)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Fix for **CVE-2018-1152**.

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-930dd33e43");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"libjpeg-turbo-1.5.3-6.fc28")) flag++;
