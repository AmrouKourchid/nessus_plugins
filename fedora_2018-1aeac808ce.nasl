...
# extracted from Fedora Security Advisory FEDORA-2018-1aeac808ce.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-1aeac808ce");

  script_name(english:"Fedora 28 : gd (2018-1aeac808ce)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-1aeac808ce");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"gd-2.2.5-3.fc28")) flag++;
