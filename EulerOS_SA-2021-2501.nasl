...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : java-1.8.0-openjdk (EulerOS-SA-2021-2501)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2501
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4b4849be");
...
var pkgs = [
  "java-1.8.0-openjdk-1.8.0.191.b12-0.h21.eulerosv2r7",
  "java-1.8.0-openjdk-devel-1.8.0.191.b12-0.h21.eulerosv2r7",
  "java-1.8.0-openjdk-headless-1.8.0.191.b12-0.h21.eulerosv2r7"
];
