...
# extracted from Oracle Linux Security Advisory ELSA-2020-1037.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : advancecomp (ELSA-2020-1037)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2020-1037.html");
...
var pkgs = [
    {'reference':'advancecomp-1.15-22.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
