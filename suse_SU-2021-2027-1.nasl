...
# SUSE update advisory SUSE-SU-2021:2027-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-23134", "CVE-2021-33034", "CVE-2021-33200");
  script_xref(name:"SuSE", value:"SUSE-SU-2021:2027-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 13 for SLE 15 SP2) (SUSE-SU-2021:2027-1)");
...
the SUSE-SU-2021:2027-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-June/009046.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fb2ac96b");
...
var pkgs = [
    {'reference':'kernel-livepatch-5_3_18-24_64-default-2-2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
];
