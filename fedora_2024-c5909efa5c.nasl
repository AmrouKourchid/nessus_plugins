...
# extracted from Fedora Security Advisory FEDORA-2024-c5909efa5c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c5909efa5c");

  script_name(english:"Fedora 41 : gdcm (2024-c5909efa5c)");
...
FEDORA-2024-c5909efa5c advisory.
    ...
    * Fri Mar 22 2024 Srgio M. Basto <sergio@serjux.com> - 3.0.23-3
    - Update URL
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c5909efa5c");
  script_set_attribute(attribute:"solution", value:
"Update the affected gdcm package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:gdcm");
...
var pkgs = [
    {'reference':'gdcm-3.0.23-5.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gdcm');
}
