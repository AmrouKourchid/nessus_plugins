...
# extracted from Fedora Security Advisory FEDORA-2024-18b9c9b9cf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-18b9c9b9cf");

  script_name(english:"Fedora 39 : python3.6 (2024-18b9c9b9cf)");
...
FEDORA-2024-18b9c9b9cf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-18b9c9b9cf");
...
var pkgs = [
    {'reference':'python3.6-3.6.15-28.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
