...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : fuse (EulerOS-SA-2019-1287)");
...
vulnerability :
  ...
  - It was discovered that fusermount failed to properly
    sanitize its environment before executing mount and
    umount commands. A local user could possibly use this
    flaw to escalate their privileges on the
    system.(CVE-2015-3202)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1287
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f4440881");
...
pkgs = ["fuse-2.9.2-11.h6.eulerosv2r7",
        "fuse-devel-2.9.2-11.h6.eulerosv2r7",
        "fuse-libs-2.9.2-11.h6.eulerosv2r7"];
