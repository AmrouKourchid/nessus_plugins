...
# extracted from Fedora Security Advisory FEDORA-2023-a2a92ab69a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-a2a92ab69a");

  script_name(english:"Fedora 38 : thunderbird (2023-a2a92ab69a)");
...
FEDORA-2023-a2a92ab69a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-a2a92ab69a");
...
var pkgs = [
    {'reference':'thunderbird-102.10.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
