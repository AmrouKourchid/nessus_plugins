...
# extracted from Amazon Linux 2 Security Advisory ALASKERNEL-5.15-2024-045.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : kernel (ALASKERNEL-5.15-2024-045)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Amazon Linux 2 host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The version of kernel installed on the remote host is prior to 5.15.161-106.159. It is, therefore, affected by a
vulnerability as referenced in the ALAS2KERNEL-5.15-2024-045 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2/ALASKERNEL-5.15-2024-045.html");
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "kpatch hotfix for ALASKERNEL-5.15-2024-045");
  }
  else
  {
