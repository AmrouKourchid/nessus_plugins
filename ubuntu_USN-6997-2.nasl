...
# extracted from Ubuntu Security Notice USN-6997-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6997-2");

  script_name(english:"Ubuntu 14.04 LTS : LibTIFF vulnerability (USN-6997-2)");
...
USN-6997-2 advisory.
    ...
    USN-6997-1 fixed a vulnerability in LibTIFF. This update provides the corresponding update for Ubuntu
    14.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6997-2");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'libtiff-opengl', 'pkgver': '4.0.3-7ubuntu0.11+esm14', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libtiff-tools', 'pkgver': '4.0.3-7ubuntu0.11+esm14', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libtiff4-dev', 'pkgver': '4.0.3-7ubuntu0.11+esm14', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libtiff5', 'pkgver': '4.0.3-7ubuntu0.11+esm14', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libtiff5-alt-dev', 'pkgver': '4.0.3-7ubuntu0.11+esm14', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libtiff5-dev', 'pkgver': '4.0.3-7ubuntu0.11+esm14', 'ubuntu_pro': TRUE},
    {'osver': '14.04', 'pkgname': 'libtiffxx5', 'pkgver': '4.0.3-7ubuntu0.11+esm14', 'ubuntu_pro': TRUE}
];
