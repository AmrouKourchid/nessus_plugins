...
# extracted from Fedora Security Advisory FEDORA-2023-26b58f8098
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-26b58f8098");

  script_name(english:"Fedora 36 : epiphany (2023-26b58f8098)");
...
FEDORA-2023-26b58f8098 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-26b58f8098");
...
var pkgs = [
    {'reference':'epiphany-42.5-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
