...
# extracted from Red Hat Security Advisory RHSA-2007:0276. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : shadow-utils (RHSA-2007:0276)");
...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2007/rhsa-2007_0276.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3909b7bf");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=176951");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=177017");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=188263");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=193053");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2007:0276");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL shadow-utils package based on the guidance in RHSA-2007:0276.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2006-1174");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'shadow-utils-4.0.3-61.RHEL4', 'cpu':'i386', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'shadow-utils-4.0.3-61.RHEL4', 'cpu':'ppc', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'shadow-utils-4.0.3-61.RHEL4', 'cpu':'s390', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'shadow-utils-4.0.3-61.RHEL4', 'cpu':'s390x', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'shadow-utils-4.0.3-61.RHEL4', 'cpu':'x86_64', 'release':'4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
    ]
  }
];
