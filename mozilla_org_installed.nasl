...
# ESR branches
var firefox_esr_major_versions_pattern = "^(10\.|17\.|24\.|31\.|38\.|45\.|52\.|60\.|68\.|78\.|91\.|102\.|115\.|128\.|140\.)";
# Thunderbird ESR was merged into the mainstream and is no more
var thunderbird_esr_major_versions_pattern = "^(10\.|17\.|115\.|128\.|140\.)";
...
{
  report = '\n' + info;
  report_installs(app_name:prod, report_override:report);
}
else
{
  if (max_index(errors))
