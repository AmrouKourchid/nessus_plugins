...
vulnerabilities as referenced in the SUSE-SU-2021:3843-1 advisory.
...
var pkgs = [
    {'reference':'libIlmImf-Imf_2_1-21-2.1.0-6.42.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'openexr-2.1.0-6.42.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
