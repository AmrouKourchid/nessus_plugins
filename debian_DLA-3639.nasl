...
# extracted from Debian Security Advisory dla-3639. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3639 : distro-info-data - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has a package installed that is affected by a vulnerability as referenced in the dla-3639
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3639-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'distro-info-data', 'reference': '0.41+deb10u8'}
];
