...
# SUSE update advisory SUSE-SU-2023:1599-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-26545");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1599-1");

  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 32 for SLE 12 SP4) (SUSE-SU-2023:1599-1)");
...
the SUSE-SU-2023:1599-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-March/014200.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?94978cb3");
  script_set_attribute(attribute:"solution", value:
"Update the affected kernel-livepatch-4_12_14-150100_197_134-default, kgraft-patch-4_12_14-122_150-default and / or
kgraft-patch-4_12_14-95_114-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.150-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_150-default-2-2.3', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '4.12.14-150100.197.134-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150100_197_134-default-2-150100.2.3', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      },
      '4.12.14-95.114-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_114-default-3-2.3', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-4_12_14-150100_197_134-default / etc');
}
