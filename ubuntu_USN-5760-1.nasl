...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : libxml2 vulnerabilities (USN-5760-1)");
...
vulnerabilities as referenced in the USN-5760-1 advisory.
    ...
    issue to cause a crash. (CVE-2022-2309)

    It was discovered that libxml2 incorrectly handled certain XML files. An attacker could possibly use this
    issue to expose sensitive information or cause a crash. (CVE-2022-40303)

    It was discovered that libxml2 incorrectly handled certain XML files. An attacker could possibly use this
    issue to execute arbitrary code. (CVE-2022-40304)
