...
# extracted from Fedora Security Advisory FEDORA-2023-eb60fcd505
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-eb60fcd505");
  script_xref(name:"IAVB", value:"2023-B-0080-S");

  script_name(english:"Fedora 38 : golang (2023-eb60fcd505)");
...
FEDORA-2023-eb60fcd505 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-eb60fcd505");
...
var pkgs = [
    {'reference':'golang-1.20.6-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
