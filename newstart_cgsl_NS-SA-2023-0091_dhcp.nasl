...
# extracted from ZTE advisory NS-SA-2023-0091. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.06 : dhcp Vulnerability (NS-SA-2023-0091)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.06, has dhcp packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/notice/NS-SA-2023-0091");
  script_set_attribute(attribute:"see_also", value:"https://security.gd-linux.com/info/CVE-2021-25217");
...
var pkgs = {
  'CGSL MAIN 6.06': [
    'dhcp-client-4.3.6-47.0.1.zncgsl6',
    'dhcp-common-4.3.6-47.0.1.zncgsl6',
    'dhcp-libs-4.3.6-47.0.1.zncgsl6'
  ]
};
