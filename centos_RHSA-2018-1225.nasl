...
# CentOS Errata and Security Advisory 2018:1225 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : librelp (CESA-2018:1225)");
...
and Kevin Backhouse (lgtm.com / Semmle) as the original reporters.");
  # https://lists.centos.org/pipermail/centos-announce/2018-May/022818.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd591664");
  script_set_attribute(attribute:"solution", value:
"Update the affected librelp packages.");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"librelp-1.2.7-3.el6_9.1")) flag++;
if (rpm_check(release:"CentOS-6", reference:"librelp-devel-1.2.7-3.el6_9.1")) flag++;
