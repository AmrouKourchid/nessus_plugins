...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : libxml2 (EulerOS-SA-2021-2193)");
...
the following vulnerabilities :
  ...
  - ** RESERVED ** This candidate has been reserved by an
    ...
    will be provided.(CVE-2021-3541)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2193
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f5a14a44");
...
"Update the affected libxml2 packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-3537");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-3541");
