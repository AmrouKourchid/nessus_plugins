...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"HT214118");
  ...
  script_name(english:"macOS 12.x < 12.7.6 Multiple Vulnerabilities (HT214118)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a macOS update that fixes multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of macOS / Mac OS X that is 12.x prior to 12.7.6. It is, therefore, affected by
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT214118");
...
"Upgrade to macOS 12.7.6 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-23261");
...
var constraints = [
  { 'fixed_version' : '12.7.6', 'min_version' : '12.0', 'fixed_display' : 'macOS Monterey 12.7.6' }
];
