...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : avahi (EulerOS-SA-2020-2004)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2004
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5015ca06");
...
pkgs = ["avahi-0.7-16.h7.eulerosv2r8",
        "avahi-autoipd-0.7-16.h7.eulerosv2r8",
        "avahi-glib-0.7-16.h7.eulerosv2r8",
        "avahi-libs-0.7-16.h7.eulerosv2r8"];
