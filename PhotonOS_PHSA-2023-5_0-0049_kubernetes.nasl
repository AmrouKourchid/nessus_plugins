...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Kubernetes PHSA-2023-5.0-0049");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'kubernetes-1.27.3-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'kubernetes-kubeadm-1.27.3-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'kubernetes-pause-1.27.3-1.ph5')) flag++;
