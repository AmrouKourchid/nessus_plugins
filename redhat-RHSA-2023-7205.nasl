...
# extracted from Red Hat Security Advisory RHSA-2023:7205. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7205");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"RHEL 8 : nodejs:20 (RHSA-2023:7205)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for nodejs:20.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:7205 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7205.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d9ab4220");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7205");
...
"Update the RHEL nodejs:20 package based on the guidance in RHSA-2023:7205.");
  ...
  script_cwe_id(22, 94, 200, 354, 400);
  ...
  'nodejs:20': [
    {
      ...
      'pkgs': [
        {'reference':'nodejs-20.8.1-1.module+el8.9.0+20473+c4e3d824', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-devel-20.8.1-1.module+el8.9.0+20473+c4e3d824', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-docs-20.8.1-1.module+el8.9.0+20473+c4e3d824', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'nodejs-full-i18n-20.8.1-1.module+el8.9.0+20473+c4e3d824', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        ...
        {'reference':'npm-10.1.0-1.20.8.1.1.module+el8.9.0+20473+c4e3d824', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
