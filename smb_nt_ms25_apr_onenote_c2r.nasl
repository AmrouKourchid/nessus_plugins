...
if (description)
{
  ...
  script_name(english:"Security Updates for Microsoft OneNote C2R (April 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft OneNote Products are affected by a security feature bypass vulnerability.");
  script_set_attribute(attribute:"description", value:
"The Microsoft OneNote Products are missing a security update. It is, therefore, affected by a security feature bypass
vulnerability.
...
manually perform an update.");
  ...
  script_dependencies("office_installed.nasl", "smb_hotfixes.nasl", "ms_bulletin_checks_possible.nasl", "onenote_installed.nbin");
