...
# extracted from Ubuntu Security Notice USN-2753-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : LXC vulnerability (USN-2753-1)");
...
USN-2753-1 advisory.
    ...
    Roman Fiedler discovered a directory traversal flaw in lxc-start. A local attacker with access to an LXC
    container could exploit this flaw to run programs inside the container that are not confined by AppArmor
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2753-1");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'liblxc1', 'pkgver': '1.0.7-0ubuntu0.5'},
    {'osver': '14.04', 'pkgname': 'lxc', 'pkgver': '1.0.7-0ubuntu0.5'},
    {'osver': '14.04', 'pkgname': 'lxc-dev', 'pkgver': '1.0.7-0ubuntu0.5'},
    {'osver': '14.04', 'pkgname': 'lxc-templates', 'pkgver': '1.0.7-0ubuntu0.5'},
    {'osver': '14.04', 'pkgname': 'lxc-tests', 'pkgver': '1.0.7-0ubuntu0.5'},
    {'osver': '14.04', 'pkgname': 'python3-lxc', 'pkgver': '1.0.7-0ubuntu0.5'}
];
