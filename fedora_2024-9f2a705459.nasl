...
# extracted from Fedora Security Advisory FEDORA-2024-9f2a705459
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9f2a705459");

  script_name(english:"Fedora 41 : micropython (2024-9f2a705459)");
...
FEDORA-2024-9f2a705459 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9f2a705459");
...
var pkgs = [
    {'reference':'micropython-1.22.2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
