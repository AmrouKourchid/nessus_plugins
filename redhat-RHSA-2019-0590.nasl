...
# extracted from Red Hat Security Advisory RHSA-2019:0590. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2019:0590");

  script_name(english:"RHEL 7 : ansible (RHSA-2019:0590)");
...
referenced in the RHSA-2019:0590 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1663497");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0590.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?febee341");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0590");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL ansible package based on the guidance in RHSA-2019:0590.");
