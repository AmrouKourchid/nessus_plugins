...
if (description)
{
  ...
  script_cve_id("CVE-2021-47024");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47024");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: vsock/virtio: free queued packets when
    ...
    socket from the af_vsock lists calling vsock_remove_sock(). [1]
    https://syzkaller.appspot.com/bug?extid=24452624fc4c571eedd9 (CVE-2021-47024)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47024");
