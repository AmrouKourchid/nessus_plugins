...
# extracted from Fedora Security Advisory FEDORA-2023-86dce75007
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-86dce75007");

  script_name(english:"Fedora 38 : zchunk (2023-86dce75007)");
...
FEDORA-2023-86dce75007 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-86dce75007");
...
var pkgs = [
    {'reference':'zchunk-1.3.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
