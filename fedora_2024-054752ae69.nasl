...
# extracted from Fedora Security Advisory FEDORA-2024-054752ae69
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-054752ae69");
  script_xref(name:"IAVA", value:"2024-A-0672-S");

  script_name(english:"Fedora 40 : buildah / podman (2024-054752ae69)");
...
FEDORA-2024-054752ae69 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-054752ae69");
...
var pkgs = [
    {'reference':'buildah-1.37.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'podman-5.2.5-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
