...
# extracted from Fedora Security Advisory FEDORA-2022-d93b3bd8b9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-d93b3bd8b9");

  script_name(english:"Fedora 36 : mingw-expat (2022-d93b3bd8b9)");
...
FEDORA-2022-d93b3bd8b9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-d93b3bd8b9");
...
var pkgs = [
    {'reference':'mingw-expat-2.4.9-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
