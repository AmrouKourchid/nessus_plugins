...
# extracted from Fedora Security Advisory FEDORA-2019-d03bae77f5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-d03bae77f5");

  script_name(english:"Fedora 28 : hostapd (2019-d03bae77f5)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d03bae77f5");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"hostapd-2.7-2.fc28")) flag++;
