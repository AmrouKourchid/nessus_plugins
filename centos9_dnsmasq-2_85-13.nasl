...
if (description)
{
  ...
  script_name(english:"CentOS 9 : dnsmasq-2.85-13.el9");
...
dnsmasq-2.85-13.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=35040");
...
var pkgs = [
    {'reference':'dnsmasq-2.85-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dnsmasq-utils-2.85-13.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
