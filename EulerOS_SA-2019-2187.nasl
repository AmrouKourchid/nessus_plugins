...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : SDL (EulerOS-SA-2019-2187)");
...
vulnerability :
  ...
  - SDL (Simple DirectMedia Layer) through 1.2.15 and 2.x
    ...
    SDL_SoftBlit in video/SDL_blit.c.(CVE-2019-13616)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2187
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a5e6e246");
...
pkgs = ["SDL-1.2.15-14.h4.eulerosv2r7",
        "SDL-devel-1.2.15-14.h4.eulerosv2r7"];
