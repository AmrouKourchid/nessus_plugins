...
"The remote Red Hat host is missing one or more security updates for python27-python / python27-python-pip.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_1663.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d9dd905");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2064442");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python27-python / python27-python-pip packages based on the guidance in RHSA-2022:1663.");
