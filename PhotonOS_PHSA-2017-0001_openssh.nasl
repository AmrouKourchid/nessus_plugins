...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openssh-7.4p1-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openssh-debuginfo-7.4p1-1.ph1')) flag++;
