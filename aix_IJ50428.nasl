...
if (description)
{
  ...
  script_name(english:"AIX (IJ50428)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AIX host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"The version of AIX installed on the remote host is prior to APAR IJ50428. It is, therefore, affected by a vulnerability
as referenced in the IJ50428 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/apar/IJ50428");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/7148150");
  script_set_attribute(attribute:"solution", value:
"Please apply the appropriate interim fix per APAR IJ50428.");
...
var constraints = [
    {'release': '4.1', 'ml': '00', 'sp': '10', 'patch': 'IJ50428s1a', 'package': 'bos.net.tcp.sendmail', 'minfilesetver': '7.3.2.0', 'maxfilesetver': '7.3.2.0'},
    {'release': '7.3', 'ml': '02', 'sp': '01', 'patch': 'IJ50428s1a', 'package': 'bos.net.tcp.sendmail', 'minfilesetver': '7.3.2.0', 'maxfilesetver': '7.3.2.0'}
];
