...
if (description)
{
  ...
  script_cve_id("CVE-2024-47544");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-47544");
...
patch available.
  ...
  - GStreamer is a library for constructing graphs of media-handling components. The function
    ...
    fixed in 1.24.10. (CVE-2024-47544)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss4_vector", value:"CVSS:4.0/AV:L/AC:L/AT:N/PR:N/UI:P/VC:N/VI:N/VA:H/SC:N/SI:N/SA:N");
  script_set_attribute(attribute:"cvss4_threat_vector", value:"CVSS:4.0/E:U");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-47544");
