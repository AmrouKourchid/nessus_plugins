...
# extracted from Red Hat Security Advisory RHSA-2024:2337. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:2337");

  script_name(english:"RHEL 9 : python3.11-cryptography (RHSA-2024:2337)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_2337.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6e118d1e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:2337");
...
"Update the RHEL python3.11-cryptography package based on the guidance in RHSA-2024:2337.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3.11-cryptography-37.0.2-6.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
