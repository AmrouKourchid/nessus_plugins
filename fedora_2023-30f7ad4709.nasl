...
# extracted from Fedora Security Advisory FEDORA-2023-30f7ad4709
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-30f7ad4709");

  script_name(english:"Fedora 37 : golang (2023-30f7ad4709)");
...
FEDORA-2023-30f7ad4709 advisory.

    go1.19.10 (released 2023-06-06) includes four security fixes to the cmd/go and runtime packages, as well
    as bug fixes to the compiler, the go command, and the runtime.  [See the milestone on the issue tracker
    for details](https://github.com/golang/go/issues?q=milestone%3AGo1.19.10+label%3ACherryPickApproved).

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-30f7ad4709");
...
var pkgs = [
    {'reference':'golang-1.19.10-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
