...
# extracted from Fedora Security Advisory FEDORA-2023-3c8c06b6bb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-3c8c06b6bb");

  script_name(english:"Fedora 40 : python3.11 (2023-3c8c06b6bb)");
...
FEDORA-2023-3c8c06b6bb advisory.

    Automatic update for python3.11-3.11.7-2.fc40.

    ##### **Changelog**

    ```
    * Mon Dec 18 2023 Lumr Balhar <lbalhar@redhat.com> - 3.11.7-2
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3c8c06b6bb");
...
var pkgs = [
    {'reference':'python3.11-3.11.7-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
