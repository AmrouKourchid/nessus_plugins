...
# extracted from Fedora Security Advisory FEDORA-2024-334b3be641
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-334b3be641");

  script_name(english:"Fedora 39 : selinux-policy (2024-334b3be641)");
...
FEDORA-2024-334b3be641 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-334b3be641");
  script_set_attribute(attribute:"solution", value:
"Update the affected selinux-policy package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:selinux-policy");
...
var pkgs = [
    {'reference':'selinux-policy-39.4-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
