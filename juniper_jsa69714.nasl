...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?75e0e453");
...
var vuln_ranges = [
  {'min_ver':'20.3', 'fixed_ver':'20.3R3-S3', 'model':'^(MX|QFX5)'},
  {'min_ver':'20.4', 'fixed_ver':'20.4R3-S2', 'model':'^(MX|QFX5)'},
  {'min_ver':'21.2', 'fixed_ver':'21.2R2-S1', 'model':'^(MX|QFX5)'}
];
