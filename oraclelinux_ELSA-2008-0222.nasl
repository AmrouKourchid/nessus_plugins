...
# Oracle Linux Security Advisory ELSA-2008-0222 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : firefox (ELSA-2008-0222)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2008-0222.html");
...
"Update the affected firefox and / or firefox-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-1380");
...
var pkgs = [
    {'reference':'firefox-1.5.0.12-15.el5_1.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-devel-1.5.0.12-15.el5_1.0.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-1.5.0.12-15.el5_1.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-devel-1.5.0.12-15.el5_1.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
