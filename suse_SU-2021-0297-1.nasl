...
# extracted from SUSE update advisory SUSE-SU-2021:0297-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : openvswitch (SUSE-SU-2021:0297-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85151183");
...
zypper in -t patch SUSE-OpenStack-Cloud-Crowbar-9-2021-297=1

SUSE OpenStack Cloud 9 :

zypper in -t patch SUSE-OpenStack-Cloud-9-2021-297=1

SUSE Linux Enterprise Server for SAP 12-SP4 :

zypper in -t patch SUSE-SLE-SAP-12-SP4-2021-297=1

SUSE Linux Enterprise Server 12-SP4-LTSS :

zypper in -t patch SUSE-SLE-SERVER-12-SP4-LTSS-2021-297=1");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:libopenvswitch-2_8");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:libopenvswitch-2_8-0-debuginfo");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"libopenvswitch-2_8-0-2.8.10-4.23.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libopenvswitch-2_8-0-debuginfo-2.8.10-4.23.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"openvswitch-2.8.10-4.23.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"openvswitch-debuginfo-2.8.10-4.23.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"openvswitch-debugsource-2.8.10-4.23.1")) flag++;
