...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Freetype2 PHSA-2025-5.0-0499");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'freetype2-2.13.3-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'freetype2-devel-2.13.3-1.ph5')) flag++;
