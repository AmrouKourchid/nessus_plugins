...
# extracted from Fedora Security Advisory FEDORA-2022-8b770865e3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8b770865e3");

  script_name(english:"Fedora 37 : drupal7-i18n (2022-8b770865e3)");
...
FEDORA-2022-8b770865e3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8b770865e3");
...
var pkgs = [
    {'reference':'drupal7-i18n-1.31-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
