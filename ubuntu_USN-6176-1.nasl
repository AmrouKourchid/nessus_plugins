...
vulnerability as referenced in the USN-6176-1 advisory.
    ...
    user or automated system were tricked into processing a specially crafted file, an attacker could possibly
    use this issue to consume system resources, resulting in a denial of service.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-pypdf2', 'pkgver': '1.25.1-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '16.04', 'pkgname': 'python3-pypdf2', 'pkgver': '1.25.1-1ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python-pypdf2', 'pkgver': '1.26.0-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '18.04', 'pkgname': 'python3-pypdf2', 'pkgver': '1.26.0-2ubuntu0.1~esm1', 'ubuntu_pro': TRUE},
    {'osver': '20.04', 'pkgname': 'python-pypdf2', 'pkgver': '1.26.0-3ubuntu1.20.04.1', 'ubuntu_pro': FALSE},
    {'osver': '20.04', 'pkgname': 'python3-pypdf2', 'pkgver': '1.26.0-3ubuntu1.20.04.1', 'ubuntu_pro': FALSE},
    {'osver': '22.04', 'pkgname': 'python3-pypdf2', 'pkgver': '1.26.0-4ubuntu0.22.04.1', 'ubuntu_pro': FALSE}
];
