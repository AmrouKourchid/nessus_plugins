...
# extracted from Red Hat Security Advisory RHSA-2023:0282. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0282");

  script_name(english:"RHEL 9 : sudo (RHSA-2023:0282)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0282.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6e085146");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2161142");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0282");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sudo package based on the guidance in RHSA-2023:0282.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.9.5p2-7.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-python-plugin-1.9.5p2-7.el9_1.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
