...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 11.0.0.M23 < 11.0.0 multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 11.0.0. It is, therefore, affected by multiple
vulnerabilities as referenced in the fixed_in_apache_tomcat_11.0.0_security-11 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3be4dfc");
  # https://github.com/apache/tomcat/commit/6d097a66746635df6880fe7662a792156b0eca14
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?534167c4");
  # https://tomcat.apache.org/security-11.html#Fixed_in_Apache_Tomcat_11.0.0
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d7964b84");
...
var constraints = [
  { 'min_version' : '11.0.0.M23', 'max_version' : '11.0.0.M26', 'fixed_version' : '11.0.0' }
];
