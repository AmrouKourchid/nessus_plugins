...
# extracted from Debian Security Advisory dla-3934. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3934 : heif-gdk-pixbuf - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dla-3934
advisory.
...
var pkgs = [
    {'release': '11.0', 'prefix': 'heif-gdk-pixbuf', 'reference': '1.11.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'heif-thumbnailer', 'reference': '1.11.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libheif-dev', 'reference': '1.11.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libheif-examples', 'reference': '1.11.0-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libheif1', 'reference': '1.11.0-1+deb11u1'}
];
