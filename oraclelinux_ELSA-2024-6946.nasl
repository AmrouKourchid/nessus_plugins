...
# extracted from Oracle Linux Security Advisory ELSA-2024-6946.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : grafana-pcp (ELSA-2024-6946)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-6946.html");
