...
if (description)
{
  ...
  script_name(english:"Adobe Premiere Pro < 13.1.3 Arbitrary code execution (APSB19-33)");
...
"The version of Adobe Premiere Pro installed on the remote Windows host is prior to 13.1.3. It is, therefore, affected by
a vulnerability as referenced in the APSB19-33 advisory.
