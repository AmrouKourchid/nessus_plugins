...
# extracted from Fedora Security Advisory FEDORA-2024-cd1f01e5d9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-cd1f01e5d9");
  script_xref(name:"IAVB", value:"2024-B-0061-S");

  script_name(english:"Fedora 40 : wireshark (2024-cd1f01e5d9)");
...
FEDORA-2024-cd1f01e5d9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-cd1f01e5d9");
...
var pkgs = [
    {'reference':'wireshark-4.2.5-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
