...
"The version of Firefox ESR installed on the remote Windows host is prior to 68.8. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2020-17 advisory. Note that Nessus has not tested for this issue but has
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'68.8', min:'68.0.0', severity:SECURITY_HOLE);
