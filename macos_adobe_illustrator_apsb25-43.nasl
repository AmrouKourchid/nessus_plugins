...
if (description)
{
  ...
  script_cve_id("CVE-2025-30330");

  script_name(english:"Adobe Illustrator < 28.7.6 / 29.0 < 29.4 Arbitrary code execution (APSB25-43) (macOS)");
...
"The version of Adobe Illustrator installed on the remote macOS host is prior to 28.7.6, 29.4. It is, therefore, affected
by a vulnerability as referenced in the APSB25-43 advisory.
  ...
  - Illustrator versions 29.3, 28.7.5 and earlier are affected by a Heap-based Buffer Overflow vulnerability
    ...
    issue requires user interaction in that a victim must open a malicious file. (CVE-2025-30330)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/illustrator/apsb25-43.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe Illustrator version 28.7.6, 29.4 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-30330");
...
var constraints = [
  { 'fixed_version' : '28.7.6', 'fixed_display' : '28.7.6 and above' },
  { 'min_version' : '29.0', 'fixed_version' : '29.4', 'fixed_display' : '29.4 and above' }
];
