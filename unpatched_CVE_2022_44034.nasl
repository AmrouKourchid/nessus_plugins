...
if (description)
{
  ...
  script_cve_id("CVE-2022-44034");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-44034");
...
patch available.
  ...
  - An issue was discovered in the Linux kernel through 6.0.6. drivers/char/pcmcia/scr24x_cs.c has a race
    condition and resultant use-after-free if a physically proximate attacker removes a PCMCIA device while
    calling open(), aka a race condition between scr24x_open() and scr24x_remove(). (CVE-2022-44034)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-44034");
