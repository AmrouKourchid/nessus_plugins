...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glibc-2.26-10.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glibc-debuginfo-2.26-10.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glibc-devel-2.26-10.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glibc-i18n-2.26-10.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glibc-iconv-2.26-10.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glibc-lang-2.26-10.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glibc-nscd-2.26-10.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'glibc-tools-2.26-10.ph2')) flag++;
