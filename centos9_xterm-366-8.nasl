...
if (description)
{
  ...
  script_name(english:"CentOS 9 : xterm-366-8.el9");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update for xterm.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 9 host has packages installed that are affected by a vulnerability as referenced in the
xterm-366-8.el9 build changelog.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=16884");
  script_set_attribute(attribute:"solution", value:
"Update the CentOS 9 Stream xterm package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:xterm-resize");
...
var pkgs = [
    {'reference':'xterm-366-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xterm-resize-366-8.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
