...
# extracted from Fedora Security Advisory FEDORA-2025-7d002ee0e7
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-46657");
  script_xref(name:"FEDORA", value:"2025-7d002ee0e7");

  script_name(english:"Fedora 41 : mupdf (2025-7d002ee0e7)");
...
FEDORA-2025-7d002ee0e7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-7d002ee0e7");
...
"Update the affected mupdf package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46657");
...
var pkgs = [
    {'reference':'mupdf-1.24.6-4.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
