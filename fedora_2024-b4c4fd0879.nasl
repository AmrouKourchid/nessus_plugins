...
# extracted from Fedora Security Advisory FEDORA-2024-b4c4fd0879
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b4c4fd0879");

  script_name(english:"Fedora 41 : python-webob (2024-b4c4fd0879)");
...
FEDORA-2024-b4c4fd0879 advisory.
    ...
    ```
    * Thu Aug 15 2024 Jn ONDREJ (SAL) <ondrejj(at)salstar.sk> - 1.8.8-1
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b4c4fd0879");
...
var pkgs = [
    {'reference':'python-webob-1.8.8-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
