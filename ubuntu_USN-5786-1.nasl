...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : GNOME Files vulnerability (USN-5786-1)");
...
referenced in the USN-5786-1 advisory.

    It was discovered that GNOME Files incorrectly handled certain filenames. An attacker could possibly use
    this issue to cause GNOME Files to crash, leading to a denial of service.
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gir1.2-nautilus-3.0 / libnautilus-extension-dev / etc');
}
