...
if (description)
{
  ...
  script_name(english:"RHCOS 4 : OpenShift Container Platform 4.13.1 (RHSA-2023:3303)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat CoreOS host is missing a security update for OpenShift Container Platform 4.13.1.");
...
referenced in the RHSA-2023:3303 advisory.
...
"Update the RHCOS OpenShift Container Platform 4.13.1 packages based on the guidance in RHSA-2023:3303.");
...
var pkgs = [
    {'reference':'cri-o-1.26.3-6.rhaos4.13.gitb3475fb.el8', 'release':'4', 'el_string':'el8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
    {'reference':'cri-o-1.26.3-7.rhaos4.13.gitb3475fb.el9', 'release':'4', 'el_string':'el9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
];
