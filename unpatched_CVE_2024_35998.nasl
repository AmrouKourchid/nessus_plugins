...
if (description)
{
  ...
  script_cve_id("CVE-2024-35998");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-35998");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: smb3: fix lock ordering potential
    deadlock in cifs_sync_mid_result Coverity spotted that the cifs_sync_mid_result function could deadlock
    Thread deadlock (ORDER_REVERSAL) lock_order: Calling spin_lock acquires lock TCP_Server_Info.srv_lock
    while holding lock TCP_Server_Info.mid_lock Addresses-Coverity: 1590401 (Thread deadlock
    (ORDER_REVERSAL)) (CVE-2024-35998)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-35998");
