...
# extracted from Red Hat Security Advisory sqlite. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2023-36191", "CVE-2024-0232");

  script_name(english:"RHEL 9 : sqlite (Unpatched Vulnerability) (deprecated)");
