...
# extracted from Red Hat Security Advisory RHSA-2021:3144. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-34485");
  script_xref(name:"RHSA", value:"2021:3144");
  script_xref(name:"IAVA", value:"2021-A-0379");
  script_xref(name:"IAVA", value:"2021-A-0380-S");

  script_name(english:"RHEL 7 : .NET Core 2.1 on Red Hat Enterprise Linux (RHSA-2021:3144)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:3144 advisory.
    ...
    are .NET Core SDK  2.1.525 and .NET Core Runtime 2.1.29.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_3144.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3f4b83c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3144");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet21-2.1-28.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-2.1.525-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-host-2.1.29-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-runtime-2.1-2.1.29-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-sdk-2.1-2.1.525-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-dotnet-sdk-2.1.5xx-2.1.525-1.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'},
      {'reference':'rh-dotnet21-runtime-2.1-28.el7_9', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet21'}
    ]
  }
];
