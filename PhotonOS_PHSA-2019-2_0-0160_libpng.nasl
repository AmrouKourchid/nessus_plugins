...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libpng PHSA-2019-2.0-0160");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libpng-1.6.29-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libpng-debuginfo-1.6.29-2.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'libpng-devel-1.6.29-2.ph2')) flag++;
