...
# Red Hat Security Advisory RHSA-2020:3241. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : firefox (CESA-2020:3241)");
...
pkgs = [
    {'reference':'firefox-68.11.0-1.el8_2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-68.11.0-1.el8_2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
