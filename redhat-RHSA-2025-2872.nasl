...
# extracted from Red Hat Security Advisory RHSA-2025:2872. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2025:2872");

  script_name(english:"RHEL 8 : pcs (RHSA-2025:2872)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for pcs.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2025:2872 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2025/rhsa-2025_2872.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7bed569");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2025:2872");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL pcs package based on the guidance in RHSA-2025:2872.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pcs-0.10.18-2.el8_10.4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcs-snmp-0.10.18-2.el8_10.4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
