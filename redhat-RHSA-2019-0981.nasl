...
referenced in the RHSA-2019:0981 advisory.

    Python is an interpreted, interactive, object-oriented programming language that supports modules,
    classes, exceptions, high-level dynamic data types, and dynamic typing.

    SQLAlchemy is an Object Relational Mapper (ORM) that provides a flexible, high-level interface to SQL
    databases.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0981.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?53a01fe4");
  # https://python-security.readthedocs.io/vuln/urlsplit-nfkc-normalization.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5717aed8");
...
"Update the RHEL python27:2.7 package based on the guidance in RHSA-2019:0981.");
  ...
  'python27:2.7': [
    {
      ...
      'pkgs': [
        {'reference':'babel-2.5.1-9.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-nose-docs-1.3.7-30.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-psycopg2-doc-2.7.5-7.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python-sqlalchemy-doc-1.3.2-1.module+el8.0.0+2974+76d21d2e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-2.7.15-22.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-attrs-17.4.0-10.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-babel-2.5.1-9.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-backports-1.0-15.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-backports-ssl_match_hostname-3.5.0.1-11.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-bson-3.6.1-9.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-chardet-3.0.4-10.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-coverage-4.5.1-4.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-Cython-0.28.1-7.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-debug-2.7.15-22.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-devel-2.7.15-22.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-dns-1.15.0-9.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-docs-2.7.15-4.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-docs-info-2.7.15-4.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-docutils-0.14-12.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-funcsigs-1.0.2-13.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-idna-2.5-7.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-ipaddress-1.0.18-6.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-jinja2-2.10-8.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-libs-2.7.15-22.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-lxml-4.2.3-3.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-markupsafe-0.23-19.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-mock-2.0.0-13.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-nose-1.3.7-30.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-numpy-1.14.2-10.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'python2-numpy-doc-1.14.2-10.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'python2-numpy-f2py-1.14.2-10.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
        {'reference':'python2-pip-9.0.3-13.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-pluggy-0.6.0-8.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-psycopg2-2.7.5-7.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-psycopg2-debug-2.7.5-7.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-psycopg2-tests-2.7.5-7.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-py-1.5.3-6.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-pygments-2.2.0-20.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-pymongo-3.6.1-9.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-pymongo-gridfs-3.6.1-9.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-PyMySQL-0.8.0-10.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-pysocks-1.6.8-6.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-pytest-3.4.2-13.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-pytest-mock-1.9.0-4.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-pytz-2017.2-12.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-pyyaml-3.12-16.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-requests-2.20.0-2.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-rpm-macros-3-38.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-scipy-1.0.0-19.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-setuptools-39.0.1-11.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-setuptools_scm-1.15.7-6.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-six-1.11.0-5.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-sqlalchemy-1.3.2-1.module+el8.0.0+2974+76d21d2e', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-test-2.7.15-22.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tkinter-2.7.15-22.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-tools-2.7.15-22.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-urllib3-1.23-7.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-virtualenv-15.1.0-18.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'python2-wheel-0.30.0-13.module+el8.0.0+2961+596d0223', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
      ]
    }
  ]
};
