...
# extracted from Red Hat Security Advisory RHSA-2023:7666. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7666");
  script_xref(name:"IAVB", value:"2023-B-0088-S");

  script_name(english:"RHEL 8 : postgresql:12 (RHSA-2023:7666)");
...
referenced in the RHSA-2023:7666 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7666.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b11d880e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7666");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql:12 package based on the guidance in RHSA-2023:7666.");
  ...
  script_cwe_id(190, 20, 89, 200, 400, 686);
  ...
  'postgresql:12': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'postgresql-12.17-1.module+el8.6.0+20721+c66fb2f5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-contrib-12.17-1.module+el8.6.0+20721+c66fb2f5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-docs-12.17-1.module+el8.6.0+20721+c66fb2f5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plperl-12.17-1.module+el8.6.0+20721+c66fb2f5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-plpython3-12.17-1.module+el8.6.0+20721+c66fb2f5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-pltcl-12.17-1.module+el8.6.0+20721+c66fb2f5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-12.17-1.module+el8.6.0+20721+c66fb2f5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-server-devel-12.17-1.module+el8.6.0+20721+c66fb2f5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-static-12.17-1.module+el8.6.0+20721+c66fb2f5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-12.17-1.module+el8.6.0+20721+c66fb2f5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-test-rpm-macros-12.17-1.module+el8.6.0+20721+c66fb2f5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-12.17-1.module+el8.6.0+20721+c66fb2f5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'postgresql-upgrade-devel-12.17-1.module+el8.6.0+20721+c66fb2f5', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
      ]
    }
  ]
};
