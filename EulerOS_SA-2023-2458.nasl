...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : tpm2-tss (EulerOS-SA-2023-2458)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2458
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e5aadcdc");
...
var pkgs = [
  "tpm2-tss-3.0.3-1.h2.eulerosv2r10"
];
