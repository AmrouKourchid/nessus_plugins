...
# extracted from openSUSE Security Update openSUSE-2020-2264.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gdm (openSUSE-2020-2264)");
...
"This update for gdm fixes the following issues :
  ...
  - CVE-2020-16125: Fixed a privilege escalation
    (bsc#1178150).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1178150");
  script_set_attribute(attribute:"solution", value:
"Update the affected gdm packages.");
...
if ( rpm_check(release:"SUSE15.1", reference:"gdm-3.26.2.1-lp151.16.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gdm-branding-upstream-3.26.2.1-lp151.16.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gdm-debuginfo-3.26.2.1-lp151.16.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gdm-debugsource-3.26.2.1-lp151.16.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gdm-devel-3.26.2.1-lp151.16.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gdm-lang-3.26.2.1-lp151.16.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"gdmflexiserver-3.26.2.1-lp151.16.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libgdm1-3.26.2.1-lp151.16.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libgdm1-debuginfo-3.26.2.1-lp151.16.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"typelib-1_0-Gdm-1_0-3.26.2.1-lp151.16.10.1") ) flag++;
