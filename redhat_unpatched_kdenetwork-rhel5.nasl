...
# extracted from Red Hat Security Advisory kdenetwork. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2014-6053");

  script_name(english:"RHEL 5 : kdenetwork (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-6053");
