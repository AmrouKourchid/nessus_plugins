...
if (description)
{
  ...
  script_cve_id("CVE-2022-2309", "CVE-2022-40303");

  script_name(english:"Photon OS 5.0: Libxml2 PHSA-2023-5.0-0018");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2022-40303");
...
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libxml2-2.11.4-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', cpu:'x86_64', reference:'libxml2-devel-2.11.4-1.ph5')) flag++;
