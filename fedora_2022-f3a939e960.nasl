...
# extracted from Fedora Security Advisory FEDORA-2022-f3a939e960
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-f3a939e960");

  script_name(english:"Fedora 37 : mingw-pixman (2022-f3a939e960)");
...
FEDORA-2022-f3a939e960 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-f3a939e960");
...
var pkgs = [
    {'reference':'mingw-pixman-0.42.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
