...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : polkit (EulerOS-SA-2019-1101)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1101
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ff1c991");
...
pkgs = ["polkit-0.112-12.h6",
        "polkit-devel-0.112-12.h6",
        "polkit-docs-0.112-12.h6"];
