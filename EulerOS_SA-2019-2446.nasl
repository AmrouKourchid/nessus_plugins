...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : ntp (EulerOS-SA-2019-2446)");
...
vulnerabilities :
  ...
  - NTP before 4.2.8p7 and 4.3.x before 4.3.92 allows
    remote attackers to cause a denial of service (prevent
    subsequent authentication) by leveraging knowledge of
    the controlkey or requestkey and sending a crafted
    packet to ntpd, which changes the value of trustedkey,
    controlkey, or requestkey. NOTE: this vulnerability
    exists because of a CVE-2016-2516
    regression.(CVE-2016-2517)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2446
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e2a35bb4");
...
"Update the affected ntp packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-7973");
...
pkgs = ["ntp-4.2.6p5-25.1.h21",
        "ntpdate-4.2.6p5-25.1.h21"];
