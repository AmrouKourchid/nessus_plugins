...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5051979");
  script_xref(name:"MSKB", value:"5052106");
  script_xref(name:"MSFT", value:"MS25-5051979");
  script_xref(name:"MSFT", value:"MS25-5052106");
  ...
  script_name(english:"KB5051979: Windows Server 2022 / Azure Stack HCI 22H2 Security Update (February 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5051979 or hotpatch 5052106. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5051979");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5051979");
...
if (
  smb_check_rollup(os:'10',
                   ...
                   rollup_date:'02_2025',
                   bulletin:bulletin,
                   rollup_kb_list:[5051979, 5052106])
)
{
