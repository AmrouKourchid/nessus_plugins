...
# extracted from SUSE update advisory SUSE-SU-2020:1898-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : MozillaFirefox (SUSE-SU-2020:1898-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1166238");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?661a00d4");
...
zypper in -t patch
SUSE-SLE-Module-Desktop-Applications-15-SP2-2020-1898=1

SUSE Linux Enterprise Module for Desktop Applications 15-SP1 :

zypper in -t patch
SUSE-SLE-Module-Desktop-Applications-15-SP1-2020-1898=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"MozillaFirefox-devel-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"MozillaFirefox-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"MozillaFirefox-branding-SLE-78-4.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"MozillaFirefox-debuginfo-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"MozillaFirefox-debugsource-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"MozillaFirefox-translations-common-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"MozillaFirefox-translations-other-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLES15", sp:"2", cpu:"x86_64", reference:"MozillaFirefox-devel-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"MozillaFirefox-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"MozillaFirefox-branding-SLE-78-4.14.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"MozillaFirefox-debuginfo-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"MozillaFirefox-debugsource-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"MozillaFirefox-translations-common-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"MozillaFirefox-translations-other-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"MozillaFirefox-devel-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"MozillaFirefox-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"MozillaFirefox-branding-SLE-78-4.14.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"MozillaFirefox-debuginfo-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"MozillaFirefox-debugsource-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"MozillaFirefox-translations-common-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"MozillaFirefox-translations-other-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLED15", sp:"2", cpu:"x86_64", reference:"MozillaFirefox-devel-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"MozillaFirefox-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"MozillaFirefox-branding-SLE-78-4.14.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"MozillaFirefox-debuginfo-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"MozillaFirefox-debugsource-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"MozillaFirefox-translations-common-78.0.1-3.94.2")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"MozillaFirefox-translations-other-78.0.1-3.94.2")) flag++;
