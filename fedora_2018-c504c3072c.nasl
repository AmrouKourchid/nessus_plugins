...
# extracted from Fedora Security Advisory FEDORA-2018-c504c3072c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-c504c3072c");

  script_name(english:"Fedora 29 : okular (2018-c504c3072c)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Security fix for CVE-2018-1000801

Note that Tenable Network Security has extracted the preceding
description block directly from the Fedora update system website.
Tenable has attempted to automatically clean and format it as much as
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-c504c3072c");
  script_set_attribute(attribute:"solution", value:
"Update the affected okular package.");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"okular-18.08.1-1.fc29")) flag++;
