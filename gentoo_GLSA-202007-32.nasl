...
# extracted from Gentoo Linux Security Advisory GLSA 202007-32.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-32");

  script_name(english:"GLSA-202007-32 : Sarg: Local privilege escalation");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202007-32
(Sarg: Local privilege escalation)

    A flaw in Sarg&rsquo;s handling of temporary directories was discovered.
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202007-32");
...
if (qpkg_check(package:"net-analyzer/sarg", unaffected:make_list("ge 2.4.0"), vulnerable:make_list("lt 2.4.0"))) flag++;
