...
# extracted from Red Hat Security Advisory xdg-utils. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : xdg-utils (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  # https://security.access.redhat.com/data/csaf/v2/vex/2022/cve-2022-4055.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c6e9848");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:xdg-utils");
