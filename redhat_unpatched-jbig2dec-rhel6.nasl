...
# extracted from Red Hat Security Advisory jbig2dec. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2017-7885", "CVE-2017-9216");

  script_name(english:"RHEL 6 : jbig2dec (Unpatched Vulnerability) (deprecated)");
