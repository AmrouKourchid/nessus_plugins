...
if (description)
{
  ...
  script_cve_id("CVE-2021-47352");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2021-47352");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: virtio-net: Add validation for used
    length This adds validation for used length (might come from an untrusted device) to avoid data corruption
    or loss. (CVE-2021-47352)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-47352");
