...
# extracted from Fedora Security Advisory FEDORA-2018-56ec0ccd82.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-56ec0ccd82");

  script_name(english:"Fedora 27 : feh (2018-56ec0ccd82)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-56ec0ccd82");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"feh-2.28-1.fc27")) flag++;
