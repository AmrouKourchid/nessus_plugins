...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Mongodb PHSA-2017-0052");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the mongodb package has been released.");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'mongodb-3.4.10-1.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'mongodb-debuginfo-3.4.10-1.ph1')) flag++;
