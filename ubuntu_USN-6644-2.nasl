...
# extracted from Ubuntu Security Notice USN-6644-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6644-2");

  script_name(english:"Ubuntu 22.04 LTS : LibTIFF vulnerabilities (USN-6644-2)");
...
the USN-6644-2 advisory.

    USN-6644-1 fixed vulnerabilities in LibTIFF. This update provides the corresponding updates for Ubuntu
    22.04 LTS.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6644-2");
...
var pkgs = [
    {'osver': '22.04', 'pkgname': 'libtiff-dev', 'pkgver': '4.3.0-6ubuntu0.8'},
    {'osver': '22.04', 'pkgname': 'libtiff-opengl', 'pkgver': '4.3.0-6ubuntu0.8'},
    {'osver': '22.04', 'pkgname': 'libtiff-tools', 'pkgver': '4.3.0-6ubuntu0.8'},
    {'osver': '22.04', 'pkgname': 'libtiff5', 'pkgver': '4.3.0-6ubuntu0.8'},
    {'osver': '22.04', 'pkgname': 'libtiff5-dev', 'pkgver': '4.3.0-6ubuntu0.8'},
    {'osver': '22.04', 'pkgname': 'libtiffxx5', 'pkgver': '4.3.0-6ubuntu0.8'}
];
