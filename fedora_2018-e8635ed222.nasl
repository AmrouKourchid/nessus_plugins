...
# extracted from Fedora Security Advisory FEDORA-2018-e8635ed222.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-e8635ed222");

  script_name(english:"Fedora 28 : unboundid-ldapsdk (2018-e8635ed222)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-e8635ed222");
  script_set_attribute(attribute:"solution", value:
"Update the affected unboundid-ldapsdk package.");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"unboundid-ldapsdk-4.0.5-1.fc28")) flag++;
