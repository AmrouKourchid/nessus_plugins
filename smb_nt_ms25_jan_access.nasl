...
if (description)
{
  ...
  script_cve_id("CVE-2025-21186", "CVE-2025-21366", "CVE-2025-21395");
  script_xref(name:"MSKB", value:"5002670");
  script_xref(name:"MSFT", value:"MS25-5002670");
  script_xref(name:"IAVA", value:"2025-A-0037-S");

  script_name(english:"Security Updates for Microsoft Access Products (January 2025)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Access Products are missing a security update.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Access Products are missing a security update. It is, therefore, affected by multiple remote code
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002670");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002670 to address this issue.");
...
var constraints = [
  { 'kb':'5002670', 'channel':'MSI', 'fixed_version': '16.0.5483.1000', 'sp' : 0}
];
