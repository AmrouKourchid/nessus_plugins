...
# extracted from Red Hat Security Advisory RHSA-2019:0483. The text 
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2019/rhsa-2019_0483.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?37732219");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:0483");
...
"Update the RHEL openssl package based on the guidance in RHSA-2019:0483.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssl-1.0.2k-16.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-devel-1.0.2k-16.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-libs-1.0.2k-16.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-perl-1.0.2k-16.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-static-1.0.2k-16.el7_6.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
