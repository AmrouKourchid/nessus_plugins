...
# extracted from Fedora Security Advisory FEDORA-2023-6ad6467a06
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-6ad6467a06");

  script_name(english:"Fedora 38 : vim (2023-6ad6467a06)");
...
FEDORA-2023-6ad6467a06 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-6ad6467a06");
...
var pkgs = [
    {'reference':'vim-9.0.1649-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
