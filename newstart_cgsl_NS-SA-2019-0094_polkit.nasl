...
# extracted from ZTE advisory NS-SA-2019-0094. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.06 : polkit Vulnerability (NS-SA-2019-0094)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.06, has polkit packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2019-0094");
