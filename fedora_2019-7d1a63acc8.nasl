...
# extracted from Fedora Security Advisory FEDORA-2019-7d1a63acc8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : ansible (2019-7d1a63acc8)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-7d1a63acc8");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"ansible-2.7.8-1.fc29")) flag++;
