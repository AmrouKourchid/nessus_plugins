...
# extracted from Red Hat Security Advisory RHSA-2024:0564. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-21698", "CVE-2023-28642");
  script_xref(name:"RHSA", value:"2024:0564");

  script_name(english:"RHEL 8 : container-tools:3.0 (RHSA-2024:0564)");
...
referenced in the RHSA-2024:0564 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0564.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73e5b75b");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/RHEL-17147");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0564");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL container-tools:3.0 package based on the guidance in RHSA-2024:0564.");
  ...
  'container-tools:3.0': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'runc-1.0.0-77.rc95.module+el8.4.0+21078+a96cfbf6', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'runc-1.0.0-77.rc95.module+el8.4.0+21078+a96cfbf6', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
