...
# AlmaLinux Security Advisory ALSA-2024:5529.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:5529");

  script_name(english:"AlmaLinux 9 : curl (ALSA-2024:5529)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-5529.html");
...
var pkgs = [
    {'reference':'curl-7.76.1-29.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'curl-minimal-7.76.1-29.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libcurl-7.76.1-29.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libcurl-devel-7.76.1-29.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'},
    {'reference':'libcurl-minimal-7.76.1-29.el9_4.1', 'release':'9', 'el_string':'el9_4', 'rpm_spec_vers_cmp':TRUE, 'epoch':'0'}
];
