...
# extracted from Fedora Security Advisory FEDORA-2024-c5b42e6462
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c5b42e6462");

  script_name(english:"Fedora 38 : rust-h2 (2024-c5b42e6462)");
...
FEDORA-2024-c5b42e6462 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c5b42e6462");
  script_set_attribute(attribute:"solution", value:
"Update the affected rust-h2 package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:rust-h2");
...
var pkgs = [
    {'reference':'rust-h2-0.3.26-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rust-h2');
}
