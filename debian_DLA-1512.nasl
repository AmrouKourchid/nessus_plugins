...
# extracted from Debian Security Advisory DLA-1512-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1512-1 : sympa security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2018/09/msg00023.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/sympa");
...
"Upgrade the affected sympa package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1000671");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"sympa", reference:"6.1.23~dfsg-2+deb8u3")) flag++;
