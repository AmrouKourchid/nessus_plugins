...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Nginx PHSA-2017-0038");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'nginx-1.11.13-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'nginx-debuginfo-1.11.13-4.ph1')) flag++;
