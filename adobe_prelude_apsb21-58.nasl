...
if (description)
{
  ...
  script_name(english:"Adobe Prelude < 10.1 Multiple Arbitrary code execution (APSB21-58)");

  script_set_attribute(attribute:"synopsis", value:
"The Adobe Prelude instance installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Prelude installed on the remote Windows host is prior to 10.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the APSB21-58 advisory.

  - Adobe Prelude version 10.0 (and earlier) is affected by a memory corruption vulnerability when parsing a
    ...
    that a victim must open a malicious file. (CVE-2021-35999)

  - Adobe Prelude version 10.0 (and earlier) are affected by an uninitialized variable vulnerability when
    ...
    requires user interaction in that a victim must open a malicious file. (CVE-2021-36007)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/prelude/apsb21-58.html");
