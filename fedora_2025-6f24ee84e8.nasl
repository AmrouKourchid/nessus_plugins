...
# extracted from Fedora Security Advisory FEDORA-2025-6f24ee84e8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-6f24ee84e8");

  script_name(english:"Fedora 41 : python-django (2025-6f24ee84e8)");
...
FEDORA-2025-6f24ee84e8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-6f24ee84e8");
...
var pkgs = [
    {'reference':'python-django-4.2.20-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
