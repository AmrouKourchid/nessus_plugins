...
# extracted from Gentoo Linux Security Advisory GLSA 201804-17.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201804-17");
  script_xref(name:"CEA-ID", value:"CEA-2019-0227");

  script_name(english:"GLSA-201804-17 : Quagga: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201804-17
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201804-17");
...
if (qpkg_check(package:"net-misc/quagga", unaffected:make_list("ge 1.2.4"), vulnerable:make_list("lt 1.2.4"))) flag++;
