...
# extracted from Fedora Security Advisory FEDORA-2024-ebf3fe7bc9
#
...
if (description)
{
  ...
  script_cve_id("CVE-2024-6232", "CVE-2024-8088");
  script_xref(name:"FEDORA", value:"2024-ebf3fe7bc9");

  script_name(english:"Fedora 41 : python3-docs / python3.13 (2024-ebf3fe7bc9)");
...
FEDORA-2024-ebf3fe7bc9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-ebf3fe7bc9");
...
var pkgs = [
    {'reference':'python3-docs-3.13.0~rc2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3.13-3.13.0~rc2-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-docs / python3.13');
}
