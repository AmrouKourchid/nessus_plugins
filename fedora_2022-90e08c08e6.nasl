...
# extracted from Fedora Security Advisory FEDORA-2022-90e08c08e6
#
...
if (description)
{
  ...
  script_cve_id("CVE-2022-3559", "CVE-2022-3620");
  script_xref(name:"IAVA", value:"2022-A-0338-S");
  script_xref(name:"FEDORA", value:"2022-90e08c08e6");

  script_name(english:"Fedora 37 : exim (2022-90e08c08e6)");
...
FEDORA-2022-90e08c08e6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-90e08c08e6");
...
"Update the affected exim package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-3620");
...
var pkgs = [
    {'reference':'exim-4.96-5.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
