...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : ImageMagick (EulerOS-SA-2022-2223)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2223
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc619134");
...
var pkgs = [
  "ImageMagick-6.9.9.38-3.h25.eulerosv2r8",
  "ImageMagick-c++-6.9.9.38-3.h25.eulerosv2r8",
  "ImageMagick-libs-6.9.9.38-3.h25.eulerosv2r8",
  "ImageMagick-perl-6.9.9.38-3.h25.eulerosv2r8"
];
