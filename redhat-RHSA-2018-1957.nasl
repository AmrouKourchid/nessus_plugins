...
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_1957.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0792a30c");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:1957");
...
"Update the RHEL git package based on the guidance in RHSA-2018:1957.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'emacs-git-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'emacs-git-el-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-all-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-bzr-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-cvs-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-daemon-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-email-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-gui-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-hg-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-p4-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'git-svn-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitk-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'gitweb-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Git-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'perl-Git-SVN-1.8.3.1-14.el7_5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
