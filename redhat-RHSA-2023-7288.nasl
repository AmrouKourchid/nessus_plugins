...
# extracted from Red Hat Security Advisory RHSA-2023:7288. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7288");
  script_xref(name:"CEA-ID", value:"CEA-2024-0004");

  script_name(english:"RHEL 8 : Red Hat Product OCP Tools 4.14 Openshift Jenkins (RHSA-2023:7288)");
...
referenced in the RHSA-2023:7288 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_7288.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d0274547");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7288");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.14.1699356715-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2022-25857', 'CVE-2022-29599', 'CVE-2022-42889', 'CVE-2023-24422', 'CVE-2023-25761', 'CVE-2023-25762', 'CVE-2023-39325', 'CVE-2023-44487']},
      {'reference':'jenkins-2.414.3.1699356615-3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'cves':['CVE-2023-39325', 'CVE-2023-44487']}
    ]
  }
];
