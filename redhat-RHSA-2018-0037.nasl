...
# extracted from Red Hat Security Advisory RHSA-2018:0037. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0037");
  script_xref(name:"IAVA", value:"2018-A-0020");
  script_xref(name:"IAVA", value:"2018-A-0017-S");

  script_name(english:"RHEL 6 : microcode_ctl (RHSA-2018:0037) (Spectre)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"An update for microcode_ctl is now available for Red Hat Enterprise
Linux 6.6 Advanced Update Support and Red Hat Enterprise Linux 6.6
Telco Extended Update Support.
...
issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0037");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"microcode_ctl-1.17-19.1.el6_6")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"microcode_ctl-debuginfo-1.17-19.1.el6_6")) flag++;
