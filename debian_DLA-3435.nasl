...
# extracted from Debian Security Advisory dla-3435. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3435 : rainloop - security update");
...
dla-3435 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3435-1                debian-lts@lists.debian.org
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/rainloop");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2019-13389");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-29360");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/rainloop");
...
"Upgrade the rainloop packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-13389");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:rainloop");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'rainloop', 'reference': '1.12.1-2+deb10u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rainloop');
}
