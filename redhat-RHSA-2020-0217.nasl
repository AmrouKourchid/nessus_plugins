...
# extracted from Red Hat Security Advisory RHSA-2020:0217. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:0217");

  script_name(english:"RHEL 7 : Ansible security update (2.7.16) (Moderate) (RHSA-2020:0217)");
...
referenced in the RHSA-2020:0217 advisory.
    ...
    * CVE-2019-14905 Ansible: malicious code could craft filename in nxos_file_copy module
    ...
    See: https://github.com/ansible/ansible/blob/v2.7.16/changelogs/CHANGELOG-v2.7.rst for details on bug
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_0217.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?74a081f8");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0217");
...
"Update the RHEL Ansible package based on the guidance in RHSA-2020:0217.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.7.16-1.el7ae', 'release':'7', 'el_string':'el7ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'ansible-2.7'}
    ]
  }
];
