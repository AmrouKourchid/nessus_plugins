...
# extracted from Fedora Security Advisory FEDORA-2022-cdeabe1bc0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-cdeabe1bc0");

  script_name(english:"Fedora 35 : postgresql-jdbc (2022-cdeabe1bc0)");
...
FEDORA-2022-cdeabe1bc0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-cdeabe1bc0");
...
var pkgs = [
    {'reference':'postgresql-jdbc-42.2.26-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
