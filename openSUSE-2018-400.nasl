...
# extracted from openSUSE Security Update openSUSE-2018-400.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : perl (openSUSE-2018-400)");
...
This update was imported from the SUSE:SLE-12:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1082216");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1082233");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1082234");
...
if ( rpm_check(release:"SUSE42.3", reference:"perl-5.18.2-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"perl-base-5.18.2-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"perl-base-debuginfo-5.18.2-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"perl-debuginfo-5.18.2-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"perl-debugsource-5.18.2-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"perl-32bit-5.18.2-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"perl-base-32bit-5.18.2-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"perl-base-debuginfo-32bit-5.18.2-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"perl-debuginfo-32bit-5.18.2-12.1") ) flag++;
