...
if (description)
{
  ...
  script_cve_id("CVE-2025-21818");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-21818 (deprecated)");
...
"n/a");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-21818");
