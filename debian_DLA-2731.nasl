...
dla-2731 advisory.
    ...
    One security issue affects WordPress, a weblog manager, versions between 3.7 and 5.7. This update fixes
    the following security issues: Object injection in PHPMailer (CVE-2020-36326 and CVE-2018-19296). For
    Debian 9 stretch, this problem has been fixed in version 4.7.21+dfsg-0+deb9u1. We recommend that you
    upgrade your wordpress packages. For the detailed security status of wordpress please refer to its
    security tracker page at: https://security-tracker.debian.org/tracker/wordpress Further information about
