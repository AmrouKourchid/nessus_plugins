...
# openSUSE Security Update openSUSE-SU-2022:0113-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : nodejs12 (openSUSE-SU-2022:0113-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the openSUSE-SU-2022:0113-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bbb77ccf");
...
var pkgs = [
    {'reference':'nodejs12-12.22.9-4.25.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nodejs12-devel-12.22.9-4.25.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'npm12-12.22.9-4.25.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
