...
if (description)
{
  ...
  script_name(english:"Security Updates for Azure CycleCloud (July 2024)");
...
version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?236350f4");
  # https://learn.microsoft.com/en-us/azure/cyclecloud/release-notes/8-6-2?view=cyclecloud-8
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67c18ac3");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released CycleCloud version 8.6.2 to address this issue");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-10086");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-38092");
...
var constraints = [  
  {'min_version': '7.9.0', 'fixed_version': '8.6.2'}
];
