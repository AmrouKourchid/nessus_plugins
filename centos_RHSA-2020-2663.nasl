...
# extracted from Red Hat Security Advisory RHSA-2020:2663 and 
# CentOS Errata and Security Advisory 2020:2663 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : ntp (RHSA-2020:2663)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RHSA-2020:2663 advisory.
...
var pkgs = [
    {'reference':'ntp-4.2.6p5-29.el7.centos.2', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntp-4.2.6p5-29.el7.centos.2', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntp-doc-4.2.6p5-29.el7.centos.2', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntp-doc-4.2.6p5-29.el7.centos.2', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntp-perl-4.2.6p5-29.el7.centos.2', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntp-perl-4.2.6p5-29.el7.centos.2', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntpdate-4.2.6p5-29.el7.centos.2', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ntpdate-4.2.6p5-29.el7.centos.2', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sntp-4.2.6p5-29.el7.centos.2', 'cpu':'ppc64le', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sntp-4.2.6p5-29.el7.centos.2', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
