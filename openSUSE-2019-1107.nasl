...
Security issue fixed :
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1126340");
...
"Update the affected tor packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-8955");
...
if ( rpm_check(release:"SUSE15.0", reference:"tor-0.3.4.11-lp150.22.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"tor-debuginfo-0.3.4.11-lp150.22.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"tor-debugsource-0.3.4.11-lp150.22.1") ) flag++;
