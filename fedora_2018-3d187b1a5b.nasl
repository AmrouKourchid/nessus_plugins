...
# extracted from Fedora Security Advisory FEDORA-2018-3d187b1a5b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-3d187b1a5b");

  script_name(english:"Fedora 27 : udisks2 (2018-3d187b1a5b)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-3d187b1a5b");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"udisks2-2.7.6-2.fc27")) flag++;
