...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : proftpd (EulerOS-SA-2025-1535)");
...
the following vulnerabilities :
    ...
    Buffer Overflow vulnerability in Proftpd commit 4017eff8 allows a remote attacker to execute arbitrary
    code and can cause a Denial of Service (DoS) on the FTP service by sending a maliciously crafted message
    to the ProFTPD service port.(CVE-2024-57392)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1535
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2fcbc005");
...
var pkgs = [
  "proftpd-1.3.7a-1.h12.eulerosv2r10"
];
