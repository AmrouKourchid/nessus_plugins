...
# openSUSE Security Update openSUSE-SU-2025:0117-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2025-2592");

  script_name(english:"openSUSE 15 Security Update : doomsday (openSUSE-SU-2025:0117-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1239917");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/S3ZMAN5677TB6D5IC67FGAVTSCVBDT3B/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?15ee0872");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2025-2592");
  script_set_attribute(attribute:"solution", value:
"Update the affected doomsday package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:doomsday");
...
var pkgs = [
    {'reference':'doomsday-2.3.1-bp156.4.3.1', 'release':'SUSE15.6', 'rpm_spec_vers_cmp':TRUE}
];
