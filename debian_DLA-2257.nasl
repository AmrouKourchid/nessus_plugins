...
# extracted from Debian Security Advisory DLA-2257-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2257-1 : pngquant security update");
...
introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://lists.debian.org/debian-lts-announce/2020/06/msg00028.html");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/pngquant");
  script_set_attribute(attribute:"solution", value:
"Upgrade the affected pngquant package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-5735");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:pngquant");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"pngquant", reference:"2.3.0-1+deb8u1")) flag++;
