...
# extracted from Fedora Security Advisory FEDORA-2023-105880e618
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-105880e618");

  script_name(english:"Fedora 37 : llhttp / python-aiohttp (2023-105880e618)");
...
FEDORA-2023-105880e618 advisory.

    Update `llhttp` to 8.1.1 (including a SONAME version bump and ABI break,
    https://pagure.io/fesco/issue/3049) and `python-aiohttp` to 3.8.5. Fixes CVE-2023-30589.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-105880e618");
...
var pkgs = [
    {'reference':'llhttp-8.1.1-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python-aiohttp-3.8.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
