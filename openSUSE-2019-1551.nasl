...
# extracted from openSUSE Security Update openSUSE-2019-1551.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : neovim (openSUSE-2019-1551)");
...
if ( rpm_check(release:"SUSE15.1", reference:"neovim-0.3.5-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"neovim-debuginfo-0.3.5-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"neovim-debugsource-0.3.5-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"neovim-lang-0.3.5-lp151.2.3.1") ) flag++;
