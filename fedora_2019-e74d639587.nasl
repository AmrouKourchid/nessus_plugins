...
# extracted from Fedora Security Advisory FEDORA-2019-e74d639587.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-e74d639587");

  script_name(english:"Fedora 29 : libxslt (2019-e74d639587)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e74d639587");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libxslt-1.1.33-1.fc29")) flag++;
