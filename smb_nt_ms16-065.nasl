...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3142023");
  script_xref(name:"MSKB", value:"3142024");
  script_xref(name:"MSKB", value:"3142025");
  script_xref(name:"MSKB", value:"3142026");
  script_xref(name:"MSKB", value:"3142030");
  script_xref(name:"MSKB", value:"3142032");
  script_xref(name:"MSKB", value:"3142033");
  script_xref(name:"MSKB", value:"3142035");
  script_xref(name:"MSKB", value:"3142036");
  script_xref(name:"MSKB", value:"3142037");
  script_xref(name:"MSKB", value:"3156387");
  script_xref(name:"MSKB", value:"3156421");
  script_xref(name:"IAVB", value:"2016-B-0087-S");
...
allowing the attacker to decrypt encrypted SSL/TLS traffic.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6fda3559");
...
2.0 SP2, 3.5, 3.5.1, 4.5.2, 4.6, and 4.6.1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0149");
