...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05ef5c2c");
  # https://git.openssl.org/gitweb/?p=openssl.git;a=commitdiff;h=4d8a88c134df634ba610ff8db1eb8478ac5fd345
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58b324e2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.cve.org/CVERecord?id=CVE-2022-2274");
...
var constraints = [
  { 'min_version' : '3.0.0', 'fixed_version' : '3.0.5' },
  { 'min_version' : '3.0.4', 'fixed_version' : '3.0.5' }
];
