...
# extracted from Red Hat Security Advisory RHSA-2020:4330 and
# CentOS Errata and Security Advisory 2020:4330 respectively.
##
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (RHSA-2020:4330)");
...
var pkgs = [
    {'reference':'firefox-78.4.0-2.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
