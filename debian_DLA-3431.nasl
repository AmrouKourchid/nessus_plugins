...
if (description)
{
  ...
  script_name(english:"Debian dla-3431 : libsqlite-tcl - security update");
...
dla-3431 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3431-1                debian-lts@lists.debian.org
...
"Upgrade the libsqlite-tcl packages.");
