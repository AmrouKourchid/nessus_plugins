...
# extracted from openSUSE Security Update openSUSE-2020-1128.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libraw (openSUSE-2020-1128)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1173674");
...
"Update the affected libraw packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-15503");
...
if ( rpm_check(release:"SUSE15.2", reference:"libraw-debuginfo-0.18.9-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libraw-debugsource-0.18.9-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libraw-devel-0.18.9-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libraw-devel-static-0.18.9-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libraw-tools-0.18.9-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libraw-tools-debuginfo-0.18.9-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libraw16-0.18.9-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libraw16-debuginfo-0.18.9-lp152.5.3.1") ) flag++;
