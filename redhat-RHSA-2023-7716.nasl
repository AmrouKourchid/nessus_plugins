...
# extracted from Red Hat Security Advisory RHSA-2023:7716. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:7716");

  script_name(english:"RHEL 8 : webkit2gtk3 (RHSA-2023:7716)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:7716 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:7716");
...
var constraints = [
  {
    'repo_relative_urls': [
      ...
      'content/dist/rhel8/8.8/aarch64/supplementary/debug',
      'content/dist/rhel8/8.8/aarch64/supplementary/os',
      'content/dist/rhel8/8.8/aarch64/supplementary/source/SRPMS',
      ...
      'content/dist/rhel8/8.9/aarch64/supplementary/debug',
      'content/dist/rhel8/8.9/aarch64/supplementary/os',
      'content/dist/rhel8/8.9/aarch64/supplementary/source/SRPMS',
    ...
    'pkgs': [
      {'reference':'webkit2gtk3-2.40.5-1.el8_9.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-devel-2.40.5-1.el8_9.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-2.40.5-1.el8_9.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'webkit2gtk3-jsc-devel-2.40.5-1.el8_9.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
