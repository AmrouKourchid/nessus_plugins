...
# AlmaLinux Security Advisory ALSA-2024:11216.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2024:11216");
  script_xref(name:"RHSA", value:"2024:11216");
  script_xref(name:"IAVB", value:"2024-B-0132-S");

  script_name(english:"AlmaLinux 9 : containernetworking-plugins (ALSA-2024:11216)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2024-11216.html");
...
var pkgs = [
    {'reference':'containernetworking-plugins-1.5.1-3.el9_5', 'cpu':'aarch64', 'release':'9', 'el_string':'el9_5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
