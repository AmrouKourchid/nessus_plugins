...
# extracted from Fedora Security Advisory FEDORA-2022-e1ce6f6d88
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-e1ce6f6d88");

  script_name(english:"Fedora 37 : nbd (2022-e1ce6f6d88)");
...
FEDORA-2022-e1ce6f6d88 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-e1ce6f6d88");
...
var pkgs = [
    {'reference':'nbd-3.24-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
