...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : yum- (ELSA-2014-1004)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2014-1004.html");
...
"Update the affected yum-updatesd package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0022");
...
var pkgs = [
    {'reference':'yum-updatesd-0.9-6.el5_10', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'yum-updatesd-0.9-6.el5_10', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
