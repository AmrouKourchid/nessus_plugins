...
# extracted from Fedora Security Advisory FEDORA-2023-983329cf45
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-983329cf45");
  script_xref(name:"IAVA", value:"2023-A-0702-S");

  script_name(english:"Fedora 38 : firefox / nss (2023-983329cf45)");
...
FEDORA-2023-983329cf45 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-983329cf45");
...
var pkgs = [
    {'reference':'firefox-121.0-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'nss-3.95.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
