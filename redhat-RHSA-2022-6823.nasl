...
# extracted from Red Hat Security Advisory RHSA-2022:6823. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:6823");

  script_name(english:"RHEL 9 : Red Hat JBoss Enterprise Application Platform 7.4.7 Security update (Important) (RHSA-2022:6823)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:6823 advisory.
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_6823.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a62ed78a");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6823");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/JBEAP-23620");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-snakeyaml-1.31.0-1.redhat_00001.1.el9eap', 'release':'9', 'el_string':'el9eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2022-25857']},
      {'reference':'eap7-undertow-2.2.19-1.SP2_redhat_00001.1.el9eap', 'release':'9', 'el_string':'el9eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7', 'cves':['CVE-2022-1259', 'CVE-2022-2053']}
    ]
  }
];
