...
if (description)
{
  ...
  script_cve_id("CVE-2024-0321");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-0321");
...
patch available.
  ...
  - Stack-based Buffer Overflow in GitHub repository gpac/gpac prior to 2.3-DEV. (CVE-2024-0321)
