...
# extracted from Red Hat Security Advisory RHSA-2019:3756 and 
# CentOS Errata and Security Advisory 2019:3756 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : thunderbird (CESA-2019:3756)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2019-November/023514.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?161519fe");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-68.2.0-2.el6.centos", allowmaj:TRUE)) flag++;
