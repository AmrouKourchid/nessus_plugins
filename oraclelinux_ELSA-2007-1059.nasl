...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Important: / pcre (ELSA-2007-1059)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-1059.html");
...
"Update the affected pcre and / or pcre-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2006-7228");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2006-7225");
...
var pkgs = [
    {'reference':'pcre-6.6-2.el5_1.7', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pcre-devel-6.6-2.el5_1.7', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pcre-6.6-2.el5_1.7', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pcre-devel-6.6-2.el5_1.7', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
