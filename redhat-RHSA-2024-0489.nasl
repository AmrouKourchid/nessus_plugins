...
# extracted from Red Hat Security Advisory RHSA-2024:0489. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:0489");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.12.48 (RHSA-2024:0489)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for OpenShift Container Platform 4.12.48.");
...
the RHSA-2024:0489 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.12.48. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_0489.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b11d5908");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2251198");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:0489");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.12.48 packages based on the guidance in RHSA-2024:0489.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.25.5-6.rhaos4.12.gitfcf6ef3.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
