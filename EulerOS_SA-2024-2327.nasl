...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.12.0 : httpd (EulerOS-SA-2024-2327)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-2327
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe3d451b");
...
var pkgs = [
  "httpd-2.4.51-12.h9.eulerosv2r12",
  "httpd-filesystem-2.4.51-12.h9.eulerosv2r12",
  "httpd-tools-2.4.51-12.h9.eulerosv2r12",
  "mod_ssl-2.4.51-12.h9.eulerosv2r12"
];
