...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : e2fsprogs (EulerOS-SA-2020-1665)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1665
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?366dee3a");
...
pkgs = ["e2fsprogs-1.42.9-9.h1",
        "e2fsprogs-devel-1.42.9-9.h1",
        "e2fsprogs-libs-1.42.9-9.h1",
        "libcom_err-1.42.9-9.h1",
        "libcom_err-devel-1.42.9-9.h1",
        "libss-1.42.9-9.h1"];
