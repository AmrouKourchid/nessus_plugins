...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : 389-ds-base (EulerOS-SA-2018-1077)");
...
vulnerabilities :
  ...
  - It was found that 389-ds-base since 1.3.6.1 up to and
    including 1.4.0.3 did not always handle internal hash
    comparison operations correctly during the
  ...
  - An out-of-bounds memory read flaw was found in the way
    ...
    service.(CVE-2018-1054)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1077
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c290dc38");
...
pkgs = ["389-ds-base-1.3.5.10-20.h3",
        "389-ds-base-libs-1.3.5.10-20.h3"];
