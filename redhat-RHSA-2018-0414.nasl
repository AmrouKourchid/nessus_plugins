...
# extracted from Red Hat Security Advisory RHSA-2018:0414. The text 
...
referenced in the RHSA-2018:0414 advisory.
    ...
    * Previously, if an administrator configured an index for an attribute with a specific matching rule in
    the nsMatchingRule parameter, Directory Server did not use the retrieved indexer. As a consequence,
    Directory Server did not index the values of this attribute with the specified matching rules, and
    searches with extended filters were unindexed. With this update, Directory Server uses the retrieved
    indexer that processes the specified matching rule. As a result, searches using extended filters with a
    specified matching rule are now indexed. (BZ#1536343)

Tenable has extracted the preceding description block directly from the Red Hat Enterprise Linux security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2018/rhsa-2018_0414.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7c638e0b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:0414");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1525628");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1536343");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1537314");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL 389-ds-base package based on the guidance in RHSA-2018:0414.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'389-ds-base-1.3.6.1-28.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-devel-1.3.6.1-28.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-libs-1.3.6.1-28.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'389-ds-base-snmp-1.3.6.1-28.el7_4', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
