...
# extracted from Fedora Security Advisory FEDORA-2022-25f35ed634
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-25f35ed634");

  script_name(english:"Fedora 37 : protobuf (2022-25f35ed634)");
...
FEDORA-2022-25f35ed634 advisory.
    ...
    *    Added a man page for protoc
    ...
    See [PR](https://src.fedoraproject.org/rpms/protobuf/pull-request/16) for more details.

Tenable has extracted the preceding description block directly from the Fedora security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-25f35ed634");
  script_set_attribute(attribute:"solution", value:
"Update the affected protobuf package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:protobuf");
...
var pkgs = [
    {'reference':'protobuf-3.19.6-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
