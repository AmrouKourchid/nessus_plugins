...
# extracted from Fedora Security Advisory FEDORA-2019-758824a3ff.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : python2 / python2-docs (2019-758824a3ff)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-758824a3ff");
...
flag = 0;
if (rpm_check(release:"FC29", reference:"python2-2.7.17-1.fc29")) flag++;
if (rpm_check(release:"FC29", reference:"python2-docs-2.7.17-1.fc29")) flag++;
