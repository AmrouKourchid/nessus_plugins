...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : flatpak (EulerOS-SA-2020-1846)");
...
vulnerability :
  ...
  - Flatpak before 1.0.7, and 1.1.x and 1.2.x before 1.2.3,
    ...
    allows attackers to modify a host-side executable
    file.(CVE-2019-8308)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1846
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?864e184b");
...
pkgs = ["flatpak-1.0.3-1.h3.eulerosv2r8",
        "flatpak-libs-1.0.3-1.h3.eulerosv2r8"];
