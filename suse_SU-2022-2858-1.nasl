...
# SUSE update advisory SUSE-SU-2022:2858-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:2858-1");

  script_name(english:"SUSE SLES12 Security Update : rsync (SUSE-SU-2022:2858-1)");
...
in the SUSE-SU-2022:2858-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf15ba78");
...
var pkgs = [
    {'reference':'rsync-3.1.3-3.9.1', 'sp':'5', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5']},
    {'reference':'rsync-3.1.3-3.9.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.5']}
];
