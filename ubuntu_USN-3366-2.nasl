...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : OpenJDK 8 regression (USN-3366-2)");
...
USN-3366-2 advisory.
    ...
    USN-3366-1 fixed vulnerabilities in OpenJDK 8. Unfortunately, that update introduced a regression that
    caused some valid JAR files to fail validation. This update fixes the problem.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3366-2");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'openjdk-8-demo', 'pkgver': '8u131-b11-2ubuntu1.16.04.3'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk', 'pkgver': '8u131-b11-2ubuntu1.16.04.3'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jdk-headless', 'pkgver': '8u131-b11-2ubuntu1.16.04.3'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre', 'pkgver': '8u131-b11-2ubuntu1.16.04.3'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-headless', 'pkgver': '8u131-b11-2ubuntu1.16.04.3'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-jamvm', 'pkgver': '8u131-b11-2ubuntu1.16.04.3'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-jre-zero', 'pkgver': '8u131-b11-2ubuntu1.16.04.3'},
    {'osver': '16.04', 'pkgname': 'openjdk-8-source', 'pkgver': '8u131-b11-2ubuntu1.16.04.3'}
];
