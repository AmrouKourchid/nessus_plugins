...
# extracted from Fedora Security Advisory FEDORA-2024-305522ab38
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-305522ab38");

  script_name(english:"Fedora 41 : pypy (2024-305522ab38)");
...
FEDORA-2024-305522ab38 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-305522ab38");
...
var pkgs = [
    {'reference':'pypy-7.3.15-3.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
