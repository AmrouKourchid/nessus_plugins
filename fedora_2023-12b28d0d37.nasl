...
# extracted from Fedora Security Advisory FEDORA-2023-12b28d0d37
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-12b28d0d37");

  script_name(english:"Fedora 36 : chromium (2023-12b28d0d37)");
...
FEDORA-2023-12b28d0d37 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-12b28d0d37");
...
var pkgs = [
    {'reference':'chromium-113.0.5672.63-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
