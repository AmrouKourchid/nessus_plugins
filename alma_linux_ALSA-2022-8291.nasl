...
# AlmaLinux Security Advisory ALSA-2022:8291.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:8291");

  script_name(english:"AlmaLinux 9 : rsync (ALSA-2022:8291)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-8291.html");
