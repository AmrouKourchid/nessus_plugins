...
# extracted from Fedora Security Advisory FEDORA-2024-a53b24023d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-a53b24023d");

  script_name(english:"Fedora 39 : prometheus-podman-exporter (2024-a53b24023d)");
...
FEDORA-2024-a53b24023d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-a53b24023d");
...
var pkgs = [
    {'reference':'prometheus-podman-exporter-1.7.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
