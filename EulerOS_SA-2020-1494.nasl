...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : gpgme (EulerOS-SA-2020-1494)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the gpgme package installed, the EulerOS
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1494
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66bae05b");
  script_set_attribute(attribute:"solution", value:
"Update the affected gpgme package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3564");
...
pkgs = ["gpgme-1.3.2-5.h1.eulerosv2r7"];
