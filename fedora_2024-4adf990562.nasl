...
# extracted from Fedora Security Advisory FEDORA-2024-4adf990562
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-4adf990562");
  script_xref(name:"IAVA", value:"2024-A-0110-S");
  script_xref(name:"IAVA", value:"2024-A-0118-S");

  script_name(english:"Fedora 39 : chromium (2024-4adf990562)");
...
FEDORA-2024-4adf990562 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-4adf990562");
...
var pkgs = [
    {'reference':'chromium-122.0.6261.57-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
