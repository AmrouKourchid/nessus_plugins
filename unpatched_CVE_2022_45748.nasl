...
if (description)
{
  ...
  script_cve_id("CVE-2022-45748");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-45748");
...
patch available.
  ...
  - An issue was discovered with assimp 5.1.4, a use after free occurred in function
    ColladaParser::ExtractDataObjectFromChannel in file /code/AssetLib/Collada/ColladaParser.cpp.
    (CVE-2022-45748)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-45748");
