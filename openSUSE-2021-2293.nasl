...
# openSUSE Security Update openSUSE-SU-2021:2293-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : jdom2 (openSUSE-SU-2021:2293-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:2293-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dbd6b7e6");
...
pkgs = [
    {'reference':'jdom2-2.0.6-3.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jdom2-javadoc-2.0.6-3.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
