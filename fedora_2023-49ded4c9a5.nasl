...
# extracted from Fedora Security Advisory FEDORA-2023-49ded4c9a5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-49ded4c9a5");

  script_name(english:"Fedora 37 : python-oauthlib (2023-49ded4c9a5)");
...
FEDORA-2023-49ded4c9a5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-49ded4c9a5");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-oauthlib package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:python-oauthlib");
...
var pkgs = [
    {'reference':'python-oauthlib-3.2.2-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
