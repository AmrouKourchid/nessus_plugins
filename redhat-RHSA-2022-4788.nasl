...
# extracted from Red Hat Security Advisory RHSA-2022:4788. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:4788");

  script_name(english:"RHEL 8 : openvswitch2.16 (RHSA-2022:4788)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for openvswitch2.16.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2022:4788 advisory.
    ...
    * openvswitch2.16: DPDK: Out-of-bounds read/write in vhost_user_set_inflight_fd() may lead to crash
    (CVE-2021-3839)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_4788.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f37248f1");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:4788");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2025882");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2055097");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2055793");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2080273");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL openvswitch2.16 package based on the guidance in RHSA-2022:4788.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openvswitch2.16-2.16.0-74.el8fdp', 'release':'8', 'el_string':'el8fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openvswitch'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openvswitch2.16');
}
