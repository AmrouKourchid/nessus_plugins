...
# extracted from Fedora Security Advisory FEDORA-2023-c7f63322b5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-c7f63322b5");

  script_name(english:"Fedora 38 : kubernetes (2023-c7f63322b5)");
...
FEDORA-2023-c7f63322b5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-c7f63322b5");
...
var pkgs = [
    {'reference':'kubernetes-1.26.6-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
