...
# extracted from Red Hat Security Advisory RHSA-2021:4319. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4319");

  script_name(english:"RHEL 8 : compat-exiv2-026 (RHSA-2021:4319)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for compat-exiv2-026.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2021:4319 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4319.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?230a41df");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.5_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7240878e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4319");
...
"Update the RHEL compat-exiv2-026 package based on the guidance in RHSA-2021:4319.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'compat-exiv2-026-0.26-6.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
