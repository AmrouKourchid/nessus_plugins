...
material to unprivileged users.");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K24324390");
...
Solution K24324390.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-10011");
