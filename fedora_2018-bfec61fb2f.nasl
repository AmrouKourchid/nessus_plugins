...
# extracted from Fedora Security Advisory FEDORA-2018-bfec61fb2f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-bfec61fb2f");

  script_name(english:"Fedora 28 : 32:bind (2018-bfec61fb2f)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-bfec61fb2f");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"bind-9.11.3-12.fc28", epoch:"32")) flag++;
