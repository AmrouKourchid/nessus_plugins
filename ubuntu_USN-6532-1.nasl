...
# extracted from Ubuntu Security Notice USN-6532-1. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"6532-1");

  script_name(english:"Ubuntu 16.04 ESM : Linux kernel vulnerabilities (USN-6532-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-6532-1");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-1126-kvm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-1163-aws");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-248-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-4.4.0-248-lowlatency");
...
{
  audit(AUDIT_PATCH_INSTALLED, 'Kernel package for USN-6532-1');
}

if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  var cve_list = make_list('CVE-2023-5717', 'CVE-2023-20593', 'CVE-2023-31085', 'CVE-2023-39189', 'CVE-2023-39192', 'CVE-2023-39193', 'CVE-2023-39194', 'CVE-2023-42754', 'CVE-2023-45862', 'CVE-2023-45871');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for USN-6532-1');
  }
  else
  {
