...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : httpd (EulerOS-SA-2024-1936)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1936
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05a57150");
...
var pkgs = [
  "httpd-2.4.34-24.h20.eulerosv2r9",
  "httpd-filesystem-2.4.34-24.h20.eulerosv2r9",
  "httpd-tools-2.4.34-24.h20.eulerosv2r9",
  "mod_ssl-2.4.34-24.h20.eulerosv2r9"
];
