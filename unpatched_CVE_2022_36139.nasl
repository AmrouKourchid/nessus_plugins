...
if (description)
{
  ...
  script_cve_id("CVE-2022-36139");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-36139");
...
patch available.
  ...
  - SWFMill commit 53d7690 was discovered to contain a heap-buffer overflow via
    SWF::Writer::writeByte(unsigned char). (CVE-2022-36139)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-36139");
