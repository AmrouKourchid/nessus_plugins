...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : dnsmasq (EulerOS-SA-2024-1981)");
...
Tenable has extracted the preceding description block directly from the EulerOS Virtualization dnsmasq security
advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1981
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92a8bf33");
...
var pkgs = [
  "dnsmasq-2.82-5.h21.eulerosv2r10"
];
