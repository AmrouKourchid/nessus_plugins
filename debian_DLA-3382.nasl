...
# extracted from Debian Security Advisory dla-3382. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3382 : libopenimageio-dev - security update");
...
dla-3382 advisory.
    ...
    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3382-1                debian-lts@lists.debian.org
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libopenimageio-dev', 'reference': '2.0.5~dfsg0-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libopenimageio-doc', 'reference': '2.0.5~dfsg0-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libopenimageio2.0', 'reference': '2.0.5~dfsg0-1+deb10u1'},
    {'release': '10.0', 'prefix': 'openimageio-tools', 'reference': '2.0.5~dfsg0-1+deb10u1'},
    {'release': '10.0', 'prefix': 'python3-openimageio', 'reference': '2.0.5~dfsg0-1+deb10u1'}
];
