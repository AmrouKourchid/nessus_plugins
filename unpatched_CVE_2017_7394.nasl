...
if (description)
{
  ...
  script_cve_id("CVE-2017-7394");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2017-7394");
...
patch available.
  ...
  - In TigerVNC 1.7.1 (SSecurityPlain.cxx SSecurityPlain::processMsg), unauthenticated users can crash the
    server by sending long usernames. (CVE-2017-7394)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-7394");
