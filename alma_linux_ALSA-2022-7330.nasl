...
# AlmaLinux Security Advisory ALSA-2022:7330.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7330");

  script_name(english:"AlmaLinux 9 : kpatch-patch (ALSA-2022:7330)");
...
ALSA-2022:7330 advisory.

  - kernel: posix cpu timer use-after-free may lead to local privilege escalation (CVE-2022-2585)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-7330.html");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for ALSA-2022:7330');
  }
  else
  {
