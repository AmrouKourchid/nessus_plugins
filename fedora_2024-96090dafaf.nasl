...
# extracted from Fedora Security Advisory FEDORA-2024-96090dafaf
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-96090dafaf");

  script_name(english:"Fedora 38 : ncurses (2024-96090dafaf)");
...
FEDORA-2024-96090dafaf advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-96090dafaf");
...
"Update the affected ncurses package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:ncurses");
...
var pkgs = [
    {'reference':'ncurses-6.4-7.20230520.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
