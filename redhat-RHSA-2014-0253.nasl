...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : Red Hat JBoss Enterprise Application Platform 6.2.1 (RHSA-2014:0253)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat JBoss Enterprise Application Platform 6.2.1.");
...
in the RHSA-2014:0253 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2014/rhsa-2014_0253.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?290c6389");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0253");
...
"Update the RHEL Red Hat JBoss Enterprise Application Platform 6.2.1 package based on the guidance in RHSA-2014:0253.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jbossweb-7.3.0-2.Final_redhat_2.1.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jbossweb-7.3.0-2.Final_redhat_2.1.ep6.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  }
];
