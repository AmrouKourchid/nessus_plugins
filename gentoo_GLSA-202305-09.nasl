...
# extracted from Gentoo Linux Security Advisory GLSA 202305-09.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202305-09 : syslog-ng: Denial of Service");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202305-09");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=891941");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 3.38.1"),
    'vulnerable' : make_list("lt 3.38.1")
  }
];
