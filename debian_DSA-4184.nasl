...
are opened.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=878267");
  # https://security-tracker.debian.org/tracker/source-package/sdl-image1.2
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2ad8d43");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/jessie/sdl-image1.2");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/sdl-image1.2");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2018/dsa-4184");
...
in version 1.2.12-5+deb9u1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-3839");
