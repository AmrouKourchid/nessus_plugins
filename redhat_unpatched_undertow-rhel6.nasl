...
# extracted from Red Hat Security Advisory undertow. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2024-3653");

  script_name(english:"RHEL 6 : undertow (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-3653");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:undertow");
