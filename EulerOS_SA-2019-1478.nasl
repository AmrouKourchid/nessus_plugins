...
if (description)
{
  ...
  script_bugtraq_id(63183, 64471, 69216);
...
"Update the affected kernel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-0570");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-12233");
