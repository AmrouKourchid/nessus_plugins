...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : binutils (EulerOS-SA-2025-1406)");
...
the following vulnerabilities :
    ...
    patch is baac6c221e9d69335bf41366a1c7d87d8ab2f893. It is recommended to upgrade the affected
    component.(CVE-2025-0840)

    https://www.gnu.org/software/binutils/ nm =2.43 is affected by: Incorrect Access Control. The type of
    exploitation is: local. The component is: `nm --without-symbol-version` function.(CVE-2024-57360)

Tenable has extracted the preceding description block directly from the EulerOS binutils security advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1406
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d5edd80e");
...
var pkgs = [
  "binutils-2.37-14.h12.eulerosv2r12"
];
