...
# extracted from Red Hat Security Advisory RHSA-2013:0150. The text 
...
if (description)
{
  ...
  script_bugtraq_id(57155);
  script_xref(name:"RHSA", value:"2013:0150");

  script_name(english:"RHEL 5 / 6 : acroread (RHSA-2013:0150)");
...
referenced in the RHSA-2013:0150 advisory.

  - acroread: multiple code execution flaws (APSB13-02) (CVE-2012-1530, CVE-2013-0601, CVE-2013-0602,
    CVE-2013-0603, CVE-2013-0604, CVE-2013-0605, CVE-2013-0606, CVE-2013-0607, CVE-2013-0608, CVE-2013-0609,
    CVE-2013-0610, CVE-2013-0611, CVE-2013-0612, CVE-2013-0613, CVE-2013-0614, CVE-2013-0615, CVE-2013-0616,
    CVE-2013-0617, CVE-2013-0618, CVE-2013-0619, CVE-2013-0620, CVE-2013-0621, CVE-2013-0623, CVE-2013-0626,
    CVE-2013-1376)
...
number.");
  ...
  # https://access.redhat.com/security/data/csaf/v2/advisories/2013/rhsa-2013_0150.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?deb38eee");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0150");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#critical");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=893235");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL acroread package based on the guidance in RHSA-2013:0150.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:H/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1376");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'acroread-9.5.3-1.el6_3', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'acroread-plugin-9.5.3-1.el6_3', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'acroread-9.5.3-1.el5_9', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'acroread-plugin-9.5.3-1.el5_9', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
