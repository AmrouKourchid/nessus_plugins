...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.0.1 < 1.0.1k Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.0.1k. It is, therefore, affected by multiple
vulnerabilities as referenced in the 1.0.1k advisory.
...
var constraints = [
  { 'min_version' : '1.0.1', 'fixed_version' : '1.0.1k' },
  { 'min_version' : '1.0.1j', 'fixed_version' : '1.0.1k' }
];
