...
# extracted from Fedora Security Advisory FEDORA-2023-2121eca964
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-2121eca964");
  script_xref(name:"IAVA", value:"2023-A-0674-S");

  script_name(english:"Fedora 38 : curl (2023-2121eca964)");
...
FEDORA-2023-2121eca964 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-2121eca964");
...
var pkgs = [
    {'reference':'curl-8.0.1-6.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
