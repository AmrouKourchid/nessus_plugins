...
# SUSE update advisory SUSE-SU-2023:1645-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2023-1078");
  script_xref(name:"SuSE", value:"SUSE-SU-2023:1645-1");

  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 30 for SLE 15 SP3) (SUSE-SU-2023:1645-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2023-March/014210.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?65bea9f5");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150300.59.115-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_115-default-2-150300.2.3', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
