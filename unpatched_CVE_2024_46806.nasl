...
if (description)
{
  ...
  script_cve_id("CVE-2024-46806");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-46806");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm/amdgpu: Fix the warning division
    or modulo by zero Checks the partition mode and returns an error for an invalid mode. (CVE-2024-46806)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-46806");
