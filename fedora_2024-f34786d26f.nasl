...
# extracted from Fedora Security Advisory FEDORA-2024-f34786d26f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-f34786d26f");

  script_name(english:"Fedora 38 : python-aiohttp (2024-f34786d26f)");
...
FEDORA-2024-f34786d26f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f34786d26f");
...
var pkgs = [
    {'reference':'python-aiohttp-3.9.5-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
