...
# extracted from Fedora Security Advisory FEDORA-2023-99870af9f0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-99870af9f0");

  script_name(english:"Fedora 37 : OpenImageIO (2023-99870af9f0)");
...
FEDORA-2023-99870af9f0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-99870af9f0");
...
var pkgs = [
    {'reference':'OpenImageIO-2.4.14.0-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
