...
# extracted from Fedora Security Advisory FEDORA-2023-b0717d8c45
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-b0717d8c45");

  script_name(english:"Fedora 37 : flatpak (2023-b0717d8c45)");
...
FEDORA-2023-b0717d8c45 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-b0717d8c45");
...
var pkgs = [
    {'reference':'flatpak-1.14.4-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
