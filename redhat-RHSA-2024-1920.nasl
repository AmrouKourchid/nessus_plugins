...
# extracted from Red Hat Security Advisory RHSA-2024:1920. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:1920");

  script_name(english:"RHEL 9 : sssd (RHSA-2024:1920)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_1920.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc0e853e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:1920");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL sssd package based on the guidance in RHSA-2024:1920.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libipa_hbac-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_autofs-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_certmap-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_idmap-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_nss_idmap-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_nss_idmap-devel-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_simpleifp-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libsss_sudo-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libipa_hbac-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-libsss_nss_idmap-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-sss-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-sss-murmur-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-sssdconfig-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ad-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-client-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-common-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-common-pac-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-dbus-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-idp-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ipa-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-kcm-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-krb5-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-krb5-common-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-ldap-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-nfs-idmap-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-polkit-rules-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-proxy-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-tools-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sssd-winbind-idmap-2.8.2-5.el9_2.4', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
