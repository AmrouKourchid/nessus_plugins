...
# extracted from Red Hat Security Advisory RHSA-2021:4838. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:4838");

  script_name(english:"RHEL 8 : mailman:2.1 (RHSA-2021:4838)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for mailman:2.1.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2021:4838 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_4838.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7978d81f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:4838");
...
"Update the RHEL mailman:2.1 package based on the guidance in RHSA-2021:4838.");
  ...
  'mailman:2.1': [
    {
      ...
      'pkgs': [
        {'reference':'mailman-2.1.29-4.module+el8.1.0+13242+45286865.1', 'sp':'1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
      ]
    }
  ]
};
