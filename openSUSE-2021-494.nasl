...
# extracted from openSUSE Security Update openSUSE-2021-494.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : tar (openSUSE-2021-494)");
...
This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1181131");
...
if ( rpm_check(release:"SUSE15.2", reference:"tar-1.30-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tar-backup-scripts-1.30-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tar-debuginfo-1.30-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tar-debugsource-1.30-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tar-lang-1.30-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tar-rmt-1.30-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tar-rmt-debuginfo-1.30-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tar-tests-1.30-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tar-tests-debuginfo-1.30-lp152.4.3.1") ) flag++;
