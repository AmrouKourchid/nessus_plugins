...
# extracted from Red Hat Security Advisory RHSA-2023:1016. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1016");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.0 (openstack-cinder) (RHSA-2023:1016)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 17.0 (openstack-cinder).");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1016.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f6cf4d03");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1016");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.0 (openstack-cinder) package based on the guidance in RHSA-2023:1016.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-cinder-18.2.1-0.20230202190311.1776695.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python3-cinder-18.2.1-0.20230202190311.1776695.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python3-cinder-common-18.2.1-0.20230202190311.1776695.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openstack-cinder / python3-cinder / python3-cinder-common');
}
