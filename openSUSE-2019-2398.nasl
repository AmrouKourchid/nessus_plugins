...
# extracted from openSUSE Security Update openSUSE-2019-2398.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : lz4 (openSUSE-2019-2398)");
...
if ( rpm_check(release:"SUSE15.0", reference:"liblz4-1-1.8.0-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"liblz4-1-debuginfo-1.8.0-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"liblz4-devel-1.8.0-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"lz4-1.8.0-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"lz4-debuginfo-1.8.0-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"lz4-debugsource-1.8.0-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"liblz4-1-32bit-1.8.0-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", cpu:"x86_64", reference:"liblz4-1-32bit-debuginfo-1.8.0-lp150.2.3.1") ) flag++;
