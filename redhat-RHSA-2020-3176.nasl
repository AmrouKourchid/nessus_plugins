...
# extracted from Red Hat Security Advisory RHSA-2020:3176. The text
...
if (description)
{
  ...
  script_name(english:"RHEL 8 : postgresql-jdbc (RHSA-2020:3176)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_3176.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?911ad949");
...
"Update the RHEL postgresql-jdbc package based on the guidance in RHSA-2020:3176.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postgresql-jdbc-42.2.3-3.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-jdbc-javadoc-42.2.3-3.el8_2', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
