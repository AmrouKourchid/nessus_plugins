...
# extracted from Red Hat Security Advisory RHSA-2024:8312. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2024:8312");

  script_name(english:"RHEL 9 : NetworkManager-libreswan (RHSA-2024:8312)");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2024/rhsa-2024_8312.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?59a9927d");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2024:8312");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL NetworkManager-libreswan package based on the guidance in RHSA-2024:8312.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'NetworkManager-libreswan-1.2.14-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'NetworkManager-libreswan-gnome-1.2.14-3.el9_0', 'sp':'0', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
