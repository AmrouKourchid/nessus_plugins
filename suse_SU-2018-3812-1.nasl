...
# extracted from SUSE update advisory SUSE-SU-2018:3812-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 Security Update : libwpd (SUSE-SU-2018:3812-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20183812-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?934e79cc");
...
SUSE-SLE-WE-12-SP3-2018-2706=1

SUSE Linux Enterprise Software Development Kit 12-SP3:zypper in -t
patch SUSE-SLE-SDK-12-SP3-2018-2706=1

SUSE Linux Enterprise Desktop 12-SP3:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP3-2018-2706=1");
...
flag = 0;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"libwpd-0_10-10-0.10.2-2.7.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"libwpd-0_10-10-debuginfo-0.10.2-2.7.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"libwpd-debugsource-0.10.2-2.7.1")) flag++;
