...
# extracted from Oracle Linux Security Advisory ELSA-2024-8365.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : python-idna (ELSA-2024-8365)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-8365.html");
...
"Update the affected python-idna package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:python-idna");
...
var pkgs = [
    {'reference':'python-idna-2.4-1.0.1.el7', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
