...
# extracted from Red Hat Security Advisory spice-vdagent-win. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2013-2152");

  script_name(english:"RHEL 7 : spice-vdagent-win (Unpatched Vulnerability) (deprecated)");
...
"Plugin has been deprecated due to a change in logic. Coverage will be provided in a new plugin.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-2152");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:spice-vdagent-win");
