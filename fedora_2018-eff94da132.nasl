...
# extracted from Fedora Security Advisory FEDORA-2018-eff94da132.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : clamav (2018-eff94da132)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-eff94da132");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"clamav-0.100.2-2.fc28")) flag++;
