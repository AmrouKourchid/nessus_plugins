...
if (description)
{
  ...
  script_cve_id("CVE-2015-8387");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-8387");
...
patch available.
  ...
  - PCRE before 8.38 mishandles (?123) subroutine calls and related subroutine calls, which allows remote
    attackers to cause a denial of service (integer overflow) or possibly have unspecified other impact via a
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8387");
