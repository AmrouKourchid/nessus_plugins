...
if (description)
{
  ...
  script_name(english:"Google Chrome < 120.0.6099.217 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is prior to 120.0.6099.217. It is, therefore, affected
...
"Upgrade to Google Chrome version 120.0.6099.217 or later.");
...
google_chrome_check_version(installs:installs, fix:'120.0.6099.217', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
