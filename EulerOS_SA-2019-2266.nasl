...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : spice-gtk (EulerOS-SA-2019-2266)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2266
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?033bdbb0");
...
pkgs = ["spice-glib-0.31-6.2.h3",
        "spice-gtk3-0.31-6.2.h3"];
