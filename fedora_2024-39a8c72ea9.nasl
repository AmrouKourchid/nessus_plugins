...
# extracted from Fedora Security Advisory FEDORA-2024-39a8c72ea9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-39a8c72ea9");

  script_name(english:"Fedora 38 : python-paramiko (2024-39a8c72ea9)");
...
FEDORA-2024-39a8c72ea9 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-39a8c72ea9");
...
var pkgs = [
    {'reference':'python-paramiko-3.4.0-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
