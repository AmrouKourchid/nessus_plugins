...
# extracted from VMware Security Advisory PHSA-2023-5.0-0030. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 5.0: Apache PHSA-2023-5.0-0030");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the apache package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-5.0-30.md");
...
if (rpm_check(release:'PhotonOS-5.0', reference:'apache-tomcat-10.1.8-1.ph5')) flag++;
if (rpm_check(release:'PhotonOS-5.0', reference:'apache-tomcat-webapps-10.1.8-1.ph5')) flag++;
