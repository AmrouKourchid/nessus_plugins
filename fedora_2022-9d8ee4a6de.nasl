...
# extracted from Fedora Security Advisory FEDORA-2022-9d8ee4a6de
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-9d8ee4a6de");

  script_name(english:"Fedora 36 : php-twig2 (2022-9d8ee4a6de)");
...
FEDORA-2022-9d8ee4a6de advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-9d8ee4a6de");
  script_set_attribute(attribute:"solution", value:
"Update the affected php-twig2 package.");
...
var pkgs = [
    {'reference':'php-twig2-2.15.3-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE}
];
