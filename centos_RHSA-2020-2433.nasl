...
# CentOS Errata and Security Advisory 2020:2433 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : microcode_ctl (RHSA-2020:2433)");
...
var pkgs = [
    {'reference':'microcode_ctl-1.17-33.26.el6_10', 'cpu':'x86_64', 'release':'CentOS-6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
