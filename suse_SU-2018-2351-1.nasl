...
# extracted from SUSE update advisory SUSE-SU-2018:2351-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (SUSE-SU-2018:2351-1) (Foreshadow)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20182351-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ede73b35");
...
SUSE-SLE-SERVER-12-2018-1590=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"kgraft-patch-3_12_61-52_101-default-8-2.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"kgraft-patch-3_12_61-52_101-xen-8-2.1")) flag++;
