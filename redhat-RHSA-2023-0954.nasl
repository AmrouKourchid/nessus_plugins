...
# extracted from Red Hat Security Advisory RHSA-2023:0954. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:0954");

  script_name(english:"RHEL 9 : systemd (RHSA-2023:0954)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for systemd.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 9 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:0954 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0954.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6728d93e");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0954");
