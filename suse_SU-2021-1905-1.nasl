...
in the SUSE-SU-2021:1905-1 advisory.
...
var pkgs = [
    {'reference':'libspice-client-glib-2_0-8-0.31-9.13', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.2']},
    {'reference':'libspice-client-glib-helper-0.31-9.13', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.2']},
    {'reference':'libspice-client-gtk-2_0-4-0.31-9.13', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.2']},
    {'reference':'libspice-client-gtk-3_0-4-0.31-9.13', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.2']},
    {'reference':'libspice-controller0-0.31-9.13', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.2']},
    {'reference':'typelib-1_0-SpiceClientGlib-2_0-0.31-9.13', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.2']},
    {'reference':'typelib-1_0-SpiceClientGtk-3_0-0.31-9.13', 'sp':'2', 'cpu':'x86_64', 'release':'SLES_SAP12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.2']},
