...
# extracted from Ubuntu Security Notice USN-5223-2. The text
...
if (description)
{
  ...
  script_xref(name:"USN", value:"5223-2");

  script_name(english:"Ubuntu 16.04 ESM : Apache Log4j 1.2 vulnerability (USN-5223-2)");
...
USN-5223-2 advisory.
    ...
    USN-5223-1 fixed a vulnerability in Apache Log4j 1.2. This update provides the corresponding update for
    Ubuntu 16.04 ESM.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-5223-2");
