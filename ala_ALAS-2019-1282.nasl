...
# extracted from Amazon Linux AMI Security Advisory ALAS-2019-1282.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1282");

  script_name(english:"Amazon Linux AMI : php71 / php72,php73 (ALAS-2019-1282)");
...
implemented, it is possible that file being renamed is briefly
available with wrong permissions while the rename is ongoing, thus
enabling unauthorized users to access the data.(CVE-2019-9637)

An issue was discovered in the EXIF component in PHP before 7.1.27,
7.2.x before 7.2.16, and 7.3.x before 7.3.3. There is an Invalid Read
in exif_process_SOFn.(CVE-2019-9640)

Note: The Release Date is incorrect, These CVEs were fixed Mar. 2019");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2019-1282.html");
...
Run 'yum update php73' to update your system.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-9640");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"php71-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-bcmath-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-cli-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-common-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-dba-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-dbg-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-debuginfo-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-devel-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-embedded-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-enchant-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-fpm-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-gd-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-gmp-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-imap-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-intl-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-json-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-ldap-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-mbstring-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-mcrypt-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-mysqlnd-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-odbc-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-opcache-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-pdo-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-pdo-dblib-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-pgsql-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-process-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-pspell-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-recode-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-snmp-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-soap-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-tidy-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-xml-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php71-xmlrpc-7.1.27-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-bcmath-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-cli-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-common-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-dba-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-dbg-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-debuginfo-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-devel-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-embedded-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-enchant-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-fpm-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-gd-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-gmp-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-imap-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-intl-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-json-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-ldap-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-mbstring-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-mysqlnd-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-odbc-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-opcache-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-pdo-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-pdo-dblib-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-pgsql-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-process-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-pspell-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-recode-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-snmp-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-soap-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-tidy-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-xml-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-xmlrpc-7.2.16-1.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-bcmath-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-cli-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-common-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-dba-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-dbg-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-debuginfo-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-devel-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-embedded-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-enchant-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-fpm-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-gd-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-gmp-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-imap-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-intl-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-json-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-ldap-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-mbstring-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-mysqlnd-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-odbc-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-opcache-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-pdo-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-pdo-dblib-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-pgsql-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-process-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-pspell-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-recode-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-snmp-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-soap-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-tidy-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-xml-7.3.4-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-xmlrpc-7.3.4-1.14.amzn1")) flag++;
