...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : pango (ELSA-2009-0476)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-0476.html");
...
"Update the affected pango and / or pango-devel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-1194");
...
var pkgs = [
    {'reference':'pango-1.14.9-5.el5_3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pango-devel-1.14.9-5.el5_3', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pango-1.14.9-5.el5_3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pango-devel-1.14.9-5.el5_3', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
