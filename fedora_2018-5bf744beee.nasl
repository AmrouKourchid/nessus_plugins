...
# extracted from Fedora Security Advisory FEDORA-2018-5bf744beee.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : gd (2018-5bf744beee)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Patch Security fix for CVE-2018-1000222
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-5bf744beee");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"gd-2.2.5-6.fc28")) flag++;
