...
# extracted from Fedora Security Advisory FEDORA-2023-52aa3d1a4f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-52aa3d1a4f");

  script_name(english:"Fedora 39 : libppd (2023-52aa3d1a4f)");
...
FEDORA-2023-52aa3d1a4f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-52aa3d1a4f");
...
var pkgs = [
    {'reference':'libppd-2.0~rc2-4.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
