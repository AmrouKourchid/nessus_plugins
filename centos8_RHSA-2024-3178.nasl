...
# Red Hat Security Advisory RHSA-2024:3178. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : linux-firmware (CESA-2024:3178)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2024:3178 advisory.
...
var pkgs = [
    ...
    {'reference':'libertas-usb8388-firmware-20240111-121.gitb3132c18.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
