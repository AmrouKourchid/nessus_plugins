...
if (description)
{
  ...
  script_cve_id("CVE-2022-49638");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49638");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: icmp: Fix data-races around sysctl.
    While reading icmp sysctl variables, they can be changed concurrently. So, we need to add READ_ONCE() to
    avoid data-races. (CVE-2022-49638)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49638");
