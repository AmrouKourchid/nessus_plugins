...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL6.x i386/x86_64 (20200619)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2006&L=SCIENTIFIC-LINUX-ERRATA&P=6292
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?566b87e3");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"thunderbird-68.9.0-1.el6_10", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"thunderbird-debuginfo-68.9.0-1.el6_10", allowmaj:TRUE)) flag++;
