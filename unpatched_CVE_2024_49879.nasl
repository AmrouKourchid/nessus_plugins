...
if (description)
{
  ...
  script_cve_id("CVE-2024-49879");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-49879");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: drm: omapdrm: Add missing check for
    alloc_ordered_workqueue As it may return NULL pointer and cause NULL pointer dereference. Add check for
    the return value of alloc_ordered_workqueue. (CVE-2024-49879)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-49879");
