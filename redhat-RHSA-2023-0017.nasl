...
if (description)
{
  ...
  script_name(english:"RHEL 8 : OpenShift Container Platform 4.8.56 (RHSA-2023:0017)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.8.56.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2023:0017 advisory.

    Red Hat OpenShift Container Platform is Red Hat's cloud computing
    Kubernetes application platform solution designed for on-premise or private
    cloud deployments.

    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.8.56. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_0017.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7299f845");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2074855");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2103548");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2103551");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2114755");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2119642");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2119643");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2119644");
...
"Update the RHEL OpenShift Container Platform 4.8.56 packages based on the guidance in RHSA-2023:0017.");
  ...
  script_cwe_id(22, 79, 200, 208, 288, 322, 352, 410, 435, 668, 693, 862);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.8.1672842762-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-29047', 'CVE-2022-30945', 'CVE-2022-30946', 'CVE-2022-30948', 'CVE-2022-30952', 'CVE-2022-30953', 'CVE-2022-30954', 'CVE-2022-34176', 'CVE-2022-34177', 'CVE-2022-36881', 'CVE-2022-36882', 'CVE-2022-36883', 'CVE-2022-36884', 'CVE-2022-36885']},
      {'reference':'jenkins-2.361.1.1672840472-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-2048', 'CVE-2022-34174']}
    ]
  }
];
