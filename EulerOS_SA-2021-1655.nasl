...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : librepo (EulerOS-SA-2021-1655)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1655
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8983e49b");
...
pkgs = ["librepo-1.11.0-2.h3.eulerosv2r9",
        "python3-librepo-1.11.0-2.h3.eulerosv2r9"];
