...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Runc PHSA-2023-4.0-0391");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'runc-1.1.4-7.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'runc-doc-1.1.4-7.ph4')) flag++;
