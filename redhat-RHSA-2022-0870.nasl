...
# extracted from Red Hat Security Advisory RHSA-2022:0870. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2022-0532", "CVE-2022-0811");
  script_xref(name:"RHSA", value:"2022:0870");
  script_xref(name:"CEA-ID", value:"CEA-2022-0010");

  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.7.45 (RHSA-2022:0870)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.7.45.");
...
referenced in the RHSA-2022:0870 advisory.
    ...
    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.7.45. See the following
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0870.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1ba0ed7b");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0870");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2059475");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2064013");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#important");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.7.45 packages based on the guidance in RHSA-2022:0870.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.20.6-11.rhaos4.7.git76ea3d0.el8', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'cri-o-1.20.6-11.rhaos4.7.git76ea3d0.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'cri-o-1.20.6-11.rhaos4.7.git76ea3d0.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'cri-o-1.20.6-11.rhaos4.7.git76ea3d0.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
