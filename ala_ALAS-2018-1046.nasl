...
# extracted from Amazon Linux AMI Security Advisory ALAS-2018-1046.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : kernel (ALAS-2018-1046)");
...
copy can cause memory corruption or possible privilege escalation.
(CVE-2018-11412)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2018-1046.html");
