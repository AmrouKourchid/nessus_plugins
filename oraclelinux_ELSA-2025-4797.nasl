...
# extracted from Oracle Linux Security Advisory ELSA-2025-4797.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : thunderbird (ELSA-2025-4797)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2025-4797.html");
...
var pkgs = [
    {'reference':'thunderbird-128.10.0-1.0.1.el8_10', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-128.10.0-1.0.1.el8_10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
