...
# Red Hat Security Advisory RHSA-2023:0288. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : firefox (CESA-2023:0288)");
...
var pkgs = [
    {'reference':'firefox-102.7.0-1.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.7.0-1.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
