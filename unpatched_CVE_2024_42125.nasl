...
if (description)
{
  ...
  script_cve_id("CVE-2024-42125");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-42125");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: wifi: rtw89: fw: scan offload prohibit
    all 6 GHz channel if no 6 GHz sband We have some policy via BIOS to block uses of 6 GHz. In this case, 6
    GHz sband will be NULL even if it is WiFi 7 chip. So, add NULL handling here to avoid crash.
    (CVE-2024-42125)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-42125");
