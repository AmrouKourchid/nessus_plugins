...
# extracted from Red Hat Security Advisory RHSA-2023:2867. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2867");

  script_name(english:"RHEL 8 : postgresql-jdbc (RHSA-2023:2867)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for postgresql-jdbc.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:2867 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2867.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?17155073");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2867");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL postgresql-jdbc package based on the guidance in RHSA-2023:2867.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'postgresql-jdbc-42.2.14-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'postgresql-jdbc-javadoc-42.2.14-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
