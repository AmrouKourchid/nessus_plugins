...
# extracted from Oracle Linux Security Advisory ELSA-2024-9472.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 9 : grafana-pcp (ELSA-2024-9472)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2024-9472.html");
...
var pkgs = [
    {'reference':'grafana-pcp-5.1.1-9.el9_5', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'grafana-pcp-5.1.1-9.el9_5', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
