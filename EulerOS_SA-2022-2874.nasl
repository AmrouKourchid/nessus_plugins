...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libarchive (EulerOS-SA-2022-2874)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2874
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?becd9efc");
...
var pkgs = [
  "libarchive-3.4.3-2.h4.eulerosv2r10"
];
