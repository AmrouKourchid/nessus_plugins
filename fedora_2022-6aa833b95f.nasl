...
# extracted from Fedora Security Advisory FEDORA-2022-6aa833b95f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-6aa833b95f");

  script_name(english:"Fedora 38 : fasterxml-oss-parent / jackson-annotations / jackson-bom / etc (2022-6aa833b95f)");
...
FEDORA-2022-6aa833b95f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-6aa833b95f");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:fasterxml-oss-parent");
...
var pkgs = [
    {'reference':'fasterxml-oss-parent-49-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jackson-annotations-2.14.1-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jackson-bom-2.14.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jackson-core-2.14.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jackson-databind-2.14.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jackson-jaxrs-providers-2.14.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jackson-modules-base-2.14.1-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jackson-parent-2.14-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'fasterxml-oss-parent / jackson-annotations / jackson-bom / etc');
}
