...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : gnutls (EulerOS-SA-2024-1763)");
...
the following vulnerabilities :
    ...
    This flaw allows an unauthenticated, remote client or attacker to initiate a denial of service
    attack.(CVE-2024-0567)
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1763
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7abebbf0");
...
var pkgs = [
  "gnutls-3.7.2-6.h9.eulerosv2r12",
  "gnutls-utils-3.7.2-6.h9.eulerosv2r12"
];
