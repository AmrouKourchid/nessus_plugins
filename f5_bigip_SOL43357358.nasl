...
# extracted from F5 Networks BIG-IP Solution K43357358.
#
# @NOAGENT@
##
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : AMD processors vulnerability (K43357358)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K43357358 advisory.

    A potential vulnerability in some AMD processors using frequency scaling may allow an authenticated
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://my.f5.com/manage/s/article/K43357358");
...
Refer to the vendor for remediation guidance.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-23823");
