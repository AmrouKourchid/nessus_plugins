...
# extracted from Fedora Security Advisory FEDORA-2023-d01f8a69b4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-d01f8a69b4");

  script_name(english:"Fedora 38 : python3.10 (2023-d01f8a69b4)");
...
FEDORA-2023-d01f8a69b4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d01f8a69b4");
...
var pkgs = [
    {'reference':'python3.10-3.10.13-2.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
