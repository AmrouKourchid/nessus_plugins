...
# extracted from Fedora Security Advisory FEDORA-2023-bc61f7a145
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-bc61f7a145");

  script_name(english:"Fedora 38 : mod_security (2023-bc61f7a145)");
...
FEDORA-2023-bc61f7a145 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-bc61f7a145");
  script_set_attribute(attribute:"solution", value:
"Update the affected mod_security package.");
...
var pkgs = [
    {'reference':'mod_security-2.9.7-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
