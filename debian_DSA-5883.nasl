...
# extracted from Debian Security Advisory dsa-5883. The text
...
if (description)
{
  ...
  script_name(english:"Debian dsa-5883 : mercurial - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 12 host has packages installed that are affected by a vulnerability as referenced in the dsa-5883
advisory.

    - -------------------------------------------------------------------------
    Debian Security Advisory DSA-5883-1                   security@debian.org
    https://www.debian.org/security/                       Moritz Muehlenhoff
    March 22, 2025                        https://www.debian.org/security/faq
    - -------------------------------------------------------------------------
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/mercurial");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2025-2361");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bookworm/mercurial");
...
var pkgs = [
    {'release': '12.0', 'prefix': 'mercurial', 'reference': '6.3.2-1+deb12u1'},
    {'release': '12.0', 'prefix': 'mercurial-common', 'reference': '6.3.2-1+deb12u1'}
];
