...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : python-requests (EulerOS-SA-2023-3413)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3413
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cda1eccf");
...
var pkgs = [
  "python-requests-2.6.0-1.h3.eulerosv2r7"
];
