...
# extracted from Fedora Security Advisory FEDORA-2024-c5152808e4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c5152808e4");

  script_name(english:"Fedora 39 : pypy (2024-c5152808e4)");
...
FEDORA-2024-c5152808e4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c5152808e4");
...
var pkgs = [
    {'reference':'pypy-7.3.16-2.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
