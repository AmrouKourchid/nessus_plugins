...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : libjpeg-turbo (EulerOS-SA-2020-2359)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2359
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?784b4d4a");
...
pkgs = ["libjpeg-turbo-1.2.90-5.h5",
        "libjpeg-turbo-devel-1.2.90-5.h5"];
