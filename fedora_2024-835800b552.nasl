...
# extracted from Fedora Security Advisory FEDORA-2024-835800b552
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-835800b552");

  script_name(english:"Fedora 39 : c-ares (2024-835800b552)");
...
FEDORA-2024-835800b552 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-835800b552");
...
var pkgs = [
    {'reference':'c-ares-1.28.1-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
