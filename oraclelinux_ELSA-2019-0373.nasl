...
# extracted from Red Hat Security Advisory RHSA-2019:0373 and 
# Oracle Linux Security Advisory ELSA-2019-0373 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : firefox (ELSA-2019-0373)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2019-0373.html");
...
var pkgs = [
    {'reference':'firefox-60.5.1-1.0.1.el6_10', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
