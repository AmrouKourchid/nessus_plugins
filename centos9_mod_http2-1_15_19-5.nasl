...
if (description)
{
  ...
  script_name(english:"CentOS 9 : mod_http2-1.15.19-5.el9");
...
mod_http2-1.15.19-5.el9 build changelog.

  - HTTP request splitting with mod_rewrite and mod_proxy (CVE-2023-25690)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=36481");
...
var pkgs = [
    {'reference':'mod_http2-1.15.19-5.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
