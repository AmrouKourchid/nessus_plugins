...
# extracted from Fedora Security Advisory FEDORA-2024-c8c2a52fb8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c8c2a52fb8");
  script_xref(name:"IAVA", value:"2024-A-0053-S");

  script_name(english:"Fedora 39 : thunderbird (2024-c8c2a52fb8)");
...
FEDORA-2024-c8c2a52fb8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c8c2a52fb8");
...
var pkgs = [
    {'reference':'thunderbird-115.7.0-1.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
