...
# extracted from Debian Security Advisory dla-3256. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3256 : xdmx - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-4283");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-46340");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-46341");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-46342");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-46343");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-46344");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'xdmx', 'reference': '2:1.20.4-1+deb10u7'},
    {'release': '10.0', 'prefix': 'xdmx-tools', 'reference': '2:1.20.4-1+deb10u7'},
    {'release': '10.0', 'prefix': 'xnest', 'reference': '2:1.20.4-1+deb10u7'},
    {'release': '10.0', 'prefix': 'xorg-server-source', 'reference': '2:1.20.4-1+deb10u7'},
    {'release': '10.0', 'prefix': 'xserver-common', 'reference': '2:1.20.4-1+deb10u7'},
    {'release': '10.0', 'prefix': 'xserver-xephyr', 'reference': '2:1.20.4-1+deb10u7'},
    {'release': '10.0', 'prefix': 'xserver-xorg-core', 'reference': '2:1.20.4-1+deb10u7'},
    {'release': '10.0', 'prefix': 'xserver-xorg-dev', 'reference': '2:1.20.4-1+deb10u7'},
    {'release': '10.0', 'prefix': 'xserver-xorg-legacy', 'reference': '2:1.20.4-1+deb10u7'},
    {'release': '10.0', 'prefix': 'xvfb', 'reference': '2:1.20.4-1+deb10u7'},
    {'release': '10.0', 'prefix': 'xwayland', 'reference': '2:1.20.4-1+deb10u7'}
];
