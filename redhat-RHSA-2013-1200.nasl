...
# extracted from Red Hat Security Advisory RHSA-2013:1200. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:1200");

  script_name(english:"RHEL 6 : python-glanceclient (RHSA-2013:1200)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for python-glanceclient.");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=989738");
  # https://access.redhat.com/security/data/csaf/v2/advisories/2013/rhsa-2013_1200.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b745f0e9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:1200");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL python-glanceclient package based on the guidance in RHSA-2013:1200.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-4111");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-glanceclient-0.9.0-2.el6ost', 'release':'6', 'el_string':'el6ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python-glanceclient');
}
