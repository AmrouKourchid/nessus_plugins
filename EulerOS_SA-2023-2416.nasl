...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : python-mako (EulerOS-SA-2023-2416)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-mako package installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2416
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f37a286");
...
"Update the affected python-mako packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python-mako");
...
var pkgs = [
  "python-mako-0.8.1-2.eulerosv2r7.h1"
];
