...
# extracted from Red Hat Security Advisory RHSA-2023:1842. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1842");

  script_name(english:"RHEL 8 : curl (RHSA-2023:1842)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for curl.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:1842 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1842.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?def18632");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2167815");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1842");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL curl package based on the guidance in RHSA-2023:1842.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'curl-7.61.1-22.el8_6.6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-7.61.1-22.el8_6.6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-devel-7.61.1-22.el8_6.6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-minimal-7.61.1-22.el8_6.6', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
