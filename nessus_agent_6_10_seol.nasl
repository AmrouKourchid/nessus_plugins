...
if (description)
{
  ...
  script_name(english:"Tenable Nessus Agent SEoL (<= 6.10.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Tenable Nessus Agent is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Tenable Nessus Agent is less than or equal to 6.10.x. It is, therefore, no longer maintained
...
"Upgrade to a version of Tenable Nessus Agent that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2018/08/31");
...
var constraints = [
  { max_branch : '6.10', seol : 20180831, eseol : 20190228 }
];
