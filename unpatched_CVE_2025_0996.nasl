...
if (description)
{
  ...
  script_cve_id("CVE-2025-0996");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2025-0996");
...
patch available.
  ...
  - Inappropriate implementation in Browser UI in Google Chrome on Android prior to 133.0.6943.98 allowed a
    remote attacker to spoof the contents of the Omnibox (URL bar) via a crafted HTML page. (Chromium security
    severity: High) (CVE-2025-0996)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2025-0996");
