...
# extracted from Red Hat Security Advisory RHSA-2012:1538. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2012:1538");

  script_name(english:"RHEL 6 : Red Hat Network Satellite server jabberd (RHSA-2012:1538)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat Network Satellite server jabberd.");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2012/rhsa-2012_1538.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2bfa6b12");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2012:1538");
...
"Update the RHEL Red Hat Network Satellite server jabberd package based on the guidance in RHSA-2012:1538.");
