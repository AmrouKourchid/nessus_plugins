...
# extracted from Ubuntu Security Notice USN-2482-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2482-1");

  script_name(english:"Ubuntu 14.04 LTS : elfutils vulnerability (USN-2482-1)");
...
USN-2482-1 advisory.
    ...
    Alexander Cherepanov discovered that libelf1 incorrectly handled certain filesystem paths while extracting
    ar archives. An attacker could use this flaw to perform a directory traversal attack on the root directory
    if the process extracting the ar archive has write access to the root directory.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-2482-1");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-9447");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'elfutils', 'pkgver': '0.158-0ubuntu5.2'},
    {'osver': '14.04', 'pkgname': 'libasm-dev', 'pkgver': '0.158-0ubuntu5.2'},
    {'osver': '14.04', 'pkgname': 'libasm1', 'pkgver': '0.158-0ubuntu5.2'},
    {'osver': '14.04', 'pkgname': 'libdw-dev', 'pkgver': '0.158-0ubuntu5.2'},
    {'osver': '14.04', 'pkgname': 'libdw1', 'pkgver': '0.158-0ubuntu5.2'},
    {'osver': '14.04', 'pkgname': 'libelf-dev', 'pkgver': '0.158-0ubuntu5.2'},
    {'osver': '14.04', 'pkgname': 'libelf1', 'pkgver': '0.158-0ubuntu5.2'}
];
