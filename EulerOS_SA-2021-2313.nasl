...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : python-ipaddress (EulerOS-SA-2021-2313)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the python-ipaddress packages installed,
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2313
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fee6e2d4");
...
"Update the affected python-ipaddress package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python2-ipaddress");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python3-ipaddress");
...
pkgs = ["python2-ipaddress-1.0.18-5.h4.eulerosv2r8",
        "python3-ipaddress-1.0.18-5.h4.eulerosv2r8"];
