...
# extracted from Red Hat Security Advisory RHSA-2021:1752. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1752");

  script_name(english:"RHEL 8 : evolution (RHSA-2021:1752)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:1752 advisory.
    ...
    * evolution-data-server: NULL pointer dereference related to imapx_free_capability and
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1752.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?285c18b3");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.4_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?862005a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#low");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1752");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'evolution-3.28.5-16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-bogofilter-3.28.5-16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-data-server-3.28.5-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-data-server-devel-3.28.5-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'evolution-data-server-perl-3.28.5-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-data-server-tests-3.28.5-15.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-devel-3.28.5-16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'evolution-pst-3.28.5-16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'evolution-spamassassin-3.28.5-16.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'evolution-ews-3.28.5-10.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
