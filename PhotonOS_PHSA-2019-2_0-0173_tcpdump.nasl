...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Tcpdump PHSA-2019-2.0-0173");
...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'tcpdump-4.9.2-3.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'tcpdump-debuginfo-4.9.2-3.ph2')) flag++;
