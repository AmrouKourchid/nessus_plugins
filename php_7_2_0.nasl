...
if (description)
{
  ...
  script_name(english:"PHP 7.2.x < 7.2.0 Heap-based Buffer Overflow Vulnerability");
...
server is 7.0.x prior to 7.0.23. It is, therefore, affected by a
...
relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://php.net/ChangeLog-7.php#7.2.0");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PHP version 7.2.0 or later.");
...
constraints = [
  { "min_version" : "7.2.0alpha0", "fixed_version" : "7.2.0" }
];
