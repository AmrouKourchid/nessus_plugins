...
# extracted from Fedora Security Advisory FEDORA-2025-721a8bada2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-721a8bada2");

  script_name(english:"Fedora 40 : ovn (2025-721a8bada2)");
...
FEDORA-2025-721a8bada2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-721a8bada2");
...
var pkgs = [
    {'reference':'ovn-24.09.2-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
