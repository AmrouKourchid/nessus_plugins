...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 23.04 : FreeType vulnerability (USN-6062-1)");
...
referenced in the USN-6062-1 advisory.

    It was discovered that FreeType incorrectly handled certain malformed font files. If a user were tricked
    into using a specially crafted font file, a remote attacker could cause FreeType to crash, or possibly
