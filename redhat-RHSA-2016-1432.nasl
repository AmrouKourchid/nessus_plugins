...
referenced in the RHSA-2016:1432 advisory.
    ...
    the Amazon Web Services (AWS) Elastic Compute Cloud (EC2). With this update, the packages have been
    updated to ensure compatibility with Red Hat JBoss Enterprise Application Platform 6.4.9.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2016/rhsa-2016_1432.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b0160a25");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2016:1432");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jboss-ec2-eap-7.5.9-2.Final_redhat_2.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'},
      {'reference':'jboss-ec2-eap-samples-7.5.9-2.Final_redhat_2.ep6.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6'}
    ]
  }
];
