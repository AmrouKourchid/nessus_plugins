...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : binutils (EulerOS-SA-2023-3420)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-3420
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77da1db0");
...
var pkgs = [
  "binutils-2.31.1-13.h31.eulerosv2r8",
  "binutils-devel-2.31.1-13.h31.eulerosv2r8"
];
