...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : ghostscript (EulerOS-SA-2021-1434)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1434
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b148a282");
...
pkgs = ["ghostscript-9.07-31.6.h20.eulerosv2r7",
        "ghostscript-fonts-5.50-32.eulerosv2r7"];
