...
# extracted from Fedora Security Advisory FEDORA-2024-b5dd623284
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-b5dd623284");

  script_name(english:"Fedora 40 : chromium (2024-b5dd623284)");
...
FEDORA-2024-b5dd623284 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-b5dd623284");
...
var pkgs = [
    {'reference':'chromium-125.0.6422.112-2.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
