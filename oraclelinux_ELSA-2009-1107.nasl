...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : apr-util (ELSA-2009-1107)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2009-1107.html");
...
"Update the affected apr-util, apr-util-devel and / or apr-util-docs packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-1956");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2009-1955");
...
var pkgs = [
    {'reference':'apr-util-1.2.7-7.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'apr-util-devel-1.2.7-7.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'apr-util-docs-1.2.7-7.el5_3.1', 'cpu':'i386', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'apr-util-1.2.7-7.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'apr-util-devel-1.2.7-7.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'apr-util-docs-1.2.7-7.el5_3.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
