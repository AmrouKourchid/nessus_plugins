...
# extracted from Gentoo Linux Security Advisory GLSA 202107-34.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-34");

  script_name(english:"GLSA-202107-34 : FluidSynth: Remote code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-34
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-34"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All FluidSynth users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:fluidsynth");
...
if (qpkg_check(package:"media-sound/fluidsynth", unaffected:make_list("ge 2.2.0"), vulnerable:make_list("lt 2.2.0"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "FluidSynth");
}
