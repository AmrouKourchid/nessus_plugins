...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2018-2285.html");
...
var pkgs = [
    {'reference':'yum-NetworkManager-dispatcher-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-aliases-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-auto-update-debug-info-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-changelog-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-copr-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-fastestmirror-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-filter-data-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-fs-snapshot-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-keys-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-list-data-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-local-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-merge-conf-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-ovl-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-post-transaction-actions-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-pre-transaction-actions-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-priorities-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-protectbase-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-ps-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-remove-with-leaves-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-rpm-warm-cache-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-show-leaves-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-tmprepo-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-tsflags-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-upgrade-helper-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-verify-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-plugin-versionlock-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-updateonboot-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'yum-utils-1.1.31-46.0.1.el7_5', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
