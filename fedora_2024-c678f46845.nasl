...
# extracted from Fedora Security Advisory FEDORA-2024-c678f46845
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c678f46845");

  script_name(english:"Fedora 40 : python-zipp (2024-c678f46845)");
...
FEDORA-2024-c678f46845 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c678f46845");
...
var pkgs = [
    {'reference':'python-zipp-3.17.0-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
