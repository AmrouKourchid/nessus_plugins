...
# extracted from Fedora Security Advisory FEDORA-2022-bbd21c18ad
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-bbd21c18ad");

  script_name(english:"Fedora 37 : python2.7 (2022-bbd21c18ad)");
...
FEDORA-2022-bbd21c18ad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-bbd21c18ad");
...
var pkgs = [
    {'reference':'python2.7-2.7.18-22.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
