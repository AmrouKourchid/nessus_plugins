...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP12 : openjpeg2 (EulerOS-SA-2025-1302)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2025-1302
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d444fa82");
...
var pkgs = [
  "openjpeg2-2.5.0-1.h1.eulerosv2r12"
];
