...
# extracted from Fedora Security Advisory FEDORA-2023-63c69aa712
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-63c69aa712");
  script_xref(name:"IAVA", value:"2023-A-0283-S");

  script_name(english:"Fedora 37 : python3.11 (2023-63c69aa712)");
...
FEDORA-2023-63c69aa712 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-63c69aa712");
...
var pkgs = [
    {'reference':'python3.11-3.11.3-2.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
