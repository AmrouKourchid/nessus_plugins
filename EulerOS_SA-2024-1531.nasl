...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : mozjs60 (EulerOS-SA-2024-1531)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1531
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b844d900");
...
var pkgs = [
  "mozjs60-60.2.2-4.h14.eulerosv2r10"
];
