...
# extracted from Red Hat Security Advisory RHSA-2020:4539. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2020:4539");

  script_name(english:"RHEL 8 : pcre2 (RHSA-2020:4539)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for pcre2.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2020:4539 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_4539.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0691c1b9");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.3_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7e37d18");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:4539");
...
"Update the RHEL pcre2 package based on the guidance in RHSA-2020:4539.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'pcre2-10.32-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcre2-devel-10.32-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcre2-tools-10.32-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcre2-utf16-10.32-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'pcre2-utf32-10.32-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
