...
# extracted from Fedora Security Advisory FEDORA-2022-8cf76a9ceb
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-8cf76a9ceb");

  script_name(english:"Fedora 35 : xterm (2022-8cf76a9ceb)");
...
FEDORA-2022-8cf76a9ceb advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-8cf76a9ceb");
...
var pkgs = [
    {'reference':'xterm-375-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE}
];
