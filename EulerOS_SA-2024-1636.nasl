...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : python-pillow (EulerOS-SA-2024-1636)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1636
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7fa203f7");
...
var pkgs = [
  "python3-pillow-9.0.1-1.h5.eulerosv2r11"
];
