...
# extracted from Debian Security Advisory dla-4089. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-4089 : libxslt1-dev - security update");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libxslt1-dev', 'reference': '1.1.34-4+deb11u2'},
    {'release': '11.0', 'prefix': 'libxslt1.1', 'reference': '1.1.34-4+deb11u2'},
    {'release': '11.0', 'prefix': 'xsltproc', 'reference': '1.1.34-4+deb11u2'}
];
