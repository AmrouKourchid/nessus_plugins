...
if (description)
{
  ...
  script_cve_id("CVE-2015-8779");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2015-8779");
...
patch available.
  ...
  - Stack-based buffer overflow in the catopen function in the GNU C Library (aka glibc or libc6) before 2.23
    allows context-dependent attackers to cause a denial of service (application crash) or possibly execute
    arbitrary code via a long catalog name. (CVE-2015-8779)
