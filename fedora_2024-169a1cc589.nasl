...
# extracted from Fedora Security Advisory FEDORA-2024-169a1cc589
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-169a1cc589");
  script_xref(name:"IAVB", value:"2024-B-0095-S");

  script_name(english:"Fedora 40 : xen (2024-169a1cc589)");
...
FEDORA-2024-169a1cc589 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-169a1cc589");
...
var pkgs = [
    {'reference':'xen-4.18.2-4.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
