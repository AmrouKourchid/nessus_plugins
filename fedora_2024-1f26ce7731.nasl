...
# extracted from Fedora Security Advisory FEDORA-2024-1f26ce7731
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-1f26ce7731");

  script_name(english:"Fedora 40 : openvswitch (2024-1f26ce7731)");
...
FEDORA-2024-1f26ce7731 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1f26ce7731");
...
var pkgs = [
    {'reference':'openvswitch-3.3.0-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE}
];
