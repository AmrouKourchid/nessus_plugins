...
# extracted from Red Hat Security Advisory RHSA-2021:5036. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:5036");

  script_name(english:"RHEL 8 : virt:8.2 and virt-devel:8.2 (RHSA-2021:5036)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_5036.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fac432b5");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:5036");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/show_bug.cgi?id=1998514");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL virt:8.2 / virt-devel:8.2 packages based on the guidance in RHSA-2021:5036.");
  ...
  'virt:8.2': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'qemu-guest-agent-4.2.0-29.module+el8.2.1+13346+415e44e8.10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-img-4.2.0-29.module+el8.2.1+13346+415e44e8.10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-4.2.0-29.module+el8.2.1+13346+415e44e8.10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-curl-4.2.0-29.module+el8.2.1+13346+415e44e8.10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-gluster-4.2.0-29.module+el8.2.1+13346+415e44e8.10', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-iscsi-4.2.0-29.module+el8.2.1+13346+415e44e8.10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-rbd-4.2.0-29.module+el8.2.1+13346+415e44e8.10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-block-ssh-4.2.0-29.module+el8.2.1+13346+415e44e8.10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-common-4.2.0-29.module+el8.2.1+13346+415e44e8.10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
        {'reference':'qemu-kvm-core-4.2.0-29.module+el8.2.1+13346+415e44e8.10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
  ...
  'virt-devel:8.2': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'qemu-kvm-tests-4.2.0-29.module+el8.2.1+13346+415e44e8.10', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'15'},
