...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop 21.x < 21.2.3 Vulnerability (APSB20-63)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop installed on the remote Windows host is prior to 21.2.3. It is, therefore, affected by a
vulnerability as referenced in the apsb20-63 advisory.
