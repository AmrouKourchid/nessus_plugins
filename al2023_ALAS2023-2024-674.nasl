...
# extracted from Amazon Linux 2023 Security Advisory ALAS2023-2024-674.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2024-24786", "CVE-2024-29018", "CVE-2024-41110");
  script_xref(name:"IAVA", value:"2024-A-0438-S");

  script_name(english:"Amazon Linux 2023 : docker (ALAS2023-2024-674)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/AL2023/ALAS-2024-674.html");
...
"Run 'dnf update docker --releasever 2023.5.20240730' to update your system.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-41110");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2024-29018");
...
var pkgs = [
    {'reference':'docker-25.0.6-1.amzn2023.0.1', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-25.0.6-1.amzn2023.0.1', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-debuginfo-25.0.6-1.amzn2023.0.1', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-debuginfo-25.0.6-1.amzn2023.0.1', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-debugsource-25.0.6-1.amzn2023.0.1', 'cpu':'aarch64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'docker-debugsource-25.0.6-1.amzn2023.0.1', 'cpu':'x86_64', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE}
];
