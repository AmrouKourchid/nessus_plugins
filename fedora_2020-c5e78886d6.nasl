...
# extracted from Fedora Security Advisory FEDORA-2020-c5e78886d6.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : 14:tcpdump (2020-c5e78886d6)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-c5e78886d6");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"tcpdump-4.9.3-4.fc32", epoch:"14")) flag++;
