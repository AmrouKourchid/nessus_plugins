...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : xorg-x11-server (EulerOS-SA-2021-2016)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2016
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?306554ca");
...
pkgs = ["xorg-x11-server-Xorg-1.20.1-4.h9.eulerosv2r8",
