...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 10.0.0.M5 < 10.0.16 multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 10.0.16. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_10.0.16_security-10 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58bfc861");
  # https://tomcat.apache.org/security-10.html#Fixed_in_Apache_Tomcat_10.0.16
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77bb5895");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Apache Tomcat version 10.0.16 or later.");
...
var constraints = [
  { 'min_version' : '10.0.0.M5', 'max_version' : '10.0.14', 'fixed_version' : '10.0.16' }
];
