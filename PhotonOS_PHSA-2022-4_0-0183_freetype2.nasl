...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Freetype2 PHSA-2022-4.0-0183");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'freetype2-2.10.2-4.ph4')) flag++;
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'freetype2-devel-2.10.2-4.ph4')) flag++;
