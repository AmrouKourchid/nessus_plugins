...
if (description)
{
  ...
  script_name(english:"Adobe Reader < 2015.006.30497 / 2017.011.30142 / 2019.012.20034 Multiple Vulnerabilities (APSB19-18)");
...
"The version of Adobe Reader installed on the remote Windows host is a version prior to 2015.006.30497, 2017.011.30142,
or 2019.012.20034. It is, therefore, affected by multiple vulnerabilities.
...
"Upgrade to Adobe Reader version 2015.006.30497 / 2017.011.30142 / 2019.012.20034 or later.");
...
var constraints = [
  { 'min_version' : '15.6', 'max_version' : '15.006.30495', 'fixed_version' : '15.006.30497', 'track' : 'DC Classic' },
  { 'min_version' : '17.8', 'max_version' : '17.011.30140', 'fixed_version' : '17.011.30142', 'track' : 'DC Classic' },
  { 'min_version' : '15.7', 'max_version' : '19.010.20100', 'fixed_version' : '19.012.20034', 'track' : 'DC Continuous' }
];
