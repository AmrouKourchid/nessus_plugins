...
# extracted from Ubuntu Security Notice USN-2852-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2852-1");

  script_name(english:"Ubuntu 15.10 : linux-raspi2 vulnerability (USN-2852-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/2852-1/");
  script_set_attribute(attribute:"solution", value:
"Update the affected linux-image-4.2-raspi2 package.");
  script_set_attribute(attribute:"risk_factor", value:"High");

  script_set_attribute(attribute:"vuln_publication_date", value:"2015/12/19");
...
if (ubuntu_check(osver:"15.10", pkgname:"linux-image-4.2.0-1017-raspi2", pkgver:"4.2.0-1017.24")) flag++;
