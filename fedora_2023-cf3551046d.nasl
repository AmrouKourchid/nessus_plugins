...
# extracted from Fedora Security Advisory FEDORA-2023-cf3551046d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-cf3551046d");

  script_name(english:"Fedora 37 : moby-engine (2023-cf3551046d)");
...
FEDORA-2023-cf3551046d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-cf3551046d");
...
"Update the affected moby-engine package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-26054");
...
var pkgs = [
    {'reference':'moby-engine-24.0.5-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
