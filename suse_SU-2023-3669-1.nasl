...
# SUSE update advisory SUSE-SU-2023:3669-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2023:3669-1");

  script_name(english:"SUSE SLES15 Security Update : python-brotlipy (SUSE-SU-2023:3669-1)");
...
in the SUSE-SU-2023:3669-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-updates/2023-September/031550.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b58f9238");
...
var pkgs = [
    {'reference':'python3-brotlipy-0.7.0-150100.3.6.1', 'sp':'1', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
    {'reference':'python3-brotlipy-0.7.0-150100.3.6.1', 'sp':'2', 'release':'SLES_SAP15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
    {'reference':'python3-brotlipy-0.7.0-150100.3.6.1', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.1', 'SUSE-Manager-Proxy-release-4.0', 'SUSE-Manager-Server-release-4.0', 'sle-module-public-cloud-release-15.1', 'sles-release-15.1', 'suse-manager-server-release-4.0']},
    {'reference':'python3-brotlipy-0.7.0-150100.3.6.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLE_HPC-release-15.2', 'SUSE-Manager-Proxy-release-4.1', 'SUSE-Manager-Server-release-4.1', 'sle-module-public-cloud-release-15.2', 'sles-release-15.2', 'suse-manager-server-release-4.1']}
];
