...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : sssd (EulerOS-SA-2024-1972)");
...
number.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2024-1972
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1fe41d25");
...
var pkgs = [
  "python3-sssd-2.2.2-3.h17.eulerosv2r9",
  "sssd-2.2.2-3.h17.eulerosv2r9"
];
