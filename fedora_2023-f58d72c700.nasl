...
# extracted from Fedora Security Advisory FEDORA-2023-f58d72c700
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f58d72c700");

  script_name(english:"Fedora 37 : ruby (2023-f58d72c700)");
...
FEDORA-2023-f58d72c700 advisory.
    ...
    * Fix ReDoS vulnerability in Time (CVE-2023-28756)
    ...
    Fix bundler improperly resolving archful gems in Gemfile.lock. (rhbz#2178171)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f58d72c700");
...
var pkgs = [
    {'reference':'ruby-3.1.4-175.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
