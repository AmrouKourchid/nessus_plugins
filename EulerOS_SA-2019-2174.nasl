...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : nss (EulerOS-SA-2019-2174)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2174
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ae4fc21");
...
pkgs = ["nss-3.36.0-8.h3.eulerosv2r7",
        "nss-devel-3.36.0-8.h3.eulerosv2r7",
        "nss-sysinit-3.36.0-8.h3.eulerosv2r7",
        "nss-tools-3.36.0-8.h3.eulerosv2r7"];
