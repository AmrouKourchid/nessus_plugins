...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : glibc (EulerOS-SA-2021-2216)");
...
vulnerability :
  ...
  - The iconv program in the GNU C Library (aka glibc or
    libc6) 2.31 and earlier, when invoked with multiple
    suffixes in the destination encoding (TRANSLATE or
    IGNORE) along with the -c option, enters an infinite
    loop when processing invalid multi-byte input
    sequences, leading to a denial of
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2216
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bb2a7dc8");
...
pkgs = ["glibc-2.17-222.h42.eulerosv2r7",
        "glibc-common-2.17-222.h42.eulerosv2r7",
        "glibc-devel-2.17-222.h42.eulerosv2r7",
        "glibc-headers-2.17-222.h42.eulerosv2r7",
        "glibc-static-2.17-222.h42.eulerosv2r7",
        "glibc-utils-2.17-222.h42.eulerosv2r7",
        "nscd-2.17-222.h42.eulerosv2r7"];
