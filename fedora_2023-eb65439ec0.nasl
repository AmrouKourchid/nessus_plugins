...
# extracted from Fedora Security Advisory FEDORA-2023-eb65439ec0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-eb65439ec0");

  script_name(english:"Fedora 37 : matrix-synapse (2023-eb65439ec0)");
...
FEDORA-2023-eb65439ec0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-eb65439ec0");
...
var pkgs = [
    {'reference':'matrix-synapse-1.63.1-3.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
