...
# extracted from Red Hat Security Advisory RHSA-2022:8626. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2022:8626");

  script_name(english:"RHEL 8 : OpenShift Container Platform 4.11.17 (RHSA-2022:8626)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates for OpenShift Container Platform 4.11.17.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2022:8626 advisory.

    Red Hat OpenShift Container Platform is Red Hat's cloud computing
    Kubernetes application platform solution designed for on-premise or private
    cloud deployments.

    This advisory contains the RPM packages for Red Hat OpenShift Container Platform 4.11.17. See the
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_8626.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d579c32e");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8626");
  ...
  script_set_attribute(attribute:"see_also", value:"https://issues.redhat.com/browse/OCPBUGS-4045");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL OpenShift Container Platform 4.11.17 packages based on the guidance in RHSA-2022:8626.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.24.3-6.rhaos4.11.gitc4567c0.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-1705', 'CVE-2022-32148', 'CVE-2022-32189']},
      {'reference':'cri-tools-1.24.2-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-1705', 'CVE-2022-27664', 'CVE-2022-32189']},
      {'reference':'ignition-2.14.0-5.rhaos4.11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-32189']},
      {'reference':'ignition-validate-2.14.0-5.rhaos4.11.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube', 'cves':['CVE-2022-32189']}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cri-o / cri-tools / ignition / ignition-validate');
}
