...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2022/rhsa-2022_0851.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?203bfc61");
...
"Update the RHEL kpatch-patch package based on the guidance in RHSA-2022:0851.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  var cve_list = make_list('CVE-2021-0920', 'CVE-2021-4028', 'CVE-2021-4083', 'CVE-2022-0330', 'CVE-2022-0492', 'CVE-2022-22942');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RHSA-2022:0851');
  }
  else
  {
