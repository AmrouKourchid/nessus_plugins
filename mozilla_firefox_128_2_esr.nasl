...
"The version of Firefox ESR installed on the remote Windows host is prior to 128.2. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2024-40 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'128.2', min:'128.0.0', severity:SECURITY_HOLE);
