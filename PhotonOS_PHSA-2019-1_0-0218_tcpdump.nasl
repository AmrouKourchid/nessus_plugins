...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Tcpdump PHSA-2019-1.0-0218");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"tcpdump-4.9.2-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"tcpdump-debuginfo-4.9.2-2.ph1")) flag++;
