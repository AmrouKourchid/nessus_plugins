...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : perl (EulerOS-SA-2019-2035)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2035
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8e64f9b");
...
"Update the affected perl packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-6185");
...
pkgs = ["perl-5.16.3-285.h6",
        "perl-core-5.16.3-285.h6",
        "perl-devel-5.16.3-285.h6",
        "perl-libs-5.16.3-285.h6",
        "perl-macros-5.16.3-285.h6"];
