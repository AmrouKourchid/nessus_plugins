...
# extracted from Fedora Security Advisory FEDORA-2023-0597579983
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-0597579983");

  script_name(english:"Fedora 37 : kernel (2023-0597579983)");
...
FEDORA-2023-0597579983 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-0597579983");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2023-0597579983');
  }
  else
  {
...
var pkgs = [
    {'reference':'kernel-6.1.7-200.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
