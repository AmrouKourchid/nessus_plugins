...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2013/rhsa-2013_0729.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae08aa2f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0729");
...
"Update the RHEL haproxy package based on the guidance in RHSA-2013:0729.");
