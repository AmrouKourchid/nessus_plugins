...
# extracted from Fedora Security Advisory FEDORA-2024-270e3b5e9b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-270e3b5e9b");

  script_name(english:"Fedora 39 : onnx (2024-270e3b5e9b)");
...
FEDORA-2024-270e3b5e9b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-270e3b5e9b");
...
var pkgs = [
    {'reference':'onnx-1.14.0-9.fc39', 'release':'FC39', 'rpm_spec_vers_cmp':TRUE}
];
