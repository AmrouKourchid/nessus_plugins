...
# extracted from Ubuntu Security Notice USN-3402-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : PySAML2 vulnerability (USN-3402-1)");
...
USN-3402-1 advisory.
    ...
    It was discovered that PySAML2 incorrectly handled certain SAML XML requests and responses. A remote
    attacker could use this issue to read arbitrary files.

Tenable has extracted the preceding description block directly from the Ubuntu security advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://ubuntu.com/security/notices/USN-3402-1");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-pysaml2', 'pkgver': '3.0.0-3ubuntu1.16.04.1'},
    {'osver': '16.04', 'pkgname': 'python3-pysaml2', 'pkgver': '3.0.0-3ubuntu1.16.04.1'}
];
