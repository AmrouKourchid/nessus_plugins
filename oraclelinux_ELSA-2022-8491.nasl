...
ELSA-2022-8491 advisory.
    ...
    [1.20.4-19]
    - CVE fix for: CVE-2022-3550, CVE-2022-3551
...
var pkgs = [
    ...
    {'reference':'xorg-x11-server-source-1.20.4-19.el7_9', 'cpu':'aarch64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-devel-1.20.4-19.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-source-1.20.4-19.el7_9', 'cpu':'i686', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'xorg-x11-server-source-1.20.4-19.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
];
