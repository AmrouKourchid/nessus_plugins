...
if (description)
{
  ...
  script_cve_id("CVE-2019-20405");

  script_name(english:"Atlassian Jira 7.13.x < 8.6.0 JMX monitoring flag CSRF Vulnerability (JRASERVER-70570)");
...
version 7.13.x prior to 8.6.0. It is, therefore, affected by a flaw in the JMX monitoring component. An unauthenticated,
remote attacker can exploit this by tricking a user into visiting a specially crafted web page, allowing the attacker to
turn the JMX monitoring flag off or on.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version 
number.");
  # https://jira.atlassian.com/browse/JRASERVER-70570
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3fbe06c0");
...
"Upgrade to Atlassian Jira version 8.6.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-20405");
...
constraints = [
  { 'min_version' : '7.13', 'fixed_version' : '8.6.0' }
];
