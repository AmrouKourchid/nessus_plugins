...
# Hotfix doesn't increment sw version, and remote detection can't identify installed hotfixes,
# so require paranoia when app is registered via remote detection. 
