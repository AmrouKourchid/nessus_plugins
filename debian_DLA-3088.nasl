...
# extracted from Debian Security Advisory dla-3088. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3088 : libsnmp-base - security update");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libsnmp-base', 'reference': '5.7.3+dfsg-5+deb10u3'},
    {'release': '10.0', 'prefix': 'libsnmp-dev', 'reference': '5.7.3+dfsg-5+deb10u3'},
    {'release': '10.0', 'prefix': 'libsnmp-perl', 'reference': '5.7.3+dfsg-5+deb10u3'},
    {'release': '10.0', 'prefix': 'libsnmp30', 'reference': '5.7.3+dfsg-5+deb10u3'},
    {'release': '10.0', 'prefix': 'libsnmp30-dbg', 'reference': '5.7.3+dfsg-5+deb10u3'},
    {'release': '10.0', 'prefix': 'python-netsnmp', 'reference': '5.7.3+dfsg-5+deb10u3'},
    {'release': '10.0', 'prefix': 'snmp', 'reference': '5.7.3+dfsg-5+deb10u3'},
    {'release': '10.0', 'prefix': 'snmpd', 'reference': '5.7.3+dfsg-5+deb10u3'},
    {'release': '10.0', 'prefix': 'snmptrapd', 'reference': '5.7.3+dfsg-5+deb10u3'},
    {'release': '10.0', 'prefix': 'tkmib', 'reference': '5.7.3+dfsg-5+deb10u3'}
];
