...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : Moderate: / squirrelmail (ELSA-2007-0358)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2007-0358.html");
...
"Update the affected squirrelmail package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-2589");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2007-1262");
...
var pkgs = [
    {'reference':'squirrelmail-1.4.8-4.0.1.el5.0.1', 'cpu':'x86_64', 'release':'5', 'rpm_spec_vers_cmp':TRUE}
];
