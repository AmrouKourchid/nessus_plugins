...
# extracted from Debian Security Advisory dla-3597. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3597 : open-vm-tools - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3597
advisory.

    -------------------------------------------------------------------------
    Debian LTS Advisory DLA-3597-1                debian-lts@lists.debian.org
    https://www.debian.org/lts/security/                      Markus Koschany
    October 01, 2023                              https://wiki.debian.org/LTS
    -------------------------------------------------------------------------

    Package        : open-vm-tools
    Version        : 2:10.3.10-1+deb10u5
    ...
    assigned a more privileged Guest Alias.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/open-vm-tools");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'open-vm-tools', 'reference': '2:10.3.10-1+deb10u5'},
    {'release': '10.0', 'prefix': 'open-vm-tools-desktop', 'reference': '2:10.3.10-1+deb10u5'},
    {'release': '10.0', 'prefix': 'open-vm-tools-dev', 'reference': '2:10.3.10-1+deb10u5'}
];
