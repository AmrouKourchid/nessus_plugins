...
# SUSE update advisory SUSE-SU-2021:14807-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14807-1");

  script_name(english:"SUSE SLES11 Security Update : curl (SUSE-SU-2021:14807-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES11 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2021:14807-1 advisory.
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-September/009504.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?904d38b0");
...
var pkgs = [
    {'reference':'curl-openssl1-7.37.0-70.74.1', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'libcurl4-openssl1-32bit-7.37.0-70.74.1', 'sp':'0', 'cpu':'s390x', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'libcurl4-openssl1-32bit-7.37.0-70.74.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']},
    {'reference':'libcurl4-openssl1-7.37.0-70.74.1', 'sp':'0', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.3-0']}
];
