...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS : Exim vulnerability (USN-5741-1)");
...
referenced in the USN-5741-1 advisory.

    It was discovered that Exim incorrectly handled certain regular expressions. An attacker could use this
    issue to cause Exim to crash, resulting in a denial of service, or possibly execute arbitrary code.
