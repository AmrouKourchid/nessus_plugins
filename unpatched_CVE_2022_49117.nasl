...
if (description)
{
  ...
  script_cve_id("CVE-2022-49117");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2022-49117");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: mips: ralink: fix a refcount leak in
    ill_acc_of_setup() of_node_put(np) needs to be called when pdev == NULL. (CVE-2022-49117)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-49117");
