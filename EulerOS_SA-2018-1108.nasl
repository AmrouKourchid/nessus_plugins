...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : ruby (EulerOS-SA-2018-1108)");
...
vulnerabilities :
  ...
  - RubyGems version Ruby 2.2 series: 2.2.9 and earlier,
    ...
    could cause an infinite loop.. (CVE-2018-1000075)
  ...
  - RubyGems version Ruby 2.2 series: 2.2.9 and earlier,
    ...
    signatures.. (CVE-2018-1000076)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1108
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?029305a7");
...
pkgs = ["ruby-2.0.0.648-33.h6",
        "ruby-irb-2.0.0.648-33.h6",
        "ruby-libs-2.0.0.648-33.h6"];
