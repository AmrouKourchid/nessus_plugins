...
referenced in the RHSA-2020:5275 advisory.
    ...
    * php: Information disclosure in function get_headers (CVE-2020-7066)
    ...
    For detailed information on changes in this release, see the Red Hat Software Collections 3.6 Release
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4b503af4");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2020/rhsa-2020_5275.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d4feae0");
...
"Update the affected packages.");
  ...
  script_cwe_id(119, 121, 125, 170, 190, 200, 284, 476);
