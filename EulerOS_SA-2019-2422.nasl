...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : cups (EulerOS-SA-2019-2422)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2422
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?076f6443");
...
pkgs = ["cups-1.6.3-26.h3",
        "cups-client-1.6.3-26.h3",
        "cups-devel-1.6.3-26.h3",
        "cups-filesystem-1.6.3-26.h3",
        "cups-libs-1.6.3-26.h3",
        "cups-lpd-1.6.3-26.h3"];
