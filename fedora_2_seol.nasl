...
if (description)
{
  ...
  script_name(english:"Fedoraproject Fedora SEoL (2.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Fedoraproject Fedora is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Fedoraproject Fedora is 2.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of Fedoraproject Fedora that is currently supported.");
  ...
  script_set_attribute(attribute:"seol_date", value:"2005/04/11");
...
var constraints = [
  { max_branch : '2', min_branch : '2', seol : 20050411 }
];
