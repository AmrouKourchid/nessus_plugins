...
# extracted from Red Hat Security Advisory RHSA-2023:2589. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:2589");

  script_name(english:"RHEL 9 : autotrace (RHSA-2023:2589)");
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_2589.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73519d22");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:2589");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL autotrace package based on the guidance in RHSA-2023:2589.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'autotrace-0.31.1-65.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
