...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 7.0.0 < 7.0.75");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 7.0.75. It is, therefore, affected by a vulnerability as
referenced in the fixed_in_apache_tomcat_7.0.75_security-7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://svn.apache.org/viewvc?view=rev&rev=1777471");
  # https://tomcat.apache.org/security-7.html#Fixed_in_Apache_Tomcat_7.0.75
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8e9b7a2b");
...
var constraints = [
  { 'min_version' : '7.0.0', 'max_version' : '7.0.73', 'fixed_version' : '7.0.75' }
];
