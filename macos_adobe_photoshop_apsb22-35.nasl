...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop 22.x < 22.5.8 / 23.x < 23.4.1 Multiple Vulnerabilities (macOS APSB22-35)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Photoshop installed on remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Photoshop installed on the remote macOS or Mac OS X host is prior to 22.5.8/23.4.1. It is,
therefore, affected by multiple vulnerabilities as referenced in the apsb22-35 advisory.
