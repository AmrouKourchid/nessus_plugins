...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2013-0169.html");
...
"Update the affected vino package.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2011-0905");
...
var pkgs = [
    {'reference':'vino-2.28.1-8.el6_3', 'cpu':'i686', 'release':'6', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'vino-2.28.1-8.el6_3', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE}
];
