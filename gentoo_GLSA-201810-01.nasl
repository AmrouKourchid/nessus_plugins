...
# extracted from Gentoo Linux Security Advisory GLSA 201810-01.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201810-01");

  script_name(english:"GLSA-201810-01 : Mozilla Firefox: Multiple vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote Gentoo host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-201810-01
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/201810-01");
...
if (qpkg_check(package:"www-client/firefox", unaffected:make_list("ge 60.2.2"), vulnerable:make_list("lt 60.2.2"))) flag++;
if (qpkg_check(package:"www-client/firefox-bin", unaffected:make_list("ge 60.2.2"), vulnerable:make_list("lt 60.2.2"))) flag++;
