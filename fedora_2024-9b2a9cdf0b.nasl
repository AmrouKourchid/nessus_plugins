...
# extracted from Fedora Security Advisory FEDORA-2024-9b2a9cdf0b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-9b2a9cdf0b");

  script_name(english:"Fedora 40 : thunderbird (2024-9b2a9cdf0b)");
...
FEDORA-2024-9b2a9cdf0b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-9b2a9cdf0b");
...
var pkgs = [
    {'reference':'thunderbird-128.5.2-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
