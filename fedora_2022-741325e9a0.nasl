...
# extracted from Fedora Security Advisory FEDORA-2022-741325e9a0
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2022-741325e9a0");

  script_name(english:"Fedora 37 : golang-github-distribution-3 (2022-741325e9a0)");
...
FEDORA-2022-741325e9a0 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2022-741325e9a0");
...
var pkgs = [
    {'reference':'golang-github-distribution-3-3.0.0-0.1.pre1.20221009git0122d7d.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
