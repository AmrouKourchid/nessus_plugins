...
# extracted from openSUSE Security Update openSUSE-2019-1721.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : bubblewrap (openSUSE-2019-1721)");
...
Security issue fixed :
  ...
  - CVE-2019-12439: Fixed insecure use of /tmp
    (bsc#1136958).

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1136958");
  script_set_attribute(attribute:"solution", value:
"Update the affected bubblewrap packages.");
...
if ( rpm_check(release:"SUSE15.0", reference:"bubblewrap-0.2.0-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"bubblewrap-debuginfo-0.2.0-lp150.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"bubblewrap-debugsource-0.2.0-lp150.2.3.1") ) flag++;
