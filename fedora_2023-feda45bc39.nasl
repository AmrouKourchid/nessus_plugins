...
# extracted from Fedora Security Advisory FEDORA-2023-feda45bc39
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-feda45bc39");

  script_name(english:"Fedora 38 : dotnet6.0 (2023-feda45bc39)");
...
FEDORA-2023-feda45bc39 advisory.

    This is the July 2023 update for .NET 6. It updates the SDK to 6.0.120 and Runtime to 6.0.20.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-feda45bc39");
...
var pkgs = [
    {'reference':'dotnet6.0-6.0.120-1.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
