...
# extracted from Fedora Security Advisory FEDORA-2024-900475e0f7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-900475e0f7");

  script_name(english:"Fedora 40 : netatalk (2024-900475e0f7)");
...
FEDORA-2024-900475e0f7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-900475e0f7");
...
var pkgs = [
    {'reference':'netatalk-3.2.1-1.fc40', 'release':'FC40', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
