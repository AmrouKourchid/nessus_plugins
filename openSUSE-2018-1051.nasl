...
# extracted from openSUSE Security Update openSUSE-2018-1051.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : shadow (openSUSE-2018-1051)");
...
"This update for shadow fixes the following security issue :
  ...
  - CVE-2018-16588: Prevent useradd from creating
    intermediate directories with mode 0777 (bsc#1106914)

This update was imported from the SUSE:SLE-15:Update update project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1106914");
...
"Update the affected shadow packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-16588");
...
if ( rpm_check(release:"SUSE15.0", reference:"shadow-4.5-lp150.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"shadow-debuginfo-4.5-lp150.6.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"shadow-debugsource-4.5-lp150.6.3.1") ) flag++;
