...
# extracted from Red Hat Security Advisory RHSA-2023:3018. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:3018");

  script_name(english:"RHEL 8 : libarchive (RHSA-2023:3018)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for libarchive.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:3018 advisory.
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_3018.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9cecc1a2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3018");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL libarchive package based on the guidance in RHSA-2023:3018.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'bsdtar-3.3.3-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libarchive-3.3.3-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libarchive-devel-3.3.3-5.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
