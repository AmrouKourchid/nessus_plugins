...
# extracted from Fedora Security Advisory FEDORA-2023-f3389245ce
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f3389245ce");

  script_name(english:"Fedora 37 : optipng (2023-f3389245ce)");
...
FEDORA-2023-f3389245ce advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f3389245ce");
...
var pkgs = [
    {'reference':'optipng-0.7.8-1.fc37', 'release':'FC37', 'rpm_spec_vers_cmp':TRUE}
];
