...
"The version of php-pecl-imagick installed on the remote host is prior to 3.4.4-1.8. It is, therefore, affected by
multiple vulnerabilities as referenced in the ALAS-2020-1391 advisory.
    ...
    is mishandled in ReadImage in MagickCore/constitute.c. (CVE-2019-11597)

    In ImageMagick 7.0.6-6, a memory exhaustion vulnerability was found in the function ReadTIFFImage, which
    allows attackers to cause a denial of service. (CVE-2019-15140)
...
var pkgs = [
    {'reference':'php-pecl-imagick-3.4.4-1.8.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'php-pecl-imagick-3.4.4-1.8.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'php-pecl-imagick-debuginfo-3.4.4-1.8.amzn1', 'cpu':'i686', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'php-pecl-imagick-debuginfo-3.4.4-1.8.amzn1', 'cpu':'x86_64', 'release':'ALA', 'rpm_spec_vers_cmp':TRUE}
];
