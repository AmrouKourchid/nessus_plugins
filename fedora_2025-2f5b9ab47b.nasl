...
# extracted from Fedora Security Advisory FEDORA-2025-2f5b9ab47b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-2f5b9ab47b");

  script_name(english:"Fedora 41 : thunderbird (2025-2f5b9ab47b)");
...
FEDORA-2025-2f5b9ab47b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2f5b9ab47b");
...
var pkgs = [
    {'reference':'thunderbird-128.6.0-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
