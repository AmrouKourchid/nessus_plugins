...
# extracted from Red Hat Security Advisory RHSA-2023:1017. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2023:1017");

  script_name(english:"RHEL 9 : Red Hat OpenStack Platform 17.0 (openstack-glance) (RHSA-2023:1017)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update for Red Hat OpenStack Platform 17.0 (openstack-glance).");
...
number.");
  ...
  # https://security.access.redhat.com/data/csaf/v2/advisories/2023/rhsa-2023_1017.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b2197a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:1017");
  script_set_attribute(attribute:"solution", value:
"Update the RHEL Red Hat OpenStack Platform 17.0 (openstack-glance) package based on the guidance in RHSA-2023:1017.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-glance-22.1.1-0.20220919210603.677c89c.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'},
      {'reference':'python3-glance-22.1.1-0.20220919210603.677c89c.el9ost', 'release':'9', 'el_string':'el9ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1', 'exists_check':'openstack-'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'openstack-glance / python3-glance');
}
