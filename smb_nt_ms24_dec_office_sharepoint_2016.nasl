...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002659");
  script_xref(name:"MSFT", value:"MS24-5002659");
  script_xref(name:"IAVA", value:"2024-A-0809-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2016 (December 2024)");
...
security updates. It is, therefore, affected by multiple vulnerabilities:
  ...
  - A remote code execution vulnerability.
    (CVE-2024-49065, CVE-2024-49070) 
  
  - A Information Disclosure Vulnerability. 
    (CVE-2024-49062, CVE-2024-49064)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002659");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002659 to address this issue.");
