...
# SUSE update advisory SUSE-SU-2022:3715-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2022:3715-1");

  script_name(english:"SUSE SLES12 Security Update : multipath-tools (SUSE-SU-2022:3715-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2022-October/012645.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3b78fd27");
...
var pkgs = [
    {'reference':'kpartx-0.6.2+suse20221017.514d453-71.26.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.2']},
    {'reference':'multipath-tools-0.6.2+suse20221017.514d453-71.26.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.2']}
];
