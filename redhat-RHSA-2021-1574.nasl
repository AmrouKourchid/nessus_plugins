...
# extracted from Red Hat Security Advisory RHSA-2021:1574. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:1574");

  script_name(english:"RHEL 8 : NetworkManager and libnma (RHSA-2021:1574)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2021:1574 advisory.
    ...
    The following packages have been upgraded to a later upstream version: NetworkManager (1.30.0).
    (BZ#1878783)
...
number.");
  # https://security.access.redhat.com/data/csaf/v2/advisories/2021/rhsa-2021_1574.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6b1b1934");
  # https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/8.4_release_notes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?862005a9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/updates/classification/#moderate");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:1574");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'NetworkManager-1.30.0-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-adsl-1.30.0-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-bluetooth-1.30.0-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-cloud-setup-1.30.0-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      ...
      {'reference':'NetworkManager-libnm-1.30.0-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-libnm-devel-1.30.0-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-ovs-1.30.0-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-ppp-1.30.0-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-team-1.30.0-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-tui-1.30.0-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-wifi-1.30.0-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'NetworkManager-wwan-1.30.0-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libnma-1.8.30-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libnma-devel-1.8.30-2.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
