...
# extracted from Debian Security Advisory dsa-5308. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5308-1 : webkit2gtk - security update");
...
dsa-5308 advisory.
    ...
    The following vulnerabilities have been discovered in the WebKitGTK web engine: CVE-2022-42852 hazbinhotel
    discovered that processing maliciously crafted web content may result in the disclosure of process memory.
    CVE-2022-42856 Clement Lecigne discovered that processing maliciously crafted web content may lead to
    arbitrary code execution. CVE-2022-42867 Maddie Stone discovered that processing maliciously crafted web
    content may lead to arbitrary code execution. CVE-2022-46692 KirtiKumar Anandrao Ramchandani discovered
    that processing maliciously crafted web content may bypass Same Origin Policy. CVE-2022-46698 Dohyun Lee
    and Ryan Shin discovered that processing maliciously crafted web content may disclose sensitive user
    information. CVE-2022-46699 Samuel Gross discovered that processing maliciously crafted web content may
    lead to arbitrary code execution. CVE-2022-46700 Samuel Gross discovered that processing maliciously
    crafted web content may lead to arbitrary code execution. For the stable distribution (bullseye), these
    problems have been fixed in version 2.38.3-1~deb11u1. We recommend that you upgrade your webkit2gtk
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5308");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'gir1.2-javascriptcoregtk-4.0', 'reference': '2.38.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'gir1.2-webkit2-4.0', 'reference': '2.38.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libjavascriptcoregtk-4.0-18', 'reference': '2.38.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libjavascriptcoregtk-4.0-bin', 'reference': '2.38.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libjavascriptcoregtk-4.0-dev', 'reference': '2.38.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libwebkit2gtk-4.0-37', 'reference': '2.38.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libwebkit2gtk-4.0-dev', 'reference': '2.38.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'libwebkit2gtk-4.0-doc', 'reference': '2.38.3-1~deb11u1'},
    {'release': '11.0', 'prefix': 'webkit2gtk-driver', 'reference': '2.38.3-1~deb11u1'}
];
