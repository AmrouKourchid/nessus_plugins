...
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ntp-4.2.8p12-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ntp-debuginfo-4.2.8p12-1.ph2')) flag++;
if (rpm_check(release:'PhotonOS-2.0', cpu:'x86_64', reference:'ntp-perl-4.2.8p12-1.ph2')) flag++;
