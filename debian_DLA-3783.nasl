...
# extracted from Debian Security Advisory dla-3783. The text
...
if (description)
{
  ...
  script_name(english:"Debian dla-3783 : expat - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3783
advisory.
...
var pkgs = [
    {'release': '10.0', 'prefix': 'expat', 'reference': '2.2.6-2+deb10u7'},
    {'release': '10.0', 'prefix': 'libexpat1', 'reference': '2.2.6-2+deb10u7'},
    {'release': '10.0', 'prefix': 'libexpat1-dev', 'reference': '2.2.6-2+deb10u7'}
];
