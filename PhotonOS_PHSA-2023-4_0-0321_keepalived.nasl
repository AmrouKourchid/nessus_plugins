...
# extracted from VMware Security Advisory PHSA-2023-4.0-0321. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 4.0: Keepalived PHSA-2023-4.0-0321");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the keepalived package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Update-4.0-321.md");
...
if (rpm_check(release:'PhotonOS-4.0', cpu:'x86_64', reference:'keepalived-2.1.5-5.ph4')) flag++;
