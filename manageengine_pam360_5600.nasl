...
if (description)
{
  ...
  script_name(english:"ManageEngine PAM360 < 5.6 Build 5600 SQLi");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is running a web application affected by a SQL injection vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of ManageEngine PAM360 prior to 5.6 Build 5600. It is, therefore, affected by a
...
"Upgrade to ManageEngine PAM360 version 5.6 Build 5600 or later.");
...
var constraints = [
  { 'max_version' : '5550', 'fixed_display' : '5.6 Build 5600' }
];
