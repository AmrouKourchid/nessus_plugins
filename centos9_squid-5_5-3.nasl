...
if (description)
{
  ...
  script_name(english:"CentOS 9 : squid-5.5-3.el9");
...
squid-5.5-3.el9 build changelog.

  - buffer-over-read in SSPI and SMB authentication (CVE-2022-41318)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://kojihub.stream.centos.org/koji/buildinfo?buildID=26145");
...
var pkgs = [
    {'reference':'squid-5.5-3.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
