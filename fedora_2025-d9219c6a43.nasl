...
# extracted from Fedora Security Advisory FEDORA-2025-d9219c6a43
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2025-d9219c6a43");
  script_xref(name:"IAVA", value:"2025-A-0010-S");

  script_name(english:"Fedora 41 : chromium (2025-d9219c6a43)");
...
FEDORA-2025-d9219c6a43 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-d9219c6a43");
...
var pkgs = [
    {'reference':'chromium-132.0.6834.83-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
