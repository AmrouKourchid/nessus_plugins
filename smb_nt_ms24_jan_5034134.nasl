...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5034134");
  script_xref(name:"MSFT", value:"MS24-5034134");
  script_xref(name:"IAVA", value:"2024-A-0015-S");
  script_xref(name:"IAVA", value:"2024-A-0016-S");

  script_name(english:"KB5034134: Windows 10 LTS 1507 Security Update (January 2024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 5034134. It is, therefore, affected by multiple vulnerabilities
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/help/5034134");
  script_set_attribute(attribute:"solution", value:
"Apply Security Update 5034134");
