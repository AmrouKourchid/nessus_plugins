...
if (description)
{
  ...
  script_cve_id("CVE-2019-3826");

  script_name(english:"Photon OS 3.0: Telegraf PHSA-2023-3.0-0615");
...
if (rpm_check(release:'PhotonOS-3.0', cpu:'x86_64', reference:'telegraf-1.27.1-1.ph3')) flag++;
