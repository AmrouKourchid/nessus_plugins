...
if (description)
{
  ...
  script_cve_id("CVE-2024-24266");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-24266");
...
patch available.
  ...
  - gpac v2.2.1 was discovered to contain a Use-After-Free (UAF) vulnerability via the dasher_configure_pid
    function at /src/filters/dasher.c. (CVE-2024-24266)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-24266");
