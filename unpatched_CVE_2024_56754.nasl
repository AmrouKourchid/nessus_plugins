...
if (description)
{
  ...
  script_cve_id("CVE-2024-56754");

  script_name(english:"Linux Distros Unpatched Vulnerability : CVE-2024-56754");
...
patch available.
  ...
  - In the Linux kernel, the following vulnerability has been resolved: crypto: caam - Fix the pointer passed
    to caam_qi_shutdown() The type of the last parameter given to devm_add_action_or_reset() is struct
    caam_drv_private *, but in caam_qi_shutdown(), it is casted to struct device *. Pass the correct
    parameter to devm_add_action_or_reset() so that the resources are released as expected. (CVE-2024-56754)
...
"There is no known solution at this time.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2024-56754");
