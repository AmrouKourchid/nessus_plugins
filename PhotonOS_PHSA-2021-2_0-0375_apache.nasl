...
# extracted from VMware Security Advisory PHSA-2021-2.0-0375. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Apache PHSA-2021-2.0-0375");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the apache package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-375.md");
...
if (rpm_check(release:'PhotonOS-2.0', reference:'apache-tomcat-8.5.60-3.ph2')) flag++;
