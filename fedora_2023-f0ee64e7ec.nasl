...
# extracted from Fedora Security Advisory FEDORA-2023-f0ee64e7ec
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2023-f0ee64e7ec");

  script_name(english:"Fedora 36 : liferea (2023-f0ee64e7ec)");
...
FEDORA-2023-f0ee64e7ec advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-f0ee64e7ec");
...
var pkgs = [
    {'reference':'liferea-1.14.1-1.fc36', 'release':'FC36', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
