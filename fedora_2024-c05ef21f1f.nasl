...
# extracted from Fedora Security Advisory FEDORA-2024-c05ef21f1f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-c05ef21f1f");

  script_name(english:"Fedora 41 : perl-Module-ScanDeps (2024-c05ef21f1f)");
...
FEDORA-2024-c05ef21f1f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-c05ef21f1f");
...
var pkgs = [
    {'reference':'perl-Module-ScanDeps-1.37-1.fc41', 'release':'FC41', 'rpm_spec_vers_cmp':TRUE}
];
