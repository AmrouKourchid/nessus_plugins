...
if (description)
{
  ...
  script_name(english:"OpenSSL 3.1.0 < 3.1.5 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 3.1.5. It is, therefore, affected by multiple
vulnerabilities as referenced in the 3.1.5 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a42ec4e");
  # https://github.com/openssl/openssl/commit/f3fc5808fe9ff74042d639839610d03b8fdcc015
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?950a9188");
  # https://github.com/openssl/openssl/commit/ddeb4b6c6d527e54ce9a99cba785c0f7776e54b6
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aca829a1");
  # https://github.com/openssl/openssl/commit/d135eeab8a5dbf72b3da5240bab9ddb7678dbd2c
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d086a7ea");
...
var constraints = [
  { 'min_version' : '3.1.0', 'fixed_version' : '3.1.5' }
];
