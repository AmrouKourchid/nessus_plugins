...
# extracted from Fedora Security Advisory FEDORA-2024-797928fed3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2024-797928fed3");

  script_name(english:"Fedora 38 : pypy (2024-797928fed3)");
...
FEDORA-2024-797928fed3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-797928fed3");
...
var pkgs = [
    {'reference':'pypy-7.3.15-3.fc38', 'release':'FC38', 'rpm_spec_vers_cmp':TRUE}
];
